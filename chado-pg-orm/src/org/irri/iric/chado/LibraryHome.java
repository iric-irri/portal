 ...
 * @see org.irri.iric.chado.Library
 * @author Hibernate Tools
 */
public class LibraryHome {

	private static final Log log = LogFactory.getLog(LibraryHome.class);
	...
	public void persist(Library transientInstance) {
		log.debug("persisting Library instance");
		try {
	...
	public Library findById(int id) {
		...
		try {
			Library instance = (Library) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Library", id);
			if (instance == null) {
	...
	public List findByExample(Library instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Library")
