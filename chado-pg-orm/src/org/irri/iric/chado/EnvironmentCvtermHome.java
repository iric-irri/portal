...
/**
 * Home object for domain model class EnvironmentCvterm.
 * @see org.irri.iric.chado.EnvironmentCvterm
 * @author Hibernate Tools
 */
public class EnvironmentCvtermHome {

	private static final Log log = LogFactory
			.getLog(EnvironmentCvtermHome.class);
	...
	public void persist(EnvironmentCvterm transientInstance) {
		log.debug("persisting EnvironmentCvterm instance");
		try {
	...
	public EnvironmentCvterm merge(EnvironmentCvterm detachedInstance) {
		...
		try {
			EnvironmentCvterm result = (EnvironmentCvterm) sessionFactory
	...
	public EnvironmentCvterm findById(int id) {
		log.debug("getting EnvironmentCvterm instance with id: " + id);
		try {
			EnvironmentCvterm instance = (EnvironmentCvterm) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.EnvironmentCvterm", id);
			if (instance == null) {
	...
	public List findByExample(EnvironmentCvterm instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.EnvironmentCvterm")
