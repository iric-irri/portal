...
/**
 * Home object for domain model class PubRelationship.
 * @see org.irri.iric.chado.PubRelationship
 * @author Hibernate Tools
 */
public class PubRelationshipHome {

	private static final Log log = LogFactory.getLog(PubRelationshipHome.class);
	...
	public void persist(PubRelationship transientInstance) {
		log.debug("persisting PubRelationship instance");
		try {
	...
	public PubRelationship merge(PubRelationship detachedInstance) {
		...
		try {
			PubRelationship result = (PubRelationship) sessionFactory
	...
	public PubRelationship findById(int id) {
		log.debug("getting PubRelationship instance with id: " + id);
		try {
			PubRelationship instance = (PubRelationship) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.PubRelationship", id);
			if (instance == null) {
	...
	public List findByExample(PubRelationship instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.PubRelationship")
