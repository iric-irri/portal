 ...
 * @see org.irri.iric.chado.Environment
...
public class EnvironmentHome {
	...
	public Environment merge(Environment detachedInstance) {
		...
		try {
			Environment result = (Environment) sessionFactory
	...
	public Environment findById(int id) {
		...
		try {
			Environment instance = (Environment) sessionFactory
					.getCurrentSession().get("org.irri.iric.chado.Environment",
							id);
			if (instance == null) {
	...
	public List findByExample(Environment instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Environment")
