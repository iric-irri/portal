...
/**
 * Home object for domain model class Pub.
 * @see org.irri.iric.chado.Pub
 * @author Hibernate Tools
 */
public class PubHome {

	private static final Log log = LogFactory.getLog(PubHome.class);
	...
	public void persist(Pub transientInstance) {
		log.debug("persisting Pub instance");
		try {
	...
	public Pub merge(Pub detachedInstance) {
		...
		try {
			Pub result = (Pub) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Pub findById(int id) {
		...
		try {
			Pub instance = (Pub) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.Pub", id);
			if (instance == null) {
	...
	public List findByExample(Pub instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Pub")
