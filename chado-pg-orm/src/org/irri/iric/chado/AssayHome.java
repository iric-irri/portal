...
public class AssayHome {
	...
	public List findByExample(Assay instance) {
		log.debug("finding Assay instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Assay")
