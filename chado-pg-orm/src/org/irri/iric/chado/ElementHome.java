 ...
 * @see org.irri.iric.chado.Element
 * @author Hibernate Tools
 */
public class ElementHome {

	private static final Log log = LogFactory.getLog(ElementHome.class);
	...
	public Element merge(Element detachedInstance) {
		...
		try {
			Element result = (Element) sessionFactory.getCurrentSession()
	...
	public Element findById(int id) {
		...
		try {
			Element instance = (Element) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Element", id);
			if (instance == null) {
	...
	public List findByExample(Element instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Element")
