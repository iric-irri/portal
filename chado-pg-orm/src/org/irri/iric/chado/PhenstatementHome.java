...
/**
 * Home object for domain model class Phenstatement.
 * @see org.irri.iric.chado.Phenstatement
 * @author Hibernate Tools
 */
public class PhenstatementHome {

	private static final Log log = LogFactory.getLog(PhenstatementHome.class);
	...
	public void persist(Phenstatement transientInstance) {
		log.debug("persisting Phenstatement instance");
		try {
	...
	public Phenstatement merge(Phenstatement detachedInstance) {
		...
		try {
			Phenstatement result = (Phenstatement) sessionFactory
	...
	public Phenstatement findById(int id) {
		log.debug("getting Phenstatement instance with id: " + id);
		try {
			Phenstatement instance = (Phenstatement) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.Phenstatement", id);
			if (instance == null) {
	...
	public List findByExample(Phenstatement instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Phenstatement")
