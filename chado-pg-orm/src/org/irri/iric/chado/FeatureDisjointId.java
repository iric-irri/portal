...
/**
 * FeatureDisjointId generated by hbm2java
 */
public class FeatureDisjointId implements java.io.Serializable {

	private Integer subjectId;
	private Integer objectId;

	public FeatureDisjointId() {
	}

	public FeatureDisjointId(Integer subjectId, Integer objectId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeatureDisjointId))
			return false;
		FeatureDisjointId castOther = (FeatureDisjointId) other;
