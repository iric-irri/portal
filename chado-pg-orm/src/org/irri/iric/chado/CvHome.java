 ...
 * @see org.irri.iric.chado.Cv
 * @author Hibernate Tools
 */
public class CvHome {

	private static final Log log = LogFactory.getLog(CvHome.class);
	...
	public void persist(Cv transientInstance) {
	...
	public Cv merge(Cv detachedInstance) {
		...
		try {
			Cv result = (Cv) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Cv findById(int id) {
		...
		try {
			Cv instance = (Cv) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.Cv", id);
			if (instance == null) {
	...
	public List findByExample(Cv instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Cv")
