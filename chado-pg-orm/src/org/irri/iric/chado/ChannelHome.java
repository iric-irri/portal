...
/**
 * Home object for domain model class Channel.
 * @see org.irri.iric.chado.Channel
 * @author Hibernate Tools
 */
public class ChannelHome {

	private static final Log log = LogFactory.getLog(ChannelHome.class);
	...
	public void persist(Channel transientInstance) {
		log.debug("persisting Channel instance");
		try {
	...
	public Channel merge(Channel detachedInstance) {
		...
		try {
			Channel result = (Channel) sessionFactory.getCurrentSession()
	...
	public Channel findById(int id) {
		...
		try {
			Channel instance = (Channel) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Channel", id);
			if (instance == null) {
	...
	public List findByExample(Channel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Channel")
