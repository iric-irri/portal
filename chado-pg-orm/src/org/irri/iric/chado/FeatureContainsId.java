...
/**
 * FeatureContainsId generated by hbm2java
 */
public class FeatureContainsId implements java.io.Serializable {

	private Integer subjectId;
	private Integer objectId;

	public FeatureContainsId() {
	}

	public FeatureContainsId(Integer subjectId, Integer objectId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeatureContainsId))
			return false;
		FeatureContainsId castOther = (FeatureContainsId) other;
