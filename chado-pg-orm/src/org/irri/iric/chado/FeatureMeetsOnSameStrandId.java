...
/**
 * FeatureMeetsOnSameStrandId generated by hbm2java
 */
public class FeatureMeetsOnSameStrandId implements java.io.Serializable {

	private Integer subjectId;
	private Integer objectId;

	public FeatureMeetsOnSameStrandId() {
	}

	public FeatureMeetsOnSameStrandId(Integer subjectId, Integer objectId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeatureMeetsOnSameStrandId))
			return false;
		FeatureMeetsOnSameStrandId castOther = (FeatureMeetsOnSameStrandId) other;
