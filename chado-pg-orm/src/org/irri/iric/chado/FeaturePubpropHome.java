...
/**
 * Home object for domain model class FeaturePubprop.
 * @see org.irri.iric.chado.FeaturePubprop
 * @author Hibernate Tools
 */
public class FeaturePubpropHome {

	private static final Log log = LogFactory.getLog(FeaturePubpropHome.class);
	...
	public void persist(FeaturePubprop transientInstance) {
		log.debug("persisting FeaturePubprop instance");
		try {
	...
	public FeaturePubprop merge(FeaturePubprop detachedInstance) {
		...
		try {
			FeaturePubprop result = (FeaturePubprop) sessionFactory
	...
	public FeaturePubprop findById(int id) {
		log.debug("getting FeaturePubprop instance with id: " + id);
		try {
			FeaturePubprop instance = (FeaturePubprop) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.FeaturePubprop", id);
			if (instance == null) {
	...
	public List findByExample(FeaturePubprop instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.FeaturePubprop")
