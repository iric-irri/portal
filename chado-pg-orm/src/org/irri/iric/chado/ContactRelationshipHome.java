...
/**
 * Home object for domain model class ContactRelationship.
 * @see org.irri.iric.chado.ContactRelationship
 * @author Hibernate Tools
 */
public class ContactRelationshipHome {

	private static final Log log = LogFactory
			.getLog(ContactRelationshipHome.class);
	...
	public void persist(ContactRelationship transientInstance) {
		log.debug("persisting ContactRelationship instance");
		try {
	...
	public ContactRelationship merge(ContactRelationship detachedInstance) {
		...
		try {
			ContactRelationship result = (ContactRelationship) sessionFactory
	...
	public ContactRelationship findById(int id) {
		log.debug("getting ContactRelationship instance with id: " + id);
		try {
			ContactRelationship instance = (ContactRelationship) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.ContactRelationship", id);
			if (instance == null) {
	...
	public List findByExample(ContactRelationship instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.ContactRelationship")
