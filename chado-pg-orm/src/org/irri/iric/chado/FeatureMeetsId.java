...
/**
 * FeatureMeetsId generated by hbm2java
 */
public class FeatureMeetsId implements java.io.Serializable {

	private Integer subjectId;
	private Integer objectId;

	public FeatureMeetsId() {
	}

	public FeatureMeetsId(Integer subjectId, Integer objectId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeatureMeetsId))
			return false;
		FeatureMeetsId castOther = (FeatureMeetsId) other;
