...
/**
 * InversionBreakpointId generated by hbm2java
 */
public class InversionBreakpointId implements java.io.Serializable {

	private Integer inversionBreakpointId;
	...
	public InversionBreakpointId() {
	}

	public InversionBreakpointId(Integer inversionBreakpointId,
		...
		this.inversionBreakpointId = inversionBreakpointId;
	...
	public Integer getInversionBreakpointId() {
		return this.inversionBreakpointId;
	}

	public void setInversionBreakpointId(Integer inversionBreakpointId) {
		this.inversionBreakpointId = inversionBreakpointId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionBreakpointId))
			return false;
		InversionBreakpointId castOther = (InversionBreakpointId) other;

		return ((this.getInversionBreakpointId() == castOther
				.getInversionBreakpointId()) || (this
				.getInversionBreakpointId() != null
				&& castOther.getInversionBreakpointId() != null && this
				.getInversionBreakpointId().equals(
						castOther.getInversionBreakpointId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionBreakpointId() == null ? 0 : this
						.getInversionBreakpointId().hashCode());
		result = 37 * result
