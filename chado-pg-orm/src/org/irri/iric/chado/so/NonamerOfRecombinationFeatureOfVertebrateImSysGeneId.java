...
/**
 * NonamerOfRecombinationFeatureOfVertebrateImSysGeneId generated by hbm2java
 */
public class NonamerOfRecombinationFeatureOfVertebrateImSysGeneId implements
		java.io.Serializable {

	private Integer nonamerOfRecombinationFeatureOfVertebrateImSysGeneId;
	...
	public NonamerOfRecombinationFeatureOfVertebrateImSysGeneId() {
	}

	public NonamerOfRecombinationFeatureOfVertebrateImSysGeneId(
			Integer nonamerOfRecombinationFeatureOfVertebrateImSysGeneId,
		...
		this.nonamerOfRecombinationFeatureOfVertebrateImSysGeneId = nonamerOfRecombinationFeatureOfVertebrateImSysGeneId;
	...
	public Integer getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId() {
		return this.nonamerOfRecombinationFeatureOfVertebrateImSysGeneId;
	}

	public void setNonamerOfRecombinationFeatureOfVertebrateImSysGeneId(
			Integer nonamerOfRecombinationFeatureOfVertebrateImSysGeneId) {
		this.nonamerOfRecombinationFeatureOfVertebrateImSysGeneId = nonamerOfRecombinationFeatureOfVertebrateImSysGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonamerOfRecombinationFeatureOfVertebrateImSysGeneId))
			return false;
		NonamerOfRecombinationFeatureOfVertebrateImSysGeneId castOther = (NonamerOfRecombinationFeatureOfVertebrateImSysGeneId) other;

		return ((this.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId() == castOther
				.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId()) || (this
				.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId() != null
				&& castOther
						.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId() != null && this
				.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId()
				.equals(castOther
						.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId() == null ? 0
						: this.getNonamerOfRecombinationFeatureOfVertebrateImSysGeneId()
								.hashCode());
		result = 37 * result
