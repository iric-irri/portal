...
/**
 * BoundByProteinId generated by hbm2java
 */
public class BoundByProteinId implements java.io.Serializable {

	private Integer boundByProteinId;
	...
	public BoundByProteinId() {
	}

	public BoundByProteinId(Integer boundByProteinId, Integer featureId,
		...
		this.boundByProteinId = boundByProteinId;
	...
	public Integer getBoundByProteinId() {
		return this.boundByProteinId;
	}

	public void setBoundByProteinId(Integer boundByProteinId) {
		this.boundByProteinId = boundByProteinId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BoundByProteinId))
			return false;
		BoundByProteinId castOther = (BoundByProteinId) other;

		return ((this.getBoundByProteinId() == castOther.getBoundByProteinId()) || (this
				.getBoundByProteinId() != null
				&& castOther.getBoundByProteinId() != null && this
				.getBoundByProteinId().equals(castOther.getBoundByProteinId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBoundByProteinId() == null ? 0 : this
						.getBoundByProteinId().hashCode());
		result = 37 * result
