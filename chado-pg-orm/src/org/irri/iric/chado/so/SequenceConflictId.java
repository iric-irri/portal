...
/**
 * SequenceConflictId generated by hbm2java
 */
public class SequenceConflictId implements java.io.Serializable {

	private Integer sequenceConflictId;
	...
	public SequenceConflictId() {
	}

	public SequenceConflictId(Integer sequenceConflictId, Integer featureId,
		...
		this.sequenceConflictId = sequenceConflictId;
	...
	public Integer getSequenceConflictId() {
		return this.sequenceConflictId;
	}

	public void setSequenceConflictId(Integer sequenceConflictId) {
		this.sequenceConflictId = sequenceConflictId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceConflictId))
			return false;
		SequenceConflictId castOther = (SequenceConflictId) other;

		return ((this.getSequenceConflictId() == castOther
				.getSequenceConflictId()) || (this.getSequenceConflictId() != null
				&& castOther.getSequenceConflictId() != null && this
				.getSequenceConflictId().equals(
						castOther.getSequenceConflictId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceConflictId() == null ? 0 : this
						.getSequenceConflictId().hashCode());
		result = 37 * result
