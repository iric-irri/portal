...
/**
 * Minus24SignalId generated by hbm2java
 */
public class Minus24SignalId implements java.io.Serializable {

	private Integer minus24SignalId;
	...
	public Minus24SignalId() {
	}

	public Minus24SignalId(Integer minus24SignalId, Integer featureId,
		...
		this.minus24SignalId = minus24SignalId;
	...
	public Integer getMinus24SignalId() {
		return this.minus24SignalId;
	}

	public void setMinus24SignalId(Integer minus24SignalId) {
		this.minus24SignalId = minus24SignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus24SignalId))
			return false;
		Minus24SignalId castOther = (Minus24SignalId) other;

		return ((this.getMinus24SignalId() == castOther.getMinus24SignalId()) || (this
				.getMinus24SignalId() != null
				&& castOther.getMinus24SignalId() != null && this
				.getMinus24SignalId().equals(castOther.getMinus24SignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus24SignalId() == null ? 0 : this.getMinus24SignalId()
						.hashCode());
		result = 37 * result
