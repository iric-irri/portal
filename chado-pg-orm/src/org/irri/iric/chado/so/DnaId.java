...
/**
 * DnaId generated by hbm2java
 */
public class DnaId implements java.io.Serializable {
	...
	public DnaId(Integer dnaId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaId))
			return false;
		DnaId castOther = (DnaId) other;

		return ((this.getDnaId() == castOther.getDnaId()) || (this.getDnaId() != null
				&& castOther.getDnaId() != null && this.getDnaId().equals(
				castOther.getDnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDnaId() == null ? 0 : this.getDnaId().hashCode());
		result = 37 * result
