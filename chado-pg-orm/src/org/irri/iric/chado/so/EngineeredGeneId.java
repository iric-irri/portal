...
/**
 * EngineeredGeneId generated by hbm2java
 */
public class EngineeredGeneId implements java.io.Serializable {

	private Integer engineeredGeneId;
	...
	public EngineeredGeneId() {
	}

	public EngineeredGeneId(Integer engineeredGeneId, Integer featureId,
	...
	public Integer getEngineeredGeneId() {
		return this.engineeredGeneId;
	}

	public void setEngineeredGeneId(Integer engineeredGeneId) {
		this.engineeredGeneId = engineeredGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredGeneId))
			return false;
		EngineeredGeneId castOther = (EngineeredGeneId) other;

		return ((this.getEngineeredGeneId() == castOther.getEngineeredGeneId()) || (this
				.getEngineeredGeneId() != null
				&& castOther.getEngineeredGeneId() != null && this
				.getEngineeredGeneId().equals(castOther.getEngineeredGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredGeneId() == null ? 0 : this
						.getEngineeredGeneId().hashCode());
		result = 37 * result
