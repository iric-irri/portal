...
/**
 * CClusterId generated by hbm2java
 */
public class CClusterId implements java.io.Serializable {

	private Integer CClusterId;
	...
	public CClusterId(Integer CClusterId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCClusterId() {
		return this.CClusterId;
	}

	public void setCClusterId(Integer CClusterId) {
		this.CClusterId = CClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CClusterId))
			return false;
		CClusterId castOther = (CClusterId) other;

		return ((this.getCClusterId() == castOther.getCClusterId()) || (this
				.getCClusterId() != null && castOther.getCClusterId() != null && this
				.getCClusterId().equals(castOther.getCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCClusterId() == null ? 0 : this.getCClusterId()
						.hashCode());
		result = 37 * result
