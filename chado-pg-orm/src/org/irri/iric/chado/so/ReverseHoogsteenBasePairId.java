...
/**
 * ReverseHoogsteenBasePairId generated by hbm2java
 */
public class ReverseHoogsteenBasePairId implements java.io.Serializable {

	private Integer reverseHoogsteenBasePairId;
	...
	public ReverseHoogsteenBasePairId() {
	}

	public ReverseHoogsteenBasePairId(Integer reverseHoogsteenBasePairId,
		...
		this.reverseHoogsteenBasePairId = reverseHoogsteenBasePairId;
	...
	public Integer getReverseHoogsteenBasePairId() {
		return this.reverseHoogsteenBasePairId;
	}

	public void setReverseHoogsteenBasePairId(Integer reverseHoogsteenBasePairId) {
		this.reverseHoogsteenBasePairId = reverseHoogsteenBasePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReverseHoogsteenBasePairId))
			return false;
		ReverseHoogsteenBasePairId castOther = (ReverseHoogsteenBasePairId) other;

		return ((this.getReverseHoogsteenBasePairId() == castOther
				.getReverseHoogsteenBasePairId()) || (this
				.getReverseHoogsteenBasePairId() != null
				&& castOther.getReverseHoogsteenBasePairId() != null && this
				.getReverseHoogsteenBasePairId().equals(
						castOther.getReverseHoogsteenBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReverseHoogsteenBasePairId() == null ? 0 : this
						.getReverseHoogsteenBasePairId().hashCode());
		result = 37 * result
