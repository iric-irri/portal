...
/**
 * NoOutputId generated by hbm2java
 */
public class NoOutputId implements java.io.Serializable {

	private Integer noOutputId;
	...
	public NoOutputId(Integer noOutputId, Integer featureId, Integer dbxrefId,
	...
	public Integer getNoOutputId() {
		return this.noOutputId;
	}

	public void setNoOutputId(Integer noOutputId) {
		this.noOutputId = noOutputId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NoOutputId))
			return false;
		NoOutputId castOther = (NoOutputId) other;

		return ((this.getNoOutputId() == castOther.getNoOutputId()) || (this
				.getNoOutputId() != null && castOther.getNoOutputId() != null && this
				.getNoOutputId().equals(castOther.getNoOutputId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNoOutputId() == null ? 0 : this.getNoOutputId()
						.hashCode());
		result = 37 * result
