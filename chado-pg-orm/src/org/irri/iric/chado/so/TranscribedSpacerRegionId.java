...
/**
 * TranscribedSpacerRegionId generated by hbm2java
 */
public class TranscribedSpacerRegionId implements java.io.Serializable {

	private Integer transcribedSpacerRegionId;
	...
	public TranscribedSpacerRegionId() {
	}

	public TranscribedSpacerRegionId(Integer transcribedSpacerRegionId,
		...
		this.transcribedSpacerRegionId = transcribedSpacerRegionId;
	...
	public Integer getTranscribedSpacerRegionId() {
		return this.transcribedSpacerRegionId;
	}

	public void setTranscribedSpacerRegionId(Integer transcribedSpacerRegionId) {
		this.transcribedSpacerRegionId = transcribedSpacerRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscribedSpacerRegionId))
			return false;
		TranscribedSpacerRegionId castOther = (TranscribedSpacerRegionId) other;

		return ((this.getTranscribedSpacerRegionId() == castOther
				.getTranscribedSpacerRegionId()) || (this
				.getTranscribedSpacerRegionId() != null
				&& castOther.getTranscribedSpacerRegionId() != null && this
				.getTranscribedSpacerRegionId().equals(
						castOther.getTranscribedSpacerRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscribedSpacerRegionId() == null ? 0 : this
						.getTranscribedSpacerRegionId().hashCode());
		result = 37 * result
