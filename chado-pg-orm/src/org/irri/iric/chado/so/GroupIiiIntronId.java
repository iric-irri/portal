...
/**
 * GroupIiiIntronId generated by hbm2java
 */
public class GroupIiiIntronId implements java.io.Serializable {

	private Integer groupIiiIntronId;
	...
	public GroupIiiIntronId() {
	}

	public GroupIiiIntronId(Integer groupIiiIntronId, Integer featureId,
		...
		this.groupIiiIntronId = groupIiiIntronId;
	...
	public Integer getGroupIiiIntronId() {
		return this.groupIiiIntronId;
	}

	public void setGroupIiiIntronId(Integer groupIiiIntronId) {
		this.groupIiiIntronId = groupIiiIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIiiIntronId))
			return false;
		GroupIiiIntronId castOther = (GroupIiiIntronId) other;

		return ((this.getGroupIiiIntronId() == castOther.getGroupIiiIntronId()) || (this
				.getGroupIiiIntronId() != null
				&& castOther.getGroupIiiIntronId() != null && this
				.getGroupIiiIntronId().equals(castOther.getGroupIiiIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroupIiiIntronId() == null ? 0 : this
						.getGroupIiiIntronId().hashCode());
		result = 37 * result
