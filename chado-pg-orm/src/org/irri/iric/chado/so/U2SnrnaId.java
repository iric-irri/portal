...
/**
 * U2SnrnaId generated by hbm2java
 */
public class U2SnrnaId implements java.io.Serializable {

	private Integer u2SnrnaId;
	...
	public U2SnrnaId(Integer u2SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU2SnrnaId() {
		return this.u2SnrnaId;
	}

	public void setU2SnrnaId(Integer u2SnrnaId) {
		this.u2SnrnaId = u2SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U2SnrnaId))
			return false;
		U2SnrnaId castOther = (U2SnrnaId) other;

		return ((this.getU2SnrnaId() == castOther.getU2SnrnaId()) || (this
				.getU2SnrnaId() != null && castOther.getU2SnrnaId() != null && this
				.getU2SnrnaId().equals(castOther.getU2SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getU2SnrnaId() == null ? 0 : this.getU2SnrnaId().hashCode());
		result = 37 * result
