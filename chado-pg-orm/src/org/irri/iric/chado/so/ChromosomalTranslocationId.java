...
/**
 * ChromosomalTranslocationId generated by hbm2java
 */
public class ChromosomalTranslocationId implements java.io.Serializable {

	private Integer chromosomalTranslocationId;
	...
	public ChromosomalTranslocationId() {
	}

	public ChromosomalTranslocationId(Integer chromosomalTranslocationId,
		...
		this.chromosomalTranslocationId = chromosomalTranslocationId;
	...
	public Integer getChromosomalTranslocationId() {
		return this.chromosomalTranslocationId;
	}

	public void setChromosomalTranslocationId(Integer chromosomalTranslocationId) {
		this.chromosomalTranslocationId = chromosomalTranslocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalTranslocationId))
			return false;
		ChromosomalTranslocationId castOther = (ChromosomalTranslocationId) other;

		return ((this.getChromosomalTranslocationId() == castOther
				.getChromosomalTranslocationId()) || (this
				.getChromosomalTranslocationId() != null
				&& castOther.getChromosomalTranslocationId() != null && this
				.getChromosomalTranslocationId().equals(
						castOther.getChromosomalTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalTranslocationId() == null ? 0 : this
						.getChromosomalTranslocationId().hashCode());
		result = 37 * result
