...
/**
 * H2bUbiquitinationSiteId generated by hbm2java
 */
public class H2bUbiquitinationSiteId implements java.io.Serializable {

	private Integer h2bUbiquitinationSiteId;
	...
	public H2bUbiquitinationSiteId() {
	}

	public H2bUbiquitinationSiteId(Integer h2bUbiquitinationSiteId,
		...
		this.h2bUbiquitinationSiteId = h2bUbiquitinationSiteId;
	...
	public Integer getH2bUbiquitinationSiteId() {
		return this.h2bUbiquitinationSiteId;
	}

	public void setH2bUbiquitinationSiteId(Integer h2bUbiquitinationSiteId) {
		this.h2bUbiquitinationSiteId = h2bUbiquitinationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H2bUbiquitinationSiteId))
			return false;
		H2bUbiquitinationSiteId castOther = (H2bUbiquitinationSiteId) other;

		return ((this.getH2bUbiquitinationSiteId() == castOther
				.getH2bUbiquitinationSiteId()) || (this
				.getH2bUbiquitinationSiteId() != null
				&& castOther.getH2bUbiquitinationSiteId() != null && this
				.getH2bUbiquitinationSiteId().equals(
						castOther.getH2bUbiquitinationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH2bUbiquitinationSiteId() == null ? 0 : this
						.getH2bUbiquitinationSiteId().hashCode());
		result = 37 * result
