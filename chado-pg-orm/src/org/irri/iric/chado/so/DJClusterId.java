...
/**
 * DJClusterId generated by hbm2java
 */
public class DJClusterId implements java.io.Serializable {

	private Integer DJClusterId;
	...
	public DJClusterId(Integer DJClusterId, Integer featureId,
	...
	public Integer getDJClusterId() {
		return this.DJClusterId;
	}

	public void setDJClusterId(Integer DJClusterId) {
		this.DJClusterId = DJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DJClusterId))
			return false;
		DJClusterId castOther = (DJClusterId) other;

		return ((this.getDJClusterId() == castOther.getDJClusterId()) || (this
				.getDJClusterId() != null && castOther.getDJClusterId() != null && this
				.getDJClusterId().equals(castOther.getDJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDJClusterId() == null ? 0 : this.getDJClusterId()
						.hashCode());
		result = 37 * result
