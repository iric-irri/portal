...
/**
 * InterbandId generated by hbm2java
 */
public class InterbandId implements java.io.Serializable {

	private Integer interbandId;
	...
	public InterbandId(Integer interbandId, Integer featureId,
	...
	public Integer getInterbandId() {
		return this.interbandId;
	}

	public void setInterbandId(Integer interbandId) {
		this.interbandId = interbandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InterbandId))
			return false;
		InterbandId castOther = (InterbandId) other;

		return ((this.getInterbandId() == castOther.getInterbandId()) || (this
				.getInterbandId() != null && castOther.getInterbandId() != null && this
				.getInterbandId().equals(castOther.getInterbandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInterbandId() == null ? 0 : this.getInterbandId()
						.hashCode());
		result = 37 * result
