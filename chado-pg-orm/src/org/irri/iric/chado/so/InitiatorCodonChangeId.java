...
/**
 * InitiatorCodonChangeId generated by hbm2java
 */
public class InitiatorCodonChangeId implements java.io.Serializable {

	private Integer initiatorCodonChangeId;
	...
	public InitiatorCodonChangeId() {
	}

	public InitiatorCodonChangeId(Integer initiatorCodonChangeId,
		...
		this.initiatorCodonChangeId = initiatorCodonChangeId;
	...
	public Integer getInitiatorCodonChangeId() {
		return this.initiatorCodonChangeId;
	}

	public void setInitiatorCodonChangeId(Integer initiatorCodonChangeId) {
		this.initiatorCodonChangeId = initiatorCodonChangeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InitiatorCodonChangeId))
			return false;
		InitiatorCodonChangeId castOther = (InitiatorCodonChangeId) other;

		return ((this.getInitiatorCodonChangeId() == castOther
				.getInitiatorCodonChangeId()) || (this
				.getInitiatorCodonChangeId() != null
				&& castOther.getInitiatorCodonChangeId() != null && this
				.getInitiatorCodonChangeId().equals(
						castOther.getInitiatorCodonChangeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInitiatorCodonChangeId() == null ? 0 : this
						.getInitiatorCodonChangeId().hashCode());
		result = 37 * result
