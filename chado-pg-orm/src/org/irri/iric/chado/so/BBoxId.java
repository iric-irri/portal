...
/**
 * BBoxId generated by hbm2java
 */
public class BBoxId implements java.io.Serializable {
	...
	public BBoxId(Integer BBoxId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BBoxId))
			return false;
		BBoxId castOther = (BBoxId) other;

		return ((this.getBBoxId() == castOther.getBBoxId()) || (this
				.getBBoxId() != null && castOther.getBBoxId() != null && this
				.getBBoxId().equals(castOther.getBBoxId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getBBoxId() == null ? 0 : this.getBBoxId().hashCode());
		result = 37 * result
