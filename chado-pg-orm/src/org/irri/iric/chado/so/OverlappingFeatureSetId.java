...
/**
 * OverlappingFeatureSetId generated by hbm2java
 */
public class OverlappingFeatureSetId implements java.io.Serializable {

	private Integer overlappingFeatureSetId;
	...
	public OverlappingFeatureSetId() {
	}

	public OverlappingFeatureSetId(Integer overlappingFeatureSetId,
		...
		this.overlappingFeatureSetId = overlappingFeatureSetId;
	...
	public Integer getOverlappingFeatureSetId() {
		return this.overlappingFeatureSetId;
	}

	public void setOverlappingFeatureSetId(Integer overlappingFeatureSetId) {
		this.overlappingFeatureSetId = overlappingFeatureSetId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OverlappingFeatureSetId))
			return false;
		OverlappingFeatureSetId castOther = (OverlappingFeatureSetId) other;

		return ((this.getOverlappingFeatureSetId() == castOther
				.getOverlappingFeatureSetId()) || (this
				.getOverlappingFeatureSetId() != null
				&& castOther.getOverlappingFeatureSetId() != null && this
				.getOverlappingFeatureSetId().equals(
						castOther.getOverlappingFeatureSetId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOverlappingFeatureSetId() == null ? 0 : this
						.getOverlappingFeatureSetId().hashCode());
		result = 37 * result
