...
/**
 * LeucoplastSequenceId generated by hbm2java
 */
public class LeucoplastSequenceId implements java.io.Serializable {

	private Integer leucoplastSequenceId;
	...
	public LeucoplastSequenceId() {
	}

	public LeucoplastSequenceId(Integer leucoplastSequenceId,
		...
		this.leucoplastSequenceId = leucoplastSequenceId;
	...
	public Integer getLeucoplastSequenceId() {
		return this.leucoplastSequenceId;
	}

	public void setLeucoplastSequenceId(Integer leucoplastSequenceId) {
		this.leucoplastSequenceId = leucoplastSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucoplastSequenceId))
			return false;
		LeucoplastSequenceId castOther = (LeucoplastSequenceId) other;

		return ((this.getLeucoplastSequenceId() == castOther
				.getLeucoplastSequenceId()) || (this.getLeucoplastSequenceId() != null
				&& castOther.getLeucoplastSequenceId() != null && this
				.getLeucoplastSequenceId().equals(
						castOther.getLeucoplastSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeucoplastSequenceId() == null ? 0 : this
						.getLeucoplastSequenceId().hashCode());
		result = 37 * result
