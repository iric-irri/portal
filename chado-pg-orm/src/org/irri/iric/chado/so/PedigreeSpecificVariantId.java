...
/**
 * PedigreeSpecificVariantId generated by hbm2java
 */
public class PedigreeSpecificVariantId implements java.io.Serializable {

	private Integer pedigreeSpecificVariantId;
	...
	public PedigreeSpecificVariantId() {
	}

	public PedigreeSpecificVariantId(Integer pedigreeSpecificVariantId,
		...
		this.pedigreeSpecificVariantId = pedigreeSpecificVariantId;
	...
	public Integer getPedigreeSpecificVariantId() {
		return this.pedigreeSpecificVariantId;
	}

	public void setPedigreeSpecificVariantId(Integer pedigreeSpecificVariantId) {
		this.pedigreeSpecificVariantId = pedigreeSpecificVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PedigreeSpecificVariantId))
			return false;
		PedigreeSpecificVariantId castOther = (PedigreeSpecificVariantId) other;

		return ((this.getPedigreeSpecificVariantId() == castOther
				.getPedigreeSpecificVariantId()) || (this
				.getPedigreeSpecificVariantId() != null
				&& castOther.getPedigreeSpecificVariantId() != null && this
				.getPedigreeSpecificVariantId().equals(
						castOther.getPedigreeSpecificVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPedigreeSpecificVariantId() == null ? 0 : this
						.getPedigreeSpecificVariantId().hashCode());
		result = 37 * result
