...
/**
 * TranscriptionRegulatoryRegionId generated by hbm2java
 */
public class TranscriptionRegulatoryRegionId implements java.io.Serializable {

	private Integer transcriptionRegulatoryRegionId;
	...
	public TranscriptionRegulatoryRegionId() {
	}

	public TranscriptionRegulatoryRegionId(
			Integer transcriptionRegulatoryRegionId, Integer featureId,
		...
		this.transcriptionRegulatoryRegionId = transcriptionRegulatoryRegionId;
	...
	public Integer getTranscriptionRegulatoryRegionId() {
		return this.transcriptionRegulatoryRegionId;
	}

	public void setTranscriptionRegulatoryRegionId(
			Integer transcriptionRegulatoryRegionId) {
		this.transcriptionRegulatoryRegionId = transcriptionRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionRegulatoryRegionId))
			return false;
		TranscriptionRegulatoryRegionId castOther = (TranscriptionRegulatoryRegionId) other;

		return ((this.getTranscriptionRegulatoryRegionId() == castOther
				.getTranscriptionRegulatoryRegionId()) || (this
				.getTranscriptionRegulatoryRegionId() != null
				&& castOther.getTranscriptionRegulatoryRegionId() != null && this
				.getTranscriptionRegulatoryRegionId().equals(
						castOther.getTranscriptionRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionRegulatoryRegionId() == null ? 0 : this
						.getTranscriptionRegulatoryRegionId().hashCode());
		result = 37 * result
