...
/**
 * OverlappingId generated by hbm2java
 */
public class OverlappingId implements java.io.Serializable {

	private Integer overlappingId;
	...
	public OverlappingId() {
	}

	public OverlappingId(Integer overlappingId, Integer featureId,
		...
		this.overlappingId = overlappingId;
	...
	public Integer getOverlappingId() {
		return this.overlappingId;
	}

	public void setOverlappingId(Integer overlappingId) {
		this.overlappingId = overlappingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OverlappingId))
			return false;
		OverlappingId castOther = (OverlappingId) other;

		return ((this.getOverlappingId() == castOther.getOverlappingId()) || (this
				.getOverlappingId() != null
				&& castOther.getOverlappingId() != null && this
				.getOverlappingId().equals(castOther.getOverlappingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOverlappingId() == null ? 0 : this.getOverlappingId()
						.hashCode());
		result = 37 * result
