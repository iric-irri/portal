...
/**
 * ConsensusId generated by hbm2java
 */
public class ConsensusId implements java.io.Serializable {
	...
	public ConsensusId(Integer consensusId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConsensusId))
			return false;
		ConsensusId castOther = (ConsensusId) other;

		return ((this.getConsensusId() == castOther.getConsensusId()) || (this
				.getConsensusId() != null && castOther.getConsensusId() != null && this
				.getConsensusId().equals(castOther.getConsensusId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConsensusId() == null ? 0 : this.getConsensusId()
						.hashCode());
		result = 37 * result
