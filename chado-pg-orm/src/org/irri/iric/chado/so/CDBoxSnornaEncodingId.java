...
/**
 * CDBoxSnornaEncodingId generated by hbm2java
 */
public class CDBoxSnornaEncodingId implements java.io.Serializable {

	private Integer CDBoxSnornaEncodingId;
	...
	public CDBoxSnornaEncodingId() {
	}

	public CDBoxSnornaEncodingId(Integer CDBoxSnornaEncodingId,
		...
		this.CDBoxSnornaEncodingId = CDBoxSnornaEncodingId;
	...
	public Integer getCDBoxSnornaEncodingId() {
		return this.CDBoxSnornaEncodingId;
	}

	public void setCDBoxSnornaEncodingId(Integer CDBoxSnornaEncodingId) {
		this.CDBoxSnornaEncodingId = CDBoxSnornaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CDBoxSnornaEncodingId))
			return false;
		CDBoxSnornaEncodingId castOther = (CDBoxSnornaEncodingId) other;

		return ((this.getCDBoxSnornaEncodingId() == castOther
				.getCDBoxSnornaEncodingId()) || (this
				.getCDBoxSnornaEncodingId() != null
				&& castOther.getCDBoxSnornaEncodingId() != null && this
				.getCDBoxSnornaEncodingId().equals(
						castOther.getCDBoxSnornaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCDBoxSnornaEncodingId() == null ? 0 : this
						.getCDBoxSnornaEncodingId().hashCode());
		result = 37 * result
