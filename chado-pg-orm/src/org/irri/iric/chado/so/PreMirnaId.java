...
/**
 * PreMirnaId generated by hbm2java
 */
public class PreMirnaId implements java.io.Serializable {

	private Integer preMirnaId;
	...
	public PreMirnaId(Integer preMirnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPreMirnaId() {
		return this.preMirnaId;
	}

	public void setPreMirnaId(Integer preMirnaId) {
		this.preMirnaId = preMirnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreMirnaId))
			return false;
		PreMirnaId castOther = (PreMirnaId) other;

		return ((this.getPreMirnaId() == castOther.getPreMirnaId()) || (this
				.getPreMirnaId() != null && castOther.getPreMirnaId() != null && this
				.getPreMirnaId().equals(castOther.getPreMirnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPreMirnaId() == null ? 0 : this.getPreMirnaId()
						.hashCode());
		result = 37 * result
