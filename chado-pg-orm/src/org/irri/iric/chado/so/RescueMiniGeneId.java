...
/**
 * RescueMiniGeneId generated by hbm2java
 */
public class RescueMiniGeneId implements java.io.Serializable {

	private Integer rescueMiniGeneId;
	...
	public RescueMiniGeneId() {
	}

	public RescueMiniGeneId(Integer rescueMiniGeneId, Integer featureId,
		...
		this.rescueMiniGeneId = rescueMiniGeneId;
	...
	public Integer getRescueMiniGeneId() {
		return this.rescueMiniGeneId;
	}

	public void setRescueMiniGeneId(Integer rescueMiniGeneId) {
		this.rescueMiniGeneId = rescueMiniGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RescueMiniGeneId))
			return false;
		RescueMiniGeneId castOther = (RescueMiniGeneId) other;

		return ((this.getRescueMiniGeneId() == castOther.getRescueMiniGeneId()) || (this
				.getRescueMiniGeneId() != null
				&& castOther.getRescueMiniGeneId() != null && this
				.getRescueMiniGeneId().equals(castOther.getRescueMiniGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRescueMiniGeneId() == null ? 0 : this
						.getRescueMiniGeneId().hashCode());
		result = 37 * result
