...
/**
 * CDBoxSnornaId generated by hbm2java
 */
public class CDBoxSnornaId implements java.io.Serializable {

	private Integer CDBoxSnornaId;
	...
	public CDBoxSnornaId() {
	}

	public CDBoxSnornaId(Integer CDBoxSnornaId, Integer featureId,
		...
		this.CDBoxSnornaId = CDBoxSnornaId;
	...
	public Integer getCDBoxSnornaId() {
		return this.CDBoxSnornaId;
	}

	public void setCDBoxSnornaId(Integer CDBoxSnornaId) {
		this.CDBoxSnornaId = CDBoxSnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CDBoxSnornaId))
			return false;
		CDBoxSnornaId castOther = (CDBoxSnornaId) other;

		return ((this.getCDBoxSnornaId() == castOther.getCDBoxSnornaId()) || (this
				.getCDBoxSnornaId() != null
				&& castOther.getCDBoxSnornaId() != null && this
				.getCDBoxSnornaId().equals(castOther.getCDBoxSnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCDBoxSnornaId() == null ? 0 : this.getCDBoxSnornaId()
						.hashCode());
		result = 37 * result
