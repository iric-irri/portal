...
/**
 * StandardDraftId generated by hbm2java
 */
public class StandardDraftId implements java.io.Serializable {

	private Integer standardDraftId;
	...
	public StandardDraftId() {
	}

	public StandardDraftId(Integer standardDraftId, Integer featureId,
		...
		this.standardDraftId = standardDraftId;
	...
	public Integer getStandardDraftId() {
		return this.standardDraftId;
	}

	public void setStandardDraftId(Integer standardDraftId) {
		this.standardDraftId = standardDraftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StandardDraftId))
			return false;
		StandardDraftId castOther = (StandardDraftId) other;

		return ((this.getStandardDraftId() == castOther.getStandardDraftId()) || (this
				.getStandardDraftId() != null
				&& castOther.getStandardDraftId() != null && this
				.getStandardDraftId().equals(castOther.getStandardDraftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStandardDraftId() == null ? 0 : this.getStandardDraftId()
						.hashCode());
		result = 37 * result
