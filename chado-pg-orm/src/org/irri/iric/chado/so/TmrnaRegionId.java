...
/**
 * TmrnaRegionId generated by hbm2java
 */
public class TmrnaRegionId implements java.io.Serializable {

	private Integer tmrnaRegionId;
	...
	public TmrnaRegionId() {
	}

	public TmrnaRegionId(Integer tmrnaRegionId, Integer featureId,
		...
		this.tmrnaRegionId = tmrnaRegionId;
	...
	public Integer getTmrnaRegionId() {
		return this.tmrnaRegionId;
	}

	public void setTmrnaRegionId(Integer tmrnaRegionId) {
		this.tmrnaRegionId = tmrnaRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaRegionId))
			return false;
		TmrnaRegionId castOther = (TmrnaRegionId) other;

		return ((this.getTmrnaRegionId() == castOther.getTmrnaRegionId()) || (this
				.getTmrnaRegionId() != null
				&& castOther.getTmrnaRegionId() != null && this
				.getTmrnaRegionId().equals(castOther.getTmrnaRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaRegionId() == null ? 0 : this.getTmrnaRegionId()
						.hashCode());
		result = 37 * result
