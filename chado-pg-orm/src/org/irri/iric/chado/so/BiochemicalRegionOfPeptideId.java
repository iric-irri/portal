...
/**
 * BiochemicalRegionOfPeptideId generated by hbm2java
 */
public class BiochemicalRegionOfPeptideId implements java.io.Serializable {

	private Integer biochemicalRegionOfPeptideId;
	...
	public BiochemicalRegionOfPeptideId() {
	}

	public BiochemicalRegionOfPeptideId(Integer biochemicalRegionOfPeptideId,
		...
		this.biochemicalRegionOfPeptideId = biochemicalRegionOfPeptideId;
	...
	public Integer getBiochemicalRegionOfPeptideId() {
		return this.biochemicalRegionOfPeptideId;
	}

	public void setBiochemicalRegionOfPeptideId(
			Integer biochemicalRegionOfPeptideId) {
		this.biochemicalRegionOfPeptideId = biochemicalRegionOfPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BiochemicalRegionOfPeptideId))
			return false;
		BiochemicalRegionOfPeptideId castOther = (BiochemicalRegionOfPeptideId) other;

		return ((this.getBiochemicalRegionOfPeptideId() == castOther
				.getBiochemicalRegionOfPeptideId()) || (this
				.getBiochemicalRegionOfPeptideId() != null
				&& castOther.getBiochemicalRegionOfPeptideId() != null && this
				.getBiochemicalRegionOfPeptideId().equals(
						castOther.getBiochemicalRegionOfPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBiochemicalRegionOfPeptideId() == null ? 0 : this
						.getBiochemicalRegionOfPeptideId().hashCode());
		result = 37 * result
