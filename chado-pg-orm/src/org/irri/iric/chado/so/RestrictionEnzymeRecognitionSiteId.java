...
/**
 * RestrictionEnzymeRecognitionSiteId generated by hbm2java
 */
public class RestrictionEnzymeRecognitionSiteId implements java.io.Serializable {

	private Integer restrictionEnzymeRecognitionSiteId;
	...
	public RestrictionEnzymeRecognitionSiteId() {
	}

	public RestrictionEnzymeRecognitionSiteId(
			Integer restrictionEnzymeRecognitionSiteId, Integer featureId,
		...
		this.restrictionEnzymeRecognitionSiteId = restrictionEnzymeRecognitionSiteId;
	...
	public Integer getRestrictionEnzymeRecognitionSiteId() {
		return this.restrictionEnzymeRecognitionSiteId;
	}

	public void setRestrictionEnzymeRecognitionSiteId(
			Integer restrictionEnzymeRecognitionSiteId) {
		this.restrictionEnzymeRecognitionSiteId = restrictionEnzymeRecognitionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RestrictionEnzymeRecognitionSiteId))
			return false;
		RestrictionEnzymeRecognitionSiteId castOther = (RestrictionEnzymeRecognitionSiteId) other;

		return ((this.getRestrictionEnzymeRecognitionSiteId() == castOther
				.getRestrictionEnzymeRecognitionSiteId()) || (this
				.getRestrictionEnzymeRecognitionSiteId() != null
				&& castOther.getRestrictionEnzymeRecognitionSiteId() != null && this
				.getRestrictionEnzymeRecognitionSiteId().equals(
						castOther.getRestrictionEnzymeRecognitionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRestrictionEnzymeRecognitionSiteId() == null ? 0 : this
						.getRestrictionEnzymeRecognitionSiteId().hashCode());
		result = 37 * result
