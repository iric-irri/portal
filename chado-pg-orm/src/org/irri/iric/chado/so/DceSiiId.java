...
/**
 * DceSiiId generated by hbm2java
 */
public class DceSiiId implements java.io.Serializable {

	private Integer dceSiiId;
	...
	public DceSiiId(Integer dceSiiId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDceSiiId() {
		return this.dceSiiId;
	}

	public void setDceSiiId(Integer dceSiiId) {
		this.dceSiiId = dceSiiId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DceSiiId))
			return false;
		DceSiiId castOther = (DceSiiId) other;

		return ((this.getDceSiiId() == castOther.getDceSiiId()) || (this
				.getDceSiiId() != null && castOther.getDceSiiId() != null && this
				.getDceSiiId().equals(castOther.getDceSiiId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDceSiiId() == null ? 0 : this.getDceSiiId().hashCode());
		result = 37 * result
