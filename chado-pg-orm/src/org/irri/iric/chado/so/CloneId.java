...
/**
 * CloneId generated by hbm2java
 */
public class CloneId implements java.io.Serializable {
	...
	public CloneId(Integer cloneId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CloneId))
			return false;
		CloneId castOther = (CloneId) other;

		return ((this.getCloneId() == castOther.getCloneId()) || (this
				.getCloneId() != null && castOther.getCloneId() != null && this
				.getCloneId().equals(castOther.getCloneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCloneId() == null ? 0 : this.getCloneId().hashCode());
		result = 37 * result
