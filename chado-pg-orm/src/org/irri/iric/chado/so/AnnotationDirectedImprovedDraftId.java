...
/**
 * AnnotationDirectedImprovedDraftId generated by hbm2java
 */
public class AnnotationDirectedImprovedDraftId implements java.io.Serializable {

	private Integer annotationDirectedImprovedDraftId;
	...
	public AnnotationDirectedImprovedDraftId() {
	}

	public AnnotationDirectedImprovedDraftId(
			Integer annotationDirectedImprovedDraftId, Integer featureId,
		...
		this.annotationDirectedImprovedDraftId = annotationDirectedImprovedDraftId;
	...
	public Integer getAnnotationDirectedImprovedDraftId() {
		return this.annotationDirectedImprovedDraftId;
	}

	public void setAnnotationDirectedImprovedDraftId(
			Integer annotationDirectedImprovedDraftId) {
		this.annotationDirectedImprovedDraftId = annotationDirectedImprovedDraftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnnotationDirectedImprovedDraftId))
			return false;
		AnnotationDirectedImprovedDraftId castOther = (AnnotationDirectedImprovedDraftId) other;

		return ((this.getAnnotationDirectedImprovedDraftId() == castOther
				.getAnnotationDirectedImprovedDraftId()) || (this
				.getAnnotationDirectedImprovedDraftId() != null
				&& castOther.getAnnotationDirectedImprovedDraftId() != null && this
				.getAnnotationDirectedImprovedDraftId().equals(
						castOther.getAnnotationDirectedImprovedDraftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAnnotationDirectedImprovedDraftId() == null ? 0 : this
						.getAnnotationDirectedImprovedDraftId().hashCode());
		result = 37 * result
