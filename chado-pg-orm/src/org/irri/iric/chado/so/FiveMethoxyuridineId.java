...
/**
 * FiveMethoxyuridineId generated by hbm2java
 */
public class FiveMethoxyuridineId implements java.io.Serializable {

	private Integer fiveMethoxyuridineId;
	...
	public FiveMethoxyuridineId() {
	}

	public FiveMethoxyuridineId(Integer fiveMethoxyuridineId,
		...
		this.fiveMethoxyuridineId = fiveMethoxyuridineId;
	...
	public Integer getFiveMethoxyuridineId() {
		return this.fiveMethoxyuridineId;
	}

	public void setFiveMethoxyuridineId(Integer fiveMethoxyuridineId) {
		this.fiveMethoxyuridineId = fiveMethoxyuridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethoxyuridineId))
			return false;
		FiveMethoxyuridineId castOther = (FiveMethoxyuridineId) other;

		return ((this.getFiveMethoxyuridineId() == castOther
				.getFiveMethoxyuridineId()) || (this.getFiveMethoxyuridineId() != null
				&& castOther.getFiveMethoxyuridineId() != null && this
				.getFiveMethoxyuridineId().equals(
						castOther.getFiveMethoxyuridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethoxyuridineId() == null ? 0 : this
						.getFiveMethoxyuridineId().hashCode());
		result = 37 * result
