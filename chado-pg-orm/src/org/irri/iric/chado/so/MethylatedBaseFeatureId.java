...
/**
 * MethylatedBaseFeatureId generated by hbm2java
 */
public class MethylatedBaseFeatureId implements java.io.Serializable {

	private Integer methylatedBaseFeatureId;
	...
	public MethylatedBaseFeatureId() {
	}

	public MethylatedBaseFeatureId(Integer methylatedBaseFeatureId,
		...
		this.methylatedBaseFeatureId = methylatedBaseFeatureId;
	...
	public Integer getMethylatedBaseFeatureId() {
		return this.methylatedBaseFeatureId;
	}

	public void setMethylatedBaseFeatureId(Integer methylatedBaseFeatureId) {
		this.methylatedBaseFeatureId = methylatedBaseFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylatedBaseFeatureId))
			return false;
		MethylatedBaseFeatureId castOther = (MethylatedBaseFeatureId) other;

		return ((this.getMethylatedBaseFeatureId() == castOther
				.getMethylatedBaseFeatureId()) || (this
				.getMethylatedBaseFeatureId() != null
				&& castOther.getMethylatedBaseFeatureId() != null && this
				.getMethylatedBaseFeatureId().equals(
						castOther.getMethylatedBaseFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylatedBaseFeatureId() == null ? 0 : this
						.getMethylatedBaseFeatureId().hashCode());
		result = 37 * result
