...
/**
 * CodingSequenceVariantId generated by hbm2java
 */
public class CodingSequenceVariantId implements java.io.Serializable {

	private Integer codingSequenceVariantId;
	...
	public CodingSequenceVariantId() {
	}

	public CodingSequenceVariantId(Integer codingSequenceVariantId,
		...
		this.codingSequenceVariantId = codingSequenceVariantId;
	...
	public Integer getCodingSequenceVariantId() {
		return this.codingSequenceVariantId;
	}

	public void setCodingSequenceVariantId(Integer codingSequenceVariantId) {
		this.codingSequenceVariantId = codingSequenceVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingSequenceVariantId))
			return false;
		CodingSequenceVariantId castOther = (CodingSequenceVariantId) other;

		return ((this.getCodingSequenceVariantId() == castOther
				.getCodingSequenceVariantId()) || (this
				.getCodingSequenceVariantId() != null
				&& castOther.getCodingSequenceVariantId() != null && this
				.getCodingSequenceVariantId().equals(
						castOther.getCodingSequenceVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingSequenceVariantId() == null ? 0 : this
						.getCodingSequenceVariantId().hashCode());
		result = 37 * result
