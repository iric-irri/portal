...
/**
 * UninvertInsertDupId generated by hbm2java
 */
public class UninvertInsertDupId implements java.io.Serializable {

	private Integer uninvertInsertDupId;
	...
	public UninvertInsertDupId() {
	}

	public UninvertInsertDupId(Integer uninvertInsertDupId, Integer featureId,
		...
		this.uninvertInsertDupId = uninvertInsertDupId;
	...
	public Integer getUninvertInsertDupId() {
		return this.uninvertInsertDupId;
	}

	public void setUninvertInsertDupId(Integer uninvertInsertDupId) {
		this.uninvertInsertDupId = uninvertInsertDupId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UninvertInsertDupId))
			return false;
		UninvertInsertDupId castOther = (UninvertInsertDupId) other;

		return ((this.getUninvertInsertDupId() == castOther
				.getUninvertInsertDupId()) || (this.getUninvertInsertDupId() != null
				&& castOther.getUninvertInsertDupId() != null && this
				.getUninvertInsertDupId().equals(
						castOther.getUninvertInsertDupId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUninvertInsertDupId() == null ? 0 : this
						.getUninvertInsertDupId().hashCode());
		result = 37 * result
