...
/**
 * BacterialRnapolPromoterId generated by hbm2java
 */
public class BacterialRnapolPromoterId implements java.io.Serializable {

	private Integer bacterialRnapolPromoterId;
	...
	public BacterialRnapolPromoterId() {
	}

	public BacterialRnapolPromoterId(Integer bacterialRnapolPromoterId,
		...
		this.bacterialRnapolPromoterId = bacterialRnapolPromoterId;
	...
	public Integer getBacterialRnapolPromoterId() {
		return this.bacterialRnapolPromoterId;
	}

	public void setBacterialRnapolPromoterId(Integer bacterialRnapolPromoterId) {
		this.bacterialRnapolPromoterId = bacterialRnapolPromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BacterialRnapolPromoterId))
			return false;
		BacterialRnapolPromoterId castOther = (BacterialRnapolPromoterId) other;

		return ((this.getBacterialRnapolPromoterId() == castOther
				.getBacterialRnapolPromoterId()) || (this
				.getBacterialRnapolPromoterId() != null
				&& castOther.getBacterialRnapolPromoterId() != null && this
				.getBacterialRnapolPromoterId().equals(
						castOther.getBacterialRnapolPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBacterialRnapolPromoterId() == null ? 0 : this
						.getBacterialRnapolPromoterId().hashCode());
		result = 37 * result
