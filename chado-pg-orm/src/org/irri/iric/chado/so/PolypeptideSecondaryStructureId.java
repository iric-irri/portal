...
/**
 * PolypeptideSecondaryStructureId generated by hbm2java
 */
public class PolypeptideSecondaryStructureId implements java.io.Serializable {

	private Integer polypeptideSecondaryStructureId;
	...
	public PolypeptideSecondaryStructureId() {
	}

	public PolypeptideSecondaryStructureId(
			Integer polypeptideSecondaryStructureId, Integer featureId,
		...
		this.polypeptideSecondaryStructureId = polypeptideSecondaryStructureId;
	...
	public Integer getPolypeptideSecondaryStructureId() {
		return this.polypeptideSecondaryStructureId;
	}

	public void setPolypeptideSecondaryStructureId(
			Integer polypeptideSecondaryStructureId) {
		this.polypeptideSecondaryStructureId = polypeptideSecondaryStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideSecondaryStructureId))
			return false;
		PolypeptideSecondaryStructureId castOther = (PolypeptideSecondaryStructureId) other;

		return ((this.getPolypeptideSecondaryStructureId() == castOther
				.getPolypeptideSecondaryStructureId()) || (this
				.getPolypeptideSecondaryStructureId() != null
				&& castOther.getPolypeptideSecondaryStructureId() != null && this
				.getPolypeptideSecondaryStructureId().equals(
						castOther.getPolypeptideSecondaryStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideSecondaryStructureId() == null ? 0 : this
						.getPolypeptideSecondaryStructureId().hashCode());
		result = 37 * result
