...
/**
 * RateOfTranscriptionVariantId generated by hbm2java
 */
public class RateOfTranscriptionVariantId implements java.io.Serializable {

	private Integer rateOfTranscriptionVariantId;
	...
	public RateOfTranscriptionVariantId() {
	}

	public RateOfTranscriptionVariantId(Integer rateOfTranscriptionVariantId,
		...
		this.rateOfTranscriptionVariantId = rateOfTranscriptionVariantId;
	...
	public Integer getRateOfTranscriptionVariantId() {
		return this.rateOfTranscriptionVariantId;
	}

	public void setRateOfTranscriptionVariantId(
			Integer rateOfTranscriptionVariantId) {
		this.rateOfTranscriptionVariantId = rateOfTranscriptionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RateOfTranscriptionVariantId))
			return false;
		RateOfTranscriptionVariantId castOther = (RateOfTranscriptionVariantId) other;

		return ((this.getRateOfTranscriptionVariantId() == castOther
				.getRateOfTranscriptionVariantId()) || (this
				.getRateOfTranscriptionVariantId() != null
				&& castOther.getRateOfTranscriptionVariantId() != null && this
				.getRateOfTranscriptionVariantId().equals(
						castOther.getRateOfTranscriptionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRateOfTranscriptionVariantId() == null ? 0 : this
						.getRateOfTranscriptionVariantId().hashCode());
		result = 37 * result
