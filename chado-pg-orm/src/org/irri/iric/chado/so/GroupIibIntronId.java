...
/**
 * GroupIibIntronId generated by hbm2java
 */
public class GroupIibIntronId implements java.io.Serializable {

	private Integer groupIibIntronId;
	...
	public GroupIibIntronId() {
	}

	public GroupIibIntronId(Integer groupIibIntronId, Integer featureId,
		...
		this.groupIibIntronId = groupIibIntronId;
	...
	public Integer getGroupIibIntronId() {
		return this.groupIibIntronId;
	}

	public void setGroupIibIntronId(Integer groupIibIntronId) {
		this.groupIibIntronId = groupIibIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIibIntronId))
			return false;
		GroupIibIntronId castOther = (GroupIibIntronId) other;

		return ((this.getGroupIibIntronId() == castOther.getGroupIibIntronId()) || (this
				.getGroupIibIntronId() != null
				&& castOther.getGroupIibIntronId() != null && this
				.getGroupIibIntronId().equals(castOther.getGroupIibIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroupIibIntronId() == null ? 0 : this
						.getGroupIibIntronId().hashCode());
		result = 37 * result
