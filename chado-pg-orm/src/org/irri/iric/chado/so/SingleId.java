...
/**
 * SingleId generated by hbm2java
 */
public class SingleId implements java.io.Serializable {
	...
	public SingleId(Integer singleId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SingleId))
			return false;
		SingleId castOther = (SingleId) other;

		return ((this.getSingleId() == castOther.getSingleId()) || (this
				.getSingleId() != null && castOther.getSingleId() != null && this
				.getSingleId().equals(castOther.getSingleId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSingleId() == null ? 0 : this.getSingleId().hashCode());
		result = 37 * result
