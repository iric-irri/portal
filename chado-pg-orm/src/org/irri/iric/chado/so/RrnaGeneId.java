...
/**
 * RrnaGeneId generated by hbm2java
 */
public class RrnaGeneId implements java.io.Serializable {

	private Integer rrnaGeneId;
	...
	public RrnaGeneId(Integer rrnaGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrnaGeneId() {
		return this.rrnaGeneId;
	}

	public void setRrnaGeneId(Integer rrnaGeneId) {
		this.rrnaGeneId = rrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaGeneId))
			return false;
		RrnaGeneId castOther = (RrnaGeneId) other;

		return ((this.getRrnaGeneId() == castOther.getRrnaGeneId()) || (this
				.getRrnaGeneId() != null && castOther.getRrnaGeneId() != null && this
				.getRrnaGeneId().equals(castOther.getRrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaGeneId() == null ? 0 : this.getRrnaGeneId()
						.hashCode());
		result = 37 * result
