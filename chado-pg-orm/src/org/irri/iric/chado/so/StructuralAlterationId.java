...
/**
 * StructuralAlterationId generated by hbm2java
 */
public class StructuralAlterationId implements java.io.Serializable {

	private Integer structuralAlterationId;
	...
	public StructuralAlterationId() {
	}

	public StructuralAlterationId(Integer structuralAlterationId,
		...
		this.structuralAlterationId = structuralAlterationId;
	...
	public Integer getStructuralAlterationId() {
		return this.structuralAlterationId;
	}

	public void setStructuralAlterationId(Integer structuralAlterationId) {
		this.structuralAlterationId = structuralAlterationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StructuralAlterationId))
			return false;
		StructuralAlterationId castOther = (StructuralAlterationId) other;

		return ((this.getStructuralAlterationId() == castOther
				.getStructuralAlterationId()) || (this
				.getStructuralAlterationId() != null
				&& castOther.getStructuralAlterationId() != null && this
				.getStructuralAlterationId().equals(
						castOther.getStructuralAlterationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStructuralAlterationId() == null ? 0 : this
						.getStructuralAlterationId().hashCode());
		result = 37 * result
