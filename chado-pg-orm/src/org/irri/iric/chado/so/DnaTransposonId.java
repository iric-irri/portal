...
/**
 * DnaTransposonId generated by hbm2java
 */
public class DnaTransposonId implements java.io.Serializable {

	private Integer dnaTransposonId;
	...
	public DnaTransposonId() {
	}

	public DnaTransposonId(Integer dnaTransposonId, Integer featureId,
		...
		this.dnaTransposonId = dnaTransposonId;
	...
	public Integer getDnaTransposonId() {
		return this.dnaTransposonId;
	}

	public void setDnaTransposonId(Integer dnaTransposonId) {
		this.dnaTransposonId = dnaTransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaTransposonId))
			return false;
		DnaTransposonId castOther = (DnaTransposonId) other;

		return ((this.getDnaTransposonId() == castOther.getDnaTransposonId()) || (this
				.getDnaTransposonId() != null
				&& castOther.getDnaTransposonId() != null && this
				.getDnaTransposonId().equals(castOther.getDnaTransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaTransposonId() == null ? 0 : this.getDnaTransposonId()
						.hashCode());
		result = 37 * result
