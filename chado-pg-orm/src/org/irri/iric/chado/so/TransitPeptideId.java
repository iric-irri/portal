...
/**
 * TransitPeptideId generated by hbm2java
 */
public class TransitPeptideId implements java.io.Serializable {

	private Integer transitPeptideId;
	...
	public TransitPeptideId() {
	}

	public TransitPeptideId(Integer transitPeptideId, Integer featureId,
		...
		this.transitPeptideId = transitPeptideId;
	...
	public Integer getTransitPeptideId() {
		return this.transitPeptideId;
	}

	public void setTransitPeptideId(Integer transitPeptideId) {
		this.transitPeptideId = transitPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransitPeptideId))
			return false;
		TransitPeptideId castOther = (TransitPeptideId) other;

		return ((this.getTransitPeptideId() == castOther.getTransitPeptideId()) || (this
				.getTransitPeptideId() != null
				&& castOther.getTransitPeptideId() != null && this
				.getTransitPeptideId().equals(castOther.getTransitPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransitPeptideId() == null ? 0 : this
						.getTransitPeptideId().hashCode());
		result = 37 * result
