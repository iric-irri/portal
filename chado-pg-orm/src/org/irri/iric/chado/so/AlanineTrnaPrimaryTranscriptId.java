...
/**
 * AlanineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class AlanineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer alanineTrnaPrimaryTranscriptId;
	...
	public AlanineTrnaPrimaryTranscriptId() {
	}

	public AlanineTrnaPrimaryTranscriptId(
			Integer alanineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.alanineTrnaPrimaryTranscriptId = alanineTrnaPrimaryTranscriptId;
	...
	public Integer getAlanineTrnaPrimaryTranscriptId() {
		return this.alanineTrnaPrimaryTranscriptId;
	}

	public void setAlanineTrnaPrimaryTranscriptId(
			Integer alanineTrnaPrimaryTranscriptId) {
		this.alanineTrnaPrimaryTranscriptId = alanineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlanineTrnaPrimaryTranscriptId))
			return false;
		AlanineTrnaPrimaryTranscriptId castOther = (AlanineTrnaPrimaryTranscriptId) other;

		return ((this.getAlanineTrnaPrimaryTranscriptId() == castOther
				.getAlanineTrnaPrimaryTranscriptId()) || (this
				.getAlanineTrnaPrimaryTranscriptId() != null
				&& castOther.getAlanineTrnaPrimaryTranscriptId() != null && this
				.getAlanineTrnaPrimaryTranscriptId().equals(
						castOther.getAlanineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlanineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getAlanineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
