...
/**
 * TerminalInvertedRepeatElementId generated by hbm2java
 */
public class TerminalInvertedRepeatElementId implements java.io.Serializable {

	private Integer terminalInvertedRepeatElementId;
	...
	public TerminalInvertedRepeatElementId() {
	}

	public TerminalInvertedRepeatElementId(
			Integer terminalInvertedRepeatElementId, Integer featureId,
		...
		this.terminalInvertedRepeatElementId = terminalInvertedRepeatElementId;
	...
	public Integer getTerminalInvertedRepeatElementId() {
		return this.terminalInvertedRepeatElementId;
	}

	public void setTerminalInvertedRepeatElementId(
			Integer terminalInvertedRepeatElementId) {
		this.terminalInvertedRepeatElementId = terminalInvertedRepeatElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminalInvertedRepeatElementId))
			return false;
		TerminalInvertedRepeatElementId castOther = (TerminalInvertedRepeatElementId) other;

		return ((this.getTerminalInvertedRepeatElementId() == castOther
				.getTerminalInvertedRepeatElementId()) || (this
				.getTerminalInvertedRepeatElementId() != null
				&& castOther.getTerminalInvertedRepeatElementId() != null && this
				.getTerminalInvertedRepeatElementId().equals(
						castOther.getTerminalInvertedRepeatElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminalInvertedRepeatElementId() == null ? 0 : this
						.getTerminalInvertedRepeatElementId().hashCode());
		result = 37 * result
