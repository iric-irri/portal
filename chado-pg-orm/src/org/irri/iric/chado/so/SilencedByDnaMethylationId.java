...
/**
 * SilencedByDnaMethylationId generated by hbm2java
 */
public class SilencedByDnaMethylationId implements java.io.Serializable {

	private Integer silencedByDnaMethylationId;
	...
	public SilencedByDnaMethylationId() {
	}

	public SilencedByDnaMethylationId(Integer silencedByDnaMethylationId,
		...
		this.silencedByDnaMethylationId = silencedByDnaMethylationId;
	...
	public Integer getSilencedByDnaMethylationId() {
		return this.silencedByDnaMethylationId;
	}

	public void setSilencedByDnaMethylationId(Integer silencedByDnaMethylationId) {
		this.silencedByDnaMethylationId = silencedByDnaMethylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByDnaMethylationId))
			return false;
		SilencedByDnaMethylationId castOther = (SilencedByDnaMethylationId) other;

		return ((this.getSilencedByDnaMethylationId() == castOther
				.getSilencedByDnaMethylationId()) || (this
				.getSilencedByDnaMethylationId() != null
				&& castOther.getSilencedByDnaMethylationId() != null && this
				.getSilencedByDnaMethylationId().equals(
						castOther.getSilencedByDnaMethylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByDnaMethylationId() == null ? 0 : this
						.getSilencedByDnaMethylationId().hashCode());
		result = 37 * result
