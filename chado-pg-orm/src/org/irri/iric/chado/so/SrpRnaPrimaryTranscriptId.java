...
/**
 * SrpRnaPrimaryTranscriptId generated by hbm2java
 */
public class SrpRnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer srpRnaPrimaryTranscriptId;
	...
	public SrpRnaPrimaryTranscriptId() {
	}

	public SrpRnaPrimaryTranscriptId(Integer srpRnaPrimaryTranscriptId,
		...
		this.srpRnaPrimaryTranscriptId = srpRnaPrimaryTranscriptId;
	...
	public Integer getSrpRnaPrimaryTranscriptId() {
		return this.srpRnaPrimaryTranscriptId;
	}

	public void setSrpRnaPrimaryTranscriptId(Integer srpRnaPrimaryTranscriptId) {
		this.srpRnaPrimaryTranscriptId = srpRnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SrpRnaPrimaryTranscriptId))
			return false;
		SrpRnaPrimaryTranscriptId castOther = (SrpRnaPrimaryTranscriptId) other;

		return ((this.getSrpRnaPrimaryTranscriptId() == castOther
				.getSrpRnaPrimaryTranscriptId()) || (this
				.getSrpRnaPrimaryTranscriptId() != null
				&& castOther.getSrpRnaPrimaryTranscriptId() != null && this
				.getSrpRnaPrimaryTranscriptId().equals(
						castOther.getSrpRnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSrpRnaPrimaryTranscriptId() == null ? 0 : this
						.getSrpRnaPrimaryTranscriptId().hashCode());
		result = 37 * result
