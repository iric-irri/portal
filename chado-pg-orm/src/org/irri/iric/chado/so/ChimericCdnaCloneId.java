...
/**
 * ChimericCdnaCloneId generated by hbm2java
 */
public class ChimericCdnaCloneId implements java.io.Serializable {

	private Integer chimericCdnaCloneId;
	...
	public ChimericCdnaCloneId() {
	}

	public ChimericCdnaCloneId(Integer chimericCdnaCloneId, Integer featureId,
		...
		this.chimericCdnaCloneId = chimericCdnaCloneId;
	...
	public Integer getChimericCdnaCloneId() {
		return this.chimericCdnaCloneId;
	}

	public void setChimericCdnaCloneId(Integer chimericCdnaCloneId) {
		this.chimericCdnaCloneId = chimericCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChimericCdnaCloneId))
			return false;
		ChimericCdnaCloneId castOther = (ChimericCdnaCloneId) other;

		return ((this.getChimericCdnaCloneId() == castOther
				.getChimericCdnaCloneId()) || (this.getChimericCdnaCloneId() != null
				&& castOther.getChimericCdnaCloneId() != null && this
				.getChimericCdnaCloneId().equals(
						castOther.getChimericCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChimericCdnaCloneId() == null ? 0 : this
						.getChimericCdnaCloneId().hashCode());
		result = 37 * result
