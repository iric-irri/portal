...
/**
 * TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId generated by hbm2java
 */
public class TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId implements
		java.io.Serializable {

	private Integer twoMethylthioN6HydroxynorvalylCarbamoyladenosineId;
	...
	public TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() {
	}

	public TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId(
			Integer twoMethylthioN6HydroxynorvalylCarbamoyladenosineId,
		...
		this.twoMethylthioN6HydroxynorvalylCarbamoyladenosineId = twoMethylthioN6HydroxynorvalylCarbamoyladenosineId;
	...
	public Integer getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() {
		return this.twoMethylthioN6HydroxynorvalylCarbamoyladenosineId;
	}

	public void setTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId(
			Integer twoMethylthioN6HydroxynorvalylCarbamoyladenosineId) {
		this.twoMethylthioN6HydroxynorvalylCarbamoyladenosineId = twoMethylthioN6HydroxynorvalylCarbamoyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId))
			return false;
		TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId castOther = (TwoMethylthioN6HydroxynorvalylCarbamoyladenosineId) other;

		return ((this.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() == castOther
				.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId()) || (this
				.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() != null
				&& castOther
						.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() != null && this
				.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId()
				.equals(castOther
						.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId() == null ? 0
						: this.getTwoMethylthioN6HydroxynorvalylCarbamoyladenosineId()
								.hashCode());
		result = 37 * result
