...
/**
 * CrypticId generated by hbm2java
 */
public class CrypticId implements java.io.Serializable {

	private Integer crypticId;
	...
	public CrypticId(Integer crypticId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCrypticId() {
		return this.crypticId;
	}

	public void setCrypticId(Integer crypticId) {
		this.crypticId = crypticId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticId))
			return false;
		CrypticId castOther = (CrypticId) other;

		return ((this.getCrypticId() == castOther.getCrypticId()) || (this
				.getCrypticId() != null && castOther.getCrypticId() != null && this
				.getCrypticId().equals(castOther.getCrypticId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCrypticId() == null ? 0 : this.getCrypticId().hashCode());
		result = 37 * result
