...
/**
 * U3LtrRegionId generated by hbm2java
 */
public class U3LtrRegionId implements java.io.Serializable {

	private Integer u3LtrRegionId;
	...
	public U3LtrRegionId() {
	}

	public U3LtrRegionId(Integer u3LtrRegionId, Integer featureId,
		...
		this.u3LtrRegionId = u3LtrRegionId;
	...
	public Integer getU3LtrRegionId() {
		return this.u3LtrRegionId;
	}

	public void setU3LtrRegionId(Integer u3LtrRegionId) {
		this.u3LtrRegionId = u3LtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U3LtrRegionId))
			return false;
		U3LtrRegionId castOther = (U3LtrRegionId) other;

		return ((this.getU3LtrRegionId() == castOther.getU3LtrRegionId()) || (this
				.getU3LtrRegionId() != null
				&& castOther.getU3LtrRegionId() != null && this
				.getU3LtrRegionId().equals(castOther.getU3LtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU3LtrRegionId() == null ? 0 : this.getU3LtrRegionId()
						.hashCode());
		result = 37 * result
