...
/**
 * LambdaVectorId generated by hbm2java
 */
public class LambdaVectorId implements java.io.Serializable {

	private Integer lambdaVectorId;
	...
	public LambdaVectorId() {
	}

	public LambdaVectorId(Integer lambdaVectorId, Integer featureId,
		...
		this.lambdaVectorId = lambdaVectorId;
	...
	public Integer getLambdaVectorId() {
		return this.lambdaVectorId;
	}

	public void setLambdaVectorId(Integer lambdaVectorId) {
		this.lambdaVectorId = lambdaVectorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LambdaVectorId))
			return false;
		LambdaVectorId castOther = (LambdaVectorId) other;

		return ((this.getLambdaVectorId() == castOther.getLambdaVectorId()) || (this
				.getLambdaVectorId() != null
				&& castOther.getLambdaVectorId() != null && this
				.getLambdaVectorId().equals(castOther.getLambdaVectorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLambdaVectorId() == null ? 0 : this.getLambdaVectorId()
						.hashCode());
		result = 37 * result
