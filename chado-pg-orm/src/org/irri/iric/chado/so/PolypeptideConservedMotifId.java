...
/**
 * PolypeptideConservedMotifId generated by hbm2java
 */
public class PolypeptideConservedMotifId implements java.io.Serializable {

	private Integer polypeptideConservedMotifId;
	...
	public PolypeptideConservedMotifId() {
	}

	public PolypeptideConservedMotifId(Integer polypeptideConservedMotifId,
		...
		this.polypeptideConservedMotifId = polypeptideConservedMotifId;
	...
	public Integer getPolypeptideConservedMotifId() {
		return this.polypeptideConservedMotifId;
	}

	public void setPolypeptideConservedMotifId(
			Integer polypeptideConservedMotifId) {
		this.polypeptideConservedMotifId = polypeptideConservedMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideConservedMotifId))
			return false;
		PolypeptideConservedMotifId castOther = (PolypeptideConservedMotifId) other;

		return ((this.getPolypeptideConservedMotifId() == castOther
				.getPolypeptideConservedMotifId()) || (this
				.getPolypeptideConservedMotifId() != null
				&& castOther.getPolypeptideConservedMotifId() != null && this
				.getPolypeptideConservedMotifId().equals(
						castOther.getPolypeptideConservedMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideConservedMotifId() == null ? 0 : this
						.getPolypeptideConservedMotifId().hashCode());
		result = 37 * result
