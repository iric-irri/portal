...
/**
 * CloneEndId generated by hbm2java
 */
public class CloneEndId implements java.io.Serializable {

	private Integer cloneEndId;
	...
	public CloneEndId(Integer cloneEndId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCloneEndId() {
		return this.cloneEndId;
	}

	public void setCloneEndId(Integer cloneEndId) {
		this.cloneEndId = cloneEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CloneEndId))
			return false;
		CloneEndId castOther = (CloneEndId) other;

		return ((this.getCloneEndId() == castOther.getCloneEndId()) || (this
				.getCloneEndId() != null && castOther.getCloneEndId() != null && this
				.getCloneEndId().equals(castOther.getCloneEndId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCloneEndId() == null ? 0 : this.getCloneEndId()
						.hashCode());
		result = 37 * result
