...
/**
 * CatmatRightHandedThreeId generated by hbm2java
 */
public class CatmatRightHandedThreeId implements java.io.Serializable {

	private Integer catmatRightHandedThreeId;
	...
	public CatmatRightHandedThreeId() {
	}

	public CatmatRightHandedThreeId(Integer catmatRightHandedThreeId,
		...
		this.catmatRightHandedThreeId = catmatRightHandedThreeId;
	...
	public Integer getCatmatRightHandedThreeId() {
		return this.catmatRightHandedThreeId;
	}

	public void setCatmatRightHandedThreeId(Integer catmatRightHandedThreeId) {
		this.catmatRightHandedThreeId = catmatRightHandedThreeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatmatRightHandedThreeId))
			return false;
		CatmatRightHandedThreeId castOther = (CatmatRightHandedThreeId) other;

		return ((this.getCatmatRightHandedThreeId() == castOther
				.getCatmatRightHandedThreeId()) || (this
				.getCatmatRightHandedThreeId() != null
				&& castOther.getCatmatRightHandedThreeId() != null && this
				.getCatmatRightHandedThreeId().equals(
						castOther.getCatmatRightHandedThreeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCatmatRightHandedThreeId() == null ? 0 : this
						.getCatmatRightHandedThreeId().hashCode());
		result = 37 * result
