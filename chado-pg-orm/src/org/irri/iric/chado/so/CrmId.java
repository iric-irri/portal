...
/**
 * CrmId generated by hbm2java
 */
public class CrmId implements java.io.Serializable {
	...
	public CrmId(Integer crmId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrmId))
			return false;
		CrmId castOther = (CrmId) other;

		return ((this.getCrmId() == castOther.getCrmId()) || (this.getCrmId() != null
				&& castOther.getCrmId() != null && this.getCrmId().equals(
				castOther.getCrmId())))
