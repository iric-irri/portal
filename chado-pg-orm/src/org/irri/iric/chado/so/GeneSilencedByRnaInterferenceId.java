...
/**
 * GeneSilencedByRnaInterferenceId generated by hbm2java
 */
public class GeneSilencedByRnaInterferenceId implements java.io.Serializable {

	private Integer geneSilencedByRnaInterferenceId;
	...
	public GeneSilencedByRnaInterferenceId() {
	}

	public GeneSilencedByRnaInterferenceId(
			Integer geneSilencedByRnaInterferenceId, Integer featureId,
		...
		this.geneSilencedByRnaInterferenceId = geneSilencedByRnaInterferenceId;
	...
	public Integer getGeneSilencedByRnaInterferenceId() {
		return this.geneSilencedByRnaInterferenceId;
	}

	public void setGeneSilencedByRnaInterferenceId(
			Integer geneSilencedByRnaInterferenceId) {
		this.geneSilencedByRnaInterferenceId = geneSilencedByRnaInterferenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByRnaInterferenceId))
			return false;
		GeneSilencedByRnaInterferenceId castOther = (GeneSilencedByRnaInterferenceId) other;

		return ((this.getGeneSilencedByRnaInterferenceId() == castOther
				.getGeneSilencedByRnaInterferenceId()) || (this
				.getGeneSilencedByRnaInterferenceId() != null
				&& castOther.getGeneSilencedByRnaInterferenceId() != null && this
				.getGeneSilencedByRnaInterferenceId().equals(
						castOther.getGeneSilencedByRnaInterferenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByRnaInterferenceId() == null ? 0 : this
						.getGeneSilencedByRnaInterferenceId().hashCode());
		result = 37 * result
