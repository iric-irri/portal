...
/**
 * ModifiedGlycineId generated by hbm2java
 */
public class ModifiedGlycineId implements java.io.Serializable {

	private Integer modifiedGlycineId;
	...
	public ModifiedGlycineId() {
	}

	public ModifiedGlycineId(Integer modifiedGlycineId, Integer featureId,
		...
		this.modifiedGlycineId = modifiedGlycineId;
	...
	public Integer getModifiedGlycineId() {
		return this.modifiedGlycineId;
	}

	public void setModifiedGlycineId(Integer modifiedGlycineId) {
		this.modifiedGlycineId = modifiedGlycineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedGlycineId))
			return false;
		ModifiedGlycineId castOther = (ModifiedGlycineId) other;

		return ((this.getModifiedGlycineId() == castOther
				.getModifiedGlycineId()) || (this.getModifiedGlycineId() != null
				&& castOther.getModifiedGlycineId() != null && this
				.getModifiedGlycineId()
				.equals(castOther.getModifiedGlycineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedGlycineId() == null ? 0 : this
						.getModifiedGlycineId().hashCode());
		result = 37 * result
