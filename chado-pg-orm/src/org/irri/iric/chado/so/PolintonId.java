...
/**
 * PolintonId generated by hbm2java
 */
public class PolintonId implements java.io.Serializable {

	private Integer polintonId;
	...
	public PolintonId(Integer polintonId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPolintonId() {
		return this.polintonId;
	}

	public void setPolintonId(Integer polintonId) {
		this.polintonId = polintonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolintonId))
			return false;
		PolintonId castOther = (PolintonId) other;

		return ((this.getPolintonId() == castOther.getPolintonId()) || (this
				.getPolintonId() != null && castOther.getPolintonId() != null && this
				.getPolintonId().equals(castOther.getPolintonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolintonId() == null ? 0 : this.getPolintonId()
						.hashCode());
		result = 37 * result
