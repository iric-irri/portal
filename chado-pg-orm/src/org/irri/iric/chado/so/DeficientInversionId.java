...
/**
 * DeficientInversionId generated by hbm2java
 */
public class DeficientInversionId implements java.io.Serializable {

	private Integer deficientInversionId;
	...
	public DeficientInversionId() {
	}

	public DeficientInversionId(Integer deficientInversionId,
		...
		this.deficientInversionId = deficientInversionId;
	...
	public Integer getDeficientInversionId() {
		return this.deficientInversionId;
	}

	public void setDeficientInversionId(Integer deficientInversionId) {
		this.deficientInversionId = deficientInversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeficientInversionId))
			return false;
		DeficientInversionId castOther = (DeficientInversionId) other;

		return ((this.getDeficientInversionId() == castOther
				.getDeficientInversionId()) || (this.getDeficientInversionId() != null
				&& castOther.getDeficientInversionId() != null && this
				.getDeficientInversionId().equals(
						castOther.getDeficientInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeficientInversionId() == null ? 0 : this
						.getDeficientInversionId().hashCode());
		result = 37 * result
