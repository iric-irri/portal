...
/**
 * StTurnRightHandedTypeOneId generated by hbm2java
 */
public class StTurnRightHandedTypeOneId implements java.io.Serializable {

	private Integer stTurnRightHandedTypeOneId;
	...
	public StTurnRightHandedTypeOneId() {
	}

	public StTurnRightHandedTypeOneId(Integer stTurnRightHandedTypeOneId,
		...
		this.stTurnRightHandedTypeOneId = stTurnRightHandedTypeOneId;
	...
	public Integer getStTurnRightHandedTypeOneId() {
		return this.stTurnRightHandedTypeOneId;
	}

	public void setStTurnRightHandedTypeOneId(Integer stTurnRightHandedTypeOneId) {
		this.stTurnRightHandedTypeOneId = stTurnRightHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StTurnRightHandedTypeOneId))
			return false;
		StTurnRightHandedTypeOneId castOther = (StTurnRightHandedTypeOneId) other;

		return ((this.getStTurnRightHandedTypeOneId() == castOther
				.getStTurnRightHandedTypeOneId()) || (this
				.getStTurnRightHandedTypeOneId() != null
				&& castOther.getStTurnRightHandedTypeOneId() != null && this
				.getStTurnRightHandedTypeOneId().equals(
						castOther.getStTurnRightHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStTurnRightHandedTypeOneId() == null ? 0 : this
						.getStTurnRightHandedTypeOneId().hashCode());
		result = 37 * result
