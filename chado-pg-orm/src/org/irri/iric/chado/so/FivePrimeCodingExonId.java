...
/**
 * FivePrimeCodingExonId generated by hbm2java
 */
public class FivePrimeCodingExonId implements java.io.Serializable {

	private Integer fivePrimeCodingExonId;
	...
	public FivePrimeCodingExonId() {
	}

	public FivePrimeCodingExonId(Integer fivePrimeCodingExonId,
		...
		this.fivePrimeCodingExonId = fivePrimeCodingExonId;
	...
	public Integer getFivePrimeCodingExonId() {
		return this.fivePrimeCodingExonId;
	}

	public void setFivePrimeCodingExonId(Integer fivePrimeCodingExonId) {
		this.fivePrimeCodingExonId = fivePrimeCodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeCodingExonId))
			return false;
		FivePrimeCodingExonId castOther = (FivePrimeCodingExonId) other;

		return ((this.getFivePrimeCodingExonId() == castOther
				.getFivePrimeCodingExonId()) || (this
				.getFivePrimeCodingExonId() != null
				&& castOther.getFivePrimeCodingExonId() != null && this
				.getFivePrimeCodingExonId().equals(
						castOther.getFivePrimeCodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeCodingExonId() == null ? 0 : this
						.getFivePrimeCodingExonId().hashCode());
		result = 37 * result
