...
/**
 * LinearDoubleStrandedRnaChromosomeId generated by hbm2java
 */
public class LinearDoubleStrandedRnaChromosomeId implements
		java.io.Serializable {

	private Integer linearDoubleStrandedRnaChromosomeId;
	...
	public LinearDoubleStrandedRnaChromosomeId() {
	}

	public LinearDoubleStrandedRnaChromosomeId(
			Integer linearDoubleStrandedRnaChromosomeId, Integer featureId,
		...
		this.linearDoubleStrandedRnaChromosomeId = linearDoubleStrandedRnaChromosomeId;
	...
	public Integer getLinearDoubleStrandedRnaChromosomeId() {
		return this.linearDoubleStrandedRnaChromosomeId;
	}

	public void setLinearDoubleStrandedRnaChromosomeId(
			Integer linearDoubleStrandedRnaChromosomeId) {
		this.linearDoubleStrandedRnaChromosomeId = linearDoubleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinearDoubleStrandedRnaChromosomeId))
			return false;
		LinearDoubleStrandedRnaChromosomeId castOther = (LinearDoubleStrandedRnaChromosomeId) other;

		return ((this.getLinearDoubleStrandedRnaChromosomeId() == castOther
				.getLinearDoubleStrandedRnaChromosomeId()) || (this
				.getLinearDoubleStrandedRnaChromosomeId() != null
				&& castOther.getLinearDoubleStrandedRnaChromosomeId() != null && this
				.getLinearDoubleStrandedRnaChromosomeId().equals(
						castOther.getLinearDoubleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLinearDoubleStrandedRnaChromosomeId() == null ? 0 : this
						.getLinearDoubleStrandedRnaChromosomeId().hashCode());
		result = 37 * result
