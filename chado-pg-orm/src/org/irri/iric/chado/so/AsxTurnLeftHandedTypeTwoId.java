...
/**
 * AsxTurnLeftHandedTypeTwoId generated by hbm2java
 */
public class AsxTurnLeftHandedTypeTwoId implements java.io.Serializable {

	private Integer asxTurnLeftHandedTypeTwoId;
	...
	public AsxTurnLeftHandedTypeTwoId() {
	}

	public AsxTurnLeftHandedTypeTwoId(Integer asxTurnLeftHandedTypeTwoId,
		...
		this.asxTurnLeftHandedTypeTwoId = asxTurnLeftHandedTypeTwoId;
	...
	public Integer getAsxTurnLeftHandedTypeTwoId() {
		return this.asxTurnLeftHandedTypeTwoId;
	}

	public void setAsxTurnLeftHandedTypeTwoId(Integer asxTurnLeftHandedTypeTwoId) {
		this.asxTurnLeftHandedTypeTwoId = asxTurnLeftHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxTurnLeftHandedTypeTwoId))
			return false;
		AsxTurnLeftHandedTypeTwoId castOther = (AsxTurnLeftHandedTypeTwoId) other;

		return ((this.getAsxTurnLeftHandedTypeTwoId() == castOther
				.getAsxTurnLeftHandedTypeTwoId()) || (this
				.getAsxTurnLeftHandedTypeTwoId() != null
				&& castOther.getAsxTurnLeftHandedTypeTwoId() != null && this
				.getAsxTurnLeftHandedTypeTwoId().equals(
						castOther.getAsxTurnLeftHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsxTurnLeftHandedTypeTwoId() == null ? 0 : this
						.getAsxTurnLeftHandedTypeTwoId().hashCode());
		result = 37 * result
