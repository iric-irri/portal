...
/**
 * TranscribedFragmentId generated by hbm2java
 */
public class TranscribedFragmentId implements java.io.Serializable {

	private Integer transcribedFragmentId;
	...
	public TranscribedFragmentId() {
	}

	public TranscribedFragmentId(Integer transcribedFragmentId,
		...
		this.transcribedFragmentId = transcribedFragmentId;
	...
	public Integer getTranscribedFragmentId() {
		return this.transcribedFragmentId;
	}

	public void setTranscribedFragmentId(Integer transcribedFragmentId) {
		this.transcribedFragmentId = transcribedFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscribedFragmentId))
			return false;
		TranscribedFragmentId castOther = (TranscribedFragmentId) other;

		return ((this.getTranscribedFragmentId() == castOther
				.getTranscribedFragmentId()) || (this
				.getTranscribedFragmentId() != null
				&& castOther.getTranscribedFragmentId() != null && this
				.getTranscribedFragmentId().equals(
						castOther.getTranscribedFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscribedFragmentId() == null ? 0 : this
						.getTranscribedFragmentId().hashCode());
		result = 37 * result
