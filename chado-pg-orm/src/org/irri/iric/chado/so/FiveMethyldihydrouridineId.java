...
/**
 * FiveMethyldihydrouridineId generated by hbm2java
 */
public class FiveMethyldihydrouridineId implements java.io.Serializable {

	private Integer fiveMethyldihydrouridineId;
	...
	public FiveMethyldihydrouridineId() {
	}

	public FiveMethyldihydrouridineId(Integer fiveMethyldihydrouridineId,
		...
		this.fiveMethyldihydrouridineId = fiveMethyldihydrouridineId;
	...
	public Integer getFiveMethyldihydrouridineId() {
		return this.fiveMethyldihydrouridineId;
	}

	public void setFiveMethyldihydrouridineId(Integer fiveMethyldihydrouridineId) {
		this.fiveMethyldihydrouridineId = fiveMethyldihydrouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethyldihydrouridineId))
			return false;
		FiveMethyldihydrouridineId castOther = (FiveMethyldihydrouridineId) other;

		return ((this.getFiveMethyldihydrouridineId() == castOther
				.getFiveMethyldihydrouridineId()) || (this
				.getFiveMethyldihydrouridineId() != null
				&& castOther.getFiveMethyldihydrouridineId() != null && this
				.getFiveMethyldihydrouridineId().equals(
						castOther.getFiveMethyldihydrouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethyldihydrouridineId() == null ? 0 : this
						.getFiveMethyldihydrouridineId().hashCode());
		result = 37 * result
