...
/**
 * MiteId generated by hbm2java
 */
public class MiteId implements java.io.Serializable {

	private Integer miteId;
	...
	public MiteId(Integer miteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMiteId() {
		return this.miteId;
	}

	public void setMiteId(Integer miteId) {
		this.miteId = miteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MiteId))
			return false;
		MiteId castOther = (MiteId) other;

		return ((this.getMiteId() == castOther.getMiteId()) || (this
				.getMiteId() != null && castOther.getMiteId() != null && this
				.getMiteId().equals(castOther.getMiteId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMiteId() == null ? 0 : this.getMiteId().hashCode());
		result = 37 * result
