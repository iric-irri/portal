...
/**
 * RecursiveSpliceSiteId generated by hbm2java
 */
public class RecursiveSpliceSiteId implements java.io.Serializable {

	private Integer recursiveSpliceSiteId;
	...
	public RecursiveSpliceSiteId() {
	}

	public RecursiveSpliceSiteId(Integer recursiveSpliceSiteId,
		...
		this.recursiveSpliceSiteId = recursiveSpliceSiteId;
	...
	public Integer getRecursiveSpliceSiteId() {
		return this.recursiveSpliceSiteId;
	}

	public void setRecursiveSpliceSiteId(Integer recursiveSpliceSiteId) {
		this.recursiveSpliceSiteId = recursiveSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecursiveSpliceSiteId))
			return false;
		RecursiveSpliceSiteId castOther = (RecursiveSpliceSiteId) other;

		return ((this.getRecursiveSpliceSiteId() == castOther
				.getRecursiveSpliceSiteId()) || (this
				.getRecursiveSpliceSiteId() != null
				&& castOther.getRecursiveSpliceSiteId() != null && this
				.getRecursiveSpliceSiteId().equals(
						castOther.getRecursiveSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecursiveSpliceSiteId() == null ? 0 : this
						.getRecursiveSpliceSiteId().hashCode());
		result = 37 * result
