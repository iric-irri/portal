...
/**
 * MinicircleId generated by hbm2java
 */
public class MinicircleId implements java.io.Serializable {

	private Integer minicircleId;
	...
	public MinicircleId(Integer minicircleId, Integer featureId,
		...
		this.minicircleId = minicircleId;
	...
	public Integer getMinicircleId() {
		return this.minicircleId;
	}

	public void setMinicircleId(Integer minicircleId) {
		this.minicircleId = minicircleId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MinicircleId))
			return false;
		MinicircleId castOther = (MinicircleId) other;

		return ((this.getMinicircleId() == castOther.getMinicircleId()) || (this
				.getMinicircleId() != null
				&& castOther.getMinicircleId() != null && this
				.getMinicircleId().equals(castOther.getMinicircleId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinicircleId() == null ? 0 : this.getMinicircleId()
						.hashCode());
		result = 37 * result
