...
/**
 * ReadId generated by hbm2java
 */
public class ReadId implements java.io.Serializable {
	...
	public ReadId(Integer readId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReadId))
			return false;
		ReadId castOther = (ReadId) other;

		return ((this.getReadId() == castOther.getReadId()) || (this
				.getReadId() != null && castOther.getReadId() != null && this
				.getReadId().equals(castOther.getReadId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getReadId() == null ? 0 : this.getReadId().hashCode());
		result = 37 * result
