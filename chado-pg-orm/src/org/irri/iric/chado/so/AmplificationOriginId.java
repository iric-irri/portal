...
/**
 * AmplificationOriginId generated by hbm2java
 */
public class AmplificationOriginId implements java.io.Serializable {

	private Integer amplificationOriginId;
	...
	public AmplificationOriginId() {
	}

	public AmplificationOriginId(Integer amplificationOriginId,
		...
		this.amplificationOriginId = amplificationOriginId;
	...
	public Integer getAmplificationOriginId() {
		return this.amplificationOriginId;
	}

	public void setAmplificationOriginId(Integer amplificationOriginId) {
		this.amplificationOriginId = amplificationOriginId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AmplificationOriginId))
			return false;
		AmplificationOriginId castOther = (AmplificationOriginId) other;

		return ((this.getAmplificationOriginId() == castOther
				.getAmplificationOriginId()) || (this
				.getAmplificationOriginId() != null
				&& castOther.getAmplificationOriginId() != null && this
				.getAmplificationOriginId().equals(
						castOther.getAmplificationOriginId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAmplificationOriginId() == null ? 0 : this
						.getAmplificationOriginId().hashCode());
		result = 37 * result
