...
/**
 * CGeneId generated by hbm2java
 */
public class CGeneId implements java.io.Serializable {

	private Integer CGeneId;
	...
	public CGeneId(Integer CGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCGeneId() {
		return this.CGeneId;
	}

	public void setCGeneId(Integer CGeneId) {
		this.CGeneId = CGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CGeneId))
			return false;
		CGeneId castOther = (CGeneId) other;

		return ((this.getCGeneId() == castOther.getCGeneId()) || (this
				.getCGeneId() != null && castOther.getCGeneId() != null && this
				.getCGeneId().equals(castOther.getCGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCGeneId() == null ? 0 : this.getCGeneId().hashCode());
		result = 37 * result
