...
/**
 * TransposonFragmentId generated by hbm2java
 */
public class TransposonFragmentId implements java.io.Serializable {

	private Integer transposonFragmentId;
	...
	public TransposonFragmentId() {
	}

	public TransposonFragmentId(Integer transposonFragmentId,
		...
		this.transposonFragmentId = transposonFragmentId;
	...
	public Integer getTransposonFragmentId() {
		return this.transposonFragmentId;
	}

	public void setTransposonFragmentId(Integer transposonFragmentId) {
		this.transposonFragmentId = transposonFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransposonFragmentId))
			return false;
		TransposonFragmentId castOther = (TransposonFragmentId) other;

		return ((this.getTransposonFragmentId() == castOther
				.getTransposonFragmentId()) || (this.getTransposonFragmentId() != null
				&& castOther.getTransposonFragmentId() != null && this
				.getTransposonFragmentId().equals(
						castOther.getTransposonFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransposonFragmentId() == null ? 0 : this
						.getTransposonFragmentId().hashCode());
		result = 37 * result
