...
/**
 * CleavedForGpiAnchorRegionId generated by hbm2java
 */
public class CleavedForGpiAnchorRegionId implements java.io.Serializable {

	private Integer cleavedForGpiAnchorRegionId;
	...
	public CleavedForGpiAnchorRegionId() {
	}

	public CleavedForGpiAnchorRegionId(Integer cleavedForGpiAnchorRegionId,
		...
		this.cleavedForGpiAnchorRegionId = cleavedForGpiAnchorRegionId;
	...
	public Integer getCleavedForGpiAnchorRegionId() {
		return this.cleavedForGpiAnchorRegionId;
	}

	public void setCleavedForGpiAnchorRegionId(
			Integer cleavedForGpiAnchorRegionId) {
		this.cleavedForGpiAnchorRegionId = cleavedForGpiAnchorRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CleavedForGpiAnchorRegionId))
			return false;
		CleavedForGpiAnchorRegionId castOther = (CleavedForGpiAnchorRegionId) other;

		return ((this.getCleavedForGpiAnchorRegionId() == castOther
				.getCleavedForGpiAnchorRegionId()) || (this
				.getCleavedForGpiAnchorRegionId() != null
				&& castOther.getCleavedForGpiAnchorRegionId() != null && this
				.getCleavedForGpiAnchorRegionId().equals(
						castOther.getCleavedForGpiAnchorRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCleavedForGpiAnchorRegionId() == null ? 0 : this
						.getCleavedForGpiAnchorRegionId().hashCode());
		result = 37 * result
