...
/**
 * PrimaryTranscriptRegionId generated by hbm2java
 */
public class PrimaryTranscriptRegionId implements java.io.Serializable {

	private Integer primaryTranscriptRegionId;
	...
	public PrimaryTranscriptRegionId() {
	}

	public PrimaryTranscriptRegionId(Integer primaryTranscriptRegionId,
		...
		this.primaryTranscriptRegionId = primaryTranscriptRegionId;
	...
	public Integer getPrimaryTranscriptRegionId() {
		return this.primaryTranscriptRegionId;
	}

	public void setPrimaryTranscriptRegionId(Integer primaryTranscriptRegionId) {
		this.primaryTranscriptRegionId = primaryTranscriptRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrimaryTranscriptRegionId))
			return false;
		PrimaryTranscriptRegionId castOther = (PrimaryTranscriptRegionId) other;

		return ((this.getPrimaryTranscriptRegionId() == castOther
				.getPrimaryTranscriptRegionId()) || (this
				.getPrimaryTranscriptRegionId() != null
				&& castOther.getPrimaryTranscriptRegionId() != null && this
				.getPrimaryTranscriptRegionId().equals(
						castOther.getPrimaryTranscriptRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPrimaryTranscriptRegionId() == null ? 0 : this
						.getPrimaryTranscriptRegionId().hashCode());
		result = 37 * result
