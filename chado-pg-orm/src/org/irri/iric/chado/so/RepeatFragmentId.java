...
/**
 * RepeatFragmentId generated by hbm2java
 */
public class RepeatFragmentId implements java.io.Serializable {

	private Integer repeatFragmentId;
	...
	public RepeatFragmentId() {
	}

	public RepeatFragmentId(Integer repeatFragmentId, Integer featureId,
		...
		this.repeatFragmentId = repeatFragmentId;
	...
	public Integer getRepeatFragmentId() {
		return this.repeatFragmentId;
	}

	public void setRepeatFragmentId(Integer repeatFragmentId) {
		this.repeatFragmentId = repeatFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RepeatFragmentId))
			return false;
		RepeatFragmentId castOther = (RepeatFragmentId) other;

		return ((this.getRepeatFragmentId() == castOther.getRepeatFragmentId()) || (this
				.getRepeatFragmentId() != null
				&& castOther.getRepeatFragmentId() != null && this
				.getRepeatFragmentId().equals(castOther.getRepeatFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRepeatFragmentId() == null ? 0 : this
						.getRepeatFragmentId().hashCode());
		result = 37 * result
