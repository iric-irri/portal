...
/**
 * VariantQualityId generated by hbm2java
 */
public class VariantQualityId implements java.io.Serializable {

	private Integer variantQualityId;
	...
	public VariantQualityId() {
	}

	public VariantQualityId(Integer variantQualityId, Integer featureId,
		...
		this.variantQualityId = variantQualityId;
	...
	public Integer getVariantQualityId() {
		return this.variantQualityId;
	}

	public void setVariantQualityId(Integer variantQualityId) {
		this.variantQualityId = variantQualityId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantQualityId))
			return false;
		VariantQualityId castOther = (VariantQualityId) other;

		return ((this.getVariantQualityId() == castOther.getVariantQualityId()) || (this
				.getVariantQualityId() != null
				&& castOther.getVariantQualityId() != null && this
				.getVariantQualityId().equals(castOther.getVariantQualityId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantQualityId() == null ? 0 : this
						.getVariantQualityId().hashCode());
		result = 37 * result
