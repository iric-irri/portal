...
/**
 * ScrnaEncodingId generated by hbm2java
 */
public class ScrnaEncodingId implements java.io.Serializable {

	private Integer scrnaEncodingId;
	...
	public ScrnaEncodingId() {
	}

	public ScrnaEncodingId(Integer scrnaEncodingId, Integer featureId,
		...
		this.scrnaEncodingId = scrnaEncodingId;
	...
	public Integer getScrnaEncodingId() {
		return this.scrnaEncodingId;
	}

	public void setScrnaEncodingId(Integer scrnaEncodingId) {
		this.scrnaEncodingId = scrnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ScrnaEncodingId))
			return false;
		ScrnaEncodingId castOther = (ScrnaEncodingId) other;

		return ((this.getScrnaEncodingId() == castOther.getScrnaEncodingId()) || (this
				.getScrnaEncodingId() != null
				&& castOther.getScrnaEncodingId() != null && this
				.getScrnaEncodingId().equals(castOther.getScrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getScrnaEncodingId() == null ? 0 : this.getScrnaEncodingId()
						.hashCode());
		result = 37 * result
