...
/**
 * DjJCClusterId generated by hbm2java
 */
public class DjJCClusterId implements java.io.Serializable {

	private Integer djJCClusterId;
	...
	public DjJCClusterId() {
	}

	public DjJCClusterId(Integer djJCClusterId, Integer featureId,
		...
		this.djJCClusterId = djJCClusterId;
	...
	public Integer getDjJCClusterId() {
		return this.djJCClusterId;
	}

	public void setDjJCClusterId(Integer djJCClusterId) {
		this.djJCClusterId = djJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DjJCClusterId))
			return false;
		DjJCClusterId castOther = (DjJCClusterId) other;

		return ((this.getDjJCClusterId() == castOther.getDjJCClusterId()) || (this
				.getDjJCClusterId() != null
				&& castOther.getDjJCClusterId() != null && this
				.getDjJCClusterId().equals(castOther.getDjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDjJCClusterId() == null ? 0 : this.getDjJCClusterId()
						.hashCode());
		result = 37 * result
