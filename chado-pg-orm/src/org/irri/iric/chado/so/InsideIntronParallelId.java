...
/**
 * InsideIntronParallelId generated by hbm2java
 */
public class InsideIntronParallelId implements java.io.Serializable {

	private Integer insideIntronParallelId;
	...
	public InsideIntronParallelId() {
	}

	public InsideIntronParallelId(Integer insideIntronParallelId,
		...
		this.insideIntronParallelId = insideIntronParallelId;
	...
	public Integer getInsideIntronParallelId() {
		return this.insideIntronParallelId;
	}

	public void setInsideIntronParallelId(Integer insideIntronParallelId) {
		this.insideIntronParallelId = insideIntronParallelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsideIntronParallelId))
			return false;
		InsideIntronParallelId castOther = (InsideIntronParallelId) other;

		return ((this.getInsideIntronParallelId() == castOther
				.getInsideIntronParallelId()) || (this
				.getInsideIntronParallelId() != null
				&& castOther.getInsideIntronParallelId() != null && this
				.getInsideIntronParallelId().equals(
						castOther.getInsideIntronParallelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsideIntronParallelId() == null ? 0 : this
						.getInsideIntronParallelId().hashCode());
		result = 37 * result
