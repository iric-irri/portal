...
/**
 * NaturalPlasmidId generated by hbm2java
 */
public class NaturalPlasmidId implements java.io.Serializable {

	private Integer naturalPlasmidId;
	...
	public NaturalPlasmidId() {
	}

	public NaturalPlasmidId(Integer naturalPlasmidId, Integer featureId,
		...
		this.naturalPlasmidId = naturalPlasmidId;
	...
	public Integer getNaturalPlasmidId() {
		return this.naturalPlasmidId;
	}

	public void setNaturalPlasmidId(Integer naturalPlasmidId) {
		this.naturalPlasmidId = naturalPlasmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NaturalPlasmidId))
			return false;
		NaturalPlasmidId castOther = (NaturalPlasmidId) other;

		return ((this.getNaturalPlasmidId() == castOther.getNaturalPlasmidId()) || (this
				.getNaturalPlasmidId() != null
				&& castOther.getNaturalPlasmidId() != null && this
				.getNaturalPlasmidId().equals(castOther.getNaturalPlasmidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNaturalPlasmidId() == null ? 0 : this
						.getNaturalPlasmidId().hashCode());
		result = 37 * result
