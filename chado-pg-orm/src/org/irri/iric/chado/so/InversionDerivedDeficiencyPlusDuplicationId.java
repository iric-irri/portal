...
/**
 * InversionDerivedDeficiencyPlusDuplicationId generated by hbm2java
 */
public class InversionDerivedDeficiencyPlusDuplicationId implements
		java.io.Serializable {

	private Integer inversionDerivedDeficiencyPlusDuplicationId;
	...
	public InversionDerivedDeficiencyPlusDuplicationId() {
	}

	public InversionDerivedDeficiencyPlusDuplicationId(
			Integer inversionDerivedDeficiencyPlusDuplicationId,
		...
		this.inversionDerivedDeficiencyPlusDuplicationId = inversionDerivedDeficiencyPlusDuplicationId;
	...
	public Integer getInversionDerivedDeficiencyPlusDuplicationId() {
		return this.inversionDerivedDeficiencyPlusDuplicationId;
	}

	public void setInversionDerivedDeficiencyPlusDuplicationId(
			Integer inversionDerivedDeficiencyPlusDuplicationId) {
		this.inversionDerivedDeficiencyPlusDuplicationId = inversionDerivedDeficiencyPlusDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedDeficiencyPlusDuplicationId))
			return false;
		InversionDerivedDeficiencyPlusDuplicationId castOther = (InversionDerivedDeficiencyPlusDuplicationId) other;

		return ((this.getInversionDerivedDeficiencyPlusDuplicationId() == castOther
				.getInversionDerivedDeficiencyPlusDuplicationId()) || (this
				.getInversionDerivedDeficiencyPlusDuplicationId() != null
				&& castOther.getInversionDerivedDeficiencyPlusDuplicationId() != null && this
				.getInversionDerivedDeficiencyPlusDuplicationId()
				.equals(castOther
						.getInversionDerivedDeficiencyPlusDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedDeficiencyPlusDuplicationId() == null ? 0
						: this.getInversionDerivedDeficiencyPlusDuplicationId()
								.hashCode());
		result = 37 * result
