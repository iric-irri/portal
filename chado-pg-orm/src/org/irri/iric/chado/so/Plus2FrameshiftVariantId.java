...
/**
 * Plus2FrameshiftVariantId generated by hbm2java
 */
public class Plus2FrameshiftVariantId implements java.io.Serializable {

	private Integer plus2FrameshiftVariantId;
	...
	public Plus2FrameshiftVariantId() {
	}

	public Plus2FrameshiftVariantId(Integer plus2FrameshiftVariantId,
		...
		this.plus2FrameshiftVariantId = plus2FrameshiftVariantId;
	...
	public Integer getPlus2FrameshiftVariantId() {
		return this.plus2FrameshiftVariantId;
	}

	public void setPlus2FrameshiftVariantId(Integer plus2FrameshiftVariantId) {
		this.plus2FrameshiftVariantId = plus2FrameshiftVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus2FrameshiftVariantId))
			return false;
		Plus2FrameshiftVariantId castOther = (Plus2FrameshiftVariantId) other;

		return ((this.getPlus2FrameshiftVariantId() == castOther
				.getPlus2FrameshiftVariantId()) || (this
				.getPlus2FrameshiftVariantId() != null
				&& castOther.getPlus2FrameshiftVariantId() != null && this
				.getPlus2FrameshiftVariantId().equals(
						castOther.getPlus2FrameshiftVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus2FrameshiftVariantId() == null ? 0 : this
						.getPlus2FrameshiftVariantId().hashCode());
		result = 37 * result
