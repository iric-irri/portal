...
/**
 * DartMarkerId generated by hbm2java
 */
public class DartMarkerId implements java.io.Serializable {

	private Integer dartMarkerId;
	...
	public DartMarkerId(Integer dartMarkerId, Integer featureId,
		...
		this.dartMarkerId = dartMarkerId;
	...
	public Integer getDartMarkerId() {
		return this.dartMarkerId;
	}

	public void setDartMarkerId(Integer dartMarkerId) {
		this.dartMarkerId = dartMarkerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DartMarkerId))
			return false;
		DartMarkerId castOther = (DartMarkerId) other;

		return ((this.getDartMarkerId() == castOther.getDartMarkerId()) || (this
				.getDartMarkerId() != null
				&& castOther.getDartMarkerId() != null && this
				.getDartMarkerId().equals(castOther.getDartMarkerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDartMarkerId() == null ? 0 : this.getDartMarkerId()
						.hashCode());
		result = 37 * result
