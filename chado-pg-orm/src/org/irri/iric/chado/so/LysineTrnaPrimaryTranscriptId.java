...
/**
 * LysineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class LysineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer lysineTrnaPrimaryTranscriptId;
	...
	public LysineTrnaPrimaryTranscriptId() {
	}

	public LysineTrnaPrimaryTranscriptId(Integer lysineTrnaPrimaryTranscriptId,
		...
		this.lysineTrnaPrimaryTranscriptId = lysineTrnaPrimaryTranscriptId;
	...
	public Integer getLysineTrnaPrimaryTranscriptId() {
		return this.lysineTrnaPrimaryTranscriptId;
	}

	public void setLysineTrnaPrimaryTranscriptId(
			Integer lysineTrnaPrimaryTranscriptId) {
		this.lysineTrnaPrimaryTranscriptId = lysineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LysineTrnaPrimaryTranscriptId))
			return false;
		LysineTrnaPrimaryTranscriptId castOther = (LysineTrnaPrimaryTranscriptId) other;

		return ((this.getLysineTrnaPrimaryTranscriptId() == castOther
				.getLysineTrnaPrimaryTranscriptId()) || (this
				.getLysineTrnaPrimaryTranscriptId() != null
				&& castOther.getLysineTrnaPrimaryTranscriptId() != null && this
				.getLysineTrnaPrimaryTranscriptId().equals(
						castOther.getLysineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLysineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getLysineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
