...
/**
 * PElementId generated by hbm2java
 */
public class PElementId implements java.io.Serializable {

	private Integer PElementId;
	...
	public PElementId(Integer PElementId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPElementId() {
		return this.PElementId;
	}

	public void setPElementId(Integer PElementId) {
		this.PElementId = PElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PElementId))
			return false;
		PElementId castOther = (PElementId) other;

		return ((this.getPElementId() == castOther.getPElementId()) || (this
				.getPElementId() != null && castOther.getPElementId() != null && this
				.getPElementId().equals(castOther.getPElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPElementId() == null ? 0 : this.getPElementId()
						.hashCode());
		result = 37 * result
