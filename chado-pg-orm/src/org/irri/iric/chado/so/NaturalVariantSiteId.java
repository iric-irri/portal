...
/**
 * NaturalVariantSiteId generated by hbm2java
 */
public class NaturalVariantSiteId implements java.io.Serializable {

	private Integer naturalVariantSiteId;
	...
	public NaturalVariantSiteId() {
	}

	public NaturalVariantSiteId(Integer naturalVariantSiteId,
		...
		this.naturalVariantSiteId = naturalVariantSiteId;
	...
	public Integer getNaturalVariantSiteId() {
		return this.naturalVariantSiteId;
	}

	public void setNaturalVariantSiteId(Integer naturalVariantSiteId) {
		this.naturalVariantSiteId = naturalVariantSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NaturalVariantSiteId))
			return false;
		NaturalVariantSiteId castOther = (NaturalVariantSiteId) other;

		return ((this.getNaturalVariantSiteId() == castOther
				.getNaturalVariantSiteId()) || (this.getNaturalVariantSiteId() != null
				&& castOther.getNaturalVariantSiteId() != null && this
				.getNaturalVariantSiteId().equals(
						castOther.getNaturalVariantSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNaturalVariantSiteId() == null ? 0 : this
						.getNaturalVariantSiteId().hashCode());
		result = 37 * result
