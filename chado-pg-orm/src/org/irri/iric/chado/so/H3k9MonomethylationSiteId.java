...
/**
 * H3k9MonomethylationSiteId generated by hbm2java
 */
public class H3k9MonomethylationSiteId implements java.io.Serializable {

	private Integer h3k9MonomethylationSiteId;
	...
	public H3k9MonomethylationSiteId() {
	}

	public H3k9MonomethylationSiteId(Integer h3k9MonomethylationSiteId,
		...
		this.h3k9MonomethylationSiteId = h3k9MonomethylationSiteId;
	...
	public Integer getH3k9MonomethylationSiteId() {
		return this.h3k9MonomethylationSiteId;
	}

	public void setH3k9MonomethylationSiteId(Integer h3k9MonomethylationSiteId) {
		this.h3k9MonomethylationSiteId = h3k9MonomethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k9MonomethylationSiteId))
			return false;
		H3k9MonomethylationSiteId castOther = (H3k9MonomethylationSiteId) other;

		return ((this.getH3k9MonomethylationSiteId() == castOther
				.getH3k9MonomethylationSiteId()) || (this
				.getH3k9MonomethylationSiteId() != null
				&& castOther.getH3k9MonomethylationSiteId() != null && this
				.getH3k9MonomethylationSiteId().equals(
						castOther.getH3k9MonomethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k9MonomethylationSiteId() == null ? 0 : this
						.getH3k9MonomethylationSiteId().hashCode());
		result = 37 * result
