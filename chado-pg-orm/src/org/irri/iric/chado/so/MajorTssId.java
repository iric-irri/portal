...
/**
 * MajorTssId generated by hbm2java
 */
public class MajorTssId implements java.io.Serializable {

	private Integer majorTssId;
	...
	public MajorTssId(Integer majorTssId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMajorTssId() {
		return this.majorTssId;
	}

	public void setMajorTssId(Integer majorTssId) {
		this.majorTssId = majorTssId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MajorTssId))
			return false;
		MajorTssId castOther = (MajorTssId) other;

		return ((this.getMajorTssId() == castOther.getMajorTssId()) || (this
				.getMajorTssId() != null && castOther.getMajorTssId() != null && this
				.getMajorTssId().equals(castOther.getMajorTssId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMajorTssId() == null ? 0 : this.getMajorTssId()
						.hashCode());
		result = 37 * result
