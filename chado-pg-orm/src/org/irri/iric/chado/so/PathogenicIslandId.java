...
/**
 * PathogenicIslandId generated by hbm2java
 */
public class PathogenicIslandId implements java.io.Serializable {

	private Integer pathogenicIslandId;
	...
	public PathogenicIslandId() {
	}

	public PathogenicIslandId(Integer pathogenicIslandId, Integer featureId,
		...
		this.pathogenicIslandId = pathogenicIslandId;
	...
	public Integer getPathogenicIslandId() {
		return this.pathogenicIslandId;
	}

	public void setPathogenicIslandId(Integer pathogenicIslandId) {
		this.pathogenicIslandId = pathogenicIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PathogenicIslandId))
			return false;
		PathogenicIslandId castOther = (PathogenicIslandId) other;

		return ((this.getPathogenicIslandId() == castOther
				.getPathogenicIslandId()) || (this.getPathogenicIslandId() != null
				&& castOther.getPathogenicIslandId() != null && this
				.getPathogenicIslandId().equals(
						castOther.getPathogenicIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPathogenicIslandId() == null ? 0 : this
						.getPathogenicIslandId().hashCode());
		result = 37 * result
