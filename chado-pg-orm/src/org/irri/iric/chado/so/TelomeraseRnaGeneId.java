...
/**
 * TelomeraseRnaGeneId generated by hbm2java
 */
public class TelomeraseRnaGeneId implements java.io.Serializable {

	private Integer telomeraseRnaGeneId;
	...
	public TelomeraseRnaGeneId() {
	}

	public TelomeraseRnaGeneId(Integer telomeraseRnaGeneId, Integer featureId,
		...
		this.telomeraseRnaGeneId = telomeraseRnaGeneId;
	...
	public Integer getTelomeraseRnaGeneId() {
		return this.telomeraseRnaGeneId;
	}

	public void setTelomeraseRnaGeneId(Integer telomeraseRnaGeneId) {
		this.telomeraseRnaGeneId = telomeraseRnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TelomeraseRnaGeneId))
			return false;
		TelomeraseRnaGeneId castOther = (TelomeraseRnaGeneId) other;

		return ((this.getTelomeraseRnaGeneId() == castOther
				.getTelomeraseRnaGeneId()) || (this.getTelomeraseRnaGeneId() != null
				&& castOther.getTelomeraseRnaGeneId() != null && this
				.getTelomeraseRnaGeneId().equals(
						castOther.getTelomeraseRnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTelomeraseRnaGeneId() == null ? 0 : this
						.getTelomeraseRnaGeneId().hashCode());
		result = 37 * result
