...
/**
 * TranslocationElementId generated by hbm2java
 */
public class TranslocationElementId implements java.io.Serializable {

	private Integer translocationElementId;
	...
	public TranslocationElementId() {
	}

	public TranslocationElementId(Integer translocationElementId,
		...
		this.translocationElementId = translocationElementId;
	...
	public Integer getTranslocationElementId() {
		return this.translocationElementId;
	}

	public void setTranslocationElementId(Integer translocationElementId) {
		this.translocationElementId = translocationElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslocationElementId))
			return false;
		TranslocationElementId castOther = (TranslocationElementId) other;

		return ((this.getTranslocationElementId() == castOther
				.getTranslocationElementId()) || (this
				.getTranslocationElementId() != null
				&& castOther.getTranslocationElementId() != null && this
				.getTranslocationElementId().equals(
						castOther.getTranslocationElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslocationElementId() == null ? 0 : this
						.getTranslocationElementId().hashCode());
		result = 37 * result
