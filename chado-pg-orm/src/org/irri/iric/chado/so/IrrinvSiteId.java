...
/**
 * IrrinvSiteId generated by hbm2java
 */
public class IrrinvSiteId implements java.io.Serializable {

	private Integer irrinvSiteId;
	...
	public IrrinvSiteId(Integer irrinvSiteId, Integer featureId,
		...
		this.irrinvSiteId = irrinvSiteId;
	...
	public Integer getIrrinvSiteId() {
		return this.irrinvSiteId;
	}

	public void setIrrinvSiteId(Integer irrinvSiteId) {
		this.irrinvSiteId = irrinvSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IrrinvSiteId))
			return false;
		IrrinvSiteId castOther = (IrrinvSiteId) other;

		return ((this.getIrrinvSiteId() == castOther.getIrrinvSiteId()) || (this
				.getIrrinvSiteId() != null
				&& castOther.getIrrinvSiteId() != null && this
				.getIrrinvSiteId().equals(castOther.getIrrinvSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIrrinvSiteId() == null ? 0 : this.getIrrinvSiteId()
						.hashCode());
		result = 37 * result
