...
/**
 * StructuralVariantId generated by hbm2java
 */
public class StructuralVariantId implements java.io.Serializable {

	private Integer structuralVariantId;
	...
	public StructuralVariantId() {
	}

	public StructuralVariantId(Integer structuralVariantId, Integer featureId,
	...
	public Integer getStructuralVariantId() {
		return this.structuralVariantId;
	}

	public void setStructuralVariantId(Integer structuralVariantId) {
		this.structuralVariantId = structuralVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StructuralVariantId))
			return false;
		StructuralVariantId castOther = (StructuralVariantId) other;

		return ((this.getStructuralVariantId() == castOther
				.getStructuralVariantId()) || (this.getStructuralVariantId() != null
				&& castOther.getStructuralVariantId() != null && this
				.getStructuralVariantId().equals(
						castOther.getStructuralVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStructuralVariantId() == null ? 0 : this
						.getStructuralVariantId().hashCode());
		result = 37 * result
