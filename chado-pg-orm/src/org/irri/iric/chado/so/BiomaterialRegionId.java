...
/**
 * BiomaterialRegionId generated by hbm2java
 */
public class BiomaterialRegionId implements java.io.Serializable {

	private Integer biomaterialRegionId;
	...
	public BiomaterialRegionId() {
	}

	public BiomaterialRegionId(Integer biomaterialRegionId, Integer featureId,
		...
		this.biomaterialRegionId = biomaterialRegionId;
	...
	public Integer getBiomaterialRegionId() {
		return this.biomaterialRegionId;
	}

	public void setBiomaterialRegionId(Integer biomaterialRegionId) {
		this.biomaterialRegionId = biomaterialRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BiomaterialRegionId))
			return false;
		BiomaterialRegionId castOther = (BiomaterialRegionId) other;

		return ((this.getBiomaterialRegionId() == castOther
				.getBiomaterialRegionId()) || (this.getBiomaterialRegionId() != null
				&& castOther.getBiomaterialRegionId() != null && this
				.getBiomaterialRegionId().equals(
						castOther.getBiomaterialRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBiomaterialRegionId() == null ? 0 : this
						.getBiomaterialRegionId().hashCode());
		result = 37 * result
