...
/**
 * MethylinosineId generated by hbm2java
 */
public class MethylinosineId implements java.io.Serializable {

	private Integer methylinosineId;
	...
	public MethylinosineId() {
	}

	public MethylinosineId(Integer methylinosineId, Integer featureId,
		...
		this.methylinosineId = methylinosineId;
	...
	public Integer getMethylinosineId() {
		return this.methylinosineId;
	}

	public void setMethylinosineId(Integer methylinosineId) {
		this.methylinosineId = methylinosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylinosineId))
			return false;
		MethylinosineId castOther = (MethylinosineId) other;

		return ((this.getMethylinosineId() == castOther.getMethylinosineId()) || (this
				.getMethylinosineId() != null
				&& castOther.getMethylinosineId() != null && this
				.getMethylinosineId().equals(castOther.getMethylinosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylinosineId() == null ? 0 : this.getMethylinosineId()
						.hashCode());
		result = 37 * result
