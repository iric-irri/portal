...
/**
 * GcvbRnaId generated by hbm2java
 */
public class GcvbRnaId implements java.io.Serializable {

	private Integer gcvbRnaId;
	...
	public GcvbRnaId(Integer gcvbRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGcvbRnaId() {
		return this.gcvbRnaId;
	}

	public void setGcvbRnaId(Integer gcvbRnaId) {
		this.gcvbRnaId = gcvbRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GcvbRnaId))
			return false;
		GcvbRnaId castOther = (GcvbRnaId) other;

		return ((this.getGcvbRnaId() == castOther.getGcvbRnaId()) || (this
				.getGcvbRnaId() != null && castOther.getGcvbRnaId() != null && this
				.getGcvbRnaId().equals(castOther.getGcvbRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGcvbRnaId() == null ? 0 : this.getGcvbRnaId().hashCode());
		result = 37 * result
