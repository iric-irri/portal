...
/**
 * FivePrimeDHeptamerId generated by hbm2java
 */
public class FivePrimeDHeptamerId implements java.io.Serializable {

	private Integer fivePrimeDHeptamerId;
	...
	public FivePrimeDHeptamerId() {
	}

	public FivePrimeDHeptamerId(Integer fivePrimeDHeptamerId,
		...
		this.fivePrimeDHeptamerId = fivePrimeDHeptamerId;
	...
	public Integer getFivePrimeDHeptamerId() {
		return this.fivePrimeDHeptamerId;
	}

	public void setFivePrimeDHeptamerId(Integer fivePrimeDHeptamerId) {
		this.fivePrimeDHeptamerId = fivePrimeDHeptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeDHeptamerId))
			return false;
		FivePrimeDHeptamerId castOther = (FivePrimeDHeptamerId) other;

		return ((this.getFivePrimeDHeptamerId() == castOther
				.getFivePrimeDHeptamerId()) || (this.getFivePrimeDHeptamerId() != null
				&& castOther.getFivePrimeDHeptamerId() != null && this
				.getFivePrimeDHeptamerId().equals(
						castOther.getFivePrimeDHeptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeDHeptamerId() == null ? 0 : this
						.getFivePrimeDHeptamerId().hashCode());
		result = 37 * result
