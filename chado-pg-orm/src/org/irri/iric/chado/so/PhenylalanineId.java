...
/**
 * PhenylalanineId generated by hbm2java
 */
public class PhenylalanineId implements java.io.Serializable {

	private Integer phenylalanineId;
	...
	public PhenylalanineId() {
	}

	public PhenylalanineId(Integer phenylalanineId, Integer featureId,
		...
		this.phenylalanineId = phenylalanineId;
	...
	public Integer getPhenylalanineId() {
		return this.phenylalanineId;
	}

	public void setPhenylalanineId(Integer phenylalanineId) {
		this.phenylalanineId = phenylalanineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhenylalanineId))
			return false;
		PhenylalanineId castOther = (PhenylalanineId) other;

		return ((this.getPhenylalanineId() == castOther.getPhenylalanineId()) || (this
				.getPhenylalanineId() != null
				&& castOther.getPhenylalanineId() != null && this
				.getPhenylalanineId().equals(castOther.getPhenylalanineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPhenylalanineId() == null ? 0 : this.getPhenylalanineId()
						.hashCode());
		result = 37 * result
