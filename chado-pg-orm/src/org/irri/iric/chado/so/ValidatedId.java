...
/**
 * ValidatedId generated by hbm2java
 */
public class ValidatedId implements java.io.Serializable {
	...
	public ValidatedId(Integer validatedId, Integer featureId,
	...
	public Integer getValidatedId() {
		return this.validatedId;
	}

	public void setValidatedId(Integer validatedId) {
		this.validatedId = validatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ValidatedId))
			return false;
		ValidatedId castOther = (ValidatedId) other;

		return ((this.getValidatedId() == castOther.getValidatedId()) || (this
				.getValidatedId() != null && castOther.getValidatedId() != null && this
				.getValidatedId().equals(castOther.getValidatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getValidatedId() == null ? 0 : this.getValidatedId()
						.hashCode());
		result = 37 * result
