...
/**
 * AspePrimerId generated by hbm2java
 */
public class AspePrimerId implements java.io.Serializable {

	private Integer aspePrimerId;
	...
	public AspePrimerId(Integer aspePrimerId, Integer featureId,
		...
		this.aspePrimerId = aspePrimerId;
	...
	public Integer getAspePrimerId() {
		return this.aspePrimerId;
	}

	public void setAspePrimerId(Integer aspePrimerId) {
		this.aspePrimerId = aspePrimerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AspePrimerId))
			return false;
		AspePrimerId castOther = (AspePrimerId) other;

		return ((this.getAspePrimerId() == castOther.getAspePrimerId()) || (this
				.getAspePrimerId() != null
				&& castOther.getAspePrimerId() != null && this
				.getAspePrimerId().equals(castOther.getAspePrimerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAspePrimerId() == null ? 0 : this.getAspePrimerId()
						.hashCode());
		result = 37 * result
