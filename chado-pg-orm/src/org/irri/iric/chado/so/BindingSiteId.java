...
/**
 * BindingSiteId generated by hbm2java
 */
public class BindingSiteId implements java.io.Serializable {

	private Integer bindingSiteId;
	...
	public BindingSiteId() {
	}

	public BindingSiteId(Integer bindingSiteId, Integer featureId,
	...
	public Integer getBindingSiteId() {
		return this.bindingSiteId;
	}

	public void setBindingSiteId(Integer bindingSiteId) {
		this.bindingSiteId = bindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BindingSiteId))
			return false;
		BindingSiteId castOther = (BindingSiteId) other;

		return ((this.getBindingSiteId() == castOther.getBindingSiteId()) || (this
				.getBindingSiteId() != null
				&& castOther.getBindingSiteId() != null && this
				.getBindingSiteId().equals(castOther.getBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBindingSiteId() == null ? 0 : this.getBindingSiteId()
						.hashCode());
		result = 37 * result
