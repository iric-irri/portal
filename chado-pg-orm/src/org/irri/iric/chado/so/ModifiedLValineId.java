...
/**
 * ModifiedLValineId generated by hbm2java
 */
public class ModifiedLValineId implements java.io.Serializable {

	private Integer modifiedLValineId;
	...
	public ModifiedLValineId() {
	}

	public ModifiedLValineId(Integer modifiedLValineId, Integer featureId,
		...
		this.modifiedLValineId = modifiedLValineId;
	...
	public Integer getModifiedLValineId() {
		return this.modifiedLValineId;
	}

	public void setModifiedLValineId(Integer modifiedLValineId) {
		this.modifiedLValineId = modifiedLValineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLValineId))
			return false;
		ModifiedLValineId castOther = (ModifiedLValineId) other;

		return ((this.getModifiedLValineId() == castOther
				.getModifiedLValineId()) || (this.getModifiedLValineId() != null
				&& castOther.getModifiedLValineId() != null && this
				.getModifiedLValineId()
				.equals(castOther.getModifiedLValineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLValineId() == null ? 0 : this
						.getModifiedLValineId().hashCode());
		result = 37 * result
