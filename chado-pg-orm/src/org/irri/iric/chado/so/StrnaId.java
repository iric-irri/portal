...
/**
 * StrnaId generated by hbm2java
 */
public class StrnaId implements java.io.Serializable {

	private Integer strnaId;
	...
	public StrnaId(Integer strnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getStrnaId() {
		return this.strnaId;
	}

	public void setStrnaId(Integer strnaId) {
		this.strnaId = strnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StrnaId))
			return false;
		StrnaId castOther = (StrnaId) other;

		return ((this.getStrnaId() == castOther.getStrnaId()) || (this
				.getStrnaId() != null && castOther.getStrnaId() != null && this
				.getStrnaId().equals(castOther.getStrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getStrnaId() == null ? 0 : this.getStrnaId().hashCode());
		result = 37 * result
