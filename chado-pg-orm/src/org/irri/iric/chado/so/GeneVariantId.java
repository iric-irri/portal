...
/**
 * GeneVariantId generated by hbm2java
 */
public class GeneVariantId implements java.io.Serializable {

	private Integer geneVariantId;
	...
	public GeneVariantId(Integer geneVariantId, Integer featureId,
		...
		this.geneVariantId = geneVariantId;
	...
	public Integer getGeneVariantId() {
		return this.geneVariantId;
	}

	public void setGeneVariantId(Integer geneVariantId) {
		this.geneVariantId = geneVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneVariantId))
			return false;
		GeneVariantId castOther = (GeneVariantId) other;

		return ((this.getGeneVariantId() == castOther.getGeneVariantId()) || (this
				.getGeneVariantId() != null
				&& castOther.getGeneVariantId() != null && this
				.getGeneVariantId().equals(castOther.getGeneVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneVariantId() == null ? 0 : this.getGeneVariantId()
						.hashCode());
		result = 37 * result
