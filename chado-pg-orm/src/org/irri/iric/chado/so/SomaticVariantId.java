...
/**
 * SomaticVariantId generated by hbm2java
 */
public class SomaticVariantId implements java.io.Serializable {

	private Integer somaticVariantId;
	...
	public SomaticVariantId() {
	}

	public SomaticVariantId(Integer somaticVariantId, Integer featureId,
		...
		this.somaticVariantId = somaticVariantId;
	...
	public Integer getSomaticVariantId() {
		return this.somaticVariantId;
	}

	public void setSomaticVariantId(Integer somaticVariantId) {
		this.somaticVariantId = somaticVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SomaticVariantId))
			return false;
		SomaticVariantId castOther = (SomaticVariantId) other;

		return ((this.getSomaticVariantId() == castOther.getSomaticVariantId()) || (this
				.getSomaticVariantId() != null
				&& castOther.getSomaticVariantId() != null && this
				.getSomaticVariantId().equals(castOther.getSomaticVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSomaticVariantId() == null ? 0 : this
						.getSomaticVariantId().hashCode());
		result = 37 * result
