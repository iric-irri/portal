...
/**
 * MatrixAttachmentSiteId generated by hbm2java
 */
public class MatrixAttachmentSiteId implements java.io.Serializable {

	private Integer matrixAttachmentSiteId;
	...
	public MatrixAttachmentSiteId() {
	}

	public MatrixAttachmentSiteId(Integer matrixAttachmentSiteId,
		...
		this.matrixAttachmentSiteId = matrixAttachmentSiteId;
	...
	public Integer getMatrixAttachmentSiteId() {
		return this.matrixAttachmentSiteId;
	}

	public void setMatrixAttachmentSiteId(Integer matrixAttachmentSiteId) {
		this.matrixAttachmentSiteId = matrixAttachmentSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatrixAttachmentSiteId))
			return false;
		MatrixAttachmentSiteId castOther = (MatrixAttachmentSiteId) other;

		return ((this.getMatrixAttachmentSiteId() == castOther
				.getMatrixAttachmentSiteId()) || (this
				.getMatrixAttachmentSiteId() != null
				&& castOther.getMatrixAttachmentSiteId() != null && this
				.getMatrixAttachmentSiteId().equals(
						castOther.getMatrixAttachmentSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatrixAttachmentSiteId() == null ? 0 : this
						.getMatrixAttachmentSiteId().hashCode());
		result = 37 * result
