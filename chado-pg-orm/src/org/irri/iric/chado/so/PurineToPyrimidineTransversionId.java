...
/**
 * PurineToPyrimidineTransversionId generated by hbm2java
 */
public class PurineToPyrimidineTransversionId implements java.io.Serializable {

	private Integer purineToPyrimidineTransversionId;
	...
	public PurineToPyrimidineTransversionId() {
	}

	public PurineToPyrimidineTransversionId(
			Integer purineToPyrimidineTransversionId, Integer featureId,
		...
		this.purineToPyrimidineTransversionId = purineToPyrimidineTransversionId;
	...
	public Integer getPurineToPyrimidineTransversionId() {
		return this.purineToPyrimidineTransversionId;
	}

	public void setPurineToPyrimidineTransversionId(
			Integer purineToPyrimidineTransversionId) {
		this.purineToPyrimidineTransversionId = purineToPyrimidineTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PurineToPyrimidineTransversionId))
			return false;
		PurineToPyrimidineTransversionId castOther = (PurineToPyrimidineTransversionId) other;

		return ((this.getPurineToPyrimidineTransversionId() == castOther
				.getPurineToPyrimidineTransversionId()) || (this
				.getPurineToPyrimidineTransversionId() != null
				&& castOther.getPurineToPyrimidineTransversionId() != null && this
				.getPurineToPyrimidineTransversionId().equals(
						castOther.getPurineToPyrimidineTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPurineToPyrimidineTransversionId() == null ? 0 : this
						.getPurineToPyrimidineTransversionId().hashCode());
		result = 37 * result
