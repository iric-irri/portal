...
/**
 * EngineeredEpisomeId generated by hbm2java
 */
public class EngineeredEpisomeId implements java.io.Serializable {

	private Integer engineeredEpisomeId;
	...
	public EngineeredEpisomeId() {
	}

	public EngineeredEpisomeId(Integer engineeredEpisomeId, Integer featureId,
		...
		this.engineeredEpisomeId = engineeredEpisomeId;
	...
	public Integer getEngineeredEpisomeId() {
		return this.engineeredEpisomeId;
	}

	public void setEngineeredEpisomeId(Integer engineeredEpisomeId) {
		this.engineeredEpisomeId = engineeredEpisomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredEpisomeId))
			return false;
		EngineeredEpisomeId castOther = (EngineeredEpisomeId) other;

		return ((this.getEngineeredEpisomeId() == castOther
				.getEngineeredEpisomeId()) || (this.getEngineeredEpisomeId() != null
				&& castOther.getEngineeredEpisomeId() != null && this
				.getEngineeredEpisomeId().equals(
						castOther.getEngineeredEpisomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredEpisomeId() == null ? 0 : this
						.getEngineeredEpisomeId().hashCode());
		result = 37 * result
