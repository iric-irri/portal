...
/**
 * ProplastidSequenceId generated by hbm2java
 */
public class ProplastidSequenceId implements java.io.Serializable {

	private Integer proplastidSequenceId;
	...
	public ProplastidSequenceId() {
	}

	public ProplastidSequenceId(Integer proplastidSequenceId,
		...
		this.proplastidSequenceId = proplastidSequenceId;
	...
	public Integer getProplastidSequenceId() {
		return this.proplastidSequenceId;
	}

	public void setProplastidSequenceId(Integer proplastidSequenceId) {
		this.proplastidSequenceId = proplastidSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProplastidSequenceId))
			return false;
		ProplastidSequenceId castOther = (ProplastidSequenceId) other;

		return ((this.getProplastidSequenceId() == castOther
				.getProplastidSequenceId()) || (this.getProplastidSequenceId() != null
				&& castOther.getProplastidSequenceId() != null && this
				.getProplastidSequenceId().equals(
						castOther.getProplastidSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProplastidSequenceId() == null ? 0 : this
						.getProplastidSequenceId().hashCode());
		result = 37 * result
