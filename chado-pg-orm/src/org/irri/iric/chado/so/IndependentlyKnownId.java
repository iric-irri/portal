...
/**
 * IndependentlyKnownId generated by hbm2java
 */
public class IndependentlyKnownId implements java.io.Serializable {

	private Integer independentlyKnownId;
	...
	public IndependentlyKnownId() {
	}

	public IndependentlyKnownId(Integer independentlyKnownId,
		...
		this.independentlyKnownId = independentlyKnownId;
	...
	public Integer getIndependentlyKnownId() {
		return this.independentlyKnownId;
	}

	public void setIndependentlyKnownId(Integer independentlyKnownId) {
		this.independentlyKnownId = independentlyKnownId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IndependentlyKnownId))
			return false;
		IndependentlyKnownId castOther = (IndependentlyKnownId) other;

		return ((this.getIndependentlyKnownId() == castOther
				.getIndependentlyKnownId()) || (this.getIndependentlyKnownId() != null
				&& castOther.getIndependentlyKnownId() != null && this
				.getIndependentlyKnownId().equals(
						castOther.getIndependentlyKnownId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIndependentlyKnownId() == null ? 0 : this
						.getIndependentlyKnownId().hashCode());
		result = 37 * result
