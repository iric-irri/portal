...
/**
 * OneTwoPrimeODimethyladenosineId generated by hbm2java
 */
public class OneTwoPrimeODimethyladenosineId implements java.io.Serializable {

	private Integer oneTwoPrimeODimethyladenosineId;
	...
	public OneTwoPrimeODimethyladenosineId() {
	}

	public OneTwoPrimeODimethyladenosineId(
			Integer oneTwoPrimeODimethyladenosineId, Integer featureId,
		...
		this.oneTwoPrimeODimethyladenosineId = oneTwoPrimeODimethyladenosineId;
	...
	public Integer getOneTwoPrimeODimethyladenosineId() {
		return this.oneTwoPrimeODimethyladenosineId;
	}

	public void setOneTwoPrimeODimethyladenosineId(
			Integer oneTwoPrimeODimethyladenosineId) {
		this.oneTwoPrimeODimethyladenosineId = oneTwoPrimeODimethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneTwoPrimeODimethyladenosineId))
			return false;
		OneTwoPrimeODimethyladenosineId castOther = (OneTwoPrimeODimethyladenosineId) other;

		return ((this.getOneTwoPrimeODimethyladenosineId() == castOther
				.getOneTwoPrimeODimethyladenosineId()) || (this
				.getOneTwoPrimeODimethyladenosineId() != null
				&& castOther.getOneTwoPrimeODimethyladenosineId() != null && this
				.getOneTwoPrimeODimethyladenosineId().equals(
						castOther.getOneTwoPrimeODimethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneTwoPrimeODimethyladenosineId() == null ? 0 : this
						.getOneTwoPrimeODimethyladenosineId().hashCode());
		result = 37 * result
