...
/**
 * PseudogenicRrnaId generated by hbm2java
 */
public class PseudogenicRrnaId implements java.io.Serializable {

	private Integer pseudogenicRrnaId;
	...
	public PseudogenicRrnaId() {
	}

	public PseudogenicRrnaId(Integer pseudogenicRrnaId, Integer featureId,
		...
		this.pseudogenicRrnaId = pseudogenicRrnaId;
	...
	public Integer getPseudogenicRrnaId() {
		return this.pseudogenicRrnaId;
	}

	public void setPseudogenicRrnaId(Integer pseudogenicRrnaId) {
		this.pseudogenicRrnaId = pseudogenicRrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicRrnaId))
			return false;
		PseudogenicRrnaId castOther = (PseudogenicRrnaId) other;

		return ((this.getPseudogenicRrnaId() == castOther
				.getPseudogenicRrnaId()) || (this.getPseudogenicRrnaId() != null
				&& castOther.getPseudogenicRrnaId() != null && this
				.getPseudogenicRrnaId()
				.equals(castOther.getPseudogenicRrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicRrnaId() == null ? 0 : this
						.getPseudogenicRrnaId().hashCode());
		result = 37 * result
