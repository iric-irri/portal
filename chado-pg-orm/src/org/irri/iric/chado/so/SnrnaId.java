...
/**
 * SnrnaId generated by hbm2java
 */
public class SnrnaId implements java.io.Serializable {

	private Integer snrnaId;
	...
	public SnrnaId(Integer snrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSnrnaId() {
		return this.snrnaId;
	}

	public void setSnrnaId(Integer snrnaId) {
		this.snrnaId = snrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnrnaId))
			return false;
		SnrnaId castOther = (SnrnaId) other;

		return ((this.getSnrnaId() == castOther.getSnrnaId()) || (this
				.getSnrnaId() != null && castOther.getSnrnaId() != null && this
				.getSnrnaId().equals(castOther.getSnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSnrnaId() == null ? 0 : this.getSnrnaId().hashCode());
		result = 37 * result
