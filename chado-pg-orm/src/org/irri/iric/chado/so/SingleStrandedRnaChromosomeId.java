...
/**
 * SingleStrandedRnaChromosomeId generated by hbm2java
 */
public class SingleStrandedRnaChromosomeId implements java.io.Serializable {

	private Integer singleStrandedRnaChromosomeId;
	...
	public SingleStrandedRnaChromosomeId() {
	}

	public SingleStrandedRnaChromosomeId(Integer singleStrandedRnaChromosomeId,
		...
		this.singleStrandedRnaChromosomeId = singleStrandedRnaChromosomeId;
	...
	public Integer getSingleStrandedRnaChromosomeId() {
		return this.singleStrandedRnaChromosomeId;
	}

	public void setSingleStrandedRnaChromosomeId(
			Integer singleStrandedRnaChromosomeId) {
		this.singleStrandedRnaChromosomeId = singleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SingleStrandedRnaChromosomeId))
			return false;
		SingleStrandedRnaChromosomeId castOther = (SingleStrandedRnaChromosomeId) other;

		return ((this.getSingleStrandedRnaChromosomeId() == castOther
				.getSingleStrandedRnaChromosomeId()) || (this
				.getSingleStrandedRnaChromosomeId() != null
				&& castOther.getSingleStrandedRnaChromosomeId() != null && this
				.getSingleStrandedRnaChromosomeId().equals(
						castOther.getSingleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSingleStrandedRnaChromosomeId() == null ? 0 : this
						.getSingleStrandedRnaChromosomeId().hashCode());
		result = 37 * result
