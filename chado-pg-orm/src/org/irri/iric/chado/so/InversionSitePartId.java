...
/**
 * InversionSitePartId generated by hbm2java
 */
public class InversionSitePartId implements java.io.Serializable {

	private Integer inversionSitePartId;
	...
	public InversionSitePartId() {
	}

	public InversionSitePartId(Integer inversionSitePartId, Integer featureId,
		...
		this.inversionSitePartId = inversionSitePartId;
	...
	public Integer getInversionSitePartId() {
		return this.inversionSitePartId;
	}

	public void setInversionSitePartId(Integer inversionSitePartId) {
		this.inversionSitePartId = inversionSitePartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionSitePartId))
			return false;
		InversionSitePartId castOther = (InversionSitePartId) other;

		return ((this.getInversionSitePartId() == castOther
				.getInversionSitePartId()) || (this.getInversionSitePartId() != null
				&& castOther.getInversionSitePartId() != null && this
				.getInversionSitePartId().equals(
						castOther.getInversionSitePartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionSitePartId() == null ? 0 : this
						.getInversionSitePartId().hashCode());
		result = 37 * result
