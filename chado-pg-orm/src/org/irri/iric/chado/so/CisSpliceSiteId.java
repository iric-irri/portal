...
/**
 * CisSpliceSiteId generated by hbm2java
 */
public class CisSpliceSiteId implements java.io.Serializable {

	private Integer cisSpliceSiteId;
	...
	public CisSpliceSiteId() {
	}

	public CisSpliceSiteId(Integer cisSpliceSiteId, Integer featureId,
		...
		this.cisSpliceSiteId = cisSpliceSiteId;
	...
	public Integer getCisSpliceSiteId() {
		return this.cisSpliceSiteId;
	}

	public void setCisSpliceSiteId(Integer cisSpliceSiteId) {
		this.cisSpliceSiteId = cisSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CisSpliceSiteId))
			return false;
		CisSpliceSiteId castOther = (CisSpliceSiteId) other;

		return ((this.getCisSpliceSiteId() == castOther.getCisSpliceSiteId()) || (this
				.getCisSpliceSiteId() != null
				&& castOther.getCisSpliceSiteId() != null && this
				.getCisSpliceSiteId().equals(castOther.getCisSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCisSpliceSiteId() == null ? 0 : this.getCisSpliceSiteId()
						.hashCode());
		result = 37 * result
