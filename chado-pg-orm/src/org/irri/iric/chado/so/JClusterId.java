...
/**
 * JClusterId generated by hbm2java
 */
public class JClusterId implements java.io.Serializable {

	private Integer JClusterId;
	...
	public JClusterId(Integer JClusterId, Integer featureId, Integer dbxrefId,
	...
	public Integer getJClusterId() {
		return this.JClusterId;
	}

	public void setJClusterId(Integer JClusterId) {
		this.JClusterId = JClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JClusterId))
			return false;
		JClusterId castOther = (JClusterId) other;

		return ((this.getJClusterId() == castOther.getJClusterId()) || (this
				.getJClusterId() != null && castOther.getJClusterId() != null && this
				.getJClusterId().equals(castOther.getJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJClusterId() == null ? 0 : this.getJClusterId()
						.hashCode());
		result = 37 * result
