...
/**
 * FiveAminomethylTwoThiouridineId generated by hbm2java
 */
public class FiveAminomethylTwoThiouridineId implements java.io.Serializable {

	private Integer fiveAminomethylTwoThiouridineId;
	...
	public FiveAminomethylTwoThiouridineId() {
	}

	public FiveAminomethylTwoThiouridineId(
			Integer fiveAminomethylTwoThiouridineId, Integer featureId,
		...
		this.fiveAminomethylTwoThiouridineId = fiveAminomethylTwoThiouridineId;
	...
	public Integer getFiveAminomethylTwoThiouridineId() {
		return this.fiveAminomethylTwoThiouridineId;
	}

	public void setFiveAminomethylTwoThiouridineId(
			Integer fiveAminomethylTwoThiouridineId) {
		this.fiveAminomethylTwoThiouridineId = fiveAminomethylTwoThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveAminomethylTwoThiouridineId))
			return false;
		FiveAminomethylTwoThiouridineId castOther = (FiveAminomethylTwoThiouridineId) other;

		return ((this.getFiveAminomethylTwoThiouridineId() == castOther
				.getFiveAminomethylTwoThiouridineId()) || (this
				.getFiveAminomethylTwoThiouridineId() != null
				&& castOther.getFiveAminomethylTwoThiouridineId() != null && this
				.getFiveAminomethylTwoThiouridineId().equals(
						castOther.getFiveAminomethylTwoThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveAminomethylTwoThiouridineId() == null ? 0 : this
						.getFiveAminomethylTwoThiouridineId().hashCode());
		result = 37 * result
