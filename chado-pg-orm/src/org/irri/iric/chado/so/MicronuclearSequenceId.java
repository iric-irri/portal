...
/**
 * MicronuclearSequenceId generated by hbm2java
 */
public class MicronuclearSequenceId implements java.io.Serializable {

	private Integer micronuclearSequenceId;
	...
	public MicronuclearSequenceId() {
	}

	public MicronuclearSequenceId(Integer micronuclearSequenceId,
		...
		this.micronuclearSequenceId = micronuclearSequenceId;
	...
	public Integer getMicronuclearSequenceId() {
		return this.micronuclearSequenceId;
	}

	public void setMicronuclearSequenceId(Integer micronuclearSequenceId) {
		this.micronuclearSequenceId = micronuclearSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MicronuclearSequenceId))
			return false;
		MicronuclearSequenceId castOther = (MicronuclearSequenceId) other;

		return ((this.getMicronuclearSequenceId() == castOther
				.getMicronuclearSequenceId()) || (this
				.getMicronuclearSequenceId() != null
				&& castOther.getMicronuclearSequenceId() != null && this
				.getMicronuclearSequenceId().equals(
						castOther.getMicronuclearSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMicronuclearSequenceId() == null ? 0 : this
						.getMicronuclearSequenceId().hashCode());
		result = 37 * result
