...
/**
 * BipartiteDuplicationId generated by hbm2java
 */
public class BipartiteDuplicationId implements java.io.Serializable {

	private Integer bipartiteDuplicationId;
	...
	public BipartiteDuplicationId() {
	}

	public BipartiteDuplicationId(Integer bipartiteDuplicationId,
		...
		this.bipartiteDuplicationId = bipartiteDuplicationId;
	...
	public Integer getBipartiteDuplicationId() {
		return this.bipartiteDuplicationId;
	}

	public void setBipartiteDuplicationId(Integer bipartiteDuplicationId) {
		this.bipartiteDuplicationId = bipartiteDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BipartiteDuplicationId))
			return false;
		BipartiteDuplicationId castOther = (BipartiteDuplicationId) other;

		return ((this.getBipartiteDuplicationId() == castOther
				.getBipartiteDuplicationId()) || (this
				.getBipartiteDuplicationId() != null
				&& castOther.getBipartiteDuplicationId() != null && this
				.getBipartiteDuplicationId().equals(
						castOther.getBipartiteDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBipartiteDuplicationId() == null ? 0 : this
						.getBipartiteDuplicationId().hashCode());
		result = 37 * result
