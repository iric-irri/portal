...
/**
 * StickyEndRestrictionEnzymeCleavageSiteId generated by hbm2java
 */
public class StickyEndRestrictionEnzymeCleavageSiteId implements
		java.io.Serializable {

	private Integer stickyEndRestrictionEnzymeCleavageSiteId;
	...
	public StickyEndRestrictionEnzymeCleavageSiteId() {
	}

	public StickyEndRestrictionEnzymeCleavageSiteId(
			Integer stickyEndRestrictionEnzymeCleavageSiteId,
		...
		this.stickyEndRestrictionEnzymeCleavageSiteId = stickyEndRestrictionEnzymeCleavageSiteId;
	...
	public Integer getStickyEndRestrictionEnzymeCleavageSiteId() {
		return this.stickyEndRestrictionEnzymeCleavageSiteId;
	}

	public void setStickyEndRestrictionEnzymeCleavageSiteId(
			Integer stickyEndRestrictionEnzymeCleavageSiteId) {
		this.stickyEndRestrictionEnzymeCleavageSiteId = stickyEndRestrictionEnzymeCleavageSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StickyEndRestrictionEnzymeCleavageSiteId))
			return false;
		StickyEndRestrictionEnzymeCleavageSiteId castOther = (StickyEndRestrictionEnzymeCleavageSiteId) other;

		return ((this.getStickyEndRestrictionEnzymeCleavageSiteId() == castOther
				.getStickyEndRestrictionEnzymeCleavageSiteId()) || (this
				.getStickyEndRestrictionEnzymeCleavageSiteId() != null
				&& castOther.getStickyEndRestrictionEnzymeCleavageSiteId() != null && this
				.getStickyEndRestrictionEnzymeCleavageSiteId()
				.equals(castOther.getStickyEndRestrictionEnzymeCleavageSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStickyEndRestrictionEnzymeCleavageSiteId() == null ? 0
						: this.getStickyEndRestrictionEnzymeCleavageSiteId()
								.hashCode());
		result = 37 * result
