...
/**
 * LeucoplastChromosomeId generated by hbm2java
 */
public class LeucoplastChromosomeId implements java.io.Serializable {

	private Integer leucoplastChromosomeId;
	...
	public LeucoplastChromosomeId() {
	}

	public LeucoplastChromosomeId(Integer leucoplastChromosomeId,
		...
		this.leucoplastChromosomeId = leucoplastChromosomeId;
	...
	public Integer getLeucoplastChromosomeId() {
		return this.leucoplastChromosomeId;
	}

	public void setLeucoplastChromosomeId(Integer leucoplastChromosomeId) {
		this.leucoplastChromosomeId = leucoplastChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucoplastChromosomeId))
			return false;
		LeucoplastChromosomeId castOther = (LeucoplastChromosomeId) other;

		return ((this.getLeucoplastChromosomeId() == castOther
				.getLeucoplastChromosomeId()) || (this
				.getLeucoplastChromosomeId() != null
				&& castOther.getLeucoplastChromosomeId() != null && this
				.getLeucoplastChromosomeId().equals(
						castOther.getLeucoplastChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeucoplastChromosomeId() == null ? 0 : this
						.getLeucoplastChromosomeId().hashCode());
		result = 37 * result
