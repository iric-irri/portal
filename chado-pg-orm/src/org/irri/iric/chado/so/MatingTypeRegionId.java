...
/**
 * MatingTypeRegionId generated by hbm2java
 */
public class MatingTypeRegionId implements java.io.Serializable {

	private Integer matingTypeRegionId;
	...
	public MatingTypeRegionId() {
	}

	public MatingTypeRegionId(Integer matingTypeRegionId, Integer featureId,
		...
		this.matingTypeRegionId = matingTypeRegionId;
	...
	public Integer getMatingTypeRegionId() {
		return this.matingTypeRegionId;
	}

	public void setMatingTypeRegionId(Integer matingTypeRegionId) {
		this.matingTypeRegionId = matingTypeRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatingTypeRegionId))
			return false;
		MatingTypeRegionId castOther = (MatingTypeRegionId) other;

		return ((this.getMatingTypeRegionId() == castOther
				.getMatingTypeRegionId()) || (this.getMatingTypeRegionId() != null
				&& castOther.getMatingTypeRegionId() != null && this
				.getMatingTypeRegionId().equals(
						castOther.getMatingTypeRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatingTypeRegionId() == null ? 0 : this
						.getMatingTypeRegionId().hashCode());
		result = 37 * result
