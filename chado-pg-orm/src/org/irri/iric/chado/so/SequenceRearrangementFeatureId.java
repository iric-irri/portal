...
/**
 * SequenceRearrangementFeatureId generated by hbm2java
 */
public class SequenceRearrangementFeatureId implements java.io.Serializable {

	private Integer sequenceRearrangementFeatureId;
	...
	public SequenceRearrangementFeatureId() {
	}

	public SequenceRearrangementFeatureId(
			Integer sequenceRearrangementFeatureId, Integer featureId,
		...
		this.sequenceRearrangementFeatureId = sequenceRearrangementFeatureId;
	...
	public Integer getSequenceRearrangementFeatureId() {
		return this.sequenceRearrangementFeatureId;
	}

	public void setSequenceRearrangementFeatureId(
			Integer sequenceRearrangementFeatureId) {
		this.sequenceRearrangementFeatureId = sequenceRearrangementFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceRearrangementFeatureId))
			return false;
		SequenceRearrangementFeatureId castOther = (SequenceRearrangementFeatureId) other;

		return ((this.getSequenceRearrangementFeatureId() == castOther
				.getSequenceRearrangementFeatureId()) || (this
				.getSequenceRearrangementFeatureId() != null
				&& castOther.getSequenceRearrangementFeatureId() != null && this
				.getSequenceRearrangementFeatureId().equals(
						castOther.getSequenceRearrangementFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceRearrangementFeatureId() == null ? 0 : this
						.getSequenceRearrangementFeatureId().hashCode());
		result = 37 * result
