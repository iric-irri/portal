...
/**
 * LocusControlRegionId generated by hbm2java
 */
public class LocusControlRegionId implements java.io.Serializable {

	private Integer locusControlRegionId;
	...
	public LocusControlRegionId() {
	}

	public LocusControlRegionId(Integer locusControlRegionId,
		...
		this.locusControlRegionId = locusControlRegionId;
	...
	public Integer getLocusControlRegionId() {
		return this.locusControlRegionId;
	}

	public void setLocusControlRegionId(Integer locusControlRegionId) {
		this.locusControlRegionId = locusControlRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LocusControlRegionId))
			return false;
		LocusControlRegionId castOther = (LocusControlRegionId) other;

		return ((this.getLocusControlRegionId() == castOther
				.getLocusControlRegionId()) || (this.getLocusControlRegionId() != null
				&& castOther.getLocusControlRegionId() != null && this
				.getLocusControlRegionId().equals(
						castOther.getLocusControlRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLocusControlRegionId() == null ? 0 : this
						.getLocusControlRegionId().hashCode());
		result = 37 * result
