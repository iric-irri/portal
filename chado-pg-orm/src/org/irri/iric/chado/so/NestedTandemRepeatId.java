...
/**
 * NestedTandemRepeatId generated by hbm2java
 */
public class NestedTandemRepeatId implements java.io.Serializable {

	private Integer nestedTandemRepeatId;
	...
	public NestedTandemRepeatId() {
	}

	public NestedTandemRepeatId(Integer nestedTandemRepeatId,
		...
		this.nestedTandemRepeatId = nestedTandemRepeatId;
	...
	public Integer getNestedTandemRepeatId() {
		return this.nestedTandemRepeatId;
	}

	public void setNestedTandemRepeatId(Integer nestedTandemRepeatId) {
		this.nestedTandemRepeatId = nestedTandemRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NestedTandemRepeatId))
			return false;
		NestedTandemRepeatId castOther = (NestedTandemRepeatId) other;

		return ((this.getNestedTandemRepeatId() == castOther
				.getNestedTandemRepeatId()) || (this.getNestedTandemRepeatId() != null
				&& castOther.getNestedTandemRepeatId() != null && this
				.getNestedTandemRepeatId().equals(
						castOther.getNestedTandemRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNestedTandemRepeatId() == null ? 0 : this
						.getNestedTandemRepeatId().hashCode());
		result = 37 * result
