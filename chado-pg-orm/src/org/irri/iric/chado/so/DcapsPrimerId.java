...
/**
 * DcapsPrimerId generated by hbm2java
 */
public class DcapsPrimerId implements java.io.Serializable {

	private Integer dcapsPrimerId;
	...
	public DcapsPrimerId() {
	}

	public DcapsPrimerId(Integer dcapsPrimerId, Integer featureId,
		...
		this.dcapsPrimerId = dcapsPrimerId;
	...
	public Integer getDcapsPrimerId() {
		return this.dcapsPrimerId;
	}

	public void setDcapsPrimerId(Integer dcapsPrimerId) {
		this.dcapsPrimerId = dcapsPrimerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DcapsPrimerId))
			return false;
		DcapsPrimerId castOther = (DcapsPrimerId) other;

		return ((this.getDcapsPrimerId() == castOther.getDcapsPrimerId()) || (this
				.getDcapsPrimerId() != null
				&& castOther.getDcapsPrimerId() != null && this
				.getDcapsPrimerId().equals(castOther.getDcapsPrimerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDcapsPrimerId() == null ? 0 : this.getDcapsPrimerId()
						.hashCode());
		result = 37 * result
