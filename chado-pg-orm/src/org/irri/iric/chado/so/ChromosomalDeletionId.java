...
/**
 * ChromosomalDeletionId generated by hbm2java
 */
public class ChromosomalDeletionId implements java.io.Serializable {

	private Integer chromosomalDeletionId;
	...
	public ChromosomalDeletionId() {
	}

	public ChromosomalDeletionId(Integer chromosomalDeletionId,
		...
		this.chromosomalDeletionId = chromosomalDeletionId;
	...
	public Integer getChromosomalDeletionId() {
		return this.chromosomalDeletionId;
	}

	public void setChromosomalDeletionId(Integer chromosomalDeletionId) {
		this.chromosomalDeletionId = chromosomalDeletionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalDeletionId))
			return false;
		ChromosomalDeletionId castOther = (ChromosomalDeletionId) other;

		return ((this.getChromosomalDeletionId() == castOther
				.getChromosomalDeletionId()) || (this
				.getChromosomalDeletionId() != null
				&& castOther.getChromosomalDeletionId() != null && this
				.getChromosomalDeletionId().equals(
						castOther.getChromosomalDeletionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalDeletionId() == null ? 0 : this
						.getChromosomalDeletionId().hashCode());
		result = 37 * result
