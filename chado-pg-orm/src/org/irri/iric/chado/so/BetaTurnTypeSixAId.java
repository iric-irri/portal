...
/**
 * BetaTurnTypeSixAId generated by hbm2java
 */
public class BetaTurnTypeSixAId implements java.io.Serializable {

	private Integer betaTurnTypeSixAId;
	...
	public BetaTurnTypeSixAId() {
	}

	public BetaTurnTypeSixAId(Integer betaTurnTypeSixAId, Integer featureId,
		...
		this.betaTurnTypeSixAId = betaTurnTypeSixAId;
	...
	public Integer getBetaTurnTypeSixAId() {
		return this.betaTurnTypeSixAId;
	}

	public void setBetaTurnTypeSixAId(Integer betaTurnTypeSixAId) {
		this.betaTurnTypeSixAId = betaTurnTypeSixAId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeSixAId))
			return false;
		BetaTurnTypeSixAId castOther = (BetaTurnTypeSixAId) other;

		return ((this.getBetaTurnTypeSixAId() == castOther
				.getBetaTurnTypeSixAId()) || (this.getBetaTurnTypeSixAId() != null
				&& castOther.getBetaTurnTypeSixAId() != null && this
				.getBetaTurnTypeSixAId().equals(
						castOther.getBetaTurnTypeSixAId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeSixAId() == null ? 0 : this
						.getBetaTurnTypeSixAId().hashCode());
		result = 37 * result
