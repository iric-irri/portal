...
/**
 * GeneSilencedByHistoneMethylationId generated by hbm2java
 */
public class GeneSilencedByHistoneMethylationId implements java.io.Serializable {

	private Integer geneSilencedByHistoneMethylationId;
	...
	public GeneSilencedByHistoneMethylationId() {
	}

	public GeneSilencedByHistoneMethylationId(
			Integer geneSilencedByHistoneMethylationId, Integer featureId,
		...
		this.geneSilencedByHistoneMethylationId = geneSilencedByHistoneMethylationId;
	...
	public Integer getGeneSilencedByHistoneMethylationId() {
		return this.geneSilencedByHistoneMethylationId;
	}

	public void setGeneSilencedByHistoneMethylationId(
			Integer geneSilencedByHistoneMethylationId) {
		this.geneSilencedByHistoneMethylationId = geneSilencedByHistoneMethylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByHistoneMethylationId))
			return false;
		GeneSilencedByHistoneMethylationId castOther = (GeneSilencedByHistoneMethylationId) other;

		return ((this.getGeneSilencedByHistoneMethylationId() == castOther
				.getGeneSilencedByHistoneMethylationId()) || (this
				.getGeneSilencedByHistoneMethylationId() != null
				&& castOther.getGeneSilencedByHistoneMethylationId() != null && this
				.getGeneSilencedByHistoneMethylationId().equals(
						castOther.getGeneSilencedByHistoneMethylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByHistoneMethylationId() == null ? 0 : this
						.getGeneSilencedByHistoneMethylationId().hashCode());
		result = 37 * result
