...
/**
 * TataBoxId generated by hbm2java
 */
public class TataBoxId implements java.io.Serializable {

	private Integer tataBoxId;
	...
	public TataBoxId(Integer tataBoxId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTataBoxId() {
		return this.tataBoxId;
	}

	public void setTataBoxId(Integer tataBoxId) {
		this.tataBoxId = tataBoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TataBoxId))
			return false;
		TataBoxId castOther = (TataBoxId) other;

		return ((this.getTataBoxId() == castOther.getTataBoxId()) || (this
				.getTataBoxId() != null && castOther.getTataBoxId() != null && this
				.getTataBoxId().equals(castOther.getTataBoxId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTataBoxId() == null ? 0 : this.getTataBoxId().hashCode());
		result = 37 * result
