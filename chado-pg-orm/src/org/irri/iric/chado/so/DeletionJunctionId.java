...
/**
 * DeletionJunctionId generated by hbm2java
 */
public class DeletionJunctionId implements java.io.Serializable {

	private Integer deletionJunctionId;
	...
	public DeletionJunctionId() {
	}

	public DeletionJunctionId(Integer deletionJunctionId, Integer featureId,
		...
		this.deletionJunctionId = deletionJunctionId;
	...
	public Integer getDeletionJunctionId() {
		return this.deletionJunctionId;
	}

	public void setDeletionJunctionId(Integer deletionJunctionId) {
		this.deletionJunctionId = deletionJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeletionJunctionId))
			return false;
		DeletionJunctionId castOther = (DeletionJunctionId) other;

		return ((this.getDeletionJunctionId() == castOther
				.getDeletionJunctionId()) || (this.getDeletionJunctionId() != null
				&& castOther.getDeletionJunctionId() != null && this
				.getDeletionJunctionId().equals(
						castOther.getDeletionJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeletionJunctionId() == null ? 0 : this
						.getDeletionJunctionId().hashCode());
		result = 37 * result
