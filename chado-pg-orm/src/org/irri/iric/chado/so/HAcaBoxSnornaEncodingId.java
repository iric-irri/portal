...
/**
 * HAcaBoxSnornaEncodingId generated by hbm2java
 */
public class HAcaBoxSnornaEncodingId implements java.io.Serializable {

	private Integer HAcaBoxSnornaEncodingId;
	...
	public HAcaBoxSnornaEncodingId() {
	}

	public HAcaBoxSnornaEncodingId(Integer HAcaBoxSnornaEncodingId,
		...
		this.HAcaBoxSnornaEncodingId = HAcaBoxSnornaEncodingId;
	...
	public Integer getHAcaBoxSnornaEncodingId() {
		return this.HAcaBoxSnornaEncodingId;
	}

	public void setHAcaBoxSnornaEncodingId(Integer HAcaBoxSnornaEncodingId) {
		this.HAcaBoxSnornaEncodingId = HAcaBoxSnornaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HAcaBoxSnornaEncodingId))
			return false;
		HAcaBoxSnornaEncodingId castOther = (HAcaBoxSnornaEncodingId) other;

		return ((this.getHAcaBoxSnornaEncodingId() == castOther
				.getHAcaBoxSnornaEncodingId()) || (this
				.getHAcaBoxSnornaEncodingId() != null
				&& castOther.getHAcaBoxSnornaEncodingId() != null && this
				.getHAcaBoxSnornaEncodingId().equals(
						castOther.getHAcaBoxSnornaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHAcaBoxSnornaEncodingId() == null ? 0 : this
						.getHAcaBoxSnornaEncodingId().hashCode());
		result = 37 * result
