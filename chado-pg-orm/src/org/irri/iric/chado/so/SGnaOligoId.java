...
/**
 * SGnaOligoId generated by hbm2java
 */
public class SGnaOligoId implements java.io.Serializable {

	private Integer SGnaOligoId;
	...
	public SGnaOligoId(Integer SGnaOligoId, Integer featureId,
	...
	public Integer getSGnaOligoId() {
		return this.SGnaOligoId;
	}

	public void setSGnaOligoId(Integer SGnaOligoId) {
		this.SGnaOligoId = SGnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SGnaOligoId))
			return false;
		SGnaOligoId castOther = (SGnaOligoId) other;

		return ((this.getSGnaOligoId() == castOther.getSGnaOligoId()) || (this
				.getSGnaOligoId() != null && castOther.getSGnaOligoId() != null && this
				.getSGnaOligoId().equals(castOther.getSGnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSGnaOligoId() == null ? 0 : this.getSGnaOligoId()
						.hashCode());
		result = 37 * result
