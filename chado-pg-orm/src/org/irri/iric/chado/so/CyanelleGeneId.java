...
/**
 * CyanelleGeneId generated by hbm2java
 */
public class CyanelleGeneId implements java.io.Serializable {

	private Integer cyanelleGeneId;
	...
	public CyanelleGeneId() {
	}

	public CyanelleGeneId(Integer cyanelleGeneId, Integer featureId,
		...
		this.cyanelleGeneId = cyanelleGeneId;
	...
	public Integer getCyanelleGeneId() {
		return this.cyanelleGeneId;
	}

	public void setCyanelleGeneId(Integer cyanelleGeneId) {
		this.cyanelleGeneId = cyanelleGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CyanelleGeneId))
			return false;
		CyanelleGeneId castOther = (CyanelleGeneId) other;

		return ((this.getCyanelleGeneId() == castOther.getCyanelleGeneId()) || (this
				.getCyanelleGeneId() != null
				&& castOther.getCyanelleGeneId() != null && this
				.getCyanelleGeneId().equals(castOther.getCyanelleGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCyanelleGeneId() == null ? 0 : this.getCyanelleGeneId()
						.hashCode());
		result = 37 * result
