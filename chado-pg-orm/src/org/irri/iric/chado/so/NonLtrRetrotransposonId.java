...
/**
 * NonLtrRetrotransposonId generated by hbm2java
 */
public class NonLtrRetrotransposonId implements java.io.Serializable {

	private Integer nonLtrRetrotransposonId;
	...
	public NonLtrRetrotransposonId() {
	}

	public NonLtrRetrotransposonId(Integer nonLtrRetrotransposonId,
		...
		this.nonLtrRetrotransposonId = nonLtrRetrotransposonId;
	...
	public Integer getNonLtrRetrotransposonId() {
		return this.nonLtrRetrotransposonId;
	}

	public void setNonLtrRetrotransposonId(Integer nonLtrRetrotransposonId) {
		this.nonLtrRetrotransposonId = nonLtrRetrotransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonLtrRetrotransposonId))
			return false;
		NonLtrRetrotransposonId castOther = (NonLtrRetrotransposonId) other;

		return ((this.getNonLtrRetrotransposonId() == castOther
				.getNonLtrRetrotransposonId()) || (this
				.getNonLtrRetrotransposonId() != null
				&& castOther.getNonLtrRetrotransposonId() != null && this
				.getNonLtrRetrotransposonId().equals(
						castOther.getNonLtrRetrotransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonLtrRetrotransposonId() == null ? 0 : this
						.getNonLtrRetrotransposonId().hashCode());
		result = 37 * result
