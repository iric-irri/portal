...
/**
 * SnpId generated by hbm2java
 */
public class SnpId implements java.io.Serializable {
	...
	public SnpId(Integer snpId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnpId))
			return false;
		SnpId castOther = (SnpId) other;

		return ((this.getSnpId() == castOther.getSnpId()) || (this.getSnpId() != null
				&& castOther.getSnpId() != null && this.getSnpId().equals(
				castOther.getSnpId())))
