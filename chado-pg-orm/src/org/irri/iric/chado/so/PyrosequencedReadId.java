...
/**
 * PyrosequencedReadId generated by hbm2java
 */
public class PyrosequencedReadId implements java.io.Serializable {

	private Integer pyrosequencedReadId;
	...
	public PyrosequencedReadId() {
	}

	public PyrosequencedReadId(Integer pyrosequencedReadId, Integer featureId,
		...
		this.pyrosequencedReadId = pyrosequencedReadId;
	...
	public Integer getPyrosequencedReadId() {
		return this.pyrosequencedReadId;
	}

	public void setPyrosequencedReadId(Integer pyrosequencedReadId) {
		this.pyrosequencedReadId = pyrosequencedReadId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrosequencedReadId))
			return false;
		PyrosequencedReadId castOther = (PyrosequencedReadId) other;

		return ((this.getPyrosequencedReadId() == castOther
				.getPyrosequencedReadId()) || (this.getPyrosequencedReadId() != null
				&& castOther.getPyrosequencedReadId() != null && this
				.getPyrosequencedReadId().equals(
						castOther.getPyrosequencedReadId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrosequencedReadId() == null ? 0 : this
						.getPyrosequencedReadId().hashCode());
		result = 37 * result
