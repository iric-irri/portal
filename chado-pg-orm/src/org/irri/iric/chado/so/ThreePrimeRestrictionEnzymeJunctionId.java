...
/**
 * ThreePrimeRestrictionEnzymeJunctionId generated by hbm2java
 */
public class ThreePrimeRestrictionEnzymeJunctionId implements
		java.io.Serializable {

	private Integer threePrimeRestrictionEnzymeJunctionId;
	...
	public ThreePrimeRestrictionEnzymeJunctionId() {
	}

	public ThreePrimeRestrictionEnzymeJunctionId(
			Integer threePrimeRestrictionEnzymeJunctionId, Integer featureId,
		...
		this.threePrimeRestrictionEnzymeJunctionId = threePrimeRestrictionEnzymeJunctionId;
	...
	public Integer getThreePrimeRestrictionEnzymeJunctionId() {
		return this.threePrimeRestrictionEnzymeJunctionId;
	}

	public void setThreePrimeRestrictionEnzymeJunctionId(
			Integer threePrimeRestrictionEnzymeJunctionId) {
		this.threePrimeRestrictionEnzymeJunctionId = threePrimeRestrictionEnzymeJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeRestrictionEnzymeJunctionId))
			return false;
		ThreePrimeRestrictionEnzymeJunctionId castOther = (ThreePrimeRestrictionEnzymeJunctionId) other;

		return ((this.getThreePrimeRestrictionEnzymeJunctionId() == castOther
				.getThreePrimeRestrictionEnzymeJunctionId()) || (this
				.getThreePrimeRestrictionEnzymeJunctionId() != null
				&& castOther.getThreePrimeRestrictionEnzymeJunctionId() != null && this
				.getThreePrimeRestrictionEnzymeJunctionId().equals(
						castOther.getThreePrimeRestrictionEnzymeJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeRestrictionEnzymeJunctionId() == null ? 0
						: this.getThreePrimeRestrictionEnzymeJunctionId()
								.hashCode());
		result = 37 * result
