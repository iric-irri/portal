...
/**
 * ConsensusMrnaId generated by hbm2java
 */
public class ConsensusMrnaId implements java.io.Serializable {

	private Integer consensusMrnaId;
	...
	public ConsensusMrnaId() {
	}

	public ConsensusMrnaId(Integer consensusMrnaId, Integer featureId,
		...
		this.consensusMrnaId = consensusMrnaId;
	...
	public Integer getConsensusMrnaId() {
		return this.consensusMrnaId;
	}

	public void setConsensusMrnaId(Integer consensusMrnaId) {
		this.consensusMrnaId = consensusMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConsensusMrnaId))
			return false;
		ConsensusMrnaId castOther = (ConsensusMrnaId) other;

		return ((this.getConsensusMrnaId() == castOther.getConsensusMrnaId()) || (this
				.getConsensusMrnaId() != null
				&& castOther.getConsensusMrnaId() != null && this
				.getConsensusMrnaId().equals(castOther.getConsensusMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConsensusMrnaId() == null ? 0 : this.getConsensusMrnaId()
						.hashCode());
		result = 37 * result
