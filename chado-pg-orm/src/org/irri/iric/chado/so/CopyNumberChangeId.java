...
/**
 * CopyNumberChangeId generated by hbm2java
 */
public class CopyNumberChangeId implements java.io.Serializable {

	private Integer copyNumberChangeId;
	...
	public CopyNumberChangeId() {
	}

	public CopyNumberChangeId(Integer copyNumberChangeId, Integer featureId,
		...
		this.copyNumberChangeId = copyNumberChangeId;
	...
	public Integer getCopyNumberChangeId() {
		return this.copyNumberChangeId;
	}

	public void setCopyNumberChangeId(Integer copyNumberChangeId) {
		this.copyNumberChangeId = copyNumberChangeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CopyNumberChangeId))
			return false;
		CopyNumberChangeId castOther = (CopyNumberChangeId) other;

		return ((this.getCopyNumberChangeId() == castOther
				.getCopyNumberChangeId()) || (this.getCopyNumberChangeId() != null
				&& castOther.getCopyNumberChangeId() != null && this
				.getCopyNumberChangeId().equals(
						castOther.getCopyNumberChangeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCopyNumberChangeId() == null ? 0 : this
						.getCopyNumberChangeId().hashCode());
		result = 37 * result
