...
/**
 * GenomicCloneId generated by hbm2java
 */
public class GenomicCloneId implements java.io.Serializable {

	private Integer genomicCloneId;
	...
	public GenomicCloneId() {
	}

	public GenomicCloneId(Integer genomicCloneId, Integer featureId,
		...
		this.genomicCloneId = genomicCloneId;
	...
	public Integer getGenomicCloneId() {
		return this.genomicCloneId;
	}

	public void setGenomicCloneId(Integer genomicCloneId) {
		this.genomicCloneId = genomicCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenomicCloneId))
			return false;
		GenomicCloneId castOther = (GenomicCloneId) other;

		return ((this.getGenomicCloneId() == castOther.getGenomicCloneId()) || (this
				.getGenomicCloneId() != null
				&& castOther.getGenomicCloneId() != null && this
				.getGenomicCloneId().equals(castOther.getGenomicCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGenomicCloneId() == null ? 0 : this.getGenomicCloneId()
						.hashCode());
		result = 37 * result
