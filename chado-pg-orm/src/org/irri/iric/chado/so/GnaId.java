...
/**
 * GnaId generated by hbm2java
 */
public class GnaId implements java.io.Serializable {

	private Integer gnaId;
	...
	public GnaId(Integer gnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGnaId() {
		return this.gnaId;
	}

	public void setGnaId(Integer gnaId) {
		this.gnaId = gnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GnaId))
			return false;
		GnaId castOther = (GnaId) other;

		return ((this.getGnaId() == castOther.getGnaId()) || (this.getGnaId() != null
				&& castOther.getGnaId() != null && this.getGnaId().equals(
				castOther.getGnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGnaId() == null ? 0 : this.getGnaId().hashCode());
		result = 37 * result
