...
/**
 * RetronId generated by hbm2java
 */
public class RetronId implements java.io.Serializable {

	private Integer retronId;
	...
	public RetronId(Integer retronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRetronId() {
		return this.retronId;
	}

	public void setRetronId(Integer retronId) {
		this.retronId = retronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RetronId))
			return false;
		RetronId castOther = (RetronId) other;

		return ((this.getRetronId() == castOther.getRetronId()) || (this
				.getRetronId() != null && castOther.getRetronId() != null && this
				.getRetronId().equals(castOther.getRetronId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRetronId() == null ? 0 : this.getRetronId().hashCode());
		result = 37 * result
