...
/**
 * IntergenicVariantId generated by hbm2java
 */
public class IntergenicVariantId implements java.io.Serializable {

	private Integer intergenicVariantId;
	...
	public IntergenicVariantId() {
	}

	public IntergenicVariantId(Integer intergenicVariantId, Integer featureId,
		...
		this.intergenicVariantId = intergenicVariantId;
	...
	public Integer getIntergenicVariantId() {
		return this.intergenicVariantId;
	}

	public void setIntergenicVariantId(Integer intergenicVariantId) {
		this.intergenicVariantId = intergenicVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntergenicVariantId))
			return false;
		IntergenicVariantId castOther = (IntergenicVariantId) other;

		return ((this.getIntergenicVariantId() == castOther
				.getIntergenicVariantId()) || (this.getIntergenicVariantId() != null
				&& castOther.getIntergenicVariantId() != null && this
				.getIntergenicVariantId().equals(
						castOther.getIntergenicVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntergenicVariantId() == null ? 0 : this
						.getIntergenicVariantId().hashCode());
		result = 37 * result
