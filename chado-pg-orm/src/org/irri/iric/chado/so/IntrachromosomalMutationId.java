...
/**
 * IntrachromosomalMutationId generated by hbm2java
 */
public class IntrachromosomalMutationId implements java.io.Serializable {

	private Integer intrachromosomalMutationId;
	...
	public IntrachromosomalMutationId() {
	}

	public IntrachromosomalMutationId(Integer intrachromosomalMutationId,
		...
		this.intrachromosomalMutationId = intrachromosomalMutationId;
	...
	public Integer getIntrachromosomalMutationId() {
		return this.intrachromosomalMutationId;
	}

	public void setIntrachromosomalMutationId(Integer intrachromosomalMutationId) {
		this.intrachromosomalMutationId = intrachromosomalMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrachromosomalMutationId))
			return false;
		IntrachromosomalMutationId castOther = (IntrachromosomalMutationId) other;

		return ((this.getIntrachromosomalMutationId() == castOther
				.getIntrachromosomalMutationId()) || (this
				.getIntrachromosomalMutationId() != null
				&& castOther.getIntrachromosomalMutationId() != null && this
				.getIntrachromosomalMutationId().equals(
						castOther.getIntrachromosomalMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrachromosomalMutationId() == null ? 0 : this
						.getIntrachromosomalMutationId().hashCode());
		result = 37 * result
