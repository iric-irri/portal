...
/**
 * GeneticMarkerId generated by hbm2java
 */
public class GeneticMarkerId implements java.io.Serializable {

	private Integer geneticMarkerId;
	...
	public GeneticMarkerId() {
	}

	public GeneticMarkerId(Integer geneticMarkerId, Integer featureId,
	...
	public Integer getGeneticMarkerId() {
		return this.geneticMarkerId;
	}

	public void setGeneticMarkerId(Integer geneticMarkerId) {
		this.geneticMarkerId = geneticMarkerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneticMarkerId))
			return false;
		GeneticMarkerId castOther = (GeneticMarkerId) other;

		return ((this.getGeneticMarkerId() == castOther.getGeneticMarkerId()) || (this
				.getGeneticMarkerId() != null
				&& castOther.getGeneticMarkerId() != null && this
				.getGeneticMarkerId().equals(castOther.getGeneticMarkerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneticMarkerId() == null ? 0 : this.getGeneticMarkerId()
						.hashCode());
		result = 37 * result
