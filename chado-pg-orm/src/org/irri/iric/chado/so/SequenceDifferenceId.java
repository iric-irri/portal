...
/**
 * SequenceDifferenceId generated by hbm2java
 */
public class SequenceDifferenceId implements java.io.Serializable {

	private Integer sequenceDifferenceId;
	...
	public SequenceDifferenceId() {
	}

	public SequenceDifferenceId(Integer sequenceDifferenceId,
		...
		this.sequenceDifferenceId = sequenceDifferenceId;
	...
	public Integer getSequenceDifferenceId() {
		return this.sequenceDifferenceId;
	}

	public void setSequenceDifferenceId(Integer sequenceDifferenceId) {
		this.sequenceDifferenceId = sequenceDifferenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceDifferenceId))
			return false;
		SequenceDifferenceId castOther = (SequenceDifferenceId) other;

		return ((this.getSequenceDifferenceId() == castOther
				.getSequenceDifferenceId()) || (this.getSequenceDifferenceId() != null
				&& castOther.getSequenceDifferenceId() != null && this
				.getSequenceDifferenceId().equals(
						castOther.getSequenceDifferenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceDifferenceId() == null ? 0 : this
						.getSequenceDifferenceId().hashCode());
		result = 37 * result
