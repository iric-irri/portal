...
/**
 * PeptideLocalizationSignalId generated by hbm2java
 */
public class PeptideLocalizationSignalId implements java.io.Serializable {

	private Integer peptideLocalizationSignalId;
	...
	public PeptideLocalizationSignalId() {
	}

	public PeptideLocalizationSignalId(Integer peptideLocalizationSignalId,
		...
		this.peptideLocalizationSignalId = peptideLocalizationSignalId;
	...
	public Integer getPeptideLocalizationSignalId() {
		return this.peptideLocalizationSignalId;
	}

	public void setPeptideLocalizationSignalId(
			Integer peptideLocalizationSignalId) {
		this.peptideLocalizationSignalId = peptideLocalizationSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeptideLocalizationSignalId))
			return false;
		PeptideLocalizationSignalId castOther = (PeptideLocalizationSignalId) other;

		return ((this.getPeptideLocalizationSignalId() == castOther
				.getPeptideLocalizationSignalId()) || (this
				.getPeptideLocalizationSignalId() != null
				&& castOther.getPeptideLocalizationSignalId() != null && this
				.getPeptideLocalizationSignalId().equals(
						castOther.getPeptideLocalizationSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeptideLocalizationSignalId() == null ? 0 : this
						.getPeptideLocalizationSignalId().hashCode());
		result = 37 * result
