...
/**
 * ChromosomeArmId generated by hbm2java
 */
public class ChromosomeArmId implements java.io.Serializable {

	private Integer chromosomeArmId;
	...
	public ChromosomeArmId() {
	}

	public ChromosomeArmId(Integer chromosomeArmId, Integer featureId,
		...
		this.chromosomeArmId = chromosomeArmId;
	...
	public Integer getChromosomeArmId() {
		return this.chromosomeArmId;
	}

	public void setChromosomeArmId(Integer chromosomeArmId) {
		this.chromosomeArmId = chromosomeArmId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeArmId))
			return false;
		ChromosomeArmId castOther = (ChromosomeArmId) other;

		return ((this.getChromosomeArmId() == castOther.getChromosomeArmId()) || (this
				.getChromosomeArmId() != null
				&& castOther.getChromosomeArmId() != null && this
				.getChromosomeArmId().equals(castOther.getChromosomeArmId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeArmId() == null ? 0 : this.getChromosomeArmId()
						.hashCode());
		result = 37 * result
