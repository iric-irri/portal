...
/**
 * SilencedId generated by hbm2java
 */
public class SilencedId implements java.io.Serializable {

	private Integer silencedId;
	...
	public SilencedId(Integer silencedId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSilencedId() {
		return this.silencedId;
	}

	public void setSilencedId(Integer silencedId) {
		this.silencedId = silencedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedId))
			return false;
		SilencedId castOther = (SilencedId) other;

		return ((this.getSilencedId() == castOther.getSilencedId()) || (this
				.getSilencedId() != null && castOther.getSilencedId() != null && this
				.getSilencedId().equals(castOther.getSilencedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedId() == null ? 0 : this.getSilencedId()
						.hashCode());
		result = 37 * result
