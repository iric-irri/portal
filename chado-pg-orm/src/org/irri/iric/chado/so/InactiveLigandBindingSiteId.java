...
/**
 * InactiveLigandBindingSiteId generated by hbm2java
 */
public class InactiveLigandBindingSiteId implements java.io.Serializable {

	private Integer inactiveLigandBindingSiteId;
	...
	public InactiveLigandBindingSiteId() {
	}

	public InactiveLigandBindingSiteId(Integer inactiveLigandBindingSiteId,
		...
		this.inactiveLigandBindingSiteId = inactiveLigandBindingSiteId;
	...
	public Integer getInactiveLigandBindingSiteId() {
		return this.inactiveLigandBindingSiteId;
	}

	public void setInactiveLigandBindingSiteId(
			Integer inactiveLigandBindingSiteId) {
		this.inactiveLigandBindingSiteId = inactiveLigandBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InactiveLigandBindingSiteId))
			return false;
		InactiveLigandBindingSiteId castOther = (InactiveLigandBindingSiteId) other;

		return ((this.getInactiveLigandBindingSiteId() == castOther
				.getInactiveLigandBindingSiteId()) || (this
				.getInactiveLigandBindingSiteId() != null
				&& castOther.getInactiveLigandBindingSiteId() != null && this
				.getInactiveLigandBindingSiteId().equals(
						castOther.getInactiveLigandBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInactiveLigandBindingSiteId() == null ? 0 : this
						.getInactiveLigandBindingSiteId().hashCode());
		result = 37 * result
