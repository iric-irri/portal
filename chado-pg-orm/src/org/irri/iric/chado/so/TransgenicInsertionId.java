...
/**
 * TransgenicInsertionId generated by hbm2java
 */
public class TransgenicInsertionId implements java.io.Serializable {

	private Integer transgenicInsertionId;
	...
	public TransgenicInsertionId() {
	}

	public TransgenicInsertionId(Integer transgenicInsertionId,
		...
		this.transgenicInsertionId = transgenicInsertionId;
	...
	public Integer getTransgenicInsertionId() {
		return this.transgenicInsertionId;
	}

	public void setTransgenicInsertionId(Integer transgenicInsertionId) {
		this.transgenicInsertionId = transgenicInsertionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransgenicInsertionId))
			return false;
		TransgenicInsertionId castOther = (TransgenicInsertionId) other;

		return ((this.getTransgenicInsertionId() == castOther
				.getTransgenicInsertionId()) || (this
				.getTransgenicInsertionId() != null
				&& castOther.getTransgenicInsertionId() != null && this
				.getTransgenicInsertionId().equals(
						castOther.getTransgenicInsertionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransgenicInsertionId() == null ? 0 : this
						.getTransgenicInsertionId().hashCode());
		result = 37 * result
