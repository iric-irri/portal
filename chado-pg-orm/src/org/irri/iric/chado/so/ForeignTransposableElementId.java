...
/**
 * ForeignTransposableElementId generated by hbm2java
 */
public class ForeignTransposableElementId implements java.io.Serializable {

	private Integer foreignTransposableElementId;
	...
	public ForeignTransposableElementId() {
	}

	public ForeignTransposableElementId(Integer foreignTransposableElementId,
		...
		this.foreignTransposableElementId = foreignTransposableElementId;
	...
	public Integer getForeignTransposableElementId() {
		return this.foreignTransposableElementId;
	}

	public void setForeignTransposableElementId(
			Integer foreignTransposableElementId) {
		this.foreignTransposableElementId = foreignTransposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ForeignTransposableElementId))
			return false;
		ForeignTransposableElementId castOther = (ForeignTransposableElementId) other;

		return ((this.getForeignTransposableElementId() == castOther
				.getForeignTransposableElementId()) || (this
				.getForeignTransposableElementId() != null
				&& castOther.getForeignTransposableElementId() != null && this
				.getForeignTransposableElementId().equals(
						castOther.getForeignTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getForeignTransposableElementId() == null ? 0 : this
						.getForeignTransposableElementId().hashCode());
		result = 37 * result
