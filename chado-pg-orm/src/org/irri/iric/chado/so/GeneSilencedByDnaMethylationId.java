...
/**
 * GeneSilencedByDnaMethylationId generated by hbm2java
 */
public class GeneSilencedByDnaMethylationId implements java.io.Serializable {

	private Integer geneSilencedByDnaMethylationId;
	...
	public GeneSilencedByDnaMethylationId() {
	}

	public GeneSilencedByDnaMethylationId(
			Integer geneSilencedByDnaMethylationId, Integer featureId,
		...
		this.geneSilencedByDnaMethylationId = geneSilencedByDnaMethylationId;
	...
	public Integer getGeneSilencedByDnaMethylationId() {
		return this.geneSilencedByDnaMethylationId;
	}

	public void setGeneSilencedByDnaMethylationId(
			Integer geneSilencedByDnaMethylationId) {
		this.geneSilencedByDnaMethylationId = geneSilencedByDnaMethylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByDnaMethylationId))
			return false;
		GeneSilencedByDnaMethylationId castOther = (GeneSilencedByDnaMethylationId) other;

		return ((this.getGeneSilencedByDnaMethylationId() == castOther
				.getGeneSilencedByDnaMethylationId()) || (this
				.getGeneSilencedByDnaMethylationId() != null
				&& castOther.getGeneSilencedByDnaMethylationId() != null && this
				.getGeneSilencedByDnaMethylationId().equals(
						castOther.getGeneSilencedByDnaMethylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByDnaMethylationId() == null ? 0 : this
						.getGeneSilencedByDnaMethylationId().hashCode());
		result = 37 * result
