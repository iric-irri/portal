...
/**
 * RetrotransposedId generated by hbm2java
 */
public class RetrotransposedId implements java.io.Serializable {

	private Integer retrotransposedId;
	...
	public RetrotransposedId() {
	}

	public RetrotransposedId(Integer retrotransposedId, Integer featureId,
		...
		this.retrotransposedId = retrotransposedId;
	...
	public Integer getRetrotransposedId() {
		return this.retrotransposedId;
	}

	public void setRetrotransposedId(Integer retrotransposedId) {
		this.retrotransposedId = retrotransposedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RetrotransposedId))
			return false;
		RetrotransposedId castOther = (RetrotransposedId) other;

		return ((this.getRetrotransposedId() == castOther
				.getRetrotransposedId()) || (this.getRetrotransposedId() != null
				&& castOther.getRetrotransposedId() != null && this
				.getRetrotransposedId()
				.equals(castOther.getRetrotransposedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRetrotransposedId() == null ? 0 : this
						.getRetrotransposedId().hashCode());
		result = 37 * result
