...
/**
 * PericentricId generated by hbm2java
 */
public class PericentricId implements java.io.Serializable {

	private Integer pericentricId;
	...
	public PericentricId() {
	}

	public PericentricId(Integer pericentricId, Integer featureId,
		...
		this.pericentricId = pericentricId;
	...
	public Integer getPericentricId() {
		return this.pericentricId;
	}

	public void setPericentricId(Integer pericentricId) {
		this.pericentricId = pericentricId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PericentricId))
			return false;
		PericentricId castOther = (PericentricId) other;

		return ((this.getPericentricId() == castOther.getPericentricId()) || (this
				.getPericentricId() != null
				&& castOther.getPericentricId() != null && this
				.getPericentricId().equals(castOther.getPericentricId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPericentricId() == null ? 0 : this.getPericentricId()
						.hashCode());
		result = 37 * result
