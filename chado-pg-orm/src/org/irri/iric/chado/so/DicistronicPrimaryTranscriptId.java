...
/**
 * DicistronicPrimaryTranscriptId generated by hbm2java
 */
public class DicistronicPrimaryTranscriptId implements java.io.Serializable {

	private Integer dicistronicPrimaryTranscriptId;
	...
	public DicistronicPrimaryTranscriptId() {
	}

	public DicistronicPrimaryTranscriptId(
			Integer dicistronicPrimaryTranscriptId, Integer featureId,
		...
		this.dicistronicPrimaryTranscriptId = dicistronicPrimaryTranscriptId;
	...
	public Integer getDicistronicPrimaryTranscriptId() {
		return this.dicistronicPrimaryTranscriptId;
	}

	public void setDicistronicPrimaryTranscriptId(
			Integer dicistronicPrimaryTranscriptId) {
		this.dicistronicPrimaryTranscriptId = dicistronicPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DicistronicPrimaryTranscriptId))
			return false;
		DicistronicPrimaryTranscriptId castOther = (DicistronicPrimaryTranscriptId) other;

		return ((this.getDicistronicPrimaryTranscriptId() == castOther
				.getDicistronicPrimaryTranscriptId()) || (this
				.getDicistronicPrimaryTranscriptId() != null
				&& castOther.getDicistronicPrimaryTranscriptId() != null && this
				.getDicistronicPrimaryTranscriptId().equals(
						castOther.getDicistronicPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDicistronicPrimaryTranscriptId() == null ? 0 : this
						.getDicistronicPrimaryTranscriptId().hashCode());
		result = 37 * result
