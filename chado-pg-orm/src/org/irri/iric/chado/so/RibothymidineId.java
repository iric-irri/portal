...
/**
 * RibothymidineId generated by hbm2java
 */
public class RibothymidineId implements java.io.Serializable {

	private Integer ribothymidineId;
	...
	public RibothymidineId() {
	}

	public RibothymidineId(Integer ribothymidineId, Integer featureId,
		...
		this.ribothymidineId = ribothymidineId;
	...
	public Integer getRibothymidineId() {
		return this.ribothymidineId;
	}

	public void setRibothymidineId(Integer ribothymidineId) {
		this.ribothymidineId = ribothymidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RibothymidineId))
			return false;
		RibothymidineId castOther = (RibothymidineId) other;

		return ((this.getRibothymidineId() == castOther.getRibothymidineId()) || (this
				.getRibothymidineId() != null
				&& castOther.getRibothymidineId() != null && this
				.getRibothymidineId().equals(castOther.getRibothymidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRibothymidineId() == null ? 0 : this.getRibothymidineId()
						.hashCode());
		result = 37 * result
