...
/**
 * VdjCClusterId generated by hbm2java
 */
public class VdjCClusterId implements java.io.Serializable {

	private Integer vdjCClusterId;
	...
	public VdjCClusterId() {
	}

	public VdjCClusterId(Integer vdjCClusterId, Integer featureId,
		...
		this.vdjCClusterId = vdjCClusterId;
	...
	public Integer getVdjCClusterId() {
		return this.vdjCClusterId;
	}

	public void setVdjCClusterId(Integer vdjCClusterId) {
		this.vdjCClusterId = vdjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VdjCClusterId))
			return false;
		VdjCClusterId castOther = (VdjCClusterId) other;

		return ((this.getVdjCClusterId() == castOther.getVdjCClusterId()) || (this
				.getVdjCClusterId() != null
				&& castOther.getVdjCClusterId() != null && this
				.getVdjCClusterId().equals(castOther.getVdjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVdjCClusterId() == null ? 0 : this.getVdjCClusterId()
						.hashCode());
		result = 37 * result
