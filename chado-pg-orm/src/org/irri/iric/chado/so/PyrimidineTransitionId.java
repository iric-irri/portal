...
/**
 * PyrimidineTransitionId generated by hbm2java
 */
public class PyrimidineTransitionId implements java.io.Serializable {

	private Integer pyrimidineTransitionId;
	...
	public PyrimidineTransitionId() {
	}

	public PyrimidineTransitionId(Integer pyrimidineTransitionId,
		...
		this.pyrimidineTransitionId = pyrimidineTransitionId;
	...
	public Integer getPyrimidineTransitionId() {
		return this.pyrimidineTransitionId;
	}

	public void setPyrimidineTransitionId(Integer pyrimidineTransitionId) {
		this.pyrimidineTransitionId = pyrimidineTransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrimidineTransitionId))
			return false;
		PyrimidineTransitionId castOther = (PyrimidineTransitionId) other;

		return ((this.getPyrimidineTransitionId() == castOther
				.getPyrimidineTransitionId()) || (this
				.getPyrimidineTransitionId() != null
				&& castOther.getPyrimidineTransitionId() != null && this
				.getPyrimidineTransitionId().equals(
						castOther.getPyrimidineTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrimidineTransitionId() == null ? 0 : this
						.getPyrimidineTransitionId().hashCode());
		result = 37 * result
