...
/**
 * ConservativeAminoAcidSubstitutionId generated by hbm2java
 */
public class ConservativeAminoAcidSubstitutionId implements
		java.io.Serializable {

	private Integer conservativeAminoAcidSubstitutionId;
	...
	public ConservativeAminoAcidSubstitutionId() {
	}

	public ConservativeAminoAcidSubstitutionId(
			Integer conservativeAminoAcidSubstitutionId, Integer featureId,
		...
		this.conservativeAminoAcidSubstitutionId = conservativeAminoAcidSubstitutionId;
	...
	public Integer getConservativeAminoAcidSubstitutionId() {
		return this.conservativeAminoAcidSubstitutionId;
	}

	public void setConservativeAminoAcidSubstitutionId(
			Integer conservativeAminoAcidSubstitutionId) {
		this.conservativeAminoAcidSubstitutionId = conservativeAminoAcidSubstitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConservativeAminoAcidSubstitutionId))
			return false;
		ConservativeAminoAcidSubstitutionId castOther = (ConservativeAminoAcidSubstitutionId) other;

		return ((this.getConservativeAminoAcidSubstitutionId() == castOther
				.getConservativeAminoAcidSubstitutionId()) || (this
				.getConservativeAminoAcidSubstitutionId() != null
				&& castOther.getConservativeAminoAcidSubstitutionId() != null && this
				.getConservativeAminoAcidSubstitutionId().equals(
						castOther.getConservativeAminoAcidSubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConservativeAminoAcidSubstitutionId() == null ? 0 : this
						.getConservativeAminoAcidSubstitutionId().hashCode());
		result = 37 * result
