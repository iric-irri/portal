...
/**
 * RpraRnaId generated by hbm2java
 */
public class RpraRnaId implements java.io.Serializable {

	private Integer rpraRnaId;
	...
	public RpraRnaId(Integer rpraRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRpraRnaId() {
		return this.rpraRnaId;
	}

	public void setRpraRnaId(Integer rpraRnaId) {
		this.rpraRnaId = rpraRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RpraRnaId))
			return false;
		RpraRnaId castOther = (RpraRnaId) other;

		return ((this.getRpraRnaId() == castOther.getRpraRnaId()) || (this
				.getRpraRnaId() != null && castOther.getRpraRnaId() != null && this
				.getRpraRnaId().equals(castOther.getRpraRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRpraRnaId() == null ? 0 : this.getRpraRnaId().hashCode());
		result = 37 * result
