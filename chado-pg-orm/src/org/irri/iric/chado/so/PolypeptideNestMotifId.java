...
/**
 * PolypeptideNestMotifId generated by hbm2java
 */
public class PolypeptideNestMotifId implements java.io.Serializable {

	private Integer polypeptideNestMotifId;
	...
	public PolypeptideNestMotifId() {
	}

	public PolypeptideNestMotifId(Integer polypeptideNestMotifId,
		...
		this.polypeptideNestMotifId = polypeptideNestMotifId;
	...
	public Integer getPolypeptideNestMotifId() {
		return this.polypeptideNestMotifId;
	}

	public void setPolypeptideNestMotifId(Integer polypeptideNestMotifId) {
		this.polypeptideNestMotifId = polypeptideNestMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideNestMotifId))
			return false;
		PolypeptideNestMotifId castOther = (PolypeptideNestMotifId) other;

		return ((this.getPolypeptideNestMotifId() == castOther
				.getPolypeptideNestMotifId()) || (this
				.getPolypeptideNestMotifId() != null
				&& castOther.getPolypeptideNestMotifId() != null && this
				.getPolypeptideNestMotifId().equals(
						castOther.getPolypeptideNestMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideNestMotifId() == null ? 0 : this
						.getPolypeptideNestMotifId().hashCode());
		result = 37 * result
