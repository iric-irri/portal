...
/**
 * GalactosylQueuosineId generated by hbm2java
 */
public class GalactosylQueuosineId implements java.io.Serializable {

	private Integer galactosylQueuosineId;
	...
	public GalactosylQueuosineId() {
	}

	public GalactosylQueuosineId(Integer galactosylQueuosineId,
		...
		this.galactosylQueuosineId = galactosylQueuosineId;
	...
	public Integer getGalactosylQueuosineId() {
		return this.galactosylQueuosineId;
	}

	public void setGalactosylQueuosineId(Integer galactosylQueuosineId) {
		this.galactosylQueuosineId = galactosylQueuosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GalactosylQueuosineId))
			return false;
		GalactosylQueuosineId castOther = (GalactosylQueuosineId) other;

		return ((this.getGalactosylQueuosineId() == castOther
				.getGalactosylQueuosineId()) || (this
				.getGalactosylQueuosineId() != null
				&& castOther.getGalactosylQueuosineId() != null && this
				.getGalactosylQueuosineId().equals(
						castOther.getGalactosylQueuosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGalactosylQueuosineId() == null ? 0 : this
						.getGalactosylQueuosineId().hashCode());
		result = 37 * result
