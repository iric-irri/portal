...
/**
 * EngineeredForeignRegionId generated by hbm2java
 */
public class EngineeredForeignRegionId implements java.io.Serializable {

	private Integer engineeredForeignRegionId;
	...
	public EngineeredForeignRegionId() {
	}

	public EngineeredForeignRegionId(Integer engineeredForeignRegionId,
		...
		this.engineeredForeignRegionId = engineeredForeignRegionId;
	...
	public Integer getEngineeredForeignRegionId() {
		return this.engineeredForeignRegionId;
	}

	public void setEngineeredForeignRegionId(Integer engineeredForeignRegionId) {
		this.engineeredForeignRegionId = engineeredForeignRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredForeignRegionId))
			return false;
		EngineeredForeignRegionId castOther = (EngineeredForeignRegionId) other;

		return ((this.getEngineeredForeignRegionId() == castOther
				.getEngineeredForeignRegionId()) || (this
				.getEngineeredForeignRegionId() != null
				&& castOther.getEngineeredForeignRegionId() != null && this
				.getEngineeredForeignRegionId().equals(
						castOther.getEngineeredForeignRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredForeignRegionId() == null ? 0 : this
						.getEngineeredForeignRegionId().hashCode());
		result = 37 * result
