...
/**
 * LinearSingleStrandedDnaChromosomeId generated by hbm2java
 */
public class LinearSingleStrandedDnaChromosomeId implements
		java.io.Serializable {

	private Integer linearSingleStrandedDnaChromosomeId;
	...
	public LinearSingleStrandedDnaChromosomeId() {
	}

	public LinearSingleStrandedDnaChromosomeId(
			Integer linearSingleStrandedDnaChromosomeId, Integer featureId,
		...
		this.linearSingleStrandedDnaChromosomeId = linearSingleStrandedDnaChromosomeId;
	...
	public Integer getLinearSingleStrandedDnaChromosomeId() {
		return this.linearSingleStrandedDnaChromosomeId;
	}

	public void setLinearSingleStrandedDnaChromosomeId(
			Integer linearSingleStrandedDnaChromosomeId) {
		this.linearSingleStrandedDnaChromosomeId = linearSingleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinearSingleStrandedDnaChromosomeId))
			return false;
		LinearSingleStrandedDnaChromosomeId castOther = (LinearSingleStrandedDnaChromosomeId) other;

		return ((this.getLinearSingleStrandedDnaChromosomeId() == castOther
				.getLinearSingleStrandedDnaChromosomeId()) || (this
				.getLinearSingleStrandedDnaChromosomeId() != null
				&& castOther.getLinearSingleStrandedDnaChromosomeId() != null && this
				.getLinearSingleStrandedDnaChromosomeId().equals(
						castOther.getLinearSingleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLinearSingleStrandedDnaChromosomeId() == null ? 0 : this
						.getLinearSingleStrandedDnaChromosomeId().hashCode());
		result = 37 * result
