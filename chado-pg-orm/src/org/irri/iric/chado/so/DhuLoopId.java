...
/**
 * DhuLoopId generated by hbm2java
 */
public class DhuLoopId implements java.io.Serializable {

	private Integer dhuLoopId;
	...
	public DhuLoopId(Integer dhuLoopId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDhuLoopId() {
		return this.dhuLoopId;
	}

	public void setDhuLoopId(Integer dhuLoopId) {
		this.dhuLoopId = dhuLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DhuLoopId))
			return false;
		DhuLoopId castOther = (DhuLoopId) other;

		return ((this.getDhuLoopId() == castOther.getDhuLoopId()) || (this
				.getDhuLoopId() != null && castOther.getDhuLoopId() != null && this
				.getDhuLoopId().equals(castOther.getDhuLoopId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDhuLoopId() == null ? 0 : this.getDhuLoopId().hashCode());
		result = 37 * result
