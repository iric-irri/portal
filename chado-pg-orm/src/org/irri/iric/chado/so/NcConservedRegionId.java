...
/**
 * NcConservedRegionId generated by hbm2java
 */
public class NcConservedRegionId implements java.io.Serializable {

	private Integer ncConservedRegionId;
	...
	public NcConservedRegionId() {
	}

	public NcConservedRegionId(Integer ncConservedRegionId, Integer featureId,
		...
		this.ncConservedRegionId = ncConservedRegionId;
	...
	public Integer getNcConservedRegionId() {
		return this.ncConservedRegionId;
	}

	public void setNcConservedRegionId(Integer ncConservedRegionId) {
		this.ncConservedRegionId = ncConservedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcConservedRegionId))
			return false;
		NcConservedRegionId castOther = (NcConservedRegionId) other;

		return ((this.getNcConservedRegionId() == castOther
				.getNcConservedRegionId()) || (this.getNcConservedRegionId() != null
				&& castOther.getNcConservedRegionId() != null && this
				.getNcConservedRegionId().equals(
						castOther.getNcConservedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNcConservedRegionId() == null ? 0 : this
						.getNcConservedRegionId().hashCode());
		result = 37 * result
