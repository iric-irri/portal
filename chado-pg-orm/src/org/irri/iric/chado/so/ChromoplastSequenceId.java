...
/**
 * ChromoplastSequenceId generated by hbm2java
 */
public class ChromoplastSequenceId implements java.io.Serializable {

	private Integer chromoplastSequenceId;
	...
	public ChromoplastSequenceId() {
	}

	public ChromoplastSequenceId(Integer chromoplastSequenceId,
		...
		this.chromoplastSequenceId = chromoplastSequenceId;
	...
	public Integer getChromoplastSequenceId() {
		return this.chromoplastSequenceId;
	}

	public void setChromoplastSequenceId(Integer chromoplastSequenceId) {
		this.chromoplastSequenceId = chromoplastSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromoplastSequenceId))
			return false;
		ChromoplastSequenceId castOther = (ChromoplastSequenceId) other;

		return ((this.getChromoplastSequenceId() == castOther
				.getChromoplastSequenceId()) || (this
				.getChromoplastSequenceId() != null
				&& castOther.getChromoplastSequenceId() != null && this
				.getChromoplastSequenceId().equals(
						castOther.getChromoplastSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromoplastSequenceId() == null ? 0 : this
						.getChromoplastSequenceId().hashCode());
		result = 37 * result
