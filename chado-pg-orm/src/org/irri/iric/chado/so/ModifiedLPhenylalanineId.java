...
/**
 * ModifiedLPhenylalanineId generated by hbm2java
 */
public class ModifiedLPhenylalanineId implements java.io.Serializable {

	private Integer modifiedLPhenylalanineId;
	...
	public ModifiedLPhenylalanineId() {
	}

	public ModifiedLPhenylalanineId(Integer modifiedLPhenylalanineId,
		...
		this.modifiedLPhenylalanineId = modifiedLPhenylalanineId;
	...
	public Integer getModifiedLPhenylalanineId() {
		return this.modifiedLPhenylalanineId;
	}

	public void setModifiedLPhenylalanineId(Integer modifiedLPhenylalanineId) {
		this.modifiedLPhenylalanineId = modifiedLPhenylalanineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLPhenylalanineId))
			return false;
		ModifiedLPhenylalanineId castOther = (ModifiedLPhenylalanineId) other;

		return ((this.getModifiedLPhenylalanineId() == castOther
				.getModifiedLPhenylalanineId()) || (this
				.getModifiedLPhenylalanineId() != null
				&& castOther.getModifiedLPhenylalanineId() != null && this
				.getModifiedLPhenylalanineId().equals(
						castOther.getModifiedLPhenylalanineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLPhenylalanineId() == null ? 0 : this
						.getModifiedLPhenylalanineId().hashCode());
		result = 37 * result
