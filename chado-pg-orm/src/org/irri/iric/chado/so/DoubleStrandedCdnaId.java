...
/**
 * DoubleStrandedCdnaId generated by hbm2java
 */
public class DoubleStrandedCdnaId implements java.io.Serializable {

	private Integer doubleStrandedCdnaId;
	...
	public DoubleStrandedCdnaId() {
	}

	public DoubleStrandedCdnaId(Integer doubleStrandedCdnaId,
		...
		this.doubleStrandedCdnaId = doubleStrandedCdnaId;
	...
	public Integer getDoubleStrandedCdnaId() {
		return this.doubleStrandedCdnaId;
	}

	public void setDoubleStrandedCdnaId(Integer doubleStrandedCdnaId) {
		this.doubleStrandedCdnaId = doubleStrandedCdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DoubleStrandedCdnaId))
			return false;
		DoubleStrandedCdnaId castOther = (DoubleStrandedCdnaId) other;

		return ((this.getDoubleStrandedCdnaId() == castOther
				.getDoubleStrandedCdnaId()) || (this.getDoubleStrandedCdnaId() != null
				&& castOther.getDoubleStrandedCdnaId() != null && this
				.getDoubleStrandedCdnaId().equals(
						castOther.getDoubleStrandedCdnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDoubleStrandedCdnaId() == null ? 0 : this
						.getDoubleStrandedCdnaId().hashCode());
		result = 37 * result
