...
/**
 * DpeMotifId generated by hbm2java
 */
public class DpeMotifId implements java.io.Serializable {

	private Integer dpeMotifId;
	...
	public DpeMotifId(Integer dpeMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDpeMotifId() {
		return this.dpeMotifId;
	}

	public void setDpeMotifId(Integer dpeMotifId) {
		this.dpeMotifId = dpeMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DpeMotifId))
			return false;
		DpeMotifId castOther = (DpeMotifId) other;

		return ((this.getDpeMotifId() == castOther.getDpeMotifId()) || (this
				.getDpeMotifId() != null && castOther.getDpeMotifId() != null && this
				.getDpeMotifId().equals(castOther.getDpeMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDpeMotifId() == null ? 0 : this.getDpeMotifId()
						.hashCode());
		result = 37 * result
