...
/**
 * AlterationAttributeId generated by hbm2java
 */
public class AlterationAttributeId implements java.io.Serializable {

	private Integer alterationAttributeId;
	...
	public AlterationAttributeId() {
	}

	public AlterationAttributeId(Integer alterationAttributeId,
		...
		this.alterationAttributeId = alterationAttributeId;
	...
	public Integer getAlterationAttributeId() {
		return this.alterationAttributeId;
	}

	public void setAlterationAttributeId(Integer alterationAttributeId) {
		this.alterationAttributeId = alterationAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlterationAttributeId))
			return false;
		AlterationAttributeId castOther = (AlterationAttributeId) other;

		return ((this.getAlterationAttributeId() == castOther
				.getAlterationAttributeId()) || (this
				.getAlterationAttributeId() != null
				&& castOther.getAlterationAttributeId() != null && this
				.getAlterationAttributeId().equals(
						castOther.getAlterationAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlterationAttributeId() == null ? 0 : this
						.getAlterationAttributeId().hashCode());
		result = 37 * result
