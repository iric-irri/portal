...
/**
 * NaturalTransposableElementId generated by hbm2java
 */
public class NaturalTransposableElementId implements java.io.Serializable {

	private Integer naturalTransposableElementId;
	...
	public NaturalTransposableElementId() {
	}

	public NaturalTransposableElementId(Integer naturalTransposableElementId,
		...
		this.naturalTransposableElementId = naturalTransposableElementId;
	...
	public Integer getNaturalTransposableElementId() {
		return this.naturalTransposableElementId;
	}

	public void setNaturalTransposableElementId(
			Integer naturalTransposableElementId) {
		this.naturalTransposableElementId = naturalTransposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NaturalTransposableElementId))
			return false;
		NaturalTransposableElementId castOther = (NaturalTransposableElementId) other;

		return ((this.getNaturalTransposableElementId() == castOther
				.getNaturalTransposableElementId()) || (this
				.getNaturalTransposableElementId() != null
				&& castOther.getNaturalTransposableElementId() != null && this
				.getNaturalTransposableElementId().equals(
						castOther.getNaturalTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNaturalTransposableElementId() == null ? 0 : this
						.getNaturalTransposableElementId().hashCode());
		result = 37 * result
