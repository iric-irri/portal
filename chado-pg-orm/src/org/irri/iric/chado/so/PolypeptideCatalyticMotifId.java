...
/**
 * PolypeptideCatalyticMotifId generated by hbm2java
 */
public class PolypeptideCatalyticMotifId implements java.io.Serializable {

	private Integer polypeptideCatalyticMotifId;
	...
	public PolypeptideCatalyticMotifId() {
	}

	public PolypeptideCatalyticMotifId(Integer polypeptideCatalyticMotifId,
		...
		this.polypeptideCatalyticMotifId = polypeptideCatalyticMotifId;
	...
	public Integer getPolypeptideCatalyticMotifId() {
		return this.polypeptideCatalyticMotifId;
	}

	public void setPolypeptideCatalyticMotifId(
			Integer polypeptideCatalyticMotifId) {
		this.polypeptideCatalyticMotifId = polypeptideCatalyticMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideCatalyticMotifId))
			return false;
		PolypeptideCatalyticMotifId castOther = (PolypeptideCatalyticMotifId) other;

		return ((this.getPolypeptideCatalyticMotifId() == castOther
				.getPolypeptideCatalyticMotifId()) || (this
				.getPolypeptideCatalyticMotifId() != null
				&& castOther.getPolypeptideCatalyticMotifId() != null && this
				.getPolypeptideCatalyticMotifId().equals(
						castOther.getPolypeptideCatalyticMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideCatalyticMotifId() == null ? 0 : this
						.getPolypeptideCatalyticMotifId().hashCode());
		result = 37 * result
