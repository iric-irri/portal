...
/**
 * SevenMethylguanosineId generated by hbm2java
 */
public class SevenMethylguanosineId implements java.io.Serializable {

	private Integer sevenMethylguanosineId;
	...
	public SevenMethylguanosineId() {
	}

	public SevenMethylguanosineId(Integer sevenMethylguanosineId,
		...
		this.sevenMethylguanosineId = sevenMethylguanosineId;
	...
	public Integer getSevenMethylguanosineId() {
		return this.sevenMethylguanosineId;
	}

	public void setSevenMethylguanosineId(Integer sevenMethylguanosineId) {
		this.sevenMethylguanosineId = sevenMethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SevenMethylguanosineId))
			return false;
		SevenMethylguanosineId castOther = (SevenMethylguanosineId) other;

		return ((this.getSevenMethylguanosineId() == castOther
				.getSevenMethylguanosineId()) || (this
				.getSevenMethylguanosineId() != null
				&& castOther.getSevenMethylguanosineId() != null && this
				.getSevenMethylguanosineId().equals(
						castOther.getSevenMethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSevenMethylguanosineId() == null ? 0 : this
						.getSevenMethylguanosineId().hashCode());
		result = 37 * result
