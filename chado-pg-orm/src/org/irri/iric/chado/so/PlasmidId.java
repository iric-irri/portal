...
/**
 * PlasmidId generated by hbm2java
 */
public class PlasmidId implements java.io.Serializable {
	...
	public PlasmidId(Integer plasmidId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlasmidId))
			return false;
		PlasmidId castOther = (PlasmidId) other;

		return ((this.getPlasmidId() == castOther.getPlasmidId()) || (this
				.getPlasmidId() != null && castOther.getPlasmidId() != null && this
				.getPlasmidId().equals(castOther.getPlasmidId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPlasmidId() == null ? 0 : this.getPlasmidId().hashCode());
		result = 37 * result
