...
/**
 * MirnaAntiguideId generated by hbm2java
 */
public class MirnaAntiguideId implements java.io.Serializable {

	private Integer mirnaAntiguideId;
	...
	public MirnaAntiguideId() {
	}

	public MirnaAntiguideId(Integer mirnaAntiguideId, Integer featureId,
		...
		this.mirnaAntiguideId = mirnaAntiguideId;
	...
	public Integer getMirnaAntiguideId() {
		return this.mirnaAntiguideId;
	}

	public void setMirnaAntiguideId(Integer mirnaAntiguideId) {
		this.mirnaAntiguideId = mirnaAntiguideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaAntiguideId))
			return false;
		MirnaAntiguideId castOther = (MirnaAntiguideId) other;

		return ((this.getMirnaAntiguideId() == castOther.getMirnaAntiguideId()) || (this
				.getMirnaAntiguideId() != null
				&& castOther.getMirnaAntiguideId() != null && this
				.getMirnaAntiguideId().equals(castOther.getMirnaAntiguideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaAntiguideId() == null ? 0 : this
						.getMirnaAntiguideId().hashCode());
		result = 37 * result
