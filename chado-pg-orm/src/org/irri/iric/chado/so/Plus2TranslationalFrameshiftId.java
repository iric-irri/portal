...
/**
 * Plus2TranslationalFrameshiftId generated by hbm2java
 */
public class Plus2TranslationalFrameshiftId implements java.io.Serializable {

	private Integer plus2TranslationalFrameshiftId;
	...
	public Plus2TranslationalFrameshiftId() {
	}

	public Plus2TranslationalFrameshiftId(
			Integer plus2TranslationalFrameshiftId, Integer featureId,
		...
		this.plus2TranslationalFrameshiftId = plus2TranslationalFrameshiftId;
	...
	public Integer getPlus2TranslationalFrameshiftId() {
		return this.plus2TranslationalFrameshiftId;
	}

	public void setPlus2TranslationalFrameshiftId(
			Integer plus2TranslationalFrameshiftId) {
		this.plus2TranslationalFrameshiftId = plus2TranslationalFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus2TranslationalFrameshiftId))
			return false;
		Plus2TranslationalFrameshiftId castOther = (Plus2TranslationalFrameshiftId) other;

		return ((this.getPlus2TranslationalFrameshiftId() == castOther
				.getPlus2TranslationalFrameshiftId()) || (this
				.getPlus2TranslationalFrameshiftId() != null
				&& castOther.getPlus2TranslationalFrameshiftId() != null && this
				.getPlus2TranslationalFrameshiftId().equals(
						castOther.getPlus2TranslationalFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus2TranslationalFrameshiftId() == null ? 0 : this
						.getPlus2TranslationalFrameshiftId().hashCode());
		result = 37 * result
