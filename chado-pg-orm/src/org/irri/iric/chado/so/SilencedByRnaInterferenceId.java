...
/**
 * SilencedByRnaInterferenceId generated by hbm2java
 */
public class SilencedByRnaInterferenceId implements java.io.Serializable {

	private Integer silencedByRnaInterferenceId;
	...
	public SilencedByRnaInterferenceId() {
	}

	public SilencedByRnaInterferenceId(Integer silencedByRnaInterferenceId,
		...
		this.silencedByRnaInterferenceId = silencedByRnaInterferenceId;
	...
	public Integer getSilencedByRnaInterferenceId() {
		return this.silencedByRnaInterferenceId;
	}

	public void setSilencedByRnaInterferenceId(
			Integer silencedByRnaInterferenceId) {
		this.silencedByRnaInterferenceId = silencedByRnaInterferenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByRnaInterferenceId))
			return false;
		SilencedByRnaInterferenceId castOther = (SilencedByRnaInterferenceId) other;

		return ((this.getSilencedByRnaInterferenceId() == castOther
				.getSilencedByRnaInterferenceId()) || (this
				.getSilencedByRnaInterferenceId() != null
				&& castOther.getSilencedByRnaInterferenceId() != null && this
				.getSilencedByRnaInterferenceId().equals(
						castOther.getSilencedByRnaInterferenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByRnaInterferenceId() == null ? 0 : this
						.getSilencedByRnaInterferenceId().hashCode());
		result = 37 * result
