...
/**
 * GcRichPromoterRegionId generated by hbm2java
 */
public class GcRichPromoterRegionId implements java.io.Serializable {

	private Integer gcRichPromoterRegionId;
	...
	public GcRichPromoterRegionId() {
	}

	public GcRichPromoterRegionId(Integer gcRichPromoterRegionId,
		...
		this.gcRichPromoterRegionId = gcRichPromoterRegionId;
	...
	public Integer getGcRichPromoterRegionId() {
		return this.gcRichPromoterRegionId;
	}

	public void setGcRichPromoterRegionId(Integer gcRichPromoterRegionId) {
		this.gcRichPromoterRegionId = gcRichPromoterRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GcRichPromoterRegionId))
			return false;
		GcRichPromoterRegionId castOther = (GcRichPromoterRegionId) other;

		return ((this.getGcRichPromoterRegionId() == castOther
				.getGcRichPromoterRegionId()) || (this
				.getGcRichPromoterRegionId() != null
				&& castOther.getGcRichPromoterRegionId() != null && this
				.getGcRichPromoterRegionId().equals(
						castOther.getGcRichPromoterRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGcRichPromoterRegionId() == null ? 0 : this
						.getGcRichPromoterRegionId().hashCode());
		result = 37 * result
