...
/**
 * ThreePrimeRstId generated by hbm2java
 */
public class ThreePrimeRstId implements java.io.Serializable {

	private Integer threePrimeRstId;
	...
	public ThreePrimeRstId() {
	}

	public ThreePrimeRstId(Integer threePrimeRstId, Integer featureId,
		...
		this.threePrimeRstId = threePrimeRstId;
	...
	public Integer getThreePrimeRstId() {
		return this.threePrimeRstId;
	}

	public void setThreePrimeRstId(Integer threePrimeRstId) {
		this.threePrimeRstId = threePrimeRstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeRstId))
			return false;
		ThreePrimeRstId castOther = (ThreePrimeRstId) other;

		return ((this.getThreePrimeRstId() == castOther.getThreePrimeRstId()) || (this
				.getThreePrimeRstId() != null
				&& castOther.getThreePrimeRstId() != null && this
				.getThreePrimeRstId().equals(castOther.getThreePrimeRstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeRstId() == null ? 0 : this.getThreePrimeRstId()
						.hashCode());
		result = 37 * result
