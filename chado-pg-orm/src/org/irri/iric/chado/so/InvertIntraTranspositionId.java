...
/**
 * InvertIntraTranspositionId generated by hbm2java
 */
public class InvertIntraTranspositionId implements java.io.Serializable {

	private Integer invertIntraTranspositionId;
	...
	public InvertIntraTranspositionId() {
	}

	public InvertIntraTranspositionId(Integer invertIntraTranspositionId,
		...
		this.invertIntraTranspositionId = invertIntraTranspositionId;
	...
	public Integer getInvertIntraTranspositionId() {
		return this.invertIntraTranspositionId;
	}

	public void setInvertIntraTranspositionId(Integer invertIntraTranspositionId) {
		this.invertIntraTranspositionId = invertIntraTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertIntraTranspositionId))
			return false;
		InvertIntraTranspositionId castOther = (InvertIntraTranspositionId) other;

		return ((this.getInvertIntraTranspositionId() == castOther
				.getInvertIntraTranspositionId()) || (this
				.getInvertIntraTranspositionId() != null
				&& castOther.getInvertIntraTranspositionId() != null && this
				.getInvertIntraTranspositionId().equals(
						castOther.getInvertIntraTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertIntraTranspositionId() == null ? 0 : this
						.getInvertIntraTranspositionId().hashCode());
		result = 37 * result
