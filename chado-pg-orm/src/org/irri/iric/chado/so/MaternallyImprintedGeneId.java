...
/**
 * MaternallyImprintedGeneId generated by hbm2java
 */
public class MaternallyImprintedGeneId implements java.io.Serializable {

	private Integer maternallyImprintedGeneId;
	...
	public MaternallyImprintedGeneId() {
	}

	public MaternallyImprintedGeneId(Integer maternallyImprintedGeneId,
		...
		this.maternallyImprintedGeneId = maternallyImprintedGeneId;
	...
	public Integer getMaternallyImprintedGeneId() {
		return this.maternallyImprintedGeneId;
	}

	public void setMaternallyImprintedGeneId(Integer maternallyImprintedGeneId) {
		this.maternallyImprintedGeneId = maternallyImprintedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaternallyImprintedGeneId))
			return false;
		MaternallyImprintedGeneId castOther = (MaternallyImprintedGeneId) other;

		return ((this.getMaternallyImprintedGeneId() == castOther
				.getMaternallyImprintedGeneId()) || (this
				.getMaternallyImprintedGeneId() != null
				&& castOther.getMaternallyImprintedGeneId() != null && this
				.getMaternallyImprintedGeneId().equals(
						castOther.getMaternallyImprintedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaternallyImprintedGeneId() == null ? 0 : this
						.getMaternallyImprintedGeneId().hashCode());
		result = 37 * result
