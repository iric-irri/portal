...
/**
 * VjCClusterId generated by hbm2java
 */
public class VjCClusterId implements java.io.Serializable {

	private Integer vjCClusterId;
	...
	public VjCClusterId(Integer vjCClusterId, Integer featureId,
		...
		this.vjCClusterId = vjCClusterId;
	...
	public Integer getVjCClusterId() {
		return this.vjCClusterId;
	}

	public void setVjCClusterId(Integer vjCClusterId) {
		this.vjCClusterId = vjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VjCClusterId))
			return false;
		VjCClusterId castOther = (VjCClusterId) other;

		return ((this.getVjCClusterId() == castOther.getVjCClusterId()) || (this
				.getVjCClusterId() != null
				&& castOther.getVjCClusterId() != null && this
				.getVjCClusterId().equals(castOther.getVjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVjCClusterId() == null ? 0 : this.getVjCClusterId()
						.hashCode());
		result = 37 * result
