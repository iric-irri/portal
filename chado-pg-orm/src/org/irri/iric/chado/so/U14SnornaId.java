...
/**
 * U14SnornaId generated by hbm2java
 */
public class U14SnornaId implements java.io.Serializable {

	private Integer u14SnornaId;
	...
	public U14SnornaId(Integer u14SnornaId, Integer featureId,
	...
	public Integer getU14SnornaId() {
		return this.u14SnornaId;
	}

	public void setU14SnornaId(Integer u14SnornaId) {
		this.u14SnornaId = u14SnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U14SnornaId))
			return false;
		U14SnornaId castOther = (U14SnornaId) other;

		return ((this.getU14SnornaId() == castOther.getU14SnornaId()) || (this
				.getU14SnornaId() != null && castOther.getU14SnornaId() != null && this
				.getU14SnornaId().equals(castOther.getU14SnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU14SnornaId() == null ? 0 : this.getU14SnornaId()
						.hashCode());
		result = 37 * result
