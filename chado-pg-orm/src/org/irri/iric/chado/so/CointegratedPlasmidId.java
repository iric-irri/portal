...
/**
 * CointegratedPlasmidId generated by hbm2java
 */
public class CointegratedPlasmidId implements java.io.Serializable {

	private Integer cointegratedPlasmidId;
	...
	public CointegratedPlasmidId() {
	}

	public CointegratedPlasmidId(Integer cointegratedPlasmidId,
		...
		this.cointegratedPlasmidId = cointegratedPlasmidId;
	...
	public Integer getCointegratedPlasmidId() {
		return this.cointegratedPlasmidId;
	}

	public void setCointegratedPlasmidId(Integer cointegratedPlasmidId) {
		this.cointegratedPlasmidId = cointegratedPlasmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CointegratedPlasmidId))
			return false;
		CointegratedPlasmidId castOther = (CointegratedPlasmidId) other;

		return ((this.getCointegratedPlasmidId() == castOther
				.getCointegratedPlasmidId()) || (this
				.getCointegratedPlasmidId() != null
				&& castOther.getCointegratedPlasmidId() != null && this
				.getCointegratedPlasmidId().equals(
						castOther.getCointegratedPlasmidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCointegratedPlasmidId() == null ? 0 : this
						.getCointegratedPlasmidId().hashCode());
		result = 37 * result
