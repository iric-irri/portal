...
/**
 * ExternalTranscribedSpacerRegionId generated by hbm2java
 */
public class ExternalTranscribedSpacerRegionId implements java.io.Serializable {

	private Integer externalTranscribedSpacerRegionId;
	...
	public ExternalTranscribedSpacerRegionId() {
	}

	public ExternalTranscribedSpacerRegionId(
			Integer externalTranscribedSpacerRegionId, Integer featureId,
		...
		this.externalTranscribedSpacerRegionId = externalTranscribedSpacerRegionId;
	...
	public Integer getExternalTranscribedSpacerRegionId() {
		return this.externalTranscribedSpacerRegionId;
	}

	public void setExternalTranscribedSpacerRegionId(
			Integer externalTranscribedSpacerRegionId) {
		this.externalTranscribedSpacerRegionId = externalTranscribedSpacerRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExternalTranscribedSpacerRegionId))
			return false;
		ExternalTranscribedSpacerRegionId castOther = (ExternalTranscribedSpacerRegionId) other;

		return ((this.getExternalTranscribedSpacerRegionId() == castOther
				.getExternalTranscribedSpacerRegionId()) || (this
				.getExternalTranscribedSpacerRegionId() != null
				&& castOther.getExternalTranscribedSpacerRegionId() != null && this
				.getExternalTranscribedSpacerRegionId().equals(
						castOther.getExternalTranscribedSpacerRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExternalTranscribedSpacerRegionId() == null ? 0 : this
						.getExternalTranscribedSpacerRegionId().hashCode());
		result = 37 * result
