...
/**
 * FivePrimeNoncodingExonId generated by hbm2java
 */
public class FivePrimeNoncodingExonId implements java.io.Serializable {

	private Integer fivePrimeNoncodingExonId;
	...
	public FivePrimeNoncodingExonId() {
	}

	public FivePrimeNoncodingExonId(Integer fivePrimeNoncodingExonId,
		...
		this.fivePrimeNoncodingExonId = fivePrimeNoncodingExonId;
	...
	public Integer getFivePrimeNoncodingExonId() {
		return this.fivePrimeNoncodingExonId;
	}

	public void setFivePrimeNoncodingExonId(Integer fivePrimeNoncodingExonId) {
		this.fivePrimeNoncodingExonId = fivePrimeNoncodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeNoncodingExonId))
			return false;
		FivePrimeNoncodingExonId castOther = (FivePrimeNoncodingExonId) other;

		return ((this.getFivePrimeNoncodingExonId() == castOther
				.getFivePrimeNoncodingExonId()) || (this
				.getFivePrimeNoncodingExonId() != null
				&& castOther.getFivePrimeNoncodingExonId() != null && this
				.getFivePrimeNoncodingExonId().equals(
						castOther.getFivePrimeNoncodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeNoncodingExonId() == null ? 0 : this
						.getFivePrimeNoncodingExonId().hashCode());
		result = 37 * result
