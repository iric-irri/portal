...
/**
 * InterchromosomalTranspositionId generated by hbm2java
 */
public class InterchromosomalTranspositionId implements java.io.Serializable {

	private Integer interchromosomalTranspositionId;
	...
	public InterchromosomalTranspositionId() {
	}

	public InterchromosomalTranspositionId(
			Integer interchromosomalTranspositionId, Integer featureId,
		...
		this.interchromosomalTranspositionId = interchromosomalTranspositionId;
	...
	public Integer getInterchromosomalTranspositionId() {
		return this.interchromosomalTranspositionId;
	}

	public void setInterchromosomalTranspositionId(
			Integer interchromosomalTranspositionId) {
		this.interchromosomalTranspositionId = interchromosomalTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InterchromosomalTranspositionId))
			return false;
		InterchromosomalTranspositionId castOther = (InterchromosomalTranspositionId) other;

		return ((this.getInterchromosomalTranspositionId() == castOther
				.getInterchromosomalTranspositionId()) || (this
				.getInterchromosomalTranspositionId() != null
				&& castOther.getInterchromosomalTranspositionId() != null && this
				.getInterchromosomalTranspositionId().equals(
						castOther.getInterchromosomalTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInterchromosomalTranspositionId() == null ? 0 : this
						.getInterchromosomalTranspositionId().hashCode());
		result = 37 * result
