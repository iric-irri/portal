...
/**
 * FivePrimeThreePrimeOverlapId generated by hbm2java
 */
public class FivePrimeThreePrimeOverlapId implements java.io.Serializable {

	private Integer fivePrimeThreePrimeOverlapId;
	...
	public FivePrimeThreePrimeOverlapId() {
	}

	public FivePrimeThreePrimeOverlapId(Integer fivePrimeThreePrimeOverlapId,
		...
		this.fivePrimeThreePrimeOverlapId = fivePrimeThreePrimeOverlapId;
	...
	public Integer getFivePrimeThreePrimeOverlapId() {
		return this.fivePrimeThreePrimeOverlapId;
	}

	public void setFivePrimeThreePrimeOverlapId(
			Integer fivePrimeThreePrimeOverlapId) {
		this.fivePrimeThreePrimeOverlapId = fivePrimeThreePrimeOverlapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeThreePrimeOverlapId))
			return false;
		FivePrimeThreePrimeOverlapId castOther = (FivePrimeThreePrimeOverlapId) other;

		return ((this.getFivePrimeThreePrimeOverlapId() == castOther
				.getFivePrimeThreePrimeOverlapId()) || (this
				.getFivePrimeThreePrimeOverlapId() != null
				&& castOther.getFivePrimeThreePrimeOverlapId() != null && this
				.getFivePrimeThreePrimeOverlapId().equals(
						castOther.getFivePrimeThreePrimeOverlapId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeThreePrimeOverlapId() == null ? 0 : this
						.getFivePrimeThreePrimeOverlapId().hashCode());
		result = 37 * result
