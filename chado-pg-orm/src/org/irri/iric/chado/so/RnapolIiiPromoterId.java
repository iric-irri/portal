...
/**
 * RnapolIiiPromoterId generated by hbm2java
 */
public class RnapolIiiPromoterId implements java.io.Serializable {

	private Integer rnapolIiiPromoterId;
	...
	public RnapolIiiPromoterId() {
	}

	public RnapolIiiPromoterId(Integer rnapolIiiPromoterId, Integer featureId,
		...
		this.rnapolIiiPromoterId = rnapolIiiPromoterId;
	...
	public Integer getRnapolIiiPromoterId() {
		return this.rnapolIiiPromoterId;
	}

	public void setRnapolIiiPromoterId(Integer rnapolIiiPromoterId) {
		this.rnapolIiiPromoterId = rnapolIiiPromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnapolIiiPromoterId))
			return false;
		RnapolIiiPromoterId castOther = (RnapolIiiPromoterId) other;

		return ((this.getRnapolIiiPromoterId() == castOther
				.getRnapolIiiPromoterId()) || (this.getRnapolIiiPromoterId() != null
				&& castOther.getRnapolIiiPromoterId() != null && this
				.getRnapolIiiPromoterId().equals(
						castOther.getRnapolIiiPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnapolIiiPromoterId() == null ? 0 : this
						.getRnapolIiiPromoterId().hashCode());
		result = 37 * result
