...
/**
 * PolypeptideStructuralRegionId generated by hbm2java
 */
public class PolypeptideStructuralRegionId implements java.io.Serializable {

	private Integer polypeptideStructuralRegionId;
	...
	public PolypeptideStructuralRegionId() {
	}

	public PolypeptideStructuralRegionId(Integer polypeptideStructuralRegionId,
		...
		this.polypeptideStructuralRegionId = polypeptideStructuralRegionId;
	...
	public Integer getPolypeptideStructuralRegionId() {
		return this.polypeptideStructuralRegionId;
	}

	public void setPolypeptideStructuralRegionId(
			Integer polypeptideStructuralRegionId) {
		this.polypeptideStructuralRegionId = polypeptideStructuralRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideStructuralRegionId))
			return false;
		PolypeptideStructuralRegionId castOther = (PolypeptideStructuralRegionId) other;

		return ((this.getPolypeptideStructuralRegionId() == castOther
				.getPolypeptideStructuralRegionId()) || (this
				.getPolypeptideStructuralRegionId() != null
				&& castOther.getPolypeptideStructuralRegionId() != null && this
				.getPolypeptideStructuralRegionId().equals(
						castOther.getPolypeptideStructuralRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideStructuralRegionId() == null ? 0 : this
						.getPolypeptideStructuralRegionId().hashCode());
		result = 37 * result
