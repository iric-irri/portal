...
/**
 * RegulatoryRegionVariantId generated by hbm2java
 */
public class RegulatoryRegionVariantId implements java.io.Serializable {

	private Integer regulatoryRegionVariantId;
	...
	public RegulatoryRegionVariantId() {
	}

	public RegulatoryRegionVariantId(Integer regulatoryRegionVariantId,
		...
		this.regulatoryRegionVariantId = regulatoryRegionVariantId;
	...
	public Integer getRegulatoryRegionVariantId() {
		return this.regulatoryRegionVariantId;
	}

	public void setRegulatoryRegionVariantId(Integer regulatoryRegionVariantId) {
		this.regulatoryRegionVariantId = regulatoryRegionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegulatoryRegionVariantId))
			return false;
		RegulatoryRegionVariantId castOther = (RegulatoryRegionVariantId) other;

		return ((this.getRegulatoryRegionVariantId() == castOther
				.getRegulatoryRegionVariantId()) || (this
				.getRegulatoryRegionVariantId() != null
				&& castOther.getRegulatoryRegionVariantId() != null && this
				.getRegulatoryRegionVariantId().equals(
						castOther.getRegulatoryRegionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegulatoryRegionVariantId() == null ? 0 : this
						.getRegulatoryRegionVariantId().hashCode());
		result = 37 * result
