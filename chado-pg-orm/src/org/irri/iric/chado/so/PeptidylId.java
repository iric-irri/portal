...
/**
 * PeptidylId generated by hbm2java
 */
public class PeptidylId implements java.io.Serializable {

	private Integer peptidylId;
	...
	public PeptidylId(Integer peptidylId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPeptidylId() {
		return this.peptidylId;
	}

	public void setPeptidylId(Integer peptidylId) {
		this.peptidylId = peptidylId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeptidylId))
			return false;
		PeptidylId castOther = (PeptidylId) other;

		return ((this.getPeptidylId() == castOther.getPeptidylId()) || (this
				.getPeptidylId() != null && castOther.getPeptidylId() != null && this
				.getPeptidylId().equals(castOther.getPeptidylId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeptidylId() == null ? 0 : this.getPeptidylId()
						.hashCode());
		result = 37 * result
