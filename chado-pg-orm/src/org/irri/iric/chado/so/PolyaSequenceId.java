...
/**
 * PolyaSequenceId generated by hbm2java
 */
public class PolyaSequenceId implements java.io.Serializable {

	private Integer polyaSequenceId;
	...
	public PolyaSequenceId() {
	}

	public PolyaSequenceId(Integer polyaSequenceId, Integer featureId,
		...
		this.polyaSequenceId = polyaSequenceId;
	...
	public Integer getPolyaSequenceId() {
		return this.polyaSequenceId;
	}

	public void setPolyaSequenceId(Integer polyaSequenceId) {
		this.polyaSequenceId = polyaSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyaSequenceId))
			return false;
		PolyaSequenceId castOther = (PolyaSequenceId) other;

		return ((this.getPolyaSequenceId() == castOther.getPolyaSequenceId()) || (this
				.getPolyaSequenceId() != null
				&& castOther.getPolyaSequenceId() != null && this
				.getPolyaSequenceId().equals(castOther.getPolyaSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyaSequenceId() == null ? 0 : this.getPolyaSequenceId()
						.hashCode());
		result = 37 * result
