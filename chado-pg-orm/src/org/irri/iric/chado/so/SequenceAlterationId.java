...
/**
 * SequenceAlterationId generated by hbm2java
 */
public class SequenceAlterationId implements java.io.Serializable {

	private Integer sequenceAlterationId;
	...
	public SequenceAlterationId() {
	}

	public SequenceAlterationId(Integer sequenceAlterationId,
		...
		this.sequenceAlterationId = sequenceAlterationId;
	...
	public Integer getSequenceAlterationId() {
		return this.sequenceAlterationId;
	}

	public void setSequenceAlterationId(Integer sequenceAlterationId) {
		this.sequenceAlterationId = sequenceAlterationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceAlterationId))
			return false;
		SequenceAlterationId castOther = (SequenceAlterationId) other;

		return ((this.getSequenceAlterationId() == castOther
				.getSequenceAlterationId()) || (this.getSequenceAlterationId() != null
				&& castOther.getSequenceAlterationId() != null && this
				.getSequenceAlterationId().equals(
						castOther.getSequenceAlterationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceAlterationId() == null ? 0 : this
						.getSequenceAlterationId().hashCode());
		result = 37 * result
