...
/**
 * RecombinationallyRearrangedId generated by hbm2java
 */
public class RecombinationallyRearrangedId implements java.io.Serializable {

	private Integer recombinationallyRearrangedId;
	...
	public RecombinationallyRearrangedId() {
	}

	public RecombinationallyRearrangedId(Integer recombinationallyRearrangedId,
		...
		this.recombinationallyRearrangedId = recombinationallyRearrangedId;
	...
	public Integer getRecombinationallyRearrangedId() {
		return this.recombinationallyRearrangedId;
	}

	public void setRecombinationallyRearrangedId(
			Integer recombinationallyRearrangedId) {
		this.recombinationallyRearrangedId = recombinationallyRearrangedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationallyRearrangedId))
			return false;
		RecombinationallyRearrangedId castOther = (RecombinationallyRearrangedId) other;

		return ((this.getRecombinationallyRearrangedId() == castOther
				.getRecombinationallyRearrangedId()) || (this
				.getRecombinationallyRearrangedId() != null
				&& castOther.getRecombinationallyRearrangedId() != null && this
				.getRecombinationallyRearrangedId().equals(
						castOther.getRecombinationallyRearrangedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationallyRearrangedId() == null ? 0 : this
						.getRecombinationallyRearrangedId().hashCode());
		result = 37 * result
