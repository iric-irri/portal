...
/**
 * LinearSingleStrandedRnaChromosomeId generated by hbm2java
 */
public class LinearSingleStrandedRnaChromosomeId implements
		java.io.Serializable {

	private Integer linearSingleStrandedRnaChromosomeId;
	...
	public LinearSingleStrandedRnaChromosomeId() {
	}

	public LinearSingleStrandedRnaChromosomeId(
			Integer linearSingleStrandedRnaChromosomeId, Integer featureId,
		...
		this.linearSingleStrandedRnaChromosomeId = linearSingleStrandedRnaChromosomeId;
	...
	public Integer getLinearSingleStrandedRnaChromosomeId() {
		return this.linearSingleStrandedRnaChromosomeId;
	}

	public void setLinearSingleStrandedRnaChromosomeId(
			Integer linearSingleStrandedRnaChromosomeId) {
		this.linearSingleStrandedRnaChromosomeId = linearSingleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinearSingleStrandedRnaChromosomeId))
			return false;
		LinearSingleStrandedRnaChromosomeId castOther = (LinearSingleStrandedRnaChromosomeId) other;

		return ((this.getLinearSingleStrandedRnaChromosomeId() == castOther
				.getLinearSingleStrandedRnaChromosomeId()) || (this
				.getLinearSingleStrandedRnaChromosomeId() != null
				&& castOther.getLinearSingleStrandedRnaChromosomeId() != null && this
				.getLinearSingleStrandedRnaChromosomeId().equals(
						castOther.getLinearSingleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLinearSingleStrandedRnaChromosomeId() == null ? 0 : this
						.getLinearSingleStrandedRnaChromosomeId().hashCode());
		result = 37 * result
