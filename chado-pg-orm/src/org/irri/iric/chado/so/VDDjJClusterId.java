...
/**
 * VDDjJClusterId generated by hbm2java
 */
public class VDDjJClusterId implements java.io.Serializable {

	private Integer VDDjJClusterId;
	...
	public VDDjJClusterId() {
	}

	public VDDjJClusterId(Integer VDDjJClusterId, Integer featureId,
		...
		this.VDDjJClusterId = VDDjJClusterId;
	...
	public Integer getVDDjJClusterId() {
		return this.VDDjJClusterId;
	}

	public void setVDDjJClusterId(Integer VDDjJClusterId) {
		this.VDDjJClusterId = VDDjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDDjJClusterId))
			return false;
		VDDjJClusterId castOther = (VDDjJClusterId) other;

		return ((this.getVDDjJClusterId() == castOther.getVDDjJClusterId()) || (this
				.getVDDjJClusterId() != null
				&& castOther.getVDDjJClusterId() != null && this
				.getVDDjJClusterId().equals(castOther.getVDDjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDDjJClusterId() == null ? 0 : this.getVDDjJClusterId()
						.hashCode());
		result = 37 * result
