...
/**
 * PolypeptideFusionId generated by hbm2java
 */
public class PolypeptideFusionId implements java.io.Serializable {

	private Integer polypeptideFusionId;
	...
	public PolypeptideFusionId() {
	}

	public PolypeptideFusionId(Integer polypeptideFusionId, Integer featureId,
		...
		this.polypeptideFusionId = polypeptideFusionId;
	...
	public Integer getPolypeptideFusionId() {
		return this.polypeptideFusionId;
	}

	public void setPolypeptideFusionId(Integer polypeptideFusionId) {
		this.polypeptideFusionId = polypeptideFusionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideFusionId))
			return false;
		PolypeptideFusionId castOther = (PolypeptideFusionId) other;

		return ((this.getPolypeptideFusionId() == castOther
				.getPolypeptideFusionId()) || (this.getPolypeptideFusionId() != null
				&& castOther.getPolypeptideFusionId() != null && this
				.getPolypeptideFusionId().equals(
						castOther.getPolypeptideFusionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideFusionId() == null ? 0 : this
						.getPolypeptideFusionId().hashCode());
		result = 37 * result
