...
/**
 * ClonedCdnaInsertId generated by hbm2java
 */
public class ClonedCdnaInsertId implements java.io.Serializable {

	private Integer clonedCdnaInsertId;
	...
	public ClonedCdnaInsertId() {
	}

	public ClonedCdnaInsertId(Integer clonedCdnaInsertId, Integer featureId,
		...
		this.clonedCdnaInsertId = clonedCdnaInsertId;
	...
	public Integer getClonedCdnaInsertId() {
		return this.clonedCdnaInsertId;
	}

	public void setClonedCdnaInsertId(Integer clonedCdnaInsertId) {
		this.clonedCdnaInsertId = clonedCdnaInsertId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClonedCdnaInsertId))
			return false;
		ClonedCdnaInsertId castOther = (ClonedCdnaInsertId) other;

		return ((this.getClonedCdnaInsertId() == castOther
				.getClonedCdnaInsertId()) || (this.getClonedCdnaInsertId() != null
				&& castOther.getClonedCdnaInsertId() != null && this
				.getClonedCdnaInsertId().equals(
						castOther.getClonedCdnaInsertId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getClonedCdnaInsertId() == null ? 0 : this
						.getClonedCdnaInsertId().hashCode());
		result = 37 * result
