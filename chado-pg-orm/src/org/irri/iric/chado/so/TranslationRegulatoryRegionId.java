...
/**
 * TranslationRegulatoryRegionId generated by hbm2java
 */
public class TranslationRegulatoryRegionId implements java.io.Serializable {

	private Integer translationRegulatoryRegionId;
	...
	public TranslationRegulatoryRegionId() {
	}

	public TranslationRegulatoryRegionId(Integer translationRegulatoryRegionId,
		...
		this.translationRegulatoryRegionId = translationRegulatoryRegionId;
	...
	public Integer getTranslationRegulatoryRegionId() {
		return this.translationRegulatoryRegionId;
	}

	public void setTranslationRegulatoryRegionId(
			Integer translationRegulatoryRegionId) {
		this.translationRegulatoryRegionId = translationRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationRegulatoryRegionId))
			return false;
		TranslationRegulatoryRegionId castOther = (TranslationRegulatoryRegionId) other;

		return ((this.getTranslationRegulatoryRegionId() == castOther
				.getTranslationRegulatoryRegionId()) || (this
				.getTranslationRegulatoryRegionId() != null
				&& castOther.getTranslationRegulatoryRegionId() != null && this
				.getTranslationRegulatoryRegionId().equals(
						castOther.getTranslationRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationRegulatoryRegionId() == null ? 0 : this
						.getTranslationRegulatoryRegionId().hashCode());
		result = 37 * result
