...
/**
 * CapId generated by hbm2java
 */
public class CapId implements java.io.Serializable {
	...
	public CapId(Integer capId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CapId))
			return false;
		CapId castOther = (CapId) other;

		return ((this.getCapId() == castOther.getCapId()) || (this.getCapId() != null
				&& castOther.getCapId() != null && this.getCapId().equals(
				castOther.getCapId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCapId() == null ? 0 : this.getCapId().hashCode());
		result = 37 * result
