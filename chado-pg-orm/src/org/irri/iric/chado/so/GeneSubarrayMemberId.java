...
/**
 * GeneSubarrayMemberId generated by hbm2java
 */
public class GeneSubarrayMemberId implements java.io.Serializable {

	private Integer geneSubarrayMemberId;
	...
	public GeneSubarrayMemberId() {
	}

	public GeneSubarrayMemberId(Integer geneSubarrayMemberId,
		...
		this.geneSubarrayMemberId = geneSubarrayMemberId;
	...
	public Integer getGeneSubarrayMemberId() {
		return this.geneSubarrayMemberId;
	}

	public void setGeneSubarrayMemberId(Integer geneSubarrayMemberId) {
		this.geneSubarrayMemberId = geneSubarrayMemberId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSubarrayMemberId))
			return false;
		GeneSubarrayMemberId castOther = (GeneSubarrayMemberId) other;

		return ((this.getGeneSubarrayMemberId() == castOther
				.getGeneSubarrayMemberId()) || (this.getGeneSubarrayMemberId() != null
				&& castOther.getGeneSubarrayMemberId() != null && this
				.getGeneSubarrayMemberId().equals(
						castOther.getGeneSubarrayMemberId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSubarrayMemberId() == null ? 0 : this
						.getGeneSubarrayMemberId().hashCode());
		result = 37 * result
