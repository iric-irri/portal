...
/**
 * SymmetricRnaInternalLoopId generated by hbm2java
 */
public class SymmetricRnaInternalLoopId implements java.io.Serializable {

	private Integer symmetricRnaInternalLoopId;
	...
	public SymmetricRnaInternalLoopId() {
	}

	public SymmetricRnaInternalLoopId(Integer symmetricRnaInternalLoopId,
		...
		this.symmetricRnaInternalLoopId = symmetricRnaInternalLoopId;
	...
	public Integer getSymmetricRnaInternalLoopId() {
		return this.symmetricRnaInternalLoopId;
	}

	public void setSymmetricRnaInternalLoopId(Integer symmetricRnaInternalLoopId) {
		this.symmetricRnaInternalLoopId = symmetricRnaInternalLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SymmetricRnaInternalLoopId))
			return false;
		SymmetricRnaInternalLoopId castOther = (SymmetricRnaInternalLoopId) other;

		return ((this.getSymmetricRnaInternalLoopId() == castOther
				.getSymmetricRnaInternalLoopId()) || (this
				.getSymmetricRnaInternalLoopId() != null
				&& castOther.getSymmetricRnaInternalLoopId() != null && this
				.getSymmetricRnaInternalLoopId().equals(
						castOther.getSymmetricRnaInternalLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSymmetricRnaInternalLoopId() == null ? 0 : this
						.getSymmetricRnaInternalLoopId().hashCode());
		result = 37 * result
