...
/**
 * LigationBasedReadId generated by hbm2java
 */
public class LigationBasedReadId implements java.io.Serializable {

	private Integer ligationBasedReadId;
	...
	public LigationBasedReadId() {
	}

	public LigationBasedReadId(Integer ligationBasedReadId, Integer featureId,
		...
		this.ligationBasedReadId = ligationBasedReadId;
	...
	public Integer getLigationBasedReadId() {
		return this.ligationBasedReadId;
	}

	public void setLigationBasedReadId(Integer ligationBasedReadId) {
		this.ligationBasedReadId = ligationBasedReadId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LigationBasedReadId))
			return false;
		LigationBasedReadId castOther = (LigationBasedReadId) other;

		return ((this.getLigationBasedReadId() == castOther
				.getLigationBasedReadId()) || (this.getLigationBasedReadId() != null
				&& castOther.getLigationBasedReadId() != null && this
				.getLigationBasedReadId().equals(
						castOther.getLigationBasedReadId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLigationBasedReadId() == null ? 0 : this
						.getLigationBasedReadId().hashCode());
		result = 37 * result
