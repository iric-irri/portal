...
/**
 * N4N42PrimeOTrimethylcytidineId generated by hbm2java
 */
public class N4N42PrimeOTrimethylcytidineId implements java.io.Serializable {

	private Integer n4N42PrimeOTrimethylcytidineId;
	...
	public N4N42PrimeOTrimethylcytidineId() {
	}

	public N4N42PrimeOTrimethylcytidineId(
			Integer n4N42PrimeOTrimethylcytidineId, Integer featureId,
		...
		this.n4N42PrimeOTrimethylcytidineId = n4N42PrimeOTrimethylcytidineId;
	...
	public Integer getN4N42PrimeOTrimethylcytidineId() {
		return this.n4N42PrimeOTrimethylcytidineId;
	}

	public void setN4N42PrimeOTrimethylcytidineId(
			Integer n4N42PrimeOTrimethylcytidineId) {
		this.n4N42PrimeOTrimethylcytidineId = n4N42PrimeOTrimethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N4N42PrimeOTrimethylcytidineId))
			return false;
		N4N42PrimeOTrimethylcytidineId castOther = (N4N42PrimeOTrimethylcytidineId) other;

		return ((this.getN4N42PrimeOTrimethylcytidineId() == castOther
				.getN4N42PrimeOTrimethylcytidineId()) || (this
				.getN4N42PrimeOTrimethylcytidineId() != null
				&& castOther.getN4N42PrimeOTrimethylcytidineId() != null && this
				.getN4N42PrimeOTrimethylcytidineId().equals(
						castOther.getN4N42PrimeOTrimethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN4N42PrimeOTrimethylcytidineId() == null ? 0 : this
						.getN4N42PrimeOTrimethylcytidineId().hashCode());
		result = 37 * result
