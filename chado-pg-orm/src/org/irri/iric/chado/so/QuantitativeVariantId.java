...
/**
 * QuantitativeVariantId generated by hbm2java
 */
public class QuantitativeVariantId implements java.io.Serializable {

	private Integer quantitativeVariantId;
	...
	public QuantitativeVariantId() {
	}

	public QuantitativeVariantId(Integer quantitativeVariantId,
		...
		this.quantitativeVariantId = quantitativeVariantId;
	...
	public Integer getQuantitativeVariantId() {
		return this.quantitativeVariantId;
	}

	public void setQuantitativeVariantId(Integer quantitativeVariantId) {
		this.quantitativeVariantId = quantitativeVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QuantitativeVariantId))
			return false;
		QuantitativeVariantId castOther = (QuantitativeVariantId) other;

		return ((this.getQuantitativeVariantId() == castOther
				.getQuantitativeVariantId()) || (this
				.getQuantitativeVariantId() != null
				&& castOther.getQuantitativeVariantId() != null && this
				.getQuantitativeVariantId().equals(
						castOther.getQuantitativeVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getQuantitativeVariantId() == null ? 0 : this
						.getQuantitativeVariantId().hashCode());
		result = 37 * result
