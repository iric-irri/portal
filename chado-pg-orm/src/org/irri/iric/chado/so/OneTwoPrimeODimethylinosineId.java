...
/**
 * OneTwoPrimeODimethylinosineId generated by hbm2java
 */
public class OneTwoPrimeODimethylinosineId implements java.io.Serializable {

	private Integer oneTwoPrimeODimethylinosineId;
	...
	public OneTwoPrimeODimethylinosineId() {
	}

	public OneTwoPrimeODimethylinosineId(Integer oneTwoPrimeODimethylinosineId,
		...
		this.oneTwoPrimeODimethylinosineId = oneTwoPrimeODimethylinosineId;
	...
	public Integer getOneTwoPrimeODimethylinosineId() {
		return this.oneTwoPrimeODimethylinosineId;
	}

	public void setOneTwoPrimeODimethylinosineId(
			Integer oneTwoPrimeODimethylinosineId) {
		this.oneTwoPrimeODimethylinosineId = oneTwoPrimeODimethylinosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneTwoPrimeODimethylinosineId))
			return false;
		OneTwoPrimeODimethylinosineId castOther = (OneTwoPrimeODimethylinosineId) other;

		return ((this.getOneTwoPrimeODimethylinosineId() == castOther
				.getOneTwoPrimeODimethylinosineId()) || (this
				.getOneTwoPrimeODimethylinosineId() != null
				&& castOther.getOneTwoPrimeODimethylinosineId() != null && this
				.getOneTwoPrimeODimethylinosineId().equals(
						castOther.getOneTwoPrimeODimethylinosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneTwoPrimeODimethylinosineId() == null ? 0 : this
						.getOneTwoPrimeODimethylinosineId().hashCode());
		result = 37 * result
