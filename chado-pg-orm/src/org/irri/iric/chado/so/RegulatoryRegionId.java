...
/**
 * RegulatoryRegionId generated by hbm2java
 */
public class RegulatoryRegionId implements java.io.Serializable {

	private Integer regulatoryRegionId;
	...
	public RegulatoryRegionId() {
	}

	public RegulatoryRegionId(Integer regulatoryRegionId, Integer featureId,
	...
	public Integer getRegulatoryRegionId() {
		return this.regulatoryRegionId;
	}

	public void setRegulatoryRegionId(Integer regulatoryRegionId) {
		this.regulatoryRegionId = regulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegulatoryRegionId))
			return false;
		RegulatoryRegionId castOther = (RegulatoryRegionId) other;

		return ((this.getRegulatoryRegionId() == castOther
				.getRegulatoryRegionId()) || (this.getRegulatoryRegionId() != null
				&& castOther.getRegulatoryRegionId() != null && this
				.getRegulatoryRegionId().equals(
						castOther.getRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegulatoryRegionId() == null ? 0 : this
						.getRegulatoryRegionId().hashCode());
		result = 37 * result
