...
public class GeneAttributeId implements java.io.Serializable {
	...
	private Integer geneAttributeId;
	...
	public GeneAttributeId(Integer geneAttributeId, Integer featureId,
		...
		this.geneAttributeId = geneAttributeId;
	...
	public Integer getGeneAttributeId() {
		return this.geneAttributeId;
	}

	public void setGeneAttributeId(Integer geneAttributeId) {
		this.geneAttributeId = geneAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		return ((this.getGeneAttributeId() == castOther.getGeneAttributeId()) || (this
				.getGeneAttributeId() != null
				&& castOther.getGeneAttributeId() != null && this
				.getGeneAttributeId().equals(castOther.getGeneAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneAttributeId() == null ? 0 : this.getGeneAttributeId()
						.hashCode());
		result = 37 * result
