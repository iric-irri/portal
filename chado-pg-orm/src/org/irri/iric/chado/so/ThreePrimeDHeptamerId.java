...
/**
 * ThreePrimeDHeptamerId generated by hbm2java
 */
public class ThreePrimeDHeptamerId implements java.io.Serializable {

	private Integer threePrimeDHeptamerId;
	...
	public ThreePrimeDHeptamerId() {
	}

	public ThreePrimeDHeptamerId(Integer threePrimeDHeptamerId,
		...
		this.threePrimeDHeptamerId = threePrimeDHeptamerId;
	...
	public Integer getThreePrimeDHeptamerId() {
		return this.threePrimeDHeptamerId;
	}

	public void setThreePrimeDHeptamerId(Integer threePrimeDHeptamerId) {
		this.threePrimeDHeptamerId = threePrimeDHeptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeDHeptamerId))
			return false;
		ThreePrimeDHeptamerId castOther = (ThreePrimeDHeptamerId) other;

		return ((this.getThreePrimeDHeptamerId() == castOther
				.getThreePrimeDHeptamerId()) || (this
				.getThreePrimeDHeptamerId() != null
				&& castOther.getThreePrimeDHeptamerId() != null && this
				.getThreePrimeDHeptamerId().equals(
						castOther.getThreePrimeDHeptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeDHeptamerId() == null ? 0 : this
						.getThreePrimeDHeptamerId().hashCode());
		result = 37 * result
