...
/**
 * UncharacterisedChromosomalMutationId generated by hbm2java
 */
public class UncharacterisedChromosomalMutationId implements
		java.io.Serializable {

	private Integer uncharacterisedChromosomalMutationId;
	...
	public UncharacterisedChromosomalMutationId() {
	}

	public UncharacterisedChromosomalMutationId(
			Integer uncharacterisedChromosomalMutationId, Integer featureId,
		...
		this.uncharacterisedChromosomalMutationId = uncharacterisedChromosomalMutationId;
	...
	public Integer getUncharacterisedChromosomalMutationId() {
		return this.uncharacterisedChromosomalMutationId;
	}

	public void setUncharacterisedChromosomalMutationId(
			Integer uncharacterisedChromosomalMutationId) {
		this.uncharacterisedChromosomalMutationId = uncharacterisedChromosomalMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UncharacterisedChromosomalMutationId))
			return false;
		UncharacterisedChromosomalMutationId castOther = (UncharacterisedChromosomalMutationId) other;

		return ((this.getUncharacterisedChromosomalMutationId() == castOther
				.getUncharacterisedChromosomalMutationId()) || (this
				.getUncharacterisedChromosomalMutationId() != null
				&& castOther.getUncharacterisedChromosomalMutationId() != null && this
				.getUncharacterisedChromosomalMutationId().equals(
						castOther.getUncharacterisedChromosomalMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUncharacterisedChromosomalMutationId() == null ? 0 : this
						.getUncharacterisedChromosomalMutationId().hashCode());
		result = 37 * result
