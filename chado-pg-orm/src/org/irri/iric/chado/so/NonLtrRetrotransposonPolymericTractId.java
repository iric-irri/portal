...
/**
 * NonLtrRetrotransposonPolymericTractId generated by hbm2java
 */
public class NonLtrRetrotransposonPolymericTractId implements
		java.io.Serializable {

	private Integer nonLtrRetrotransposonPolymericTractId;
	...
	public NonLtrRetrotransposonPolymericTractId() {
	}

	public NonLtrRetrotransposonPolymericTractId(
			Integer nonLtrRetrotransposonPolymericTractId, Integer featureId,
		...
		this.nonLtrRetrotransposonPolymericTractId = nonLtrRetrotransposonPolymericTractId;
	...
	public Integer getNonLtrRetrotransposonPolymericTractId() {
		return this.nonLtrRetrotransposonPolymericTractId;
	}

	public void setNonLtrRetrotransposonPolymericTractId(
			Integer nonLtrRetrotransposonPolymericTractId) {
		this.nonLtrRetrotransposonPolymericTractId = nonLtrRetrotransposonPolymericTractId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonLtrRetrotransposonPolymericTractId))
			return false;
		NonLtrRetrotransposonPolymericTractId castOther = (NonLtrRetrotransposonPolymericTractId) other;

		return ((this.getNonLtrRetrotransposonPolymericTractId() == castOther
				.getNonLtrRetrotransposonPolymericTractId()) || (this
				.getNonLtrRetrotransposonPolymericTractId() != null
				&& castOther.getNonLtrRetrotransposonPolymericTractId() != null && this
				.getNonLtrRetrotransposonPolymericTractId().equals(
						castOther.getNonLtrRetrotransposonPolymericTractId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonLtrRetrotransposonPolymericTractId() == null ? 0
						: this.getNonLtrRetrotransposonPolymericTractId()
								.hashCode());
		result = 37 * result
