...
/**
 * InversionCumTranslocationId generated by hbm2java
 */
public class InversionCumTranslocationId implements java.io.Serializable {

	private Integer inversionCumTranslocationId;
	...
	public InversionCumTranslocationId() {
	}

	public InversionCumTranslocationId(Integer inversionCumTranslocationId,
		...
		this.inversionCumTranslocationId = inversionCumTranslocationId;
	...
	public Integer getInversionCumTranslocationId() {
		return this.inversionCumTranslocationId;
	}

	public void setInversionCumTranslocationId(
			Integer inversionCumTranslocationId) {
		this.inversionCumTranslocationId = inversionCumTranslocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionCumTranslocationId))
			return false;
		InversionCumTranslocationId castOther = (InversionCumTranslocationId) other;

		return ((this.getInversionCumTranslocationId() == castOther
				.getInversionCumTranslocationId()) || (this
				.getInversionCumTranslocationId() != null
				&& castOther.getInversionCumTranslocationId() != null && this
				.getInversionCumTranslocationId().equals(
						castOther.getInversionCumTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionCumTranslocationId() == null ? 0 : this
						.getInversionCumTranslocationId().hashCode());
		result = 37 * result
