...
/**
 * GeneWithStopCodonRedefinedAsSelenocysteineId generated by hbm2java
 */
public class GeneWithStopCodonRedefinedAsSelenocysteineId implements
		java.io.Serializable {

	private Integer geneWithStopCodonRedefinedAsSelenocysteineId;
	...
	public GeneWithStopCodonRedefinedAsSelenocysteineId() {
	}

	public GeneWithStopCodonRedefinedAsSelenocysteineId(
			Integer geneWithStopCodonRedefinedAsSelenocysteineId,
		...
		this.geneWithStopCodonRedefinedAsSelenocysteineId = geneWithStopCodonRedefinedAsSelenocysteineId;
	...
	public Integer getGeneWithStopCodonRedefinedAsSelenocysteineId() {
		return this.geneWithStopCodonRedefinedAsSelenocysteineId;
	}

	public void setGeneWithStopCodonRedefinedAsSelenocysteineId(
			Integer geneWithStopCodonRedefinedAsSelenocysteineId) {
		this.geneWithStopCodonRedefinedAsSelenocysteineId = geneWithStopCodonRedefinedAsSelenocysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithStopCodonRedefinedAsSelenocysteineId))
			return false;
		GeneWithStopCodonRedefinedAsSelenocysteineId castOther = (GeneWithStopCodonRedefinedAsSelenocysteineId) other;

		return ((this.getGeneWithStopCodonRedefinedAsSelenocysteineId() == castOther
				.getGeneWithStopCodonRedefinedAsSelenocysteineId()) || (this
				.getGeneWithStopCodonRedefinedAsSelenocysteineId() != null
				&& castOther.getGeneWithStopCodonRedefinedAsSelenocysteineId() != null && this
				.getGeneWithStopCodonRedefinedAsSelenocysteineId()
				.equals(castOther
						.getGeneWithStopCodonRedefinedAsSelenocysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithStopCodonRedefinedAsSelenocysteineId() == null ? 0
						: this.getGeneWithStopCodonRedefinedAsSelenocysteineId()
								.hashCode());
		result = 37 * result
