...
/**
 * PreEditedMrnaId generated by hbm2java
 */
public class PreEditedMrnaId implements java.io.Serializable {

	private Integer preEditedMrnaId;
	...
	public PreEditedMrnaId() {
	}

	public PreEditedMrnaId(Integer preEditedMrnaId, Integer featureId,
		...
		this.preEditedMrnaId = preEditedMrnaId;
	...
	public Integer getPreEditedMrnaId() {
		return this.preEditedMrnaId;
	}

	public void setPreEditedMrnaId(Integer preEditedMrnaId) {
		this.preEditedMrnaId = preEditedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreEditedMrnaId))
			return false;
		PreEditedMrnaId castOther = (PreEditedMrnaId) other;

		return ((this.getPreEditedMrnaId() == castOther.getPreEditedMrnaId()) || (this
				.getPreEditedMrnaId() != null
				&& castOther.getPreEditedMrnaId() != null && this
				.getPreEditedMrnaId().equals(castOther.getPreEditedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPreEditedMrnaId() == null ? 0 : this.getPreEditedMrnaId()
						.hashCode());
		result = 37 * result
