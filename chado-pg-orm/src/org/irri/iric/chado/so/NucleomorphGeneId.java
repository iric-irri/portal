...
/**
 * NucleomorphGeneId generated by hbm2java
 */
public class NucleomorphGeneId implements java.io.Serializable {

	private Integer nucleomorphGeneId;
	...
	public NucleomorphGeneId() {
	}

	public NucleomorphGeneId(Integer nucleomorphGeneId, Integer featureId,
		...
		this.nucleomorphGeneId = nucleomorphGeneId;
	...
	public Integer getNucleomorphGeneId() {
		return this.nucleomorphGeneId;
	}

	public void setNucleomorphGeneId(Integer nucleomorphGeneId) {
		this.nucleomorphGeneId = nucleomorphGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleomorphGeneId))
			return false;
		NucleomorphGeneId castOther = (NucleomorphGeneId) other;

		return ((this.getNucleomorphGeneId() == castOther
				.getNucleomorphGeneId()) || (this.getNucleomorphGeneId() != null
				&& castOther.getNucleomorphGeneId() != null && this
				.getNucleomorphGeneId()
				.equals(castOther.getNucleomorphGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleomorphGeneId() == null ? 0 : this
						.getNucleomorphGeneId().hashCode());
		result = 37 * result
