...
/**
 * ResolutionSiteId generated by hbm2java
 */
public class ResolutionSiteId implements java.io.Serializable {

	private Integer resolutionSiteId;
	...
	public ResolutionSiteId() {
	}

	public ResolutionSiteId(Integer resolutionSiteId, Integer featureId,
		...
		this.resolutionSiteId = resolutionSiteId;
	...
	public Integer getResolutionSiteId() {
		return this.resolutionSiteId;
	}

	public void setResolutionSiteId(Integer resolutionSiteId) {
		this.resolutionSiteId = resolutionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ResolutionSiteId))
			return false;
		ResolutionSiteId castOther = (ResolutionSiteId) other;

		return ((this.getResolutionSiteId() == castOther.getResolutionSiteId()) || (this
				.getResolutionSiteId() != null
				&& castOther.getResolutionSiteId() != null && this
				.getResolutionSiteId().equals(castOther.getResolutionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getResolutionSiteId() == null ? 0 : this
						.getResolutionSiteId().hashCode());
		result = 37 * result
