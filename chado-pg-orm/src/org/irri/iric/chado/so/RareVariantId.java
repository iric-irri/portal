...
/**
 * RareVariantId generated by hbm2java
 */
public class RareVariantId implements java.io.Serializable {

	private Integer rareVariantId;
	...
	public RareVariantId() {
	}

	public RareVariantId(Integer rareVariantId, Integer featureId,
		...
		this.rareVariantId = rareVariantId;
	...
	public Integer getRareVariantId() {
		return this.rareVariantId;
	}

	public void setRareVariantId(Integer rareVariantId) {
		this.rareVariantId = rareVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RareVariantId))
			return false;
		RareVariantId castOther = (RareVariantId) other;

		return ((this.getRareVariantId() == castOther.getRareVariantId()) || (this
				.getRareVariantId() != null
				&& castOther.getRareVariantId() != null && this
				.getRareVariantId().equals(castOther.getRareVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRareVariantId() == null ? 0 : this.getRareVariantId()
						.hashCode());
		result = 37 * result
