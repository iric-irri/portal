...
/**
 * ThreePrimeDRecombinationSignalSequenceId generated by hbm2java
 */
public class ThreePrimeDRecombinationSignalSequenceId implements
		java.io.Serializable {

	private Integer threePrimeDRecombinationSignalSequenceId;
	...
	public ThreePrimeDRecombinationSignalSequenceId() {
	}

	public ThreePrimeDRecombinationSignalSequenceId(
			Integer threePrimeDRecombinationSignalSequenceId,
		...
		this.threePrimeDRecombinationSignalSequenceId = threePrimeDRecombinationSignalSequenceId;
	...
	public Integer getThreePrimeDRecombinationSignalSequenceId() {
		return this.threePrimeDRecombinationSignalSequenceId;
	}

	public void setThreePrimeDRecombinationSignalSequenceId(
			Integer threePrimeDRecombinationSignalSequenceId) {
		this.threePrimeDRecombinationSignalSequenceId = threePrimeDRecombinationSignalSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeDRecombinationSignalSequenceId))
			return false;
		ThreePrimeDRecombinationSignalSequenceId castOther = (ThreePrimeDRecombinationSignalSequenceId) other;

		return ((this.getThreePrimeDRecombinationSignalSequenceId() == castOther
				.getThreePrimeDRecombinationSignalSequenceId()) || (this
				.getThreePrimeDRecombinationSignalSequenceId() != null
				&& castOther.getThreePrimeDRecombinationSignalSequenceId() != null && this
				.getThreePrimeDRecombinationSignalSequenceId()
				.equals(castOther.getThreePrimeDRecombinationSignalSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeDRecombinationSignalSequenceId() == null ? 0
						: this.getThreePrimeDRecombinationSignalSequenceId()
								.hashCode());
		result = 37 * result
