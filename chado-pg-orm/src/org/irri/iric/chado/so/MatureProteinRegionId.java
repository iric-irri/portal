...
/**
 * MatureProteinRegionId generated by hbm2java
 */
public class MatureProteinRegionId implements java.io.Serializable {

	private Integer matureProteinRegionId;
	...
	public MatureProteinRegionId() {
	}

	public MatureProteinRegionId(Integer matureProteinRegionId,
		...
		this.matureProteinRegionId = matureProteinRegionId;
	...
	public Integer getMatureProteinRegionId() {
		return this.matureProteinRegionId;
	}

	public void setMatureProteinRegionId(Integer matureProteinRegionId) {
		this.matureProteinRegionId = matureProteinRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatureProteinRegionId))
			return false;
		MatureProteinRegionId castOther = (MatureProteinRegionId) other;

		return ((this.getMatureProteinRegionId() == castOther
				.getMatureProteinRegionId()) || (this
				.getMatureProteinRegionId() != null
				&& castOther.getMatureProteinRegionId() != null && this
				.getMatureProteinRegionId().equals(
						castOther.getMatureProteinRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatureProteinRegionId() == null ? 0 : this
						.getMatureProteinRegionId().hashCode());
		result = 37 * result
