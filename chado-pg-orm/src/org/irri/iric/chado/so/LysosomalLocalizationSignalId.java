...
/**
 * LysosomalLocalizationSignalId generated by hbm2java
 */
public class LysosomalLocalizationSignalId implements java.io.Serializable {

	private Integer lysosomalLocalizationSignalId;
	...
	public LysosomalLocalizationSignalId() {
	}

	public LysosomalLocalizationSignalId(Integer lysosomalLocalizationSignalId,
		...
		this.lysosomalLocalizationSignalId = lysosomalLocalizationSignalId;
	...
	public Integer getLysosomalLocalizationSignalId() {
		return this.lysosomalLocalizationSignalId;
	}

	public void setLysosomalLocalizationSignalId(
			Integer lysosomalLocalizationSignalId) {
		this.lysosomalLocalizationSignalId = lysosomalLocalizationSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LysosomalLocalizationSignalId))
			return false;
		LysosomalLocalizationSignalId castOther = (LysosomalLocalizationSignalId) other;

		return ((this.getLysosomalLocalizationSignalId() == castOther
				.getLysosomalLocalizationSignalId()) || (this
				.getLysosomalLocalizationSignalId() != null
				&& castOther.getLysosomalLocalizationSignalId() != null && this
				.getLysosomalLocalizationSignalId().equals(
						castOther.getLysosomalLocalizationSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLysosomalLocalizationSignalId() == null ? 0 : this
						.getLysosomalLocalizationSignalId().hashCode());
		result = 37 * result
