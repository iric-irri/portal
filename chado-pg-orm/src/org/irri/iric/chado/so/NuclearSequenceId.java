...
/**
 * NuclearSequenceId generated by hbm2java
 */
public class NuclearSequenceId implements java.io.Serializable {

	private Integer nuclearSequenceId;
	...
	public NuclearSequenceId() {
	}

	public NuclearSequenceId(Integer nuclearSequenceId, Integer featureId,
		...
		this.nuclearSequenceId = nuclearSequenceId;
	...
	public Integer getNuclearSequenceId() {
		return this.nuclearSequenceId;
	}

	public void setNuclearSequenceId(Integer nuclearSequenceId) {
		this.nuclearSequenceId = nuclearSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearSequenceId))
			return false;
		NuclearSequenceId castOther = (NuclearSequenceId) other;

		return ((this.getNuclearSequenceId() == castOther
				.getNuclearSequenceId()) || (this.getNuclearSequenceId() != null
				&& castOther.getNuclearSequenceId() != null && this
				.getNuclearSequenceId()
				.equals(castOther.getNuclearSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearSequenceId() == null ? 0 : this
						.getNuclearSequenceId().hashCode());
		result = 37 * result
