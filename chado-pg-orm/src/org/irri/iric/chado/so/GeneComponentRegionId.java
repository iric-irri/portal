...
/**
 * GeneComponentRegionId generated by hbm2java
 */
public class GeneComponentRegionId implements java.io.Serializable {

	private Integer geneComponentRegionId;
	...
	public GeneComponentRegionId() {
	}

	public GeneComponentRegionId(Integer geneComponentRegionId,
		...
		this.geneComponentRegionId = geneComponentRegionId;
	...
	public Integer getGeneComponentRegionId() {
		return this.geneComponentRegionId;
	}

	public void setGeneComponentRegionId(Integer geneComponentRegionId) {
		this.geneComponentRegionId = geneComponentRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneComponentRegionId))
			return false;
		GeneComponentRegionId castOther = (GeneComponentRegionId) other;

		return ((this.getGeneComponentRegionId() == castOther
				.getGeneComponentRegionId()) || (this
				.getGeneComponentRegionId() != null
				&& castOther.getGeneComponentRegionId() != null && this
				.getGeneComponentRegionId().equals(
						castOther.getGeneComponentRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneComponentRegionId() == null ? 0 : this
						.getGeneComponentRegionId().hashCode());
		result = 37 * result
