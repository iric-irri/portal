...
/**
 * RnaId generated by hbm2java
 */
public class RnaId implements java.io.Serializable {

	private Integer rnaId;
	...
	public RnaId(Integer rnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRnaId() {
		return this.rnaId;
	}

	public void setRnaId(Integer rnaId) {
		this.rnaId = rnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaId))
			return false;
		RnaId castOther = (RnaId) other;

		return ((this.getRnaId() == castOther.getRnaId()) || (this.getRnaId() != null
				&& castOther.getRnaId() != null && this.getRnaId().equals(
				castOther.getRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRnaId() == null ? 0 : this.getRnaId().hashCode());
		result = 37 * result
