...
/**
 * VVjCClusterId generated by hbm2java
 */
public class VVjCClusterId implements java.io.Serializable {

	private Integer VVjCClusterId;
	...
	public VVjCClusterId() {
	}

	public VVjCClusterId(Integer VVjCClusterId, Integer featureId,
		...
		this.VVjCClusterId = VVjCClusterId;
	...
	public Integer getVVjCClusterId() {
		return this.VVjCClusterId;
	}

	public void setVVjCClusterId(Integer VVjCClusterId) {
		this.VVjCClusterId = VVjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVjCClusterId))
			return false;
		VVjCClusterId castOther = (VVjCClusterId) other;

		return ((this.getVVjCClusterId() == castOther.getVVjCClusterId()) || (this
				.getVVjCClusterId() != null
				&& castOther.getVVjCClusterId() != null && this
				.getVVjCClusterId().equals(castOther.getVVjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVjCClusterId() == null ? 0 : this.getVVjCClusterId()
						.hashCode());
		result = 37 * result
