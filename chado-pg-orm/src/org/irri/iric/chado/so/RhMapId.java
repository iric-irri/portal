...
/**
 * RhMapId generated by hbm2java
 */
public class RhMapId implements java.io.Serializable {

	private Integer rhMapId;
	...
	public RhMapId(Integer rhMapId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRhMapId() {
		return this.rhMapId;
	}

	public void setRhMapId(Integer rhMapId) {
		this.rhMapId = rhMapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RhMapId))
			return false;
		RhMapId castOther = (RhMapId) other;

		return ((this.getRhMapId() == castOther.getRhMapId()) || (this
				.getRhMapId() != null && castOther.getRhMapId() != null && this
				.getRhMapId().equals(castOther.getRhMapId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRhMapId() == null ? 0 : this.getRhMapId().hashCode());
		result = 37 * result
