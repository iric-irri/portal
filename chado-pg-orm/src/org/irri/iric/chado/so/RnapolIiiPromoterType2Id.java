...
/**
 * RnapolIiiPromoterType2Id generated by hbm2java
 */
public class RnapolIiiPromoterType2Id implements java.io.Serializable {

	private Integer rnapolIiiPromoterType2Id;
	...
	public RnapolIiiPromoterType2Id() {
	}

	public RnapolIiiPromoterType2Id(Integer rnapolIiiPromoterType2Id,
		...
		this.rnapolIiiPromoterType2Id = rnapolIiiPromoterType2Id;
	...
	public Integer getRnapolIiiPromoterType2Id() {
		return this.rnapolIiiPromoterType2Id;
	}

	public void setRnapolIiiPromoterType2Id(Integer rnapolIiiPromoterType2Id) {
		this.rnapolIiiPromoterType2Id = rnapolIiiPromoterType2Id;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnapolIiiPromoterType2Id))
			return false;
		RnapolIiiPromoterType2Id castOther = (RnapolIiiPromoterType2Id) other;

		return ((this.getRnapolIiiPromoterType2Id() == castOther
				.getRnapolIiiPromoterType2Id()) || (this
				.getRnapolIiiPromoterType2Id() != null
				&& castOther.getRnapolIiiPromoterType2Id() != null && this
				.getRnapolIiiPromoterType2Id().equals(
						castOther.getRnapolIiiPromoterType2Id())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnapolIiiPromoterType2Id() == null ? 0 : this
						.getRnapolIiiPromoterType2Id().hashCode());
		result = 37 * result
