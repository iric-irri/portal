...
/**
 * RibosomeEntrySiteId generated by hbm2java
 */
public class RibosomeEntrySiteId implements java.io.Serializable {

	private Integer ribosomeEntrySiteId;
	...
	public RibosomeEntrySiteId() {
	}

	public RibosomeEntrySiteId(Integer ribosomeEntrySiteId, Integer featureId,
		...
		this.ribosomeEntrySiteId = ribosomeEntrySiteId;
	...
	public Integer getRibosomeEntrySiteId() {
		return this.ribosomeEntrySiteId;
	}

	public void setRibosomeEntrySiteId(Integer ribosomeEntrySiteId) {
		this.ribosomeEntrySiteId = ribosomeEntrySiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RibosomeEntrySiteId))
			return false;
		RibosomeEntrySiteId castOther = (RibosomeEntrySiteId) other;

		return ((this.getRibosomeEntrySiteId() == castOther
				.getRibosomeEntrySiteId()) || (this.getRibosomeEntrySiteId() != null
				&& castOther.getRibosomeEntrySiteId() != null && this
				.getRibosomeEntrySiteId().equals(
						castOther.getRibosomeEntrySiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRibosomeEntrySiteId() == null ? 0 : this
						.getRibosomeEntrySiteId().hashCode());
		result = 37 * result
