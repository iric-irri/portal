...
/**
 * HistidineId generated by hbm2java
 */
public class HistidineId implements java.io.Serializable {

	private Integer histidineId;
	...
	public HistidineId(Integer histidineId, Integer featureId,
	...
	public Integer getHistidineId() {
		return this.histidineId;
	}

	public void setHistidineId(Integer histidineId) {
		this.histidineId = histidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistidineId))
			return false;
		HistidineId castOther = (HistidineId) other;

		return ((this.getHistidineId() == castOther.getHistidineId()) || (this
				.getHistidineId() != null && castOther.getHistidineId() != null && this
				.getHistidineId().equals(castOther.getHistidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistidineId() == null ? 0 : this.getHistidineId()
						.hashCode());
		result = 37 * result
