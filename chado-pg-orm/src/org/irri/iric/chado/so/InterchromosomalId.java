...
/**
 * InterchromosomalId generated by hbm2java
 */
public class InterchromosomalId implements java.io.Serializable {

	private Integer interchromosomalId;
	...
	public InterchromosomalId() {
	}

	public InterchromosomalId(Integer interchromosomalId, Integer featureId,
		...
		this.interchromosomalId = interchromosomalId;
	...
	public Integer getInterchromosomalId() {
		return this.interchromosomalId;
	}

	public void setInterchromosomalId(Integer interchromosomalId) {
		this.interchromosomalId = interchromosomalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InterchromosomalId))
			return false;
		InterchromosomalId castOther = (InterchromosomalId) other;

		return ((this.getInterchromosomalId() == castOther
				.getInterchromosomalId()) || (this.getInterchromosomalId() != null
				&& castOther.getInterchromosomalId() != null && this
				.getInterchromosomalId().equals(
						castOther.getInterchromosomalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInterchromosomalId() == null ? 0 : this
						.getInterchromosomalId().hashCode());
		result = 37 * result
