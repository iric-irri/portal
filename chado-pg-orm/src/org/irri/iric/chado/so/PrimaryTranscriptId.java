...
/**
 * PrimaryTranscriptId generated by hbm2java
 */
public class PrimaryTranscriptId implements java.io.Serializable {

	private Integer primaryTranscriptId;
	...
	public PrimaryTranscriptId() {
	}

	public PrimaryTranscriptId(Integer primaryTranscriptId, Integer featureId,
	...
	public Integer getPrimaryTranscriptId() {
		return this.primaryTranscriptId;
	}

	public void setPrimaryTranscriptId(Integer primaryTranscriptId) {
		this.primaryTranscriptId = primaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrimaryTranscriptId))
			return false;
		PrimaryTranscriptId castOther = (PrimaryTranscriptId) other;

		return ((this.getPrimaryTranscriptId() == castOther
				.getPrimaryTranscriptId()) || (this.getPrimaryTranscriptId() != null
				&& castOther.getPrimaryTranscriptId() != null && this
				.getPrimaryTranscriptId().equals(
						castOther.getPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPrimaryTranscriptId() == null ? 0 : this
						.getPrimaryTranscriptId().hashCode());
		result = 37 * result
