...
/**
 * EpoxyqueuosineId generated by hbm2java
 */
public class EpoxyqueuosineId implements java.io.Serializable {

	private Integer epoxyqueuosineId;
	...
	public EpoxyqueuosineId() {
	}

	public EpoxyqueuosineId(Integer epoxyqueuosineId, Integer featureId,
		...
		this.epoxyqueuosineId = epoxyqueuosineId;
	...
	public Integer getEpoxyqueuosineId() {
		return this.epoxyqueuosineId;
	}

	public void setEpoxyqueuosineId(Integer epoxyqueuosineId) {
		this.epoxyqueuosineId = epoxyqueuosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpoxyqueuosineId))
			return false;
		EpoxyqueuosineId castOther = (EpoxyqueuosineId) other;

		return ((this.getEpoxyqueuosineId() == castOther.getEpoxyqueuosineId()) || (this
				.getEpoxyqueuosineId() != null
				&& castOther.getEpoxyqueuosineId() != null && this
				.getEpoxyqueuosineId().equals(castOther.getEpoxyqueuosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEpoxyqueuosineId() == null ? 0 : this
						.getEpoxyqueuosineId().hashCode());
		result = 37 * result
