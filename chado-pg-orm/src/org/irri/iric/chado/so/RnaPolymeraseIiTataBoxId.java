...
/**
 * RnaPolymeraseIiTataBoxId generated by hbm2java
 */
public class RnaPolymeraseIiTataBoxId implements java.io.Serializable {

	private Integer rnaPolymeraseIiTataBoxId;
	...
	public RnaPolymeraseIiTataBoxId() {
	}

	public RnaPolymeraseIiTataBoxId(Integer rnaPolymeraseIiTataBoxId,
		...
		this.rnaPolymeraseIiTataBoxId = rnaPolymeraseIiTataBoxId;
	...
	public Integer getRnaPolymeraseIiTataBoxId() {
		return this.rnaPolymeraseIiTataBoxId;
	}

	public void setRnaPolymeraseIiTataBoxId(Integer rnaPolymeraseIiTataBoxId) {
		this.rnaPolymeraseIiTataBoxId = rnaPolymeraseIiTataBoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaPolymeraseIiTataBoxId))
			return false;
		RnaPolymeraseIiTataBoxId castOther = (RnaPolymeraseIiTataBoxId) other;

		return ((this.getRnaPolymeraseIiTataBoxId() == castOther
				.getRnaPolymeraseIiTataBoxId()) || (this
				.getRnaPolymeraseIiTataBoxId() != null
				&& castOther.getRnaPolymeraseIiTataBoxId() != null && this
				.getRnaPolymeraseIiTataBoxId().equals(
						castOther.getRnaPolymeraseIiTataBoxId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaPolymeraseIiTataBoxId() == null ? 0 : this
						.getRnaPolymeraseIiTataBoxId().hashCode());
		result = 37 * result
