...
/**
 * DirectId generated by hbm2java
 */
public class DirectId implements java.io.Serializable {
	...
	public DirectId(Integer directId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DirectId))
			return false;
		DirectId castOther = (DirectId) other;

		return ((this.getDirectId() == castOther.getDirectId()) || (this
				.getDirectId() != null && castOther.getDirectId() != null && this
				.getDirectId().equals(castOther.getDirectId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDirectId() == null ? 0 : this.getDirectId().hashCode());
		result = 37 * result
