...
/**
 * IntegratedPlasmidId generated by hbm2java
 */
public class IntegratedPlasmidId implements java.io.Serializable {

	private Integer integratedPlasmidId;
	...
	public IntegratedPlasmidId() {
	}

	public IntegratedPlasmidId(Integer integratedPlasmidId, Integer featureId,
		...
		this.integratedPlasmidId = integratedPlasmidId;
	...
	public Integer getIntegratedPlasmidId() {
		return this.integratedPlasmidId;
	}

	public void setIntegratedPlasmidId(Integer integratedPlasmidId) {
		this.integratedPlasmidId = integratedPlasmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntegratedPlasmidId))
			return false;
		IntegratedPlasmidId castOther = (IntegratedPlasmidId) other;

		return ((this.getIntegratedPlasmidId() == castOther
				.getIntegratedPlasmidId()) || (this.getIntegratedPlasmidId() != null
				&& castOther.getIntegratedPlasmidId() != null && this
				.getIntegratedPlasmidId().equals(
						castOther.getIntegratedPlasmidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntegratedPlasmidId() == null ? 0 : this
						.getIntegratedPlasmidId().hashCode());
		result = 37 * result
