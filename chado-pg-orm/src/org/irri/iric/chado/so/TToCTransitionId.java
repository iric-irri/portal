...
/**
 * TToCTransitionId generated by hbm2java
 */
public class TToCTransitionId implements java.io.Serializable {

	private Integer TToCTransitionId;
	...
	public TToCTransitionId() {
	}

	public TToCTransitionId(Integer TToCTransitionId, Integer featureId,
		...
		this.TToCTransitionId = TToCTransitionId;
	...
	public Integer getTToCTransitionId() {
		return this.TToCTransitionId;
	}

	public void setTToCTransitionId(Integer TToCTransitionId) {
		this.TToCTransitionId = TToCTransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TToCTransitionId))
			return false;
		TToCTransitionId castOther = (TToCTransitionId) other;

		return ((this.getTToCTransitionId() == castOther.getTToCTransitionId()) || (this
				.getTToCTransitionId() != null
				&& castOther.getTToCTransitionId() != null && this
				.getTToCTransitionId().equals(castOther.getTToCTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTToCTransitionId() == null ? 0 : this
						.getTToCTransitionId().hashCode());
		result = 37 * result
