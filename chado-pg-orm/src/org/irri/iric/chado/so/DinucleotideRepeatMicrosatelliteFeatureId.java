...
/**
 * DinucleotideRepeatMicrosatelliteFeatureId generated by hbm2java
 */
public class DinucleotideRepeatMicrosatelliteFeatureId implements
		java.io.Serializable {

	private Integer dinucleotideRepeatMicrosatelliteFeatureId;
	...
	public DinucleotideRepeatMicrosatelliteFeatureId() {
	}

	public DinucleotideRepeatMicrosatelliteFeatureId(
			Integer dinucleotideRepeatMicrosatelliteFeatureId,
		...
		this.dinucleotideRepeatMicrosatelliteFeatureId = dinucleotideRepeatMicrosatelliteFeatureId;
	...
	public Integer getDinucleotideRepeatMicrosatelliteFeatureId() {
		return this.dinucleotideRepeatMicrosatelliteFeatureId;
	}

	public void setDinucleotideRepeatMicrosatelliteFeatureId(
			Integer dinucleotideRepeatMicrosatelliteFeatureId) {
		this.dinucleotideRepeatMicrosatelliteFeatureId = dinucleotideRepeatMicrosatelliteFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DinucleotideRepeatMicrosatelliteFeatureId))
			return false;
		DinucleotideRepeatMicrosatelliteFeatureId castOther = (DinucleotideRepeatMicrosatelliteFeatureId) other;

		return ((this.getDinucleotideRepeatMicrosatelliteFeatureId() == castOther
				.getDinucleotideRepeatMicrosatelliteFeatureId()) || (this
				.getDinucleotideRepeatMicrosatelliteFeatureId() != null
				&& castOther.getDinucleotideRepeatMicrosatelliteFeatureId() != null && this
				.getDinucleotideRepeatMicrosatelliteFeatureId()
				.equals(castOther
						.getDinucleotideRepeatMicrosatelliteFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDinucleotideRepeatMicrosatelliteFeatureId() == null ? 0
						: this.getDinucleotideRepeatMicrosatelliteFeatureId()
								.hashCode());
		result = 37 * result
