...
/**
 * SilencerId generated by hbm2java
 */
public class SilencerId implements java.io.Serializable {
	...
	public SilencerId(Integer silencerId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencerId))
			return false;
		SilencerId castOther = (SilencerId) other;

		return ((this.getSilencerId() == castOther.getSilencerId()) || (this
				.getSilencerId() != null && castOther.getSilencerId() != null && this
				.getSilencerId().equals(castOther.getSilencerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencerId() == null ? 0 : this.getSilencerId()
						.hashCode());
		result = 37 * result
