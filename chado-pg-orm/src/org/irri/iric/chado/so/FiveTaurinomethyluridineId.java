...
/**
 * FiveTaurinomethyluridineId generated by hbm2java
 */
public class FiveTaurinomethyluridineId implements java.io.Serializable {

	private Integer fiveTaurinomethyluridineId;
	...
	public FiveTaurinomethyluridineId() {
	}

	public FiveTaurinomethyluridineId(Integer fiveTaurinomethyluridineId,
		...
		this.fiveTaurinomethyluridineId = fiveTaurinomethyluridineId;
	...
	public Integer getFiveTaurinomethyluridineId() {
		return this.fiveTaurinomethyluridineId;
	}

	public void setFiveTaurinomethyluridineId(Integer fiveTaurinomethyluridineId) {
		this.fiveTaurinomethyluridineId = fiveTaurinomethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveTaurinomethyluridineId))
			return false;
		FiveTaurinomethyluridineId castOther = (FiveTaurinomethyluridineId) other;

		return ((this.getFiveTaurinomethyluridineId() == castOther
				.getFiveTaurinomethyluridineId()) || (this
				.getFiveTaurinomethyluridineId() != null
				&& castOther.getFiveTaurinomethyluridineId() != null && this
				.getFiveTaurinomethyluridineId().equals(
						castOther.getFiveTaurinomethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveTaurinomethyluridineId() == null ? 0 : this
						.getFiveTaurinomethyluridineId().hashCode());
		result = 37 * result
