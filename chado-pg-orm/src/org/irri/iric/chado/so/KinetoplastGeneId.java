...
/**
 * KinetoplastGeneId generated by hbm2java
 */
public class KinetoplastGeneId implements java.io.Serializable {

	private Integer kinetoplastGeneId;
	...
	public KinetoplastGeneId() {
	}

	public KinetoplastGeneId(Integer kinetoplastGeneId, Integer featureId,
		...
		this.kinetoplastGeneId = kinetoplastGeneId;
	...
	public Integer getKinetoplastGeneId() {
		return this.kinetoplastGeneId;
	}

	public void setKinetoplastGeneId(Integer kinetoplastGeneId) {
		this.kinetoplastGeneId = kinetoplastGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KinetoplastGeneId))
			return false;
		KinetoplastGeneId castOther = (KinetoplastGeneId) other;

		return ((this.getKinetoplastGeneId() == castOther
				.getKinetoplastGeneId()) || (this.getKinetoplastGeneId() != null
				&& castOther.getKinetoplastGeneId() != null && this
				.getKinetoplastGeneId()
				.equals(castOther.getKinetoplastGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getKinetoplastGeneId() == null ? 0 : this
						.getKinetoplastGeneId().hashCode());
		result = 37 * result
