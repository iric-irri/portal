...
/**
 * PseMotifId generated by hbm2java
 */
public class PseMotifId implements java.io.Serializable {

	private Integer pseMotifId;
	...
	public PseMotifId(Integer pseMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPseMotifId() {
		return this.pseMotifId;
	}

	public void setPseMotifId(Integer pseMotifId) {
		this.pseMotifId = pseMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseMotifId))
			return false;
		PseMotifId castOther = (PseMotifId) other;

		return ((this.getPseMotifId() == castOther.getPseMotifId()) || (this
				.getPseMotifId() != null && castOther.getPseMotifId() != null && this
				.getPseMotifId().equals(castOther.getPseMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseMotifId() == null ? 0 : this.getPseMotifId()
						.hashCode());
		result = 37 * result
