...
/**
 * TransposableElementInsertionSiteId generated by hbm2java
 */
public class TransposableElementInsertionSiteId implements java.io.Serializable {

	private Integer transposableElementInsertionSiteId;
	...
	public TransposableElementInsertionSiteId() {
	}

	public TransposableElementInsertionSiteId(
			Integer transposableElementInsertionSiteId, Integer featureId,
		...
		this.transposableElementInsertionSiteId = transposableElementInsertionSiteId;
	...
	public Integer getTransposableElementInsertionSiteId() {
		return this.transposableElementInsertionSiteId;
	}

	public void setTransposableElementInsertionSiteId(
			Integer transposableElementInsertionSiteId) {
		this.transposableElementInsertionSiteId = transposableElementInsertionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransposableElementInsertionSiteId))
			return false;
		TransposableElementInsertionSiteId castOther = (TransposableElementInsertionSiteId) other;

		return ((this.getTransposableElementInsertionSiteId() == castOther
				.getTransposableElementInsertionSiteId()) || (this
				.getTransposableElementInsertionSiteId() != null
				&& castOther.getTransposableElementInsertionSiteId() != null && this
				.getTransposableElementInsertionSiteId().equals(
						castOther.getTransposableElementInsertionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransposableElementInsertionSiteId() == null ? 0 : this
						.getTransposableElementInsertionSiteId().hashCode());
		result = 37 * result
