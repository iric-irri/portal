...
/**
 * Group1IntronHomingEndonucleaseTargetRegionId generated by hbm2java
 */
public class Group1IntronHomingEndonucleaseTargetRegionId implements
		java.io.Serializable {

	private Integer group1IntronHomingEndonucleaseTargetRegionId;
	...
	public Group1IntronHomingEndonucleaseTargetRegionId() {
	}

	public Group1IntronHomingEndonucleaseTargetRegionId(
			Integer group1IntronHomingEndonucleaseTargetRegionId,
		...
		this.group1IntronHomingEndonucleaseTargetRegionId = group1IntronHomingEndonucleaseTargetRegionId;
	...
	public Integer getGroup1IntronHomingEndonucleaseTargetRegionId() {
		return this.group1IntronHomingEndonucleaseTargetRegionId;
	}

	public void setGroup1IntronHomingEndonucleaseTargetRegionId(
			Integer group1IntronHomingEndonucleaseTargetRegionId) {
		this.group1IntronHomingEndonucleaseTargetRegionId = group1IntronHomingEndonucleaseTargetRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Group1IntronHomingEndonucleaseTargetRegionId))
			return false;
		Group1IntronHomingEndonucleaseTargetRegionId castOther = (Group1IntronHomingEndonucleaseTargetRegionId) other;

		return ((this.getGroup1IntronHomingEndonucleaseTargetRegionId() == castOther
				.getGroup1IntronHomingEndonucleaseTargetRegionId()) || (this
				.getGroup1IntronHomingEndonucleaseTargetRegionId() != null
				&& castOther.getGroup1IntronHomingEndonucleaseTargetRegionId() != null && this
				.getGroup1IntronHomingEndonucleaseTargetRegionId()
				.equals(castOther
						.getGroup1IntronHomingEndonucleaseTargetRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroup1IntronHomingEndonucleaseTargetRegionId() == null ? 0
						: this.getGroup1IntronHomingEndonucleaseTargetRegionId()
								.hashCode());
		result = 37 * result
