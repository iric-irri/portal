...
/**
 * SineElementId generated by hbm2java
 */
public class SineElementId implements java.io.Serializable {

	private Integer sineElementId;
	...
	public SineElementId() {
	}

	public SineElementId(Integer sineElementId, Integer featureId,
		...
		this.sineElementId = sineElementId;
	...
	public Integer getSineElementId() {
		return this.sineElementId;
	}

	public void setSineElementId(Integer sineElementId) {
		this.sineElementId = sineElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SineElementId))
			return false;
		SineElementId castOther = (SineElementId) other;

		return ((this.getSineElementId() == castOther.getSineElementId()) || (this
				.getSineElementId() != null
				&& castOther.getSineElementId() != null && this
				.getSineElementId().equals(castOther.getSineElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSineElementId() == null ? 0 : this.getSineElementId()
						.hashCode());
		result = 37 * result
