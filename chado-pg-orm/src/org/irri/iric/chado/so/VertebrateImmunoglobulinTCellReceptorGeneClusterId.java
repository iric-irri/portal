...
/**
 * VertebrateImmunoglobulinTCellReceptorGeneClusterId generated by hbm2java
 */
public class VertebrateImmunoglobulinTCellReceptorGeneClusterId implements
		java.io.Serializable {

	private Integer vertebrateImmunoglobulinTCellReceptorGeneClusterId;
	...
	public VertebrateImmunoglobulinTCellReceptorGeneClusterId() {
	}

	public VertebrateImmunoglobulinTCellReceptorGeneClusterId(
			Integer vertebrateImmunoglobulinTCellReceptorGeneClusterId,
		...
		this.vertebrateImmunoglobulinTCellReceptorGeneClusterId = vertebrateImmunoglobulinTCellReceptorGeneClusterId;
	...
	public Integer getVertebrateImmunoglobulinTCellReceptorGeneClusterId() {
		return this.vertebrateImmunoglobulinTCellReceptorGeneClusterId;
	}

	public void setVertebrateImmunoglobulinTCellReceptorGeneClusterId(
			Integer vertebrateImmunoglobulinTCellReceptorGeneClusterId) {
		this.vertebrateImmunoglobulinTCellReceptorGeneClusterId = vertebrateImmunoglobulinTCellReceptorGeneClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateImmunoglobulinTCellReceptorGeneClusterId))
			return false;
		VertebrateImmunoglobulinTCellReceptorGeneClusterId castOther = (VertebrateImmunoglobulinTCellReceptorGeneClusterId) other;

		return ((this.getVertebrateImmunoglobulinTCellReceptorGeneClusterId() == castOther
				.getVertebrateImmunoglobulinTCellReceptorGeneClusterId()) || (this
				.getVertebrateImmunoglobulinTCellReceptorGeneClusterId() != null
				&& castOther
						.getVertebrateImmunoglobulinTCellReceptorGeneClusterId() != null && this
				.getVertebrateImmunoglobulinTCellReceptorGeneClusterId()
				.equals(castOther
						.getVertebrateImmunoglobulinTCellReceptorGeneClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateImmunoglobulinTCellReceptorGeneClusterId() == null ? 0
						: this.getVertebrateImmunoglobulinTCellReceptorGeneClusterId()
								.hashCode());
		result = 37 * result
