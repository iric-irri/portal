...
/**
 * NucleotideMatchId generated by hbm2java
 */
public class NucleotideMatchId implements java.io.Serializable {

	private Integer nucleotideMatchId;
	...
	public NucleotideMatchId() {
	}

	public NucleotideMatchId(Integer nucleotideMatchId, Integer featureId,
		...
		this.nucleotideMatchId = nucleotideMatchId;
	...
	public Integer getNucleotideMatchId() {
		return this.nucleotideMatchId;
	}

	public void setNucleotideMatchId(Integer nucleotideMatchId) {
		this.nucleotideMatchId = nucleotideMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleotideMatchId))
			return false;
		NucleotideMatchId castOther = (NucleotideMatchId) other;

		return ((this.getNucleotideMatchId() == castOther
				.getNucleotideMatchId()) || (this.getNucleotideMatchId() != null
				&& castOther.getNucleotideMatchId() != null && this
				.getNucleotideMatchId()
				.equals(castOther.getNucleotideMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleotideMatchId() == null ? 0 : this
						.getNucleotideMatchId().hashCode());
		result = 37 * result
