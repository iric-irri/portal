...
/**
 * LincrnaId generated by hbm2java
 */
public class LincrnaId implements java.io.Serializable {

	private Integer lincrnaId;
	...
	public LincrnaId(Integer lincrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLincrnaId() {
		return this.lincrnaId;
	}

	public void setLincrnaId(Integer lincrnaId) {
		this.lincrnaId = lincrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LincrnaId))
			return false;
		LincrnaId castOther = (LincrnaId) other;

		return ((this.getLincrnaId() == castOther.getLincrnaId()) || (this
				.getLincrnaId() != null && castOther.getLincrnaId() != null && this
				.getLincrnaId().equals(castOther.getLincrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getLincrnaId() == null ? 0 : this.getLincrnaId().hashCode());
		result = 37 * result
