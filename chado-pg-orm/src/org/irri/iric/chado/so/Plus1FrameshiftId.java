...
/**
 * Plus1FrameshiftId generated by hbm2java
 */
public class Plus1FrameshiftId implements java.io.Serializable {

	private Integer plus1FrameshiftId;
	...
	public Plus1FrameshiftId() {
	}

	public Plus1FrameshiftId(Integer plus1FrameshiftId, Integer featureId,
		...
		this.plus1FrameshiftId = plus1FrameshiftId;
	...
	public Integer getPlus1FrameshiftId() {
		return this.plus1FrameshiftId;
	}

	public void setPlus1FrameshiftId(Integer plus1FrameshiftId) {
		this.plus1FrameshiftId = plus1FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus1FrameshiftId))
			return false;
		Plus1FrameshiftId castOther = (Plus1FrameshiftId) other;

		return ((this.getPlus1FrameshiftId() == castOther
				.getPlus1FrameshiftId()) || (this.getPlus1FrameshiftId() != null
				&& castOther.getPlus1FrameshiftId() != null && this
				.getPlus1FrameshiftId()
				.equals(castOther.getPlus1FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus1FrameshiftId() == null ? 0 : this
						.getPlus1FrameshiftId().hashCode());
		result = 37 * result
