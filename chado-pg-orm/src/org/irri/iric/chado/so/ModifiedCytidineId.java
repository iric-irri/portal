...
/**
 * ModifiedCytidineId generated by hbm2java
 */
public class ModifiedCytidineId implements java.io.Serializable {

	private Integer modifiedCytidineId;
	...
	public ModifiedCytidineId() {
	}

	public ModifiedCytidineId(Integer modifiedCytidineId, Integer featureId,
		...
		this.modifiedCytidineId = modifiedCytidineId;
	...
	public Integer getModifiedCytidineId() {
		return this.modifiedCytidineId;
	}

	public void setModifiedCytidineId(Integer modifiedCytidineId) {
		this.modifiedCytidineId = modifiedCytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedCytidineId))
			return false;
		ModifiedCytidineId castOther = (ModifiedCytidineId) other;

		return ((this.getModifiedCytidineId() == castOther
				.getModifiedCytidineId()) || (this.getModifiedCytidineId() != null
				&& castOther.getModifiedCytidineId() != null && this
				.getModifiedCytidineId().equals(
						castOther.getModifiedCytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedCytidineId() == null ? 0 : this
						.getModifiedCytidineId().hashCode());
		result = 37 * result
