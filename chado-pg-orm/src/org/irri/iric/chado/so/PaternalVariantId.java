...
/**
 * PaternalVariantId generated by hbm2java
 */
public class PaternalVariantId implements java.io.Serializable {

	private Integer paternalVariantId;
	...
	public PaternalVariantId() {
	}

	public PaternalVariantId(Integer paternalVariantId, Integer featureId,
		...
		this.paternalVariantId = paternalVariantId;
	...
	public Integer getPaternalVariantId() {
		return this.paternalVariantId;
	}

	public void setPaternalVariantId(Integer paternalVariantId) {
		this.paternalVariantId = paternalVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaternalVariantId))
			return false;
		PaternalVariantId castOther = (PaternalVariantId) other;

		return ((this.getPaternalVariantId() == castOther
				.getPaternalVariantId()) || (this.getPaternalVariantId() != null
				&& castOther.getPaternalVariantId() != null && this
				.getPaternalVariantId()
				.equals(castOther.getPaternalVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPaternalVariantId() == null ? 0 : this
						.getPaternalVariantId().hashCode());
		result = 37 * result
