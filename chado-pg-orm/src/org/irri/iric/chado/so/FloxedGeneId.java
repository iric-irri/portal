...
/**
 * FloxedGeneId generated by hbm2java
 */
public class FloxedGeneId implements java.io.Serializable {

	private Integer floxedGeneId;
	...
	public FloxedGeneId(Integer floxedGeneId, Integer featureId,
		...
		this.floxedGeneId = floxedGeneId;
	...
	public Integer getFloxedGeneId() {
		return this.floxedGeneId;
	}

	public void setFloxedGeneId(Integer floxedGeneId) {
		this.floxedGeneId = floxedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FloxedGeneId))
			return false;
		FloxedGeneId castOther = (FloxedGeneId) other;

		return ((this.getFloxedGeneId() == castOther.getFloxedGeneId()) || (this
				.getFloxedGeneId() != null
				&& castOther.getFloxedGeneId() != null && this
				.getFloxedGeneId().equals(castOther.getFloxedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFloxedGeneId() == null ? 0 : this.getFloxedGeneId()
						.hashCode());
		result = 37 * result
