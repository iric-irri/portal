...
/**
 * SequenceMotifId generated by hbm2java
 */
public class SequenceMotifId implements java.io.Serializable {

	private Integer sequenceMotifId;
	...
	public SequenceMotifId() {
	}

	public SequenceMotifId(Integer sequenceMotifId, Integer featureId,
		...
		this.sequenceMotifId = sequenceMotifId;
	...
	public Integer getSequenceMotifId() {
		return this.sequenceMotifId;
	}

	public void setSequenceMotifId(Integer sequenceMotifId) {
		this.sequenceMotifId = sequenceMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceMotifId))
			return false;
		SequenceMotifId castOther = (SequenceMotifId) other;

		return ((this.getSequenceMotifId() == castOther.getSequenceMotifId()) || (this
				.getSequenceMotifId() != null
				&& castOther.getSequenceMotifId() != null && this
				.getSequenceMotifId().equals(castOther.getSequenceMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceMotifId() == null ? 0 : this.getSequenceMotifId()
						.hashCode());
		result = 37 * result
