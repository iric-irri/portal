...
/**
 * VariantOriginId generated by hbm2java
 */
public class VariantOriginId implements java.io.Serializable {

	private Integer variantOriginId;
	...
	public VariantOriginId() {
	}

	public VariantOriginId(Integer variantOriginId, Integer featureId,
		...
		this.variantOriginId = variantOriginId;
	...
	public Integer getVariantOriginId() {
		return this.variantOriginId;
	}

	public void setVariantOriginId(Integer variantOriginId) {
		this.variantOriginId = variantOriginId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantOriginId))
			return false;
		VariantOriginId castOther = (VariantOriginId) other;

		return ((this.getVariantOriginId() == castOther.getVariantOriginId()) || (this
				.getVariantOriginId() != null
				&& castOther.getVariantOriginId() != null && this
				.getVariantOriginId().equals(castOther.getVariantOriginId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantOriginId() == null ? 0 : this.getVariantOriginId()
						.hashCode());
		result = 37 * result
