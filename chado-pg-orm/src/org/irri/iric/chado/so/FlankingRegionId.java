...
/**
 * FlankingRegionId generated by hbm2java
 */
public class FlankingRegionId implements java.io.Serializable {

	private Integer flankingRegionId;
	...
	public FlankingRegionId() {
	}

	public FlankingRegionId(Integer flankingRegionId, Integer featureId,
		...
		this.flankingRegionId = flankingRegionId;
	...
	public Integer getFlankingRegionId() {
		return this.flankingRegionId;
	}

	public void setFlankingRegionId(Integer flankingRegionId) {
		this.flankingRegionId = flankingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FlankingRegionId))
			return false;
		FlankingRegionId castOther = (FlankingRegionId) other;

		return ((this.getFlankingRegionId() == castOther.getFlankingRegionId()) || (this
				.getFlankingRegionId() != null
				&& castOther.getFlankingRegionId() != null && this
				.getFlankingRegionId().equals(castOther.getFlankingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFlankingRegionId() == null ? 0 : this
						.getFlankingRegionId().hashCode());
		result = 37 * result
