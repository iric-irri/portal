...
/**
 * TwoThiocytidineId generated by hbm2java
 */
public class TwoThiocytidineId implements java.io.Serializable {

	private Integer twoThiocytidineId;
	...
	public TwoThiocytidineId() {
	}

	public TwoThiocytidineId(Integer twoThiocytidineId, Integer featureId,
		...
		this.twoThiocytidineId = twoThiocytidineId;
	...
	public Integer getTwoThiocytidineId() {
		return this.twoThiocytidineId;
	}

	public void setTwoThiocytidineId(Integer twoThiocytidineId) {
		this.twoThiocytidineId = twoThiocytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoThiocytidineId))
			return false;
		TwoThiocytidineId castOther = (TwoThiocytidineId) other;

		return ((this.getTwoThiocytidineId() == castOther
				.getTwoThiocytidineId()) || (this.getTwoThiocytidineId() != null
				&& castOther.getTwoThiocytidineId() != null && this
				.getTwoThiocytidineId()
				.equals(castOther.getTwoThiocytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoThiocytidineId() == null ? 0 : this
						.getTwoThiocytidineId().hashCode());
		result = 37 * result
