...
/**
 * BenignVariantId generated by hbm2java
 */
public class BenignVariantId implements java.io.Serializable {

	private Integer benignVariantId;
	...
	public BenignVariantId() {
	}

	public BenignVariantId(Integer benignVariantId, Integer featureId,
		...
		this.benignVariantId = benignVariantId;
	...
	public Integer getBenignVariantId() {
		return this.benignVariantId;
	}

	public void setBenignVariantId(Integer benignVariantId) {
		this.benignVariantId = benignVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BenignVariantId))
			return false;
		BenignVariantId castOther = (BenignVariantId) other;

		return ((this.getBenignVariantId() == castOther.getBenignVariantId()) || (this
				.getBenignVariantId() != null
				&& castOther.getBenignVariantId() != null && this
				.getBenignVariantId().equals(castOther.getBenignVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBenignVariantId() == null ? 0 : this.getBenignVariantId()
						.hashCode());
		result = 37 * result
