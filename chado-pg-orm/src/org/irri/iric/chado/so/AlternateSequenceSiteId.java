...
/**
 * AlternateSequenceSiteId generated by hbm2java
 */
public class AlternateSequenceSiteId implements java.io.Serializable {

	private Integer alternateSequenceSiteId;
	...
	public AlternateSequenceSiteId() {
	}

	public AlternateSequenceSiteId(Integer alternateSequenceSiteId,
		...
		this.alternateSequenceSiteId = alternateSequenceSiteId;
	...
	public Integer getAlternateSequenceSiteId() {
		return this.alternateSequenceSiteId;
	}

	public void setAlternateSequenceSiteId(Integer alternateSequenceSiteId) {
		this.alternateSequenceSiteId = alternateSequenceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlternateSequenceSiteId))
			return false;
		AlternateSequenceSiteId castOther = (AlternateSequenceSiteId) other;

		return ((this.getAlternateSequenceSiteId() == castOther
				.getAlternateSequenceSiteId()) || (this
				.getAlternateSequenceSiteId() != null
				&& castOther.getAlternateSequenceSiteId() != null && this
				.getAlternateSequenceSiteId().equals(
						castOther.getAlternateSequenceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlternateSequenceSiteId() == null ? 0 : this
						.getAlternateSequenceSiteId().hashCode());
		result = 37 * result
