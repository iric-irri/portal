...
/**
 * CdsFragmentId generated by hbm2java
 */
public class CdsFragmentId implements java.io.Serializable {

	private Integer cdsFragmentId;
	...
	public CdsFragmentId() {
	}

	public CdsFragmentId(Integer cdsFragmentId, Integer featureId,
		...
		this.cdsFragmentId = cdsFragmentId;
	...
	public Integer getCdsFragmentId() {
		return this.cdsFragmentId;
	}

	public void setCdsFragmentId(Integer cdsFragmentId) {
		this.cdsFragmentId = cdsFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsFragmentId))
			return false;
		CdsFragmentId castOther = (CdsFragmentId) other;

		return ((this.getCdsFragmentId() == castOther.getCdsFragmentId()) || (this
				.getCdsFragmentId() != null
				&& castOther.getCdsFragmentId() != null && this
				.getCdsFragmentId().equals(castOther.getCdsFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsFragmentId() == null ? 0 : this.getCdsFragmentId()
						.hashCode());
		result = 37 * result
