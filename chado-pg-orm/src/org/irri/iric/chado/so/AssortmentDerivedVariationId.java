...
/**
 * AssortmentDerivedVariationId generated by hbm2java
 */
public class AssortmentDerivedVariationId implements java.io.Serializable {

	private Integer assortmentDerivedVariationId;
	...
	public AssortmentDerivedVariationId() {
	}

	public AssortmentDerivedVariationId(Integer assortmentDerivedVariationId,
		...
		this.assortmentDerivedVariationId = assortmentDerivedVariationId;
	...
	public Integer getAssortmentDerivedVariationId() {
		return this.assortmentDerivedVariationId;
	}

	public void setAssortmentDerivedVariationId(
			Integer assortmentDerivedVariationId) {
		this.assortmentDerivedVariationId = assortmentDerivedVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssortmentDerivedVariationId))
			return false;
		AssortmentDerivedVariationId castOther = (AssortmentDerivedVariationId) other;

		return ((this.getAssortmentDerivedVariationId() == castOther
				.getAssortmentDerivedVariationId()) || (this
				.getAssortmentDerivedVariationId() != null
				&& castOther.getAssortmentDerivedVariationId() != null && this
				.getAssortmentDerivedVariationId().equals(
						castOther.getAssortmentDerivedVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssortmentDerivedVariationId() == null ? 0 : this
						.getAssortmentDerivedVariationId().hashCode());
		result = 37 * result
