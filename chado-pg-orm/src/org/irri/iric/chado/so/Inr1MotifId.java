...
/**
 * Inr1MotifId generated by hbm2java
 */
public class Inr1MotifId implements java.io.Serializable {

	private Integer inr1MotifId;
	...
	public Inr1MotifId(Integer inr1MotifId, Integer featureId,
	...
	public Integer getInr1MotifId() {
		return this.inr1MotifId;
	}

	public void setInr1MotifId(Integer inr1MotifId) {
		this.inr1MotifId = inr1MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Inr1MotifId))
			return false;
		Inr1MotifId castOther = (Inr1MotifId) other;

		return ((this.getInr1MotifId() == castOther.getInr1MotifId()) || (this
				.getInr1MotifId() != null && castOther.getInr1MotifId() != null && this
				.getInr1MotifId().equals(castOther.getInr1MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInr1MotifId() == null ? 0 : this.getInr1MotifId()
						.hashCode());
		result = 37 * result
