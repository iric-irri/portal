...
/**
 * TranscriptVariantId generated by hbm2java
 */
public class TranscriptVariantId implements java.io.Serializable {

	private Integer transcriptVariantId;
	...
	public TranscriptVariantId() {
	}

	public TranscriptVariantId(Integer transcriptVariantId, Integer featureId,
		...
		this.transcriptVariantId = transcriptVariantId;
	...
	public Integer getTranscriptVariantId() {
		return this.transcriptVariantId;
	}

	public void setTranscriptVariantId(Integer transcriptVariantId) {
		this.transcriptVariantId = transcriptVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptVariantId))
			return false;
		TranscriptVariantId castOther = (TranscriptVariantId) other;

		return ((this.getTranscriptVariantId() == castOther
				.getTranscriptVariantId()) || (this.getTranscriptVariantId() != null
				&& castOther.getTranscriptVariantId() != null && this
				.getTranscriptVariantId().equals(
						castOther.getTranscriptVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptVariantId() == null ? 0 : this
						.getTranscriptVariantId().hashCode());
		result = 37 * result
