...
/**
 * TranscriptionallyRegulatedId generated by hbm2java
 */
public class TranscriptionallyRegulatedId implements java.io.Serializable {

	private Integer transcriptionallyRegulatedId;
	...
	public TranscriptionallyRegulatedId() {
	}

	public TranscriptionallyRegulatedId(Integer transcriptionallyRegulatedId,
		...
		this.transcriptionallyRegulatedId = transcriptionallyRegulatedId;
	...
	public Integer getTranscriptionallyRegulatedId() {
		return this.transcriptionallyRegulatedId;
	}

	public void setTranscriptionallyRegulatedId(
			Integer transcriptionallyRegulatedId) {
		this.transcriptionallyRegulatedId = transcriptionallyRegulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionallyRegulatedId))
			return false;
		TranscriptionallyRegulatedId castOther = (TranscriptionallyRegulatedId) other;

		return ((this.getTranscriptionallyRegulatedId() == castOther
				.getTranscriptionallyRegulatedId()) || (this
				.getTranscriptionallyRegulatedId() != null
				&& castOther.getTranscriptionallyRegulatedId() != null && this
				.getTranscriptionallyRegulatedId().equals(
						castOther.getTranscriptionallyRegulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionallyRegulatedId() == null ? 0 : this
						.getTranscriptionallyRegulatedId().hashCode());
		result = 37 * result
