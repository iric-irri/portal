...
/**
 * ApicoplastSequenceId generated by hbm2java
 */
public class ApicoplastSequenceId implements java.io.Serializable {

	private Integer apicoplastSequenceId;
	...
	public ApicoplastSequenceId() {
	}

	public ApicoplastSequenceId(Integer apicoplastSequenceId,
		...
		this.apicoplastSequenceId = apicoplastSequenceId;
	...
	public Integer getApicoplastSequenceId() {
		return this.apicoplastSequenceId;
	}

	public void setApicoplastSequenceId(Integer apicoplastSequenceId) {
		this.apicoplastSequenceId = apicoplastSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApicoplastSequenceId))
			return false;
		ApicoplastSequenceId castOther = (ApicoplastSequenceId) other;

		return ((this.getApicoplastSequenceId() == castOther
				.getApicoplastSequenceId()) || (this.getApicoplastSequenceId() != null
				&& castOther.getApicoplastSequenceId() != null && this
				.getApicoplastSequenceId().equals(
						castOther.getApicoplastSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getApicoplastSequenceId() == null ? 0 : this
						.getApicoplastSequenceId().hashCode());
		result = 37 * result
