...
/**
 * TwoPrimeORibosylguanosinePhosphateId generated by hbm2java
 */
public class TwoPrimeORibosylguanosinePhosphateId implements
		java.io.Serializable {

	private Integer twoPrimeORibosylguanosinePhosphateId;
	...
	public TwoPrimeORibosylguanosinePhosphateId() {
	}

	public TwoPrimeORibosylguanosinePhosphateId(
			Integer twoPrimeORibosylguanosinePhosphateId, Integer featureId,
		...
		this.twoPrimeORibosylguanosinePhosphateId = twoPrimeORibosylguanosinePhosphateId;
	...
	public Integer getTwoPrimeORibosylguanosinePhosphateId() {
		return this.twoPrimeORibosylguanosinePhosphateId;
	}

	public void setTwoPrimeORibosylguanosinePhosphateId(
			Integer twoPrimeORibosylguanosinePhosphateId) {
		this.twoPrimeORibosylguanosinePhosphateId = twoPrimeORibosylguanosinePhosphateId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeORibosylguanosinePhosphateId))
			return false;
		TwoPrimeORibosylguanosinePhosphateId castOther = (TwoPrimeORibosylguanosinePhosphateId) other;

		return ((this.getTwoPrimeORibosylguanosinePhosphateId() == castOther
				.getTwoPrimeORibosylguanosinePhosphateId()) || (this
				.getTwoPrimeORibosylguanosinePhosphateId() != null
				&& castOther.getTwoPrimeORibosylguanosinePhosphateId() != null && this
				.getTwoPrimeORibosylguanosinePhosphateId().equals(
						castOther.getTwoPrimeORibosylguanosinePhosphateId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeORibosylguanosinePhosphateId() == null ? 0 : this
						.getTwoPrimeORibosylguanosinePhosphateId().hashCode());
		result = 37 * result
