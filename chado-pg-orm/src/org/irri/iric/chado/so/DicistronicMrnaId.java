...
/**
 * DicistronicMrnaId generated by hbm2java
 */
public class DicistronicMrnaId implements java.io.Serializable {

	private Integer dicistronicMrnaId;
	...
	public DicistronicMrnaId() {
	}

	public DicistronicMrnaId(Integer dicistronicMrnaId, Integer featureId,
		...
		this.dicistronicMrnaId = dicistronicMrnaId;
	...
	public Integer getDicistronicMrnaId() {
		return this.dicistronicMrnaId;
	}

	public void setDicistronicMrnaId(Integer dicistronicMrnaId) {
		this.dicistronicMrnaId = dicistronicMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DicistronicMrnaId))
			return false;
		DicistronicMrnaId castOther = (DicistronicMrnaId) other;

		return ((this.getDicistronicMrnaId() == castOther
				.getDicistronicMrnaId()) || (this.getDicistronicMrnaId() != null
				&& castOther.getDicistronicMrnaId() != null && this
				.getDicistronicMrnaId()
				.equals(castOther.getDicistronicMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDicistronicMrnaId() == null ? 0 : this
						.getDicistronicMrnaId().hashCode());
		result = 37 * result
