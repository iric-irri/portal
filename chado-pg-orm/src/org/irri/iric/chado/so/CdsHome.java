 ...
 * @see org.irri.iric.chado.so.Cds
...
public class CdsHome {
	...
	public Cds merge(Cds detachedInstance) {
		...
		try {
			Cds result = (Cds) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Cds findById(org.irri.iric.chado.so.CdsId id) {
		log.debug("getting Cds instance with id: " + id);
		try {
			Cds instance = (Cds) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.so.Cds", id);
			if (instance == null) {
	...
	public List findByExample(Cds instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Cds")
