...
/**
 * VGeneId generated by hbm2java
 */
public class VGeneId implements java.io.Serializable {

	private Integer VGeneId;
	...
	public VGeneId(Integer VGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVGeneId() {
		return this.VGeneId;
	}

	public void setVGeneId(Integer VGeneId) {
		this.VGeneId = VGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VGeneId))
			return false;
		VGeneId castOther = (VGeneId) other;

		return ((this.getVGeneId() == castOther.getVGeneId()) || (this
				.getVGeneId() != null && castOther.getVGeneId() != null && this
				.getVGeneId().equals(castOther.getVGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVGeneId() == null ? 0 : this.getVGeneId().hashCode());
		result = 37 * result
