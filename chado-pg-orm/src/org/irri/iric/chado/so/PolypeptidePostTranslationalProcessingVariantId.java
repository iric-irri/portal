...
/**
 * PolypeptidePostTranslationalProcessingVariantId generated by hbm2java
 */
public class PolypeptidePostTranslationalProcessingVariantId implements
		java.io.Serializable {

	private Integer polypeptidePostTranslationalProcessingVariantId;
	...
	public PolypeptidePostTranslationalProcessingVariantId() {
	}

	public PolypeptidePostTranslationalProcessingVariantId(
			Integer polypeptidePostTranslationalProcessingVariantId,
		...
		this.polypeptidePostTranslationalProcessingVariantId = polypeptidePostTranslationalProcessingVariantId;
	...
	public Integer getPolypeptidePostTranslationalProcessingVariantId() {
		return this.polypeptidePostTranslationalProcessingVariantId;
	}

	public void setPolypeptidePostTranslationalProcessingVariantId(
			Integer polypeptidePostTranslationalProcessingVariantId) {
		this.polypeptidePostTranslationalProcessingVariantId = polypeptidePostTranslationalProcessingVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptidePostTranslationalProcessingVariantId))
			return false;
		PolypeptidePostTranslationalProcessingVariantId castOther = (PolypeptidePostTranslationalProcessingVariantId) other;

		return ((this.getPolypeptidePostTranslationalProcessingVariantId() == castOther
				.getPolypeptidePostTranslationalProcessingVariantId()) || (this
				.getPolypeptidePostTranslationalProcessingVariantId() != null
				&& castOther
						.getPolypeptidePostTranslationalProcessingVariantId() != null && this
				.getPolypeptidePostTranslationalProcessingVariantId()
				.equals(castOther
						.getPolypeptidePostTranslationalProcessingVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptidePostTranslationalProcessingVariantId() == null ? 0
						: this.getPolypeptidePostTranslationalProcessingVariantId()
								.hashCode());
		result = 37 * result
