...
/**
 * AlphaBetaMotifId generated by hbm2java
 */
public class AlphaBetaMotifId implements java.io.Serializable {

	private Integer alphaBetaMotifId;
	...
	public AlphaBetaMotifId() {
	}

	public AlphaBetaMotifId(Integer alphaBetaMotifId, Integer featureId,
		...
		this.alphaBetaMotifId = alphaBetaMotifId;
	...
	public Integer getAlphaBetaMotifId() {
		return this.alphaBetaMotifId;
	}

	public void setAlphaBetaMotifId(Integer alphaBetaMotifId) {
		this.alphaBetaMotifId = alphaBetaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlphaBetaMotifId))
			return false;
		AlphaBetaMotifId castOther = (AlphaBetaMotifId) other;

		return ((this.getAlphaBetaMotifId() == castOther.getAlphaBetaMotifId()) || (this
				.getAlphaBetaMotifId() != null
				&& castOther.getAlphaBetaMotifId() != null && this
				.getAlphaBetaMotifId().equals(castOther.getAlphaBetaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlphaBetaMotifId() == null ? 0 : this
						.getAlphaBetaMotifId().hashCode());
		result = 37 * result
