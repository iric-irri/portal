...
/**
 * VjJClusterId generated by hbm2java
 */
public class VjJClusterId implements java.io.Serializable {

	private Integer vjJClusterId;
	...
	public VjJClusterId(Integer vjJClusterId, Integer featureId,
		...
		this.vjJClusterId = vjJClusterId;
	...
	public Integer getVjJClusterId() {
		return this.vjJClusterId;
	}

	public void setVjJClusterId(Integer vjJClusterId) {
		this.vjJClusterId = vjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VjJClusterId))
			return false;
		VjJClusterId castOther = (VjJClusterId) other;

		return ((this.getVjJClusterId() == castOther.getVjJClusterId()) || (this
				.getVjJClusterId() != null
				&& castOther.getVjJClusterId() != null && this
				.getVjJClusterId().equals(castOther.getVjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVjJClusterId() == null ? 0 : this.getVjJClusterId()
						.hashCode());
		result = 37 * result
