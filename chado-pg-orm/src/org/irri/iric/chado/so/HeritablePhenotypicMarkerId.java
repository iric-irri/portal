...
/**
 * HeritablePhenotypicMarkerId generated by hbm2java
 */
public class HeritablePhenotypicMarkerId implements java.io.Serializable {

	private Integer heritablePhenotypicMarkerId;
	...
	public HeritablePhenotypicMarkerId() {
	}

	public HeritablePhenotypicMarkerId(Integer heritablePhenotypicMarkerId,
		...
		this.heritablePhenotypicMarkerId = heritablePhenotypicMarkerId;
	...
	public Integer getHeritablePhenotypicMarkerId() {
		return this.heritablePhenotypicMarkerId;
	}

	public void setHeritablePhenotypicMarkerId(
			Integer heritablePhenotypicMarkerId) {
		this.heritablePhenotypicMarkerId = heritablePhenotypicMarkerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HeritablePhenotypicMarkerId))
			return false;
		HeritablePhenotypicMarkerId castOther = (HeritablePhenotypicMarkerId) other;

		return ((this.getHeritablePhenotypicMarkerId() == castOther
				.getHeritablePhenotypicMarkerId()) || (this
				.getHeritablePhenotypicMarkerId() != null
				&& castOther.getHeritablePhenotypicMarkerId() != null && this
				.getHeritablePhenotypicMarkerId().equals(
						castOther.getHeritablePhenotypicMarkerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHeritablePhenotypicMarkerId() == null ? 0 : this
						.getHeritablePhenotypicMarkerId().hashCode());
		result = 37 * result
