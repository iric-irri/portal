...
/**
 * ParalogousRegionId generated by hbm2java
 */
public class ParalogousRegionId implements java.io.Serializable {

	private Integer paralogousRegionId;
	...
	public ParalogousRegionId() {
	}

	public ParalogousRegionId(Integer paralogousRegionId, Integer featureId,
		...
		this.paralogousRegionId = paralogousRegionId;
	...
	public Integer getParalogousRegionId() {
		return this.paralogousRegionId;
	}

	public void setParalogousRegionId(Integer paralogousRegionId) {
		this.paralogousRegionId = paralogousRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParalogousRegionId))
			return false;
		ParalogousRegionId castOther = (ParalogousRegionId) other;

		return ((this.getParalogousRegionId() == castOther
				.getParalogousRegionId()) || (this.getParalogousRegionId() != null
				&& castOther.getParalogousRegionId() != null && this
				.getParalogousRegionId().equals(
						castOther.getParalogousRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getParalogousRegionId() == null ? 0 : this
						.getParalogousRegionId().hashCode());
		result = 37 * result
