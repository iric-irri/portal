...
/**
 * Minus35SignalId generated by hbm2java
 */
public class Minus35SignalId implements java.io.Serializable {

	private Integer minus35SignalId;
	...
	public Minus35SignalId() {
	}

	public Minus35SignalId(Integer minus35SignalId, Integer featureId,
		...
		this.minus35SignalId = minus35SignalId;
	...
	public Integer getMinus35SignalId() {
		return this.minus35SignalId;
	}

	public void setMinus35SignalId(Integer minus35SignalId) {
		this.minus35SignalId = minus35SignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus35SignalId))
			return false;
		Minus35SignalId castOther = (Minus35SignalId) other;

		return ((this.getMinus35SignalId() == castOther.getMinus35SignalId()) || (this
				.getMinus35SignalId() != null
				&& castOther.getMinus35SignalId() != null && this
				.getMinus35SignalId().equals(castOther.getMinus35SignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus35SignalId() == null ? 0 : this.getMinus35SignalId()
						.hashCode());
		result = 37 * result
