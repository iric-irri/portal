...
/**
 * ThreePrimeCisSpliceSiteId generated by hbm2java
 */
public class ThreePrimeCisSpliceSiteId implements java.io.Serializable {

	private Integer threePrimeCisSpliceSiteId;
	...
	public ThreePrimeCisSpliceSiteId() {
	}

	public ThreePrimeCisSpliceSiteId(Integer threePrimeCisSpliceSiteId,
		...
		this.threePrimeCisSpliceSiteId = threePrimeCisSpliceSiteId;
	...
	public Integer getThreePrimeCisSpliceSiteId() {
		return this.threePrimeCisSpliceSiteId;
	}

	public void setThreePrimeCisSpliceSiteId(Integer threePrimeCisSpliceSiteId) {
		this.threePrimeCisSpliceSiteId = threePrimeCisSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeCisSpliceSiteId))
			return false;
		ThreePrimeCisSpliceSiteId castOther = (ThreePrimeCisSpliceSiteId) other;

		return ((this.getThreePrimeCisSpliceSiteId() == castOther
				.getThreePrimeCisSpliceSiteId()) || (this
				.getThreePrimeCisSpliceSiteId() != null
				&& castOther.getThreePrimeCisSpliceSiteId() != null && this
				.getThreePrimeCisSpliceSiteId().equals(
						castOther.getThreePrimeCisSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeCisSpliceSiteId() == null ? 0 : this
						.getThreePrimeCisSpliceSiteId().hashCode());
		result = 37 * result
