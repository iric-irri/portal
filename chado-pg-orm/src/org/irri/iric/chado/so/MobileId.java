...
public class MobileId implements java.io.Serializable {
	...
	public MobileId(Integer mobileId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		return ((this.getMobileId() == castOther.getMobileId()) || (this
				.getMobileId() != null && castOther.getMobileId() != null && this
				.getMobileId().equals(castOther.getMobileId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMobileId() == null ? 0 : this.getMobileId().hashCode());
		result = 37 * result
