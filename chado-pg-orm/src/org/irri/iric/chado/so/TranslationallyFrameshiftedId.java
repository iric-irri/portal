...
/**
 * TranslationallyFrameshiftedId generated by hbm2java
 */
public class TranslationallyFrameshiftedId implements java.io.Serializable {

	private Integer translationallyFrameshiftedId;
	...
	public TranslationallyFrameshiftedId() {
	}

	public TranslationallyFrameshiftedId(Integer translationallyFrameshiftedId,
		...
		this.translationallyFrameshiftedId = translationallyFrameshiftedId;
	...
	public Integer getTranslationallyFrameshiftedId() {
		return this.translationallyFrameshiftedId;
	}

	public void setTranslationallyFrameshiftedId(
			Integer translationallyFrameshiftedId) {
		this.translationallyFrameshiftedId = translationallyFrameshiftedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationallyFrameshiftedId))
			return false;
		TranslationallyFrameshiftedId castOther = (TranslationallyFrameshiftedId) other;

		return ((this.getTranslationallyFrameshiftedId() == castOther
				.getTranslationallyFrameshiftedId()) || (this
				.getTranslationallyFrameshiftedId() != null
				&& castOther.getTranslationallyFrameshiftedId() != null && this
				.getTranslationallyFrameshiftedId().equals(
						castOther.getTranslationallyFrameshiftedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationallyFrameshiftedId() == null ? 0 : this
						.getTranslationallyFrameshiftedId().hashCode());
		result = 37 * result
