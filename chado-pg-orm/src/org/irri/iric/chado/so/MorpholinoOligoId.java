...
/**
 * MorpholinoOligoId generated by hbm2java
 */
public class MorpholinoOligoId implements java.io.Serializable {

	private Integer morpholinoOligoId;
	...
	public MorpholinoOligoId() {
	}

	public MorpholinoOligoId(Integer morpholinoOligoId, Integer featureId,
		...
		this.morpholinoOligoId = morpholinoOligoId;
	...
	public Integer getMorpholinoOligoId() {
		return this.morpholinoOligoId;
	}

	public void setMorpholinoOligoId(Integer morpholinoOligoId) {
		this.morpholinoOligoId = morpholinoOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MorpholinoOligoId))
			return false;
		MorpholinoOligoId castOther = (MorpholinoOligoId) other;

		return ((this.getMorpholinoOligoId() == castOther
				.getMorpholinoOligoId()) || (this.getMorpholinoOligoId() != null
				&& castOther.getMorpholinoOligoId() != null && this
				.getMorpholinoOligoId()
				.equals(castOther.getMorpholinoOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMorpholinoOligoId() == null ? 0 : this
						.getMorpholinoOligoId().hashCode());
		result = 37 * result
