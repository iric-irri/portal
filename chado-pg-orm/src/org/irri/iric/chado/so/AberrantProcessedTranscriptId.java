...
/**
 * AberrantProcessedTranscriptId generated by hbm2java
 */
public class AberrantProcessedTranscriptId implements java.io.Serializable {

	private Integer aberrantProcessedTranscriptId;
	...
	public AberrantProcessedTranscriptId() {
	}

	public AberrantProcessedTranscriptId(Integer aberrantProcessedTranscriptId,
		...
		this.aberrantProcessedTranscriptId = aberrantProcessedTranscriptId;
	...
	public Integer getAberrantProcessedTranscriptId() {
		return this.aberrantProcessedTranscriptId;
	}

	public void setAberrantProcessedTranscriptId(
			Integer aberrantProcessedTranscriptId) {
		this.aberrantProcessedTranscriptId = aberrantProcessedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AberrantProcessedTranscriptId))
			return false;
		AberrantProcessedTranscriptId castOther = (AberrantProcessedTranscriptId) other;

		return ((this.getAberrantProcessedTranscriptId() == castOther
				.getAberrantProcessedTranscriptId()) || (this
				.getAberrantProcessedTranscriptId() != null
				&& castOther.getAberrantProcessedTranscriptId() != null && this
				.getAberrantProcessedTranscriptId().equals(
						castOther.getAberrantProcessedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAberrantProcessedTranscriptId() == null ? 0 : this
						.getAberrantProcessedTranscriptId().hashCode());
		result = 37 * result
