...
/**
 * H3k9MethylationSiteId generated by hbm2java
 */
public class H3k9MethylationSiteId implements java.io.Serializable {

	private Integer h3k9MethylationSiteId;
	...
	public H3k9MethylationSiteId() {
	}

	public H3k9MethylationSiteId(Integer h3k9MethylationSiteId,
		...
		this.h3k9MethylationSiteId = h3k9MethylationSiteId;
	...
	public Integer getH3k9MethylationSiteId() {
		return this.h3k9MethylationSiteId;
	}

	public void setH3k9MethylationSiteId(Integer h3k9MethylationSiteId) {
		this.h3k9MethylationSiteId = h3k9MethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k9MethylationSiteId))
			return false;
		H3k9MethylationSiteId castOther = (H3k9MethylationSiteId) other;

		return ((this.getH3k9MethylationSiteId() == castOther
				.getH3k9MethylationSiteId()) || (this
				.getH3k9MethylationSiteId() != null
				&& castOther.getH3k9MethylationSiteId() != null && this
				.getH3k9MethylationSiteId().equals(
						castOther.getH3k9MethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k9MethylationSiteId() == null ? 0 : this
						.getH3k9MethylationSiteId().hashCode());
		result = 37 * result
