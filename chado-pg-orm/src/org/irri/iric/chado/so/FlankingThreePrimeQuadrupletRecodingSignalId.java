...
/**
 * FlankingThreePrimeQuadrupletRecodingSignalId generated by hbm2java
 */
public class FlankingThreePrimeQuadrupletRecodingSignalId implements
		java.io.Serializable {

	private Integer flankingThreePrimeQuadrupletRecodingSignalId;
	...
	public FlankingThreePrimeQuadrupletRecodingSignalId() {
	}

	public FlankingThreePrimeQuadrupletRecodingSignalId(
			Integer flankingThreePrimeQuadrupletRecodingSignalId,
		...
		this.flankingThreePrimeQuadrupletRecodingSignalId = flankingThreePrimeQuadrupletRecodingSignalId;
	...
	public Integer getFlankingThreePrimeQuadrupletRecodingSignalId() {
		return this.flankingThreePrimeQuadrupletRecodingSignalId;
	}

	public void setFlankingThreePrimeQuadrupletRecodingSignalId(
			Integer flankingThreePrimeQuadrupletRecodingSignalId) {
		this.flankingThreePrimeQuadrupletRecodingSignalId = flankingThreePrimeQuadrupletRecodingSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FlankingThreePrimeQuadrupletRecodingSignalId))
			return false;
		FlankingThreePrimeQuadrupletRecodingSignalId castOther = (FlankingThreePrimeQuadrupletRecodingSignalId) other;

		return ((this.getFlankingThreePrimeQuadrupletRecodingSignalId() == castOther
				.getFlankingThreePrimeQuadrupletRecodingSignalId()) || (this
				.getFlankingThreePrimeQuadrupletRecodingSignalId() != null
				&& castOther.getFlankingThreePrimeQuadrupletRecodingSignalId() != null && this
				.getFlankingThreePrimeQuadrupletRecodingSignalId()
				.equals(castOther
						.getFlankingThreePrimeQuadrupletRecodingSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFlankingThreePrimeQuadrupletRecodingSignalId() == null ? 0
						: this.getFlankingThreePrimeQuadrupletRecodingSignalId()
								.hashCode());
		result = 37 * result
