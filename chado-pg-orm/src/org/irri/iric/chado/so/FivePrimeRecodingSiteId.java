...
/**
 * FivePrimeRecodingSiteId generated by hbm2java
 */
public class FivePrimeRecodingSiteId implements java.io.Serializable {

	private Integer fivePrimeRecodingSiteId;
	...
	public FivePrimeRecodingSiteId() {
	}

	public FivePrimeRecodingSiteId(Integer fivePrimeRecodingSiteId,
		...
		this.fivePrimeRecodingSiteId = fivePrimeRecodingSiteId;
	...
	public Integer getFivePrimeRecodingSiteId() {
		return this.fivePrimeRecodingSiteId;
	}

	public void setFivePrimeRecodingSiteId(Integer fivePrimeRecodingSiteId) {
		this.fivePrimeRecodingSiteId = fivePrimeRecodingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeRecodingSiteId))
			return false;
		FivePrimeRecodingSiteId castOther = (FivePrimeRecodingSiteId) other;

		return ((this.getFivePrimeRecodingSiteId() == castOther
				.getFivePrimeRecodingSiteId()) || (this
				.getFivePrimeRecodingSiteId() != null
				&& castOther.getFivePrimeRecodingSiteId() != null && this
				.getFivePrimeRecodingSiteId().equals(
						castOther.getFivePrimeRecodingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeRecodingSiteId() == null ? 0 : this
						.getFivePrimeRecodingSiteId().hashCode());
		result = 37 * result
