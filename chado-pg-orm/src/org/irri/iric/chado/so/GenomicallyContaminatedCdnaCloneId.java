...
/**
 * GenomicallyContaminatedCdnaCloneId generated by hbm2java
 */
public class GenomicallyContaminatedCdnaCloneId implements java.io.Serializable {

	private Integer genomicallyContaminatedCdnaCloneId;
	...
	public GenomicallyContaminatedCdnaCloneId() {
	}

	public GenomicallyContaminatedCdnaCloneId(
			Integer genomicallyContaminatedCdnaCloneId, Integer featureId,
		...
		this.genomicallyContaminatedCdnaCloneId = genomicallyContaminatedCdnaCloneId;
	...
	public Integer getGenomicallyContaminatedCdnaCloneId() {
		return this.genomicallyContaminatedCdnaCloneId;
	}

	public void setGenomicallyContaminatedCdnaCloneId(
			Integer genomicallyContaminatedCdnaCloneId) {
		this.genomicallyContaminatedCdnaCloneId = genomicallyContaminatedCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenomicallyContaminatedCdnaCloneId))
			return false;
		GenomicallyContaminatedCdnaCloneId castOther = (GenomicallyContaminatedCdnaCloneId) other;

		return ((this.getGenomicallyContaminatedCdnaCloneId() == castOther
				.getGenomicallyContaminatedCdnaCloneId()) || (this
				.getGenomicallyContaminatedCdnaCloneId() != null
				&& castOther.getGenomicallyContaminatedCdnaCloneId() != null && this
				.getGenomicallyContaminatedCdnaCloneId().equals(
						castOther.getGenomicallyContaminatedCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGenomicallyContaminatedCdnaCloneId() == null ? 0 : this
						.getGenomicallyContaminatedCdnaCloneId().hashCode());
		result = 37 * result
