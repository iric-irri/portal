...
/**
 * CircularSingleStrandedDnaChromosomeId generated by hbm2java
 */
public class CircularSingleStrandedDnaChromosomeId implements
		java.io.Serializable {

	private Integer circularSingleStrandedDnaChromosomeId;
	...
	public CircularSingleStrandedDnaChromosomeId() {
	}

	public CircularSingleStrandedDnaChromosomeId(
			Integer circularSingleStrandedDnaChromosomeId, Integer featureId,
		...
		this.circularSingleStrandedDnaChromosomeId = circularSingleStrandedDnaChromosomeId;
	...
	public Integer getCircularSingleStrandedDnaChromosomeId() {
		return this.circularSingleStrandedDnaChromosomeId;
	}

	public void setCircularSingleStrandedDnaChromosomeId(
			Integer circularSingleStrandedDnaChromosomeId) {
		this.circularSingleStrandedDnaChromosomeId = circularSingleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CircularSingleStrandedDnaChromosomeId))
			return false;
		CircularSingleStrandedDnaChromosomeId castOther = (CircularSingleStrandedDnaChromosomeId) other;

		return ((this.getCircularSingleStrandedDnaChromosomeId() == castOther
				.getCircularSingleStrandedDnaChromosomeId()) || (this
				.getCircularSingleStrandedDnaChromosomeId() != null
				&& castOther.getCircularSingleStrandedDnaChromosomeId() != null && this
				.getCircularSingleStrandedDnaChromosomeId().equals(
						castOther.getCircularSingleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCircularSingleStrandedDnaChromosomeId() == null ? 0
						: this.getCircularSingleStrandedDnaChromosomeId()
								.hashCode());
		result = 37 * result
