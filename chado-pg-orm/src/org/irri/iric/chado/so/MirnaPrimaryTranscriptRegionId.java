...
/**
 * MirnaPrimaryTranscriptRegionId generated by hbm2java
 */
public class MirnaPrimaryTranscriptRegionId implements java.io.Serializable {

	private Integer mirnaPrimaryTranscriptRegionId;
	...
	public MirnaPrimaryTranscriptRegionId() {
	}

	public MirnaPrimaryTranscriptRegionId(
			Integer mirnaPrimaryTranscriptRegionId, Integer featureId,
		...
		this.mirnaPrimaryTranscriptRegionId = mirnaPrimaryTranscriptRegionId;
	...
	public Integer getMirnaPrimaryTranscriptRegionId() {
		return this.mirnaPrimaryTranscriptRegionId;
	}

	public void setMirnaPrimaryTranscriptRegionId(
			Integer mirnaPrimaryTranscriptRegionId) {
		this.mirnaPrimaryTranscriptRegionId = mirnaPrimaryTranscriptRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaPrimaryTranscriptRegionId))
			return false;
		MirnaPrimaryTranscriptRegionId castOther = (MirnaPrimaryTranscriptRegionId) other;

		return ((this.getMirnaPrimaryTranscriptRegionId() == castOther
				.getMirnaPrimaryTranscriptRegionId()) || (this
				.getMirnaPrimaryTranscriptRegionId() != null
				&& castOther.getMirnaPrimaryTranscriptRegionId() != null && this
				.getMirnaPrimaryTranscriptRegionId().equals(
						castOther.getMirnaPrimaryTranscriptRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaPrimaryTranscriptRegionId() == null ? 0 : this
						.getMirnaPrimaryTranscriptRegionId().hashCode());
		result = 37 * result
