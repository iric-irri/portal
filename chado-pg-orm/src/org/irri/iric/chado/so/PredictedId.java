...
/**
 * PredictedId generated by hbm2java
 */
public class PredictedId implements java.io.Serializable {
	...
	public PredictedId(Integer predictedId, Integer featureId,
	...
	public Integer getPredictedId() {
		return this.predictedId;
	}

	public void setPredictedId(Integer predictedId) {
		this.predictedId = predictedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PredictedId))
			return false;
		PredictedId castOther = (PredictedId) other;

		return ((this.getPredictedId() == castOther.getPredictedId()) || (this
				.getPredictedId() != null && castOther.getPredictedId() != null && this
				.getPredictedId().equals(castOther.getPredictedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPredictedId() == null ? 0 : this.getPredictedId()
						.hashCode());
		result = 37 * result
