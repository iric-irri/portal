...
/**
 * FrameshiftVariantId generated by hbm2java
 */
public class FrameshiftVariantId implements java.io.Serializable {

	private Integer frameshiftVariantId;
	...
	public FrameshiftVariantId() {
	}

	public FrameshiftVariantId(Integer frameshiftVariantId, Integer featureId,
		...
		this.frameshiftVariantId = frameshiftVariantId;
	...
	public Integer getFrameshiftVariantId() {
		return this.frameshiftVariantId;
	}

	public void setFrameshiftVariantId(Integer frameshiftVariantId) {
		this.frameshiftVariantId = frameshiftVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FrameshiftVariantId))
			return false;
		FrameshiftVariantId castOther = (FrameshiftVariantId) other;

		return ((this.getFrameshiftVariantId() == castOther
				.getFrameshiftVariantId()) || (this.getFrameshiftVariantId() != null
				&& castOther.getFrameshiftVariantId() != null && this
				.getFrameshiftVariantId().equals(
						castOther.getFrameshiftVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFrameshiftVariantId() == null ? 0 : this
						.getFrameshiftVariantId().hashCode());
		result = 37 * result
