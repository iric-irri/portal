...
/**
 * SequenceSecondaryStructureId generated by hbm2java
 */
public class SequenceSecondaryStructureId implements java.io.Serializable {

	private Integer sequenceSecondaryStructureId;
	...
	public SequenceSecondaryStructureId() {
	}

	public SequenceSecondaryStructureId(Integer sequenceSecondaryStructureId,
		...
		this.sequenceSecondaryStructureId = sequenceSecondaryStructureId;
	...
	public Integer getSequenceSecondaryStructureId() {
		return this.sequenceSecondaryStructureId;
	}

	public void setSequenceSecondaryStructureId(
			Integer sequenceSecondaryStructureId) {
		this.sequenceSecondaryStructureId = sequenceSecondaryStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceSecondaryStructureId))
			return false;
		SequenceSecondaryStructureId castOther = (SequenceSecondaryStructureId) other;

		return ((this.getSequenceSecondaryStructureId() == castOther
				.getSequenceSecondaryStructureId()) || (this
				.getSequenceSecondaryStructureId() != null
				&& castOther.getSequenceSecondaryStructureId() != null && this
				.getSequenceSecondaryStructureId().equals(
						castOther.getSequenceSecondaryStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceSecondaryStructureId() == null ? 0 : this
						.getSequenceSecondaryStructureId().hashCode());
		result = 37 * result
