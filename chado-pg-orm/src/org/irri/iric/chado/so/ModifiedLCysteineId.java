...
/**
 * ModifiedLCysteineId generated by hbm2java
 */
public class ModifiedLCysteineId implements java.io.Serializable {

	private Integer modifiedLCysteineId;
	...
	public ModifiedLCysteineId() {
	}

	public ModifiedLCysteineId(Integer modifiedLCysteineId, Integer featureId,
		...
		this.modifiedLCysteineId = modifiedLCysteineId;
	...
	public Integer getModifiedLCysteineId() {
		return this.modifiedLCysteineId;
	}

	public void setModifiedLCysteineId(Integer modifiedLCysteineId) {
		this.modifiedLCysteineId = modifiedLCysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLCysteineId))
			return false;
		ModifiedLCysteineId castOther = (ModifiedLCysteineId) other;

		return ((this.getModifiedLCysteineId() == castOther
				.getModifiedLCysteineId()) || (this.getModifiedLCysteineId() != null
				&& castOther.getModifiedLCysteineId() != null && this
				.getModifiedLCysteineId().equals(
						castOther.getModifiedLCysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLCysteineId() == null ? 0 : this
						.getModifiedLCysteineId().hashCode());
		result = 37 * result
