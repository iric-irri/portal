...
/**
 * ProximalPromoterElementId generated by hbm2java
 */
public class ProximalPromoterElementId implements java.io.Serializable {

	private Integer proximalPromoterElementId;
	...
	public ProximalPromoterElementId() {
	}

	public ProximalPromoterElementId(Integer proximalPromoterElementId,
		...
		this.proximalPromoterElementId = proximalPromoterElementId;
	...
	public Integer getProximalPromoterElementId() {
		return this.proximalPromoterElementId;
	}

	public void setProximalPromoterElementId(Integer proximalPromoterElementId) {
		this.proximalPromoterElementId = proximalPromoterElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProximalPromoterElementId))
			return false;
		ProximalPromoterElementId castOther = (ProximalPromoterElementId) other;

		return ((this.getProximalPromoterElementId() == castOther
				.getProximalPromoterElementId()) || (this
				.getProximalPromoterElementId() != null
				&& castOther.getProximalPromoterElementId() != null && this
				.getProximalPromoterElementId().equals(
						castOther.getProximalPromoterElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProximalPromoterElementId() == null ? 0 : this
						.getProximalPromoterElementId().hashCode());
		result = 37 * result
