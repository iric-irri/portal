...
/**
 * ValineId generated by hbm2java
 */
public class ValineId implements java.io.Serializable {

	private Integer valineId;
	...
	public ValineId(Integer valineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getValineId() {
		return this.valineId;
	}

	public void setValineId(Integer valineId) {
		this.valineId = valineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ValineId))
			return false;
		ValineId castOther = (ValineId) other;

		return ((this.getValineId() == castOther.getValineId()) || (this
				.getValineId() != null && castOther.getValineId() != null && this
				.getValineId().equals(castOther.getValineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getValineId() == null ? 0 : this.getValineId().hashCode());
		result = 37 * result
