...
/**
 * VdGeneId generated by hbm2java
 */
public class VdGeneId implements java.io.Serializable {

	private Integer vdGeneId;
	...
	public VdGeneId(Integer vdGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVdGeneId() {
		return this.vdGeneId;
	}

	public void setVdGeneId(Integer vdGeneId) {
		this.vdGeneId = vdGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VdGeneId))
			return false;
		VdGeneId castOther = (VdGeneId) other;

		return ((this.getVdGeneId() == castOther.getVdGeneId()) || (this
				.getVdGeneId() != null && castOther.getVdGeneId() != null && this
				.getVdGeneId().equals(castOther.getVdGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVdGeneId() == null ? 0 : this.getVdGeneId().hashCode());
		result = 37 * result
