...
/**
 * Complex3dStructuralVariantId generated by hbm2java
 */
public class Complex3dStructuralVariantId implements java.io.Serializable {

	private Integer complex3dStructuralVariantId;
	...
	public Complex3dStructuralVariantId() {
	}

	public Complex3dStructuralVariantId(Integer complex3dStructuralVariantId,
		...
		this.complex3dStructuralVariantId = complex3dStructuralVariantId;
	...
	public Integer getComplex3dStructuralVariantId() {
		return this.complex3dStructuralVariantId;
	}

	public void setComplex3dStructuralVariantId(
			Integer complex3dStructuralVariantId) {
		this.complex3dStructuralVariantId = complex3dStructuralVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Complex3dStructuralVariantId))
			return false;
		Complex3dStructuralVariantId castOther = (Complex3dStructuralVariantId) other;

		return ((this.getComplex3dStructuralVariantId() == castOther
				.getComplex3dStructuralVariantId()) || (this
				.getComplex3dStructuralVariantId() != null
				&& castOther.getComplex3dStructuralVariantId() != null && this
				.getComplex3dStructuralVariantId().equals(
						castOther.getComplex3dStructuralVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplex3dStructuralVariantId() == null ? 0 : this
						.getComplex3dStructuralVariantId().hashCode());
		result = 37 * result
