...
/**
 * TransmembranePolypeptideRegionId generated by hbm2java
 */
public class TransmembranePolypeptideRegionId implements java.io.Serializable {

	private Integer transmembranePolypeptideRegionId;
	...
	public TransmembranePolypeptideRegionId() {
	}

	public TransmembranePolypeptideRegionId(
			Integer transmembranePolypeptideRegionId, Integer featureId,
		...
		this.transmembranePolypeptideRegionId = transmembranePolypeptideRegionId;
	...
	public Integer getTransmembranePolypeptideRegionId() {
		return this.transmembranePolypeptideRegionId;
	}

	public void setTransmembranePolypeptideRegionId(
			Integer transmembranePolypeptideRegionId) {
		this.transmembranePolypeptideRegionId = transmembranePolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransmembranePolypeptideRegionId))
			return false;
		TransmembranePolypeptideRegionId castOther = (TransmembranePolypeptideRegionId) other;

		return ((this.getTransmembranePolypeptideRegionId() == castOther
				.getTransmembranePolypeptideRegionId()) || (this
				.getTransmembranePolypeptideRegionId() != null
				&& castOther.getTransmembranePolypeptideRegionId() != null && this
				.getTransmembranePolypeptideRegionId().equals(
						castOther.getTransmembranePolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransmembranePolypeptideRegionId() == null ? 0 : this
						.getTransmembranePolypeptideRegionId().hashCode());
		result = 37 * result
