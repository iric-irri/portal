...
/**
 * HighIdentityRegionId generated by hbm2java
 */
public class HighIdentityRegionId implements java.io.Serializable {

	private Integer highIdentityRegionId;
	...
	public HighIdentityRegionId() {
	}

	public HighIdentityRegionId(Integer highIdentityRegionId,
		...
		this.highIdentityRegionId = highIdentityRegionId;
	...
	public Integer getHighIdentityRegionId() {
		return this.highIdentityRegionId;
	}

	public void setHighIdentityRegionId(Integer highIdentityRegionId) {
		this.highIdentityRegionId = highIdentityRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HighIdentityRegionId))
			return false;
		HighIdentityRegionId castOther = (HighIdentityRegionId) other;

		return ((this.getHighIdentityRegionId() == castOther
				.getHighIdentityRegionId()) || (this.getHighIdentityRegionId() != null
				&& castOther.getHighIdentityRegionId() != null && this
				.getHighIdentityRegionId().equals(
						castOther.getHighIdentityRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHighIdentityRegionId() == null ? 0 : this
						.getHighIdentityRegionId().hashCode());
		result = 37 * result
