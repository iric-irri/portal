...
/**
 * IncreasedPolyadenylationVariantId generated by hbm2java
 */
public class IncreasedPolyadenylationVariantId implements java.io.Serializable {

	private Integer increasedPolyadenylationVariantId;
	...
	public IncreasedPolyadenylationVariantId() {
	}

	public IncreasedPolyadenylationVariantId(
			Integer increasedPolyadenylationVariantId, Integer featureId,
		...
		this.increasedPolyadenylationVariantId = increasedPolyadenylationVariantId;
	...
	public Integer getIncreasedPolyadenylationVariantId() {
		return this.increasedPolyadenylationVariantId;
	}

	public void setIncreasedPolyadenylationVariantId(
			Integer increasedPolyadenylationVariantId) {
		this.increasedPolyadenylationVariantId = increasedPolyadenylationVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncreasedPolyadenylationVariantId))
			return false;
		IncreasedPolyadenylationVariantId castOther = (IncreasedPolyadenylationVariantId) other;

		return ((this.getIncreasedPolyadenylationVariantId() == castOther
				.getIncreasedPolyadenylationVariantId()) || (this
				.getIncreasedPolyadenylationVariantId() != null
				&& castOther.getIncreasedPolyadenylationVariantId() != null && this
				.getIncreasedPolyadenylationVariantId().equals(
						castOther.getIncreasedPolyadenylationVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncreasedPolyadenylationVariantId() == null ? 0 : this
						.getIncreasedPolyadenylationVariantId().hashCode());
		result = 37 * result
