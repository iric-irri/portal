...
/**
 * PolycistronicTranscriptId generated by hbm2java
 */
public class PolycistronicTranscriptId implements java.io.Serializable {

	private Integer polycistronicTranscriptId;
	...
	public PolycistronicTranscriptId() {
	}

	public PolycistronicTranscriptId(Integer polycistronicTranscriptId,
		...
		this.polycistronicTranscriptId = polycistronicTranscriptId;
	...
	public Integer getPolycistronicTranscriptId() {
		return this.polycistronicTranscriptId;
	}

	public void setPolycistronicTranscriptId(Integer polycistronicTranscriptId) {
		this.polycistronicTranscriptId = polycistronicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolycistronicTranscriptId))
			return false;
		PolycistronicTranscriptId castOther = (PolycistronicTranscriptId) other;

		return ((this.getPolycistronicTranscriptId() == castOther
				.getPolycistronicTranscriptId()) || (this
				.getPolycistronicTranscriptId() != null
				&& castOther.getPolycistronicTranscriptId() != null && this
				.getPolycistronicTranscriptId().equals(
						castOther.getPolycistronicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolycistronicTranscriptId() == null ? 0 : this
						.getPolycistronicTranscriptId().hashCode());
		result = 37 * result
