...
/**
 * RecombinationSignalSequenceId generated by hbm2java
 */
public class RecombinationSignalSequenceId implements java.io.Serializable {

	private Integer recombinationSignalSequenceId;
	...
	public RecombinationSignalSequenceId() {
	}

	public RecombinationSignalSequenceId(Integer recombinationSignalSequenceId,
		...
		this.recombinationSignalSequenceId = recombinationSignalSequenceId;
	...
	public Integer getRecombinationSignalSequenceId() {
		return this.recombinationSignalSequenceId;
	}

	public void setRecombinationSignalSequenceId(
			Integer recombinationSignalSequenceId) {
		this.recombinationSignalSequenceId = recombinationSignalSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationSignalSequenceId))
			return false;
		RecombinationSignalSequenceId castOther = (RecombinationSignalSequenceId) other;

		return ((this.getRecombinationSignalSequenceId() == castOther
				.getRecombinationSignalSequenceId()) || (this
				.getRecombinationSignalSequenceId() != null
				&& castOther.getRecombinationSignalSequenceId() != null && this
				.getRecombinationSignalSequenceId().equals(
						castOther.getRecombinationSignalSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationSignalSequenceId() == null ? 0 : this
						.getRecombinationSignalSequenceId().hashCode());
		result = 37 * result
