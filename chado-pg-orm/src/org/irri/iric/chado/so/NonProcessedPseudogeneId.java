...
/**
 * NonProcessedPseudogeneId generated by hbm2java
 */
public class NonProcessedPseudogeneId implements java.io.Serializable {

	private Integer nonProcessedPseudogeneId;
	...
	public NonProcessedPseudogeneId() {
	}

	public NonProcessedPseudogeneId(Integer nonProcessedPseudogeneId,
		...
		this.nonProcessedPseudogeneId = nonProcessedPseudogeneId;
	...
	public Integer getNonProcessedPseudogeneId() {
		return this.nonProcessedPseudogeneId;
	}

	public void setNonProcessedPseudogeneId(Integer nonProcessedPseudogeneId) {
		this.nonProcessedPseudogeneId = nonProcessedPseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonProcessedPseudogeneId))
			return false;
		NonProcessedPseudogeneId castOther = (NonProcessedPseudogeneId) other;

		return ((this.getNonProcessedPseudogeneId() == castOther
				.getNonProcessedPseudogeneId()) || (this
				.getNonProcessedPseudogeneId() != null
				&& castOther.getNonProcessedPseudogeneId() != null && this
				.getNonProcessedPseudogeneId().equals(
						castOther.getNonProcessedPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonProcessedPseudogeneId() == null ? 0 : this
						.getNonProcessedPseudogeneId().hashCode());
		result = 37 * result
