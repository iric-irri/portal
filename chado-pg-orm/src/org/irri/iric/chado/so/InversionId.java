...
/**
 * InversionId generated by hbm2java
 */
public class InversionId implements java.io.Serializable {
	...
	public InversionId(Integer inversionId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionId))
			return false;
		InversionId castOther = (InversionId) other;

		return ((this.getInversionId() == castOther.getInversionId()) || (this
				.getInversionId() != null && castOther.getInversionId() != null && this
				.getInversionId().equals(castOther.getInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionId() == null ? 0 : this.getInversionId()
						.hashCode());
		result = 37 * result
