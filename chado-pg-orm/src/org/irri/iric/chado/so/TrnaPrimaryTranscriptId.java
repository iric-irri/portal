...
/**
 * TrnaPrimaryTranscriptId generated by hbm2java
 */
public class TrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer trnaPrimaryTranscriptId;
	...
	public TrnaPrimaryTranscriptId() {
	}

	public TrnaPrimaryTranscriptId(Integer trnaPrimaryTranscriptId,
		...
		this.trnaPrimaryTranscriptId = trnaPrimaryTranscriptId;
	...
	public Integer getTrnaPrimaryTranscriptId() {
		return this.trnaPrimaryTranscriptId;
	}

	public void setTrnaPrimaryTranscriptId(Integer trnaPrimaryTranscriptId) {
		this.trnaPrimaryTranscriptId = trnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaPrimaryTranscriptId))
			return false;
		TrnaPrimaryTranscriptId castOther = (TrnaPrimaryTranscriptId) other;

		return ((this.getTrnaPrimaryTranscriptId() == castOther
				.getTrnaPrimaryTranscriptId()) || (this
				.getTrnaPrimaryTranscriptId() != null
				&& castOther.getTrnaPrimaryTranscriptId() != null && this
				.getTrnaPrimaryTranscriptId().equals(
						castOther.getTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrnaPrimaryTranscriptId() == null ? 0 : this
						.getTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
