...
/**
 * ParalogousId generated by hbm2java
 */
public class ParalogousId implements java.io.Serializable {

	private Integer paralogousId;
	...
	public ParalogousId(Integer paralogousId, Integer featureId,
		...
		this.paralogousId = paralogousId;
	...
	public Integer getParalogousId() {
		return this.paralogousId;
	}

	public void setParalogousId(Integer paralogousId) {
		this.paralogousId = paralogousId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParalogousId))
			return false;
		ParalogousId castOther = (ParalogousId) other;

		return ((this.getParalogousId() == castOther.getParalogousId()) || (this
				.getParalogousId() != null
				&& castOther.getParalogousId() != null && this
				.getParalogousId().equals(castOther.getParalogousId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getParalogousId() == null ? 0 : this.getParalogousId()
						.hashCode());
		result = 37 * result
