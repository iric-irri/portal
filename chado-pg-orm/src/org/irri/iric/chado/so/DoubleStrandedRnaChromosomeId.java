...
/**
 * DoubleStrandedRnaChromosomeId generated by hbm2java
 */
public class DoubleStrandedRnaChromosomeId implements java.io.Serializable {

	private Integer doubleStrandedRnaChromosomeId;
	...
	public DoubleStrandedRnaChromosomeId() {
	}

	public DoubleStrandedRnaChromosomeId(Integer doubleStrandedRnaChromosomeId,
		...
		this.doubleStrandedRnaChromosomeId = doubleStrandedRnaChromosomeId;
	...
	public Integer getDoubleStrandedRnaChromosomeId() {
		return this.doubleStrandedRnaChromosomeId;
	}

	public void setDoubleStrandedRnaChromosomeId(
			Integer doubleStrandedRnaChromosomeId) {
		this.doubleStrandedRnaChromosomeId = doubleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DoubleStrandedRnaChromosomeId))
			return false;
		DoubleStrandedRnaChromosomeId castOther = (DoubleStrandedRnaChromosomeId) other;

		return ((this.getDoubleStrandedRnaChromosomeId() == castOther
				.getDoubleStrandedRnaChromosomeId()) || (this
				.getDoubleStrandedRnaChromosomeId() != null
				&& castOther.getDoubleStrandedRnaChromosomeId() != null && this
				.getDoubleStrandedRnaChromosomeId().equals(
						castOther.getDoubleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDoubleStrandedRnaChromosomeId() == null ? 0 : this
						.getDoubleStrandedRnaChromosomeId().hashCode());
		result = 37 * result
