...
/**
 * LtrComponentId generated by hbm2java
 */
public class LtrComponentId implements java.io.Serializable {

	private Integer ltrComponentId;
	...
	public LtrComponentId() {
	}

	public LtrComponentId(Integer ltrComponentId, Integer featureId,
		...
		this.ltrComponentId = ltrComponentId;
	...
	public Integer getLtrComponentId() {
		return this.ltrComponentId;
	}

	public void setLtrComponentId(Integer ltrComponentId) {
		this.ltrComponentId = ltrComponentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LtrComponentId))
			return false;
		LtrComponentId castOther = (LtrComponentId) other;

		return ((this.getLtrComponentId() == castOther.getLtrComponentId()) || (this
				.getLtrComponentId() != null
				&& castOther.getLtrComponentId() != null && this
				.getLtrComponentId().equals(castOther.getLtrComponentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLtrComponentId() == null ? 0 : this.getLtrComponentId()
						.hashCode());
		result = 37 * result
