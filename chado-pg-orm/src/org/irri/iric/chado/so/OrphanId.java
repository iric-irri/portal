...
/**
 * OrphanId generated by hbm2java
 */
public class OrphanId implements java.io.Serializable {
	...
	public OrphanId(Integer orphanId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrphanId))
			return false;
		OrphanId castOther = (OrphanId) other;

		return ((this.getOrphanId() == castOther.getOrphanId()) || (this
				.getOrphanId() != null && castOther.getOrphanId() != null && this
				.getOrphanId().equals(castOther.getOrphanId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOrphanId() == null ? 0 : this.getOrphanId().hashCode());
		result = 37 * result
