...
/**
 * ExonLossId generated by hbm2java
 */
public class ExonLossId implements java.io.Serializable {

	private Integer exonLossId;
	...
	public ExonLossId(Integer exonLossId, Integer featureId, Integer dbxrefId,
	...
	public Integer getExonLossId() {
		return this.exonLossId;
	}

	public void setExonLossId(Integer exonLossId) {
		this.exonLossId = exonLossId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonLossId))
			return false;
		ExonLossId castOther = (ExonLossId) other;

		return ((this.getExonLossId() == castOther.getExonLossId()) || (this
				.getExonLossId() != null && castOther.getExonLossId() != null && this
				.getExonLossId().equals(castOther.getExonLossId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonLossId() == null ? 0 : this.getExonLossId()
						.hashCode());
		result = 37 * result
