...
/**
 * N4MethylcytidineId generated by hbm2java
 */
public class N4MethylcytidineId implements java.io.Serializable {

	private Integer n4MethylcytidineId;
	...
	public N4MethylcytidineId() {
	}

	public N4MethylcytidineId(Integer n4MethylcytidineId, Integer featureId,
		...
		this.n4MethylcytidineId = n4MethylcytidineId;
	...
	public Integer getN4MethylcytidineId() {
		return this.n4MethylcytidineId;
	}

	public void setN4MethylcytidineId(Integer n4MethylcytidineId) {
		this.n4MethylcytidineId = n4MethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N4MethylcytidineId))
			return false;
		N4MethylcytidineId castOther = (N4MethylcytidineId) other;

		return ((this.getN4MethylcytidineId() == castOther
				.getN4MethylcytidineId()) || (this.getN4MethylcytidineId() != null
				&& castOther.getN4MethylcytidineId() != null && this
				.getN4MethylcytidineId().equals(
						castOther.getN4MethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN4MethylcytidineId() == null ? 0 : this
						.getN4MethylcytidineId().hashCode());
		result = 37 * result
