...
/**
 * FiveFormylcytidineId generated by hbm2java
 */
public class FiveFormylcytidineId implements java.io.Serializable {

	private Integer fiveFormylcytidineId;
	...
	public FiveFormylcytidineId() {
	}

	public FiveFormylcytidineId(Integer fiveFormylcytidineId,
		...
		this.fiveFormylcytidineId = fiveFormylcytidineId;
	...
	public Integer getFiveFormylcytidineId() {
		return this.fiveFormylcytidineId;
	}

	public void setFiveFormylcytidineId(Integer fiveFormylcytidineId) {
		this.fiveFormylcytidineId = fiveFormylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveFormylcytidineId))
			return false;
		FiveFormylcytidineId castOther = (FiveFormylcytidineId) other;

		return ((this.getFiveFormylcytidineId() == castOther
				.getFiveFormylcytidineId()) || (this.getFiveFormylcytidineId() != null
				&& castOther.getFiveFormylcytidineId() != null && this
				.getFiveFormylcytidineId().equals(
						castOther.getFiveFormylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveFormylcytidineId() == null ? 0 : this
						.getFiveFormylcytidineId().hashCode());
		result = 37 * result
