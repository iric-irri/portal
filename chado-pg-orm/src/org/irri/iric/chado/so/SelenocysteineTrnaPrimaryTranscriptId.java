...
/**
 * SelenocysteineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class SelenocysteineTrnaPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer selenocysteineTrnaPrimaryTranscriptId;
	...
	public SelenocysteineTrnaPrimaryTranscriptId() {
	}

	public SelenocysteineTrnaPrimaryTranscriptId(
			Integer selenocysteineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.selenocysteineTrnaPrimaryTranscriptId = selenocysteineTrnaPrimaryTranscriptId;
	...
	public Integer getSelenocysteineTrnaPrimaryTranscriptId() {
		return this.selenocysteineTrnaPrimaryTranscriptId;
	}

	public void setSelenocysteineTrnaPrimaryTranscriptId(
			Integer selenocysteineTrnaPrimaryTranscriptId) {
		this.selenocysteineTrnaPrimaryTranscriptId = selenocysteineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SelenocysteineTrnaPrimaryTranscriptId))
			return false;
		SelenocysteineTrnaPrimaryTranscriptId castOther = (SelenocysteineTrnaPrimaryTranscriptId) other;

		return ((this.getSelenocysteineTrnaPrimaryTranscriptId() == castOther
				.getSelenocysteineTrnaPrimaryTranscriptId()) || (this
				.getSelenocysteineTrnaPrimaryTranscriptId() != null
				&& castOther.getSelenocysteineTrnaPrimaryTranscriptId() != null && this
				.getSelenocysteineTrnaPrimaryTranscriptId().equals(
						castOther.getSelenocysteineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSelenocysteineTrnaPrimaryTranscriptId() == null ? 0
						: this.getSelenocysteineTrnaPrimaryTranscriptId()
								.hashCode());
		result = 37 * result
