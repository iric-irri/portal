...
/**
 * ThreePrimeRecodingSiteId generated by hbm2java
 */
public class ThreePrimeRecodingSiteId implements java.io.Serializable {

	private Integer threePrimeRecodingSiteId;
	...
	public ThreePrimeRecodingSiteId() {
	}

	public ThreePrimeRecodingSiteId(Integer threePrimeRecodingSiteId,
		...
		this.threePrimeRecodingSiteId = threePrimeRecodingSiteId;
	...
	public Integer getThreePrimeRecodingSiteId() {
		return this.threePrimeRecodingSiteId;
	}

	public void setThreePrimeRecodingSiteId(Integer threePrimeRecodingSiteId) {
		this.threePrimeRecodingSiteId = threePrimeRecodingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeRecodingSiteId))
			return false;
		ThreePrimeRecodingSiteId castOther = (ThreePrimeRecodingSiteId) other;

		return ((this.getThreePrimeRecodingSiteId() == castOther
				.getThreePrimeRecodingSiteId()) || (this
				.getThreePrimeRecodingSiteId() != null
				&& castOther.getThreePrimeRecodingSiteId() != null && this
				.getThreePrimeRecodingSiteId().equals(
						castOther.getThreePrimeRecodingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeRecodingSiteId() == null ? 0 : this
						.getThreePrimeRecodingSiteId().hashCode());
		result = 37 * result
