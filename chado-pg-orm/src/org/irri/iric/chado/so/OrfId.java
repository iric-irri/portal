...
/**
 * OrfId generated by hbm2java
 */
public class OrfId implements java.io.Serializable {

	private Integer orfId;
	...
	public OrfId(Integer orfId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrfId))
			return false;
		OrfId castOther = (OrfId) other;

		return ((this.getOrfId() == castOther.getOrfId()) || (this.getOrfId() != null
				&& castOther.getOrfId() != null && this.getOrfId().equals(
				castOther.getOrfId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOrfId() == null ? 0 : this.getOrfId().hashCode());
		result = 37 * result
