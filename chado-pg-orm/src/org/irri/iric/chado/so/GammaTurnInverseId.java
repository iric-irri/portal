...
/**
 * GammaTurnInverseId generated by hbm2java
 */
public class GammaTurnInverseId implements java.io.Serializable {

	private Integer gammaTurnInverseId;
	...
	public GammaTurnInverseId() {
	}

	public GammaTurnInverseId(Integer gammaTurnInverseId, Integer featureId,
		...
		this.gammaTurnInverseId = gammaTurnInverseId;
	...
	public Integer getGammaTurnInverseId() {
		return this.gammaTurnInverseId;
	}

	public void setGammaTurnInverseId(Integer gammaTurnInverseId) {
		this.gammaTurnInverseId = gammaTurnInverseId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GammaTurnInverseId))
			return false;
		GammaTurnInverseId castOther = (GammaTurnInverseId) other;

		return ((this.getGammaTurnInverseId() == castOther
				.getGammaTurnInverseId()) || (this.getGammaTurnInverseId() != null
				&& castOther.getGammaTurnInverseId() != null && this
				.getGammaTurnInverseId().equals(
						castOther.getGammaTurnInverseId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGammaTurnInverseId() == null ? 0 : this
						.getGammaTurnInverseId().hashCode());
		result = 37 * result
