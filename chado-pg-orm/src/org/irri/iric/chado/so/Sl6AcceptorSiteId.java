...
/**
 * Sl6AcceptorSiteId generated by hbm2java
 */
public class Sl6AcceptorSiteId implements java.io.Serializable {

	private Integer sl6AcceptorSiteId;
	...
	public Sl6AcceptorSiteId() {
	}

	public Sl6AcceptorSiteId(Integer sl6AcceptorSiteId, Integer featureId,
		...
		this.sl6AcceptorSiteId = sl6AcceptorSiteId;
	...
	public Integer getSl6AcceptorSiteId() {
		return this.sl6AcceptorSiteId;
	}

	public void setSl6AcceptorSiteId(Integer sl6AcceptorSiteId) {
		this.sl6AcceptorSiteId = sl6AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl6AcceptorSiteId))
			return false;
		Sl6AcceptorSiteId castOther = (Sl6AcceptorSiteId) other;

		return ((this.getSl6AcceptorSiteId() == castOther
				.getSl6AcceptorSiteId()) || (this.getSl6AcceptorSiteId() != null
				&& castOther.getSl6AcceptorSiteId() != null && this
				.getSl6AcceptorSiteId()
				.equals(castOther.getSl6AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl6AcceptorSiteId() == null ? 0 : this
						.getSl6AcceptorSiteId().hashCode());
		result = 37 * result
