...
/**
 * U2IntronId generated by hbm2java
 */
public class U2IntronId implements java.io.Serializable {

	private Integer u2IntronId;
	...
	public U2IntronId(Integer u2IntronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU2IntronId() {
		return this.u2IntronId;
	}

	public void setU2IntronId(Integer u2IntronId) {
		this.u2IntronId = u2IntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U2IntronId))
			return false;
		U2IntronId castOther = (U2IntronId) other;

		return ((this.getU2IntronId() == castOther.getU2IntronId()) || (this
				.getU2IntronId() != null && castOther.getU2IntronId() != null && this
				.getU2IntronId().equals(castOther.getU2IntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU2IntronId() == null ? 0 : this.getU2IntronId()
						.hashCode());
		result = 37 * result
