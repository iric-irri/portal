...
/**
 * MetalBindingSiteId generated by hbm2java
 */
public class MetalBindingSiteId implements java.io.Serializable {

	private Integer metalBindingSiteId;
	...
	public MetalBindingSiteId() {
	}

	public MetalBindingSiteId(Integer metalBindingSiteId, Integer featureId,
		...
		this.metalBindingSiteId = metalBindingSiteId;
	...
	public Integer getMetalBindingSiteId() {
		return this.metalBindingSiteId;
	}

	public void setMetalBindingSiteId(Integer metalBindingSiteId) {
		this.metalBindingSiteId = metalBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MetalBindingSiteId))
			return false;
		MetalBindingSiteId castOther = (MetalBindingSiteId) other;

		return ((this.getMetalBindingSiteId() == castOther
				.getMetalBindingSiteId()) || (this.getMetalBindingSiteId() != null
				&& castOther.getMetalBindingSiteId() != null && this
				.getMetalBindingSiteId().equals(
						castOther.getMetalBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMetalBindingSiteId() == null ? 0 : this
						.getMetalBindingSiteId().hashCode());
		result = 37 * result
