...
/**
 * RrnaCleavageRnaId generated by hbm2java
 */
public class RrnaCleavageRnaId implements java.io.Serializable {

	private Integer rrnaCleavageRnaId;
	...
	public RrnaCleavageRnaId() {
	}

	public RrnaCleavageRnaId(Integer rrnaCleavageRnaId, Integer featureId,
		...
		this.rrnaCleavageRnaId = rrnaCleavageRnaId;
	...
	public Integer getRrnaCleavageRnaId() {
		return this.rrnaCleavageRnaId;
	}

	public void setRrnaCleavageRnaId(Integer rrnaCleavageRnaId) {
		this.rrnaCleavageRnaId = rrnaCleavageRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaCleavageRnaId))
			return false;
		RrnaCleavageRnaId castOther = (RrnaCleavageRnaId) other;

		return ((this.getRrnaCleavageRnaId() == castOther
				.getRrnaCleavageRnaId()) || (this.getRrnaCleavageRnaId() != null
				&& castOther.getRrnaCleavageRnaId() != null && this
				.getRrnaCleavageRnaId()
				.equals(castOther.getRrnaCleavageRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaCleavageRnaId() == null ? 0 : this
						.getRrnaCleavageRnaId().hashCode());
		result = 37 * result
