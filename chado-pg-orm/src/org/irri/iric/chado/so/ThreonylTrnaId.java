...
/**
 * ThreonylTrnaId generated by hbm2java
 */
public class ThreonylTrnaId implements java.io.Serializable {

	private Integer threonylTrnaId;
	...
	public ThreonylTrnaId() {
	}

	public ThreonylTrnaId(Integer threonylTrnaId, Integer featureId,
		...
		this.threonylTrnaId = threonylTrnaId;
	...
	public Integer getThreonylTrnaId() {
		return this.threonylTrnaId;
	}

	public void setThreonylTrnaId(Integer threonylTrnaId) {
		this.threonylTrnaId = threonylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreonylTrnaId))
			return false;
		ThreonylTrnaId castOther = (ThreonylTrnaId) other;

		return ((this.getThreonylTrnaId() == castOther.getThreonylTrnaId()) || (this
				.getThreonylTrnaId() != null
				&& castOther.getThreonylTrnaId() != null && this
				.getThreonylTrnaId().equals(castOther.getThreonylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreonylTrnaId() == null ? 0 : this.getThreonylTrnaId()
						.hashCode());
		result = 37 * result
