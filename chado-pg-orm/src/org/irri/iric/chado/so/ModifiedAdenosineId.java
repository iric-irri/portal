...
/**
 * ModifiedAdenosineId generated by hbm2java
 */
public class ModifiedAdenosineId implements java.io.Serializable {

	private Integer modifiedAdenosineId;
	...
	public ModifiedAdenosineId() {
	}

	public ModifiedAdenosineId(Integer modifiedAdenosineId, Integer featureId,
		...
		this.modifiedAdenosineId = modifiedAdenosineId;
	...
	public Integer getModifiedAdenosineId() {
		return this.modifiedAdenosineId;
	}

	public void setModifiedAdenosineId(Integer modifiedAdenosineId) {
		this.modifiedAdenosineId = modifiedAdenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedAdenosineId))
			return false;
		ModifiedAdenosineId castOther = (ModifiedAdenosineId) other;

		return ((this.getModifiedAdenosineId() == castOther
				.getModifiedAdenosineId()) || (this.getModifiedAdenosineId() != null
				&& castOther.getModifiedAdenosineId() != null && this
				.getModifiedAdenosineId().equals(
						castOther.getModifiedAdenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedAdenosineId() == null ? 0 : this
						.getModifiedAdenosineId().hashCode());
		result = 37 * result
