...
/**
 * ThreePrimeCodingExonNoncodingRegionId generated by hbm2java
 */
public class ThreePrimeCodingExonNoncodingRegionId implements
		java.io.Serializable {

	private Integer threePrimeCodingExonNoncodingRegionId;
	...
	public ThreePrimeCodingExonNoncodingRegionId() {
	}

	public ThreePrimeCodingExonNoncodingRegionId(
			Integer threePrimeCodingExonNoncodingRegionId, Integer featureId,
		...
		this.threePrimeCodingExonNoncodingRegionId = threePrimeCodingExonNoncodingRegionId;
	...
	public Integer getThreePrimeCodingExonNoncodingRegionId() {
		return this.threePrimeCodingExonNoncodingRegionId;
	}

	public void setThreePrimeCodingExonNoncodingRegionId(
			Integer threePrimeCodingExonNoncodingRegionId) {
		this.threePrimeCodingExonNoncodingRegionId = threePrimeCodingExonNoncodingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeCodingExonNoncodingRegionId))
			return false;
		ThreePrimeCodingExonNoncodingRegionId castOther = (ThreePrimeCodingExonNoncodingRegionId) other;

		return ((this.getThreePrimeCodingExonNoncodingRegionId() == castOther
				.getThreePrimeCodingExonNoncodingRegionId()) || (this
				.getThreePrimeCodingExonNoncodingRegionId() != null
				&& castOther.getThreePrimeCodingExonNoncodingRegionId() != null && this
				.getThreePrimeCodingExonNoncodingRegionId().equals(
						castOther.getThreePrimeCodingExonNoncodingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeCodingExonNoncodingRegionId() == null ? 0
						: this.getThreePrimeCodingExonNoncodingRegionId()
								.hashCode());
		result = 37 * result
