...
/**
 * VertebrateImmuneSystemGeneRecombinationFeatureId generated by hbm2java
 */
public class VertebrateImmuneSystemGeneRecombinationFeatureId implements
		java.io.Serializable {

	private Integer vertebrateImmuneSystemGeneRecombinationFeatureId;
	...
	public VertebrateImmuneSystemGeneRecombinationFeatureId() {
	}

	public VertebrateImmuneSystemGeneRecombinationFeatureId(
			Integer vertebrateImmuneSystemGeneRecombinationFeatureId,
		...
		this.vertebrateImmuneSystemGeneRecombinationFeatureId = vertebrateImmuneSystemGeneRecombinationFeatureId;
	...
	public Integer getVertebrateImmuneSystemGeneRecombinationFeatureId() {
		return this.vertebrateImmuneSystemGeneRecombinationFeatureId;
	}

	public void setVertebrateImmuneSystemGeneRecombinationFeatureId(
			Integer vertebrateImmuneSystemGeneRecombinationFeatureId) {
		this.vertebrateImmuneSystemGeneRecombinationFeatureId = vertebrateImmuneSystemGeneRecombinationFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateImmuneSystemGeneRecombinationFeatureId))
			return false;
		VertebrateImmuneSystemGeneRecombinationFeatureId castOther = (VertebrateImmuneSystemGeneRecombinationFeatureId) other;

		return ((this.getVertebrateImmuneSystemGeneRecombinationFeatureId() == castOther
				.getVertebrateImmuneSystemGeneRecombinationFeatureId()) || (this
				.getVertebrateImmuneSystemGeneRecombinationFeatureId() != null
				&& castOther
						.getVertebrateImmuneSystemGeneRecombinationFeatureId() != null && this
				.getVertebrateImmuneSystemGeneRecombinationFeatureId()
				.equals(castOther
						.getVertebrateImmuneSystemGeneRecombinationFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateImmuneSystemGeneRecombinationFeatureId() == null ? 0
						: this.getVertebrateImmuneSystemGeneRecombinationFeatureId()
								.hashCode());
		result = 37 * result
