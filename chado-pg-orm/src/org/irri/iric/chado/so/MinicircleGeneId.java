...
/**
 * MinicircleGeneId generated by hbm2java
 */
public class MinicircleGeneId implements java.io.Serializable {

	private Integer minicircleGeneId;
	...
	public MinicircleGeneId() {
	}

	public MinicircleGeneId(Integer minicircleGeneId, Integer featureId,
		...
		this.minicircleGeneId = minicircleGeneId;
	...
	public Integer getMinicircleGeneId() {
		return this.minicircleGeneId;
	}

	public void setMinicircleGeneId(Integer minicircleGeneId) {
		this.minicircleGeneId = minicircleGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MinicircleGeneId))
			return false;
		MinicircleGeneId castOther = (MinicircleGeneId) other;

		return ((this.getMinicircleGeneId() == castOther.getMinicircleGeneId()) || (this
				.getMinicircleGeneId() != null
				&& castOther.getMinicircleGeneId() != null && this
				.getMinicircleGeneId().equals(castOther.getMinicircleGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinicircleGeneId() == null ? 0 : this
						.getMinicircleGeneId().hashCode());
		result = 37 * result
