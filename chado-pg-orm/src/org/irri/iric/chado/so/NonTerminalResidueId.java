...
/**
 * NonTerminalResidueId generated by hbm2java
 */
public class NonTerminalResidueId implements java.io.Serializable {

	private Integer nonTerminalResidueId;
	...
	public NonTerminalResidueId() {
	}

	public NonTerminalResidueId(Integer nonTerminalResidueId,
		...
		this.nonTerminalResidueId = nonTerminalResidueId;
	...
	public Integer getNonTerminalResidueId() {
		return this.nonTerminalResidueId;
	}

	public void setNonTerminalResidueId(Integer nonTerminalResidueId) {
		this.nonTerminalResidueId = nonTerminalResidueId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonTerminalResidueId))
			return false;
		NonTerminalResidueId castOther = (NonTerminalResidueId) other;

		return ((this.getNonTerminalResidueId() == castOther
				.getNonTerminalResidueId()) || (this.getNonTerminalResidueId() != null
				&& castOther.getNonTerminalResidueId() != null && this
				.getNonTerminalResidueId().equals(
						castOther.getNonTerminalResidueId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonTerminalResidueId() == null ? 0 : this
						.getNonTerminalResidueId().hashCode());
		result = 37 * result
