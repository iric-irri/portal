...
/**
 * QtlId generated by hbm2java
 */
public class QtlId implements java.io.Serializable {
	...
	public QtlId(Integer qtlId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QtlId))
			return false;
		QtlId castOther = (QtlId) other;

		return ((this.getQtlId() == castOther.getQtlId()) || (this.getQtlId() != null
				&& castOther.getQtlId() != null && this.getQtlId().equals(
				castOther.getQtlId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getQtlId() == null ? 0 : this.getQtlId().hashCode());
		result = 37 * result
