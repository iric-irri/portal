...
/**
 * FusionGeneId generated by hbm2java
 */
public class FusionGeneId implements java.io.Serializable {

	private Integer fusionGeneId;
	...
	public FusionGeneId(Integer fusionGeneId, Integer featureId,
		...
		this.fusionGeneId = fusionGeneId;
	...
	public Integer getFusionGeneId() {
		return this.fusionGeneId;
	}

	public void setFusionGeneId(Integer fusionGeneId) {
		this.fusionGeneId = fusionGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FusionGeneId))
			return false;
		FusionGeneId castOther = (FusionGeneId) other;

		return ((this.getFusionGeneId() == castOther.getFusionGeneId()) || (this
				.getFusionGeneId() != null
				&& castOther.getFusionGeneId() != null && this
				.getFusionGeneId().equals(castOther.getFusionGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFusionGeneId() == null ? 0 : this.getFusionGeneId()
						.hashCode());
		result = 37 * result
