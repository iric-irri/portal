...
/**
 * KinetoplastId generated by hbm2java
 */
public class KinetoplastId implements java.io.Serializable {

	private Integer kinetoplastId;
	...
	public KinetoplastId() {
	}

	public KinetoplastId(Integer kinetoplastId, Integer featureId,
		...
		this.kinetoplastId = kinetoplastId;
	...
	public Integer getKinetoplastId() {
		return this.kinetoplastId;
	}

	public void setKinetoplastId(Integer kinetoplastId) {
		this.kinetoplastId = kinetoplastId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KinetoplastId))
			return false;
		KinetoplastId castOther = (KinetoplastId) other;

		return ((this.getKinetoplastId() == castOther.getKinetoplastId()) || (this
				.getKinetoplastId() != null
				&& castOther.getKinetoplastId() != null && this
				.getKinetoplastId().equals(castOther.getKinetoplastId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getKinetoplastId() == null ? 0 : this.getKinetoplastId()
						.hashCode());
		result = 37 * result
