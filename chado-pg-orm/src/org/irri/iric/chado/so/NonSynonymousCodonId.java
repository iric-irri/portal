...
/**
 * NonSynonymousCodonId generated by hbm2java
 */
public class NonSynonymousCodonId implements java.io.Serializable {

	private Integer nonSynonymousCodonId;
	...
	public NonSynonymousCodonId() {
	}

	public NonSynonymousCodonId(Integer nonSynonymousCodonId,
		...
		this.nonSynonymousCodonId = nonSynonymousCodonId;
	...
	public Integer getNonSynonymousCodonId() {
		return this.nonSynonymousCodonId;
	}

	public void setNonSynonymousCodonId(Integer nonSynonymousCodonId) {
		this.nonSynonymousCodonId = nonSynonymousCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonSynonymousCodonId))
			return false;
		NonSynonymousCodonId castOther = (NonSynonymousCodonId) other;

		return ((this.getNonSynonymousCodonId() == castOther
				.getNonSynonymousCodonId()) || (this.getNonSynonymousCodonId() != null
				&& castOther.getNonSynonymousCodonId() != null && this
				.getNonSynonymousCodonId().equals(
						castOther.getNonSynonymousCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonSynonymousCodonId() == null ? 0 : this
						.getNonSynonymousCodonId().hashCode());
		result = 37 * result
