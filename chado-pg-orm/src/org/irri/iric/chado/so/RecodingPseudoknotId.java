...
/**
 * RecodingPseudoknotId generated by hbm2java
 */
public class RecodingPseudoknotId implements java.io.Serializable {

	private Integer recodingPseudoknotId;
	...
	public RecodingPseudoknotId() {
	}

	public RecodingPseudoknotId(Integer recodingPseudoknotId,
		...
		this.recodingPseudoknotId = recodingPseudoknotId;
	...
	public Integer getRecodingPseudoknotId() {
		return this.recodingPseudoknotId;
	}

	public void setRecodingPseudoknotId(Integer recodingPseudoknotId) {
		this.recodingPseudoknotId = recodingPseudoknotId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodingPseudoknotId))
			return false;
		RecodingPseudoknotId castOther = (RecodingPseudoknotId) other;

		return ((this.getRecodingPseudoknotId() == castOther
				.getRecodingPseudoknotId()) || (this.getRecodingPseudoknotId() != null
				&& castOther.getRecodingPseudoknotId() != null && this
				.getRecodingPseudoknotId().equals(
						castOther.getRecodingPseudoknotId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecodingPseudoknotId() == null ? 0 : this
						.getRecodingPseudoknotId().hashCode());
		result = 37 * result
