...
/**
 * RrTractId generated by hbm2java
 */
public class RrTractId implements java.io.Serializable {

	private Integer rrTractId;
	...
	public RrTractId(Integer rrTractId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrTractId() {
		return this.rrTractId;
	}

	public void setRrTractId(Integer rrTractId) {
		this.rrTractId = rrTractId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrTractId))
			return false;
		RrTractId castOther = (RrTractId) other;

		return ((this.getRrTractId() == castOther.getRrTractId()) || (this
				.getRrTractId() != null && castOther.getRrTractId() != null && this
				.getRrTractId().equals(castOther.getRrTractId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrTractId() == null ? 0 : this.getRrTractId().hashCode());
		result = 37 * result
