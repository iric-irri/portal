...
/**
 * MacronuclearSequenceId generated by hbm2java
 */
public class MacronuclearSequenceId implements java.io.Serializable {

	private Integer macronuclearSequenceId;
	...
	public MacronuclearSequenceId() {
	}

	public MacronuclearSequenceId(Integer macronuclearSequenceId,
		...
		this.macronuclearSequenceId = macronuclearSequenceId;
	...
	public Integer getMacronuclearSequenceId() {
		return this.macronuclearSequenceId;
	}

	public void setMacronuclearSequenceId(Integer macronuclearSequenceId) {
		this.macronuclearSequenceId = macronuclearSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MacronuclearSequenceId))
			return false;
		MacronuclearSequenceId castOther = (MacronuclearSequenceId) other;

		return ((this.getMacronuclearSequenceId() == castOther
				.getMacronuclearSequenceId()) || (this
				.getMacronuclearSequenceId() != null
				&& castOther.getMacronuclearSequenceId() != null && this
				.getMacronuclearSequenceId().equals(
						castOther.getMacronuclearSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMacronuclearSequenceId() == null ? 0 : this
						.getMacronuclearSequenceId().hashCode());
		result = 37 * result
