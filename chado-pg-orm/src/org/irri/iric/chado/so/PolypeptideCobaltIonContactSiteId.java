...
/**
 * PolypeptideCobaltIonContactSiteId generated by hbm2java
 */
public class PolypeptideCobaltIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideCobaltIonContactSiteId;
	...
	public PolypeptideCobaltIonContactSiteId() {
	}

	public PolypeptideCobaltIonContactSiteId(
			Integer polypeptideCobaltIonContactSiteId, Integer featureId,
		...
		this.polypeptideCobaltIonContactSiteId = polypeptideCobaltIonContactSiteId;
	...
	public Integer getPolypeptideCobaltIonContactSiteId() {
		return this.polypeptideCobaltIonContactSiteId;
	}

	public void setPolypeptideCobaltIonContactSiteId(
			Integer polypeptideCobaltIonContactSiteId) {
		this.polypeptideCobaltIonContactSiteId = polypeptideCobaltIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideCobaltIonContactSiteId))
			return false;
		PolypeptideCobaltIonContactSiteId castOther = (PolypeptideCobaltIonContactSiteId) other;

		return ((this.getPolypeptideCobaltIonContactSiteId() == castOther
				.getPolypeptideCobaltIonContactSiteId()) || (this
				.getPolypeptideCobaltIonContactSiteId() != null
				&& castOther.getPolypeptideCobaltIonContactSiteId() != null && this
				.getPolypeptideCobaltIonContactSiteId().equals(
						castOther.getPolypeptideCobaltIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideCobaltIonContactSiteId() == null ? 0 : this
						.getPolypeptideCobaltIonContactSiteId().hashCode());
		result = 37 * result
