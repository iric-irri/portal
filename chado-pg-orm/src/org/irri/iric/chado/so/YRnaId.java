...
/**
 * YRnaId generated by hbm2java
 */
public class YRnaId implements java.io.Serializable {

	private Integer YRnaId;
	...
	public YRnaId(Integer YRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getYRnaId() {
		return this.YRnaId;
	}

	public void setYRnaId(Integer YRnaId) {
		this.YRnaId = YRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YRnaId))
			return false;
		YRnaId castOther = (YRnaId) other;

		return ((this.getYRnaId() == castOther.getYRnaId()) || (this
				.getYRnaId() != null && castOther.getYRnaId() != null && this
				.getYRnaId().equals(castOther.getYRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getYRnaId() == null ? 0 : this.getYRnaId().hashCode());
		result = 37 * result
