...
/**
 * DeletionBreakpointId generated by hbm2java
 */
public class DeletionBreakpointId implements java.io.Serializable {

	private Integer deletionBreakpointId;
	...
	public DeletionBreakpointId() {
	}

	public DeletionBreakpointId(Integer deletionBreakpointId,
		...
		this.deletionBreakpointId = deletionBreakpointId;
	...
	public Integer getDeletionBreakpointId() {
		return this.deletionBreakpointId;
	}

	public void setDeletionBreakpointId(Integer deletionBreakpointId) {
		this.deletionBreakpointId = deletionBreakpointId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeletionBreakpointId))
			return false;
		DeletionBreakpointId castOther = (DeletionBreakpointId) other;

		return ((this.getDeletionBreakpointId() == castOther
				.getDeletionBreakpointId()) || (this.getDeletionBreakpointId() != null
				&& castOther.getDeletionBreakpointId() != null && this
				.getDeletionBreakpointId().equals(
						castOther.getDeletionBreakpointId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeletionBreakpointId() == null ? 0 : this
						.getDeletionBreakpointId().hashCode());
		result = 37 * result
