...
/**
 * PrimerBindingSiteId generated by hbm2java
 */
public class PrimerBindingSiteId implements java.io.Serializable {

	private Integer primerBindingSiteId;
	...
	public PrimerBindingSiteId() {
	}

	public PrimerBindingSiteId(Integer primerBindingSiteId, Integer featureId,
		...
		this.primerBindingSiteId = primerBindingSiteId;
	...
	public Integer getPrimerBindingSiteId() {
		return this.primerBindingSiteId;
	}

	public void setPrimerBindingSiteId(Integer primerBindingSiteId) {
		this.primerBindingSiteId = primerBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrimerBindingSiteId))
			return false;
		PrimerBindingSiteId castOther = (PrimerBindingSiteId) other;

		return ((this.getPrimerBindingSiteId() == castOther
				.getPrimerBindingSiteId()) || (this.getPrimerBindingSiteId() != null
				&& castOther.getPrimerBindingSiteId() != null && this
				.getPrimerBindingSiteId().equals(
						castOther.getPrimerBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPrimerBindingSiteId() == null ? 0 : this
						.getPrimerBindingSiteId().hashCode());
		result = 37 * result
