...
/**
 * Home object for domain model class Operator.
 * @see org.irri.iric.chado.so.Operator
 * @author Hibernate Tools
 */
public class OperatorHome {

	private static final Log log = LogFactory.getLog(OperatorHome.class);
	...
	public void persist(Operator transientInstance) {
		log.debug("persisting Operator instance");
		try {
	...
	public Operator merge(Operator detachedInstance) {
		...
		try {
			Operator result = (Operator) sessionFactory.getCurrentSession()
	...
	public Operator findById(org.irri.iric.chado.so.OperatorId id) {
		log.debug("getting Operator instance with id: " + id);
		try {
			Operator instance = (Operator) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.so.Operator", id);
			if (instance == null) {
	...
	public List findByExample(Operator instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Operator")
