...
/**
 * AttiSiteId generated by hbm2java
 */
public class AttiSiteId implements java.io.Serializable {

	private Integer attiSiteId;
	...
	public AttiSiteId(Integer attiSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttiSiteId() {
		return this.attiSiteId;
	}

	public void setAttiSiteId(Integer attiSiteId) {
		this.attiSiteId = attiSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttiSiteId))
			return false;
		AttiSiteId castOther = (AttiSiteId) other;

		return ((this.getAttiSiteId() == castOther.getAttiSiteId()) || (this
				.getAttiSiteId() != null && castOther.getAttiSiteId() != null && this
				.getAttiSiteId().equals(castOther.getAttiSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttiSiteId() == null ? 0 : this.getAttiSiteId()
						.hashCode());
		result = 37 * result
