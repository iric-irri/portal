...
/**
 * FivePrimeLtrId generated by hbm2java
 */
public class FivePrimeLtrId implements java.io.Serializable {

	private Integer fivePrimeLtrId;
	...
	public FivePrimeLtrId() {
	}

	public FivePrimeLtrId(Integer fivePrimeLtrId, Integer featureId,
		...
		this.fivePrimeLtrId = fivePrimeLtrId;
	...
	public Integer getFivePrimeLtrId() {
		return this.fivePrimeLtrId;
	}

	public void setFivePrimeLtrId(Integer fivePrimeLtrId) {
		this.fivePrimeLtrId = fivePrimeLtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeLtrId))
			return false;
		FivePrimeLtrId castOther = (FivePrimeLtrId) other;

		return ((this.getFivePrimeLtrId() == castOther.getFivePrimeLtrId()) || (this
				.getFivePrimeLtrId() != null
				&& castOther.getFivePrimeLtrId() != null && this
				.getFivePrimeLtrId().equals(castOther.getFivePrimeLtrId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeLtrId() == null ? 0 : this.getFivePrimeLtrId()
						.hashCode());
		result = 37 * result
