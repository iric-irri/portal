...
/**
 * DuplicatedPseudogeneId generated by hbm2java
 */
public class DuplicatedPseudogeneId implements java.io.Serializable {

	private Integer duplicatedPseudogeneId;
	...
	public DuplicatedPseudogeneId() {
	}

	public DuplicatedPseudogeneId(Integer duplicatedPseudogeneId,
		...
		this.duplicatedPseudogeneId = duplicatedPseudogeneId;
	...
	public Integer getDuplicatedPseudogeneId() {
		return this.duplicatedPseudogeneId;
	}

	public void setDuplicatedPseudogeneId(Integer duplicatedPseudogeneId) {
		this.duplicatedPseudogeneId = duplicatedPseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DuplicatedPseudogeneId))
			return false;
		DuplicatedPseudogeneId castOther = (DuplicatedPseudogeneId) other;

		return ((this.getDuplicatedPseudogeneId() == castOther
				.getDuplicatedPseudogeneId()) || (this
				.getDuplicatedPseudogeneId() != null
				&& castOther.getDuplicatedPseudogeneId() != null && this
				.getDuplicatedPseudogeneId().equals(
						castOther.getDuplicatedPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDuplicatedPseudogeneId() == null ? 0 : this
						.getDuplicatedPseudogeneId().hashCode());
		result = 37 * result
