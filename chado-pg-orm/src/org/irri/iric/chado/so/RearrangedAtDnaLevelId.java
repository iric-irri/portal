...
/**
 * RearrangedAtDnaLevelId generated by hbm2java
 */
public class RearrangedAtDnaLevelId implements java.io.Serializable {

	private Integer rearrangedAtDnaLevelId;
	...
	public RearrangedAtDnaLevelId() {
	}

	public RearrangedAtDnaLevelId(Integer rearrangedAtDnaLevelId,
		...
		this.rearrangedAtDnaLevelId = rearrangedAtDnaLevelId;
	...
	public Integer getRearrangedAtDnaLevelId() {
		return this.rearrangedAtDnaLevelId;
	}

	public void setRearrangedAtDnaLevelId(Integer rearrangedAtDnaLevelId) {
		this.rearrangedAtDnaLevelId = rearrangedAtDnaLevelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RearrangedAtDnaLevelId))
			return false;
		RearrangedAtDnaLevelId castOther = (RearrangedAtDnaLevelId) other;

		return ((this.getRearrangedAtDnaLevelId() == castOther
				.getRearrangedAtDnaLevelId()) || (this
				.getRearrangedAtDnaLevelId() != null
				&& castOther.getRearrangedAtDnaLevelId() != null && this
				.getRearrangedAtDnaLevelId().equals(
						castOther.getRearrangedAtDnaLevelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRearrangedAtDnaLevelId() == null ? 0 : this
						.getRearrangedAtDnaLevelId().hashCode());
		result = 37 * result
