...
/**
 * IntronVariantId generated by hbm2java
 */
public class IntronVariantId implements java.io.Serializable {

	private Integer intronVariantId;
	...
	public IntronVariantId() {
	}

	public IntronVariantId(Integer intronVariantId, Integer featureId,
		...
		this.intronVariantId = intronVariantId;
	...
	public Integer getIntronVariantId() {
		return this.intronVariantId;
	}

	public void setIntronVariantId(Integer intronVariantId) {
		this.intronVariantId = intronVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronVariantId))
			return false;
		IntronVariantId castOther = (IntronVariantId) other;

		return ((this.getIntronVariantId() == castOther.getIntronVariantId()) || (this
				.getIntronVariantId() != null
				&& castOther.getIntronVariantId() != null && this
				.getIntronVariantId().equals(castOther.getIntronVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntronVariantId() == null ? 0 : this.getIntronVariantId()
						.hashCode());
		result = 37 * result
