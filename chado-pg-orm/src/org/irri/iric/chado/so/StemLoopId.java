...
/**
 * StemLoopId generated by hbm2java
 */
public class StemLoopId implements java.io.Serializable {

	private Integer stemLoopId;
	...
	public StemLoopId(Integer stemLoopId, Integer featureId, Integer dbxrefId,
	...
	public Integer getStemLoopId() {
		return this.stemLoopId;
	}

	public void setStemLoopId(Integer stemLoopId) {
		this.stemLoopId = stemLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StemLoopId))
			return false;
		StemLoopId castOther = (StemLoopId) other;

		return ((this.getStemLoopId() == castOther.getStemLoopId()) || (this
				.getStemLoopId() != null && castOther.getStemLoopId() != null && this
				.getStemLoopId().equals(castOther.getStemLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStemLoopId() == null ? 0 : this.getStemLoopId()
						.hashCode());
		result = 37 * result
