...
/**
 * TranscriptStabilityVariantId generated by hbm2java
 */
public class TranscriptStabilityVariantId implements java.io.Serializable {

	private Integer transcriptStabilityVariantId;
	...
	public TranscriptStabilityVariantId() {
	}

	public TranscriptStabilityVariantId(Integer transcriptStabilityVariantId,
		...
		this.transcriptStabilityVariantId = transcriptStabilityVariantId;
	...
	public Integer getTranscriptStabilityVariantId() {
		return this.transcriptStabilityVariantId;
	}

	public void setTranscriptStabilityVariantId(
			Integer transcriptStabilityVariantId) {
		this.transcriptStabilityVariantId = transcriptStabilityVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptStabilityVariantId))
			return false;
		TranscriptStabilityVariantId castOther = (TranscriptStabilityVariantId) other;

		return ((this.getTranscriptStabilityVariantId() == castOther
				.getTranscriptStabilityVariantId()) || (this
				.getTranscriptStabilityVariantId() != null
				&& castOther.getTranscriptStabilityVariantId() != null && this
				.getTranscriptStabilityVariantId().equals(
						castOther.getTranscriptStabilityVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptStabilityVariantId() == null ? 0 : this
						.getTranscriptStabilityVariantId().hashCode());
		result = 37 * result
