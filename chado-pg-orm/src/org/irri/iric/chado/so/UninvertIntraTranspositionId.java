...
/**
 * UninvertIntraTranspositionId generated by hbm2java
 */
public class UninvertIntraTranspositionId implements java.io.Serializable {

	private Integer uninvertIntraTranspositionId;
	...
	public UninvertIntraTranspositionId() {
	}

	public UninvertIntraTranspositionId(Integer uninvertIntraTranspositionId,
		...
		this.uninvertIntraTranspositionId = uninvertIntraTranspositionId;
	...
	public Integer getUninvertIntraTranspositionId() {
		return this.uninvertIntraTranspositionId;
	}

	public void setUninvertIntraTranspositionId(
			Integer uninvertIntraTranspositionId) {
		this.uninvertIntraTranspositionId = uninvertIntraTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UninvertIntraTranspositionId))
			return false;
		UninvertIntraTranspositionId castOther = (UninvertIntraTranspositionId) other;

		return ((this.getUninvertIntraTranspositionId() == castOther
				.getUninvertIntraTranspositionId()) || (this
				.getUninvertIntraTranspositionId() != null
				&& castOther.getUninvertIntraTranspositionId() != null && this
				.getUninvertIntraTranspositionId().equals(
						castOther.getUninvertIntraTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUninvertIntraTranspositionId() == null ? 0 : this
						.getUninvertIntraTranspositionId().hashCode());
		result = 37 * result
