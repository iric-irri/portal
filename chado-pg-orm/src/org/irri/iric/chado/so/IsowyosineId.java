...
/**
 * IsowyosineId generated by hbm2java
 */
public class IsowyosineId implements java.io.Serializable {

	private Integer isowyosineId;
	...
	public IsowyosineId(Integer isowyosineId, Integer featureId,
		...
		this.isowyosineId = isowyosineId;
	...
	public Integer getIsowyosineId() {
		return this.isowyosineId;
	}

	public void setIsowyosineId(Integer isowyosineId) {
		this.isowyosineId = isowyosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IsowyosineId))
			return false;
		IsowyosineId castOther = (IsowyosineId) other;

		return ((this.getIsowyosineId() == castOther.getIsowyosineId()) || (this
				.getIsowyosineId() != null
				&& castOther.getIsowyosineId() != null && this
				.getIsowyosineId().equals(castOther.getIsowyosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIsowyosineId() == null ? 0 : this.getIsowyosineId()
						.hashCode());
		result = 37 * result
