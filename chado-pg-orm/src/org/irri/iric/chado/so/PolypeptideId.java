...
/**
 * PolypeptideId generated by hbm2java
 */
public class PolypeptideId implements java.io.Serializable {

	private Integer polypeptideId;
	...
	public PolypeptideId() {
	}

	public PolypeptideId(Integer polypeptideId, Integer featureId,
		...
		this.polypeptideId = polypeptideId;
	...
	public Integer getPolypeptideId() {
		return this.polypeptideId;
	}

	public void setPolypeptideId(Integer polypeptideId) {
		this.polypeptideId = polypeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideId))
			return false;
		PolypeptideId castOther = (PolypeptideId) other;

		return ((this.getPolypeptideId() == castOther.getPolypeptideId()) || (this
				.getPolypeptideId() != null
				&& castOther.getPolypeptideId() != null && this
				.getPolypeptideId().equals(castOther.getPolypeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideId() == null ? 0 : this.getPolypeptideId()
						.hashCode());
		result = 37 * result
