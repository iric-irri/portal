...
/**
 * ChromoplastGeneId generated by hbm2java
 */
public class ChromoplastGeneId implements java.io.Serializable {

	private Integer chromoplastGeneId;
	...
	public ChromoplastGeneId() {
	}

	public ChromoplastGeneId(Integer chromoplastGeneId, Integer featureId,
		...
		this.chromoplastGeneId = chromoplastGeneId;
	...
	public Integer getChromoplastGeneId() {
		return this.chromoplastGeneId;
	}

	public void setChromoplastGeneId(Integer chromoplastGeneId) {
		this.chromoplastGeneId = chromoplastGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromoplastGeneId))
			return false;
		ChromoplastGeneId castOther = (ChromoplastGeneId) other;

		return ((this.getChromoplastGeneId() == castOther
				.getChromoplastGeneId()) || (this.getChromoplastGeneId() != null
				&& castOther.getChromoplastGeneId() != null && this
				.getChromoplastGeneId()
				.equals(castOther.getChromoplastGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromoplastGeneId() == null ? 0 : this
						.getChromoplastGeneId().hashCode());
		result = 37 * result
