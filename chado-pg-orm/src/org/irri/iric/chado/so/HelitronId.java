...
/**
 * HelitronId generated by hbm2java
 */
public class HelitronId implements java.io.Serializable {

	private Integer helitronId;
	...
	public HelitronId(Integer helitronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getHelitronId() {
		return this.helitronId;
	}

	public void setHelitronId(Integer helitronId) {
		this.helitronId = helitronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HelitronId))
			return false;
		HelitronId castOther = (HelitronId) other;

		return ((this.getHelitronId() == castOther.getHelitronId()) || (this
				.getHelitronId() != null && castOther.getHelitronId() != null && this
				.getHelitronId().equals(castOther.getHelitronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHelitronId() == null ? 0 : this.getHelitronId()
						.hashCode());
		result = 37 * result
