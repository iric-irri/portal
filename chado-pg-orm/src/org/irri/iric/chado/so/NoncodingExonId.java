...
/**
 * NoncodingExonId generated by hbm2java
 */
public class NoncodingExonId implements java.io.Serializable {

	private Integer noncodingExonId;
	...
	public NoncodingExonId() {
	}

	public NoncodingExonId(Integer noncodingExonId, Integer featureId,
		...
		this.noncodingExonId = noncodingExonId;
	...
	public Integer getNoncodingExonId() {
		return this.noncodingExonId;
	}

	public void setNoncodingExonId(Integer noncodingExonId) {
		this.noncodingExonId = noncodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NoncodingExonId))
			return false;
		NoncodingExonId castOther = (NoncodingExonId) other;

		return ((this.getNoncodingExonId() == castOther.getNoncodingExonId()) || (this
				.getNoncodingExonId() != null
				&& castOther.getNoncodingExonId() != null && this
				.getNoncodingExonId().equals(castOther.getNoncodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNoncodingExonId() == null ? 0 : this.getNoncodingExonId()
						.hashCode());
		result = 37 * result
