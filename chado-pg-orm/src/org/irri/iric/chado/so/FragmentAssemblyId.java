...
/**
 * FragmentAssemblyId generated by hbm2java
 */
public class FragmentAssemblyId implements java.io.Serializable {

	private Integer fragmentAssemblyId;
	...
	public FragmentAssemblyId() {
	}

	public FragmentAssemblyId(Integer fragmentAssemblyId, Integer featureId,
		...
		this.fragmentAssemblyId = fragmentAssemblyId;
	...
	public Integer getFragmentAssemblyId() {
		return this.fragmentAssemblyId;
	}

	public void setFragmentAssemblyId(Integer fragmentAssemblyId) {
		this.fragmentAssemblyId = fragmentAssemblyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FragmentAssemblyId))
			return false;
		FragmentAssemblyId castOther = (FragmentAssemblyId) other;

		return ((this.getFragmentAssemblyId() == castOther
				.getFragmentAssemblyId()) || (this.getFragmentAssemblyId() != null
				&& castOther.getFragmentAssemblyId() != null && this
				.getFragmentAssemblyId().equals(
						castOther.getFragmentAssemblyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFragmentAssemblyId() == null ? 0 : this
						.getFragmentAssemblyId().hashCode());
		result = 37 * result
