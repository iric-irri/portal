...
/**
 * TranscriptRegionId generated by hbm2java
 */
public class TranscriptRegionId implements java.io.Serializable {

	private Integer transcriptRegionId;
	...
	public TranscriptRegionId() {
	}

	public TranscriptRegionId(Integer transcriptRegionId, Integer featureId,
		...
		this.transcriptRegionId = transcriptRegionId;
	...
	public Integer getTranscriptRegionId() {
		return this.transcriptRegionId;
	}

	public void setTranscriptRegionId(Integer transcriptRegionId) {
		this.transcriptRegionId = transcriptRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptRegionId))
			return false;
		TranscriptRegionId castOther = (TranscriptRegionId) other;

		return ((this.getTranscriptRegionId() == castOther
				.getTranscriptRegionId()) || (this.getTranscriptRegionId() != null
				&& castOther.getTranscriptRegionId() != null && this
				.getTranscriptRegionId().equals(
						castOther.getTranscriptRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptRegionId() == null ? 0 : this
						.getTranscriptRegionId().hashCode());
		result = 37 * result
