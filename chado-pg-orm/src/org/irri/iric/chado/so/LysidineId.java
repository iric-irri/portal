...
/**
 * LysidineId generated by hbm2java
 */
public class LysidineId implements java.io.Serializable {

	private Integer lysidineId;
	...
	public LysidineId(Integer lysidineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLysidineId() {
		return this.lysidineId;
	}

	public void setLysidineId(Integer lysidineId) {
		this.lysidineId = lysidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LysidineId))
			return false;
		LysidineId castOther = (LysidineId) other;

		return ((this.getLysidineId() == castOther.getLysidineId()) || (this
				.getLysidineId() != null && castOther.getLysidineId() != null && this
				.getLysidineId().equals(castOther.getLysidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLysidineId() == null ? 0 : this.getLysidineId()
						.hashCode());
		result = 37 * result
