...
/**
 * FourThiouridineId generated by hbm2java
 */
public class FourThiouridineId implements java.io.Serializable {

	private Integer fourThiouridineId;
	...
	public FourThiouridineId() {
	}

	public FourThiouridineId(Integer fourThiouridineId, Integer featureId,
		...
		this.fourThiouridineId = fourThiouridineId;
	...
	public Integer getFourThiouridineId() {
		return this.fourThiouridineId;
	}

	public void setFourThiouridineId(Integer fourThiouridineId) {
		this.fourThiouridineId = fourThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FourThiouridineId))
			return false;
		FourThiouridineId castOther = (FourThiouridineId) other;

		return ((this.getFourThiouridineId() == castOther
				.getFourThiouridineId()) || (this.getFourThiouridineId() != null
				&& castOther.getFourThiouridineId() != null && this
				.getFourThiouridineId()
				.equals(castOther.getFourThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFourThiouridineId() == null ? 0 : this
						.getFourThiouridineId().hashCode());
		result = 37 * result
