...
/**
 * ClassIiRnaId generated by hbm2java
 */
public class ClassIiRnaId implements java.io.Serializable {

	private Integer classIiRnaId;
	...
	public ClassIiRnaId(Integer classIiRnaId, Integer featureId,
		...
		this.classIiRnaId = classIiRnaId;
	...
	public Integer getClassIiRnaId() {
		return this.classIiRnaId;
	}

	public void setClassIiRnaId(Integer classIiRnaId) {
		this.classIiRnaId = classIiRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClassIiRnaId))
			return false;
		ClassIiRnaId castOther = (ClassIiRnaId) other;

		return ((this.getClassIiRnaId() == castOther.getClassIiRnaId()) || (this
				.getClassIiRnaId() != null
				&& castOther.getClassIiRnaId() != null && this
				.getClassIiRnaId().equals(castOther.getClassIiRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getClassIiRnaId() == null ? 0 : this.getClassIiRnaId()
						.hashCode());
		result = 37 * result
