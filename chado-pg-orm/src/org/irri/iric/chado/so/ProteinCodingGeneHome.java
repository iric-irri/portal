 ...
 * @see org.irri.iric.chado.so.ProteinCodingGene
...
public class ProteinCodingGeneHome {
	...
	public ProteinCodingGene findById(
			org.irri.iric.chado.so.ProteinCodingGeneId id) {
		log.debug("getting ProteinCodingGene instance with id: " + id);
		try {
			ProteinCodingGene instance = (ProteinCodingGene) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.so.ProteinCodingGene", id);
			if (instance == null) {
	...
	public List findByExample(ProteinCodingGene instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.ProteinCodingGene")
