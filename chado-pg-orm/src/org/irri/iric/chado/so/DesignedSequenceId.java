...
/**
 * DesignedSequenceId generated by hbm2java
 */
public class DesignedSequenceId implements java.io.Serializable {

	private Integer designedSequenceId;
	...
	public DesignedSequenceId() {
	}

	public DesignedSequenceId(Integer designedSequenceId, Integer featureId,
		...
		this.designedSequenceId = designedSequenceId;
	...
	public Integer getDesignedSequenceId() {
		return this.designedSequenceId;
	}

	public void setDesignedSequenceId(Integer designedSequenceId) {
		this.designedSequenceId = designedSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DesignedSequenceId))
			return false;
		DesignedSequenceId castOther = (DesignedSequenceId) other;

		return ((this.getDesignedSequenceId() == castOther
				.getDesignedSequenceId()) || (this.getDesignedSequenceId() != null
				&& castOther.getDesignedSequenceId() != null && this
				.getDesignedSequenceId().equals(
						castOther.getDesignedSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDesignedSequenceId() == null ? 0 : this
						.getDesignedSequenceId().hashCode());
		result = 37 * result
