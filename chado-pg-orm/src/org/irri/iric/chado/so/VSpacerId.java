...
/**
 * VSpacerId generated by hbm2java
 */
public class VSpacerId implements java.io.Serializable {

	private Integer VSpacerId;
	...
	public VSpacerId(Integer VSpacerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVSpacerId() {
		return this.VSpacerId;
	}

	public void setVSpacerId(Integer VSpacerId) {
		this.VSpacerId = VSpacerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSpacerId))
			return false;
		VSpacerId castOther = (VSpacerId) other;

		return ((this.getVSpacerId() == castOther.getVSpacerId()) || (this
				.getVSpacerId() != null && castOther.getVSpacerId() != null && this
				.getVSpacerId().equals(castOther.getVSpacerId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVSpacerId() == null ? 0 : this.getVSpacerId().hashCode());
		result = 37 * result
