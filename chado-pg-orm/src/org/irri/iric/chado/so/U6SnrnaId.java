...
/**
 * U6SnrnaId generated by hbm2java
 */
public class U6SnrnaId implements java.io.Serializable {

	private Integer u6SnrnaId;
	...
	public U6SnrnaId(Integer u6SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU6SnrnaId() {
		return this.u6SnrnaId;
	}

	public void setU6SnrnaId(Integer u6SnrnaId) {
		this.u6SnrnaId = u6SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U6SnrnaId))
			return false;
		U6SnrnaId castOther = (U6SnrnaId) other;

		return ((this.getU6SnrnaId() == castOther.getU6SnrnaId()) || (this
				.getU6SnrnaId() != null && castOther.getU6SnrnaId() != null && this
				.getU6SnrnaId().equals(castOther.getU6SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getU6SnrnaId() == null ? 0 : this.getU6SnrnaId().hashCode());
		result = 37 * result
