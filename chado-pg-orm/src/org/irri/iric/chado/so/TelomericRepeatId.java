...
/**
 * TelomericRepeatId generated by hbm2java
 */
public class TelomericRepeatId implements java.io.Serializable {

	private Integer telomericRepeatId;
	...
	public TelomericRepeatId() {
	}

	public TelomericRepeatId(Integer telomericRepeatId, Integer featureId,
		...
		this.telomericRepeatId = telomericRepeatId;
	...
	public Integer getTelomericRepeatId() {
		return this.telomericRepeatId;
	}

	public void setTelomericRepeatId(Integer telomericRepeatId) {
		this.telomericRepeatId = telomericRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TelomericRepeatId))
			return false;
		TelomericRepeatId castOther = (TelomericRepeatId) other;

		return ((this.getTelomericRepeatId() == castOther
				.getTelomericRepeatId()) || (this.getTelomericRepeatId() != null
				&& castOther.getTelomericRepeatId() != null && this
				.getTelomericRepeatId()
				.equals(castOther.getTelomericRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTelomericRepeatId() == null ? 0 : this
						.getTelomericRepeatId().hashCode());
		result = 37 * result
