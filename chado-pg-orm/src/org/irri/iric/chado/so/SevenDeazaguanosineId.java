...
/**
 * SevenDeazaguanosineId generated by hbm2java
 */
public class SevenDeazaguanosineId implements java.io.Serializable {

	private Integer sevenDeazaguanosineId;
	...
	public SevenDeazaguanosineId() {
	}

	public SevenDeazaguanosineId(Integer sevenDeazaguanosineId,
		...
		this.sevenDeazaguanosineId = sevenDeazaguanosineId;
	...
	public Integer getSevenDeazaguanosineId() {
		return this.sevenDeazaguanosineId;
	}

	public void setSevenDeazaguanosineId(Integer sevenDeazaguanosineId) {
		this.sevenDeazaguanosineId = sevenDeazaguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SevenDeazaguanosineId))
			return false;
		SevenDeazaguanosineId castOther = (SevenDeazaguanosineId) other;

		return ((this.getSevenDeazaguanosineId() == castOther
				.getSevenDeazaguanosineId()) || (this
				.getSevenDeazaguanosineId() != null
				&& castOther.getSevenDeazaguanosineId() != null && this
				.getSevenDeazaguanosineId().equals(
						castOther.getSevenDeazaguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSevenDeazaguanosineId() == null ? 0 : this
						.getSevenDeazaguanosineId().hashCode());
		result = 37 * result
