...
/**
 * UninvertInterTranspositionId generated by hbm2java
 */
public class UninvertInterTranspositionId implements java.io.Serializable {

	private Integer uninvertInterTranspositionId;
	...
	public UninvertInterTranspositionId() {
	}

	public UninvertInterTranspositionId(Integer uninvertInterTranspositionId,
		...
		this.uninvertInterTranspositionId = uninvertInterTranspositionId;
	...
	public Integer getUninvertInterTranspositionId() {
		return this.uninvertInterTranspositionId;
	}

	public void setUninvertInterTranspositionId(
			Integer uninvertInterTranspositionId) {
		this.uninvertInterTranspositionId = uninvertInterTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UninvertInterTranspositionId))
			return false;
		UninvertInterTranspositionId castOther = (UninvertInterTranspositionId) other;

		return ((this.getUninvertInterTranspositionId() == castOther
				.getUninvertInterTranspositionId()) || (this
				.getUninvertInterTranspositionId() != null
				&& castOther.getUninvertInterTranspositionId() != null && this
				.getUninvertInterTranspositionId().equals(
						castOther.getUninvertInterTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUninvertInterTranspositionId() == null ? 0 : this
						.getUninvertInterTranspositionId().hashCode());
		result = 37 * result
