...
/**
 * NuclearRimLocalizationSignalId generated by hbm2java
 */
public class NuclearRimLocalizationSignalId implements java.io.Serializable {

	private Integer nuclearRimLocalizationSignalId;
	...
	public NuclearRimLocalizationSignalId() {
	}

	public NuclearRimLocalizationSignalId(
			Integer nuclearRimLocalizationSignalId, Integer featureId,
		...
		this.nuclearRimLocalizationSignalId = nuclearRimLocalizationSignalId;
	...
	public Integer getNuclearRimLocalizationSignalId() {
		return this.nuclearRimLocalizationSignalId;
	}

	public void setNuclearRimLocalizationSignalId(
			Integer nuclearRimLocalizationSignalId) {
		this.nuclearRimLocalizationSignalId = nuclearRimLocalizationSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearRimLocalizationSignalId))
			return false;
		NuclearRimLocalizationSignalId castOther = (NuclearRimLocalizationSignalId) other;

		return ((this.getNuclearRimLocalizationSignalId() == castOther
				.getNuclearRimLocalizationSignalId()) || (this
				.getNuclearRimLocalizationSignalId() != null
				&& castOther.getNuclearRimLocalizationSignalId() != null && this
				.getNuclearRimLocalizationSignalId().equals(
						castOther.getNuclearRimLocalizationSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearRimLocalizationSignalId() == null ? 0 : this
						.getNuclearRimLocalizationSignalId().hashCode());
		result = 37 * result
