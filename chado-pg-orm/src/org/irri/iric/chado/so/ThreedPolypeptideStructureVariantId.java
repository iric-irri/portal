...
/**
 * ThreedPolypeptideStructureVariantId generated by hbm2java
 */
public class ThreedPolypeptideStructureVariantId implements
		java.io.Serializable {

	private Integer threedPolypeptideStructureVariantId;
	...
	public ThreedPolypeptideStructureVariantId() {
	}

	public ThreedPolypeptideStructureVariantId(
			Integer threedPolypeptideStructureVariantId, Integer featureId,
		...
		this.threedPolypeptideStructureVariantId = threedPolypeptideStructureVariantId;
	...
	public Integer getThreedPolypeptideStructureVariantId() {
		return this.threedPolypeptideStructureVariantId;
	}

	public void setThreedPolypeptideStructureVariantId(
			Integer threedPolypeptideStructureVariantId) {
		this.threedPolypeptideStructureVariantId = threedPolypeptideStructureVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreedPolypeptideStructureVariantId))
			return false;
		ThreedPolypeptideStructureVariantId castOther = (ThreedPolypeptideStructureVariantId) other;

		return ((this.getThreedPolypeptideStructureVariantId() == castOther
				.getThreedPolypeptideStructureVariantId()) || (this
				.getThreedPolypeptideStructureVariantId() != null
				&& castOther.getThreedPolypeptideStructureVariantId() != null && this
				.getThreedPolypeptideStructureVariantId().equals(
						castOther.getThreedPolypeptideStructureVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreedPolypeptideStructureVariantId() == null ? 0 : this
						.getThreedPolypeptideStructureVariantId().hashCode());
		result = 37 * result
