...
/**
 * SpliceJunctionId generated by hbm2java
 */
public class SpliceJunctionId implements java.io.Serializable {

	private Integer spliceJunctionId;
	...
	public SpliceJunctionId() {
	}

	public SpliceJunctionId(Integer spliceJunctionId, Integer featureId,
		...
		this.spliceJunctionId = spliceJunctionId;
	...
	public Integer getSpliceJunctionId() {
		return this.spliceJunctionId;
	}

	public void setSpliceJunctionId(Integer spliceJunctionId) {
		this.spliceJunctionId = spliceJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceJunctionId))
			return false;
		SpliceJunctionId castOther = (SpliceJunctionId) other;

		return ((this.getSpliceJunctionId() == castOther.getSpliceJunctionId()) || (this
				.getSpliceJunctionId() != null
				&& castOther.getSpliceJunctionId() != null && this
				.getSpliceJunctionId().equals(castOther.getSpliceJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceJunctionId() == null ? 0 : this
						.getSpliceJunctionId().hashCode());
		result = 37 * result
