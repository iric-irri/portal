...
/**
 * TwoPrimeOMethylguanosineId generated by hbm2java
 */
public class TwoPrimeOMethylguanosineId implements java.io.Serializable {

	private Integer twoPrimeOMethylguanosineId;
	...
	public TwoPrimeOMethylguanosineId() {
	}

	public TwoPrimeOMethylguanosineId(Integer twoPrimeOMethylguanosineId,
		...
		this.twoPrimeOMethylguanosineId = twoPrimeOMethylguanosineId;
	...
	public Integer getTwoPrimeOMethylguanosineId() {
		return this.twoPrimeOMethylguanosineId;
	}

	public void setTwoPrimeOMethylguanosineId(Integer twoPrimeOMethylguanosineId) {
		this.twoPrimeOMethylguanosineId = twoPrimeOMethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethylguanosineId))
			return false;
		TwoPrimeOMethylguanosineId castOther = (TwoPrimeOMethylguanosineId) other;

		return ((this.getTwoPrimeOMethylguanosineId() == castOther
				.getTwoPrimeOMethylguanosineId()) || (this
				.getTwoPrimeOMethylguanosineId() != null
				&& castOther.getTwoPrimeOMethylguanosineId() != null && this
				.getTwoPrimeOMethylguanosineId().equals(
						castOther.getTwoPrimeOMethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethylguanosineId() == null ? 0 : this
						.getTwoPrimeOMethylguanosineId().hashCode());
		result = 37 * result
