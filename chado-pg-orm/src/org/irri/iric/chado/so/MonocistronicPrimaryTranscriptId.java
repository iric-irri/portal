...
/**
 * MonocistronicPrimaryTranscriptId generated by hbm2java
 */
public class MonocistronicPrimaryTranscriptId implements java.io.Serializable {

	private Integer monocistronicPrimaryTranscriptId;
	...
	public MonocistronicPrimaryTranscriptId() {
	}

	public MonocistronicPrimaryTranscriptId(
			Integer monocistronicPrimaryTranscriptId, Integer featureId,
		...
		this.monocistronicPrimaryTranscriptId = monocistronicPrimaryTranscriptId;
	...
	public Integer getMonocistronicPrimaryTranscriptId() {
		return this.monocistronicPrimaryTranscriptId;
	}

	public void setMonocistronicPrimaryTranscriptId(
			Integer monocistronicPrimaryTranscriptId) {
		this.monocistronicPrimaryTranscriptId = monocistronicPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MonocistronicPrimaryTranscriptId))
			return false;
		MonocistronicPrimaryTranscriptId castOther = (MonocistronicPrimaryTranscriptId) other;

		return ((this.getMonocistronicPrimaryTranscriptId() == castOther
				.getMonocistronicPrimaryTranscriptId()) || (this
				.getMonocistronicPrimaryTranscriptId() != null
				&& castOther.getMonocistronicPrimaryTranscriptId() != null && this
				.getMonocistronicPrimaryTranscriptId().equals(
						castOther.getMonocistronicPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMonocistronicPrimaryTranscriptId() == null ? 0 : this
						.getMonocistronicPrimaryTranscriptId().hashCode());
		result = 37 * result
