...
/**
 * CopyNumberLossId generated by hbm2java
 */
public class CopyNumberLossId implements java.io.Serializable {

	private Integer copyNumberLossId;
	...
	public CopyNumberLossId() {
	}

	public CopyNumberLossId(Integer copyNumberLossId, Integer featureId,
		...
		this.copyNumberLossId = copyNumberLossId;
	...
	public Integer getCopyNumberLossId() {
		return this.copyNumberLossId;
	}

	public void setCopyNumberLossId(Integer copyNumberLossId) {
		this.copyNumberLossId = copyNumberLossId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CopyNumberLossId))
			return false;
		CopyNumberLossId castOther = (CopyNumberLossId) other;

		return ((this.getCopyNumberLossId() == castOther.getCopyNumberLossId()) || (this
				.getCopyNumberLossId() != null
				&& castOther.getCopyNumberLossId() != null && this
				.getCopyNumberLossId().equals(castOther.getCopyNumberLossId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCopyNumberLossId() == null ? 0 : this
						.getCopyNumberLossId().hashCode());
		result = 37 * result
