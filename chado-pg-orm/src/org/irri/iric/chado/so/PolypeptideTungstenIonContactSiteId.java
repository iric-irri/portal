...
/**
 * PolypeptideTungstenIonContactSiteId generated by hbm2java
 */
public class PolypeptideTungstenIonContactSiteId implements
		java.io.Serializable {

	private Integer polypeptideTungstenIonContactSiteId;
	...
	public PolypeptideTungstenIonContactSiteId() {
	}

	public PolypeptideTungstenIonContactSiteId(
			Integer polypeptideTungstenIonContactSiteId, Integer featureId,
		...
		this.polypeptideTungstenIonContactSiteId = polypeptideTungstenIonContactSiteId;
	...
	public Integer getPolypeptideTungstenIonContactSiteId() {
		return this.polypeptideTungstenIonContactSiteId;
	}

	public void setPolypeptideTungstenIonContactSiteId(
			Integer polypeptideTungstenIonContactSiteId) {
		this.polypeptideTungstenIonContactSiteId = polypeptideTungstenIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideTungstenIonContactSiteId))
			return false;
		PolypeptideTungstenIonContactSiteId castOther = (PolypeptideTungstenIonContactSiteId) other;

		return ((this.getPolypeptideTungstenIonContactSiteId() == castOther
				.getPolypeptideTungstenIonContactSiteId()) || (this
				.getPolypeptideTungstenIonContactSiteId() != null
				&& castOther.getPolypeptideTungstenIonContactSiteId() != null && this
				.getPolypeptideTungstenIonContactSiteId().equals(
						castOther.getPolypeptideTungstenIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideTungstenIonContactSiteId() == null ? 0 : this
						.getPolypeptideTungstenIonContactSiteId().hashCode());
		result = 37 * result
