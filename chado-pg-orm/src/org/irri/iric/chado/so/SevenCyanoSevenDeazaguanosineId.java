...
/**
 * SevenCyanoSevenDeazaguanosineId generated by hbm2java
 */
public class SevenCyanoSevenDeazaguanosineId implements java.io.Serializable {

	private Integer sevenCyanoSevenDeazaguanosineId;
	...
	public SevenCyanoSevenDeazaguanosineId() {
	}

	public SevenCyanoSevenDeazaguanosineId(
			Integer sevenCyanoSevenDeazaguanosineId, Integer featureId,
		...
		this.sevenCyanoSevenDeazaguanosineId = sevenCyanoSevenDeazaguanosineId;
	...
	public Integer getSevenCyanoSevenDeazaguanosineId() {
		return this.sevenCyanoSevenDeazaguanosineId;
	}

	public void setSevenCyanoSevenDeazaguanosineId(
			Integer sevenCyanoSevenDeazaguanosineId) {
		this.sevenCyanoSevenDeazaguanosineId = sevenCyanoSevenDeazaguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SevenCyanoSevenDeazaguanosineId))
			return false;
		SevenCyanoSevenDeazaguanosineId castOther = (SevenCyanoSevenDeazaguanosineId) other;

		return ((this.getSevenCyanoSevenDeazaguanosineId() == castOther
				.getSevenCyanoSevenDeazaguanosineId()) || (this
				.getSevenCyanoSevenDeazaguanosineId() != null
				&& castOther.getSevenCyanoSevenDeazaguanosineId() != null && this
				.getSevenCyanoSevenDeazaguanosineId().equals(
						castOther.getSevenCyanoSevenDeazaguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSevenCyanoSevenDeazaguanosineId() == null ? 0 : this
						.getSevenCyanoSevenDeazaguanosineId().hashCode());
		result = 37 * result
