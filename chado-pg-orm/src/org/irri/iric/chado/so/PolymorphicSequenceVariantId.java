...
/**
 * PolymorphicSequenceVariantId generated by hbm2java
 */
public class PolymorphicSequenceVariantId implements java.io.Serializable {

	private Integer polymorphicSequenceVariantId;
	...
	public PolymorphicSequenceVariantId() {
	}

	public PolymorphicSequenceVariantId(Integer polymorphicSequenceVariantId,
		...
		this.polymorphicSequenceVariantId = polymorphicSequenceVariantId;
	...
	public Integer getPolymorphicSequenceVariantId() {
		return this.polymorphicSequenceVariantId;
	}

	public void setPolymorphicSequenceVariantId(
			Integer polymorphicSequenceVariantId) {
		this.polymorphicSequenceVariantId = polymorphicSequenceVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolymorphicSequenceVariantId))
			return false;
		PolymorphicSequenceVariantId castOther = (PolymorphicSequenceVariantId) other;

		return ((this.getPolymorphicSequenceVariantId() == castOther
				.getPolymorphicSequenceVariantId()) || (this
				.getPolymorphicSequenceVariantId() != null
				&& castOther.getPolymorphicSequenceVariantId() != null && this
				.getPolymorphicSequenceVariantId().equals(
						castOther.getPolymorphicSequenceVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolymorphicSequenceVariantId() == null ? 0 : this
						.getPolymorphicSequenceVariantId().hashCode());
		result = 37 * result
