...
/**
 * CloneInsertEndId generated by hbm2java
 */
public class CloneInsertEndId implements java.io.Serializable {

	private Integer cloneInsertEndId;
	...
	public CloneInsertEndId() {
	}

	public CloneInsertEndId(Integer cloneInsertEndId, Integer featureId,
		...
		this.cloneInsertEndId = cloneInsertEndId;
	...
	public Integer getCloneInsertEndId() {
		return this.cloneInsertEndId;
	}

	public void setCloneInsertEndId(Integer cloneInsertEndId) {
		this.cloneInsertEndId = cloneInsertEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CloneInsertEndId))
			return false;
		CloneInsertEndId castOther = (CloneInsertEndId) other;

		return ((this.getCloneInsertEndId() == castOther.getCloneInsertEndId()) || (this
				.getCloneInsertEndId() != null
				&& castOther.getCloneInsertEndId() != null && this
				.getCloneInsertEndId().equals(castOther.getCloneInsertEndId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCloneInsertEndId() == null ? 0 : this
						.getCloneInsertEndId().hashCode());
		result = 37 * result
