...
/**
 * SnornaGeneId generated by hbm2java
 */
public class SnornaGeneId implements java.io.Serializable {

	private Integer snornaGeneId;
	...
	public SnornaGeneId(Integer snornaGeneId, Integer featureId,
		...
		this.snornaGeneId = snornaGeneId;
	...
	public Integer getSnornaGeneId() {
		return this.snornaGeneId;
	}

	public void setSnornaGeneId(Integer snornaGeneId) {
		this.snornaGeneId = snornaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnornaGeneId))
			return false;
		SnornaGeneId castOther = (SnornaGeneId) other;

		return ((this.getSnornaGeneId() == castOther.getSnornaGeneId()) || (this
				.getSnornaGeneId() != null
				&& castOther.getSnornaGeneId() != null && this
				.getSnornaGeneId().equals(castOther.getSnornaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnornaGeneId() == null ? 0 : this.getSnornaGeneId()
						.hashCode());
		result = 37 * result
