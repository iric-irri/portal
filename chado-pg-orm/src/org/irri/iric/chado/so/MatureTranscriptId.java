...
/**
 * MatureTranscriptId generated by hbm2java
 */
public class MatureTranscriptId implements java.io.Serializable {

	private Integer matureTranscriptId;
	...
	public MatureTranscriptId() {
	}

	public MatureTranscriptId(Integer matureTranscriptId, Integer featureId,
		...
		this.matureTranscriptId = matureTranscriptId;
	...
	public Integer getMatureTranscriptId() {
		return this.matureTranscriptId;
	}

	public void setMatureTranscriptId(Integer matureTranscriptId) {
		this.matureTranscriptId = matureTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatureTranscriptId))
			return false;
		MatureTranscriptId castOther = (MatureTranscriptId) other;

		return ((this.getMatureTranscriptId() == castOther
				.getMatureTranscriptId()) || (this.getMatureTranscriptId() != null
				&& castOther.getMatureTranscriptId() != null && this
				.getMatureTranscriptId().equals(
						castOther.getMatureTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatureTranscriptId() == null ? 0 : this
						.getMatureTranscriptId().hashCode());
		result = 37 * result
