...
/**
 * RLtrRegionId generated by hbm2java
 */
public class RLtrRegionId implements java.io.Serializable {

	private Integer RLtrRegionId;
	...
	public RLtrRegionId(Integer RLtrRegionId, Integer featureId,
		...
		this.RLtrRegionId = RLtrRegionId;
	...
	public Integer getRLtrRegionId() {
		return this.RLtrRegionId;
	}

	public void setRLtrRegionId(Integer RLtrRegionId) {
		this.RLtrRegionId = RLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RLtrRegionId))
			return false;
		RLtrRegionId castOther = (RLtrRegionId) other;

		return ((this.getRLtrRegionId() == castOther.getRLtrRegionId()) || (this
				.getRLtrRegionId() != null
				&& castOther.getRLtrRegionId() != null && this
				.getRLtrRegionId().equals(castOther.getRLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRLtrRegionId() == null ? 0 : this.getRLtrRegionId()
						.hashCode());
		result = 37 * result
