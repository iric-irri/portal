...
/**
 * Sl4AcceptorSiteId generated by hbm2java
 */
public class Sl4AcceptorSiteId implements java.io.Serializable {

	private Integer sl4AcceptorSiteId;
	...
	public Sl4AcceptorSiteId() {
	}

	public Sl4AcceptorSiteId(Integer sl4AcceptorSiteId, Integer featureId,
		...
		this.sl4AcceptorSiteId = sl4AcceptorSiteId;
	...
	public Integer getSl4AcceptorSiteId() {
		return this.sl4AcceptorSiteId;
	}

	public void setSl4AcceptorSiteId(Integer sl4AcceptorSiteId) {
		this.sl4AcceptorSiteId = sl4AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl4AcceptorSiteId))
			return false;
		Sl4AcceptorSiteId castOther = (Sl4AcceptorSiteId) other;

		return ((this.getSl4AcceptorSiteId() == castOther
				.getSl4AcceptorSiteId()) || (this.getSl4AcceptorSiteId() != null
				&& castOther.getSl4AcceptorSiteId() != null && this
				.getSl4AcceptorSiteId()
				.equals(castOther.getSl4AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl4AcceptorSiteId() == null ? 0 : this
						.getSl4AcceptorSiteId().hashCode());
		result = 37 * result
