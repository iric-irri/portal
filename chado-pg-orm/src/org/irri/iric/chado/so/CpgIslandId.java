...
/**
 * CpgIslandId generated by hbm2java
 */
public class CpgIslandId implements java.io.Serializable {

	private Integer cpgIslandId;
	...
	public CpgIslandId(Integer cpgIslandId, Integer featureId,
	...
	public Integer getCpgIslandId() {
		return this.cpgIslandId;
	}

	public void setCpgIslandId(Integer cpgIslandId) {
		this.cpgIslandId = cpgIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CpgIslandId))
			return false;
		CpgIslandId castOther = (CpgIslandId) other;

		return ((this.getCpgIslandId() == castOther.getCpgIslandId()) || (this
				.getCpgIslandId() != null && castOther.getCpgIslandId() != null && this
				.getCpgIslandId().equals(castOther.getCpgIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCpgIslandId() == null ? 0 : this.getCpgIslandId()
						.hashCode());
		result = 37 * result
