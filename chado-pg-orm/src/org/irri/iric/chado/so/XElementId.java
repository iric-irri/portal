...
/**
 * XElementId generated by hbm2java
 */
public class XElementId implements java.io.Serializable {

	private Integer XElementId;
	...
	public XElementId(Integer XElementId, Integer featureId, Integer dbxrefId,
	...
	public Integer getXElementId() {
		return this.XElementId;
	}

	public void setXElementId(Integer XElementId) {
		this.XElementId = XElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof XElementId))
			return false;
		XElementId castOther = (XElementId) other;

		return ((this.getXElementId() == castOther.getXElementId()) || (this
				.getXElementId() != null && castOther.getXElementId() != null && this
				.getXElementId().equals(castOther.getXElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getXElementId() == null ? 0 : this.getXElementId()
						.hashCode());
		result = 37 * result
