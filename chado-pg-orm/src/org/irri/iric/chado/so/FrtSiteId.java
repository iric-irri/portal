...
/**
 * FrtSiteId generated by hbm2java
 */
public class FrtSiteId implements java.io.Serializable {

	private Integer frtSiteId;
	...
	public FrtSiteId(Integer frtSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getFrtSiteId() {
		return this.frtSiteId;
	}

	public void setFrtSiteId(Integer frtSiteId) {
		this.frtSiteId = frtSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FrtSiteId))
			return false;
		FrtSiteId castOther = (FrtSiteId) other;

		return ((this.getFrtSiteId() == castOther.getFrtSiteId()) || (this
				.getFrtSiteId() != null && castOther.getFrtSiteId() != null && this
				.getFrtSiteId().equals(castOther.getFrtSiteId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getFrtSiteId() == null ? 0 : this.getFrtSiteId().hashCode());
		result = 37 * result
