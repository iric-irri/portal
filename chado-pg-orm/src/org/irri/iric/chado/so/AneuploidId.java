...
/**
 * AneuploidId generated by hbm2java
 */
public class AneuploidId implements java.io.Serializable {

	private Integer aneuploidId;
	...
	public AneuploidId(Integer aneuploidId, Integer featureId,
	...
	public Integer getAneuploidId() {
		return this.aneuploidId;
	}

	public void setAneuploidId(Integer aneuploidId) {
		this.aneuploidId = aneuploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AneuploidId))
			return false;
		AneuploidId castOther = (AneuploidId) other;

		return ((this.getAneuploidId() == castOther.getAneuploidId()) || (this
				.getAneuploidId() != null && castOther.getAneuploidId() != null && this
				.getAneuploidId().equals(castOther.getAneuploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAneuploidId() == null ? 0 : this.getAneuploidId()
						.hashCode());
		result = 37 * result
