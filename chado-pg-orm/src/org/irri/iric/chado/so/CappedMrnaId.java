...
/**
 * CappedMrnaId generated by hbm2java
 */
public class CappedMrnaId implements java.io.Serializable {

	private Integer cappedMrnaId;
	...
	public CappedMrnaId(Integer cappedMrnaId, Integer featureId,
		...
		this.cappedMrnaId = cappedMrnaId;
	...
	public Integer getCappedMrnaId() {
		return this.cappedMrnaId;
	}

	public void setCappedMrnaId(Integer cappedMrnaId) {
		this.cappedMrnaId = cappedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CappedMrnaId))
			return false;
		CappedMrnaId castOther = (CappedMrnaId) other;

		return ((this.getCappedMrnaId() == castOther.getCappedMrnaId()) || (this
				.getCappedMrnaId() != null
				&& castOther.getCappedMrnaId() != null && this
				.getCappedMrnaId().equals(castOther.getCappedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCappedMrnaId() == null ? 0 : this.getCappedMrnaId()
						.hashCode());
		result = 37 * result
