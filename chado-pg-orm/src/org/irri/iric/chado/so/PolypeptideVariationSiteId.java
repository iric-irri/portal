...
/**
 * PolypeptideVariationSiteId generated by hbm2java
 */
public class PolypeptideVariationSiteId implements java.io.Serializable {

	private Integer polypeptideVariationSiteId;
	...
	public PolypeptideVariationSiteId() {
	}

	public PolypeptideVariationSiteId(Integer polypeptideVariationSiteId,
		...
		this.polypeptideVariationSiteId = polypeptideVariationSiteId;
	...
	public Integer getPolypeptideVariationSiteId() {
		return this.polypeptideVariationSiteId;
	}

	public void setPolypeptideVariationSiteId(Integer polypeptideVariationSiteId) {
		this.polypeptideVariationSiteId = polypeptideVariationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideVariationSiteId))
			return false;
		PolypeptideVariationSiteId castOther = (PolypeptideVariationSiteId) other;

		return ((this.getPolypeptideVariationSiteId() == castOther
				.getPolypeptideVariationSiteId()) || (this
				.getPolypeptideVariationSiteId() != null
				&& castOther.getPolypeptideVariationSiteId() != null && this
				.getPolypeptideVariationSiteId().equals(
						castOther.getPolypeptideVariationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideVariationSiteId() == null ? 0 : this
						.getPolypeptideVariationSiteId().hashCode());
		result = 37 * result
