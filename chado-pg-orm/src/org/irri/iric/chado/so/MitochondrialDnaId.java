...
/**
 * MitochondrialDnaId generated by hbm2java
 */
public class MitochondrialDnaId implements java.io.Serializable {

	private Integer mitochondrialDnaId;
	...
	public MitochondrialDnaId() {
	}

	public MitochondrialDnaId(Integer mitochondrialDnaId, Integer featureId,
		...
		this.mitochondrialDnaId = mitochondrialDnaId;
	...
	public Integer getMitochondrialDnaId() {
		return this.mitochondrialDnaId;
	}

	public void setMitochondrialDnaId(Integer mitochondrialDnaId) {
		this.mitochondrialDnaId = mitochondrialDnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MitochondrialDnaId))
			return false;
		MitochondrialDnaId castOther = (MitochondrialDnaId) other;

		return ((this.getMitochondrialDnaId() == castOther
				.getMitochondrialDnaId()) || (this.getMitochondrialDnaId() != null
				&& castOther.getMitochondrialDnaId() != null && this
				.getMitochondrialDnaId().equals(
						castOther.getMitochondrialDnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMitochondrialDnaId() == null ? 0 : this
						.getMitochondrialDnaId().hashCode());
		result = 37 * result
