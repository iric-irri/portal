...
/**
 * VariantFrequencyId generated by hbm2java
 */
public class VariantFrequencyId implements java.io.Serializable {

	private Integer variantFrequencyId;
	...
	public VariantFrequencyId() {
	}

	public VariantFrequencyId(Integer variantFrequencyId, Integer featureId,
		...
		this.variantFrequencyId = variantFrequencyId;
	...
	public Integer getVariantFrequencyId() {
		return this.variantFrequencyId;
	}

	public void setVariantFrequencyId(Integer variantFrequencyId) {
		this.variantFrequencyId = variantFrequencyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantFrequencyId))
			return false;
		VariantFrequencyId castOther = (VariantFrequencyId) other;

		return ((this.getVariantFrequencyId() == castOther
				.getVariantFrequencyId()) || (this.getVariantFrequencyId() != null
				&& castOther.getVariantFrequencyId() != null && this
				.getVariantFrequencyId().equals(
						castOther.getVariantFrequencyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantFrequencyId() == null ? 0 : this
						.getVariantFrequencyId().hashCode());
		result = 37 * result
