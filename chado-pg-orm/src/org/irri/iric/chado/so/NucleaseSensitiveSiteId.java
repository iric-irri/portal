...
/**
 * NucleaseSensitiveSiteId generated by hbm2java
 */
public class NucleaseSensitiveSiteId implements java.io.Serializable {

	private Integer nucleaseSensitiveSiteId;
	...
	public NucleaseSensitiveSiteId() {
	}

	public NucleaseSensitiveSiteId(Integer nucleaseSensitiveSiteId,
		...
		this.nucleaseSensitiveSiteId = nucleaseSensitiveSiteId;
	...
	public Integer getNucleaseSensitiveSiteId() {
		return this.nucleaseSensitiveSiteId;
	}

	public void setNucleaseSensitiveSiteId(Integer nucleaseSensitiveSiteId) {
		this.nucleaseSensitiveSiteId = nucleaseSensitiveSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleaseSensitiveSiteId))
			return false;
		NucleaseSensitiveSiteId castOther = (NucleaseSensitiveSiteId) other;

		return ((this.getNucleaseSensitiveSiteId() == castOther
				.getNucleaseSensitiveSiteId()) || (this
				.getNucleaseSensitiveSiteId() != null
				&& castOther.getNucleaseSensitiveSiteId() != null && this
				.getNucleaseSensitiveSiteId().equals(
						castOther.getNucleaseSensitiveSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleaseSensitiveSiteId() == null ? 0 : this
						.getNucleaseSensitiveSiteId().hashCode());
		result = 37 * result
