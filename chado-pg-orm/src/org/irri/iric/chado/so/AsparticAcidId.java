...
/**
 * AsparticAcidId generated by hbm2java
 */
public class AsparticAcidId implements java.io.Serializable {

	private Integer asparticAcidId;
	...
	public AsparticAcidId() {
	}

	public AsparticAcidId(Integer asparticAcidId, Integer featureId,
		...
		this.asparticAcidId = asparticAcidId;
	...
	public Integer getAsparticAcidId() {
		return this.asparticAcidId;
	}

	public void setAsparticAcidId(Integer asparticAcidId) {
		this.asparticAcidId = asparticAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsparticAcidId))
			return false;
		AsparticAcidId castOther = (AsparticAcidId) other;

		return ((this.getAsparticAcidId() == castOther.getAsparticAcidId()) || (this
				.getAsparticAcidId() != null
				&& castOther.getAsparticAcidId() != null && this
				.getAsparticAcidId().equals(castOther.getAsparticAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsparticAcidId() == null ? 0 : this.getAsparticAcidId()
						.hashCode());
		result = 37 * result
