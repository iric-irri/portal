...
/**
 * AsxTurnRightHandedTypeTwoId generated by hbm2java
 */
public class AsxTurnRightHandedTypeTwoId implements java.io.Serializable {

	private Integer asxTurnRightHandedTypeTwoId;
	...
	public AsxTurnRightHandedTypeTwoId() {
	}

	public AsxTurnRightHandedTypeTwoId(Integer asxTurnRightHandedTypeTwoId,
		...
		this.asxTurnRightHandedTypeTwoId = asxTurnRightHandedTypeTwoId;
	...
	public Integer getAsxTurnRightHandedTypeTwoId() {
		return this.asxTurnRightHandedTypeTwoId;
	}

	public void setAsxTurnRightHandedTypeTwoId(
			Integer asxTurnRightHandedTypeTwoId) {
		this.asxTurnRightHandedTypeTwoId = asxTurnRightHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxTurnRightHandedTypeTwoId))
			return false;
		AsxTurnRightHandedTypeTwoId castOther = (AsxTurnRightHandedTypeTwoId) other;

		return ((this.getAsxTurnRightHandedTypeTwoId() == castOther
				.getAsxTurnRightHandedTypeTwoId()) || (this
				.getAsxTurnRightHandedTypeTwoId() != null
				&& castOther.getAsxTurnRightHandedTypeTwoId() != null && this
				.getAsxTurnRightHandedTypeTwoId().equals(
						castOther.getAsxTurnRightHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsxTurnRightHandedTypeTwoId() == null ? 0 : this
						.getAsxTurnRightHandedTypeTwoId().hashCode());
		result = 37 * result
