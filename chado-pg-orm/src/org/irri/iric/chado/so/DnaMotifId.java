...
/**
 * DnaMotifId generated by hbm2java
 */
public class DnaMotifId implements java.io.Serializable {

	private Integer dnaMotifId;
	...
	public DnaMotifId(Integer dnaMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDnaMotifId() {
		return this.dnaMotifId;
	}

	public void setDnaMotifId(Integer dnaMotifId) {
		this.dnaMotifId = dnaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaMotifId))
			return false;
		DnaMotifId castOther = (DnaMotifId) other;

		return ((this.getDnaMotifId() == castOther.getDnaMotifId()) || (this
				.getDnaMotifId() != null && castOther.getDnaMotifId() != null && this
				.getDnaMotifId().equals(castOther.getDnaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaMotifId() == null ? 0 : this.getDnaMotifId()
						.hashCode());
		result = 37 * result
