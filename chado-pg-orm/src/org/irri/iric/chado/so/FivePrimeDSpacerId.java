...
/**
 * FivePrimeDSpacerId generated by hbm2java
 */
public class FivePrimeDSpacerId implements java.io.Serializable {

	private Integer fivePrimeDSpacerId;
	...
	public FivePrimeDSpacerId() {
	}

	public FivePrimeDSpacerId(Integer fivePrimeDSpacerId, Integer featureId,
		...
		this.fivePrimeDSpacerId = fivePrimeDSpacerId;
	...
	public Integer getFivePrimeDSpacerId() {
		return this.fivePrimeDSpacerId;
	}

	public void setFivePrimeDSpacerId(Integer fivePrimeDSpacerId) {
		this.fivePrimeDSpacerId = fivePrimeDSpacerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeDSpacerId))
			return false;
		FivePrimeDSpacerId castOther = (FivePrimeDSpacerId) other;

		return ((this.getFivePrimeDSpacerId() == castOther
				.getFivePrimeDSpacerId()) || (this.getFivePrimeDSpacerId() != null
				&& castOther.getFivePrimeDSpacerId() != null && this
				.getFivePrimeDSpacerId().equals(
						castOther.getFivePrimeDSpacerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeDSpacerId() == null ? 0 : this
						.getFivePrimeDSpacerId().hashCode());
		result = 37 * result
