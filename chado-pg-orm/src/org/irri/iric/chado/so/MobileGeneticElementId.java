...
/**
 * MobileGeneticElementId generated by hbm2java
 */
public class MobileGeneticElementId implements java.io.Serializable {

	private Integer mobileGeneticElementId;
	...
	public MobileGeneticElementId() {
	}

	public MobileGeneticElementId(Integer mobileGeneticElementId,
		...
		this.mobileGeneticElementId = mobileGeneticElementId;
	...
	public Integer getMobileGeneticElementId() {
		return this.mobileGeneticElementId;
	}

	public void setMobileGeneticElementId(Integer mobileGeneticElementId) {
		this.mobileGeneticElementId = mobileGeneticElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MobileGeneticElementId))
			return false;
		MobileGeneticElementId castOther = (MobileGeneticElementId) other;

		return ((this.getMobileGeneticElementId() == castOther
				.getMobileGeneticElementId()) || (this
				.getMobileGeneticElementId() != null
				&& castOther.getMobileGeneticElementId() != null && this
				.getMobileGeneticElementId().equals(
						castOther.getMobileGeneticElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMobileGeneticElementId() == null ? 0 : this
						.getMobileGeneticElementId().hashCode());
		result = 37 * result
