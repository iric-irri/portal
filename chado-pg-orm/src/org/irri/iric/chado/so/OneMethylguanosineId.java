...
/**
 * OneMethylguanosineId generated by hbm2java
 */
public class OneMethylguanosineId implements java.io.Serializable {

	private Integer oneMethylguanosineId;
	...
	public OneMethylguanosineId() {
	}

	public OneMethylguanosineId(Integer oneMethylguanosineId,
		...
		this.oneMethylguanosineId = oneMethylguanosineId;
	...
	public Integer getOneMethylguanosineId() {
		return this.oneMethylguanosineId;
	}

	public void setOneMethylguanosineId(Integer oneMethylguanosineId) {
		this.oneMethylguanosineId = oneMethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneMethylguanosineId))
			return false;
		OneMethylguanosineId castOther = (OneMethylguanosineId) other;

		return ((this.getOneMethylguanosineId() == castOther
				.getOneMethylguanosineId()) || (this.getOneMethylguanosineId() != null
				&& castOther.getOneMethylguanosineId() != null && this
				.getOneMethylguanosineId().equals(
						castOther.getOneMethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneMethylguanosineId() == null ? 0 : this
						.getOneMethylguanosineId().hashCode());
		result = 37 * result
