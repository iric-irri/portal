...
/**
 * RecombinationallyRearrangedVertebrateImmuneSystemGeneId generated by hbm2java
 */
public class RecombinationallyRearrangedVertebrateImmuneSystemGeneId implements
		java.io.Serializable {

	private Integer recombinationallyRearrangedVertebrateImmuneSystemGeneId;
	...
	public RecombinationallyRearrangedVertebrateImmuneSystemGeneId() {
	}

	public RecombinationallyRearrangedVertebrateImmuneSystemGeneId(
			Integer recombinationallyRearrangedVertebrateImmuneSystemGeneId,
		...
		this.recombinationallyRearrangedVertebrateImmuneSystemGeneId = recombinationallyRearrangedVertebrateImmuneSystemGeneId;
	...
	public Integer getRecombinationallyRearrangedVertebrateImmuneSystemGeneId() {
		return this.recombinationallyRearrangedVertebrateImmuneSystemGeneId;
	}

	public void setRecombinationallyRearrangedVertebrateImmuneSystemGeneId(
			Integer recombinationallyRearrangedVertebrateImmuneSystemGeneId) {
		this.recombinationallyRearrangedVertebrateImmuneSystemGeneId = recombinationallyRearrangedVertebrateImmuneSystemGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationallyRearrangedVertebrateImmuneSystemGeneId))
			return false;
		RecombinationallyRearrangedVertebrateImmuneSystemGeneId castOther = (RecombinationallyRearrangedVertebrateImmuneSystemGeneId) other;

		return ((this
				.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId() == castOther
				.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId()) || (this
				.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId() != null
				&& castOther
						.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId() != null && this
				.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId()
				.equals(castOther
						.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationallyRearrangedVertebrateImmuneSystemGeneId() == null ? 0
						: this.getRecombinationallyRearrangedVertebrateImmuneSystemGeneId()
								.hashCode());
		result = 37 * result
