...
/**
 * PacEndId generated by hbm2java
 */
public class PacEndId implements java.io.Serializable {

	private Integer pacEndId;
	...
	public PacEndId(Integer pacEndId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPacEndId() {
		return this.pacEndId;
	}

	public void setPacEndId(Integer pacEndId) {
		this.pacEndId = pacEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PacEndId))
			return false;
		PacEndId castOther = (PacEndId) other;

		return ((this.getPacEndId() == castOther.getPacEndId()) || (this
				.getPacEndId() != null && castOther.getPacEndId() != null && this
				.getPacEndId().equals(castOther.getPacEndId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPacEndId() == null ? 0 : this.getPacEndId().hashCode());
		result = 37 * result
