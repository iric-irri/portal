...
/**
 * Minus1TranslationallyFrameshiftedId generated by hbm2java
 */
public class Minus1TranslationallyFrameshiftedId implements
		java.io.Serializable {

	private Integer minus1TranslationallyFrameshiftedId;
	...
	public Minus1TranslationallyFrameshiftedId() {
	}

	public Minus1TranslationallyFrameshiftedId(
			Integer minus1TranslationallyFrameshiftedId, Integer featureId,
		...
		this.minus1TranslationallyFrameshiftedId = minus1TranslationallyFrameshiftedId;
	...
	public Integer getMinus1TranslationallyFrameshiftedId() {
		return this.minus1TranslationallyFrameshiftedId;
	}

	public void setMinus1TranslationallyFrameshiftedId(
			Integer minus1TranslationallyFrameshiftedId) {
		this.minus1TranslationallyFrameshiftedId = minus1TranslationallyFrameshiftedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus1TranslationallyFrameshiftedId))
			return false;
		Minus1TranslationallyFrameshiftedId castOther = (Minus1TranslationallyFrameshiftedId) other;

		return ((this.getMinus1TranslationallyFrameshiftedId() == castOther
				.getMinus1TranslationallyFrameshiftedId()) || (this
				.getMinus1TranslationallyFrameshiftedId() != null
				&& castOther.getMinus1TranslationallyFrameshiftedId() != null && this
				.getMinus1TranslationallyFrameshiftedId().equals(
						castOther.getMinus1TranslationallyFrameshiftedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus1TranslationallyFrameshiftedId() == null ? 0 : this
						.getMinus1TranslationallyFrameshiftedId().hashCode());
		result = 37 * result
