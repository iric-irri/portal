...
/**
 * SilencedByHistoneModificationId generated by hbm2java
 */
public class SilencedByHistoneModificationId implements java.io.Serializable {

	private Integer silencedByHistoneModificationId;
	...
	public SilencedByHistoneModificationId() {
	}

	public SilencedByHistoneModificationId(
			Integer silencedByHistoneModificationId, Integer featureId,
		...
		this.silencedByHistoneModificationId = silencedByHistoneModificationId;
	...
	public Integer getSilencedByHistoneModificationId() {
		return this.silencedByHistoneModificationId;
	}

	public void setSilencedByHistoneModificationId(
			Integer silencedByHistoneModificationId) {
		this.silencedByHistoneModificationId = silencedByHistoneModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByHistoneModificationId))
			return false;
		SilencedByHistoneModificationId castOther = (SilencedByHistoneModificationId) other;

		return ((this.getSilencedByHistoneModificationId() == castOther
				.getSilencedByHistoneModificationId()) || (this
				.getSilencedByHistoneModificationId() != null
				&& castOther.getSilencedByHistoneModificationId() != null && this
				.getSilencedByHistoneModificationId().equals(
						castOther.getSilencedByHistoneModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByHistoneModificationId() == null ? 0 : this
						.getSilencedByHistoneModificationId().hashCode());
		result = 37 * result
