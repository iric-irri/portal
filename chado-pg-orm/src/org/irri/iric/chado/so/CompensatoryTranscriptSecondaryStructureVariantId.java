...
/**
 * CompensatoryTranscriptSecondaryStructureVariantId generated by hbm2java
 */
public class CompensatoryTranscriptSecondaryStructureVariantId implements
		java.io.Serializable {

	private Integer compensatoryTranscriptSecondaryStructureVariantId;
	...
	public CompensatoryTranscriptSecondaryStructureVariantId() {
	}

	public CompensatoryTranscriptSecondaryStructureVariantId(
			Integer compensatoryTranscriptSecondaryStructureVariantId,
		...
		this.compensatoryTranscriptSecondaryStructureVariantId = compensatoryTranscriptSecondaryStructureVariantId;
	...
	public Integer getCompensatoryTranscriptSecondaryStructureVariantId() {
		return this.compensatoryTranscriptSecondaryStructureVariantId;
	}

	public void setCompensatoryTranscriptSecondaryStructureVariantId(
			Integer compensatoryTranscriptSecondaryStructureVariantId) {
		this.compensatoryTranscriptSecondaryStructureVariantId = compensatoryTranscriptSecondaryStructureVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CompensatoryTranscriptSecondaryStructureVariantId))
			return false;
		CompensatoryTranscriptSecondaryStructureVariantId castOther = (CompensatoryTranscriptSecondaryStructureVariantId) other;

		return ((this.getCompensatoryTranscriptSecondaryStructureVariantId() == castOther
				.getCompensatoryTranscriptSecondaryStructureVariantId()) || (this
				.getCompensatoryTranscriptSecondaryStructureVariantId() != null
				&& castOther
						.getCompensatoryTranscriptSecondaryStructureVariantId() != null && this
				.getCompensatoryTranscriptSecondaryStructureVariantId()
				.equals(castOther
						.getCompensatoryTranscriptSecondaryStructureVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCompensatoryTranscriptSecondaryStructureVariantId() == null ? 0
						: this.getCompensatoryTranscriptSecondaryStructureVariantId()
								.hashCode());
		result = 37 * result
