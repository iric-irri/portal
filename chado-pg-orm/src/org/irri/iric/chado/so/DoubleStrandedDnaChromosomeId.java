...
/**
 * DoubleStrandedDnaChromosomeId generated by hbm2java
 */
public class DoubleStrandedDnaChromosomeId implements java.io.Serializable {

	private Integer doubleStrandedDnaChromosomeId;
	...
	public DoubleStrandedDnaChromosomeId() {
	}

	public DoubleStrandedDnaChromosomeId(Integer doubleStrandedDnaChromosomeId,
		...
		this.doubleStrandedDnaChromosomeId = doubleStrandedDnaChromosomeId;
	...
	public Integer getDoubleStrandedDnaChromosomeId() {
		return this.doubleStrandedDnaChromosomeId;
	}

	public void setDoubleStrandedDnaChromosomeId(
			Integer doubleStrandedDnaChromosomeId) {
		this.doubleStrandedDnaChromosomeId = doubleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DoubleStrandedDnaChromosomeId))
			return false;
		DoubleStrandedDnaChromosomeId castOther = (DoubleStrandedDnaChromosomeId) other;

		return ((this.getDoubleStrandedDnaChromosomeId() == castOther
				.getDoubleStrandedDnaChromosomeId()) || (this
				.getDoubleStrandedDnaChromosomeId() != null
				&& castOther.getDoubleStrandedDnaChromosomeId() != null && this
				.getDoubleStrandedDnaChromosomeId().equals(
						castOther.getDoubleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDoubleStrandedDnaChromosomeId() == null ? 0 : this
						.getDoubleStrandedDnaChromosomeId().hashCode());
		result = 37 * result
