...
/**
 * SingleStrandedDnaChromosomeId generated by hbm2java
 */
public class SingleStrandedDnaChromosomeId implements java.io.Serializable {

	private Integer singleStrandedDnaChromosomeId;
	...
	public SingleStrandedDnaChromosomeId() {
	}

	public SingleStrandedDnaChromosomeId(Integer singleStrandedDnaChromosomeId,
		...
		this.singleStrandedDnaChromosomeId = singleStrandedDnaChromosomeId;
	...
	public Integer getSingleStrandedDnaChromosomeId() {
		return this.singleStrandedDnaChromosomeId;
	}

	public void setSingleStrandedDnaChromosomeId(
			Integer singleStrandedDnaChromosomeId) {
		this.singleStrandedDnaChromosomeId = singleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SingleStrandedDnaChromosomeId))
			return false;
		SingleStrandedDnaChromosomeId castOther = (SingleStrandedDnaChromosomeId) other;

		return ((this.getSingleStrandedDnaChromosomeId() == castOther
				.getSingleStrandedDnaChromosomeId()) || (this
				.getSingleStrandedDnaChromosomeId() != null
				&& castOther.getSingleStrandedDnaChromosomeId() != null && this
				.getSingleStrandedDnaChromosomeId().equals(
						castOther.getSingleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSingleStrandedDnaChromosomeId() == null ? 0 : this
						.getSingleStrandedDnaChromosomeId().hashCode());
		result = 37 * result
