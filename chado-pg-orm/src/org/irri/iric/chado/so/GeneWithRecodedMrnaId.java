...
/**
 * GeneWithRecodedMrnaId generated by hbm2java
 */
public class GeneWithRecodedMrnaId implements java.io.Serializable {

	private Integer geneWithRecodedMrnaId;
	...
	public GeneWithRecodedMrnaId() {
	}

	public GeneWithRecodedMrnaId(Integer geneWithRecodedMrnaId,
		...
		this.geneWithRecodedMrnaId = geneWithRecodedMrnaId;
	...
	public Integer getGeneWithRecodedMrnaId() {
		return this.geneWithRecodedMrnaId;
	}

	public void setGeneWithRecodedMrnaId(Integer geneWithRecodedMrnaId) {
		this.geneWithRecodedMrnaId = geneWithRecodedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithRecodedMrnaId))
			return false;
		GeneWithRecodedMrnaId castOther = (GeneWithRecodedMrnaId) other;

		return ((this.getGeneWithRecodedMrnaId() == castOther
				.getGeneWithRecodedMrnaId()) || (this
				.getGeneWithRecodedMrnaId() != null
				&& castOther.getGeneWithRecodedMrnaId() != null && this
				.getGeneWithRecodedMrnaId().equals(
						castOther.getGeneWithRecodedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithRecodedMrnaId() == null ? 0 : this
						.getGeneWithRecodedMrnaId().hashCode());
		result = 37 * result
