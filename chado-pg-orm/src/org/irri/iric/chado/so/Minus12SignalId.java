...
/**
 * Minus12SignalId generated by hbm2java
 */
public class Minus12SignalId implements java.io.Serializable {

	private Integer minus12SignalId;
	...
	public Minus12SignalId() {
	}

	public Minus12SignalId(Integer minus12SignalId, Integer featureId,
		...
		this.minus12SignalId = minus12SignalId;
	...
	public Integer getMinus12SignalId() {
		return this.minus12SignalId;
	}

	public void setMinus12SignalId(Integer minus12SignalId) {
		this.minus12SignalId = minus12SignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus12SignalId))
			return false;
		Minus12SignalId castOther = (Minus12SignalId) other;

		return ((this.getMinus12SignalId() == castOther.getMinus12SignalId()) || (this
				.getMinus12SignalId() != null
				&& castOther.getMinus12SignalId() != null && this
				.getMinus12SignalId().equals(castOther.getMinus12SignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus12SignalId() == null ? 0 : this.getMinus12SignalId()
						.hashCode());
		result = 37 * result
