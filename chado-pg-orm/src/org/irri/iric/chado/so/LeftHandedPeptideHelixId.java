...
/**
 * LeftHandedPeptideHelixId generated by hbm2java
 */
public class LeftHandedPeptideHelixId implements java.io.Serializable {

	private Integer leftHandedPeptideHelixId;
	...
	public LeftHandedPeptideHelixId() {
	}

	public LeftHandedPeptideHelixId(Integer leftHandedPeptideHelixId,
		...
		this.leftHandedPeptideHelixId = leftHandedPeptideHelixId;
	...
	public Integer getLeftHandedPeptideHelixId() {
		return this.leftHandedPeptideHelixId;
	}

	public void setLeftHandedPeptideHelixId(Integer leftHandedPeptideHelixId) {
		this.leftHandedPeptideHelixId = leftHandedPeptideHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeftHandedPeptideHelixId))
			return false;
		LeftHandedPeptideHelixId castOther = (LeftHandedPeptideHelixId) other;

		return ((this.getLeftHandedPeptideHelixId() == castOther
				.getLeftHandedPeptideHelixId()) || (this
				.getLeftHandedPeptideHelixId() != null
				&& castOther.getLeftHandedPeptideHelixId() != null && this
				.getLeftHandedPeptideHelixId().equals(
						castOther.getLeftHandedPeptideHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeftHandedPeptideHelixId() == null ? 0 : this
						.getLeftHandedPeptideHelixId().hashCode());
		result = 37 * result
