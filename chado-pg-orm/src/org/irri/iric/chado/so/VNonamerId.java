...
/**
 * VNonamerId generated by hbm2java
 */
public class VNonamerId implements java.io.Serializable {

	private Integer VNonamerId;
	...
	public VNonamerId(Integer VNonamerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVNonamerId() {
		return this.VNonamerId;
	}

	public void setVNonamerId(Integer VNonamerId) {
		this.VNonamerId = VNonamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VNonamerId))
			return false;
		VNonamerId castOther = (VNonamerId) other;

		return ((this.getVNonamerId() == castOther.getVNonamerId()) || (this
				.getVNonamerId() != null && castOther.getVNonamerId() != null && this
				.getVNonamerId().equals(castOther.getVNonamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVNonamerId() == null ? 0 : this.getVNonamerId()
						.hashCode());
		result = 37 * result
