...
/**
 * MinorTssId generated by hbm2java
 */
public class MinorTssId implements java.io.Serializable {

	private Integer minorTssId;
	...
	public MinorTssId(Integer minorTssId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMinorTssId() {
		return this.minorTssId;
	}

	public void setMinorTssId(Integer minorTssId) {
		this.minorTssId = minorTssId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MinorTssId))
			return false;
		MinorTssId castOther = (MinorTssId) other;

		return ((this.getMinorTssId() == castOther.getMinorTssId()) || (this
				.getMinorTssId() != null && castOther.getMinorTssId() != null && this
				.getMinorTssId().equals(castOther.getMinorTssId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinorTssId() == null ? 0 : this.getMinorTssId()
						.hashCode());
		result = 37 * result
