...
/**
 * RestrictionEnzymeBindingSiteId generated by hbm2java
 */
public class RestrictionEnzymeBindingSiteId implements java.io.Serializable {

	private Integer restrictionEnzymeBindingSiteId;
	...
	public RestrictionEnzymeBindingSiteId() {
	}

	public RestrictionEnzymeBindingSiteId(
			Integer restrictionEnzymeBindingSiteId, Integer featureId,
		...
		this.restrictionEnzymeBindingSiteId = restrictionEnzymeBindingSiteId;
	...
	public Integer getRestrictionEnzymeBindingSiteId() {
		return this.restrictionEnzymeBindingSiteId;
	}

	public void setRestrictionEnzymeBindingSiteId(
			Integer restrictionEnzymeBindingSiteId) {
		this.restrictionEnzymeBindingSiteId = restrictionEnzymeBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RestrictionEnzymeBindingSiteId))
			return false;
		RestrictionEnzymeBindingSiteId castOther = (RestrictionEnzymeBindingSiteId) other;

		return ((this.getRestrictionEnzymeBindingSiteId() == castOther
				.getRestrictionEnzymeBindingSiteId()) || (this
				.getRestrictionEnzymeBindingSiteId() != null
				&& castOther.getRestrictionEnzymeBindingSiteId() != null && this
				.getRestrictionEnzymeBindingSiteId().equals(
						castOther.getRestrictionEnzymeBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRestrictionEnzymeBindingSiteId() == null ? 0 : this
						.getRestrictionEnzymeBindingSiteId().hashCode());
		result = 37 * result
