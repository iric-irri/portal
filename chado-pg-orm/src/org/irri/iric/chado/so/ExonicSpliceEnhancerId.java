...
/**
 * ExonicSpliceEnhancerId generated by hbm2java
 */
public class ExonicSpliceEnhancerId implements java.io.Serializable {

	private Integer exonicSpliceEnhancerId;
	...
	public ExonicSpliceEnhancerId() {
	}

	public ExonicSpliceEnhancerId(Integer exonicSpliceEnhancerId,
		...
		this.exonicSpliceEnhancerId = exonicSpliceEnhancerId;
	...
	public Integer getExonicSpliceEnhancerId() {
		return this.exonicSpliceEnhancerId;
	}

	public void setExonicSpliceEnhancerId(Integer exonicSpliceEnhancerId) {
		this.exonicSpliceEnhancerId = exonicSpliceEnhancerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonicSpliceEnhancerId))
			return false;
		ExonicSpliceEnhancerId castOther = (ExonicSpliceEnhancerId) other;

		return ((this.getExonicSpliceEnhancerId() == castOther
				.getExonicSpliceEnhancerId()) || (this
				.getExonicSpliceEnhancerId() != null
				&& castOther.getExonicSpliceEnhancerId() != null && this
				.getExonicSpliceEnhancerId().equals(
						castOther.getExonicSpliceEnhancerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonicSpliceEnhancerId() == null ? 0 : this
						.getExonicSpliceEnhancerId().hashCode());
		result = 37 * result
