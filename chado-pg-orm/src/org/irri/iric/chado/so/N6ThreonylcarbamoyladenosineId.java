...
/**
 * N6ThreonylcarbamoyladenosineId generated by hbm2java
 */
public class N6ThreonylcarbamoyladenosineId implements java.io.Serializable {

	private Integer n6ThreonylcarbamoyladenosineId;
	...
	public N6ThreonylcarbamoyladenosineId() {
	}

	public N6ThreonylcarbamoyladenosineId(
			Integer n6ThreonylcarbamoyladenosineId, Integer featureId,
		...
		this.n6ThreonylcarbamoyladenosineId = n6ThreonylcarbamoyladenosineId;
	...
	public Integer getN6ThreonylcarbamoyladenosineId() {
		return this.n6ThreonylcarbamoyladenosineId;
	}

	public void setN6ThreonylcarbamoyladenosineId(
			Integer n6ThreonylcarbamoyladenosineId) {
		this.n6ThreonylcarbamoyladenosineId = n6ThreonylcarbamoyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6ThreonylcarbamoyladenosineId))
			return false;
		N6ThreonylcarbamoyladenosineId castOther = (N6ThreonylcarbamoyladenosineId) other;

		return ((this.getN6ThreonylcarbamoyladenosineId() == castOther
				.getN6ThreonylcarbamoyladenosineId()) || (this
				.getN6ThreonylcarbamoyladenosineId() != null
				&& castOther.getN6ThreonylcarbamoyladenosineId() != null && this
				.getN6ThreonylcarbamoyladenosineId().equals(
						castOther.getN6ThreonylcarbamoyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6ThreonylcarbamoyladenosineId() == null ? 0 : this
						.getN6ThreonylcarbamoyladenosineId().hashCode());
		result = 37 * result
