...
/**
 * RnapolIiiPromoterType3Id generated by hbm2java
 */
public class RnapolIiiPromoterType3Id implements java.io.Serializable {

	private Integer rnapolIiiPromoterType3Id;
	...
	public RnapolIiiPromoterType3Id() {
	}

	public RnapolIiiPromoterType3Id(Integer rnapolIiiPromoterType3Id,
		...
		this.rnapolIiiPromoterType3Id = rnapolIiiPromoterType3Id;
	...
	public Integer getRnapolIiiPromoterType3Id() {
		return this.rnapolIiiPromoterType3Id;
	}

	public void setRnapolIiiPromoterType3Id(Integer rnapolIiiPromoterType3Id) {
		this.rnapolIiiPromoterType3Id = rnapolIiiPromoterType3Id;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnapolIiiPromoterType3Id))
			return false;
		RnapolIiiPromoterType3Id castOther = (RnapolIiiPromoterType3Id) other;

		return ((this.getRnapolIiiPromoterType3Id() == castOther
				.getRnapolIiiPromoterType3Id()) || (this
				.getRnapolIiiPromoterType3Id() != null
				&& castOther.getRnapolIiiPromoterType3Id() != null && this
				.getRnapolIiiPromoterType3Id().equals(
						castOther.getRnapolIiiPromoterType3Id())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnapolIiiPromoterType3Id() == null ? 0 : this
						.getRnapolIiiPromoterType3Id().hashCode());
		result = 37 * result
