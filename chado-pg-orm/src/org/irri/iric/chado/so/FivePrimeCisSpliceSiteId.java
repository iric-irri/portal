...
/**
 * FivePrimeCisSpliceSiteId generated by hbm2java
 */
public class FivePrimeCisSpliceSiteId implements java.io.Serializable {

	private Integer fivePrimeCisSpliceSiteId;
	...
	public FivePrimeCisSpliceSiteId() {
	}

	public FivePrimeCisSpliceSiteId(Integer fivePrimeCisSpliceSiteId,
		...
		this.fivePrimeCisSpliceSiteId = fivePrimeCisSpliceSiteId;
	...
	public Integer getFivePrimeCisSpliceSiteId() {
		return this.fivePrimeCisSpliceSiteId;
	}

	public void setFivePrimeCisSpliceSiteId(Integer fivePrimeCisSpliceSiteId) {
		this.fivePrimeCisSpliceSiteId = fivePrimeCisSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeCisSpliceSiteId))
			return false;
		FivePrimeCisSpliceSiteId castOther = (FivePrimeCisSpliceSiteId) other;

		return ((this.getFivePrimeCisSpliceSiteId() == castOther
				.getFivePrimeCisSpliceSiteId()) || (this
				.getFivePrimeCisSpliceSiteId() != null
				&& castOther.getFivePrimeCisSpliceSiteId() != null && this
				.getFivePrimeCisSpliceSiteId().equals(
						castOther.getFivePrimeCisSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeCisSpliceSiteId() == null ? 0 : this
						.getFivePrimeCisSpliceSiteId().hashCode());
		result = 37 * result
