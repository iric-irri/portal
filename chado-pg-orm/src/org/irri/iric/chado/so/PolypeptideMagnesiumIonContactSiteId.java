...
/**
 * PolypeptideMagnesiumIonContactSiteId generated by hbm2java
 */
public class PolypeptideMagnesiumIonContactSiteId implements
		java.io.Serializable {

	private Integer polypeptideMagnesiumIonContactSiteId;
	...
	public PolypeptideMagnesiumIonContactSiteId() {
	}

	public PolypeptideMagnesiumIonContactSiteId(
			Integer polypeptideMagnesiumIonContactSiteId, Integer featureId,
		...
		this.polypeptideMagnesiumIonContactSiteId = polypeptideMagnesiumIonContactSiteId;
	...
	public Integer getPolypeptideMagnesiumIonContactSiteId() {
		return this.polypeptideMagnesiumIonContactSiteId;
	}

	public void setPolypeptideMagnesiumIonContactSiteId(
			Integer polypeptideMagnesiumIonContactSiteId) {
		this.polypeptideMagnesiumIonContactSiteId = polypeptideMagnesiumIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideMagnesiumIonContactSiteId))
			return false;
		PolypeptideMagnesiumIonContactSiteId castOther = (PolypeptideMagnesiumIonContactSiteId) other;

		return ((this.getPolypeptideMagnesiumIonContactSiteId() == castOther
				.getPolypeptideMagnesiumIonContactSiteId()) || (this
				.getPolypeptideMagnesiumIonContactSiteId() != null
				&& castOther.getPolypeptideMagnesiumIonContactSiteId() != null && this
				.getPolypeptideMagnesiumIonContactSiteId().equals(
						castOther.getPolypeptideMagnesiumIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideMagnesiumIonContactSiteId() == null ? 0 : this
						.getPolypeptideMagnesiumIonContactSiteId().hashCode());
		result = 37 * result
