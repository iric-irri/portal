...
/**
 * UtrId generated by hbm2java
 */
public class UtrId implements java.io.Serializable {
	...
	public UtrId(Integer utrId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UtrId))
			return false;
		UtrId castOther = (UtrId) other;

		return ((this.getUtrId() == castOther.getUtrId()) || (this.getUtrId() != null
				&& castOther.getUtrId() != null && this.getUtrId().equals(
				castOther.getUtrId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getUtrId() == null ? 0 : this.getUtrId().hashCode());
		result = 37 * result
