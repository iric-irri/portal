...
/**
 * ModifiedLSelenocysteineId generated by hbm2java
 */
public class ModifiedLSelenocysteineId implements java.io.Serializable {

	private Integer modifiedLSelenocysteineId;
	...
	public ModifiedLSelenocysteineId() {
	}

	public ModifiedLSelenocysteineId(Integer modifiedLSelenocysteineId,
		...
		this.modifiedLSelenocysteineId = modifiedLSelenocysteineId;
	...
	public Integer getModifiedLSelenocysteineId() {
		return this.modifiedLSelenocysteineId;
	}

	public void setModifiedLSelenocysteineId(Integer modifiedLSelenocysteineId) {
		this.modifiedLSelenocysteineId = modifiedLSelenocysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLSelenocysteineId))
			return false;
		ModifiedLSelenocysteineId castOther = (ModifiedLSelenocysteineId) other;

		return ((this.getModifiedLSelenocysteineId() == castOther
				.getModifiedLSelenocysteineId()) || (this
				.getModifiedLSelenocysteineId() != null
				&& castOther.getModifiedLSelenocysteineId() != null && this
				.getModifiedLSelenocysteineId().equals(
						castOther.getModifiedLSelenocysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLSelenocysteineId() == null ? 0 : this
						.getModifiedLSelenocysteineId().hashCode());
		result = 37 * result
