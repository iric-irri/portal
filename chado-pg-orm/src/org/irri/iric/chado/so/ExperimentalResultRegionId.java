...
/**
 * ExperimentalResultRegionId generated by hbm2java
 */
public class ExperimentalResultRegionId implements java.io.Serializable {

	private Integer experimentalResultRegionId;
	...
	public ExperimentalResultRegionId() {
	}

	public ExperimentalResultRegionId(Integer experimentalResultRegionId,
		...
		this.experimentalResultRegionId = experimentalResultRegionId;
	...
	public Integer getExperimentalResultRegionId() {
		return this.experimentalResultRegionId;
	}

	public void setExperimentalResultRegionId(Integer experimentalResultRegionId) {
		this.experimentalResultRegionId = experimentalResultRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExperimentalResultRegionId))
			return false;
		ExperimentalResultRegionId castOther = (ExperimentalResultRegionId) other;

		return ((this.getExperimentalResultRegionId() == castOther
				.getExperimentalResultRegionId()) || (this
				.getExperimentalResultRegionId() != null
				&& castOther.getExperimentalResultRegionId() != null && this
				.getExperimentalResultRegionId().equals(
						castOther.getExperimentalResultRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExperimentalResultRegionId() == null ? 0 : this
						.getExperimentalResultRegionId().hashCode());
		result = 37 * result
