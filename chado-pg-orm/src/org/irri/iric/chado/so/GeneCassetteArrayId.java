...
/**
 * GeneCassetteArrayId generated by hbm2java
 */
public class GeneCassetteArrayId implements java.io.Serializable {

	private Integer geneCassetteArrayId;
	...
	public GeneCassetteArrayId() {
	}

	public GeneCassetteArrayId(Integer geneCassetteArrayId, Integer featureId,
		...
		this.geneCassetteArrayId = geneCassetteArrayId;
	...
	public Integer getGeneCassetteArrayId() {
		return this.geneCassetteArrayId;
	}

	public void setGeneCassetteArrayId(Integer geneCassetteArrayId) {
		this.geneCassetteArrayId = geneCassetteArrayId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneCassetteArrayId))
			return false;
		GeneCassetteArrayId castOther = (GeneCassetteArrayId) other;

		return ((this.getGeneCassetteArrayId() == castOther
				.getGeneCassetteArrayId()) || (this.getGeneCassetteArrayId() != null
				&& castOther.getGeneCassetteArrayId() != null && this
				.getGeneCassetteArrayId().equals(
						castOther.getGeneCassetteArrayId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneCassetteArrayId() == null ? 0 : this
						.getGeneCassetteArrayId().hashCode());
		result = 37 * result
