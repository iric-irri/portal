...
/**
 * RestrictionEnzymeSingleStrandOverhangId generated by hbm2java
 */
public class RestrictionEnzymeSingleStrandOverhangId implements
		java.io.Serializable {

	private Integer restrictionEnzymeSingleStrandOverhangId;
	...
	public RestrictionEnzymeSingleStrandOverhangId() {
	}

	public RestrictionEnzymeSingleStrandOverhangId(
			Integer restrictionEnzymeSingleStrandOverhangId, Integer featureId,
		...
		this.restrictionEnzymeSingleStrandOverhangId = restrictionEnzymeSingleStrandOverhangId;
	...
	public Integer getRestrictionEnzymeSingleStrandOverhangId() {
		return this.restrictionEnzymeSingleStrandOverhangId;
	}

	public void setRestrictionEnzymeSingleStrandOverhangId(
			Integer restrictionEnzymeSingleStrandOverhangId) {
		this.restrictionEnzymeSingleStrandOverhangId = restrictionEnzymeSingleStrandOverhangId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RestrictionEnzymeSingleStrandOverhangId))
			return false;
		RestrictionEnzymeSingleStrandOverhangId castOther = (RestrictionEnzymeSingleStrandOverhangId) other;

		return ((this.getRestrictionEnzymeSingleStrandOverhangId() == castOther
				.getRestrictionEnzymeSingleStrandOverhangId()) || (this
				.getRestrictionEnzymeSingleStrandOverhangId() != null
				&& castOther.getRestrictionEnzymeSingleStrandOverhangId() != null && this
				.getRestrictionEnzymeSingleStrandOverhangId().equals(
						castOther.getRestrictionEnzymeSingleStrandOverhangId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRestrictionEnzymeSingleStrandOverhangId() == null ? 0
						: this.getRestrictionEnzymeSingleStrandOverhangId()
								.hashCode());
		result = 37 * result
