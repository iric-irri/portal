...
/**
 * U3SnornaId generated by hbm2java
 */
public class U3SnornaId implements java.io.Serializable {

	private Integer u3SnornaId;
	...
	public U3SnornaId(Integer u3SnornaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU3SnornaId() {
		return this.u3SnornaId;
	}

	public void setU3SnornaId(Integer u3SnornaId) {
		this.u3SnornaId = u3SnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U3SnornaId))
			return false;
		U3SnornaId castOther = (U3SnornaId) other;

		return ((this.getU3SnornaId() == castOther.getU3SnornaId()) || (this
				.getU3SnornaId() != null && castOther.getU3SnornaId() != null && this
				.getU3SnornaId().equals(castOther.getU3SnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU3SnornaId() == null ? 0 : this.getU3SnornaId()
						.hashCode());
		result = 37 * result
