...
/**
 * EncodesDisjointPolypeptidesId generated by hbm2java
 */
public class EncodesDisjointPolypeptidesId implements java.io.Serializable {

	private Integer encodesDisjointPolypeptidesId;
	...
	public EncodesDisjointPolypeptidesId() {
	}

	public EncodesDisjointPolypeptidesId(Integer encodesDisjointPolypeptidesId,
		...
		this.encodesDisjointPolypeptidesId = encodesDisjointPolypeptidesId;
	...
	public Integer getEncodesDisjointPolypeptidesId() {
		return this.encodesDisjointPolypeptidesId;
	}

	public void setEncodesDisjointPolypeptidesId(
			Integer encodesDisjointPolypeptidesId) {
		this.encodesDisjointPolypeptidesId = encodesDisjointPolypeptidesId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesDisjointPolypeptidesId))
			return false;
		EncodesDisjointPolypeptidesId castOther = (EncodesDisjointPolypeptidesId) other;

		return ((this.getEncodesDisjointPolypeptidesId() == castOther
				.getEncodesDisjointPolypeptidesId()) || (this
				.getEncodesDisjointPolypeptidesId() != null
				&& castOther.getEncodesDisjointPolypeptidesId() != null && this
				.getEncodesDisjointPolypeptidesId().equals(
						castOther.getEncodesDisjointPolypeptidesId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesDisjointPolypeptidesId() == null ? 0 : this
						.getEncodesDisjointPolypeptidesId().hashCode());
		result = 37 * result
