...
/**
 * FivePrimeOpenReadingFrameId generated by hbm2java
 */
public class FivePrimeOpenReadingFrameId implements java.io.Serializable {

	private Integer fivePrimeOpenReadingFrameId;
	...
	public FivePrimeOpenReadingFrameId() {
	}

	public FivePrimeOpenReadingFrameId(Integer fivePrimeOpenReadingFrameId,
		...
		this.fivePrimeOpenReadingFrameId = fivePrimeOpenReadingFrameId;
	...
	public Integer getFivePrimeOpenReadingFrameId() {
		return this.fivePrimeOpenReadingFrameId;
	}

	public void setFivePrimeOpenReadingFrameId(
			Integer fivePrimeOpenReadingFrameId) {
		this.fivePrimeOpenReadingFrameId = fivePrimeOpenReadingFrameId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeOpenReadingFrameId))
			return false;
		FivePrimeOpenReadingFrameId castOther = (FivePrimeOpenReadingFrameId) other;

		return ((this.getFivePrimeOpenReadingFrameId() == castOther
				.getFivePrimeOpenReadingFrameId()) || (this
				.getFivePrimeOpenReadingFrameId() != null
				&& castOther.getFivePrimeOpenReadingFrameId() != null && this
				.getFivePrimeOpenReadingFrameId().equals(
						castOther.getFivePrimeOpenReadingFrameId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeOpenReadingFrameId() == null ? 0 : this
						.getFivePrimeOpenReadingFrameId().hashCode());
		result = 37 * result
