...
/**
 * PacId generated by hbm2java
 */
public class PacId implements java.io.Serializable {
	...
	public PacId(Integer pacId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PacId))
			return false;
		PacId castOther = (PacId) other;

		return ((this.getPacId() == castOther.getPacId()) || (this.getPacId() != null
				&& castOther.getPacId() != null && this.getPacId().equals(
				castOther.getPacId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPacId() == null ? 0 : this.getPacId().hashCode());
		result = 37 * result
