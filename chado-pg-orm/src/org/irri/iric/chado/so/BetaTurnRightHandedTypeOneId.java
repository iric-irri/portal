...
/**
 * BetaTurnRightHandedTypeOneId generated by hbm2java
 */
public class BetaTurnRightHandedTypeOneId implements java.io.Serializable {

	private Integer betaTurnRightHandedTypeOneId;
	...
	public BetaTurnRightHandedTypeOneId() {
	}

	public BetaTurnRightHandedTypeOneId(Integer betaTurnRightHandedTypeOneId,
		...
		this.betaTurnRightHandedTypeOneId = betaTurnRightHandedTypeOneId;
	...
	public Integer getBetaTurnRightHandedTypeOneId() {
		return this.betaTurnRightHandedTypeOneId;
	}

	public void setBetaTurnRightHandedTypeOneId(
			Integer betaTurnRightHandedTypeOneId) {
		this.betaTurnRightHandedTypeOneId = betaTurnRightHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnRightHandedTypeOneId))
			return false;
		BetaTurnRightHandedTypeOneId castOther = (BetaTurnRightHandedTypeOneId) other;

		return ((this.getBetaTurnRightHandedTypeOneId() == castOther
				.getBetaTurnRightHandedTypeOneId()) || (this
				.getBetaTurnRightHandedTypeOneId() != null
				&& castOther.getBetaTurnRightHandedTypeOneId() != null && this
				.getBetaTurnRightHandedTypeOneId().equals(
						castOther.getBetaTurnRightHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnRightHandedTypeOneId() == null ? 0 : this
						.getBetaTurnRightHandedTypeOneId().hashCode());
		result = 37 * result
