...
/**
 * VDDjJCClusterId generated by hbm2java
 */
public class VDDjJCClusterId implements java.io.Serializable {

	private Integer VDDjJCClusterId;
	...
	public VDDjJCClusterId() {
	}

	public VDDjJCClusterId(Integer VDDjJCClusterId, Integer featureId,
		...
		this.VDDjJCClusterId = VDDjJCClusterId;
	...
	public Integer getVDDjJCClusterId() {
		return this.VDDjJCClusterId;
	}

	public void setVDDjJCClusterId(Integer VDDjJCClusterId) {
		this.VDDjJCClusterId = VDDjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDDjJCClusterId))
			return false;
		VDDjJCClusterId castOther = (VDDjJCClusterId) other;

		return ((this.getVDDjJCClusterId() == castOther.getVDDjJCClusterId()) || (this
				.getVDDjJCClusterId() != null
				&& castOther.getVDDjJCClusterId() != null && this
				.getVDDjJCClusterId().equals(castOther.getVDDjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDDjJCClusterId() == null ? 0 : this.getVDDjJCClusterId()
						.hashCode());
		result = 37 * result
