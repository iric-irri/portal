...
/**
 * DistalPromoterElementId generated by hbm2java
 */
public class DistalPromoterElementId implements java.io.Serializable {

	private Integer distalPromoterElementId;
	...
	public DistalPromoterElementId() {
	}

	public DistalPromoterElementId(Integer distalPromoterElementId,
		...
		this.distalPromoterElementId = distalPromoterElementId;
	...
	public Integer getDistalPromoterElementId() {
		return this.distalPromoterElementId;
	}

	public void setDistalPromoterElementId(Integer distalPromoterElementId) {
		this.distalPromoterElementId = distalPromoterElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DistalPromoterElementId))
			return false;
		DistalPromoterElementId castOther = (DistalPromoterElementId) other;

		return ((this.getDistalPromoterElementId() == castOther
				.getDistalPromoterElementId()) || (this
				.getDistalPromoterElementId() != null
				&& castOther.getDistalPromoterElementId() != null && this
				.getDistalPromoterElementId().equals(
						castOther.getDistalPromoterElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDistalPromoterElementId() == null ? 0 : this
						.getDistalPromoterElementId().hashCode());
		result = 37 * result
