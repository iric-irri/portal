...
/**
 * CappedPrimaryTranscriptId generated by hbm2java
 */
public class CappedPrimaryTranscriptId implements java.io.Serializable {

	private Integer cappedPrimaryTranscriptId;
	...
	public CappedPrimaryTranscriptId() {
	}

	public CappedPrimaryTranscriptId(Integer cappedPrimaryTranscriptId,
		...
		this.cappedPrimaryTranscriptId = cappedPrimaryTranscriptId;
	...
	public Integer getCappedPrimaryTranscriptId() {
		return this.cappedPrimaryTranscriptId;
	}

	public void setCappedPrimaryTranscriptId(Integer cappedPrimaryTranscriptId) {
		this.cappedPrimaryTranscriptId = cappedPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CappedPrimaryTranscriptId))
			return false;
		CappedPrimaryTranscriptId castOther = (CappedPrimaryTranscriptId) other;

		return ((this.getCappedPrimaryTranscriptId() == castOther
				.getCappedPrimaryTranscriptId()) || (this
				.getCappedPrimaryTranscriptId() != null
				&& castOther.getCappedPrimaryTranscriptId() != null && this
				.getCappedPrimaryTranscriptId().equals(
						castOther.getCappedPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCappedPrimaryTranscriptId() == null ? 0 : this
						.getCappedPrimaryTranscriptId().hashCode());
		result = 37 * result
