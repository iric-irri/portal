...
/**
 * BiologicalRegionId generated by hbm2java
 */
public class BiologicalRegionId implements java.io.Serializable {

	private Integer biologicalRegionId;
	...
	public BiologicalRegionId() {
	}

	public BiologicalRegionId(Integer biologicalRegionId, Integer featureId,
		...
		this.biologicalRegionId = biologicalRegionId;
	...
	public Integer getBiologicalRegionId() {
		return this.biologicalRegionId;
	}

	public void setBiologicalRegionId(Integer biologicalRegionId) {
		this.biologicalRegionId = biologicalRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BiologicalRegionId))
			return false;
		BiologicalRegionId castOther = (BiologicalRegionId) other;

		return ((this.getBiologicalRegionId() == castOther
				.getBiologicalRegionId()) || (this.getBiologicalRegionId() != null
				&& castOther.getBiologicalRegionId() != null && this
				.getBiologicalRegionId().equals(
						castOther.getBiologicalRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBiologicalRegionId() == null ? 0 : this
						.getBiologicalRegionId().hashCode());
		result = 37 * result
