...
/**
 * PhagemidId generated by hbm2java
 */
public class PhagemidId implements java.io.Serializable {

	private Integer phagemidId;
	...
	public PhagemidId(Integer phagemidId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPhagemidId() {
		return this.phagemidId;
	}

	public void setPhagemidId(Integer phagemidId) {
		this.phagemidId = phagemidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhagemidId))
			return false;
		PhagemidId castOther = (PhagemidId) other;

		return ((this.getPhagemidId() == castOther.getPhagemidId()) || (this
				.getPhagemidId() != null && castOther.getPhagemidId() != null && this
				.getPhagemidId().equals(castOther.getPhagemidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPhagemidId() == null ? 0 : this.getPhagemidId()
						.hashCode());
		result = 37 * result
