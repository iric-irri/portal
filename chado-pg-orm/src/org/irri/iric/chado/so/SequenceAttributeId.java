...
/**
 * SequenceAttributeId generated by hbm2java
 */
public class SequenceAttributeId implements java.io.Serializable {

	private Integer sequenceAttributeId;
	...
	public SequenceAttributeId() {
	}

	public SequenceAttributeId(Integer sequenceAttributeId, Integer featureId,
		...
		this.sequenceAttributeId = sequenceAttributeId;
	...
	public Integer getSequenceAttributeId() {
		return this.sequenceAttributeId;
	}

	public void setSequenceAttributeId(Integer sequenceAttributeId) {
		this.sequenceAttributeId = sequenceAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceAttributeId))
			return false;
		SequenceAttributeId castOther = (SequenceAttributeId) other;

		return ((this.getSequenceAttributeId() == castOther
				.getSequenceAttributeId()) || (this.getSequenceAttributeId() != null
				&& castOther.getSequenceAttributeId() != null && this
				.getSequenceAttributeId().equals(
						castOther.getSequenceAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceAttributeId() == null ? 0 : this
						.getSequenceAttributeId().hashCode());
		result = 37 * result
