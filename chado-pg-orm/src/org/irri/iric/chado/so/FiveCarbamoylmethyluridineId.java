...
/**
 * FiveCarbamoylmethyluridineId generated by hbm2java
 */
public class FiveCarbamoylmethyluridineId implements java.io.Serializable {

	private Integer fiveCarbamoylmethyluridineId;
	...
	public FiveCarbamoylmethyluridineId() {
	}

	public FiveCarbamoylmethyluridineId(Integer fiveCarbamoylmethyluridineId,
		...
		this.fiveCarbamoylmethyluridineId = fiveCarbamoylmethyluridineId;
	...
	public Integer getFiveCarbamoylmethyluridineId() {
		return this.fiveCarbamoylmethyluridineId;
	}

	public void setFiveCarbamoylmethyluridineId(
			Integer fiveCarbamoylmethyluridineId) {
		this.fiveCarbamoylmethyluridineId = fiveCarbamoylmethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCarbamoylmethyluridineId))
			return false;
		FiveCarbamoylmethyluridineId castOther = (FiveCarbamoylmethyluridineId) other;

		return ((this.getFiveCarbamoylmethyluridineId() == castOther
				.getFiveCarbamoylmethyluridineId()) || (this
				.getFiveCarbamoylmethyluridineId() != null
				&& castOther.getFiveCarbamoylmethyluridineId() != null && this
				.getFiveCarbamoylmethyluridineId().equals(
						castOther.getFiveCarbamoylmethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCarbamoylmethyluridineId() == null ? 0 : this
						.getFiveCarbamoylmethyluridineId().hashCode());
		result = 37 * result
