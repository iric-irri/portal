...
/**
 * SpliceEnhancerId generated by hbm2java
 */
public class SpliceEnhancerId implements java.io.Serializable {

	private Integer spliceEnhancerId;
	...
	public SpliceEnhancerId() {
	}

	public SpliceEnhancerId(Integer spliceEnhancerId, Integer featureId,
		...
		this.spliceEnhancerId = spliceEnhancerId;
	...
	public Integer getSpliceEnhancerId() {
		return this.spliceEnhancerId;
	}

	public void setSpliceEnhancerId(Integer spliceEnhancerId) {
		this.spliceEnhancerId = spliceEnhancerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceEnhancerId))
			return false;
		SpliceEnhancerId castOther = (SpliceEnhancerId) other;

		return ((this.getSpliceEnhancerId() == castOther.getSpliceEnhancerId()) || (this
				.getSpliceEnhancerId() != null
				&& castOther.getSpliceEnhancerId() != null && this
				.getSpliceEnhancerId().equals(castOther.getSpliceEnhancerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceEnhancerId() == null ? 0 : this
						.getSpliceEnhancerId().hashCode());
		result = 37 * result
