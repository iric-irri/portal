...
/**
 * PrimerMatchId generated by hbm2java
 */
public class PrimerMatchId implements java.io.Serializable {

	private Integer primerMatchId;
	...
	public PrimerMatchId() {
	}

	public PrimerMatchId(Integer primerMatchId, Integer featureId,
		...
		this.primerMatchId = primerMatchId;
	...
	public Integer getPrimerMatchId() {
		return this.primerMatchId;
	}

	public void setPrimerMatchId(Integer primerMatchId) {
		this.primerMatchId = primerMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrimerMatchId))
			return false;
		PrimerMatchId castOther = (PrimerMatchId) other;

		return ((this.getPrimerMatchId() == castOther.getPrimerMatchId()) || (this
				.getPrimerMatchId() != null
				&& castOther.getPrimerMatchId() != null && this
				.getPrimerMatchId().equals(castOther.getPrimerMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPrimerMatchId() == null ? 0 : this.getPrimerMatchId()
						.hashCode());
		result = 37 * result
