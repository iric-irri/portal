...
/**
 * InframeCodonLossId generated by hbm2java
 */
public class InframeCodonLossId implements java.io.Serializable {

	private Integer inframeCodonLossId;
	...
	public InframeCodonLossId() {
	}

	public InframeCodonLossId(Integer inframeCodonLossId, Integer featureId,
		...
		this.inframeCodonLossId = inframeCodonLossId;
	...
	public Integer getInframeCodonLossId() {
		return this.inframeCodonLossId;
	}

	public void setInframeCodonLossId(Integer inframeCodonLossId) {
		this.inframeCodonLossId = inframeCodonLossId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InframeCodonLossId))
			return false;
		InframeCodonLossId castOther = (InframeCodonLossId) other;

		return ((this.getInframeCodonLossId() == castOther
				.getInframeCodonLossId()) || (this.getInframeCodonLossId() != null
				&& castOther.getInframeCodonLossId() != null && this
				.getInframeCodonLossId().equals(
						castOther.getInframeCodonLossId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInframeCodonLossId() == null ? 0 : this
						.getInframeCodonLossId().hashCode());
		result = 37 * result
