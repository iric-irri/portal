...
/**
 * EndosomalLocalizationSignalId generated by hbm2java
 */
public class EndosomalLocalizationSignalId implements java.io.Serializable {

	private Integer endosomalLocalizationSignalId;
	...
	public EndosomalLocalizationSignalId() {
	}

	public EndosomalLocalizationSignalId(Integer endosomalLocalizationSignalId,
		...
		this.endosomalLocalizationSignalId = endosomalLocalizationSignalId;
	...
	public Integer getEndosomalLocalizationSignalId() {
		return this.endosomalLocalizationSignalId;
	}

	public void setEndosomalLocalizationSignalId(
			Integer endosomalLocalizationSignalId) {
		this.endosomalLocalizationSignalId = endosomalLocalizationSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EndosomalLocalizationSignalId))
			return false;
		EndosomalLocalizationSignalId castOther = (EndosomalLocalizationSignalId) other;

		return ((this.getEndosomalLocalizationSignalId() == castOther
				.getEndosomalLocalizationSignalId()) || (this
				.getEndosomalLocalizationSignalId() != null
				&& castOther.getEndosomalLocalizationSignalId() != null && this
				.getEndosomalLocalizationSignalId().equals(
						castOther.getEndosomalLocalizationSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEndosomalLocalizationSignalId() == null ? 0 : this
						.getEndosomalLocalizationSignalId().hashCode());
		result = 37 * result
