...
/**
 * TopologicallyDefinedRegionId generated by hbm2java
 */
public class TopologicallyDefinedRegionId implements java.io.Serializable {

	private Integer topologicallyDefinedRegionId;
	...
	public TopologicallyDefinedRegionId() {
	}

	public TopologicallyDefinedRegionId(Integer topologicallyDefinedRegionId,
		...
		this.topologicallyDefinedRegionId = topologicallyDefinedRegionId;
	...
	public Integer getTopologicallyDefinedRegionId() {
		return this.topologicallyDefinedRegionId;
	}

	public void setTopologicallyDefinedRegionId(
			Integer topologicallyDefinedRegionId) {
		this.topologicallyDefinedRegionId = topologicallyDefinedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TopologicallyDefinedRegionId))
			return false;
		TopologicallyDefinedRegionId castOther = (TopologicallyDefinedRegionId) other;

		return ((this.getTopologicallyDefinedRegionId() == castOther
				.getTopologicallyDefinedRegionId()) || (this
				.getTopologicallyDefinedRegionId() != null
				&& castOther.getTopologicallyDefinedRegionId() != null && this
				.getTopologicallyDefinedRegionId().equals(
						castOther.getTopologicallyDefinedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTopologicallyDefinedRegionId() == null ? 0 : this
						.getTopologicallyDefinedRegionId().hashCode());
		result = 37 * result
