...
/**
 * FivePrimeDNonamerId generated by hbm2java
 */
public class FivePrimeDNonamerId implements java.io.Serializable {

	private Integer fivePrimeDNonamerId;
	...
	public FivePrimeDNonamerId() {
	}

	public FivePrimeDNonamerId(Integer fivePrimeDNonamerId, Integer featureId,
		...
		this.fivePrimeDNonamerId = fivePrimeDNonamerId;
	...
	public Integer getFivePrimeDNonamerId() {
		return this.fivePrimeDNonamerId;
	}

	public void setFivePrimeDNonamerId(Integer fivePrimeDNonamerId) {
		this.fivePrimeDNonamerId = fivePrimeDNonamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeDNonamerId))
			return false;
		FivePrimeDNonamerId castOther = (FivePrimeDNonamerId) other;

		return ((this.getFivePrimeDNonamerId() == castOther
				.getFivePrimeDNonamerId()) || (this.getFivePrimeDNonamerId() != null
				&& castOther.getFivePrimeDNonamerId() != null && this
				.getFivePrimeDNonamerId().equals(
						castOther.getFivePrimeDNonamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeDNonamerId() == null ? 0 : this
						.getFivePrimeDNonamerId().hashCode());
		result = 37 * result
