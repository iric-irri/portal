...
/**
 * RflpFragmentId generated by hbm2java
 */
public class RflpFragmentId implements java.io.Serializable {

	private Integer rflpFragmentId;
	...
	public RflpFragmentId() {
	}

	public RflpFragmentId(Integer rflpFragmentId, Integer featureId,
		...
		this.rflpFragmentId = rflpFragmentId;
	...
	public Integer getRflpFragmentId() {
		return this.rflpFragmentId;
	}

	public void setRflpFragmentId(Integer rflpFragmentId) {
		this.rflpFragmentId = rflpFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RflpFragmentId))
			return false;
		RflpFragmentId castOther = (RflpFragmentId) other;

		return ((this.getRflpFragmentId() == castOther.getRflpFragmentId()) || (this
				.getRflpFragmentId() != null
				&& castOther.getRflpFragmentId() != null && this
				.getRflpFragmentId().equals(castOther.getRflpFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRflpFragmentId() == null ? 0 : this.getRflpFragmentId()
						.hashCode());
		result = 37 * result
