...
/**
 * CdsId generated by hbm2java
 */
public class CdsId implements java.io.Serializable {
	...
	public CdsId(Integer cdsId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsId))
			return false;
		CdsId castOther = (CdsId) other;

		return ((this.getCdsId() == castOther.getCdsId()) || (this.getCdsId() != null
				&& castOther.getCdsId() != null && this.getCdsId().equals(
				castOther.getCdsId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCdsId() == null ? 0 : this.getCdsId().hashCode());
		result = 37 * result
