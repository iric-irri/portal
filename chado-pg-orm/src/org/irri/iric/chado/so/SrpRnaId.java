...
/**
 * SrpRnaId generated by hbm2java
 */
public class SrpRnaId implements java.io.Serializable {

	private Integer srpRnaId;
	...
	public SrpRnaId(Integer srpRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSrpRnaId() {
		return this.srpRnaId;
	}

	public void setSrpRnaId(Integer srpRnaId) {
		this.srpRnaId = srpRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SrpRnaId))
			return false;
		SrpRnaId castOther = (SrpRnaId) other;

		return ((this.getSrpRnaId() == castOther.getSrpRnaId()) || (this
				.getSrpRnaId() != null && castOther.getSrpRnaId() != null && this
				.getSrpRnaId().equals(castOther.getSrpRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSrpRnaId() == null ? 0 : this.getSrpRnaId().hashCode());
		result = 37 * result
