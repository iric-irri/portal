...
/**
 * NonCanonicalStartCodonId generated by hbm2java
 */
public class NonCanonicalStartCodonId implements java.io.Serializable {

	private Integer nonCanonicalStartCodonId;
	...
	public NonCanonicalStartCodonId() {
	}

	public NonCanonicalStartCodonId(Integer nonCanonicalStartCodonId,
		...
		this.nonCanonicalStartCodonId = nonCanonicalStartCodonId;
	...
	public Integer getNonCanonicalStartCodonId() {
		return this.nonCanonicalStartCodonId;
	}

	public void setNonCanonicalStartCodonId(Integer nonCanonicalStartCodonId) {
		this.nonCanonicalStartCodonId = nonCanonicalStartCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonCanonicalStartCodonId))
			return false;
		NonCanonicalStartCodonId castOther = (NonCanonicalStartCodonId) other;

		return ((this.getNonCanonicalStartCodonId() == castOther
				.getNonCanonicalStartCodonId()) || (this
				.getNonCanonicalStartCodonId() != null
				&& castOther.getNonCanonicalStartCodonId() != null && this
				.getNonCanonicalStartCodonId().equals(
						castOther.getNonCanonicalStartCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonCanonicalStartCodonId() == null ? 0 : this
						.getNonCanonicalStartCodonId().hashCode());
		result = 37 * result
