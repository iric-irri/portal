...
/**
 * H3k9DimethylationSiteId generated by hbm2java
 */
public class H3k9DimethylationSiteId implements java.io.Serializable {

	private Integer h3k9DimethylationSiteId;
	...
	public H3k9DimethylationSiteId() {
	}

	public H3k9DimethylationSiteId(Integer h3k9DimethylationSiteId,
		...
		this.h3k9DimethylationSiteId = h3k9DimethylationSiteId;
	...
	public Integer getH3k9DimethylationSiteId() {
		return this.h3k9DimethylationSiteId;
	}

	public void setH3k9DimethylationSiteId(Integer h3k9DimethylationSiteId) {
		this.h3k9DimethylationSiteId = h3k9DimethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k9DimethylationSiteId))
			return false;
		H3k9DimethylationSiteId castOther = (H3k9DimethylationSiteId) other;

		return ((this.getH3k9DimethylationSiteId() == castOther
				.getH3k9DimethylationSiteId()) || (this
				.getH3k9DimethylationSiteId() != null
				&& castOther.getH3k9DimethylationSiteId() != null && this
				.getH3k9DimethylationSiteId().equals(
						castOther.getH3k9DimethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k9DimethylationSiteId() == null ? 0 : this
						.getH3k9DimethylationSiteId().hashCode());
		result = 37 * result
