...
/**
 * RstId generated by hbm2java
 */
public class RstId implements java.io.Serializable {
	...
	public RstId(Integer rstId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RstId))
			return false;
		RstId castOther = (RstId) other;

		return ((this.getRstId() == castOther.getRstId()) || (this.getRstId() != null
				&& castOther.getRstId() != null && this.getRstId().equals(
				castOther.getRstId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRstId() == null ? 0 : this.getRstId().hashCode());
		result = 37 * result
