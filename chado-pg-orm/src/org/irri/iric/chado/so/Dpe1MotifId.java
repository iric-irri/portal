...
/**
 * Dpe1MotifId generated by hbm2java
 */
public class Dpe1MotifId implements java.io.Serializable {

	private Integer dpe1MotifId;
	...
	public Dpe1MotifId(Integer dpe1MotifId, Integer featureId,
	...
	public Integer getDpe1MotifId() {
		return this.dpe1MotifId;
	}

	public void setDpe1MotifId(Integer dpe1MotifId) {
		this.dpe1MotifId = dpe1MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dpe1MotifId))
			return false;
		Dpe1MotifId castOther = (Dpe1MotifId) other;

		return ((this.getDpe1MotifId() == castOther.getDpe1MotifId()) || (this
				.getDpe1MotifId() != null && castOther.getDpe1MotifId() != null && this
				.getDpe1MotifId().equals(castOther.getDpe1MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDpe1MotifId() == null ? 0 : this.getDpe1MotifId()
						.hashCode());
		result = 37 * result
