...
/**
 * InosineId generated by hbm2java
 */
public class InosineId implements java.io.Serializable {

	private Integer inosineId;
	...
	public InosineId(Integer inosineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getInosineId() {
		return this.inosineId;
	}

	public void setInosineId(Integer inosineId) {
		this.inosineId = inosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InosineId))
			return false;
		InosineId castOther = (InosineId) other;

		return ((this.getInosineId() == castOther.getInosineId()) || (this
				.getInosineId() != null && castOther.getInosineId() != null && this
				.getInosineId().equals(castOther.getInosineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getInosineId() == null ? 0 : this.getInosineId().hashCode());
		result = 37 * result
