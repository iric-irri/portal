...
/**
 * PolymeraseSynthesisReadId generated by hbm2java
 */
public class PolymeraseSynthesisReadId implements java.io.Serializable {

	private Integer polymeraseSynthesisReadId;
	...
	public PolymeraseSynthesisReadId() {
	}

	public PolymeraseSynthesisReadId(Integer polymeraseSynthesisReadId,
		...
		this.polymeraseSynthesisReadId = polymeraseSynthesisReadId;
	...
	public Integer getPolymeraseSynthesisReadId() {
		return this.polymeraseSynthesisReadId;
	}

	public void setPolymeraseSynthesisReadId(Integer polymeraseSynthesisReadId) {
		this.polymeraseSynthesisReadId = polymeraseSynthesisReadId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolymeraseSynthesisReadId))
			return false;
		PolymeraseSynthesisReadId castOther = (PolymeraseSynthesisReadId) other;

		return ((this.getPolymeraseSynthesisReadId() == castOther
				.getPolymeraseSynthesisReadId()) || (this
				.getPolymeraseSynthesisReadId() != null
				&& castOther.getPolymeraseSynthesisReadId() != null && this
				.getPolymeraseSynthesisReadId().equals(
						castOther.getPolymeraseSynthesisReadId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolymeraseSynthesisReadId() == null ? 0 : this
						.getPolymeraseSynthesisReadId().hashCode());
		result = 37 * result
