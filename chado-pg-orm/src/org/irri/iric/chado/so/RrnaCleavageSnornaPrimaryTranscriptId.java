...
/**
 * RrnaCleavageSnornaPrimaryTranscriptId generated by hbm2java
 */
public class RrnaCleavageSnornaPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer rrnaCleavageSnornaPrimaryTranscriptId;
	...
	public RrnaCleavageSnornaPrimaryTranscriptId() {
	}

	public RrnaCleavageSnornaPrimaryTranscriptId(
			Integer rrnaCleavageSnornaPrimaryTranscriptId, Integer featureId,
		...
		this.rrnaCleavageSnornaPrimaryTranscriptId = rrnaCleavageSnornaPrimaryTranscriptId;
	...
	public Integer getRrnaCleavageSnornaPrimaryTranscriptId() {
		return this.rrnaCleavageSnornaPrimaryTranscriptId;
	}

	public void setRrnaCleavageSnornaPrimaryTranscriptId(
			Integer rrnaCleavageSnornaPrimaryTranscriptId) {
		this.rrnaCleavageSnornaPrimaryTranscriptId = rrnaCleavageSnornaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaCleavageSnornaPrimaryTranscriptId))
			return false;
		RrnaCleavageSnornaPrimaryTranscriptId castOther = (RrnaCleavageSnornaPrimaryTranscriptId) other;

		return ((this.getRrnaCleavageSnornaPrimaryTranscriptId() == castOther
				.getRrnaCleavageSnornaPrimaryTranscriptId()) || (this
				.getRrnaCleavageSnornaPrimaryTranscriptId() != null
				&& castOther.getRrnaCleavageSnornaPrimaryTranscriptId() != null && this
				.getRrnaCleavageSnornaPrimaryTranscriptId().equals(
						castOther.getRrnaCleavageSnornaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaCleavageSnornaPrimaryTranscriptId() == null ? 0
						: this.getRrnaCleavageSnornaPrimaryTranscriptId()
								.hashCode());
		result = 37 * result
