...
/**
 * MrnaWithPlus1FrameshiftId generated by hbm2java
 */
public class MrnaWithPlus1FrameshiftId implements java.io.Serializable {

	private Integer mrnaWithPlus1FrameshiftId;
	...
	public MrnaWithPlus1FrameshiftId() {
	}

	public MrnaWithPlus1FrameshiftId(Integer mrnaWithPlus1FrameshiftId,
		...
		this.mrnaWithPlus1FrameshiftId = mrnaWithPlus1FrameshiftId;
	...
	public Integer getMrnaWithPlus1FrameshiftId() {
		return this.mrnaWithPlus1FrameshiftId;
	}

	public void setMrnaWithPlus1FrameshiftId(Integer mrnaWithPlus1FrameshiftId) {
		this.mrnaWithPlus1FrameshiftId = mrnaWithPlus1FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaWithPlus1FrameshiftId))
			return false;
		MrnaWithPlus1FrameshiftId castOther = (MrnaWithPlus1FrameshiftId) other;

		return ((this.getMrnaWithPlus1FrameshiftId() == castOther
				.getMrnaWithPlus1FrameshiftId()) || (this
				.getMrnaWithPlus1FrameshiftId() != null
				&& castOther.getMrnaWithPlus1FrameshiftId() != null && this
				.getMrnaWithPlus1FrameshiftId().equals(
						castOther.getMrnaWithPlus1FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaWithPlus1FrameshiftId() == null ? 0 : this
						.getMrnaWithPlus1FrameshiftId().hashCode());
		result = 37 * result
