...
/**
 * GeneSegmentId generated by hbm2java
 */
public class GeneSegmentId implements java.io.Serializable {

	private Integer geneSegmentId;
	...
	public GeneSegmentId() {
	}

	public GeneSegmentId(Integer geneSegmentId, Integer featureId,
		...
		this.geneSegmentId = geneSegmentId;
	...
	public Integer getGeneSegmentId() {
		return this.geneSegmentId;
	}

	public void setGeneSegmentId(Integer geneSegmentId) {
		this.geneSegmentId = geneSegmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSegmentId))
			return false;
		GeneSegmentId castOther = (GeneSegmentId) other;

		return ((this.getGeneSegmentId() == castOther.getGeneSegmentId()) || (this
				.getGeneSegmentId() != null
				&& castOther.getGeneSegmentId() != null && this
				.getGeneSegmentId().equals(castOther.getGeneSegmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSegmentId() == null ? 0 : this.getGeneSegmentId()
						.hashCode());
		result = 37 * result
