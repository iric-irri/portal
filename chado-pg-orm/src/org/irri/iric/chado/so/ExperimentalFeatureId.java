...
/**
 * ExperimentalFeatureId generated by hbm2java
 */
public class ExperimentalFeatureId implements java.io.Serializable {

	private Integer experimentalFeatureId;
	...
	public ExperimentalFeatureId() {
	}

	public ExperimentalFeatureId(Integer experimentalFeatureId,
	...
	public Integer getExperimentalFeatureId() {
		return this.experimentalFeatureId;
	}

	public void setExperimentalFeatureId(Integer experimentalFeatureId) {
		this.experimentalFeatureId = experimentalFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExperimentalFeatureId))
			return false;
		ExperimentalFeatureId castOther = (ExperimentalFeatureId) other;

		return ((this.getExperimentalFeatureId() == castOther
				.getExperimentalFeatureId()) || (this
				.getExperimentalFeatureId() != null
				&& castOther.getExperimentalFeatureId() != null && this
				.getExperimentalFeatureId().equals(
						castOther.getExperimentalFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExperimentalFeatureId() == null ? 0 : this
						.getExperimentalFeatureId().hashCode());
		result = 37 * result
