...
/**
 * RnaseMrpRnaId generated by hbm2java
 */
public class RnaseMrpRnaId implements java.io.Serializable {

	private Integer rnaseMrpRnaId;
	...
	public RnaseMrpRnaId() {
	}

	public RnaseMrpRnaId(Integer rnaseMrpRnaId, Integer featureId,
		...
		this.rnaseMrpRnaId = rnaseMrpRnaId;
	...
	public Integer getRnaseMrpRnaId() {
		return this.rnaseMrpRnaId;
	}

	public void setRnaseMrpRnaId(Integer rnaseMrpRnaId) {
		this.rnaseMrpRnaId = rnaseMrpRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaseMrpRnaId))
			return false;
		RnaseMrpRnaId castOther = (RnaseMrpRnaId) other;

		return ((this.getRnaseMrpRnaId() == castOther.getRnaseMrpRnaId()) || (this
				.getRnaseMrpRnaId() != null
				&& castOther.getRnaseMrpRnaId() != null && this
				.getRnaseMrpRnaId().equals(castOther.getRnaseMrpRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaseMrpRnaId() == null ? 0 : this.getRnaseMrpRnaId()
						.hashCode());
		result = 37 * result
