...
/**
 * DiseaseCausingVariantId generated by hbm2java
 */
public class DiseaseCausingVariantId implements java.io.Serializable {

	private Integer diseaseCausingVariantId;
	...
	public DiseaseCausingVariantId() {
	}

	public DiseaseCausingVariantId(Integer diseaseCausingVariantId,
		...
		this.diseaseCausingVariantId = diseaseCausingVariantId;
	...
	public Integer getDiseaseCausingVariantId() {
		return this.diseaseCausingVariantId;
	}

	public void setDiseaseCausingVariantId(Integer diseaseCausingVariantId) {
		this.diseaseCausingVariantId = diseaseCausingVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DiseaseCausingVariantId))
			return false;
		DiseaseCausingVariantId castOther = (DiseaseCausingVariantId) other;

		return ((this.getDiseaseCausingVariantId() == castOther
				.getDiseaseCausingVariantId()) || (this
				.getDiseaseCausingVariantId() != null
				&& castOther.getDiseaseCausingVariantId() != null && this
				.getDiseaseCausingVariantId().equals(
						castOther.getDiseaseCausingVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDiseaseCausingVariantId() == null ? 0 : this
						.getDiseaseCausingVariantId().hashCode());
		result = 37 * result
