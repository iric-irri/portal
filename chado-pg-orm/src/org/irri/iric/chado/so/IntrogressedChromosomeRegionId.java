...
/**
 * IntrogressedChromosomeRegionId generated by hbm2java
 */
public class IntrogressedChromosomeRegionId implements java.io.Serializable {

	private Integer introgressedChromosomeRegionId;
	...
	public IntrogressedChromosomeRegionId() {
	}

	public IntrogressedChromosomeRegionId(
			Integer introgressedChromosomeRegionId, Integer featureId,
		...
		this.introgressedChromosomeRegionId = introgressedChromosomeRegionId;
	...
	public Integer getIntrogressedChromosomeRegionId() {
		return this.introgressedChromosomeRegionId;
	}

	public void setIntrogressedChromosomeRegionId(
			Integer introgressedChromosomeRegionId) {
		this.introgressedChromosomeRegionId = introgressedChromosomeRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrogressedChromosomeRegionId))
			return false;
		IntrogressedChromosomeRegionId castOther = (IntrogressedChromosomeRegionId) other;

		return ((this.getIntrogressedChromosomeRegionId() == castOther
				.getIntrogressedChromosomeRegionId()) || (this
				.getIntrogressedChromosomeRegionId() != null
				&& castOther.getIntrogressedChromosomeRegionId() != null && this
				.getIntrogressedChromosomeRegionId().equals(
						castOther.getIntrogressedChromosomeRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrogressedChromosomeRegionId() == null ? 0 : this
						.getIntrogressedChromosomeRegionId().hashCode());
		result = 37 * result
