...
/**
 * BetaTurnLeftHandedTypeTwoId generated by hbm2java
 */
public class BetaTurnLeftHandedTypeTwoId implements java.io.Serializable {

	private Integer betaTurnLeftHandedTypeTwoId;
	...
	public BetaTurnLeftHandedTypeTwoId() {
	}

	public BetaTurnLeftHandedTypeTwoId(Integer betaTurnLeftHandedTypeTwoId,
		...
		this.betaTurnLeftHandedTypeTwoId = betaTurnLeftHandedTypeTwoId;
	...
	public Integer getBetaTurnLeftHandedTypeTwoId() {
		return this.betaTurnLeftHandedTypeTwoId;
	}

	public void setBetaTurnLeftHandedTypeTwoId(
			Integer betaTurnLeftHandedTypeTwoId) {
		this.betaTurnLeftHandedTypeTwoId = betaTurnLeftHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnLeftHandedTypeTwoId))
			return false;
		BetaTurnLeftHandedTypeTwoId castOther = (BetaTurnLeftHandedTypeTwoId) other;

		return ((this.getBetaTurnLeftHandedTypeTwoId() == castOther
				.getBetaTurnLeftHandedTypeTwoId()) || (this
				.getBetaTurnLeftHandedTypeTwoId() != null
				&& castOther.getBetaTurnLeftHandedTypeTwoId() != null && this
				.getBetaTurnLeftHandedTypeTwoId().equals(
						castOther.getBetaTurnLeftHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnLeftHandedTypeTwoId() == null ? 0 : this
						.getBetaTurnLeftHandedTypeTwoId().hashCode());
		result = 37 * result
