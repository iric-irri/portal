...
/**
 * SequencingPrimerId generated by hbm2java
 */
public class SequencingPrimerId implements java.io.Serializable {

	private Integer sequencingPrimerId;
	...
	public SequencingPrimerId() {
	}

	public SequencingPrimerId(Integer sequencingPrimerId, Integer featureId,
		...
		this.sequencingPrimerId = sequencingPrimerId;
	...
	public Integer getSequencingPrimerId() {
		return this.sequencingPrimerId;
	}

	public void setSequencingPrimerId(Integer sequencingPrimerId) {
		this.sequencingPrimerId = sequencingPrimerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequencingPrimerId))
			return false;
		SequencingPrimerId castOther = (SequencingPrimerId) other;

		return ((this.getSequencingPrimerId() == castOther
				.getSequencingPrimerId()) || (this.getSequencingPrimerId() != null
				&& castOther.getSequencingPrimerId() != null && this
				.getSequencingPrimerId().equals(
						castOther.getSequencingPrimerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequencingPrimerId() == null ? 0 : this
						.getSequencingPrimerId().hashCode());
		result = 37 * result
