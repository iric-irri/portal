...
/**
 * BetaTurnTypeEightId generated by hbm2java
 */
public class BetaTurnTypeEightId implements java.io.Serializable {

	private Integer betaTurnTypeEightId;
	...
	public BetaTurnTypeEightId() {
	}

	public BetaTurnTypeEightId(Integer betaTurnTypeEightId, Integer featureId,
		...
		this.betaTurnTypeEightId = betaTurnTypeEightId;
	...
	public Integer getBetaTurnTypeEightId() {
		return this.betaTurnTypeEightId;
	}

	public void setBetaTurnTypeEightId(Integer betaTurnTypeEightId) {
		this.betaTurnTypeEightId = betaTurnTypeEightId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeEightId))
			return false;
		BetaTurnTypeEightId castOther = (BetaTurnTypeEightId) other;

		return ((this.getBetaTurnTypeEightId() == castOther
				.getBetaTurnTypeEightId()) || (this.getBetaTurnTypeEightId() != null
				&& castOther.getBetaTurnTypeEightId() != null && this
				.getBetaTurnTypeEightId().equals(
						castOther.getBetaTurnTypeEightId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeEightId() == null ? 0 : this
						.getBetaTurnTypeEightId().hashCode());
		result = 37 * result
