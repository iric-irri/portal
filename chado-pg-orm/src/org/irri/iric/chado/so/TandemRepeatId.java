...
/**
 * TandemRepeatId generated by hbm2java
 */
public class TandemRepeatId implements java.io.Serializable {

	private Integer tandemRepeatId;
	...
	public TandemRepeatId() {
	}

	public TandemRepeatId(Integer tandemRepeatId, Integer featureId,
		...
		this.tandemRepeatId = tandemRepeatId;
	...
	public Integer getTandemRepeatId() {
		return this.tandemRepeatId;
	}

	public void setTandemRepeatId(Integer tandemRepeatId) {
		this.tandemRepeatId = tandemRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TandemRepeatId))
			return false;
		TandemRepeatId castOther = (TandemRepeatId) other;

		return ((this.getTandemRepeatId() == castOther.getTandemRepeatId()) || (this
				.getTandemRepeatId() != null
				&& castOther.getTandemRepeatId() != null && this
				.getTandemRepeatId().equals(castOther.getTandemRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTandemRepeatId() == null ? 0 : this.getTandemRepeatId()
						.hashCode());
		result = 37 * result
