...
/**
 * TandemDuplicationId generated by hbm2java
 */
public class TandemDuplicationId implements java.io.Serializable {

	private Integer tandemDuplicationId;
	...
	public TandemDuplicationId() {
	}

	public TandemDuplicationId(Integer tandemDuplicationId, Integer featureId,
		...
		this.tandemDuplicationId = tandemDuplicationId;
	...
	public Integer getTandemDuplicationId() {
		return this.tandemDuplicationId;
	}

	public void setTandemDuplicationId(Integer tandemDuplicationId) {
		this.tandemDuplicationId = tandemDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TandemDuplicationId))
			return false;
		TandemDuplicationId castOther = (TandemDuplicationId) other;

		return ((this.getTandemDuplicationId() == castOther
				.getTandemDuplicationId()) || (this.getTandemDuplicationId() != null
				&& castOther.getTandemDuplicationId() != null && this
				.getTandemDuplicationId().equals(
						castOther.getTandemDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTandemDuplicationId() == null ? 0 : this
						.getTandemDuplicationId().hashCode());
		result = 37 * result
