...
/**
 * MrnaAttributeId generated by hbm2java
 */
public class MrnaAttributeId implements java.io.Serializable {

	private Integer mrnaAttributeId;
	...
	public MrnaAttributeId() {
	}

	public MrnaAttributeId(Integer mrnaAttributeId, Integer featureId,
		...
		this.mrnaAttributeId = mrnaAttributeId;
	...
	public Integer getMrnaAttributeId() {
		return this.mrnaAttributeId;
	}

	public void setMrnaAttributeId(Integer mrnaAttributeId) {
		this.mrnaAttributeId = mrnaAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaAttributeId))
			return false;
		MrnaAttributeId castOther = (MrnaAttributeId) other;

		return ((this.getMrnaAttributeId() == castOther.getMrnaAttributeId()) || (this
				.getMrnaAttributeId() != null
				&& castOther.getMrnaAttributeId() != null && this
				.getMrnaAttributeId().equals(castOther.getMrnaAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaAttributeId() == null ? 0 : this.getMrnaAttributeId()
						.hashCode());
		result = 37 * result
