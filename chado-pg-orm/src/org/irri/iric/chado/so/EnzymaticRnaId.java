...
/**
 * EnzymaticRnaId generated by hbm2java
 */
public class EnzymaticRnaId implements java.io.Serializable {

	private Integer enzymaticRnaId;
	...
	public EnzymaticRnaId() {
	}

	public EnzymaticRnaId(Integer enzymaticRnaId, Integer featureId,
		...
		this.enzymaticRnaId = enzymaticRnaId;
	...
	public Integer getEnzymaticRnaId() {
		return this.enzymaticRnaId;
	}

	public void setEnzymaticRnaId(Integer enzymaticRnaId) {
		this.enzymaticRnaId = enzymaticRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnzymaticRnaId))
			return false;
		EnzymaticRnaId castOther = (EnzymaticRnaId) other;

		return ((this.getEnzymaticRnaId() == castOther.getEnzymaticRnaId()) || (this
				.getEnzymaticRnaId() != null
				&& castOther.getEnzymaticRnaId() != null && this
				.getEnzymaticRnaId().equals(castOther.getEnzymaticRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnzymaticRnaId() == null ? 0 : this.getEnzymaticRnaId()
						.hashCode());
		result = 37 * result
