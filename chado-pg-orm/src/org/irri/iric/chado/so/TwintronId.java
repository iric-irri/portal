...
/**
 * TwintronId generated by hbm2java
 */
public class TwintronId implements java.io.Serializable {

	private Integer twintronId;
	...
	public TwintronId(Integer twintronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTwintronId() {
		return this.twintronId;
	}

	public void setTwintronId(Integer twintronId) {
		this.twintronId = twintronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwintronId))
			return false;
		TwintronId castOther = (TwintronId) other;

		return ((this.getTwintronId() == castOther.getTwintronId()) || (this
				.getTwintronId() != null && castOther.getTwintronId() != null && this
				.getTwintronId().equals(castOther.getTwintronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwintronId() == null ? 0 : this.getTwintronId()
						.hashCode());
		result = 37 * result
