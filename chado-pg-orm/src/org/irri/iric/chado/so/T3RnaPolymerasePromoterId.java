...
/**
 * T3RnaPolymerasePromoterId generated by hbm2java
 */
public class T3RnaPolymerasePromoterId implements java.io.Serializable {

	private Integer t3RnaPolymerasePromoterId;
	...
	public T3RnaPolymerasePromoterId() {
	}

	public T3RnaPolymerasePromoterId(Integer t3RnaPolymerasePromoterId,
		...
		this.t3RnaPolymerasePromoterId = t3RnaPolymerasePromoterId;
	...
	public Integer getT3RnaPolymerasePromoterId() {
		return this.t3RnaPolymerasePromoterId;
	}

	public void setT3RnaPolymerasePromoterId(Integer t3RnaPolymerasePromoterId) {
		this.t3RnaPolymerasePromoterId = t3RnaPolymerasePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof T3RnaPolymerasePromoterId))
			return false;
		T3RnaPolymerasePromoterId castOther = (T3RnaPolymerasePromoterId) other;

		return ((this.getT3RnaPolymerasePromoterId() == castOther
				.getT3RnaPolymerasePromoterId()) || (this
				.getT3RnaPolymerasePromoterId() != null
				&& castOther.getT3RnaPolymerasePromoterId() != null && this
				.getT3RnaPolymerasePromoterId().equals(
						castOther.getT3RnaPolymerasePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getT3RnaPolymerasePromoterId() == null ? 0 : this
						.getT3RnaPolymerasePromoterId().hashCode());
		result = 37 * result
