...
/**
 * ExonVariantId generated by hbm2java
 */
public class ExonVariantId implements java.io.Serializable {

	private Integer exonVariantId;
	...
	public ExonVariantId() {
	}

	public ExonVariantId(Integer exonVariantId, Integer featureId,
		...
		this.exonVariantId = exonVariantId;
	...
	public Integer getExonVariantId() {
		return this.exonVariantId;
	}

	public void setExonVariantId(Integer exonVariantId) {
		this.exonVariantId = exonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonVariantId))
			return false;
		ExonVariantId castOther = (ExonVariantId) other;

		return ((this.getExonVariantId() == castOther.getExonVariantId()) || (this
				.getExonVariantId() != null
				&& castOther.getExonVariantId() != null && this
				.getExonVariantId().equals(castOther.getExonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonVariantId() == null ? 0 : this.getExonVariantId()
						.hashCode());
		result = 37 * result
