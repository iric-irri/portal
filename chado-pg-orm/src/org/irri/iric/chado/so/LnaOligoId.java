...
/**
 * LnaOligoId generated by hbm2java
 */
public class LnaOligoId implements java.io.Serializable {

	private Integer lnaOligoId;
	...
	public LnaOligoId(Integer lnaOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLnaOligoId() {
		return this.lnaOligoId;
	}

	public void setLnaOligoId(Integer lnaOligoId) {
		this.lnaOligoId = lnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LnaOligoId))
			return false;
		LnaOligoId castOther = (LnaOligoId) other;

		return ((this.getLnaOligoId() == castOther.getLnaOligoId()) || (this
				.getLnaOligoId() != null && castOther.getLnaOligoId() != null && this
				.getLnaOligoId().equals(castOther.getLnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLnaOligoId() == null ? 0 : this.getLnaOligoId()
						.hashCode());
		result = 37 * result
