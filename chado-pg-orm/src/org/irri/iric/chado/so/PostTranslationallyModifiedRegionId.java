...
/**
 * PostTranslationallyModifiedRegionId generated by hbm2java
 */
public class PostTranslationallyModifiedRegionId implements
		java.io.Serializable {

	private Integer postTranslationallyModifiedRegionId;
	...
	public PostTranslationallyModifiedRegionId() {
	}

	public PostTranslationallyModifiedRegionId(
			Integer postTranslationallyModifiedRegionId, Integer featureId,
		...
		this.postTranslationallyModifiedRegionId = postTranslationallyModifiedRegionId;
	...
	public Integer getPostTranslationallyModifiedRegionId() {
		return this.postTranslationallyModifiedRegionId;
	}

	public void setPostTranslationallyModifiedRegionId(
			Integer postTranslationallyModifiedRegionId) {
		this.postTranslationallyModifiedRegionId = postTranslationallyModifiedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PostTranslationallyModifiedRegionId))
			return false;
		PostTranslationallyModifiedRegionId castOther = (PostTranslationallyModifiedRegionId) other;

		return ((this.getPostTranslationallyModifiedRegionId() == castOther
				.getPostTranslationallyModifiedRegionId()) || (this
				.getPostTranslationallyModifiedRegionId() != null
				&& castOther.getPostTranslationallyModifiedRegionId() != null && this
				.getPostTranslationallyModifiedRegionId().equals(
						castOther.getPostTranslationallyModifiedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPostTranslationallyModifiedRegionId() == null ? 0 : this
						.getPostTranslationallyModifiedRegionId().hashCode());
		result = 37 * result
