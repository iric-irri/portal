...
/**
 * TetraloopId generated by hbm2java
 */
public class TetraloopId implements java.io.Serializable {

	private Integer tetraloopId;
	...
	public TetraloopId(Integer tetraloopId, Integer featureId,
	...
	public Integer getTetraloopId() {
		return this.tetraloopId;
	}

	public void setTetraloopId(Integer tetraloopId) {
		this.tetraloopId = tetraloopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TetraloopId))
			return false;
		TetraloopId castOther = (TetraloopId) other;

		return ((this.getTetraloopId() == castOther.getTetraloopId()) || (this
				.getTetraloopId() != null && castOther.getTetraloopId() != null && this
				.getTetraloopId().equals(castOther.getTetraloopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTetraloopId() == null ? 0 : this.getTetraloopId()
						.hashCode());
		result = 37 * result
