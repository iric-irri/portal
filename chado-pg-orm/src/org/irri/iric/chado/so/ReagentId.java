...
/**
 * ReagentId generated by hbm2java
 */
public class ReagentId implements java.io.Serializable {
	...
	public ReagentId(Integer reagentId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReagentId))
			return false;
		ReagentId castOther = (ReagentId) other;

		return ((this.getReagentId() == castOther.getReagentId()) || (this
				.getReagentId() != null && castOther.getReagentId() != null && this
