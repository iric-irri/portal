...
/**
 * ProplastidGeneId generated by hbm2java
 */
public class ProplastidGeneId implements java.io.Serializable {

	private Integer proplastidGeneId;
	...
	public ProplastidGeneId() {
	}

	public ProplastidGeneId(Integer proplastidGeneId, Integer featureId,
		...
		this.proplastidGeneId = proplastidGeneId;
	...
	public Integer getProplastidGeneId() {
		return this.proplastidGeneId;
	}

	public void setProplastidGeneId(Integer proplastidGeneId) {
		this.proplastidGeneId = proplastidGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProplastidGeneId))
			return false;
		ProplastidGeneId castOther = (ProplastidGeneId) other;

		return ((this.getProplastidGeneId() == castOther.getProplastidGeneId()) || (this
				.getProplastidGeneId() != null
				&& castOther.getProplastidGeneId() != null && this
				.getProplastidGeneId().equals(castOther.getProplastidGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProplastidGeneId() == null ? 0 : this
						.getProplastidGeneId().hashCode());
		result = 37 * result
