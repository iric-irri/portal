...
/**
 * CysteinylTrnaId generated by hbm2java
 */
public class CysteinylTrnaId implements java.io.Serializable {

	private Integer cysteinylTrnaId;
	...
	public CysteinylTrnaId() {
	}

	public CysteinylTrnaId(Integer cysteinylTrnaId, Integer featureId,
		...
		this.cysteinylTrnaId = cysteinylTrnaId;
	...
	public Integer getCysteinylTrnaId() {
		return this.cysteinylTrnaId;
	}

	public void setCysteinylTrnaId(Integer cysteinylTrnaId) {
		this.cysteinylTrnaId = cysteinylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CysteinylTrnaId))
			return false;
		CysteinylTrnaId castOther = (CysteinylTrnaId) other;

		return ((this.getCysteinylTrnaId() == castOther.getCysteinylTrnaId()) || (this
				.getCysteinylTrnaId() != null
				&& castOther.getCysteinylTrnaId() != null && this
				.getCysteinylTrnaId().equals(castOther.getCysteinylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCysteinylTrnaId() == null ? 0 : this.getCysteinylTrnaId()
						.hashCode());
		result = 37 * result
