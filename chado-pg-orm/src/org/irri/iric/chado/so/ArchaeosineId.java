...
/**
 * ArchaeosineId generated by hbm2java
 */
public class ArchaeosineId implements java.io.Serializable {

	private Integer archaeosineId;
	...
	public ArchaeosineId() {
	}

	public ArchaeosineId(Integer archaeosineId, Integer featureId,
		...
		this.archaeosineId = archaeosineId;
	...
	public Integer getArchaeosineId() {
		return this.archaeosineId;
	}

	public void setArchaeosineId(Integer archaeosineId) {
		this.archaeosineId = archaeosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArchaeosineId))
			return false;
		ArchaeosineId castOther = (ArchaeosineId) other;

		return ((this.getArchaeosineId() == castOther.getArchaeosineId()) || (this
				.getArchaeosineId() != null
				&& castOther.getArchaeosineId() != null && this
				.getArchaeosineId().equals(castOther.getArchaeosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getArchaeosineId() == null ? 0 : this.getArchaeosineId()
						.hashCode());
		result = 37 * result
