...
/**
 * FiveHydroxyuridineId generated by hbm2java
 */
public class FiveHydroxyuridineId implements java.io.Serializable {

	private Integer fiveHydroxyuridineId;
	...
	public FiveHydroxyuridineId() {
	}

	public FiveHydroxyuridineId(Integer fiveHydroxyuridineId,
		...
		this.fiveHydroxyuridineId = fiveHydroxyuridineId;
	...
	public Integer getFiveHydroxyuridineId() {
		return this.fiveHydroxyuridineId;
	}

	public void setFiveHydroxyuridineId(Integer fiveHydroxyuridineId) {
		this.fiveHydroxyuridineId = fiveHydroxyuridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveHydroxyuridineId))
			return false;
		FiveHydroxyuridineId castOther = (FiveHydroxyuridineId) other;

		return ((this.getFiveHydroxyuridineId() == castOther
				.getFiveHydroxyuridineId()) || (this.getFiveHydroxyuridineId() != null
				&& castOther.getFiveHydroxyuridineId() != null && this
				.getFiveHydroxyuridineId().equals(
						castOther.getFiveHydroxyuridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveHydroxyuridineId() == null ? 0 : this
						.getFiveHydroxyuridineId().hashCode());
		result = 37 * result
