...
/**
 * MinisatelliteId generated by hbm2java
 */
public class MinisatelliteId implements java.io.Serializable {

	private Integer minisatelliteId;
	...
	public MinisatelliteId() {
	}

	public MinisatelliteId(Integer minisatelliteId, Integer featureId,
		...
		this.minisatelliteId = minisatelliteId;
	...
	public Integer getMinisatelliteId() {
		return this.minisatelliteId;
	}

	public void setMinisatelliteId(Integer minisatelliteId) {
		this.minisatelliteId = minisatelliteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MinisatelliteId))
			return false;
		MinisatelliteId castOther = (MinisatelliteId) other;

		return ((this.getMinisatelliteId() == castOther.getMinisatelliteId()) || (this
				.getMinisatelliteId() != null
				&& castOther.getMinisatelliteId() != null && this
				.getMinisatelliteId().equals(castOther.getMinisatelliteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinisatelliteId() == null ? 0 : this.getMinisatelliteId()
						.hashCode());
		result = 37 * result
