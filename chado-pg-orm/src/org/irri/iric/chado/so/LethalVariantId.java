...
/**
 * LethalVariantId generated by hbm2java
 */
public class LethalVariantId implements java.io.Serializable {

	private Integer lethalVariantId;
	...
	public LethalVariantId() {
	}

	public LethalVariantId(Integer lethalVariantId, Integer featureId,
		...
		this.lethalVariantId = lethalVariantId;
	...
	public Integer getLethalVariantId() {
		return this.lethalVariantId;
	}

	public void setLethalVariantId(Integer lethalVariantId) {
		this.lethalVariantId = lethalVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LethalVariantId))
			return false;
		LethalVariantId castOther = (LethalVariantId) other;

		return ((this.getLethalVariantId() == castOther.getLethalVariantId()) || (this
				.getLethalVariantId() != null
				&& castOther.getLethalVariantId() != null && this
				.getLethalVariantId().equals(castOther.getLethalVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLethalVariantId() == null ? 0 : this.getLethalVariantId()
						.hashCode());
		result = 37 * result
