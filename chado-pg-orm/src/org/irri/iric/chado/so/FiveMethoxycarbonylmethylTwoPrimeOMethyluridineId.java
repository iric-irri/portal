...
/**
 * FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId generated by hbm2java
 */
public class FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId implements
		java.io.Serializable {

	private Integer fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId;
	...
	public FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() {
	}

	public FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId(
			Integer fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId,
		...
		this.fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId = fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId;
	...
	public Integer getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() {
		return this.fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId;
	}

	public void setFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId(
			Integer fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId) {
		this.fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId = fiveMethoxycarbonylmethylTwoPrimeOMethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId))
			return false;
		FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId castOther = (FiveMethoxycarbonylmethylTwoPrimeOMethyluridineId) other;

		return ((this.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() == castOther
				.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId()) || (this
				.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() != null
				&& castOther
						.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() != null && this
				.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId()
				.equals(castOther
						.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId() == null ? 0
						: this.getFiveMethoxycarbonylmethylTwoPrimeOMethyluridineId()
								.hashCode());
		result = 37 * result
