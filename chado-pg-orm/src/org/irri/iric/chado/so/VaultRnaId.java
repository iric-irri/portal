...
/**
 * VaultRnaId generated by hbm2java
 */
public class VaultRnaId implements java.io.Serializable {

	private Integer vaultRnaId;
	...
	public VaultRnaId(Integer vaultRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVaultRnaId() {
		return this.vaultRnaId;
	}

	public void setVaultRnaId(Integer vaultRnaId) {
		this.vaultRnaId = vaultRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VaultRnaId))
			return false;
		VaultRnaId castOther = (VaultRnaId) other;

		return ((this.getVaultRnaId() == castOther.getVaultRnaId()) || (this
				.getVaultRnaId() != null && castOther.getVaultRnaId() != null && this
				.getVaultRnaId().equals(castOther.getVaultRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVaultRnaId() == null ? 0 : this.getVaultRnaId()
						.hashCode());
		result = 37 * result
