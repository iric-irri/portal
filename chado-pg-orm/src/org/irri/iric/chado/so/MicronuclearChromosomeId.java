...
/**
 * MicronuclearChromosomeId generated by hbm2java
 */
public class MicronuclearChromosomeId implements java.io.Serializable {

	private Integer micronuclearChromosomeId;
	...
	public MicronuclearChromosomeId() {
	}

	public MicronuclearChromosomeId(Integer micronuclearChromosomeId,
		...
		this.micronuclearChromosomeId = micronuclearChromosomeId;
	...
	public Integer getMicronuclearChromosomeId() {
		return this.micronuclearChromosomeId;
	}

	public void setMicronuclearChromosomeId(Integer micronuclearChromosomeId) {
		this.micronuclearChromosomeId = micronuclearChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MicronuclearChromosomeId))
			return false;
		MicronuclearChromosomeId castOther = (MicronuclearChromosomeId) other;

		return ((this.getMicronuclearChromosomeId() == castOther
				.getMicronuclearChromosomeId()) || (this
				.getMicronuclearChromosomeId() != null
				&& castOther.getMicronuclearChromosomeId() != null && this
				.getMicronuclearChromosomeId().equals(
						castOther.getMicronuclearChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMicronuclearChromosomeId() == null ? 0 : this
						.getMicronuclearChromosomeId().hashCode());
		result = 37 * result
