...
/**
 * ConsensusRegionId generated by hbm2java
 */
public class ConsensusRegionId implements java.io.Serializable {

	private Integer consensusRegionId;
	...
	public ConsensusRegionId() {
	}

	public ConsensusRegionId(Integer consensusRegionId, Integer featureId,
		...
		this.consensusRegionId = consensusRegionId;
	...
	public Integer getConsensusRegionId() {
		return this.consensusRegionId;
	}

	public void setConsensusRegionId(Integer consensusRegionId) {
		this.consensusRegionId = consensusRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConsensusRegionId))
			return false;
		ConsensusRegionId castOther = (ConsensusRegionId) other;

		return ((this.getConsensusRegionId() == castOther
				.getConsensusRegionId()) || (this.getConsensusRegionId() != null
				&& castOther.getConsensusRegionId() != null && this
				.getConsensusRegionId()
				.equals(castOther.getConsensusRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConsensusRegionId() == null ? 0 : this
						.getConsensusRegionId().hashCode());
		result = 37 * result
