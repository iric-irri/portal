...
/**
 * IMotifId generated by hbm2java
 */
public class IMotifId implements java.io.Serializable {

	private Integer IMotifId;
	...
	public IMotifId(Integer IMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIMotifId() {
		return this.IMotifId;
	}

	public void setIMotifId(Integer IMotifId) {
		this.IMotifId = IMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IMotifId))
			return false;
		IMotifId castOther = (IMotifId) other;

		return ((this.getIMotifId() == castOther.getIMotifId()) || (this
				.getIMotifId() != null && castOther.getIMotifId() != null && this
				.getIMotifId().equals(castOther.getIMotifId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getIMotifId() == null ? 0 : this.getIMotifId().hashCode());
		result = 37 * result
