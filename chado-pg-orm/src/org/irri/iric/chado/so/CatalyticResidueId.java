...
/**
 * CatalyticResidueId generated by hbm2java
 */
public class CatalyticResidueId implements java.io.Serializable {

	private Integer catalyticResidueId;
	...
	public CatalyticResidueId() {
	}

	public CatalyticResidueId(Integer catalyticResidueId, Integer featureId,
		...
		this.catalyticResidueId = catalyticResidueId;
	...
	public Integer getCatalyticResidueId() {
		return this.catalyticResidueId;
	}

	public void setCatalyticResidueId(Integer catalyticResidueId) {
		this.catalyticResidueId = catalyticResidueId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalyticResidueId))
			return false;
		CatalyticResidueId castOther = (CatalyticResidueId) other;

		return ((this.getCatalyticResidueId() == castOther
				.getCatalyticResidueId()) || (this.getCatalyticResidueId() != null
				&& castOther.getCatalyticResidueId() != null && this
				.getCatalyticResidueId().equals(
						castOther.getCatalyticResidueId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCatalyticResidueId() == null ? 0 : this
						.getCatalyticResidueId().hashCode());
		result = 37 * result
