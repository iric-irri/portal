...
/**
 * CentromereDnaElementIiId generated by hbm2java
 */
public class CentromereDnaElementIiId implements java.io.Serializable {

	private Integer centromereDnaElementIiId;
	...
	public CentromereDnaElementIiId() {
	}

	public CentromereDnaElementIiId(Integer centromereDnaElementIiId,
		...
		this.centromereDnaElementIiId = centromereDnaElementIiId;
	...
	public Integer getCentromereDnaElementIiId() {
		return this.centromereDnaElementIiId;
	}

	public void setCentromereDnaElementIiId(Integer centromereDnaElementIiId) {
		this.centromereDnaElementIiId = centromereDnaElementIiId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentromereDnaElementIiId))
			return false;
		CentromereDnaElementIiId castOther = (CentromereDnaElementIiId) other;

		return ((this.getCentromereDnaElementIiId() == castOther
				.getCentromereDnaElementIiId()) || (this
				.getCentromereDnaElementIiId() != null
				&& castOther.getCentromereDnaElementIiId() != null && this
				.getCentromereDnaElementIiId().equals(
						castOther.getCentromereDnaElementIiId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentromereDnaElementIiId() == null ? 0 : this
						.getCentromereDnaElementIiId().hashCode());
		result = 37 * result
