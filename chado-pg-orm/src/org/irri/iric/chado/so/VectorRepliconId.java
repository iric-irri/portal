...
/**
 * VectorRepliconId generated by hbm2java
 */
public class VectorRepliconId implements java.io.Serializable {

	private Integer vectorRepliconId;
	...
	public VectorRepliconId() {
	}

	public VectorRepliconId(Integer vectorRepliconId, Integer featureId,
		...
		this.vectorRepliconId = vectorRepliconId;
	...
	public Integer getVectorRepliconId() {
		return this.vectorRepliconId;
	}

	public void setVectorRepliconId(Integer vectorRepliconId) {
		this.vectorRepliconId = vectorRepliconId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VectorRepliconId))
			return false;
		VectorRepliconId castOther = (VectorRepliconId) other;

		return ((this.getVectorRepliconId() == castOther.getVectorRepliconId()) || (this
				.getVectorRepliconId() != null
				&& castOther.getVectorRepliconId() != null && this
				.getVectorRepliconId().equals(castOther.getVectorRepliconId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVectorRepliconId() == null ? 0 : this
						.getVectorRepliconId().hashCode());
		result = 37 * result
