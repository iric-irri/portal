...
/**
 * GeneWithPolycistronicTranscriptId generated by hbm2java
 */
public class GeneWithPolycistronicTranscriptId implements java.io.Serializable {

	private Integer geneWithPolycistronicTranscriptId;
	...
	public GeneWithPolycistronicTranscriptId() {
	}

	public GeneWithPolycistronicTranscriptId(
			Integer geneWithPolycistronicTranscriptId, Integer featureId,
		...
		this.geneWithPolycistronicTranscriptId = geneWithPolycistronicTranscriptId;
	...
	public Integer getGeneWithPolycistronicTranscriptId() {
		return this.geneWithPolycistronicTranscriptId;
	}

	public void setGeneWithPolycistronicTranscriptId(
			Integer geneWithPolycistronicTranscriptId) {
		this.geneWithPolycistronicTranscriptId = geneWithPolycistronicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithPolycistronicTranscriptId))
			return false;
		GeneWithPolycistronicTranscriptId castOther = (GeneWithPolycistronicTranscriptId) other;

		return ((this.getGeneWithPolycistronicTranscriptId() == castOther
				.getGeneWithPolycistronicTranscriptId()) || (this
				.getGeneWithPolycistronicTranscriptId() != null
				&& castOther.getGeneWithPolycistronicTranscriptId() != null && this
				.getGeneWithPolycistronicTranscriptId().equals(
						castOther.getGeneWithPolycistronicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithPolycistronicTranscriptId() == null ? 0 : this
						.getGeneWithPolycistronicTranscriptId().hashCode());
		result = 37 * result
