...
/**
 * BetaTurnTypeSixAOneId generated by hbm2java
 */
public class BetaTurnTypeSixAOneId implements java.io.Serializable {

	private Integer betaTurnTypeSixAOneId;
	...
	public BetaTurnTypeSixAOneId() {
	}

	public BetaTurnTypeSixAOneId(Integer betaTurnTypeSixAOneId,
		...
		this.betaTurnTypeSixAOneId = betaTurnTypeSixAOneId;
	...
	public Integer getBetaTurnTypeSixAOneId() {
		return this.betaTurnTypeSixAOneId;
	}

	public void setBetaTurnTypeSixAOneId(Integer betaTurnTypeSixAOneId) {
		this.betaTurnTypeSixAOneId = betaTurnTypeSixAOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeSixAOneId))
			return false;
		BetaTurnTypeSixAOneId castOther = (BetaTurnTypeSixAOneId) other;

		return ((this.getBetaTurnTypeSixAOneId() == castOther
				.getBetaTurnTypeSixAOneId()) || (this
				.getBetaTurnTypeSixAOneId() != null
				&& castOther.getBetaTurnTypeSixAOneId() != null && this
				.getBetaTurnTypeSixAOneId().equals(
						castOther.getBetaTurnTypeSixAOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeSixAOneId() == null ? 0 : this
						.getBetaTurnTypeSixAOneId().hashCode());
		result = 37 * result
