...
/**
 * TilingPathFragmentId generated by hbm2java
 */
public class TilingPathFragmentId implements java.io.Serializable {

	private Integer tilingPathFragmentId;
	...
	public TilingPathFragmentId() {
	}

	public TilingPathFragmentId(Integer tilingPathFragmentId,
		...
		this.tilingPathFragmentId = tilingPathFragmentId;
	...
	public Integer getTilingPathFragmentId() {
		return this.tilingPathFragmentId;
	}

	public void setTilingPathFragmentId(Integer tilingPathFragmentId) {
		this.tilingPathFragmentId = tilingPathFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TilingPathFragmentId))
			return false;
		TilingPathFragmentId castOther = (TilingPathFragmentId) other;

		return ((this.getTilingPathFragmentId() == castOther
				.getTilingPathFragmentId()) || (this.getTilingPathFragmentId() != null
				&& castOther.getTilingPathFragmentId() != null && this
				.getTilingPathFragmentId().equals(
						castOther.getTilingPathFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTilingPathFragmentId() == null ? 0 : this
						.getTilingPathFragmentId().hashCode());
		result = 37 * result
