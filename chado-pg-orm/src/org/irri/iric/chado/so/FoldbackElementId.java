...
/**
 * FoldbackElementId generated by hbm2java
 */
public class FoldbackElementId implements java.io.Serializable {

	private Integer foldbackElementId;
	...
	public FoldbackElementId() {
	}

	public FoldbackElementId(Integer foldbackElementId, Integer featureId,
		...
		this.foldbackElementId = foldbackElementId;
	...
	public Integer getFoldbackElementId() {
		return this.foldbackElementId;
	}

	public void setFoldbackElementId(Integer foldbackElementId) {
		this.foldbackElementId = foldbackElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FoldbackElementId))
			return false;
		FoldbackElementId castOther = (FoldbackElementId) other;

		return ((this.getFoldbackElementId() == castOther
				.getFoldbackElementId()) || (this.getFoldbackElementId() != null
				&& castOther.getFoldbackElementId() != null && this
				.getFoldbackElementId()
				.equals(castOther.getFoldbackElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFoldbackElementId() == null ? 0 : this
						.getFoldbackElementId().hashCode());
		result = 37 * result
