...
/**
 * DGeneRecombinationFeatureId generated by hbm2java
 */
public class DGeneRecombinationFeatureId implements java.io.Serializable {

	private Integer DGeneRecombinationFeatureId;
	...
	public DGeneRecombinationFeatureId() {
	}

	public DGeneRecombinationFeatureId(Integer DGeneRecombinationFeatureId,
		...
		this.DGeneRecombinationFeatureId = DGeneRecombinationFeatureId;
	...
	public Integer getDGeneRecombinationFeatureId() {
		return this.DGeneRecombinationFeatureId;
	}

	public void setDGeneRecombinationFeatureId(
			Integer DGeneRecombinationFeatureId) {
		this.DGeneRecombinationFeatureId = DGeneRecombinationFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DGeneRecombinationFeatureId))
			return false;
		DGeneRecombinationFeatureId castOther = (DGeneRecombinationFeatureId) other;

		return ((this.getDGeneRecombinationFeatureId() == castOther
				.getDGeneRecombinationFeatureId()) || (this
				.getDGeneRecombinationFeatureId() != null
				&& castOther.getDGeneRecombinationFeatureId() != null && this
				.getDGeneRecombinationFeatureId().equals(
						castOther.getDGeneRecombinationFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDGeneRecombinationFeatureId() == null ? 0 : this
						.getDGeneRecombinationFeatureId().hashCode());
		result = 37 * result
