...
/**
 * RescueRegionId generated by hbm2java
 */
public class RescueRegionId implements java.io.Serializable {

	private Integer rescueRegionId;
	...
	public RescueRegionId() {
	}

	public RescueRegionId(Integer rescueRegionId, Integer featureId,
		...
		this.rescueRegionId = rescueRegionId;
	...
	public Integer getRescueRegionId() {
		return this.rescueRegionId;
	}

	public void setRescueRegionId(Integer rescueRegionId) {
		this.rescueRegionId = rescueRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RescueRegionId))
			return false;
		RescueRegionId castOther = (RescueRegionId) other;

		return ((this.getRescueRegionId() == castOther.getRescueRegionId()) || (this
				.getRescueRegionId() != null
				&& castOther.getRescueRegionId() != null && this
				.getRescueRegionId().equals(castOther.getRescueRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRescueRegionId() == null ? 0 : this.getRescueRegionId()
						.hashCode());
		result = 37 * result
