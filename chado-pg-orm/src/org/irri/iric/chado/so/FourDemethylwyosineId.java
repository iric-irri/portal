...
/**
 * FourDemethylwyosineId generated by hbm2java
 */
public class FourDemethylwyosineId implements java.io.Serializable {

	private Integer fourDemethylwyosineId;
	...
	public FourDemethylwyosineId() {
	}

	public FourDemethylwyosineId(Integer fourDemethylwyosineId,
		...
		this.fourDemethylwyosineId = fourDemethylwyosineId;
	...
	public Integer getFourDemethylwyosineId() {
		return this.fourDemethylwyosineId;
	}

	public void setFourDemethylwyosineId(Integer fourDemethylwyosineId) {
		this.fourDemethylwyosineId = fourDemethylwyosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FourDemethylwyosineId))
			return false;
		FourDemethylwyosineId castOther = (FourDemethylwyosineId) other;

		return ((this.getFourDemethylwyosineId() == castOther
				.getFourDemethylwyosineId()) || (this
				.getFourDemethylwyosineId() != null
				&& castOther.getFourDemethylwyosineId() != null && this
				.getFourDemethylwyosineId().equals(
						castOther.getFourDemethylwyosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFourDemethylwyosineId() == null ? 0 : this
						.getFourDemethylwyosineId().hashCode());
		result = 37 * result
