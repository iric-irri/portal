...
/**
 * IntermediateElementId generated by hbm2java
 */
public class IntermediateElementId implements java.io.Serializable {

	private Integer intermediateElementId;
	...
	public IntermediateElementId() {
	}

	public IntermediateElementId(Integer intermediateElementId,
		...
		this.intermediateElementId = intermediateElementId;
	...
	public Integer getIntermediateElementId() {
		return this.intermediateElementId;
	}

	public void setIntermediateElementId(Integer intermediateElementId) {
		this.intermediateElementId = intermediateElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntermediateElementId))
			return false;
		IntermediateElementId castOther = (IntermediateElementId) other;

		return ((this.getIntermediateElementId() == castOther
				.getIntermediateElementId()) || (this
				.getIntermediateElementId() != null
				&& castOther.getIntermediateElementId() != null && this
				.getIntermediateElementId().equals(
						castOther.getIntermediateElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntermediateElementId() == null ? 0 : this
						.getIntermediateElementId().hashCode());
		result = 37 * result
