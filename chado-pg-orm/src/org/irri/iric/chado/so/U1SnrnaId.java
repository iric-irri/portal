...
/**
 * U1SnrnaId generated by hbm2java
 */
public class U1SnrnaId implements java.io.Serializable {

	private Integer u1SnrnaId;
	...
	public U1SnrnaId(Integer u1SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU1SnrnaId() {
		return this.u1SnrnaId;
	}

	public void setU1SnrnaId(Integer u1SnrnaId) {
		this.u1SnrnaId = u1SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U1SnrnaId))
			return false;
		U1SnrnaId castOther = (U1SnrnaId) other;

		return ((this.getU1SnrnaId() == castOther.getU1SnrnaId()) || (this
				.getU1SnrnaId() != null && castOther.getU1SnrnaId() != null && this
				.getU1SnrnaId().equals(castOther.getU1SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getU1SnrnaId() == null ? 0 : this.getU1SnrnaId().hashCode());
		result = 37 * result
