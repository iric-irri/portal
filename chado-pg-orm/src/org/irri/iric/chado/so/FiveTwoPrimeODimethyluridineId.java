...
/**
 * FiveTwoPrimeODimethyluridineId generated by hbm2java
 */
public class FiveTwoPrimeODimethyluridineId implements java.io.Serializable {

	private Integer fiveTwoPrimeODimethyluridineId;
	...
	public FiveTwoPrimeODimethyluridineId() {
	}

	public FiveTwoPrimeODimethyluridineId(
			Integer fiveTwoPrimeODimethyluridineId, Integer featureId,
		...
		this.fiveTwoPrimeODimethyluridineId = fiveTwoPrimeODimethyluridineId;
	...
	public Integer getFiveTwoPrimeODimethyluridineId() {
		return this.fiveTwoPrimeODimethyluridineId;
	}

	public void setFiveTwoPrimeODimethyluridineId(
			Integer fiveTwoPrimeODimethyluridineId) {
		this.fiveTwoPrimeODimethyluridineId = fiveTwoPrimeODimethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveTwoPrimeODimethyluridineId))
			return false;
		FiveTwoPrimeODimethyluridineId castOther = (FiveTwoPrimeODimethyluridineId) other;

		return ((this.getFiveTwoPrimeODimethyluridineId() == castOther
				.getFiveTwoPrimeODimethyluridineId()) || (this
				.getFiveTwoPrimeODimethyluridineId() != null
				&& castOther.getFiveTwoPrimeODimethyluridineId() != null && this
				.getFiveTwoPrimeODimethyluridineId().equals(
						castOther.getFiveTwoPrimeODimethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveTwoPrimeODimethyluridineId() == null ? 0 : this
						.getFiveTwoPrimeODimethyluridineId().hashCode());
		result = 37 * result
