...
/**
 * SoNaturalId generated by hbm2java
 */
public class SoNaturalId implements java.io.Serializable {

	private Integer soNaturalId;
	...
	public SoNaturalId(Integer soNaturalId, Integer featureId,
	...
	public Integer getSoNaturalId() {
		return this.soNaturalId;
	}

	public void setSoNaturalId(Integer soNaturalId) {
		this.soNaturalId = soNaturalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SoNaturalId))
			return false;
		SoNaturalId castOther = (SoNaturalId) other;

		return ((this.getSoNaturalId() == castOther.getSoNaturalId()) || (this
				.getSoNaturalId() != null && castOther.getSoNaturalId() != null && this
				.getSoNaturalId().equals(castOther.getSoNaturalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSoNaturalId() == null ? 0 : this.getSoNaturalId()
						.hashCode());
		result = 37 * result
