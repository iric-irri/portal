...
/**
 * ThreePrimeEstId generated by hbm2java
 */
public class ThreePrimeEstId implements java.io.Serializable {

	private Integer threePrimeEstId;
	...
	public ThreePrimeEstId() {
	}

	public ThreePrimeEstId(Integer threePrimeEstId, Integer featureId,
		...
		this.threePrimeEstId = threePrimeEstId;
	...
	public Integer getThreePrimeEstId() {
		return this.threePrimeEstId;
	}

	public void setThreePrimeEstId(Integer threePrimeEstId) {
		this.threePrimeEstId = threePrimeEstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeEstId))
			return false;
		ThreePrimeEstId castOther = (ThreePrimeEstId) other;

		return ((this.getThreePrimeEstId() == castOther.getThreePrimeEstId()) || (this
				.getThreePrimeEstId() != null
				&& castOther.getThreePrimeEstId() != null && this
				.getThreePrimeEstId().equals(castOther.getThreePrimeEstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeEstId() == null ? 0 : this.getThreePrimeEstId()
						.hashCode());
		result = 37 * result
