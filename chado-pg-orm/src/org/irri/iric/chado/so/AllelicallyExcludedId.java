...
/**
 * AllelicallyExcludedId generated by hbm2java
 */
public class AllelicallyExcludedId implements java.io.Serializable {

	private Integer allelicallyExcludedId;
	...
	public AllelicallyExcludedId() {
	}

	public AllelicallyExcludedId(Integer allelicallyExcludedId,
		...
		this.allelicallyExcludedId = allelicallyExcludedId;
	...
	public Integer getAllelicallyExcludedId() {
		return this.allelicallyExcludedId;
	}

	public void setAllelicallyExcludedId(Integer allelicallyExcludedId) {
		this.allelicallyExcludedId = allelicallyExcludedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AllelicallyExcludedId))
			return false;
		AllelicallyExcludedId castOther = (AllelicallyExcludedId) other;

		return ((this.getAllelicallyExcludedId() == castOther
				.getAllelicallyExcludedId()) || (this
				.getAllelicallyExcludedId() != null
				&& castOther.getAllelicallyExcludedId() != null && this
				.getAllelicallyExcludedId().equals(
						castOther.getAllelicallyExcludedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAllelicallyExcludedId() == null ? 0 : this
						.getAllelicallyExcludedId().hashCode());
		result = 37 * result
