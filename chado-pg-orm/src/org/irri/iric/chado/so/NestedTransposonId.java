...
/**
 * NestedTransposonId generated by hbm2java
 */
public class NestedTransposonId implements java.io.Serializable {

	private Integer nestedTransposonId;
	...
	public NestedTransposonId() {
	}

	public NestedTransposonId(Integer nestedTransposonId, Integer featureId,
		...
		this.nestedTransposonId = nestedTransposonId;
	...
	public Integer getNestedTransposonId() {
		return this.nestedTransposonId;
	}

	public void setNestedTransposonId(Integer nestedTransposonId) {
		this.nestedTransposonId = nestedTransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NestedTransposonId))
			return false;
		NestedTransposonId castOther = (NestedTransposonId) other;

		return ((this.getNestedTransposonId() == castOther
				.getNestedTransposonId()) || (this.getNestedTransposonId() != null
				&& castOther.getNestedTransposonId() != null && this
				.getNestedTransposonId().equals(
						castOther.getNestedTransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNestedTransposonId() == null ? 0 : this
						.getNestedTransposonId().hashCode());
		result = 37 * result
