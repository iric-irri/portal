...
/**
 * ModifiedInosineId generated by hbm2java
 */
public class ModifiedInosineId implements java.io.Serializable {

	private Integer modifiedInosineId;
	...
	public ModifiedInosineId() {
	}

	public ModifiedInosineId(Integer modifiedInosineId, Integer featureId,
		...
		this.modifiedInosineId = modifiedInosineId;
	...
	public Integer getModifiedInosineId() {
		return this.modifiedInosineId;
	}

	public void setModifiedInosineId(Integer modifiedInosineId) {
		this.modifiedInosineId = modifiedInosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedInosineId))
			return false;
		ModifiedInosineId castOther = (ModifiedInosineId) other;

		return ((this.getModifiedInosineId() == castOther
				.getModifiedInosineId()) || (this.getModifiedInosineId() != null
				&& castOther.getModifiedInosineId() != null && this
				.getModifiedInosineId()
				.equals(castOther.getModifiedInosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedInosineId() == null ? 0 : this
						.getModifiedInosineId().hashCode());
		result = 37 * result
