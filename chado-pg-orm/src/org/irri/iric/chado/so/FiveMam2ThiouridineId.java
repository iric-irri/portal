...
/**
 * FiveMam2ThiouridineId generated by hbm2java
 */
public class FiveMam2ThiouridineId implements java.io.Serializable {

	private Integer fiveMam2ThiouridineId;
	...
	public FiveMam2ThiouridineId() {
	}

	public FiveMam2ThiouridineId(Integer fiveMam2ThiouridineId,
		...
		this.fiveMam2ThiouridineId = fiveMam2ThiouridineId;
	...
	public Integer getFiveMam2ThiouridineId() {
		return this.fiveMam2ThiouridineId;
	}

	public void setFiveMam2ThiouridineId(Integer fiveMam2ThiouridineId) {
		this.fiveMam2ThiouridineId = fiveMam2ThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMam2ThiouridineId))
			return false;
		FiveMam2ThiouridineId castOther = (FiveMam2ThiouridineId) other;

		return ((this.getFiveMam2ThiouridineId() == castOther
				.getFiveMam2ThiouridineId()) || (this
				.getFiveMam2ThiouridineId() != null
				&& castOther.getFiveMam2ThiouridineId() != null && this
				.getFiveMam2ThiouridineId().equals(
						castOther.getFiveMam2ThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMam2ThiouridineId() == null ? 0 : this
						.getFiveMam2ThiouridineId().hashCode());
		result = 37 * result
