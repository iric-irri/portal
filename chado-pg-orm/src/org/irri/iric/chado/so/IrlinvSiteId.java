...
/**
 * IrlinvSiteId generated by hbm2java
 */
public class IrlinvSiteId implements java.io.Serializable {

	private Integer irlinvSiteId;
	...
	public IrlinvSiteId(Integer irlinvSiteId, Integer featureId,
		...
		this.irlinvSiteId = irlinvSiteId;
	...
	public Integer getIrlinvSiteId() {
		return this.irlinvSiteId;
	}

	public void setIrlinvSiteId(Integer irlinvSiteId) {
		this.irlinvSiteId = irlinvSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IrlinvSiteId))
			return false;
		IrlinvSiteId castOther = (IrlinvSiteId) other;

		return ((this.getIrlinvSiteId() == castOther.getIrlinvSiteId()) || (this
				.getIrlinvSiteId() != null
				&& castOther.getIrlinvSiteId() != null && this
				.getIrlinvSiteId().equals(castOther.getIrlinvSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIrlinvSiteId() == null ? 0 : this.getIrlinvSiteId()
						.hashCode());
		result = 37 * result
