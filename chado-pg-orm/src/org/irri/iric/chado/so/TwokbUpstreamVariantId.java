...
/**
 * TwokbUpstreamVariantId generated by hbm2java
 */
public class TwokbUpstreamVariantId implements java.io.Serializable {

	private Integer twokbUpstreamVariantId;
	...
	public TwokbUpstreamVariantId() {
	}

	public TwokbUpstreamVariantId(Integer twokbUpstreamVariantId,
		...
		this.twokbUpstreamVariantId = twokbUpstreamVariantId;
	...
	public Integer getTwokbUpstreamVariantId() {
		return this.twokbUpstreamVariantId;
	}

	public void setTwokbUpstreamVariantId(Integer twokbUpstreamVariantId) {
		this.twokbUpstreamVariantId = twokbUpstreamVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwokbUpstreamVariantId))
			return false;
		TwokbUpstreamVariantId castOther = (TwokbUpstreamVariantId) other;

		return ((this.getTwokbUpstreamVariantId() == castOther
				.getTwokbUpstreamVariantId()) || (this
				.getTwokbUpstreamVariantId() != null
				&& castOther.getTwokbUpstreamVariantId() != null && this
				.getTwokbUpstreamVariantId().equals(
						castOther.getTwokbUpstreamVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwokbUpstreamVariantId() == null ? 0 : this
						.getTwokbUpstreamVariantId().hashCode());
		result = 37 * result
