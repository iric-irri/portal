...
/**
 * Sl12AcceptorSiteId generated by hbm2java
 */
public class Sl12AcceptorSiteId implements java.io.Serializable {

	private Integer sl12AcceptorSiteId;
	...
	public Sl12AcceptorSiteId() {
	}

	public Sl12AcceptorSiteId(Integer sl12AcceptorSiteId, Integer featureId,
		...
		this.sl12AcceptorSiteId = sl12AcceptorSiteId;
	...
	public Integer getSl12AcceptorSiteId() {
		return this.sl12AcceptorSiteId;
	}

	public void setSl12AcceptorSiteId(Integer sl12AcceptorSiteId) {
		this.sl12AcceptorSiteId = sl12AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl12AcceptorSiteId))
			return false;
		Sl12AcceptorSiteId castOther = (Sl12AcceptorSiteId) other;

		return ((this.getSl12AcceptorSiteId() == castOther
				.getSl12AcceptorSiteId()) || (this.getSl12AcceptorSiteId() != null
				&& castOther.getSl12AcceptorSiteId() != null && this
				.getSl12AcceptorSiteId().equals(
						castOther.getSl12AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl12AcceptorSiteId() == null ? 0 : this
						.getSl12AcceptorSiteId().hashCode());
		result = 37 * result
