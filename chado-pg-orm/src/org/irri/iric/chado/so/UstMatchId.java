...
/**
 * UstMatchId generated by hbm2java
 */
public class UstMatchId implements java.io.Serializable {

	private Integer ustMatchId;
	...
	public UstMatchId(Integer ustMatchId, Integer featureId, Integer dbxrefId,
	...
	public Integer getUstMatchId() {
		return this.ustMatchId;
	}

	public void setUstMatchId(Integer ustMatchId) {
		this.ustMatchId = ustMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UstMatchId))
			return false;
		UstMatchId castOther = (UstMatchId) other;

		return ((this.getUstMatchId() == castOther.getUstMatchId()) || (this
				.getUstMatchId() != null && castOther.getUstMatchId() != null && this
				.getUstMatchId().equals(castOther.getUstMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUstMatchId() == null ? 0 : this.getUstMatchId()
						.hashCode());
		result = 37 * result
