...
/**
 * AptamerId generated by hbm2java
 */
public class AptamerId implements java.io.Serializable {

	private Integer aptamerId;
	...
	public AptamerId(Integer aptamerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAptamerId() {
		return this.aptamerId;
	}

	public void setAptamerId(Integer aptamerId) {
		this.aptamerId = aptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AptamerId))
			return false;
		AptamerId castOther = (AptamerId) other;

		return ((this.getAptamerId() == castOther.getAptamerId()) || (this
				.getAptamerId() != null && castOther.getAptamerId() != null && this
				.getAptamerId().equals(castOther.getAptamerId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getAptamerId() == null ? 0 : this.getAptamerId().hashCode());
		result = 37 * result
