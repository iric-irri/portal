...
/**
 * InvertedInsertionalDuplicationId generated by hbm2java
 */
public class InvertedInsertionalDuplicationId implements java.io.Serializable {

	private Integer invertedInsertionalDuplicationId;
	...
	public InvertedInsertionalDuplicationId() {
	}

	public InvertedInsertionalDuplicationId(
			Integer invertedInsertionalDuplicationId, Integer featureId,
		...
		this.invertedInsertionalDuplicationId = invertedInsertionalDuplicationId;
	...
	public Integer getInvertedInsertionalDuplicationId() {
		return this.invertedInsertionalDuplicationId;
	}

	public void setInvertedInsertionalDuplicationId(
			Integer invertedInsertionalDuplicationId) {
		this.invertedInsertionalDuplicationId = invertedInsertionalDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertedInsertionalDuplicationId))
			return false;
		InvertedInsertionalDuplicationId castOther = (InvertedInsertionalDuplicationId) other;

		return ((this.getInvertedInsertionalDuplicationId() == castOther
				.getInvertedInsertionalDuplicationId()) || (this
				.getInvertedInsertionalDuplicationId() != null
				&& castOther.getInvertedInsertionalDuplicationId() != null && this
				.getInvertedInsertionalDuplicationId().equals(
						castOther.getInvertedInsertionalDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertedInsertionalDuplicationId() == null ? 0 : this
						.getInvertedInsertionalDuplicationId().hashCode());
		result = 37 * result
