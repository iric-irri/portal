...
/**
 * HydroxywybutosineId generated by hbm2java
 */
public class HydroxywybutosineId implements java.io.Serializable {

	private Integer hydroxywybutosineId;
	...
	public HydroxywybutosineId() {
	}

	public HydroxywybutosineId(Integer hydroxywybutosineId, Integer featureId,
		...
		this.hydroxywybutosineId = hydroxywybutosineId;
	...
	public Integer getHydroxywybutosineId() {
		return this.hydroxywybutosineId;
	}

	public void setHydroxywybutosineId(Integer hydroxywybutosineId) {
		this.hydroxywybutosineId = hydroxywybutosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HydroxywybutosineId))
			return false;
		HydroxywybutosineId castOther = (HydroxywybutosineId) other;

		return ((this.getHydroxywybutosineId() == castOther
				.getHydroxywybutosineId()) || (this.getHydroxywybutosineId() != null
				&& castOther.getHydroxywybutosineId() != null && this
				.getHydroxywybutosineId().equals(
						castOther.getHydroxywybutosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHydroxywybutosineId() == null ? 0 : this
						.getHydroxywybutosineId().hashCode());
		result = 37 * result
