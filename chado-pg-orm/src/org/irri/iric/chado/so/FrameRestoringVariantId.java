...
/**
 * FrameRestoringVariantId generated by hbm2java
 */
public class FrameRestoringVariantId implements java.io.Serializable {

	private Integer frameRestoringVariantId;
	...
	public FrameRestoringVariantId() {
	}

	public FrameRestoringVariantId(Integer frameRestoringVariantId,
		...
		this.frameRestoringVariantId = frameRestoringVariantId;
	...
	public Integer getFrameRestoringVariantId() {
		return this.frameRestoringVariantId;
	}

	public void setFrameRestoringVariantId(Integer frameRestoringVariantId) {
		this.frameRestoringVariantId = frameRestoringVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FrameRestoringVariantId))
			return false;
		FrameRestoringVariantId castOther = (FrameRestoringVariantId) other;

		return ((this.getFrameRestoringVariantId() == castOther
				.getFrameRestoringVariantId()) || (this
				.getFrameRestoringVariantId() != null
				&& castOther.getFrameRestoringVariantId() != null && this
				.getFrameRestoringVariantId().equals(
						castOther.getFrameRestoringVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFrameRestoringVariantId() == null ? 0 : this
						.getFrameRestoringVariantId().hashCode());
		result = 37 * result
