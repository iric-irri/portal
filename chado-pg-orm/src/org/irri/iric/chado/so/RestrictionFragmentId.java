...
/**
 * RestrictionFragmentId generated by hbm2java
 */
public class RestrictionFragmentId implements java.io.Serializable {

	private Integer restrictionFragmentId;
	...
	public RestrictionFragmentId() {
	}

	public RestrictionFragmentId(Integer restrictionFragmentId,
		...
		this.restrictionFragmentId = restrictionFragmentId;
	...
	public Integer getRestrictionFragmentId() {
		return this.restrictionFragmentId;
	}

	public void setRestrictionFragmentId(Integer restrictionFragmentId) {
		this.restrictionFragmentId = restrictionFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RestrictionFragmentId))
			return false;
		RestrictionFragmentId castOther = (RestrictionFragmentId) other;

		return ((this.getRestrictionFragmentId() == castOther
				.getRestrictionFragmentId()) || (this
				.getRestrictionFragmentId() != null
				&& castOther.getRestrictionFragmentId() != null && this
				.getRestrictionFragmentId().equals(
						castOther.getRestrictionFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRestrictionFragmentId() == null ? 0 : this
						.getRestrictionFragmentId().hashCode());
		result = 37 * result
