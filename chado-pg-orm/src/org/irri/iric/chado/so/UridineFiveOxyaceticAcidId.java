...
/**
 * UridineFiveOxyaceticAcidId generated by hbm2java
 */
public class UridineFiveOxyaceticAcidId implements java.io.Serializable {

	private Integer uridineFiveOxyaceticAcidId;
	...
	public UridineFiveOxyaceticAcidId() {
	}

	public UridineFiveOxyaceticAcidId(Integer uridineFiveOxyaceticAcidId,
		...
		this.uridineFiveOxyaceticAcidId = uridineFiveOxyaceticAcidId;
	...
	public Integer getUridineFiveOxyaceticAcidId() {
		return this.uridineFiveOxyaceticAcidId;
	}

	public void setUridineFiveOxyaceticAcidId(Integer uridineFiveOxyaceticAcidId) {
		this.uridineFiveOxyaceticAcidId = uridineFiveOxyaceticAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UridineFiveOxyaceticAcidId))
			return false;
		UridineFiveOxyaceticAcidId castOther = (UridineFiveOxyaceticAcidId) other;

		return ((this.getUridineFiveOxyaceticAcidId() == castOther
				.getUridineFiveOxyaceticAcidId()) || (this
				.getUridineFiveOxyaceticAcidId() != null
				&& castOther.getUridineFiveOxyaceticAcidId() != null && this
				.getUridineFiveOxyaceticAcidId().equals(
						castOther.getUridineFiveOxyaceticAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUridineFiveOxyaceticAcidId() == null ? 0 : this
						.getUridineFiveOxyaceticAcidId().hashCode());
		result = 37 * result
