...
/**
 * AsxTurnId generated by hbm2java
 */
public class AsxTurnId implements java.io.Serializable {

	private Integer asxTurnId;
	...
	public AsxTurnId(Integer asxTurnId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAsxTurnId() {
		return this.asxTurnId;
	}

	public void setAsxTurnId(Integer asxTurnId) {
		this.asxTurnId = asxTurnId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxTurnId))
			return false;
		AsxTurnId castOther = (AsxTurnId) other;

		return ((this.getAsxTurnId() == castOther.getAsxTurnId()) || (this
				.getAsxTurnId() != null && castOther.getAsxTurnId() != null && this
				.getAsxTurnId().equals(castOther.getAsxTurnId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getAsxTurnId() == null ? 0 : this.getAsxTurnId().hashCode());
		result = 37 * result
