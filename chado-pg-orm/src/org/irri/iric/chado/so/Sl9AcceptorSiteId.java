...
/**
 * Sl9AcceptorSiteId generated by hbm2java
 */
public class Sl9AcceptorSiteId implements java.io.Serializable {

	private Integer sl9AcceptorSiteId;
	...
	public Sl9AcceptorSiteId() {
	}

	public Sl9AcceptorSiteId(Integer sl9AcceptorSiteId, Integer featureId,
		...
		this.sl9AcceptorSiteId = sl9AcceptorSiteId;
	...
	public Integer getSl9AcceptorSiteId() {
		return this.sl9AcceptorSiteId;
	}

	public void setSl9AcceptorSiteId(Integer sl9AcceptorSiteId) {
		this.sl9AcceptorSiteId = sl9AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl9AcceptorSiteId))
			return false;
		Sl9AcceptorSiteId castOther = (Sl9AcceptorSiteId) other;

		return ((this.getSl9AcceptorSiteId() == castOther
				.getSl9AcceptorSiteId()) || (this.getSl9AcceptorSiteId() != null
				&& castOther.getSl9AcceptorSiteId() != null && this
				.getSl9AcceptorSiteId()
				.equals(castOther.getSl9AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl9AcceptorSiteId() == null ? 0 : this
						.getSl9AcceptorSiteId().hashCode());
		result = 37 * result
