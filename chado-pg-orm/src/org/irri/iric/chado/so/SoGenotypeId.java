...
/**
 * SoGenotypeId generated by hbm2java
 */
public class SoGenotypeId implements java.io.Serializable {

	private Integer soGenotypeId;
	...
	public SoGenotypeId(Integer soGenotypeId, Integer featureId,
		...
		this.soGenotypeId = soGenotypeId;
	...
	public Integer getSoGenotypeId() {
		return this.soGenotypeId;
	}

	public void setSoGenotypeId(Integer soGenotypeId) {
		this.soGenotypeId = soGenotypeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SoGenotypeId))
			return false;
		SoGenotypeId castOther = (SoGenotypeId) other;

		return ((this.getSoGenotypeId() == castOther.getSoGenotypeId()) || (this
				.getSoGenotypeId() != null
				&& castOther.getSoGenotypeId() != null && this
				.getSoGenotypeId().equals(castOther.getSoGenotypeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSoGenotypeId() == null ? 0 : this.getSoGenotypeId()
						.hashCode());
		result = 37 * result
