...
/**
 * RestrictionEnzymeCleavageJunctionId generated by hbm2java
 */
public class RestrictionEnzymeCleavageJunctionId implements
		java.io.Serializable {

	private Integer restrictionEnzymeCleavageJunctionId;
	...
	public RestrictionEnzymeCleavageJunctionId() {
	}

	public RestrictionEnzymeCleavageJunctionId(
			Integer restrictionEnzymeCleavageJunctionId, Integer featureId,
		...
		this.restrictionEnzymeCleavageJunctionId = restrictionEnzymeCleavageJunctionId;
	...
	public Integer getRestrictionEnzymeCleavageJunctionId() {
		return this.restrictionEnzymeCleavageJunctionId;
	}

	public void setRestrictionEnzymeCleavageJunctionId(
			Integer restrictionEnzymeCleavageJunctionId) {
		this.restrictionEnzymeCleavageJunctionId = restrictionEnzymeCleavageJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RestrictionEnzymeCleavageJunctionId))
			return false;
		RestrictionEnzymeCleavageJunctionId castOther = (RestrictionEnzymeCleavageJunctionId) other;

		return ((this.getRestrictionEnzymeCleavageJunctionId() == castOther
				.getRestrictionEnzymeCleavageJunctionId()) || (this
				.getRestrictionEnzymeCleavageJunctionId() != null
				&& castOther.getRestrictionEnzymeCleavageJunctionId() != null && this
				.getRestrictionEnzymeCleavageJunctionId().equals(
						castOther.getRestrictionEnzymeCleavageJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRestrictionEnzymeCleavageJunctionId() == null ? 0 : this
						.getRestrictionEnzymeCleavageJunctionId().hashCode());
		result = 37 * result
