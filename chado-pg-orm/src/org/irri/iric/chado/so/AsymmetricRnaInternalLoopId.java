...
/**
 * AsymmetricRnaInternalLoopId generated by hbm2java
 */
public class AsymmetricRnaInternalLoopId implements java.io.Serializable {

	private Integer asymmetricRnaInternalLoopId;
	...
	public AsymmetricRnaInternalLoopId() {
	}

	public AsymmetricRnaInternalLoopId(Integer asymmetricRnaInternalLoopId,
		...
		this.asymmetricRnaInternalLoopId = asymmetricRnaInternalLoopId;
	...
	public Integer getAsymmetricRnaInternalLoopId() {
		return this.asymmetricRnaInternalLoopId;
	}

	public void setAsymmetricRnaInternalLoopId(
			Integer asymmetricRnaInternalLoopId) {
		this.asymmetricRnaInternalLoopId = asymmetricRnaInternalLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsymmetricRnaInternalLoopId))
			return false;
		AsymmetricRnaInternalLoopId castOther = (AsymmetricRnaInternalLoopId) other;

		return ((this.getAsymmetricRnaInternalLoopId() == castOther
				.getAsymmetricRnaInternalLoopId()) || (this
				.getAsymmetricRnaInternalLoopId() != null
				&& castOther.getAsymmetricRnaInternalLoopId() != null && this
				.getAsymmetricRnaInternalLoopId().equals(
						castOther.getAsymmetricRnaInternalLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsymmetricRnaInternalLoopId() == null ? 0 : this
						.getAsymmetricRnaInternalLoopId().hashCode());
		result = 37 * result
