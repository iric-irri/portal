...
/**
 * AssemblyId generated by hbm2java
 */
public class AssemblyId implements java.io.Serializable {
	...
	public AssemblyId(Integer assemblyId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssemblyId))
			return false;
		AssemblyId castOther = (AssemblyId) other;

		return ((this.getAssemblyId() == castOther.getAssemblyId()) || (this
				.getAssemblyId() != null && castOther.getAssemblyId() != null && this
				.getAssemblyId().equals(castOther.getAssemblyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssemblyId() == null ? 0 : this.getAssemblyId()
						.hashCode());
		result = 37 * result
