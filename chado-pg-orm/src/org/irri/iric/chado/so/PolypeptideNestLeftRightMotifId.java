...
/**
 * PolypeptideNestLeftRightMotifId generated by hbm2java
 */
public class PolypeptideNestLeftRightMotifId implements java.io.Serializable {

	private Integer polypeptideNestLeftRightMotifId;
	...
	public PolypeptideNestLeftRightMotifId() {
	}

	public PolypeptideNestLeftRightMotifId(
			Integer polypeptideNestLeftRightMotifId, Integer featureId,
		...
		this.polypeptideNestLeftRightMotifId = polypeptideNestLeftRightMotifId;
	...
	public Integer getPolypeptideNestLeftRightMotifId() {
		return this.polypeptideNestLeftRightMotifId;
	}

	public void setPolypeptideNestLeftRightMotifId(
			Integer polypeptideNestLeftRightMotifId) {
		this.polypeptideNestLeftRightMotifId = polypeptideNestLeftRightMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideNestLeftRightMotifId))
			return false;
		PolypeptideNestLeftRightMotifId castOther = (PolypeptideNestLeftRightMotifId) other;

		return ((this.getPolypeptideNestLeftRightMotifId() == castOther
				.getPolypeptideNestLeftRightMotifId()) || (this
				.getPolypeptideNestLeftRightMotifId() != null
				&& castOther.getPolypeptideNestLeftRightMotifId() != null && this
				.getPolypeptideNestLeftRightMotifId().equals(
						castOther.getPolypeptideNestLeftRightMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideNestLeftRightMotifId() == null ? 0 : this
						.getPolypeptideNestLeftRightMotifId().hashCode());
		result = 37 * result
