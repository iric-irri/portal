...
/**
 * NestedRepeatId generated by hbm2java
 */
public class NestedRepeatId implements java.io.Serializable {

	private Integer nestedRepeatId;
	...
	public NestedRepeatId() {
	}

	public NestedRepeatId(Integer nestedRepeatId, Integer featureId,
		...
		this.nestedRepeatId = nestedRepeatId;
	...
	public Integer getNestedRepeatId() {
		return this.nestedRepeatId;
	}

	public void setNestedRepeatId(Integer nestedRepeatId) {
		this.nestedRepeatId = nestedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NestedRepeatId))
			return false;
		NestedRepeatId castOther = (NestedRepeatId) other;

		return ((this.getNestedRepeatId() == castOther.getNestedRepeatId()) || (this
				.getNestedRepeatId() != null
				&& castOther.getNestedRepeatId() != null && this
				.getNestedRepeatId().equals(castOther.getNestedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNestedRepeatId() == null ? 0 : this.getNestedRepeatId()
						.hashCode());
		result = 37 * result
