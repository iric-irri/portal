...
/**
 * LevelOfTranscriptVariantId generated by hbm2java
 */
public class LevelOfTranscriptVariantId implements java.io.Serializable {

	private Integer levelOfTranscriptVariantId;
	...
	public LevelOfTranscriptVariantId() {
	}

	public LevelOfTranscriptVariantId(Integer levelOfTranscriptVariantId,
		...
		this.levelOfTranscriptVariantId = levelOfTranscriptVariantId;
	...
	public Integer getLevelOfTranscriptVariantId() {
		return this.levelOfTranscriptVariantId;
	}

	public void setLevelOfTranscriptVariantId(Integer levelOfTranscriptVariantId) {
		this.levelOfTranscriptVariantId = levelOfTranscriptVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LevelOfTranscriptVariantId))
			return false;
		LevelOfTranscriptVariantId castOther = (LevelOfTranscriptVariantId) other;

		return ((this.getLevelOfTranscriptVariantId() == castOther
				.getLevelOfTranscriptVariantId()) || (this
				.getLevelOfTranscriptVariantId() != null
				&& castOther.getLevelOfTranscriptVariantId() != null && this
				.getLevelOfTranscriptVariantId().equals(
						castOther.getLevelOfTranscriptVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLevelOfTranscriptVariantId() == null ? 0 : this
						.getLevelOfTranscriptVariantId().hashCode());
		result = 37 * result
