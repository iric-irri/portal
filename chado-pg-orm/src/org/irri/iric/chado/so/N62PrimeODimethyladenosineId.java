...
/**
 * N62PrimeODimethyladenosineId generated by hbm2java
 */
public class N62PrimeODimethyladenosineId implements java.io.Serializable {

	private Integer n62PrimeODimethyladenosineId;
	...
	public N62PrimeODimethyladenosineId() {
	}

	public N62PrimeODimethyladenosineId(Integer n62PrimeODimethyladenosineId,
		...
		this.n62PrimeODimethyladenosineId = n62PrimeODimethyladenosineId;
	...
	public Integer getN62PrimeODimethyladenosineId() {
		return this.n62PrimeODimethyladenosineId;
	}

	public void setN62PrimeODimethyladenosineId(
			Integer n62PrimeODimethyladenosineId) {
		this.n62PrimeODimethyladenosineId = n62PrimeODimethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N62PrimeODimethyladenosineId))
			return false;
		N62PrimeODimethyladenosineId castOther = (N62PrimeODimethyladenosineId) other;

		return ((this.getN62PrimeODimethyladenosineId() == castOther
				.getN62PrimeODimethyladenosineId()) || (this
				.getN62PrimeODimethyladenosineId() != null
				&& castOther.getN62PrimeODimethyladenosineId() != null && this
				.getN62PrimeODimethyladenosineId().equals(
						castOther.getN62PrimeODimethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN62PrimeODimethyladenosineId() == null ? 0 : this
						.getN62PrimeODimethyladenosineId().hashCode());
		result = 37 * result
