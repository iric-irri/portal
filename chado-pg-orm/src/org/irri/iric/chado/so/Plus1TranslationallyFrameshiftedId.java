...
/**
 * Plus1TranslationallyFrameshiftedId generated by hbm2java
 */
public class Plus1TranslationallyFrameshiftedId implements java.io.Serializable {

	private Integer plus1TranslationallyFrameshiftedId;
	...
	public Plus1TranslationallyFrameshiftedId() {
	}

	public Plus1TranslationallyFrameshiftedId(
			Integer plus1TranslationallyFrameshiftedId, Integer featureId,
		...
		this.plus1TranslationallyFrameshiftedId = plus1TranslationallyFrameshiftedId;
	...
	public Integer getPlus1TranslationallyFrameshiftedId() {
		return this.plus1TranslationallyFrameshiftedId;
	}

	public void setPlus1TranslationallyFrameshiftedId(
			Integer plus1TranslationallyFrameshiftedId) {
		this.plus1TranslationallyFrameshiftedId = plus1TranslationallyFrameshiftedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus1TranslationallyFrameshiftedId))
			return false;
		Plus1TranslationallyFrameshiftedId castOther = (Plus1TranslationallyFrameshiftedId) other;

		return ((this.getPlus1TranslationallyFrameshiftedId() == castOther
				.getPlus1TranslationallyFrameshiftedId()) || (this
				.getPlus1TranslationallyFrameshiftedId() != null
				&& castOther.getPlus1TranslationallyFrameshiftedId() != null && this
				.getPlus1TranslationallyFrameshiftedId().equals(
						castOther.getPlus1TranslationallyFrameshiftedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus1TranslationallyFrameshiftedId() == null ? 0 : this
						.getPlus1TranslationallyFrameshiftedId().hashCode());
		result = 37 * result
