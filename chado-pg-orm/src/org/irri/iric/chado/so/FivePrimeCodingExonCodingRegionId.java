...
/**
 * FivePrimeCodingExonCodingRegionId generated by hbm2java
 */
public class FivePrimeCodingExonCodingRegionId implements java.io.Serializable {

	private Integer fivePrimeCodingExonCodingRegionId;
	...
	public FivePrimeCodingExonCodingRegionId() {
	}

	public FivePrimeCodingExonCodingRegionId(
			Integer fivePrimeCodingExonCodingRegionId, Integer featureId,
		...
		this.fivePrimeCodingExonCodingRegionId = fivePrimeCodingExonCodingRegionId;
	...
	public Integer getFivePrimeCodingExonCodingRegionId() {
		return this.fivePrimeCodingExonCodingRegionId;
	}

	public void setFivePrimeCodingExonCodingRegionId(
			Integer fivePrimeCodingExonCodingRegionId) {
		this.fivePrimeCodingExonCodingRegionId = fivePrimeCodingExonCodingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeCodingExonCodingRegionId))
			return false;
		FivePrimeCodingExonCodingRegionId castOther = (FivePrimeCodingExonCodingRegionId) other;

		return ((this.getFivePrimeCodingExonCodingRegionId() == castOther
				.getFivePrimeCodingExonCodingRegionId()) || (this
				.getFivePrimeCodingExonCodingRegionId() != null
				&& castOther.getFivePrimeCodingExonCodingRegionId() != null && this
				.getFivePrimeCodingExonCodingRegionId().equals(
						castOther.getFivePrimeCodingExonCodingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeCodingExonCodingRegionId() == null ? 0 : this
						.getFivePrimeCodingExonCodingRegionId().hashCode());
		result = 37 * result
