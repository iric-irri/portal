...
/**
 * PairedEndFragmentId generated by hbm2java
 */
public class PairedEndFragmentId implements java.io.Serializable {

	private Integer pairedEndFragmentId;
	...
	public PairedEndFragmentId() {
	}

	public PairedEndFragmentId(Integer pairedEndFragmentId, Integer featureId,
		...
		this.pairedEndFragmentId = pairedEndFragmentId;
	...
	public Integer getPairedEndFragmentId() {
		return this.pairedEndFragmentId;
	}

	public void setPairedEndFragmentId(Integer pairedEndFragmentId) {
		this.pairedEndFragmentId = pairedEndFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PairedEndFragmentId))
			return false;
		PairedEndFragmentId castOther = (PairedEndFragmentId) other;

		return ((this.getPairedEndFragmentId() == castOther
				.getPairedEndFragmentId()) || (this.getPairedEndFragmentId() != null
				&& castOther.getPairedEndFragmentId() != null && this
				.getPairedEndFragmentId().equals(
						castOther.getPairedEndFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPairedEndFragmentId() == null ? 0 : this
						.getPairedEndFragmentId().hashCode());
		result = 37 * result
