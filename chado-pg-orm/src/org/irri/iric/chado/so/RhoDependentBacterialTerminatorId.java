...
/**
 * RhoDependentBacterialTerminatorId generated by hbm2java
 */
public class RhoDependentBacterialTerminatorId implements java.io.Serializable {

	private Integer rhoDependentBacterialTerminatorId;
	...
	public RhoDependentBacterialTerminatorId() {
	}

	public RhoDependentBacterialTerminatorId(
			Integer rhoDependentBacterialTerminatorId, Integer featureId,
		...
		this.rhoDependentBacterialTerminatorId = rhoDependentBacterialTerminatorId;
	...
	public Integer getRhoDependentBacterialTerminatorId() {
		return this.rhoDependentBacterialTerminatorId;
	}

	public void setRhoDependentBacterialTerminatorId(
			Integer rhoDependentBacterialTerminatorId) {
		this.rhoDependentBacterialTerminatorId = rhoDependentBacterialTerminatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RhoDependentBacterialTerminatorId))
			return false;
		RhoDependentBacterialTerminatorId castOther = (RhoDependentBacterialTerminatorId) other;

		return ((this.getRhoDependentBacterialTerminatorId() == castOther
				.getRhoDependentBacterialTerminatorId()) || (this
				.getRhoDependentBacterialTerminatorId() != null
				&& castOther.getRhoDependentBacterialTerminatorId() != null && this
				.getRhoDependentBacterialTerminatorId().equals(
						castOther.getRhoDependentBacterialTerminatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRhoDependentBacterialTerminatorId() == null ? 0 : this
						.getRhoDependentBacterialTerminatorId().hashCode());
		result = 37 * result
