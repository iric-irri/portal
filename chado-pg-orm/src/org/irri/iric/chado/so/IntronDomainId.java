...
/**
 * IntronDomainId generated by hbm2java
 */
public class IntronDomainId implements java.io.Serializable {

	private Integer intronDomainId;
	...
	public IntronDomainId() {
	}

	public IntronDomainId(Integer intronDomainId, Integer featureId,
		...
		this.intronDomainId = intronDomainId;
	...
	public Integer getIntronDomainId() {
		return this.intronDomainId;
	}

	public void setIntronDomainId(Integer intronDomainId) {
		this.intronDomainId = intronDomainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronDomainId))
			return false;
		IntronDomainId castOther = (IntronDomainId) other;

		return ((this.getIntronDomainId() == castOther.getIntronDomainId()) || (this
				.getIntronDomainId() != null
				&& castOther.getIntronDomainId() != null && this
				.getIntronDomainId().equals(castOther.getIntronDomainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntronDomainId() == null ? 0 : this.getIntronDomainId()
						.hashCode());
		result = 37 * result
