...
/**
 * InsertionalId generated by hbm2java
 */
public class InsertionalId implements java.io.Serializable {

	private Integer insertionalId;
	...
	public InsertionalId() {
	}

	public InsertionalId(Integer insertionalId, Integer featureId,
		...
		this.insertionalId = insertionalId;
	...
	public Integer getInsertionalId() {
		return this.insertionalId;
	}

	public void setInsertionalId(Integer insertionalId) {
		this.insertionalId = insertionalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionalId))
			return false;
		InsertionalId castOther = (InsertionalId) other;

		return ((this.getInsertionalId() == castOther.getInsertionalId()) || (this
				.getInsertionalId() != null
				&& castOther.getInsertionalId() != null && this
				.getInsertionalId().equals(castOther.getInsertionalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionalId() == null ? 0 : this.getInsertionalId()
						.hashCode());
		result = 37 * result
