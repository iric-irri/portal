...
/**
 * RnaseMrpRnaGeneId generated by hbm2java
 */
public class RnaseMrpRnaGeneId implements java.io.Serializable {

	private Integer rnaseMrpRnaGeneId;
	...
	public RnaseMrpRnaGeneId() {
	}

	public RnaseMrpRnaGeneId(Integer rnaseMrpRnaGeneId, Integer featureId,
		...
		this.rnaseMrpRnaGeneId = rnaseMrpRnaGeneId;
	...
	public Integer getRnaseMrpRnaGeneId() {
		return this.rnaseMrpRnaGeneId;
	}

	public void setRnaseMrpRnaGeneId(Integer rnaseMrpRnaGeneId) {
		this.rnaseMrpRnaGeneId = rnaseMrpRnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaseMrpRnaGeneId))
			return false;
		RnaseMrpRnaGeneId castOther = (RnaseMrpRnaGeneId) other;

		return ((this.getRnaseMrpRnaGeneId() == castOther
				.getRnaseMrpRnaGeneId()) || (this.getRnaseMrpRnaGeneId() != null
				&& castOther.getRnaseMrpRnaGeneId() != null && this
				.getRnaseMrpRnaGeneId()
				.equals(castOther.getRnaseMrpRnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaseMrpRnaGeneId() == null ? 0 : this
						.getRnaseMrpRnaGeneId().hashCode());
		result = 37 * result
