...
/**
 * PolypyrimidineTractId generated by hbm2java
 */
public class PolypyrimidineTractId implements java.io.Serializable {

	private Integer polypyrimidineTractId;
	...
	public PolypyrimidineTractId() {
	}

	public PolypyrimidineTractId(Integer polypyrimidineTractId,
		...
		this.polypyrimidineTractId = polypyrimidineTractId;
	...
	public Integer getPolypyrimidineTractId() {
		return this.polypyrimidineTractId;
	}

	public void setPolypyrimidineTractId(Integer polypyrimidineTractId) {
		this.polypyrimidineTractId = polypyrimidineTractId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypyrimidineTractId))
			return false;
		PolypyrimidineTractId castOther = (PolypyrimidineTractId) other;

		return ((this.getPolypyrimidineTractId() == castOther
				.getPolypyrimidineTractId()) || (this
				.getPolypyrimidineTractId() != null
				&& castOther.getPolypyrimidineTractId() != null && this
				.getPolypyrimidineTractId().equals(
						castOther.getPolypyrimidineTractId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypyrimidineTractId() == null ? 0 : this
						.getPolypyrimidineTractId().hashCode());
		result = 37 * result
