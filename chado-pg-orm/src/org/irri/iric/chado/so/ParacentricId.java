...
/**
 * ParacentricId generated by hbm2java
 */
public class ParacentricId implements java.io.Serializable {

	private Integer paracentricId;
	...
	public ParacentricId() {
	}

	public ParacentricId(Integer paracentricId, Integer featureId,
		...
		this.paracentricId = paracentricId;
	...
	public Integer getParacentricId() {
		return this.paracentricId;
	}

	public void setParacentricId(Integer paracentricId) {
		this.paracentricId = paracentricId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParacentricId))
			return false;
		ParacentricId castOther = (ParacentricId) other;

		return ((this.getParacentricId() == castOther.getParacentricId()) || (this
				.getParacentricId() != null
				&& castOther.getParacentricId() != null && this
				.getParacentricId().equals(castOther.getParacentricId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getParacentricId() == null ? 0 : this.getParacentricId()
						.hashCode());
		result = 37 * result
