...
/**
 * ExperimentallyDeterminedId generated by hbm2java
 */
public class ExperimentallyDeterminedId implements java.io.Serializable {

	private Integer experimentallyDeterminedId;
	...
	public ExperimentallyDeterminedId() {
	}

	public ExperimentallyDeterminedId(Integer experimentallyDeterminedId,
		...
		this.experimentallyDeterminedId = experimentallyDeterminedId;
	...
	public Integer getExperimentallyDeterminedId() {
		return this.experimentallyDeterminedId;
	}

	public void setExperimentallyDeterminedId(Integer experimentallyDeterminedId) {
		this.experimentallyDeterminedId = experimentallyDeterminedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExperimentallyDeterminedId))
			return false;
		ExperimentallyDeterminedId castOther = (ExperimentallyDeterminedId) other;

		return ((this.getExperimentallyDeterminedId() == castOther
				.getExperimentallyDeterminedId()) || (this
				.getExperimentallyDeterminedId() != null
				&& castOther.getExperimentallyDeterminedId() != null && this
				.getExperimentallyDeterminedId().equals(
						castOther.getExperimentallyDeterminedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExperimentallyDeterminedId() == null ? 0 : this
						.getExperimentallyDeterminedId().hashCode());
		result = 37 * result
