...
/**
 * LoxpSiteId generated by hbm2java
 */
public class LoxpSiteId implements java.io.Serializable {

	private Integer loxpSiteId;
	...
	public LoxpSiteId(Integer loxpSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLoxpSiteId() {
		return this.loxpSiteId;
	}

	public void setLoxpSiteId(Integer loxpSiteId) {
		this.loxpSiteId = loxpSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LoxpSiteId))
			return false;
		LoxpSiteId castOther = (LoxpSiteId) other;

		return ((this.getLoxpSiteId() == castOther.getLoxpSiteId()) || (this
				.getLoxpSiteId() != null && castOther.getLoxpSiteId() != null && this
				.getLoxpSiteId().equals(castOther.getLoxpSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLoxpSiteId() == null ? 0 : this.getLoxpSiteId()
						.hashCode());
		result = 37 * result
