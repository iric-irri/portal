...
/**
 * VjGeneId generated by hbm2java
 */
public class VjGeneId implements java.io.Serializable {

	private Integer vjGeneId;
	...
	public VjGeneId(Integer vjGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVjGeneId() {
		return this.vjGeneId;
	}

	public void setVjGeneId(Integer vjGeneId) {
		this.vjGeneId = vjGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VjGeneId))
			return false;
		VjGeneId castOther = (VjGeneId) other;

		return ((this.getVjGeneId() == castOther.getVjGeneId()) || (this
				.getVjGeneId() != null && castOther.getVjGeneId() != null && this
				.getVjGeneId().equals(castOther.getVjGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVjGeneId() == null ? 0 : this.getVjGeneId().hashCode());
		result = 37 * result
