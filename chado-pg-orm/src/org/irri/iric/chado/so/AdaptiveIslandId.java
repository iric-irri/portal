...
/**
 * AdaptiveIslandId generated by hbm2java
 */
public class AdaptiveIslandId implements java.io.Serializable {

	private Integer adaptiveIslandId;
	...
	public AdaptiveIslandId() {
	}

	public AdaptiveIslandId(Integer adaptiveIslandId, Integer featureId,
		...
		this.adaptiveIslandId = adaptiveIslandId;
	...
	public Integer getAdaptiveIslandId() {
		return this.adaptiveIslandId;
	}

	public void setAdaptiveIslandId(Integer adaptiveIslandId) {
		this.adaptiveIslandId = adaptiveIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AdaptiveIslandId))
			return false;
		AdaptiveIslandId castOther = (AdaptiveIslandId) other;

		return ((this.getAdaptiveIslandId() == castOther.getAdaptiveIslandId()) || (this
				.getAdaptiveIslandId() != null
				&& castOther.getAdaptiveIslandId() != null && this
				.getAdaptiveIslandId().equals(castOther.getAdaptiveIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAdaptiveIslandId() == null ? 0 : this
						.getAdaptiveIslandId().hashCode());
		result = 37 * result
