...
/**
 * OperonMemberId generated by hbm2java
 */
public class OperonMemberId implements java.io.Serializable {

	private Integer operonMemberId;
	...
	public OperonMemberId() {
	}

	public OperonMemberId(Integer operonMemberId, Integer featureId,
		...
		this.operonMemberId = operonMemberId;
	...
	public Integer getOperonMemberId() {
		return this.operonMemberId;
	}

	public void setOperonMemberId(Integer operonMemberId) {
		this.operonMemberId = operonMemberId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OperonMemberId))
			return false;
		OperonMemberId castOther = (OperonMemberId) other;

		return ((this.getOperonMemberId() == castOther.getOperonMemberId()) || (this
				.getOperonMemberId() != null
				&& castOther.getOperonMemberId() != null && this
				.getOperonMemberId().equals(castOther.getOperonMemberId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOperonMemberId() == null ? 0 : this.getOperonMemberId()
						.hashCode());
		result = 37 * result
