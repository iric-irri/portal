...
/**
 * DatabankEntryId generated by hbm2java
 */
public class DatabankEntryId implements java.io.Serializable {

	private Integer databankEntryId;
	...
	public DatabankEntryId() {
	}

	public DatabankEntryId(Integer databankEntryId, Integer featureId,
		...
		this.databankEntryId = databankEntryId;
	...
	public Integer getDatabankEntryId() {
		return this.databankEntryId;
	}

	public void setDatabankEntryId(Integer databankEntryId) {
		this.databankEntryId = databankEntryId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DatabankEntryId))
			return false;
		DatabankEntryId castOther = (DatabankEntryId) other;

		return ((this.getDatabankEntryId() == castOther.getDatabankEntryId()) || (this
				.getDatabankEntryId() != null
				&& castOther.getDatabankEntryId() != null && this
				.getDatabankEntryId().equals(castOther.getDatabankEntryId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDatabankEntryId() == null ? 0 : this.getDatabankEntryId()
						.hashCode());
		result = 37 * result
