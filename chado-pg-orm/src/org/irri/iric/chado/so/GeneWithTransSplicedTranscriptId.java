...
/**
 * GeneWithTransSplicedTranscriptId generated by hbm2java
 */
public class GeneWithTransSplicedTranscriptId implements java.io.Serializable {

	private Integer geneWithTransSplicedTranscriptId;
	...
	public GeneWithTransSplicedTranscriptId() {
	}

	public GeneWithTransSplicedTranscriptId(
			Integer geneWithTransSplicedTranscriptId, Integer featureId,
		...
		this.geneWithTransSplicedTranscriptId = geneWithTransSplicedTranscriptId;
	...
	public Integer getGeneWithTransSplicedTranscriptId() {
		return this.geneWithTransSplicedTranscriptId;
	}

	public void setGeneWithTransSplicedTranscriptId(
			Integer geneWithTransSplicedTranscriptId) {
		this.geneWithTransSplicedTranscriptId = geneWithTransSplicedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithTransSplicedTranscriptId))
			return false;
		GeneWithTransSplicedTranscriptId castOther = (GeneWithTransSplicedTranscriptId) other;

		return ((this.getGeneWithTransSplicedTranscriptId() == castOther
				.getGeneWithTransSplicedTranscriptId()) || (this
				.getGeneWithTransSplicedTranscriptId() != null
				&& castOther.getGeneWithTransSplicedTranscriptId() != null && this
				.getGeneWithTransSplicedTranscriptId().equals(
						castOther.getGeneWithTransSplicedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithTransSplicedTranscriptId() == null ? 0 : this
						.getGeneWithTransSplicedTranscriptId().hashCode());
		result = 37 * result
