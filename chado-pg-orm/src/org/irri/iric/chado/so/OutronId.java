...
/**
 * OutronId generated by hbm2java
 */
public class OutronId implements java.io.Serializable {

	private Integer outronId;
	...
	public OutronId(Integer outronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getOutronId() {
		return this.outronId;
	}

	public void setOutronId(Integer outronId) {
		this.outronId = outronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OutronId))
			return false;
		OutronId castOther = (OutronId) other;

		return ((this.getOutronId() == castOther.getOutronId()) || (this
				.getOutronId() != null && castOther.getOutronId() != null && this
				.getOutronId().equals(castOther.getOutronId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOutronId() == null ? 0 : this.getOutronId().hashCode());
		result = 37 * result
