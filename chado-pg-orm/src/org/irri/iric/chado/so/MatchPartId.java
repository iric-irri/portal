...
/**
 * MatchPartId generated by hbm2java
 */
public class MatchPartId implements java.io.Serializable {

	private Integer matchPartId;
	...
	public MatchPartId(Integer matchPartId, Integer featureId,
	...
	public Integer getMatchPartId() {
		return this.matchPartId;
	}

	public void setMatchPartId(Integer matchPartId) {
		this.matchPartId = matchPartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatchPartId))
			return false;
		MatchPartId castOther = (MatchPartId) other;

		return ((this.getMatchPartId() == castOther.getMatchPartId()) || (this
				.getMatchPartId() != null && castOther.getMatchPartId() != null && this
				.getMatchPartId().equals(castOther.getMatchPartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatchPartId() == null ? 0 : this.getMatchPartId()
						.hashCode());
		result = 37 * result
