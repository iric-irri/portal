...
/**
 * UBoxId generated by hbm2java
 */
public class UBoxId implements java.io.Serializable {

	private Integer UBoxId;
	...
	public UBoxId(Integer UBoxId, Integer featureId, Integer dbxrefId,
	...
	public Integer getUBoxId() {
		return this.UBoxId;
	}

	public void setUBoxId(Integer UBoxId) {
		this.UBoxId = UBoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UBoxId))
			return false;
		UBoxId castOther = (UBoxId) other;

		return ((this.getUBoxId() == castOther.getUBoxId()) || (this
				.getUBoxId() != null && castOther.getUBoxId() != null && this
				.getUBoxId().equals(castOther.getUBoxId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getUBoxId() == null ? 0 : this.getUBoxId().hashCode());
		result = 37 * result
