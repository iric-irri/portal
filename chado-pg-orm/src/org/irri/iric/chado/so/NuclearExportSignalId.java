...
/**
 * NuclearExportSignalId generated by hbm2java
 */
public class NuclearExportSignalId implements java.io.Serializable {

	private Integer nuclearExportSignalId;
	...
	public NuclearExportSignalId() {
	}

	public NuclearExportSignalId(Integer nuclearExportSignalId,
		...
		this.nuclearExportSignalId = nuclearExportSignalId;
	...
	public Integer getNuclearExportSignalId() {
		return this.nuclearExportSignalId;
	}

	public void setNuclearExportSignalId(Integer nuclearExportSignalId) {
		this.nuclearExportSignalId = nuclearExportSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearExportSignalId))
			return false;
		NuclearExportSignalId castOther = (NuclearExportSignalId) other;

		return ((this.getNuclearExportSignalId() == castOther
				.getNuclearExportSignalId()) || (this
				.getNuclearExportSignalId() != null
				&& castOther.getNuclearExportSignalId() != null && this
				.getNuclearExportSignalId().equals(
						castOther.getNuclearExportSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearExportSignalId() == null ? 0 : this
						.getNuclearExportSignalId().hashCode());
		result = 37 * result
