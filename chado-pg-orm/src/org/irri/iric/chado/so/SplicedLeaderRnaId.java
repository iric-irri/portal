...
/**
 * SplicedLeaderRnaId generated by hbm2java
 */
public class SplicedLeaderRnaId implements java.io.Serializable {

	private Integer splicedLeaderRnaId;
	...
	public SplicedLeaderRnaId() {
	}

	public SplicedLeaderRnaId(Integer splicedLeaderRnaId, Integer featureId,
		...
		this.splicedLeaderRnaId = splicedLeaderRnaId;
	...
	public Integer getSplicedLeaderRnaId() {
		return this.splicedLeaderRnaId;
	}

	public void setSplicedLeaderRnaId(Integer splicedLeaderRnaId) {
		this.splicedLeaderRnaId = splicedLeaderRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SplicedLeaderRnaId))
			return false;
		SplicedLeaderRnaId castOther = (SplicedLeaderRnaId) other;

		return ((this.getSplicedLeaderRnaId() == castOther
				.getSplicedLeaderRnaId()) || (this.getSplicedLeaderRnaId() != null
				&& castOther.getSplicedLeaderRnaId() != null && this
				.getSplicedLeaderRnaId().equals(
						castOther.getSplicedLeaderRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSplicedLeaderRnaId() == null ? 0 : this
						.getSplicedLeaderRnaId().hashCode());
		result = 37 * result
