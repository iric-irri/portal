...
/**
 * DiseaseAssociatedVariantId generated by hbm2java
 */
public class DiseaseAssociatedVariantId implements java.io.Serializable {

	private Integer diseaseAssociatedVariantId;
	...
	public DiseaseAssociatedVariantId() {
	}

	public DiseaseAssociatedVariantId(Integer diseaseAssociatedVariantId,
		...
		this.diseaseAssociatedVariantId = diseaseAssociatedVariantId;
	...
	public Integer getDiseaseAssociatedVariantId() {
		return this.diseaseAssociatedVariantId;
	}

	public void setDiseaseAssociatedVariantId(Integer diseaseAssociatedVariantId) {
		this.diseaseAssociatedVariantId = diseaseAssociatedVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DiseaseAssociatedVariantId))
			return false;
		DiseaseAssociatedVariantId castOther = (DiseaseAssociatedVariantId) other;

		return ((this.getDiseaseAssociatedVariantId() == castOther
				.getDiseaseAssociatedVariantId()) || (this
				.getDiseaseAssociatedVariantId() != null
				&& castOther.getDiseaseAssociatedVariantId() != null && this
				.getDiseaseAssociatedVariantId().equals(
						castOther.getDiseaseAssociatedVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDiseaseAssociatedVariantId() == null ? 0 : this
						.getDiseaseAssociatedVariantId().hashCode());
		result = 37 * result
