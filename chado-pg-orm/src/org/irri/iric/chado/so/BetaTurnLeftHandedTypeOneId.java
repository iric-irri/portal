...
/**
 * BetaTurnLeftHandedTypeOneId generated by hbm2java
 */
public class BetaTurnLeftHandedTypeOneId implements java.io.Serializable {

	private Integer betaTurnLeftHandedTypeOneId;
	...
	public BetaTurnLeftHandedTypeOneId() {
	}

	public BetaTurnLeftHandedTypeOneId(Integer betaTurnLeftHandedTypeOneId,
		...
		this.betaTurnLeftHandedTypeOneId = betaTurnLeftHandedTypeOneId;
	...
	public Integer getBetaTurnLeftHandedTypeOneId() {
		return this.betaTurnLeftHandedTypeOneId;
	}

	public void setBetaTurnLeftHandedTypeOneId(
			Integer betaTurnLeftHandedTypeOneId) {
		this.betaTurnLeftHandedTypeOneId = betaTurnLeftHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnLeftHandedTypeOneId))
			return false;
		BetaTurnLeftHandedTypeOneId castOther = (BetaTurnLeftHandedTypeOneId) other;

		return ((this.getBetaTurnLeftHandedTypeOneId() == castOther
				.getBetaTurnLeftHandedTypeOneId()) || (this
				.getBetaTurnLeftHandedTypeOneId() != null
				&& castOther.getBetaTurnLeftHandedTypeOneId() != null && this
				.getBetaTurnLeftHandedTypeOneId().equals(
						castOther.getBetaTurnLeftHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnLeftHandedTypeOneId() == null ? 0 : this
						.getBetaTurnLeftHandedTypeOneId().hashCode());
		result = 37 * result
