...
/**
 * VertebrateIgTCellReceptorRearrangedGeneClusterId generated by hbm2java
 */
public class VertebrateIgTCellReceptorRearrangedGeneClusterId implements
		java.io.Serializable {

	private Integer vertebrateIgTCellReceptorRearrangedGeneClusterId;
	...
	public VertebrateIgTCellReceptorRearrangedGeneClusterId() {
	}

	public VertebrateIgTCellReceptorRearrangedGeneClusterId(
			Integer vertebrateIgTCellReceptorRearrangedGeneClusterId,
		...
		this.vertebrateIgTCellReceptorRearrangedGeneClusterId = vertebrateIgTCellReceptorRearrangedGeneClusterId;
	...
	public Integer getVertebrateIgTCellReceptorRearrangedGeneClusterId() {
		return this.vertebrateIgTCellReceptorRearrangedGeneClusterId;
	}

	public void setVertebrateIgTCellReceptorRearrangedGeneClusterId(
			Integer vertebrateIgTCellReceptorRearrangedGeneClusterId) {
		this.vertebrateIgTCellReceptorRearrangedGeneClusterId = vertebrateIgTCellReceptorRearrangedGeneClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateIgTCellReceptorRearrangedGeneClusterId))
			return false;
		VertebrateIgTCellReceptorRearrangedGeneClusterId castOther = (VertebrateIgTCellReceptorRearrangedGeneClusterId) other;

		return ((this.getVertebrateIgTCellReceptorRearrangedGeneClusterId() == castOther
				.getVertebrateIgTCellReceptorRearrangedGeneClusterId()) || (this
				.getVertebrateIgTCellReceptorRearrangedGeneClusterId() != null
				&& castOther
						.getVertebrateIgTCellReceptorRearrangedGeneClusterId() != null && this
				.getVertebrateIgTCellReceptorRearrangedGeneClusterId()
				.equals(castOther
						.getVertebrateIgTCellReceptorRearrangedGeneClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateIgTCellReceptorRearrangedGeneClusterId() == null ? 0
						: this.getVertebrateIgTCellReceptorRearrangedGeneClusterId()
								.hashCode());
		result = 37 * result
