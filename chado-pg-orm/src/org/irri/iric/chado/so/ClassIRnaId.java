...
/**
 * ClassIRnaId generated by hbm2java
 */
public class ClassIRnaId implements java.io.Serializable {

	private Integer classIRnaId;
	...
	public ClassIRnaId(Integer classIRnaId, Integer featureId,
	...
	public Integer getClassIRnaId() {
		return this.classIRnaId;
	}

	public void setClassIRnaId(Integer classIRnaId) {
		this.classIRnaId = classIRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClassIRnaId))
			return false;
		ClassIRnaId castOther = (ClassIRnaId) other;

		return ((this.getClassIRnaId() == castOther.getClassIRnaId()) || (this
				.getClassIRnaId() != null && castOther.getClassIRnaId() != null && this
				.getClassIRnaId().equals(castOther.getClassIRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getClassIRnaId() == null ? 0 : this.getClassIRnaId()
						.hashCode());
		result = 37 * result
