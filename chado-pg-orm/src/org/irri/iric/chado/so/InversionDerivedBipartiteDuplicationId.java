...
/**
 * InversionDerivedBipartiteDuplicationId generated by hbm2java
 */
public class InversionDerivedBipartiteDuplicationId implements
		java.io.Serializable {

	private Integer inversionDerivedBipartiteDuplicationId;
	...
	public InversionDerivedBipartiteDuplicationId() {
	}

	public InversionDerivedBipartiteDuplicationId(
			Integer inversionDerivedBipartiteDuplicationId, Integer featureId,
		...
		this.inversionDerivedBipartiteDuplicationId = inversionDerivedBipartiteDuplicationId;
	...
	public Integer getInversionDerivedBipartiteDuplicationId() {
		return this.inversionDerivedBipartiteDuplicationId;
	}

	public void setInversionDerivedBipartiteDuplicationId(
			Integer inversionDerivedBipartiteDuplicationId) {
		this.inversionDerivedBipartiteDuplicationId = inversionDerivedBipartiteDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedBipartiteDuplicationId))
			return false;
		InversionDerivedBipartiteDuplicationId castOther = (InversionDerivedBipartiteDuplicationId) other;

		return ((this.getInversionDerivedBipartiteDuplicationId() == castOther
				.getInversionDerivedBipartiteDuplicationId()) || (this
				.getInversionDerivedBipartiteDuplicationId() != null
				&& castOther.getInversionDerivedBipartiteDuplicationId() != null && this
				.getInversionDerivedBipartiteDuplicationId().equals(
						castOther.getInversionDerivedBipartiteDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedBipartiteDuplicationId() == null ? 0
						: this.getInversionDerivedBipartiteDuplicationId()
								.hashCode());
		result = 37 * result
