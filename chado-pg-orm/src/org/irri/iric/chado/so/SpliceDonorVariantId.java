...
/**
 * SpliceDonorVariantId generated by hbm2java
 */
public class SpliceDonorVariantId implements java.io.Serializable {

	private Integer spliceDonorVariantId;
	...
	public SpliceDonorVariantId() {
	}

	public SpliceDonorVariantId(Integer spliceDonorVariantId,
		...
		this.spliceDonorVariantId = spliceDonorVariantId;
	...
	public Integer getSpliceDonorVariantId() {
		return this.spliceDonorVariantId;
	}

	public void setSpliceDonorVariantId(Integer spliceDonorVariantId) {
		this.spliceDonorVariantId = spliceDonorVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceDonorVariantId))
			return false;
		SpliceDonorVariantId castOther = (SpliceDonorVariantId) other;

		return ((this.getSpliceDonorVariantId() == castOther
				.getSpliceDonorVariantId()) || (this.getSpliceDonorVariantId() != null
				&& castOther.getSpliceDonorVariantId() != null && this
				.getSpliceDonorVariantId().equals(
						castOther.getSpliceDonorVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceDonorVariantId() == null ? 0 : this
						.getSpliceDonorVariantId().hashCode());
		result = 37 * result
