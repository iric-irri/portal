...
/**
 * CentromericRepeatId generated by hbm2java
 */
public class CentromericRepeatId implements java.io.Serializable {

	private Integer centromericRepeatId;
	...
	public CentromericRepeatId() {
	}

	public CentromericRepeatId(Integer centromericRepeatId, Integer featureId,
		...
		this.centromericRepeatId = centromericRepeatId;
	...
	public Integer getCentromericRepeatId() {
		return this.centromericRepeatId;
	}

	public void setCentromericRepeatId(Integer centromericRepeatId) {
		this.centromericRepeatId = centromericRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentromericRepeatId))
			return false;
		CentromericRepeatId castOther = (CentromericRepeatId) other;

		return ((this.getCentromericRepeatId() == castOther
				.getCentromericRepeatId()) || (this.getCentromericRepeatId() != null
				&& castOther.getCentromericRepeatId() != null && this
				.getCentromericRepeatId().equals(
						castOther.getCentromericRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentromericRepeatId() == null ? 0 : this
						.getCentromericRepeatId().hashCode());
		result = 37 * result
