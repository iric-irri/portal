...
/**
 * FivePrimeUtrId generated by hbm2java
 */
public class FivePrimeUtrId implements java.io.Serializable {

	private Integer fivePrimeUtrId;
	...
	public FivePrimeUtrId() {
	}

	public FivePrimeUtrId(Integer fivePrimeUtrId, Integer featureId,
		...
		this.fivePrimeUtrId = fivePrimeUtrId;
	...
	public Integer getFivePrimeUtrId() {
		return this.fivePrimeUtrId;
	}

	public void setFivePrimeUtrId(Integer fivePrimeUtrId) {
		this.fivePrimeUtrId = fivePrimeUtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeUtrId))
			return false;
		FivePrimeUtrId castOther = (FivePrimeUtrId) other;

		return ((this.getFivePrimeUtrId() == castOther.getFivePrimeUtrId()) || (this
				.getFivePrimeUtrId() != null
				&& castOther.getFivePrimeUtrId() != null && this
				.getFivePrimeUtrId().equals(castOther.getFivePrimeUtrId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeUtrId() == null ? 0 : this.getFivePrimeUtrId()
						.hashCode());
		result = 37 * result
