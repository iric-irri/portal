...
/**
 * BipartiteInversionId generated by hbm2java
 */
public class BipartiteInversionId implements java.io.Serializable {

	private Integer bipartiteInversionId;
	...
	public BipartiteInversionId() {
	}

	public BipartiteInversionId(Integer bipartiteInversionId,
		...
		this.bipartiteInversionId = bipartiteInversionId;
	...
	public Integer getBipartiteInversionId() {
		return this.bipartiteInversionId;
	}

	public void setBipartiteInversionId(Integer bipartiteInversionId) {
		this.bipartiteInversionId = bipartiteInversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BipartiteInversionId))
			return false;
		BipartiteInversionId castOther = (BipartiteInversionId) other;

		return ((this.getBipartiteInversionId() == castOther
				.getBipartiteInversionId()) || (this.getBipartiteInversionId() != null
				&& castOther.getBipartiteInversionId() != null && this
				.getBipartiteInversionId().equals(
						castOther.getBipartiteInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBipartiteInversionId() == null ? 0 : this
						.getBipartiteInversionId().hashCode());
		result = 37 * result
