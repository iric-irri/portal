...
/**
 * PossibleBaseCallErrorId generated by hbm2java
 */
public class PossibleBaseCallErrorId implements java.io.Serializable {

	private Integer possibleBaseCallErrorId;
	...
	public PossibleBaseCallErrorId() {
	}

	public PossibleBaseCallErrorId(Integer possibleBaseCallErrorId,
		...
		this.possibleBaseCallErrorId = possibleBaseCallErrorId;
	...
	public Integer getPossibleBaseCallErrorId() {
		return this.possibleBaseCallErrorId;
	}

	public void setPossibleBaseCallErrorId(Integer possibleBaseCallErrorId) {
		this.possibleBaseCallErrorId = possibleBaseCallErrorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PossibleBaseCallErrorId))
			return false;
		PossibleBaseCallErrorId castOther = (PossibleBaseCallErrorId) other;

		return ((this.getPossibleBaseCallErrorId() == castOther
				.getPossibleBaseCallErrorId()) || (this
				.getPossibleBaseCallErrorId() != null
				&& castOther.getPossibleBaseCallErrorId() != null && this
				.getPossibleBaseCallErrorId().equals(
						castOther.getPossibleBaseCallErrorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPossibleBaseCallErrorId() == null ? 0 : this
						.getPossibleBaseCallErrorId().hashCode());
		result = 37 * result
