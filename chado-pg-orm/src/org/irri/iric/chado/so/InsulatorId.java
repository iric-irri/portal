...
/**
 * InsulatorId generated by hbm2java
 */
public class InsulatorId implements java.io.Serializable {

	private Integer insulatorId;
	...
	public InsulatorId(Integer insulatorId, Integer featureId,
	...
	public Integer getInsulatorId() {
		return this.insulatorId;
	}

	public void setInsulatorId(Integer insulatorId) {
		this.insulatorId = insulatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsulatorId))
			return false;
		InsulatorId castOther = (InsulatorId) other;

		return ((this.getInsulatorId() == castOther.getInsulatorId()) || (this
				.getInsulatorId() != null && castOther.getInsulatorId() != null && this
				.getInsulatorId().equals(castOther.getInsulatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsulatorId() == null ? 0 : this.getInsulatorId()
						.hashCode());
		result = 37 * result
