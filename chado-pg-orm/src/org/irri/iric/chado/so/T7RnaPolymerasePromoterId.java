...
/**
 * T7RnaPolymerasePromoterId generated by hbm2java
 */
public class T7RnaPolymerasePromoterId implements java.io.Serializable {

	private Integer t7RnaPolymerasePromoterId;
	...
	public T7RnaPolymerasePromoterId() {
	}

	public T7RnaPolymerasePromoterId(Integer t7RnaPolymerasePromoterId,
		...
		this.t7RnaPolymerasePromoterId = t7RnaPolymerasePromoterId;
	...
	public Integer getT7RnaPolymerasePromoterId() {
		return this.t7RnaPolymerasePromoterId;
	}

	public void setT7RnaPolymerasePromoterId(Integer t7RnaPolymerasePromoterId) {
		this.t7RnaPolymerasePromoterId = t7RnaPolymerasePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof T7RnaPolymerasePromoterId))
			return false;
		T7RnaPolymerasePromoterId castOther = (T7RnaPolymerasePromoterId) other;

		return ((this.getT7RnaPolymerasePromoterId() == castOther
				.getT7RnaPolymerasePromoterId()) || (this
				.getT7RnaPolymerasePromoterId() != null
				&& castOther.getT7RnaPolymerasePromoterId() != null && this
				.getT7RnaPolymerasePromoterId().equals(
						castOther.getT7RnaPolymerasePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getT7RnaPolymerasePromoterId() == null ? 0 : this
						.getT7RnaPolymerasePromoterId().hashCode());
		result = 37 * result
