...
/**
 * PolypeptideManganeseIonContactSiteId generated by hbm2java
 */
public class PolypeptideManganeseIonContactSiteId implements
		java.io.Serializable {

	private Integer polypeptideManganeseIonContactSiteId;
	...
	public PolypeptideManganeseIonContactSiteId() {
	}

	public PolypeptideManganeseIonContactSiteId(
			Integer polypeptideManganeseIonContactSiteId, Integer featureId,
		...
		this.polypeptideManganeseIonContactSiteId = polypeptideManganeseIonContactSiteId;
	...
	public Integer getPolypeptideManganeseIonContactSiteId() {
		return this.polypeptideManganeseIonContactSiteId;
	}

	public void setPolypeptideManganeseIonContactSiteId(
			Integer polypeptideManganeseIonContactSiteId) {
		this.polypeptideManganeseIonContactSiteId = polypeptideManganeseIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideManganeseIonContactSiteId))
			return false;
		PolypeptideManganeseIonContactSiteId castOther = (PolypeptideManganeseIonContactSiteId) other;

		return ((this.getPolypeptideManganeseIonContactSiteId() == castOther
				.getPolypeptideManganeseIonContactSiteId()) || (this
				.getPolypeptideManganeseIonContactSiteId() != null
				&& castOther.getPolypeptideManganeseIonContactSiteId() != null && this
				.getPolypeptideManganeseIonContactSiteId().equals(
						castOther.getPolypeptideManganeseIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideManganeseIonContactSiteId() == null ? 0 : this
						.getPolypeptideManganeseIonContactSiteId().hashCode());
		result = 37 * result
