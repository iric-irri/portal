...
/**
 * ChromosomeNumberVariationId generated by hbm2java
 */
public class ChromosomeNumberVariationId implements java.io.Serializable {

	private Integer chromosomeNumberVariationId;
	...
	public ChromosomeNumberVariationId() {
	}

	public ChromosomeNumberVariationId(Integer chromosomeNumberVariationId,
		...
		this.chromosomeNumberVariationId = chromosomeNumberVariationId;
	...
	public Integer getChromosomeNumberVariationId() {
		return this.chromosomeNumberVariationId;
	}

	public void setChromosomeNumberVariationId(
			Integer chromosomeNumberVariationId) {
		this.chromosomeNumberVariationId = chromosomeNumberVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeNumberVariationId))
			return false;
		ChromosomeNumberVariationId castOther = (ChromosomeNumberVariationId) other;

		return ((this.getChromosomeNumberVariationId() == castOther
				.getChromosomeNumberVariationId()) || (this
				.getChromosomeNumberVariationId() != null
				&& castOther.getChromosomeNumberVariationId() != null && this
				.getChromosomeNumberVariationId().equals(
						castOther.getChromosomeNumberVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeNumberVariationId() == null ? 0 : this
						.getChromosomeNumberVariationId().hashCode());
		result = 37 * result
