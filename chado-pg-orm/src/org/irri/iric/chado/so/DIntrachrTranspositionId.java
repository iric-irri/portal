...
/**
 * DIntrachrTranspositionId generated by hbm2java
 */
public class DIntrachrTranspositionId implements java.io.Serializable {

	private Integer DIntrachrTranspositionId;
	...
	public DIntrachrTranspositionId() {
	}

	public DIntrachrTranspositionId(Integer DIntrachrTranspositionId,
		...
		this.DIntrachrTranspositionId = DIntrachrTranspositionId;
	...
	public Integer getDIntrachrTranspositionId() {
		return this.DIntrachrTranspositionId;
	}

	public void setDIntrachrTranspositionId(Integer DIntrachrTranspositionId) {
		this.DIntrachrTranspositionId = DIntrachrTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DIntrachrTranspositionId))
			return false;
		DIntrachrTranspositionId castOther = (DIntrachrTranspositionId) other;

		return ((this.getDIntrachrTranspositionId() == castOther
				.getDIntrachrTranspositionId()) || (this
				.getDIntrachrTranspositionId() != null
				&& castOther.getDIntrachrTranspositionId() != null && this
				.getDIntrachrTranspositionId().equals(
						castOther.getDIntrachrTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDIntrachrTranspositionId() == null ? 0 : this
						.getDIntrachrTranspositionId().hashCode());
		result = 37 * result
