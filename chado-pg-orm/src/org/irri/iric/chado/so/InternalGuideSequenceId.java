...
/**
 * InternalGuideSequenceId generated by hbm2java
 */
public class InternalGuideSequenceId implements java.io.Serializable {

	private Integer internalGuideSequenceId;
	...
	public InternalGuideSequenceId() {
	}

	public InternalGuideSequenceId(Integer internalGuideSequenceId,
		...
		this.internalGuideSequenceId = internalGuideSequenceId;
	...
	public Integer getInternalGuideSequenceId() {
		return this.internalGuideSequenceId;
	}

	public void setInternalGuideSequenceId(Integer internalGuideSequenceId) {
		this.internalGuideSequenceId = internalGuideSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalGuideSequenceId))
			return false;
		InternalGuideSequenceId castOther = (InternalGuideSequenceId) other;

		return ((this.getInternalGuideSequenceId() == castOther
				.getInternalGuideSequenceId()) || (this
				.getInternalGuideSequenceId() != null
				&& castOther.getInternalGuideSequenceId() != null && this
				.getInternalGuideSequenceId().equals(
						castOther.getInternalGuideSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalGuideSequenceId() == null ? 0 : this
						.getInternalGuideSequenceId().hashCode());
		result = 37 * result
