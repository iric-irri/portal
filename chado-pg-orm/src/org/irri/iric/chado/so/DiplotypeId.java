...
/**
 * DiplotypeId generated by hbm2java
 */
public class DiplotypeId implements java.io.Serializable {

	private Integer diplotypeId;
	...
	public DiplotypeId(Integer diplotypeId, Integer featureId,
	...
	public Integer getDiplotypeId() {
		return this.diplotypeId;
	}

	public void setDiplotypeId(Integer diplotypeId) {
		this.diplotypeId = diplotypeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DiplotypeId))
			return false;
		DiplotypeId castOther = (DiplotypeId) other;

		return ((this.getDiplotypeId() == castOther.getDiplotypeId()) || (this
				.getDiplotypeId() != null && castOther.getDiplotypeId() != null && this
				.getDiplotypeId().equals(castOther.getDiplotypeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDiplotypeId() == null ? 0 : this.getDiplotypeId()
						.hashCode());
		result = 37 * result
