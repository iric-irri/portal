...
/**
 * MannosylQueuosineId generated by hbm2java
 */
public class MannosylQueuosineId implements java.io.Serializable {

	private Integer mannosylQueuosineId;
	...
	public MannosylQueuosineId() {
	}

	public MannosylQueuosineId(Integer mannosylQueuosineId, Integer featureId,
		...
		this.mannosylQueuosineId = mannosylQueuosineId;
	...
	public Integer getMannosylQueuosineId() {
		return this.mannosylQueuosineId;
	}

	public void setMannosylQueuosineId(Integer mannosylQueuosineId) {
		this.mannosylQueuosineId = mannosylQueuosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MannosylQueuosineId))
			return false;
		MannosylQueuosineId castOther = (MannosylQueuosineId) other;

		return ((this.getMannosylQueuosineId() == castOther
				.getMannosylQueuosineId()) || (this.getMannosylQueuosineId() != null
				&& castOther.getMannosylQueuosineId() != null && this
				.getMannosylQueuosineId().equals(
						castOther.getMannosylQueuosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMannosylQueuosineId() == null ? 0 : this
						.getMannosylQueuosineId().hashCode());
		result = 37 * result
