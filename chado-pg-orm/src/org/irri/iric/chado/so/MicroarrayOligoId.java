...
/**
 * MicroarrayOligoId generated by hbm2java
 */
public class MicroarrayOligoId implements java.io.Serializable {

	private Integer microarrayOligoId;
	...
	public MicroarrayOligoId() {
	}

	public MicroarrayOligoId(Integer microarrayOligoId, Integer featureId,
		...
		this.microarrayOligoId = microarrayOligoId;
	...
	public Integer getMicroarrayOligoId() {
		return this.microarrayOligoId;
	}

	public void setMicroarrayOligoId(Integer microarrayOligoId) {
		this.microarrayOligoId = microarrayOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MicroarrayOligoId))
			return false;
		MicroarrayOligoId castOther = (MicroarrayOligoId) other;

		return ((this.getMicroarrayOligoId() == castOther
				.getMicroarrayOligoId()) || (this.getMicroarrayOligoId() != null
				&& castOther.getMicroarrayOligoId() != null && this
				.getMicroarrayOligoId()
				.equals(castOther.getMicroarrayOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMicroarrayOligoId() == null ? 0 : this
						.getMicroarrayOligoId().hashCode());
		result = 37 * result
