...
/**
 * AllelicallyExcludedGeneId generated by hbm2java
 */
public class AllelicallyExcludedGeneId implements java.io.Serializable {

	private Integer allelicallyExcludedGeneId;
	...
	public AllelicallyExcludedGeneId() {
	}

	public AllelicallyExcludedGeneId(Integer allelicallyExcludedGeneId,
		...
		this.allelicallyExcludedGeneId = allelicallyExcludedGeneId;
	...
	public Integer getAllelicallyExcludedGeneId() {
		return this.allelicallyExcludedGeneId;
	}

	public void setAllelicallyExcludedGeneId(Integer allelicallyExcludedGeneId) {
		this.allelicallyExcludedGeneId = allelicallyExcludedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AllelicallyExcludedGeneId))
			return false;
		AllelicallyExcludedGeneId castOther = (AllelicallyExcludedGeneId) other;

		return ((this.getAllelicallyExcludedGeneId() == castOther
				.getAllelicallyExcludedGeneId()) || (this
				.getAllelicallyExcludedGeneId() != null
				&& castOther.getAllelicallyExcludedGeneId() != null && this
				.getAllelicallyExcludedGeneId().equals(
						castOther.getAllelicallyExcludedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAllelicallyExcludedGeneId() == null ? 0 : this
						.getAllelicallyExcludedGeneId().hashCode());
		result = 37 * result
