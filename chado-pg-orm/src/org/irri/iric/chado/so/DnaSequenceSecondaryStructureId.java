...
/**
 * DnaSequenceSecondaryStructureId generated by hbm2java
 */
public class DnaSequenceSecondaryStructureId implements java.io.Serializable {

	private Integer dnaSequenceSecondaryStructureId;
	...
	public DnaSequenceSecondaryStructureId() {
	}

	public DnaSequenceSecondaryStructureId(
			Integer dnaSequenceSecondaryStructureId, Integer featureId,
		...
		this.dnaSequenceSecondaryStructureId = dnaSequenceSecondaryStructureId;
	...
	public Integer getDnaSequenceSecondaryStructureId() {
		return this.dnaSequenceSecondaryStructureId;
	}

	public void setDnaSequenceSecondaryStructureId(
			Integer dnaSequenceSecondaryStructureId) {
		this.dnaSequenceSecondaryStructureId = dnaSequenceSecondaryStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaSequenceSecondaryStructureId))
			return false;
		DnaSequenceSecondaryStructureId castOther = (DnaSequenceSecondaryStructureId) other;

		return ((this.getDnaSequenceSecondaryStructureId() == castOther
				.getDnaSequenceSecondaryStructureId()) || (this
				.getDnaSequenceSecondaryStructureId() != null
				&& castOther.getDnaSequenceSecondaryStructureId() != null && this
				.getDnaSequenceSecondaryStructureId().equals(
						castOther.getDnaSequenceSecondaryStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaSequenceSecondaryStructureId() == null ? 0 : this
						.getDnaSequenceSecondaryStructureId().hashCode());
		result = 37 * result
