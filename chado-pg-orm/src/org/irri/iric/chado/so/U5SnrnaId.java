...
/**
 * U5SnrnaId generated by hbm2java
 */
public class U5SnrnaId implements java.io.Serializable {

	private Integer u5SnrnaId;
	...
	public U5SnrnaId(Integer u5SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU5SnrnaId() {
		return this.u5SnrnaId;
	}

	public void setU5SnrnaId(Integer u5SnrnaId) {
		this.u5SnrnaId = u5SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U5SnrnaId))
			return false;
		U5SnrnaId castOther = (U5SnrnaId) other;

		return ((this.getU5SnrnaId() == castOther.getU5SnrnaId()) || (this
				.getU5SnrnaId() != null && castOther.getU5SnrnaId() != null && this
				.getU5SnrnaId().equals(castOther.getU5SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getU5SnrnaId() == null ? 0 : this.getU5SnrnaId().hashCode());
		result = 37 * result
