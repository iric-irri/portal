...
/**
 * InactiveCatalyticSiteId generated by hbm2java
 */
public class InactiveCatalyticSiteId implements java.io.Serializable {

	private Integer inactiveCatalyticSiteId;
	...
	public InactiveCatalyticSiteId() {
	}

	public InactiveCatalyticSiteId(Integer inactiveCatalyticSiteId,
		...
		this.inactiveCatalyticSiteId = inactiveCatalyticSiteId;
	...
	public Integer getInactiveCatalyticSiteId() {
		return this.inactiveCatalyticSiteId;
	}

	public void setInactiveCatalyticSiteId(Integer inactiveCatalyticSiteId) {
		this.inactiveCatalyticSiteId = inactiveCatalyticSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InactiveCatalyticSiteId))
			return false;
		InactiveCatalyticSiteId castOther = (InactiveCatalyticSiteId) other;

		return ((this.getInactiveCatalyticSiteId() == castOther
				.getInactiveCatalyticSiteId()) || (this
				.getInactiveCatalyticSiteId() != null
				&& castOther.getInactiveCatalyticSiteId() != null && this
				.getInactiveCatalyticSiteId().equals(
						castOther.getInactiveCatalyticSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInactiveCatalyticSiteId() == null ? 0 : this
						.getInactiveCatalyticSiteId().hashCode());
		result = 37 * result
