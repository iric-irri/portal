...
/**
 * InternalEliminatedSequenceId generated by hbm2java
 */
public class InternalEliminatedSequenceId implements java.io.Serializable {

	private Integer internalEliminatedSequenceId;
	...
	public InternalEliminatedSequenceId() {
	}

	public InternalEliminatedSequenceId(Integer internalEliminatedSequenceId,
		...
		this.internalEliminatedSequenceId = internalEliminatedSequenceId;
	...
	public Integer getInternalEliminatedSequenceId() {
		return this.internalEliminatedSequenceId;
	}

	public void setInternalEliminatedSequenceId(
			Integer internalEliminatedSequenceId) {
		this.internalEliminatedSequenceId = internalEliminatedSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalEliminatedSequenceId))
			return false;
		InternalEliminatedSequenceId castOther = (InternalEliminatedSequenceId) other;

		return ((this.getInternalEliminatedSequenceId() == castOther
				.getInternalEliminatedSequenceId()) || (this
				.getInternalEliminatedSequenceId() != null
				&& castOther.getInternalEliminatedSequenceId() != null && this
				.getInternalEliminatedSequenceId().equals(
						castOther.getInternalEliminatedSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalEliminatedSequenceId() == null ? 0 : this
						.getInternalEliminatedSequenceId().hashCode());
		result = 37 * result
