...
/**
 * PseudouridylationGuideSnornaId generated by hbm2java
 */
public class PseudouridylationGuideSnornaId implements java.io.Serializable {

	private Integer pseudouridylationGuideSnornaId;
	...
	public PseudouridylationGuideSnornaId() {
	}

	public PseudouridylationGuideSnornaId(
			Integer pseudouridylationGuideSnornaId, Integer featureId,
		...
		this.pseudouridylationGuideSnornaId = pseudouridylationGuideSnornaId;
	...
	public Integer getPseudouridylationGuideSnornaId() {
		return this.pseudouridylationGuideSnornaId;
	}

	public void setPseudouridylationGuideSnornaId(
			Integer pseudouridylationGuideSnornaId) {
		this.pseudouridylationGuideSnornaId = pseudouridylationGuideSnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudouridylationGuideSnornaId))
			return false;
		PseudouridylationGuideSnornaId castOther = (PseudouridylationGuideSnornaId) other;

		return ((this.getPseudouridylationGuideSnornaId() == castOther
				.getPseudouridylationGuideSnornaId()) || (this
				.getPseudouridylationGuideSnornaId() != null
				&& castOther.getPseudouridylationGuideSnornaId() != null && this
				.getPseudouridylationGuideSnornaId().equals(
						castOther.getPseudouridylationGuideSnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudouridylationGuideSnornaId() == null ? 0 : this
						.getPseudouridylationGuideSnornaId().hashCode());
		result = 37 * result
