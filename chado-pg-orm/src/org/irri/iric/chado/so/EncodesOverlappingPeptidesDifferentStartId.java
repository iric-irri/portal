...
/**
 * EncodesOverlappingPeptidesDifferentStartId generated by hbm2java
 */
public class EncodesOverlappingPeptidesDifferentStartId implements
		java.io.Serializable {

	private Integer encodesOverlappingPeptidesDifferentStartId;
	...
	public EncodesOverlappingPeptidesDifferentStartId() {
	}

	public EncodesOverlappingPeptidesDifferentStartId(
			Integer encodesOverlappingPeptidesDifferentStartId,
		...
		this.encodesOverlappingPeptidesDifferentStartId = encodesOverlappingPeptidesDifferentStartId;
	...
	public Integer getEncodesOverlappingPeptidesDifferentStartId() {
		return this.encodesOverlappingPeptidesDifferentStartId;
	}

	public void setEncodesOverlappingPeptidesDifferentStartId(
			Integer encodesOverlappingPeptidesDifferentStartId) {
		this.encodesOverlappingPeptidesDifferentStartId = encodesOverlappingPeptidesDifferentStartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesOverlappingPeptidesDifferentStartId))
			return false;
		EncodesOverlappingPeptidesDifferentStartId castOther = (EncodesOverlappingPeptidesDifferentStartId) other;

		return ((this.getEncodesOverlappingPeptidesDifferentStartId() == castOther
				.getEncodesOverlappingPeptidesDifferentStartId()) || (this
				.getEncodesOverlappingPeptidesDifferentStartId() != null
				&& castOther.getEncodesOverlappingPeptidesDifferentStartId() != null && this
				.getEncodesOverlappingPeptidesDifferentStartId()
				.equals(castOther
						.getEncodesOverlappingPeptidesDifferentStartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesOverlappingPeptidesDifferentStartId() == null ? 0
						: this.getEncodesOverlappingPeptidesDifferentStartId()
								.hashCode());
		result = 37 * result
