...
/**
 * PhenylalanylTrnaId generated by hbm2java
 */
public class PhenylalanylTrnaId implements java.io.Serializable {

	private Integer phenylalanylTrnaId;
	...
	public PhenylalanylTrnaId() {
	}

	public PhenylalanylTrnaId(Integer phenylalanylTrnaId, Integer featureId,
		...
		this.phenylalanylTrnaId = phenylalanylTrnaId;
	...
	public Integer getPhenylalanylTrnaId() {
		return this.phenylalanylTrnaId;
	}

	public void setPhenylalanylTrnaId(Integer phenylalanylTrnaId) {
		this.phenylalanylTrnaId = phenylalanylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhenylalanylTrnaId))
			return false;
		PhenylalanylTrnaId castOther = (PhenylalanylTrnaId) other;

		return ((this.getPhenylalanylTrnaId() == castOther
				.getPhenylalanylTrnaId()) || (this.getPhenylalanylTrnaId() != null
				&& castOther.getPhenylalanylTrnaId() != null && this
				.getPhenylalanylTrnaId().equals(
						castOther.getPhenylalanylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPhenylalanylTrnaId() == null ? 0 : this
						.getPhenylalanylTrnaId().hashCode());
		result = 37 * result
