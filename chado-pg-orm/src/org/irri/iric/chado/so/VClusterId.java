...
/**
 * VClusterId generated by hbm2java
 */
public class VClusterId implements java.io.Serializable {
	...
	public VClusterId(Integer VClusterId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VClusterId))
			return false;
		VClusterId castOther = (VClusterId) other;

		return ((this.getVClusterId() == castOther.getVClusterId()) || (this
				.getVClusterId() != null && castOther.getVClusterId() != null && this
				.getVClusterId().equals(castOther.getVClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVClusterId() == null ? 0 : this.getVClusterId()
						.hashCode());
		result = 37 * result
