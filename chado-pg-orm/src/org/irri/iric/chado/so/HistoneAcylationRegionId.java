...
/**
 * HistoneAcylationRegionId generated by hbm2java
 */
public class HistoneAcylationRegionId implements java.io.Serializable {

	private Integer histoneAcylationRegionId;
	...
	public HistoneAcylationRegionId() {
	}

	public HistoneAcylationRegionId(Integer histoneAcylationRegionId,
		...
		this.histoneAcylationRegionId = histoneAcylationRegionId;
	...
	public Integer getHistoneAcylationRegionId() {
		return this.histoneAcylationRegionId;
	}

	public void setHistoneAcylationRegionId(Integer histoneAcylationRegionId) {
		this.histoneAcylationRegionId = histoneAcylationRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneAcylationRegionId))
			return false;
		HistoneAcylationRegionId castOther = (HistoneAcylationRegionId) other;

		return ((this.getHistoneAcylationRegionId() == castOther
				.getHistoneAcylationRegionId()) || (this
				.getHistoneAcylationRegionId() != null
				&& castOther.getHistoneAcylationRegionId() != null && this
				.getHistoneAcylationRegionId().equals(
						castOther.getHistoneAcylationRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneAcylationRegionId() == null ? 0 : this
						.getHistoneAcylationRegionId().hashCode());
		result = 37 * result
