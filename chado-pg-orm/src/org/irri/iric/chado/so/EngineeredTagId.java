...
/**
 * EngineeredTagId generated by hbm2java
 */
public class EngineeredTagId implements java.io.Serializable {

	private Integer engineeredTagId;
	...
	public EngineeredTagId() {
	}

	public EngineeredTagId(Integer engineeredTagId, Integer featureId,
		...
		this.engineeredTagId = engineeredTagId;
	...
	public Integer getEngineeredTagId() {
		return this.engineeredTagId;
	}

	public void setEngineeredTagId(Integer engineeredTagId) {
		this.engineeredTagId = engineeredTagId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredTagId))
			return false;
		EngineeredTagId castOther = (EngineeredTagId) other;

		return ((this.getEngineeredTagId() == castOther.getEngineeredTagId()) || (this
				.getEngineeredTagId() != null
				&& castOther.getEngineeredTagId() != null && this
				.getEngineeredTagId().equals(castOther.getEngineeredTagId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredTagId() == null ? 0 : this.getEngineeredTagId()
						.hashCode());
		result = 37 * result
