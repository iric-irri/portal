...
/**
 * DicistronicTranscriptId generated by hbm2java
 */
public class DicistronicTranscriptId implements java.io.Serializable {

	private Integer dicistronicTranscriptId;
	...
	public DicistronicTranscriptId() {
	}

	public DicistronicTranscriptId(Integer dicistronicTranscriptId,
		...
		this.dicistronicTranscriptId = dicistronicTranscriptId;
	...
	public Integer getDicistronicTranscriptId() {
		return this.dicistronicTranscriptId;
	}

	public void setDicistronicTranscriptId(Integer dicistronicTranscriptId) {
		this.dicistronicTranscriptId = dicistronicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DicistronicTranscriptId))
			return false;
		DicistronicTranscriptId castOther = (DicistronicTranscriptId) other;

		return ((this.getDicistronicTranscriptId() == castOther
				.getDicistronicTranscriptId()) || (this
				.getDicistronicTranscriptId() != null
				&& castOther.getDicistronicTranscriptId() != null && this
				.getDicistronicTranscriptId().equals(
						castOther.getDicistronicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDicistronicTranscriptId() == null ? 0 : this
						.getDicistronicTranscriptId().hashCode());
		result = 37 * result
