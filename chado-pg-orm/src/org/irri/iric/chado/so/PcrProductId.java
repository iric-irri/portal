...
/**
 * PcrProductId generated by hbm2java
 */
public class PcrProductId implements java.io.Serializable {

	private Integer pcrProductId;
	...
	public PcrProductId(Integer pcrProductId, Integer featureId,
		...
		this.pcrProductId = pcrProductId;
	...
	public Integer getPcrProductId() {
		return this.pcrProductId;
	}

	public void setPcrProductId(Integer pcrProductId) {
		this.pcrProductId = pcrProductId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PcrProductId))
			return false;
		PcrProductId castOther = (PcrProductId) other;

		return ((this.getPcrProductId() == castOther.getPcrProductId()) || (this
				.getPcrProductId() != null
				&& castOther.getPcrProductId() != null && this
				.getPcrProductId().equals(castOther.getPcrProductId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPcrProductId() == null ? 0 : this.getPcrProductId()
						.hashCode());
		result = 37 * result
