...
/**
 * BetaStrandId generated by hbm2java
 */
public class BetaStrandId implements java.io.Serializable {

	private Integer betaStrandId;
	...
	public BetaStrandId(Integer betaStrandId, Integer featureId,
		...
		this.betaStrandId = betaStrandId;
	...
	public Integer getBetaStrandId() {
		return this.betaStrandId;
	}

	public void setBetaStrandId(Integer betaStrandId) {
		this.betaStrandId = betaStrandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaStrandId))
			return false;
		BetaStrandId castOther = (BetaStrandId) other;

		return ((this.getBetaStrandId() == castOther.getBetaStrandId()) || (this
				.getBetaStrandId() != null
				&& castOther.getBetaStrandId() != null && this
				.getBetaStrandId().equals(castOther.getBetaStrandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaStrandId() == null ? 0 : this.getBetaStrandId()
						.hashCode());
		result = 37 * result
