...
/**
 * GeneWithStopCodonReadThroughId generated by hbm2java
 */
public class GeneWithStopCodonReadThroughId implements java.io.Serializable {

	private Integer geneWithStopCodonReadThroughId;
	...
	public GeneWithStopCodonReadThroughId() {
	}

	public GeneWithStopCodonReadThroughId(
			Integer geneWithStopCodonReadThroughId, Integer featureId,
		...
		this.geneWithStopCodonReadThroughId = geneWithStopCodonReadThroughId;
	...
	public Integer getGeneWithStopCodonReadThroughId() {
		return this.geneWithStopCodonReadThroughId;
	}

	public void setGeneWithStopCodonReadThroughId(
			Integer geneWithStopCodonReadThroughId) {
		this.geneWithStopCodonReadThroughId = geneWithStopCodonReadThroughId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithStopCodonReadThroughId))
			return false;
		GeneWithStopCodonReadThroughId castOther = (GeneWithStopCodonReadThroughId) other;

		return ((this.getGeneWithStopCodonReadThroughId() == castOther
				.getGeneWithStopCodonReadThroughId()) || (this
				.getGeneWithStopCodonReadThroughId() != null
				&& castOther.getGeneWithStopCodonReadThroughId() != null && this
				.getGeneWithStopCodonReadThroughId().equals(
						castOther.getGeneWithStopCodonReadThroughId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithStopCodonReadThroughId() == null ? 0 : this
						.getGeneWithStopCodonReadThroughId().hashCode());
		result = 37 * result
