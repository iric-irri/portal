...
/**
 * EpitopeId generated by hbm2java
 */
public class EpitopeId implements java.io.Serializable {

	private Integer epitopeId;
	...
	public EpitopeId(Integer epitopeId, Integer featureId, Integer dbxrefId,
	...
	public Integer getEpitopeId() {
		return this.epitopeId;
	}

	public void setEpitopeId(Integer epitopeId) {
		this.epitopeId = epitopeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpitopeId))
			return false;
		EpitopeId castOther = (EpitopeId) other;

		return ((this.getEpitopeId() == castOther.getEpitopeId()) || (this
				.getEpitopeId() != null && castOther.getEpitopeId() != null && this
				.getEpitopeId().equals(castOther.getEpitopeId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getEpitopeId() == null ? 0 : this.getEpitopeId().hashCode());
		result = 37 * result
