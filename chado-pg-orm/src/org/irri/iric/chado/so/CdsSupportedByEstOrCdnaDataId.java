...
/**
 * CdsSupportedByEstOrCdnaDataId generated by hbm2java
 */
public class CdsSupportedByEstOrCdnaDataId implements java.io.Serializable {

	private Integer cdsSupportedByEstOrCdnaDataId;
	...
	public CdsSupportedByEstOrCdnaDataId() {
	}

	public CdsSupportedByEstOrCdnaDataId(Integer cdsSupportedByEstOrCdnaDataId,
		...
		this.cdsSupportedByEstOrCdnaDataId = cdsSupportedByEstOrCdnaDataId;
	...
	public Integer getCdsSupportedByEstOrCdnaDataId() {
		return this.cdsSupportedByEstOrCdnaDataId;
	}

	public void setCdsSupportedByEstOrCdnaDataId(
			Integer cdsSupportedByEstOrCdnaDataId) {
		this.cdsSupportedByEstOrCdnaDataId = cdsSupportedByEstOrCdnaDataId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsSupportedByEstOrCdnaDataId))
			return false;
		CdsSupportedByEstOrCdnaDataId castOther = (CdsSupportedByEstOrCdnaDataId) other;

		return ((this.getCdsSupportedByEstOrCdnaDataId() == castOther
				.getCdsSupportedByEstOrCdnaDataId()) || (this
				.getCdsSupportedByEstOrCdnaDataId() != null
				&& castOther.getCdsSupportedByEstOrCdnaDataId() != null && this
				.getCdsSupportedByEstOrCdnaDataId().equals(
						castOther.getCdsSupportedByEstOrCdnaDataId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsSupportedByEstOrCdnaDataId() == null ? 0 : this
						.getCdsSupportedByEstOrCdnaDataId().hashCode());
		result = 37 * result
