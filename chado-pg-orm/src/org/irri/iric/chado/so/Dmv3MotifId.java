...
/**
 * Dmv3MotifId generated by hbm2java
 */
public class Dmv3MotifId implements java.io.Serializable {

	private Integer dmv3MotifId;
	...
	public Dmv3MotifId(Integer dmv3MotifId, Integer featureId,
	...
	public Integer getDmv3MotifId() {
		return this.dmv3MotifId;
	}

	public void setDmv3MotifId(Integer dmv3MotifId) {
		this.dmv3MotifId = dmv3MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dmv3MotifId))
			return false;
		Dmv3MotifId castOther = (Dmv3MotifId) other;

		return ((this.getDmv3MotifId() == castOther.getDmv3MotifId()) || (this
				.getDmv3MotifId() != null && castOther.getDmv3MotifId() != null && this
				.getDmv3MotifId().equals(castOther.getDmv3MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDmv3MotifId() == null ? 0 : this.getDmv3MotifId()
						.hashCode());
		result = 37 * result
