...
/**
 * ConservativeMissenseCodonId generated by hbm2java
 */
public class ConservativeMissenseCodonId implements java.io.Serializable {

	private Integer conservativeMissenseCodonId;
	...
	public ConservativeMissenseCodonId() {
	}

	public ConservativeMissenseCodonId(Integer conservativeMissenseCodonId,
		...
		this.conservativeMissenseCodonId = conservativeMissenseCodonId;
	...
	public Integer getConservativeMissenseCodonId() {
		return this.conservativeMissenseCodonId;
	}

	public void setConservativeMissenseCodonId(
			Integer conservativeMissenseCodonId) {
		this.conservativeMissenseCodonId = conservativeMissenseCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConservativeMissenseCodonId))
			return false;
		ConservativeMissenseCodonId castOther = (ConservativeMissenseCodonId) other;

		return ((this.getConservativeMissenseCodonId() == castOther
				.getConservativeMissenseCodonId()) || (this
				.getConservativeMissenseCodonId() != null
				&& castOther.getConservativeMissenseCodonId() != null && this
				.getConservativeMissenseCodonId().equals(
						castOther.getConservativeMissenseCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConservativeMissenseCodonId() == null ? 0 : this
						.getConservativeMissenseCodonId().hashCode());
		result = 37 * result
