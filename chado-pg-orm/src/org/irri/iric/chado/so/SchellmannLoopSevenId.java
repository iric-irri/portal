...
/**
 * SchellmannLoopSevenId generated by hbm2java
 */
public class SchellmannLoopSevenId implements java.io.Serializable {

	private Integer schellmannLoopSevenId;
	...
	public SchellmannLoopSevenId() {
	}

	public SchellmannLoopSevenId(Integer schellmannLoopSevenId,
		...
		this.schellmannLoopSevenId = schellmannLoopSevenId;
	...
	public Integer getSchellmannLoopSevenId() {
		return this.schellmannLoopSevenId;
	}

	public void setSchellmannLoopSevenId(Integer schellmannLoopSevenId) {
		this.schellmannLoopSevenId = schellmannLoopSevenId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SchellmannLoopSevenId))
			return false;
		SchellmannLoopSevenId castOther = (SchellmannLoopSevenId) other;

		return ((this.getSchellmannLoopSevenId() == castOther
				.getSchellmannLoopSevenId()) || (this
				.getSchellmannLoopSevenId() != null
				&& castOther.getSchellmannLoopSevenId() != null && this
				.getSchellmannLoopSevenId().equals(
						castOther.getSchellmannLoopSevenId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSchellmannLoopSevenId() == null ? 0 : this
						.getSchellmannLoopSevenId().hashCode());
		result = 37 * result
