...
/**
 * Plus2FramshiftId generated by hbm2java
 */
public class Plus2FramshiftId implements java.io.Serializable {

	private Integer plus2FramshiftId;
	...
	public Plus2FramshiftId() {
	}

	public Plus2FramshiftId(Integer plus2FramshiftId, Integer featureId,
		...
		this.plus2FramshiftId = plus2FramshiftId;
	...
	public Integer getPlus2FramshiftId() {
		return this.plus2FramshiftId;
	}

	public void setPlus2FramshiftId(Integer plus2FramshiftId) {
		this.plus2FramshiftId = plus2FramshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus2FramshiftId))
			return false;
		Plus2FramshiftId castOther = (Plus2FramshiftId) other;

		return ((this.getPlus2FramshiftId() == castOther.getPlus2FramshiftId()) || (this
				.getPlus2FramshiftId() != null
				&& castOther.getPlus2FramshiftId() != null && this
				.getPlus2FramshiftId().equals(castOther.getPlus2FramshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus2FramshiftId() == null ? 0 : this
						.getPlus2FramshiftId().hashCode());
		result = 37 * result
