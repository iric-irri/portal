...
/**
 * ExonOfSingleExonGeneId generated by hbm2java
 */
public class ExonOfSingleExonGeneId implements java.io.Serializable {

	private Integer exonOfSingleExonGeneId;
	...
	public ExonOfSingleExonGeneId() {
	}

	public ExonOfSingleExonGeneId(Integer exonOfSingleExonGeneId,
		...
		this.exonOfSingleExonGeneId = exonOfSingleExonGeneId;
	...
	public Integer getExonOfSingleExonGeneId() {
		return this.exonOfSingleExonGeneId;
	}

	public void setExonOfSingleExonGeneId(Integer exonOfSingleExonGeneId) {
		this.exonOfSingleExonGeneId = exonOfSingleExonGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonOfSingleExonGeneId))
			return false;
		ExonOfSingleExonGeneId castOther = (ExonOfSingleExonGeneId) other;

		return ((this.getExonOfSingleExonGeneId() == castOther
				.getExonOfSingleExonGeneId()) || (this
				.getExonOfSingleExonGeneId() != null
				&& castOther.getExonOfSingleExonGeneId() != null && this
				.getExonOfSingleExonGeneId().equals(
						castOther.getExonOfSingleExonGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonOfSingleExonGeneId() == null ? 0 : this
						.getExonOfSingleExonGeneId().hashCode());
		result = 37 * result
