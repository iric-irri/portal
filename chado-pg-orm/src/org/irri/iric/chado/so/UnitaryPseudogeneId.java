...
/**
 * UnitaryPseudogeneId generated by hbm2java
 */
public class UnitaryPseudogeneId implements java.io.Serializable {

	private Integer unitaryPseudogeneId;
	...
	public UnitaryPseudogeneId() {
	}

	public UnitaryPseudogeneId(Integer unitaryPseudogeneId, Integer featureId,
		...
		this.unitaryPseudogeneId = unitaryPseudogeneId;
	...
	public Integer getUnitaryPseudogeneId() {
		return this.unitaryPseudogeneId;
	}

	public void setUnitaryPseudogeneId(Integer unitaryPseudogeneId) {
		this.unitaryPseudogeneId = unitaryPseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnitaryPseudogeneId))
			return false;
		UnitaryPseudogeneId castOther = (UnitaryPseudogeneId) other;

		return ((this.getUnitaryPseudogeneId() == castOther
				.getUnitaryPseudogeneId()) || (this.getUnitaryPseudogeneId() != null
				&& castOther.getUnitaryPseudogeneId() != null && this
				.getUnitaryPseudogeneId().equals(
						castOther.getUnitaryPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUnitaryPseudogeneId() == null ? 0 : this
						.getUnitaryPseudogeneId().hashCode());
		result = 37 * result
