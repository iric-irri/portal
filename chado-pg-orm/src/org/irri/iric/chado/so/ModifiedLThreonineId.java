...
/**
 * ModifiedLThreonineId generated by hbm2java
 */
public class ModifiedLThreonineId implements java.io.Serializable {

	private Integer modifiedLThreonineId;
	...
	public ModifiedLThreonineId() {
	}

	public ModifiedLThreonineId(Integer modifiedLThreonineId,
		...
		this.modifiedLThreonineId = modifiedLThreonineId;
	...
	public Integer getModifiedLThreonineId() {
		return this.modifiedLThreonineId;
	}

	public void setModifiedLThreonineId(Integer modifiedLThreonineId) {
		this.modifiedLThreonineId = modifiedLThreonineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLThreonineId))
			return false;
		ModifiedLThreonineId castOther = (ModifiedLThreonineId) other;

		return ((this.getModifiedLThreonineId() == castOther
				.getModifiedLThreonineId()) || (this.getModifiedLThreonineId() != null
				&& castOther.getModifiedLThreonineId() != null && this
				.getModifiedLThreonineId().equals(
						castOther.getModifiedLThreonineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLThreonineId() == null ? 0 : this
						.getModifiedLThreonineId().hashCode());
		result = 37 * result
