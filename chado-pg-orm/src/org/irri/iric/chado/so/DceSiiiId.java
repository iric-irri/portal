...
/**
 * DceSiiiId generated by hbm2java
 */
public class DceSiiiId implements java.io.Serializable {

	private Integer dceSiiiId;
	...
	public DceSiiiId(Integer dceSiiiId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDceSiiiId() {
		return this.dceSiiiId;
	}

	public void setDceSiiiId(Integer dceSiiiId) {
		this.dceSiiiId = dceSiiiId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DceSiiiId))
			return false;
		DceSiiiId castOther = (DceSiiiId) other;

		return ((this.getDceSiiiId() == castOther.getDceSiiiId()) || (this
				.getDceSiiiId() != null && castOther.getDceSiiiId() != null && this
				.getDceSiiiId().equals(castOther.getDceSiiiId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDceSiiiId() == null ? 0 : this.getDceSiiiId().hashCode());
		result = 37 * result
