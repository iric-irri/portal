...
/**
 * ThreePrimeDNonamerId generated by hbm2java
 */
public class ThreePrimeDNonamerId implements java.io.Serializable {

	private Integer threePrimeDNonamerId;
	...
	public ThreePrimeDNonamerId() {
	}

	public ThreePrimeDNonamerId(Integer threePrimeDNonamerId,
		...
		this.threePrimeDNonamerId = threePrimeDNonamerId;
	...
	public Integer getThreePrimeDNonamerId() {
		return this.threePrimeDNonamerId;
	}

	public void setThreePrimeDNonamerId(Integer threePrimeDNonamerId) {
		this.threePrimeDNonamerId = threePrimeDNonamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeDNonamerId))
			return false;
		ThreePrimeDNonamerId castOther = (ThreePrimeDNonamerId) other;

		return ((this.getThreePrimeDNonamerId() == castOther
				.getThreePrimeDNonamerId()) || (this.getThreePrimeDNonamerId() != null
				&& castOther.getThreePrimeDNonamerId() != null && this
				.getThreePrimeDNonamerId().equals(
						castOther.getThreePrimeDNonamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeDNonamerId() == null ? 0 : this
						.getThreePrimeDNonamerId().hashCode());
		result = 37 * result
