...
/**
 * IntrachromosomalTranspositionId generated by hbm2java
 */
public class IntrachromosomalTranspositionId implements java.io.Serializable {

	private Integer intrachromosomalTranspositionId;
	...
	public IntrachromosomalTranspositionId() {
	}

	public IntrachromosomalTranspositionId(
			Integer intrachromosomalTranspositionId, Integer featureId,
		...
		this.intrachromosomalTranspositionId = intrachromosomalTranspositionId;
	...
	public Integer getIntrachromosomalTranspositionId() {
		return this.intrachromosomalTranspositionId;
	}

	public void setIntrachromosomalTranspositionId(
			Integer intrachromosomalTranspositionId) {
		this.intrachromosomalTranspositionId = intrachromosomalTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrachromosomalTranspositionId))
			return false;
		IntrachromosomalTranspositionId castOther = (IntrachromosomalTranspositionId) other;

		return ((this.getIntrachromosomalTranspositionId() == castOther
				.getIntrachromosomalTranspositionId()) || (this
				.getIntrachromosomalTranspositionId() != null
				&& castOther.getIntrachromosomalTranspositionId() != null && this
				.getIntrachromosomalTranspositionId().equals(
						castOther.getIntrachromosomalTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrachromosomalTranspositionId() == null ? 0 : this
						.getIntrachromosomalTranspositionId().hashCode());
		result = 37 * result
