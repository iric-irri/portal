...
/**
 * IndelId generated by hbm2java
 */
public class IndelId implements java.io.Serializable {

	private Integer indelId;
	...
	public IndelId(Integer indelId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIndelId() {
		return this.indelId;
	}

	public void setIndelId(Integer indelId) {
		this.indelId = indelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IndelId))
			return false;
		IndelId castOther = (IndelId) other;

		return ((this.getIndelId() == castOther.getIndelId()) || (this
				.getIndelId() != null && castOther.getIndelId() != null && this
				.getIndelId().equals(castOther.getIndelId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getIndelId() == null ? 0 : this.getIndelId().hashCode());
		result = 37 * result
