...
/**
 * MrnaRegionId generated by hbm2java
 */
public class MrnaRegionId implements java.io.Serializable {

	private Integer mrnaRegionId;
	...
	public MrnaRegionId(Integer mrnaRegionId, Integer featureId,
		...
		this.mrnaRegionId = mrnaRegionId;
	...
	public Integer getMrnaRegionId() {
		return this.mrnaRegionId;
	}

	public void setMrnaRegionId(Integer mrnaRegionId) {
		this.mrnaRegionId = mrnaRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaRegionId))
			return false;
		MrnaRegionId castOther = (MrnaRegionId) other;

		return ((this.getMrnaRegionId() == castOther.getMrnaRegionId()) || (this
				.getMrnaRegionId() != null
				&& castOther.getMrnaRegionId() != null && this
				.getMrnaRegionId().equals(castOther.getMrnaRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaRegionId() == null ? 0 : this.getMrnaRegionId()
						.hashCode());
		result = 37 * result
