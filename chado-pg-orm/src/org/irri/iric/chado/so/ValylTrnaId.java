...
/**
 * ValylTrnaId generated by hbm2java
 */
public class ValylTrnaId implements java.io.Serializable {

	private Integer valylTrnaId;
	...
	public ValylTrnaId(Integer valylTrnaId, Integer featureId,
	...
	public Integer getValylTrnaId() {
		return this.valylTrnaId;
	}

	public void setValylTrnaId(Integer valylTrnaId) {
		this.valylTrnaId = valylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ValylTrnaId))
			return false;
		ValylTrnaId castOther = (ValylTrnaId) other;

		return ((this.getValylTrnaId() == castOther.getValylTrnaId()) || (this
				.getValylTrnaId() != null && castOther.getValylTrnaId() != null && this
				.getValylTrnaId().equals(castOther.getValylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getValylTrnaId() == null ? 0 : this.getValylTrnaId()
						.hashCode());
		result = 37 * result
