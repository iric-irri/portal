...
/**
 * MirnaId generated by hbm2java
 */
public class MirnaId implements java.io.Serializable {
	...
	public MirnaId(Integer mirnaId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaId))
			return false;
		MirnaId castOther = (MirnaId) other;

		return ((this.getMirnaId() == castOther.getMirnaId()) || (this
				.getMirnaId() != null && castOther.getMirnaId() != null && this
				.getMirnaId().equals(castOther.getMirnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMirnaId() == null ? 0 : this.getMirnaId().hashCode());
		result = 37 * result
