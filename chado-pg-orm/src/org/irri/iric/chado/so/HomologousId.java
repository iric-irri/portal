...
/**
 * HomologousId generated by hbm2java
 */
public class HomologousId implements java.io.Serializable {

	private Integer homologousId;
	...
	public HomologousId(Integer homologousId, Integer featureId,
	...
	public Integer getHomologousId() {
		return this.homologousId;
	}

	public void setHomologousId(Integer homologousId) {
		this.homologousId = homologousId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HomologousId))
			return false;
		HomologousId castOther = (HomologousId) other;

		return ((this.getHomologousId() == castOther.getHomologousId()) || (this
				.getHomologousId() != null
				&& castOther.getHomologousId() != null && this
				.getHomologousId().equals(castOther.getHomologousId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHomologousId() == null ? 0 : this.getHomologousId()
						.hashCode());
		result = 37 * result
