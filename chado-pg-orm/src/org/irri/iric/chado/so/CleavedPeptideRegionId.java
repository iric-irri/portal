...
/**
 * CleavedPeptideRegionId generated by hbm2java
 */
public class CleavedPeptideRegionId implements java.io.Serializable {

	private Integer cleavedPeptideRegionId;
	...
	public CleavedPeptideRegionId() {
	}

	public CleavedPeptideRegionId(Integer cleavedPeptideRegionId,
		...
		this.cleavedPeptideRegionId = cleavedPeptideRegionId;
	...
	public Integer getCleavedPeptideRegionId() {
		return this.cleavedPeptideRegionId;
	}

	public void setCleavedPeptideRegionId(Integer cleavedPeptideRegionId) {
		this.cleavedPeptideRegionId = cleavedPeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CleavedPeptideRegionId))
			return false;
		CleavedPeptideRegionId castOther = (CleavedPeptideRegionId) other;

		return ((this.getCleavedPeptideRegionId() == castOther
				.getCleavedPeptideRegionId()) || (this
				.getCleavedPeptideRegionId() != null
				&& castOther.getCleavedPeptideRegionId() != null && this
				.getCleavedPeptideRegionId().equals(
						castOther.getCleavedPeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCleavedPeptideRegionId() == null ? 0 : this
						.getCleavedPeptideRegionId().hashCode());
		result = 37 * result
