...
/**
 * TwoMethylthioN6MethyladenosineId generated by hbm2java
 */
public class TwoMethylthioN6MethyladenosineId implements java.io.Serializable {

	private Integer twoMethylthioN6MethyladenosineId;
	...
	public TwoMethylthioN6MethyladenosineId() {
	}

	public TwoMethylthioN6MethyladenosineId(
			Integer twoMethylthioN6MethyladenosineId, Integer featureId,
		...
		this.twoMethylthioN6MethyladenosineId = twoMethylthioN6MethyladenosineId;
	...
	public Integer getTwoMethylthioN6MethyladenosineId() {
		return this.twoMethylthioN6MethyladenosineId;
	}

	public void setTwoMethylthioN6MethyladenosineId(
			Integer twoMethylthioN6MethyladenosineId) {
		this.twoMethylthioN6MethyladenosineId = twoMethylthioN6MethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethylthioN6MethyladenosineId))
			return false;
		TwoMethylthioN6MethyladenosineId castOther = (TwoMethylthioN6MethyladenosineId) other;

		return ((this.getTwoMethylthioN6MethyladenosineId() == castOther
				.getTwoMethylthioN6MethyladenosineId()) || (this
				.getTwoMethylthioN6MethyladenosineId() != null
				&& castOther.getTwoMethylthioN6MethyladenosineId() != null && this
				.getTwoMethylthioN6MethyladenosineId().equals(
						castOther.getTwoMethylthioN6MethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethylthioN6MethyladenosineId() == null ? 0 : this
						.getTwoMethylthioN6MethyladenosineId().hashCode());
		result = 37 * result
