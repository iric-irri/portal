...
/**
 * EncodesAlternatelySplicedTranscriptsId generated by hbm2java
 */
public class EncodesAlternatelySplicedTranscriptsId implements
		java.io.Serializable {

	private Integer encodesAlternatelySplicedTranscriptsId;
	...
	public EncodesAlternatelySplicedTranscriptsId() {
	}

	public EncodesAlternatelySplicedTranscriptsId(
			Integer encodesAlternatelySplicedTranscriptsId, Integer featureId,
		...
		this.encodesAlternatelySplicedTranscriptsId = encodesAlternatelySplicedTranscriptsId;
	...
	public Integer getEncodesAlternatelySplicedTranscriptsId() {
		return this.encodesAlternatelySplicedTranscriptsId;
	}

	public void setEncodesAlternatelySplicedTranscriptsId(
			Integer encodesAlternatelySplicedTranscriptsId) {
		this.encodesAlternatelySplicedTranscriptsId = encodesAlternatelySplicedTranscriptsId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesAlternatelySplicedTranscriptsId))
			return false;
		EncodesAlternatelySplicedTranscriptsId castOther = (EncodesAlternatelySplicedTranscriptsId) other;

		return ((this.getEncodesAlternatelySplicedTranscriptsId() == castOther
				.getEncodesAlternatelySplicedTranscriptsId()) || (this
				.getEncodesAlternatelySplicedTranscriptsId() != null
				&& castOther.getEncodesAlternatelySplicedTranscriptsId() != null && this
				.getEncodesAlternatelySplicedTranscriptsId().equals(
						castOther.getEncodesAlternatelySplicedTranscriptsId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesAlternatelySplicedTranscriptsId() == null ? 0
						: this.getEncodesAlternatelySplicedTranscriptsId()
								.hashCode());
		result = 37 * result
