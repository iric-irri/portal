...
/**
 * ProcessedPseudogeneId generated by hbm2java
 */
public class ProcessedPseudogeneId implements java.io.Serializable {

	private Integer processedPseudogeneId;
	...
	public ProcessedPseudogeneId() {
	}

	public ProcessedPseudogeneId(Integer processedPseudogeneId,
		...
		this.processedPseudogeneId = processedPseudogeneId;
	...
	public Integer getProcessedPseudogeneId() {
		return this.processedPseudogeneId;
	}

	public void setProcessedPseudogeneId(Integer processedPseudogeneId) {
		this.processedPseudogeneId = processedPseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProcessedPseudogeneId))
			return false;
		ProcessedPseudogeneId castOther = (ProcessedPseudogeneId) other;

		return ((this.getProcessedPseudogeneId() == castOther
				.getProcessedPseudogeneId()) || (this
				.getProcessedPseudogeneId() != null
				&& castOther.getProcessedPseudogeneId() != null && this
				.getProcessedPseudogeneId().equals(
						castOther.getProcessedPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProcessedPseudogeneId() == null ? 0 : this
						.getProcessedPseudogeneId().hashCode());
		result = 37 * result
