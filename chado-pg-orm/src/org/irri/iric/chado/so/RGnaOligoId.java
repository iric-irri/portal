...
/**
 * RGnaOligoId generated by hbm2java
 */
public class RGnaOligoId implements java.io.Serializable {

	private Integer RGnaOligoId;
	...
	public RGnaOligoId(Integer RGnaOligoId, Integer featureId,
	...
	public Integer getRGnaOligoId() {
		return this.RGnaOligoId;
	}

	public void setRGnaOligoId(Integer RGnaOligoId) {
		this.RGnaOligoId = RGnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RGnaOligoId))
			return false;
		RGnaOligoId castOther = (RGnaOligoId) other;

		return ((this.getRGnaOligoId() == castOther.getRGnaOligoId()) || (this
				.getRGnaOligoId() != null && castOther.getRGnaOligoId() != null && this
				.getRGnaOligoId().equals(castOther.getRGnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRGnaOligoId() == null ? 0 : this.getRGnaOligoId()
						.hashCode());
		result = 37 * result
