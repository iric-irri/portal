...
/**
 * ExtrachromosomalMobileGeneticElementId generated by hbm2java
 */
public class ExtrachromosomalMobileGeneticElementId implements
		java.io.Serializable {

	private Integer extrachromosomalMobileGeneticElementId;
	...
	public ExtrachromosomalMobileGeneticElementId() {
	}

	public ExtrachromosomalMobileGeneticElementId(
			Integer extrachromosomalMobileGeneticElementId, Integer featureId,
		...
		this.extrachromosomalMobileGeneticElementId = extrachromosomalMobileGeneticElementId;
	...
	public Integer getExtrachromosomalMobileGeneticElementId() {
		return this.extrachromosomalMobileGeneticElementId;
	}

	public void setExtrachromosomalMobileGeneticElementId(
			Integer extrachromosomalMobileGeneticElementId) {
		this.extrachromosomalMobileGeneticElementId = extrachromosomalMobileGeneticElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExtrachromosomalMobileGeneticElementId))
			return false;
		ExtrachromosomalMobileGeneticElementId castOther = (ExtrachromosomalMobileGeneticElementId) other;

		return ((this.getExtrachromosomalMobileGeneticElementId() == castOther
				.getExtrachromosomalMobileGeneticElementId()) || (this
				.getExtrachromosomalMobileGeneticElementId() != null
				&& castOther.getExtrachromosomalMobileGeneticElementId() != null && this
				.getExtrachromosomalMobileGeneticElementId().equals(
						castOther.getExtrachromosomalMobileGeneticElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExtrachromosomalMobileGeneticElementId() == null ? 0
						: this.getExtrachromosomalMobileGeneticElementId()
								.hashCode());
		result = 37 * result
