...
/**
 * QueuosineId generated by hbm2java
 */
public class QueuosineId implements java.io.Serializable {

	private Integer queuosineId;
	...
	public QueuosineId(Integer queuosineId, Integer featureId,
	...
	public Integer getQueuosineId() {
		return this.queuosineId;
	}

	public void setQueuosineId(Integer queuosineId) {
		this.queuosineId = queuosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QueuosineId))
			return false;
		QueuosineId castOther = (QueuosineId) other;

		return ((this.getQueuosineId() == castOther.getQueuosineId()) || (this
				.getQueuosineId() != null && castOther.getQueuosineId() != null && this
				.getQueuosineId().equals(castOther.getQueuosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getQueuosineId() == null ? 0 : this.getQueuosineId()
						.hashCode());
		result = 37 * result
