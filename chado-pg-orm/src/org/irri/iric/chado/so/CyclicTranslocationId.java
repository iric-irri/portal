...
/**
 * CyclicTranslocationId generated by hbm2java
 */
public class CyclicTranslocationId implements java.io.Serializable {

	private Integer cyclicTranslocationId;
	...
	public CyclicTranslocationId() {
	}

	public CyclicTranslocationId(Integer cyclicTranslocationId,
		...
		this.cyclicTranslocationId = cyclicTranslocationId;
	...
	public Integer getCyclicTranslocationId() {
		return this.cyclicTranslocationId;
	}

	public void setCyclicTranslocationId(Integer cyclicTranslocationId) {
		this.cyclicTranslocationId = cyclicTranslocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CyclicTranslocationId))
			return false;
		CyclicTranslocationId castOther = (CyclicTranslocationId) other;

		return ((this.getCyclicTranslocationId() == castOther
				.getCyclicTranslocationId()) || (this
				.getCyclicTranslocationId() != null
				&& castOther.getCyclicTranslocationId() != null && this
				.getCyclicTranslocationId().equals(
						castOther.getCyclicTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCyclicTranslocationId() == null ? 0 : this
						.getCyclicTranslocationId().hashCode());
		result = 37 * result
