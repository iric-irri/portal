...
/**
 * InvalidatedByGenomicPolyaPrimedCdnaId generated by hbm2java
 */
public class InvalidatedByGenomicPolyaPrimedCdnaId implements
		java.io.Serializable {

	private Integer invalidatedByGenomicPolyaPrimedCdnaId;
	...
	public InvalidatedByGenomicPolyaPrimedCdnaId() {
	}

	public InvalidatedByGenomicPolyaPrimedCdnaId(
			Integer invalidatedByGenomicPolyaPrimedCdnaId, Integer featureId,
		...
		this.invalidatedByGenomicPolyaPrimedCdnaId = invalidatedByGenomicPolyaPrimedCdnaId;
	...
	public Integer getInvalidatedByGenomicPolyaPrimedCdnaId() {
		return this.invalidatedByGenomicPolyaPrimedCdnaId;
	}

	public void setInvalidatedByGenomicPolyaPrimedCdnaId(
			Integer invalidatedByGenomicPolyaPrimedCdnaId) {
		this.invalidatedByGenomicPolyaPrimedCdnaId = invalidatedByGenomicPolyaPrimedCdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedByGenomicPolyaPrimedCdnaId))
			return false;
		InvalidatedByGenomicPolyaPrimedCdnaId castOther = (InvalidatedByGenomicPolyaPrimedCdnaId) other;

		return ((this.getInvalidatedByGenomicPolyaPrimedCdnaId() == castOther
				.getInvalidatedByGenomicPolyaPrimedCdnaId()) || (this
				.getInvalidatedByGenomicPolyaPrimedCdnaId() != null
				&& castOther.getInvalidatedByGenomicPolyaPrimedCdnaId() != null && this
				.getInvalidatedByGenomicPolyaPrimedCdnaId().equals(
						castOther.getInvalidatedByGenomicPolyaPrimedCdnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedByGenomicPolyaPrimedCdnaId() == null ? 0
						: this.getInvalidatedByGenomicPolyaPrimedCdnaId()
								.hashCode());
		result = 37 * result
