...
/**
 * TransSplicedMrnaId generated by hbm2java
 */
public class TransSplicedMrnaId implements java.io.Serializable {

	private Integer transSplicedMrnaId;
	...
	public TransSplicedMrnaId() {
	}

	public TransSplicedMrnaId(Integer transSplicedMrnaId, Integer featureId,
		...
		this.transSplicedMrnaId = transSplicedMrnaId;
	...
	public Integer getTransSplicedMrnaId() {
		return this.transSplicedMrnaId;
	}

	public void setTransSplicedMrnaId(Integer transSplicedMrnaId) {
		this.transSplicedMrnaId = transSplicedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSplicedMrnaId))
			return false;
		TransSplicedMrnaId castOther = (TransSplicedMrnaId) other;

		return ((this.getTransSplicedMrnaId() == castOther
				.getTransSplicedMrnaId()) || (this.getTransSplicedMrnaId() != null
				&& castOther.getTransSplicedMrnaId() != null && this
				.getTransSplicedMrnaId().equals(
						castOther.getTransSplicedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSplicedMrnaId() == null ? 0 : this
						.getTransSplicedMrnaId().hashCode());
		result = 37 * result
