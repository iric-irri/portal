...
/**
 * NonProteinCodingId generated by hbm2java
 */
public class NonProteinCodingId implements java.io.Serializable {

	private Integer nonProteinCodingId;
	...
	public NonProteinCodingId() {
	}

	public NonProteinCodingId(Integer nonProteinCodingId, Integer featureId,
		...
		this.nonProteinCodingId = nonProteinCodingId;
	...
	public Integer getNonProteinCodingId() {
		return this.nonProteinCodingId;
	}

	public void setNonProteinCodingId(Integer nonProteinCodingId) {
		this.nonProteinCodingId = nonProteinCodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonProteinCodingId))
			return false;
		NonProteinCodingId castOther = (NonProteinCodingId) other;

		return ((this.getNonProteinCodingId() == castOther
				.getNonProteinCodingId()) || (this.getNonProteinCodingId() != null
				&& castOther.getNonProteinCodingId() != null && this
				.getNonProteinCodingId().equals(
						castOther.getNonProteinCodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonProteinCodingId() == null ? 0 : this
						.getNonProteinCodingId().hashCode());
		result = 37 * result
