...
/**
 * AminoAcidInsertionId generated by hbm2java
 */
public class AminoAcidInsertionId implements java.io.Serializable {

	private Integer aminoAcidInsertionId;
	...
	public AminoAcidInsertionId() {
	}

	public AminoAcidInsertionId(Integer aminoAcidInsertionId,
		...
		this.aminoAcidInsertionId = aminoAcidInsertionId;
	...
	public Integer getAminoAcidInsertionId() {
		return this.aminoAcidInsertionId;
	}

	public void setAminoAcidInsertionId(Integer aminoAcidInsertionId) {
		this.aminoAcidInsertionId = aminoAcidInsertionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AminoAcidInsertionId))
			return false;
		AminoAcidInsertionId castOther = (AminoAcidInsertionId) other;

		return ((this.getAminoAcidInsertionId() == castOther
				.getAminoAcidInsertionId()) || (this.getAminoAcidInsertionId() != null
				&& castOther.getAminoAcidInsertionId() != null && this
				.getAminoAcidInsertionId().equals(
						castOther.getAminoAcidInsertionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAminoAcidInsertionId() == null ? 0 : this
						.getAminoAcidInsertionId().hashCode());
		result = 37 * result
