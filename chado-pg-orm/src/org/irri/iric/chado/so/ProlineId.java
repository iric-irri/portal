...
/**
 * ProlineId generated by hbm2java
 */
public class ProlineId implements java.io.Serializable {
	...
	public ProlineId(Integer prolineId, Integer featureId, Integer dbxrefId,
	...
	public void setProlineId(Integer prolineId) {
		this.prolineId = prolineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProlineId))
			return false;
		ProlineId castOther = (ProlineId) other;

		return ((this.getProlineId() == castOther.getProlineId()) || (this
				.getProlineId() != null && castOther.getProlineId() != null && this
				.getProlineId().equals(castOther.getProlineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getProlineId() == null ? 0 : this.getProlineId().hashCode());
		result = 37 * result
