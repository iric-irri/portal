...
/**
 * InsertionalDuplicationId generated by hbm2java
 */
public class InsertionalDuplicationId implements java.io.Serializable {

	private Integer insertionalDuplicationId;
	...
	public InsertionalDuplicationId() {
	}

	public InsertionalDuplicationId(Integer insertionalDuplicationId,
		...
		this.insertionalDuplicationId = insertionalDuplicationId;
	...
	public Integer getInsertionalDuplicationId() {
		return this.insertionalDuplicationId;
	}

	public void setInsertionalDuplicationId(Integer insertionalDuplicationId) {
		this.insertionalDuplicationId = insertionalDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionalDuplicationId))
			return false;
		InsertionalDuplicationId castOther = (InsertionalDuplicationId) other;

		return ((this.getInsertionalDuplicationId() == castOther
				.getInsertionalDuplicationId()) || (this
				.getInsertionalDuplicationId() != null
				&& castOther.getInsertionalDuplicationId() != null && this
				.getInsertionalDuplicationId().equals(
						castOther.getInsertionalDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionalDuplicationId() == null ? 0 : this
						.getInsertionalDuplicationId().hashCode());
		result = 37 * result
