...
/**
 * TransgenicId generated by hbm2java
 */
public class TransgenicId implements java.io.Serializable {

	private Integer transgenicId;
	...
	public TransgenicId(Integer transgenicId, Integer featureId,
		...
		this.transgenicId = transgenicId;
	...
	public Integer getTransgenicId() {
		return this.transgenicId;
	}

	public void setTransgenicId(Integer transgenicId) {
		this.transgenicId = transgenicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransgenicId))
			return false;
		TransgenicId castOther = (TransgenicId) other;

		return ((this.getTransgenicId() == castOther.getTransgenicId()) || (this
				.getTransgenicId() != null
				&& castOther.getTransgenicId() != null && this
				.getTransgenicId().equals(castOther.getTransgenicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransgenicId() == null ? 0 : this.getTransgenicId()
						.hashCode());
		result = 37 * result
