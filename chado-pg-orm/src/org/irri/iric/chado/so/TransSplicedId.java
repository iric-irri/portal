...
/**
 * TransSplicedId generated by hbm2java
 */
public class TransSplicedId implements java.io.Serializable {

	private Integer transSplicedId;
	...
	public TransSplicedId() {
	}

	public TransSplicedId(Integer transSplicedId, Integer featureId,
		...
		this.transSplicedId = transSplicedId;
	...
	public Integer getTransSplicedId() {
		return this.transSplicedId;
	}

	public void setTransSplicedId(Integer transSplicedId) {
		this.transSplicedId = transSplicedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSplicedId))
			return false;
		TransSplicedId castOther = (TransSplicedId) other;

		return ((this.getTransSplicedId() == castOther.getTransSplicedId()) || (this
				.getTransSplicedId() != null
				&& castOther.getTransSplicedId() != null && this
				.getTransSplicedId().equals(castOther.getTransSplicedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSplicedId() == null ? 0 : this.getTransSplicedId()
						.hashCode());
		result = 37 * result
