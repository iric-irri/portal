...
/**
 * MobileIntronId generated by hbm2java
 */
public class MobileIntronId implements java.io.Serializable {

	private Integer mobileIntronId;
	...
	public MobileIntronId() {
	}

	public MobileIntronId(Integer mobileIntronId, Integer featureId,
		...
		this.mobileIntronId = mobileIntronId;
	...
	public Integer getMobileIntronId() {
		return this.mobileIntronId;
	}

	public void setMobileIntronId(Integer mobileIntronId) {
		this.mobileIntronId = mobileIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MobileIntronId))
			return false;
		MobileIntronId castOther = (MobileIntronId) other;

		return ((this.getMobileIntronId() == castOther.getMobileIntronId()) || (this
				.getMobileIntronId() != null
				&& castOther.getMobileIntronId() != null && this
				.getMobileIntronId().equals(castOther.getMobileIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMobileIntronId() == null ? 0 : this.getMobileIntronId()
						.hashCode());
		result = 37 * result
