...
/**
 * Ndm3MotifId generated by hbm2java
 */
public class Ndm3MotifId implements java.io.Serializable {

	private Integer ndm3MotifId;
	...
	public Ndm3MotifId(Integer ndm3MotifId, Integer featureId,
	...
	public Integer getNdm3MotifId() {
		return this.ndm3MotifId;
	}

	public void setNdm3MotifId(Integer ndm3MotifId) {
		this.ndm3MotifId = ndm3MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Ndm3MotifId))
			return false;
		Ndm3MotifId castOther = (Ndm3MotifId) other;

		return ((this.getNdm3MotifId() == castOther.getNdm3MotifId()) || (this
				.getNdm3MotifId() != null && castOther.getNdm3MotifId() != null && this
				.getNdm3MotifId().equals(castOther.getNdm3MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNdm3MotifId() == null ? 0 : this.getNdm3MotifId()
						.hashCode());
		result = 37 * result
