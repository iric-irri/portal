...
/**
 * SerineThreonineMotifId generated by hbm2java
 */
public class SerineThreonineMotifId implements java.io.Serializable {

	private Integer serineThreonineMotifId;
	...
	public SerineThreonineMotifId() {
	}

	public SerineThreonineMotifId(Integer serineThreonineMotifId,
		...
		this.serineThreonineMotifId = serineThreonineMotifId;
	...
	public Integer getSerineThreonineMotifId() {
		return this.serineThreonineMotifId;
	}

	public void setSerineThreonineMotifId(Integer serineThreonineMotifId) {
		this.serineThreonineMotifId = serineThreonineMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerineThreonineMotifId))
			return false;
		SerineThreonineMotifId castOther = (SerineThreonineMotifId) other;

		return ((this.getSerineThreonineMotifId() == castOther
				.getSerineThreonineMotifId()) || (this
				.getSerineThreonineMotifId() != null
				&& castOther.getSerineThreonineMotifId() != null && this
				.getSerineThreonineMotifId().equals(
						castOther.getSerineThreonineMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSerineThreonineMotifId() == null ? 0 : this
						.getSerineThreonineMotifId().hashCode());
		result = 37 * result
