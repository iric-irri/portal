...
/**
 * TmrnaPrimaryTranscriptId generated by hbm2java
 */
public class TmrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer tmrnaPrimaryTranscriptId;
	...
	public TmrnaPrimaryTranscriptId() {
	}

	public TmrnaPrimaryTranscriptId(Integer tmrnaPrimaryTranscriptId,
		...
		this.tmrnaPrimaryTranscriptId = tmrnaPrimaryTranscriptId;
	...
	public Integer getTmrnaPrimaryTranscriptId() {
		return this.tmrnaPrimaryTranscriptId;
	}

	public void setTmrnaPrimaryTranscriptId(Integer tmrnaPrimaryTranscriptId) {
		this.tmrnaPrimaryTranscriptId = tmrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaPrimaryTranscriptId))
			return false;
		TmrnaPrimaryTranscriptId castOther = (TmrnaPrimaryTranscriptId) other;

		return ((this.getTmrnaPrimaryTranscriptId() == castOther
				.getTmrnaPrimaryTranscriptId()) || (this
				.getTmrnaPrimaryTranscriptId() != null
				&& castOther.getTmrnaPrimaryTranscriptId() != null && this
				.getTmrnaPrimaryTranscriptId().equals(
						castOther.getTmrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaPrimaryTranscriptId() == null ? 0 : this
						.getTmrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
