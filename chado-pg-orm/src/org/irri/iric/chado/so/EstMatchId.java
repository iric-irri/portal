...
/**
 * EstMatchId generated by hbm2java
 */
public class EstMatchId implements java.io.Serializable {

	private Integer estMatchId;
	...
	public EstMatchId(Integer estMatchId, Integer featureId, Integer dbxrefId,
	...
	public Integer getEstMatchId() {
		return this.estMatchId;
	}

	public void setEstMatchId(Integer estMatchId) {
		this.estMatchId = estMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EstMatchId))
			return false;
		EstMatchId castOther = (EstMatchId) other;

		return ((this.getEstMatchId() == castOther.getEstMatchId()) || (this
				.getEstMatchId() != null && castOther.getEstMatchId() != null && this
				.getEstMatchId().equals(castOther.getEstMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEstMatchId() == null ? 0 : this.getEstMatchId()
						.hashCode());
		result = 37 * result
