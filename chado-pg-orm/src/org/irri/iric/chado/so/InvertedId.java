...
/**
 * InvertedId generated by hbm2java
 */
public class InvertedId implements java.io.Serializable {
	...
	public InvertedId(Integer invertedId, Integer featureId, Integer dbxrefId,
	...
	public void setInvertedId(Integer invertedId) {
		this.invertedId = invertedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertedId))
			return false;
		InvertedId castOther = (InvertedId) other;

		return ((this.getInvertedId() == castOther.getInvertedId()) || (this
				.getInvertedId() != null && castOther.getInvertedId() != null && this
				.getInvertedId().equals(castOther.getInvertedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertedId() == null ? 0 : this.getInvertedId()
						.hashCode());
		result = 37 * result
