...
/**
 * BoundByNucleicAcidId generated by hbm2java
 */
public class BoundByNucleicAcidId implements java.io.Serializable {

	private Integer boundByNucleicAcidId;
	...
	public BoundByNucleicAcidId() {
	}

	public BoundByNucleicAcidId(Integer boundByNucleicAcidId,
		...
		this.boundByNucleicAcidId = boundByNucleicAcidId;
	...
	public Integer getBoundByNucleicAcidId() {
		return this.boundByNucleicAcidId;
	}

	public void setBoundByNucleicAcidId(Integer boundByNucleicAcidId) {
		this.boundByNucleicAcidId = boundByNucleicAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BoundByNucleicAcidId))
			return false;
		BoundByNucleicAcidId castOther = (BoundByNucleicAcidId) other;

		return ((this.getBoundByNucleicAcidId() == castOther
				.getBoundByNucleicAcidId()) || (this.getBoundByNucleicAcidId() != null
				&& castOther.getBoundByNucleicAcidId() != null && this
				.getBoundByNucleicAcidId().equals(
						castOther.getBoundByNucleicAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBoundByNucleicAcidId() == null ? 0 : this
						.getBoundByNucleicAcidId().hashCode());
		result = 37 * result
