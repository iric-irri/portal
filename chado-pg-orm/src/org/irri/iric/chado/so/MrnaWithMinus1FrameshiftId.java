...
/**
 * MrnaWithMinus1FrameshiftId generated by hbm2java
 */
public class MrnaWithMinus1FrameshiftId implements java.io.Serializable {

	private Integer mrnaWithMinus1FrameshiftId;
	...
	public MrnaWithMinus1FrameshiftId() {
	}

	public MrnaWithMinus1FrameshiftId(Integer mrnaWithMinus1FrameshiftId,
		...
		this.mrnaWithMinus1FrameshiftId = mrnaWithMinus1FrameshiftId;
	...
	public Integer getMrnaWithMinus1FrameshiftId() {
		return this.mrnaWithMinus1FrameshiftId;
	}

	public void setMrnaWithMinus1FrameshiftId(Integer mrnaWithMinus1FrameshiftId) {
		this.mrnaWithMinus1FrameshiftId = mrnaWithMinus1FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaWithMinus1FrameshiftId))
			return false;
		MrnaWithMinus1FrameshiftId castOther = (MrnaWithMinus1FrameshiftId) other;

		return ((this.getMrnaWithMinus1FrameshiftId() == castOther
				.getMrnaWithMinus1FrameshiftId()) || (this
				.getMrnaWithMinus1FrameshiftId() != null
				&& castOther.getMrnaWithMinus1FrameshiftId() != null && this
				.getMrnaWithMinus1FrameshiftId().equals(
						castOther.getMrnaWithMinus1FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaWithMinus1FrameshiftId() == null ? 0 : this
						.getMrnaWithMinus1FrameshiftId().hashCode());
		result = 37 * result
