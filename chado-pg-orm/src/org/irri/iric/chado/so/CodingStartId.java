...
/**
 * CodingStartId generated by hbm2java
 */
public class CodingStartId implements java.io.Serializable {

	private Integer codingStartId;
	...
	public CodingStartId() {
	}

	public CodingStartId(Integer codingStartId, Integer featureId,
		...
		this.codingStartId = codingStartId;
	...
	public Integer getCodingStartId() {
		return this.codingStartId;
	}

	public void setCodingStartId(Integer codingStartId) {
		this.codingStartId = codingStartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingStartId))
			return false;
		CodingStartId castOther = (CodingStartId) other;

		return ((this.getCodingStartId() == castOther.getCodingStartId()) || (this
				.getCodingStartId() != null
				&& castOther.getCodingStartId() != null && this
				.getCodingStartId().equals(castOther.getCodingStartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingStartId() == null ? 0 : this.getCodingStartId()
						.hashCode());
		result = 37 * result
