...
/**
 * HistoneModificationId generated by hbm2java
 */
public class HistoneModificationId implements java.io.Serializable {

	private Integer histoneModificationId;
	...
	public HistoneModificationId() {
	}

	public HistoneModificationId(Integer histoneModificationId,
		...
		this.histoneModificationId = histoneModificationId;
	...
	public Integer getHistoneModificationId() {
		return this.histoneModificationId;
	}

	public void setHistoneModificationId(Integer histoneModificationId) {
		this.histoneModificationId = histoneModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneModificationId))
			return false;
		HistoneModificationId castOther = (HistoneModificationId) other;

		return ((this.getHistoneModificationId() == castOther
				.getHistoneModificationId()) || (this
				.getHistoneModificationId() != null
				&& castOther.getHistoneModificationId() != null && this
				.getHistoneModificationId().equals(
						castOther.getHistoneModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneModificationId() == null ? 0 : this
						.getHistoneModificationId().hashCode());
		result = 37 * result
