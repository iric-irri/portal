...
/**
 * PredictedByAbInitioComputationId generated by hbm2java
 */
public class PredictedByAbInitioComputationId implements java.io.Serializable {

	private Integer predictedByAbInitioComputationId;
	...
	public PredictedByAbInitioComputationId() {
	}

	public PredictedByAbInitioComputationId(
			Integer predictedByAbInitioComputationId, Integer featureId,
		...
		this.predictedByAbInitioComputationId = predictedByAbInitioComputationId;
	...
	public Integer getPredictedByAbInitioComputationId() {
		return this.predictedByAbInitioComputationId;
	}

	public void setPredictedByAbInitioComputationId(
			Integer predictedByAbInitioComputationId) {
		this.predictedByAbInitioComputationId = predictedByAbInitioComputationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PredictedByAbInitioComputationId))
			return false;
		PredictedByAbInitioComputationId castOther = (PredictedByAbInitioComputationId) other;

		return ((this.getPredictedByAbInitioComputationId() == castOther
				.getPredictedByAbInitioComputationId()) || (this
				.getPredictedByAbInitioComputationId() != null
				&& castOther.getPredictedByAbInitioComputationId() != null && this
				.getPredictedByAbInitioComputationId().equals(
						castOther.getPredictedByAbInitioComputationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPredictedByAbInitioComputationId() == null ? 0 : this
						.getPredictedByAbInitioComputationId().hashCode());
		result = 37 * result
