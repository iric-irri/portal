...
/**
 * SilencedGeneId generated by hbm2java
 */
public class SilencedGeneId implements java.io.Serializable {

	private Integer silencedGeneId;
	...
	public SilencedGeneId() {
	}

	public SilencedGeneId(Integer silencedGeneId, Integer featureId,
		...
		this.silencedGeneId = silencedGeneId;
	...
	public Integer getSilencedGeneId() {
		return this.silencedGeneId;
	}

	public void setSilencedGeneId(Integer silencedGeneId) {
		this.silencedGeneId = silencedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedGeneId))
			return false;
		SilencedGeneId castOther = (SilencedGeneId) other;

		return ((this.getSilencedGeneId() == castOther.getSilencedGeneId()) || (this
				.getSilencedGeneId() != null
				&& castOther.getSilencedGeneId() != null && this
				.getSilencedGeneId().equals(castOther.getSilencedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedGeneId() == null ? 0 : this.getSilencedGeneId()
						.hashCode());
		result = 37 * result
