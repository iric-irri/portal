...
/**
 * ExonJunctionId generated by hbm2java
 */
public class ExonJunctionId implements java.io.Serializable {

	private Integer exonJunctionId;
	...
	public ExonJunctionId() {
	}

	public ExonJunctionId(Integer exonJunctionId, Integer featureId,
		...
		this.exonJunctionId = exonJunctionId;
	...
	public Integer getExonJunctionId() {
		return this.exonJunctionId;
	}

	public void setExonJunctionId(Integer exonJunctionId) {
		this.exonJunctionId = exonJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonJunctionId))
			return false;
		ExonJunctionId castOther = (ExonJunctionId) other;

		return ((this.getExonJunctionId() == castOther.getExonJunctionId()) || (this
				.getExonJunctionId() != null
				&& castOther.getExonJunctionId() != null && this
				.getExonJunctionId().equals(castOther.getExonJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonJunctionId() == null ? 0 : this.getExonJunctionId()
						.hashCode());
		result = 37 * result
