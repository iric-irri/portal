...
/**
 * ThreePrimeRepeatRecodingSignalId generated by hbm2java
 */
public class ThreePrimeRepeatRecodingSignalId implements java.io.Serializable {

	private Integer threePrimeRepeatRecodingSignalId;
	...
	public ThreePrimeRepeatRecodingSignalId() {
	}

	public ThreePrimeRepeatRecodingSignalId(
			Integer threePrimeRepeatRecodingSignalId, Integer featureId,
		...
		this.threePrimeRepeatRecodingSignalId = threePrimeRepeatRecodingSignalId;
	...
	public Integer getThreePrimeRepeatRecodingSignalId() {
		return this.threePrimeRepeatRecodingSignalId;
	}

	public void setThreePrimeRepeatRecodingSignalId(
			Integer threePrimeRepeatRecodingSignalId) {
		this.threePrimeRepeatRecodingSignalId = threePrimeRepeatRecodingSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeRepeatRecodingSignalId))
			return false;
		ThreePrimeRepeatRecodingSignalId castOther = (ThreePrimeRepeatRecodingSignalId) other;

		return ((this.getThreePrimeRepeatRecodingSignalId() == castOther
				.getThreePrimeRepeatRecodingSignalId()) || (this
				.getThreePrimeRepeatRecodingSignalId() != null
				&& castOther.getThreePrimeRepeatRecodingSignalId() != null && this
				.getThreePrimeRepeatRecodingSignalId().equals(
						castOther.getThreePrimeRepeatRecodingSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeRepeatRecodingSignalId() == null ? 0 : this
						.getThreePrimeRepeatRecodingSignalId().hashCode());
		result = 37 * result
