...
/**
 * CryptogeneId generated by hbm2java
 */
public class CryptogeneId implements java.io.Serializable {

	private Integer cryptogeneId;
	...
	public CryptogeneId(Integer cryptogeneId, Integer featureId,
		...
		this.cryptogeneId = cryptogeneId;
	...
	public Integer getCryptogeneId() {
		return this.cryptogeneId;
	}

	public void setCryptogeneId(Integer cryptogeneId) {
		this.cryptogeneId = cryptogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CryptogeneId))
			return false;
		CryptogeneId castOther = (CryptogeneId) other;

		return ((this.getCryptogeneId() == castOther.getCryptogeneId()) || (this
				.getCryptogeneId() != null
				&& castOther.getCryptogeneId() != null && this
				.getCryptogeneId().equals(castOther.getCryptogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCryptogeneId() == null ? 0 : this.getCryptogeneId()
						.hashCode());
		result = 37 * result
