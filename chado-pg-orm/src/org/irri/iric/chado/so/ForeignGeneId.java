...
/**
 * ForeignGeneId generated by hbm2java
 */
public class ForeignGeneId implements java.io.Serializable {

	private Integer foreignGeneId;
	...
	public ForeignGeneId() {
	}

	public ForeignGeneId(Integer foreignGeneId, Integer featureId,
		...
		this.foreignGeneId = foreignGeneId;
	...
	public Integer getForeignGeneId() {
		return this.foreignGeneId;
	}

	public void setForeignGeneId(Integer foreignGeneId) {
		this.foreignGeneId = foreignGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ForeignGeneId))
			return false;
		ForeignGeneId castOther = (ForeignGeneId) other;

		return ((this.getForeignGeneId() == castOther.getForeignGeneId()) || (this
				.getForeignGeneId() != null
				&& castOther.getForeignGeneId() != null && this
				.getForeignGeneId().equals(castOther.getForeignGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getForeignGeneId() == null ? 0 : this.getForeignGeneId()
						.hashCode());
		result = 37 * result
