...
/**
 * EncodesAlternateTranscriptionStartSitesId generated by hbm2java
 */
public class EncodesAlternateTranscriptionStartSitesId implements
		java.io.Serializable {

	private Integer encodesAlternateTranscriptionStartSitesId;
	...
	public EncodesAlternateTranscriptionStartSitesId() {
	}

	public EncodesAlternateTranscriptionStartSitesId(
			Integer encodesAlternateTranscriptionStartSitesId,
		...
		this.encodesAlternateTranscriptionStartSitesId = encodesAlternateTranscriptionStartSitesId;
	...
	public Integer getEncodesAlternateTranscriptionStartSitesId() {
		return this.encodesAlternateTranscriptionStartSitesId;
	}

	public void setEncodesAlternateTranscriptionStartSitesId(
			Integer encodesAlternateTranscriptionStartSitesId) {
		this.encodesAlternateTranscriptionStartSitesId = encodesAlternateTranscriptionStartSitesId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesAlternateTranscriptionStartSitesId))
			return false;
		EncodesAlternateTranscriptionStartSitesId castOther = (EncodesAlternateTranscriptionStartSitesId) other;

		return ((this.getEncodesAlternateTranscriptionStartSitesId() == castOther
				.getEncodesAlternateTranscriptionStartSitesId()) || (this
				.getEncodesAlternateTranscriptionStartSitesId() != null
				&& castOther.getEncodesAlternateTranscriptionStartSitesId() != null && this
				.getEncodesAlternateTranscriptionStartSitesId()
				.equals(castOther
						.getEncodesAlternateTranscriptionStartSitesId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesAlternateTranscriptionStartSitesId() == null ? 0
						: this.getEncodesAlternateTranscriptionStartSitesId()
								.hashCode());
		result = 37 * result
