...
/**
 * GeneSilencedByHistoneModificationId generated by hbm2java
 */
public class GeneSilencedByHistoneModificationId implements
		java.io.Serializable {

	private Integer geneSilencedByHistoneModificationId;
	...
	public GeneSilencedByHistoneModificationId() {
	}

	public GeneSilencedByHistoneModificationId(
			Integer geneSilencedByHistoneModificationId, Integer featureId,
		...
		this.geneSilencedByHistoneModificationId = geneSilencedByHistoneModificationId;
	...
	public Integer getGeneSilencedByHistoneModificationId() {
		return this.geneSilencedByHistoneModificationId;
	}

	public void setGeneSilencedByHistoneModificationId(
			Integer geneSilencedByHistoneModificationId) {
		this.geneSilencedByHistoneModificationId = geneSilencedByHistoneModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByHistoneModificationId))
			return false;
		GeneSilencedByHistoneModificationId castOther = (GeneSilencedByHistoneModificationId) other;

		return ((this.getGeneSilencedByHistoneModificationId() == castOther
				.getGeneSilencedByHistoneModificationId()) || (this
				.getGeneSilencedByHistoneModificationId() != null
				&& castOther.getGeneSilencedByHistoneModificationId() != null && this
				.getGeneSilencedByHistoneModificationId().equals(
						castOther.getGeneSilencedByHistoneModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByHistoneModificationId() == null ? 0 : this
						.getGeneSilencedByHistoneModificationId().hashCode());
		result = 37 * result
