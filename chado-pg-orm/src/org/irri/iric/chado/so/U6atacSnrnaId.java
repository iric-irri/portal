...
/**
 * U6atacSnrnaId generated by hbm2java
 */
public class U6atacSnrnaId implements java.io.Serializable {

	private Integer u6atacSnrnaId;
	...
	public U6atacSnrnaId() {
	}

	public U6atacSnrnaId(Integer u6atacSnrnaId, Integer featureId,
		...
		this.u6atacSnrnaId = u6atacSnrnaId;
	...
	public Integer getU6atacSnrnaId() {
		return this.u6atacSnrnaId;
	}

	public void setU6atacSnrnaId(Integer u6atacSnrnaId) {
		this.u6atacSnrnaId = u6atacSnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U6atacSnrnaId))
			return false;
		U6atacSnrnaId castOther = (U6atacSnrnaId) other;

		return ((this.getU6atacSnrnaId() == castOther.getU6atacSnrnaId()) || (this
				.getU6atacSnrnaId() != null
				&& castOther.getU6atacSnrnaId() != null && this
				.getU6atacSnrnaId().equals(castOther.getU6atacSnrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU6atacSnrnaId() == null ? 0 : this.getU6atacSnrnaId()
						.hashCode());
		result = 37 * result
