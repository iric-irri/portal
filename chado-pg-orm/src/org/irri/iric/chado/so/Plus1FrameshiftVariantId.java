...
/**
 * Plus1FrameshiftVariantId generated by hbm2java
 */
public class Plus1FrameshiftVariantId implements java.io.Serializable {

	private Integer plus1FrameshiftVariantId;
	...
	public Plus1FrameshiftVariantId() {
	}

	public Plus1FrameshiftVariantId(Integer plus1FrameshiftVariantId,
		...
		this.plus1FrameshiftVariantId = plus1FrameshiftVariantId;
	...
	public Integer getPlus1FrameshiftVariantId() {
		return this.plus1FrameshiftVariantId;
	}

	public void setPlus1FrameshiftVariantId(Integer plus1FrameshiftVariantId) {
		this.plus1FrameshiftVariantId = plus1FrameshiftVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus1FrameshiftVariantId))
			return false;
		Plus1FrameshiftVariantId castOther = (Plus1FrameshiftVariantId) other;

		return ((this.getPlus1FrameshiftVariantId() == castOther
				.getPlus1FrameshiftVariantId()) || (this
				.getPlus1FrameshiftVariantId() != null
				&& castOther.getPlus1FrameshiftVariantId() != null && this
				.getPlus1FrameshiftVariantId().equals(
						castOther.getPlus1FrameshiftVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus1FrameshiftVariantId() == null ? 0 : this
						.getPlus1FrameshiftVariantId().hashCode());
		result = 37 * result
