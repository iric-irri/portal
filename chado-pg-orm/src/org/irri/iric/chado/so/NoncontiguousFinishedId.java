...
/**
 * NoncontiguousFinishedId generated by hbm2java
 */
public class NoncontiguousFinishedId implements java.io.Serializable {

	private Integer noncontiguousFinishedId;
	...
	public NoncontiguousFinishedId() {
	}

	public NoncontiguousFinishedId(Integer noncontiguousFinishedId,
		...
		this.noncontiguousFinishedId = noncontiguousFinishedId;
	...
	public Integer getNoncontiguousFinishedId() {
		return this.noncontiguousFinishedId;
	}

	public void setNoncontiguousFinishedId(Integer noncontiguousFinishedId) {
		this.noncontiguousFinishedId = noncontiguousFinishedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NoncontiguousFinishedId))
			return false;
		NoncontiguousFinishedId castOther = (NoncontiguousFinishedId) other;

		return ((this.getNoncontiguousFinishedId() == castOther
				.getNoncontiguousFinishedId()) || (this
				.getNoncontiguousFinishedId() != null
				&& castOther.getNoncontiguousFinishedId() != null && this
				.getNoncontiguousFinishedId().equals(
						castOther.getNoncontiguousFinishedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNoncontiguousFinishedId() == null ? 0 : this
						.getNoncontiguousFinishedId().hashCode());
		result = 37 * result
