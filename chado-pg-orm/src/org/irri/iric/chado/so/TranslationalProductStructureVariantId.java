...
/**
 * TranslationalProductStructureVariantId generated by hbm2java
 */
public class TranslationalProductStructureVariantId implements
		java.io.Serializable {

	private Integer translationalProductStructureVariantId;
	...
	public TranslationalProductStructureVariantId() {
	}

	public TranslationalProductStructureVariantId(
			Integer translationalProductStructureVariantId, Integer featureId,
		...
		this.translationalProductStructureVariantId = translationalProductStructureVariantId;
	...
	public Integer getTranslationalProductStructureVariantId() {
		return this.translationalProductStructureVariantId;
	}

	public void setTranslationalProductStructureVariantId(
			Integer translationalProductStructureVariantId) {
		this.translationalProductStructureVariantId = translationalProductStructureVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationalProductStructureVariantId))
			return false;
		TranslationalProductStructureVariantId castOther = (TranslationalProductStructureVariantId) other;

		return ((this.getTranslationalProductStructureVariantId() == castOther
				.getTranslationalProductStructureVariantId()) || (this
				.getTranslationalProductStructureVariantId() != null
				&& castOther.getTranslationalProductStructureVariantId() != null && this
				.getTranslationalProductStructureVariantId().equals(
						castOther.getTranslationalProductStructureVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationalProductStructureVariantId() == null ? 0
						: this.getTranslationalProductStructureVariantId()
								.hashCode());
		result = 37 * result
