...
/**
 * GenomicDnaId generated by hbm2java
 */
public class GenomicDnaId implements java.io.Serializable {

	private Integer genomicDnaId;
	...
	public GenomicDnaId(Integer genomicDnaId, Integer featureId,
		...
		this.genomicDnaId = genomicDnaId;
	...
	public Integer getGenomicDnaId() {
		return this.genomicDnaId;
	}

	public void setGenomicDnaId(Integer genomicDnaId) {
		this.genomicDnaId = genomicDnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenomicDnaId))
			return false;
		GenomicDnaId castOther = (GenomicDnaId) other;

		return ((this.getGenomicDnaId() == castOther.getGenomicDnaId()) || (this
				.getGenomicDnaId() != null
				&& castOther.getGenomicDnaId() != null && this
				.getGenomicDnaId().equals(castOther.getGenomicDnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGenomicDnaId() == null ? 0 : this.getGenomicDnaId()
						.hashCode());
		result = 37 * result
