...
/**
 * VVdjJClusterId generated by hbm2java
 */
public class VVdjJClusterId implements java.io.Serializable {

	private Integer VVdjJClusterId;
	...
	public VVdjJClusterId() {
	}

	public VVdjJClusterId(Integer VVdjJClusterId, Integer featureId,
		...
		this.VVdjJClusterId = VVdjJClusterId;
	...
	public Integer getVVdjJClusterId() {
		return this.VVdjJClusterId;
	}

	public void setVVdjJClusterId(Integer VVdjJClusterId) {
		this.VVdjJClusterId = VVdjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVdjJClusterId))
			return false;
		VVdjJClusterId castOther = (VVdjJClusterId) other;

		return ((this.getVVdjJClusterId() == castOther.getVVdjJClusterId()) || (this
				.getVVdjJClusterId() != null
				&& castOther.getVVdjJClusterId() != null && this
				.getVVdjJClusterId().equals(castOther.getVVdjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVdjJClusterId() == null ? 0 : this.getVVdjJClusterId()
						.hashCode());
		result = 37 * result
