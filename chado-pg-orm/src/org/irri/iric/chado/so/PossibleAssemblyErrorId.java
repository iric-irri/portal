...
/**
 * PossibleAssemblyErrorId generated by hbm2java
 */
public class PossibleAssemblyErrorId implements java.io.Serializable {

	private Integer possibleAssemblyErrorId;
	...
	public PossibleAssemblyErrorId() {
	}

	public PossibleAssemblyErrorId(Integer possibleAssemblyErrorId,
		...
		this.possibleAssemblyErrorId = possibleAssemblyErrorId;
	...
	public Integer getPossibleAssemblyErrorId() {
		return this.possibleAssemblyErrorId;
	}

	public void setPossibleAssemblyErrorId(Integer possibleAssemblyErrorId) {
		this.possibleAssemblyErrorId = possibleAssemblyErrorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PossibleAssemblyErrorId))
			return false;
		PossibleAssemblyErrorId castOther = (PossibleAssemblyErrorId) other;

		return ((this.getPossibleAssemblyErrorId() == castOther
				.getPossibleAssemblyErrorId()) || (this
				.getPossibleAssemblyErrorId() != null
				&& castOther.getPossibleAssemblyErrorId() != null && this
				.getPossibleAssemblyErrorId().equals(
						castOther.getPossibleAssemblyErrorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPossibleAssemblyErrorId() == null ? 0 : this
						.getPossibleAssemblyErrorId().hashCode());
		result = 37 * result
