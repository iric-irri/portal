...
/**
 * IntramembranePolypeptideRegionId generated by hbm2java
 */
public class IntramembranePolypeptideRegionId implements java.io.Serializable {

	private Integer intramembranePolypeptideRegionId;
	...
	public IntramembranePolypeptideRegionId() {
	}

	public IntramembranePolypeptideRegionId(
			Integer intramembranePolypeptideRegionId, Integer featureId,
		...
		this.intramembranePolypeptideRegionId = intramembranePolypeptideRegionId;
	...
	public Integer getIntramembranePolypeptideRegionId() {
		return this.intramembranePolypeptideRegionId;
	}

	public void setIntramembranePolypeptideRegionId(
			Integer intramembranePolypeptideRegionId) {
		this.intramembranePolypeptideRegionId = intramembranePolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntramembranePolypeptideRegionId))
			return false;
		IntramembranePolypeptideRegionId castOther = (IntramembranePolypeptideRegionId) other;

		return ((this.getIntramembranePolypeptideRegionId() == castOther
				.getIntramembranePolypeptideRegionId()) || (this
				.getIntramembranePolypeptideRegionId() != null
				&& castOther.getIntramembranePolypeptideRegionId() != null && this
				.getIntramembranePolypeptideRegionId().equals(
						castOther.getIntramembranePolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntramembranePolypeptideRegionId() == null ? 0 : this
						.getIntramembranePolypeptideRegionId().hashCode());
		result = 37 * result
