...
/**
 * PostTranslationallyRegulatedByProteinModificationId generated by hbm2java
 */
public class PostTranslationallyRegulatedByProteinModificationId implements
		java.io.Serializable {

	private Integer postTranslationallyRegulatedByProteinModificationId;
	...
	public PostTranslationallyRegulatedByProteinModificationId() {
	}

	public PostTranslationallyRegulatedByProteinModificationId(
			Integer postTranslationallyRegulatedByProteinModificationId,
		...
		this.postTranslationallyRegulatedByProteinModificationId = postTranslationallyRegulatedByProteinModificationId;
	...
	public Integer getPostTranslationallyRegulatedByProteinModificationId() {
		return this.postTranslationallyRegulatedByProteinModificationId;
	}

	public void setPostTranslationallyRegulatedByProteinModificationId(
			Integer postTranslationallyRegulatedByProteinModificationId) {
		this.postTranslationallyRegulatedByProteinModificationId = postTranslationallyRegulatedByProteinModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PostTranslationallyRegulatedByProteinModificationId))
			return false;
		PostTranslationallyRegulatedByProteinModificationId castOther = (PostTranslationallyRegulatedByProteinModificationId) other;

		return ((this.getPostTranslationallyRegulatedByProteinModificationId() == castOther
				.getPostTranslationallyRegulatedByProteinModificationId()) || (this
				.getPostTranslationallyRegulatedByProteinModificationId() != null
				&& castOther
						.getPostTranslationallyRegulatedByProteinModificationId() != null && this
				.getPostTranslationallyRegulatedByProteinModificationId()
				.equals(castOther
						.getPostTranslationallyRegulatedByProteinModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPostTranslationallyRegulatedByProteinModificationId() == null ? 0
						: this.getPostTranslationallyRegulatedByProteinModificationId()
								.hashCode());
		result = 37 * result
