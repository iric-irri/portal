...
/**
 * N6HydroxynorvalylcarbamoyladenosineId generated by hbm2java
 */
public class N6HydroxynorvalylcarbamoyladenosineId implements
		java.io.Serializable {

	private Integer n6HydroxynorvalylcarbamoyladenosineId;
	...
	public N6HydroxynorvalylcarbamoyladenosineId() {
	}

	public N6HydroxynorvalylcarbamoyladenosineId(
			Integer n6HydroxynorvalylcarbamoyladenosineId, Integer featureId,
		...
		this.n6HydroxynorvalylcarbamoyladenosineId = n6HydroxynorvalylcarbamoyladenosineId;
	...
	public Integer getN6HydroxynorvalylcarbamoyladenosineId() {
		return this.n6HydroxynorvalylcarbamoyladenosineId;
	}

	public void setN6HydroxynorvalylcarbamoyladenosineId(
			Integer n6HydroxynorvalylcarbamoyladenosineId) {
		this.n6HydroxynorvalylcarbamoyladenosineId = n6HydroxynorvalylcarbamoyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6HydroxynorvalylcarbamoyladenosineId))
			return false;
		N6HydroxynorvalylcarbamoyladenosineId castOther = (N6HydroxynorvalylcarbamoyladenosineId) other;

		return ((this.getN6HydroxynorvalylcarbamoyladenosineId() == castOther
				.getN6HydroxynorvalylcarbamoyladenosineId()) || (this
				.getN6HydroxynorvalylcarbamoyladenosineId() != null
				&& castOther.getN6HydroxynorvalylcarbamoyladenosineId() != null && this
				.getN6HydroxynorvalylcarbamoyladenosineId().equals(
						castOther.getN6HydroxynorvalylcarbamoyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6HydroxynorvalylcarbamoyladenosineId() == null ? 0
						: this.getN6HydroxynorvalylcarbamoyladenosineId()
								.hashCode());
		result = 37 * result
