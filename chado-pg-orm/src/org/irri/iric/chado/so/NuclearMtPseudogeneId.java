...
/**
 * NuclearMtPseudogeneId generated by hbm2java
 */
public class NuclearMtPseudogeneId implements java.io.Serializable {

	private Integer nuclearMtPseudogeneId;
	...
	public NuclearMtPseudogeneId() {
	}

	public NuclearMtPseudogeneId(Integer nuclearMtPseudogeneId,
		...
		this.nuclearMtPseudogeneId = nuclearMtPseudogeneId;
	...
	public Integer getNuclearMtPseudogeneId() {
		return this.nuclearMtPseudogeneId;
	}

	public void setNuclearMtPseudogeneId(Integer nuclearMtPseudogeneId) {
		this.nuclearMtPseudogeneId = nuclearMtPseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearMtPseudogeneId))
			return false;
		NuclearMtPseudogeneId castOther = (NuclearMtPseudogeneId) other;

		return ((this.getNuclearMtPseudogeneId() == castOther
				.getNuclearMtPseudogeneId()) || (this
				.getNuclearMtPseudogeneId() != null
				&& castOther.getNuclearMtPseudogeneId() != null && this
				.getNuclearMtPseudogeneId().equals(
						castOther.getNuclearMtPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearMtPseudogeneId() == null ? 0 : this
						.getNuclearMtPseudogeneId().hashCode());
		result = 37 * result
