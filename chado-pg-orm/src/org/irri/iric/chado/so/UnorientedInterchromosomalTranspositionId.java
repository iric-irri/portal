...
/**
 * UnorientedInterchromosomalTranspositionId generated by hbm2java
 */
public class UnorientedInterchromosomalTranspositionId implements
		java.io.Serializable {

	private Integer unorientedInterchromosomalTranspositionId;
	...
	public UnorientedInterchromosomalTranspositionId() {
	}

	public UnorientedInterchromosomalTranspositionId(
			Integer unorientedInterchromosomalTranspositionId,
		...
		this.unorientedInterchromosomalTranspositionId = unorientedInterchromosomalTranspositionId;
	...
	public Integer getUnorientedInterchromosomalTranspositionId() {
		return this.unorientedInterchromosomalTranspositionId;
	}

	public void setUnorientedInterchromosomalTranspositionId(
			Integer unorientedInterchromosomalTranspositionId) {
		this.unorientedInterchromosomalTranspositionId = unorientedInterchromosomalTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnorientedInterchromosomalTranspositionId))
			return false;
		UnorientedInterchromosomalTranspositionId castOther = (UnorientedInterchromosomalTranspositionId) other;

		return ((this.getUnorientedInterchromosomalTranspositionId() == castOther
				.getUnorientedInterchromosomalTranspositionId()) || (this
				.getUnorientedInterchromosomalTranspositionId() != null
				&& castOther.getUnorientedInterchromosomalTranspositionId() != null && this
				.getUnorientedInterchromosomalTranspositionId()
				.equals(castOther
						.getUnorientedInterchromosomalTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUnorientedInterchromosomalTranspositionId() == null ? 0
						: this.getUnorientedInterchromosomalTranspositionId()
								.hashCode());
		result = 37 * result
