...
/**
 * WildTypeRescueGeneId generated by hbm2java
 */
public class WildTypeRescueGeneId implements java.io.Serializable {

	private Integer wildTypeRescueGeneId;
	...
	public WildTypeRescueGeneId() {
	}

	public WildTypeRescueGeneId(Integer wildTypeRescueGeneId,
		...
		this.wildTypeRescueGeneId = wildTypeRescueGeneId;
	...
	public Integer getWildTypeRescueGeneId() {
		return this.wildTypeRescueGeneId;
	}

	public void setWildTypeRescueGeneId(Integer wildTypeRescueGeneId) {
		this.wildTypeRescueGeneId = wildTypeRescueGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WildTypeRescueGeneId))
			return false;
		WildTypeRescueGeneId castOther = (WildTypeRescueGeneId) other;

		return ((this.getWildTypeRescueGeneId() == castOther
				.getWildTypeRescueGeneId()) || (this.getWildTypeRescueGeneId() != null
				&& castOther.getWildTypeRescueGeneId() != null && this
				.getWildTypeRescueGeneId().equals(
						castOther.getWildTypeRescueGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWildTypeRescueGeneId() == null ? 0 : this
						.getWildTypeRescueGeneId().hashCode());
		result = 37 * result
