...
/**
 * InrMotifId generated by hbm2java
 */
public class InrMotifId implements java.io.Serializable {

	private Integer inrMotifId;
	...
	public InrMotifId(Integer inrMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getInrMotifId() {
		return this.inrMotifId;
	}

	public void setInrMotifId(Integer inrMotifId) {
		this.inrMotifId = inrMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InrMotifId))
			return false;
		InrMotifId castOther = (InrMotifId) other;

		return ((this.getInrMotifId() == castOther.getInrMotifId()) || (this
				.getInrMotifId() != null && castOther.getInrMotifId() != null && this
				.getInrMotifId().equals(castOther.getInrMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInrMotifId() == null ? 0 : this.getInrMotifId()
						.hashCode());
		result = 37 * result
