...
/**
 * PolypeptideIronIonContactSiteId generated by hbm2java
 */
public class PolypeptideIronIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideIronIonContactSiteId;
	...
	public PolypeptideIronIonContactSiteId() {
	}

	public PolypeptideIronIonContactSiteId(
			Integer polypeptideIronIonContactSiteId, Integer featureId,
		...
		this.polypeptideIronIonContactSiteId = polypeptideIronIonContactSiteId;
	...
	public Integer getPolypeptideIronIonContactSiteId() {
		return this.polypeptideIronIonContactSiteId;
	}

	public void setPolypeptideIronIonContactSiteId(
			Integer polypeptideIronIonContactSiteId) {
		this.polypeptideIronIonContactSiteId = polypeptideIronIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideIronIonContactSiteId))
			return false;
		PolypeptideIronIonContactSiteId castOther = (PolypeptideIronIonContactSiteId) other;

		return ((this.getPolypeptideIronIonContactSiteId() == castOther
				.getPolypeptideIronIonContactSiteId()) || (this
				.getPolypeptideIronIonContactSiteId() != null
				&& castOther.getPolypeptideIronIonContactSiteId() != null && this
				.getPolypeptideIronIonContactSiteId().equals(
						castOther.getPolypeptideIronIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideIronIonContactSiteId() == null ? 0 : this
						.getPolypeptideIronIonContactSiteId().hashCode());
		result = 37 * result
