...
/**
 * ArsId generated by hbm2java
 */
public class ArsId implements java.io.Serializable {
	...
	public ArsId(Integer arsId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArsId))
			return false;
		ArsId castOther = (ArsId) other;

		return ((this.getArsId() == castOther.getArsId()) || (this.getArsId() != null
				&& castOther.getArsId() != null && this.getArsId().equals(
				castOther.getArsId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getArsId() == null ? 0 : this.getArsId().hashCode());
		result = 37 * result
