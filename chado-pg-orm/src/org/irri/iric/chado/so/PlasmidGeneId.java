...
/**
 * PlasmidGeneId generated by hbm2java
 */
public class PlasmidGeneId implements java.io.Serializable {

	private Integer plasmidGeneId;
	...
	public PlasmidGeneId() {
	}

	public PlasmidGeneId(Integer plasmidGeneId, Integer featureId,
		...
		this.plasmidGeneId = plasmidGeneId;
	...
	public Integer getPlasmidGeneId() {
		return this.plasmidGeneId;
	}

	public void setPlasmidGeneId(Integer plasmidGeneId) {
		this.plasmidGeneId = plasmidGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlasmidGeneId))
			return false;
		PlasmidGeneId castOther = (PlasmidGeneId) other;

		return ((this.getPlasmidGeneId() == castOther.getPlasmidGeneId()) || (this
				.getPlasmidGeneId() != null
				&& castOther.getPlasmidGeneId() != null && this
				.getPlasmidGeneId().equals(castOther.getPlasmidGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlasmidGeneId() == null ? 0 : this.getPlasmidGeneId()
						.hashCode());
		result = 37 * result
