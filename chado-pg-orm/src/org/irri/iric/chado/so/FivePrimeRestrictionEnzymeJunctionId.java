...
/**
 * FivePrimeRestrictionEnzymeJunctionId generated by hbm2java
 */
public class FivePrimeRestrictionEnzymeJunctionId implements
		java.io.Serializable {

	private Integer fivePrimeRestrictionEnzymeJunctionId;
	...
	public FivePrimeRestrictionEnzymeJunctionId() {
	}

	public FivePrimeRestrictionEnzymeJunctionId(
			Integer fivePrimeRestrictionEnzymeJunctionId, Integer featureId,
		...
		this.fivePrimeRestrictionEnzymeJunctionId = fivePrimeRestrictionEnzymeJunctionId;
	...
	public Integer getFivePrimeRestrictionEnzymeJunctionId() {
		return this.fivePrimeRestrictionEnzymeJunctionId;
	}

	public void setFivePrimeRestrictionEnzymeJunctionId(
			Integer fivePrimeRestrictionEnzymeJunctionId) {
		this.fivePrimeRestrictionEnzymeJunctionId = fivePrimeRestrictionEnzymeJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeRestrictionEnzymeJunctionId))
			return false;
		FivePrimeRestrictionEnzymeJunctionId castOther = (FivePrimeRestrictionEnzymeJunctionId) other;

		return ((this.getFivePrimeRestrictionEnzymeJunctionId() == castOther
				.getFivePrimeRestrictionEnzymeJunctionId()) || (this
				.getFivePrimeRestrictionEnzymeJunctionId() != null
				&& castOther.getFivePrimeRestrictionEnzymeJunctionId() != null && this
				.getFivePrimeRestrictionEnzymeJunctionId().equals(
						castOther.getFivePrimeRestrictionEnzymeJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeRestrictionEnzymeJunctionId() == null ? 0 : this
						.getFivePrimeRestrictionEnzymeJunctionId().hashCode());
		result = 37 * result
