...
/**
 * PseudogenicExonId generated by hbm2java
 */
public class PseudogenicExonId implements java.io.Serializable {

	private Integer pseudogenicExonId;
	...
	public PseudogenicExonId() {
	}

	public PseudogenicExonId(Integer pseudogenicExonId, Integer featureId,
		...
		this.pseudogenicExonId = pseudogenicExonId;
	...
	public Integer getPseudogenicExonId() {
		return this.pseudogenicExonId;
	}

	public void setPseudogenicExonId(Integer pseudogenicExonId) {
		this.pseudogenicExonId = pseudogenicExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicExonId))
			return false;
		PseudogenicExonId castOther = (PseudogenicExonId) other;

		return ((this.getPseudogenicExonId() == castOther
				.getPseudogenicExonId()) || (this.getPseudogenicExonId() != null
				&& castOther.getPseudogenicExonId() != null && this
				.getPseudogenicExonId()
				.equals(castOther.getPseudogenicExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicExonId() == null ? 0 : this
						.getPseudogenicExonId().hashCode());
		result = 37 * result
