...
/**
 * UtrVariantId generated by hbm2java
 */
public class UtrVariantId implements java.io.Serializable {

	private Integer utrVariantId;
	...
	public UtrVariantId(Integer utrVariantId, Integer featureId,
		...
		this.utrVariantId = utrVariantId;
	...
	public Integer getUtrVariantId() {
		return this.utrVariantId;
	}

	public void setUtrVariantId(Integer utrVariantId) {
		this.utrVariantId = utrVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UtrVariantId))
			return false;
		UtrVariantId castOther = (UtrVariantId) other;

		return ((this.getUtrVariantId() == castOther.getUtrVariantId()) || (this
				.getUtrVariantId() != null
				&& castOther.getUtrVariantId() != null && this
				.getUtrVariantId().equals(castOther.getUtrVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUtrVariantId() == null ? 0 : this.getUtrVariantId()
						.hashCode());
		result = 37 * result
