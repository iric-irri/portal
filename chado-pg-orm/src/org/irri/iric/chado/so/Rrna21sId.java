...
/**
 * Rrna21sId generated by hbm2java
 */
public class Rrna21sId implements java.io.Serializable {

	private Integer rrna21sId;
	...
	public Rrna21sId(Integer rrna21sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna21sId() {
		return this.rrna21sId;
	}

	public void setRrna21sId(Integer rrna21sId) {
		this.rrna21sId = rrna21sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna21sId))
			return false;
		Rrna21sId castOther = (Rrna21sId) other;

		return ((this.getRrna21sId() == castOther.getRrna21sId()) || (this
				.getRrna21sId() != null && castOther.getRrna21sId() != null && this
				.getRrna21sId().equals(castOther.getRrna21sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna21sId() == null ? 0 : this.getRrna21sId().hashCode());
		result = 37 * result
