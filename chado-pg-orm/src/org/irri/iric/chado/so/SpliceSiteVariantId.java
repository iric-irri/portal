...
/**
 * SpliceSiteVariantId generated by hbm2java
 */
public class SpliceSiteVariantId implements java.io.Serializable {

	private Integer spliceSiteVariantId;
	...
	public SpliceSiteVariantId() {
	}

	public SpliceSiteVariantId(Integer spliceSiteVariantId, Integer featureId,
		...
		this.spliceSiteVariantId = spliceSiteVariantId;
	...
	public Integer getSpliceSiteVariantId() {
		return this.spliceSiteVariantId;
	}

	public void setSpliceSiteVariantId(Integer spliceSiteVariantId) {
		this.spliceSiteVariantId = spliceSiteVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceSiteVariantId))
			return false;
		SpliceSiteVariantId castOther = (SpliceSiteVariantId) other;

		return ((this.getSpliceSiteVariantId() == castOther
				.getSpliceSiteVariantId()) || (this.getSpliceSiteVariantId() != null
				&& castOther.getSpliceSiteVariantId() != null && this
				.getSpliceSiteVariantId().equals(
						castOther.getSpliceSiteVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceSiteVariantId() == null ? 0 : this
						.getSpliceSiteVariantId().hashCode());
		result = 37 * result
