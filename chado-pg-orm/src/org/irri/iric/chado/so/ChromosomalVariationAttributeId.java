...
/**
 * ChromosomalVariationAttributeId generated by hbm2java
 */
public class ChromosomalVariationAttributeId implements java.io.Serializable {

	private Integer chromosomalVariationAttributeId;
	...
	public ChromosomalVariationAttributeId() {
	}

	public ChromosomalVariationAttributeId(
			Integer chromosomalVariationAttributeId, Integer featureId,
		...
		this.chromosomalVariationAttributeId = chromosomalVariationAttributeId;
	...
	public Integer getChromosomalVariationAttributeId() {
		return this.chromosomalVariationAttributeId;
	}

	public void setChromosomalVariationAttributeId(
			Integer chromosomalVariationAttributeId) {
		this.chromosomalVariationAttributeId = chromosomalVariationAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalVariationAttributeId))
			return false;
		ChromosomalVariationAttributeId castOther = (ChromosomalVariationAttributeId) other;

		return ((this.getChromosomalVariationAttributeId() == castOther
				.getChromosomalVariationAttributeId()) || (this
				.getChromosomalVariationAttributeId() != null
				&& castOther.getChromosomalVariationAttributeId() != null && this
				.getChromosomalVariationAttributeId().equals(
						castOther.getChromosomalVariationAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalVariationAttributeId() == null ? 0 : this
						.getChromosomalVariationAttributeId().hashCode());
		result = 37 * result
