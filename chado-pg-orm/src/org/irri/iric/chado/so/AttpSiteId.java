...
/**
 * AttpSiteId generated by hbm2java
 */
public class AttpSiteId implements java.io.Serializable {

	private Integer attpSiteId;
	...
	public AttpSiteId(Integer attpSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttpSiteId() {
		return this.attpSiteId;
	}

	public void setAttpSiteId(Integer attpSiteId) {
		this.attpSiteId = attpSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttpSiteId))
			return false;
		AttpSiteId castOther = (AttpSiteId) other;

		return ((this.getAttpSiteId() == castOther.getAttpSiteId()) || (this
				.getAttpSiteId() != null && castOther.getAttpSiteId() != null && this
				.getAttpSiteId().equals(castOther.getAttpSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttpSiteId() == null ? 0 : this.getAttpSiteId()
						.hashCode());
		result = 37 * result
