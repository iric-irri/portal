...
/**
 * HelixTurnHelixId generated by hbm2java
 */
public class HelixTurnHelixId implements java.io.Serializable {

	private Integer helixTurnHelixId;
	...
	public HelixTurnHelixId() {
	}

	public HelixTurnHelixId(Integer helixTurnHelixId, Integer featureId,
		...
		this.helixTurnHelixId = helixTurnHelixId;
	...
	public Integer getHelixTurnHelixId() {
		return this.helixTurnHelixId;
	}

	public void setHelixTurnHelixId(Integer helixTurnHelixId) {
		this.helixTurnHelixId = helixTurnHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HelixTurnHelixId))
			return false;
		HelixTurnHelixId castOther = (HelixTurnHelixId) other;

		return ((this.getHelixTurnHelixId() == castOther.getHelixTurnHelixId()) || (this
				.getHelixTurnHelixId() != null
				&& castOther.getHelixTurnHelixId() != null && this
				.getHelixTurnHelixId().equals(castOther.getHelixTurnHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHelixTurnHelixId() == null ? 0 : this
						.getHelixTurnHelixId().hashCode());
		result = 37 * result
