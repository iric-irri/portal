...
/**
 * HAcaBoxSnornaId generated by hbm2java
 */
public class HAcaBoxSnornaId implements java.io.Serializable {

	private Integer HAcaBoxSnornaId;
	...
	public HAcaBoxSnornaId() {
	}

	public HAcaBoxSnornaId(Integer HAcaBoxSnornaId, Integer featureId,
		...
		this.HAcaBoxSnornaId = HAcaBoxSnornaId;
	...
	public Integer getHAcaBoxSnornaId() {
		return this.HAcaBoxSnornaId;
	}

	public void setHAcaBoxSnornaId(Integer HAcaBoxSnornaId) {
		this.HAcaBoxSnornaId = HAcaBoxSnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HAcaBoxSnornaId))
			return false;
		HAcaBoxSnornaId castOther = (HAcaBoxSnornaId) other;

		return ((this.getHAcaBoxSnornaId() == castOther.getHAcaBoxSnornaId()) || (this
				.getHAcaBoxSnornaId() != null
				&& castOther.getHAcaBoxSnornaId() != null && this
				.getHAcaBoxSnornaId().equals(castOther.getHAcaBoxSnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHAcaBoxSnornaId() == null ? 0 : this.getHAcaBoxSnornaId()
						.hashCode());
		result = 37 * result
