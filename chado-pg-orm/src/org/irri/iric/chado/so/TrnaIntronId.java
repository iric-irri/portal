...
/**
 * TrnaIntronId generated by hbm2java
 */
public class TrnaIntronId implements java.io.Serializable {

	private Integer trnaIntronId;
	...
	public TrnaIntronId(Integer trnaIntronId, Integer featureId,
		...
		this.trnaIntronId = trnaIntronId;
	...
	public Integer getTrnaIntronId() {
		return this.trnaIntronId;
	}

	public void setTrnaIntronId(Integer trnaIntronId) {
		this.trnaIntronId = trnaIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaIntronId))
			return false;
		TrnaIntronId castOther = (TrnaIntronId) other;

		return ((this.getTrnaIntronId() == castOther.getTrnaIntronId()) || (this
				.getTrnaIntronId() != null
				&& castOther.getTrnaIntronId() != null && this
				.getTrnaIntronId().equals(castOther.getTrnaIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrnaIntronId() == null ? 0 : this.getTrnaIntronId()
						.hashCode());
		result = 37 * result
