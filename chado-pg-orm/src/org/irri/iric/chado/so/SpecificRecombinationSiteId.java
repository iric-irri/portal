...
/**
 * SpecificRecombinationSiteId generated by hbm2java
 */
public class SpecificRecombinationSiteId implements java.io.Serializable {

	private Integer specificRecombinationSiteId;
	...
	public SpecificRecombinationSiteId() {
	}

	public SpecificRecombinationSiteId(Integer specificRecombinationSiteId,
		...
		this.specificRecombinationSiteId = specificRecombinationSiteId;
	...
	public Integer getSpecificRecombinationSiteId() {
		return this.specificRecombinationSiteId;
	}

	public void setSpecificRecombinationSiteId(
			Integer specificRecombinationSiteId) {
		this.specificRecombinationSiteId = specificRecombinationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpecificRecombinationSiteId))
			return false;
		SpecificRecombinationSiteId castOther = (SpecificRecombinationSiteId) other;

		return ((this.getSpecificRecombinationSiteId() == castOther
				.getSpecificRecombinationSiteId()) || (this
				.getSpecificRecombinationSiteId() != null
				&& castOther.getSpecificRecombinationSiteId() != null && this
				.getSpecificRecombinationSiteId().equals(
						castOther.getSpecificRecombinationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpecificRecombinationSiteId() == null ? 0 : this
						.getSpecificRecombinationSiteId().hashCode());
		result = 37 * result
