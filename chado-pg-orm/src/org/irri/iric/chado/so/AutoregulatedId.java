...
/**
 * AutoregulatedId generated by hbm2java
 */
public class AutoregulatedId implements java.io.Serializable {

	private Integer autoregulatedId;
	...
	public AutoregulatedId() {
	}

	public AutoregulatedId(Integer autoregulatedId, Integer featureId,
		...
		this.autoregulatedId = autoregulatedId;
	...
	public Integer getAutoregulatedId() {
		return this.autoregulatedId;
	}

	public void setAutoregulatedId(Integer autoregulatedId) {
		this.autoregulatedId = autoregulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutoregulatedId))
			return false;
		AutoregulatedId castOther = (AutoregulatedId) other;

		return ((this.getAutoregulatedId() == castOther.getAutoregulatedId()) || (this
				.getAutoregulatedId() != null
				&& castOther.getAutoregulatedId() != null && this
				.getAutoregulatedId().equals(castOther.getAutoregulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAutoregulatedId() == null ? 0 : this.getAutoregulatedId()
						.hashCode());
		result = 37 * result
