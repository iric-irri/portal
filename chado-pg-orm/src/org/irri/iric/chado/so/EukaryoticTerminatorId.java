...
/**
 * EukaryoticTerminatorId generated by hbm2java
 */
public class EukaryoticTerminatorId implements java.io.Serializable {

	private Integer eukaryoticTerminatorId;
	...
	public EukaryoticTerminatorId() {
	}

	public EukaryoticTerminatorId(Integer eukaryoticTerminatorId,
		...
		this.eukaryoticTerminatorId = eukaryoticTerminatorId;
	...
	public Integer getEukaryoticTerminatorId() {
		return this.eukaryoticTerminatorId;
	}

	public void setEukaryoticTerminatorId(Integer eukaryoticTerminatorId) {
		this.eukaryoticTerminatorId = eukaryoticTerminatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EukaryoticTerminatorId))
			return false;
		EukaryoticTerminatorId castOther = (EukaryoticTerminatorId) other;

		return ((this.getEukaryoticTerminatorId() == castOther
				.getEukaryoticTerminatorId()) || (this
				.getEukaryoticTerminatorId() != null
				&& castOther.getEukaryoticTerminatorId() != null && this
				.getEukaryoticTerminatorId().equals(
						castOther.getEukaryoticTerminatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEukaryoticTerminatorId() == null ? 0 : this
						.getEukaryoticTerminatorId().hashCode());
		result = 37 * result
