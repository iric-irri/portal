...
/**
 * SonicateFragmentId generated by hbm2java
 */
public class SonicateFragmentId implements java.io.Serializable {

	private Integer sonicateFragmentId;
	...
	public SonicateFragmentId() {
	}

	public SonicateFragmentId(Integer sonicateFragmentId, Integer featureId,
		...
		this.sonicateFragmentId = sonicateFragmentId;
	...
	public Integer getSonicateFragmentId() {
		return this.sonicateFragmentId;
	}

	public void setSonicateFragmentId(Integer sonicateFragmentId) {
		this.sonicateFragmentId = sonicateFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SonicateFragmentId))
			return false;
		SonicateFragmentId castOther = (SonicateFragmentId) other;

		return ((this.getSonicateFragmentId() == castOther
				.getSonicateFragmentId()) || (this.getSonicateFragmentId() != null
				&& castOther.getSonicateFragmentId() != null && this
				.getSonicateFragmentId().equals(
						castOther.getSonicateFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSonicateFragmentId() == null ? 0 : this
						.getSonicateFragmentId().hashCode());
		result = 37 * result
