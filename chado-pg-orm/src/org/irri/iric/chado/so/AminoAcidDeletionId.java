...
/**
 * AminoAcidDeletionId generated by hbm2java
 */
public class AminoAcidDeletionId implements java.io.Serializable {

	private Integer aminoAcidDeletionId;
	...
	public AminoAcidDeletionId() {
	}

	public AminoAcidDeletionId(Integer aminoAcidDeletionId, Integer featureId,
		...
		this.aminoAcidDeletionId = aminoAcidDeletionId;
	...
	public Integer getAminoAcidDeletionId() {
		return this.aminoAcidDeletionId;
	}

	public void setAminoAcidDeletionId(Integer aminoAcidDeletionId) {
		this.aminoAcidDeletionId = aminoAcidDeletionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AminoAcidDeletionId))
			return false;
		AminoAcidDeletionId castOther = (AminoAcidDeletionId) other;

		return ((this.getAminoAcidDeletionId() == castOther
				.getAminoAcidDeletionId()) || (this.getAminoAcidDeletionId() != null
				&& castOther.getAminoAcidDeletionId() != null && this
				.getAminoAcidDeletionId().equals(
						castOther.getAminoAcidDeletionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAminoAcidDeletionId() == null ? 0 : this
						.getAminoAcidDeletionId().hashCode());
		result = 37 * result
