...
/**
 * PrimerId generated by hbm2java
 */
public class PrimerId implements java.io.Serializable {
	...
	public PrimerId(Integer primerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPrimerId() {
		return this.primerId;
	}

	public void setPrimerId(Integer primerId) {
		this.primerId = primerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrimerId))
			return false;
		PrimerId castOther = (PrimerId) other;

		return ((this.getPrimerId() == castOther.getPrimerId()) || (this
				.getPrimerId() != null && castOther.getPrimerId() != null && this
				.getPrimerId().equals(castOther.getPrimerId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPrimerId() == null ? 0 : this.getPrimerId().hashCode());
		result = 37 * result
