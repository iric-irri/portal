...
/**
 * ModifiedLLeucineId generated by hbm2java
 */
public class ModifiedLLeucineId implements java.io.Serializable {

	private Integer modifiedLLeucineId;
	...
	public ModifiedLLeucineId() {
	}

	public ModifiedLLeucineId(Integer modifiedLLeucineId, Integer featureId,
		...
		this.modifiedLLeucineId = modifiedLLeucineId;
	...
	public Integer getModifiedLLeucineId() {
		return this.modifiedLLeucineId;
	}

	public void setModifiedLLeucineId(Integer modifiedLLeucineId) {
		this.modifiedLLeucineId = modifiedLLeucineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLLeucineId))
			return false;
		ModifiedLLeucineId castOther = (ModifiedLLeucineId) other;

		return ((this.getModifiedLLeucineId() == castOther
				.getModifiedLLeucineId()) || (this.getModifiedLLeucineId() != null
				&& castOther.getModifiedLLeucineId() != null && this
				.getModifiedLLeucineId().equals(
						castOther.getModifiedLLeucineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLLeucineId() == null ? 0 : this
						.getModifiedLLeucineId().hashCode());
		result = 37 * result
