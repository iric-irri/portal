...
/**
 * Sl8AcceptorSiteId generated by hbm2java
 */
public class Sl8AcceptorSiteId implements java.io.Serializable {

	private Integer sl8AcceptorSiteId;
	...
	public Sl8AcceptorSiteId() {
	}

	public Sl8AcceptorSiteId(Integer sl8AcceptorSiteId, Integer featureId,
		...
		this.sl8AcceptorSiteId = sl8AcceptorSiteId;
	...
	public Integer getSl8AcceptorSiteId() {
		return this.sl8AcceptorSiteId;
	}

	public void setSl8AcceptorSiteId(Integer sl8AcceptorSiteId) {
		this.sl8AcceptorSiteId = sl8AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl8AcceptorSiteId))
			return false;
		Sl8AcceptorSiteId castOther = (Sl8AcceptorSiteId) other;

		return ((this.getSl8AcceptorSiteId() == castOther
				.getSl8AcceptorSiteId()) || (this.getSl8AcceptorSiteId() != null
				&& castOther.getSl8AcceptorSiteId() != null && this
				.getSl8AcceptorSiteId()
				.equals(castOther.getSl8AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl8AcceptorSiteId() == null ? 0 : this
						.getSl8AcceptorSiteId().hashCode());
		result = 37 * result
