...
/**
 * TransSpliceAcceptorSiteId generated by hbm2java
 */
public class TransSpliceAcceptorSiteId implements java.io.Serializable {

	private Integer transSpliceAcceptorSiteId;
	...
	public TransSpliceAcceptorSiteId() {
	}

	public TransSpliceAcceptorSiteId(Integer transSpliceAcceptorSiteId,
		...
		this.transSpliceAcceptorSiteId = transSpliceAcceptorSiteId;
	...
	public Integer getTransSpliceAcceptorSiteId() {
		return this.transSpliceAcceptorSiteId;
	}

	public void setTransSpliceAcceptorSiteId(Integer transSpliceAcceptorSiteId) {
		this.transSpliceAcceptorSiteId = transSpliceAcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSpliceAcceptorSiteId))
			return false;
		TransSpliceAcceptorSiteId castOther = (TransSpliceAcceptorSiteId) other;

		return ((this.getTransSpliceAcceptorSiteId() == castOther
				.getTransSpliceAcceptorSiteId()) || (this
				.getTransSpliceAcceptorSiteId() != null
				&& castOther.getTransSpliceAcceptorSiteId() != null && this
				.getTransSpliceAcceptorSiteId().equals(
						castOther.getTransSpliceAcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSpliceAcceptorSiteId() == null ? 0 : this
						.getTransSpliceAcceptorSiteId().hashCode());
		result = 37 * result
