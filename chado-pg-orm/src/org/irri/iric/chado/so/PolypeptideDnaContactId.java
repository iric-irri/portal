...
/**
 * PolypeptideDnaContactId generated by hbm2java
 */
public class PolypeptideDnaContactId implements java.io.Serializable {

	private Integer polypeptideDnaContactId;
	...
	public PolypeptideDnaContactId() {
	}

	public PolypeptideDnaContactId(Integer polypeptideDnaContactId,
		...
		this.polypeptideDnaContactId = polypeptideDnaContactId;
	...
	public Integer getPolypeptideDnaContactId() {
		return this.polypeptideDnaContactId;
	}

	public void setPolypeptideDnaContactId(Integer polypeptideDnaContactId) {
		this.polypeptideDnaContactId = polypeptideDnaContactId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideDnaContactId))
			return false;
		PolypeptideDnaContactId castOther = (PolypeptideDnaContactId) other;

		return ((this.getPolypeptideDnaContactId() == castOther
				.getPolypeptideDnaContactId()) || (this
				.getPolypeptideDnaContactId() != null
				&& castOther.getPolypeptideDnaContactId() != null && this
				.getPolypeptideDnaContactId().equals(
						castOther.getPolypeptideDnaContactId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideDnaContactId() == null ? 0 : this
						.getPolypeptideDnaContactId().hashCode());
		result = 37 * result
