...
/**
 * GeneSilencedByHistoneDeacetylationId generated by hbm2java
 */
public class GeneSilencedByHistoneDeacetylationId implements
		java.io.Serializable {

	private Integer geneSilencedByHistoneDeacetylationId;
	...
	public GeneSilencedByHistoneDeacetylationId() {
	}

	public GeneSilencedByHistoneDeacetylationId(
			Integer geneSilencedByHistoneDeacetylationId, Integer featureId,
		...
		this.geneSilencedByHistoneDeacetylationId = geneSilencedByHistoneDeacetylationId;
	...
	public Integer getGeneSilencedByHistoneDeacetylationId() {
		return this.geneSilencedByHistoneDeacetylationId;
	}

	public void setGeneSilencedByHistoneDeacetylationId(
			Integer geneSilencedByHistoneDeacetylationId) {
		this.geneSilencedByHistoneDeacetylationId = geneSilencedByHistoneDeacetylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByHistoneDeacetylationId))
			return false;
		GeneSilencedByHistoneDeacetylationId castOther = (GeneSilencedByHistoneDeacetylationId) other;

		return ((this.getGeneSilencedByHistoneDeacetylationId() == castOther
				.getGeneSilencedByHistoneDeacetylationId()) || (this
				.getGeneSilencedByHistoneDeacetylationId() != null
				&& castOther.getGeneSilencedByHistoneDeacetylationId() != null && this
				.getGeneSilencedByHistoneDeacetylationId().equals(
						castOther.getGeneSilencedByHistoneDeacetylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByHistoneDeacetylationId() == null ? 0 : this
						.getGeneSilencedByHistoneDeacetylationId().hashCode());
		result = 37 * result
