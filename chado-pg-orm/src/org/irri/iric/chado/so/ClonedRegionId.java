...
/**
 * ClonedRegionId generated by hbm2java
 */
public class ClonedRegionId implements java.io.Serializable {

	private Integer clonedRegionId;
	...
	public ClonedRegionId() {
	}

	public ClonedRegionId(Integer clonedRegionId, Integer featureId,
		...
		this.clonedRegionId = clonedRegionId;
	...
	public Integer getClonedRegionId() {
		return this.clonedRegionId;
	}

	public void setClonedRegionId(Integer clonedRegionId) {
		this.clonedRegionId = clonedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClonedRegionId))
			return false;
		ClonedRegionId castOther = (ClonedRegionId) other;

		return ((this.getClonedRegionId() == castOther.getClonedRegionId()) || (this
				.getClonedRegionId() != null
				&& castOther.getClonedRegionId() != null && this
				.getClonedRegionId().equals(castOther.getClonedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getClonedRegionId() == null ? 0 : this.getClonedRegionId()
						.hashCode());
		result = 37 * result
