...
/**
 * TransSplicedTranscriptId generated by hbm2java
 */
public class TransSplicedTranscriptId implements java.io.Serializable {

	private Integer transSplicedTranscriptId;
	...
	public TransSplicedTranscriptId() {
	}

	public TransSplicedTranscriptId(Integer transSplicedTranscriptId,
		...
		this.transSplicedTranscriptId = transSplicedTranscriptId;
	...
	public Integer getTransSplicedTranscriptId() {
		return this.transSplicedTranscriptId;
	}

	public void setTransSplicedTranscriptId(Integer transSplicedTranscriptId) {
		this.transSplicedTranscriptId = transSplicedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSplicedTranscriptId))
			return false;
		TransSplicedTranscriptId castOther = (TransSplicedTranscriptId) other;

		return ((this.getTransSplicedTranscriptId() == castOther
				.getTransSplicedTranscriptId()) || (this
				.getTransSplicedTranscriptId() != null
				&& castOther.getTransSplicedTranscriptId() != null && this
				.getTransSplicedTranscriptId().equals(
						castOther.getTransSplicedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSplicedTranscriptId() == null ? 0 : this
						.getTransSplicedTranscriptId().hashCode());
		result = 37 * result
