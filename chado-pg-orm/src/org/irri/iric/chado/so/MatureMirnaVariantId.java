...
/**
 * MatureMirnaVariantId generated by hbm2java
 */
public class MatureMirnaVariantId implements java.io.Serializable {

	private Integer matureMirnaVariantId;
	...
	public MatureMirnaVariantId() {
	}

	public MatureMirnaVariantId(Integer matureMirnaVariantId,
		...
		this.matureMirnaVariantId = matureMirnaVariantId;
	...
	public Integer getMatureMirnaVariantId() {
		return this.matureMirnaVariantId;
	}

	public void setMatureMirnaVariantId(Integer matureMirnaVariantId) {
		this.matureMirnaVariantId = matureMirnaVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatureMirnaVariantId))
			return false;
		MatureMirnaVariantId castOther = (MatureMirnaVariantId) other;

		return ((this.getMatureMirnaVariantId() == castOther
				.getMatureMirnaVariantId()) || (this.getMatureMirnaVariantId() != null
				&& castOther.getMatureMirnaVariantId() != null && this
				.getMatureMirnaVariantId().equals(
						castOther.getMatureMirnaVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatureMirnaVariantId() == null ? 0 : this
						.getMatureMirnaVariantId().hashCode());
		result = 37 * result
