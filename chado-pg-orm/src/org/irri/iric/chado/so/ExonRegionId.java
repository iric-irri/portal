...
/**
 * ExonRegionId generated by hbm2java
 */
public class ExonRegionId implements java.io.Serializable {

	private Integer exonRegionId;
	...
	public ExonRegionId(Integer exonRegionId, Integer featureId,
		...
		this.exonRegionId = exonRegionId;
	...
	public Integer getExonRegionId() {
		return this.exonRegionId;
	}

	public void setExonRegionId(Integer exonRegionId) {
		this.exonRegionId = exonRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonRegionId))
			return false;
		ExonRegionId castOther = (ExonRegionId) other;

		return ((this.getExonRegionId() == castOther.getExonRegionId()) || (this
				.getExonRegionId() != null
				&& castOther.getExonRegionId() != null && this
				.getExonRegionId().equals(castOther.getExonRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExonRegionId() == null ? 0 : this.getExonRegionId()
						.hashCode());
		result = 37 * result
