...
/**
 * TToGTransversionId generated by hbm2java
 */
public class TToGTransversionId implements java.io.Serializable {

	private Integer TToGTransversionId;
	...
	public TToGTransversionId() {
	}

	public TToGTransversionId(Integer TToGTransversionId, Integer featureId,
		...
		this.TToGTransversionId = TToGTransversionId;
	...
	public Integer getTToGTransversionId() {
		return this.TToGTransversionId;
	}

	public void setTToGTransversionId(Integer TToGTransversionId) {
		this.TToGTransversionId = TToGTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TToGTransversionId))
			return false;
		TToGTransversionId castOther = (TToGTransversionId) other;

		return ((this.getTToGTransversionId() == castOther
				.getTToGTransversionId()) || (this.getTToGTransversionId() != null
				&& castOther.getTToGTransversionId() != null && this
				.getTToGTransversionId().equals(
						castOther.getTToGTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTToGTransversionId() == null ? 0 : this
						.getTToGTransversionId().hashCode());
		result = 37 * result
