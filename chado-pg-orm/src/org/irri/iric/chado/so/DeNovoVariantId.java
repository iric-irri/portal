...
/**
 * DeNovoVariantId generated by hbm2java
 */
public class DeNovoVariantId implements java.io.Serializable {

	private Integer deNovoVariantId;
	...
	public DeNovoVariantId() {
	}

	public DeNovoVariantId(Integer deNovoVariantId, Integer featureId,
		...
		this.deNovoVariantId = deNovoVariantId;
	...
	public Integer getDeNovoVariantId() {
		return this.deNovoVariantId;
	}

	public void setDeNovoVariantId(Integer deNovoVariantId) {
		this.deNovoVariantId = deNovoVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeNovoVariantId))
			return false;
		DeNovoVariantId castOther = (DeNovoVariantId) other;

		return ((this.getDeNovoVariantId() == castOther.getDeNovoVariantId()) || (this
				.getDeNovoVariantId() != null
				&& castOther.getDeNovoVariantId() != null && this
				.getDeNovoVariantId().equals(castOther.getDeNovoVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeNovoVariantId() == null ? 0 : this.getDeNovoVariantId()
						.hashCode());
		result = 37 * result
