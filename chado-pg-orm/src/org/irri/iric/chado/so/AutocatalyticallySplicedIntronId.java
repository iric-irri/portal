...
/**
 * AutocatalyticallySplicedIntronId generated by hbm2java
 */
public class AutocatalyticallySplicedIntronId implements java.io.Serializable {

	private Integer autocatalyticallySplicedIntronId;
	...
	public AutocatalyticallySplicedIntronId() {
	}

	public AutocatalyticallySplicedIntronId(
			Integer autocatalyticallySplicedIntronId, Integer featureId,
		...
		this.autocatalyticallySplicedIntronId = autocatalyticallySplicedIntronId;
	...
	public Integer getAutocatalyticallySplicedIntronId() {
		return this.autocatalyticallySplicedIntronId;
	}

	public void setAutocatalyticallySplicedIntronId(
			Integer autocatalyticallySplicedIntronId) {
		this.autocatalyticallySplicedIntronId = autocatalyticallySplicedIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutocatalyticallySplicedIntronId))
			return false;
		AutocatalyticallySplicedIntronId castOther = (AutocatalyticallySplicedIntronId) other;

		return ((this.getAutocatalyticallySplicedIntronId() == castOther
				.getAutocatalyticallySplicedIntronId()) || (this
				.getAutocatalyticallySplicedIntronId() != null
				&& castOther.getAutocatalyticallySplicedIntronId() != null && this
				.getAutocatalyticallySplicedIntronId().equals(
						castOther.getAutocatalyticallySplicedIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAutocatalyticallySplicedIntronId() == null ? 0 : this
						.getAutocatalyticallySplicedIntronId().hashCode());
		result = 37 * result
