...
/**
 * VertebrateImmuneSystemGeneRecombinationSignalFeatureId generated by hbm2java
 */
public class VertebrateImmuneSystemGeneRecombinationSignalFeatureId implements
		java.io.Serializable {

	private Integer vertebrateImmuneSystemGeneRecombinationSignalFeatureId;
	...
	public VertebrateImmuneSystemGeneRecombinationSignalFeatureId() {
	}

	public VertebrateImmuneSystemGeneRecombinationSignalFeatureId(
			Integer vertebrateImmuneSystemGeneRecombinationSignalFeatureId,
		...
		this.vertebrateImmuneSystemGeneRecombinationSignalFeatureId = vertebrateImmuneSystemGeneRecombinationSignalFeatureId;
	...
	public Integer getVertebrateImmuneSystemGeneRecombinationSignalFeatureId() {
		return this.vertebrateImmuneSystemGeneRecombinationSignalFeatureId;
	}

	public void setVertebrateImmuneSystemGeneRecombinationSignalFeatureId(
			Integer vertebrateImmuneSystemGeneRecombinationSignalFeatureId) {
		this.vertebrateImmuneSystemGeneRecombinationSignalFeatureId = vertebrateImmuneSystemGeneRecombinationSignalFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateImmuneSystemGeneRecombinationSignalFeatureId))
			return false;
		VertebrateImmuneSystemGeneRecombinationSignalFeatureId castOther = (VertebrateImmuneSystemGeneRecombinationSignalFeatureId) other;

		return ((this
				.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId() == castOther
				.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId()) || (this
				.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId() != null
				&& castOther
						.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId() != null && this
				.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId()
				.equals(castOther
						.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateImmuneSystemGeneRecombinationSignalFeatureId() == null ? 0
						: this.getVertebrateImmuneSystemGeneRecombinationSignalFeatureId()
								.hashCode());
		result = 37 * result
