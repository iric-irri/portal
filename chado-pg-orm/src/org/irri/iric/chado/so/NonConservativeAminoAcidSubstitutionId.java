...
/**
 * NonConservativeAminoAcidSubstitutionId generated by hbm2java
 */
public class NonConservativeAminoAcidSubstitutionId implements
		java.io.Serializable {

	private Integer nonConservativeAminoAcidSubstitutionId;
	...
	public NonConservativeAminoAcidSubstitutionId() {
	}

	public NonConservativeAminoAcidSubstitutionId(
			Integer nonConservativeAminoAcidSubstitutionId, Integer featureId,
		...
		this.nonConservativeAminoAcidSubstitutionId = nonConservativeAminoAcidSubstitutionId;
	...
	public Integer getNonConservativeAminoAcidSubstitutionId() {
		return this.nonConservativeAminoAcidSubstitutionId;
	}

	public void setNonConservativeAminoAcidSubstitutionId(
			Integer nonConservativeAminoAcidSubstitutionId) {
		this.nonConservativeAminoAcidSubstitutionId = nonConservativeAminoAcidSubstitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonConservativeAminoAcidSubstitutionId))
			return false;
		NonConservativeAminoAcidSubstitutionId castOther = (NonConservativeAminoAcidSubstitutionId) other;

		return ((this.getNonConservativeAminoAcidSubstitutionId() == castOther
				.getNonConservativeAminoAcidSubstitutionId()) || (this
				.getNonConservativeAminoAcidSubstitutionId() != null
				&& castOther.getNonConservativeAminoAcidSubstitutionId() != null && this
				.getNonConservativeAminoAcidSubstitutionId().equals(
						castOther.getNonConservativeAminoAcidSubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonConservativeAminoAcidSubstitutionId() == null ? 0
						: this.getNonConservativeAminoAcidSubstitutionId()
								.hashCode());
		result = 37 * result
