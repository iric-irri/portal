...
/**
 * DsOligoId generated by hbm2java
 */
public class DsOligoId implements java.io.Serializable {

	private Integer dsOligoId;
	...
	public DsOligoId(Integer dsOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDsOligoId() {
		return this.dsOligoId;
	}

	public void setDsOligoId(Integer dsOligoId) {
		this.dsOligoId = dsOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DsOligoId))
			return false;
		DsOligoId castOther = (DsOligoId) other;

		return ((this.getDsOligoId() == castOther.getDsOligoId()) || (this
				.getDsOligoId() != null && castOther.getDsOligoId() != null && this
				.getDsOligoId().equals(castOther.getDsOligoId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDsOligoId() == null ? 0 : this.getDsOligoId().hashCode());
		result = 37 * result
