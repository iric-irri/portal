...
/**
 * DispersedRepeatId generated by hbm2java
 */
public class DispersedRepeatId implements java.io.Serializable {

	private Integer dispersedRepeatId;
	...
	public DispersedRepeatId() {
	}

	public DispersedRepeatId(Integer dispersedRepeatId, Integer featureId,
		...
		this.dispersedRepeatId = dispersedRepeatId;
	...
	public Integer getDispersedRepeatId() {
		return this.dispersedRepeatId;
	}

	public void setDispersedRepeatId(Integer dispersedRepeatId) {
		this.dispersedRepeatId = dispersedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DispersedRepeatId))
			return false;
		DispersedRepeatId castOther = (DispersedRepeatId) other;

		return ((this.getDispersedRepeatId() == castOther
				.getDispersedRepeatId()) || (this.getDispersedRepeatId() != null
				&& castOther.getDispersedRepeatId() != null && this
				.getDispersedRepeatId()
				.equals(castOther.getDispersedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDispersedRepeatId() == null ? 0 : this
						.getDispersedRepeatId().hashCode());
		result = 37 * result
