...
/**
 * EnhancerBindingSiteId generated by hbm2java
 */
public class EnhancerBindingSiteId implements java.io.Serializable {

	private Integer enhancerBindingSiteId;
	...
	public EnhancerBindingSiteId() {
	}

	public EnhancerBindingSiteId(Integer enhancerBindingSiteId,
		...
		this.enhancerBindingSiteId = enhancerBindingSiteId;
	...
	public Integer getEnhancerBindingSiteId() {
		return this.enhancerBindingSiteId;
	}

	public void setEnhancerBindingSiteId(Integer enhancerBindingSiteId) {
		this.enhancerBindingSiteId = enhancerBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnhancerBindingSiteId))
			return false;
		EnhancerBindingSiteId castOther = (EnhancerBindingSiteId) other;

		return ((this.getEnhancerBindingSiteId() == castOther
				.getEnhancerBindingSiteId()) || (this
				.getEnhancerBindingSiteId() != null
				&& castOther.getEnhancerBindingSiteId() != null && this
				.getEnhancerBindingSiteId().equals(
						castOther.getEnhancerBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnhancerBindingSiteId() == null ? 0 : this
						.getEnhancerBindingSiteId().hashCode());
		result = 37 * result
