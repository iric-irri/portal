...
/**
 * GeneTrapConstructId generated by hbm2java
 */
public class GeneTrapConstructId implements java.io.Serializable {

	private Integer geneTrapConstructId;
	...
	public GeneTrapConstructId() {
	}

	public GeneTrapConstructId(Integer geneTrapConstructId, Integer featureId,
		...
		this.geneTrapConstructId = geneTrapConstructId;
	...
	public Integer getGeneTrapConstructId() {
		return this.geneTrapConstructId;
	}

	public void setGeneTrapConstructId(Integer geneTrapConstructId) {
		this.geneTrapConstructId = geneTrapConstructId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneTrapConstructId))
			return false;
		GeneTrapConstructId castOther = (GeneTrapConstructId) other;

		return ((this.getGeneTrapConstructId() == castOther
				.getGeneTrapConstructId()) || (this.getGeneTrapConstructId() != null
				&& castOther.getGeneTrapConstructId() != null && this
				.getGeneTrapConstructId().equals(
						castOther.getGeneTrapConstructId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneTrapConstructId() == null ? 0 : this
						.getGeneTrapConstructId().hashCode());
		result = 37 * result
