...
/**
 * VDjClusterId generated by hbm2java
 */
public class VDjClusterId implements java.io.Serializable {

	private Integer VDjClusterId;
	...
	public VDjClusterId(Integer VDjClusterId, Integer featureId,
		...
		this.VDjClusterId = VDjClusterId;
	...
	public Integer getVDjClusterId() {
		return this.VDjClusterId;
	}

	public void setVDjClusterId(Integer VDjClusterId) {
		this.VDjClusterId = VDjClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDjClusterId))
			return false;
		VDjClusterId castOther = (VDjClusterId) other;

		return ((this.getVDjClusterId() == castOther.getVDjClusterId()) || (this
				.getVDjClusterId() != null
				&& castOther.getVDjClusterId() != null && this
				.getVDjClusterId().equals(castOther.getVDjClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDjClusterId() == null ? 0 : this.getVDjClusterId()
						.hashCode());
		result = 37 * result
