...
/**
 * EditedTranscriptByAToISubstitutionId generated by hbm2java
 */
public class EditedTranscriptByAToISubstitutionId implements
		java.io.Serializable {

	private Integer editedTranscriptByAToISubstitutionId;
	...
	public EditedTranscriptByAToISubstitutionId() {
	}

	public EditedTranscriptByAToISubstitutionId(
			Integer editedTranscriptByAToISubstitutionId, Integer featureId,
		...
		this.editedTranscriptByAToISubstitutionId = editedTranscriptByAToISubstitutionId;
	...
	public Integer getEditedTranscriptByAToISubstitutionId() {
		return this.editedTranscriptByAToISubstitutionId;
	}

	public void setEditedTranscriptByAToISubstitutionId(
			Integer editedTranscriptByAToISubstitutionId) {
		this.editedTranscriptByAToISubstitutionId = editedTranscriptByAToISubstitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedTranscriptByAToISubstitutionId))
			return false;
		EditedTranscriptByAToISubstitutionId castOther = (EditedTranscriptByAToISubstitutionId) other;

		return ((this.getEditedTranscriptByAToISubstitutionId() == castOther
				.getEditedTranscriptByAToISubstitutionId()) || (this
				.getEditedTranscriptByAToISubstitutionId() != null
				&& castOther.getEditedTranscriptByAToISubstitutionId() != null && this
				.getEditedTranscriptByAToISubstitutionId().equals(
						castOther.getEditedTranscriptByAToISubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditedTranscriptByAToISubstitutionId() == null ? 0 : this
						.getEditedTranscriptByAToISubstitutionId().hashCode());
		result = 37 * result
