...
/**
 * PolypeptideConservedRegionId generated by hbm2java
 */
public class PolypeptideConservedRegionId implements java.io.Serializable {

	private Integer polypeptideConservedRegionId;
	...
	public PolypeptideConservedRegionId() {
	}

	public PolypeptideConservedRegionId(Integer polypeptideConservedRegionId,
		...
		this.polypeptideConservedRegionId = polypeptideConservedRegionId;
	...
	public Integer getPolypeptideConservedRegionId() {
		return this.polypeptideConservedRegionId;
	}

	public void setPolypeptideConservedRegionId(
			Integer polypeptideConservedRegionId) {
		this.polypeptideConservedRegionId = polypeptideConservedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideConservedRegionId))
			return false;
		PolypeptideConservedRegionId castOther = (PolypeptideConservedRegionId) other;

		return ((this.getPolypeptideConservedRegionId() == castOther
				.getPolypeptideConservedRegionId()) || (this
				.getPolypeptideConservedRegionId() != null
				&& castOther.getPolypeptideConservedRegionId() != null && this
				.getPolypeptideConservedRegionId().equals(
						castOther.getPolypeptideConservedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideConservedRegionId() == null ? 0 : this
						.getPolypeptideConservedRegionId().hashCode());
		result = 37 * result
