...
/**
 * AutopolyploidId generated by hbm2java
 */
public class AutopolyploidId implements java.io.Serializable {

	private Integer autopolyploidId;
	...
	public AutopolyploidId() {
	}

	public AutopolyploidId(Integer autopolyploidId, Integer featureId,
		...
		this.autopolyploidId = autopolyploidId;
	...
	public Integer getAutopolyploidId() {
		return this.autopolyploidId;
	}

	public void setAutopolyploidId(Integer autopolyploidId) {
		this.autopolyploidId = autopolyploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutopolyploidId))
			return false;
		AutopolyploidId castOther = (AutopolyploidId) other;

		return ((this.getAutopolyploidId() == castOther.getAutopolyploidId()) || (this
				.getAutopolyploidId() != null
				&& castOther.getAutopolyploidId() != null && this
				.getAutopolyploidId().equals(castOther.getAutopolyploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAutopolyploidId() == null ? 0 : this.getAutopolyploidId()
						.hashCode());
		result = 37 * result
