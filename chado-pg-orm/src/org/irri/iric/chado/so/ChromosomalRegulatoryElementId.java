...
/**
 * ChromosomalRegulatoryElementId generated by hbm2java
 */
public class ChromosomalRegulatoryElementId implements java.io.Serializable {

	private Integer chromosomalRegulatoryElementId;
	...
	public ChromosomalRegulatoryElementId() {
	}

	public ChromosomalRegulatoryElementId(
			Integer chromosomalRegulatoryElementId, Integer featureId,
		...
		this.chromosomalRegulatoryElementId = chromosomalRegulatoryElementId;
	...
	public Integer getChromosomalRegulatoryElementId() {
		return this.chromosomalRegulatoryElementId;
	}

	public void setChromosomalRegulatoryElementId(
			Integer chromosomalRegulatoryElementId) {
		this.chromosomalRegulatoryElementId = chromosomalRegulatoryElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalRegulatoryElementId))
			return false;
		ChromosomalRegulatoryElementId castOther = (ChromosomalRegulatoryElementId) other;

		return ((this.getChromosomalRegulatoryElementId() == castOther
				.getChromosomalRegulatoryElementId()) || (this
				.getChromosomalRegulatoryElementId() != null
				&& castOther.getChromosomalRegulatoryElementId() != null && this
				.getChromosomalRegulatoryElementId().equals(
						castOther.getChromosomalRegulatoryElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalRegulatoryElementId() == null ? 0 : this
						.getChromosomalRegulatoryElementId().hashCode());
		result = 37 * result
