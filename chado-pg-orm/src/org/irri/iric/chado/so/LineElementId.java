...
/**
 * LineElementId generated by hbm2java
 */
public class LineElementId implements java.io.Serializable {

	private Integer lineElementId;
	...
	public LineElementId() {
	}

	public LineElementId(Integer lineElementId, Integer featureId,
		...
		this.lineElementId = lineElementId;
	...
	public Integer getLineElementId() {
		return this.lineElementId;
	}

	public void setLineElementId(Integer lineElementId) {
		this.lineElementId = lineElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LineElementId))
			return false;
		LineElementId castOther = (LineElementId) other;

		return ((this.getLineElementId() == castOther.getLineElementId()) || (this
				.getLineElementId() != null
				&& castOther.getLineElementId() != null && this
				.getLineElementId().equals(castOther.getLineElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLineElementId() == null ? 0 : this.getLineElementId()
						.hashCode());
		result = 37 * result
