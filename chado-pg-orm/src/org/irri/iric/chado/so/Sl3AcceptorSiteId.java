...
/**
 * Sl3AcceptorSiteId generated by hbm2java
 */
public class Sl3AcceptorSiteId implements java.io.Serializable {

	private Integer sl3AcceptorSiteId;
	...
	public Sl3AcceptorSiteId() {
	}

	public Sl3AcceptorSiteId(Integer sl3AcceptorSiteId, Integer featureId,
		...
		this.sl3AcceptorSiteId = sl3AcceptorSiteId;
	...
	public Integer getSl3AcceptorSiteId() {
		return this.sl3AcceptorSiteId;
	}

	public void setSl3AcceptorSiteId(Integer sl3AcceptorSiteId) {
		this.sl3AcceptorSiteId = sl3AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl3AcceptorSiteId))
			return false;
		Sl3AcceptorSiteId castOther = (Sl3AcceptorSiteId) other;

		return ((this.getSl3AcceptorSiteId() == castOther
				.getSl3AcceptorSiteId()) || (this.getSl3AcceptorSiteId() != null
				&& castOther.getSl3AcceptorSiteId() != null && this
				.getSl3AcceptorSiteId()
				.equals(castOther.getSl3AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl3AcceptorSiteId() == null ? 0 : this
						.getSl3AcceptorSiteId().hashCode());
		result = 37 * result
