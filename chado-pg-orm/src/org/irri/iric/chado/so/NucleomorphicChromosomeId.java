...
/**
 * NucleomorphicChromosomeId generated by hbm2java
 */
public class NucleomorphicChromosomeId implements java.io.Serializable {

	private Integer nucleomorphicChromosomeId;
	...
	public NucleomorphicChromosomeId() {
	}

	public NucleomorphicChromosomeId(Integer nucleomorphicChromosomeId,
		...
		this.nucleomorphicChromosomeId = nucleomorphicChromosomeId;
	...
	public Integer getNucleomorphicChromosomeId() {
		return this.nucleomorphicChromosomeId;
	}

	public void setNucleomorphicChromosomeId(Integer nucleomorphicChromosomeId) {
		this.nucleomorphicChromosomeId = nucleomorphicChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleomorphicChromosomeId))
			return false;
		NucleomorphicChromosomeId castOther = (NucleomorphicChromosomeId) other;

		return ((this.getNucleomorphicChromosomeId() == castOther
				.getNucleomorphicChromosomeId()) || (this
				.getNucleomorphicChromosomeId() != null
				&& castOther.getNucleomorphicChromosomeId() != null && this
				.getNucleomorphicChromosomeId().equals(
						castOther.getNucleomorphicChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleomorphicChromosomeId() == null ? 0 : this
						.getNucleomorphicChromosomeId().hashCode());
		result = 37 * result
