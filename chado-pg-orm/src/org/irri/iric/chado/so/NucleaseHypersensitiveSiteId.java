...
/**
 * NucleaseHypersensitiveSiteId generated by hbm2java
 */
public class NucleaseHypersensitiveSiteId implements java.io.Serializable {

	private Integer nucleaseHypersensitiveSiteId;
	...
	public NucleaseHypersensitiveSiteId() {
	}

	public NucleaseHypersensitiveSiteId(Integer nucleaseHypersensitiveSiteId,
		...
		this.nucleaseHypersensitiveSiteId = nucleaseHypersensitiveSiteId;
	...
	public Integer getNucleaseHypersensitiveSiteId() {
		return this.nucleaseHypersensitiveSiteId;
	}

	public void setNucleaseHypersensitiveSiteId(
			Integer nucleaseHypersensitiveSiteId) {
		this.nucleaseHypersensitiveSiteId = nucleaseHypersensitiveSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleaseHypersensitiveSiteId))
			return false;
		NucleaseHypersensitiveSiteId castOther = (NucleaseHypersensitiveSiteId) other;

		return ((this.getNucleaseHypersensitiveSiteId() == castOther
				.getNucleaseHypersensitiveSiteId()) || (this
				.getNucleaseHypersensitiveSiteId() != null
				&& castOther.getNucleaseHypersensitiveSiteId() != null && this
				.getNucleaseHypersensitiveSiteId().equals(
						castOther.getNucleaseHypersensitiveSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleaseHypersensitiveSiteId() == null ? 0 : this
						.getNucleaseHypersensitiveSiteId().hashCode());
		result = 37 * result
