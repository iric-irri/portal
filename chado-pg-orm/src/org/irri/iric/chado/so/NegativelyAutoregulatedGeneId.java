...
/**
 * NegativelyAutoregulatedGeneId generated by hbm2java
 */
public class NegativelyAutoregulatedGeneId implements java.io.Serializable {

	private Integer negativelyAutoregulatedGeneId;
	...
	public NegativelyAutoregulatedGeneId() {
	}

	public NegativelyAutoregulatedGeneId(Integer negativelyAutoregulatedGeneId,
		...
		this.negativelyAutoregulatedGeneId = negativelyAutoregulatedGeneId;
	...
	public Integer getNegativelyAutoregulatedGeneId() {
		return this.negativelyAutoregulatedGeneId;
	}

	public void setNegativelyAutoregulatedGeneId(
			Integer negativelyAutoregulatedGeneId) {
		this.negativelyAutoregulatedGeneId = negativelyAutoregulatedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NegativelyAutoregulatedGeneId))
			return false;
		NegativelyAutoregulatedGeneId castOther = (NegativelyAutoregulatedGeneId) other;

		return ((this.getNegativelyAutoregulatedGeneId() == castOther
				.getNegativelyAutoregulatedGeneId()) || (this
				.getNegativelyAutoregulatedGeneId() != null
				&& castOther.getNegativelyAutoregulatedGeneId() != null && this
				.getNegativelyAutoregulatedGeneId().equals(
						castOther.getNegativelyAutoregulatedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNegativelyAutoregulatedGeneId() == null ? 0 : this
						.getNegativelyAutoregulatedGeneId().hashCode());
		result = 37 * result
