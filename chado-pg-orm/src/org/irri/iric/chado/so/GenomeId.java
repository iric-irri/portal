...
/**
 * GenomeId generated by hbm2java
 */
public class GenomeId implements java.io.Serializable {
	...
	public GenomeId(Integer genomeId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenomeId))
			return false;
		GenomeId castOther = (GenomeId) other;

		return ((this.getGenomeId() == castOther.getGenomeId()) || (this
				.getGenomeId() != null && castOther.getGenomeId() != null && this
				.getGenomeId().equals(castOther.getGenomeId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGenomeId() == null ? 0 : this.getGenomeId().hashCode());
		result = 37 * result
