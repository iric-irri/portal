...
/**
 * BacClonedGenomicInsertId generated by hbm2java
 */
public class BacClonedGenomicInsertId implements java.io.Serializable {

	private Integer bacClonedGenomicInsertId;
	...
	public BacClonedGenomicInsertId() {
	}

	public BacClonedGenomicInsertId(Integer bacClonedGenomicInsertId,
		...
		this.bacClonedGenomicInsertId = bacClonedGenomicInsertId;
	...
	public Integer getBacClonedGenomicInsertId() {
		return this.bacClonedGenomicInsertId;
	}

	public void setBacClonedGenomicInsertId(Integer bacClonedGenomicInsertId) {
		this.bacClonedGenomicInsertId = bacClonedGenomicInsertId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BacClonedGenomicInsertId))
			return false;
		BacClonedGenomicInsertId castOther = (BacClonedGenomicInsertId) other;

		return ((this.getBacClonedGenomicInsertId() == castOther
				.getBacClonedGenomicInsertId()) || (this
				.getBacClonedGenomicInsertId() != null
				&& castOther.getBacClonedGenomicInsertId() != null && this
				.getBacClonedGenomicInsertId().equals(
						castOther.getBacClonedGenomicInsertId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBacClonedGenomicInsertId() == null ? 0 : this
						.getBacClonedGenomicInsertId().hashCode());
		result = 37 * result
