...
/**
 * OrphanCdsId generated by hbm2java
 */
public class OrphanCdsId implements java.io.Serializable {

	private Integer orphanCdsId;
	...
	public OrphanCdsId(Integer orphanCdsId, Integer featureId,
	...
	public Integer getOrphanCdsId() {
		return this.orphanCdsId;
	}

	public void setOrphanCdsId(Integer orphanCdsId) {
		this.orphanCdsId = orphanCdsId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrphanCdsId))
			return false;
		OrphanCdsId castOther = (OrphanCdsId) other;

		return ((this.getOrphanCdsId() == castOther.getOrphanCdsId()) || (this
				.getOrphanCdsId() != null && castOther.getOrphanCdsId() != null && this
				.getOrphanCdsId().equals(castOther.getOrphanCdsId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOrphanCdsId() == null ? 0 : this.getOrphanCdsId()
						.hashCode());
		result = 37 * result
