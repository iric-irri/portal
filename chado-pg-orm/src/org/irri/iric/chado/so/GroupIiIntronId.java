...
/**
 * GroupIiIntronId generated by hbm2java
 */
public class GroupIiIntronId implements java.io.Serializable {

	private Integer groupIiIntronId;
	...
	public GroupIiIntronId() {
	}

	public GroupIiIntronId(Integer groupIiIntronId, Integer featureId,
		...
		this.groupIiIntronId = groupIiIntronId;
	...
	public Integer getGroupIiIntronId() {
		return this.groupIiIntronId;
	}

	public void setGroupIiIntronId(Integer groupIiIntronId) {
		this.groupIiIntronId = groupIiIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIiIntronId))
			return false;
		GroupIiIntronId castOther = (GroupIiIntronId) other;

		return ((this.getGroupIiIntronId() == castOther.getGroupIiIntronId()) || (this
				.getGroupIiIntronId() != null
				&& castOther.getGroupIiIntronId() != null && this
				.getGroupIiIntronId().equals(castOther.getGroupIiIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroupIiIntronId() == null ? 0 : this.getGroupIiIntronId()
						.hashCode());
		result = 37 * result
