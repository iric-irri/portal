...
/**
 * VVdjCClusterId generated by hbm2java
 */
public class VVdjCClusterId implements java.io.Serializable {

	private Integer VVdjCClusterId;
	...
	public VVdjCClusterId() {
	}

	public VVdjCClusterId(Integer VVdjCClusterId, Integer featureId,
		...
		this.VVdjCClusterId = VVdjCClusterId;
	...
	public Integer getVVdjCClusterId() {
		return this.VVdjCClusterId;
	}

	public void setVVdjCClusterId(Integer VVdjCClusterId) {
		this.VVdjCClusterId = VVdjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVdjCClusterId))
			return false;
		VVdjCClusterId castOther = (VVdjCClusterId) other;

		return ((this.getVVdjCClusterId() == castOther.getVVdjCClusterId()) || (this
				.getVVdjCClusterId() != null
				&& castOther.getVVdjCClusterId() != null && this
				.getVVdjCClusterId().equals(castOther.getVVdjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVdjCClusterId() == null ? 0 : this.getVVdjCClusterId()
						.hashCode());
		result = 37 * result
