...
/**
 * Sl1AcceptorSiteId generated by hbm2java
 */
public class Sl1AcceptorSiteId implements java.io.Serializable {

	private Integer sl1AcceptorSiteId;
	...
	public Sl1AcceptorSiteId() {
	}

	public Sl1AcceptorSiteId(Integer sl1AcceptorSiteId, Integer featureId,
		...
		this.sl1AcceptorSiteId = sl1AcceptorSiteId;
	...
	public Integer getSl1AcceptorSiteId() {
		return this.sl1AcceptorSiteId;
	}

	public void setSl1AcceptorSiteId(Integer sl1AcceptorSiteId) {
		this.sl1AcceptorSiteId = sl1AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl1AcceptorSiteId))
			return false;
		Sl1AcceptorSiteId castOther = (Sl1AcceptorSiteId) other;

		return ((this.getSl1AcceptorSiteId() == castOther
				.getSl1AcceptorSiteId()) || (this.getSl1AcceptorSiteId() != null
				&& castOther.getSl1AcceptorSiteId() != null && this
				.getSl1AcceptorSiteId()
				.equals(castOther.getSl1AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl1AcceptorSiteId() == null ? 0 : this
						.getSl1AcceptorSiteId().hashCode());
		result = 37 * result
