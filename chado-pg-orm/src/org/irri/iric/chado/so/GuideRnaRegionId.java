...
/**
 * GuideRnaRegionId generated by hbm2java
 */
public class GuideRnaRegionId implements java.io.Serializable {

	private Integer guideRnaRegionId;
	...
	public GuideRnaRegionId() {
	}

	public GuideRnaRegionId(Integer guideRnaRegionId, Integer featureId,
		...
		this.guideRnaRegionId = guideRnaRegionId;
	...
	public Integer getGuideRnaRegionId() {
		return this.guideRnaRegionId;
	}

	public void setGuideRnaRegionId(Integer guideRnaRegionId) {
		this.guideRnaRegionId = guideRnaRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GuideRnaRegionId))
			return false;
		GuideRnaRegionId castOther = (GuideRnaRegionId) other;

		return ((this.getGuideRnaRegionId() == castOther.getGuideRnaRegionId()) || (this
				.getGuideRnaRegionId() != null
				&& castOther.getGuideRnaRegionId() != null && this
				.getGuideRnaRegionId().equals(castOther.getGuideRnaRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGuideRnaRegionId() == null ? 0 : this
						.getGuideRnaRegionId().hashCode());
		result = 37 * result
