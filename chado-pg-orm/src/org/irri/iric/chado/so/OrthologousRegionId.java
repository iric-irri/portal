...
/**
 * OrthologousRegionId generated by hbm2java
 */
public class OrthologousRegionId implements java.io.Serializable {

	private Integer orthologousRegionId;
	...
	public OrthologousRegionId() {
	}

	public OrthologousRegionId(Integer orthologousRegionId, Integer featureId,
		...
		this.orthologousRegionId = orthologousRegionId;
	...
	public Integer getOrthologousRegionId() {
		return this.orthologousRegionId;
	}

	public void setOrthologousRegionId(Integer orthologousRegionId) {
		this.orthologousRegionId = orthologousRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrthologousRegionId))
			return false;
		OrthologousRegionId castOther = (OrthologousRegionId) other;

		return ((this.getOrthologousRegionId() == castOther
				.getOrthologousRegionId()) || (this.getOrthologousRegionId() != null
				&& castOther.getOrthologousRegionId() != null && this
				.getOrthologousRegionId().equals(
						castOther.getOrthologousRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOrthologousRegionId() == null ? 0 : this
						.getOrthologousRegionId().hashCode());
		result = 37 * result
