...
/**
 * IronResponsiveElementId generated by hbm2java
 */
public class IronResponsiveElementId implements java.io.Serializable {

	private Integer ironResponsiveElementId;
	...
	public IronResponsiveElementId() {
	}

	public IronResponsiveElementId(Integer ironResponsiveElementId,
		...
		this.ironResponsiveElementId = ironResponsiveElementId;
	...
	public Integer getIronResponsiveElementId() {
		return this.ironResponsiveElementId;
	}

	public void setIronResponsiveElementId(Integer ironResponsiveElementId) {
		this.ironResponsiveElementId = ironResponsiveElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IronResponsiveElementId))
			return false;
		IronResponsiveElementId castOther = (IronResponsiveElementId) other;

		return ((this.getIronResponsiveElementId() == castOther
				.getIronResponsiveElementId()) || (this
				.getIronResponsiveElementId() != null
				&& castOther.getIronResponsiveElementId() != null && this
				.getIronResponsiveElementId().equals(
						castOther.getIronResponsiveElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIronResponsiveElementId() == null ? 0 : this
						.getIronResponsiveElementId().hashCode());
		result = 37 * result
