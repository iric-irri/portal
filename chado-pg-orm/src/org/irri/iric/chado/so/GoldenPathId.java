...
/**
 * GoldenPathId generated by hbm2java
 */
public class GoldenPathId implements java.io.Serializable {

	private Integer goldenPathId;
	...
	public GoldenPathId(Integer goldenPathId, Integer featureId,
		...
		this.goldenPathId = goldenPathId;
	...
	public Integer getGoldenPathId() {
		return this.goldenPathId;
	}

	public void setGoldenPathId(Integer goldenPathId) {
		this.goldenPathId = goldenPathId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GoldenPathId))
			return false;
		GoldenPathId castOther = (GoldenPathId) other;

		return ((this.getGoldenPathId() == castOther.getGoldenPathId()) || (this
				.getGoldenPathId() != null
				&& castOther.getGoldenPathId() != null && this
				.getGoldenPathId().equals(castOther.getGoldenPathId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGoldenPathId() == null ? 0 : this.getGoldenPathId()
						.hashCode());
		result = 37 * result
