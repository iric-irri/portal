...
/**
 * ClonedGenomicInsertId generated by hbm2java
 */
public class ClonedGenomicInsertId implements java.io.Serializable {

	private Integer clonedGenomicInsertId;
	...
	public ClonedGenomicInsertId() {
	}

	public ClonedGenomicInsertId(Integer clonedGenomicInsertId,
		...
		this.clonedGenomicInsertId = clonedGenomicInsertId;
	...
	public Integer getClonedGenomicInsertId() {
		return this.clonedGenomicInsertId;
	}

	public void setClonedGenomicInsertId(Integer clonedGenomicInsertId) {
		this.clonedGenomicInsertId = clonedGenomicInsertId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClonedGenomicInsertId))
			return false;
		ClonedGenomicInsertId castOther = (ClonedGenomicInsertId) other;

		return ((this.getClonedGenomicInsertId() == castOther
				.getClonedGenomicInsertId()) || (this
				.getClonedGenomicInsertId() != null
				&& castOther.getClonedGenomicInsertId() != null && this
				.getClonedGenomicInsertId().equals(
						castOther.getClonedGenomicInsertId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getClonedGenomicInsertId() == null ? 0 : this
						.getClonedGenomicInsertId().hashCode());
		result = 37 * result
