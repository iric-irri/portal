...
/**
 * HomingEndonucleaseBindingSiteId generated by hbm2java
 */
public class HomingEndonucleaseBindingSiteId implements java.io.Serializable {

	private Integer homingEndonucleaseBindingSiteId;
	...
	public HomingEndonucleaseBindingSiteId() {
	}

	public HomingEndonucleaseBindingSiteId(
			Integer homingEndonucleaseBindingSiteId, Integer featureId,
		...
		this.homingEndonucleaseBindingSiteId = homingEndonucleaseBindingSiteId;
	...
	public Integer getHomingEndonucleaseBindingSiteId() {
		return this.homingEndonucleaseBindingSiteId;
	}

	public void setHomingEndonucleaseBindingSiteId(
			Integer homingEndonucleaseBindingSiteId) {
		this.homingEndonucleaseBindingSiteId = homingEndonucleaseBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HomingEndonucleaseBindingSiteId))
			return false;
		HomingEndonucleaseBindingSiteId castOther = (HomingEndonucleaseBindingSiteId) other;

		return ((this.getHomingEndonucleaseBindingSiteId() == castOther
				.getHomingEndonucleaseBindingSiteId()) || (this
				.getHomingEndonucleaseBindingSiteId() != null
				&& castOther.getHomingEndonucleaseBindingSiteId() != null && this
				.getHomingEndonucleaseBindingSiteId().equals(
						castOther.getHomingEndonucleaseBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHomingEndonucleaseBindingSiteId() == null ? 0 : this
						.getHomingEndonucleaseBindingSiteId().hashCode());
		result = 37 * result
