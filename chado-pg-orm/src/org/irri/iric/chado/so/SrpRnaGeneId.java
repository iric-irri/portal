...
/**
 * SrpRnaGeneId generated by hbm2java
 */
public class SrpRnaGeneId implements java.io.Serializable {

	private Integer srpRnaGeneId;
	...
	public SrpRnaGeneId(Integer srpRnaGeneId, Integer featureId,
		...
		this.srpRnaGeneId = srpRnaGeneId;
	...
	public Integer getSrpRnaGeneId() {
		return this.srpRnaGeneId;
	}

	public void setSrpRnaGeneId(Integer srpRnaGeneId) {
		this.srpRnaGeneId = srpRnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SrpRnaGeneId))
			return false;
		SrpRnaGeneId castOther = (SrpRnaGeneId) other;

		return ((this.getSrpRnaGeneId() == castOther.getSrpRnaGeneId()) || (this
				.getSrpRnaGeneId() != null
				&& castOther.getSrpRnaGeneId() != null && this
				.getSrpRnaGeneId().equals(castOther.getSrpRnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSrpRnaGeneId() == null ? 0 : this.getSrpRnaGeneId()
						.hashCode());
		result = 37 * result
