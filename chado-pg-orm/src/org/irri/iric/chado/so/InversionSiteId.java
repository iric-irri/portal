...
/**
 * InversionSiteId generated by hbm2java
 */
public class InversionSiteId implements java.io.Serializable {

	private Integer inversionSiteId;
	...
	public InversionSiteId() {
	}

	public InversionSiteId(Integer inversionSiteId, Integer featureId,
		...
		this.inversionSiteId = inversionSiteId;
	...
	public Integer getInversionSiteId() {
		return this.inversionSiteId;
	}

	public void setInversionSiteId(Integer inversionSiteId) {
		this.inversionSiteId = inversionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionSiteId))
			return false;
		InversionSiteId castOther = (InversionSiteId) other;

		return ((this.getInversionSiteId() == castOther.getInversionSiteId()) || (this
				.getInversionSiteId() != null
				&& castOther.getInversionSiteId() != null && this
				.getInversionSiteId().equals(castOther.getInversionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionSiteId() == null ? 0 : this.getInversionSiteId()
						.hashCode());
		result = 37 * result
