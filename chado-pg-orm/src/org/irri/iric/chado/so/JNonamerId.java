...
/**
 * JNonamerId generated by hbm2java
 */
public class JNonamerId implements java.io.Serializable {

	private Integer JNonamerId;
	...
	public JNonamerId(Integer JNonamerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getJNonamerId() {
		return this.JNonamerId;
	}

	public void setJNonamerId(Integer JNonamerId) {
		this.JNonamerId = JNonamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JNonamerId))
			return false;
		JNonamerId castOther = (JNonamerId) other;

		return ((this.getJNonamerId() == castOther.getJNonamerId()) || (this
				.getJNonamerId() != null && castOther.getJNonamerId() != null && this
				.getJNonamerId().equals(castOther.getJNonamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJNonamerId() == null ? 0 : this.getJNonamerId()
						.hashCode());
		result = 37 * result
