...
/**
 * CdsSupportedByDomainMatchDataId generated by hbm2java
 */
public class CdsSupportedByDomainMatchDataId implements java.io.Serializable {

	private Integer cdsSupportedByDomainMatchDataId;
	...
	public CdsSupportedByDomainMatchDataId() {
	}

	public CdsSupportedByDomainMatchDataId(
			Integer cdsSupportedByDomainMatchDataId, Integer featureId,
		...
		this.cdsSupportedByDomainMatchDataId = cdsSupportedByDomainMatchDataId;
	...
	public Integer getCdsSupportedByDomainMatchDataId() {
		return this.cdsSupportedByDomainMatchDataId;
	}

	public void setCdsSupportedByDomainMatchDataId(
			Integer cdsSupportedByDomainMatchDataId) {
		this.cdsSupportedByDomainMatchDataId = cdsSupportedByDomainMatchDataId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsSupportedByDomainMatchDataId))
			return false;
		CdsSupportedByDomainMatchDataId castOther = (CdsSupportedByDomainMatchDataId) other;

		return ((this.getCdsSupportedByDomainMatchDataId() == castOther
				.getCdsSupportedByDomainMatchDataId()) || (this
				.getCdsSupportedByDomainMatchDataId() != null
				&& castOther.getCdsSupportedByDomainMatchDataId() != null && this
				.getCdsSupportedByDomainMatchDataId().equals(
						castOther.getCdsSupportedByDomainMatchDataId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsSupportedByDomainMatchDataId() == null ? 0 : this
						.getCdsSupportedByDomainMatchDataId().hashCode());
		result = 37 * result
