...
/**
 * GammaTurnId generated by hbm2java
 */
public class GammaTurnId implements java.io.Serializable {

	private Integer gammaTurnId;
	...
	public GammaTurnId(Integer gammaTurnId, Integer featureId,
	...
	public Integer getGammaTurnId() {
		return this.gammaTurnId;
	}

	public void setGammaTurnId(Integer gammaTurnId) {
		this.gammaTurnId = gammaTurnId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GammaTurnId))
			return false;
		GammaTurnId castOther = (GammaTurnId) other;

		return ((this.getGammaTurnId() == castOther.getGammaTurnId()) || (this
				.getGammaTurnId() != null && castOther.getGammaTurnId() != null && this
				.getGammaTurnId().equals(castOther.getGammaTurnId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGammaTurnId() == null ? 0 : this.getGammaTurnId()
						.hashCode());
		result = 37 * result
