...
/**
 * H3k4MonomethylationSiteId generated by hbm2java
 */
public class H3k4MonomethylationSiteId implements java.io.Serializable {

	private Integer h3k4MonomethylationSiteId;
	...
	public H3k4MonomethylationSiteId() {
	}

	public H3k4MonomethylationSiteId(Integer h3k4MonomethylationSiteId,
		...
		this.h3k4MonomethylationSiteId = h3k4MonomethylationSiteId;
	...
	public Integer getH3k4MonomethylationSiteId() {
		return this.h3k4MonomethylationSiteId;
	}

	public void setH3k4MonomethylationSiteId(Integer h3k4MonomethylationSiteId) {
		this.h3k4MonomethylationSiteId = h3k4MonomethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k4MonomethylationSiteId))
			return false;
		H3k4MonomethylationSiteId castOther = (H3k4MonomethylationSiteId) other;

		return ((this.getH3k4MonomethylationSiteId() == castOther
				.getH3k4MonomethylationSiteId()) || (this
				.getH3k4MonomethylationSiteId() != null
				&& castOther.getH3k4MonomethylationSiteId() != null && this
				.getH3k4MonomethylationSiteId().equals(
						castOther.getH3k4MonomethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k4MonomethylationSiteId() == null ? 0 : this
						.getH3k4MonomethylationSiteId().hashCode());
		result = 37 * result
