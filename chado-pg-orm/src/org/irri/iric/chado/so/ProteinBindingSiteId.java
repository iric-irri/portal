...
/**
 * ProteinBindingSiteId generated by hbm2java
 */
public class ProteinBindingSiteId implements java.io.Serializable {

	private Integer proteinBindingSiteId;
	...
	public ProteinBindingSiteId() {
	}

	public ProteinBindingSiteId(Integer proteinBindingSiteId,
		...
		this.proteinBindingSiteId = proteinBindingSiteId;
	...
	public Integer getProteinBindingSiteId() {
		return this.proteinBindingSiteId;
	}

	public void setProteinBindingSiteId(Integer proteinBindingSiteId) {
		this.proteinBindingSiteId = proteinBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinBindingSiteId))
			return false;
		ProteinBindingSiteId castOther = (ProteinBindingSiteId) other;

		return ((this.getProteinBindingSiteId() == castOther
				.getProteinBindingSiteId()) || (this.getProteinBindingSiteId() != null
				&& castOther.getProteinBindingSiteId() != null && this
				.getProteinBindingSiteId().equals(
						castOther.getProteinBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinBindingSiteId() == null ? 0 : this
						.getProteinBindingSiteId().hashCode());
		result = 37 * result
