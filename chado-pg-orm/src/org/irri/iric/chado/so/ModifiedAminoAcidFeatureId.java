...
/**
 * ModifiedAminoAcidFeatureId generated by hbm2java
 */
public class ModifiedAminoAcidFeatureId implements java.io.Serializable {

	private Integer modifiedAminoAcidFeatureId;
	...
	public ModifiedAminoAcidFeatureId() {
	}

	public ModifiedAminoAcidFeatureId(Integer modifiedAminoAcidFeatureId,
		...
		this.modifiedAminoAcidFeatureId = modifiedAminoAcidFeatureId;
	...
	public Integer getModifiedAminoAcidFeatureId() {
		return this.modifiedAminoAcidFeatureId;
	}

	public void setModifiedAminoAcidFeatureId(Integer modifiedAminoAcidFeatureId) {
		this.modifiedAminoAcidFeatureId = modifiedAminoAcidFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedAminoAcidFeatureId))
			return false;
		ModifiedAminoAcidFeatureId castOther = (ModifiedAminoAcidFeatureId) other;

		return ((this.getModifiedAminoAcidFeatureId() == castOther
				.getModifiedAminoAcidFeatureId()) || (this
				.getModifiedAminoAcidFeatureId() != null
				&& castOther.getModifiedAminoAcidFeatureId() != null && this
				.getModifiedAminoAcidFeatureId().equals(
						castOther.getModifiedAminoAcidFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedAminoAcidFeatureId() == null ? 0 : this
						.getModifiedAminoAcidFeatureId().hashCode());
		result = 37 * result
