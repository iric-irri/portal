...
/**
 * ProviralLocationId generated by hbm2java
 */
public class ProviralLocationId implements java.io.Serializable {

	private Integer proviralLocationId;
	...
	public ProviralLocationId() {
	}

	public ProviralLocationId(Integer proviralLocationId, Integer featureId,
		...
		this.proviralLocationId = proviralLocationId;
	...
	public Integer getProviralLocationId() {
		return this.proviralLocationId;
	}

	public void setProviralLocationId(Integer proviralLocationId) {
		this.proviralLocationId = proviralLocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProviralLocationId))
			return false;
		ProviralLocationId castOther = (ProviralLocationId) other;

		return ((this.getProviralLocationId() == castOther
				.getProviralLocationId()) || (this.getProviralLocationId() != null
				&& castOther.getProviralLocationId() != null && this
				.getProviralLocationId().equals(
						castOther.getProviralLocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProviralLocationId() == null ? 0 : this
						.getProviralLocationId().hashCode());
		result = 37 * result
