...
/**
 * PositivelyAutoregulatedGeneId generated by hbm2java
 */
public class PositivelyAutoregulatedGeneId implements java.io.Serializable {

	private Integer positivelyAutoregulatedGeneId;
	...
	public PositivelyAutoregulatedGeneId() {
	}

	public PositivelyAutoregulatedGeneId(Integer positivelyAutoregulatedGeneId,
		...
		this.positivelyAutoregulatedGeneId = positivelyAutoregulatedGeneId;
	...
	public Integer getPositivelyAutoregulatedGeneId() {
		return this.positivelyAutoregulatedGeneId;
	}

	public void setPositivelyAutoregulatedGeneId(
			Integer positivelyAutoregulatedGeneId) {
		this.positivelyAutoregulatedGeneId = positivelyAutoregulatedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PositivelyAutoregulatedGeneId))
			return false;
		PositivelyAutoregulatedGeneId castOther = (PositivelyAutoregulatedGeneId) other;

		return ((this.getPositivelyAutoregulatedGeneId() == castOther
				.getPositivelyAutoregulatedGeneId()) || (this
				.getPositivelyAutoregulatedGeneId() != null
				&& castOther.getPositivelyAutoregulatedGeneId() != null && this
				.getPositivelyAutoregulatedGeneId().equals(
						castOther.getPositivelyAutoregulatedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPositivelyAutoregulatedGeneId() == null ? 0 : this
						.getPositivelyAutoregulatedGeneId().hashCode());
		result = 37 * result
