...
/**
 * PolypeptideTurnMotifId generated by hbm2java
 */
public class PolypeptideTurnMotifId implements java.io.Serializable {

	private Integer polypeptideTurnMotifId;
	...
	public PolypeptideTurnMotifId() {
	}

	public PolypeptideTurnMotifId(Integer polypeptideTurnMotifId,
		...
		this.polypeptideTurnMotifId = polypeptideTurnMotifId;
	...
	public Integer getPolypeptideTurnMotifId() {
		return this.polypeptideTurnMotifId;
	}

	public void setPolypeptideTurnMotifId(Integer polypeptideTurnMotifId) {
		this.polypeptideTurnMotifId = polypeptideTurnMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideTurnMotifId))
			return false;
		PolypeptideTurnMotifId castOther = (PolypeptideTurnMotifId) other;

		return ((this.getPolypeptideTurnMotifId() == castOther
				.getPolypeptideTurnMotifId()) || (this
				.getPolypeptideTurnMotifId() != null
				&& castOther.getPolypeptideTurnMotifId() != null && this
				.getPolypeptideTurnMotifId().equals(
						castOther.getPolypeptideTurnMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideTurnMotifId() == null ? 0 : this
						.getPolypeptideTurnMotifId().hashCode());
		result = 37 * result
