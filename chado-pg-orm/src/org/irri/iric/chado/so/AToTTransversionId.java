...
/**
 * AToTTransversionId generated by hbm2java
 */
public class AToTTransversionId implements java.io.Serializable {

	private Integer AToTTransversionId;
	...
	public AToTTransversionId() {
	}

	public AToTTransversionId(Integer AToTTransversionId, Integer featureId,
		...
		this.AToTTransversionId = AToTTransversionId;
	...
	public Integer getAToTTransversionId() {
		return this.AToTTransversionId;
	}

	public void setAToTTransversionId(Integer AToTTransversionId) {
		this.AToTTransversionId = AToTTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AToTTransversionId))
			return false;
		AToTTransversionId castOther = (AToTTransversionId) other;

		return ((this.getAToTTransversionId() == castOther
				.getAToTTransversionId()) || (this.getAToTTransversionId() != null
				&& castOther.getAToTTransversionId() != null && this
				.getAToTTransversionId().equals(
						castOther.getAToTTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAToTTransversionId() == null ? 0 : this
						.getAToTTransversionId().hashCode());
		result = 37 * result
