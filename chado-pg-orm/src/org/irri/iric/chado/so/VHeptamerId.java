...
/**
 * VHeptamerId generated by hbm2java
 */
public class VHeptamerId implements java.io.Serializable {

	private Integer VHeptamerId;
	...
	public VHeptamerId(Integer VHeptamerId, Integer featureId,
	...
	public Integer getVHeptamerId() {
		return this.VHeptamerId;
	}

	public void setVHeptamerId(Integer VHeptamerId) {
		this.VHeptamerId = VHeptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VHeptamerId))
			return false;
		VHeptamerId castOther = (VHeptamerId) other;

		return ((this.getVHeptamerId() == castOther.getVHeptamerId()) || (this
				.getVHeptamerId() != null && castOther.getVHeptamerId() != null && this
				.getVHeptamerId().equals(castOther.getVHeptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVHeptamerId() == null ? 0 : this.getVHeptamerId()
						.hashCode());
		result = 37 * result
