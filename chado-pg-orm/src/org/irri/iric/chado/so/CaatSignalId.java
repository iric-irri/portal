...
/**
 * CaatSignalId generated by hbm2java
 */
public class CaatSignalId implements java.io.Serializable {

	private Integer caatSignalId;
	...
	public CaatSignalId(Integer caatSignalId, Integer featureId,
		...
		this.caatSignalId = caatSignalId;
	...
	public Integer getCaatSignalId() {
		return this.caatSignalId;
	}

	public void setCaatSignalId(Integer caatSignalId) {
		this.caatSignalId = caatSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CaatSignalId))
			return false;
		CaatSignalId castOther = (CaatSignalId) other;

		return ((this.getCaatSignalId() == castOther.getCaatSignalId()) || (this
				.getCaatSignalId() != null
				&& castOther.getCaatSignalId() != null && this
				.getCaatSignalId().equals(castOther.getCaatSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCaatSignalId() == null ? 0 : this.getCaatSignalId()
						.hashCode());
		result = 37 * result
