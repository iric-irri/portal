...
/**
 * CodonVariantId generated by hbm2java
 */
public class CodonVariantId implements java.io.Serializable {

	private Integer codonVariantId;
	...
	public CodonVariantId() {
	}

	public CodonVariantId(Integer codonVariantId, Integer featureId,
		...
		this.codonVariantId = codonVariantId;
	...
	public Integer getCodonVariantId() {
		return this.codonVariantId;
	}

	public void setCodonVariantId(Integer codonVariantId) {
		this.codonVariantId = codonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodonVariantId))
			return false;
		CodonVariantId castOther = (CodonVariantId) other;

		return ((this.getCodonVariantId() == castOther.getCodonVariantId()) || (this
				.getCodonVariantId() != null
				&& castOther.getCodonVariantId() != null && this
				.getCodonVariantId().equals(castOther.getCodonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodonVariantId() == null ? 0 : this.getCodonVariantId()
						.hashCode());
		result = 37 * result
