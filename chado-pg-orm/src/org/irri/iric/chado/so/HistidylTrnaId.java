...
/**
 * HistidylTrnaId generated by hbm2java
 */
public class HistidylTrnaId implements java.io.Serializable {

	private Integer histidylTrnaId;
	...
	public HistidylTrnaId() {
	}

	public HistidylTrnaId(Integer histidylTrnaId, Integer featureId,
		...
		this.histidylTrnaId = histidylTrnaId;
	...
	public Integer getHistidylTrnaId() {
		return this.histidylTrnaId;
	}

	public void setHistidylTrnaId(Integer histidylTrnaId) {
		this.histidylTrnaId = histidylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistidylTrnaId))
			return false;
		HistidylTrnaId castOther = (HistidylTrnaId) other;

		return ((this.getHistidylTrnaId() == castOther.getHistidylTrnaId()) || (this
				.getHistidylTrnaId() != null
				&& castOther.getHistidylTrnaId() != null && this
				.getHistidylTrnaId().equals(castOther.getHistidylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistidylTrnaId() == null ? 0 : this.getHistidylTrnaId()
						.hashCode());
		result = 37 * result
