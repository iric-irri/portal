...
/**
 * PhageSequenceId generated by hbm2java
 */
public class PhageSequenceId implements java.io.Serializable {

	private Integer phageSequenceId;
	...
	public PhageSequenceId() {
	}

	public PhageSequenceId(Integer phageSequenceId, Integer featureId,
		...
		this.phageSequenceId = phageSequenceId;
	...
	public Integer getPhageSequenceId() {
		return this.phageSequenceId;
	}

	public void setPhageSequenceId(Integer phageSequenceId) {
		this.phageSequenceId = phageSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhageSequenceId))
			return false;
		PhageSequenceId castOther = (PhageSequenceId) other;

		return ((this.getPhageSequenceId() == castOther.getPhageSequenceId()) || (this
				.getPhageSequenceId() != null
				&& castOther.getPhageSequenceId() != null && this
				.getPhageSequenceId().equals(castOther.getPhageSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPhageSequenceId() == null ? 0 : this.getPhageSequenceId()
						.hashCode());
		result = 37 * result
