...
/**
 * EngineeredForeignTransposableElementId generated by hbm2java
 */
public class EngineeredForeignTransposableElementId implements
		java.io.Serializable {

	private Integer engineeredForeignTransposableElementId;
	...
	public EngineeredForeignTransposableElementId() {
	}

	public EngineeredForeignTransposableElementId(
			Integer engineeredForeignTransposableElementId, Integer featureId,
		...
		this.engineeredForeignTransposableElementId = engineeredForeignTransposableElementId;
	...
	public Integer getEngineeredForeignTransposableElementId() {
		return this.engineeredForeignTransposableElementId;
	}

	public void setEngineeredForeignTransposableElementId(
			Integer engineeredForeignTransposableElementId) {
		this.engineeredForeignTransposableElementId = engineeredForeignTransposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredForeignTransposableElementId))
			return false;
		EngineeredForeignTransposableElementId castOther = (EngineeredForeignTransposableElementId) other;

		return ((this.getEngineeredForeignTransposableElementId() == castOther
				.getEngineeredForeignTransposableElementId()) || (this
				.getEngineeredForeignTransposableElementId() != null
				&& castOther.getEngineeredForeignTransposableElementId() != null && this
				.getEngineeredForeignTransposableElementId().equals(
						castOther.getEngineeredForeignTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredForeignTransposableElementId() == null ? 0
						: this.getEngineeredForeignTransposableElementId()
								.hashCode());
		result = 37 * result
