...
/**
 * MembranePeptideLoopId generated by hbm2java
 */
public class MembranePeptideLoopId implements java.io.Serializable {

	private Integer membranePeptideLoopId;
	...
	public MembranePeptideLoopId() {
	}

	public MembranePeptideLoopId(Integer membranePeptideLoopId,
		...
		this.membranePeptideLoopId = membranePeptideLoopId;
	...
	public Integer getMembranePeptideLoopId() {
		return this.membranePeptideLoopId;
	}

	public void setMembranePeptideLoopId(Integer membranePeptideLoopId) {
		this.membranePeptideLoopId = membranePeptideLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MembranePeptideLoopId))
			return false;
		MembranePeptideLoopId castOther = (MembranePeptideLoopId) other;

		return ((this.getMembranePeptideLoopId() == castOther
				.getMembranePeptideLoopId()) || (this
				.getMembranePeptideLoopId() != null
				&& castOther.getMembranePeptideLoopId() != null && this
				.getMembranePeptideLoopId().equals(
						castOther.getMembranePeptideLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMembranePeptideLoopId() == null ? 0 : this
						.getMembranePeptideLoopId().hashCode());
		result = 37 * result
