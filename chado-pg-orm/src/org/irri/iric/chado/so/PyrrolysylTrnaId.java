...
/**
 * PyrrolysylTrnaId generated by hbm2java
 */
public class PyrrolysylTrnaId implements java.io.Serializable {

	private Integer pyrrolysylTrnaId;
	...
	public PyrrolysylTrnaId() {
	}

	public PyrrolysylTrnaId(Integer pyrrolysylTrnaId, Integer featureId,
		...
		this.pyrrolysylTrnaId = pyrrolysylTrnaId;
	...
	public Integer getPyrrolysylTrnaId() {
		return this.pyrrolysylTrnaId;
	}

	public void setPyrrolysylTrnaId(Integer pyrrolysylTrnaId) {
		this.pyrrolysylTrnaId = pyrrolysylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrrolysylTrnaId))
			return false;
		PyrrolysylTrnaId castOther = (PyrrolysylTrnaId) other;

		return ((this.getPyrrolysylTrnaId() == castOther.getPyrrolysylTrnaId()) || (this
				.getPyrrolysylTrnaId() != null
				&& castOther.getPyrrolysylTrnaId() != null && this
				.getPyrrolysylTrnaId().equals(castOther.getPyrrolysylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrrolysylTrnaId() == null ? 0 : this
						.getPyrrolysylTrnaId().hashCode());
		result = 37 * result
