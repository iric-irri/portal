...
/**
 * LossOfHeterozygosityId generated by hbm2java
 */
public class LossOfHeterozygosityId implements java.io.Serializable {

	private Integer lossOfHeterozygosityId;
	...
	public LossOfHeterozygosityId() {
	}

	public LossOfHeterozygosityId(Integer lossOfHeterozygosityId,
		...
		this.lossOfHeterozygosityId = lossOfHeterozygosityId;
	...
	public Integer getLossOfHeterozygosityId() {
		return this.lossOfHeterozygosityId;
	}

	public void setLossOfHeterozygosityId(Integer lossOfHeterozygosityId) {
		this.lossOfHeterozygosityId = lossOfHeterozygosityId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LossOfHeterozygosityId))
			return false;
		LossOfHeterozygosityId castOther = (LossOfHeterozygosityId) other;

		return ((this.getLossOfHeterozygosityId() == castOther
				.getLossOfHeterozygosityId()) || (this
				.getLossOfHeterozygosityId() != null
				&& castOther.getLossOfHeterozygosityId() != null && this
				.getLossOfHeterozygosityId().equals(
						castOther.getLossOfHeterozygosityId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLossOfHeterozygosityId() == null ? 0 : this
						.getLossOfHeterozygosityId().hashCode());
		result = 37 * result
