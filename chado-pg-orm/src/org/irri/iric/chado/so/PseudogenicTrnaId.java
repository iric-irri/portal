...
/**
 * PseudogenicTrnaId generated by hbm2java
 */
public class PseudogenicTrnaId implements java.io.Serializable {

	private Integer pseudogenicTrnaId;
	...
	public PseudogenicTrnaId() {
	}

	public PseudogenicTrnaId(Integer pseudogenicTrnaId, Integer featureId,
		...
		this.pseudogenicTrnaId = pseudogenicTrnaId;
	...
	public Integer getPseudogenicTrnaId() {
		return this.pseudogenicTrnaId;
	}

	public void setPseudogenicTrnaId(Integer pseudogenicTrnaId) {
		this.pseudogenicTrnaId = pseudogenicTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicTrnaId))
			return false;
		PseudogenicTrnaId castOther = (PseudogenicTrnaId) other;

		return ((this.getPseudogenicTrnaId() == castOther
				.getPseudogenicTrnaId()) || (this.getPseudogenicTrnaId() != null
				&& castOther.getPseudogenicTrnaId() != null && this
				.getPseudogenicTrnaId()
				.equals(castOther.getPseudogenicTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicTrnaId() == null ? 0 : this
						.getPseudogenicTrnaId().hashCode());
		result = 37 * result
