...
/**
 * FrtFlankedId generated by hbm2java
 */
public class FrtFlankedId implements java.io.Serializable {

	private Integer frtFlankedId;
	...
	public FrtFlankedId(Integer frtFlankedId, Integer featureId,
		...
		this.frtFlankedId = frtFlankedId;
	...
	public Integer getFrtFlankedId() {
		return this.frtFlankedId;
	}

	public void setFrtFlankedId(Integer frtFlankedId) {
		this.frtFlankedId = frtFlankedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FrtFlankedId))
			return false;
		FrtFlankedId castOther = (FrtFlankedId) other;

		return ((this.getFrtFlankedId() == castOther.getFrtFlankedId()) || (this
				.getFrtFlankedId() != null
				&& castOther.getFrtFlankedId() != null && this
				.getFrtFlankedId().equals(castOther.getFrtFlankedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFrtFlankedId() == null ? 0 : this.getFrtFlankedId()
						.hashCode());
		result = 37 * result
