...
/**
 * StrandAttributeId generated by hbm2java
 */
public class StrandAttributeId implements java.io.Serializable {

	private Integer strandAttributeId;
	...
	public StrandAttributeId() {
	}

	public StrandAttributeId(Integer strandAttributeId, Integer featureId,
		...
		this.strandAttributeId = strandAttributeId;
	...
	public Integer getStrandAttributeId() {
		return this.strandAttributeId;
	}

	public void setStrandAttributeId(Integer strandAttributeId) {
		this.strandAttributeId = strandAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StrandAttributeId))
			return false;
		StrandAttributeId castOther = (StrandAttributeId) other;

		return ((this.getStrandAttributeId() == castOther
				.getStrandAttributeId()) || (this.getStrandAttributeId() != null
				&& castOther.getStrandAttributeId() != null && this
				.getStrandAttributeId()
				.equals(castOther.getStrandAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStrandAttributeId() == null ? 0 : this
						.getStrandAttributeId().hashCode());
		result = 37 * result
