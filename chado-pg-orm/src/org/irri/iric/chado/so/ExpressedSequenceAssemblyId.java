...
/**
 * ExpressedSequenceAssemblyId generated by hbm2java
 */
public class ExpressedSequenceAssemblyId implements java.io.Serializable {

	private Integer expressedSequenceAssemblyId;
	...
	public ExpressedSequenceAssemblyId() {
	}

	public ExpressedSequenceAssemblyId(Integer expressedSequenceAssemblyId,
		...
		this.expressedSequenceAssemblyId = expressedSequenceAssemblyId;
	...
	public Integer getExpressedSequenceAssemblyId() {
		return this.expressedSequenceAssemblyId;
	}

	public void setExpressedSequenceAssemblyId(
			Integer expressedSequenceAssemblyId) {
		this.expressedSequenceAssemblyId = expressedSequenceAssemblyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExpressedSequenceAssemblyId))
			return false;
		ExpressedSequenceAssemblyId castOther = (ExpressedSequenceAssemblyId) other;

		return ((this.getExpressedSequenceAssemblyId() == castOther
				.getExpressedSequenceAssemblyId()) || (this
				.getExpressedSequenceAssemblyId() != null
				&& castOther.getExpressedSequenceAssemblyId() != null && this
				.getExpressedSequenceAssemblyId().equals(
						castOther.getExpressedSequenceAssemblyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExpressedSequenceAssemblyId() == null ? 0 : this
						.getExpressedSequenceAssemblyId().hashCode());
		result = 37 * result
