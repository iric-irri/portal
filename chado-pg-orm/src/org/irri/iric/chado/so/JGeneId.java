...
/**
 * JGeneId generated by hbm2java
 */
public class JGeneId implements java.io.Serializable {

	private Integer JGeneId;
	...
	public JGeneId(Integer JGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getJGeneId() {
		return this.JGeneId;
	}

	public void setJGeneId(Integer JGeneId) {
		this.JGeneId = JGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JGeneId))
			return false;
		JGeneId castOther = (JGeneId) other;

		return ((this.getJGeneId() == castOther.getJGeneId()) || (this
				.getJGeneId() != null && castOther.getJGeneId() != null && this
				.getJGeneId().equals(castOther.getJGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getJGeneId() == null ? 0 : this.getJGeneId().hashCode());
		result = 37 * result
