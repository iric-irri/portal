...
/**
 * DihydrouridineId generated by hbm2java
 */
public class DihydrouridineId implements java.io.Serializable {

	private Integer dihydrouridineId;
	...
	public DihydrouridineId() {
	}

	public DihydrouridineId(Integer dihydrouridineId, Integer featureId,
		...
		this.dihydrouridineId = dihydrouridineId;
	...
	public Integer getDihydrouridineId() {
		return this.dihydrouridineId;
	}

	public void setDihydrouridineId(Integer dihydrouridineId) {
		this.dihydrouridineId = dihydrouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DihydrouridineId))
			return false;
		DihydrouridineId castOther = (DihydrouridineId) other;

		return ((this.getDihydrouridineId() == castOther.getDihydrouridineId()) || (this
				.getDihydrouridineId() != null
				&& castOther.getDihydrouridineId() != null && this
				.getDihydrouridineId().equals(castOther.getDihydrouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDihydrouridineId() == null ? 0 : this
						.getDihydrouridineId().hashCode());
		result = 37 * result
