...
/**
 * ReplicationRegulatoryRegionId generated by hbm2java
 */
public class ReplicationRegulatoryRegionId implements java.io.Serializable {

	private Integer replicationRegulatoryRegionId;
	...
	public ReplicationRegulatoryRegionId() {
	}

	public ReplicationRegulatoryRegionId(Integer replicationRegulatoryRegionId,
		...
		this.replicationRegulatoryRegionId = replicationRegulatoryRegionId;
	...
	public Integer getReplicationRegulatoryRegionId() {
		return this.replicationRegulatoryRegionId;
	}

	public void setReplicationRegulatoryRegionId(
			Integer replicationRegulatoryRegionId) {
		this.replicationRegulatoryRegionId = replicationRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReplicationRegulatoryRegionId))
			return false;
		ReplicationRegulatoryRegionId castOther = (ReplicationRegulatoryRegionId) other;

		return ((this.getReplicationRegulatoryRegionId() == castOther
				.getReplicationRegulatoryRegionId()) || (this
				.getReplicationRegulatoryRegionId() != null
				&& castOther.getReplicationRegulatoryRegionId() != null && this
				.getReplicationRegulatoryRegionId().equals(
						castOther.getReplicationRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReplicationRegulatoryRegionId() == null ? 0 : this
						.getReplicationRegulatoryRegionId().hashCode());
		result = 37 * result
