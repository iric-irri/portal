...
/**
 * HoogsteenBasePairId generated by hbm2java
 */
public class HoogsteenBasePairId implements java.io.Serializable {

	private Integer hoogsteenBasePairId;
	...
	public HoogsteenBasePairId() {
	}

	public HoogsteenBasePairId(Integer hoogsteenBasePairId, Integer featureId,
		...
		this.hoogsteenBasePairId = hoogsteenBasePairId;
	...
	public Integer getHoogsteenBasePairId() {
		return this.hoogsteenBasePairId;
	}

	public void setHoogsteenBasePairId(Integer hoogsteenBasePairId) {
		this.hoogsteenBasePairId = hoogsteenBasePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HoogsteenBasePairId))
			return false;
		HoogsteenBasePairId castOther = (HoogsteenBasePairId) other;

		return ((this.getHoogsteenBasePairId() == castOther
				.getHoogsteenBasePairId()) || (this.getHoogsteenBasePairId() != null
				&& castOther.getHoogsteenBasePairId() != null && this
				.getHoogsteenBasePairId().equals(
						castOther.getHoogsteenBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHoogsteenBasePairId() == null ? 0 : this
						.getHoogsteenBasePairId().hashCode());
		result = 37 * result
