...
/**
 * TransposableElementFlankingRegionId generated by hbm2java
 */
public class TransposableElementFlankingRegionId implements
		java.io.Serializable {

	private Integer transposableElementFlankingRegionId;
	...
	public TransposableElementFlankingRegionId() {
	}

	public TransposableElementFlankingRegionId(
			Integer transposableElementFlankingRegionId, Integer featureId,
		...
		this.transposableElementFlankingRegionId = transposableElementFlankingRegionId;
	...
	public Integer getTransposableElementFlankingRegionId() {
		return this.transposableElementFlankingRegionId;
	}

	public void setTransposableElementFlankingRegionId(
			Integer transposableElementFlankingRegionId) {
		this.transposableElementFlankingRegionId = transposableElementFlankingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransposableElementFlankingRegionId))
			return false;
		TransposableElementFlankingRegionId castOther = (TransposableElementFlankingRegionId) other;

		return ((this.getTransposableElementFlankingRegionId() == castOther
				.getTransposableElementFlankingRegionId()) || (this
				.getTransposableElementFlankingRegionId() != null
				&& castOther.getTransposableElementFlankingRegionId() != null && this
				.getTransposableElementFlankingRegionId().equals(
						castOther.getTransposableElementFlankingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransposableElementFlankingRegionId() == null ? 0 : this
						.getTransposableElementFlankingRegionId().hashCode());
		result = 37 * result
