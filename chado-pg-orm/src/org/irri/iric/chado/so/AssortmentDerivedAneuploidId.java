...
/**
 * AssortmentDerivedAneuploidId generated by hbm2java
 */
public class AssortmentDerivedAneuploidId implements java.io.Serializable {

	private Integer assortmentDerivedAneuploidId;
	...
	public AssortmentDerivedAneuploidId() {
	}

	public AssortmentDerivedAneuploidId(Integer assortmentDerivedAneuploidId,
		...
		this.assortmentDerivedAneuploidId = assortmentDerivedAneuploidId;
	...
	public Integer getAssortmentDerivedAneuploidId() {
		return this.assortmentDerivedAneuploidId;
	}

	public void setAssortmentDerivedAneuploidId(
			Integer assortmentDerivedAneuploidId) {
		this.assortmentDerivedAneuploidId = assortmentDerivedAneuploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssortmentDerivedAneuploidId))
			return false;
		AssortmentDerivedAneuploidId castOther = (AssortmentDerivedAneuploidId) other;

		return ((this.getAssortmentDerivedAneuploidId() == castOther
				.getAssortmentDerivedAneuploidId()) || (this
				.getAssortmentDerivedAneuploidId() != null
				&& castOther.getAssortmentDerivedAneuploidId() != null && this
				.getAssortmentDerivedAneuploidId().equals(
						castOther.getAssortmentDerivedAneuploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssortmentDerivedAneuploidId() == null ? 0 : this
						.getAssortmentDerivedAneuploidId().hashCode());
		result = 37 * result
