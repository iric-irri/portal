...
/**
 * ModifiedLArginineId generated by hbm2java
 */
public class ModifiedLArginineId implements java.io.Serializable {

	private Integer modifiedLArginineId;
	...
	public ModifiedLArginineId() {
	}

	public ModifiedLArginineId(Integer modifiedLArginineId, Integer featureId,
		...
		this.modifiedLArginineId = modifiedLArginineId;
	...
	public Integer getModifiedLArginineId() {
		return this.modifiedLArginineId;
	}

	public void setModifiedLArginineId(Integer modifiedLArginineId) {
		this.modifiedLArginineId = modifiedLArginineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLArginineId))
			return false;
		ModifiedLArginineId castOther = (ModifiedLArginineId) other;

		return ((this.getModifiedLArginineId() == castOther
				.getModifiedLArginineId()) || (this.getModifiedLArginineId() != null
				&& castOther.getModifiedLArginineId() != null && this
				.getModifiedLArginineId().equals(
						castOther.getModifiedLArginineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLArginineId() == null ? 0 : this
						.getModifiedLArginineId().hashCode());
		result = 37 * result
