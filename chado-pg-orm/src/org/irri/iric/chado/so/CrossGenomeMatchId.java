...
/**
 * CrossGenomeMatchId generated by hbm2java
 */
public class CrossGenomeMatchId implements java.io.Serializable {

	private Integer crossGenomeMatchId;
	...
	public CrossGenomeMatchId() {
	}

	public CrossGenomeMatchId(Integer crossGenomeMatchId, Integer featureId,
		...
		this.crossGenomeMatchId = crossGenomeMatchId;
	...
	public Integer getCrossGenomeMatchId() {
		return this.crossGenomeMatchId;
	}

	public void setCrossGenomeMatchId(Integer crossGenomeMatchId) {
		this.crossGenomeMatchId = crossGenomeMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrossGenomeMatchId))
			return false;
		CrossGenomeMatchId castOther = (CrossGenomeMatchId) other;

		return ((this.getCrossGenomeMatchId() == castOther
				.getCrossGenomeMatchId()) || (this.getCrossGenomeMatchId() != null
				&& castOther.getCrossGenomeMatchId() != null && this
				.getCrossGenomeMatchId().equals(
						castOther.getCrossGenomeMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrossGenomeMatchId() == null ? 0 : this
						.getCrossGenomeMatchId().hashCode());
		result = 37 * result
