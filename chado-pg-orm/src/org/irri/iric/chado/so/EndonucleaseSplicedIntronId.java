...
/**
 * EndonucleaseSplicedIntronId generated by hbm2java
 */
public class EndonucleaseSplicedIntronId implements java.io.Serializable {

	private Integer endonucleaseSplicedIntronId;
	...
	public EndonucleaseSplicedIntronId() {
	}

	public EndonucleaseSplicedIntronId(Integer endonucleaseSplicedIntronId,
		...
		this.endonucleaseSplicedIntronId = endonucleaseSplicedIntronId;
	...
	public Integer getEndonucleaseSplicedIntronId() {
		return this.endonucleaseSplicedIntronId;
	}

	public void setEndonucleaseSplicedIntronId(
			Integer endonucleaseSplicedIntronId) {
		this.endonucleaseSplicedIntronId = endonucleaseSplicedIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EndonucleaseSplicedIntronId))
			return false;
		EndonucleaseSplicedIntronId castOther = (EndonucleaseSplicedIntronId) other;

		return ((this.getEndonucleaseSplicedIntronId() == castOther
				.getEndonucleaseSplicedIntronId()) || (this
				.getEndonucleaseSplicedIntronId() != null
				&& castOther.getEndonucleaseSplicedIntronId() != null && this
				.getEndonucleaseSplicedIntronId().equals(
						castOther.getEndonucleaseSplicedIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEndonucleaseSplicedIntronId() == null ? 0 : this
						.getEndonucleaseSplicedIntronId().hashCode());
		result = 37 * result
