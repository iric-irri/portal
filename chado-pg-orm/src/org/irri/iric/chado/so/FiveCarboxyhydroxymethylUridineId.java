...
/**
 * FiveCarboxyhydroxymethylUridineId generated by hbm2java
 */
public class FiveCarboxyhydroxymethylUridineId implements java.io.Serializable {

	private Integer fiveCarboxyhydroxymethylUridineId;
	...
	public FiveCarboxyhydroxymethylUridineId() {
	}

	public FiveCarboxyhydroxymethylUridineId(
			Integer fiveCarboxyhydroxymethylUridineId, Integer featureId,
		...
		this.fiveCarboxyhydroxymethylUridineId = fiveCarboxyhydroxymethylUridineId;
	...
	public Integer getFiveCarboxyhydroxymethylUridineId() {
		return this.fiveCarboxyhydroxymethylUridineId;
	}

	public void setFiveCarboxyhydroxymethylUridineId(
			Integer fiveCarboxyhydroxymethylUridineId) {
		this.fiveCarboxyhydroxymethylUridineId = fiveCarboxyhydroxymethylUridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCarboxyhydroxymethylUridineId))
			return false;
		FiveCarboxyhydroxymethylUridineId castOther = (FiveCarboxyhydroxymethylUridineId) other;

		return ((this.getFiveCarboxyhydroxymethylUridineId() == castOther
				.getFiveCarboxyhydroxymethylUridineId()) || (this
				.getFiveCarboxyhydroxymethylUridineId() != null
				&& castOther.getFiveCarboxyhydroxymethylUridineId() != null && this
				.getFiveCarboxyhydroxymethylUridineId().equals(
						castOther.getFiveCarboxyhydroxymethylUridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCarboxyhydroxymethylUridineId() == null ? 0 : this
						.getFiveCarboxyhydroxymethylUridineId().hashCode());
		result = 37 * result
