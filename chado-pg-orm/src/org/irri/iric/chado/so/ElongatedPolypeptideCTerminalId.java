...
/**
 * ElongatedPolypeptideCTerminalId generated by hbm2java
 */
public class ElongatedPolypeptideCTerminalId implements java.io.Serializable {

	private Integer elongatedPolypeptideCTerminalId;
	...
	public ElongatedPolypeptideCTerminalId() {
	}

	public ElongatedPolypeptideCTerminalId(
			Integer elongatedPolypeptideCTerminalId, Integer featureId,
		...
		this.elongatedPolypeptideCTerminalId = elongatedPolypeptideCTerminalId;
	...
	public Integer getElongatedPolypeptideCTerminalId() {
		return this.elongatedPolypeptideCTerminalId;
	}

	public void setElongatedPolypeptideCTerminalId(
			Integer elongatedPolypeptideCTerminalId) {
		this.elongatedPolypeptideCTerminalId = elongatedPolypeptideCTerminalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedPolypeptideCTerminalId))
			return false;
		ElongatedPolypeptideCTerminalId castOther = (ElongatedPolypeptideCTerminalId) other;

		return ((this.getElongatedPolypeptideCTerminalId() == castOther
				.getElongatedPolypeptideCTerminalId()) || (this
				.getElongatedPolypeptideCTerminalId() != null
				&& castOther.getElongatedPolypeptideCTerminalId() != null && this
				.getElongatedPolypeptideCTerminalId().equals(
						castOther.getElongatedPolypeptideCTerminalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedPolypeptideCTerminalId() == null ? 0 : this
						.getElongatedPolypeptideCTerminalId().hashCode());
		result = 37 * result
