...
/**
 * InvertInterTranspositionId generated by hbm2java
 */
public class InvertInterTranspositionId implements java.io.Serializable {

	private Integer invertInterTranspositionId;
	...
	public InvertInterTranspositionId() {
	}

	public InvertInterTranspositionId(Integer invertInterTranspositionId,
		...
		this.invertInterTranspositionId = invertInterTranspositionId;
	...
	public Integer getInvertInterTranspositionId() {
		return this.invertInterTranspositionId;
	}

	public void setInvertInterTranspositionId(Integer invertInterTranspositionId) {
		this.invertInterTranspositionId = invertInterTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertInterTranspositionId))
			return false;
		InvertInterTranspositionId castOther = (InvertInterTranspositionId) other;

		return ((this.getInvertInterTranspositionId() == castOther
				.getInvertInterTranspositionId()) || (this
				.getInvertInterTranspositionId() != null
				&& castOther.getInvertInterTranspositionId() != null && this
				.getInvertInterTranspositionId().equals(
						castOther.getInvertInterTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertInterTranspositionId() == null ? 0 : this
						.getInvertInterTranspositionId().hashCode());
		result = 37 * result
