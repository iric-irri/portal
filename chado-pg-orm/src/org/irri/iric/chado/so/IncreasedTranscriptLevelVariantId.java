...
/**
 * IncreasedTranscriptLevelVariantId generated by hbm2java
 */
public class IncreasedTranscriptLevelVariantId implements java.io.Serializable {

	private Integer increasedTranscriptLevelVariantId;
	...
	public IncreasedTranscriptLevelVariantId() {
	}

	public IncreasedTranscriptLevelVariantId(
			Integer increasedTranscriptLevelVariantId, Integer featureId,
		...
		this.increasedTranscriptLevelVariantId = increasedTranscriptLevelVariantId;
	...
	public Integer getIncreasedTranscriptLevelVariantId() {
		return this.increasedTranscriptLevelVariantId;
	}

	public void setIncreasedTranscriptLevelVariantId(
			Integer increasedTranscriptLevelVariantId) {
		this.increasedTranscriptLevelVariantId = increasedTranscriptLevelVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncreasedTranscriptLevelVariantId))
			return false;
		IncreasedTranscriptLevelVariantId castOther = (IncreasedTranscriptLevelVariantId) other;

		return ((this.getIncreasedTranscriptLevelVariantId() == castOther
				.getIncreasedTranscriptLevelVariantId()) || (this
				.getIncreasedTranscriptLevelVariantId() != null
				&& castOther.getIncreasedTranscriptLevelVariantId() != null && this
				.getIncreasedTranscriptLevelVariantId().equals(
						castOther.getIncreasedTranscriptLevelVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncreasedTranscriptLevelVariantId() == null ? 0 : this
						.getIncreasedTranscriptLevelVariantId().hashCode());
		result = 37 * result
