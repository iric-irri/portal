...
/**
 * DnazymeId generated by hbm2java
 */
public class DnazymeId implements java.io.Serializable {

	private Integer dnazymeId;
	...
	public DnazymeId(Integer dnazymeId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDnazymeId() {
		return this.dnazymeId;
	}

	public void setDnazymeId(Integer dnazymeId) {
		this.dnazymeId = dnazymeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnazymeId))
			return false;
		DnazymeId castOther = (DnazymeId) other;

		return ((this.getDnazymeId() == castOther.getDnazymeId()) || (this
				.getDnazymeId() != null && castOther.getDnazymeId() != null && this
				.getDnazymeId().equals(castOther.getDnazymeId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDnazymeId() == null ? 0 : this.getDnazymeId().hashCode());
		result = 37 * result
