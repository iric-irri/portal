...
/**
 * RnaChromosomeId generated by hbm2java
 */
public class RnaChromosomeId implements java.io.Serializable {

	private Integer rnaChromosomeId;
	...
	public RnaChromosomeId() {
	}

	public RnaChromosomeId(Integer rnaChromosomeId, Integer featureId,
		...
		this.rnaChromosomeId = rnaChromosomeId;
	...
	public Integer getRnaChromosomeId() {
		return this.rnaChromosomeId;
	}

	public void setRnaChromosomeId(Integer rnaChromosomeId) {
		this.rnaChromosomeId = rnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaChromosomeId))
			return false;
		RnaChromosomeId castOther = (RnaChromosomeId) other;

		return ((this.getRnaChromosomeId() == castOther.getRnaChromosomeId()) || (this
				.getRnaChromosomeId() != null
				&& castOther.getRnaChromosomeId() != null && this
				.getRnaChromosomeId().equals(castOther.getRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaChromosomeId() == null ? 0 : this.getRnaChromosomeId()
						.hashCode());
		result = 37 * result
