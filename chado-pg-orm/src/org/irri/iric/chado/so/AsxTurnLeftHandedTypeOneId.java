...
/**
 * AsxTurnLeftHandedTypeOneId generated by hbm2java
 */
public class AsxTurnLeftHandedTypeOneId implements java.io.Serializable {

	private Integer asxTurnLeftHandedTypeOneId;
	...
	public AsxTurnLeftHandedTypeOneId() {
	}

	public AsxTurnLeftHandedTypeOneId(Integer asxTurnLeftHandedTypeOneId,
		...
		this.asxTurnLeftHandedTypeOneId = asxTurnLeftHandedTypeOneId;
	...
	public Integer getAsxTurnLeftHandedTypeOneId() {
		return this.asxTurnLeftHandedTypeOneId;
	}

	public void setAsxTurnLeftHandedTypeOneId(Integer asxTurnLeftHandedTypeOneId) {
		this.asxTurnLeftHandedTypeOneId = asxTurnLeftHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxTurnLeftHandedTypeOneId))
			return false;
		AsxTurnLeftHandedTypeOneId castOther = (AsxTurnLeftHandedTypeOneId) other;

		return ((this.getAsxTurnLeftHandedTypeOneId() == castOther
				.getAsxTurnLeftHandedTypeOneId()) || (this
				.getAsxTurnLeftHandedTypeOneId() != null
				&& castOther.getAsxTurnLeftHandedTypeOneId() != null && this
				.getAsxTurnLeftHandedTypeOneId().equals(
						castOther.getAsxTurnLeftHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsxTurnLeftHandedTypeOneId() == null ? 0 : this
						.getAsxTurnLeftHandedTypeOneId().hashCode());
		result = 37 * result
