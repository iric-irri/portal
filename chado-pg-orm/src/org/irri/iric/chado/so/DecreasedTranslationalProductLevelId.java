...
/**
 * DecreasedTranslationalProductLevelId generated by hbm2java
 */
public class DecreasedTranslationalProductLevelId implements
		java.io.Serializable {

	private Integer decreasedTranslationalProductLevelId;
	...
	public DecreasedTranslationalProductLevelId() {
	}

	public DecreasedTranslationalProductLevelId(
			Integer decreasedTranslationalProductLevelId, Integer featureId,
		...
		this.decreasedTranslationalProductLevelId = decreasedTranslationalProductLevelId;
	...
	public Integer getDecreasedTranslationalProductLevelId() {
		return this.decreasedTranslationalProductLevelId;
	}

	public void setDecreasedTranslationalProductLevelId(
			Integer decreasedTranslationalProductLevelId) {
		this.decreasedTranslationalProductLevelId = decreasedTranslationalProductLevelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecreasedTranslationalProductLevelId))
			return false;
		DecreasedTranslationalProductLevelId castOther = (DecreasedTranslationalProductLevelId) other;

		return ((this.getDecreasedTranslationalProductLevelId() == castOther
				.getDecreasedTranslationalProductLevelId()) || (this
				.getDecreasedTranslationalProductLevelId() != null
				&& castOther.getDecreasedTranslationalProductLevelId() != null && this
				.getDecreasedTranslationalProductLevelId().equals(
						castOther.getDecreasedTranslationalProductLevelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecreasedTranslationalProductLevelId() == null ? 0 : this
						.getDecreasedTranslationalProductLevelId().hashCode());
		result = 37 * result
