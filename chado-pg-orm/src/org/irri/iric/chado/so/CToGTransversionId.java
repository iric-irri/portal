...
/**
 * CToGTransversionId generated by hbm2java
 */
public class CToGTransversionId implements java.io.Serializable {

	private Integer CToGTransversionId;
	...
	public CToGTransversionId() {
	}

	public CToGTransversionId(Integer CToGTransversionId, Integer featureId,
		...
		this.CToGTransversionId = CToGTransversionId;
	...
	public Integer getCToGTransversionId() {
		return this.CToGTransversionId;
	}

	public void setCToGTransversionId(Integer CToGTransversionId) {
		this.CToGTransversionId = CToGTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CToGTransversionId))
			return false;
		CToGTransversionId castOther = (CToGTransversionId) other;

		return ((this.getCToGTransversionId() == castOther
				.getCToGTransversionId()) || (this.getCToGTransversionId() != null
				&& castOther.getCToGTransversionId() != null && this
				.getCToGTransversionId().equals(
						castOther.getCToGTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCToGTransversionId() == null ? 0 : this
						.getCToGTransversionId().hashCode());
		result = 37 * result
