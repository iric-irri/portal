...
/**
 * MonocistronicMrnaId generated by hbm2java
 */
public class MonocistronicMrnaId implements java.io.Serializable {

	private Integer monocistronicMrnaId;
	...
	public MonocistronicMrnaId() {
	}

	public MonocistronicMrnaId(Integer monocistronicMrnaId, Integer featureId,
		...
		this.monocistronicMrnaId = monocistronicMrnaId;
	...
	public Integer getMonocistronicMrnaId() {
		return this.monocistronicMrnaId;
	}

	public void setMonocistronicMrnaId(Integer monocistronicMrnaId) {
		this.monocistronicMrnaId = monocistronicMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MonocistronicMrnaId))
			return false;
		MonocistronicMrnaId castOther = (MonocistronicMrnaId) other;

		return ((this.getMonocistronicMrnaId() == castOther
				.getMonocistronicMrnaId()) || (this.getMonocistronicMrnaId() != null
				&& castOther.getMonocistronicMrnaId() != null && this
				.getMonocistronicMrnaId().equals(
						castOther.getMonocistronicMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMonocistronicMrnaId() == null ? 0 : this
						.getMonocistronicMrnaId().hashCode());
		result = 37 * result
