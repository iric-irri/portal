...
/**
 * ExpressedSequenceMatchId generated by hbm2java
 */
public class ExpressedSequenceMatchId implements java.io.Serializable {

	private Integer expressedSequenceMatchId;
	...
	public ExpressedSequenceMatchId() {
	}

	public ExpressedSequenceMatchId(Integer expressedSequenceMatchId,
		...
		this.expressedSequenceMatchId = expressedSequenceMatchId;
	...
	public Integer getExpressedSequenceMatchId() {
		return this.expressedSequenceMatchId;
	}

	public void setExpressedSequenceMatchId(Integer expressedSequenceMatchId) {
		this.expressedSequenceMatchId = expressedSequenceMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExpressedSequenceMatchId))
			return false;
		ExpressedSequenceMatchId castOther = (ExpressedSequenceMatchId) other;

		return ((this.getExpressedSequenceMatchId() == castOther
				.getExpressedSequenceMatchId()) || (this
				.getExpressedSequenceMatchId() != null
				&& castOther.getExpressedSequenceMatchId() != null && this
				.getExpressedSequenceMatchId().equals(
						castOther.getExpressedSequenceMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExpressedSequenceMatchId() == null ? 0 : this
						.getExpressedSequenceMatchId().hashCode());
		result = 37 * result
