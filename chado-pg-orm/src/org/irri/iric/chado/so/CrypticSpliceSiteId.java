...
/**
 * CrypticSpliceSiteId generated by hbm2java
 */
public class CrypticSpliceSiteId implements java.io.Serializable {

	private Integer crypticSpliceSiteId;
	...
	public CrypticSpliceSiteId() {
	}

	public CrypticSpliceSiteId(Integer crypticSpliceSiteId, Integer featureId,
		...
		this.crypticSpliceSiteId = crypticSpliceSiteId;
	...
	public Integer getCrypticSpliceSiteId() {
		return this.crypticSpliceSiteId;
	}

	public void setCrypticSpliceSiteId(Integer crypticSpliceSiteId) {
		this.crypticSpliceSiteId = crypticSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticSpliceSiteId))
			return false;
		CrypticSpliceSiteId castOther = (CrypticSpliceSiteId) other;

		return ((this.getCrypticSpliceSiteId() == castOther
				.getCrypticSpliceSiteId()) || (this.getCrypticSpliceSiteId() != null
				&& castOther.getCrypticSpliceSiteId() != null && this
				.getCrypticSpliceSiteId().equals(
						castOther.getCrypticSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticSpliceSiteId() == null ? 0 : this
						.getCrypticSpliceSiteId().hashCode());
		result = 37 * result
