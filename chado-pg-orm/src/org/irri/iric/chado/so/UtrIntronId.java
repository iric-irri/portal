...
/**
 * UtrIntronId generated by hbm2java
 */
public class UtrIntronId implements java.io.Serializable {

	private Integer utrIntronId;
	...
	public UtrIntronId(Integer utrIntronId, Integer featureId,
	...
	public Integer getUtrIntronId() {
		return this.utrIntronId;
	}

	public void setUtrIntronId(Integer utrIntronId) {
		this.utrIntronId = utrIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UtrIntronId))
			return false;
		UtrIntronId castOther = (UtrIntronId) other;

		return ((this.getUtrIntronId() == castOther.getUtrIntronId()) || (this
				.getUtrIntronId() != null && castOther.getUtrIntronId() != null && this
				.getUtrIntronId().equals(castOther.getUtrIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUtrIntronId() == null ? 0 : this.getUtrIntronId()
						.hashCode());
		result = 37 * result
