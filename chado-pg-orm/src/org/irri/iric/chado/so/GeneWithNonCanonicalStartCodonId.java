...
/**
 * GeneWithNonCanonicalStartCodonId generated by hbm2java
 */
public class GeneWithNonCanonicalStartCodonId implements java.io.Serializable {

	private Integer geneWithNonCanonicalStartCodonId;
	...
	public GeneWithNonCanonicalStartCodonId() {
	}

	public GeneWithNonCanonicalStartCodonId(
			Integer geneWithNonCanonicalStartCodonId, Integer featureId,
		...
		this.geneWithNonCanonicalStartCodonId = geneWithNonCanonicalStartCodonId;
	...
	public Integer getGeneWithNonCanonicalStartCodonId() {
		return this.geneWithNonCanonicalStartCodonId;
	}

	public void setGeneWithNonCanonicalStartCodonId(
			Integer geneWithNonCanonicalStartCodonId) {
		this.geneWithNonCanonicalStartCodonId = geneWithNonCanonicalStartCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithNonCanonicalStartCodonId))
			return false;
		GeneWithNonCanonicalStartCodonId castOther = (GeneWithNonCanonicalStartCodonId) other;

		return ((this.getGeneWithNonCanonicalStartCodonId() == castOther
				.getGeneWithNonCanonicalStartCodonId()) || (this
				.getGeneWithNonCanonicalStartCodonId() != null
				&& castOther.getGeneWithNonCanonicalStartCodonId() != null && this
				.getGeneWithNonCanonicalStartCodonId().equals(
						castOther.getGeneWithNonCanonicalStartCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithNonCanonicalStartCodonId() == null ? 0 : this
						.getGeneWithNonCanonicalStartCodonId().hashCode());
		result = 37 * result
