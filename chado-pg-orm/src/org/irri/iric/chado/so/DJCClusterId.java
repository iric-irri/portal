...
/**
 * DJCClusterId generated by hbm2java
 */
public class DJCClusterId implements java.io.Serializable {

	private Integer DJCClusterId;
	...
	public DJCClusterId(Integer DJCClusterId, Integer featureId,
		...
		this.DJCClusterId = DJCClusterId;
	...
	public Integer getDJCClusterId() {
		return this.DJCClusterId;
	}

	public void setDJCClusterId(Integer DJCClusterId) {
		this.DJCClusterId = DJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DJCClusterId))
			return false;
		DJCClusterId castOther = (DJCClusterId) other;

		return ((this.getDJCClusterId() == castOther.getDJCClusterId()) || (this
				.getDJCClusterId() != null
				&& castOther.getDJCClusterId() != null && this
				.getDJCClusterId().equals(castOther.getDJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDJCClusterId() == null ? 0 : this.getDJCClusterId()
						.hashCode());
		result = 37 * result
