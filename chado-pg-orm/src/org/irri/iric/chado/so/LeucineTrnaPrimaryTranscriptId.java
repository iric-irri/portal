...
/**
 * LeucineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class LeucineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer leucineTrnaPrimaryTranscriptId;
	...
	public LeucineTrnaPrimaryTranscriptId() {
	}

	public LeucineTrnaPrimaryTranscriptId(
			Integer leucineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.leucineTrnaPrimaryTranscriptId = leucineTrnaPrimaryTranscriptId;
	...
	public Integer getLeucineTrnaPrimaryTranscriptId() {
		return this.leucineTrnaPrimaryTranscriptId;
	}

	public void setLeucineTrnaPrimaryTranscriptId(
			Integer leucineTrnaPrimaryTranscriptId) {
		this.leucineTrnaPrimaryTranscriptId = leucineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucineTrnaPrimaryTranscriptId))
			return false;
		LeucineTrnaPrimaryTranscriptId castOther = (LeucineTrnaPrimaryTranscriptId) other;

		return ((this.getLeucineTrnaPrimaryTranscriptId() == castOther
				.getLeucineTrnaPrimaryTranscriptId()) || (this
				.getLeucineTrnaPrimaryTranscriptId() != null
				&& castOther.getLeucineTrnaPrimaryTranscriptId() != null && this
				.getLeucineTrnaPrimaryTranscriptId().equals(
						castOther.getLeucineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeucineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getLeucineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
