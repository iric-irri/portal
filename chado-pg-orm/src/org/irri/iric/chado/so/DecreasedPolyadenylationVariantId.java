...
/**
 * DecreasedPolyadenylationVariantId generated by hbm2java
 */
public class DecreasedPolyadenylationVariantId implements java.io.Serializable {

	private Integer decreasedPolyadenylationVariantId;
	...
	public DecreasedPolyadenylationVariantId() {
	}

	public DecreasedPolyadenylationVariantId(
			Integer decreasedPolyadenylationVariantId, Integer featureId,
		...
		this.decreasedPolyadenylationVariantId = decreasedPolyadenylationVariantId;
	...
	public Integer getDecreasedPolyadenylationVariantId() {
		return this.decreasedPolyadenylationVariantId;
	}

	public void setDecreasedPolyadenylationVariantId(
			Integer decreasedPolyadenylationVariantId) {
		this.decreasedPolyadenylationVariantId = decreasedPolyadenylationVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecreasedPolyadenylationVariantId))
			return false;
		DecreasedPolyadenylationVariantId castOther = (DecreasedPolyadenylationVariantId) other;

		return ((this.getDecreasedPolyadenylationVariantId() == castOther
				.getDecreasedPolyadenylationVariantId()) || (this
				.getDecreasedPolyadenylationVariantId() != null
				&& castOther.getDecreasedPolyadenylationVariantId() != null && this
				.getDecreasedPolyadenylationVariantId().equals(
						castOther.getDecreasedPolyadenylationVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecreasedPolyadenylationVariantId() == null ? 0 : this
						.getDecreasedPolyadenylationVariantId().hashCode());
		result = 37 * result
