...
/**
 * GuideRnaId generated by hbm2java
 */
public class GuideRnaId implements java.io.Serializable {

	private Integer guideRnaId;
	...
	public GuideRnaId(Integer guideRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGuideRnaId() {
		return this.guideRnaId;
	}

	public void setGuideRnaId(Integer guideRnaId) {
		this.guideRnaId = guideRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GuideRnaId))
			return false;
		GuideRnaId castOther = (GuideRnaId) other;

		return ((this.getGuideRnaId() == castOther.getGuideRnaId()) || (this
				.getGuideRnaId() != null && castOther.getGuideRnaId() != null && this
				.getGuideRnaId().equals(castOther.getGuideRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGuideRnaId() == null ? 0 : this.getGuideRnaId()
						.hashCode());
		result = 37 * result
