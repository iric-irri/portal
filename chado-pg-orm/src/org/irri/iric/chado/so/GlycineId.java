...
/**
 * GlycineId generated by hbm2java
 */
public class GlycineId implements java.io.Serializable {

	private Integer glycineId;
	...
	public GlycineId(Integer glycineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGlycineId() {
		return this.glycineId;
	}

	public void setGlycineId(Integer glycineId) {
		this.glycineId = glycineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlycineId))
			return false;
		GlycineId castOther = (GlycineId) other;

		return ((this.getGlycineId() == castOther.getGlycineId()) || (this
				.getGlycineId() != null && castOther.getGlycineId() != null && this
				.getGlycineId().equals(castOther.getGlycineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGlycineId() == null ? 0 : this.getGlycineId().hashCode());
		result = 37 * result
