...
/**
 * ForwardPrimerId generated by hbm2java
 */
public class ForwardPrimerId implements java.io.Serializable {
	...
	public ForwardPrimerId() {
	}

	public ForwardPrimerId(Integer forwardPrimerId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ForwardPrimerId))
			return false;
		ForwardPrimerId castOther = (ForwardPrimerId) other;

		return ((this.getForwardPrimerId() == castOther.getForwardPrimerId()) || (this
				.getForwardPrimerId() != null
				&& castOther.getForwardPrimerId() != null && this
				.getForwardPrimerId().equals(castOther.getForwardPrimerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getForwardPrimerId() == null ? 0 : this.getForwardPrimerId()
						.hashCode());
		result = 37 * result
