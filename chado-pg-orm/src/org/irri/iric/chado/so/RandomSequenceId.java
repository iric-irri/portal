...
/**
 * RandomSequenceId generated by hbm2java
 */
public class RandomSequenceId implements java.io.Serializable {

	private Integer randomSequenceId;
	...
	public RandomSequenceId(Integer randomSequenceId, Integer featureId,
	...
	public Integer getRandomSequenceId() {
		return this.randomSequenceId;
	}

	public void setRandomSequenceId(Integer randomSequenceId) {
		this.randomSequenceId = randomSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RandomSequenceId))
			return false;
		RandomSequenceId castOther = (RandomSequenceId) other;

		return ((this.getRandomSequenceId() == castOther.getRandomSequenceId()) || (this
				.getRandomSequenceId() != null
				&& castOther.getRandomSequenceId() != null && this
				.getRandomSequenceId().equals(castOther.getRandomSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRandomSequenceId() == null ? 0 : this
						.getRandomSequenceId().hashCode());
		result = 37 * result
