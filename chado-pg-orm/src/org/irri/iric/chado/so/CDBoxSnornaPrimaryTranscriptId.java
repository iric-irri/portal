...
/**
 * CDBoxSnornaPrimaryTranscriptId generated by hbm2java
 */
public class CDBoxSnornaPrimaryTranscriptId implements java.io.Serializable {

	private Integer CDBoxSnornaPrimaryTranscriptId;
	...
	public CDBoxSnornaPrimaryTranscriptId() {
	}

	public CDBoxSnornaPrimaryTranscriptId(
			Integer CDBoxSnornaPrimaryTranscriptId, Integer featureId,
		...
		this.CDBoxSnornaPrimaryTranscriptId = CDBoxSnornaPrimaryTranscriptId;
	...
	public Integer getCDBoxSnornaPrimaryTranscriptId() {
		return this.CDBoxSnornaPrimaryTranscriptId;
	}

	public void setCDBoxSnornaPrimaryTranscriptId(
			Integer CDBoxSnornaPrimaryTranscriptId) {
		this.CDBoxSnornaPrimaryTranscriptId = CDBoxSnornaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CDBoxSnornaPrimaryTranscriptId))
			return false;
		CDBoxSnornaPrimaryTranscriptId castOther = (CDBoxSnornaPrimaryTranscriptId) other;

		return ((this.getCDBoxSnornaPrimaryTranscriptId() == castOther
				.getCDBoxSnornaPrimaryTranscriptId()) || (this
				.getCDBoxSnornaPrimaryTranscriptId() != null
				&& castOther.getCDBoxSnornaPrimaryTranscriptId() != null && this
				.getCDBoxSnornaPrimaryTranscriptId().equals(
						castOther.getCDBoxSnornaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCDBoxSnornaPrimaryTranscriptId() == null ? 0 : this
						.getCDBoxSnornaPrimaryTranscriptId().hashCode());
		result = 37 * result
