...
/**
 * SnrnaPrimaryTranscriptId generated by hbm2java
 */
public class SnrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer snrnaPrimaryTranscriptId;
	...
	public SnrnaPrimaryTranscriptId() {
	}

	public SnrnaPrimaryTranscriptId(Integer snrnaPrimaryTranscriptId,
		...
		this.snrnaPrimaryTranscriptId = snrnaPrimaryTranscriptId;
	...
	public Integer getSnrnaPrimaryTranscriptId() {
		return this.snrnaPrimaryTranscriptId;
	}

	public void setSnrnaPrimaryTranscriptId(Integer snrnaPrimaryTranscriptId) {
		this.snrnaPrimaryTranscriptId = snrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnrnaPrimaryTranscriptId))
			return false;
		SnrnaPrimaryTranscriptId castOther = (SnrnaPrimaryTranscriptId) other;

		return ((this.getSnrnaPrimaryTranscriptId() == castOther
				.getSnrnaPrimaryTranscriptId()) || (this
				.getSnrnaPrimaryTranscriptId() != null
				&& castOther.getSnrnaPrimaryTranscriptId() != null && this
				.getSnrnaPrimaryTranscriptId().equals(
						castOther.getSnrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnrnaPrimaryTranscriptId() == null ? 0 : this
						.getSnrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
