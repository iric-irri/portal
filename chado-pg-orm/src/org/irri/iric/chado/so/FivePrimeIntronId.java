...
/**
 * FivePrimeIntronId generated by hbm2java
 */
public class FivePrimeIntronId implements java.io.Serializable {

	private Integer fivePrimeIntronId;
	...
	public FivePrimeIntronId() {
	}

	public FivePrimeIntronId(Integer fivePrimeIntronId, Integer featureId,
		...
		this.fivePrimeIntronId = fivePrimeIntronId;
	...
	public Integer getFivePrimeIntronId() {
		return this.fivePrimeIntronId;
	}

	public void setFivePrimeIntronId(Integer fivePrimeIntronId) {
		this.fivePrimeIntronId = fivePrimeIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeIntronId))
			return false;
		FivePrimeIntronId castOther = (FivePrimeIntronId) other;

		return ((this.getFivePrimeIntronId() == castOther
				.getFivePrimeIntronId()) || (this.getFivePrimeIntronId() != null
				&& castOther.getFivePrimeIntronId() != null && this
				.getFivePrimeIntronId()
				.equals(castOther.getFivePrimeIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeIntronId() == null ? 0 : this
						.getFivePrimeIntronId().hashCode());
		result = 37 * result
