...
/**
 * CommonVariantId generated by hbm2java
 */
public class CommonVariantId implements java.io.Serializable {

	private Integer commonVariantId;
	...
	public CommonVariantId() {
	}

	public CommonVariantId(Integer commonVariantId, Integer featureId,
		...
		this.commonVariantId = commonVariantId;
	...
	public Integer getCommonVariantId() {
		return this.commonVariantId;
	}

	public void setCommonVariantId(Integer commonVariantId) {
		this.commonVariantId = commonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CommonVariantId))
			return false;
		CommonVariantId castOther = (CommonVariantId) other;

		return ((this.getCommonVariantId() == castOther.getCommonVariantId()) || (this
				.getCommonVariantId() != null
				&& castOther.getCommonVariantId() != null && this
				.getCommonVariantId().equals(castOther.getCommonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCommonVariantId() == null ? 0 : this.getCommonVariantId()
						.hashCode());
		result = 37 * result
