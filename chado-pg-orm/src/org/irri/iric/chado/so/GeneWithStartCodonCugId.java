...
/**
 * GeneWithStartCodonCugId generated by hbm2java
 */
public class GeneWithStartCodonCugId implements java.io.Serializable {

	private Integer geneWithStartCodonCugId;
	...
	public GeneWithStartCodonCugId() {
	}

	public GeneWithStartCodonCugId(Integer geneWithStartCodonCugId,
		...
		this.geneWithStartCodonCugId = geneWithStartCodonCugId;
	...
	public Integer getGeneWithStartCodonCugId() {
		return this.geneWithStartCodonCugId;
	}

	public void setGeneWithStartCodonCugId(Integer geneWithStartCodonCugId) {
		this.geneWithStartCodonCugId = geneWithStartCodonCugId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithStartCodonCugId))
			return false;
		GeneWithStartCodonCugId castOther = (GeneWithStartCodonCugId) other;

		return ((this.getGeneWithStartCodonCugId() == castOther
				.getGeneWithStartCodonCugId()) || (this
				.getGeneWithStartCodonCugId() != null
				&& castOther.getGeneWithStartCodonCugId() != null && this
				.getGeneWithStartCodonCugId().equals(
						castOther.getGeneWithStartCodonCugId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithStartCodonCugId() == null ? 0 : this
						.getGeneWithStartCodonCugId().hashCode());
		result = 37 * result
