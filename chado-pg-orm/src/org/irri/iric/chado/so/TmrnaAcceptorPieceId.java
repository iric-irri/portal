...
/**
 * TmrnaAcceptorPieceId generated by hbm2java
 */
public class TmrnaAcceptorPieceId implements java.io.Serializable {

	private Integer tmrnaAcceptorPieceId;
	...
	public TmrnaAcceptorPieceId() {
	}

	public TmrnaAcceptorPieceId(Integer tmrnaAcceptorPieceId,
		...
		this.tmrnaAcceptorPieceId = tmrnaAcceptorPieceId;
	...
	public Integer getTmrnaAcceptorPieceId() {
		return this.tmrnaAcceptorPieceId;
	}

	public void setTmrnaAcceptorPieceId(Integer tmrnaAcceptorPieceId) {
		this.tmrnaAcceptorPieceId = tmrnaAcceptorPieceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaAcceptorPieceId))
			return false;
		TmrnaAcceptorPieceId castOther = (TmrnaAcceptorPieceId) other;

		return ((this.getTmrnaAcceptorPieceId() == castOther
				.getTmrnaAcceptorPieceId()) || (this.getTmrnaAcceptorPieceId() != null
				&& castOther.getTmrnaAcceptorPieceId() != null && this
				.getTmrnaAcceptorPieceId().equals(
						castOther.getTmrnaAcceptorPieceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaAcceptorPieceId() == null ? 0 : this
						.getTmrnaAcceptorPieceId().hashCode());
		result = 37 * result
