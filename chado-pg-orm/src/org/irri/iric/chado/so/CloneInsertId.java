...
/**
 * CloneInsertId generated by hbm2java
 */
public class CloneInsertId implements java.io.Serializable {

	private Integer cloneInsertId;
	...
	public CloneInsertId() {
	}

	public CloneInsertId(Integer cloneInsertId, Integer featureId,
		...
		this.cloneInsertId = cloneInsertId;
	...
	public Integer getCloneInsertId() {
		return this.cloneInsertId;
	}

	public void setCloneInsertId(Integer cloneInsertId) {
		this.cloneInsertId = cloneInsertId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CloneInsertId))
			return false;
		CloneInsertId castOther = (CloneInsertId) other;

		return ((this.getCloneInsertId() == castOther.getCloneInsertId()) || (this
				.getCloneInsertId() != null
				&& castOther.getCloneInsertId() != null && this
				.getCloneInsertId().equals(castOther.getCloneInsertId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCloneInsertId() == null ? 0 : this.getCloneInsertId()
						.hashCode());
		result = 37 * result
