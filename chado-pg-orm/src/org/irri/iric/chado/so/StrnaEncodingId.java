...
/**
 * StrnaEncodingId generated by hbm2java
 */
public class StrnaEncodingId implements java.io.Serializable {

	private Integer strnaEncodingId;
	...
	public StrnaEncodingId() {
	}

	public StrnaEncodingId(Integer strnaEncodingId, Integer featureId,
		...
		this.strnaEncodingId = strnaEncodingId;
	...
	public Integer getStrnaEncodingId() {
		return this.strnaEncodingId;
	}

	public void setStrnaEncodingId(Integer strnaEncodingId) {
		this.strnaEncodingId = strnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StrnaEncodingId))
			return false;
		StrnaEncodingId castOther = (StrnaEncodingId) other;

		return ((this.getStrnaEncodingId() == castOther.getStrnaEncodingId()) || (this
				.getStrnaEncodingId() != null
				&& castOther.getStrnaEncodingId() != null && this
				.getStrnaEncodingId().equals(castOther.getStrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStrnaEncodingId() == null ? 0 : this.getStrnaEncodingId()
						.hashCode());
		result = 37 * result
