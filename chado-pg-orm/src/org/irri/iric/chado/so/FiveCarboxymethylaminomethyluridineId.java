...
/**
 * FiveCarboxymethylaminomethyluridineId generated by hbm2java
 */
public class FiveCarboxymethylaminomethyluridineId implements
		java.io.Serializable {

	private Integer fiveCarboxymethylaminomethyluridineId;
	...
	public FiveCarboxymethylaminomethyluridineId() {
	}

	public FiveCarboxymethylaminomethyluridineId(
			Integer fiveCarboxymethylaminomethyluridineId, Integer featureId,
		...
		this.fiveCarboxymethylaminomethyluridineId = fiveCarboxymethylaminomethyluridineId;
	...
	public Integer getFiveCarboxymethylaminomethyluridineId() {
		return this.fiveCarboxymethylaminomethyluridineId;
	}

	public void setFiveCarboxymethylaminomethyluridineId(
			Integer fiveCarboxymethylaminomethyluridineId) {
		this.fiveCarboxymethylaminomethyluridineId = fiveCarboxymethylaminomethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCarboxymethylaminomethyluridineId))
			return false;
		FiveCarboxymethylaminomethyluridineId castOther = (FiveCarboxymethylaminomethyluridineId) other;

		return ((this.getFiveCarboxymethylaminomethyluridineId() == castOther
				.getFiveCarboxymethylaminomethyluridineId()) || (this
				.getFiveCarboxymethylaminomethyluridineId() != null
				&& castOther.getFiveCarboxymethylaminomethyluridineId() != null && this
				.getFiveCarboxymethylaminomethyluridineId().equals(
						castOther.getFiveCarboxymethylaminomethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCarboxymethylaminomethyluridineId() == null ? 0
						: this.getFiveCarboxymethylaminomethyluridineId()
								.hashCode());
		result = 37 * result
