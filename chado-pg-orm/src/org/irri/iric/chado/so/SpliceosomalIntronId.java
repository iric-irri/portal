...
/**
 * SpliceosomalIntronId generated by hbm2java
 */
public class SpliceosomalIntronId implements java.io.Serializable {

	private Integer spliceosomalIntronId;
	...
	public SpliceosomalIntronId() {
	}

	public SpliceosomalIntronId(Integer spliceosomalIntronId,
		...
		this.spliceosomalIntronId = spliceosomalIntronId;
	...
	public Integer getSpliceosomalIntronId() {
		return this.spliceosomalIntronId;
	}

	public void setSpliceosomalIntronId(Integer spliceosomalIntronId) {
		this.spliceosomalIntronId = spliceosomalIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceosomalIntronId))
			return false;
		SpliceosomalIntronId castOther = (SpliceosomalIntronId) other;

		return ((this.getSpliceosomalIntronId() == castOther
				.getSpliceosomalIntronId()) || (this.getSpliceosomalIntronId() != null
				&& castOther.getSpliceosomalIntronId() != null && this
				.getSpliceosomalIntronId().equals(
						castOther.getSpliceosomalIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceosomalIntronId() == null ? 0 : this
						.getSpliceosomalIntronId().hashCode());
		result = 37 * result
