...
/**
 * AssemblyErrorCorrectionId generated by hbm2java
 */
public class AssemblyErrorCorrectionId implements java.io.Serializable {

	private Integer assemblyErrorCorrectionId;
	...
	public AssemblyErrorCorrectionId() {
	}

	public AssemblyErrorCorrectionId(Integer assemblyErrorCorrectionId,
		...
		this.assemblyErrorCorrectionId = assemblyErrorCorrectionId;
	...
	public Integer getAssemblyErrorCorrectionId() {
		return this.assemblyErrorCorrectionId;
	}

	public void setAssemblyErrorCorrectionId(Integer assemblyErrorCorrectionId) {
		this.assemblyErrorCorrectionId = assemblyErrorCorrectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssemblyErrorCorrectionId))
			return false;
		AssemblyErrorCorrectionId castOther = (AssemblyErrorCorrectionId) other;

		return ((this.getAssemblyErrorCorrectionId() == castOther
				.getAssemblyErrorCorrectionId()) || (this
				.getAssemblyErrorCorrectionId() != null
				&& castOther.getAssemblyErrorCorrectionId() != null && this
				.getAssemblyErrorCorrectionId().equals(
						castOther.getAssemblyErrorCorrectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssemblyErrorCorrectionId() == null ? 0 : this
						.getAssemblyErrorCorrectionId().hashCode());
		result = 37 * result
