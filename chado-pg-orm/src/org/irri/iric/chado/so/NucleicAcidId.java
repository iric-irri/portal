...
/**
 * NucleicAcidId generated by hbm2java
 */
public class NucleicAcidId implements java.io.Serializable {

	private Integer nucleicAcidId;
	...
	public NucleicAcidId() {
	}

	public NucleicAcidId(Integer nucleicAcidId, Integer featureId,
	...
	public Integer getNucleicAcidId() {
		return this.nucleicAcidId;
	}

	public void setNucleicAcidId(Integer nucleicAcidId) {
		this.nucleicAcidId = nucleicAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleicAcidId))
			return false;
		NucleicAcidId castOther = (NucleicAcidId) other;

		return ((this.getNucleicAcidId() == castOther.getNucleicAcidId()) || (this
				.getNucleicAcidId() != null
				&& castOther.getNucleicAcidId() != null && this
				.getNucleicAcidId().equals(castOther.getNucleicAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleicAcidId() == null ? 0 : this.getNucleicAcidId()
						.hashCode());
		result = 37 * result
