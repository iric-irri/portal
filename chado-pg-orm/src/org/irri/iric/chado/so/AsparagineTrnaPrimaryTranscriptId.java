...
/**
 * AsparagineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class AsparagineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer asparagineTrnaPrimaryTranscriptId;
	...
	public AsparagineTrnaPrimaryTranscriptId() {
	}

	public AsparagineTrnaPrimaryTranscriptId(
			Integer asparagineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.asparagineTrnaPrimaryTranscriptId = asparagineTrnaPrimaryTranscriptId;
	...
	public Integer getAsparagineTrnaPrimaryTranscriptId() {
		return this.asparagineTrnaPrimaryTranscriptId;
	}

	public void setAsparagineTrnaPrimaryTranscriptId(
			Integer asparagineTrnaPrimaryTranscriptId) {
		this.asparagineTrnaPrimaryTranscriptId = asparagineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsparagineTrnaPrimaryTranscriptId))
			return false;
		AsparagineTrnaPrimaryTranscriptId castOther = (AsparagineTrnaPrimaryTranscriptId) other;

		return ((this.getAsparagineTrnaPrimaryTranscriptId() == castOther
				.getAsparagineTrnaPrimaryTranscriptId()) || (this
				.getAsparagineTrnaPrimaryTranscriptId() != null
				&& castOther.getAsparagineTrnaPrimaryTranscriptId() != null && this
				.getAsparagineTrnaPrimaryTranscriptId().equals(
						castOther.getAsparagineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsparagineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getAsparagineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
