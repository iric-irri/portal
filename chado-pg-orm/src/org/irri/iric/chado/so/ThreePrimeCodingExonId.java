...
/**
 * ThreePrimeCodingExonId generated by hbm2java
 */
public class ThreePrimeCodingExonId implements java.io.Serializable {

	private Integer threePrimeCodingExonId;
	...
	public ThreePrimeCodingExonId() {
	}

	public ThreePrimeCodingExonId(Integer threePrimeCodingExonId,
		...
		this.threePrimeCodingExonId = threePrimeCodingExonId;
	...
	public Integer getThreePrimeCodingExonId() {
		return this.threePrimeCodingExonId;
	}

	public void setThreePrimeCodingExonId(Integer threePrimeCodingExonId) {
		this.threePrimeCodingExonId = threePrimeCodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeCodingExonId))
			return false;
		ThreePrimeCodingExonId castOther = (ThreePrimeCodingExonId) other;

		return ((this.getThreePrimeCodingExonId() == castOther
				.getThreePrimeCodingExonId()) || (this
				.getThreePrimeCodingExonId() != null
				&& castOther.getThreePrimeCodingExonId() != null && this
				.getThreePrimeCodingExonId().equals(
						castOther.getThreePrimeCodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeCodingExonId() == null ? 0 : this
						.getThreePrimeCodingExonId().hashCode());
		result = 37 * result
