...
/**
 * PlasmidLocationId generated by hbm2java
 */
public class PlasmidLocationId implements java.io.Serializable {

	private Integer plasmidLocationId;
	...
	public PlasmidLocationId() {
	}

	public PlasmidLocationId(Integer plasmidLocationId, Integer featureId,
		...
		this.plasmidLocationId = plasmidLocationId;
	...
	public Integer getPlasmidLocationId() {
		return this.plasmidLocationId;
	}

	public void setPlasmidLocationId(Integer plasmidLocationId) {
		this.plasmidLocationId = plasmidLocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlasmidLocationId))
			return false;
		PlasmidLocationId castOther = (PlasmidLocationId) other;

		return ((this.getPlasmidLocationId() == castOther
				.getPlasmidLocationId()) || (this.getPlasmidLocationId() != null
				&& castOther.getPlasmidLocationId() != null && this
				.getPlasmidLocationId()
				.equals(castOther.getPlasmidLocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlasmidLocationId() == null ? 0 : this
						.getPlasmidLocationId().hashCode());
		result = 37 * result
