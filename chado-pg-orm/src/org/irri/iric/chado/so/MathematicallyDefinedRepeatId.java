...
/**
 * MathematicallyDefinedRepeatId generated by hbm2java
 */
public class MathematicallyDefinedRepeatId implements java.io.Serializable {

	private Integer mathematicallyDefinedRepeatId;
	...
	public MathematicallyDefinedRepeatId() {
	}

	public MathematicallyDefinedRepeatId(Integer mathematicallyDefinedRepeatId,
		...
		this.mathematicallyDefinedRepeatId = mathematicallyDefinedRepeatId;
	...
	public Integer getMathematicallyDefinedRepeatId() {
		return this.mathematicallyDefinedRepeatId;
	}

	public void setMathematicallyDefinedRepeatId(
			Integer mathematicallyDefinedRepeatId) {
		this.mathematicallyDefinedRepeatId = mathematicallyDefinedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MathematicallyDefinedRepeatId))
			return false;
		MathematicallyDefinedRepeatId castOther = (MathematicallyDefinedRepeatId) other;

		return ((this.getMathematicallyDefinedRepeatId() == castOther
				.getMathematicallyDefinedRepeatId()) || (this
				.getMathematicallyDefinedRepeatId() != null
				&& castOther.getMathematicallyDefinedRepeatId() != null && this
				.getMathematicallyDefinedRepeatId().equals(
						castOther.getMathematicallyDefinedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMathematicallyDefinedRepeatId() == null ? 0 : this
						.getMathematicallyDefinedRepeatId().hashCode());
		result = 37 * result
