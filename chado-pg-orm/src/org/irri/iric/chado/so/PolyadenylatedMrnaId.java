...
/**
 * PolyadenylatedMrnaId generated by hbm2java
 */
public class PolyadenylatedMrnaId implements java.io.Serializable {

	private Integer polyadenylatedMrnaId;
	...
	public PolyadenylatedMrnaId() {
	}

	public PolyadenylatedMrnaId(Integer polyadenylatedMrnaId,
		...
		this.polyadenylatedMrnaId = polyadenylatedMrnaId;
	...
	public Integer getPolyadenylatedMrnaId() {
		return this.polyadenylatedMrnaId;
	}

	public void setPolyadenylatedMrnaId(Integer polyadenylatedMrnaId) {
		this.polyadenylatedMrnaId = polyadenylatedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyadenylatedMrnaId))
			return false;
		PolyadenylatedMrnaId castOther = (PolyadenylatedMrnaId) other;

		return ((this.getPolyadenylatedMrnaId() == castOther
				.getPolyadenylatedMrnaId()) || (this.getPolyadenylatedMrnaId() != null
				&& castOther.getPolyadenylatedMrnaId() != null && this
				.getPolyadenylatedMrnaId().equals(
						castOther.getPolyadenylatedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyadenylatedMrnaId() == null ? 0 : this
						.getPolyadenylatedMrnaId().hashCode());
		result = 37 * result
