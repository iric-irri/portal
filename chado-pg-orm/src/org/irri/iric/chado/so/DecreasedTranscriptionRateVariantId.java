...
/**
 * DecreasedTranscriptionRateVariantId generated by hbm2java
 */
public class DecreasedTranscriptionRateVariantId implements
		java.io.Serializable {

	private Integer decreasedTranscriptionRateVariantId;
	...
	public DecreasedTranscriptionRateVariantId() {
	}

	public DecreasedTranscriptionRateVariantId(
			Integer decreasedTranscriptionRateVariantId, Integer featureId,
		...
		this.decreasedTranscriptionRateVariantId = decreasedTranscriptionRateVariantId;
	...
	public Integer getDecreasedTranscriptionRateVariantId() {
		return this.decreasedTranscriptionRateVariantId;
	}

	public void setDecreasedTranscriptionRateVariantId(
			Integer decreasedTranscriptionRateVariantId) {
		this.decreasedTranscriptionRateVariantId = decreasedTranscriptionRateVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecreasedTranscriptionRateVariantId))
			return false;
		DecreasedTranscriptionRateVariantId castOther = (DecreasedTranscriptionRateVariantId) other;

		return ((this.getDecreasedTranscriptionRateVariantId() == castOther
				.getDecreasedTranscriptionRateVariantId()) || (this
				.getDecreasedTranscriptionRateVariantId() != null
				&& castOther.getDecreasedTranscriptionRateVariantId() != null && this
				.getDecreasedTranscriptionRateVariantId().equals(
						castOther.getDecreasedTranscriptionRateVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecreasedTranscriptionRateVariantId() == null ? 0 : this
						.getDecreasedTranscriptionRateVariantId().hashCode());
		result = 37 * result
