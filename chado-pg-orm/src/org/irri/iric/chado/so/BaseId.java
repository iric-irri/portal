...
/**
 * BaseId generated by hbm2java
 */
public class BaseId implements java.io.Serializable {
	...
	public BaseId(Integer baseId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof BaseId))
			return false;
		BaseId castOther = (BaseId) other;

		return ((this.getBaseId() == castOther.getBaseId()) || (this
