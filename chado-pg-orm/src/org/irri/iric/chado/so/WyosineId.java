...
/**
 * WyosineId generated by hbm2java
 */
public class WyosineId implements java.io.Serializable {

	private Integer wyosineId;
	...
	public WyosineId(Integer wyosineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getWyosineId() {
		return this.wyosineId;
	}

	public void setWyosineId(Integer wyosineId) {
		this.wyosineId = wyosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WyosineId))
			return false;
		WyosineId castOther = (WyosineId) other;

		return ((this.getWyosineId() == castOther.getWyosineId()) || (this
				.getWyosineId() != null && castOther.getWyosineId() != null && this
				.getWyosineId().equals(castOther.getWyosineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getWyosineId() == null ? 0 : this.getWyosineId().hashCode());
		result = 37 * result
