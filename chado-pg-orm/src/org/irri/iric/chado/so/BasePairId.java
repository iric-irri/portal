...
/**
 * BasePairId generated by hbm2java
 */
public class BasePairId implements java.io.Serializable {

	private Integer basePairId;
	...
	public BasePairId(Integer basePairId, Integer featureId, Integer dbxrefId,
	...
	public Integer getBasePairId() {
		return this.basePairId;
	}

	public void setBasePairId(Integer basePairId) {
		this.basePairId = basePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BasePairId))
			return false;
		BasePairId castOther = (BasePairId) other;

		return ((this.getBasePairId() == castOther.getBasePairId()) || (this
				.getBasePairId() != null && castOther.getBasePairId() != null && this
				.getBasePairId().equals(castOther.getBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBasePairId() == null ? 0 : this.getBasePairId()
						.hashCode());
		result = 37 * result
