...
/**
 * SpliceAcceptorVariantId generated by hbm2java
 */
public class SpliceAcceptorVariantId implements java.io.Serializable {

	private Integer spliceAcceptorVariantId;
	...
	public SpliceAcceptorVariantId() {
	}

	public SpliceAcceptorVariantId(Integer spliceAcceptorVariantId,
		...
		this.spliceAcceptorVariantId = spliceAcceptorVariantId;
	...
	public Integer getSpliceAcceptorVariantId() {
		return this.spliceAcceptorVariantId;
	}

	public void setSpliceAcceptorVariantId(Integer spliceAcceptorVariantId) {
		this.spliceAcceptorVariantId = spliceAcceptorVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceAcceptorVariantId))
			return false;
		SpliceAcceptorVariantId castOther = (SpliceAcceptorVariantId) other;

		return ((this.getSpliceAcceptorVariantId() == castOther
				.getSpliceAcceptorVariantId()) || (this
				.getSpliceAcceptorVariantId() != null
				&& castOther.getSpliceAcceptorVariantId() != null && this
				.getSpliceAcceptorVariantId().equals(
						castOther.getSpliceAcceptorVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceAcceptorVariantId() == null ? 0 : this
						.getSpliceAcceptorVariantId().hashCode());
		result = 37 * result
