...
/**
 * SoloLtrId generated by hbm2java
 */
public class SoloLtrId implements java.io.Serializable {

	private Integer soloLtrId;
	...
	public SoloLtrId(Integer soloLtrId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSoloLtrId() {
		return this.soloLtrId;
	}

	public void setSoloLtrId(Integer soloLtrId) {
		this.soloLtrId = soloLtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SoloLtrId))
			return false;
		SoloLtrId castOther = (SoloLtrId) other;

		return ((this.getSoloLtrId() == castOther.getSoloLtrId()) || (this
				.getSoloLtrId() != null && castOther.getSoloLtrId() != null && this
				.getSoloLtrId().equals(castOther.getSoloLtrId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSoloLtrId() == null ? 0 : this.getSoloLtrId().hashCode());
		result = 37 * result
