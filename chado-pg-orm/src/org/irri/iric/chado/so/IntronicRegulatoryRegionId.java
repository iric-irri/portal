...
/**
 * IntronicRegulatoryRegionId generated by hbm2java
 */
public class IntronicRegulatoryRegionId implements java.io.Serializable {

	private Integer intronicRegulatoryRegionId;
	...
	public IntronicRegulatoryRegionId() {
	}

	public IntronicRegulatoryRegionId(Integer intronicRegulatoryRegionId,
		...
		this.intronicRegulatoryRegionId = intronicRegulatoryRegionId;
	...
	public Integer getIntronicRegulatoryRegionId() {
		return this.intronicRegulatoryRegionId;
	}

	public void setIntronicRegulatoryRegionId(Integer intronicRegulatoryRegionId) {
		this.intronicRegulatoryRegionId = intronicRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronicRegulatoryRegionId))
			return false;
		IntronicRegulatoryRegionId castOther = (IntronicRegulatoryRegionId) other;

		return ((this.getIntronicRegulatoryRegionId() == castOther
				.getIntronicRegulatoryRegionId()) || (this
				.getIntronicRegulatoryRegionId() != null
				&& castOther.getIntronicRegulatoryRegionId() != null && this
				.getIntronicRegulatoryRegionId().equals(
						castOther.getIntronicRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntronicRegulatoryRegionId() == null ? 0 : this
						.getIntronicRegulatoryRegionId().hashCode());
		result = 37 * result
