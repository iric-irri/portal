...
/**
 * StartCodonId generated by hbm2java
 */
public class StartCodonId implements java.io.Serializable {

	private Integer startCodonId;
	...
	public StartCodonId(Integer startCodonId, Integer featureId,
		...
		this.startCodonId = startCodonId;
	...
	public Integer getStartCodonId() {
		return this.startCodonId;
	}

	public void setStartCodonId(Integer startCodonId) {
		this.startCodonId = startCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StartCodonId))
			return false;
		StartCodonId castOther = (StartCodonId) other;

		return ((this.getStartCodonId() == castOther.getStartCodonId()) || (this
				.getStartCodonId() != null
				&& castOther.getStartCodonId() != null && this
				.getStartCodonId().equals(castOther.getStartCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStartCodonId() == null ? 0 : this.getStartCodonId()
						.hashCode());
		result = 37 * result
