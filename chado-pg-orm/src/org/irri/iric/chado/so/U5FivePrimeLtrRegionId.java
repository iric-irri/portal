...
/**
 * U5FivePrimeLtrRegionId generated by hbm2java
 */
public class U5FivePrimeLtrRegionId implements java.io.Serializable {

	private Integer u5FivePrimeLtrRegionId;
	...
	public U5FivePrimeLtrRegionId() {
	}

	public U5FivePrimeLtrRegionId(Integer u5FivePrimeLtrRegionId,
		...
		this.u5FivePrimeLtrRegionId = u5FivePrimeLtrRegionId;
	...
	public Integer getU5FivePrimeLtrRegionId() {
		return this.u5FivePrimeLtrRegionId;
	}

	public void setU5FivePrimeLtrRegionId(Integer u5FivePrimeLtrRegionId) {
		this.u5FivePrimeLtrRegionId = u5FivePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U5FivePrimeLtrRegionId))
			return false;
		U5FivePrimeLtrRegionId castOther = (U5FivePrimeLtrRegionId) other;

		return ((this.getU5FivePrimeLtrRegionId() == castOther
				.getU5FivePrimeLtrRegionId()) || (this
				.getU5FivePrimeLtrRegionId() != null
				&& castOther.getU5FivePrimeLtrRegionId() != null && this
				.getU5FivePrimeLtrRegionId().equals(
						castOther.getU5FivePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU5FivePrimeLtrRegionId() == null ? 0 : this
						.getU5FivePrimeLtrRegionId().hashCode());
		result = 37 * result
