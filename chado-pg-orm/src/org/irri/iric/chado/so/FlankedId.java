...
/**
 * FlankedId generated by hbm2java
 */
public class FlankedId implements java.io.Serializable {

	private Integer flankedId;
	...
	public FlankedId(Integer flankedId, Integer featureId, Integer dbxrefId,
	...
	public Integer getFlankedId() {
		return this.flankedId;
	}

	public void setFlankedId(Integer flankedId) {
		this.flankedId = flankedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FlankedId))
			return false;
		FlankedId castOther = (FlankedId) other;

		return ((this.getFlankedId() == castOther.getFlankedId()) || (this
				.getFlankedId() != null && castOther.getFlankedId() != null && this
				.getFlankedId().equals(castOther.getFlankedId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getFlankedId() == null ? 0 : this.getFlankedId().hashCode());
		result = 37 * result
