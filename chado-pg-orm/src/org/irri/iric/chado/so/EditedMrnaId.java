...
/**
 * EditedMrnaId generated by hbm2java
 */
public class EditedMrnaId implements java.io.Serializable {

	private Integer editedMrnaId;
	...
	public EditedMrnaId(Integer editedMrnaId, Integer featureId,
		...
		this.editedMrnaId = editedMrnaId;
	...
	public Integer getEditedMrnaId() {
		return this.editedMrnaId;
	}

	public void setEditedMrnaId(Integer editedMrnaId) {
		this.editedMrnaId = editedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedMrnaId))
			return false;
		EditedMrnaId castOther = (EditedMrnaId) other;

		return ((this.getEditedMrnaId() == castOther.getEditedMrnaId()) || (this
				.getEditedMrnaId() != null
				&& castOther.getEditedMrnaId() != null && this
				.getEditedMrnaId().equals(castOther.getEditedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditedMrnaId() == null ? 0 : this.getEditedMrnaId()
						.hashCode());
		result = 37 * result
