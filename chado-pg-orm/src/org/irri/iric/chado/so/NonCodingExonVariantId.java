...
/**
 * NonCodingExonVariantId generated by hbm2java
 */
public class NonCodingExonVariantId implements java.io.Serializable {

	private Integer nonCodingExonVariantId;
	...
	public NonCodingExonVariantId() {
	}

	public NonCodingExonVariantId(Integer nonCodingExonVariantId,
		...
		this.nonCodingExonVariantId = nonCodingExonVariantId;
	...
	public Integer getNonCodingExonVariantId() {
		return this.nonCodingExonVariantId;
	}

	public void setNonCodingExonVariantId(Integer nonCodingExonVariantId) {
		this.nonCodingExonVariantId = nonCodingExonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonCodingExonVariantId))
			return false;
		NonCodingExonVariantId castOther = (NonCodingExonVariantId) other;

		return ((this.getNonCodingExonVariantId() == castOther
				.getNonCodingExonVariantId()) || (this
				.getNonCodingExonVariantId() != null
				&& castOther.getNonCodingExonVariantId() != null && this
				.getNonCodingExonVariantId().equals(
						castOther.getNonCodingExonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonCodingExonVariantId() == null ? 0 : this
						.getNonCodingExonVariantId().hashCode());
		result = 37 * result
