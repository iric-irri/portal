...
/**
 * ChromosomeVariationId generated by hbm2java
 */
public class ChromosomeVariationId implements java.io.Serializable {

	private Integer chromosomeVariationId;
	...
	public ChromosomeVariationId() {
	}

	public ChromosomeVariationId(Integer chromosomeVariationId,
		...
		this.chromosomeVariationId = chromosomeVariationId;
	...
	public Integer getChromosomeVariationId() {
		return this.chromosomeVariationId;
	}

	public void setChromosomeVariationId(Integer chromosomeVariationId) {
		this.chromosomeVariationId = chromosomeVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeVariationId))
			return false;
		ChromosomeVariationId castOther = (ChromosomeVariationId) other;

		return ((this.getChromosomeVariationId() == castOther
				.getChromosomeVariationId()) || (this
				.getChromosomeVariationId() != null
				&& castOther.getChromosomeVariationId() != null && this
				.getChromosomeVariationId().equals(
						castOther.getChromosomeVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeVariationId() == null ? 0 : this
						.getChromosomeVariationId().hashCode());
		result = 37 * result
