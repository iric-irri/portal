...
/**
 * RnaPolymeraseIiiTataBoxId generated by hbm2java
 */
public class RnaPolymeraseIiiTataBoxId implements java.io.Serializable {

	private Integer rnaPolymeraseIiiTataBoxId;
	...
	public RnaPolymeraseIiiTataBoxId() {
	}

	public RnaPolymeraseIiiTataBoxId(Integer rnaPolymeraseIiiTataBoxId,
		...
		this.rnaPolymeraseIiiTataBoxId = rnaPolymeraseIiiTataBoxId;
	...
	public Integer getRnaPolymeraseIiiTataBoxId() {
		return this.rnaPolymeraseIiiTataBoxId;
	}

	public void setRnaPolymeraseIiiTataBoxId(Integer rnaPolymeraseIiiTataBoxId) {
		this.rnaPolymeraseIiiTataBoxId = rnaPolymeraseIiiTataBoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaPolymeraseIiiTataBoxId))
			return false;
		RnaPolymeraseIiiTataBoxId castOther = (RnaPolymeraseIiiTataBoxId) other;

		return ((this.getRnaPolymeraseIiiTataBoxId() == castOther
				.getRnaPolymeraseIiiTataBoxId()) || (this
				.getRnaPolymeraseIiiTataBoxId() != null
				&& castOther.getRnaPolymeraseIiiTataBoxId() != null && this
				.getRnaPolymeraseIiiTataBoxId().equals(
						castOther.getRnaPolymeraseIiiTataBoxId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaPolymeraseIiiTataBoxId() == null ? 0 : this
						.getRnaPolymeraseIiiTataBoxId().hashCode());
		result = 37 * result
