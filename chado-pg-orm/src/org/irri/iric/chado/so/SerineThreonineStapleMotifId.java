...
/**
 * SerineThreonineStapleMotifId generated by hbm2java
 */
public class SerineThreonineStapleMotifId implements java.io.Serializable {

	private Integer serineThreonineStapleMotifId;
	...
	public SerineThreonineStapleMotifId() {
	}

	public SerineThreonineStapleMotifId(Integer serineThreonineStapleMotifId,
		...
		this.serineThreonineStapleMotifId = serineThreonineStapleMotifId;
	...
	public Integer getSerineThreonineStapleMotifId() {
		return this.serineThreonineStapleMotifId;
	}

	public void setSerineThreonineStapleMotifId(
			Integer serineThreonineStapleMotifId) {
		this.serineThreonineStapleMotifId = serineThreonineStapleMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerineThreonineStapleMotifId))
			return false;
		SerineThreonineStapleMotifId castOther = (SerineThreonineStapleMotifId) other;

		return ((this.getSerineThreonineStapleMotifId() == castOther
				.getSerineThreonineStapleMotifId()) || (this
				.getSerineThreonineStapleMotifId() != null
				&& castOther.getSerineThreonineStapleMotifId() != null && this
				.getSerineThreonineStapleMotifId().equals(
						castOther.getSerineThreonineStapleMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSerineThreonineStapleMotifId() == null ? 0 : this
						.getSerineThreonineStapleMotifId().hashCode());
		result = 37 * result
