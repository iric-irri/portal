...
/**
 * Minus2FrameshiftId generated by hbm2java
 */
public class Minus2FrameshiftId implements java.io.Serializable {

	private Integer minus2FrameshiftId;
	...
	public Minus2FrameshiftId() {
	}

	public Minus2FrameshiftId(Integer minus2FrameshiftId, Integer featureId,
		...
		this.minus2FrameshiftId = minus2FrameshiftId;
	...
	public Integer getMinus2FrameshiftId() {
		return this.minus2FrameshiftId;
	}

	public void setMinus2FrameshiftId(Integer minus2FrameshiftId) {
		this.minus2FrameshiftId = minus2FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus2FrameshiftId))
			return false;
		Minus2FrameshiftId castOther = (Minus2FrameshiftId) other;

		return ((this.getMinus2FrameshiftId() == castOther
				.getMinus2FrameshiftId()) || (this.getMinus2FrameshiftId() != null
				&& castOther.getMinus2FrameshiftId() != null && this
				.getMinus2FrameshiftId().equals(
						castOther.getMinus2FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus2FrameshiftId() == null ? 0 : this
						.getMinus2FrameshiftId().hashCode());
		result = 37 * result
