...
/**
 * ModifiedLSerineId generated by hbm2java
 */
public class ModifiedLSerineId implements java.io.Serializable {

	private Integer modifiedLSerineId;
	...
	public ModifiedLSerineId() {
	}

	public ModifiedLSerineId(Integer modifiedLSerineId, Integer featureId,
		...
		this.modifiedLSerineId = modifiedLSerineId;
	...
	public Integer getModifiedLSerineId() {
		return this.modifiedLSerineId;
	}

	public void setModifiedLSerineId(Integer modifiedLSerineId) {
		this.modifiedLSerineId = modifiedLSerineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLSerineId))
			return false;
		ModifiedLSerineId castOther = (ModifiedLSerineId) other;

		return ((this.getModifiedLSerineId() == castOther
				.getModifiedLSerineId()) || (this.getModifiedLSerineId() != null
				&& castOther.getModifiedLSerineId() != null && this
				.getModifiedLSerineId()
				.equals(castOther.getModifiedLSerineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLSerineId() == null ? 0 : this
						.getModifiedLSerineId().hashCode());
		result = 37 * result
