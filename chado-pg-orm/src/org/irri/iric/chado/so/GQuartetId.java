...
/**
 * GQuartetId generated by hbm2java
 */
public class GQuartetId implements java.io.Serializable {

	private Integer GQuartetId;
	...
	public GQuartetId(Integer GQuartetId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGQuartetId() {
		return this.GQuartetId;
	}

	public void setGQuartetId(Integer GQuartetId) {
		this.GQuartetId = GQuartetId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GQuartetId))
			return false;
		GQuartetId castOther = (GQuartetId) other;

		return ((this.getGQuartetId() == castOther.getGQuartetId()) || (this
				.getGQuartetId() != null && castOther.getGQuartetId() != null && this
				.getGQuartetId().equals(castOther.getGQuartetId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGQuartetId() == null ? 0 : this.getGQuartetId()
						.hashCode());
		result = 37 * result
