...
/**
 * Minus10SignalId generated by hbm2java
 */
public class Minus10SignalId implements java.io.Serializable {

	private Integer minus10SignalId;
	...
	public Minus10SignalId() {
	}

	public Minus10SignalId(Integer minus10SignalId, Integer featureId,
		...
		this.minus10SignalId = minus10SignalId;
	...
	public Integer getMinus10SignalId() {
		return this.minus10SignalId;
	}

	public void setMinus10SignalId(Integer minus10SignalId) {
		this.minus10SignalId = minus10SignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus10SignalId))
			return false;
		Minus10SignalId castOther = (Minus10SignalId) other;

		return ((this.getMinus10SignalId() == castOther.getMinus10SignalId()) || (this
				.getMinus10SignalId() != null
				&& castOther.getMinus10SignalId() != null && this
				.getMinus10SignalId().equals(castOther.getMinus10SignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus10SignalId() == null ? 0 : this.getMinus10SignalId()
						.hashCode());
		result = 37 * result
