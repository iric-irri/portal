...
/**
 * StrnaGeneId generated by hbm2java
 */
public class StrnaGeneId implements java.io.Serializable {

	private Integer strnaGeneId;
	...
	public StrnaGeneId(Integer strnaGeneId, Integer featureId,
	...
	public Integer getStrnaGeneId() {
		return this.strnaGeneId;
	}

	public void setStrnaGeneId(Integer strnaGeneId) {
		this.strnaGeneId = strnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StrnaGeneId))
			return false;
		StrnaGeneId castOther = (StrnaGeneId) other;

		return ((this.getStrnaGeneId() == castOther.getStrnaGeneId()) || (this
				.getStrnaGeneId() != null && castOther.getStrnaGeneId() != null && this
				.getStrnaGeneId().equals(castOther.getStrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStrnaGeneId() == null ? 0 : this.getStrnaGeneId()
						.hashCode());
		result = 37 * result
