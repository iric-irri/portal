...
/**
 * AttlSiteId generated by hbm2java
 */
public class AttlSiteId implements java.io.Serializable {

	private Integer attlSiteId;
	...
	public AttlSiteId(Integer attlSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttlSiteId() {
		return this.attlSiteId;
	}

	public void setAttlSiteId(Integer attlSiteId) {
		this.attlSiteId = attlSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttlSiteId))
			return false;
		AttlSiteId castOther = (AttlSiteId) other;

		return ((this.getAttlSiteId() == castOther.getAttlSiteId()) || (this
				.getAttlSiteId() != null && castOther.getAttlSiteId() != null && this
				.getAttlSiteId().equals(castOther.getAttlSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttlSiteId() == null ? 0 : this.getAttlSiteId()
						.hashCode());
		result = 37 * result
