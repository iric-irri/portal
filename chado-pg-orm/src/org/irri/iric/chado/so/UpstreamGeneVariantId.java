...
/**
 * UpstreamGeneVariantId generated by hbm2java
 */
public class UpstreamGeneVariantId implements java.io.Serializable {

	private Integer upstreamGeneVariantId;
	...
	public UpstreamGeneVariantId() {
	}

	public UpstreamGeneVariantId(Integer upstreamGeneVariantId,
		...
		this.upstreamGeneVariantId = upstreamGeneVariantId;
	...
	public Integer getUpstreamGeneVariantId() {
		return this.upstreamGeneVariantId;
	}

	public void setUpstreamGeneVariantId(Integer upstreamGeneVariantId) {
		this.upstreamGeneVariantId = upstreamGeneVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UpstreamGeneVariantId))
			return false;
		UpstreamGeneVariantId castOther = (UpstreamGeneVariantId) other;

		return ((this.getUpstreamGeneVariantId() == castOther
				.getUpstreamGeneVariantId()) || (this
				.getUpstreamGeneVariantId() != null
				&& castOther.getUpstreamGeneVariantId() != null && this
				.getUpstreamGeneVariantId().equals(
						castOther.getUpstreamGeneVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUpstreamGeneVariantId() == null ? 0 : this
						.getUpstreamGeneVariantId().hashCode());
		result = 37 * result
