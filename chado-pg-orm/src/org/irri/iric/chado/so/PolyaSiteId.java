...
/**
 * PolyaSiteId generated by hbm2java
 */
public class PolyaSiteId implements java.io.Serializable {

	private Integer polyaSiteId;
	...
	public PolyaSiteId(Integer polyaSiteId, Integer featureId,
	...
	public Integer getPolyaSiteId() {
		return this.polyaSiteId;
	}

	public void setPolyaSiteId(Integer polyaSiteId) {
		this.polyaSiteId = polyaSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyaSiteId))
			return false;
		PolyaSiteId castOther = (PolyaSiteId) other;

		return ((this.getPolyaSiteId() == castOther.getPolyaSiteId()) || (this
				.getPolyaSiteId() != null && castOther.getPolyaSiteId() != null && this
				.getPolyaSiteId().equals(castOther.getPolyaSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyaSiteId() == null ? 0 : this.getPolyaSiteId()
						.hashCode());
		result = 37 * result
