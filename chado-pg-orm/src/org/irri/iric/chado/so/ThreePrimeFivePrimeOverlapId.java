...
/**
 * ThreePrimeFivePrimeOverlapId generated by hbm2java
 */
public class ThreePrimeFivePrimeOverlapId implements java.io.Serializable {

	private Integer threePrimeFivePrimeOverlapId;
	...
	public ThreePrimeFivePrimeOverlapId() {
	}

	public ThreePrimeFivePrimeOverlapId(Integer threePrimeFivePrimeOverlapId,
		...
		this.threePrimeFivePrimeOverlapId = threePrimeFivePrimeOverlapId;
	...
	public Integer getThreePrimeFivePrimeOverlapId() {
		return this.threePrimeFivePrimeOverlapId;
	}

	public void setThreePrimeFivePrimeOverlapId(
			Integer threePrimeFivePrimeOverlapId) {
		this.threePrimeFivePrimeOverlapId = threePrimeFivePrimeOverlapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeFivePrimeOverlapId))
			return false;
		ThreePrimeFivePrimeOverlapId castOther = (ThreePrimeFivePrimeOverlapId) other;

		return ((this.getThreePrimeFivePrimeOverlapId() == castOther
				.getThreePrimeFivePrimeOverlapId()) || (this
				.getThreePrimeFivePrimeOverlapId() != null
				&& castOther.getThreePrimeFivePrimeOverlapId() != null && this
				.getThreePrimeFivePrimeOverlapId().equals(
						castOther.getThreePrimeFivePrimeOverlapId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeFivePrimeOverlapId() == null ? 0 : this
						.getThreePrimeFivePrimeOverlapId().hashCode());
		result = 37 * result
