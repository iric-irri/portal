...
/**
 * HammerheadRibozymeId generated by hbm2java
 */
public class HammerheadRibozymeId implements java.io.Serializable {

	private Integer hammerheadRibozymeId;
	...
	public HammerheadRibozymeId() {
	}

	public HammerheadRibozymeId(Integer hammerheadRibozymeId,
		...
		this.hammerheadRibozymeId = hammerheadRibozymeId;
	...
	public Integer getHammerheadRibozymeId() {
		return this.hammerheadRibozymeId;
	}

	public void setHammerheadRibozymeId(Integer hammerheadRibozymeId) {
		this.hammerheadRibozymeId = hammerheadRibozymeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HammerheadRibozymeId))
			return false;
		HammerheadRibozymeId castOther = (HammerheadRibozymeId) other;

		return ((this.getHammerheadRibozymeId() == castOther
				.getHammerheadRibozymeId()) || (this.getHammerheadRibozymeId() != null
				&& castOther.getHammerheadRibozymeId() != null && this
				.getHammerheadRibozymeId().equals(
						castOther.getHammerheadRibozymeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHammerheadRibozymeId() == null ? 0 : this
						.getHammerheadRibozymeId().hashCode());
		result = 37 * result
