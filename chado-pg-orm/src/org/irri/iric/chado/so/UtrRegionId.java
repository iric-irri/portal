...
/**
 * UtrRegionId generated by hbm2java
 */
public class UtrRegionId implements java.io.Serializable {

	private Integer utrRegionId;
	...
	public UtrRegionId(Integer utrRegionId, Integer featureId,
	...
	public Integer getUtrRegionId() {
		return this.utrRegionId;
	}

	public void setUtrRegionId(Integer utrRegionId) {
		this.utrRegionId = utrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UtrRegionId))
			return false;
		UtrRegionId castOther = (UtrRegionId) other;

		return ((this.getUtrRegionId() == castOther.getUtrRegionId()) || (this
				.getUtrRegionId() != null && castOther.getUtrRegionId() != null && this
				.getUtrRegionId().equals(castOther.getUtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUtrRegionId() == null ? 0 : this.getUtrRegionId()
						.hashCode());
		result = 37 * result
