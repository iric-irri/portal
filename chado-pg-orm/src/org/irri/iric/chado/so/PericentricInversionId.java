...
/**
 * PericentricInversionId generated by hbm2java
 */
public class PericentricInversionId implements java.io.Serializable {

	private Integer pericentricInversionId;
	...
	public PericentricInversionId() {
	}

	public PericentricInversionId(Integer pericentricInversionId,
		...
		this.pericentricInversionId = pericentricInversionId;
	...
	public Integer getPericentricInversionId() {
		return this.pericentricInversionId;
	}

	public void setPericentricInversionId(Integer pericentricInversionId) {
		this.pericentricInversionId = pericentricInversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PericentricInversionId))
			return false;
		PericentricInversionId castOther = (PericentricInversionId) other;

		return ((this.getPericentricInversionId() == castOther
				.getPericentricInversionId()) || (this
				.getPericentricInversionId() != null
				&& castOther.getPericentricInversionId() != null && this
				.getPericentricInversionId().equals(
						castOther.getPericentricInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPericentricInversionId() == null ? 0 : this
						.getPericentricInversionId().hashCode());
		result = 37 * result
