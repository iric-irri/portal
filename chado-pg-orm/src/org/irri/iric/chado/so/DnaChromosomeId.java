...
/**
 * DnaChromosomeId generated by hbm2java
 */
public class DnaChromosomeId implements java.io.Serializable {

	private Integer dnaChromosomeId;
	...
	public DnaChromosomeId() {
	}

	public DnaChromosomeId(Integer dnaChromosomeId, Integer featureId,
		...
		this.dnaChromosomeId = dnaChromosomeId;
	...
	public Integer getDnaChromosomeId() {
		return this.dnaChromosomeId;
	}

	public void setDnaChromosomeId(Integer dnaChromosomeId) {
		this.dnaChromosomeId = dnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaChromosomeId))
			return false;
		DnaChromosomeId castOther = (DnaChromosomeId) other;

		return ((this.getDnaChromosomeId() == castOther.getDnaChromosomeId()) || (this
				.getDnaChromosomeId() != null
				&& castOther.getDnaChromosomeId() != null && this
				.getDnaChromosomeId().equals(castOther.getDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaChromosomeId() == null ? 0 : this.getDnaChromosomeId()
						.hashCode());
		result = 37 * result
