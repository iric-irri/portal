...
/**
 * MicrosatelliteId generated by hbm2java
 */
public class MicrosatelliteId implements java.io.Serializable {

	private Integer microsatelliteId;
	...
	public MicrosatelliteId() {
	}

	public MicrosatelliteId(Integer microsatelliteId, Integer featureId,
		...
		this.microsatelliteId = microsatelliteId;
	...
	public Integer getMicrosatelliteId() {
		return this.microsatelliteId;
	}

	public void setMicrosatelliteId(Integer microsatelliteId) {
		this.microsatelliteId = microsatelliteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MicrosatelliteId))
			return false;
		MicrosatelliteId castOther = (MicrosatelliteId) other;

		return ((this.getMicrosatelliteId() == castOther.getMicrosatelliteId()) || (this
				.getMicrosatelliteId() != null
				&& castOther.getMicrosatelliteId() != null && this
				.getMicrosatelliteId().equals(castOther.getMicrosatelliteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMicrosatelliteId() == null ? 0 : this
						.getMicrosatelliteId().hashCode());
		result = 37 * result
