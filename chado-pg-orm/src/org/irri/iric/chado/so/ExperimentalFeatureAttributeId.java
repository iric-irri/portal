...
/**
 * ExperimentalFeatureAttributeId generated by hbm2java
 */
public class ExperimentalFeatureAttributeId implements java.io.Serializable {

	private Integer experimentalFeatureAttributeId;
	...
	public ExperimentalFeatureAttributeId() {
	}

	public ExperimentalFeatureAttributeId(
			Integer experimentalFeatureAttributeId, Integer featureId,
		...
		this.experimentalFeatureAttributeId = experimentalFeatureAttributeId;
	...
	public Integer getExperimentalFeatureAttributeId() {
		return this.experimentalFeatureAttributeId;
	}

	public void setExperimentalFeatureAttributeId(
			Integer experimentalFeatureAttributeId) {
		this.experimentalFeatureAttributeId = experimentalFeatureAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExperimentalFeatureAttributeId))
			return false;
		ExperimentalFeatureAttributeId castOther = (ExperimentalFeatureAttributeId) other;

		return ((this.getExperimentalFeatureAttributeId() == castOther
				.getExperimentalFeatureAttributeId()) || (this
				.getExperimentalFeatureAttributeId() != null
				&& castOther.getExperimentalFeatureAttributeId() != null && this
				.getExperimentalFeatureAttributeId().equals(
						castOther.getExperimentalFeatureAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExperimentalFeatureAttributeId() == null ? 0 : this
						.getExperimentalFeatureAttributeId().hashCode());
		result = 37 * result
