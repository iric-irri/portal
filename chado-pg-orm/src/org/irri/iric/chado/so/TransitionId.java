...
/**
 * TransitionId generated by hbm2java
 */
public class TransitionId implements java.io.Serializable {
	...
	public TransitionId(Integer transitionId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransitionId))
			return false;
		TransitionId castOther = (TransitionId) other;

		return ((this.getTransitionId() == castOther.getTransitionId()) || (this
				.getTransitionId() != null
				&& castOther.getTransitionId() != null && this
				.getTransitionId().equals(castOther.getTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransitionId() == null ? 0 : this.getTransitionId()
						.hashCode());
		result = 37 * result
