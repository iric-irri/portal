...
/**
 * RnapolIPromoterId generated by hbm2java
 */
public class RnapolIPromoterId implements java.io.Serializable {

	private Integer rnapolIPromoterId;
	...
	public RnapolIPromoterId() {
	}

	public RnapolIPromoterId(Integer rnapolIPromoterId, Integer featureId,
		...
		this.rnapolIPromoterId = rnapolIPromoterId;
	...
	public Integer getRnapolIPromoterId() {
		return this.rnapolIPromoterId;
	}

	public void setRnapolIPromoterId(Integer rnapolIPromoterId) {
		this.rnapolIPromoterId = rnapolIPromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnapolIPromoterId))
			return false;
		RnapolIPromoterId castOther = (RnapolIPromoterId) other;

		return ((this.getRnapolIPromoterId() == castOther
				.getRnapolIPromoterId()) || (this.getRnapolIPromoterId() != null
				&& castOther.getRnapolIPromoterId() != null && this
				.getRnapolIPromoterId()
				.equals(castOther.getRnapolIPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnapolIPromoterId() == null ? 0 : this
						.getRnapolIPromoterId().hashCode());
		result = 37 * result
