...
/**
 * N2MethylguanosineId generated by hbm2java
 */
public class N2MethylguanosineId implements java.io.Serializable {

	private Integer n2MethylguanosineId;
	...
	public N2MethylguanosineId() {
	}

	public N2MethylguanosineId(Integer n2MethylguanosineId, Integer featureId,
		...
		this.n2MethylguanosineId = n2MethylguanosineId;
	...
	public Integer getN2MethylguanosineId() {
		return this.n2MethylguanosineId;
	}

	public void setN2MethylguanosineId(Integer n2MethylguanosineId) {
		this.n2MethylguanosineId = n2MethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N2MethylguanosineId))
			return false;
		N2MethylguanosineId castOther = (N2MethylguanosineId) other;

		return ((this.getN2MethylguanosineId() == castOther
				.getN2MethylguanosineId()) || (this.getN2MethylguanosineId() != null
				&& castOther.getN2MethylguanosineId() != null && this
				.getN2MethylguanosineId().equals(
						castOther.getN2MethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN2MethylguanosineId() == null ? 0 : this
						.getN2MethylguanosineId().hashCode());
		result = 37 * result
