...
/**
 * GeneWithPolyadenylatedMrnaId generated by hbm2java
 */
public class GeneWithPolyadenylatedMrnaId implements java.io.Serializable {

	private Integer geneWithPolyadenylatedMrnaId;
	...
	public GeneWithPolyadenylatedMrnaId() {
	}

	public GeneWithPolyadenylatedMrnaId(Integer geneWithPolyadenylatedMrnaId,
		...
		this.geneWithPolyadenylatedMrnaId = geneWithPolyadenylatedMrnaId;
	...
	public Integer getGeneWithPolyadenylatedMrnaId() {
		return this.geneWithPolyadenylatedMrnaId;
	}

	public void setGeneWithPolyadenylatedMrnaId(
			Integer geneWithPolyadenylatedMrnaId) {
		this.geneWithPolyadenylatedMrnaId = geneWithPolyadenylatedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithPolyadenylatedMrnaId))
			return false;
		GeneWithPolyadenylatedMrnaId castOther = (GeneWithPolyadenylatedMrnaId) other;

		return ((this.getGeneWithPolyadenylatedMrnaId() == castOther
				.getGeneWithPolyadenylatedMrnaId()) || (this
				.getGeneWithPolyadenylatedMrnaId() != null
				&& castOther.getGeneWithPolyadenylatedMrnaId() != null && this
				.getGeneWithPolyadenylatedMrnaId().equals(
						castOther.getGeneWithPolyadenylatedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithPolyadenylatedMrnaId() == null ? 0 : this
						.getGeneWithPolyadenylatedMrnaId().hashCode());
		result = 37 * result
