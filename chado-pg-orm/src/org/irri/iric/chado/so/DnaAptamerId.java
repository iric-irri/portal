...
/**
 * DnaAptamerId generated by hbm2java
 */
public class DnaAptamerId implements java.io.Serializable {

	private Integer dnaAptamerId;
	...
	public DnaAptamerId(Integer dnaAptamerId, Integer featureId,
		...
		this.dnaAptamerId = dnaAptamerId;
	...
	public Integer getDnaAptamerId() {
		return this.dnaAptamerId;
	}

	public void setDnaAptamerId(Integer dnaAptamerId) {
		this.dnaAptamerId = dnaAptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaAptamerId))
			return false;
		DnaAptamerId castOther = (DnaAptamerId) other;

		return ((this.getDnaAptamerId() == castOther.getDnaAptamerId()) || (this
				.getDnaAptamerId() != null
				&& castOther.getDnaAptamerId() != null && this
				.getDnaAptamerId().equals(castOther.getDnaAptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaAptamerId() == null ? 0 : this.getDnaAptamerId()
						.hashCode());
		result = 37 * result
