...
/**
 * DecayedExonId generated by hbm2java
 */
public class DecayedExonId implements java.io.Serializable {

	private Integer decayedExonId;
	...
	public DecayedExonId() {
	}

	public DecayedExonId(Integer decayedExonId, Integer featureId,
		...
		this.decayedExonId = decayedExonId;
	...
	public Integer getDecayedExonId() {
		return this.decayedExonId;
	}

	public void setDecayedExonId(Integer decayedExonId) {
		this.decayedExonId = decayedExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecayedExonId))
			return false;
		DecayedExonId castOther = (DecayedExonId) other;

		return ((this.getDecayedExonId() == castOther.getDecayedExonId()) || (this
				.getDecayedExonId() != null
				&& castOther.getDecayedExonId() != null && this
				.getDecayedExonId().equals(castOther.getDecayedExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecayedExonId() == null ? 0 : this.getDecayedExonId()
						.hashCode());
		result = 37 * result
