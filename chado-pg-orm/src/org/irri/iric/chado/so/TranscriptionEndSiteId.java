...
/**
 * TranscriptionEndSiteId generated by hbm2java
 */
public class TranscriptionEndSiteId implements java.io.Serializable {

	private Integer transcriptionEndSiteId;
	...
	public TranscriptionEndSiteId() {
	}

	public TranscriptionEndSiteId(Integer transcriptionEndSiteId,
		...
		this.transcriptionEndSiteId = transcriptionEndSiteId;
	...
	public Integer getTranscriptionEndSiteId() {
		return this.transcriptionEndSiteId;
	}

	public void setTranscriptionEndSiteId(Integer transcriptionEndSiteId) {
		this.transcriptionEndSiteId = transcriptionEndSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionEndSiteId))
			return false;
		TranscriptionEndSiteId castOther = (TranscriptionEndSiteId) other;

		return ((this.getTranscriptionEndSiteId() == castOther
				.getTranscriptionEndSiteId()) || (this
				.getTranscriptionEndSiteId() != null
				&& castOther.getTranscriptionEndSiteId() != null && this
				.getTranscriptionEndSiteId().equals(
						castOther.getTranscriptionEndSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionEndSiteId() == null ? 0 : this
						.getTranscriptionEndSiteId().hashCode());
		result = 37 * result
