...
/**
 * MirnaEncodingId generated by hbm2java
 */
public class MirnaEncodingId implements java.io.Serializable {

	private Integer mirnaEncodingId;
	...
	public MirnaEncodingId() {
	}

	public MirnaEncodingId(Integer mirnaEncodingId, Integer featureId,
		...
		this.mirnaEncodingId = mirnaEncodingId;
	...
	public Integer getMirnaEncodingId() {
		return this.mirnaEncodingId;
	}

	public void setMirnaEncodingId(Integer mirnaEncodingId) {
		this.mirnaEncodingId = mirnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaEncodingId))
			return false;
		MirnaEncodingId castOther = (MirnaEncodingId) other;

		return ((this.getMirnaEncodingId() == castOther.getMirnaEncodingId()) || (this
				.getMirnaEncodingId() != null
				&& castOther.getMirnaEncodingId() != null && this
				.getMirnaEncodingId().equals(castOther.getMirnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaEncodingId() == null ? 0 : this.getMirnaEncodingId()
						.hashCode());
		result = 37 * result
