...
/**
 * ABoxId generated by hbm2java
 */
public class ABoxId implements java.io.Serializable {

	private Integer ABoxId;
	...
	public ABoxId(Integer ABoxId, Integer featureId, Integer dbxrefId,
	...
	public Integer getABoxId() {
		return this.ABoxId;
	}

	public void setABoxId(Integer ABoxId) {
		this.ABoxId = ABoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ABoxId))
			return false;
		ABoxId castOther = (ABoxId) other;

		return ((this.getABoxId() == castOther.getABoxId()) || (this
				.getABoxId() != null && castOther.getABoxId() != null && this
				.getABoxId().equals(castOther.getABoxId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getABoxId() == null ? 0 : this.getABoxId().hashCode());
		result = 37 * result
