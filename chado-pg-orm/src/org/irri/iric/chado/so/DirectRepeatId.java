...
/**
 * DirectRepeatId generated by hbm2java
 */
public class DirectRepeatId implements java.io.Serializable {

	private Integer directRepeatId;
	...
	public DirectRepeatId() {
	}

	public DirectRepeatId(Integer directRepeatId, Integer featureId,
		...
		this.directRepeatId = directRepeatId;
	...
	public Integer getDirectRepeatId() {
		return this.directRepeatId;
	}

	public void setDirectRepeatId(Integer directRepeatId) {
		this.directRepeatId = directRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DirectRepeatId))
			return false;
		DirectRepeatId castOther = (DirectRepeatId) other;

		return ((this.getDirectRepeatId() == castOther.getDirectRepeatId()) || (this
				.getDirectRepeatId() != null
				&& castOther.getDirectRepeatId() != null && this
				.getDirectRepeatId().equals(castOther.getDirectRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDirectRepeatId() == null ? 0 : this.getDirectRepeatId()
						.hashCode());
		result = 37 * result
