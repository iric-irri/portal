...
/**
 * PositiveSenseSsrnaViralSequenceId generated by hbm2java
 */
public class PositiveSenseSsrnaViralSequenceId implements java.io.Serializable {

	private Integer positiveSenseSsrnaViralSequenceId;
	...
	public PositiveSenseSsrnaViralSequenceId() {
	}

	public PositiveSenseSsrnaViralSequenceId(
			Integer positiveSenseSsrnaViralSequenceId, Integer featureId,
		...
		this.positiveSenseSsrnaViralSequenceId = positiveSenseSsrnaViralSequenceId;
	...
	public Integer getPositiveSenseSsrnaViralSequenceId() {
		return this.positiveSenseSsrnaViralSequenceId;
	}

	public void setPositiveSenseSsrnaViralSequenceId(
			Integer positiveSenseSsrnaViralSequenceId) {
		this.positiveSenseSsrnaViralSequenceId = positiveSenseSsrnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PositiveSenseSsrnaViralSequenceId))
			return false;
		PositiveSenseSsrnaViralSequenceId castOther = (PositiveSenseSsrnaViralSequenceId) other;

		return ((this.getPositiveSenseSsrnaViralSequenceId() == castOther
				.getPositiveSenseSsrnaViralSequenceId()) || (this
				.getPositiveSenseSsrnaViralSequenceId() != null
				&& castOther.getPositiveSenseSsrnaViralSequenceId() != null && this
				.getPositiveSenseSsrnaViralSequenceId().equals(
						castOther.getPositiveSenseSsrnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPositiveSenseSsrnaViralSequenceId() == null ? 0 : this
						.getPositiveSenseSsrnaViralSequenceId().hashCode());
		result = 37 * result
