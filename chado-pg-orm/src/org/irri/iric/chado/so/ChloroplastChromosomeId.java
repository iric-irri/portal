...
/**
 * ChloroplastChromosomeId generated by hbm2java
 */
public class ChloroplastChromosomeId implements java.io.Serializable {

	private Integer chloroplastChromosomeId;
	...
	public ChloroplastChromosomeId() {
	}

	public ChloroplastChromosomeId(Integer chloroplastChromosomeId,
		...
		this.chloroplastChromosomeId = chloroplastChromosomeId;
	...
	public Integer getChloroplastChromosomeId() {
		return this.chloroplastChromosomeId;
	}

	public void setChloroplastChromosomeId(Integer chloroplastChromosomeId) {
		this.chloroplastChromosomeId = chloroplastChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChloroplastChromosomeId))
			return false;
		ChloroplastChromosomeId castOther = (ChloroplastChromosomeId) other;

		return ((this.getChloroplastChromosomeId() == castOther
				.getChloroplastChromosomeId()) || (this
				.getChloroplastChromosomeId() != null
				&& castOther.getChloroplastChromosomeId() != null && this
				.getChloroplastChromosomeId().equals(
						castOther.getChloroplastChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChloroplastChromosomeId() == null ? 0 : this
						.getChloroplastChromosomeId().hashCode());
		result = 37 * result
