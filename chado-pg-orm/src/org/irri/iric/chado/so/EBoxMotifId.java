...
/**
 * EBoxMotifId generated by hbm2java
 */
public class EBoxMotifId implements java.io.Serializable {

	private Integer EBoxMotifId;
	...
	public EBoxMotifId(Integer EBoxMotifId, Integer featureId,
	...
	public Integer getEBoxMotifId() {
		return this.EBoxMotifId;
	}

	public void setEBoxMotifId(Integer EBoxMotifId) {
		this.EBoxMotifId = EBoxMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EBoxMotifId))
			return false;
		EBoxMotifId castOther = (EBoxMotifId) other;

		return ((this.getEBoxMotifId() == castOther.getEBoxMotifId()) || (this
				.getEBoxMotifId() != null && castOther.getEBoxMotifId() != null && this
				.getEBoxMotifId().equals(castOther.getEBoxMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEBoxMotifId() == null ? 0 : this.getEBoxMotifId()
						.hashCode());
		result = 37 * result
