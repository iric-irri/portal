...
/**
 * FivePrimeDRecombinationSignalSequenceId generated by hbm2java
 */
public class FivePrimeDRecombinationSignalSequenceId implements
		java.io.Serializable {

	private Integer fivePrimeDRecombinationSignalSequenceId;
	...
	public FivePrimeDRecombinationSignalSequenceId() {
	}

	public FivePrimeDRecombinationSignalSequenceId(
			Integer fivePrimeDRecombinationSignalSequenceId, Integer featureId,
		...
		this.fivePrimeDRecombinationSignalSequenceId = fivePrimeDRecombinationSignalSequenceId;
	...
	public Integer getFivePrimeDRecombinationSignalSequenceId() {
		return this.fivePrimeDRecombinationSignalSequenceId;
	}

	public void setFivePrimeDRecombinationSignalSequenceId(
			Integer fivePrimeDRecombinationSignalSequenceId) {
		this.fivePrimeDRecombinationSignalSequenceId = fivePrimeDRecombinationSignalSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeDRecombinationSignalSequenceId))
			return false;
		FivePrimeDRecombinationSignalSequenceId castOther = (FivePrimeDRecombinationSignalSequenceId) other;

		return ((this.getFivePrimeDRecombinationSignalSequenceId() == castOther
				.getFivePrimeDRecombinationSignalSequenceId()) || (this
				.getFivePrimeDRecombinationSignalSequenceId() != null
				&& castOther.getFivePrimeDRecombinationSignalSequenceId() != null && this
				.getFivePrimeDRecombinationSignalSequenceId().equals(
						castOther.getFivePrimeDRecombinationSignalSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeDRecombinationSignalSequenceId() == null ? 0
						: this.getFivePrimeDRecombinationSignalSequenceId()
								.hashCode());
		result = 37 * result
