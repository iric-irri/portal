...
/**
 * NmdTranscriptVariantId generated by hbm2java
 */
public class NmdTranscriptVariantId implements java.io.Serializable {

	private Integer nmdTranscriptVariantId;
	...
	public NmdTranscriptVariantId() {
	}

	public NmdTranscriptVariantId(Integer nmdTranscriptVariantId,
		...
		this.nmdTranscriptVariantId = nmdTranscriptVariantId;
	...
	public Integer getNmdTranscriptVariantId() {
		return this.nmdTranscriptVariantId;
	}

	public void setNmdTranscriptVariantId(Integer nmdTranscriptVariantId) {
		this.nmdTranscriptVariantId = nmdTranscriptVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NmdTranscriptVariantId))
			return false;
		NmdTranscriptVariantId castOther = (NmdTranscriptVariantId) other;

		return ((this.getNmdTranscriptVariantId() == castOther
				.getNmdTranscriptVariantId()) || (this
				.getNmdTranscriptVariantId() != null
				&& castOther.getNmdTranscriptVariantId() != null && this
				.getNmdTranscriptVariantId().equals(
						castOther.getNmdTranscriptVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNmdTranscriptVariantId() == null ? 0 : this
						.getNmdTranscriptVariantId().hashCode());
		result = 37 * result
