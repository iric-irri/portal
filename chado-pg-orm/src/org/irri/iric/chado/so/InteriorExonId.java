...
/**
 * InteriorExonId generated by hbm2java
 */
public class InteriorExonId implements java.io.Serializable {

	private Integer interiorExonId;
	...
	public InteriorExonId() {
	}

	public InteriorExonId(Integer interiorExonId, Integer featureId,
		...
		this.interiorExonId = interiorExonId;
	...
	public Integer getInteriorExonId() {
		return this.interiorExonId;
	}

	public void setInteriorExonId(Integer interiorExonId) {
		this.interiorExonId = interiorExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InteriorExonId))
			return false;
		InteriorExonId castOther = (InteriorExonId) other;

		return ((this.getInteriorExonId() == castOther.getInteriorExonId()) || (this
				.getInteriorExonId() != null
				&& castOther.getInteriorExonId() != null && this
				.getInteriorExonId().equals(castOther.getInteriorExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInteriorExonId() == null ? 0 : this.getInteriorExonId()
						.hashCode());
		result = 37 * result
