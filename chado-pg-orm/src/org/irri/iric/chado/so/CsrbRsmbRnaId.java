...
/**
 * CsrbRsmbRnaId generated by hbm2java
 */
public class CsrbRsmbRnaId implements java.io.Serializable {

	private Integer csrbRsmbRnaId;
	...
	public CsrbRsmbRnaId() {
	}

	public CsrbRsmbRnaId(Integer csrbRsmbRnaId, Integer featureId,
		...
		this.csrbRsmbRnaId = csrbRsmbRnaId;
	...
	public Integer getCsrbRsmbRnaId() {
		return this.csrbRsmbRnaId;
	}

	public void setCsrbRsmbRnaId(Integer csrbRsmbRnaId) {
		this.csrbRsmbRnaId = csrbRsmbRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CsrbRsmbRnaId))
			return false;
		CsrbRsmbRnaId castOther = (CsrbRsmbRnaId) other;

		return ((this.getCsrbRsmbRnaId() == castOther.getCsrbRsmbRnaId()) || (this
				.getCsrbRsmbRnaId() != null
				&& castOther.getCsrbRsmbRnaId() != null && this
				.getCsrbRsmbRnaId().equals(castOther.getCsrbRsmbRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCsrbRsmbRnaId() == null ? 0 : this.getCsrbRsmbRnaId()
						.hashCode());
		result = 37 * result
