...
/**
 * ElongatedInFramePolypeptideNTerminalElongationId generated by hbm2java
 */
public class ElongatedInFramePolypeptideNTerminalElongationId implements
		java.io.Serializable {

	private Integer elongatedInFramePolypeptideNTerminalElongationId;
	...
	public ElongatedInFramePolypeptideNTerminalElongationId() {
	}

	public ElongatedInFramePolypeptideNTerminalElongationId(
			Integer elongatedInFramePolypeptideNTerminalElongationId,
		...
		this.elongatedInFramePolypeptideNTerminalElongationId = elongatedInFramePolypeptideNTerminalElongationId;
	...
	public Integer getElongatedInFramePolypeptideNTerminalElongationId() {
		return this.elongatedInFramePolypeptideNTerminalElongationId;
	}

	public void setElongatedInFramePolypeptideNTerminalElongationId(
			Integer elongatedInFramePolypeptideNTerminalElongationId) {
		this.elongatedInFramePolypeptideNTerminalElongationId = elongatedInFramePolypeptideNTerminalElongationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedInFramePolypeptideNTerminalElongationId))
			return false;
		ElongatedInFramePolypeptideNTerminalElongationId castOther = (ElongatedInFramePolypeptideNTerminalElongationId) other;

		return ((this.getElongatedInFramePolypeptideNTerminalElongationId() == castOther
				.getElongatedInFramePolypeptideNTerminalElongationId()) || (this
				.getElongatedInFramePolypeptideNTerminalElongationId() != null
				&& castOther
						.getElongatedInFramePolypeptideNTerminalElongationId() != null && this
				.getElongatedInFramePolypeptideNTerminalElongationId()
				.equals(castOther
						.getElongatedInFramePolypeptideNTerminalElongationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedInFramePolypeptideNTerminalElongationId() == null ? 0
						: this.getElongatedInFramePolypeptideNTerminalElongationId()
								.hashCode());
		result = 37 * result
