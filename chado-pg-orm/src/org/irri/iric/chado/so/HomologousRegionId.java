...
/**
 * HomologousRegionId generated by hbm2java
 */
public class HomologousRegionId implements java.io.Serializable {

	private Integer homologousRegionId;
	...
	public HomologousRegionId() {
	}

	public HomologousRegionId(Integer homologousRegionId, Integer featureId,
		...
		this.homologousRegionId = homologousRegionId;
	...
	public Integer getHomologousRegionId() {
		return this.homologousRegionId;
	}

	public void setHomologousRegionId(Integer homologousRegionId) {
		this.homologousRegionId = homologousRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HomologousRegionId))
			return false;
		HomologousRegionId castOther = (HomologousRegionId) other;

		return ((this.getHomologousRegionId() == castOther
				.getHomologousRegionId()) || (this.getHomologousRegionId() != null
				&& castOther.getHomologousRegionId() != null && this
				.getHomologousRegionId().equals(
						castOther.getHomologousRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHomologousRegionId() == null ? 0 : this
						.getHomologousRegionId().hashCode());
		result = 37 * result
