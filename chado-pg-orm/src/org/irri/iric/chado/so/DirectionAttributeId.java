...
/**
 * DirectionAttributeId generated by hbm2java
 */
public class DirectionAttributeId implements java.io.Serializable {

	private Integer directionAttributeId;
	...
	public DirectionAttributeId() {
	}

	public DirectionAttributeId(Integer directionAttributeId,
		...
		this.directionAttributeId = directionAttributeId;
	...
	public Integer getDirectionAttributeId() {
		return this.directionAttributeId;
	}

	public void setDirectionAttributeId(Integer directionAttributeId) {
		this.directionAttributeId = directionAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DirectionAttributeId))
			return false;
		DirectionAttributeId castOther = (DirectionAttributeId) other;

		return ((this.getDirectionAttributeId() == castOther
				.getDirectionAttributeId()) || (this.getDirectionAttributeId() != null
				&& castOther.getDirectionAttributeId() != null && this
				.getDirectionAttributeId().equals(
						castOther.getDirectionAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDirectionAttributeId() == null ? 0 : this
						.getDirectionAttributeId().hashCode());
		result = 37 * result
