...
/**
 * EngineeredInsertId generated by hbm2java
 */
public class EngineeredInsertId implements java.io.Serializable {

	private Integer engineeredInsertId;
	...
	public EngineeredInsertId() {
	}

	public EngineeredInsertId(Integer engineeredInsertId, Integer featureId,
		...
		this.engineeredInsertId = engineeredInsertId;
	...
	public Integer getEngineeredInsertId() {
		return this.engineeredInsertId;
	}

	public void setEngineeredInsertId(Integer engineeredInsertId) {
		this.engineeredInsertId = engineeredInsertId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredInsertId))
			return false;
		EngineeredInsertId castOther = (EngineeredInsertId) other;

		return ((this.getEngineeredInsertId() == castOther
				.getEngineeredInsertId()) || (this.getEngineeredInsertId() != null
				&& castOther.getEngineeredInsertId() != null && this
				.getEngineeredInsertId().equals(
						castOther.getEngineeredInsertId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredInsertId() == null ? 0 : this
						.getEngineeredInsertId().hashCode());
		result = 37 * result
