...
/**
 * GeneWithEditedTranscriptId generated by hbm2java
 */
public class GeneWithEditedTranscriptId implements java.io.Serializable {

	private Integer geneWithEditedTranscriptId;
	...
	public GeneWithEditedTranscriptId() {
	}

	public GeneWithEditedTranscriptId(Integer geneWithEditedTranscriptId,
		...
		this.geneWithEditedTranscriptId = geneWithEditedTranscriptId;
	...
	public Integer getGeneWithEditedTranscriptId() {
		return this.geneWithEditedTranscriptId;
	}

	public void setGeneWithEditedTranscriptId(Integer geneWithEditedTranscriptId) {
		this.geneWithEditedTranscriptId = geneWithEditedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithEditedTranscriptId))
			return false;
		GeneWithEditedTranscriptId castOther = (GeneWithEditedTranscriptId) other;

		return ((this.getGeneWithEditedTranscriptId() == castOther
				.getGeneWithEditedTranscriptId()) || (this
				.getGeneWithEditedTranscriptId() != null
				&& castOther.getGeneWithEditedTranscriptId() != null && this
				.getGeneWithEditedTranscriptId().equals(
						castOther.getGeneWithEditedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithEditedTranscriptId() == null ? 0 : this
						.getGeneWithEditedTranscriptId().hashCode());
		result = 37 * result
