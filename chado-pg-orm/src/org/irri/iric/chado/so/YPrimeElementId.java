...
/**
 * YPrimeElementId generated by hbm2java
 */
public class YPrimeElementId implements java.io.Serializable {

	private Integer YPrimeElementId;
	...
	public YPrimeElementId() {
	}

	public YPrimeElementId(Integer YPrimeElementId, Integer featureId,
		...
		this.YPrimeElementId = YPrimeElementId;
	...
	public Integer getYPrimeElementId() {
		return this.YPrimeElementId;
	}

	public void setYPrimeElementId(Integer YPrimeElementId) {
		this.YPrimeElementId = YPrimeElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YPrimeElementId))
			return false;
		YPrimeElementId castOther = (YPrimeElementId) other;

		return ((this.getYPrimeElementId() == castOther.getYPrimeElementId()) || (this
				.getYPrimeElementId() != null
				&& castOther.getYPrimeElementId() != null && this
				.getYPrimeElementId().equals(castOther.getYPrimeElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getYPrimeElementId() == null ? 0 : this.getYPrimeElementId()
						.hashCode());
		result = 37 * result
