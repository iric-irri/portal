...
/**
 * PseudogeneId generated by hbm2java
 */
public class PseudogeneId implements java.io.Serializable {

	private Integer pseudogeneId;
	...
	public PseudogeneId(Integer pseudogeneId, Integer featureId,
	...
	public Integer getPseudogeneId() {
		return this.pseudogeneId;
	}

	public void setPseudogeneId(Integer pseudogeneId) {
		this.pseudogeneId = pseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogeneId))
			return false;
		PseudogeneId castOther = (PseudogeneId) other;

		return ((this.getPseudogeneId() == castOther.getPseudogeneId()) || (this
				.getPseudogeneId() != null
				&& castOther.getPseudogeneId() != null && this
				.getPseudogeneId().equals(castOther.getPseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogeneId() == null ? 0 : this.getPseudogeneId()
						.hashCode());
		result = 37 * result
