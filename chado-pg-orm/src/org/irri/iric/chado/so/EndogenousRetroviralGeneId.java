...
/**
 * EndogenousRetroviralGeneId generated by hbm2java
 */
public class EndogenousRetroviralGeneId implements java.io.Serializable {

	private Integer endogenousRetroviralGeneId;
	...
	public EndogenousRetroviralGeneId() {
	}

	public EndogenousRetroviralGeneId(Integer endogenousRetroviralGeneId,
		...
		this.endogenousRetroviralGeneId = endogenousRetroviralGeneId;
	...
	public Integer getEndogenousRetroviralGeneId() {
		return this.endogenousRetroviralGeneId;
	}

	public void setEndogenousRetroviralGeneId(Integer endogenousRetroviralGeneId) {
		this.endogenousRetroviralGeneId = endogenousRetroviralGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EndogenousRetroviralGeneId))
			return false;
		EndogenousRetroviralGeneId castOther = (EndogenousRetroviralGeneId) other;

		return ((this.getEndogenousRetroviralGeneId() == castOther
				.getEndogenousRetroviralGeneId()) || (this
				.getEndogenousRetroviralGeneId() != null
				&& castOther.getEndogenousRetroviralGeneId() != null && this
				.getEndogenousRetroviralGeneId().equals(
						castOther.getEndogenousRetroviralGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEndogenousRetroviralGeneId() == null ? 0 : this
						.getEndogenousRetroviralGeneId().hashCode());
		result = 37 * result
