...
/**
 * MrnaId generated by hbm2java
 */
public class MrnaId implements java.io.Serializable {
	...
	public MrnaId(Integer mrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMrnaId() {
		return this.mrnaId;
	}

	public void setMrnaId(Integer mrnaId) {
		this.mrnaId = mrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaId))
			return false;
		MrnaId castOther = (MrnaId) other;

		return ((this.getMrnaId() == castOther.getMrnaId()) || (this
				.getMrnaId() != null && castOther.getMrnaId() != null && this
				.getMrnaId().equals(castOther.getMrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMrnaId() == null ? 0 : this.getMrnaId().hashCode());
		result = 37 * result
