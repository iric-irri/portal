...
/**
 * CircularId generated by hbm2java
 */
public class CircularId implements java.io.Serializable {
	...
	public CircularId(Integer circularId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CircularId))
			return false;
		CircularId castOther = (CircularId) other;

		return ((this.getCircularId() == castOther.getCircularId()) || (this
				.getCircularId() != null && castOther.getCircularId() != null && this
				.getCircularId().equals(castOther.getCircularId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCircularId() == null ? 0 : this.getCircularId()
						.hashCode());
		result = 37 * result
