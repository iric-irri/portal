...
/**
 * MethylationGuideSnornaPrimaryTranscriptId generated by hbm2java
 */
public class MethylationGuideSnornaPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer methylationGuideSnornaPrimaryTranscriptId;
	...
	public MethylationGuideSnornaPrimaryTranscriptId() {
	}

	public MethylationGuideSnornaPrimaryTranscriptId(
			Integer methylationGuideSnornaPrimaryTranscriptId,
		...
		this.methylationGuideSnornaPrimaryTranscriptId = methylationGuideSnornaPrimaryTranscriptId;
	...
	public Integer getMethylationGuideSnornaPrimaryTranscriptId() {
		return this.methylationGuideSnornaPrimaryTranscriptId;
	}

	public void setMethylationGuideSnornaPrimaryTranscriptId(
			Integer methylationGuideSnornaPrimaryTranscriptId) {
		this.methylationGuideSnornaPrimaryTranscriptId = methylationGuideSnornaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylationGuideSnornaPrimaryTranscriptId))
			return false;
		MethylationGuideSnornaPrimaryTranscriptId castOther = (MethylationGuideSnornaPrimaryTranscriptId) other;

		return ((this.getMethylationGuideSnornaPrimaryTranscriptId() == castOther
				.getMethylationGuideSnornaPrimaryTranscriptId()) || (this
				.getMethylationGuideSnornaPrimaryTranscriptId() != null
				&& castOther.getMethylationGuideSnornaPrimaryTranscriptId() != null && this
				.getMethylationGuideSnornaPrimaryTranscriptId()
				.equals(castOther
						.getMethylationGuideSnornaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylationGuideSnornaPrimaryTranscriptId() == null ? 0
						: this.getMethylationGuideSnornaPrimaryTranscriptId()
								.hashCode());
		result = 37 * result
