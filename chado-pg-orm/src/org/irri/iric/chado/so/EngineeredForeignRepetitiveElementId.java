...
/**
 * EngineeredForeignRepetitiveElementId generated by hbm2java
 */
public class EngineeredForeignRepetitiveElementId implements
		java.io.Serializable {

	private Integer engineeredForeignRepetitiveElementId;
	...
	public EngineeredForeignRepetitiveElementId() {
	}

	public EngineeredForeignRepetitiveElementId(
			Integer engineeredForeignRepetitiveElementId, Integer featureId,
		...
		this.engineeredForeignRepetitiveElementId = engineeredForeignRepetitiveElementId;
	...
	public Integer getEngineeredForeignRepetitiveElementId() {
		return this.engineeredForeignRepetitiveElementId;
	}

	public void setEngineeredForeignRepetitiveElementId(
			Integer engineeredForeignRepetitiveElementId) {
		this.engineeredForeignRepetitiveElementId = engineeredForeignRepetitiveElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredForeignRepetitiveElementId))
			return false;
		EngineeredForeignRepetitiveElementId castOther = (EngineeredForeignRepetitiveElementId) other;

		return ((this.getEngineeredForeignRepetitiveElementId() == castOther
				.getEngineeredForeignRepetitiveElementId()) || (this
				.getEngineeredForeignRepetitiveElementId() != null
				&& castOther.getEngineeredForeignRepetitiveElementId() != null && this
				.getEngineeredForeignRepetitiveElementId().equals(
						castOther.getEngineeredForeignRepetitiveElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredForeignRepetitiveElementId() == null ? 0 : this
						.getEngineeredForeignRepetitiveElementId().hashCode());
		result = 37 * result
