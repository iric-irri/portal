...
/**
 * GoldenPathFragmentId generated by hbm2java
 */
public class GoldenPathFragmentId implements java.io.Serializable {

	private Integer goldenPathFragmentId;
	...
	public GoldenPathFragmentId() {
	}

	public GoldenPathFragmentId(Integer goldenPathFragmentId,
		...
		this.goldenPathFragmentId = goldenPathFragmentId;
	...
	public Integer getGoldenPathFragmentId() {
		return this.goldenPathFragmentId;
	}

	public void setGoldenPathFragmentId(Integer goldenPathFragmentId) {
		this.goldenPathFragmentId = goldenPathFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GoldenPathFragmentId))
			return false;
		GoldenPathFragmentId castOther = (GoldenPathFragmentId) other;

		return ((this.getGoldenPathFragmentId() == castOther
				.getGoldenPathFragmentId()) || (this.getGoldenPathFragmentId() != null
				&& castOther.getGoldenPathFragmentId() != null && this
				.getGoldenPathFragmentId().equals(
						castOther.getGoldenPathFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGoldenPathFragmentId() == null ? 0 : this
						.getGoldenPathFragmentId().hashCode());
		result = 37 * result
