...
/**
 * GlycylTrnaId generated by hbm2java
 */
public class GlycylTrnaId implements java.io.Serializable {

	private Integer glycylTrnaId;
	...
	public GlycylTrnaId(Integer glycylTrnaId, Integer featureId,
		...
		this.glycylTrnaId = glycylTrnaId;
	...
	public Integer getGlycylTrnaId() {
		return this.glycylTrnaId;
	}

	public void setGlycylTrnaId(Integer glycylTrnaId) {
		this.glycylTrnaId = glycylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlycylTrnaId))
			return false;
		GlycylTrnaId castOther = (GlycylTrnaId) other;

		return ((this.getGlycylTrnaId() == castOther.getGlycylTrnaId()) || (this
				.getGlycylTrnaId() != null
				&& castOther.getGlycylTrnaId() != null && this
				.getGlycylTrnaId().equals(castOther.getGlycylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlycylTrnaId() == null ? 0 : this.getGlycylTrnaId()
						.hashCode());
		result = 37 * result
