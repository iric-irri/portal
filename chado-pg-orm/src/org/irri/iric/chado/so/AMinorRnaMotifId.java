...
/**
 * AMinorRnaMotifId generated by hbm2java
 */
public class AMinorRnaMotifId implements java.io.Serializable {

	private Integer AMinorRnaMotifId;
	...
	public AMinorRnaMotifId() {
	}

	public AMinorRnaMotifId(Integer AMinorRnaMotifId, Integer featureId,
		...
		this.AMinorRnaMotifId = AMinorRnaMotifId;
	...
	public Integer getAMinorRnaMotifId() {
		return this.AMinorRnaMotifId;
	}

	public void setAMinorRnaMotifId(Integer AMinorRnaMotifId) {
		this.AMinorRnaMotifId = AMinorRnaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AMinorRnaMotifId))
			return false;
		AMinorRnaMotifId castOther = (AMinorRnaMotifId) other;

		return ((this.getAMinorRnaMotifId() == castOther.getAMinorRnaMotifId()) || (this
				.getAMinorRnaMotifId() != null
				&& castOther.getAMinorRnaMotifId() != null && this
				.getAMinorRnaMotifId().equals(castOther.getAMinorRnaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAMinorRnaMotifId() == null ? 0 : this
						.getAMinorRnaMotifId().hashCode());
		result = 37 * result
