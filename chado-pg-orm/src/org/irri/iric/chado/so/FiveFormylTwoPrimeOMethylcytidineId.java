...
/**
 * FiveFormylTwoPrimeOMethylcytidineId generated by hbm2java
 */
public class FiveFormylTwoPrimeOMethylcytidineId implements
		java.io.Serializable {

	private Integer fiveFormylTwoPrimeOMethylcytidineId;
	...
	public FiveFormylTwoPrimeOMethylcytidineId() {
	}

	public FiveFormylTwoPrimeOMethylcytidineId(
			Integer fiveFormylTwoPrimeOMethylcytidineId, Integer featureId,
		...
		this.fiveFormylTwoPrimeOMethylcytidineId = fiveFormylTwoPrimeOMethylcytidineId;
	...
	public Integer getFiveFormylTwoPrimeOMethylcytidineId() {
		return this.fiveFormylTwoPrimeOMethylcytidineId;
	}

	public void setFiveFormylTwoPrimeOMethylcytidineId(
			Integer fiveFormylTwoPrimeOMethylcytidineId) {
		this.fiveFormylTwoPrimeOMethylcytidineId = fiveFormylTwoPrimeOMethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveFormylTwoPrimeOMethylcytidineId))
			return false;
		FiveFormylTwoPrimeOMethylcytidineId castOther = (FiveFormylTwoPrimeOMethylcytidineId) other;

		return ((this.getFiveFormylTwoPrimeOMethylcytidineId() == castOther
				.getFiveFormylTwoPrimeOMethylcytidineId()) || (this
				.getFiveFormylTwoPrimeOMethylcytidineId() != null
				&& castOther.getFiveFormylTwoPrimeOMethylcytidineId() != null && this
				.getFiveFormylTwoPrimeOMethylcytidineId().equals(
						castOther.getFiveFormylTwoPrimeOMethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveFormylTwoPrimeOMethylcytidineId() == null ? 0 : this
						.getFiveFormylTwoPrimeOMethylcytidineId().hashCode());
		result = 37 * result
