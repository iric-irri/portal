...
/**
 * MitochondrialChromosomeId generated by hbm2java
 */
public class MitochondrialChromosomeId implements java.io.Serializable {

	private Integer mitochondrialChromosomeId;
	...
	public MitochondrialChromosomeId() {
	}

	public MitochondrialChromosomeId(Integer mitochondrialChromosomeId,
		...
		this.mitochondrialChromosomeId = mitochondrialChromosomeId;
	...
	public Integer getMitochondrialChromosomeId() {
		return this.mitochondrialChromosomeId;
	}

	public void setMitochondrialChromosomeId(Integer mitochondrialChromosomeId) {
		this.mitochondrialChromosomeId = mitochondrialChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MitochondrialChromosomeId))
			return false;
		MitochondrialChromosomeId castOther = (MitochondrialChromosomeId) other;

		return ((this.getMitochondrialChromosomeId() == castOther
				.getMitochondrialChromosomeId()) || (this
				.getMitochondrialChromosomeId() != null
				&& castOther.getMitochondrialChromosomeId() != null && this
				.getMitochondrialChromosomeId().equals(
						castOther.getMitochondrialChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMitochondrialChromosomeId() == null ? 0 : this
						.getMitochondrialChromosomeId().hashCode());
		result = 37 * result
