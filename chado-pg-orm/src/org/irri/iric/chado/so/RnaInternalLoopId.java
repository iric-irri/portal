...
/**
 * RnaInternalLoopId generated by hbm2java
 */
public class RnaInternalLoopId implements java.io.Serializable {

	private Integer rnaInternalLoopId;
	...
	public RnaInternalLoopId() {
	}

	public RnaInternalLoopId(Integer rnaInternalLoopId, Integer featureId,
		...
		this.rnaInternalLoopId = rnaInternalLoopId;
	...
	public Integer getRnaInternalLoopId() {
		return this.rnaInternalLoopId;
	}

	public void setRnaInternalLoopId(Integer rnaInternalLoopId) {
		this.rnaInternalLoopId = rnaInternalLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaInternalLoopId))
			return false;
		RnaInternalLoopId castOther = (RnaInternalLoopId) other;

		return ((this.getRnaInternalLoopId() == castOther
				.getRnaInternalLoopId()) || (this.getRnaInternalLoopId() != null
				&& castOther.getRnaInternalLoopId() != null && this
				.getRnaInternalLoopId()
				.equals(castOther.getRnaInternalLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaInternalLoopId() == null ? 0 : this
						.getRnaInternalLoopId().hashCode());
		result = 37 * result
