...
/**
 * UndermodifiedHydroxywybutosineId generated by hbm2java
 */
public class UndermodifiedHydroxywybutosineId implements java.io.Serializable {

	private Integer undermodifiedHydroxywybutosineId;
	...
	public UndermodifiedHydroxywybutosineId() {
	}

	public UndermodifiedHydroxywybutosineId(
			Integer undermodifiedHydroxywybutosineId, Integer featureId,
		...
		this.undermodifiedHydroxywybutosineId = undermodifiedHydroxywybutosineId;
	...
	public Integer getUndermodifiedHydroxywybutosineId() {
		return this.undermodifiedHydroxywybutosineId;
	}

	public void setUndermodifiedHydroxywybutosineId(
			Integer undermodifiedHydroxywybutosineId) {
		this.undermodifiedHydroxywybutosineId = undermodifiedHydroxywybutosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UndermodifiedHydroxywybutosineId))
			return false;
		UndermodifiedHydroxywybutosineId castOther = (UndermodifiedHydroxywybutosineId) other;

		return ((this.getUndermodifiedHydroxywybutosineId() == castOther
				.getUndermodifiedHydroxywybutosineId()) || (this
				.getUndermodifiedHydroxywybutosineId() != null
				&& castOther.getUndermodifiedHydroxywybutosineId() != null && this
				.getUndermodifiedHydroxywybutosineId().equals(
						castOther.getUndermodifiedHydroxywybutosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUndermodifiedHydroxywybutosineId() == null ? 0 : this
						.getUndermodifiedHydroxywybutosineId().hashCode());
		result = 37 * result
