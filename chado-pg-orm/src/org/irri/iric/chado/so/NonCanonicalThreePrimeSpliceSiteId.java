...
/**
 * NonCanonicalThreePrimeSpliceSiteId generated by hbm2java
 */
public class NonCanonicalThreePrimeSpliceSiteId implements java.io.Serializable {

	private Integer nonCanonicalThreePrimeSpliceSiteId;
	...
	public NonCanonicalThreePrimeSpliceSiteId() {
	}

	public NonCanonicalThreePrimeSpliceSiteId(
			Integer nonCanonicalThreePrimeSpliceSiteId, Integer featureId,
		...
		this.nonCanonicalThreePrimeSpliceSiteId = nonCanonicalThreePrimeSpliceSiteId;
	...
	public Integer getNonCanonicalThreePrimeSpliceSiteId() {
		return this.nonCanonicalThreePrimeSpliceSiteId;
	}

	public void setNonCanonicalThreePrimeSpliceSiteId(
			Integer nonCanonicalThreePrimeSpliceSiteId) {
		this.nonCanonicalThreePrimeSpliceSiteId = nonCanonicalThreePrimeSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonCanonicalThreePrimeSpliceSiteId))
			return false;
		NonCanonicalThreePrimeSpliceSiteId castOther = (NonCanonicalThreePrimeSpliceSiteId) other;

		return ((this.getNonCanonicalThreePrimeSpliceSiteId() == castOther
				.getNonCanonicalThreePrimeSpliceSiteId()) || (this
				.getNonCanonicalThreePrimeSpliceSiteId() != null
				&& castOther.getNonCanonicalThreePrimeSpliceSiteId() != null && this
				.getNonCanonicalThreePrimeSpliceSiteId().equals(
						castOther.getNonCanonicalThreePrimeSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonCanonicalThreePrimeSpliceSiteId() == null ? 0 : this
						.getNonCanonicalThreePrimeSpliceSiteId().hashCode());
		result = 37 * result
