...
/**
 * ThreePrimeThreePrimeOverlapId generated by hbm2java
 */
public class ThreePrimeThreePrimeOverlapId implements java.io.Serializable {

	private Integer threePrimeThreePrimeOverlapId;
	...
	public ThreePrimeThreePrimeOverlapId() {
	}

	public ThreePrimeThreePrimeOverlapId(Integer threePrimeThreePrimeOverlapId,
		...
		this.threePrimeThreePrimeOverlapId = threePrimeThreePrimeOverlapId;
	...
	public Integer getThreePrimeThreePrimeOverlapId() {
		return this.threePrimeThreePrimeOverlapId;
	}

	public void setThreePrimeThreePrimeOverlapId(
			Integer threePrimeThreePrimeOverlapId) {
		this.threePrimeThreePrimeOverlapId = threePrimeThreePrimeOverlapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeThreePrimeOverlapId))
			return false;
		ThreePrimeThreePrimeOverlapId castOther = (ThreePrimeThreePrimeOverlapId) other;

		return ((this.getThreePrimeThreePrimeOverlapId() == castOther
				.getThreePrimeThreePrimeOverlapId()) || (this
				.getThreePrimeThreePrimeOverlapId() != null
				&& castOther.getThreePrimeThreePrimeOverlapId() != null && this
				.getThreePrimeThreePrimeOverlapId().equals(
						castOther.getThreePrimeThreePrimeOverlapId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeThreePrimeOverlapId() == null ? 0 : this
						.getThreePrimeThreePrimeOverlapId().hashCode());
		result = 37 * result
