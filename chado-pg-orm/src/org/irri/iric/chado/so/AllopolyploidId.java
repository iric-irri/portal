...
/**
 * AllopolyploidId generated by hbm2java
 */
public class AllopolyploidId implements java.io.Serializable {

	private Integer allopolyploidId;
	...
	public AllopolyploidId() {
	}

	public AllopolyploidId(Integer allopolyploidId, Integer featureId,
		...
		this.allopolyploidId = allopolyploidId;
	...
	public Integer getAllopolyploidId() {
		return this.allopolyploidId;
	}

	public void setAllopolyploidId(Integer allopolyploidId) {
		this.allopolyploidId = allopolyploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AllopolyploidId))
			return false;
		AllopolyploidId castOther = (AllopolyploidId) other;

		return ((this.getAllopolyploidId() == castOther.getAllopolyploidId()) || (this
				.getAllopolyploidId() != null
				&& castOther.getAllopolyploidId() != null && this
				.getAllopolyploidId().equals(castOther.getAllopolyploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAllopolyploidId() == null ? 0 : this.getAllopolyploidId()
						.hashCode());
		result = 37 * result
