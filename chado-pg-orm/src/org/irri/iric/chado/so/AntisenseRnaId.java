...
/**
 * AntisenseRnaId generated by hbm2java
 */
public class AntisenseRnaId implements java.io.Serializable {

	private Integer antisenseRnaId;
	...
	public AntisenseRnaId() {
	}

	public AntisenseRnaId(Integer antisenseRnaId, Integer featureId,
		...
		this.antisenseRnaId = antisenseRnaId;
	...
	public Integer getAntisenseRnaId() {
		return this.antisenseRnaId;
	}

	public void setAntisenseRnaId(Integer antisenseRnaId) {
		this.antisenseRnaId = antisenseRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AntisenseRnaId))
			return false;
		AntisenseRnaId castOther = (AntisenseRnaId) other;

		return ((this.getAntisenseRnaId() == castOther.getAntisenseRnaId()) || (this
				.getAntisenseRnaId() != null
				&& castOther.getAntisenseRnaId() != null && this
				.getAntisenseRnaId().equals(castOther.getAntisenseRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAntisenseRnaId() == null ? 0 : this.getAntisenseRnaId()
						.hashCode());
		result = 37 * result
