...
/**
 * TranslationallyRegulatedId generated by hbm2java
 */
public class TranslationallyRegulatedId implements java.io.Serializable {

	private Integer translationallyRegulatedId;
	...
	public TranslationallyRegulatedId() {
	}

	public TranslationallyRegulatedId(Integer translationallyRegulatedId,
		...
		this.translationallyRegulatedId = translationallyRegulatedId;
	...
	public Integer getTranslationallyRegulatedId() {
		return this.translationallyRegulatedId;
	}

	public void setTranslationallyRegulatedId(Integer translationallyRegulatedId) {
		this.translationallyRegulatedId = translationallyRegulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationallyRegulatedId))
			return false;
		TranslationallyRegulatedId castOther = (TranslationallyRegulatedId) other;

		return ((this.getTranslationallyRegulatedId() == castOther
				.getTranslationallyRegulatedId()) || (this
				.getTranslationallyRegulatedId() != null
				&& castOther.getTranslationallyRegulatedId() != null && this
				.getTranslationallyRegulatedId().equals(
						castOther.getTranslationallyRegulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationallyRegulatedId() == null ? 0 : this
						.getTranslationallyRegulatedId().hashCode());
		result = 37 * result
