...
/**
 * DecreasedTranscriptStabilityVariantId generated by hbm2java
 */
public class DecreasedTranscriptStabilityVariantId implements
		java.io.Serializable {

	private Integer decreasedTranscriptStabilityVariantId;
	...
	public DecreasedTranscriptStabilityVariantId() {
	}

	public DecreasedTranscriptStabilityVariantId(
			Integer decreasedTranscriptStabilityVariantId, Integer featureId,
		...
		this.decreasedTranscriptStabilityVariantId = decreasedTranscriptStabilityVariantId;
	...
	public Integer getDecreasedTranscriptStabilityVariantId() {
		return this.decreasedTranscriptStabilityVariantId;
	}

	public void setDecreasedTranscriptStabilityVariantId(
			Integer decreasedTranscriptStabilityVariantId) {
		this.decreasedTranscriptStabilityVariantId = decreasedTranscriptStabilityVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecreasedTranscriptStabilityVariantId))
			return false;
		DecreasedTranscriptStabilityVariantId castOther = (DecreasedTranscriptStabilityVariantId) other;

		return ((this.getDecreasedTranscriptStabilityVariantId() == castOther
				.getDecreasedTranscriptStabilityVariantId()) || (this
				.getDecreasedTranscriptStabilityVariantId() != null
				&& castOther.getDecreasedTranscriptStabilityVariantId() != null && this
				.getDecreasedTranscriptStabilityVariantId().equals(
						castOther.getDecreasedTranscriptStabilityVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecreasedTranscriptStabilityVariantId() == null ? 0
						: this.getDecreasedTranscriptStabilityVariantId()
								.hashCode());
		result = 37 * result
