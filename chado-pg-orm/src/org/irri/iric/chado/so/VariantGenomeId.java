...
/**
 * VariantGenomeId generated by hbm2java
 */
public class VariantGenomeId implements java.io.Serializable {

	private Integer variantGenomeId;
	...
	public VariantGenomeId() {
	}

	public VariantGenomeId(Integer variantGenomeId, Integer featureId,
		...
		this.variantGenomeId = variantGenomeId;
	...
	public Integer getVariantGenomeId() {
		return this.variantGenomeId;
	}

	public void setVariantGenomeId(Integer variantGenomeId) {
		this.variantGenomeId = variantGenomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantGenomeId))
			return false;
		VariantGenomeId castOther = (VariantGenomeId) other;

		return ((this.getVariantGenomeId() == castOther.getVariantGenomeId()) || (this
				.getVariantGenomeId() != null
				&& castOther.getVariantGenomeId() != null && this
				.getVariantGenomeId().equals(castOther.getVariantGenomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantGenomeId() == null ? 0 : this.getVariantGenomeId()
						.hashCode());
		result = 37 * result
