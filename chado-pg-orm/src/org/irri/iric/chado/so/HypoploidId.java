...
/**
 * HypoploidId generated by hbm2java
 */
public class HypoploidId implements java.io.Serializable {

	private Integer hypoploidId;
	...
	public HypoploidId(Integer hypoploidId, Integer featureId,
	...
	public Integer getHypoploidId() {
		return this.hypoploidId;
	}

	public void setHypoploidId(Integer hypoploidId) {
		this.hypoploidId = hypoploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HypoploidId))
			return false;
		HypoploidId castOther = (HypoploidId) other;

		return ((this.getHypoploidId() == castOther.getHypoploidId()) || (this
				.getHypoploidId() != null && castOther.getHypoploidId() != null && this
				.getHypoploidId().equals(castOther.getHypoploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHypoploidId() == null ? 0 : this.getHypoploidId()
						.hashCode());
		result = 37 * result
