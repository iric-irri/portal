...
/**
 * TwoMethylthioN6IsopentenyladenosineId generated by hbm2java
 */
public class TwoMethylthioN6IsopentenyladenosineId implements
		java.io.Serializable {

	private Integer twoMethylthioN6IsopentenyladenosineId;
	...
	public TwoMethylthioN6IsopentenyladenosineId() {
	}

	public TwoMethylthioN6IsopentenyladenosineId(
			Integer twoMethylthioN6IsopentenyladenosineId, Integer featureId,
		...
		this.twoMethylthioN6IsopentenyladenosineId = twoMethylthioN6IsopentenyladenosineId;
	...
	public Integer getTwoMethylthioN6IsopentenyladenosineId() {
		return this.twoMethylthioN6IsopentenyladenosineId;
	}

	public void setTwoMethylthioN6IsopentenyladenosineId(
			Integer twoMethylthioN6IsopentenyladenosineId) {
		this.twoMethylthioN6IsopentenyladenosineId = twoMethylthioN6IsopentenyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethylthioN6IsopentenyladenosineId))
			return false;
		TwoMethylthioN6IsopentenyladenosineId castOther = (TwoMethylthioN6IsopentenyladenosineId) other;

		return ((this.getTwoMethylthioN6IsopentenyladenosineId() == castOther
				.getTwoMethylthioN6IsopentenyladenosineId()) || (this
				.getTwoMethylthioN6IsopentenyladenosineId() != null
				&& castOther.getTwoMethylthioN6IsopentenyladenosineId() != null && this
				.getTwoMethylthioN6IsopentenyladenosineId().equals(
						castOther.getTwoMethylthioN6IsopentenyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethylthioN6IsopentenyladenosineId() == null ? 0
						: this.getTwoMethylthioN6IsopentenyladenosineId()
								.hashCode());
		result = 37 * result
