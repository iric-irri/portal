...
/**
 * GnaOligoId generated by hbm2java
 */
public class GnaOligoId implements java.io.Serializable {

	private Integer gnaOligoId;
	...
	public GnaOligoId(Integer gnaOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGnaOligoId() {
		return this.gnaOligoId;
	}

	public void setGnaOligoId(Integer gnaOligoId) {
		this.gnaOligoId = gnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GnaOligoId))
			return false;
		GnaOligoId castOther = (GnaOligoId) other;

		return ((this.getGnaOligoId() == castOther.getGnaOligoId()) || (this
				.getGnaOligoId() != null && castOther.getGnaOligoId() != null && this
				.getGnaOligoId().equals(castOther.getGnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGnaOligoId() == null ? 0 : this.getGnaOligoId()
						.hashCode());
		result = 37 * result
