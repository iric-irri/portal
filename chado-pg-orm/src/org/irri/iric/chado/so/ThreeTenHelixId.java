...
/**
 * ThreeTenHelixId generated by hbm2java
 */
public class ThreeTenHelixId implements java.io.Serializable {

	private Integer threeTenHelixId;
	...
	public ThreeTenHelixId() {
	}

	public ThreeTenHelixId(Integer threeTenHelixId, Integer featureId,
		...
		this.threeTenHelixId = threeTenHelixId;
	...
	public Integer getThreeTenHelixId() {
		return this.threeTenHelixId;
	}

	public void setThreeTenHelixId(Integer threeTenHelixId) {
		this.threeTenHelixId = threeTenHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeTenHelixId))
			return false;
		ThreeTenHelixId castOther = (ThreeTenHelixId) other;

		return ((this.getThreeTenHelixId() == castOther.getThreeTenHelixId()) || (this
				.getThreeTenHelixId() != null
				&& castOther.getThreeTenHelixId() != null && this
				.getThreeTenHelixId().equals(castOther.getThreeTenHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeTenHelixId() == null ? 0 : this.getThreeTenHelixId()
						.hashCode());
		result = 37 * result
