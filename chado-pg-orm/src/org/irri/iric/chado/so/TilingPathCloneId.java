...
/**
 * TilingPathCloneId generated by hbm2java
 */
public class TilingPathCloneId implements java.io.Serializable {

	private Integer tilingPathCloneId;
	...
	public TilingPathCloneId() {
	}

	public TilingPathCloneId(Integer tilingPathCloneId, Integer featureId,
		...
		this.tilingPathCloneId = tilingPathCloneId;
	...
	public Integer getTilingPathCloneId() {
		return this.tilingPathCloneId;
	}

	public void setTilingPathCloneId(Integer tilingPathCloneId) {
		this.tilingPathCloneId = tilingPathCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TilingPathCloneId))
			return false;
		TilingPathCloneId castOther = (TilingPathCloneId) other;

		return ((this.getTilingPathCloneId() == castOther
				.getTilingPathCloneId()) || (this.getTilingPathCloneId() != null
				&& castOther.getTilingPathCloneId() != null && this
				.getTilingPathCloneId()
				.equals(castOther.getTilingPathCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTilingPathCloneId() == null ? 0 : this
						.getTilingPathCloneId().hashCode());
		result = 37 * result
