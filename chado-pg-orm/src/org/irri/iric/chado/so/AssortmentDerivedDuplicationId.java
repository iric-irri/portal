...
/**
 * AssortmentDerivedDuplicationId generated by hbm2java
 */
public class AssortmentDerivedDuplicationId implements java.io.Serializable {

	private Integer assortmentDerivedDuplicationId;
	...
	public AssortmentDerivedDuplicationId() {
	}

	public AssortmentDerivedDuplicationId(
			Integer assortmentDerivedDuplicationId, Integer featureId,
		...
		this.assortmentDerivedDuplicationId = assortmentDerivedDuplicationId;
	...
	public Integer getAssortmentDerivedDuplicationId() {
		return this.assortmentDerivedDuplicationId;
	}

	public void setAssortmentDerivedDuplicationId(
			Integer assortmentDerivedDuplicationId) {
		this.assortmentDerivedDuplicationId = assortmentDerivedDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssortmentDerivedDuplicationId))
			return false;
		AssortmentDerivedDuplicationId castOther = (AssortmentDerivedDuplicationId) other;

		return ((this.getAssortmentDerivedDuplicationId() == castOther
				.getAssortmentDerivedDuplicationId()) || (this
				.getAssortmentDerivedDuplicationId() != null
				&& castOther.getAssortmentDerivedDuplicationId() != null && this
				.getAssortmentDerivedDuplicationId().equals(
						castOther.getAssortmentDerivedDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssortmentDerivedDuplicationId() == null ? 0 : this
						.getAssortmentDerivedDuplicationId().hashCode());
		result = 37 * result
