...
/**
 * ModifiedLTyrosineId generated by hbm2java
 */
public class ModifiedLTyrosineId implements java.io.Serializable {

	private Integer modifiedLTyrosineId;
	...
	public ModifiedLTyrosineId() {
	}

	public ModifiedLTyrosineId(Integer modifiedLTyrosineId, Integer featureId,
		...
		this.modifiedLTyrosineId = modifiedLTyrosineId;
	...
	public Integer getModifiedLTyrosineId() {
		return this.modifiedLTyrosineId;
	}

	public void setModifiedLTyrosineId(Integer modifiedLTyrosineId) {
		this.modifiedLTyrosineId = modifiedLTyrosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLTyrosineId))
			return false;
		ModifiedLTyrosineId castOther = (ModifiedLTyrosineId) other;

		return ((this.getModifiedLTyrosineId() == castOther
				.getModifiedLTyrosineId()) || (this.getModifiedLTyrosineId() != null
				&& castOther.getModifiedLTyrosineId() != null && this
				.getModifiedLTyrosineId().equals(
						castOther.getModifiedLTyrosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLTyrosineId() == null ? 0 : this
						.getModifiedLTyrosineId().hashCode());
		result = 37 * result
