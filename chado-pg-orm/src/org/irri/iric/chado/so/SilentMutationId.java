...
/**
 * SilentMutationId generated by hbm2java
 */
public class SilentMutationId implements java.io.Serializable {

	private Integer silentMutationId;
	...
	public SilentMutationId() {
	}

	public SilentMutationId(Integer silentMutationId, Integer featureId,
		...
		this.silentMutationId = silentMutationId;
	...
	public Integer getSilentMutationId() {
		return this.silentMutationId;
	}

	public void setSilentMutationId(Integer silentMutationId) {
		this.silentMutationId = silentMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilentMutationId))
			return false;
		SilentMutationId castOther = (SilentMutationId) other;

		return ((this.getSilentMutationId() == castOther.getSilentMutationId()) || (this
				.getSilentMutationId() != null
				&& castOther.getSilentMutationId() != null && this
				.getSilentMutationId().equals(castOther.getSilentMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilentMutationId() == null ? 0 : this
						.getSilentMutationId().hashCode());
		result = 37 * result
