...
/**
 * EngineeredTransposableElementId generated by hbm2java
 */
public class EngineeredTransposableElementId implements java.io.Serializable {

	private Integer engineeredTransposableElementId;
	...
	public EngineeredTransposableElementId() {
	}

	public EngineeredTransposableElementId(
			Integer engineeredTransposableElementId, Integer featureId,
		...
		this.engineeredTransposableElementId = engineeredTransposableElementId;
	...
	public Integer getEngineeredTransposableElementId() {
		return this.engineeredTransposableElementId;
	}

	public void setEngineeredTransposableElementId(
			Integer engineeredTransposableElementId) {
		this.engineeredTransposableElementId = engineeredTransposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredTransposableElementId))
			return false;
		EngineeredTransposableElementId castOther = (EngineeredTransposableElementId) other;

		return ((this.getEngineeredTransposableElementId() == castOther
				.getEngineeredTransposableElementId()) || (this
				.getEngineeredTransposableElementId() != null
				&& castOther.getEngineeredTransposableElementId() != null && this
				.getEngineeredTransposableElementId().equals(
						castOther.getEngineeredTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredTransposableElementId() == null ? 0 : this
						.getEngineeredTransposableElementId().hashCode());
		result = 37 * result
