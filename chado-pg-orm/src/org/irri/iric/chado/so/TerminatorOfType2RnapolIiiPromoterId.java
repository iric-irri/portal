...
/**
 * TerminatorOfType2RnapolIiiPromoterId generated by hbm2java
 */
public class TerminatorOfType2RnapolIiiPromoterId implements
		java.io.Serializable {

	private Integer terminatorOfType2RnapolIiiPromoterId;
	...
	public TerminatorOfType2RnapolIiiPromoterId() {
	}

	public TerminatorOfType2RnapolIiiPromoterId(
			Integer terminatorOfType2RnapolIiiPromoterId, Integer featureId,
		...
		this.terminatorOfType2RnapolIiiPromoterId = terminatorOfType2RnapolIiiPromoterId;
	...
	public Integer getTerminatorOfType2RnapolIiiPromoterId() {
		return this.terminatorOfType2RnapolIiiPromoterId;
	}

	public void setTerminatorOfType2RnapolIiiPromoterId(
			Integer terminatorOfType2RnapolIiiPromoterId) {
		this.terminatorOfType2RnapolIiiPromoterId = terminatorOfType2RnapolIiiPromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminatorOfType2RnapolIiiPromoterId))
			return false;
		TerminatorOfType2RnapolIiiPromoterId castOther = (TerminatorOfType2RnapolIiiPromoterId) other;

		return ((this.getTerminatorOfType2RnapolIiiPromoterId() == castOther
				.getTerminatorOfType2RnapolIiiPromoterId()) || (this
				.getTerminatorOfType2RnapolIiiPromoterId() != null
				&& castOther.getTerminatorOfType2RnapolIiiPromoterId() != null && this
				.getTerminatorOfType2RnapolIiiPromoterId().equals(
						castOther.getTerminatorOfType2RnapolIiiPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminatorOfType2RnapolIiiPromoterId() == null ? 0 : this
						.getTerminatorOfType2RnapolIiiPromoterId().hashCode());
		result = 37 * result
