...
/**
 * LnaId generated by hbm2java
 */
public class LnaId implements java.io.Serializable {

	private Integer lnaId;
	...
	public LnaId(Integer lnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLnaId() {
		return this.lnaId;
	}

	public void setLnaId(Integer lnaId) {
		this.lnaId = lnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LnaId))
			return false;
		LnaId castOther = (LnaId) other;

		return ((this.getLnaId() == castOther.getLnaId()) || (this.getLnaId() != null
				&& castOther.getLnaId() != null && this.getLnaId().equals(
				castOther.getLnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getLnaId() == null ? 0 : this.getLnaId().hashCode());
		result = 37 * result
