...
/**
 * InsertionId generated by hbm2java
 */
public class InsertionId implements java.io.Serializable {
	...
	public InsertionId(Integer insertionId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionId))
			return false;
		InsertionId castOther = (InsertionId) other;

		return ((this.getInsertionId() == castOther.getInsertionId()) || (this
				.getInsertionId() != null && castOther.getInsertionId() != null && this
				.getInsertionId().equals(castOther.getInsertionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionId() == null ? 0 : this.getInsertionId()
						.hashCode());
		result = 37 * result
