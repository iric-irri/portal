...
/**
 * FivePrimeEstId generated by hbm2java
 */
public class FivePrimeEstId implements java.io.Serializable {

	private Integer fivePrimeEstId;
	...
	public FivePrimeEstId() {
	}

	public FivePrimeEstId(Integer fivePrimeEstId, Integer featureId,
		...
		this.fivePrimeEstId = fivePrimeEstId;
	...
	public Integer getFivePrimeEstId() {
		return this.fivePrimeEstId;
	}

	public void setFivePrimeEstId(Integer fivePrimeEstId) {
		this.fivePrimeEstId = fivePrimeEstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeEstId))
			return false;
		FivePrimeEstId castOther = (FivePrimeEstId) other;

		return ((this.getFivePrimeEstId() == castOther.getFivePrimeEstId()) || (this
				.getFivePrimeEstId() != null
				&& castOther.getFivePrimeEstId() != null && this
				.getFivePrimeEstId().equals(castOther.getFivePrimeEstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeEstId() == null ? 0 : this.getFivePrimeEstId()
						.hashCode());
		result = 37 * result
