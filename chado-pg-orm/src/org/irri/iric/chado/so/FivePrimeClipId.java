...
/**
 * FivePrimeClipId generated by hbm2java
 */
public class FivePrimeClipId implements java.io.Serializable {

	private Integer fivePrimeClipId;
	...
	public FivePrimeClipId() {
	}

	public FivePrimeClipId(Integer fivePrimeClipId, Integer featureId,
		...
		this.fivePrimeClipId = fivePrimeClipId;
	...
	public Integer getFivePrimeClipId() {
		return this.fivePrimeClipId;
	}

	public void setFivePrimeClipId(Integer fivePrimeClipId) {
		this.fivePrimeClipId = fivePrimeClipId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeClipId))
			return false;
		FivePrimeClipId castOther = (FivePrimeClipId) other;

		return ((this.getFivePrimeClipId() == castOther.getFivePrimeClipId()) || (this
				.getFivePrimeClipId() != null
				&& castOther.getFivePrimeClipId() != null && this
				.getFivePrimeClipId().equals(castOther.getFivePrimeClipId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeClipId() == null ? 0 : this.getFivePrimeClipId()
						.hashCode());
		result = 37 * result
