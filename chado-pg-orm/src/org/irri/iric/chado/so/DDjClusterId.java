...
/**
 * DDjClusterId generated by hbm2java
 */
public class DDjClusterId implements java.io.Serializable {

	private Integer DDjClusterId;
	...
	public DDjClusterId(Integer DDjClusterId, Integer featureId,
		...
		this.DDjClusterId = DDjClusterId;
	...
	public Integer getDDjClusterId() {
		return this.DDjClusterId;
	}

	public void setDDjClusterId(Integer DDjClusterId) {
		this.DDjClusterId = DDjClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DDjClusterId))
			return false;
		DDjClusterId castOther = (DDjClusterId) other;

		return ((this.getDDjClusterId() == castOther.getDDjClusterId()) || (this
				.getDDjClusterId() != null
				&& castOther.getDDjClusterId() != null && this
				.getDDjClusterId().equals(castOther.getDDjClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDDjClusterId() == null ? 0 : this.getDDjClusterId()
						.hashCode());
		result = 37 * result
