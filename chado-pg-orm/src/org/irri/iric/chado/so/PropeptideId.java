...
/**
 * PropeptideId generated by hbm2java
 */
public class PropeptideId implements java.io.Serializable {

	private Integer propeptideId;
	...
	public PropeptideId(Integer propeptideId, Integer featureId,
		...
		this.propeptideId = propeptideId;
	...
	public Integer getPropeptideId() {
		return this.propeptideId;
	}

	public void setPropeptideId(Integer propeptideId) {
		this.propeptideId = propeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PropeptideId))
			return false;
		PropeptideId castOther = (PropeptideId) other;

		return ((this.getPropeptideId() == castOther.getPropeptideId()) || (this
				.getPropeptideId() != null
				&& castOther.getPropeptideId() != null && this
				.getPropeptideId().equals(castOther.getPropeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPropeptideId() == null ? 0 : this.getPropeptideId()
						.hashCode());
		result = 37 * result
