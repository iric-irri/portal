...
/**
 * TyrosineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class TyrosineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer tyrosineTrnaPrimaryTranscriptId;
	...
	public TyrosineTrnaPrimaryTranscriptId() {
	}

	public TyrosineTrnaPrimaryTranscriptId(
			Integer tyrosineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.tyrosineTrnaPrimaryTranscriptId = tyrosineTrnaPrimaryTranscriptId;
	...
	public Integer getTyrosineTrnaPrimaryTranscriptId() {
		return this.tyrosineTrnaPrimaryTranscriptId;
	}

	public void setTyrosineTrnaPrimaryTranscriptId(
			Integer tyrosineTrnaPrimaryTranscriptId) {
		this.tyrosineTrnaPrimaryTranscriptId = tyrosineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TyrosineTrnaPrimaryTranscriptId))
			return false;
		TyrosineTrnaPrimaryTranscriptId castOther = (TyrosineTrnaPrimaryTranscriptId) other;

		return ((this.getTyrosineTrnaPrimaryTranscriptId() == castOther
				.getTyrosineTrnaPrimaryTranscriptId()) || (this
				.getTyrosineTrnaPrimaryTranscriptId() != null
				&& castOther.getTyrosineTrnaPrimaryTranscriptId() != null && this
				.getTyrosineTrnaPrimaryTranscriptId().equals(
						castOther.getTyrosineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTyrosineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getTyrosineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
