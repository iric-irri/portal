...
/**
 * TmrnaGeneId generated by hbm2java
 */
public class TmrnaGeneId implements java.io.Serializable {

	private Integer tmrnaGeneId;
	...
	public TmrnaGeneId(Integer tmrnaGeneId, Integer featureId,
	...
	public Integer getTmrnaGeneId() {
		return this.tmrnaGeneId;
	}

	public void setTmrnaGeneId(Integer tmrnaGeneId) {
		this.tmrnaGeneId = tmrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaGeneId))
			return false;
		TmrnaGeneId castOther = (TmrnaGeneId) other;

		return ((this.getTmrnaGeneId() == castOther.getTmrnaGeneId()) || (this
				.getTmrnaGeneId() != null && castOther.getTmrnaGeneId() != null && this
				.getTmrnaGeneId().equals(castOther.getTmrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaGeneId() == null ? 0 : this.getTmrnaGeneId()
						.hashCode());
		result = 37 * result
