...
/**
 * InvalidatedByChimericCdnaId generated by hbm2java
 */
public class InvalidatedByChimericCdnaId implements java.io.Serializable {

	private Integer invalidatedByChimericCdnaId;
	...
	public InvalidatedByChimericCdnaId() {
	}

	public InvalidatedByChimericCdnaId(Integer invalidatedByChimericCdnaId,
		...
		this.invalidatedByChimericCdnaId = invalidatedByChimericCdnaId;
	...
	public Integer getInvalidatedByChimericCdnaId() {
		return this.invalidatedByChimericCdnaId;
	}

	public void setInvalidatedByChimericCdnaId(
			Integer invalidatedByChimericCdnaId) {
		this.invalidatedByChimericCdnaId = invalidatedByChimericCdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedByChimericCdnaId))
			return false;
		InvalidatedByChimericCdnaId castOther = (InvalidatedByChimericCdnaId) other;

		return ((this.getInvalidatedByChimericCdnaId() == castOther
				.getInvalidatedByChimericCdnaId()) || (this
				.getInvalidatedByChimericCdnaId() != null
				&& castOther.getInvalidatedByChimericCdnaId() != null && this
				.getInvalidatedByChimericCdnaId().equals(
						castOther.getInvalidatedByChimericCdnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedByChimericCdnaId() == null ? 0 : this
						.getInvalidatedByChimericCdnaId().hashCode());
		result = 37 * result
