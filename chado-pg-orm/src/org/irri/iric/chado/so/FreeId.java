...
/**
 * FreeId generated by hbm2java
 */
public class FreeId implements java.io.Serializable {
	...
	public FreeId(Integer freeId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreeId))
			return false;
		FreeId castOther = (FreeId) other;

		return ((this.getFreeId() == castOther.getFreeId()) || (this
				.getFreeId() != null && castOther.getFreeId() != null && this
				.getFreeId().equals(castOther.getFreeId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getFreeId() == null ? 0 : this.getFreeId().hashCode());
		result = 37 * result
