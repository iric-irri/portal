...
/**
 * ConformationalSwitchId generated by hbm2java
 */
public class ConformationalSwitchId implements java.io.Serializable {

	private Integer conformationalSwitchId;
	...
	public ConformationalSwitchId() {
	}

	public ConformationalSwitchId(Integer conformationalSwitchId,
		...
		this.conformationalSwitchId = conformationalSwitchId;
	...
	public Integer getConformationalSwitchId() {
		return this.conformationalSwitchId;
	}

	public void setConformationalSwitchId(Integer conformationalSwitchId) {
		this.conformationalSwitchId = conformationalSwitchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConformationalSwitchId))
			return false;
		ConformationalSwitchId castOther = (ConformationalSwitchId) other;

		return ((this.getConformationalSwitchId() == castOther
				.getConformationalSwitchId()) || (this
				.getConformationalSwitchId() != null
				&& castOther.getConformationalSwitchId() != null && this
				.getConformationalSwitchId().equals(
						castOther.getConformationalSwitchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConformationalSwitchId() == null ? 0 : this
						.getConformationalSwitchId().hashCode());
		result = 37 * result
