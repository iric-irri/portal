...
/**
 * AssemblyComponentId generated by hbm2java
 */
public class AssemblyComponentId implements java.io.Serializable {

	private Integer assemblyComponentId;
	...
	public AssemblyComponentId() {
	}

	public AssemblyComponentId(Integer assemblyComponentId, Integer featureId,
	...
	public Integer getAssemblyComponentId() {
		return this.assemblyComponentId;
	}

	public void setAssemblyComponentId(Integer assemblyComponentId) {
		this.assemblyComponentId = assemblyComponentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssemblyComponentId))
			return false;
		AssemblyComponentId castOther = (AssemblyComponentId) other;

		return ((this.getAssemblyComponentId() == castOther
				.getAssemblyComponentId()) || (this.getAssemblyComponentId() != null
				&& castOther.getAssemblyComponentId() != null && this
				.getAssemblyComponentId().equals(
						castOther.getAssemblyComponentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssemblyComponentId() == null ? 0 : this
						.getAssemblyComponentId().hashCode());
		result = 37 * result
