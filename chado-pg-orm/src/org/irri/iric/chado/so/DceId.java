...
/**
 * DceId generated by hbm2java
 */
public class DceId implements java.io.Serializable {

	private Integer dceId;
	...
	public DceId(Integer dceId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDceId() {
		return this.dceId;
	}

	public void setDceId(Integer dceId) {
		this.dceId = dceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DceId))
			return false;
		DceId castOther = (DceId) other;

		return ((this.getDceId() == castOther.getDceId()) || (this.getDceId() != null
				&& castOther.getDceId() != null && this.getDceId().equals(
				castOther.getDceId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDceId() == null ? 0 : this.getDceId().hashCode());
		result = 37 * result
