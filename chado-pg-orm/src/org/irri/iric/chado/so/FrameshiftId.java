...
/**
 * FrameshiftId generated by hbm2java
 */
public class FrameshiftId implements java.io.Serializable {

	private Integer frameshiftId;
	...
	public FrameshiftId(Integer frameshiftId, Integer featureId,
		...
		this.frameshiftId = frameshiftId;
	...
	public Integer getFrameshiftId() {
		return this.frameshiftId;
	}

	public void setFrameshiftId(Integer frameshiftId) {
		this.frameshiftId = frameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FrameshiftId))
			return false;
		FrameshiftId castOther = (FrameshiftId) other;

		return ((this.getFrameshiftId() == castOther.getFrameshiftId()) || (this
				.getFrameshiftId() != null
				&& castOther.getFrameshiftId() != null && this
				.getFrameshiftId().equals(castOther.getFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFrameshiftId() == null ? 0 : this.getFrameshiftId()
						.hashCode());
		result = 37 * result
