...
/**
 * ChromosomeId generated by hbm2java
 */
public class ChromosomeId implements java.io.Serializable {
	...
	public ChromosomeId(Integer chromosomeId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeId))
			return false;
		ChromosomeId castOther = (ChromosomeId) other;

		return ((this.getChromosomeId() == castOther.getChromosomeId()) || (this
				.getChromosomeId() != null
				&& castOther.getChromosomeId() != null && this
				.getChromosomeId().equals(castOther.getChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeId() == null ? 0 : this.getChromosomeId()
						.hashCode());
		result = 37 * result
