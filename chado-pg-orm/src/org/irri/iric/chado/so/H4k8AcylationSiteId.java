...
/**
 * H4k8AcylationSiteId generated by hbm2java
 */
public class H4k8AcylationSiteId implements java.io.Serializable {

	private Integer h4k8AcylationSiteId;
	...
	public H4k8AcylationSiteId() {
	}

	public H4k8AcylationSiteId(Integer h4k8AcylationSiteId, Integer featureId,
		...
		this.h4k8AcylationSiteId = h4k8AcylationSiteId;
	...
	public Integer getH4k8AcylationSiteId() {
		return this.h4k8AcylationSiteId;
	}

	public void setH4k8AcylationSiteId(Integer h4k8AcylationSiteId) {
		this.h4k8AcylationSiteId = h4k8AcylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H4k8AcylationSiteId))
			return false;
		H4k8AcylationSiteId castOther = (H4k8AcylationSiteId) other;

		return ((this.getH4k8AcylationSiteId() == castOther
				.getH4k8AcylationSiteId()) || (this.getH4k8AcylationSiteId() != null
				&& castOther.getH4k8AcylationSiteId() != null && this
				.getH4k8AcylationSiteId().equals(
						castOther.getH4k8AcylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH4k8AcylationSiteId() == null ? 0 : this
						.getH4k8AcylationSiteId().hashCode());
		result = 37 * result
