...
/**
 * ReciprocalChromosomalTranslocationId generated by hbm2java
 */
public class ReciprocalChromosomalTranslocationId implements
		java.io.Serializable {

	private Integer reciprocalChromosomalTranslocationId;
	...
	public ReciprocalChromosomalTranslocationId() {
	}

	public ReciprocalChromosomalTranslocationId(
			Integer reciprocalChromosomalTranslocationId, Integer featureId,
		...
		this.reciprocalChromosomalTranslocationId = reciprocalChromosomalTranslocationId;
	...
	public Integer getReciprocalChromosomalTranslocationId() {
		return this.reciprocalChromosomalTranslocationId;
	}

	public void setReciprocalChromosomalTranslocationId(
			Integer reciprocalChromosomalTranslocationId) {
		this.reciprocalChromosomalTranslocationId = reciprocalChromosomalTranslocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReciprocalChromosomalTranslocationId))
			return false;
		ReciprocalChromosomalTranslocationId castOther = (ReciprocalChromosomalTranslocationId) other;

		return ((this.getReciprocalChromosomalTranslocationId() == castOther
				.getReciprocalChromosomalTranslocationId()) || (this
				.getReciprocalChromosomalTranslocationId() != null
				&& castOther.getReciprocalChromosomalTranslocationId() != null && this
				.getReciprocalChromosomalTranslocationId().equals(
						castOther.getReciprocalChromosomalTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReciprocalChromosomalTranslocationId() == null ? 0 : this
						.getReciprocalChromosomalTranslocationId().hashCode());
		result = 37 * result
