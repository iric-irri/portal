...
/**
 * PolypeptideCalciumIonContactSiteId generated by hbm2java
 */
public class PolypeptideCalciumIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideCalciumIonContactSiteId;
	...
	public PolypeptideCalciumIonContactSiteId() {
	}

	public PolypeptideCalciumIonContactSiteId(
			Integer polypeptideCalciumIonContactSiteId, Integer featureId,
		...
		this.polypeptideCalciumIonContactSiteId = polypeptideCalciumIonContactSiteId;
	...
	public Integer getPolypeptideCalciumIonContactSiteId() {
		return this.polypeptideCalciumIonContactSiteId;
	}

	public void setPolypeptideCalciumIonContactSiteId(
			Integer polypeptideCalciumIonContactSiteId) {
		this.polypeptideCalciumIonContactSiteId = polypeptideCalciumIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideCalciumIonContactSiteId))
			return false;
		PolypeptideCalciumIonContactSiteId castOther = (PolypeptideCalciumIonContactSiteId) other;

		return ((this.getPolypeptideCalciumIonContactSiteId() == castOther
				.getPolypeptideCalciumIonContactSiteId()) || (this
				.getPolypeptideCalciumIonContactSiteId() != null
				&& castOther.getPolypeptideCalciumIonContactSiteId() != null && this
				.getPolypeptideCalciumIonContactSiteId().equals(
						castOther.getPolypeptideCalciumIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideCalciumIonContactSiteId() == null ? 0 : this
						.getPolypeptideCalciumIonContactSiteId().hashCode());
		result = 37 * result
