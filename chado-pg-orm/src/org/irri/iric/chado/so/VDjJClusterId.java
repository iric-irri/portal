...
/**
 * VDjJClusterId generated by hbm2java
 */
public class VDjJClusterId implements java.io.Serializable {

	private Integer VDjJClusterId;
	...
	public VDjJClusterId() {
	}

	public VDjJClusterId(Integer VDjJClusterId, Integer featureId,
		...
		this.VDjJClusterId = VDjJClusterId;
	...
	public Integer getVDjJClusterId() {
		return this.VDjJClusterId;
	}

	public void setVDjJClusterId(Integer VDjJClusterId) {
		this.VDjJClusterId = VDjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDjJClusterId))
			return false;
		VDjJClusterId castOther = (VDjJClusterId) other;

		return ((this.getVDjJClusterId() == castOther.getVDjJClusterId()) || (this
				.getVDjJClusterId() != null
				&& castOther.getVDjJClusterId() != null && this
				.getVDjJClusterId().equals(castOther.getVDjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDjJClusterId() == null ? 0 : this.getVDjJClusterId()
						.hashCode());
		result = 37 * result
