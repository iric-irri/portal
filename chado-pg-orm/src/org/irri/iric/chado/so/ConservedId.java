...
/**
 * ConservedId generated by hbm2java
 */
public class ConservedId implements java.io.Serializable {

	private Integer conservedId;
	...
	public ConservedId(Integer conservedId, Integer featureId,
	...
	public Integer getConservedId() {
		return this.conservedId;
	}

	public void setConservedId(Integer conservedId) {
		this.conservedId = conservedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConservedId))
			return false;
		ConservedId castOther = (ConservedId) other;

		return ((this.getConservedId() == castOther.getConservedId()) || (this
				.getConservedId() != null && castOther.getConservedId() != null && this
				.getConservedId().equals(castOther.getConservedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConservedId() == null ? 0 : this.getConservedId()
						.hashCode());
		result = 37 * result
