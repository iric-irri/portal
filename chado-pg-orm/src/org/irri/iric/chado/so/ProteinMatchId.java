...
/**
 * ProteinMatchId generated by hbm2java
 */
public class ProteinMatchId implements java.io.Serializable {
	...
	public ProteinMatchId() {
	}

	public ProteinMatchId(Integer proteinMatchId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinMatchId))
			return false;
		ProteinMatchId castOther = (ProteinMatchId) other;

		return ((this.getProteinMatchId() == castOther.getProteinMatchId()) || (this
				.getProteinMatchId() != null
				&& castOther.getProteinMatchId() != null && this
				.getProteinMatchId().equals(castOther.getProteinMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinMatchId() == null ? 0 : this.getProteinMatchId()
						.hashCode());
		result = 37 * result
