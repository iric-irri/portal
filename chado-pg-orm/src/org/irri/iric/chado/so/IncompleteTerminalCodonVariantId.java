...
/**
 * IncompleteTerminalCodonVariantId generated by hbm2java
 */
public class IncompleteTerminalCodonVariantId implements java.io.Serializable {

	private Integer incompleteTerminalCodonVariantId;
	...
	public IncompleteTerminalCodonVariantId() {
	}

	public IncompleteTerminalCodonVariantId(
			Integer incompleteTerminalCodonVariantId, Integer featureId,
		...
		this.incompleteTerminalCodonVariantId = incompleteTerminalCodonVariantId;
	...
	public Integer getIncompleteTerminalCodonVariantId() {
		return this.incompleteTerminalCodonVariantId;
	}

	public void setIncompleteTerminalCodonVariantId(
			Integer incompleteTerminalCodonVariantId) {
		this.incompleteTerminalCodonVariantId = incompleteTerminalCodonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncompleteTerminalCodonVariantId))
			return false;
		IncompleteTerminalCodonVariantId castOther = (IncompleteTerminalCodonVariantId) other;

		return ((this.getIncompleteTerminalCodonVariantId() == castOther
				.getIncompleteTerminalCodonVariantId()) || (this
				.getIncompleteTerminalCodonVariantId() != null
				&& castOther.getIncompleteTerminalCodonVariantId() != null && this
				.getIncompleteTerminalCodonVariantId().equals(
						castOther.getIncompleteTerminalCodonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncompleteTerminalCodonVariantId() == null ? 0 : this
						.getIncompleteTerminalCodonVariantId().hashCode());
		result = 37 * result
