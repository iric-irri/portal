...
/**
 * VVjClusterId generated by hbm2java
 */
public class VVjClusterId implements java.io.Serializable {

	private Integer VVjClusterId;
	...
	public VVjClusterId(Integer VVjClusterId, Integer featureId,
		...
		this.VVjClusterId = VVjClusterId;
	...
	public Integer getVVjClusterId() {
		return this.VVjClusterId;
	}

	public void setVVjClusterId(Integer VVjClusterId) {
		this.VVjClusterId = VVjClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVjClusterId))
			return false;
		VVjClusterId castOther = (VVjClusterId) other;

		return ((this.getVVjClusterId() == castOther.getVVjClusterId()) || (this
				.getVVjClusterId() != null
				&& castOther.getVVjClusterId() != null && this
				.getVVjClusterId().equals(castOther.getVVjClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVjClusterId() == null ? 0 : this.getVVjClusterId()
						.hashCode());
		result = 37 * result
