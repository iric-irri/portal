...
/**
 * AttbSiteId generated by hbm2java
 */
public class AttbSiteId implements java.io.Serializable {

	private Integer attbSiteId;
	...
	public AttbSiteId(Integer attbSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttbSiteId() {
		return this.attbSiteId;
	}

	public void setAttbSiteId(Integer attbSiteId) {
		this.attbSiteId = attbSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttbSiteId))
			return false;
		AttbSiteId castOther = (AttbSiteId) other;

		return ((this.getAttbSiteId() == castOther.getAttbSiteId()) || (this
				.getAttbSiteId() != null && castOther.getAttbSiteId() != null && this
				.getAttbSiteId().equals(castOther.getAttbSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttbSiteId() == null ? 0 : this.getAttbSiteId()
						.hashCode());
		result = 37 * result
