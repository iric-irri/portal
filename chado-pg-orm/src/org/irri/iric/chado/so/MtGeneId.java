...
/**
 * MtGeneId generated by hbm2java
 */
public class MtGeneId implements java.io.Serializable {

	private Integer mtGeneId;
	...
	public MtGeneId(Integer mtGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMtGeneId() {
		return this.mtGeneId;
	}

	public void setMtGeneId(Integer mtGeneId) {
		this.mtGeneId = mtGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MtGeneId))
			return false;
		MtGeneId castOther = (MtGeneId) other;

		return ((this.getMtGeneId() == castOther.getMtGeneId()) || (this
				.getMtGeneId() != null && castOther.getMtGeneId() != null && this
				.getMtGeneId().equals(castOther.getMtGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMtGeneId() == null ? 0 : this.getMtGeneId().hashCode());
		result = 37 * result
