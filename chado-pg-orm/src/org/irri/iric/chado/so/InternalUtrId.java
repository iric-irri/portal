...
/**
 * InternalUtrId generated by hbm2java
 */
public class InternalUtrId implements java.io.Serializable {

	private Integer internalUtrId;
	...
	public InternalUtrId() {
	}

	public InternalUtrId(Integer internalUtrId, Integer featureId,
		...
		this.internalUtrId = internalUtrId;
	...
	public Integer getInternalUtrId() {
		return this.internalUtrId;
	}

	public void setInternalUtrId(Integer internalUtrId) {
		this.internalUtrId = internalUtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalUtrId))
			return false;
		InternalUtrId castOther = (InternalUtrId) other;

		return ((this.getInternalUtrId() == castOther.getInternalUtrId()) || (this
				.getInternalUtrId() != null
				&& castOther.getInternalUtrId() != null && this
				.getInternalUtrId().equals(castOther.getInternalUtrId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalUtrId() == null ? 0 : this.getInternalUtrId()
						.hashCode());
		result = 37 * result
