...
/**
 * Dmv2MotifId generated by hbm2java
 */
public class Dmv2MotifId implements java.io.Serializable {

	private Integer dmv2MotifId;
	...
	public Dmv2MotifId(Integer dmv2MotifId, Integer featureId,
	...
	public Integer getDmv2MotifId() {
		return this.dmv2MotifId;
	}

	public void setDmv2MotifId(Integer dmv2MotifId) {
		this.dmv2MotifId = dmv2MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dmv2MotifId))
			return false;
		Dmv2MotifId castOther = (Dmv2MotifId) other;

		return ((this.getDmv2MotifId() == castOther.getDmv2MotifId()) || (this
				.getDmv2MotifId() != null && castOther.getDmv2MotifId() != null && this
				.getDmv2MotifId().equals(castOther.getDmv2MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDmv2MotifId() == null ? 0 : this.getDmv2MotifId()
						.hashCode());
		result = 37 * result
