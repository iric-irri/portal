...
/**
 * InframeCodonGainId generated by hbm2java
 */
public class InframeCodonGainId implements java.io.Serializable {

	private Integer inframeCodonGainId;
	...
	public InframeCodonGainId() {
	}

	public InframeCodonGainId(Integer inframeCodonGainId, Integer featureId,
		...
		this.inframeCodonGainId = inframeCodonGainId;
	...
	public Integer getInframeCodonGainId() {
		return this.inframeCodonGainId;
	}

	public void setInframeCodonGainId(Integer inframeCodonGainId) {
		this.inframeCodonGainId = inframeCodonGainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InframeCodonGainId))
			return false;
		InframeCodonGainId castOther = (InframeCodonGainId) other;

		return ((this.getInframeCodonGainId() == castOther
				.getInframeCodonGainId()) || (this.getInframeCodonGainId() != null
				&& castOther.getInframeCodonGainId() != null && this
				.getInframeCodonGainId().equals(
						castOther.getInframeCodonGainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInframeCodonGainId() == null ? 0 : this
						.getInframeCodonGainId().hashCode());
		result = 37 * result
