...
/**
 * UnigeneClusterId generated by hbm2java
 */
public class UnigeneClusterId implements java.io.Serializable {

	private Integer unigeneClusterId;
	...
	public UnigeneClusterId() {
	}

	public UnigeneClusterId(Integer unigeneClusterId, Integer featureId,
	...
	public Integer getUnigeneClusterId() {
		return this.unigeneClusterId;
	}

	public void setUnigeneClusterId(Integer unigeneClusterId) {
		this.unigeneClusterId = unigeneClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnigeneClusterId))
			return false;
		UnigeneClusterId castOther = (UnigeneClusterId) other;

		return ((this.getUnigeneClusterId() == castOther.getUnigeneClusterId()) || (this
				.getUnigeneClusterId() != null
				&& castOther.getUnigeneClusterId() != null && this
				.getUnigeneClusterId().equals(castOther.getUnigeneClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUnigeneClusterId() == null ? 0 : this
						.getUnigeneClusterId().hashCode());
		result = 37 * result
