...
/**
 * ModifiedLAsparagineId generated by hbm2java
 */
public class ModifiedLAsparagineId implements java.io.Serializable {

	private Integer modifiedLAsparagineId;
	...
	public ModifiedLAsparagineId() {
	}

	public ModifiedLAsparagineId(Integer modifiedLAsparagineId,
		...
		this.modifiedLAsparagineId = modifiedLAsparagineId;
	...
	public Integer getModifiedLAsparagineId() {
		return this.modifiedLAsparagineId;
	}

	public void setModifiedLAsparagineId(Integer modifiedLAsparagineId) {
		this.modifiedLAsparagineId = modifiedLAsparagineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLAsparagineId))
			return false;
		ModifiedLAsparagineId castOther = (ModifiedLAsparagineId) other;

		return ((this.getModifiedLAsparagineId() == castOther
				.getModifiedLAsparagineId()) || (this
				.getModifiedLAsparagineId() != null
				&& castOther.getModifiedLAsparagineId() != null && this
				.getModifiedLAsparagineId().equals(
						castOther.getModifiedLAsparagineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLAsparagineId() == null ? 0 : this
						.getModifiedLAsparagineId().hashCode());
		result = 37 * result
