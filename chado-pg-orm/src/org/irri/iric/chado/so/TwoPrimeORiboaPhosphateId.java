...
/**
 * TwoPrimeORiboaPhosphateId generated by hbm2java
 */
public class TwoPrimeORiboaPhosphateId implements java.io.Serializable {

	private Integer twoPrimeORiboaPhosphateId;
	...
	public TwoPrimeORiboaPhosphateId() {
	}

	public TwoPrimeORiboaPhosphateId(Integer twoPrimeORiboaPhosphateId,
		...
		this.twoPrimeORiboaPhosphateId = twoPrimeORiboaPhosphateId;
	...
	public Integer getTwoPrimeORiboaPhosphateId() {
		return this.twoPrimeORiboaPhosphateId;
	}

	public void setTwoPrimeORiboaPhosphateId(Integer twoPrimeORiboaPhosphateId) {
		this.twoPrimeORiboaPhosphateId = twoPrimeORiboaPhosphateId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeORiboaPhosphateId))
			return false;
		TwoPrimeORiboaPhosphateId castOther = (TwoPrimeORiboaPhosphateId) other;

		return ((this.getTwoPrimeORiboaPhosphateId() == castOther
				.getTwoPrimeORiboaPhosphateId()) || (this
				.getTwoPrimeORiboaPhosphateId() != null
				&& castOther.getTwoPrimeORiboaPhosphateId() != null && this
				.getTwoPrimeORiboaPhosphateId().equals(
						castOther.getTwoPrimeORiboaPhosphateId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeORiboaPhosphateId() == null ? 0 : this
						.getTwoPrimeORiboaPhosphateId().hashCode());
		result = 37 * result
