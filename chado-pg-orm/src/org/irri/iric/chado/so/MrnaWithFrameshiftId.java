...
/**
 * MrnaWithFrameshiftId generated by hbm2java
 */
public class MrnaWithFrameshiftId implements java.io.Serializable {

	private Integer mrnaWithFrameshiftId;
	...
	public MrnaWithFrameshiftId() {
	}

	public MrnaWithFrameshiftId(Integer mrnaWithFrameshiftId,
		...
		this.mrnaWithFrameshiftId = mrnaWithFrameshiftId;
	...
	public Integer getMrnaWithFrameshiftId() {
		return this.mrnaWithFrameshiftId;
	}

	public void setMrnaWithFrameshiftId(Integer mrnaWithFrameshiftId) {
		this.mrnaWithFrameshiftId = mrnaWithFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaWithFrameshiftId))
			return false;
		MrnaWithFrameshiftId castOther = (MrnaWithFrameshiftId) other;

		return ((this.getMrnaWithFrameshiftId() == castOther
				.getMrnaWithFrameshiftId()) || (this.getMrnaWithFrameshiftId() != null
				&& castOther.getMrnaWithFrameshiftId() != null && this
				.getMrnaWithFrameshiftId().equals(
						castOther.getMrnaWithFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaWithFrameshiftId() == null ? 0 : this
						.getMrnaWithFrameshiftId().hashCode());
		result = 37 * result
