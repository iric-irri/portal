...
/**
 * ChromosomeStructureVariationId generated by hbm2java
 */
public class ChromosomeStructureVariationId implements java.io.Serializable {

	private Integer chromosomeStructureVariationId;
	...
	public ChromosomeStructureVariationId() {
	}

	public ChromosomeStructureVariationId(
			Integer chromosomeStructureVariationId, Integer featureId,
		...
		this.chromosomeStructureVariationId = chromosomeStructureVariationId;
	...
	public Integer getChromosomeStructureVariationId() {
		return this.chromosomeStructureVariationId;
	}

	public void setChromosomeStructureVariationId(
			Integer chromosomeStructureVariationId) {
		this.chromosomeStructureVariationId = chromosomeStructureVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeStructureVariationId))
			return false;
		ChromosomeStructureVariationId castOther = (ChromosomeStructureVariationId) other;

		return ((this.getChromosomeStructureVariationId() == castOther
				.getChromosomeStructureVariationId()) || (this
				.getChromosomeStructureVariationId() != null
				&& castOther.getChromosomeStructureVariationId() != null && this
				.getChromosomeStructureVariationId().equals(
						castOther.getChromosomeStructureVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeStructureVariationId() == null ? 0 : this
						.getChromosomeStructureVariationId().hashCode());
		result = 37 * result
