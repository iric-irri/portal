...
/**
 * HistoneAcetylationSiteId generated by hbm2java
 */
public class HistoneAcetylationSiteId implements java.io.Serializable {

	private Integer histoneAcetylationSiteId;
	...
	public HistoneAcetylationSiteId() {
	}

	public HistoneAcetylationSiteId(Integer histoneAcetylationSiteId,
		...
		this.histoneAcetylationSiteId = histoneAcetylationSiteId;
	...
	public Integer getHistoneAcetylationSiteId() {
		return this.histoneAcetylationSiteId;
	}

	public void setHistoneAcetylationSiteId(Integer histoneAcetylationSiteId) {
		this.histoneAcetylationSiteId = histoneAcetylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneAcetylationSiteId))
			return false;
		HistoneAcetylationSiteId castOther = (HistoneAcetylationSiteId) other;

		return ((this.getHistoneAcetylationSiteId() == castOther
				.getHistoneAcetylationSiteId()) || (this
				.getHistoneAcetylationSiteId() != null
				&& castOther.getHistoneAcetylationSiteId() != null && this
				.getHistoneAcetylationSiteId().equals(
						castOther.getHistoneAcetylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneAcetylationSiteId() == null ? 0 : this
						.getHistoneAcetylationSiteId().hashCode());
		result = 37 * result
