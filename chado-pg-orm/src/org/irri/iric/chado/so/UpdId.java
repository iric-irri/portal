...
/**
 * UpdId generated by hbm2java
 */
public class UpdId implements java.io.Serializable {
	...
	public UpdId(Integer updId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UpdId))
			return false;
		UpdId castOther = (UpdId) other;
