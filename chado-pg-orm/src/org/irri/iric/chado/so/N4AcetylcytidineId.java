...
/**
 * N4AcetylcytidineId generated by hbm2java
 */
public class N4AcetylcytidineId implements java.io.Serializable {

	private Integer n4AcetylcytidineId;
	...
	public N4AcetylcytidineId() {
	}

	public N4AcetylcytidineId(Integer n4AcetylcytidineId, Integer featureId,
		...
		this.n4AcetylcytidineId = n4AcetylcytidineId;
	...
	public Integer getN4AcetylcytidineId() {
		return this.n4AcetylcytidineId;
	}

	public void setN4AcetylcytidineId(Integer n4AcetylcytidineId) {
		this.n4AcetylcytidineId = n4AcetylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N4AcetylcytidineId))
			return false;
		N4AcetylcytidineId castOther = (N4AcetylcytidineId) other;

		return ((this.getN4AcetylcytidineId() == castOther
				.getN4AcetylcytidineId()) || (this.getN4AcetylcytidineId() != null
				&& castOther.getN4AcetylcytidineId() != null && this
				.getN4AcetylcytidineId().equals(
						castOther.getN4AcetylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN4AcetylcytidineId() == null ? 0 : this
						.getN4AcetylcytidineId().hashCode());
		result = 37 * result
