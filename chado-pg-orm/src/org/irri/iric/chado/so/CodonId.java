...
/**
 * CodonId generated by hbm2java
 */
public class CodonId implements java.io.Serializable {

	private Integer codonId;
	...
	public CodonId(Integer codonId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCodonId() {
		return this.codonId;
	}

	public void setCodonId(Integer codonId) {
		this.codonId = codonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodonId))
			return false;
		CodonId castOther = (CodonId) other;

		return ((this.getCodonId() == castOther.getCodonId()) || (this
				.getCodonId() != null && castOther.getCodonId() != null && this
				.getCodonId().equals(castOther.getCodonId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCodonId() == null ? 0 : this.getCodonId().hashCode());
		result = 37 * result
