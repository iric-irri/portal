...
/**
 * ChromosomeBreakpointId generated by hbm2java
 */
public class ChromosomeBreakpointId implements java.io.Serializable {

	private Integer chromosomeBreakpointId;
	...
	public ChromosomeBreakpointId() {
	}

	public ChromosomeBreakpointId(Integer chromosomeBreakpointId,
		...
		this.chromosomeBreakpointId = chromosomeBreakpointId;
	...
	public Integer getChromosomeBreakpointId() {
		return this.chromosomeBreakpointId;
	}

	public void setChromosomeBreakpointId(Integer chromosomeBreakpointId) {
		this.chromosomeBreakpointId = chromosomeBreakpointId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeBreakpointId))
			return false;
		ChromosomeBreakpointId castOther = (ChromosomeBreakpointId) other;

		return ((this.getChromosomeBreakpointId() == castOther
				.getChromosomeBreakpointId()) || (this
				.getChromosomeBreakpointId() != null
				&& castOther.getChromosomeBreakpointId() != null && this
				.getChromosomeBreakpointId().equals(
						castOther.getChromosomeBreakpointId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeBreakpointId() == null ? 0 : this
						.getChromosomeBreakpointId().hashCode());
		result = 37 * result
