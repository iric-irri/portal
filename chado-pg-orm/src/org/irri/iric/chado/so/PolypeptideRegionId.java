...
/**
 * PolypeptideRegionId generated by hbm2java
 */
public class PolypeptideRegionId implements java.io.Serializable {

	private Integer polypeptideRegionId;
	...
	public PolypeptideRegionId() {
	}

	public PolypeptideRegionId(Integer polypeptideRegionId, Integer featureId,
		...
		this.polypeptideRegionId = polypeptideRegionId;
	...
	public Integer getPolypeptideRegionId() {
		return this.polypeptideRegionId;
	}

	public void setPolypeptideRegionId(Integer polypeptideRegionId) {
		this.polypeptideRegionId = polypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideRegionId))
			return false;
		PolypeptideRegionId castOther = (PolypeptideRegionId) other;

		return ((this.getPolypeptideRegionId() == castOther
				.getPolypeptideRegionId()) || (this.getPolypeptideRegionId() != null
				&& castOther.getPolypeptideRegionId() != null && this
				.getPolypeptideRegionId().equals(
						castOther.getPolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideRegionId() == null ? 0 : this
						.getPolypeptideRegionId().hashCode());
		result = 37 * result
