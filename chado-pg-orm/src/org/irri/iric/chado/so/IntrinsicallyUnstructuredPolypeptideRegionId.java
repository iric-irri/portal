...
/**
 * IntrinsicallyUnstructuredPolypeptideRegionId generated by hbm2java
 */
public class IntrinsicallyUnstructuredPolypeptideRegionId implements
		java.io.Serializable {

	private Integer intrinsicallyUnstructuredPolypeptideRegionId;
	...
	public IntrinsicallyUnstructuredPolypeptideRegionId() {
	}

	public IntrinsicallyUnstructuredPolypeptideRegionId(
			Integer intrinsicallyUnstructuredPolypeptideRegionId,
		...
		this.intrinsicallyUnstructuredPolypeptideRegionId = intrinsicallyUnstructuredPolypeptideRegionId;
	...
	public Integer getIntrinsicallyUnstructuredPolypeptideRegionId() {
		return this.intrinsicallyUnstructuredPolypeptideRegionId;
	}

	public void setIntrinsicallyUnstructuredPolypeptideRegionId(
			Integer intrinsicallyUnstructuredPolypeptideRegionId) {
		this.intrinsicallyUnstructuredPolypeptideRegionId = intrinsicallyUnstructuredPolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrinsicallyUnstructuredPolypeptideRegionId))
			return false;
		IntrinsicallyUnstructuredPolypeptideRegionId castOther = (IntrinsicallyUnstructuredPolypeptideRegionId) other;

		return ((this.getIntrinsicallyUnstructuredPolypeptideRegionId() == castOther
				.getIntrinsicallyUnstructuredPolypeptideRegionId()) || (this
				.getIntrinsicallyUnstructuredPolypeptideRegionId() != null
				&& castOther.getIntrinsicallyUnstructuredPolypeptideRegionId() != null && this
				.getIntrinsicallyUnstructuredPolypeptideRegionId()
				.equals(castOther
						.getIntrinsicallyUnstructuredPolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrinsicallyUnstructuredPolypeptideRegionId() == null ? 0
						: this.getIntrinsicallyUnstructuredPolypeptideRegionId()
								.hashCode());
		result = 37 * result
