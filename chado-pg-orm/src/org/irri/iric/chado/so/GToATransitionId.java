...
/**
 * GToATransitionId generated by hbm2java
 */
public class GToATransitionId implements java.io.Serializable {

	private Integer GToATransitionId;
	...
	public GToATransitionId() {
	}

	public GToATransitionId(Integer GToATransitionId, Integer featureId,
		...
		this.GToATransitionId = GToATransitionId;
	...
	public Integer getGToATransitionId() {
		return this.GToATransitionId;
	}

	public void setGToATransitionId(Integer GToATransitionId) {
		this.GToATransitionId = GToATransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GToATransitionId))
			return false;
		GToATransitionId castOther = (GToATransitionId) other;

		return ((this.getGToATransitionId() == castOther.getGToATransitionId()) || (this
				.getGToATransitionId() != null
				&& castOther.getGToATransitionId() != null && this
				.getGToATransitionId().equals(castOther.getGToATransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGToATransitionId() == null ? 0 : this
						.getGToATransitionId().hashCode());
		result = 37 * result
