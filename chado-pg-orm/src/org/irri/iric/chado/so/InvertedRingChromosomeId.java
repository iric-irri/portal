...
/**
 * InvertedRingChromosomeId generated by hbm2java
 */
public class InvertedRingChromosomeId implements java.io.Serializable {

	private Integer invertedRingChromosomeId;
	...
	public InvertedRingChromosomeId() {
	}

	public InvertedRingChromosomeId(Integer invertedRingChromosomeId,
		...
		this.invertedRingChromosomeId = invertedRingChromosomeId;
	...
	public Integer getInvertedRingChromosomeId() {
		return this.invertedRingChromosomeId;
	}

	public void setInvertedRingChromosomeId(Integer invertedRingChromosomeId) {
		this.invertedRingChromosomeId = invertedRingChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertedRingChromosomeId))
			return false;
		InvertedRingChromosomeId castOther = (InvertedRingChromosomeId) other;

		return ((this.getInvertedRingChromosomeId() == castOther
				.getInvertedRingChromosomeId()) || (this
				.getInvertedRingChromosomeId() != null
				&& castOther.getInvertedRingChromosomeId() != null && this
				.getInvertedRingChromosomeId().equals(
						castOther.getInvertedRingChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertedRingChromosomeId() == null ? 0 : this
						.getInvertedRingChromosomeId().hashCode());
		result = 37 * result
