...
/**
 * ThreePrimeUtrIntronId generated by hbm2java
 */
public class ThreePrimeUtrIntronId implements java.io.Serializable {

	private Integer threePrimeUtrIntronId;
	...
	public ThreePrimeUtrIntronId() {
	}

	public ThreePrimeUtrIntronId(Integer threePrimeUtrIntronId,
		...
		this.threePrimeUtrIntronId = threePrimeUtrIntronId;
	...
	public Integer getThreePrimeUtrIntronId() {
		return this.threePrimeUtrIntronId;
	}

	public void setThreePrimeUtrIntronId(Integer threePrimeUtrIntronId) {
		this.threePrimeUtrIntronId = threePrimeUtrIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeUtrIntronId))
			return false;
		ThreePrimeUtrIntronId castOther = (ThreePrimeUtrIntronId) other;

		return ((this.getThreePrimeUtrIntronId() == castOther
				.getThreePrimeUtrIntronId()) || (this
				.getThreePrimeUtrIntronId() != null
				&& castOther.getThreePrimeUtrIntronId() != null && this
				.getThreePrimeUtrIntronId().equals(
						castOther.getThreePrimeUtrIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeUtrIntronId() == null ? 0 : this
						.getThreePrimeUtrIntronId().hashCode());
		result = 37 * result
