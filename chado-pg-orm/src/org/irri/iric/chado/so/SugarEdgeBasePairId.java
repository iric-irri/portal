...
/**
 * SugarEdgeBasePairId generated by hbm2java
 */
public class SugarEdgeBasePairId implements java.io.Serializable {

	private Integer sugarEdgeBasePairId;
	...
	public SugarEdgeBasePairId() {
	}

	public SugarEdgeBasePairId(Integer sugarEdgeBasePairId, Integer featureId,
		...
		this.sugarEdgeBasePairId = sugarEdgeBasePairId;
	...
	public Integer getSugarEdgeBasePairId() {
		return this.sugarEdgeBasePairId;
	}

	public void setSugarEdgeBasePairId(Integer sugarEdgeBasePairId) {
		this.sugarEdgeBasePairId = sugarEdgeBasePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SugarEdgeBasePairId))
			return false;
		SugarEdgeBasePairId castOther = (SugarEdgeBasePairId) other;

		return ((this.getSugarEdgeBasePairId() == castOther
				.getSugarEdgeBasePairId()) || (this.getSugarEdgeBasePairId() != null
				&& castOther.getSugarEdgeBasePairId() != null && this
				.getSugarEdgeBasePairId().equals(
						castOther.getSugarEdgeBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSugarEdgeBasePairId() == null ? 0 : this
						.getSugarEdgeBasePairId().hashCode());
		result = 37 * result
