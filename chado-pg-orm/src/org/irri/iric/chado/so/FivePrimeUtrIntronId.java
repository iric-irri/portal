...
/**
 * FivePrimeUtrIntronId generated by hbm2java
 */
public class FivePrimeUtrIntronId implements java.io.Serializable {

	private Integer fivePrimeUtrIntronId;
	...
	public FivePrimeUtrIntronId() {
	}

	public FivePrimeUtrIntronId(Integer fivePrimeUtrIntronId,
		...
		this.fivePrimeUtrIntronId = fivePrimeUtrIntronId;
	...
	public Integer getFivePrimeUtrIntronId() {
		return this.fivePrimeUtrIntronId;
	}

	public void setFivePrimeUtrIntronId(Integer fivePrimeUtrIntronId) {
		this.fivePrimeUtrIntronId = fivePrimeUtrIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeUtrIntronId))
			return false;
		FivePrimeUtrIntronId castOther = (FivePrimeUtrIntronId) other;

		return ((this.getFivePrimeUtrIntronId() == castOther
				.getFivePrimeUtrIntronId()) || (this.getFivePrimeUtrIntronId() != null
				&& castOther.getFivePrimeUtrIntronId() != null && this
				.getFivePrimeUtrIntronId().equals(
						castOther.getFivePrimeUtrIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeUtrIntronId() == null ? 0 : this
						.getFivePrimeUtrIntronId().hashCode());
		result = 37 * result
