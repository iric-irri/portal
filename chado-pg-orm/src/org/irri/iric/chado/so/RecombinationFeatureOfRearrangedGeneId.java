...
/**
 * RecombinationFeatureOfRearrangedGeneId generated by hbm2java
 */
public class RecombinationFeatureOfRearrangedGeneId implements
		java.io.Serializable {

	private Integer recombinationFeatureOfRearrangedGeneId;
	...
	public RecombinationFeatureOfRearrangedGeneId() {
	}

	public RecombinationFeatureOfRearrangedGeneId(
			Integer recombinationFeatureOfRearrangedGeneId, Integer featureId,
		...
		this.recombinationFeatureOfRearrangedGeneId = recombinationFeatureOfRearrangedGeneId;
	...
	public Integer getRecombinationFeatureOfRearrangedGeneId() {
		return this.recombinationFeatureOfRearrangedGeneId;
	}

	public void setRecombinationFeatureOfRearrangedGeneId(
			Integer recombinationFeatureOfRearrangedGeneId) {
		this.recombinationFeatureOfRearrangedGeneId = recombinationFeatureOfRearrangedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationFeatureOfRearrangedGeneId))
			return false;
		RecombinationFeatureOfRearrangedGeneId castOther = (RecombinationFeatureOfRearrangedGeneId) other;

		return ((this.getRecombinationFeatureOfRearrangedGeneId() == castOther
				.getRecombinationFeatureOfRearrangedGeneId()) || (this
				.getRecombinationFeatureOfRearrangedGeneId() != null
				&& castOther.getRecombinationFeatureOfRearrangedGeneId() != null && this
				.getRecombinationFeatureOfRearrangedGeneId().equals(
						castOther.getRecombinationFeatureOfRearrangedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationFeatureOfRearrangedGeneId() == null ? 0
						: this.getRecombinationFeatureOfRearrangedGeneId()
								.hashCode());
		result = 37 * result
