...
/**
 * IncreasedTranscriptionRateVariantId generated by hbm2java
 */
public class IncreasedTranscriptionRateVariantId implements
		java.io.Serializable {

	private Integer increasedTranscriptionRateVariantId;
	...
	public IncreasedTranscriptionRateVariantId() {
	}

	public IncreasedTranscriptionRateVariantId(
			Integer increasedTranscriptionRateVariantId, Integer featureId,
		...
		this.increasedTranscriptionRateVariantId = increasedTranscriptionRateVariantId;
	...
	public Integer getIncreasedTranscriptionRateVariantId() {
		return this.increasedTranscriptionRateVariantId;
	}

	public void setIncreasedTranscriptionRateVariantId(
			Integer increasedTranscriptionRateVariantId) {
		this.increasedTranscriptionRateVariantId = increasedTranscriptionRateVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncreasedTranscriptionRateVariantId))
			return false;
		IncreasedTranscriptionRateVariantId castOther = (IncreasedTranscriptionRateVariantId) other;

		return ((this.getIncreasedTranscriptionRateVariantId() == castOther
				.getIncreasedTranscriptionRateVariantId()) || (this
				.getIncreasedTranscriptionRateVariantId() != null
				&& castOther.getIncreasedTranscriptionRateVariantId() != null && this
				.getIncreasedTranscriptionRateVariantId().equals(
						castOther.getIncreasedTranscriptionRateVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncreasedTranscriptionRateVariantId() == null ? 0 : this
						.getIncreasedTranscriptionRateVariantId().hashCode());
		result = 37 * result
