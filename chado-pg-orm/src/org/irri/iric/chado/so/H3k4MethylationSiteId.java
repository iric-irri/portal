...
/**
 * H3k4MethylationSiteId generated by hbm2java
 */
public class H3k4MethylationSiteId implements java.io.Serializable {

	private Integer h3k4MethylationSiteId;
	...
	public H3k4MethylationSiteId() {
	}

	public H3k4MethylationSiteId(Integer h3k4MethylationSiteId,
		...
		this.h3k4MethylationSiteId = h3k4MethylationSiteId;
	...
	public Integer getH3k4MethylationSiteId() {
		return this.h3k4MethylationSiteId;
	}

	public void setH3k4MethylationSiteId(Integer h3k4MethylationSiteId) {
		this.h3k4MethylationSiteId = h3k4MethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k4MethylationSiteId))
			return false;
		H3k4MethylationSiteId castOther = (H3k4MethylationSiteId) other;

		return ((this.getH3k4MethylationSiteId() == castOther
				.getH3k4MethylationSiteId()) || (this
				.getH3k4MethylationSiteId() != null
				&& castOther.getH3k4MethylationSiteId() != null && this
				.getH3k4MethylationSiteId().equals(
						castOther.getH3k4MethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k4MethylationSiteId() == null ? 0 : this
						.getH3k4MethylationSiteId().hashCode());
		result = 37 * result
