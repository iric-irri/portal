...
/**
 * TwoPrimeOMethylcytidineId generated by hbm2java
 */
public class TwoPrimeOMethylcytidineId implements java.io.Serializable {

	private Integer twoPrimeOMethylcytidineId;
	...
	public TwoPrimeOMethylcytidineId() {
	}

	public TwoPrimeOMethylcytidineId(Integer twoPrimeOMethylcytidineId,
		...
		this.twoPrimeOMethylcytidineId = twoPrimeOMethylcytidineId;
	...
	public Integer getTwoPrimeOMethylcytidineId() {
		return this.twoPrimeOMethylcytidineId;
	}

	public void setTwoPrimeOMethylcytidineId(Integer twoPrimeOMethylcytidineId) {
		this.twoPrimeOMethylcytidineId = twoPrimeOMethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethylcytidineId))
			return false;
		TwoPrimeOMethylcytidineId castOther = (TwoPrimeOMethylcytidineId) other;

		return ((this.getTwoPrimeOMethylcytidineId() == castOther
				.getTwoPrimeOMethylcytidineId()) || (this
				.getTwoPrimeOMethylcytidineId() != null
				&& castOther.getTwoPrimeOMethylcytidineId() != null && this
				.getTwoPrimeOMethylcytidineId().equals(
						castOther.getTwoPrimeOMethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethylcytidineId() == null ? 0 : this
						.getTwoPrimeOMethylcytidineId().hashCode());
		result = 37 * result
