...
/**
 * NonCytoplasmicPolypeptideRegionId generated by hbm2java
 */
public class NonCytoplasmicPolypeptideRegionId implements java.io.Serializable {

	private Integer nonCytoplasmicPolypeptideRegionId;
	...
	public NonCytoplasmicPolypeptideRegionId() {
	}

	public NonCytoplasmicPolypeptideRegionId(
			Integer nonCytoplasmicPolypeptideRegionId, Integer featureId,
		...
		this.nonCytoplasmicPolypeptideRegionId = nonCytoplasmicPolypeptideRegionId;
	...
	public Integer getNonCytoplasmicPolypeptideRegionId() {
		return this.nonCytoplasmicPolypeptideRegionId;
	}

	public void setNonCytoplasmicPolypeptideRegionId(
			Integer nonCytoplasmicPolypeptideRegionId) {
		this.nonCytoplasmicPolypeptideRegionId = nonCytoplasmicPolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonCytoplasmicPolypeptideRegionId))
			return false;
		NonCytoplasmicPolypeptideRegionId castOther = (NonCytoplasmicPolypeptideRegionId) other;

		return ((this.getNonCytoplasmicPolypeptideRegionId() == castOther
				.getNonCytoplasmicPolypeptideRegionId()) || (this
				.getNonCytoplasmicPolypeptideRegionId() != null
				&& castOther.getNonCytoplasmicPolypeptideRegionId() != null && this
				.getNonCytoplasmicPolypeptideRegionId().equals(
						castOther.getNonCytoplasmicPolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonCytoplasmicPolypeptideRegionId() == null ? 0 : this
						.getNonCytoplasmicPolypeptideRegionId().hashCode());
		result = 37 * result
