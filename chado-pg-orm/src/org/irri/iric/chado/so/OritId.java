...
/**
 * OritId generated by hbm2java
 */
public class OritId implements java.io.Serializable {

	private Integer oritId;
	...
	public OritId(Integer oritId, Integer featureId, Integer dbxrefId,
	...
	public void setOritId(Integer oritId) {
		this.oritId = oritId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OritId))
			return false;
		OritId castOther = (OritId) other;

		return ((this.getOritId() == castOther.getOritId()) || (this
				.getOritId() != null && castOther.getOritId() != null && this
				.getOritId().equals(castOther.getOritId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOritId() == null ? 0 : this.getOritId().hashCode());
		result = 37 * result
