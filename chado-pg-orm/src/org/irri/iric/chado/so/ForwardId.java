...
/**
 * ForwardId generated by hbm2java
 */
public class ForwardId implements java.io.Serializable {
	...
	public ForwardId(Integer forwardId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ForwardId))
			return false;
		ForwardId castOther = (ForwardId) other;

		return ((this.getForwardId() == castOther.getForwardId()) || (this
				.getForwardId() != null && castOther.getForwardId() != null && this
				.getForwardId().equals(castOther.getForwardId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getForwardId() == null ? 0 : this.getForwardId().hashCode());
		result = 37 * result
