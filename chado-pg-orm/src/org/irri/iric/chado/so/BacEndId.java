...
/**
 * BacEndId generated by hbm2java
 */
public class BacEndId implements java.io.Serializable {

	private Integer bacEndId;
	...
	public BacEndId(Integer bacEndId, Integer featureId, Integer dbxrefId,
	...
	public Integer getBacEndId() {
		return this.bacEndId;
	}

	public void setBacEndId(Integer bacEndId) {
		this.bacEndId = bacEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BacEndId))
			return false;
		BacEndId castOther = (BacEndId) other;

		return ((this.getBacEndId() == castOther.getBacEndId()) || (this
				.getBacEndId() != null && castOther.getBacEndId() != null && this
				.getBacEndId().equals(castOther.getBacEndId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getBacEndId() == null ? 0 : this.getBacEndId().hashCode());
		result = 37 * result
