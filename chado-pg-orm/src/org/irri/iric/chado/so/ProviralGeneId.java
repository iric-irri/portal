...
/**
 * ProviralGeneId generated by hbm2java
 */
public class ProviralGeneId implements java.io.Serializable {

	private Integer proviralGeneId;
	...
	public ProviralGeneId() {
	}

	public ProviralGeneId(Integer proviralGeneId, Integer featureId,
		...
		this.proviralGeneId = proviralGeneId;
	...
	public Integer getProviralGeneId() {
		return this.proviralGeneId;
	}

	public void setProviralGeneId(Integer proviralGeneId) {
		this.proviralGeneId = proviralGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProviralGeneId))
			return false;
		ProviralGeneId castOther = (ProviralGeneId) other;

		return ((this.getProviralGeneId() == castOther.getProviralGeneId()) || (this
				.getProviralGeneId() != null
				&& castOther.getProviralGeneId() != null && this
				.getProviralGeneId().equals(castOther.getProviralGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProviralGeneId() == null ? 0 : this.getProviralGeneId()
						.hashCode());
		result = 37 * result
