...
/**
 * EpisomeId generated by hbm2java
 */
public class EpisomeId implements java.io.Serializable {

	private Integer episomeId;
	...
	public EpisomeId(Integer episomeId, Integer featureId, Integer dbxrefId,
	...
	public Integer getEpisomeId() {
		return this.episomeId;
	}

	public void setEpisomeId(Integer episomeId) {
		this.episomeId = episomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpisomeId))
			return false;
		EpisomeId castOther = (EpisomeId) other;

		return ((this.getEpisomeId() == castOther.getEpisomeId()) || (this
				.getEpisomeId() != null && castOther.getEpisomeId() != null && this
				.getEpisomeId().equals(castOther.getEpisomeId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getEpisomeId() == null ? 0 : this.getEpisomeId().hashCode());
		result = 37 * result
