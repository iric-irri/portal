...
/**
 * TwoPrimeOMethyladenosineId generated by hbm2java
 */
public class TwoPrimeOMethyladenosineId implements java.io.Serializable {

	private Integer twoPrimeOMethyladenosineId;
	...
	public TwoPrimeOMethyladenosineId() {
	}

	public TwoPrimeOMethyladenosineId(Integer twoPrimeOMethyladenosineId,
		...
		this.twoPrimeOMethyladenosineId = twoPrimeOMethyladenosineId;
	...
	public Integer getTwoPrimeOMethyladenosineId() {
		return this.twoPrimeOMethyladenosineId;
	}

	public void setTwoPrimeOMethyladenosineId(Integer twoPrimeOMethyladenosineId) {
		this.twoPrimeOMethyladenosineId = twoPrimeOMethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethyladenosineId))
			return false;
		TwoPrimeOMethyladenosineId castOther = (TwoPrimeOMethyladenosineId) other;

		return ((this.getTwoPrimeOMethyladenosineId() == castOther
				.getTwoPrimeOMethyladenosineId()) || (this
				.getTwoPrimeOMethyladenosineId() != null
				&& castOther.getTwoPrimeOMethyladenosineId() != null && this
				.getTwoPrimeOMethyladenosineId().equals(
						castOther.getTwoPrimeOMethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethyladenosineId() == null ? 0 : this
						.getTwoPrimeOMethyladenosineId().hashCode());
		result = 37 * result
