...
/**
 * AspartylTrnaId generated by hbm2java
 */
public class AspartylTrnaId implements java.io.Serializable {

	private Integer aspartylTrnaId;
	...
	public AspartylTrnaId() {
	}

	public AspartylTrnaId(Integer aspartylTrnaId, Integer featureId,
		...
		this.aspartylTrnaId = aspartylTrnaId;
	...
	public Integer getAspartylTrnaId() {
		return this.aspartylTrnaId;
	}

	public void setAspartylTrnaId(Integer aspartylTrnaId) {
		this.aspartylTrnaId = aspartylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AspartylTrnaId))
			return false;
		AspartylTrnaId castOther = (AspartylTrnaId) other;

		return ((this.getAspartylTrnaId() == castOther.getAspartylTrnaId()) || (this
				.getAspartylTrnaId() != null
				&& castOther.getAspartylTrnaId() != null && this
				.getAspartylTrnaId().equals(castOther.getAspartylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAspartylTrnaId() == null ? 0 : this.getAspartylTrnaId()
						.hashCode());
		result = 37 * result
