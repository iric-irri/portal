...
/**
 * StopLostId generated by hbm2java
 */
public class StopLostId implements java.io.Serializable {

	private Integer stopLostId;
	...
	public StopLostId(Integer stopLostId, Integer featureId, Integer dbxrefId,
	...
	public Integer getStopLostId() {
		return this.stopLostId;
	}

	public void setStopLostId(Integer stopLostId) {
		this.stopLostId = stopLostId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopLostId))
			return false;
		StopLostId castOther = (StopLostId) other;

		return ((this.getStopLostId() == castOther.getStopLostId()) || (this
				.getStopLostId() != null && castOther.getStopLostId() != null && this
				.getStopLostId().equals(castOther.getStopLostId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopLostId() == null ? 0 : this.getStopLostId()
						.hashCode());
		result = 37 * result
