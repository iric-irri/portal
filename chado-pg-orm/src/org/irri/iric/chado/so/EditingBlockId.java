...
/**
 * EditingBlockId generated by hbm2java
 */
public class EditingBlockId implements java.io.Serializable {

	private Integer editingBlockId;
	...
	public EditingBlockId() {
	}

	public EditingBlockId(Integer editingBlockId, Integer featureId,
		...
		this.editingBlockId = editingBlockId;
	...
	public Integer getEditingBlockId() {
		return this.editingBlockId;
	}

	public void setEditingBlockId(Integer editingBlockId) {
		this.editingBlockId = editingBlockId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditingBlockId))
			return false;
		EditingBlockId castOther = (EditingBlockId) other;

		return ((this.getEditingBlockId() == castOther.getEditingBlockId()) || (this
				.getEditingBlockId() != null
				&& castOther.getEditingBlockId() != null && this
				.getEditingBlockId().equals(castOther.getEditingBlockId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditingBlockId() == null ? 0 : this.getEditingBlockId()
						.hashCode());
		result = 37 * result
