...
/**
 * VertebrateImmunoglobulinTCellReceptorSegmentId generated by hbm2java
 */
public class VertebrateImmunoglobulinTCellReceptorSegmentId implements
		java.io.Serializable {

	private Integer vertebrateImmunoglobulinTCellReceptorSegmentId;
	...
	public VertebrateImmunoglobulinTCellReceptorSegmentId() {
	}

	public VertebrateImmunoglobulinTCellReceptorSegmentId(
			Integer vertebrateImmunoglobulinTCellReceptorSegmentId,
		...
		this.vertebrateImmunoglobulinTCellReceptorSegmentId = vertebrateImmunoglobulinTCellReceptorSegmentId;
	...
	public Integer getVertebrateImmunoglobulinTCellReceptorSegmentId() {
		return this.vertebrateImmunoglobulinTCellReceptorSegmentId;
	}

	public void setVertebrateImmunoglobulinTCellReceptorSegmentId(
			Integer vertebrateImmunoglobulinTCellReceptorSegmentId) {
		this.vertebrateImmunoglobulinTCellReceptorSegmentId = vertebrateImmunoglobulinTCellReceptorSegmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateImmunoglobulinTCellReceptorSegmentId))
			return false;
		VertebrateImmunoglobulinTCellReceptorSegmentId castOther = (VertebrateImmunoglobulinTCellReceptorSegmentId) other;

		return ((this.getVertebrateImmunoglobulinTCellReceptorSegmentId() == castOther
				.getVertebrateImmunoglobulinTCellReceptorSegmentId()) || (this
				.getVertebrateImmunoglobulinTCellReceptorSegmentId() != null
				&& castOther
						.getVertebrateImmunoglobulinTCellReceptorSegmentId() != null && this
				.getVertebrateImmunoglobulinTCellReceptorSegmentId()
				.equals(castOther
						.getVertebrateImmunoglobulinTCellReceptorSegmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateImmunoglobulinTCellReceptorSegmentId() == null ? 0
						: this.getVertebrateImmunoglobulinTCellReceptorSegmentId()
								.hashCode());
		result = 37 * result
