...
/**
 * EpigeneticallyModifiedGeneId generated by hbm2java
 */
public class EpigeneticallyModifiedGeneId implements java.io.Serializable {

	private Integer epigeneticallyModifiedGeneId;
	...
	public EpigeneticallyModifiedGeneId() {
	}

	public EpigeneticallyModifiedGeneId(Integer epigeneticallyModifiedGeneId,
		...
		this.epigeneticallyModifiedGeneId = epigeneticallyModifiedGeneId;
	...
	public Integer getEpigeneticallyModifiedGeneId() {
		return this.epigeneticallyModifiedGeneId;
	}

	public void setEpigeneticallyModifiedGeneId(
			Integer epigeneticallyModifiedGeneId) {
		this.epigeneticallyModifiedGeneId = epigeneticallyModifiedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpigeneticallyModifiedGeneId))
			return false;
		EpigeneticallyModifiedGeneId castOther = (EpigeneticallyModifiedGeneId) other;

		return ((this.getEpigeneticallyModifiedGeneId() == castOther
				.getEpigeneticallyModifiedGeneId()) || (this
				.getEpigeneticallyModifiedGeneId() != null
				&& castOther.getEpigeneticallyModifiedGeneId() != null && this
				.getEpigeneticallyModifiedGeneId().equals(
						castOther.getEpigeneticallyModifiedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEpigeneticallyModifiedGeneId() == null ? 0 : this
						.getEpigeneticallyModifiedGeneId().hashCode());
		result = 37 * result
