...
/**
 * FiveHydroxymethylcytidineId generated by hbm2java
 */
public class FiveHydroxymethylcytidineId implements java.io.Serializable {

	private Integer fiveHydroxymethylcytidineId;
	...
	public FiveHydroxymethylcytidineId() {
	}

	public FiveHydroxymethylcytidineId(Integer fiveHydroxymethylcytidineId,
		...
		this.fiveHydroxymethylcytidineId = fiveHydroxymethylcytidineId;
	...
	public Integer getFiveHydroxymethylcytidineId() {
		return this.fiveHydroxymethylcytidineId;
	}

	public void setFiveHydroxymethylcytidineId(
			Integer fiveHydroxymethylcytidineId) {
		this.fiveHydroxymethylcytidineId = fiveHydroxymethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveHydroxymethylcytidineId))
			return false;
		FiveHydroxymethylcytidineId castOther = (FiveHydroxymethylcytidineId) other;

		return ((this.getFiveHydroxymethylcytidineId() == castOther
				.getFiveHydroxymethylcytidineId()) || (this
				.getFiveHydroxymethylcytidineId() != null
				&& castOther.getFiveHydroxymethylcytidineId() != null && this
				.getFiveHydroxymethylcytidineId().equals(
						castOther.getFiveHydroxymethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveHydroxymethylcytidineId() == null ? 0 : this
						.getFiveHydroxymethylcytidineId().hashCode());
		result = 37 * result
