...
/**
 * ModifiedLAsparticAcidId generated by hbm2java
 */
public class ModifiedLAsparticAcidId implements java.io.Serializable {

	private Integer modifiedLAsparticAcidId;
	...
	public ModifiedLAsparticAcidId() {
	}

	public ModifiedLAsparticAcidId(Integer modifiedLAsparticAcidId,
		...
		this.modifiedLAsparticAcidId = modifiedLAsparticAcidId;
	...
	public Integer getModifiedLAsparticAcidId() {
		return this.modifiedLAsparticAcidId;
	}

	public void setModifiedLAsparticAcidId(Integer modifiedLAsparticAcidId) {
		this.modifiedLAsparticAcidId = modifiedLAsparticAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLAsparticAcidId))
			return false;
		ModifiedLAsparticAcidId castOther = (ModifiedLAsparticAcidId) other;

		return ((this.getModifiedLAsparticAcidId() == castOther
				.getModifiedLAsparticAcidId()) || (this
				.getModifiedLAsparticAcidId() != null
				&& castOther.getModifiedLAsparticAcidId() != null && this
				.getModifiedLAsparticAcidId().equals(
						castOther.getModifiedLAsparticAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLAsparticAcidId() == null ? 0 : this
						.getModifiedLAsparticAcidId().hashCode());
		result = 37 * result
