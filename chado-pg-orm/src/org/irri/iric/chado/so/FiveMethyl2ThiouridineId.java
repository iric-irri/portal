...
/**
 * FiveMethyl2ThiouridineId generated by hbm2java
 */
public class FiveMethyl2ThiouridineId implements java.io.Serializable {

	private Integer fiveMethyl2ThiouridineId;
	...
	public FiveMethyl2ThiouridineId() {
	}

	public FiveMethyl2ThiouridineId(Integer fiveMethyl2ThiouridineId,
		...
		this.fiveMethyl2ThiouridineId = fiveMethyl2ThiouridineId;
	...
	public Integer getFiveMethyl2ThiouridineId() {
		return this.fiveMethyl2ThiouridineId;
	}

	public void setFiveMethyl2ThiouridineId(Integer fiveMethyl2ThiouridineId) {
		this.fiveMethyl2ThiouridineId = fiveMethyl2ThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethyl2ThiouridineId))
			return false;
		FiveMethyl2ThiouridineId castOther = (FiveMethyl2ThiouridineId) other;

		return ((this.getFiveMethyl2ThiouridineId() == castOther
				.getFiveMethyl2ThiouridineId()) || (this
				.getFiveMethyl2ThiouridineId() != null
				&& castOther.getFiveMethyl2ThiouridineId() != null && this
				.getFiveMethyl2ThiouridineId().equals(
						castOther.getFiveMethyl2ThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethyl2ThiouridineId() == null ? 0 : this
						.getFiveMethyl2ThiouridineId().hashCode());
		result = 37 * result
