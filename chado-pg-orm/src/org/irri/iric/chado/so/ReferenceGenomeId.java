...
/**
 * ReferenceGenomeId generated by hbm2java
 */
public class ReferenceGenomeId implements java.io.Serializable {
	...
	public ReferenceGenomeId() {
	}

	public ReferenceGenomeId(Integer referenceGenomeId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReferenceGenomeId))
			return false;
		ReferenceGenomeId castOther = (ReferenceGenomeId) other;

		return ((this.getReferenceGenomeId() == castOther
				.getReferenceGenomeId()) || (this.getReferenceGenomeId() != null
				&& castOther.getReferenceGenomeId() != null && this
				.getReferenceGenomeId()
				.equals(castOther.getReferenceGenomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReferenceGenomeId() == null ? 0 : this
						.getReferenceGenomeId().hashCode());
		result = 37 * result
