...
/**
 * PolyploidId generated by hbm2java
 */
public class PolyploidId implements java.io.Serializable {

	private Integer polyploidId;
	...
	public PolyploidId(Integer polyploidId, Integer featureId,
	...
	public Integer getPolyploidId() {
		return this.polyploidId;
	}

	public void setPolyploidId(Integer polyploidId) {
		this.polyploidId = polyploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyploidId))
			return false;
		PolyploidId castOther = (PolyploidId) other;

		return ((this.getPolyploidId() == castOther.getPolyploidId()) || (this
				.getPolyploidId() != null && castOther.getPolyploidId() != null && this
				.getPolyploidId().equals(castOther.getPolyploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyploidId() == null ? 0 : this.getPolyploidId()
						.hashCode());
		result = 37 * result
