...
/**
 * ThreePrimeUtrVariantId generated by hbm2java
 */
public class ThreePrimeUtrVariantId implements java.io.Serializable {

	private Integer threePrimeUtrVariantId;
	...
	public ThreePrimeUtrVariantId() {
	}

	public ThreePrimeUtrVariantId(Integer threePrimeUtrVariantId,
		...
		this.threePrimeUtrVariantId = threePrimeUtrVariantId;
	...
	public Integer getThreePrimeUtrVariantId() {
		return this.threePrimeUtrVariantId;
	}

	public void setThreePrimeUtrVariantId(Integer threePrimeUtrVariantId) {
		this.threePrimeUtrVariantId = threePrimeUtrVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeUtrVariantId))
			return false;
		ThreePrimeUtrVariantId castOther = (ThreePrimeUtrVariantId) other;

		return ((this.getThreePrimeUtrVariantId() == castOther
				.getThreePrimeUtrVariantId()) || (this
				.getThreePrimeUtrVariantId() != null
				&& castOther.getThreePrimeUtrVariantId() != null && this
				.getThreePrimeUtrVariantId().equals(
						castOther.getThreePrimeUtrVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeUtrVariantId() == null ? 0 : this
						.getThreePrimeUtrVariantId().hashCode());
		result = 37 * result
