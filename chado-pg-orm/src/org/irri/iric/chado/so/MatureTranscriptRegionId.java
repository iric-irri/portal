...
/**
 * MatureTranscriptRegionId generated by hbm2java
 */
public class MatureTranscriptRegionId implements java.io.Serializable {

	private Integer matureTranscriptRegionId;
	...
	public MatureTranscriptRegionId() {
	}

	public MatureTranscriptRegionId(Integer matureTranscriptRegionId,
		...
		this.matureTranscriptRegionId = matureTranscriptRegionId;
	...
	public Integer getMatureTranscriptRegionId() {
		return this.matureTranscriptRegionId;
	}

	public void setMatureTranscriptRegionId(Integer matureTranscriptRegionId) {
		this.matureTranscriptRegionId = matureTranscriptRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatureTranscriptRegionId))
			return false;
		MatureTranscriptRegionId castOther = (MatureTranscriptRegionId) other;

		return ((this.getMatureTranscriptRegionId() == castOther
				.getMatureTranscriptRegionId()) || (this
				.getMatureTranscriptRegionId() != null
				&& castOther.getMatureTranscriptRegionId() != null && this
				.getMatureTranscriptRegionId().equals(
						castOther.getMatureTranscriptRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMatureTranscriptRegionId() == null ? 0 : this
						.getMatureTranscriptRegionId().hashCode());
		result = 37 * result
