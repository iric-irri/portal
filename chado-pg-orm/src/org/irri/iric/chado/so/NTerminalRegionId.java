...
/**
 * NTerminalRegionId generated by hbm2java
 */
public class NTerminalRegionId implements java.io.Serializable {

	private Integer NTerminalRegionId;
	...
	public NTerminalRegionId() {
	}

	public NTerminalRegionId(Integer NTerminalRegionId, Integer featureId,
		...
		this.NTerminalRegionId = NTerminalRegionId;
	...
	public Integer getNTerminalRegionId() {
		return this.NTerminalRegionId;
	}

	public void setNTerminalRegionId(Integer NTerminalRegionId) {
		this.NTerminalRegionId = NTerminalRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NTerminalRegionId))
			return false;
		NTerminalRegionId castOther = (NTerminalRegionId) other;

		return ((this.getNTerminalRegionId() == castOther
				.getNTerminalRegionId()) || (this.getNTerminalRegionId() != null
				&& castOther.getNTerminalRegionId() != null && this
				.getNTerminalRegionId()
				.equals(castOther.getNTerminalRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNTerminalRegionId() == null ? 0 : this
						.getNTerminalRegionId().hashCode());
		result = 37 * result
