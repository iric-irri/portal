...
/**
 * LowComplexityRegionId generated by hbm2java
 */
public class LowComplexityRegionId implements java.io.Serializable {

	private Integer lowComplexityRegionId;
	...
	public LowComplexityRegionId() {
	}

	public LowComplexityRegionId(Integer lowComplexityRegionId,
		...
		this.lowComplexityRegionId = lowComplexityRegionId;
	...
	public Integer getLowComplexityRegionId() {
		return this.lowComplexityRegionId;
	}

	public void setLowComplexityRegionId(Integer lowComplexityRegionId) {
		this.lowComplexityRegionId = lowComplexityRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LowComplexityRegionId))
			return false;
		LowComplexityRegionId castOther = (LowComplexityRegionId) other;

		return ((this.getLowComplexityRegionId() == castOther
				.getLowComplexityRegionId()) || (this
				.getLowComplexityRegionId() != null
				&& castOther.getLowComplexityRegionId() != null && this
				.getLowComplexityRegionId().equals(
						castOther.getLowComplexityRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLowComplexityRegionId() == null ? 0 : this
						.getLowComplexityRegionId().hashCode());
		result = 37 * result
