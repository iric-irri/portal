...
/**
 * UaaStopCodonSignalId generated by hbm2java
 */
public class UaaStopCodonSignalId implements java.io.Serializable {

	private Integer uaaStopCodonSignalId;
	...
	public UaaStopCodonSignalId() {
	}

	public UaaStopCodonSignalId(Integer uaaStopCodonSignalId,
		...
		this.uaaStopCodonSignalId = uaaStopCodonSignalId;
	...
	public Integer getUaaStopCodonSignalId() {
		return this.uaaStopCodonSignalId;
	}

	public void setUaaStopCodonSignalId(Integer uaaStopCodonSignalId) {
		this.uaaStopCodonSignalId = uaaStopCodonSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UaaStopCodonSignalId))
			return false;
		UaaStopCodonSignalId castOther = (UaaStopCodonSignalId) other;

		return ((this.getUaaStopCodonSignalId() == castOther
				.getUaaStopCodonSignalId()) || (this.getUaaStopCodonSignalId() != null
				&& castOther.getUaaStopCodonSignalId() != null && this
				.getUaaStopCodonSignalId().equals(
						castOther.getUaaStopCodonSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUaaStopCodonSignalId() == null ? 0 : this
						.getUaaStopCodonSignalId().hashCode());
		result = 37 * result
