...
/**
 * SequenceVariantId generated by hbm2java
 */
public class SequenceVariantId implements java.io.Serializable {

	private Integer sequenceVariantId;
	...
	public SequenceVariantId() {
	}

	public SequenceVariantId(Integer sequenceVariantId, Integer featureId,
		...
		this.sequenceVariantId = sequenceVariantId;
	...
	public Integer getSequenceVariantId() {
		return this.sequenceVariantId;
	}

	public void setSequenceVariantId(Integer sequenceVariantId) {
		this.sequenceVariantId = sequenceVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceVariantId))
			return false;
		SequenceVariantId castOther = (SequenceVariantId) other;

		return ((this.getSequenceVariantId() == castOther
				.getSequenceVariantId()) || (this.getSequenceVariantId() != null
				&& castOther.getSequenceVariantId() != null && this
				.getSequenceVariantId()
				.equals(castOther.getSequenceVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceVariantId() == null ? 0 : this
						.getSequenceVariantId().hashCode());
		result = 37 * result
