...
/**
 * DInterchrTranspositionId generated by hbm2java
 */
public class DInterchrTranspositionId implements java.io.Serializable {

	private Integer DInterchrTranspositionId;
	...
	public DInterchrTranspositionId() {
	}

	public DInterchrTranspositionId(Integer DInterchrTranspositionId,
		...
		this.DInterchrTranspositionId = DInterchrTranspositionId;
	...
	public Integer getDInterchrTranspositionId() {
		return this.DInterchrTranspositionId;
	}

	public void setDInterchrTranspositionId(Integer DInterchrTranspositionId) {
		this.DInterchrTranspositionId = DInterchrTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DInterchrTranspositionId))
			return false;
		DInterchrTranspositionId castOther = (DInterchrTranspositionId) other;

		return ((this.getDInterchrTranspositionId() == castOther
				.getDInterchrTranspositionId()) || (this
				.getDInterchrTranspositionId() != null
				&& castOther.getDInterchrTranspositionId() != null && this
				.getDInterchrTranspositionId().equals(
						castOther.getDInterchrTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDInterchrTranspositionId() == null ? 0 : this
						.getDInterchrTranspositionId().hashCode());
		result = 37 * result
