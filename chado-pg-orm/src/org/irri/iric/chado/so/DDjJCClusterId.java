...
/**
 * DDjJCClusterId generated by hbm2java
 */
public class DDjJCClusterId implements java.io.Serializable {

	private Integer DDjJCClusterId;
	...
	public DDjJCClusterId() {
	}

	public DDjJCClusterId(Integer DDjJCClusterId, Integer featureId,
		...
		this.DDjJCClusterId = DDjJCClusterId;
	...
	public Integer getDDjJCClusterId() {
		return this.DDjJCClusterId;
	}

	public void setDDjJCClusterId(Integer DDjJCClusterId) {
		this.DDjJCClusterId = DDjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DDjJCClusterId))
			return false;
		DDjJCClusterId castOther = (DDjJCClusterId) other;

		return ((this.getDDjJCClusterId() == castOther.getDDjJCClusterId()) || (this
				.getDDjJCClusterId() != null
				&& castOther.getDDjJCClusterId() != null && this
				.getDDjJCClusterId().equals(castOther.getDDjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDDjJCClusterId() == null ? 0 : this.getDDjJCClusterId()
						.hashCode());
		result = 37 * result
