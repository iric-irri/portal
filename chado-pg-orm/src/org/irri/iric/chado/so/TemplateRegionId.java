...
/**
 * TemplateRegionId generated by hbm2java
 */
public class TemplateRegionId implements java.io.Serializable {

	private Integer templateRegionId;
	...
	public TemplateRegionId(Integer templateRegionId, Integer featureId,
	...
	public Integer getTemplateRegionId() {
		return this.templateRegionId;
	}

	public void setTemplateRegionId(Integer templateRegionId) {
		this.templateRegionId = templateRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TemplateRegionId))
			return false;
		TemplateRegionId castOther = (TemplateRegionId) other;

		return ((this.getTemplateRegionId() == castOther.getTemplateRegionId()) || (this
				.getTemplateRegionId() != null
				&& castOther.getTemplateRegionId() != null && this
				.getTemplateRegionId().equals(castOther.getTemplateRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTemplateRegionId() == null ? 0 : this
						.getTemplateRegionId().hashCode());
		result = 37 * result
