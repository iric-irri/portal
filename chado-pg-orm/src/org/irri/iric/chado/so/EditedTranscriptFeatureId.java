...
/**
 * EditedTranscriptFeatureId generated by hbm2java
 */
public class EditedTranscriptFeatureId implements java.io.Serializable {

	private Integer editedTranscriptFeatureId;
	...
	public EditedTranscriptFeatureId() {
	}

	public EditedTranscriptFeatureId(Integer editedTranscriptFeatureId,
		...
		this.editedTranscriptFeatureId = editedTranscriptFeatureId;
	...
	public Integer getEditedTranscriptFeatureId() {
		return this.editedTranscriptFeatureId;
	}

	public void setEditedTranscriptFeatureId(Integer editedTranscriptFeatureId) {
		this.editedTranscriptFeatureId = editedTranscriptFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedTranscriptFeatureId))
			return false;
		EditedTranscriptFeatureId castOther = (EditedTranscriptFeatureId) other;

		return ((this.getEditedTranscriptFeatureId() == castOther
				.getEditedTranscriptFeatureId()) || (this
				.getEditedTranscriptFeatureId() != null
				&& castOther.getEditedTranscriptFeatureId() != null && this
				.getEditedTranscriptFeatureId().equals(
						castOther.getEditedTranscriptFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditedTranscriptFeatureId() == null ? 0 : this
						.getEditedTranscriptFeatureId().hashCode());
		result = 37 * result
