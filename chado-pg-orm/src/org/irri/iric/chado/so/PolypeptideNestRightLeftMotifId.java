...
/**
 * PolypeptideNestRightLeftMotifId generated by hbm2java
 */
public class PolypeptideNestRightLeftMotifId implements java.io.Serializable {

	private Integer polypeptideNestRightLeftMotifId;
	...
	public PolypeptideNestRightLeftMotifId() {
	}

	public PolypeptideNestRightLeftMotifId(
			Integer polypeptideNestRightLeftMotifId, Integer featureId,
		...
		this.polypeptideNestRightLeftMotifId = polypeptideNestRightLeftMotifId;
	...
	public Integer getPolypeptideNestRightLeftMotifId() {
		return this.polypeptideNestRightLeftMotifId;
	}

	public void setPolypeptideNestRightLeftMotifId(
			Integer polypeptideNestRightLeftMotifId) {
		this.polypeptideNestRightLeftMotifId = polypeptideNestRightLeftMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideNestRightLeftMotifId))
			return false;
		PolypeptideNestRightLeftMotifId castOther = (PolypeptideNestRightLeftMotifId) other;

		return ((this.getPolypeptideNestRightLeftMotifId() == castOther
				.getPolypeptideNestRightLeftMotifId()) || (this
				.getPolypeptideNestRightLeftMotifId() != null
				&& castOther.getPolypeptideNestRightLeftMotifId() != null && this
				.getPolypeptideNestRightLeftMotifId().equals(
						castOther.getPolypeptideNestRightLeftMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideNestRightLeftMotifId() == null ? 0 : this
						.getPolypeptideNestRightLeftMotifId().hashCode());
		result = 37 * result
