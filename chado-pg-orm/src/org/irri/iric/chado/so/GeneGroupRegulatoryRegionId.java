...
/**
 * GeneGroupRegulatoryRegionId generated by hbm2java
 */
public class GeneGroupRegulatoryRegionId implements java.io.Serializable {

	private Integer geneGroupRegulatoryRegionId;
	...
	public GeneGroupRegulatoryRegionId() {
	}

	public GeneGroupRegulatoryRegionId(Integer geneGroupRegulatoryRegionId,
		...
		this.geneGroupRegulatoryRegionId = geneGroupRegulatoryRegionId;
	...
	public Integer getGeneGroupRegulatoryRegionId() {
		return this.geneGroupRegulatoryRegionId;
	}

	public void setGeneGroupRegulatoryRegionId(
			Integer geneGroupRegulatoryRegionId) {
		this.geneGroupRegulatoryRegionId = geneGroupRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneGroupRegulatoryRegionId))
			return false;
		GeneGroupRegulatoryRegionId castOther = (GeneGroupRegulatoryRegionId) other;

		return ((this.getGeneGroupRegulatoryRegionId() == castOther
				.getGeneGroupRegulatoryRegionId()) || (this
				.getGeneGroupRegulatoryRegionId() != null
				&& castOther.getGeneGroupRegulatoryRegionId() != null && this
				.getGeneGroupRegulatoryRegionId().equals(
						castOther.getGeneGroupRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneGroupRegulatoryRegionId() == null ? 0 : this
						.getGeneGroupRegulatoryRegionId().hashCode());
		result = 37 * result
