...
/**
 * OneMethyl33AminoThreeCarboxypropylPseudouridineId generated by hbm2java
 */
public class OneMethyl33AminoThreeCarboxypropylPseudouridineId implements
		java.io.Serializable {

	private Integer oneMethyl33AminoThreeCarboxypropylPseudouridineId;
	...
	public OneMethyl33AminoThreeCarboxypropylPseudouridineId() {
	}

	public OneMethyl33AminoThreeCarboxypropylPseudouridineId(
			Integer oneMethyl33AminoThreeCarboxypropylPseudouridineId,
		...
		this.oneMethyl33AminoThreeCarboxypropylPseudouridineId = oneMethyl33AminoThreeCarboxypropylPseudouridineId;
	...
	public Integer getOneMethyl33AminoThreeCarboxypropylPseudouridineId() {
		return this.oneMethyl33AminoThreeCarboxypropylPseudouridineId;
	}

	public void setOneMethyl33AminoThreeCarboxypropylPseudouridineId(
			Integer oneMethyl33AminoThreeCarboxypropylPseudouridineId) {
		this.oneMethyl33AminoThreeCarboxypropylPseudouridineId = oneMethyl33AminoThreeCarboxypropylPseudouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneMethyl33AminoThreeCarboxypropylPseudouridineId))
			return false;
		OneMethyl33AminoThreeCarboxypropylPseudouridineId castOther = (OneMethyl33AminoThreeCarboxypropylPseudouridineId) other;

		return ((this.getOneMethyl33AminoThreeCarboxypropylPseudouridineId() == castOther
				.getOneMethyl33AminoThreeCarboxypropylPseudouridineId()) || (this
				.getOneMethyl33AminoThreeCarboxypropylPseudouridineId() != null
				&& castOther
						.getOneMethyl33AminoThreeCarboxypropylPseudouridineId() != null && this
				.getOneMethyl33AminoThreeCarboxypropylPseudouridineId()
				.equals(castOther
						.getOneMethyl33AminoThreeCarboxypropylPseudouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneMethyl33AminoThreeCarboxypropylPseudouridineId() == null ? 0
						: this.getOneMethyl33AminoThreeCarboxypropylPseudouridineId()
								.hashCode());
		result = 37 * result
