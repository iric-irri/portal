...
/**
 * RreRnaId generated by hbm2java
 */
public class RreRnaId implements java.io.Serializable {

	private Integer rreRnaId;
	...
	public RreRnaId(Integer rreRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRreRnaId() {
		return this.rreRnaId;
	}

	public void setRreRnaId(Integer rreRnaId) {
		this.rreRnaId = rreRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RreRnaId))
			return false;
		RreRnaId castOther = (RreRnaId) other;

		return ((this.getRreRnaId() == castOther.getRreRnaId()) || (this
				.getRreRnaId() != null && castOther.getRreRnaId() != null && this
				.getRreRnaId().equals(castOther.getRreRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRreRnaId() == null ? 0 : this.getRreRnaId().hashCode());
		result = 37 * result
