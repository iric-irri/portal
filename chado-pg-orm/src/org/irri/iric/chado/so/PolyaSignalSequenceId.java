...
/**
 * PolyaSignalSequenceId generated by hbm2java
 */
public class PolyaSignalSequenceId implements java.io.Serializable {

	private Integer polyaSignalSequenceId;
	...
	public PolyaSignalSequenceId() {
	}

	public PolyaSignalSequenceId(Integer polyaSignalSequenceId,
		...
		this.polyaSignalSequenceId = polyaSignalSequenceId;
	...
	public Integer getPolyaSignalSequenceId() {
		return this.polyaSignalSequenceId;
	}

	public void setPolyaSignalSequenceId(Integer polyaSignalSequenceId) {
		this.polyaSignalSequenceId = polyaSignalSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyaSignalSequenceId))
			return false;
		PolyaSignalSequenceId castOther = (PolyaSignalSequenceId) other;

		return ((this.getPolyaSignalSequenceId() == castOther
				.getPolyaSignalSequenceId()) || (this
				.getPolyaSignalSequenceId() != null
				&& castOther.getPolyaSignalSequenceId() != null && this
				.getPolyaSignalSequenceId().equals(
						castOther.getPolyaSignalSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyaSignalSequenceId() == null ? 0 : this
						.getPolyaSignalSequenceId().hashCode());
		result = 37 * result
