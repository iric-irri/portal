...
/**
 * FunctionalVariantId generated by hbm2java
 */
public class FunctionalVariantId implements java.io.Serializable {

	private Integer functionalVariantId;
	...
	public FunctionalVariantId() {
	}

	public FunctionalVariantId(Integer functionalVariantId, Integer featureId,
		...
		this.functionalVariantId = functionalVariantId;
	...
	public Integer getFunctionalVariantId() {
		return this.functionalVariantId;
	}

	public void setFunctionalVariantId(Integer functionalVariantId) {
		this.functionalVariantId = functionalVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FunctionalVariantId))
			return false;
		FunctionalVariantId castOther = (FunctionalVariantId) other;

		return ((this.getFunctionalVariantId() == castOther
				.getFunctionalVariantId()) || (this.getFunctionalVariantId() != null
				&& castOther.getFunctionalVariantId() != null && this
				.getFunctionalVariantId().equals(
						castOther.getFunctionalVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFunctionalVariantId() == null ? 0 : this
						.getFunctionalVariantId().hashCode());
		result = 37 * result
