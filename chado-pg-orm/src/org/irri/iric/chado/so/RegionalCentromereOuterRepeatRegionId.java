...
/**
 * RegionalCentromereOuterRepeatRegionId generated by hbm2java
 */
public class RegionalCentromereOuterRepeatRegionId implements
		java.io.Serializable {

	private Integer regionalCentromereOuterRepeatRegionId;
	...
	public RegionalCentromereOuterRepeatRegionId() {
	}

	public RegionalCentromereOuterRepeatRegionId(
			Integer regionalCentromereOuterRepeatRegionId, Integer featureId,
		...
		this.regionalCentromereOuterRepeatRegionId = regionalCentromereOuterRepeatRegionId;
	...
	public Integer getRegionalCentromereOuterRepeatRegionId() {
		return this.regionalCentromereOuterRepeatRegionId;
	}

	public void setRegionalCentromereOuterRepeatRegionId(
			Integer regionalCentromereOuterRepeatRegionId) {
		this.regionalCentromereOuterRepeatRegionId = regionalCentromereOuterRepeatRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegionalCentromereOuterRepeatRegionId))
			return false;
		RegionalCentromereOuterRepeatRegionId castOther = (RegionalCentromereOuterRepeatRegionId) other;

		return ((this.getRegionalCentromereOuterRepeatRegionId() == castOther
				.getRegionalCentromereOuterRepeatRegionId()) || (this
				.getRegionalCentromereOuterRepeatRegionId() != null
				&& castOther.getRegionalCentromereOuterRepeatRegionId() != null && this
				.getRegionalCentromereOuterRepeatRegionId().equals(
						castOther.getRegionalCentromereOuterRepeatRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegionalCentromereOuterRepeatRegionId() == null ? 0
						: this.getRegionalCentromereOuterRepeatRegionId()
								.hashCode());
		result = 37 * result
