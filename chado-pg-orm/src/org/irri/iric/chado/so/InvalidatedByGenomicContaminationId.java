...
/**
 * InvalidatedByGenomicContaminationId generated by hbm2java
 */
public class InvalidatedByGenomicContaminationId implements
		java.io.Serializable {

	private Integer invalidatedByGenomicContaminationId;
	...
	public InvalidatedByGenomicContaminationId() {
	}

	public InvalidatedByGenomicContaminationId(
			Integer invalidatedByGenomicContaminationId, Integer featureId,
		...
		this.invalidatedByGenomicContaminationId = invalidatedByGenomicContaminationId;
	...
	public Integer getInvalidatedByGenomicContaminationId() {
		return this.invalidatedByGenomicContaminationId;
	}

	public void setInvalidatedByGenomicContaminationId(
			Integer invalidatedByGenomicContaminationId) {
		this.invalidatedByGenomicContaminationId = invalidatedByGenomicContaminationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedByGenomicContaminationId))
			return false;
		InvalidatedByGenomicContaminationId castOther = (InvalidatedByGenomicContaminationId) other;

		return ((this.getInvalidatedByGenomicContaminationId() == castOther
				.getInvalidatedByGenomicContaminationId()) || (this
				.getInvalidatedByGenomicContaminationId() != null
				&& castOther.getInvalidatedByGenomicContaminationId() != null && this
				.getInvalidatedByGenomicContaminationId().equals(
						castOther.getInvalidatedByGenomicContaminationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedByGenomicContaminationId() == null ? 0 : this
						.getInvalidatedByGenomicContaminationId().hashCode());
		result = 37 * result
