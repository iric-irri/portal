...
/**
 * U4atacSnrnaId generated by hbm2java
 */
public class U4atacSnrnaId implements java.io.Serializable {

	private Integer u4atacSnrnaId;
	...
	public U4atacSnrnaId() {
	}

	public U4atacSnrnaId(Integer u4atacSnrnaId, Integer featureId,
		...
		this.u4atacSnrnaId = u4atacSnrnaId;
	...
	public Integer getU4atacSnrnaId() {
		return this.u4atacSnrnaId;
	}

	public void setU4atacSnrnaId(Integer u4atacSnrnaId) {
		this.u4atacSnrnaId = u4atacSnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U4atacSnrnaId))
			return false;
		U4atacSnrnaId castOther = (U4atacSnrnaId) other;

		return ((this.getU4atacSnrnaId() == castOther.getU4atacSnrnaId()) || (this
				.getU4atacSnrnaId() != null
				&& castOther.getU4atacSnrnaId() != null && this
				.getU4atacSnrnaId().equals(castOther.getU4atacSnrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU4atacSnrnaId() == null ? 0 : this.getU4atacSnrnaId()
						.hashCode());
		result = 37 * result
