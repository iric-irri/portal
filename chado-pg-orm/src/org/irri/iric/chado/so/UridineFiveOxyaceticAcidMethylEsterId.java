...
/**
 * UridineFiveOxyaceticAcidMethylEsterId generated by hbm2java
 */
public class UridineFiveOxyaceticAcidMethylEsterId implements
		java.io.Serializable {

	private Integer uridineFiveOxyaceticAcidMethylEsterId;
	...
	public UridineFiveOxyaceticAcidMethylEsterId() {
	}

	public UridineFiveOxyaceticAcidMethylEsterId(
			Integer uridineFiveOxyaceticAcidMethylEsterId, Integer featureId,
		...
		this.uridineFiveOxyaceticAcidMethylEsterId = uridineFiveOxyaceticAcidMethylEsterId;
	...
	public Integer getUridineFiveOxyaceticAcidMethylEsterId() {
		return this.uridineFiveOxyaceticAcidMethylEsterId;
	}

	public void setUridineFiveOxyaceticAcidMethylEsterId(
			Integer uridineFiveOxyaceticAcidMethylEsterId) {
		this.uridineFiveOxyaceticAcidMethylEsterId = uridineFiveOxyaceticAcidMethylEsterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UridineFiveOxyaceticAcidMethylEsterId))
			return false;
		UridineFiveOxyaceticAcidMethylEsterId castOther = (UridineFiveOxyaceticAcidMethylEsterId) other;

		return ((this.getUridineFiveOxyaceticAcidMethylEsterId() == castOther
				.getUridineFiveOxyaceticAcidMethylEsterId()) || (this
				.getUridineFiveOxyaceticAcidMethylEsterId() != null
				&& castOther.getUridineFiveOxyaceticAcidMethylEsterId() != null && this
				.getUridineFiveOxyaceticAcidMethylEsterId().equals(
						castOther.getUridineFiveOxyaceticAcidMethylEsterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUridineFiveOxyaceticAcidMethylEsterId() == null ? 0
						: this.getUridineFiveOxyaceticAcidMethylEsterId()
								.hashCode());
		result = 37 * result
