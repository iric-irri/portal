...
/**
 * CtgStartCodonId generated by hbm2java
 */
public class CtgStartCodonId implements java.io.Serializable {

	private Integer ctgStartCodonId;
	...
	public CtgStartCodonId() {
	}

	public CtgStartCodonId(Integer ctgStartCodonId, Integer featureId,
		...
		this.ctgStartCodonId = ctgStartCodonId;
	...
	public Integer getCtgStartCodonId() {
		return this.ctgStartCodonId;
	}

	public void setCtgStartCodonId(Integer ctgStartCodonId) {
		this.ctgStartCodonId = ctgStartCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CtgStartCodonId))
			return false;
		CtgStartCodonId castOther = (CtgStartCodonId) other;

		return ((this.getCtgStartCodonId() == castOther.getCtgStartCodonId()) || (this
				.getCtgStartCodonId() != null
				&& castOther.getCtgStartCodonId() != null && this
				.getCtgStartCodonId().equals(castOther.getCtgStartCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCtgStartCodonId() == null ? 0 : this.getCtgStartCodonId()
						.hashCode());
		result = 37 * result
