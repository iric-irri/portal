...
/**
 * ContigCollectionId generated by hbm2java
 */
public class ContigCollectionId implements java.io.Serializable {

	private Integer contigCollectionId;
	...
	public ContigCollectionId() {
	}

	public ContigCollectionId(Integer contigCollectionId, Integer featureId,
		...
		this.contigCollectionId = contigCollectionId;
	...
	public Integer getContigCollectionId() {
		return this.contigCollectionId;
	}

	public void setContigCollectionId(Integer contigCollectionId) {
		this.contigCollectionId = contigCollectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContigCollectionId))
			return false;
		ContigCollectionId castOther = (ContigCollectionId) other;

		return ((this.getContigCollectionId() == castOther
				.getContigCollectionId()) || (this.getContigCollectionId() != null
				&& castOther.getContigCollectionId() != null && this
				.getContigCollectionId().equals(
						castOther.getContigCollectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getContigCollectionId() == null ? 0 : this
						.getContigCollectionId().hashCode());
		result = 37 * result
