...
/**
 * PseudogenicTranscriptId generated by hbm2java
 */
public class PseudogenicTranscriptId implements java.io.Serializable {

	private Integer pseudogenicTranscriptId;
	...
	public PseudogenicTranscriptId() {
	}

	public PseudogenicTranscriptId(Integer pseudogenicTranscriptId,
		...
		this.pseudogenicTranscriptId = pseudogenicTranscriptId;
	...
	public Integer getPseudogenicTranscriptId() {
		return this.pseudogenicTranscriptId;
	}

	public void setPseudogenicTranscriptId(Integer pseudogenicTranscriptId) {
		this.pseudogenicTranscriptId = pseudogenicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicTranscriptId))
			return false;
		PseudogenicTranscriptId castOther = (PseudogenicTranscriptId) other;

		return ((this.getPseudogenicTranscriptId() == castOther
				.getPseudogenicTranscriptId()) || (this
				.getPseudogenicTranscriptId() != null
				&& castOther.getPseudogenicTranscriptId() != null && this
				.getPseudogenicTranscriptId().equals(
						castOther.getPseudogenicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicTranscriptId() == null ? 0 : this
						.getPseudogenicTranscriptId().hashCode());
		result = 37 * result
