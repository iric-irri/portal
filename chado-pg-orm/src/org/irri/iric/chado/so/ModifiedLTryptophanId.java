...
/**
 * ModifiedLTryptophanId generated by hbm2java
 */
public class ModifiedLTryptophanId implements java.io.Serializable {

	private Integer modifiedLTryptophanId;
	...
	public ModifiedLTryptophanId() {
	}

	public ModifiedLTryptophanId(Integer modifiedLTryptophanId,
		...
		this.modifiedLTryptophanId = modifiedLTryptophanId;
	...
	public Integer getModifiedLTryptophanId() {
		return this.modifiedLTryptophanId;
	}

	public void setModifiedLTryptophanId(Integer modifiedLTryptophanId) {
		this.modifiedLTryptophanId = modifiedLTryptophanId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLTryptophanId))
			return false;
		ModifiedLTryptophanId castOther = (ModifiedLTryptophanId) other;

		return ((this.getModifiedLTryptophanId() == castOther
				.getModifiedLTryptophanId()) || (this
				.getModifiedLTryptophanId() != null
				&& castOther.getModifiedLTryptophanId() != null && this
				.getModifiedLTryptophanId().equals(
						castOther.getModifiedLTryptophanId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLTryptophanId() == null ? 0 : this
						.getModifiedLTryptophanId().hashCode());
		result = 37 * result
