...
/**
 * TranscribedClusterId generated by hbm2java
 */
public class TranscribedClusterId implements java.io.Serializable {

	private Integer transcribedClusterId;
	...
	public TranscribedClusterId() {
	}

	public TranscribedClusterId(Integer transcribedClusterId,
		...
		this.transcribedClusterId = transcribedClusterId;
	...
	public Integer getTranscribedClusterId() {
		return this.transcribedClusterId;
	}

	public void setTranscribedClusterId(Integer transcribedClusterId) {
		this.transcribedClusterId = transcribedClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscribedClusterId))
			return false;
		TranscribedClusterId castOther = (TranscribedClusterId) other;

		return ((this.getTranscribedClusterId() == castOther
				.getTranscribedClusterId()) || (this.getTranscribedClusterId() != null
				&& castOther.getTranscribedClusterId() != null && this
				.getTranscribedClusterId().equals(
						castOther.getTranscribedClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscribedClusterId() == null ? 0 : this
						.getTranscribedClusterId().hashCode());
		result = 37 * result
