...
/**
 * ConformationalChangeVariantId generated by hbm2java
 */
public class ConformationalChangeVariantId implements java.io.Serializable {

	private Integer conformationalChangeVariantId;
	...
	public ConformationalChangeVariantId() {
	}

	public ConformationalChangeVariantId(Integer conformationalChangeVariantId,
		...
		this.conformationalChangeVariantId = conformationalChangeVariantId;
	...
	public Integer getConformationalChangeVariantId() {
		return this.conformationalChangeVariantId;
	}

	public void setConformationalChangeVariantId(
			Integer conformationalChangeVariantId) {
		this.conformationalChangeVariantId = conformationalChangeVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConformationalChangeVariantId))
			return false;
		ConformationalChangeVariantId castOther = (ConformationalChangeVariantId) other;

		return ((this.getConformationalChangeVariantId() == castOther
				.getConformationalChangeVariantId()) || (this
				.getConformationalChangeVariantId() != null
				&& castOther.getConformationalChangeVariantId() != null && this
				.getConformationalChangeVariantId().equals(
						castOther.getConformationalChangeVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConformationalChangeVariantId() == null ? 0 : this
						.getConformationalChangeVariantId().hashCode());
		result = 37 * result
