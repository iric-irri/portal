...
/**
 * PaternallyImprintedGeneId generated by hbm2java
 */
public class PaternallyImprintedGeneId implements java.io.Serializable {

	private Integer paternallyImprintedGeneId;
	...
	public PaternallyImprintedGeneId() {
	}

	public PaternallyImprintedGeneId(Integer paternallyImprintedGeneId,
		...
		this.paternallyImprintedGeneId = paternallyImprintedGeneId;
	...
	public Integer getPaternallyImprintedGeneId() {
		return this.paternallyImprintedGeneId;
	}

	public void setPaternallyImprintedGeneId(Integer paternallyImprintedGeneId) {
		this.paternallyImprintedGeneId = paternallyImprintedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaternallyImprintedGeneId))
			return false;
		PaternallyImprintedGeneId castOther = (PaternallyImprintedGeneId) other;

		return ((this.getPaternallyImprintedGeneId() == castOther
				.getPaternallyImprintedGeneId()) || (this
				.getPaternallyImprintedGeneId() != null
				&& castOther.getPaternallyImprintedGeneId() != null && this
				.getPaternallyImprintedGeneId().equals(
						castOther.getPaternallyImprintedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPaternallyImprintedGeneId() == null ? 0 : this
						.getPaternallyImprintedGeneId().hashCode());
		result = 37 * result
