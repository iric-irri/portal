...
/**
 * SequenceCollectionId generated by hbm2java
 */
public class SequenceCollectionId implements java.io.Serializable {

	private Integer sequenceCollectionId;
	...
	public SequenceCollectionId() {
	}

	public SequenceCollectionId(Integer sequenceCollectionId,
		...
		this.sequenceCollectionId = sequenceCollectionId;
	...
	public Integer getSequenceCollectionId() {
		return this.sequenceCollectionId;
	}

	public void setSequenceCollectionId(Integer sequenceCollectionId) {
		this.sequenceCollectionId = sequenceCollectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceCollectionId))
			return false;
		SequenceCollectionId castOther = (SequenceCollectionId) other;

		return ((this.getSequenceCollectionId() == castOther
				.getSequenceCollectionId()) || (this.getSequenceCollectionId() != null
				&& castOther.getSequenceCollectionId() != null && this
				.getSequenceCollectionId().equals(
						castOther.getSequenceCollectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceCollectionId() == null ? 0 : this
						.getSequenceCollectionId().hashCode());
		result = 37 * result
