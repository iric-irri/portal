...
/**
 * SpliceSiteId generated by hbm2java
 */
public class SpliceSiteId implements java.io.Serializable {

	private Integer spliceSiteId;
	...
	public SpliceSiteId(Integer spliceSiteId, Integer featureId,
		...
		this.spliceSiteId = spliceSiteId;
	...
	public Integer getSpliceSiteId() {
		return this.spliceSiteId;
	}

	public void setSpliceSiteId(Integer spliceSiteId) {
		this.spliceSiteId = spliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceSiteId))
			return false;
		SpliceSiteId castOther = (SpliceSiteId) other;

		return ((this.getSpliceSiteId() == castOther.getSpliceSiteId()) || (this
				.getSpliceSiteId() != null
				&& castOther.getSpliceSiteId() != null && this
				.getSpliceSiteId().equals(castOther.getSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceSiteId() == null ? 0 : this.getSpliceSiteId()
						.hashCode());
		result = 37 * result
