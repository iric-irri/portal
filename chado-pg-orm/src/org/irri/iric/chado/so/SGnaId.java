...
/**
 * SGnaId generated by hbm2java
 */
public class SGnaId implements java.io.Serializable {

	private Integer SGnaId;
	...
	public SGnaId(Integer SGnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSGnaId() {
		return this.SGnaId;
	}

	public void setSGnaId(Integer SGnaId) {
		this.SGnaId = SGnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SGnaId))
			return false;
		SGnaId castOther = (SGnaId) other;

		return ((this.getSGnaId() == castOther.getSGnaId()) || (this
				.getSGnaId() != null && castOther.getSGnaId() != null && this
				.getSGnaId().equals(castOther.getSGnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSGnaId() == null ? 0 : this.getSGnaId().hashCode());
		result = 37 * result
