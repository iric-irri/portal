...
/**
 * SingleStrandRestrictionEnzymeCleavageSiteId generated by hbm2java
 */
public class SingleStrandRestrictionEnzymeCleavageSiteId implements
		java.io.Serializable {

	private Integer singleStrandRestrictionEnzymeCleavageSiteId;
	...
	public SingleStrandRestrictionEnzymeCleavageSiteId() {
	}

	public SingleStrandRestrictionEnzymeCleavageSiteId(
			Integer singleStrandRestrictionEnzymeCleavageSiteId,
		...
		this.singleStrandRestrictionEnzymeCleavageSiteId = singleStrandRestrictionEnzymeCleavageSiteId;
	...
	public Integer getSingleStrandRestrictionEnzymeCleavageSiteId() {
		return this.singleStrandRestrictionEnzymeCleavageSiteId;
	}

	public void setSingleStrandRestrictionEnzymeCleavageSiteId(
			Integer singleStrandRestrictionEnzymeCleavageSiteId) {
		this.singleStrandRestrictionEnzymeCleavageSiteId = singleStrandRestrictionEnzymeCleavageSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SingleStrandRestrictionEnzymeCleavageSiteId))
			return false;
		SingleStrandRestrictionEnzymeCleavageSiteId castOther = (SingleStrandRestrictionEnzymeCleavageSiteId) other;

		return ((this.getSingleStrandRestrictionEnzymeCleavageSiteId() == castOther
				.getSingleStrandRestrictionEnzymeCleavageSiteId()) || (this
				.getSingleStrandRestrictionEnzymeCleavageSiteId() != null
				&& castOther.getSingleStrandRestrictionEnzymeCleavageSiteId() != null && this
				.getSingleStrandRestrictionEnzymeCleavageSiteId()
				.equals(castOther
						.getSingleStrandRestrictionEnzymeCleavageSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSingleStrandRestrictionEnzymeCleavageSiteId() == null ? 0
						: this.getSingleStrandRestrictionEnzymeCleavageSiteId()
								.hashCode());
		result = 37 * result
