...
/**
 * MrnaRecodedByCodonRedefinitionId generated by hbm2java
 */
public class MrnaRecodedByCodonRedefinitionId implements java.io.Serializable {

	private Integer mrnaRecodedByCodonRedefinitionId;
	...
	public MrnaRecodedByCodonRedefinitionId() {
	}

	public MrnaRecodedByCodonRedefinitionId(
			Integer mrnaRecodedByCodonRedefinitionId, Integer featureId,
		...
		this.mrnaRecodedByCodonRedefinitionId = mrnaRecodedByCodonRedefinitionId;
	...
	public Integer getMrnaRecodedByCodonRedefinitionId() {
		return this.mrnaRecodedByCodonRedefinitionId;
	}

	public void setMrnaRecodedByCodonRedefinitionId(
			Integer mrnaRecodedByCodonRedefinitionId) {
		this.mrnaRecodedByCodonRedefinitionId = mrnaRecodedByCodonRedefinitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaRecodedByCodonRedefinitionId))
			return false;
		MrnaRecodedByCodonRedefinitionId castOther = (MrnaRecodedByCodonRedefinitionId) other;

		return ((this.getMrnaRecodedByCodonRedefinitionId() == castOther
				.getMrnaRecodedByCodonRedefinitionId()) || (this
				.getMrnaRecodedByCodonRedefinitionId() != null
				&& castOther.getMrnaRecodedByCodonRedefinitionId() != null && this
				.getMrnaRecodedByCodonRedefinitionId().equals(
						castOther.getMrnaRecodedByCodonRedefinitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaRecodedByCodonRedefinitionId() == null ? 0 : this
						.getMrnaRecodedByCodonRedefinitionId().hashCode());
		result = 37 * result
