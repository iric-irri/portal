...
/**
 * StopCodonId generated by hbm2java
 */
public class StopCodonId implements java.io.Serializable {

	private Integer stopCodonId;
	...
	public StopCodonId(Integer stopCodonId, Integer featureId,
	...
	public Integer getStopCodonId() {
		return this.stopCodonId;
	}

	public void setStopCodonId(Integer stopCodonId) {
		this.stopCodonId = stopCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopCodonId))
			return false;
		StopCodonId castOther = (StopCodonId) other;

		return ((this.getStopCodonId() == castOther.getStopCodonId()) || (this
				.getStopCodonId() != null && castOther.getStopCodonId() != null && this
				.getStopCodonId().equals(castOther.getStopCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopCodonId() == null ? 0 : this.getStopCodonId()
						.hashCode());
		result = 37 * result
