...
/**
 * RnaMotifId generated by hbm2java
 */
public class RnaMotifId implements java.io.Serializable {

	private Integer rnaMotifId;
	...
	public RnaMotifId(Integer rnaMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRnaMotifId() {
		return this.rnaMotifId;
	}

	public void setRnaMotifId(Integer rnaMotifId) {
		this.rnaMotifId = rnaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaMotifId))
			return false;
		RnaMotifId castOther = (RnaMotifId) other;

		return ((this.getRnaMotifId() == castOther.getRnaMotifId()) || (this
				.getRnaMotifId() != null && castOther.getRnaMotifId() != null && this
				.getRnaMotifId().equals(castOther.getRnaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaMotifId() == null ? 0 : this.getRnaMotifId()
						.hashCode());
		result = 37 * result
