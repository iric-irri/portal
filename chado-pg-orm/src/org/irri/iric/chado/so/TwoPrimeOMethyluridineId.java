...
/**
 * TwoPrimeOMethyluridineId generated by hbm2java
 */
public class TwoPrimeOMethyluridineId implements java.io.Serializable {

	private Integer twoPrimeOMethyluridineId;
	...
	public TwoPrimeOMethyluridineId() {
	}

	public TwoPrimeOMethyluridineId(Integer twoPrimeOMethyluridineId,
		...
		this.twoPrimeOMethyluridineId = twoPrimeOMethyluridineId;
	...
	public Integer getTwoPrimeOMethyluridineId() {
		return this.twoPrimeOMethyluridineId;
	}

	public void setTwoPrimeOMethyluridineId(Integer twoPrimeOMethyluridineId) {
		this.twoPrimeOMethyluridineId = twoPrimeOMethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethyluridineId))
			return false;
		TwoPrimeOMethyluridineId castOther = (TwoPrimeOMethyluridineId) other;

		return ((this.getTwoPrimeOMethyluridineId() == castOther
				.getTwoPrimeOMethyluridineId()) || (this
				.getTwoPrimeOMethyluridineId() != null
				&& castOther.getTwoPrimeOMethyluridineId() != null && this
				.getTwoPrimeOMethyluridineId().equals(
						castOther.getTwoPrimeOMethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethyluridineId() == null ? 0 : this
						.getTwoPrimeOMethyluridineId().hashCode());
		result = 37 * result
