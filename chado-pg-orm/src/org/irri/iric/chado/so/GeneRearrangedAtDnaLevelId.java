...
/**
 * GeneRearrangedAtDnaLevelId generated by hbm2java
 */
public class GeneRearrangedAtDnaLevelId implements java.io.Serializable {

	private Integer geneRearrangedAtDnaLevelId;
	...
	public GeneRearrangedAtDnaLevelId() {
	}

	public GeneRearrangedAtDnaLevelId(Integer geneRearrangedAtDnaLevelId,
		...
		this.geneRearrangedAtDnaLevelId = geneRearrangedAtDnaLevelId;
	...
	public Integer getGeneRearrangedAtDnaLevelId() {
		return this.geneRearrangedAtDnaLevelId;
	}

	public void setGeneRearrangedAtDnaLevelId(Integer geneRearrangedAtDnaLevelId) {
		this.geneRearrangedAtDnaLevelId = geneRearrangedAtDnaLevelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneRearrangedAtDnaLevelId))
			return false;
		GeneRearrangedAtDnaLevelId castOther = (GeneRearrangedAtDnaLevelId) other;

		return ((this.getGeneRearrangedAtDnaLevelId() == castOther
				.getGeneRearrangedAtDnaLevelId()) || (this
				.getGeneRearrangedAtDnaLevelId() != null
				&& castOther.getGeneRearrangedAtDnaLevelId() != null && this
				.getGeneRearrangedAtDnaLevelId().equals(
						castOther.getGeneRearrangedAtDnaLevelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneRearrangedAtDnaLevelId() == null ? 0 : this
						.getGeneRearrangedAtDnaLevelId().hashCode());
		result = 37 * result
