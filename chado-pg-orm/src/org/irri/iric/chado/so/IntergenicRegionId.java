...
/**
 * IntergenicRegionId generated by hbm2java
 */
public class IntergenicRegionId implements java.io.Serializable {

	private Integer intergenicRegionId;
	...
	public IntergenicRegionId() {
	}

	public IntergenicRegionId(Integer intergenicRegionId, Integer featureId,
		...
		this.intergenicRegionId = intergenicRegionId;
	...
	public Integer getIntergenicRegionId() {
		return this.intergenicRegionId;
	}

	public void setIntergenicRegionId(Integer intergenicRegionId) {
		this.intergenicRegionId = intergenicRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntergenicRegionId))
			return false;
		IntergenicRegionId castOther = (IntergenicRegionId) other;

		return ((this.getIntergenicRegionId() == castOther
				.getIntergenicRegionId()) || (this.getIntergenicRegionId() != null
				&& castOther.getIntergenicRegionId() != null && this
				.getIntergenicRegionId().equals(
						castOther.getIntergenicRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntergenicRegionId() == null ? 0 : this
						.getIntergenicRegionId().hashCode());
		result = 37 * result
