...
/**
 * OrganelleSequenceId generated by hbm2java
 */
public class OrganelleSequenceId implements java.io.Serializable {

	private Integer organelleSequenceId;
	...
	public OrganelleSequenceId() {
	}

	public OrganelleSequenceId(Integer organelleSequenceId, Integer featureId,
		...
		this.organelleSequenceId = organelleSequenceId;
	...
	public Integer getOrganelleSequenceId() {
		return this.organelleSequenceId;
	}

	public void setOrganelleSequenceId(Integer organelleSequenceId) {
		this.organelleSequenceId = organelleSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrganelleSequenceId))
			return false;
		OrganelleSequenceId castOther = (OrganelleSequenceId) other;

		return ((this.getOrganelleSequenceId() == castOther
				.getOrganelleSequenceId()) || (this.getOrganelleSequenceId() != null
				&& castOther.getOrganelleSequenceId() != null && this
				.getOrganelleSequenceId().equals(
						castOther.getOrganelleSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOrganelleSequenceId() == null ? 0 : this
						.getOrganelleSequenceId().hashCode());
		result = 37 * result
