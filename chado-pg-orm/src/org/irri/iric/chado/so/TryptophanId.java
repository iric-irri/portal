...
/**
 * TryptophanId generated by hbm2java
 */
public class TryptophanId implements java.io.Serializable {

	private Integer tryptophanId;
	...
	public TryptophanId(Integer tryptophanId, Integer featureId,
		...
		this.tryptophanId = tryptophanId;
	...
	public Integer getTryptophanId() {
		return this.tryptophanId;
	}

	public void setTryptophanId(Integer tryptophanId) {
		this.tryptophanId = tryptophanId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TryptophanId))
			return false;
		TryptophanId castOther = (TryptophanId) other;

		return ((this.getTryptophanId() == castOther.getTryptophanId()) || (this
				.getTryptophanId() != null
				&& castOther.getTryptophanId() != null && this
				.getTryptophanId().equals(castOther.getTryptophanId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTryptophanId() == null ? 0 : this.getTryptophanId()
						.hashCode());
		result = 37 * result
