...
/**
 * TranscriptSecondaryStructureVariantId generated by hbm2java
 */
public class TranscriptSecondaryStructureVariantId implements
		java.io.Serializable {

	private Integer transcriptSecondaryStructureVariantId;
	...
	public TranscriptSecondaryStructureVariantId() {
	}

	public TranscriptSecondaryStructureVariantId(
			Integer transcriptSecondaryStructureVariantId, Integer featureId,
		...
		this.transcriptSecondaryStructureVariantId = transcriptSecondaryStructureVariantId;
	...
	public Integer getTranscriptSecondaryStructureVariantId() {
		return this.transcriptSecondaryStructureVariantId;
	}

	public void setTranscriptSecondaryStructureVariantId(
			Integer transcriptSecondaryStructureVariantId) {
		this.transcriptSecondaryStructureVariantId = transcriptSecondaryStructureVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptSecondaryStructureVariantId))
			return false;
		TranscriptSecondaryStructureVariantId castOther = (TranscriptSecondaryStructureVariantId) other;

		return ((this.getTranscriptSecondaryStructureVariantId() == castOther
				.getTranscriptSecondaryStructureVariantId()) || (this
				.getTranscriptSecondaryStructureVariantId() != null
				&& castOther.getTranscriptSecondaryStructureVariantId() != null && this
				.getTranscriptSecondaryStructureVariantId().equals(
						castOther.getTranscriptSecondaryStructureVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptSecondaryStructureVariantId() == null ? 0
						: this.getTranscriptSecondaryStructureVariantId()
								.hashCode());
		result = 37 * result
