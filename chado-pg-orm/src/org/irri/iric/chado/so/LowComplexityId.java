...
/**
 * LowComplexityId generated by hbm2java
 */
public class LowComplexityId implements java.io.Serializable {

	private Integer lowComplexityId;
	...
	public LowComplexityId() {
	}

	public LowComplexityId(Integer lowComplexityId, Integer featureId,
		...
		this.lowComplexityId = lowComplexityId;
	...
	public Integer getLowComplexityId() {
		return this.lowComplexityId;
	}

	public void setLowComplexityId(Integer lowComplexityId) {
		this.lowComplexityId = lowComplexityId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LowComplexityId))
			return false;
		LowComplexityId castOther = (LowComplexityId) other;

		return ((this.getLowComplexityId() == castOther.getLowComplexityId()) || (this
				.getLowComplexityId() != null
				&& castOther.getLowComplexityId() != null && this
				.getLowComplexityId().equals(castOther.getLowComplexityId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLowComplexityId() == null ? 0 : this.getLowComplexityId()
						.hashCode());
		result = 37 * result
