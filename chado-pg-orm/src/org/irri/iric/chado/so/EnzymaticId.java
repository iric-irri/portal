...
/**
 * EnzymaticId generated by hbm2java
 */
public class EnzymaticId implements java.io.Serializable {

	private Integer enzymaticId;
	...
	public EnzymaticId(Integer enzymaticId, Integer featureId,
	...
	public Integer getEnzymaticId() {
		return this.enzymaticId;
	}

	public void setEnzymaticId(Integer enzymaticId) {
		this.enzymaticId = enzymaticId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnzymaticId))
			return false;
		EnzymaticId castOther = (EnzymaticId) other;

		return ((this.getEnzymaticId() == castOther.getEnzymaticId()) || (this
				.getEnzymaticId() != null && castOther.getEnzymaticId() != null && this
				.getEnzymaticId().equals(castOther.getEnzymaticId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnzymaticId() == null ? 0 : this.getEnzymaticId()
						.hashCode());
		result = 37 * result
