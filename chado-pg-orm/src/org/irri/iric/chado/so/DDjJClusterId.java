...
/**
 * DDjJClusterId generated by hbm2java
 */
public class DDjJClusterId implements java.io.Serializable {

	private Integer DDjJClusterId;
	...
	public DDjJClusterId() {
	}

	public DDjJClusterId(Integer DDjJClusterId, Integer featureId,
		...
		this.DDjJClusterId = DDjJClusterId;
	...
	public Integer getDDjJClusterId() {
		return this.DDjJClusterId;
	}

	public void setDDjJClusterId(Integer DDjJClusterId) {
		this.DDjJClusterId = DDjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DDjJClusterId))
			return false;
		DDjJClusterId castOther = (DDjJClusterId) other;

		return ((this.getDDjJClusterId() == castOther.getDDjJClusterId()) || (this
				.getDDjJClusterId() != null
				&& castOther.getDDjJClusterId() != null && this
				.getDDjJClusterId().equals(castOther.getDDjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDDjJClusterId() == null ? 0 : this.getDDjJClusterId()
						.hashCode());
		result = 37 * result
