...
/**
 * EpigeneticallyModifiedRegionId generated by hbm2java
 */
public class EpigeneticallyModifiedRegionId implements java.io.Serializable {

	private Integer epigeneticallyModifiedRegionId;
	...
	public EpigeneticallyModifiedRegionId() {
	}

	public EpigeneticallyModifiedRegionId(
			Integer epigeneticallyModifiedRegionId, Integer featureId,
		...
		this.epigeneticallyModifiedRegionId = epigeneticallyModifiedRegionId;
	...
	public Integer getEpigeneticallyModifiedRegionId() {
		return this.epigeneticallyModifiedRegionId;
	}

	public void setEpigeneticallyModifiedRegionId(
			Integer epigeneticallyModifiedRegionId) {
		this.epigeneticallyModifiedRegionId = epigeneticallyModifiedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpigeneticallyModifiedRegionId))
			return false;
		EpigeneticallyModifiedRegionId castOther = (EpigeneticallyModifiedRegionId) other;

		return ((this.getEpigeneticallyModifiedRegionId() == castOther
				.getEpigeneticallyModifiedRegionId()) || (this
				.getEpigeneticallyModifiedRegionId() != null
				&& castOther.getEpigeneticallyModifiedRegionId() != null && this
				.getEpigeneticallyModifiedRegionId().equals(
						castOther.getEpigeneticallyModifiedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEpigeneticallyModifiedRegionId() == null ? 0 : this
						.getEpigeneticallyModifiedRegionId().hashCode());
		result = 37 * result
