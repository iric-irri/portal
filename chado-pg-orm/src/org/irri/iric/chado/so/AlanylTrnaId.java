...
/**
 * AlanylTrnaId generated by hbm2java
 */
public class AlanylTrnaId implements java.io.Serializable {

	private Integer alanylTrnaId;
	...
	public AlanylTrnaId(Integer alanylTrnaId, Integer featureId,
		...
		this.alanylTrnaId = alanylTrnaId;
	...
	public Integer getAlanylTrnaId() {
		return this.alanylTrnaId;
	}

	public void setAlanylTrnaId(Integer alanylTrnaId) {
		this.alanylTrnaId = alanylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlanylTrnaId))
			return false;
		AlanylTrnaId castOther = (AlanylTrnaId) other;

		return ((this.getAlanylTrnaId() == castOther.getAlanylTrnaId()) || (this
				.getAlanylTrnaId() != null
				&& castOther.getAlanylTrnaId() != null && this
				.getAlanylTrnaId().equals(castOther.getAlanylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlanylTrnaId() == null ? 0 : this.getAlanylTrnaId()
						.hashCode());
		result = 37 * result
