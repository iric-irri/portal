...
/**
 * MaternalVariantId generated by hbm2java
 */
public class MaternalVariantId implements java.io.Serializable {

	private Integer maternalVariantId;
	...
	public MaternalVariantId() {
	}

	public MaternalVariantId(Integer maternalVariantId, Integer featureId,
		...
		this.maternalVariantId = maternalVariantId;
	...
	public Integer getMaternalVariantId() {
		return this.maternalVariantId;
	}

	public void setMaternalVariantId(Integer maternalVariantId) {
		this.maternalVariantId = maternalVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaternalVariantId))
			return false;
		MaternalVariantId castOther = (MaternalVariantId) other;

		return ((this.getMaternalVariantId() == castOther
				.getMaternalVariantId()) || (this.getMaternalVariantId() != null
				&& castOther.getMaternalVariantId() != null && this
				.getMaternalVariantId()
				.equals(castOther.getMaternalVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaternalVariantId() == null ? 0 : this
						.getMaternalVariantId().hashCode());
		result = 37 * result
