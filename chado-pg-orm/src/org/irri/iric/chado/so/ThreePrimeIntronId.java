...
/**
 * ThreePrimeIntronId generated by hbm2java
 */
public class ThreePrimeIntronId implements java.io.Serializable {

	private Integer threePrimeIntronId;
	...
	public ThreePrimeIntronId() {
	}

	public ThreePrimeIntronId(Integer threePrimeIntronId, Integer featureId,
		...
		this.threePrimeIntronId = threePrimeIntronId;
	...
	public Integer getThreePrimeIntronId() {
		return this.threePrimeIntronId;
	}

	public void setThreePrimeIntronId(Integer threePrimeIntronId) {
		this.threePrimeIntronId = threePrimeIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeIntronId))
			return false;
		ThreePrimeIntronId castOther = (ThreePrimeIntronId) other;

		return ((this.getThreePrimeIntronId() == castOther
				.getThreePrimeIntronId()) || (this.getThreePrimeIntronId() != null
				&& castOther.getThreePrimeIntronId() != null && this
				.getThreePrimeIntronId().equals(
						castOther.getThreePrimeIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeIntronId() == null ? 0 : this
						.getThreePrimeIntronId().hashCode());
		result = 37 * result
