...
/**
 * TwoMethylthioN6CisHydroxyisopentenylAdenosineId generated by hbm2java
 */
public class TwoMethylthioN6CisHydroxyisopentenylAdenosineId implements
		java.io.Serializable {

	private Integer twoMethylthioN6CisHydroxyisopentenylAdenosineId;
	...
	public TwoMethylthioN6CisHydroxyisopentenylAdenosineId() {
	}

	public TwoMethylthioN6CisHydroxyisopentenylAdenosineId(
			Integer twoMethylthioN6CisHydroxyisopentenylAdenosineId,
		...
		this.twoMethylthioN6CisHydroxyisopentenylAdenosineId = twoMethylthioN6CisHydroxyisopentenylAdenosineId;
	...
	public Integer getTwoMethylthioN6CisHydroxyisopentenylAdenosineId() {
		return this.twoMethylthioN6CisHydroxyisopentenylAdenosineId;
	}

	public void setTwoMethylthioN6CisHydroxyisopentenylAdenosineId(
			Integer twoMethylthioN6CisHydroxyisopentenylAdenosineId) {
		this.twoMethylthioN6CisHydroxyisopentenylAdenosineId = twoMethylthioN6CisHydroxyisopentenylAdenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethylthioN6CisHydroxyisopentenylAdenosineId))
			return false;
		TwoMethylthioN6CisHydroxyisopentenylAdenosineId castOther = (TwoMethylthioN6CisHydroxyisopentenylAdenosineId) other;

		return ((this.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId() == castOther
				.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId()) || (this
				.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId() != null
				&& castOther
						.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId() != null && this
				.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId()
				.equals(castOther
						.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethylthioN6CisHydroxyisopentenylAdenosineId() == null ? 0
						: this.getTwoMethylthioN6CisHydroxyisopentenylAdenosineId()
								.hashCode());
		result = 37 * result
