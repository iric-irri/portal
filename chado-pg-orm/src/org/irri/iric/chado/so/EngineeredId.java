...
/**
 * EngineeredId generated by hbm2java
 */
public class EngineeredId implements java.io.Serializable {

	private Integer engineeredId;
	...
	public EngineeredId(Integer engineeredId, Integer featureId,
		...
		this.engineeredId = engineeredId;
	...
	public Integer getEngineeredId() {
		return this.engineeredId;
	}

	public void setEngineeredId(Integer engineeredId) {
		this.engineeredId = engineeredId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredId))
			return false;
		EngineeredId castOther = (EngineeredId) other;

		return ((this.getEngineeredId() == castOther.getEngineeredId()) || (this
				.getEngineeredId() != null
				&& castOther.getEngineeredId() != null && this
				.getEngineeredId().equals(castOther.getEngineeredId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredId() == null ? 0 : this.getEngineeredId()
						.hashCode());
		result = 37 * result
