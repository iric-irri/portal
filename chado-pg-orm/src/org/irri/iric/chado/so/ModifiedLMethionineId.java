...
/**
 * ModifiedLMethionineId generated by hbm2java
 */
public class ModifiedLMethionineId implements java.io.Serializable {

	private Integer modifiedLMethionineId;
	...
	public ModifiedLMethionineId() {
	}

	public ModifiedLMethionineId(Integer modifiedLMethionineId,
		...
		this.modifiedLMethionineId = modifiedLMethionineId;
	...
	public Integer getModifiedLMethionineId() {
		return this.modifiedLMethionineId;
	}

	public void setModifiedLMethionineId(Integer modifiedLMethionineId) {
		this.modifiedLMethionineId = modifiedLMethionineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLMethionineId))
			return false;
		ModifiedLMethionineId castOther = (ModifiedLMethionineId) other;

		return ((this.getModifiedLMethionineId() == castOther
				.getModifiedLMethionineId()) || (this
				.getModifiedLMethionineId() != null
				&& castOther.getModifiedLMethionineId() != null && this
				.getModifiedLMethionineId().equals(
						castOther.getModifiedLMethionineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLMethionineId() == null ? 0 : this
						.getModifiedLMethionineId().hashCode());
		result = 37 * result
