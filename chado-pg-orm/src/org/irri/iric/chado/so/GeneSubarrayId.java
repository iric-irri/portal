...
/**
 * GeneSubarrayId generated by hbm2java
 */
public class GeneSubarrayId implements java.io.Serializable {

	private Integer geneSubarrayId;
	...
	public GeneSubarrayId() {
	}

	public GeneSubarrayId(Integer geneSubarrayId, Integer featureId,
		...
		this.geneSubarrayId = geneSubarrayId;
	...
	public Integer getGeneSubarrayId() {
		return this.geneSubarrayId;
	}

	public void setGeneSubarrayId(Integer geneSubarrayId) {
		this.geneSubarrayId = geneSubarrayId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSubarrayId))
			return false;
		GeneSubarrayId castOther = (GeneSubarrayId) other;

		return ((this.getGeneSubarrayId() == castOther.getGeneSubarrayId()) || (this
				.getGeneSubarrayId() != null
				&& castOther.getGeneSubarrayId() != null && this
				.getGeneSubarrayId().equals(castOther.getGeneSubarrayId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSubarrayId() == null ? 0 : this.getGeneSubarrayId()
						.hashCode());
		result = 37 * result
