...
/**
 * FiveCarboxyhydroxymethylUridineMethylEsterId generated by hbm2java
 */
public class FiveCarboxyhydroxymethylUridineMethylEsterId implements
		java.io.Serializable {

	private Integer fiveCarboxyhydroxymethylUridineMethylEsterId;
	...
	public FiveCarboxyhydroxymethylUridineMethylEsterId() {
	}

	public FiveCarboxyhydroxymethylUridineMethylEsterId(
			Integer fiveCarboxyhydroxymethylUridineMethylEsterId,
		...
		this.fiveCarboxyhydroxymethylUridineMethylEsterId = fiveCarboxyhydroxymethylUridineMethylEsterId;
	...
	public Integer getFiveCarboxyhydroxymethylUridineMethylEsterId() {
		return this.fiveCarboxyhydroxymethylUridineMethylEsterId;
	}

	public void setFiveCarboxyhydroxymethylUridineMethylEsterId(
			Integer fiveCarboxyhydroxymethylUridineMethylEsterId) {
		this.fiveCarboxyhydroxymethylUridineMethylEsterId = fiveCarboxyhydroxymethylUridineMethylEsterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCarboxyhydroxymethylUridineMethylEsterId))
			return false;
		FiveCarboxyhydroxymethylUridineMethylEsterId castOther = (FiveCarboxyhydroxymethylUridineMethylEsterId) other;

		return ((this.getFiveCarboxyhydroxymethylUridineMethylEsterId() == castOther
				.getFiveCarboxyhydroxymethylUridineMethylEsterId()) || (this
				.getFiveCarboxyhydroxymethylUridineMethylEsterId() != null
				&& castOther.getFiveCarboxyhydroxymethylUridineMethylEsterId() != null && this
				.getFiveCarboxyhydroxymethylUridineMethylEsterId()
				.equals(castOther
						.getFiveCarboxyhydroxymethylUridineMethylEsterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCarboxyhydroxymethylUridineMethylEsterId() == null ? 0
						: this.getFiveCarboxyhydroxymethylUridineMethylEsterId()
								.hashCode());
		result = 37 * result
