...
/**
 * MirnaGeneId generated by hbm2java
 */
public class MirnaGeneId implements java.io.Serializable {

	private Integer mirnaGeneId;
	...
	public MirnaGeneId(Integer mirnaGeneId, Integer featureId,
	...
	public Integer getMirnaGeneId() {
		return this.mirnaGeneId;
	}

	public void setMirnaGeneId(Integer mirnaGeneId) {
		this.mirnaGeneId = mirnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaGeneId))
			return false;
		MirnaGeneId castOther = (MirnaGeneId) other;

		return ((this.getMirnaGeneId() == castOther.getMirnaGeneId()) || (this
				.getMirnaGeneId() != null && castOther.getMirnaGeneId() != null && this
				.getMirnaGeneId().equals(castOther.getMirnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaGeneId() == null ? 0 : this.getMirnaGeneId()
						.hashCode());
		result = 37 * result
