...
/**
 * FosmidId generated by hbm2java
 */
public class FosmidId implements java.io.Serializable {

	private Integer fosmidId;
	...
	public FosmidId(Integer fosmidId, Integer featureId, Integer dbxrefId,
	...
	public Integer getFosmidId() {
		return this.fosmidId;
	}

	public void setFosmidId(Integer fosmidId) {
		this.fosmidId = fosmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FosmidId))
			return false;
		FosmidId castOther = (FosmidId) other;

		return ((this.getFosmidId() == castOther.getFosmidId()) || (this
				.getFosmidId() != null && castOther.getFosmidId() != null && this
				.getFosmidId().equals(castOther.getFosmidId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getFosmidId() == null ? 0 : this.getFosmidId().hashCode());
		result = 37 * result
