...
/**
 * ChromoplastChromosomeId generated by hbm2java
 */
public class ChromoplastChromosomeId implements java.io.Serializable {

	private Integer chromoplastChromosomeId;
	...
	public ChromoplastChromosomeId() {
	}

	public ChromoplastChromosomeId(Integer chromoplastChromosomeId,
		...
		this.chromoplastChromosomeId = chromoplastChromosomeId;
	...
	public Integer getChromoplastChromosomeId() {
		return this.chromoplastChromosomeId;
	}

	public void setChromoplastChromosomeId(Integer chromoplastChromosomeId) {
		this.chromoplastChromosomeId = chromoplastChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromoplastChromosomeId))
			return false;
		ChromoplastChromosomeId castOther = (ChromoplastChromosomeId) other;

		return ((this.getChromoplastChromosomeId() == castOther
				.getChromoplastChromosomeId()) || (this
				.getChromoplastChromosomeId() != null
				&& castOther.getChromoplastChromosomeId() != null && this
				.getChromoplastChromosomeId().equals(
						castOther.getChromoplastChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromoplastChromosomeId() == null ? 0 : this
						.getChromoplastChromosomeId().hashCode());
		result = 37 * result
