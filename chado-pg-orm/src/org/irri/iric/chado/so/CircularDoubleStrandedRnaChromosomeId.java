...
/**
 * CircularDoubleStrandedRnaChromosomeId generated by hbm2java
 */
public class CircularDoubleStrandedRnaChromosomeId implements
		java.io.Serializable {

	private Integer circularDoubleStrandedRnaChromosomeId;
	...
	public CircularDoubleStrandedRnaChromosomeId() {
	}

	public CircularDoubleStrandedRnaChromosomeId(
			Integer circularDoubleStrandedRnaChromosomeId, Integer featureId,
		...
		this.circularDoubleStrandedRnaChromosomeId = circularDoubleStrandedRnaChromosomeId;
	...
	public Integer getCircularDoubleStrandedRnaChromosomeId() {
		return this.circularDoubleStrandedRnaChromosomeId;
	}

	public void setCircularDoubleStrandedRnaChromosomeId(
			Integer circularDoubleStrandedRnaChromosomeId) {
		this.circularDoubleStrandedRnaChromosomeId = circularDoubleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CircularDoubleStrandedRnaChromosomeId))
			return false;
		CircularDoubleStrandedRnaChromosomeId castOther = (CircularDoubleStrandedRnaChromosomeId) other;

		return ((this.getCircularDoubleStrandedRnaChromosomeId() == castOther
				.getCircularDoubleStrandedRnaChromosomeId()) || (this
				.getCircularDoubleStrandedRnaChromosomeId() != null
				&& castOther.getCircularDoubleStrandedRnaChromosomeId() != null && this
				.getCircularDoubleStrandedRnaChromosomeId().equals(
						castOther.getCircularDoubleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCircularDoubleStrandedRnaChromosomeId() == null ? 0
						: this.getCircularDoubleStrandedRnaChromosomeId()
								.hashCode());
		result = 37 * result
