...
/**
 * PlastidGeneId generated by hbm2java
 */
public class PlastidGeneId implements java.io.Serializable {

	private Integer plastidGeneId;
	...
	public PlastidGeneId() {
	}

	public PlastidGeneId(Integer plastidGeneId, Integer featureId,
		...
		this.plastidGeneId = plastidGeneId;
	...
	public Integer getPlastidGeneId() {
		return this.plastidGeneId;
	}

	public void setPlastidGeneId(Integer plastidGeneId) {
		this.plastidGeneId = plastidGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlastidGeneId))
			return false;
		PlastidGeneId castOther = (PlastidGeneId) other;

		return ((this.getPlastidGeneId() == castOther.getPlastidGeneId()) || (this
				.getPlastidGeneId() != null
				&& castOther.getPlastidGeneId() != null && this
				.getPlastidGeneId().equals(castOther.getPlastidGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlastidGeneId() == null ? 0 : this.getPlastidGeneId()
						.hashCode());
		result = 37 * result
