...
/**
 * CentromereDnaElementIId generated by hbm2java
 */
public class CentromereDnaElementIId implements java.io.Serializable {

	private Integer centromereDnaElementIId;
	...
	public CentromereDnaElementIId() {
	}

	public CentromereDnaElementIId(Integer centromereDnaElementIId,
		...
		this.centromereDnaElementIId = centromereDnaElementIId;
	...
	public Integer getCentromereDnaElementIId() {
		return this.centromereDnaElementIId;
	}

	public void setCentromereDnaElementIId(Integer centromereDnaElementIId) {
		this.centromereDnaElementIId = centromereDnaElementIId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentromereDnaElementIId))
			return false;
		CentromereDnaElementIId castOther = (CentromereDnaElementIId) other;

		return ((this.getCentromereDnaElementIId() == castOther
				.getCentromereDnaElementIId()) || (this
				.getCentromereDnaElementIId() != null
				&& castOther.getCentromereDnaElementIId() != null && this
				.getCentromereDnaElementIId().equals(
						castOther.getCentromereDnaElementIId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentromereDnaElementIId() == null ? 0 : this
						.getCentromereDnaElementIId().hashCode());
		result = 37 * result
