...
/**
 * GeneWithDicistronicPrimaryTranscriptId generated by hbm2java
 */
public class GeneWithDicistronicPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer geneWithDicistronicPrimaryTranscriptId;
	...
	public GeneWithDicistronicPrimaryTranscriptId() {
	}

	public GeneWithDicistronicPrimaryTranscriptId(
			Integer geneWithDicistronicPrimaryTranscriptId, Integer featureId,
		...
		this.geneWithDicistronicPrimaryTranscriptId = geneWithDicistronicPrimaryTranscriptId;
	...
	public Integer getGeneWithDicistronicPrimaryTranscriptId() {
		return this.geneWithDicistronicPrimaryTranscriptId;
	}

	public void setGeneWithDicistronicPrimaryTranscriptId(
			Integer geneWithDicistronicPrimaryTranscriptId) {
		this.geneWithDicistronicPrimaryTranscriptId = geneWithDicistronicPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithDicistronicPrimaryTranscriptId))
			return false;
		GeneWithDicistronicPrimaryTranscriptId castOther = (GeneWithDicistronicPrimaryTranscriptId) other;

		return ((this.getGeneWithDicistronicPrimaryTranscriptId() == castOther
				.getGeneWithDicistronicPrimaryTranscriptId()) || (this
				.getGeneWithDicistronicPrimaryTranscriptId() != null
				&& castOther.getGeneWithDicistronicPrimaryTranscriptId() != null && this
				.getGeneWithDicistronicPrimaryTranscriptId().equals(
						castOther.getGeneWithDicistronicPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithDicistronicPrimaryTranscriptId() == null ? 0
						: this.getGeneWithDicistronicPrimaryTranscriptId()
								.hashCode());
		result = 37 * result
