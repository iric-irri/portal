...
/**
 * CodonRedefinedId generated by hbm2java
 */
public class CodonRedefinedId implements java.io.Serializable {

	private Integer codonRedefinedId;
	...
	public CodonRedefinedId() {
	}

	public CodonRedefinedId(Integer codonRedefinedId, Integer featureId,
		...
		this.codonRedefinedId = codonRedefinedId;
	...
	public Integer getCodonRedefinedId() {
		return this.codonRedefinedId;
	}

	public void setCodonRedefinedId(Integer codonRedefinedId) {
		this.codonRedefinedId = codonRedefinedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodonRedefinedId))
			return false;
		CodonRedefinedId castOther = (CodonRedefinedId) other;

		return ((this.getCodonRedefinedId() == castOther.getCodonRedefinedId()) || (this
				.getCodonRedefinedId() != null
				&& castOther.getCodonRedefinedId() != null && this
				.getCodonRedefinedId().equals(castOther.getCodonRedefinedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodonRedefinedId() == null ? 0 : this
						.getCodonRedefinedId().hashCode());
		result = 37 * result
