...
/**
 * EncodesOverlappingPeptidesId generated by hbm2java
 */
public class EncodesOverlappingPeptidesId implements java.io.Serializable {

	private Integer encodesOverlappingPeptidesId;
	...
	public EncodesOverlappingPeptidesId() {
	}

	public EncodesOverlappingPeptidesId(Integer encodesOverlappingPeptidesId,
		...
		this.encodesOverlappingPeptidesId = encodesOverlappingPeptidesId;
	...
	public Integer getEncodesOverlappingPeptidesId() {
		return this.encodesOverlappingPeptidesId;
	}

	public void setEncodesOverlappingPeptidesId(
			Integer encodesOverlappingPeptidesId) {
		this.encodesOverlappingPeptidesId = encodesOverlappingPeptidesId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesOverlappingPeptidesId))
			return false;
		EncodesOverlappingPeptidesId castOther = (EncodesOverlappingPeptidesId) other;

		return ((this.getEncodesOverlappingPeptidesId() == castOther
				.getEncodesOverlappingPeptidesId()) || (this
				.getEncodesOverlappingPeptidesId() != null
				&& castOther.getEncodesOverlappingPeptidesId() != null && this
				.getEncodesOverlappingPeptidesId().equals(
						castOther.getEncodesOverlappingPeptidesId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesOverlappingPeptidesId() == null ? 0 : this
						.getEncodesOverlappingPeptidesId().hashCode());
		result = 37 * result
