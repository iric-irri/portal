...
/**
 * CTerminalRegionId generated by hbm2java
 */
public class CTerminalRegionId implements java.io.Serializable {

	private Integer CTerminalRegionId;
	...
	public CTerminalRegionId() {
	}

	public CTerminalRegionId(Integer CTerminalRegionId, Integer featureId,
		...
		this.CTerminalRegionId = CTerminalRegionId;
	...
	public Integer getCTerminalRegionId() {
		return this.CTerminalRegionId;
	}

	public void setCTerminalRegionId(Integer CTerminalRegionId) {
		this.CTerminalRegionId = CTerminalRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CTerminalRegionId))
			return false;
		CTerminalRegionId castOther = (CTerminalRegionId) other;

		return ((this.getCTerminalRegionId() == castOther
				.getCTerminalRegionId()) || (this.getCTerminalRegionId() != null
				&& castOther.getCTerminalRegionId() != null && this
				.getCTerminalRegionId()
				.equals(castOther.getCTerminalRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCTerminalRegionId() == null ? 0 : this
						.getCTerminalRegionId().hashCode());
		result = 37 * result
