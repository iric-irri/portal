...
/**
 * StrnaPrimaryTranscriptId generated by hbm2java
 */
public class StrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer strnaPrimaryTranscriptId;
	...
	public StrnaPrimaryTranscriptId() {
	}

	public StrnaPrimaryTranscriptId(Integer strnaPrimaryTranscriptId,
		...
		this.strnaPrimaryTranscriptId = strnaPrimaryTranscriptId;
	...
	public Integer getStrnaPrimaryTranscriptId() {
		return this.strnaPrimaryTranscriptId;
	}

	public void setStrnaPrimaryTranscriptId(Integer strnaPrimaryTranscriptId) {
		this.strnaPrimaryTranscriptId = strnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StrnaPrimaryTranscriptId))
			return false;
		StrnaPrimaryTranscriptId castOther = (StrnaPrimaryTranscriptId) other;

		return ((this.getStrnaPrimaryTranscriptId() == castOther
				.getStrnaPrimaryTranscriptId()) || (this
				.getStrnaPrimaryTranscriptId() != null
				&& castOther.getStrnaPrimaryTranscriptId() != null && this
				.getStrnaPrimaryTranscriptId().equals(
						castOther.getStrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStrnaPrimaryTranscriptId() == null ? 0 : this
						.getStrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
