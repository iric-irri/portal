...
/**
 * CatmatLeftHandedThreeId generated by hbm2java
 */
public class CatmatLeftHandedThreeId implements java.io.Serializable {

	private Integer catmatLeftHandedThreeId;
	...
	public CatmatLeftHandedThreeId() {
	}

	public CatmatLeftHandedThreeId(Integer catmatLeftHandedThreeId,
		...
		this.catmatLeftHandedThreeId = catmatLeftHandedThreeId;
	...
	public Integer getCatmatLeftHandedThreeId() {
		return this.catmatLeftHandedThreeId;
	}

	public void setCatmatLeftHandedThreeId(Integer catmatLeftHandedThreeId) {
		this.catmatLeftHandedThreeId = catmatLeftHandedThreeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatmatLeftHandedThreeId))
			return false;
		CatmatLeftHandedThreeId castOther = (CatmatLeftHandedThreeId) other;

		return ((this.getCatmatLeftHandedThreeId() == castOther
				.getCatmatLeftHandedThreeId()) || (this
				.getCatmatLeftHandedThreeId() != null
				&& castOther.getCatmatLeftHandedThreeId() != null && this
				.getCatmatLeftHandedThreeId().equals(
						castOther.getCatmatLeftHandedThreeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCatmatLeftHandedThreeId() == null ? 0 : this
						.getCatmatLeftHandedThreeId().hashCode());
		result = 37 * result
