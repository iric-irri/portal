...
/**
 * H4kAcylationRegionId generated by hbm2java
 */
public class H4kAcylationRegionId implements java.io.Serializable {

	private Integer h4kAcylationRegionId;
	...
	public H4kAcylationRegionId() {
	}

	public H4kAcylationRegionId(Integer h4kAcylationRegionId,
		...
		this.h4kAcylationRegionId = h4kAcylationRegionId;
	...
	public Integer getH4kAcylationRegionId() {
		return this.h4kAcylationRegionId;
	}

	public void setH4kAcylationRegionId(Integer h4kAcylationRegionId) {
		this.h4kAcylationRegionId = h4kAcylationRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H4kAcylationRegionId))
			return false;
		H4kAcylationRegionId castOther = (H4kAcylationRegionId) other;

		return ((this.getH4kAcylationRegionId() == castOther
				.getH4kAcylationRegionId()) || (this.getH4kAcylationRegionId() != null
				&& castOther.getH4kAcylationRegionId() != null && this
				.getH4kAcylationRegionId().equals(
						castOther.getH4kAcylationRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH4kAcylationRegionId() == null ? 0 : this
						.getH4kAcylationRegionId().hashCode());
		result = 37 * result
