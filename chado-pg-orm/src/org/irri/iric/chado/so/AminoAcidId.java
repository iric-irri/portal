...
/**
 * AminoAcidId generated by hbm2java
 */
public class AminoAcidId implements java.io.Serializable {

	private Integer aminoAcidId;
	...
	public AminoAcidId(Integer aminoAcidId, Integer featureId,
	...
	public Integer getAminoAcidId() {
		return this.aminoAcidId;
	}

	public void setAminoAcidId(Integer aminoAcidId) {
		this.aminoAcidId = aminoAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AminoAcidId))
			return false;
		AminoAcidId castOther = (AminoAcidId) other;

		return ((this.getAminoAcidId() == castOther.getAminoAcidId()) || (this
				.getAminoAcidId() != null && castOther.getAminoAcidId() != null && this
				.getAminoAcidId().equals(castOther.getAminoAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAminoAcidId() == null ? 0 : this.getAminoAcidId()
						.hashCode());
		result = 37 * result
