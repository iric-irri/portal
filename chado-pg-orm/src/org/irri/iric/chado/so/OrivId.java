...
/**
 * OrivId generated by hbm2java
 */
public class OrivId implements java.io.Serializable {

	private Integer orivId;
	...
	public OrivId(Integer orivId, Integer featureId, Integer dbxrefId,
	...
	public Integer getOrivId() {
		return this.orivId;
	}

	public void setOrivId(Integer orivId) {
		this.orivId = orivId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrivId))
			return false;
		OrivId castOther = (OrivId) other;

		return ((this.getOrivId() == castOther.getOrivId()) || (this
				.getOrivId() != null && castOther.getOrivId() != null && this
				.getOrivId().equals(castOther.getOrivId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOrivId() == null ? 0 : this.getOrivId().hashCode());
		result = 37 * result
