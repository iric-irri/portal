...
/**
 * PolypeptideLigandContactId generated by hbm2java
 */
public class PolypeptideLigandContactId implements java.io.Serializable {

	private Integer polypeptideLigandContactId;
	...
	public PolypeptideLigandContactId() {
	}

	public PolypeptideLigandContactId(Integer polypeptideLigandContactId,
		...
		this.polypeptideLigandContactId = polypeptideLigandContactId;
	...
	public Integer getPolypeptideLigandContactId() {
		return this.polypeptideLigandContactId;
	}

	public void setPolypeptideLigandContactId(Integer polypeptideLigandContactId) {
		this.polypeptideLigandContactId = polypeptideLigandContactId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideLigandContactId))
			return false;
		PolypeptideLigandContactId castOther = (PolypeptideLigandContactId) other;

		return ((this.getPolypeptideLigandContactId() == castOther
				.getPolypeptideLigandContactId()) || (this
				.getPolypeptideLigandContactId() != null
				&& castOther.getPolypeptideLigandContactId() != null && this
				.getPolypeptideLigandContactId().equals(
						castOther.getPolypeptideLigandContactId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideLigandContactId() == null ? 0 : this
						.getPolypeptideLigandContactId().hashCode());
		result = 37 * result
