...
/**
 * Sl11AcceptorSiteId generated by hbm2java
 */
public class Sl11AcceptorSiteId implements java.io.Serializable {

	private Integer sl11AcceptorSiteId;
	...
	public Sl11AcceptorSiteId() {
	}

	public Sl11AcceptorSiteId(Integer sl11AcceptorSiteId, Integer featureId,
		...
		this.sl11AcceptorSiteId = sl11AcceptorSiteId;
	...
	public Integer getSl11AcceptorSiteId() {
		return this.sl11AcceptorSiteId;
	}

	public void setSl11AcceptorSiteId(Integer sl11AcceptorSiteId) {
		this.sl11AcceptorSiteId = sl11AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl11AcceptorSiteId))
			return false;
		Sl11AcceptorSiteId castOther = (Sl11AcceptorSiteId) other;

		return ((this.getSl11AcceptorSiteId() == castOther
				.getSl11AcceptorSiteId()) || (this.getSl11AcceptorSiteId() != null
				&& castOther.getSl11AcceptorSiteId() != null && this
				.getSl11AcceptorSiteId().equals(
						castOther.getSl11AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl11AcceptorSiteId() == null ? 0 : this
						.getSl11AcceptorSiteId().hashCode());
		result = 37 * result
