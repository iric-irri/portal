...
/**
 * InvertedTandemDuplicationId generated by hbm2java
 */
public class InvertedTandemDuplicationId implements java.io.Serializable {

	private Integer invertedTandemDuplicationId;
	...
	public InvertedTandemDuplicationId() {
	}

	public InvertedTandemDuplicationId(Integer invertedTandemDuplicationId,
		...
		this.invertedTandemDuplicationId = invertedTandemDuplicationId;
	...
	public Integer getInvertedTandemDuplicationId() {
		return this.invertedTandemDuplicationId;
	}

	public void setInvertedTandemDuplicationId(
			Integer invertedTandemDuplicationId) {
		this.invertedTandemDuplicationId = invertedTandemDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertedTandemDuplicationId))
			return false;
		InvertedTandemDuplicationId castOther = (InvertedTandemDuplicationId) other;

		return ((this.getInvertedTandemDuplicationId() == castOther
				.getInvertedTandemDuplicationId()) || (this
				.getInvertedTandemDuplicationId() != null
				&& castOther.getInvertedTandemDuplicationId() != null && this
				.getInvertedTandemDuplicationId().equals(
						castOther.getInvertedTandemDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertedTandemDuplicationId() == null ? 0 : this
						.getInvertedTandemDuplicationId().hashCode());
		result = 37 * result
