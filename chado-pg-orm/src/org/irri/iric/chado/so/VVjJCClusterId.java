...
/**
 * VVjJCClusterId generated by hbm2java
 */
public class VVjJCClusterId implements java.io.Serializable {

	private Integer VVjJCClusterId;
	...
	public VVjJCClusterId() {
	}

	public VVjJCClusterId(Integer VVjJCClusterId, Integer featureId,
		...
		this.VVjJCClusterId = VVjJCClusterId;
	...
	public Integer getVVjJCClusterId() {
		return this.VVjJCClusterId;
	}

	public void setVVjJCClusterId(Integer VVjJCClusterId) {
		this.VVjJCClusterId = VVjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVjJCClusterId))
			return false;
		VVjJCClusterId castOther = (VVjJCClusterId) other;

		return ((this.getVVjJCClusterId() == castOther.getVVjJCClusterId()) || (this
				.getVVjJCClusterId() != null
				&& castOther.getVVjJCClusterId() != null && this
				.getVVjJCClusterId().equals(castOther.getVVjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVjJCClusterId() == null ? 0 : this.getVVjJCClusterId()
						.hashCode());
		result = 37 * result
