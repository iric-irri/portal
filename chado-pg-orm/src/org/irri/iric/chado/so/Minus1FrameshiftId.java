...
/**
 * Minus1FrameshiftId generated by hbm2java
 */
public class Minus1FrameshiftId implements java.io.Serializable {

	private Integer minus1FrameshiftId;
	...
	public Minus1FrameshiftId() {
	}

	public Minus1FrameshiftId(Integer minus1FrameshiftId, Integer featureId,
		...
		this.minus1FrameshiftId = minus1FrameshiftId;
	...
	public Integer getMinus1FrameshiftId() {
		return this.minus1FrameshiftId;
	}

	public void setMinus1FrameshiftId(Integer minus1FrameshiftId) {
		this.minus1FrameshiftId = minus1FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus1FrameshiftId))
			return false;
		Minus1FrameshiftId castOther = (Minus1FrameshiftId) other;

		return ((this.getMinus1FrameshiftId() == castOther
				.getMinus1FrameshiftId()) || (this.getMinus1FrameshiftId() != null
				&& castOther.getMinus1FrameshiftId() != null && this
				.getMinus1FrameshiftId().equals(
						castOther.getMinus1FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus1FrameshiftId() == null ? 0 : this
						.getMinus1FrameshiftId().hashCode());
		result = 37 * result
