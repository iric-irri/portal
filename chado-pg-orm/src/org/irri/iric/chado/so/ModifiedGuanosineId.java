...
/**
 * ModifiedGuanosineId generated by hbm2java
 */
public class ModifiedGuanosineId implements java.io.Serializable {

	private Integer modifiedGuanosineId;
	...
	public ModifiedGuanosineId() {
	}

	public ModifiedGuanosineId(Integer modifiedGuanosineId, Integer featureId,
		...
		this.modifiedGuanosineId = modifiedGuanosineId;
	...
	public Integer getModifiedGuanosineId() {
		return this.modifiedGuanosineId;
	}

	public void setModifiedGuanosineId(Integer modifiedGuanosineId) {
		this.modifiedGuanosineId = modifiedGuanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedGuanosineId))
			return false;
		ModifiedGuanosineId castOther = (ModifiedGuanosineId) other;

		return ((this.getModifiedGuanosineId() == castOther
				.getModifiedGuanosineId()) || (this.getModifiedGuanosineId() != null
				&& castOther.getModifiedGuanosineId() != null && this
				.getModifiedGuanosineId().equals(
						castOther.getModifiedGuanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedGuanosineId() == null ? 0 : this
						.getModifiedGuanosineId().hashCode());
		result = 37 * result
