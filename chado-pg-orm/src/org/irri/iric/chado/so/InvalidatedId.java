...
/**
 * InvalidatedId generated by hbm2java
 */
public class InvalidatedId implements java.io.Serializable {

	private Integer invalidatedId;
	...
	public InvalidatedId() {
	}

	public InvalidatedId(Integer invalidatedId, Integer featureId,
	...
	public Integer getInvalidatedId() {
		return this.invalidatedId;
	}

	public void setInvalidatedId(Integer invalidatedId) {
		this.invalidatedId = invalidatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedId))
			return false;
		InvalidatedId castOther = (InvalidatedId) other;

		return ((this.getInvalidatedId() == castOther.getInvalidatedId()) || (this
				.getInvalidatedId() != null
				&& castOther.getInvalidatedId() != null && this
				.getInvalidatedId().equals(castOther.getInvalidatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedId() == null ? 0 : this.getInvalidatedId()
						.hashCode());
		result = 37 * result
