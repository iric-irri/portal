...
/**
 * SyntenicRegionId generated by hbm2java
 */
public class SyntenicRegionId implements java.io.Serializable {

	private Integer syntenicRegionId;
	...
	public SyntenicRegionId() {
	}

	public SyntenicRegionId(Integer syntenicRegionId, Integer featureId,
		...
		this.syntenicRegionId = syntenicRegionId;
	...
	public Integer getSyntenicRegionId() {
		return this.syntenicRegionId;
	}

	public void setSyntenicRegionId(Integer syntenicRegionId) {
		this.syntenicRegionId = syntenicRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SyntenicRegionId))
			return false;
		SyntenicRegionId castOther = (SyntenicRegionId) other;

		return ((this.getSyntenicRegionId() == castOther.getSyntenicRegionId()) || (this
				.getSyntenicRegionId() != null
				&& castOther.getSyntenicRegionId() != null && this
				.getSyntenicRegionId().equals(castOther.getSyntenicRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSyntenicRegionId() == null ? 0 : this
						.getSyntenicRegionId().hashCode());
		result = 37 * result
