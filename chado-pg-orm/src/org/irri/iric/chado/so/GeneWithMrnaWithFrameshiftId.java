...
/**
 * GeneWithMrnaWithFrameshiftId generated by hbm2java
 */
public class GeneWithMrnaWithFrameshiftId implements java.io.Serializable {

	private Integer geneWithMrnaWithFrameshiftId;
	...
	public GeneWithMrnaWithFrameshiftId() {
	}

	public GeneWithMrnaWithFrameshiftId(Integer geneWithMrnaWithFrameshiftId,
		...
		this.geneWithMrnaWithFrameshiftId = geneWithMrnaWithFrameshiftId;
	...
	public Integer getGeneWithMrnaWithFrameshiftId() {
		return this.geneWithMrnaWithFrameshiftId;
	}

	public void setGeneWithMrnaWithFrameshiftId(
			Integer geneWithMrnaWithFrameshiftId) {
		this.geneWithMrnaWithFrameshiftId = geneWithMrnaWithFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithMrnaWithFrameshiftId))
			return false;
		GeneWithMrnaWithFrameshiftId castOther = (GeneWithMrnaWithFrameshiftId) other;

		return ((this.getGeneWithMrnaWithFrameshiftId() == castOther
				.getGeneWithMrnaWithFrameshiftId()) || (this
				.getGeneWithMrnaWithFrameshiftId() != null
				&& castOther.getGeneWithMrnaWithFrameshiftId() != null && this
				.getGeneWithMrnaWithFrameshiftId().equals(
						castOther.getGeneWithMrnaWithFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithMrnaWithFrameshiftId() == null ? 0 : this
						.getGeneWithMrnaWithFrameshiftId().hashCode());
		result = 37 * result
