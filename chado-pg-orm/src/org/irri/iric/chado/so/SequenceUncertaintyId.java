...
/**
 * SequenceUncertaintyId generated by hbm2java
 */
public class SequenceUncertaintyId implements java.io.Serializable {

	private Integer sequenceUncertaintyId;
	...
	public SequenceUncertaintyId() {
	}

	public SequenceUncertaintyId(Integer sequenceUncertaintyId,
		...
		this.sequenceUncertaintyId = sequenceUncertaintyId;
	...
	public Integer getSequenceUncertaintyId() {
		return this.sequenceUncertaintyId;
	}

	public void setSequenceUncertaintyId(Integer sequenceUncertaintyId) {
		this.sequenceUncertaintyId = sequenceUncertaintyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceUncertaintyId))
			return false;
		SequenceUncertaintyId castOther = (SequenceUncertaintyId) other;

		return ((this.getSequenceUncertaintyId() == castOther
				.getSequenceUncertaintyId()) || (this
				.getSequenceUncertaintyId() != null
				&& castOther.getSequenceUncertaintyId() != null && this
				.getSequenceUncertaintyId().equals(
						castOther.getSequenceUncertaintyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceUncertaintyId() == null ? 0 : this
						.getSequenceUncertaintyId().hashCode());
		result = 37 * result
