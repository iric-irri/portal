...
/**
 * SmallSubunitRrnaId generated by hbm2java
 */
public class SmallSubunitRrnaId implements java.io.Serializable {

	private Integer smallSubunitRrnaId;
	...
	public SmallSubunitRrnaId() {
	}

	public SmallSubunitRrnaId(Integer smallSubunitRrnaId, Integer featureId,
		...
		this.smallSubunitRrnaId = smallSubunitRrnaId;
	...
	public Integer getSmallSubunitRrnaId() {
		return this.smallSubunitRrnaId;
	}

	public void setSmallSubunitRrnaId(Integer smallSubunitRrnaId) {
		this.smallSubunitRrnaId = smallSubunitRrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SmallSubunitRrnaId))
			return false;
		SmallSubunitRrnaId castOther = (SmallSubunitRrnaId) other;

		return ((this.getSmallSubunitRrnaId() == castOther
				.getSmallSubunitRrnaId()) || (this.getSmallSubunitRrnaId() != null
				&& castOther.getSmallSubunitRrnaId() != null && this
				.getSmallSubunitRrnaId().equals(
						castOther.getSmallSubunitRrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSmallSubunitRrnaId() == null ? 0 : this
						.getSmallSubunitRrnaId().hashCode());
		result = 37 * result
