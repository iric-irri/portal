...
/**
 * BetaTurnTypeSixBId generated by hbm2java
 */
public class BetaTurnTypeSixBId implements java.io.Serializable {

	private Integer betaTurnTypeSixBId;
	...
	public BetaTurnTypeSixBId() {
	}

	public BetaTurnTypeSixBId(Integer betaTurnTypeSixBId, Integer featureId,
		...
		this.betaTurnTypeSixBId = betaTurnTypeSixBId;
	...
	public Integer getBetaTurnTypeSixBId() {
		return this.betaTurnTypeSixBId;
	}

	public void setBetaTurnTypeSixBId(Integer betaTurnTypeSixBId) {
		this.betaTurnTypeSixBId = betaTurnTypeSixBId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeSixBId))
			return false;
		BetaTurnTypeSixBId castOther = (BetaTurnTypeSixBId) other;

		return ((this.getBetaTurnTypeSixBId() == castOther
				.getBetaTurnTypeSixBId()) || (this.getBetaTurnTypeSixBId() != null
				&& castOther.getBetaTurnTypeSixBId() != null && this
				.getBetaTurnTypeSixBId().equals(
						castOther.getBetaTurnTypeSixBId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeSixBId() == null ? 0 : this
						.getBetaTurnTypeSixBId().hashCode());
		result = 37 * result
