...
/**
 * IntrachromosomalId generated by hbm2java
 */
public class IntrachromosomalId implements java.io.Serializable {

	private Integer intrachromosomalId;
	...
	public IntrachromosomalId() {
	}

	public IntrachromosomalId(Integer intrachromosomalId, Integer featureId,
		...
		this.intrachromosomalId = intrachromosomalId;
	...
	public Integer getIntrachromosomalId() {
		return this.intrachromosomalId;
	}

	public void setIntrachromosomalId(Integer intrachromosomalId) {
		this.intrachromosomalId = intrachromosomalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrachromosomalId))
			return false;
		IntrachromosomalId castOther = (IntrachromosomalId) other;

		return ((this.getIntrachromosomalId() == castOther
				.getIntrachromosomalId()) || (this.getIntrachromosomalId() != null
				&& castOther.getIntrachromosomalId() != null && this
				.getIntrachromosomalId().equals(
						castOther.getIntrachromosomalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrachromosomalId() == null ? 0 : this
						.getIntrachromosomalId().hashCode());
		result = 37 * result
