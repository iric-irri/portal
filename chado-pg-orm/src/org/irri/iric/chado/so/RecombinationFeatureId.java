...
/**
 * RecombinationFeatureId generated by hbm2java
 */
public class RecombinationFeatureId implements java.io.Serializable {

	private Integer recombinationFeatureId;
	...
	public RecombinationFeatureId() {
	}

	public RecombinationFeatureId(Integer recombinationFeatureId,
		...
		this.recombinationFeatureId = recombinationFeatureId;
	...
	public Integer getRecombinationFeatureId() {
		return this.recombinationFeatureId;
	}

	public void setRecombinationFeatureId(Integer recombinationFeatureId) {
		this.recombinationFeatureId = recombinationFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationFeatureId))
			return false;
		RecombinationFeatureId castOther = (RecombinationFeatureId) other;

		return ((this.getRecombinationFeatureId() == castOther
				.getRecombinationFeatureId()) || (this
				.getRecombinationFeatureId() != null
				&& castOther.getRecombinationFeatureId() != null && this
				.getRecombinationFeatureId().equals(
						castOther.getRecombinationFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationFeatureId() == null ? 0 : this
						.getRecombinationFeatureId().hashCode());
		result = 37 * result
