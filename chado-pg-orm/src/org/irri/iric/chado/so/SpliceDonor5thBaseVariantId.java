...
/**
 * SpliceDonor5thBaseVariantId generated by hbm2java
 */
public class SpliceDonor5thBaseVariantId implements java.io.Serializable {

	private Integer spliceDonor5thBaseVariantId;
	...
	public SpliceDonor5thBaseVariantId() {
	}

	public SpliceDonor5thBaseVariantId(Integer spliceDonor5thBaseVariantId,
		...
		this.spliceDonor5thBaseVariantId = spliceDonor5thBaseVariantId;
	...
	public Integer getSpliceDonor5thBaseVariantId() {
		return this.spliceDonor5thBaseVariantId;
	}

	public void setSpliceDonor5thBaseVariantId(
			Integer spliceDonor5thBaseVariantId) {
		this.spliceDonor5thBaseVariantId = spliceDonor5thBaseVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceDonor5thBaseVariantId))
			return false;
		SpliceDonor5thBaseVariantId castOther = (SpliceDonor5thBaseVariantId) other;

		return ((this.getSpliceDonor5thBaseVariantId() == castOther
				.getSpliceDonor5thBaseVariantId()) || (this
				.getSpliceDonor5thBaseVariantId() != null
				&& castOther.getSpliceDonor5thBaseVariantId() != null && this
				.getSpliceDonor5thBaseVariantId().equals(
						castOther.getSpliceDonor5thBaseVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceDonor5thBaseVariantId() == null ? 0 : this
						.getSpliceDonor5thBaseVariantId().hashCode());
		result = 37 * result
