...
/**
 * EngineeredRescueRegionId generated by hbm2java
 */
public class EngineeredRescueRegionId implements java.io.Serializable {

	private Integer engineeredRescueRegionId;
	...
	public EngineeredRescueRegionId() {
	}

	public EngineeredRescueRegionId(Integer engineeredRescueRegionId,
		...
		this.engineeredRescueRegionId = engineeredRescueRegionId;
	...
	public Integer getEngineeredRescueRegionId() {
		return this.engineeredRescueRegionId;
	}

	public void setEngineeredRescueRegionId(Integer engineeredRescueRegionId) {
		this.engineeredRescueRegionId = engineeredRescueRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredRescueRegionId))
			return false;
		EngineeredRescueRegionId castOther = (EngineeredRescueRegionId) other;

		return ((this.getEngineeredRescueRegionId() == castOther
				.getEngineeredRescueRegionId()) || (this
				.getEngineeredRescueRegionId() != null
				&& castOther.getEngineeredRescueRegionId() != null && this
				.getEngineeredRescueRegionId().equals(
						castOther.getEngineeredRescueRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredRescueRegionId() == null ? 0 : this
						.getEngineeredRescueRegionId().hashCode());
		result = 37 * result
