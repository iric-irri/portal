...
/**
 * AsxMotifId generated by hbm2java
 */
public class AsxMotifId implements java.io.Serializable {

	private Integer asxMotifId;
	...
	public AsxMotifId(Integer asxMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAsxMotifId() {
		return this.asxMotifId;
	}

	public void setAsxMotifId(Integer asxMotifId) {
		this.asxMotifId = asxMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxMotifId))
			return false;
		AsxMotifId castOther = (AsxMotifId) other;

		return ((this.getAsxMotifId() == castOther.getAsxMotifId()) || (this
				.getAsxMotifId() != null && castOther.getAsxMotifId() != null && this
				.getAsxMotifId().equals(castOther.getAsxMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsxMotifId() == null ? 0 : this.getAsxMotifId()
						.hashCode());
		result = 37 * result
