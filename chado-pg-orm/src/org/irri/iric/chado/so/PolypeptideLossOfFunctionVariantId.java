...
/**
 * PolypeptideLossOfFunctionVariantId generated by hbm2java
 */
public class PolypeptideLossOfFunctionVariantId implements java.io.Serializable {

	private Integer polypeptideLossOfFunctionVariantId;
	...
	public PolypeptideLossOfFunctionVariantId() {
	}

	public PolypeptideLossOfFunctionVariantId(
			Integer polypeptideLossOfFunctionVariantId, Integer featureId,
		...
		this.polypeptideLossOfFunctionVariantId = polypeptideLossOfFunctionVariantId;
	...
	public Integer getPolypeptideLossOfFunctionVariantId() {
		return this.polypeptideLossOfFunctionVariantId;
	}

	public void setPolypeptideLossOfFunctionVariantId(
			Integer polypeptideLossOfFunctionVariantId) {
		this.polypeptideLossOfFunctionVariantId = polypeptideLossOfFunctionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideLossOfFunctionVariantId))
			return false;
		PolypeptideLossOfFunctionVariantId castOther = (PolypeptideLossOfFunctionVariantId) other;

		return ((this.getPolypeptideLossOfFunctionVariantId() == castOther
				.getPolypeptideLossOfFunctionVariantId()) || (this
				.getPolypeptideLossOfFunctionVariantId() != null
				&& castOther.getPolypeptideLossOfFunctionVariantId() != null && this
				.getPolypeptideLossOfFunctionVariantId().equals(
						castOther.getPolypeptideLossOfFunctionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideLossOfFunctionVariantId() == null ? 0 : this
						.getPolypeptideLossOfFunctionVariantId().hashCode());
		result = 37 * result
