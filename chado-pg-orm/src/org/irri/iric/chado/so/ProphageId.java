...
/**
 * ProphageId generated by hbm2java
 */
public class ProphageId implements java.io.Serializable {

	private Integer prophageId;
	...
	public ProphageId(Integer prophageId, Integer featureId, Integer dbxrefId,
	...
	public Integer getProphageId() {
		return this.prophageId;
	}

	public void setProphageId(Integer prophageId) {
		this.prophageId = prophageId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProphageId))
			return false;
		ProphageId castOther = (ProphageId) other;

		return ((this.getProphageId() == castOther.getProphageId()) || (this
				.getProphageId() != null && castOther.getProphageId() != null && this
				.getProphageId().equals(castOther.getProphageId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProphageId() == null ? 0 : this.getProphageId()
						.hashCode());
		result = 37 * result
