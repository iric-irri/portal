...
/**
 * SupportedByEstOrCdnaId generated by hbm2java
 */
public class SupportedByEstOrCdnaId implements java.io.Serializable {

	private Integer supportedByEstOrCdnaId;
	...
	public SupportedByEstOrCdnaId() {
	}

	public SupportedByEstOrCdnaId(Integer supportedByEstOrCdnaId,
		...
		this.supportedByEstOrCdnaId = supportedByEstOrCdnaId;
	...
	public Integer getSupportedByEstOrCdnaId() {
		return this.supportedByEstOrCdnaId;
	}

	public void setSupportedByEstOrCdnaId(Integer supportedByEstOrCdnaId) {
		this.supportedByEstOrCdnaId = supportedByEstOrCdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SupportedByEstOrCdnaId))
			return false;
		SupportedByEstOrCdnaId castOther = (SupportedByEstOrCdnaId) other;

		return ((this.getSupportedByEstOrCdnaId() == castOther
				.getSupportedByEstOrCdnaId()) || (this
				.getSupportedByEstOrCdnaId() != null
				&& castOther.getSupportedByEstOrCdnaId() != null && this
				.getSupportedByEstOrCdnaId().equals(
						castOther.getSupportedByEstOrCdnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSupportedByEstOrCdnaId() == null ? 0 : this
						.getSupportedByEstOrCdnaId().hashCode());
		result = 37 * result
