...
/**
 * ModifiedLProlineId generated by hbm2java
 */
public class ModifiedLProlineId implements java.io.Serializable {

	private Integer modifiedLProlineId;
	...
	public ModifiedLProlineId() {
	}

	public ModifiedLProlineId(Integer modifiedLProlineId, Integer featureId,
		...
		this.modifiedLProlineId = modifiedLProlineId;
	...
	public Integer getModifiedLProlineId() {
		return this.modifiedLProlineId;
	}

	public void setModifiedLProlineId(Integer modifiedLProlineId) {
		this.modifiedLProlineId = modifiedLProlineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLProlineId))
			return false;
		ModifiedLProlineId castOther = (ModifiedLProlineId) other;

		return ((this.getModifiedLProlineId() == castOther
				.getModifiedLProlineId()) || (this.getModifiedLProlineId() != null
				&& castOther.getModifiedLProlineId() != null && this
				.getModifiedLProlineId().equals(
						castOther.getModifiedLProlineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLProlineId() == null ? 0 : this
						.getModifiedLProlineId().hashCode());
		result = 37 * result
