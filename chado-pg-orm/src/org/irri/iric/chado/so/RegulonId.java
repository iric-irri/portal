...
/**
 * RegulonId generated by hbm2java
 */
public class RegulonId implements java.io.Serializable {
	...
	public RegulonId(Integer regulonId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegulonId))
			return false;
		RegulonId castOther = (RegulonId) other;

		return ((this.getRegulonId() == castOther.getRegulonId()) || (this
				.getRegulonId() != null && castOther.getRegulonId() != null && this
				.getRegulonId().equals(castOther.getRegulonId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRegulonId() == null ? 0 : this.getRegulonId().hashCode());
		result = 37 * result
