...
/**
 * StsId generated by hbm2java
 */
public class StsId implements java.io.Serializable {
	...
	public StsId(Integer stsId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StsId))
			return false;
		StsId castOther = (StsId) other;

		return ((this.getStsId() == castOther.getStsId()) || (this.getStsId() != null
				&& castOther.getStsId() != null && this.getStsId().equals(
				castOther.getStsId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getStsId() == null ? 0 : this.getStsId().hashCode());
		result = 37 * result
