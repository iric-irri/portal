...
/**
 * InvalidatedByPartialProcessingId generated by hbm2java
 */
public class InvalidatedByPartialProcessingId implements java.io.Serializable {

	private Integer invalidatedByPartialProcessingId;
	...
	public InvalidatedByPartialProcessingId() {
	}

	public InvalidatedByPartialProcessingId(
			Integer invalidatedByPartialProcessingId, Integer featureId,
		...
		this.invalidatedByPartialProcessingId = invalidatedByPartialProcessingId;
	...
	public Integer getInvalidatedByPartialProcessingId() {
		return this.invalidatedByPartialProcessingId;
	}

	public void setInvalidatedByPartialProcessingId(
			Integer invalidatedByPartialProcessingId) {
		this.invalidatedByPartialProcessingId = invalidatedByPartialProcessingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedByPartialProcessingId))
			return false;
		InvalidatedByPartialProcessingId castOther = (InvalidatedByPartialProcessingId) other;

		return ((this.getInvalidatedByPartialProcessingId() == castOther
				.getInvalidatedByPartialProcessingId()) || (this
				.getInvalidatedByPartialProcessingId() != null
				&& castOther.getInvalidatedByPartialProcessingId() != null && this
				.getInvalidatedByPartialProcessingId().equals(
						castOther.getInvalidatedByPartialProcessingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedByPartialProcessingId() == null ? 0 : this
						.getInvalidatedByPartialProcessingId().hashCode());
		result = 37 * result
