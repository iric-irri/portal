...
/**
 * PeptideCollectionId generated by hbm2java
 */
public class PeptideCollectionId implements java.io.Serializable {

	private Integer peptideCollectionId;
	...
	public PeptideCollectionId() {
	}

	public PeptideCollectionId(Integer peptideCollectionId, Integer featureId,
		...
		this.peptideCollectionId = peptideCollectionId;
	...
	public Integer getPeptideCollectionId() {
		return this.peptideCollectionId;
	}

	public void setPeptideCollectionId(Integer peptideCollectionId) {
		this.peptideCollectionId = peptideCollectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeptideCollectionId))
			return false;
		PeptideCollectionId castOther = (PeptideCollectionId) other;

		return ((this.getPeptideCollectionId() == castOther
				.getPeptideCollectionId()) || (this.getPeptideCollectionId() != null
				&& castOther.getPeptideCollectionId() != null && this
				.getPeptideCollectionId().equals(
						castOther.getPeptideCollectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeptideCollectionId() == null ? 0 : this
						.getPeptideCollectionId().hashCode());
		result = 37 * result
