...
/**
 * CanonicalThreePrimeSpliceSiteId generated by hbm2java
 */
public class CanonicalThreePrimeSpliceSiteId implements java.io.Serializable {

	private Integer canonicalThreePrimeSpliceSiteId;
	...
	public CanonicalThreePrimeSpliceSiteId() {
	}

	public CanonicalThreePrimeSpliceSiteId(
			Integer canonicalThreePrimeSpliceSiteId, Integer featureId,
		...
		this.canonicalThreePrimeSpliceSiteId = canonicalThreePrimeSpliceSiteId;
	...
	public Integer getCanonicalThreePrimeSpliceSiteId() {
		return this.canonicalThreePrimeSpliceSiteId;
	}

	public void setCanonicalThreePrimeSpliceSiteId(
			Integer canonicalThreePrimeSpliceSiteId) {
		this.canonicalThreePrimeSpliceSiteId = canonicalThreePrimeSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CanonicalThreePrimeSpliceSiteId))
			return false;
		CanonicalThreePrimeSpliceSiteId castOther = (CanonicalThreePrimeSpliceSiteId) other;

		return ((this.getCanonicalThreePrimeSpliceSiteId() == castOther
				.getCanonicalThreePrimeSpliceSiteId()) || (this
				.getCanonicalThreePrimeSpliceSiteId() != null
				&& castOther.getCanonicalThreePrimeSpliceSiteId() != null && this
				.getCanonicalThreePrimeSpliceSiteId().equals(
						castOther.getCanonicalThreePrimeSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCanonicalThreePrimeSpliceSiteId() == null ? 0 : this
						.getCanonicalThreePrimeSpliceSiteId().hashCode());
		result = 37 * result
