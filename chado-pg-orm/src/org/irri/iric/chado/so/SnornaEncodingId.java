...
/**
 * SnornaEncodingId generated by hbm2java
 */
public class SnornaEncodingId implements java.io.Serializable {

	private Integer snornaEncodingId;
	...
	public SnornaEncodingId() {
	}

	public SnornaEncodingId(Integer snornaEncodingId, Integer featureId,
		...
		this.snornaEncodingId = snornaEncodingId;
	...
	public Integer getSnornaEncodingId() {
		return this.snornaEncodingId;
	}

	public void setSnornaEncodingId(Integer snornaEncodingId) {
		this.snornaEncodingId = snornaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnornaEncodingId))
			return false;
		SnornaEncodingId castOther = (SnornaEncodingId) other;

		return ((this.getSnornaEncodingId() == castOther.getSnornaEncodingId()) || (this
				.getSnornaEncodingId() != null
				&& castOther.getSnornaEncodingId() != null && this
				.getSnornaEncodingId().equals(castOther.getSnornaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnornaEncodingId() == null ? 0 : this
						.getSnornaEncodingId().hashCode());
		result = 37 * result
