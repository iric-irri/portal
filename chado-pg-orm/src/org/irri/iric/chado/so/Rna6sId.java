...
/**
 * Rna6sId generated by hbm2java
 */
public class Rna6sId implements java.io.Serializable {

	private Integer rna6sId;
	...
	public Rna6sId(Integer rna6sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRna6sId() {
		return this.rna6sId;
	}

	public void setRna6sId(Integer rna6sId) {
		this.rna6sId = rna6sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rna6sId))
			return false;
		Rna6sId castOther = (Rna6sId) other;

		return ((this.getRna6sId() == castOther.getRna6sId()) || (this
				.getRna6sId() != null && castOther.getRna6sId() != null && this
				.getRna6sId().equals(castOther.getRna6sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRna6sId() == null ? 0 : this.getRna6sId().hashCode());
		result = 37 * result
