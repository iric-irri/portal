...
/**
 * AttctnSiteId generated by hbm2java
 */
public class AttctnSiteId implements java.io.Serializable {

	private Integer attctnSiteId;
	...
	public AttctnSiteId(Integer attctnSiteId, Integer featureId,
		...
		this.attctnSiteId = attctnSiteId;
	...
	public Integer getAttctnSiteId() {
		return this.attctnSiteId;
	}

	public void setAttctnSiteId(Integer attctnSiteId) {
		this.attctnSiteId = attctnSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttctnSiteId))
			return false;
		AttctnSiteId castOther = (AttctnSiteId) other;

		return ((this.getAttctnSiteId() == castOther.getAttctnSiteId()) || (this
				.getAttctnSiteId() != null
				&& castOther.getAttctnSiteId() != null && this
				.getAttctnSiteId().equals(castOther.getAttctnSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttctnSiteId() == null ? 0 : this.getAttctnSiteId()
						.hashCode());
		result = 37 * result
