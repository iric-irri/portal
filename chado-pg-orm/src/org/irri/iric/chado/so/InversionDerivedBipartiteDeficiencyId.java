...
/**
 * InversionDerivedBipartiteDeficiencyId generated by hbm2java
 */
public class InversionDerivedBipartiteDeficiencyId implements
		java.io.Serializable {

	private Integer inversionDerivedBipartiteDeficiencyId;
	...
	public InversionDerivedBipartiteDeficiencyId() {
	}

	public InversionDerivedBipartiteDeficiencyId(
			Integer inversionDerivedBipartiteDeficiencyId, Integer featureId,
		...
		this.inversionDerivedBipartiteDeficiencyId = inversionDerivedBipartiteDeficiencyId;
	...
	public Integer getInversionDerivedBipartiteDeficiencyId() {
		return this.inversionDerivedBipartiteDeficiencyId;
	}

	public void setInversionDerivedBipartiteDeficiencyId(
			Integer inversionDerivedBipartiteDeficiencyId) {
		this.inversionDerivedBipartiteDeficiencyId = inversionDerivedBipartiteDeficiencyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedBipartiteDeficiencyId))
			return false;
		InversionDerivedBipartiteDeficiencyId castOther = (InversionDerivedBipartiteDeficiencyId) other;

		return ((this.getInversionDerivedBipartiteDeficiencyId() == castOther
				.getInversionDerivedBipartiteDeficiencyId()) || (this
				.getInversionDerivedBipartiteDeficiencyId() != null
				&& castOther.getInversionDerivedBipartiteDeficiencyId() != null && this
				.getInversionDerivedBipartiteDeficiencyId().equals(
						castOther.getInversionDerivedBipartiteDeficiencyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedBipartiteDeficiencyId() == null ? 0
						: this.getInversionDerivedBipartiteDeficiencyId()
								.hashCode());
		result = 37 * result
