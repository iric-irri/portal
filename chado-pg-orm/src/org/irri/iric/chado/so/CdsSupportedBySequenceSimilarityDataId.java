...
/**
 * CdsSupportedBySequenceSimilarityDataId generated by hbm2java
 */
public class CdsSupportedBySequenceSimilarityDataId implements
		java.io.Serializable {

	private Integer cdsSupportedBySequenceSimilarityDataId;
	...
	public CdsSupportedBySequenceSimilarityDataId() {
	}

	public CdsSupportedBySequenceSimilarityDataId(
			Integer cdsSupportedBySequenceSimilarityDataId, Integer featureId,
		...
		this.cdsSupportedBySequenceSimilarityDataId = cdsSupportedBySequenceSimilarityDataId;
	...
	public Integer getCdsSupportedBySequenceSimilarityDataId() {
		return this.cdsSupportedBySequenceSimilarityDataId;
	}

	public void setCdsSupportedBySequenceSimilarityDataId(
			Integer cdsSupportedBySequenceSimilarityDataId) {
		this.cdsSupportedBySequenceSimilarityDataId = cdsSupportedBySequenceSimilarityDataId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsSupportedBySequenceSimilarityDataId))
			return false;
		CdsSupportedBySequenceSimilarityDataId castOther = (CdsSupportedBySequenceSimilarityDataId) other;

		return ((this.getCdsSupportedBySequenceSimilarityDataId() == castOther
				.getCdsSupportedBySequenceSimilarityDataId()) || (this
				.getCdsSupportedBySequenceSimilarityDataId() != null
				&& castOther.getCdsSupportedBySequenceSimilarityDataId() != null && this
				.getCdsSupportedBySequenceSimilarityDataId().equals(
						castOther.getCdsSupportedBySequenceSimilarityDataId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsSupportedBySequenceSimilarityDataId() == null ? 0
						: this.getCdsSupportedBySequenceSimilarityDataId()
								.hashCode());
		result = 37 * result
