...
/**
 * TransSpliceSiteId generated by hbm2java
 */
public class TransSpliceSiteId implements java.io.Serializable {

	private Integer transSpliceSiteId;
	...
	public TransSpliceSiteId() {
	}

	public TransSpliceSiteId(Integer transSpliceSiteId, Integer featureId,
		...
		this.transSpliceSiteId = transSpliceSiteId;
	...
	public Integer getTransSpliceSiteId() {
		return this.transSpliceSiteId;
	}

	public void setTransSpliceSiteId(Integer transSpliceSiteId) {
		this.transSpliceSiteId = transSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSpliceSiteId))
			return false;
		TransSpliceSiteId castOther = (TransSpliceSiteId) other;

		return ((this.getTransSpliceSiteId() == castOther
				.getTransSpliceSiteId()) || (this.getTransSpliceSiteId() != null
				&& castOther.getTransSpliceSiteId() != null && this
				.getTransSpliceSiteId()
				.equals(castOther.getTransSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSpliceSiteId() == null ? 0 : this
						.getTransSpliceSiteId().hashCode());
		result = 37 * result
