...
/**
 * StopCodonReadThroughId generated by hbm2java
 */
public class StopCodonReadThroughId implements java.io.Serializable {

	private Integer stopCodonReadThroughId;
	...
	public StopCodonReadThroughId() {
	}

	public StopCodonReadThroughId(Integer stopCodonReadThroughId,
		...
		this.stopCodonReadThroughId = stopCodonReadThroughId;
	...
	public Integer getStopCodonReadThroughId() {
		return this.stopCodonReadThroughId;
	}

	public void setStopCodonReadThroughId(Integer stopCodonReadThroughId) {
		this.stopCodonReadThroughId = stopCodonReadThroughId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopCodonReadThroughId))
			return false;
		StopCodonReadThroughId castOther = (StopCodonReadThroughId) other;

		return ((this.getStopCodonReadThroughId() == castOther
				.getStopCodonReadThroughId()) || (this
				.getStopCodonReadThroughId() != null
				&& castOther.getStopCodonReadThroughId() != null && this
				.getStopCodonReadThroughId().equals(
						castOther.getStopCodonReadThroughId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopCodonReadThroughId() == null ? 0 : this
						.getStopCodonReadThroughId().hashCode());
		result = 37 * result
