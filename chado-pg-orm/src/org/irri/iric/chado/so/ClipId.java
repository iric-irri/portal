...
/**
 * ClipId generated by hbm2java
 */
public class ClipId implements java.io.Serializable {
	...
	public ClipId(Integer clipId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClipId))
			return false;
		ClipId castOther = (ClipId) other;

		return ((this.getClipId() == castOther.getClipId()) || (this
				.getClipId() != null && castOther.getClipId() != null && this
				.getClipId().equals(castOther.getClipId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getClipId() == null ? 0 : this.getClipId().hashCode());
		result = 37 * result
