...
/**
 * TssId generated by hbm2java
 */
public class TssId implements java.io.Serializable {
	...
	public TssId(Integer tssId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TssId))
			return false;
		TssId castOther = (TssId) other;

		return ((this.getTssId() == castOther.getTssId()) || (this.getTssId() != null
				&& castOther.getTssId() != null && this.getTssId().equals(
				castOther.getTssId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTssId() == null ? 0 : this.getTssId().hashCode());
		result = 37 * result
