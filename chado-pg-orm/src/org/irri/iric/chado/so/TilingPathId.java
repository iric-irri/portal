...
/**
 * TilingPathId generated by hbm2java
 */
public class TilingPathId implements java.io.Serializable {

	private Integer tilingPathId;
	...
	public TilingPathId(Integer tilingPathId, Integer featureId,
		...
		this.tilingPathId = tilingPathId;
	...
	public Integer getTilingPathId() {
		return this.tilingPathId;
	}

	public void setTilingPathId(Integer tilingPathId) {
		this.tilingPathId = tilingPathId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TilingPathId))
			return false;
		TilingPathId castOther = (TilingPathId) other;

		return ((this.getTilingPathId() == castOther.getTilingPathId()) || (this
				.getTilingPathId() != null
				&& castOther.getTilingPathId() != null && this
				.getTilingPathId().equals(castOther.getTilingPathId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTilingPathId() == null ? 0 : this.getTilingPathId()
						.hashCode());
		result = 37 * result
