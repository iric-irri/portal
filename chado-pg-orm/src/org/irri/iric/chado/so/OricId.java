...
/**
 * OricId generated by hbm2java
 */
public class OricId implements java.io.Serializable {

	private Integer oricId;
	...
	public OricId(Integer oricId, Integer featureId, Integer dbxrefId,
	...
	public Integer getOricId() {
		return this.oricId;
	}

	public void setOricId(Integer oricId) {
		this.oricId = oricId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OricId))
			return false;
		OricId castOther = (OricId) other;

		return ((this.getOricId() == castOther.getOricId()) || (this
				.getOricId() != null && castOther.getOricId() != null && this
				.getOricId().equals(castOther.getOricId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOricId() == null ? 0 : this.getOricId().hashCode());
		result = 37 * result
