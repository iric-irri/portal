...
/**
 * TwoPrimeOMethylpseudouridineId generated by hbm2java
 */
public class TwoPrimeOMethylpseudouridineId implements java.io.Serializable {

	private Integer twoPrimeOMethylpseudouridineId;
	...
	public TwoPrimeOMethylpseudouridineId() {
	}

	public TwoPrimeOMethylpseudouridineId(
			Integer twoPrimeOMethylpseudouridineId, Integer featureId,
		...
		this.twoPrimeOMethylpseudouridineId = twoPrimeOMethylpseudouridineId;
	...
	public Integer getTwoPrimeOMethylpseudouridineId() {
		return this.twoPrimeOMethylpseudouridineId;
	}

	public void setTwoPrimeOMethylpseudouridineId(
			Integer twoPrimeOMethylpseudouridineId) {
		this.twoPrimeOMethylpseudouridineId = twoPrimeOMethylpseudouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethylpseudouridineId))
			return false;
		TwoPrimeOMethylpseudouridineId castOther = (TwoPrimeOMethylpseudouridineId) other;

		return ((this.getTwoPrimeOMethylpseudouridineId() == castOther
				.getTwoPrimeOMethylpseudouridineId()) || (this
				.getTwoPrimeOMethylpseudouridineId() != null
				&& castOther.getTwoPrimeOMethylpseudouridineId() != null && this
				.getTwoPrimeOMethylpseudouridineId().equals(
						castOther.getTwoPrimeOMethylpseudouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethylpseudouridineId() == null ? 0 : this
						.getTwoPrimeOMethylpseudouridineId().hashCode());
		result = 37 * result
