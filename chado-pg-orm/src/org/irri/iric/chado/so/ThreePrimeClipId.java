...
/**
 * ThreePrimeClipId generated by hbm2java
 */
public class ThreePrimeClipId implements java.io.Serializable {

	private Integer threePrimeClipId;
	...
	public ThreePrimeClipId() {
	}

	public ThreePrimeClipId(Integer threePrimeClipId, Integer featureId,
		...
		this.threePrimeClipId = threePrimeClipId;
	...
	public Integer getThreePrimeClipId() {
		return this.threePrimeClipId;
	}

	public void setThreePrimeClipId(Integer threePrimeClipId) {
		this.threePrimeClipId = threePrimeClipId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeClipId))
			return false;
		ThreePrimeClipId castOther = (ThreePrimeClipId) other;

		return ((this.getThreePrimeClipId() == castOther.getThreePrimeClipId()) || (this
				.getThreePrimeClipId() != null
				&& castOther.getThreePrimeClipId() != null && this
				.getThreePrimeClipId().equals(castOther.getThreePrimeClipId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeClipId() == null ? 0 : this
						.getThreePrimeClipId().hashCode());
		result = 37 * result
