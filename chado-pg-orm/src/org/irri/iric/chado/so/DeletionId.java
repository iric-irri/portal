...
/**
 * DeletionId generated by hbm2java
 */
public class DeletionId implements java.io.Serializable {
	...
	public DeletionId(Integer deletionId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeletionId))
			return false;
		DeletionId castOther = (DeletionId) other;

		return ((this.getDeletionId() == castOther.getDeletionId()) || (this
				.getDeletionId() != null && castOther.getDeletionId() != null && this
				.getDeletionId().equals(castOther.getDeletionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeletionId() == null ? 0 : this.getDeletionId()
						.hashCode());
		result = 37 * result
