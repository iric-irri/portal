...
/**
 * ModifiedLGlutamicAcidId generated by hbm2java
 */
public class ModifiedLGlutamicAcidId implements java.io.Serializable {

	private Integer modifiedLGlutamicAcidId;
	...
	public ModifiedLGlutamicAcidId() {
	}

	public ModifiedLGlutamicAcidId(Integer modifiedLGlutamicAcidId,
		...
		this.modifiedLGlutamicAcidId = modifiedLGlutamicAcidId;
	...
	public Integer getModifiedLGlutamicAcidId() {
		return this.modifiedLGlutamicAcidId;
	}

	public void setModifiedLGlutamicAcidId(Integer modifiedLGlutamicAcidId) {
		this.modifiedLGlutamicAcidId = modifiedLGlutamicAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLGlutamicAcidId))
			return false;
		ModifiedLGlutamicAcidId castOther = (ModifiedLGlutamicAcidId) other;

		return ((this.getModifiedLGlutamicAcidId() == castOther
				.getModifiedLGlutamicAcidId()) || (this
				.getModifiedLGlutamicAcidId() != null
				&& castOther.getModifiedLGlutamicAcidId() != null && this
				.getModifiedLGlutamicAcidId().equals(
						castOther.getModifiedLGlutamicAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLGlutamicAcidId() == null ? 0 : this
						.getModifiedLGlutamicAcidId().hashCode());
		result = 37 * result
