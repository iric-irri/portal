...
/**
 * BacId generated by hbm2java
 */
public class BacId implements java.io.Serializable {
	...
	public BacId(Integer bacId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BacId))
			return false;
		BacId castOther = (BacId) other;

		return ((this.getBacId() == castOther.getBacId()) || (this.getBacId() != null
				&& castOther.getBacId() != null && this.getBacId().equals(
				castOther.getBacId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getBacId() == null ? 0 : this.getBacId().hashCode());
		result = 37 * result
