...
/**
 * InversionDerivedAneuploidChromosomeId generated by hbm2java
 */
public class InversionDerivedAneuploidChromosomeId implements
		java.io.Serializable {

	private Integer inversionDerivedAneuploidChromosomeId;
	...
	public InversionDerivedAneuploidChromosomeId() {
	}

	public InversionDerivedAneuploidChromosomeId(
			Integer inversionDerivedAneuploidChromosomeId, Integer featureId,
		...
		this.inversionDerivedAneuploidChromosomeId = inversionDerivedAneuploidChromosomeId;
	...
	public Integer getInversionDerivedAneuploidChromosomeId() {
		return this.inversionDerivedAneuploidChromosomeId;
	}

	public void setInversionDerivedAneuploidChromosomeId(
			Integer inversionDerivedAneuploidChromosomeId) {
		this.inversionDerivedAneuploidChromosomeId = inversionDerivedAneuploidChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedAneuploidChromosomeId))
			return false;
		InversionDerivedAneuploidChromosomeId castOther = (InversionDerivedAneuploidChromosomeId) other;

		return ((this.getInversionDerivedAneuploidChromosomeId() == castOther
				.getInversionDerivedAneuploidChromosomeId()) || (this
				.getInversionDerivedAneuploidChromosomeId() != null
				&& castOther.getInversionDerivedAneuploidChromosomeId() != null && this
				.getInversionDerivedAneuploidChromosomeId().equals(
						castOther.getInversionDerivedAneuploidChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedAneuploidChromosomeId() == null ? 0
						: this.getInversionDerivedAneuploidChromosomeId()
								.hashCode());
		result = 37 * result
