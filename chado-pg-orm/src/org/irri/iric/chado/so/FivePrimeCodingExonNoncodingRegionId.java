...
/**
 * FivePrimeCodingExonNoncodingRegionId generated by hbm2java
 */
public class FivePrimeCodingExonNoncodingRegionId implements
		java.io.Serializable {

	private Integer fivePrimeCodingExonNoncodingRegionId;
	...
	public FivePrimeCodingExonNoncodingRegionId() {
	}

	public FivePrimeCodingExonNoncodingRegionId(
			Integer fivePrimeCodingExonNoncodingRegionId, Integer featureId,
		...
		this.fivePrimeCodingExonNoncodingRegionId = fivePrimeCodingExonNoncodingRegionId;
	...
	public Integer getFivePrimeCodingExonNoncodingRegionId() {
		return this.fivePrimeCodingExonNoncodingRegionId;
	}

	public void setFivePrimeCodingExonNoncodingRegionId(
			Integer fivePrimeCodingExonNoncodingRegionId) {
		this.fivePrimeCodingExonNoncodingRegionId = fivePrimeCodingExonNoncodingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeCodingExonNoncodingRegionId))
			return false;
		FivePrimeCodingExonNoncodingRegionId castOther = (FivePrimeCodingExonNoncodingRegionId) other;

		return ((this.getFivePrimeCodingExonNoncodingRegionId() == castOther
				.getFivePrimeCodingExonNoncodingRegionId()) || (this
				.getFivePrimeCodingExonNoncodingRegionId() != null
				&& castOther.getFivePrimeCodingExonNoncodingRegionId() != null && this
				.getFivePrimeCodingExonNoncodingRegionId().equals(
						castOther.getFivePrimeCodingExonNoncodingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeCodingExonNoncodingRegionId() == null ? 0 : this
						.getFivePrimeCodingExonNoncodingRegionId().hashCode());
		result = 37 * result
