...
/**
 * FiveIsopentenylaminomethylUridineId generated by hbm2java
 */
public class FiveIsopentenylaminomethylUridineId implements
		java.io.Serializable {

	private Integer fiveIsopentenylaminomethylUridineId;
	...
	public FiveIsopentenylaminomethylUridineId() {
	}

	public FiveIsopentenylaminomethylUridineId(
			Integer fiveIsopentenylaminomethylUridineId, Integer featureId,
		...
		this.fiveIsopentenylaminomethylUridineId = fiveIsopentenylaminomethylUridineId;
	...
	public Integer getFiveIsopentenylaminomethylUridineId() {
		return this.fiveIsopentenylaminomethylUridineId;
	}

	public void setFiveIsopentenylaminomethylUridineId(
			Integer fiveIsopentenylaminomethylUridineId) {
		this.fiveIsopentenylaminomethylUridineId = fiveIsopentenylaminomethylUridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveIsopentenylaminomethylUridineId))
			return false;
		FiveIsopentenylaminomethylUridineId castOther = (FiveIsopentenylaminomethylUridineId) other;

		return ((this.getFiveIsopentenylaminomethylUridineId() == castOther
				.getFiveIsopentenylaminomethylUridineId()) || (this
				.getFiveIsopentenylaminomethylUridineId() != null
				&& castOther.getFiveIsopentenylaminomethylUridineId() != null && this
				.getFiveIsopentenylaminomethylUridineId().equals(
						castOther.getFiveIsopentenylaminomethylUridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveIsopentenylaminomethylUridineId() == null ? 0 : this
						.getFiveIsopentenylaminomethylUridineId().hashCode());
		result = 37 * result
