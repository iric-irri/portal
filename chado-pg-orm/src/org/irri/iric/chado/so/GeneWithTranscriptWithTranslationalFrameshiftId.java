...
/**
 * GeneWithTranscriptWithTranslationalFrameshiftId generated by hbm2java
 */
public class GeneWithTranscriptWithTranslationalFrameshiftId implements
		java.io.Serializable {

	private Integer geneWithTranscriptWithTranslationalFrameshiftId;
	...
	public GeneWithTranscriptWithTranslationalFrameshiftId() {
	}

	public GeneWithTranscriptWithTranslationalFrameshiftId(
			Integer geneWithTranscriptWithTranslationalFrameshiftId,
		...
		this.geneWithTranscriptWithTranslationalFrameshiftId = geneWithTranscriptWithTranslationalFrameshiftId;
	...
	public Integer getGeneWithTranscriptWithTranslationalFrameshiftId() {
		return this.geneWithTranscriptWithTranslationalFrameshiftId;
	}

	public void setGeneWithTranscriptWithTranslationalFrameshiftId(
			Integer geneWithTranscriptWithTranslationalFrameshiftId) {
		this.geneWithTranscriptWithTranslationalFrameshiftId = geneWithTranscriptWithTranslationalFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithTranscriptWithTranslationalFrameshiftId))
			return false;
		GeneWithTranscriptWithTranslationalFrameshiftId castOther = (GeneWithTranscriptWithTranslationalFrameshiftId) other;

		return ((this.getGeneWithTranscriptWithTranslationalFrameshiftId() == castOther
				.getGeneWithTranscriptWithTranslationalFrameshiftId()) || (this
				.getGeneWithTranscriptWithTranslationalFrameshiftId() != null
				&& castOther
						.getGeneWithTranscriptWithTranslationalFrameshiftId() != null && this
				.getGeneWithTranscriptWithTranslationalFrameshiftId()
				.equals(castOther
						.getGeneWithTranscriptWithTranslationalFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithTranscriptWithTranslationalFrameshiftId() == null ? 0
						: this.getGeneWithTranscriptWithTranslationalFrameshiftId()
								.hashCode());
		result = 37 * result
