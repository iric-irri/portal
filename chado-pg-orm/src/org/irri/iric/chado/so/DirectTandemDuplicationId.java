...
/**
 * DirectTandemDuplicationId generated by hbm2java
 */
public class DirectTandemDuplicationId implements java.io.Serializable {

	private Integer directTandemDuplicationId;
	...
	public DirectTandemDuplicationId() {
	}

	public DirectTandemDuplicationId(Integer directTandemDuplicationId,
		...
		this.directTandemDuplicationId = directTandemDuplicationId;
	...
	public Integer getDirectTandemDuplicationId() {
		return this.directTandemDuplicationId;
	}

	public void setDirectTandemDuplicationId(Integer directTandemDuplicationId) {
		this.directTandemDuplicationId = directTandemDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DirectTandemDuplicationId))
			return false;
		DirectTandemDuplicationId castOther = (DirectTandemDuplicationId) other;

		return ((this.getDirectTandemDuplicationId() == castOther
				.getDirectTandemDuplicationId()) || (this
				.getDirectTandemDuplicationId() != null
				&& castOther.getDirectTandemDuplicationId() != null && this
				.getDirectTandemDuplicationId().equals(
						castOther.getDirectTandemDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDirectTandemDuplicationId() == null ? 0 : this
						.getDirectTandemDuplicationId().hashCode());
		result = 37 * result
