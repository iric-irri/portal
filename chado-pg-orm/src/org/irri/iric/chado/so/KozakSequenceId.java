...
/**
 * KozakSequenceId generated by hbm2java
 */
public class KozakSequenceId implements java.io.Serializable {

	private Integer kozakSequenceId;
	...
	public KozakSequenceId() {
	}

	public KozakSequenceId(Integer kozakSequenceId, Integer featureId,
		...
		this.kozakSequenceId = kozakSequenceId;
	...
	public Integer getKozakSequenceId() {
		return this.kozakSequenceId;
	}

	public void setKozakSequenceId(Integer kozakSequenceId) {
		this.kozakSequenceId = kozakSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KozakSequenceId))
			return false;
		KozakSequenceId castOther = (KozakSequenceId) other;

		return ((this.getKozakSequenceId() == castOther.getKozakSequenceId()) || (this
				.getKozakSequenceId() != null
				&& castOther.getKozakSequenceId() != null && this
				.getKozakSequenceId().equals(castOther.getKozakSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getKozakSequenceId() == null ? 0 : this.getKozakSequenceId()
						.hashCode());
		result = 37 * result
