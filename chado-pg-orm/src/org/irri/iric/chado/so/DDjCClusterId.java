...
/**
 * DDjCClusterId generated by hbm2java
 */
public class DDjCClusterId implements java.io.Serializable {

	private Integer DDjCClusterId;
	...
	public DDjCClusterId() {
	}

	public DDjCClusterId(Integer DDjCClusterId, Integer featureId,
		...
		this.DDjCClusterId = DDjCClusterId;
	...
	public Integer getDDjCClusterId() {
		return this.DDjCClusterId;
	}

	public void setDDjCClusterId(Integer DDjCClusterId) {
		this.DDjCClusterId = DDjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DDjCClusterId))
			return false;
		DDjCClusterId castOther = (DDjCClusterId) other;

		return ((this.getDDjCClusterId() == castOther.getDDjCClusterId()) || (this
				.getDDjCClusterId() != null
				&& castOther.getDDjCClusterId() != null && this
				.getDDjCClusterId().equals(castOther.getDDjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDDjCClusterId() == null ? 0 : this.getDDjCClusterId()
						.hashCode());
		result = 37 * result
