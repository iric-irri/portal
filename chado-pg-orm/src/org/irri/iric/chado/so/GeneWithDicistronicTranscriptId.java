...
/**
 * GeneWithDicistronicTranscriptId generated by hbm2java
 */
public class GeneWithDicistronicTranscriptId implements java.io.Serializable {

	private Integer geneWithDicistronicTranscriptId;
	...
	public GeneWithDicistronicTranscriptId() {
	}

	public GeneWithDicistronicTranscriptId(
			Integer geneWithDicistronicTranscriptId, Integer featureId,
		...
		this.geneWithDicistronicTranscriptId = geneWithDicistronicTranscriptId;
	...
	public Integer getGeneWithDicistronicTranscriptId() {
		return this.geneWithDicistronicTranscriptId;
	}

	public void setGeneWithDicistronicTranscriptId(
			Integer geneWithDicistronicTranscriptId) {
		this.geneWithDicistronicTranscriptId = geneWithDicistronicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithDicistronicTranscriptId))
			return false;
		GeneWithDicistronicTranscriptId castOther = (GeneWithDicistronicTranscriptId) other;

		return ((this.getGeneWithDicistronicTranscriptId() == castOther
				.getGeneWithDicistronicTranscriptId()) || (this
				.getGeneWithDicistronicTranscriptId() != null
				&& castOther.getGeneWithDicistronicTranscriptId() != null && this
				.getGeneWithDicistronicTranscriptId().equals(
						castOther.getGeneWithDicistronicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithDicistronicTranscriptId() == null ? 0 : this
						.getGeneWithDicistronicTranscriptId().hashCode());
		result = 37 * result
