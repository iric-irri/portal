...
/**
 * N272prirmeOTrimethylguanosineId generated by hbm2java
 */
public class N272prirmeOTrimethylguanosineId implements java.io.Serializable {

	private Integer n272prirmeOTrimethylguanosineId;
	...
	public N272prirmeOTrimethylguanosineId() {
	}

	public N272prirmeOTrimethylguanosineId(
			Integer n272prirmeOTrimethylguanosineId, Integer featureId,
		...
		this.n272prirmeOTrimethylguanosineId = n272prirmeOTrimethylguanosineId;
	...
	public Integer getN272prirmeOTrimethylguanosineId() {
		return this.n272prirmeOTrimethylguanosineId;
	}

	public void setN272prirmeOTrimethylguanosineId(
			Integer n272prirmeOTrimethylguanosineId) {
		this.n272prirmeOTrimethylguanosineId = n272prirmeOTrimethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N272prirmeOTrimethylguanosineId))
			return false;
		N272prirmeOTrimethylguanosineId castOther = (N272prirmeOTrimethylguanosineId) other;

		return ((this.getN272prirmeOTrimethylguanosineId() == castOther
				.getN272prirmeOTrimethylguanosineId()) || (this
				.getN272prirmeOTrimethylguanosineId() != null
				&& castOther.getN272prirmeOTrimethylguanosineId() != null && this
				.getN272prirmeOTrimethylguanosineId().equals(
						castOther.getN272prirmeOTrimethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN272prirmeOTrimethylguanosineId() == null ? 0 : this
						.getN272prirmeOTrimethylguanosineId().hashCode());
		result = 37 * result
