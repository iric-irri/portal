...
/**
 * CodingConservedRegionId generated by hbm2java
 */
public class CodingConservedRegionId implements java.io.Serializable {

	private Integer codingConservedRegionId;
	...
	public CodingConservedRegionId() {
	}

	public CodingConservedRegionId(Integer codingConservedRegionId,
		...
		this.codingConservedRegionId = codingConservedRegionId;
	...
	public Integer getCodingConservedRegionId() {
		return this.codingConservedRegionId;
	}

	public void setCodingConservedRegionId(Integer codingConservedRegionId) {
		this.codingConservedRegionId = codingConservedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingConservedRegionId))
			return false;
		CodingConservedRegionId castOther = (CodingConservedRegionId) other;

		return ((this.getCodingConservedRegionId() == castOther
				.getCodingConservedRegionId()) || (this
				.getCodingConservedRegionId() != null
				&& castOther.getCodingConservedRegionId() != null && this
				.getCodingConservedRegionId().equals(
						castOther.getCodingConservedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingConservedRegionId() == null ? 0 : this
						.getCodingConservedRegionId().hashCode());
		result = 37 * result
