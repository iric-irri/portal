...
/**
 * H3k4TrimethylationId generated by hbm2java
 */
public class H3k4TrimethylationId implements java.io.Serializable {

	private Integer h3k4TrimethylationId;
	...
	public H3k4TrimethylationId() {
	}

	public H3k4TrimethylationId(Integer h3k4TrimethylationId,
		...
		this.h3k4TrimethylationId = h3k4TrimethylationId;
	...
	public Integer getH3k4TrimethylationId() {
		return this.h3k4TrimethylationId;
	}

	public void setH3k4TrimethylationId(Integer h3k4TrimethylationId) {
		this.h3k4TrimethylationId = h3k4TrimethylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k4TrimethylationId))
			return false;
		H3k4TrimethylationId castOther = (H3k4TrimethylationId) other;

		return ((this.getH3k4TrimethylationId() == castOther
				.getH3k4TrimethylationId()) || (this.getH3k4TrimethylationId() != null
				&& castOther.getH3k4TrimethylationId() != null && this
				.getH3k4TrimethylationId().equals(
						castOther.getH3k4TrimethylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k4TrimethylationId() == null ? 0 : this
						.getH3k4TrimethylationId().hashCode());
		result = 37 * result
