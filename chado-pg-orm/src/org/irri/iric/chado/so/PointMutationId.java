...
/**
 * PointMutationId generated by hbm2java
 */
public class PointMutationId implements java.io.Serializable {

	private Integer pointMutationId;
	...
	public PointMutationId() {
	}

	public PointMutationId(Integer pointMutationId, Integer featureId,
		...
		this.pointMutationId = pointMutationId;
	...
	public Integer getPointMutationId() {
		return this.pointMutationId;
	}

	public void setPointMutationId(Integer pointMutationId) {
		this.pointMutationId = pointMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PointMutationId))
			return false;
		PointMutationId castOther = (PointMutationId) other;

		return ((this.getPointMutationId() == castOther.getPointMutationId()) || (this
				.getPointMutationId() != null
				&& castOther.getPointMutationId() != null && this
				.getPointMutationId().equals(castOther.getPointMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPointMutationId() == null ? 0 : this.getPointMutationId()
						.hashCode());
		result = 37 * result
