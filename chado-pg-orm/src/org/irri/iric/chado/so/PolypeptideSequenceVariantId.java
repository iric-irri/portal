...
/**
 * PolypeptideSequenceVariantId generated by hbm2java
 */
public class PolypeptideSequenceVariantId implements java.io.Serializable {

	private Integer polypeptideSequenceVariantId;
	...
	public PolypeptideSequenceVariantId() {
	}

	public PolypeptideSequenceVariantId(Integer polypeptideSequenceVariantId,
		...
		this.polypeptideSequenceVariantId = polypeptideSequenceVariantId;
	...
	public Integer getPolypeptideSequenceVariantId() {
		return this.polypeptideSequenceVariantId;
	}

	public void setPolypeptideSequenceVariantId(
			Integer polypeptideSequenceVariantId) {
		this.polypeptideSequenceVariantId = polypeptideSequenceVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideSequenceVariantId))
			return false;
		PolypeptideSequenceVariantId castOther = (PolypeptideSequenceVariantId) other;

		return ((this.getPolypeptideSequenceVariantId() == castOther
				.getPolypeptideSequenceVariantId()) || (this
				.getPolypeptideSequenceVariantId() != null
				&& castOther.getPolypeptideSequenceVariantId() != null && this
				.getPolypeptideSequenceVariantId().equals(
						castOther.getPolypeptideSequenceVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideSequenceVariantId() == null ? 0 : this
						.getPolypeptideSequenceVariantId().hashCode());
		result = 37 * result
