...
/**
 * TrinucRepeatMicrosatId generated by hbm2java
 */
public class TrinucRepeatMicrosatId implements java.io.Serializable {

	private Integer trinucRepeatMicrosatId;
	...
	public TrinucRepeatMicrosatId() {
	}

	public TrinucRepeatMicrosatId(Integer trinucRepeatMicrosatId,
		...
		this.trinucRepeatMicrosatId = trinucRepeatMicrosatId;
	...
	public Integer getTrinucRepeatMicrosatId() {
		return this.trinucRepeatMicrosatId;
	}

	public void setTrinucRepeatMicrosatId(Integer trinucRepeatMicrosatId) {
		this.trinucRepeatMicrosatId = trinucRepeatMicrosatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrinucRepeatMicrosatId))
			return false;
		TrinucRepeatMicrosatId castOther = (TrinucRepeatMicrosatId) other;

		return ((this.getTrinucRepeatMicrosatId() == castOther
				.getTrinucRepeatMicrosatId()) || (this
				.getTrinucRepeatMicrosatId() != null
				&& castOther.getTrinucRepeatMicrosatId() != null && this
				.getTrinucRepeatMicrosatId().equals(
						castOther.getTrinucRepeatMicrosatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrinucRepeatMicrosatId() == null ? 0 : this
						.getTrinucRepeatMicrosatId().hashCode());
		result = 37 * result
