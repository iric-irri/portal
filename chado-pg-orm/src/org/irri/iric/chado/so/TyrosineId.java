...
/**
 * TyrosineId generated by hbm2java
 */
public class TyrosineId implements java.io.Serializable {

	private Integer tyrosineId;
	...
	public TyrosineId(Integer tyrosineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTyrosineId() {
		return this.tyrosineId;
	}

	public void setTyrosineId(Integer tyrosineId) {
		this.tyrosineId = tyrosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TyrosineId))
			return false;
		TyrosineId castOther = (TyrosineId) other;

		return ((this.getTyrosineId() == castOther.getTyrosineId()) || (this
				.getTyrosineId() != null && castOther.getTyrosineId() != null && this
				.getTyrosineId().equals(castOther.getTyrosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTyrosineId() == null ? 0 : this.getTyrosineId()
						.hashCode());
		result = 37 * result
