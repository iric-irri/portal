...
/**
 * PseudogenicGeneSegmentId generated by hbm2java
 */
public class PseudogenicGeneSegmentId implements java.io.Serializable {

	private Integer pseudogenicGeneSegmentId;
	...
	public PseudogenicGeneSegmentId() {
	}

	public PseudogenicGeneSegmentId(Integer pseudogenicGeneSegmentId,
		...
		this.pseudogenicGeneSegmentId = pseudogenicGeneSegmentId;
	...
	public Integer getPseudogenicGeneSegmentId() {
		return this.pseudogenicGeneSegmentId;
	}

	public void setPseudogenicGeneSegmentId(Integer pseudogenicGeneSegmentId) {
		this.pseudogenicGeneSegmentId = pseudogenicGeneSegmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicGeneSegmentId))
			return false;
		PseudogenicGeneSegmentId castOther = (PseudogenicGeneSegmentId) other;

		return ((this.getPseudogenicGeneSegmentId() == castOther
				.getPseudogenicGeneSegmentId()) || (this
				.getPseudogenicGeneSegmentId() != null
				&& castOther.getPseudogenicGeneSegmentId() != null && this
				.getPseudogenicGeneSegmentId().equals(
						castOther.getPseudogenicGeneSegmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicGeneSegmentId() == null ? 0 : this
						.getPseudogenicGeneSegmentId().hashCode());
		result = 37 * result
