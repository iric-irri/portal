...
/**
 * ScrnaGeneId generated by hbm2java
 */
public class ScrnaGeneId implements java.io.Serializable {

	private Integer scrnaGeneId;
	...
	public ScrnaGeneId(Integer scrnaGeneId, Integer featureId,
	...
	public Integer getScrnaGeneId() {
		return this.scrnaGeneId;
	}

	public void setScrnaGeneId(Integer scrnaGeneId) {
		this.scrnaGeneId = scrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ScrnaGeneId))
			return false;
		ScrnaGeneId castOther = (ScrnaGeneId) other;

		return ((this.getScrnaGeneId() == castOther.getScrnaGeneId()) || (this
				.getScrnaGeneId() != null && castOther.getScrnaGeneId() != null && this
				.getScrnaGeneId().equals(castOther.getScrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getScrnaGeneId() == null ? 0 : this.getScrnaGeneId()
						.hashCode());
		result = 37 * result
