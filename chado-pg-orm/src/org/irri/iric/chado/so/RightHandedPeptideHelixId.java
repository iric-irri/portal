...
/**
 * RightHandedPeptideHelixId generated by hbm2java
 */
public class RightHandedPeptideHelixId implements java.io.Serializable {

	private Integer rightHandedPeptideHelixId;
	...
	public RightHandedPeptideHelixId() {
	}

	public RightHandedPeptideHelixId(Integer rightHandedPeptideHelixId,
		...
		this.rightHandedPeptideHelixId = rightHandedPeptideHelixId;
	...
	public Integer getRightHandedPeptideHelixId() {
		return this.rightHandedPeptideHelixId;
	}

	public void setRightHandedPeptideHelixId(Integer rightHandedPeptideHelixId) {
		this.rightHandedPeptideHelixId = rightHandedPeptideHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RightHandedPeptideHelixId))
			return false;
		RightHandedPeptideHelixId castOther = (RightHandedPeptideHelixId) other;

		return ((this.getRightHandedPeptideHelixId() == castOther
				.getRightHandedPeptideHelixId()) || (this
				.getRightHandedPeptideHelixId() != null
				&& castOther.getRightHandedPeptideHelixId() != null && this
				.getRightHandedPeptideHelixId().equals(
						castOther.getRightHandedPeptideHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRightHandedPeptideHelixId() == null ? 0 : this
						.getRightHandedPeptideHelixId().hashCode());
		result = 37 * result
