...
/**
 * EditedTranscriptId generated by hbm2java
 */
public class EditedTranscriptId implements java.io.Serializable {

	private Integer editedTranscriptId;
	...
	public EditedTranscriptId() {
	}

	public EditedTranscriptId(Integer editedTranscriptId, Integer featureId,
		...
		this.editedTranscriptId = editedTranscriptId;
	...
	public Integer getEditedTranscriptId() {
		return this.editedTranscriptId;
	}

	public void setEditedTranscriptId(Integer editedTranscriptId) {
		this.editedTranscriptId = editedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedTranscriptId))
			return false;
		EditedTranscriptId castOther = (EditedTranscriptId) other;

		return ((this.getEditedTranscriptId() == castOther
				.getEditedTranscriptId()) || (this.getEditedTranscriptId() != null
				&& castOther.getEditedTranscriptId() != null && this
				.getEditedTranscriptId().equals(
						castOther.getEditedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditedTranscriptId() == null ? 0 : this
						.getEditedTranscriptId().hashCode());
		result = 37 * result
