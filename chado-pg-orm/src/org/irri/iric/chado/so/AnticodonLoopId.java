...
/**
 * AnticodonLoopId generated by hbm2java
 */
public class AnticodonLoopId implements java.io.Serializable {

	private Integer anticodonLoopId;
	...
	public AnticodonLoopId() {
	}

	public AnticodonLoopId(Integer anticodonLoopId, Integer featureId,
		...
		this.anticodonLoopId = anticodonLoopId;
	...
	public Integer getAnticodonLoopId() {
		return this.anticodonLoopId;
	}

	public void setAnticodonLoopId(Integer anticodonLoopId) {
		this.anticodonLoopId = anticodonLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnticodonLoopId))
			return false;
		AnticodonLoopId castOther = (AnticodonLoopId) other;

		return ((this.getAnticodonLoopId() == castOther.getAnticodonLoopId()) || (this
				.getAnticodonLoopId() != null
				&& castOther.getAnticodonLoopId() != null && this
				.getAnticodonLoopId().equals(castOther.getAnticodonLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAnticodonLoopId() == null ? 0 : this.getAnticodonLoopId()
						.hashCode());
		result = 37 * result
