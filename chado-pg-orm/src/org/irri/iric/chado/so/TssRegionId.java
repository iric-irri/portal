...
/**
 * TssRegionId generated by hbm2java
 */
public class TssRegionId implements java.io.Serializable {

	private Integer tssRegionId;
	...
	public TssRegionId(Integer tssRegionId, Integer featureId,
	...
	public Integer getTssRegionId() {
		return this.tssRegionId;
	}

	public void setTssRegionId(Integer tssRegionId) {
		this.tssRegionId = tssRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TssRegionId))
			return false;
		TssRegionId castOther = (TssRegionId) other;

		return ((this.getTssRegionId() == castOther.getTssRegionId()) || (this
				.getTssRegionId() != null && castOther.getTssRegionId() != null && this
				.getTssRegionId().equals(castOther.getTssRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTssRegionId() == null ? 0 : this.getTssRegionId()
						.hashCode());
		result = 37 * result
