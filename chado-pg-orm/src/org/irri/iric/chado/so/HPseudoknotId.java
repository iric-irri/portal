...
/**
 * HPseudoknotId generated by hbm2java
 */
public class HPseudoknotId implements java.io.Serializable {

	private Integer HPseudoknotId;
	...
	public HPseudoknotId() {
	}

	public HPseudoknotId(Integer HPseudoknotId, Integer featureId,
		...
		this.HPseudoknotId = HPseudoknotId;
	...
	public Integer getHPseudoknotId() {
		return this.HPseudoknotId;
	}

	public void setHPseudoknotId(Integer HPseudoknotId) {
		this.HPseudoknotId = HPseudoknotId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HPseudoknotId))
			return false;
		HPseudoknotId castOther = (HPseudoknotId) other;

		return ((this.getHPseudoknotId() == castOther.getHPseudoknotId()) || (this
				.getHPseudoknotId() != null
				&& castOther.getHPseudoknotId() != null && this
				.getHPseudoknotId().equals(castOther.getHPseudoknotId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHPseudoknotId() == null ? 0 : this.getHPseudoknotId()
						.hashCode());
		result = 37 * result
