...
/**
 * ImprintedId generated by hbm2java
 */
public class ImprintedId implements java.io.Serializable {

	private Integer imprintedId;
	...
	public ImprintedId(Integer imprintedId, Integer featureId,
	...
	public Integer getImprintedId() {
		return this.imprintedId;
	}

	public void setImprintedId(Integer imprintedId) {
		this.imprintedId = imprintedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ImprintedId))
			return false;
		ImprintedId castOther = (ImprintedId) other;

		return ((this.getImprintedId() == castOther.getImprintedId()) || (this
				.getImprintedId() != null && castOther.getImprintedId() != null && this
				.getImprintedId().equals(castOther.getImprintedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getImprintedId() == null ? 0 : this.getImprintedId()
						.hashCode());
		result = 37 * result
