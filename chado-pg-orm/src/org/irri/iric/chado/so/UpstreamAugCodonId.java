...
/**
 * UpstreamAugCodonId generated by hbm2java
 */
public class UpstreamAugCodonId implements java.io.Serializable {

	private Integer upstreamAugCodonId;
	...
	public UpstreamAugCodonId() {
	}

	public UpstreamAugCodonId(Integer upstreamAugCodonId, Integer featureId,
		...
		this.upstreamAugCodonId = upstreamAugCodonId;
	...
	public Integer getUpstreamAugCodonId() {
		return this.upstreamAugCodonId;
	}

	public void setUpstreamAugCodonId(Integer upstreamAugCodonId) {
		this.upstreamAugCodonId = upstreamAugCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UpstreamAugCodonId))
			return false;
		UpstreamAugCodonId castOther = (UpstreamAugCodonId) other;

		return ((this.getUpstreamAugCodonId() == castOther
				.getUpstreamAugCodonId()) || (this.getUpstreamAugCodonId() != null
				&& castOther.getUpstreamAugCodonId() != null && this
				.getUpstreamAugCodonId().equals(
						castOther.getUpstreamAugCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUpstreamAugCodonId() == null ? 0 : this
						.getUpstreamAugCodonId().hashCode());
		result = 37 * result
