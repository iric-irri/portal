...
/**
 * ProteinProteinContactId generated by hbm2java
 */
public class ProteinProteinContactId implements java.io.Serializable {

	private Integer proteinProteinContactId;
	...
	public ProteinProteinContactId() {
	}

	public ProteinProteinContactId(Integer proteinProteinContactId,
		...
		this.proteinProteinContactId = proteinProteinContactId;
	...
	public Integer getProteinProteinContactId() {
		return this.proteinProteinContactId;
	}

	public void setProteinProteinContactId(Integer proteinProteinContactId) {
		this.proteinProteinContactId = proteinProteinContactId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinProteinContactId))
			return false;
		ProteinProteinContactId castOther = (ProteinProteinContactId) other;

		return ((this.getProteinProteinContactId() == castOther
				.getProteinProteinContactId()) || (this
				.getProteinProteinContactId() != null
				&& castOther.getProteinProteinContactId() != null && this
				.getProteinProteinContactId().equals(
						castOther.getProteinProteinContactId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinProteinContactId() == null ? 0 : this
						.getProteinProteinContactId().hashCode());
		result = 37 * result
