...
/**
 * FivePrimeLtrComponentId generated by hbm2java
 */
public class FivePrimeLtrComponentId implements java.io.Serializable {

	private Integer fivePrimeLtrComponentId;
	...
	public FivePrimeLtrComponentId() {
	}

	public FivePrimeLtrComponentId(Integer fivePrimeLtrComponentId,
		...
		this.fivePrimeLtrComponentId = fivePrimeLtrComponentId;
	...
	public Integer getFivePrimeLtrComponentId() {
		return this.fivePrimeLtrComponentId;
	}

	public void setFivePrimeLtrComponentId(Integer fivePrimeLtrComponentId) {
		this.fivePrimeLtrComponentId = fivePrimeLtrComponentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeLtrComponentId))
			return false;
		FivePrimeLtrComponentId castOther = (FivePrimeLtrComponentId) other;

		return ((this.getFivePrimeLtrComponentId() == castOther
				.getFivePrimeLtrComponentId()) || (this
				.getFivePrimeLtrComponentId() != null
				&& castOther.getFivePrimeLtrComponentId() != null && this
				.getFivePrimeLtrComponentId().equals(
						castOther.getFivePrimeLtrComponentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeLtrComponentId() == null ? 0 : this
						.getFivePrimeLtrComponentId().hashCode());
		result = 37 * result
