...
/**
 * IsoleucineId generated by hbm2java
 */
public class IsoleucineId implements java.io.Serializable {

	private Integer isoleucineId;
	...
	public IsoleucineId(Integer isoleucineId, Integer featureId,
		...
		this.isoleucineId = isoleucineId;
	...
	public Integer getIsoleucineId() {
		return this.isoleucineId;
	}

	public void setIsoleucineId(Integer isoleucineId) {
		this.isoleucineId = isoleucineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IsoleucineId))
			return false;
		IsoleucineId castOther = (IsoleucineId) other;

		return ((this.getIsoleucineId() == castOther.getIsoleucineId()) || (this
				.getIsoleucineId() != null
				&& castOther.getIsoleucineId() != null && this
				.getIsoleucineId().equals(castOther.getIsoleucineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIsoleucineId() == null ? 0 : this.getIsoleucineId()
						.hashCode());
		result = 37 * result
