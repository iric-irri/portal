...
/**
 * MonocistronicId generated by hbm2java
 */
public class MonocistronicId implements java.io.Serializable {

	private Integer monocistronicId;
	...
	public MonocistronicId() {
	}

	public MonocistronicId(Integer monocistronicId, Integer featureId,
		...
		this.monocistronicId = monocistronicId;
	...
	public Integer getMonocistronicId() {
		return this.monocistronicId;
	}

	public void setMonocistronicId(Integer monocistronicId) {
		this.monocistronicId = monocistronicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MonocistronicId))
			return false;
		MonocistronicId castOther = (MonocistronicId) other;

		return ((this.getMonocistronicId() == castOther.getMonocistronicId()) || (this
				.getMonocistronicId() != null
				&& castOther.getMonocistronicId() != null && this
				.getMonocistronicId().equals(castOther.getMonocistronicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMonocistronicId() == null ? 0 : this.getMonocistronicId()
						.hashCode());
		result = 37 * result
