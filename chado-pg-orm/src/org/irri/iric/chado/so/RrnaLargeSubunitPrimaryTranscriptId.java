...
/**
 * RrnaLargeSubunitPrimaryTranscriptId generated by hbm2java
 */
public class RrnaLargeSubunitPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer rrnaLargeSubunitPrimaryTranscriptId;
	...
	public RrnaLargeSubunitPrimaryTranscriptId() {
	}

	public RrnaLargeSubunitPrimaryTranscriptId(
			Integer rrnaLargeSubunitPrimaryTranscriptId, Integer featureId,
		...
		this.rrnaLargeSubunitPrimaryTranscriptId = rrnaLargeSubunitPrimaryTranscriptId;
	...
	public Integer getRrnaLargeSubunitPrimaryTranscriptId() {
		return this.rrnaLargeSubunitPrimaryTranscriptId;
	}

	public void setRrnaLargeSubunitPrimaryTranscriptId(
			Integer rrnaLargeSubunitPrimaryTranscriptId) {
		this.rrnaLargeSubunitPrimaryTranscriptId = rrnaLargeSubunitPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaLargeSubunitPrimaryTranscriptId))
			return false;
		RrnaLargeSubunitPrimaryTranscriptId castOther = (RrnaLargeSubunitPrimaryTranscriptId) other;

		return ((this.getRrnaLargeSubunitPrimaryTranscriptId() == castOther
				.getRrnaLargeSubunitPrimaryTranscriptId()) || (this
				.getRrnaLargeSubunitPrimaryTranscriptId() != null
				&& castOther.getRrnaLargeSubunitPrimaryTranscriptId() != null && this
				.getRrnaLargeSubunitPrimaryTranscriptId().equals(
						castOther.getRrnaLargeSubunitPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaLargeSubunitPrimaryTranscriptId() == null ? 0 : this
						.getRrnaLargeSubunitPrimaryTranscriptId().hashCode());
		result = 37 * result
