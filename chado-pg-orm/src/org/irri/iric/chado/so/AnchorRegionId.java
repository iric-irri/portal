...
/**
 * AnchorRegionId generated by hbm2java
 */
public class AnchorRegionId implements java.io.Serializable {

	private Integer anchorRegionId;
	...
	public AnchorRegionId() {
	}

	public AnchorRegionId(Integer anchorRegionId, Integer featureId,
	...
	public Integer getAnchorRegionId() {
		return this.anchorRegionId;
	}

	public void setAnchorRegionId(Integer anchorRegionId) {
		this.anchorRegionId = anchorRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnchorRegionId))
			return false;
		AnchorRegionId castOther = (AnchorRegionId) other;

		return ((this.getAnchorRegionId() == castOther.getAnchorRegionId()) || (this
				.getAnchorRegionId() != null
				&& castOther.getAnchorRegionId() != null && this
				.getAnchorRegionId().equals(castOther.getAnchorRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAnchorRegionId() == null ? 0 : this.getAnchorRegionId()
						.hashCode());
		result = 37 * result
