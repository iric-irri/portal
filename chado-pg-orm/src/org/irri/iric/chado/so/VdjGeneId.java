...
/**
 * VdjGeneId generated by hbm2java
 */
public class VdjGeneId implements java.io.Serializable {

	private Integer vdjGeneId;
	...
	public VdjGeneId(Integer vdjGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getVdjGeneId() {
		return this.vdjGeneId;
	}

	public void setVdjGeneId(Integer vdjGeneId) {
		this.vdjGeneId = vdjGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VdjGeneId))
			return false;
		VdjGeneId castOther = (VdjGeneId) other;

		return ((this.getVdjGeneId() == castOther.getVdjGeneId()) || (this
				.getVdjGeneId() != null && castOther.getVdjGeneId() != null && this
				.getVdjGeneId().equals(castOther.getVdjGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVdjGeneId() == null ? 0 : this.getVdjGeneId().hashCode());
		result = 37 * result
