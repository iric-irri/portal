...
/**
 * BrunoResponseElementId generated by hbm2java
 */
public class BrunoResponseElementId implements java.io.Serializable {

	private Integer brunoResponseElementId;
	...
	public BrunoResponseElementId() {
	}

	public BrunoResponseElementId(Integer brunoResponseElementId,
		...
		this.brunoResponseElementId = brunoResponseElementId;
	...
	public Integer getBrunoResponseElementId() {
		return this.brunoResponseElementId;
	}

	public void setBrunoResponseElementId(Integer brunoResponseElementId) {
		this.brunoResponseElementId = brunoResponseElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BrunoResponseElementId))
			return false;
		BrunoResponseElementId castOther = (BrunoResponseElementId) other;

		return ((this.getBrunoResponseElementId() == castOther
				.getBrunoResponseElementId()) || (this
				.getBrunoResponseElementId() != null
				&& castOther.getBrunoResponseElementId() != null && this
				.getBrunoResponseElementId().equals(
						castOther.getBrunoResponseElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBrunoResponseElementId() == null ? 0 : this
						.getBrunoResponseElementId().hashCode());
		result = 37 * result
