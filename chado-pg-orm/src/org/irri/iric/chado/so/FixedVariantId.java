...
/**
 * FixedVariantId generated by hbm2java
 */
public class FixedVariantId implements java.io.Serializable {

	private Integer fixedVariantId;
	...
	public FixedVariantId() {
	}

	public FixedVariantId(Integer fixedVariantId, Integer featureId,
		...
		this.fixedVariantId = fixedVariantId;
	...
	public Integer getFixedVariantId() {
		return this.fixedVariantId;
	}

	public void setFixedVariantId(Integer fixedVariantId) {
		this.fixedVariantId = fixedVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FixedVariantId))
			return false;
		FixedVariantId castOther = (FixedVariantId) other;

		return ((this.getFixedVariantId() == castOther.getFixedVariantId()) || (this
				.getFixedVariantId() != null
				&& castOther.getFixedVariantId() != null && this
				.getFixedVariantId().equals(castOther.getFixedVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFixedVariantId() == null ? 0 : this.getFixedVariantId()
						.hashCode());
		result = 37 * result
