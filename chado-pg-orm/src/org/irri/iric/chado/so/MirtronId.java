...
/**
 * MirtronId generated by hbm2java
 */
public class MirtronId implements java.io.Serializable {

	private Integer mirtronId;
	...
	public MirtronId(Integer mirtronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMirtronId() {
		return this.mirtronId;
	}

	public void setMirtronId(Integer mirtronId) {
		this.mirtronId = mirtronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirtronId))
			return false;
		MirtronId castOther = (MirtronId) other;

		return ((this.getMirtronId() == castOther.getMirtronId()) || (this
				.getMirtronId() != null && castOther.getMirtronId() != null && this
				.getMirtronId().equals(castOther.getMirtronId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMirtronId() == null ? 0 : this.getMirtronId().hashCode());
		result = 37 * result
