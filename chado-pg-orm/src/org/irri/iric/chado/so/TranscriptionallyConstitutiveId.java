...
/**
 * TranscriptionallyConstitutiveId generated by hbm2java
 */
public class TranscriptionallyConstitutiveId implements java.io.Serializable {

	private Integer transcriptionallyConstitutiveId;
	...
	public TranscriptionallyConstitutiveId() {
	}

	public TranscriptionallyConstitutiveId(
			Integer transcriptionallyConstitutiveId, Integer featureId,
		...
		this.transcriptionallyConstitutiveId = transcriptionallyConstitutiveId;
	...
	public Integer getTranscriptionallyConstitutiveId() {
		return this.transcriptionallyConstitutiveId;
	}

	public void setTranscriptionallyConstitutiveId(
			Integer transcriptionallyConstitutiveId) {
		this.transcriptionallyConstitutiveId = transcriptionallyConstitutiveId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionallyConstitutiveId))
			return false;
		TranscriptionallyConstitutiveId castOther = (TranscriptionallyConstitutiveId) other;

		return ((this.getTranscriptionallyConstitutiveId() == castOther
				.getTranscriptionallyConstitutiveId()) || (this
				.getTranscriptionallyConstitutiveId() != null
				&& castOther.getTranscriptionallyConstitutiveId() != null && this
				.getTranscriptionallyConstitutiveId().equals(
						castOther.getTranscriptionallyConstitutiveId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionallyConstitutiveId() == null ? 0 : this
						.getTranscriptionallyConstitutiveId().hashCode());
		result = 37 * result
