...
/**
 * TerminalInvertedRepeatId generated by hbm2java
 */
public class TerminalInvertedRepeatId implements java.io.Serializable {

	private Integer terminalInvertedRepeatId;
	...
	public TerminalInvertedRepeatId() {
	}

	public TerminalInvertedRepeatId(Integer terminalInvertedRepeatId,
		...
		this.terminalInvertedRepeatId = terminalInvertedRepeatId;
	...
	public Integer getTerminalInvertedRepeatId() {
		return this.terminalInvertedRepeatId;
	}

	public void setTerminalInvertedRepeatId(Integer terminalInvertedRepeatId) {
		this.terminalInvertedRepeatId = terminalInvertedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminalInvertedRepeatId))
			return false;
		TerminalInvertedRepeatId castOther = (TerminalInvertedRepeatId) other;

		return ((this.getTerminalInvertedRepeatId() == castOther
				.getTerminalInvertedRepeatId()) || (this
				.getTerminalInvertedRepeatId() != null
				&& castOther.getTerminalInvertedRepeatId() != null && this
				.getTerminalInvertedRepeatId().equals(
						castOther.getTerminalInvertedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminalInvertedRepeatId() == null ? 0 : this
						.getTerminalInvertedRepeatId().hashCode());
		result = 37 * result
