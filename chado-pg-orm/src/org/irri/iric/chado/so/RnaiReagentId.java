...
/**
 * RnaiReagentId generated by hbm2java
 */
public class RnaiReagentId implements java.io.Serializable {

	private Integer rnaiReagentId;
	...
	public RnaiReagentId() {
	}

	public RnaiReagentId(Integer rnaiReagentId, Integer featureId,
		...
		this.rnaiReagentId = rnaiReagentId;
	...
	public Integer getRnaiReagentId() {
		return this.rnaiReagentId;
	}

	public void setRnaiReagentId(Integer rnaiReagentId) {
		this.rnaiReagentId = rnaiReagentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaiReagentId))
			return false;
		RnaiReagentId castOther = (RnaiReagentId) other;

		return ((this.getRnaiReagentId() == castOther.getRnaiReagentId()) || (this
				.getRnaiReagentId() != null
				&& castOther.getRnaiReagentId() != null && this
				.getRnaiReagentId().equals(castOther.getRnaiReagentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaiReagentId() == null ? 0 : this.getRnaiReagentId()
						.hashCode());
		result = 37 * result
