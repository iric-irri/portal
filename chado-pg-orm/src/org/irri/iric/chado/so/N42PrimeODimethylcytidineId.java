...
/**
 * N42PrimeODimethylcytidineId generated by hbm2java
 */
public class N42PrimeODimethylcytidineId implements java.io.Serializable {

	private Integer n42PrimeODimethylcytidineId;
	...
	public N42PrimeODimethylcytidineId() {
	}

	public N42PrimeODimethylcytidineId(Integer n42PrimeODimethylcytidineId,
		...
		this.n42PrimeODimethylcytidineId = n42PrimeODimethylcytidineId;
	...
	public Integer getN42PrimeODimethylcytidineId() {
		return this.n42PrimeODimethylcytidineId;
	}

	public void setN42PrimeODimethylcytidineId(
			Integer n42PrimeODimethylcytidineId) {
		this.n42PrimeODimethylcytidineId = n42PrimeODimethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N42PrimeODimethylcytidineId))
			return false;
		N42PrimeODimethylcytidineId castOther = (N42PrimeODimethylcytidineId) other;

		return ((this.getN42PrimeODimethylcytidineId() == castOther
				.getN42PrimeODimethylcytidineId()) || (this
				.getN42PrimeODimethylcytidineId() != null
				&& castOther.getN42PrimeODimethylcytidineId() != null && this
				.getN42PrimeODimethylcytidineId().equals(
						castOther.getN42PrimeODimethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN42PrimeODimethylcytidineId() == null ? 0 : this
						.getN42PrimeODimethylcytidineId().hashCode());
		result = 37 * result
