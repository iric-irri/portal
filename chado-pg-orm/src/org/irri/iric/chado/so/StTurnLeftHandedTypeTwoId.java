...
/**
 * StTurnLeftHandedTypeTwoId generated by hbm2java
 */
public class StTurnLeftHandedTypeTwoId implements java.io.Serializable {

	private Integer stTurnLeftHandedTypeTwoId;
	...
	public StTurnLeftHandedTypeTwoId() {
	}

	public StTurnLeftHandedTypeTwoId(Integer stTurnLeftHandedTypeTwoId,
		...
		this.stTurnLeftHandedTypeTwoId = stTurnLeftHandedTypeTwoId;
	...
	public Integer getStTurnLeftHandedTypeTwoId() {
		return this.stTurnLeftHandedTypeTwoId;
	}

	public void setStTurnLeftHandedTypeTwoId(Integer stTurnLeftHandedTypeTwoId) {
		this.stTurnLeftHandedTypeTwoId = stTurnLeftHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StTurnLeftHandedTypeTwoId))
			return false;
		StTurnLeftHandedTypeTwoId castOther = (StTurnLeftHandedTypeTwoId) other;

		return ((this.getStTurnLeftHandedTypeTwoId() == castOther
				.getStTurnLeftHandedTypeTwoId()) || (this
				.getStTurnLeftHandedTypeTwoId() != null
				&& castOther.getStTurnLeftHandedTypeTwoId() != null && this
				.getStTurnLeftHandedTypeTwoId().equals(
						castOther.getStTurnLeftHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStTurnLeftHandedTypeTwoId() == null ? 0 : this
						.getStTurnLeftHandedTypeTwoId().hashCode());
		result = 37 * result
