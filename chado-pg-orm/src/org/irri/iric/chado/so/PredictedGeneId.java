...
/**
 * PredictedGeneId generated by hbm2java
 */
public class PredictedGeneId implements java.io.Serializable {

	private Integer predictedGeneId;
	...
	public PredictedGeneId() {
	}

	public PredictedGeneId(Integer predictedGeneId, Integer featureId,
		...
		this.predictedGeneId = predictedGeneId;
	...
	public Integer getPredictedGeneId() {
		return this.predictedGeneId;
	}

	public void setPredictedGeneId(Integer predictedGeneId) {
		this.predictedGeneId = predictedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PredictedGeneId))
			return false;
		PredictedGeneId castOther = (PredictedGeneId) other;

		return ((this.getPredictedGeneId() == castOther.getPredictedGeneId()) || (this
				.getPredictedGeneId() != null
				&& castOther.getPredictedGeneId() != null && this
				.getPredictedGeneId().equals(castOther.getPredictedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPredictedGeneId() == null ? 0 : this.getPredictedGeneId()
						.hashCode());
		result = 37 * result
