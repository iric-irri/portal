...
/**
 * ChromosomalInversionId generated by hbm2java
 */
public class ChromosomalInversionId implements java.io.Serializable {

	private Integer chromosomalInversionId;
	...
	public ChromosomalInversionId() {
	}

	public ChromosomalInversionId(Integer chromosomalInversionId,
		...
		this.chromosomalInversionId = chromosomalInversionId;
	...
	public Integer getChromosomalInversionId() {
		return this.chromosomalInversionId;
	}

	public void setChromosomalInversionId(Integer chromosomalInversionId) {
		this.chromosomalInversionId = chromosomalInversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalInversionId))
			return false;
		ChromosomalInversionId castOther = (ChromosomalInversionId) other;

		return ((this.getChromosomalInversionId() == castOther
				.getChromosomalInversionId()) || (this
				.getChromosomalInversionId() != null
				&& castOther.getChromosomalInversionId() != null && this
				.getChromosomalInversionId().equals(
						castOther.getChromosomalInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalInversionId() == null ? 0 : this
						.getChromosomalInversionId().hashCode());
		result = 37 * result
