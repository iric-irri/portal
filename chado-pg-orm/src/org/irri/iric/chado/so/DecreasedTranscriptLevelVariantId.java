...
/**
 * DecreasedTranscriptLevelVariantId generated by hbm2java
 */
public class DecreasedTranscriptLevelVariantId implements java.io.Serializable {

	private Integer decreasedTranscriptLevelVariantId;
	...
	public DecreasedTranscriptLevelVariantId() {
	}

	public DecreasedTranscriptLevelVariantId(
			Integer decreasedTranscriptLevelVariantId, Integer featureId,
		...
		this.decreasedTranscriptLevelVariantId = decreasedTranscriptLevelVariantId;
	...
	public Integer getDecreasedTranscriptLevelVariantId() {
		return this.decreasedTranscriptLevelVariantId;
	}

	public void setDecreasedTranscriptLevelVariantId(
			Integer decreasedTranscriptLevelVariantId) {
		this.decreasedTranscriptLevelVariantId = decreasedTranscriptLevelVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DecreasedTranscriptLevelVariantId))
			return false;
		DecreasedTranscriptLevelVariantId castOther = (DecreasedTranscriptLevelVariantId) other;

		return ((this.getDecreasedTranscriptLevelVariantId() == castOther
				.getDecreasedTranscriptLevelVariantId()) || (this
				.getDecreasedTranscriptLevelVariantId() != null
				&& castOther.getDecreasedTranscriptLevelVariantId() != null && this
				.getDecreasedTranscriptLevelVariantId().equals(
						castOther.getDecreasedTranscriptLevelVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDecreasedTranscriptLevelVariantId() == null ? 0 : this
						.getDecreasedTranscriptLevelVariantId().hashCode());
		result = 37 * result
