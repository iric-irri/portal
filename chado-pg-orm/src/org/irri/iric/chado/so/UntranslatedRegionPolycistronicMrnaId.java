...
/**
 * UntranslatedRegionPolycistronicMrnaId generated by hbm2java
 */
public class UntranslatedRegionPolycistronicMrnaId implements
		java.io.Serializable {

	private Integer untranslatedRegionPolycistronicMrnaId;
	...
	public UntranslatedRegionPolycistronicMrnaId() {
	}

	public UntranslatedRegionPolycistronicMrnaId(
			Integer untranslatedRegionPolycistronicMrnaId, Integer featureId,
		...
		this.untranslatedRegionPolycistronicMrnaId = untranslatedRegionPolycistronicMrnaId;
	...
	public Integer getUntranslatedRegionPolycistronicMrnaId() {
		return this.untranslatedRegionPolycistronicMrnaId;
	}

	public void setUntranslatedRegionPolycistronicMrnaId(
			Integer untranslatedRegionPolycistronicMrnaId) {
		this.untranslatedRegionPolycistronicMrnaId = untranslatedRegionPolycistronicMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UntranslatedRegionPolycistronicMrnaId))
			return false;
		UntranslatedRegionPolycistronicMrnaId castOther = (UntranslatedRegionPolycistronicMrnaId) other;

		return ((this.getUntranslatedRegionPolycistronicMrnaId() == castOther
				.getUntranslatedRegionPolycistronicMrnaId()) || (this
				.getUntranslatedRegionPolycistronicMrnaId() != null
				&& castOther.getUntranslatedRegionPolycistronicMrnaId() != null && this
				.getUntranslatedRegionPolycistronicMrnaId().equals(
						castOther.getUntranslatedRegionPolycistronicMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUntranslatedRegionPolycistronicMrnaId() == null ? 0
						: this.getUntranslatedRegionPolycistronicMrnaId()
								.hashCode());
		result = 37 * result
