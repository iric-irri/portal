...
/**
 * ScrnaPrimaryTranscriptId generated by hbm2java
 */
public class ScrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer scrnaPrimaryTranscriptId;
	...
	public ScrnaPrimaryTranscriptId() {
	}

	public ScrnaPrimaryTranscriptId(Integer scrnaPrimaryTranscriptId,
		...
		this.scrnaPrimaryTranscriptId = scrnaPrimaryTranscriptId;
	...
	public Integer getScrnaPrimaryTranscriptId() {
		return this.scrnaPrimaryTranscriptId;
	}

	public void setScrnaPrimaryTranscriptId(Integer scrnaPrimaryTranscriptId) {
		this.scrnaPrimaryTranscriptId = scrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ScrnaPrimaryTranscriptId))
			return false;
		ScrnaPrimaryTranscriptId castOther = (ScrnaPrimaryTranscriptId) other;

		return ((this.getScrnaPrimaryTranscriptId() == castOther
				.getScrnaPrimaryTranscriptId()) || (this
				.getScrnaPrimaryTranscriptId() != null
				&& castOther.getScrnaPrimaryTranscriptId() != null && this
				.getScrnaPrimaryTranscriptId().equals(
						castOther.getScrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getScrnaPrimaryTranscriptId() == null ? 0 : this
						.getScrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
