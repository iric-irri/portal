...
/**
 * AsxTurnRightHandedTypeOneId generated by hbm2java
 */
public class AsxTurnRightHandedTypeOneId implements java.io.Serializable {

	private Integer asxTurnRightHandedTypeOneId;
	...
	public AsxTurnRightHandedTypeOneId() {
	}

	public AsxTurnRightHandedTypeOneId(Integer asxTurnRightHandedTypeOneId,
		...
		this.asxTurnRightHandedTypeOneId = asxTurnRightHandedTypeOneId;
	...
	public Integer getAsxTurnRightHandedTypeOneId() {
		return this.asxTurnRightHandedTypeOneId;
	}

	public void setAsxTurnRightHandedTypeOneId(
			Integer asxTurnRightHandedTypeOneId) {
		this.asxTurnRightHandedTypeOneId = asxTurnRightHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsxTurnRightHandedTypeOneId))
			return false;
		AsxTurnRightHandedTypeOneId castOther = (AsxTurnRightHandedTypeOneId) other;

		return ((this.getAsxTurnRightHandedTypeOneId() == castOther
				.getAsxTurnRightHandedTypeOneId()) || (this
				.getAsxTurnRightHandedTypeOneId() != null
				&& castOther.getAsxTurnRightHandedTypeOneId() != null && this
				.getAsxTurnRightHandedTypeOneId().equals(
						castOther.getAsxTurnRightHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsxTurnRightHandedTypeOneId() == null ? 0 : this
						.getAsxTurnRightHandedTypeOneId().hashCode());
		result = 37 * result
