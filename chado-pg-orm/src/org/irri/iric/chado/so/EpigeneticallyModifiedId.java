...
/**
 * EpigeneticallyModifiedId generated by hbm2java
 */
public class EpigeneticallyModifiedId implements java.io.Serializable {

	private Integer epigeneticallyModifiedId;
	...
	public EpigeneticallyModifiedId() {
	}

	public EpigeneticallyModifiedId(Integer epigeneticallyModifiedId,
		...
		this.epigeneticallyModifiedId = epigeneticallyModifiedId;
	...
	public Integer getEpigeneticallyModifiedId() {
		return this.epigeneticallyModifiedId;
	}

	public void setEpigeneticallyModifiedId(Integer epigeneticallyModifiedId) {
		this.epigeneticallyModifiedId = epigeneticallyModifiedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpigeneticallyModifiedId))
			return false;
		EpigeneticallyModifiedId castOther = (EpigeneticallyModifiedId) other;

		return ((this.getEpigeneticallyModifiedId() == castOther
				.getEpigeneticallyModifiedId()) || (this
				.getEpigeneticallyModifiedId() != null
				&& castOther.getEpigeneticallyModifiedId() != null && this
				.getEpigeneticallyModifiedId().equals(
						castOther.getEpigeneticallyModifiedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEpigeneticallyModifiedId() == null ? 0 : this
						.getEpigeneticallyModifiedId().hashCode());
		result = 37 * result
