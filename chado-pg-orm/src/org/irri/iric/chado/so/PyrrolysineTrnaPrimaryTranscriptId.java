...
/**
 * PyrrolysineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class PyrrolysineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer pyrrolysineTrnaPrimaryTranscriptId;
	...
	public PyrrolysineTrnaPrimaryTranscriptId() {
	}

	public PyrrolysineTrnaPrimaryTranscriptId(
			Integer pyrrolysineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.pyrrolysineTrnaPrimaryTranscriptId = pyrrolysineTrnaPrimaryTranscriptId;
	...
	public Integer getPyrrolysineTrnaPrimaryTranscriptId() {
		return this.pyrrolysineTrnaPrimaryTranscriptId;
	}

	public void setPyrrolysineTrnaPrimaryTranscriptId(
			Integer pyrrolysineTrnaPrimaryTranscriptId) {
		this.pyrrolysineTrnaPrimaryTranscriptId = pyrrolysineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrrolysineTrnaPrimaryTranscriptId))
			return false;
		PyrrolysineTrnaPrimaryTranscriptId castOther = (PyrrolysineTrnaPrimaryTranscriptId) other;

		return ((this.getPyrrolysineTrnaPrimaryTranscriptId() == castOther
				.getPyrrolysineTrnaPrimaryTranscriptId()) || (this
				.getPyrrolysineTrnaPrimaryTranscriptId() != null
				&& castOther.getPyrrolysineTrnaPrimaryTranscriptId() != null && this
				.getPyrrolysineTrnaPrimaryTranscriptId().equals(
						castOther.getPyrrolysineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrrolysineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getPyrrolysineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
