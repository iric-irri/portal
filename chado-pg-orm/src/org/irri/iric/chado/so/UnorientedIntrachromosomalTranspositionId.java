...
/**
 * UnorientedIntrachromosomalTranspositionId generated by hbm2java
 */
public class UnorientedIntrachromosomalTranspositionId implements
		java.io.Serializable {

	private Integer unorientedIntrachromosomalTranspositionId;
	...
	public UnorientedIntrachromosomalTranspositionId() {
	}

	public UnorientedIntrachromosomalTranspositionId(
			Integer unorientedIntrachromosomalTranspositionId,
		...
		this.unorientedIntrachromosomalTranspositionId = unorientedIntrachromosomalTranspositionId;
	...
	public Integer getUnorientedIntrachromosomalTranspositionId() {
		return this.unorientedIntrachromosomalTranspositionId;
	}

	public void setUnorientedIntrachromosomalTranspositionId(
			Integer unorientedIntrachromosomalTranspositionId) {
		this.unorientedIntrachromosomalTranspositionId = unorientedIntrachromosomalTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnorientedIntrachromosomalTranspositionId))
			return false;
		UnorientedIntrachromosomalTranspositionId castOther = (UnorientedIntrachromosomalTranspositionId) other;

		return ((this.getUnorientedIntrachromosomalTranspositionId() == castOther
				.getUnorientedIntrachromosomalTranspositionId()) || (this
				.getUnorientedIntrachromosomalTranspositionId() != null
				&& castOther.getUnorientedIntrachromosomalTranspositionId() != null && this
				.getUnorientedIntrachromosomalTranspositionId()
				.equals(castOther
						.getUnorientedIntrachromosomalTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUnorientedIntrachromosomalTranspositionId() == null ? 0
						: this.getUnorientedIntrachromosomalTranspositionId()
								.hashCode());
		result = 37 * result
