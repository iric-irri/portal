...
/**
 * RegionalCentromereId generated by hbm2java
 */
public class RegionalCentromereId implements java.io.Serializable {

	private Integer regionalCentromereId;
	...
	public RegionalCentromereId() {
	}

	public RegionalCentromereId(Integer regionalCentromereId,
		...
		this.regionalCentromereId = regionalCentromereId;
	...
	public Integer getRegionalCentromereId() {
		return this.regionalCentromereId;
	}

	public void setRegionalCentromereId(Integer regionalCentromereId) {
		this.regionalCentromereId = regionalCentromereId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegionalCentromereId))
			return false;
		RegionalCentromereId castOther = (RegionalCentromereId) other;

		return ((this.getRegionalCentromereId() == castOther
				.getRegionalCentromereId()) || (this.getRegionalCentromereId() != null
				&& castOther.getRegionalCentromereId() != null && this
				.getRegionalCentromereId().equals(
						castOther.getRegionalCentromereId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegionalCentromereId() == null ? 0 : this
						.getRegionalCentromereId().hashCode());
		result = 37 * result
