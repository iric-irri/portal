 ...
 * @see org.irri.iric.chado.so.RepeatUnit
...
public class RepeatUnitHome {
	...
	public RepeatUnit findById(org.irri.iric.chado.so.RepeatUnitId id) {
		log.debug("getting RepeatUnit instance with id: " + id);
		try {
			RepeatUnit instance = (RepeatUnit) sessionFactory
					.getCurrentSession().get(
							"org.irri.iric.chado.so.RepeatUnit", id);
			if (instance == null) {
	...
	public List findByExample(RepeatUnit instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.RepeatUnit")
