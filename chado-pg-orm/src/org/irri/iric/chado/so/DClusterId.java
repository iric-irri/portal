...
/**
 * DClusterId generated by hbm2java
 */
public class DClusterId implements java.io.Serializable {

	private Integer DClusterId;
	...
	public DClusterId(Integer DClusterId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDClusterId() {
		return this.DClusterId;
	}

	public void setDClusterId(Integer DClusterId) {
		this.DClusterId = DClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DClusterId))
			return false;
		DClusterId castOther = (DClusterId) other;

		return ((this.getDClusterId() == castOther.getDClusterId()) || (this
				.getDClusterId() != null && castOther.getDClusterId() != null && this
				.getDClusterId().equals(castOther.getDClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDClusterId() == null ? 0 : this.getDClusterId()
						.hashCode());
		result = 37 * result
