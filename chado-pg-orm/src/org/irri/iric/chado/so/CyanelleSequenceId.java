...
/**
 * CyanelleSequenceId generated by hbm2java
 */
public class CyanelleSequenceId implements java.io.Serializable {

	private Integer cyanelleSequenceId;
	...
	public CyanelleSequenceId() {
	}

	public CyanelleSequenceId(Integer cyanelleSequenceId, Integer featureId,
		...
		this.cyanelleSequenceId = cyanelleSequenceId;
	...
	public Integer getCyanelleSequenceId() {
		return this.cyanelleSequenceId;
	}

	public void setCyanelleSequenceId(Integer cyanelleSequenceId) {
		this.cyanelleSequenceId = cyanelleSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CyanelleSequenceId))
			return false;
		CyanelleSequenceId castOther = (CyanelleSequenceId) other;

		return ((this.getCyanelleSequenceId() == castOther
				.getCyanelleSequenceId()) || (this.getCyanelleSequenceId() != null
				&& castOther.getCyanelleSequenceId() != null && this
				.getCyanelleSequenceId().equals(
						castOther.getCyanelleSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCyanelleSequenceId() == null ? 0 : this
						.getCyanelleSequenceId().hashCode());
		result = 37 * result
