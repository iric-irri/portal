...
/**
 * GlutamineId generated by hbm2java
 */
public class GlutamineId implements java.io.Serializable {

	private Integer glutamineId;
	...
	public GlutamineId(Integer glutamineId, Integer featureId,
	...
	public Integer getGlutamineId() {
		return this.glutamineId;
	}

	public void setGlutamineId(Integer glutamineId) {
		this.glutamineId = glutamineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutamineId))
			return false;
		GlutamineId castOther = (GlutamineId) other;

		return ((this.getGlutamineId() == castOther.getGlutamineId()) || (this
				.getGlutamineId() != null && castOther.getGlutamineId() != null && this
				.getGlutamineId().equals(castOther.getGlutamineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutamineId() == null ? 0 : this.getGlutamineId()
						.hashCode());
		result = 37 * result
