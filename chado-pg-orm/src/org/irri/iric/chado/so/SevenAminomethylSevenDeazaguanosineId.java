...
/**
 * SevenAminomethylSevenDeazaguanosineId generated by hbm2java
 */
public class SevenAminomethylSevenDeazaguanosineId implements
		java.io.Serializable {

	private Integer sevenAminomethylSevenDeazaguanosineId;
	...
	public SevenAminomethylSevenDeazaguanosineId() {
	}

	public SevenAminomethylSevenDeazaguanosineId(
			Integer sevenAminomethylSevenDeazaguanosineId, Integer featureId,
		...
		this.sevenAminomethylSevenDeazaguanosineId = sevenAminomethylSevenDeazaguanosineId;
	...
	public Integer getSevenAminomethylSevenDeazaguanosineId() {
		return this.sevenAminomethylSevenDeazaguanosineId;
	}

	public void setSevenAminomethylSevenDeazaguanosineId(
			Integer sevenAminomethylSevenDeazaguanosineId) {
		this.sevenAminomethylSevenDeazaguanosineId = sevenAminomethylSevenDeazaguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SevenAminomethylSevenDeazaguanosineId))
			return false;
		SevenAminomethylSevenDeazaguanosineId castOther = (SevenAminomethylSevenDeazaguanosineId) other;

		return ((this.getSevenAminomethylSevenDeazaguanosineId() == castOther
				.getSevenAminomethylSevenDeazaguanosineId()) || (this
				.getSevenAminomethylSevenDeazaguanosineId() != null
				&& castOther.getSevenAminomethylSevenDeazaguanosineId() != null && this
				.getSevenAminomethylSevenDeazaguanosineId().equals(
						castOther.getSevenAminomethylSevenDeazaguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSevenAminomethylSevenDeazaguanosineId() == null ? 0
						: this.getSevenAminomethylSevenDeazaguanosineId()
								.hashCode());
		result = 37 * result
