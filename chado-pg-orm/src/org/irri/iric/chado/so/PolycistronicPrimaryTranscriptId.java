...
/**
 * PolycistronicPrimaryTranscriptId generated by hbm2java
 */
public class PolycistronicPrimaryTranscriptId implements java.io.Serializable {

	private Integer polycistronicPrimaryTranscriptId;
	...
	public PolycistronicPrimaryTranscriptId() {
	}

	public PolycistronicPrimaryTranscriptId(
			Integer polycistronicPrimaryTranscriptId, Integer featureId,
		...
		this.polycistronicPrimaryTranscriptId = polycistronicPrimaryTranscriptId;
	...
	public Integer getPolycistronicPrimaryTranscriptId() {
		return this.polycistronicPrimaryTranscriptId;
	}

	public void setPolycistronicPrimaryTranscriptId(
			Integer polycistronicPrimaryTranscriptId) {
		this.polycistronicPrimaryTranscriptId = polycistronicPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolycistronicPrimaryTranscriptId))
			return false;
		PolycistronicPrimaryTranscriptId castOther = (PolycistronicPrimaryTranscriptId) other;

		return ((this.getPolycistronicPrimaryTranscriptId() == castOther
				.getPolycistronicPrimaryTranscriptId()) || (this
				.getPolycistronicPrimaryTranscriptId() != null
				&& castOther.getPolycistronicPrimaryTranscriptId() != null && this
				.getPolycistronicPrimaryTranscriptId().equals(
						castOther.getPolycistronicPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolycistronicPrimaryTranscriptId() == null ? 0 : this
						.getPolycistronicPrimaryTranscriptId().hashCode());
		result = 37 * result
