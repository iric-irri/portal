...
/**
 * BluntEndRestrictionEnzymeCleavageJunctionId generated by hbm2java
 */
public class BluntEndRestrictionEnzymeCleavageJunctionId implements
		java.io.Serializable {

	private Integer bluntEndRestrictionEnzymeCleavageJunctionId;
	...
	public BluntEndRestrictionEnzymeCleavageJunctionId() {
	}

	public BluntEndRestrictionEnzymeCleavageJunctionId(
			Integer bluntEndRestrictionEnzymeCleavageJunctionId,
		...
		this.bluntEndRestrictionEnzymeCleavageJunctionId = bluntEndRestrictionEnzymeCleavageJunctionId;
	...
	public Integer getBluntEndRestrictionEnzymeCleavageJunctionId() {
		return this.bluntEndRestrictionEnzymeCleavageJunctionId;
	}

	public void setBluntEndRestrictionEnzymeCleavageJunctionId(
			Integer bluntEndRestrictionEnzymeCleavageJunctionId) {
		this.bluntEndRestrictionEnzymeCleavageJunctionId = bluntEndRestrictionEnzymeCleavageJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BluntEndRestrictionEnzymeCleavageJunctionId))
			return false;
		BluntEndRestrictionEnzymeCleavageJunctionId castOther = (BluntEndRestrictionEnzymeCleavageJunctionId) other;

		return ((this.getBluntEndRestrictionEnzymeCleavageJunctionId() == castOther
				.getBluntEndRestrictionEnzymeCleavageJunctionId()) || (this
				.getBluntEndRestrictionEnzymeCleavageJunctionId() != null
				&& castOther.getBluntEndRestrictionEnzymeCleavageJunctionId() != null && this
				.getBluntEndRestrictionEnzymeCleavageJunctionId()
				.equals(castOther
						.getBluntEndRestrictionEnzymeCleavageJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBluntEndRestrictionEnzymeCleavageJunctionId() == null ? 0
						: this.getBluntEndRestrictionEnzymeCleavageJunctionId()
								.hashCode());
		result = 37 * result
