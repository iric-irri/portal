...
/**
 * MembraneStructureId generated by hbm2java
 */
public class MembraneStructureId implements java.io.Serializable {

	private Integer membraneStructureId;
	...
	public MembraneStructureId() {
	}

	public MembraneStructureId(Integer membraneStructureId, Integer featureId,
		...
		this.membraneStructureId = membraneStructureId;
	...
	public Integer getMembraneStructureId() {
		return this.membraneStructureId;
	}

	public void setMembraneStructureId(Integer membraneStructureId) {
		this.membraneStructureId = membraneStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MembraneStructureId))
			return false;
		MembraneStructureId castOther = (MembraneStructureId) other;

		return ((this.getMembraneStructureId() == castOther
				.getMembraneStructureId()) || (this.getMembraneStructureId() != null
				&& castOther.getMembraneStructureId() != null && this
				.getMembraneStructureId().equals(
						castOther.getMembraneStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMembraneStructureId() == null ? 0 : this
						.getMembraneStructureId().hashCode());
		result = 37 * result
