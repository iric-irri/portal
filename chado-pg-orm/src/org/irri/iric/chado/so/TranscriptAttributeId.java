...
/**
 * TranscriptAttributeId generated by hbm2java
 */
public class TranscriptAttributeId implements java.io.Serializable {

	private Integer transcriptAttributeId;
	...
	public TranscriptAttributeId() {
	}

	public TranscriptAttributeId(Integer transcriptAttributeId,
		...
		this.transcriptAttributeId = transcriptAttributeId;
	...
	public Integer getTranscriptAttributeId() {
		return this.transcriptAttributeId;
	}

	public void setTranscriptAttributeId(Integer transcriptAttributeId) {
		this.transcriptAttributeId = transcriptAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptAttributeId))
			return false;
		TranscriptAttributeId castOther = (TranscriptAttributeId) other;

		return ((this.getTranscriptAttributeId() == castOther
				.getTranscriptAttributeId()) || (this
				.getTranscriptAttributeId() != null
				&& castOther.getTranscriptAttributeId() != null && this
				.getTranscriptAttributeId().equals(
						castOther.getTranscriptAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptAttributeId() == null ? 0 : this
						.getTranscriptAttributeId().hashCode());
		result = 37 * result
