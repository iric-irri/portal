...
/**
 * AntisenseId generated by hbm2java
 */
public class AntisenseId implements java.io.Serializable {

	private Integer antisenseId;
	...
	public AntisenseId(Integer antisenseId, Integer featureId,
	...
	public Integer getAntisenseId() {
		return this.antisenseId;
	}

	public void setAntisenseId(Integer antisenseId) {
		this.antisenseId = antisenseId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AntisenseId))
			return false;
		AntisenseId castOther = (AntisenseId) other;

		return ((this.getAntisenseId() == castOther.getAntisenseId()) || (this
				.getAntisenseId() != null && castOther.getAntisenseId() != null && this
				.getAntisenseId().equals(castOther.getAntisenseId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAntisenseId() == null ? 0 : this.getAntisenseId()
						.hashCode());
		result = 37 * result
