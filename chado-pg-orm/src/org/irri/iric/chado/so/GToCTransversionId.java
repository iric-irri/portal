...
/**
 * GToCTransversionId generated by hbm2java
 */
public class GToCTransversionId implements java.io.Serializable {

	private Integer GToCTransversionId;
	...
	public GToCTransversionId() {
	}

	public GToCTransversionId(Integer GToCTransversionId, Integer featureId,
		...
		this.GToCTransversionId = GToCTransversionId;
	...
	public Integer getGToCTransversionId() {
		return this.GToCTransversionId;
	}

	public void setGToCTransversionId(Integer GToCTransversionId) {
		this.GToCTransversionId = GToCTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GToCTransversionId))
			return false;
		GToCTransversionId castOther = (GToCTransversionId) other;

		return ((this.getGToCTransversionId() == castOther
				.getGToCTransversionId()) || (this.getGToCTransversionId() != null
				&& castOther.getGToCTransversionId() != null && this
				.getGToCTransversionId().equals(
						castOther.getGToCTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGToCTransversionId() == null ? 0 : this
						.getGToCTransversionId().hashCode());
		result = 37 * result
