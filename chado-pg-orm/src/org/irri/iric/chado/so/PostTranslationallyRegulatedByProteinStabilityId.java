...
/**
 * PostTranslationallyRegulatedByProteinStabilityId generated by hbm2java
 */
public class PostTranslationallyRegulatedByProteinStabilityId implements
		java.io.Serializable {

	private Integer postTranslationallyRegulatedByProteinStabilityId;
	...
	public PostTranslationallyRegulatedByProteinStabilityId() {
	}

	public PostTranslationallyRegulatedByProteinStabilityId(
			Integer postTranslationallyRegulatedByProteinStabilityId,
		...
		this.postTranslationallyRegulatedByProteinStabilityId = postTranslationallyRegulatedByProteinStabilityId;
	...
	public Integer getPostTranslationallyRegulatedByProteinStabilityId() {
		return this.postTranslationallyRegulatedByProteinStabilityId;
	}

	public void setPostTranslationallyRegulatedByProteinStabilityId(
			Integer postTranslationallyRegulatedByProteinStabilityId) {
		this.postTranslationallyRegulatedByProteinStabilityId = postTranslationallyRegulatedByProteinStabilityId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PostTranslationallyRegulatedByProteinStabilityId))
			return false;
		PostTranslationallyRegulatedByProteinStabilityId castOther = (PostTranslationallyRegulatedByProteinStabilityId) other;

		return ((this.getPostTranslationallyRegulatedByProteinStabilityId() == castOther
				.getPostTranslationallyRegulatedByProteinStabilityId()) || (this
				.getPostTranslationallyRegulatedByProteinStabilityId() != null
				&& castOther
						.getPostTranslationallyRegulatedByProteinStabilityId() != null && this
				.getPostTranslationallyRegulatedByProteinStabilityId()
				.equals(castOther
						.getPostTranslationallyRegulatedByProteinStabilityId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPostTranslationallyRegulatedByProteinStabilityId() == null ? 0
						: this.getPostTranslationallyRegulatedByProteinStabilityId()
								.hashCode());
		result = 37 * result
