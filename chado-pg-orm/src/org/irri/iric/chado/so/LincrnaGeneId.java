...
/**
 * LincrnaGeneId generated by hbm2java
 */
public class LincrnaGeneId implements java.io.Serializable {

	private Integer lincrnaGeneId;
	...
	public LincrnaGeneId() {
	}

	public LincrnaGeneId(Integer lincrnaGeneId, Integer featureId,
		...
		this.lincrnaGeneId = lincrnaGeneId;
	...
	public Integer getLincrnaGeneId() {
		return this.lincrnaGeneId;
	}

	public void setLincrnaGeneId(Integer lincrnaGeneId) {
		this.lincrnaGeneId = lincrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LincrnaGeneId))
			return false;
		LincrnaGeneId castOther = (LincrnaGeneId) other;

		return ((this.getLincrnaGeneId() == castOther.getLincrnaGeneId()) || (this
				.getLincrnaGeneId() != null
				&& castOther.getLincrnaGeneId() != null && this
				.getLincrnaGeneId().equals(castOther.getLincrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLincrnaGeneId() == null ? 0 : this.getLincrnaGeneId()
						.hashCode());
		result = 37 * result
