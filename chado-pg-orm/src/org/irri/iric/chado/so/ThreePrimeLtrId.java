...
/**
 * ThreePrimeLtrId generated by hbm2java
 */
public class ThreePrimeLtrId implements java.io.Serializable {

	private Integer threePrimeLtrId;
	...
	public ThreePrimeLtrId() {
	}

	public ThreePrimeLtrId(Integer threePrimeLtrId, Integer featureId,
		...
		this.threePrimeLtrId = threePrimeLtrId;
	...
	public Integer getThreePrimeLtrId() {
		return this.threePrimeLtrId;
	}

	public void setThreePrimeLtrId(Integer threePrimeLtrId) {
		this.threePrimeLtrId = threePrimeLtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeLtrId))
			return false;
		ThreePrimeLtrId castOther = (ThreePrimeLtrId) other;

		return ((this.getThreePrimeLtrId() == castOther.getThreePrimeLtrId()) || (this
				.getThreePrimeLtrId() != null
				&& castOther.getThreePrimeLtrId() != null && this
				.getThreePrimeLtrId().equals(castOther.getThreePrimeLtrId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeLtrId() == null ? 0 : this.getThreePrimeLtrId()
						.hashCode());
		result = 37 * result
