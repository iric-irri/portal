...
/**
 * StopRetainedVariantId generated by hbm2java
 */
public class StopRetainedVariantId implements java.io.Serializable {

	private Integer stopRetainedVariantId;
	...
	public StopRetainedVariantId() {
	}

	public StopRetainedVariantId(Integer stopRetainedVariantId,
		...
		this.stopRetainedVariantId = stopRetainedVariantId;
	...
	public Integer getStopRetainedVariantId() {
		return this.stopRetainedVariantId;
	}

	public void setStopRetainedVariantId(Integer stopRetainedVariantId) {
		this.stopRetainedVariantId = stopRetainedVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopRetainedVariantId))
			return false;
		StopRetainedVariantId castOther = (StopRetainedVariantId) other;

		return ((this.getStopRetainedVariantId() == castOther
				.getStopRetainedVariantId()) || (this
				.getStopRetainedVariantId() != null
				&& castOther.getStopRetainedVariantId() != null && this
				.getStopRetainedVariantId().equals(
						castOther.getStopRetainedVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopRetainedVariantId() == null ? 0 : this
						.getStopRetainedVariantId().hashCode());
		result = 37 * result
