...
/**
 * CdsRegionId generated by hbm2java
 */
public class CdsRegionId implements java.io.Serializable {

	private Integer cdsRegionId;
	...
	public CdsRegionId(Integer cdsRegionId, Integer featureId,
	...
	public Integer getCdsRegionId() {
		return this.cdsRegionId;
	}

	public void setCdsRegionId(Integer cdsRegionId) {
		this.cdsRegionId = cdsRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsRegionId))
			return false;
		CdsRegionId castOther = (CdsRegionId) other;

		return ((this.getCdsRegionId() == castOther.getCdsRegionId()) || (this
				.getCdsRegionId() != null && castOther.getCdsRegionId() != null && this
				.getCdsRegionId().equals(castOther.getCdsRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsRegionId() == null ? 0 : this.getCdsRegionId()
						.hashCode());
		result = 37 * result
