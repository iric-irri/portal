...
/**
 * ShineDalgarnoSequenceId generated by hbm2java
 */
public class ShineDalgarnoSequenceId implements java.io.Serializable {

	private Integer shineDalgarnoSequenceId;
	...
	public ShineDalgarnoSequenceId() {
	}

	public ShineDalgarnoSequenceId(Integer shineDalgarnoSequenceId,
		...
		this.shineDalgarnoSequenceId = shineDalgarnoSequenceId;
	...
	public Integer getShineDalgarnoSequenceId() {
		return this.shineDalgarnoSequenceId;
	}

	public void setShineDalgarnoSequenceId(Integer shineDalgarnoSequenceId) {
		this.shineDalgarnoSequenceId = shineDalgarnoSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShineDalgarnoSequenceId))
			return false;
		ShineDalgarnoSequenceId castOther = (ShineDalgarnoSequenceId) other;

		return ((this.getShineDalgarnoSequenceId() == castOther
				.getShineDalgarnoSequenceId()) || (this
				.getShineDalgarnoSequenceId() != null
				&& castOther.getShineDalgarnoSequenceId() != null && this
				.getShineDalgarnoSequenceId().equals(
						castOther.getShineDalgarnoSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getShineDalgarnoSequenceId() == null ? 0 : this
						.getShineDalgarnoSequenceId().hashCode());
		result = 37 * result
