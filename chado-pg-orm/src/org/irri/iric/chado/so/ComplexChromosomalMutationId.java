...
/**
 * ComplexChromosomalMutationId generated by hbm2java
 */
public class ComplexChromosomalMutationId implements java.io.Serializable {

	private Integer complexChromosomalMutationId;
	...
	public ComplexChromosomalMutationId() {
	}

	public ComplexChromosomalMutationId(Integer complexChromosomalMutationId,
		...
		this.complexChromosomalMutationId = complexChromosomalMutationId;
	...
	public Integer getComplexChromosomalMutationId() {
		return this.complexChromosomalMutationId;
	}

	public void setComplexChromosomalMutationId(
			Integer complexChromosomalMutationId) {
		this.complexChromosomalMutationId = complexChromosomalMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComplexChromosomalMutationId))
			return false;
		ComplexChromosomalMutationId castOther = (ComplexChromosomalMutationId) other;

		return ((this.getComplexChromosomalMutationId() == castOther
				.getComplexChromosomalMutationId()) || (this
				.getComplexChromosomalMutationId() != null
				&& castOther.getComplexChromosomalMutationId() != null && this
				.getComplexChromosomalMutationId().equals(
						castOther.getComplexChromosomalMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplexChromosomalMutationId() == null ? 0 : this
						.getComplexChromosomalMutationId().hashCode());
		result = 37 * result
