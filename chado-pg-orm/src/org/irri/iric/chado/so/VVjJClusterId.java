...
/**
 * VVjJClusterId generated by hbm2java
 */
public class VVjJClusterId implements java.io.Serializable {

	private Integer VVjJClusterId;
	...
	public VVjJClusterId() {
	}

	public VVjJClusterId(Integer VVjJClusterId, Integer featureId,
		...
		this.VVjJClusterId = VVjJClusterId;
	...
	public Integer getVVjJClusterId() {
		return this.VVjJClusterId;
	}

	public void setVVjJClusterId(Integer VVjJClusterId) {
		this.VVjJClusterId = VVjJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVjJClusterId))
			return false;
		VVjJClusterId castOther = (VVjJClusterId) other;

		return ((this.getVVjJClusterId() == castOther.getVVjJClusterId()) || (this
				.getVVjJClusterId() != null
				&& castOther.getVVjJClusterId() != null && this
				.getVVjJClusterId().equals(castOther.getVVjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVjJClusterId() == null ? 0 : this.getVVjJClusterId()
						.hashCode());
		result = 37 * result
