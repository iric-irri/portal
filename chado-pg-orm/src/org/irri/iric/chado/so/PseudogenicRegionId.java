...
/**
 * PseudogenicRegionId generated by hbm2java
 */
public class PseudogenicRegionId implements java.io.Serializable {

	private Integer pseudogenicRegionId;
	...
	public PseudogenicRegionId() {
	}

	public PseudogenicRegionId(Integer pseudogenicRegionId, Integer featureId,
		...
		this.pseudogenicRegionId = pseudogenicRegionId;
	...
	public Integer getPseudogenicRegionId() {
		return this.pseudogenicRegionId;
	}

	public void setPseudogenicRegionId(Integer pseudogenicRegionId) {
		this.pseudogenicRegionId = pseudogenicRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogenicRegionId))
			return false;
		PseudogenicRegionId castOther = (PseudogenicRegionId) other;

		return ((this.getPseudogenicRegionId() == castOther
				.getPseudogenicRegionId()) || (this.getPseudogenicRegionId() != null
				&& castOther.getPseudogenicRegionId() != null && this
				.getPseudogenicRegionId().equals(
						castOther.getPseudogenicRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogenicRegionId() == null ? 0 : this
						.getPseudogenicRegionId().hashCode());
		result = 37 * result
