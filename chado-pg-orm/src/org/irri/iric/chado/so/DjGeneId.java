...
/**
 * DjGeneId generated by hbm2java
 */
public class DjGeneId implements java.io.Serializable {

	private Integer djGeneId;
	...
	public DjGeneId(Integer djGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDjGeneId() {
		return this.djGeneId;
	}

	public void setDjGeneId(Integer djGeneId) {
		this.djGeneId = djGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DjGeneId))
			return false;
		DjGeneId castOther = (DjGeneId) other;

		return ((this.getDjGeneId() == castOther.getDjGeneId()) || (this
				.getDjGeneId() != null && castOther.getDjGeneId() != null && this
				.getDjGeneId().equals(castOther.getDjGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDjGeneId() == null ? 0 : this.getDjGeneId().hashCode());
		result = 37 * result
