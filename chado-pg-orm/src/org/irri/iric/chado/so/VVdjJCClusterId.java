...
/**
 * VVdjJCClusterId generated by hbm2java
 */
public class VVdjJCClusterId implements java.io.Serializable {

	private Integer VVdjJCClusterId;
	...
	public VVdjJCClusterId() {
	}

	public VVdjJCClusterId(Integer VVdjJCClusterId, Integer featureId,
		...
		this.VVdjJCClusterId = VVdjJCClusterId;
	...
	public Integer getVVdjJCClusterId() {
		return this.VVdjJCClusterId;
	}

	public void setVVdjJCClusterId(Integer VVdjJCClusterId) {
		this.VVdjJCClusterId = VVdjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVdjJCClusterId))
			return false;
		VVdjJCClusterId castOther = (VVdjJCClusterId) other;

		return ((this.getVVdjJCClusterId() == castOther.getVVdjJCClusterId()) || (this
				.getVVdjJCClusterId() != null
				&& castOther.getVVdjJCClusterId() != null && this
				.getVVdjJCClusterId().equals(castOther.getVVdjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVdjJCClusterId() == null ? 0 : this.getVVdjJCClusterId()
						.hashCode());
		result = 37 * result
