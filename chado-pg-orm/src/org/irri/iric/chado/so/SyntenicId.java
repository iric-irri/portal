...
/**
 * SyntenicId generated by hbm2java
 */
public class SyntenicId implements java.io.Serializable {

	private Integer syntenicId;
	...
	public SyntenicId(Integer syntenicId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSyntenicId() {
		return this.syntenicId;
	}

	public void setSyntenicId(Integer syntenicId) {
		this.syntenicId = syntenicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SyntenicId))
			return false;
		SyntenicId castOther = (SyntenicId) other;

		return ((this.getSyntenicId() == castOther.getSyntenicId()) || (this
				.getSyntenicId() != null && castOther.getSyntenicId() != null && this
				.getSyntenicId().equals(castOther.getSyntenicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSyntenicId() == null ? 0 : this.getSyntenicId()
						.hashCode());
		result = 37 * result
