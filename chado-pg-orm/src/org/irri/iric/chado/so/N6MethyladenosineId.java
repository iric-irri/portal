...
/**
 * N6MethyladenosineId generated by hbm2java
 */
public class N6MethyladenosineId implements java.io.Serializable {

	private Integer n6MethyladenosineId;
	...
	public N6MethyladenosineId() {
	}

	public N6MethyladenosineId(Integer n6MethyladenosineId, Integer featureId,
		...
		this.n6MethyladenosineId = n6MethyladenosineId;
	...
	public Integer getN6MethyladenosineId() {
		return this.n6MethyladenosineId;
	}

	public void setN6MethyladenosineId(Integer n6MethyladenosineId) {
		this.n6MethyladenosineId = n6MethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6MethyladenosineId))
			return false;
		N6MethyladenosineId castOther = (N6MethyladenosineId) other;

		return ((this.getN6MethyladenosineId() == castOther
				.getN6MethyladenosineId()) || (this.getN6MethyladenosineId() != null
				&& castOther.getN6MethyladenosineId() != null && this
				.getN6MethyladenosineId().equals(
						castOther.getN6MethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6MethyladenosineId() == null ? 0 : this
						.getN6MethyladenosineId().hashCode());
		result = 37 * result
