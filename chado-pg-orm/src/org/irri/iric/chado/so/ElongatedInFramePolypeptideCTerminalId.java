...
/**
 * ElongatedInFramePolypeptideCTerminalId generated by hbm2java
 */
public class ElongatedInFramePolypeptideCTerminalId implements
		java.io.Serializable {

	private Integer elongatedInFramePolypeptideCTerminalId;
	...
	public ElongatedInFramePolypeptideCTerminalId() {
	}

	public ElongatedInFramePolypeptideCTerminalId(
			Integer elongatedInFramePolypeptideCTerminalId, Integer featureId,
		...
		this.elongatedInFramePolypeptideCTerminalId = elongatedInFramePolypeptideCTerminalId;
	...
	public Integer getElongatedInFramePolypeptideCTerminalId() {
		return this.elongatedInFramePolypeptideCTerminalId;
	}

	public void setElongatedInFramePolypeptideCTerminalId(
			Integer elongatedInFramePolypeptideCTerminalId) {
		this.elongatedInFramePolypeptideCTerminalId = elongatedInFramePolypeptideCTerminalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedInFramePolypeptideCTerminalId))
			return false;
		ElongatedInFramePolypeptideCTerminalId castOther = (ElongatedInFramePolypeptideCTerminalId) other;

		return ((this.getElongatedInFramePolypeptideCTerminalId() == castOther
				.getElongatedInFramePolypeptideCTerminalId()) || (this
				.getElongatedInFramePolypeptideCTerminalId() != null
				&& castOther.getElongatedInFramePolypeptideCTerminalId() != null && this
				.getElongatedInFramePolypeptideCTerminalId().equals(
						castOther.getElongatedInFramePolypeptideCTerminalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedInFramePolypeptideCTerminalId() == null ? 0
						: this.getElongatedInFramePolypeptideCTerminalId()
								.hashCode());
		result = 37 * result
