...
/**
 * Sl7AcceptorSiteId generated by hbm2java
 */
public class Sl7AcceptorSiteId implements java.io.Serializable {

	private Integer sl7AcceptorSiteId;
	...
	public Sl7AcceptorSiteId() {
	}

	public Sl7AcceptorSiteId(Integer sl7AcceptorSiteId, Integer featureId,
		...
		this.sl7AcceptorSiteId = sl7AcceptorSiteId;
	...
	public Integer getSl7AcceptorSiteId() {
		return this.sl7AcceptorSiteId;
	}

	public void setSl7AcceptorSiteId(Integer sl7AcceptorSiteId) {
		this.sl7AcceptorSiteId = sl7AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl7AcceptorSiteId))
			return false;
		Sl7AcceptorSiteId castOther = (Sl7AcceptorSiteId) other;

		return ((this.getSl7AcceptorSiteId() == castOther
				.getSl7AcceptorSiteId()) || (this.getSl7AcceptorSiteId() != null
				&& castOther.getSl7AcceptorSiteId() != null && this
				.getSl7AcceptorSiteId()
				.equals(castOther.getSl7AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl7AcceptorSiteId() == null ? 0 : this
						.getSl7AcceptorSiteId().hashCode());
		result = 37 * result
