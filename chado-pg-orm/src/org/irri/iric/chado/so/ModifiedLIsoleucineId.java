...
/**
 * ModifiedLIsoleucineId generated by hbm2java
 */
public class ModifiedLIsoleucineId implements java.io.Serializable {

	private Integer modifiedLIsoleucineId;
	...
	public ModifiedLIsoleucineId() {
	}

	public ModifiedLIsoleucineId(Integer modifiedLIsoleucineId,
		...
		this.modifiedLIsoleucineId = modifiedLIsoleucineId;
	...
	public Integer getModifiedLIsoleucineId() {
		return this.modifiedLIsoleucineId;
	}

	public void setModifiedLIsoleucineId(Integer modifiedLIsoleucineId) {
		this.modifiedLIsoleucineId = modifiedLIsoleucineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLIsoleucineId))
			return false;
		ModifiedLIsoleucineId castOther = (ModifiedLIsoleucineId) other;

		return ((this.getModifiedLIsoleucineId() == castOther
				.getModifiedLIsoleucineId()) || (this
				.getModifiedLIsoleucineId() != null
				&& castOther.getModifiedLIsoleucineId() != null && this
				.getModifiedLIsoleucineId().equals(
						castOther.getModifiedLIsoleucineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLIsoleucineId() == null ? 0 : this
						.getModifiedLIsoleucineId().hashCode());
		result = 37 * result
