...
/**
 * ConjugativeTransposonId generated by hbm2java
 */
public class ConjugativeTransposonId implements java.io.Serializable {

	private Integer conjugativeTransposonId;
	...
	public ConjugativeTransposonId() {
	}

	public ConjugativeTransposonId(Integer conjugativeTransposonId,
		...
		this.conjugativeTransposonId = conjugativeTransposonId;
	...
	public Integer getConjugativeTransposonId() {
		return this.conjugativeTransposonId;
	}

	public void setConjugativeTransposonId(Integer conjugativeTransposonId) {
		this.conjugativeTransposonId = conjugativeTransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConjugativeTransposonId))
			return false;
		ConjugativeTransposonId castOther = (ConjugativeTransposonId) other;

		return ((this.getConjugativeTransposonId() == castOther
				.getConjugativeTransposonId()) || (this
				.getConjugativeTransposonId() != null
				&& castOther.getConjugativeTransposonId() != null && this
				.getConjugativeTransposonId().equals(
						castOther.getConjugativeTransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConjugativeTransposonId() == null ? 0 : this
						.getConjugativeTransposonId().hashCode());
		result = 37 * result
