...
/**
 * OxysRnaId generated by hbm2java
 */
public class OxysRnaId implements java.io.Serializable {

	private Integer oxysRnaId;
	...
	public OxysRnaId(Integer oxysRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getOxysRnaId() {
		return this.oxysRnaId;
	}

	public void setOxysRnaId(Integer oxysRnaId) {
		this.oxysRnaId = oxysRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OxysRnaId))
			return false;
		OxysRnaId castOther = (OxysRnaId) other;

		return ((this.getOxysRnaId() == castOther.getOxysRnaId()) || (this
				.getOxysRnaId() != null && castOther.getOxysRnaId() != null && this
				.getOxysRnaId().equals(castOther.getOxysRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOxysRnaId() == null ? 0 : this.getOxysRnaId().hashCode());
		result = 37 * result
