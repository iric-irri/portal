...
/**
 * RnaJunctionLoopId generated by hbm2java
 */
public class RnaJunctionLoopId implements java.io.Serializable {

	private Integer rnaJunctionLoopId;
	...
	public RnaJunctionLoopId() {
	}

	public RnaJunctionLoopId(Integer rnaJunctionLoopId, Integer featureId,
		...
		this.rnaJunctionLoopId = rnaJunctionLoopId;
	...
	public Integer getRnaJunctionLoopId() {
		return this.rnaJunctionLoopId;
	}

	public void setRnaJunctionLoopId(Integer rnaJunctionLoopId) {
		this.rnaJunctionLoopId = rnaJunctionLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaJunctionLoopId))
			return false;
		RnaJunctionLoopId castOther = (RnaJunctionLoopId) other;

		return ((this.getRnaJunctionLoopId() == castOther
				.getRnaJunctionLoopId()) || (this.getRnaJunctionLoopId() != null
				&& castOther.getRnaJunctionLoopId() != null && this
				.getRnaJunctionLoopId()
				.equals(castOther.getRnaJunctionLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaJunctionLoopId() == null ? 0 : this
						.getRnaJunctionLoopId().hashCode());
		result = 37 * result
