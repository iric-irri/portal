...
/**
 * ChromosomalDuplicationId generated by hbm2java
 */
public class ChromosomalDuplicationId implements java.io.Serializable {

	private Integer chromosomalDuplicationId;
	...
	public ChromosomalDuplicationId() {
	}

	public ChromosomalDuplicationId(Integer chromosomalDuplicationId,
		...
		this.chromosomalDuplicationId = chromosomalDuplicationId;
	...
	public Integer getChromosomalDuplicationId() {
		return this.chromosomalDuplicationId;
	}

	public void setChromosomalDuplicationId(Integer chromosomalDuplicationId) {
		this.chromosomalDuplicationId = chromosomalDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalDuplicationId))
			return false;
		ChromosomalDuplicationId castOther = (ChromosomalDuplicationId) other;

		return ((this.getChromosomalDuplicationId() == castOther
				.getChromosomalDuplicationId()) || (this
				.getChromosomalDuplicationId() != null
				&& castOther.getChromosomalDuplicationId() != null && this
				.getChromosomalDuplicationId().equals(
						castOther.getChromosomalDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalDuplicationId() == null ? 0 : this
						.getChromosomalDuplicationId().hashCode());
		result = 37 * result
