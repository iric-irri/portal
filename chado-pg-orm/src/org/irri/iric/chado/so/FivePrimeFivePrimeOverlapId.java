...
/**
 * FivePrimeFivePrimeOverlapId generated by hbm2java
 */
public class FivePrimeFivePrimeOverlapId implements java.io.Serializable {

	private Integer fivePrimeFivePrimeOverlapId;
	...
	public FivePrimeFivePrimeOverlapId() {
	}

	public FivePrimeFivePrimeOverlapId(Integer fivePrimeFivePrimeOverlapId,
		...
		this.fivePrimeFivePrimeOverlapId = fivePrimeFivePrimeOverlapId;
	...
	public Integer getFivePrimeFivePrimeOverlapId() {
		return this.fivePrimeFivePrimeOverlapId;
	}

	public void setFivePrimeFivePrimeOverlapId(
			Integer fivePrimeFivePrimeOverlapId) {
		this.fivePrimeFivePrimeOverlapId = fivePrimeFivePrimeOverlapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeFivePrimeOverlapId))
			return false;
		FivePrimeFivePrimeOverlapId castOther = (FivePrimeFivePrimeOverlapId) other;

		return ((this.getFivePrimeFivePrimeOverlapId() == castOther
				.getFivePrimeFivePrimeOverlapId()) || (this
				.getFivePrimeFivePrimeOverlapId() != null
				&& castOther.getFivePrimeFivePrimeOverlapId() != null && this
				.getFivePrimeFivePrimeOverlapId().equals(
						castOther.getFivePrimeFivePrimeOverlapId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeFivePrimeOverlapId() == null ? 0 : this
						.getFivePrimeFivePrimeOverlapId().hashCode());
		result = 37 * result
