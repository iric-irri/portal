...
/**
 * NonTranscribedRegionId generated by hbm2java
 */
public class NonTranscribedRegionId implements java.io.Serializable {

	private Integer nonTranscribedRegionId;
	...
	public NonTranscribedRegionId() {
	}

	public NonTranscribedRegionId(Integer nonTranscribedRegionId,
		...
		this.nonTranscribedRegionId = nonTranscribedRegionId;
	...
	public Integer getNonTranscribedRegionId() {
		return this.nonTranscribedRegionId;
	}

	public void setNonTranscribedRegionId(Integer nonTranscribedRegionId) {
		this.nonTranscribedRegionId = nonTranscribedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonTranscribedRegionId))
			return false;
		NonTranscribedRegionId castOther = (NonTranscribedRegionId) other;

		return ((this.getNonTranscribedRegionId() == castOther
				.getNonTranscribedRegionId()) || (this
				.getNonTranscribedRegionId() != null
				&& castOther.getNonTranscribedRegionId() != null && this
				.getNonTranscribedRegionId().equals(
						castOther.getNonTranscribedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonTranscribedRegionId() == null ? 0 : this
						.getNonTranscribedRegionId().hashCode());
		result = 37 * result
