...
/**
 * GeneFragmentId generated by hbm2java
 */
public class GeneFragmentId implements java.io.Serializable {

	private Integer geneFragmentId;
	...
	public GeneFragmentId() {
	}

	public GeneFragmentId(Integer geneFragmentId, Integer featureId,
		...
		this.geneFragmentId = geneFragmentId;
	...
	public Integer getGeneFragmentId() {
		return this.geneFragmentId;
	}

	public void setGeneFragmentId(Integer geneFragmentId) {
		this.geneFragmentId = geneFragmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneFragmentId))
			return false;
		GeneFragmentId castOther = (GeneFragmentId) other;

		return ((this.getGeneFragmentId() == castOther.getGeneFragmentId()) || (this
				.getGeneFragmentId() != null
				&& castOther.getGeneFragmentId() != null && this
				.getGeneFragmentId().equals(castOther.getGeneFragmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneFragmentId() == null ? 0 : this.getGeneFragmentId()
						.hashCode());
		result = 37 * result
