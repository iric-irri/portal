...
/**
 * DistantThreePrimeRecodingSignalId generated by hbm2java
 */
public class DistantThreePrimeRecodingSignalId implements java.io.Serializable {

	private Integer distantThreePrimeRecodingSignalId;
	...
	public DistantThreePrimeRecodingSignalId() {
	}

	public DistantThreePrimeRecodingSignalId(
			Integer distantThreePrimeRecodingSignalId, Integer featureId,
		...
		this.distantThreePrimeRecodingSignalId = distantThreePrimeRecodingSignalId;
	...
	public Integer getDistantThreePrimeRecodingSignalId() {
		return this.distantThreePrimeRecodingSignalId;
	}

	public void setDistantThreePrimeRecodingSignalId(
			Integer distantThreePrimeRecodingSignalId) {
		this.distantThreePrimeRecodingSignalId = distantThreePrimeRecodingSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DistantThreePrimeRecodingSignalId))
			return false;
		DistantThreePrimeRecodingSignalId castOther = (DistantThreePrimeRecodingSignalId) other;

		return ((this.getDistantThreePrimeRecodingSignalId() == castOther
				.getDistantThreePrimeRecodingSignalId()) || (this
				.getDistantThreePrimeRecodingSignalId() != null
				&& castOther.getDistantThreePrimeRecodingSignalId() != null && this
				.getDistantThreePrimeRecodingSignalId().equals(
						castOther.getDistantThreePrimeRecodingSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDistantThreePrimeRecodingSignalId() == null ? 0 : this
						.getDistantThreePrimeRecodingSignalId().hashCode());
		result = 37 * result
