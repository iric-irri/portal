...
/**
 * MethylatedCId generated by hbm2java
 */
public class MethylatedCId implements java.io.Serializable {

	private Integer methylatedCId;
	...
	public MethylatedCId() {
	}

	public MethylatedCId(Integer methylatedCId, Integer featureId,
		...
		this.methylatedCId = methylatedCId;
	...
	public Integer getMethylatedCId() {
		return this.methylatedCId;
	}

	public void setMethylatedCId(Integer methylatedCId) {
		this.methylatedCId = methylatedCId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylatedCId))
			return false;
		MethylatedCId castOther = (MethylatedCId) other;

		return ((this.getMethylatedCId() == castOther.getMethylatedCId()) || (this
				.getMethylatedCId() != null
				&& castOther.getMethylatedCId() != null && this
				.getMethylatedCId().equals(castOther.getMethylatedCId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylatedCId() == null ? 0 : this.getMethylatedCId()
						.hashCode());
		result = 37 * result
