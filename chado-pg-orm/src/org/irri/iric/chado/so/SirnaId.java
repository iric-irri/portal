...
/**
 * SirnaId generated by hbm2java
 */
public class SirnaId implements java.io.Serializable {
	...
	public SirnaId(Integer sirnaId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SirnaId))
			return false;
		SirnaId castOther = (SirnaId) other;

		return ((this.getSirnaId() == castOther.getSirnaId()) || (this
				.getSirnaId() != null && castOther.getSirnaId() != null && this
				.getSirnaId().equals(castOther.getSirnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSirnaId() == null ? 0 : this.getSirnaId().hashCode());
		result = 37 * result
