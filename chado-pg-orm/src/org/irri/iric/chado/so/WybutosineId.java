...
/**
 * WybutosineId generated by hbm2java
 */
public class WybutosineId implements java.io.Serializable {

	private Integer wybutosineId;
	...
	public WybutosineId(Integer wybutosineId, Integer featureId,
		...
		this.wybutosineId = wybutosineId;
	...
	public Integer getWybutosineId() {
		return this.wybutosineId;
	}

	public void setWybutosineId(Integer wybutosineId) {
		this.wybutosineId = wybutosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WybutosineId))
			return false;
		WybutosineId castOther = (WybutosineId) other;

		return ((this.getWybutosineId() == castOther.getWybutosineId()) || (this
				.getWybutosineId() != null
				&& castOther.getWybutosineId() != null && this
				.getWybutosineId().equals(castOther.getWybutosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWybutosineId() == null ? 0 : this.getWybutosineId()
						.hashCode());
		result = 37 * result
