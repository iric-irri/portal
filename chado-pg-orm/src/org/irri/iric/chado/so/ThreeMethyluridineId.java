...
/**
 * ThreeMethyluridineId generated by hbm2java
 */
public class ThreeMethyluridineId implements java.io.Serializable {

	private Integer threeMethyluridineId;
	...
	public ThreeMethyluridineId() {
	}

	public ThreeMethyluridineId(Integer threeMethyluridineId,
		...
		this.threeMethyluridineId = threeMethyluridineId;
	...
	public Integer getThreeMethyluridineId() {
		return this.threeMethyluridineId;
	}

	public void setThreeMethyluridineId(Integer threeMethyluridineId) {
		this.threeMethyluridineId = threeMethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeMethyluridineId))
			return false;
		ThreeMethyluridineId castOther = (ThreeMethyluridineId) other;

		return ((this.getThreeMethyluridineId() == castOther
				.getThreeMethyluridineId()) || (this.getThreeMethyluridineId() != null
				&& castOther.getThreeMethyluridineId() != null && this
				.getThreeMethyluridineId().equals(
						castOther.getThreeMethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeMethyluridineId() == null ? 0 : this
						.getThreeMethyluridineId().hashCode());
		result = 37 * result
