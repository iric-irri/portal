...
/**
 * JunctionId generated by hbm2java
 */
public class JunctionId implements java.io.Serializable {
	...
	public JunctionId(Integer junctionId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JunctionId))
			return false;
		JunctionId castOther = (JunctionId) other;

		return ((this.getJunctionId() == castOther.getJunctionId()) || (this
				.getJunctionId() != null && castOther.getJunctionId() != null && this
				.getJunctionId().equals(castOther.getJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJunctionId() == null ? 0 : this.getJunctionId()
						.hashCode());
		result = 37 * result
