...
/**
 * CdnaCloneId generated by hbm2java
 */
public class CdnaCloneId implements java.io.Serializable {

	private Integer cdnaCloneId;
	...
	public CdnaCloneId(Integer cdnaCloneId, Integer featureId,
	...
	public Integer getCdnaCloneId() {
		return this.cdnaCloneId;
	}

	public void setCdnaCloneId(Integer cdnaCloneId) {
		this.cdnaCloneId = cdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdnaCloneId))
			return false;
		CdnaCloneId castOther = (CdnaCloneId) other;

		return ((this.getCdnaCloneId() == castOther.getCdnaCloneId()) || (this
				.getCdnaCloneId() != null && castOther.getCdnaCloneId() != null && this
				.getCdnaCloneId().equals(castOther.getCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdnaCloneId() == null ? 0 : this.getCdnaCloneId()
						.hashCode());
		result = 37 * result
