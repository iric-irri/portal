...
/**
 * DnaBindingSiteId generated by hbm2java
 */
public class DnaBindingSiteId implements java.io.Serializable {

	private Integer dnaBindingSiteId;
	...
	public DnaBindingSiteId() {
	}

	public DnaBindingSiteId(Integer dnaBindingSiteId, Integer featureId,
		...
		this.dnaBindingSiteId = dnaBindingSiteId;
	...
	public Integer getDnaBindingSiteId() {
		return this.dnaBindingSiteId;
	}

	public void setDnaBindingSiteId(Integer dnaBindingSiteId) {
		this.dnaBindingSiteId = dnaBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaBindingSiteId))
			return false;
		DnaBindingSiteId castOther = (DnaBindingSiteId) other;

		return ((this.getDnaBindingSiteId() == castOther.getDnaBindingSiteId()) || (this
				.getDnaBindingSiteId() != null
				&& castOther.getDnaBindingSiteId() != null && this
				.getDnaBindingSiteId().equals(castOther.getDnaBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaBindingSiteId() == null ? 0 : this
						.getDnaBindingSiteId().hashCode());
		result = 37 * result
