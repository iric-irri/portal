...
/**
 * PolypeptideZincIonContactSiteId generated by hbm2java
 */
public class PolypeptideZincIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideZincIonContactSiteId;
	...
	public PolypeptideZincIonContactSiteId() {
	}

	public PolypeptideZincIonContactSiteId(
			Integer polypeptideZincIonContactSiteId, Integer featureId,
		...
		this.polypeptideZincIonContactSiteId = polypeptideZincIonContactSiteId;
	...
	public Integer getPolypeptideZincIonContactSiteId() {
		return this.polypeptideZincIonContactSiteId;
	}

	public void setPolypeptideZincIonContactSiteId(
			Integer polypeptideZincIonContactSiteId) {
		this.polypeptideZincIonContactSiteId = polypeptideZincIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideZincIonContactSiteId))
			return false;
		PolypeptideZincIonContactSiteId castOther = (PolypeptideZincIonContactSiteId) other;

		return ((this.getPolypeptideZincIonContactSiteId() == castOther
				.getPolypeptideZincIonContactSiteId()) || (this
				.getPolypeptideZincIonContactSiteId() != null
				&& castOther.getPolypeptideZincIonContactSiteId() != null && this
				.getPolypeptideZincIonContactSiteId().equals(
						castOther.getPolypeptideZincIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideZincIonContactSiteId() == null ? 0 : this
						.getPolypeptideZincIonContactSiteId().hashCode());
		result = 37 * result
