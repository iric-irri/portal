...
/**
 * FreeDuplicationId generated by hbm2java
 */
public class FreeDuplicationId implements java.io.Serializable {

	private Integer freeDuplicationId;
	...
	public FreeDuplicationId() {
	}

	public FreeDuplicationId(Integer freeDuplicationId, Integer featureId,
		...
		this.freeDuplicationId = freeDuplicationId;
	...
	public Integer getFreeDuplicationId() {
		return this.freeDuplicationId;
	}

	public void setFreeDuplicationId(Integer freeDuplicationId) {
		this.freeDuplicationId = freeDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreeDuplicationId))
			return false;
		FreeDuplicationId castOther = (FreeDuplicationId) other;

		return ((this.getFreeDuplicationId() == castOther
				.getFreeDuplicationId()) || (this.getFreeDuplicationId() != null
				&& castOther.getFreeDuplicationId() != null && this
				.getFreeDuplicationId()
				.equals(castOther.getFreeDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFreeDuplicationId() == null ? 0 : this
						.getFreeDuplicationId().hashCode());
		result = 37 * result
