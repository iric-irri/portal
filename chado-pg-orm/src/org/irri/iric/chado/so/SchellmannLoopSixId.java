...
/**
 * SchellmannLoopSixId generated by hbm2java
 */
public class SchellmannLoopSixId implements java.io.Serializable {

	private Integer schellmannLoopSixId;
	...
	public SchellmannLoopSixId() {
	}

	public SchellmannLoopSixId(Integer schellmannLoopSixId, Integer featureId,
		...
		this.schellmannLoopSixId = schellmannLoopSixId;
	...
	public Integer getSchellmannLoopSixId() {
		return this.schellmannLoopSixId;
	}

	public void setSchellmannLoopSixId(Integer schellmannLoopSixId) {
		this.schellmannLoopSixId = schellmannLoopSixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SchellmannLoopSixId))
			return false;
		SchellmannLoopSixId castOther = (SchellmannLoopSixId) other;

		return ((this.getSchellmannLoopSixId() == castOther
				.getSchellmannLoopSixId()) || (this.getSchellmannLoopSixId() != null
				&& castOther.getSchellmannLoopSixId() != null && this
				.getSchellmannLoopSixId().equals(
						castOther.getSchellmannLoopSixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSchellmannLoopSixId() == null ? 0 : this
						.getSchellmannLoopSixId().hashCode());
		result = 37 * result
