...
/**
 * FinishedGenomeId generated by hbm2java
 */
public class FinishedGenomeId implements java.io.Serializable {

	private Integer finishedGenomeId;
	...
	public FinishedGenomeId() {
	}

	public FinishedGenomeId(Integer finishedGenomeId, Integer featureId,
		...
		this.finishedGenomeId = finishedGenomeId;
	...
	public Integer getFinishedGenomeId() {
		return this.finishedGenomeId;
	}

	public void setFinishedGenomeId(Integer finishedGenomeId) {
		this.finishedGenomeId = finishedGenomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FinishedGenomeId))
			return false;
		FinishedGenomeId castOther = (FinishedGenomeId) other;

		return ((this.getFinishedGenomeId() == castOther.getFinishedGenomeId()) || (this
				.getFinishedGenomeId() != null
				&& castOther.getFinishedGenomeId() != null && this
				.getFinishedGenomeId().equals(castOther.getFinishedGenomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFinishedGenomeId() == null ? 0 : this
						.getFinishedGenomeId().hashCode());
		result = 37 * result
