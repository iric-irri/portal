...
/**
 * TwoPrimeOMethylinosineId generated by hbm2java
 */
public class TwoPrimeOMethylinosineId implements java.io.Serializable {

	private Integer twoPrimeOMethylinosineId;
	...
	public TwoPrimeOMethylinosineId() {
	}

	public TwoPrimeOMethylinosineId(Integer twoPrimeOMethylinosineId,
		...
		this.twoPrimeOMethylinosineId = twoPrimeOMethylinosineId;
	...
	public Integer getTwoPrimeOMethylinosineId() {
		return this.twoPrimeOMethylinosineId;
	}

	public void setTwoPrimeOMethylinosineId(Integer twoPrimeOMethylinosineId) {
		this.twoPrimeOMethylinosineId = twoPrimeOMethylinosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoPrimeOMethylinosineId))
			return false;
		TwoPrimeOMethylinosineId castOther = (TwoPrimeOMethylinosineId) other;

		return ((this.getTwoPrimeOMethylinosineId() == castOther
				.getTwoPrimeOMethylinosineId()) || (this
				.getTwoPrimeOMethylinosineId() != null
				&& castOther.getTwoPrimeOMethylinosineId() != null && this
				.getTwoPrimeOMethylinosineId().equals(
						castOther.getTwoPrimeOMethylinosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoPrimeOMethylinosineId() == null ? 0 : this
						.getTwoPrimeOMethylinosineId().hashCode());
		result = 37 * result
