...
/**
 * Sl10AccceptorSiteId generated by hbm2java
 */
public class Sl10AccceptorSiteId implements java.io.Serializable {

	private Integer sl10AccceptorSiteId;
	...
	public Sl10AccceptorSiteId() {
	}

	public Sl10AccceptorSiteId(Integer sl10AccceptorSiteId, Integer featureId,
		...
		this.sl10AccceptorSiteId = sl10AccceptorSiteId;
	...
	public Integer getSl10AccceptorSiteId() {
		return this.sl10AccceptorSiteId;
	}

	public void setSl10AccceptorSiteId(Integer sl10AccceptorSiteId) {
		this.sl10AccceptorSiteId = sl10AccceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl10AccceptorSiteId))
			return false;
		Sl10AccceptorSiteId castOther = (Sl10AccceptorSiteId) other;

		return ((this.getSl10AccceptorSiteId() == castOther
				.getSl10AccceptorSiteId()) || (this.getSl10AccceptorSiteId() != null
				&& castOther.getSl10AccceptorSiteId() != null && this
				.getSl10AccceptorSiteId().equals(
						castOther.getSl10AccceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl10AccceptorSiteId() == null ? 0 : this
						.getSl10AccceptorSiteId().hashCode());
		result = 37 * result
