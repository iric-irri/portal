...
/**
 * SerineId generated by hbm2java
 */
public class SerineId implements java.io.Serializable {

	private Integer serineId;
	...
	public SerineId(Integer serineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSerineId() {
		return this.serineId;
	}

	public void setSerineId(Integer serineId) {
		this.serineId = serineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerineId))
			return false;
		SerineId castOther = (SerineId) other;

		return ((this.getSerineId() == castOther.getSerineId()) || (this
				.getSerineId() != null && castOther.getSerineId() != null && this
				.getSerineId().equals(castOther.getSerineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSerineId() == null ? 0 : this.getSerineId().hashCode());
		result = 37 * result
