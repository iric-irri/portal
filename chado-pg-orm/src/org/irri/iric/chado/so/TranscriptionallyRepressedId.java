...
/**
 * TranscriptionallyRepressedId generated by hbm2java
 */
public class TranscriptionallyRepressedId implements java.io.Serializable {

	private Integer transcriptionallyRepressedId;
	...
	public TranscriptionallyRepressedId() {
	}

	public TranscriptionallyRepressedId(Integer transcriptionallyRepressedId,
		...
		this.transcriptionallyRepressedId = transcriptionallyRepressedId;
	...
	public Integer getTranscriptionallyRepressedId() {
		return this.transcriptionallyRepressedId;
	}

	public void setTranscriptionallyRepressedId(
			Integer transcriptionallyRepressedId) {
		this.transcriptionallyRepressedId = transcriptionallyRepressedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionallyRepressedId))
			return false;
		TranscriptionallyRepressedId castOther = (TranscriptionallyRepressedId) other;

		return ((this.getTranscriptionallyRepressedId() == castOther
				.getTranscriptionallyRepressedId()) || (this
				.getTranscriptionallyRepressedId() != null
				&& castOther.getTranscriptionallyRepressedId() != null && this
				.getTranscriptionallyRepressedId().equals(
						castOther.getTranscriptionallyRepressedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionallyRepressedId() == null ? 0 : this
						.getTranscriptionallyRepressedId().hashCode());
		result = 37 * result
