...
/**
 * H3k9AcetylationSiteId generated by hbm2java
 */
public class H3k9AcetylationSiteId implements java.io.Serializable {

	private Integer h3k9AcetylationSiteId;
	...
	public H3k9AcetylationSiteId() {
	}

	public H3k9AcetylationSiteId(Integer h3k9AcetylationSiteId,
		...
		this.h3k9AcetylationSiteId = h3k9AcetylationSiteId;
	...
	public Integer getH3k9AcetylationSiteId() {
		return this.h3k9AcetylationSiteId;
	}

	public void setH3k9AcetylationSiteId(Integer h3k9AcetylationSiteId) {
		this.h3k9AcetylationSiteId = h3k9AcetylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k9AcetylationSiteId))
			return false;
		H3k9AcetylationSiteId castOther = (H3k9AcetylationSiteId) other;

		return ((this.getH3k9AcetylationSiteId() == castOther
				.getH3k9AcetylationSiteId()) || (this
				.getH3k9AcetylationSiteId() != null
				&& castOther.getH3k9AcetylationSiteId() != null && this
				.getH3k9AcetylationSiteId().equals(
						castOther.getH3k9AcetylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k9AcetylationSiteId() == null ? 0 : this
						.getH3k9AcetylationSiteId().hashCode());
		result = 37 * result
