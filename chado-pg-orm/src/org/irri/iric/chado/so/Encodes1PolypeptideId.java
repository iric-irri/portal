...
/**
 * Encodes1PolypeptideId generated by hbm2java
 */
public class Encodes1PolypeptideId implements java.io.Serializable {

	private Integer encodes1PolypeptideId;
	...
	public Encodes1PolypeptideId() {
	}

	public Encodes1PolypeptideId(Integer encodes1PolypeptideId,
		...
		this.encodes1PolypeptideId = encodes1PolypeptideId;
	...
	public Integer getEncodes1PolypeptideId() {
		return this.encodes1PolypeptideId;
	}

	public void setEncodes1PolypeptideId(Integer encodes1PolypeptideId) {
		this.encodes1PolypeptideId = encodes1PolypeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Encodes1PolypeptideId))
			return false;
		Encodes1PolypeptideId castOther = (Encodes1PolypeptideId) other;

		return ((this.getEncodes1PolypeptideId() == castOther
				.getEncodes1PolypeptideId()) || (this
				.getEncodes1PolypeptideId() != null
				&& castOther.getEncodes1PolypeptideId() != null && this
				.getEncodes1PolypeptideId().equals(
						castOther.getEncodes1PolypeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodes1PolypeptideId() == null ? 0 : this
						.getEncodes1PolypeptideId().hashCode());
		result = 37 * result
