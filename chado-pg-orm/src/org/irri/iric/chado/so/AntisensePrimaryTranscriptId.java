...
/**
 * AntisensePrimaryTranscriptId generated by hbm2java
 */
public class AntisensePrimaryTranscriptId implements java.io.Serializable {

	private Integer antisensePrimaryTranscriptId;
	...
	public AntisensePrimaryTranscriptId() {
	}

	public AntisensePrimaryTranscriptId(Integer antisensePrimaryTranscriptId,
		...
		this.antisensePrimaryTranscriptId = antisensePrimaryTranscriptId;
	...
	public Integer getAntisensePrimaryTranscriptId() {
		return this.antisensePrimaryTranscriptId;
	}

	public void setAntisensePrimaryTranscriptId(
			Integer antisensePrimaryTranscriptId) {
		this.antisensePrimaryTranscriptId = antisensePrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AntisensePrimaryTranscriptId))
			return false;
		AntisensePrimaryTranscriptId castOther = (AntisensePrimaryTranscriptId) other;

		return ((this.getAntisensePrimaryTranscriptId() == castOther
				.getAntisensePrimaryTranscriptId()) || (this
				.getAntisensePrimaryTranscriptId() != null
				&& castOther.getAntisensePrimaryTranscriptId() != null && this
				.getAntisensePrimaryTranscriptId().equals(
						castOther.getAntisensePrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAntisensePrimaryTranscriptId() == null ? 0 : this
						.getAntisensePrimaryTranscriptId().hashCode());
		result = 37 * result
