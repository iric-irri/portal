...
/**
 * BlockedReadingFrameId generated by hbm2java
 */
public class BlockedReadingFrameId implements java.io.Serializable {

	private Integer blockedReadingFrameId;
	...
	public BlockedReadingFrameId() {
	}

	public BlockedReadingFrameId(Integer blockedReadingFrameId,
		...
		this.blockedReadingFrameId = blockedReadingFrameId;
	...
	public Integer getBlockedReadingFrameId() {
		return this.blockedReadingFrameId;
	}

	public void setBlockedReadingFrameId(Integer blockedReadingFrameId) {
		this.blockedReadingFrameId = blockedReadingFrameId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BlockedReadingFrameId))
			return false;
		BlockedReadingFrameId castOther = (BlockedReadingFrameId) other;

		return ((this.getBlockedReadingFrameId() == castOther
				.getBlockedReadingFrameId()) || (this
				.getBlockedReadingFrameId() != null
				&& castOther.getBlockedReadingFrameId() != null && this
				.getBlockedReadingFrameId().equals(
						castOther.getBlockedReadingFrameId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBlockedReadingFrameId() == null ? 0 : this
						.getBlockedReadingFrameId().hashCode());
		result = 37 * result
