...
/**
 * InsulatorBindingSiteId generated by hbm2java
 */
public class InsulatorBindingSiteId implements java.io.Serializable {

	private Integer insulatorBindingSiteId;
	...
	public InsulatorBindingSiteId() {
	}

	public InsulatorBindingSiteId(Integer insulatorBindingSiteId,
		...
		this.insulatorBindingSiteId = insulatorBindingSiteId;
	...
	public Integer getInsulatorBindingSiteId() {
		return this.insulatorBindingSiteId;
	}

	public void setInsulatorBindingSiteId(Integer insulatorBindingSiteId) {
		this.insulatorBindingSiteId = insulatorBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsulatorBindingSiteId))
			return false;
		InsulatorBindingSiteId castOther = (InsulatorBindingSiteId) other;

		return ((this.getInsulatorBindingSiteId() == castOther
				.getInsulatorBindingSiteId()) || (this
				.getInsulatorBindingSiteId() != null
				&& castOther.getInsulatorBindingSiteId() != null && this
				.getInsulatorBindingSiteId().equals(
						castOther.getInsulatorBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsulatorBindingSiteId() == null ? 0 : this
						.getInsulatorBindingSiteId().hashCode());
		result = 37 * result
