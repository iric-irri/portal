...
/**
 * ElongatedPolypeptideNTerminalId generated by hbm2java
 */
public class ElongatedPolypeptideNTerminalId implements java.io.Serializable {

	private Integer elongatedPolypeptideNTerminalId;
	...
	public ElongatedPolypeptideNTerminalId() {
	}

	public ElongatedPolypeptideNTerminalId(
			Integer elongatedPolypeptideNTerminalId, Integer featureId,
		...
		this.elongatedPolypeptideNTerminalId = elongatedPolypeptideNTerminalId;
	...
	public Integer getElongatedPolypeptideNTerminalId() {
		return this.elongatedPolypeptideNTerminalId;
	}

	public void setElongatedPolypeptideNTerminalId(
			Integer elongatedPolypeptideNTerminalId) {
		this.elongatedPolypeptideNTerminalId = elongatedPolypeptideNTerminalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedPolypeptideNTerminalId))
			return false;
		ElongatedPolypeptideNTerminalId castOther = (ElongatedPolypeptideNTerminalId) other;

		return ((this.getElongatedPolypeptideNTerminalId() == castOther
				.getElongatedPolypeptideNTerminalId()) || (this
				.getElongatedPolypeptideNTerminalId() != null
				&& castOther.getElongatedPolypeptideNTerminalId() != null && this
				.getElongatedPolypeptideNTerminalId().equals(
						castOther.getElongatedPolypeptideNTerminalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedPolypeptideNTerminalId() == null ? 0 : this
						.getElongatedPolypeptideNTerminalId().hashCode());
		result = 37 * result
