...
/**
 * SimpleSequenceLengthVariationId generated by hbm2java
 */
public class SimpleSequenceLengthVariationId implements java.io.Serializable {

	private Integer simpleSequenceLengthVariationId;
	...
	public SimpleSequenceLengthVariationId() {
	}

	public SimpleSequenceLengthVariationId(
			Integer simpleSequenceLengthVariationId, Integer featureId,
		...
		this.simpleSequenceLengthVariationId = simpleSequenceLengthVariationId;
	...
	public Integer getSimpleSequenceLengthVariationId() {
		return this.simpleSequenceLengthVariationId;
	}

	public void setSimpleSequenceLengthVariationId(
			Integer simpleSequenceLengthVariationId) {
		this.simpleSequenceLengthVariationId = simpleSequenceLengthVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SimpleSequenceLengthVariationId))
			return false;
		SimpleSequenceLengthVariationId castOther = (SimpleSequenceLengthVariationId) other;

		return ((this.getSimpleSequenceLengthVariationId() == castOther
				.getSimpleSequenceLengthVariationId()) || (this
				.getSimpleSequenceLengthVariationId() != null
				&& castOther.getSimpleSequenceLengthVariationId() != null && this
				.getSimpleSequenceLengthVariationId().equals(
						castOther.getSimpleSequenceLengthVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSimpleSequenceLengthVariationId() == null ? 0 : this
						.getSimpleSequenceLengthVariationId().hashCode());
		result = 37 * result
