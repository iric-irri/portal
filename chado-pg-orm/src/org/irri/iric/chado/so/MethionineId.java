...
/**
 * MethionineId generated by hbm2java
 */
public class MethionineId implements java.io.Serializable {

	private Integer methionineId;
	...
	public MethionineId(Integer methionineId, Integer featureId,
		...
		this.methionineId = methionineId;
	...
	public Integer getMethionineId() {
		return this.methionineId;
	}

	public void setMethionineId(Integer methionineId) {
		this.methionineId = methionineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethionineId))
			return false;
		MethionineId castOther = (MethionineId) other;

		return ((this.getMethionineId() == castOther.getMethionineId()) || (this
				.getMethionineId() != null
				&& castOther.getMethionineId() != null && this
				.getMethionineId().equals(castOther.getMethionineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethionineId() == null ? 0 : this.getMethionineId()
						.hashCode());
		result = 37 * result
