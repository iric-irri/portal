...
/**
 * InsertionBreakpointId generated by hbm2java
 */
public class InsertionBreakpointId implements java.io.Serializable {

	private Integer insertionBreakpointId;
	...
	public InsertionBreakpointId() {
	}

	public InsertionBreakpointId(Integer insertionBreakpointId,
		...
		this.insertionBreakpointId = insertionBreakpointId;
	...
	public Integer getInsertionBreakpointId() {
		return this.insertionBreakpointId;
	}

	public void setInsertionBreakpointId(Integer insertionBreakpointId) {
		this.insertionBreakpointId = insertionBreakpointId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionBreakpointId))
			return false;
		InsertionBreakpointId castOther = (InsertionBreakpointId) other;

		return ((this.getInsertionBreakpointId() == castOther
				.getInsertionBreakpointId()) || (this
				.getInsertionBreakpointId() != null
				&& castOther.getInsertionBreakpointId() != null && this
				.getInsertionBreakpointId().equals(
						castOther.getInsertionBreakpointId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionBreakpointId() == null ? 0 : this
						.getInsertionBreakpointId().hashCode());
		result = 37 * result
