...
/**
 * BluntEndRestrictionEnzymeCleavageSiteId generated by hbm2java
 */
public class BluntEndRestrictionEnzymeCleavageSiteId implements
		java.io.Serializable {

	private Integer bluntEndRestrictionEnzymeCleavageSiteId;
	...
	public BluntEndRestrictionEnzymeCleavageSiteId() {
	}

	public BluntEndRestrictionEnzymeCleavageSiteId(
			Integer bluntEndRestrictionEnzymeCleavageSiteId, Integer featureId,
		...
		this.bluntEndRestrictionEnzymeCleavageSiteId = bluntEndRestrictionEnzymeCleavageSiteId;
	...
	public Integer getBluntEndRestrictionEnzymeCleavageSiteId() {
		return this.bluntEndRestrictionEnzymeCleavageSiteId;
	}

	public void setBluntEndRestrictionEnzymeCleavageSiteId(
			Integer bluntEndRestrictionEnzymeCleavageSiteId) {
		this.bluntEndRestrictionEnzymeCleavageSiteId = bluntEndRestrictionEnzymeCleavageSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BluntEndRestrictionEnzymeCleavageSiteId))
			return false;
		BluntEndRestrictionEnzymeCleavageSiteId castOther = (BluntEndRestrictionEnzymeCleavageSiteId) other;

		return ((this.getBluntEndRestrictionEnzymeCleavageSiteId() == castOther
				.getBluntEndRestrictionEnzymeCleavageSiteId()) || (this
				.getBluntEndRestrictionEnzymeCleavageSiteId() != null
				&& castOther.getBluntEndRestrictionEnzymeCleavageSiteId() != null && this
				.getBluntEndRestrictionEnzymeCleavageSiteId().equals(
						castOther.getBluntEndRestrictionEnzymeCleavageSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBluntEndRestrictionEnzymeCleavageSiteId() == null ? 0
						: this.getBluntEndRestrictionEnzymeCleavageSiteId()
								.hashCode());
		result = 37 * result
