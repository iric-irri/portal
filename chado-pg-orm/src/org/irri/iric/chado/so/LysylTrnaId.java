...
/**
 * LysylTrnaId generated by hbm2java
 */
public class LysylTrnaId implements java.io.Serializable {

	private Integer lysylTrnaId;
	...
	public LysylTrnaId(Integer lysylTrnaId, Integer featureId,
	...
	public Integer getLysylTrnaId() {
		return this.lysylTrnaId;
	}

	public void setLysylTrnaId(Integer lysylTrnaId) {
		this.lysylTrnaId = lysylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LysylTrnaId))
			return false;
		LysylTrnaId castOther = (LysylTrnaId) other;

		return ((this.getLysylTrnaId() == castOther.getLysylTrnaId()) || (this
				.getLysylTrnaId() != null && castOther.getLysylTrnaId() != null && this
				.getLysylTrnaId().equals(castOther.getLysylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLysylTrnaId() == null ? 0 : this.getLysylTrnaId()
						.hashCode());
		result = 37 * result
