...
/**
 * VDDjCClusterId generated by hbm2java
 */
public class VDDjCClusterId implements java.io.Serializable {

	private Integer VDDjCClusterId;
	...
	public VDDjCClusterId() {
	}

	public VDDjCClusterId(Integer VDDjCClusterId, Integer featureId,
		...
		this.VDDjCClusterId = VDDjCClusterId;
	...
	public Integer getVDDjCClusterId() {
		return this.VDDjCClusterId;
	}

	public void setVDDjCClusterId(Integer VDDjCClusterId) {
		this.VDDjCClusterId = VDDjCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDDjCClusterId))
			return false;
		VDDjCClusterId castOther = (VDDjCClusterId) other;

		return ((this.getVDDjCClusterId() == castOther.getVDDjCClusterId()) || (this
				.getVDDjCClusterId() != null
				&& castOther.getVDDjCClusterId() != null && this
				.getVDDjCClusterId().equals(castOther.getVDDjCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDDjCClusterId() == null ? 0 : this.getVDDjCClusterId()
						.hashCode());
		result = 37 * result
