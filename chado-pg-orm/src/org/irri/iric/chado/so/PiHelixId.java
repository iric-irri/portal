...
/**
 * PiHelixId generated by hbm2java
 */
public class PiHelixId implements java.io.Serializable {

	private Integer piHelixId;
	...
	public PiHelixId(Integer piHelixId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPiHelixId() {
		return this.piHelixId;
	}

	public void setPiHelixId(Integer piHelixId) {
		this.piHelixId = piHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PiHelixId))
			return false;
		PiHelixId castOther = (PiHelixId) other;

		return ((this.getPiHelixId() == castOther.getPiHelixId()) || (this
				.getPiHelixId() != null && castOther.getPiHelixId() != null && this
				.getPiHelixId().equals(castOther.getPiHelixId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPiHelixId() == null ? 0 : this.getPiHelixId().hashCode());
		result = 37 * result
