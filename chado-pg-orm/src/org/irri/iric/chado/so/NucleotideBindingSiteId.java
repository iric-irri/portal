...
/**
 * NucleotideBindingSiteId generated by hbm2java
 */
public class NucleotideBindingSiteId implements java.io.Serializable {

	private Integer nucleotideBindingSiteId;
	...
	public NucleotideBindingSiteId() {
	}

	public NucleotideBindingSiteId(Integer nucleotideBindingSiteId,
		...
		this.nucleotideBindingSiteId = nucleotideBindingSiteId;
	...
	public Integer getNucleotideBindingSiteId() {
		return this.nucleotideBindingSiteId;
	}

	public void setNucleotideBindingSiteId(Integer nucleotideBindingSiteId) {
		this.nucleotideBindingSiteId = nucleotideBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleotideBindingSiteId))
			return false;
		NucleotideBindingSiteId castOther = (NucleotideBindingSiteId) other;

		return ((this.getNucleotideBindingSiteId() == castOther
				.getNucleotideBindingSiteId()) || (this
				.getNucleotideBindingSiteId() != null
				&& castOther.getNucleotideBindingSiteId() != null && this
				.getNucleotideBindingSiteId().equals(
						castOther.getNucleotideBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleotideBindingSiteId() == null ? 0 : this
						.getNucleotideBindingSiteId().hashCode());
		result = 37 * result
