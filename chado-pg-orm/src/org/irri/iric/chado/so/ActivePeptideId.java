...
/**
 * ActivePeptideId generated by hbm2java
 */
public class ActivePeptideId implements java.io.Serializable {

	private Integer activePeptideId;
	...
	public ActivePeptideId() {
	}

	public ActivePeptideId(Integer activePeptideId, Integer featureId,
		...
		this.activePeptideId = activePeptideId;
	...
	public Integer getActivePeptideId() {
		return this.activePeptideId;
	}

	public void setActivePeptideId(Integer activePeptideId) {
		this.activePeptideId = activePeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ActivePeptideId))
			return false;
		ActivePeptideId castOther = (ActivePeptideId) other;

		return ((this.getActivePeptideId() == castOther.getActivePeptideId()) || (this
				.getActivePeptideId() != null
				&& castOther.getActivePeptideId() != null && this
				.getActivePeptideId().equals(castOther.getActivePeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getActivePeptideId() == null ? 0 : this.getActivePeptideId()
						.hashCode());
		result = 37 * result
