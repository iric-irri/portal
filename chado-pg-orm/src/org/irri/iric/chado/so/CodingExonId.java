...
/**
 * CodingExonId generated by hbm2java
 */
public class CodingExonId implements java.io.Serializable {

	private Integer codingExonId;
	...
	public CodingExonId(Integer codingExonId, Integer featureId,
		...
		this.codingExonId = codingExonId;
	...
	public Integer getCodingExonId() {
		return this.codingExonId;
	}

	public void setCodingExonId(Integer codingExonId) {
		this.codingExonId = codingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingExonId))
			return false;
		CodingExonId castOther = (CodingExonId) other;

		return ((this.getCodingExonId() == castOther.getCodingExonId()) || (this
				.getCodingExonId() != null
				&& castOther.getCodingExonId() != null && this
				.getCodingExonId().equals(castOther.getCodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingExonId() == null ? 0 : this.getCodingExonId()
						.hashCode());
		result = 37 * result
