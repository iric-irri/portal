...
/**
 * PnaId generated by hbm2java
 */
public class PnaId implements java.io.Serializable {

	private Integer pnaId;
	...
	public PnaId(Integer pnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPnaId() {
		return this.pnaId;
	}

	public void setPnaId(Integer pnaId) {
		this.pnaId = pnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PnaId))
			return false;
		PnaId castOther = (PnaId) other;

		return ((this.getPnaId() == castOther.getPnaId()) || (this.getPnaId() != null
				&& castOther.getPnaId() != null && this.getPnaId().equals(
				castOther.getPnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getPnaId() == null ? 0 : this.getPnaId().hashCode());
		result = 37 * result
