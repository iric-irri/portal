...
/**
 * ParallelBetaStrandId generated by hbm2java
 */
public class ParallelBetaStrandId implements java.io.Serializable {

	private Integer parallelBetaStrandId;
	...
	public ParallelBetaStrandId() {
	}

	public ParallelBetaStrandId(Integer parallelBetaStrandId,
		...
		this.parallelBetaStrandId = parallelBetaStrandId;
	...
	public Integer getParallelBetaStrandId() {
		return this.parallelBetaStrandId;
	}

	public void setParallelBetaStrandId(Integer parallelBetaStrandId) {
		this.parallelBetaStrandId = parallelBetaStrandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParallelBetaStrandId))
			return false;
		ParallelBetaStrandId castOther = (ParallelBetaStrandId) other;

		return ((this.getParallelBetaStrandId() == castOther
				.getParallelBetaStrandId()) || (this.getParallelBetaStrandId() != null
				&& castOther.getParallelBetaStrandId() != null && this
				.getParallelBetaStrandId().equals(
						castOther.getParallelBetaStrandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getParallelBetaStrandId() == null ? 0 : this
						.getParallelBetaStrandId().hashCode());
		result = 37 * result
