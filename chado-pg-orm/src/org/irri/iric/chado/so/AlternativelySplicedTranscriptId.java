...
/**
 * AlternativelySplicedTranscriptId generated by hbm2java
 */
public class AlternativelySplicedTranscriptId implements java.io.Serializable {

	private Integer alternativelySplicedTranscriptId;
	...
	public AlternativelySplicedTranscriptId() {
	}

	public AlternativelySplicedTranscriptId(
			Integer alternativelySplicedTranscriptId, Integer featureId,
		...
		this.alternativelySplicedTranscriptId = alternativelySplicedTranscriptId;
	...
	public Integer getAlternativelySplicedTranscriptId() {
		return this.alternativelySplicedTranscriptId;
	}

	public void setAlternativelySplicedTranscriptId(
			Integer alternativelySplicedTranscriptId) {
		this.alternativelySplicedTranscriptId = alternativelySplicedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlternativelySplicedTranscriptId))
			return false;
		AlternativelySplicedTranscriptId castOther = (AlternativelySplicedTranscriptId) other;

		return ((this.getAlternativelySplicedTranscriptId() == castOther
				.getAlternativelySplicedTranscriptId()) || (this
				.getAlternativelySplicedTranscriptId() != null
				&& castOther.getAlternativelySplicedTranscriptId() != null && this
				.getAlternativelySplicedTranscriptId().equals(
						castOther.getAlternativelySplicedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlternativelySplicedTranscriptId() == null ? 0 : this
						.getAlternativelySplicedTranscriptId().hashCode());
		result = 37 * result
