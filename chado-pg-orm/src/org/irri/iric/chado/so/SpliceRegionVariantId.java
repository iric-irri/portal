...
/**
 * SpliceRegionVariantId generated by hbm2java
 */
public class SpliceRegionVariantId implements java.io.Serializable {

	private Integer spliceRegionVariantId;
	...
	public SpliceRegionVariantId() {
	}

	public SpliceRegionVariantId(Integer spliceRegionVariantId,
		...
		this.spliceRegionVariantId = spliceRegionVariantId;
	...
	public Integer getSpliceRegionVariantId() {
		return this.spliceRegionVariantId;
	}

	public void setSpliceRegionVariantId(Integer spliceRegionVariantId) {
		this.spliceRegionVariantId = spliceRegionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceRegionVariantId))
			return false;
		SpliceRegionVariantId castOther = (SpliceRegionVariantId) other;

		return ((this.getSpliceRegionVariantId() == castOther
				.getSpliceRegionVariantId()) || (this
				.getSpliceRegionVariantId() != null
				&& castOther.getSpliceRegionVariantId() != null && this
				.getSpliceRegionVariantId().equals(
						castOther.getSpliceRegionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceRegionVariantId() == null ? 0 : this
						.getSpliceRegionVariantId().hashCode());
		result = 37 * result
