...
/**
 * RepeatComponentId generated by hbm2java
 */
public class RepeatComponentId implements java.io.Serializable {

	private Integer repeatComponentId;
	...
	public RepeatComponentId() {
	}

	public RepeatComponentId(Integer repeatComponentId, Integer featureId,
		...
		this.repeatComponentId = repeatComponentId;
	...
	public Integer getRepeatComponentId() {
		return this.repeatComponentId;
	}

	public void setRepeatComponentId(Integer repeatComponentId) {
		this.repeatComponentId = repeatComponentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RepeatComponentId))
			return false;
		RepeatComponentId castOther = (RepeatComponentId) other;

		return ((this.getRepeatComponentId() == castOther
				.getRepeatComponentId()) || (this.getRepeatComponentId() != null
				&& castOther.getRepeatComponentId() != null && this
				.getRepeatComponentId()
				.equals(castOther.getRepeatComponentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRepeatComponentId() == null ? 0 : this
						.getRepeatComponentId().hashCode());
		result = 37 * result
