...
/**
 * WcBasePairId generated by hbm2java
 */
public class WcBasePairId implements java.io.Serializable {

	private Integer wcBasePairId;
	...
	public WcBasePairId(Integer wcBasePairId, Integer featureId,
		...
		this.wcBasePairId = wcBasePairId;
	...
	public Integer getWcBasePairId() {
		return this.wcBasePairId;
	}

	public void setWcBasePairId(Integer wcBasePairId) {
		this.wcBasePairId = wcBasePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WcBasePairId))
			return false;
		WcBasePairId castOther = (WcBasePairId) other;

		return ((this.getWcBasePairId() == castOther.getWcBasePairId()) || (this
				.getWcBasePairId() != null
				&& castOther.getWcBasePairId() != null && this
				.getWcBasePairId().equals(castOther.getWcBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWcBasePairId() == null ? 0 : this.getWcBasePairId()
						.hashCode());
		result = 37 * result
