...
/**
 * PromoterTrapConstructId generated by hbm2java
 */
public class PromoterTrapConstructId implements java.io.Serializable {

	private Integer promoterTrapConstructId;
	...
	public PromoterTrapConstructId() {
	}

	public PromoterTrapConstructId(Integer promoterTrapConstructId,
		...
		this.promoterTrapConstructId = promoterTrapConstructId;
	...
	public Integer getPromoterTrapConstructId() {
		return this.promoterTrapConstructId;
	}

	public void setPromoterTrapConstructId(Integer promoterTrapConstructId) {
		this.promoterTrapConstructId = promoterTrapConstructId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PromoterTrapConstructId))
			return false;
		PromoterTrapConstructId castOther = (PromoterTrapConstructId) other;

		return ((this.getPromoterTrapConstructId() == castOther
				.getPromoterTrapConstructId()) || (this
				.getPromoterTrapConstructId() != null
				&& castOther.getPromoterTrapConstructId() != null && this
				.getPromoterTrapConstructId().equals(
						castOther.getPromoterTrapConstructId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPromoterTrapConstructId() == null ? 0 : this
						.getPromoterTrapConstructId().hashCode());
		result = 37 * result
