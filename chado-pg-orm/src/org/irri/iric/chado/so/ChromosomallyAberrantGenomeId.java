...
/**
 * ChromosomallyAberrantGenomeId generated by hbm2java
 */
public class ChromosomallyAberrantGenomeId implements java.io.Serializable {

	private Integer chromosomallyAberrantGenomeId;
	...
	public ChromosomallyAberrantGenomeId() {
	}

	public ChromosomallyAberrantGenomeId(Integer chromosomallyAberrantGenomeId,
		...
		this.chromosomallyAberrantGenomeId = chromosomallyAberrantGenomeId;
	...
	public Integer getChromosomallyAberrantGenomeId() {
		return this.chromosomallyAberrantGenomeId;
	}

	public void setChromosomallyAberrantGenomeId(
			Integer chromosomallyAberrantGenomeId) {
		this.chromosomallyAberrantGenomeId = chromosomallyAberrantGenomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomallyAberrantGenomeId))
			return false;
		ChromosomallyAberrantGenomeId castOther = (ChromosomallyAberrantGenomeId) other;

		return ((this.getChromosomallyAberrantGenomeId() == castOther
				.getChromosomallyAberrantGenomeId()) || (this
				.getChromosomallyAberrantGenomeId() != null
				&& castOther.getChromosomallyAberrantGenomeId() != null && this
				.getChromosomallyAberrantGenomeId().equals(
						castOther.getChromosomallyAberrantGenomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomallyAberrantGenomeId() == null ? 0 : this
						.getChromosomallyAberrantGenomeId().hashCode());
		result = 37 * result
