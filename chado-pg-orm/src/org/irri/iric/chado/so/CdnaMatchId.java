...
/**
 * CdnaMatchId generated by hbm2java
 */
public class CdnaMatchId implements java.io.Serializable {

	private Integer cdnaMatchId;
	...
	public CdnaMatchId(Integer cdnaMatchId, Integer featureId,
	...
	public Integer getCdnaMatchId() {
		return this.cdnaMatchId;
	}

	public void setCdnaMatchId(Integer cdnaMatchId) {
		this.cdnaMatchId = cdnaMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdnaMatchId))
			return false;
		CdnaMatchId castOther = (CdnaMatchId) other;

		return ((this.getCdnaMatchId() == castOther.getCdnaMatchId()) || (this
				.getCdnaMatchId() != null && castOther.getCdnaMatchId() != null && this
				.getCdnaMatchId().equals(castOther.getCdnaMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdnaMatchId() == null ? 0 : this.getCdnaMatchId()
						.hashCode());
		result = 37 * result
