...
/**
 * DreMotifId generated by hbm2java
 */
public class DreMotifId implements java.io.Serializable {

	private Integer dreMotifId;
	...
	public DreMotifId(Integer dreMotifId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDreMotifId() {
		return this.dreMotifId;
	}

	public void setDreMotifId(Integer dreMotifId) {
		this.dreMotifId = dreMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DreMotifId))
			return false;
		DreMotifId castOther = (DreMotifId) other;

		return ((this.getDreMotifId() == castOther.getDreMotifId()) || (this
				.getDreMotifId() != null && castOther.getDreMotifId() != null && this
				.getDreMotifId().equals(castOther.getDreMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDreMotifId() == null ? 0 : this.getDreMotifId()
						.hashCode());
		result = 37 * result
