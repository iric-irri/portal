 ...
 * @see org.irri.iric.chado.so.Score
...
public class ScoreHome {
	...
	public Score merge(Score detachedInstance) {
		...
		try {
			Score result = (Score) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Score findById(org.irri.iric.chado.so.ScoreId id) {
		log.debug("getting Score instance with id: " + id);
		try {
			Score instance = (Score) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.so.Score", id);
			if (instance == null) {
	...
	public List findByExample(Score instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Score")
