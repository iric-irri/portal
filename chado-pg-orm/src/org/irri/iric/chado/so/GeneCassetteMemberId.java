...
/**
 * GeneCassetteMemberId generated by hbm2java
 */
public class GeneCassetteMemberId implements java.io.Serializable {

	private Integer geneCassetteMemberId;
	...
	public GeneCassetteMemberId() {
	}

	public GeneCassetteMemberId(Integer geneCassetteMemberId,
		...
		this.geneCassetteMemberId = geneCassetteMemberId;
	...
	public Integer getGeneCassetteMemberId() {
		return this.geneCassetteMemberId;
	}

	public void setGeneCassetteMemberId(Integer geneCassetteMemberId) {
		this.geneCassetteMemberId = geneCassetteMemberId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneCassetteMemberId))
			return false;
		GeneCassetteMemberId castOther = (GeneCassetteMemberId) other;

		return ((this.getGeneCassetteMemberId() == castOther
				.getGeneCassetteMemberId()) || (this.getGeneCassetteMemberId() != null
				&& castOther.getGeneCassetteMemberId() != null && this
				.getGeneCassetteMemberId().equals(
						castOther.getGeneCassetteMemberId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneCassetteMemberId() == null ? 0 : this
						.getGeneCassetteMemberId().hashCode());
		result = 37 * result
