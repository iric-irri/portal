...
/**
 * AttenuatorId generated by hbm2java
 */
public class AttenuatorId implements java.io.Serializable {
	...
	public AttenuatorId(Integer attenuatorId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttenuatorId))
			return false;
		AttenuatorId castOther = (AttenuatorId) other;

		return ((this.getAttenuatorId() == castOther.getAttenuatorId()) || (this
				.getAttenuatorId() != null
				&& castOther.getAttenuatorId() != null && this
				.getAttenuatorId().equals(castOther.getAttenuatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttenuatorId() == null ? 0 : this.getAttenuatorId()
						.hashCode());
		result = 37 * result
