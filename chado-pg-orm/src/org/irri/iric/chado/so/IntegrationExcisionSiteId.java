...
/**
 * IntegrationExcisionSiteId generated by hbm2java
 */
public class IntegrationExcisionSiteId implements java.io.Serializable {

	private Integer integrationExcisionSiteId;
	...
	public IntegrationExcisionSiteId() {
	}

	public IntegrationExcisionSiteId(Integer integrationExcisionSiteId,
		...
		this.integrationExcisionSiteId = integrationExcisionSiteId;
	...
	public Integer getIntegrationExcisionSiteId() {
		return this.integrationExcisionSiteId;
	}

	public void setIntegrationExcisionSiteId(Integer integrationExcisionSiteId) {
		this.integrationExcisionSiteId = integrationExcisionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntegrationExcisionSiteId))
			return false;
		IntegrationExcisionSiteId castOther = (IntegrationExcisionSiteId) other;

		return ((this.getIntegrationExcisionSiteId() == castOther
				.getIntegrationExcisionSiteId()) || (this
				.getIntegrationExcisionSiteId() != null
				&& castOther.getIntegrationExcisionSiteId() != null && this
				.getIntegrationExcisionSiteId().equals(
						castOther.getIntegrationExcisionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntegrationExcisionSiteId() == null ? 0 : this
						.getIntegrationExcisionSiteId().hashCode());
		result = 37 * result
