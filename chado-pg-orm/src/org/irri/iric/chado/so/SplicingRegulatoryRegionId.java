...
/**
 * SplicingRegulatoryRegionId generated by hbm2java
 */
public class SplicingRegulatoryRegionId implements java.io.Serializable {

	private Integer splicingRegulatoryRegionId;
	...
	public SplicingRegulatoryRegionId() {
	}

	public SplicingRegulatoryRegionId(Integer splicingRegulatoryRegionId,
		...
		this.splicingRegulatoryRegionId = splicingRegulatoryRegionId;
	...
	public Integer getSplicingRegulatoryRegionId() {
		return this.splicingRegulatoryRegionId;
	}

	public void setSplicingRegulatoryRegionId(Integer splicingRegulatoryRegionId) {
		this.splicingRegulatoryRegionId = splicingRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SplicingRegulatoryRegionId))
			return false;
		SplicingRegulatoryRegionId castOther = (SplicingRegulatoryRegionId) other;

		return ((this.getSplicingRegulatoryRegionId() == castOther
				.getSplicingRegulatoryRegionId()) || (this
				.getSplicingRegulatoryRegionId() != null
				&& castOther.getSplicingRegulatoryRegionId() != null && this
				.getSplicingRegulatoryRegionId().equals(
						castOther.getSplicingRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSplicingRegulatoryRegionId() == null ? 0 : this
						.getSplicingRegulatoryRegionId().hashCode());
		result = 37 * result
