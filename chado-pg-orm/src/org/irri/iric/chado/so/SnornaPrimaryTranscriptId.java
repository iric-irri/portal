...
/**
 * SnornaPrimaryTranscriptId generated by hbm2java
 */
public class SnornaPrimaryTranscriptId implements java.io.Serializable {

	private Integer snornaPrimaryTranscriptId;
	...
	public SnornaPrimaryTranscriptId() {
	}

	public SnornaPrimaryTranscriptId(Integer snornaPrimaryTranscriptId,
		...
		this.snornaPrimaryTranscriptId = snornaPrimaryTranscriptId;
	...
	public Integer getSnornaPrimaryTranscriptId() {
		return this.snornaPrimaryTranscriptId;
	}

	public void setSnornaPrimaryTranscriptId(Integer snornaPrimaryTranscriptId) {
		this.snornaPrimaryTranscriptId = snornaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnornaPrimaryTranscriptId))
			return false;
		SnornaPrimaryTranscriptId castOther = (SnornaPrimaryTranscriptId) other;

		return ((this.getSnornaPrimaryTranscriptId() == castOther
				.getSnornaPrimaryTranscriptId()) || (this
				.getSnornaPrimaryTranscriptId() != null
				&& castOther.getSnornaPrimaryTranscriptId() != null && this
				.getSnornaPrimaryTranscriptId().equals(
						castOther.getSnornaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnornaPrimaryTranscriptId() == null ? 0 : this
						.getSnornaPrimaryTranscriptId().hashCode());
		result = 37 * result
