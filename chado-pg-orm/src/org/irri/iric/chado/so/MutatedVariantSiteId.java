...
/**
 * MutatedVariantSiteId generated by hbm2java
 */
public class MutatedVariantSiteId implements java.io.Serializable {

	private Integer mutatedVariantSiteId;
	...
	public MutatedVariantSiteId() {
	}

	public MutatedVariantSiteId(Integer mutatedVariantSiteId,
		...
		this.mutatedVariantSiteId = mutatedVariantSiteId;
	...
	public Integer getMutatedVariantSiteId() {
		return this.mutatedVariantSiteId;
	}

	public void setMutatedVariantSiteId(Integer mutatedVariantSiteId) {
		this.mutatedVariantSiteId = mutatedVariantSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MutatedVariantSiteId))
			return false;
		MutatedVariantSiteId castOther = (MutatedVariantSiteId) other;

		return ((this.getMutatedVariantSiteId() == castOther
				.getMutatedVariantSiteId()) || (this.getMutatedVariantSiteId() != null
				&& castOther.getMutatedVariantSiteId() != null && this
				.getMutatedVariantSiteId().equals(
						castOther.getMutatedVariantSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMutatedVariantSiteId() == null ? 0 : this
						.getMutatedVariantSiteId().hashCode());
		result = 37 * result
