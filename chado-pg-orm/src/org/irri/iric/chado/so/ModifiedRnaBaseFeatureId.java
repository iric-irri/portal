...
/**
 * ModifiedRnaBaseFeatureId generated by hbm2java
 */
public class ModifiedRnaBaseFeatureId implements java.io.Serializable {

	private Integer modifiedRnaBaseFeatureId;
	...
	public ModifiedRnaBaseFeatureId() {
	}

	public ModifiedRnaBaseFeatureId(Integer modifiedRnaBaseFeatureId,
		...
		this.modifiedRnaBaseFeatureId = modifiedRnaBaseFeatureId;
	...
	public Integer getModifiedRnaBaseFeatureId() {
		return this.modifiedRnaBaseFeatureId;
	}

	public void setModifiedRnaBaseFeatureId(Integer modifiedRnaBaseFeatureId) {
		this.modifiedRnaBaseFeatureId = modifiedRnaBaseFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedRnaBaseFeatureId))
			return false;
		ModifiedRnaBaseFeatureId castOther = (ModifiedRnaBaseFeatureId) other;

		return ((this.getModifiedRnaBaseFeatureId() == castOther
				.getModifiedRnaBaseFeatureId()) || (this
				.getModifiedRnaBaseFeatureId() != null
				&& castOther.getModifiedRnaBaseFeatureId() != null && this
				.getModifiedRnaBaseFeatureId().equals(
						castOther.getModifiedRnaBaseFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedRnaBaseFeatureId() == null ? 0 : this
						.getModifiedRnaBaseFeatureId().hashCode());
		result = 37 * result
