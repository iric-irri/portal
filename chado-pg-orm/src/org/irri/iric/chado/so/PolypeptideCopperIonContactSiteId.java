...
/**
 * PolypeptideCopperIonContactSiteId generated by hbm2java
 */
public class PolypeptideCopperIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideCopperIonContactSiteId;
	...
	public PolypeptideCopperIonContactSiteId() {
	}

	public PolypeptideCopperIonContactSiteId(
			Integer polypeptideCopperIonContactSiteId, Integer featureId,
		...
		this.polypeptideCopperIonContactSiteId = polypeptideCopperIonContactSiteId;
	...
	public Integer getPolypeptideCopperIonContactSiteId() {
		return this.polypeptideCopperIonContactSiteId;
	}

	public void setPolypeptideCopperIonContactSiteId(
			Integer polypeptideCopperIonContactSiteId) {
		this.polypeptideCopperIonContactSiteId = polypeptideCopperIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideCopperIonContactSiteId))
			return false;
		PolypeptideCopperIonContactSiteId castOther = (PolypeptideCopperIonContactSiteId) other;

		return ((this.getPolypeptideCopperIonContactSiteId() == castOther
				.getPolypeptideCopperIonContactSiteId()) || (this
				.getPolypeptideCopperIonContactSiteId() != null
				&& castOther.getPolypeptideCopperIonContactSiteId() != null && this
				.getPolypeptideCopperIonContactSiteId().equals(
						castOther.getPolypeptideCopperIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideCopperIonContactSiteId() == null ? 0 : this
						.getPolypeptideCopperIonContactSiteId().hashCode());
		result = 37 * result
