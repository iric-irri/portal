...
/**
 * FivePrimeUtrVariantId generated by hbm2java
 */
public class FivePrimeUtrVariantId implements java.io.Serializable {

	private Integer fivePrimeUtrVariantId;
	...
	public FivePrimeUtrVariantId() {
	}

	public FivePrimeUtrVariantId(Integer fivePrimeUtrVariantId,
		...
		this.fivePrimeUtrVariantId = fivePrimeUtrVariantId;
	...
	public Integer getFivePrimeUtrVariantId() {
		return this.fivePrimeUtrVariantId;
	}

	public void setFivePrimeUtrVariantId(Integer fivePrimeUtrVariantId) {
		this.fivePrimeUtrVariantId = fivePrimeUtrVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeUtrVariantId))
			return false;
		FivePrimeUtrVariantId castOther = (FivePrimeUtrVariantId) other;

		return ((this.getFivePrimeUtrVariantId() == castOther
				.getFivePrimeUtrVariantId()) || (this
				.getFivePrimeUtrVariantId() != null
				&& castOther.getFivePrimeUtrVariantId() != null && this
				.getFivePrimeUtrVariantId().equals(
						castOther.getFivePrimeUtrVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeUtrVariantId() == null ? 0 : this
						.getFivePrimeUtrVariantId().hashCode());
		result = 37 * result
