...
/**
 * FivePrimeTerminalInvertedRepeatId generated by hbm2java
 */
public class FivePrimeTerminalInvertedRepeatId implements java.io.Serializable {

	private Integer fivePrimeTerminalInvertedRepeatId;
	...
	public FivePrimeTerminalInvertedRepeatId() {
	}

	public FivePrimeTerminalInvertedRepeatId(
			Integer fivePrimeTerminalInvertedRepeatId, Integer featureId,
		...
		this.fivePrimeTerminalInvertedRepeatId = fivePrimeTerminalInvertedRepeatId;
	...
	public Integer getFivePrimeTerminalInvertedRepeatId() {
		return this.fivePrimeTerminalInvertedRepeatId;
	}

	public void setFivePrimeTerminalInvertedRepeatId(
			Integer fivePrimeTerminalInvertedRepeatId) {
		this.fivePrimeTerminalInvertedRepeatId = fivePrimeTerminalInvertedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeTerminalInvertedRepeatId))
			return false;
		FivePrimeTerminalInvertedRepeatId castOther = (FivePrimeTerminalInvertedRepeatId) other;

		return ((this.getFivePrimeTerminalInvertedRepeatId() == castOther
				.getFivePrimeTerminalInvertedRepeatId()) || (this
				.getFivePrimeTerminalInvertedRepeatId() != null
				&& castOther.getFivePrimeTerminalInvertedRepeatId() != null && this
				.getFivePrimeTerminalInvertedRepeatId().equals(
						castOther.getFivePrimeTerminalInvertedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeTerminalInvertedRepeatId() == null ? 0 : this
						.getFivePrimeTerminalInvertedRepeatId().hashCode());
		result = 37 * result
