...
/**
 * ThreePrimeCodingExonCodingRegionId generated by hbm2java
 */
public class ThreePrimeCodingExonCodingRegionId implements java.io.Serializable {

	private Integer threePrimeCodingExonCodingRegionId;
	...
	public ThreePrimeCodingExonCodingRegionId() {
	}

	public ThreePrimeCodingExonCodingRegionId(
			Integer threePrimeCodingExonCodingRegionId, Integer featureId,
		...
		this.threePrimeCodingExonCodingRegionId = threePrimeCodingExonCodingRegionId;
	...
	public Integer getThreePrimeCodingExonCodingRegionId() {
		return this.threePrimeCodingExonCodingRegionId;
	}

	public void setThreePrimeCodingExonCodingRegionId(
			Integer threePrimeCodingExonCodingRegionId) {
		this.threePrimeCodingExonCodingRegionId = threePrimeCodingExonCodingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeCodingExonCodingRegionId))
			return false;
		ThreePrimeCodingExonCodingRegionId castOther = (ThreePrimeCodingExonCodingRegionId) other;

		return ((this.getThreePrimeCodingExonCodingRegionId() == castOther
				.getThreePrimeCodingExonCodingRegionId()) || (this
				.getThreePrimeCodingExonCodingRegionId() != null
				&& castOther.getThreePrimeCodingExonCodingRegionId() != null && this
				.getThreePrimeCodingExonCodingRegionId().equals(
						castOther.getThreePrimeCodingExonCodingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeCodingExonCodingRegionId() == null ? 0 : this
						.getThreePrimeCodingExonCodingRegionId().hashCode());
		result = 37 * result
