...
/**
 * Rrna5sId generated by hbm2java
 */
public class Rrna5sId implements java.io.Serializable {

	private Integer rrna5sId;
	...
	public Rrna5sId(Integer rrna5sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna5sId() {
		return this.rrna5sId;
	}

	public void setRrna5sId(Integer rrna5sId) {
		this.rrna5sId = rrna5sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna5sId))
			return false;
		Rrna5sId castOther = (Rrna5sId) other;

		return ((this.getRrna5sId() == castOther.getRrna5sId()) || (this
				.getRrna5sId() != null && castOther.getRrna5sId() != null && this
				.getRrna5sId().equals(castOther.getRrna5sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna5sId() == null ? 0 : this.getRrna5sId().hashCode());
		result = 37 * result
