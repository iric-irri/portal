...
/**
 * GagaMotifId generated by hbm2java
 */
public class GagaMotifId implements java.io.Serializable {

	private Integer gagaMotifId;
	...
	public GagaMotifId(Integer gagaMotifId, Integer featureId,
	...
	public Integer getGagaMotifId() {
		return this.gagaMotifId;
	}

	public void setGagaMotifId(Integer gagaMotifId) {
		this.gagaMotifId = gagaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GagaMotifId))
			return false;
		GagaMotifId castOther = (GagaMotifId) other;

		return ((this.getGagaMotifId() == castOther.getGagaMotifId()) || (this
				.getGagaMotifId() != null && castOther.getGagaMotifId() != null && this
				.getGagaMotifId().equals(castOther.getGagaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGagaMotifId() == null ? 0 : this.getGagaMotifId()
						.hashCode());
		result = 37 * result
