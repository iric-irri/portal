...
/**
 * ModifiedUridineId generated by hbm2java
 */
public class ModifiedUridineId implements java.io.Serializable {

	private Integer modifiedUridineId;
	...
	public ModifiedUridineId() {
	}

	public ModifiedUridineId(Integer modifiedUridineId, Integer featureId,
		...
		this.modifiedUridineId = modifiedUridineId;
	...
	public Integer getModifiedUridineId() {
		return this.modifiedUridineId;
	}

	public void setModifiedUridineId(Integer modifiedUridineId) {
		this.modifiedUridineId = modifiedUridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedUridineId))
			return false;
		ModifiedUridineId castOther = (ModifiedUridineId) other;

		return ((this.getModifiedUridineId() == castOther
				.getModifiedUridineId()) || (this.getModifiedUridineId() != null
				&& castOther.getModifiedUridineId() != null && this
				.getModifiedUridineId()
				.equals(castOther.getModifiedUridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedUridineId() == null ? 0 : this
						.getModifiedUridineId().hashCode());
		result = 37 * result
