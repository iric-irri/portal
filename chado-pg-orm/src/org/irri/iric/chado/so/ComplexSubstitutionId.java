...
/**
 * ComplexSubstitutionId generated by hbm2java
 */
public class ComplexSubstitutionId implements java.io.Serializable {

	private Integer complexSubstitutionId;
	...
	public ComplexSubstitutionId() {
	}

	public ComplexSubstitutionId(Integer complexSubstitutionId,
		...
		this.complexSubstitutionId = complexSubstitutionId;
	...
	public Integer getComplexSubstitutionId() {
		return this.complexSubstitutionId;
	}

	public void setComplexSubstitutionId(Integer complexSubstitutionId) {
		this.complexSubstitutionId = complexSubstitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComplexSubstitutionId))
			return false;
		ComplexSubstitutionId castOther = (ComplexSubstitutionId) other;

		return ((this.getComplexSubstitutionId() == castOther
				.getComplexSubstitutionId()) || (this
				.getComplexSubstitutionId() != null
				&& castOther.getComplexSubstitutionId() != null && this
				.getComplexSubstitutionId().equals(
						castOther.getComplexSubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplexSubstitutionId() == null ? 0 : this
						.getComplexSubstitutionId().hashCode());
		result = 37 * result
