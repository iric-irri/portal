...
/**
 * InterchromosomalDuplicationId generated by hbm2java
 */
public class InterchromosomalDuplicationId implements java.io.Serializable {

	private Integer interchromosomalDuplicationId;
	...
	public InterchromosomalDuplicationId() {
	}

	public InterchromosomalDuplicationId(Integer interchromosomalDuplicationId,
		...
		this.interchromosomalDuplicationId = interchromosomalDuplicationId;
	...
	public Integer getInterchromosomalDuplicationId() {
		return this.interchromosomalDuplicationId;
	}

	public void setInterchromosomalDuplicationId(
			Integer interchromosomalDuplicationId) {
		this.interchromosomalDuplicationId = interchromosomalDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InterchromosomalDuplicationId))
			return false;
		InterchromosomalDuplicationId castOther = (InterchromosomalDuplicationId) other;

		return ((this.getInterchromosomalDuplicationId() == castOther
				.getInterchromosomalDuplicationId()) || (this
				.getInterchromosomalDuplicationId() != null
				&& castOther.getInterchromosomalDuplicationId() != null && this
				.getInterchromosomalDuplicationId().equals(
						castOther.getInterchromosomalDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInterchromosomalDuplicationId() == null ? 0 : this
						.getInterchromosomalDuplicationId().hashCode());
		result = 37 * result
