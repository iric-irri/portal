...
/**
 * PolymerAttributeId generated by hbm2java
 */
public class PolymerAttributeId implements java.io.Serializable {

	private Integer polymerAttributeId;
	...
	public PolymerAttributeId() {
	}

	public PolymerAttributeId(Integer polymerAttributeId, Integer featureId,
		...
		this.polymerAttributeId = polymerAttributeId;
	...
	public Integer getPolymerAttributeId() {
		return this.polymerAttributeId;
	}

	public void setPolymerAttributeId(Integer polymerAttributeId) {
		this.polymerAttributeId = polymerAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolymerAttributeId))
			return false;
		PolymerAttributeId castOther = (PolymerAttributeId) other;

		return ((this.getPolymerAttributeId() == castOther
				.getPolymerAttributeId()) || (this.getPolymerAttributeId() != null
				&& castOther.getPolymerAttributeId() != null && this
				.getPolymerAttributeId().equals(
						castOther.getPolymerAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolymerAttributeId() == null ? 0 : this
						.getPolymerAttributeId().hashCode());
		result = 37 * result
