...
/**
 * PolypeptideSequencingInformationId generated by hbm2java
 */
public class PolypeptideSequencingInformationId implements java.io.Serializable {

	private Integer polypeptideSequencingInformationId;
	...
	public PolypeptideSequencingInformationId() {
	}

	public PolypeptideSequencingInformationId(
			Integer polypeptideSequencingInformationId, Integer featureId,
		...
		this.polypeptideSequencingInformationId = polypeptideSequencingInformationId;
	...
	public Integer getPolypeptideSequencingInformationId() {
		return this.polypeptideSequencingInformationId;
	}

	public void setPolypeptideSequencingInformationId(
			Integer polypeptideSequencingInformationId) {
		this.polypeptideSequencingInformationId = polypeptideSequencingInformationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideSequencingInformationId))
			return false;
		PolypeptideSequencingInformationId castOther = (PolypeptideSequencingInformationId) other;

		return ((this.getPolypeptideSequencingInformationId() == castOther
				.getPolypeptideSequencingInformationId()) || (this
				.getPolypeptideSequencingInformationId() != null
				&& castOther.getPolypeptideSequencingInformationId() != null && this
				.getPolypeptideSequencingInformationId().equals(
						castOther.getPolypeptideSequencingInformationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideSequencingInformationId() == null ? 0 : this
						.getPolypeptideSequencingInformationId().hashCode());
		result = 37 * result
