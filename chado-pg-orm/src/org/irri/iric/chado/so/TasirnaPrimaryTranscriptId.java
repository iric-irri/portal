...
/**
 * TasirnaPrimaryTranscriptId generated by hbm2java
 */
public class TasirnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer tasirnaPrimaryTranscriptId;
	...
	public TasirnaPrimaryTranscriptId() {
	}

	public TasirnaPrimaryTranscriptId(Integer tasirnaPrimaryTranscriptId,
		...
		this.tasirnaPrimaryTranscriptId = tasirnaPrimaryTranscriptId;
	...
	public Integer getTasirnaPrimaryTranscriptId() {
		return this.tasirnaPrimaryTranscriptId;
	}

	public void setTasirnaPrimaryTranscriptId(Integer tasirnaPrimaryTranscriptId) {
		this.tasirnaPrimaryTranscriptId = tasirnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TasirnaPrimaryTranscriptId))
			return false;
		TasirnaPrimaryTranscriptId castOther = (TasirnaPrimaryTranscriptId) other;

		return ((this.getTasirnaPrimaryTranscriptId() == castOther
				.getTasirnaPrimaryTranscriptId()) || (this
				.getTasirnaPrimaryTranscriptId() != null
				&& castOther.getTasirnaPrimaryTranscriptId() != null && this
				.getTasirnaPrimaryTranscriptId().equals(
						castOther.getTasirnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTasirnaPrimaryTranscriptId() == null ? 0 : this
						.getTasirnaPrimaryTranscriptId().hashCode());
		result = 37 * result
