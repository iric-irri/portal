...
/**
 * EditingDomainId generated by hbm2java
 */
public class EditingDomainId implements java.io.Serializable {

	private Integer editingDomainId;
	...
	public EditingDomainId() {
	}

	public EditingDomainId(Integer editingDomainId, Integer featureId,
	...
	public Integer getEditingDomainId() {
		return this.editingDomainId;
	}

	public void setEditingDomainId(Integer editingDomainId) {
		this.editingDomainId = editingDomainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditingDomainId))
			return false;
		EditingDomainId castOther = (EditingDomainId) other;

		return ((this.getEditingDomainId() == castOther.getEditingDomainId()) || (this
				.getEditingDomainId() != null
				&& castOther.getEditingDomainId() != null && this
				.getEditingDomainId().equals(castOther.getEditingDomainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditingDomainId() == null ? 0 : this.getEditingDomainId()
						.hashCode());
		result = 37 * result
