...
/**
 * ReversePrimerId generated by hbm2java
 */
public class ReversePrimerId implements java.io.Serializable {
	...
	public ReversePrimerId() {
	}

	public ReversePrimerId(Integer reversePrimerId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReversePrimerId))
			return false;
		ReversePrimerId castOther = (ReversePrimerId) other;

		return ((this.getReversePrimerId() == castOther.getReversePrimerId()) || (this
				.getReversePrimerId() != null
				&& castOther.getReversePrimerId() != null && this
				.getReversePrimerId().equals(castOther.getReversePrimerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReversePrimerId() == null ? 0 : this.getReversePrimerId()
						.hashCode());
		result = 37 * result
