...
/**
 * MiniExonDonorRnaId generated by hbm2java
 */
public class MiniExonDonorRnaId implements java.io.Serializable {

	private Integer miniExonDonorRnaId;
	...
	public MiniExonDonorRnaId() {
	}

	public MiniExonDonorRnaId(Integer miniExonDonorRnaId, Integer featureId,
		...
		this.miniExonDonorRnaId = miniExonDonorRnaId;
	...
	public Integer getMiniExonDonorRnaId() {
		return this.miniExonDonorRnaId;
	}

	public void setMiniExonDonorRnaId(Integer miniExonDonorRnaId) {
		this.miniExonDonorRnaId = miniExonDonorRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MiniExonDonorRnaId))
			return false;
		MiniExonDonorRnaId castOther = (MiniExonDonorRnaId) other;

		return ((this.getMiniExonDonorRnaId() == castOther
				.getMiniExonDonorRnaId()) || (this.getMiniExonDonorRnaId() != null
				&& castOther.getMiniExonDonorRnaId() != null && this
				.getMiniExonDonorRnaId().equals(
						castOther.getMiniExonDonorRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMiniExonDonorRnaId() == null ? 0 : this
						.getMiniExonDonorRnaId().hashCode());
		result = 37 * result
