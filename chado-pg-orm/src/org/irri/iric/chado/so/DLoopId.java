...
/**
 * DLoopId generated by hbm2java
 */
public class DLoopId implements java.io.Serializable {

	private Integer DLoopId;
	...
	public DLoopId(Integer DLoopId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDLoopId() {
		return this.DLoopId;
	}

	public void setDLoopId(Integer DLoopId) {
		this.DLoopId = DLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DLoopId))
			return false;
		DLoopId castOther = (DLoopId) other;

		return ((this.getDLoopId() == castOther.getDLoopId()) || (this
				.getDLoopId() != null && castOther.getDLoopId() != null && this
				.getDLoopId().equals(castOther.getDLoopId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDLoopId() == null ? 0 : this.getDLoopId().hashCode());
		result = 37 * result
