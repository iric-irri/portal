...
/**
 * RrnaId generated by hbm2java
 */
public class RrnaId implements java.io.Serializable {

	private Integer rrnaId;
	...
	public RrnaId(Integer rrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrnaId() {
		return this.rrnaId;
	}

	public void setRrnaId(Integer rrnaId) {
		this.rrnaId = rrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaId))
			return false;
		RrnaId castOther = (RrnaId) other;

		return ((this.getRrnaId() == castOther.getRrnaId()) || (this
				.getRrnaId() != null && castOther.getRrnaId() != null && this
				.getRrnaId().equals(castOther.getRrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrnaId() == null ? 0 : this.getRrnaId().hashCode());
		result = 37 * result
