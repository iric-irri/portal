...
/**
 * GapId generated by hbm2java
 */
public class GapId implements java.io.Serializable {
	...
	public GapId(Integer gapId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGapId() {
		return this.gapId;
	}

	public void setGapId(Integer gapId) {
		this.gapId = gapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GapId))
			return false;
		GapId castOther = (GapId) other;

		return ((this.getGapId() == castOther.getGapId()) || (this.getGapId() != null
				&& castOther.getGapId() != null && this.getGapId().equals(
				castOther.getGapId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGapId() == null ? 0 : this.getGapId().hashCode());
		result = 37 * result
