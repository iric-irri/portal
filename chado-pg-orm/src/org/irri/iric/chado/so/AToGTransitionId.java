...
/**
 * AToGTransitionId generated by hbm2java
 */
public class AToGTransitionId implements java.io.Serializable {

	private Integer AToGTransitionId;
	...
	public AToGTransitionId() {
	}

	public AToGTransitionId(Integer AToGTransitionId, Integer featureId,
		...
		this.AToGTransitionId = AToGTransitionId;
	...
	public Integer getAToGTransitionId() {
		return this.AToGTransitionId;
	}

	public void setAToGTransitionId(Integer AToGTransitionId) {
		this.AToGTransitionId = AToGTransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AToGTransitionId))
			return false;
		AToGTransitionId castOther = (AToGTransitionId) other;

		return ((this.getAToGTransitionId() == castOther.getAToGTransitionId()) || (this
				.getAToGTransitionId() != null
				&& castOther.getAToGTransitionId() != null && this
				.getAToGTransitionId().equals(castOther.getAToGTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAToGTransitionId() == null ? 0 : this
						.getAToGTransitionId().hashCode());
		result = 37 * result
