...
/**
 * TwoThioTwoPrimeOMethyluridineId generated by hbm2java
 */
public class TwoThioTwoPrimeOMethyluridineId implements java.io.Serializable {

	private Integer twoThioTwoPrimeOMethyluridineId;
	...
	public TwoThioTwoPrimeOMethyluridineId() {
	}

	public TwoThioTwoPrimeOMethyluridineId(
			Integer twoThioTwoPrimeOMethyluridineId, Integer featureId,
		...
		this.twoThioTwoPrimeOMethyluridineId = twoThioTwoPrimeOMethyluridineId;
	...
	public Integer getTwoThioTwoPrimeOMethyluridineId() {
		return this.twoThioTwoPrimeOMethyluridineId;
	}

	public void setTwoThioTwoPrimeOMethyluridineId(
			Integer twoThioTwoPrimeOMethyluridineId) {
		this.twoThioTwoPrimeOMethyluridineId = twoThioTwoPrimeOMethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoThioTwoPrimeOMethyluridineId))
			return false;
		TwoThioTwoPrimeOMethyluridineId castOther = (TwoThioTwoPrimeOMethyluridineId) other;

		return ((this.getTwoThioTwoPrimeOMethyluridineId() == castOther
				.getTwoThioTwoPrimeOMethyluridineId()) || (this
				.getTwoThioTwoPrimeOMethyluridineId() != null
				&& castOther.getTwoThioTwoPrimeOMethyluridineId() != null && this
				.getTwoThioTwoPrimeOMethyluridineId().equals(
						castOther.getTwoThioTwoPrimeOMethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoThioTwoPrimeOMethyluridineId() == null ? 0 : this
						.getTwoThioTwoPrimeOMethyluridineId().hashCode());
		result = 37 * result
