...
/**
 * EngineeredFusionGeneId generated by hbm2java
 */
public class EngineeredFusionGeneId implements java.io.Serializable {

	private Integer engineeredFusionGeneId;
	...
	public EngineeredFusionGeneId() {
	}

	public EngineeredFusionGeneId(Integer engineeredFusionGeneId,
		...
		this.engineeredFusionGeneId = engineeredFusionGeneId;
	...
	public Integer getEngineeredFusionGeneId() {
		return this.engineeredFusionGeneId;
	}

	public void setEngineeredFusionGeneId(Integer engineeredFusionGeneId) {
		this.engineeredFusionGeneId = engineeredFusionGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredFusionGeneId))
			return false;
		EngineeredFusionGeneId castOther = (EngineeredFusionGeneId) other;

		return ((this.getEngineeredFusionGeneId() == castOther
				.getEngineeredFusionGeneId()) || (this
				.getEngineeredFusionGeneId() != null
				&& castOther.getEngineeredFusionGeneId() != null && this
				.getEngineeredFusionGeneId().equals(
						castOther.getEngineeredFusionGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredFusionGeneId() == null ? 0 : this
						.getEngineeredFusionGeneId().hashCode());
		result = 37 * result
