...
/**
 * Dmv4MotifId generated by hbm2java
 */
public class Dmv4MotifId implements java.io.Serializable {

	private Integer dmv4MotifId;
	...
	public Dmv4MotifId(Integer dmv4MotifId, Integer featureId,
	...
	public Integer getDmv4MotifId() {
		return this.dmv4MotifId;
	}

	public void setDmv4MotifId(Integer dmv4MotifId) {
		this.dmv4MotifId = dmv4MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dmv4MotifId))
			return false;
		Dmv4MotifId castOther = (Dmv4MotifId) other;

		return ((this.getDmv4MotifId() == castOther.getDmv4MotifId()) || (this
				.getDmv4MotifId() != null && castOther.getDmv4MotifId() != null && this
				.getDmv4MotifId().equals(castOther.getDmv4MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDmv4MotifId() == null ? 0 : this.getDmv4MotifId()
						.hashCode());
		result = 37 * result
