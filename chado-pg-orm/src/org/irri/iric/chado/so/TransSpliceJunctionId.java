...
/**
 * TransSpliceJunctionId generated by hbm2java
 */
public class TransSpliceJunctionId implements java.io.Serializable {

	private Integer transSpliceJunctionId;
	...
	public TransSpliceJunctionId() {
	}

	public TransSpliceJunctionId(Integer transSpliceJunctionId,
		...
		this.transSpliceJunctionId = transSpliceJunctionId;
	...
	public Integer getTransSpliceJunctionId() {
		return this.transSpliceJunctionId;
	}

	public void setTransSpliceJunctionId(Integer transSpliceJunctionId) {
		this.transSpliceJunctionId = transSpliceJunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSpliceJunctionId))
			return false;
		TransSpliceJunctionId castOther = (TransSpliceJunctionId) other;

		return ((this.getTransSpliceJunctionId() == castOther
				.getTransSpliceJunctionId()) || (this
				.getTransSpliceJunctionId() != null
				&& castOther.getTransSpliceJunctionId() != null && this
				.getTransSpliceJunctionId().equals(
						castOther.getTransSpliceJunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSpliceJunctionId() == null ? 0 : this
						.getTransSpliceJunctionId().hashCode());
		result = 37 * result
