...
/**
 * PolypeptideTruncationId generated by hbm2java
 */
public class PolypeptideTruncationId implements java.io.Serializable {

	private Integer polypeptideTruncationId;
	...
	public PolypeptideTruncationId() {
	}

	public PolypeptideTruncationId(Integer polypeptideTruncationId,
		...
		this.polypeptideTruncationId = polypeptideTruncationId;
	...
	public Integer getPolypeptideTruncationId() {
		return this.polypeptideTruncationId;
	}

	public void setPolypeptideTruncationId(Integer polypeptideTruncationId) {
		this.polypeptideTruncationId = polypeptideTruncationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideTruncationId))
			return false;
		PolypeptideTruncationId castOther = (PolypeptideTruncationId) other;

		return ((this.getPolypeptideTruncationId() == castOther
				.getPolypeptideTruncationId()) || (this
				.getPolypeptideTruncationId() != null
				&& castOther.getPolypeptideTruncationId() != null && this
				.getPolypeptideTruncationId().equals(
						castOther.getPolypeptideTruncationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideTruncationId() == null ? 0 : this
						.getPolypeptideTruncationId().hashCode());
		result = 37 * result
