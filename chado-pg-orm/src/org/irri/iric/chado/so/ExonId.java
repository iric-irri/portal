...
/**
 * ExonId generated by hbm2java
 */
public class ExonId implements java.io.Serializable {
	...
	public ExonId(Integer exonId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExonId))
			return false;
		ExonId castOther = (ExonId) other;

		return ((this.getExonId() == castOther.getExonId()) || (this
				.getExonId() != null && castOther.getExonId() != null && this
				.getExonId().equals(castOther.getExonId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getExonId() == null ? 0 : this.getExonId().hashCode());
		result = 37 * result
