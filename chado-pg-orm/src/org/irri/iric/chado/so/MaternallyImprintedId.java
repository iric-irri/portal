...
/**
 * MaternallyImprintedId generated by hbm2java
 */
public class MaternallyImprintedId implements java.io.Serializable {

	private Integer maternallyImprintedId;
	...
	public MaternallyImprintedId() {
	}

	public MaternallyImprintedId(Integer maternallyImprintedId,
		...
		this.maternallyImprintedId = maternallyImprintedId;
	...
	public Integer getMaternallyImprintedId() {
		return this.maternallyImprintedId;
	}

	public void setMaternallyImprintedId(Integer maternallyImprintedId) {
		this.maternallyImprintedId = maternallyImprintedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaternallyImprintedId))
			return false;
		MaternallyImprintedId castOther = (MaternallyImprintedId) other;

		return ((this.getMaternallyImprintedId() == castOther
				.getMaternallyImprintedId()) || (this
				.getMaternallyImprintedId() != null
				&& castOther.getMaternallyImprintedId() != null && this
				.getMaternallyImprintedId().equals(
						castOther.getMaternallyImprintedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaternallyImprintedId() == null ? 0 : this
						.getMaternallyImprintedId().hashCode());
		result = 37 * result
