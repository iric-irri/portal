...
/**
 * CysteineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class CysteineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer cysteineTrnaPrimaryTranscriptId;
	...
	public CysteineTrnaPrimaryTranscriptId() {
	}

	public CysteineTrnaPrimaryTranscriptId(
			Integer cysteineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.cysteineTrnaPrimaryTranscriptId = cysteineTrnaPrimaryTranscriptId;
	...
	public Integer getCysteineTrnaPrimaryTranscriptId() {
		return this.cysteineTrnaPrimaryTranscriptId;
	}

	public void setCysteineTrnaPrimaryTranscriptId(
			Integer cysteineTrnaPrimaryTranscriptId) {
		this.cysteineTrnaPrimaryTranscriptId = cysteineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CysteineTrnaPrimaryTranscriptId))
			return false;
		CysteineTrnaPrimaryTranscriptId castOther = (CysteineTrnaPrimaryTranscriptId) other;

		return ((this.getCysteineTrnaPrimaryTranscriptId() == castOther
				.getCysteineTrnaPrimaryTranscriptId()) || (this
				.getCysteineTrnaPrimaryTranscriptId() != null
				&& castOther.getCysteineTrnaPrimaryTranscriptId() != null && this
				.getCysteineTrnaPrimaryTranscriptId().equals(
						castOther.getCysteineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCysteineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getCysteineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
