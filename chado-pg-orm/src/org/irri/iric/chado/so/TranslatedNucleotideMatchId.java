...
/**
 * TranslatedNucleotideMatchId generated by hbm2java
 */
public class TranslatedNucleotideMatchId implements java.io.Serializable {

	private Integer translatedNucleotideMatchId;
	...
	public TranslatedNucleotideMatchId() {
	}

	public TranslatedNucleotideMatchId(Integer translatedNucleotideMatchId,
		...
		this.translatedNucleotideMatchId = translatedNucleotideMatchId;
	...
	public Integer getTranslatedNucleotideMatchId() {
		return this.translatedNucleotideMatchId;
	}

	public void setTranslatedNucleotideMatchId(
			Integer translatedNucleotideMatchId) {
		this.translatedNucleotideMatchId = translatedNucleotideMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslatedNucleotideMatchId))
			return false;
		TranslatedNucleotideMatchId castOther = (TranslatedNucleotideMatchId) other;

		return ((this.getTranslatedNucleotideMatchId() == castOther
				.getTranslatedNucleotideMatchId()) || (this
				.getTranslatedNucleotideMatchId() != null
				&& castOther.getTranslatedNucleotideMatchId() != null && this
				.getTranslatedNucleotideMatchId().equals(
						castOther.getTranslatedNucleotideMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslatedNucleotideMatchId() == null ? 0 : this
						.getTranslatedNucleotideMatchId().hashCode());
		result = 37 * result
