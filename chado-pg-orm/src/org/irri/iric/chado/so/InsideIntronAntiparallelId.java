...
/**
 * InsideIntronAntiparallelId generated by hbm2java
 */
public class InsideIntronAntiparallelId implements java.io.Serializable {

	private Integer insideIntronAntiparallelId;
	...
	public InsideIntronAntiparallelId() {
	}

	public InsideIntronAntiparallelId(Integer insideIntronAntiparallelId,
		...
		this.insideIntronAntiparallelId = insideIntronAntiparallelId;
	...
	public Integer getInsideIntronAntiparallelId() {
		return this.insideIntronAntiparallelId;
	}

	public void setInsideIntronAntiparallelId(Integer insideIntronAntiparallelId) {
		this.insideIntronAntiparallelId = insideIntronAntiparallelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsideIntronAntiparallelId))
			return false;
		InsideIntronAntiparallelId castOther = (InsideIntronAntiparallelId) other;

		return ((this.getInsideIntronAntiparallelId() == castOther
				.getInsideIntronAntiparallelId()) || (this
				.getInsideIntronAntiparallelId() != null
				&& castOther.getInsideIntronAntiparallelId() != null && this
				.getInsideIntronAntiparallelId().equals(
						castOther.getInsideIntronAntiparallelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsideIntronAntiparallelId() == null ? 0 : this
						.getInsideIntronAntiparallelId().hashCode());
		result = 37 * result
