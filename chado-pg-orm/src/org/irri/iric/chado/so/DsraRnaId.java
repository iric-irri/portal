...
/**
 * DsraRnaId generated by hbm2java
 */
public class DsraRnaId implements java.io.Serializable {

	private Integer dsraRnaId;
	...
	public DsraRnaId(Integer dsraRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDsraRnaId() {
		return this.dsraRnaId;
	}

	public void setDsraRnaId(Integer dsraRnaId) {
		this.dsraRnaId = dsraRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DsraRnaId))
			return false;
		DsraRnaId castOther = (DsraRnaId) other;

		return ((this.getDsraRnaId() == castOther.getDsraRnaId()) || (this
				.getDsraRnaId() != null && castOther.getDsraRnaId() != null && this
				.getDsraRnaId().equals(castOther.getDsraRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDsraRnaId() == null ? 0 : this.getDsraRnaId().hashCode());
		result = 37 * result
