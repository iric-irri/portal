...
/**
 * HistoneBindingSiteId generated by hbm2java
 */
public class HistoneBindingSiteId implements java.io.Serializable {

	private Integer histoneBindingSiteId;
	...
	public HistoneBindingSiteId() {
	}

	public HistoneBindingSiteId(Integer histoneBindingSiteId,
		...
		this.histoneBindingSiteId = histoneBindingSiteId;
	...
	public Integer getHistoneBindingSiteId() {
		return this.histoneBindingSiteId;
	}

	public void setHistoneBindingSiteId(Integer histoneBindingSiteId) {
		this.histoneBindingSiteId = histoneBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneBindingSiteId))
			return false;
		HistoneBindingSiteId castOther = (HistoneBindingSiteId) other;

		return ((this.getHistoneBindingSiteId() == castOther
				.getHistoneBindingSiteId()) || (this.getHistoneBindingSiteId() != null
				&& castOther.getHistoneBindingSiteId() != null && this
				.getHistoneBindingSiteId().equals(
						castOther.getHistoneBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneBindingSiteId() == null ? 0 : this
						.getHistoneBindingSiteId().hashCode());
		result = 37 * result
