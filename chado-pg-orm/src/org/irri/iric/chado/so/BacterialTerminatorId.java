...
/**
 * BacterialTerminatorId generated by hbm2java
 */
public class BacterialTerminatorId implements java.io.Serializable {

	private Integer bacterialTerminatorId;
	...
	public BacterialTerminatorId() {
	}

	public BacterialTerminatorId(Integer bacterialTerminatorId,
		...
		this.bacterialTerminatorId = bacterialTerminatorId;
	...
	public Integer getBacterialTerminatorId() {
		return this.bacterialTerminatorId;
	}

	public void setBacterialTerminatorId(Integer bacterialTerminatorId) {
		this.bacterialTerminatorId = bacterialTerminatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BacterialTerminatorId))
			return false;
		BacterialTerminatorId castOther = (BacterialTerminatorId) other;

		return ((this.getBacterialTerminatorId() == castOther
				.getBacterialTerminatorId()) || (this
				.getBacterialTerminatorId() != null
				&& castOther.getBacterialTerminatorId() != null && this
				.getBacterialTerminatorId().equals(
						castOther.getBacterialTerminatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBacterialTerminatorId() == null ? 0 : this
						.getBacterialTerminatorId().hashCode());
		result = 37 * result
