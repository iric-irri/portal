...
/**
 * ArchaealIntronId generated by hbm2java
 */
public class ArchaealIntronId implements java.io.Serializable {

	private Integer archaealIntronId;
	...
	public ArchaealIntronId() {
	}

	public ArchaealIntronId(Integer archaealIntronId, Integer featureId,
		...
		this.archaealIntronId = archaealIntronId;
	...
	public Integer getArchaealIntronId() {
		return this.archaealIntronId;
	}

	public void setArchaealIntronId(Integer archaealIntronId) {
		this.archaealIntronId = archaealIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArchaealIntronId))
			return false;
		ArchaealIntronId castOther = (ArchaealIntronId) other;

		return ((this.getArchaealIntronId() == castOther.getArchaealIntronId()) || (this
				.getArchaealIntronId() != null
				&& castOther.getArchaealIntronId() != null && this
				.getArchaealIntronId().equals(castOther.getArchaealIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getArchaealIntronId() == null ? 0 : this
						.getArchaealIntronId().hashCode());
		result = 37 * result
