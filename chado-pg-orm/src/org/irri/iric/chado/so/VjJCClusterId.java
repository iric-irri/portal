...
/**
 * VjJCClusterId generated by hbm2java
 */
public class VjJCClusterId implements java.io.Serializable {

	private Integer vjJCClusterId;
	...
	public VjJCClusterId() {
	}

	public VjJCClusterId(Integer vjJCClusterId, Integer featureId,
		...
		this.vjJCClusterId = vjJCClusterId;
	...
	public Integer getVjJCClusterId() {
		return this.vjJCClusterId;
	}

	public void setVjJCClusterId(Integer vjJCClusterId) {
		this.vjJCClusterId = vjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VjJCClusterId))
			return false;
		VjJCClusterId castOther = (VjJCClusterId) other;

		return ((this.getVjJCClusterId() == castOther.getVjJCClusterId()) || (this
				.getVjJCClusterId() != null
				&& castOther.getVjJCClusterId() != null && this
				.getVjJCClusterId().equals(castOther.getVjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVjJCClusterId() == null ? 0 : this.getVjJCClusterId()
						.hashCode());
		result = 37 * result
