...
/**
 * MetabolicIslandId generated by hbm2java
 */
public class MetabolicIslandId implements java.io.Serializable {

	private Integer metabolicIslandId;
	...
	public MetabolicIslandId() {
	}

	public MetabolicIslandId(Integer metabolicIslandId, Integer featureId,
		...
		this.metabolicIslandId = metabolicIslandId;
	...
	public Integer getMetabolicIslandId() {
		return this.metabolicIslandId;
	}

	public void setMetabolicIslandId(Integer metabolicIslandId) {
		this.metabolicIslandId = metabolicIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MetabolicIslandId))
			return false;
		MetabolicIslandId castOther = (MetabolicIslandId) other;

		return ((this.getMetabolicIslandId() == castOther
				.getMetabolicIslandId()) || (this.getMetabolicIslandId() != null
				&& castOther.getMetabolicIslandId() != null && this
				.getMetabolicIslandId()
				.equals(castOther.getMetabolicIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMetabolicIslandId() == null ? 0 : this
						.getMetabolicIslandId().hashCode());
		result = 37 * result
