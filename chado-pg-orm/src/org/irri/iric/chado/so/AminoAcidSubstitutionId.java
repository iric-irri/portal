...
/**
 * AminoAcidSubstitutionId generated by hbm2java
 */
public class AminoAcidSubstitutionId implements java.io.Serializable {

	private Integer aminoAcidSubstitutionId;
	...
	public AminoAcidSubstitutionId() {
	}

	public AminoAcidSubstitutionId(Integer aminoAcidSubstitutionId,
		...
		this.aminoAcidSubstitutionId = aminoAcidSubstitutionId;
	...
	public Integer getAminoAcidSubstitutionId() {
		return this.aminoAcidSubstitutionId;
	}

	public void setAminoAcidSubstitutionId(Integer aminoAcidSubstitutionId) {
		this.aminoAcidSubstitutionId = aminoAcidSubstitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AminoAcidSubstitutionId))
			return false;
		AminoAcidSubstitutionId castOther = (AminoAcidSubstitutionId) other;

		return ((this.getAminoAcidSubstitutionId() == castOther
				.getAminoAcidSubstitutionId()) || (this
				.getAminoAcidSubstitutionId() != null
				&& castOther.getAminoAcidSubstitutionId() != null && this
				.getAminoAcidSubstitutionId().equals(
						castOther.getAminoAcidSubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAminoAcidSubstitutionId() == null ? 0 : this
						.getAminoAcidSubstitutionId().hashCode());
		result = 37 * result
