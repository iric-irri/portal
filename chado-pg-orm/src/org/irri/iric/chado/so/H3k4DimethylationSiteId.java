...
/**
 * H3k4DimethylationSiteId generated by hbm2java
 */
public class H3k4DimethylationSiteId implements java.io.Serializable {

	private Integer h3k4DimethylationSiteId;
	...
	public H3k4DimethylationSiteId() {
	}

	public H3k4DimethylationSiteId(Integer h3k4DimethylationSiteId,
		...
		this.h3k4DimethylationSiteId = h3k4DimethylationSiteId;
	...
	public Integer getH3k4DimethylationSiteId() {
		return this.h3k4DimethylationSiteId;
	}

	public void setH3k4DimethylationSiteId(Integer h3k4DimethylationSiteId) {
		this.h3k4DimethylationSiteId = h3k4DimethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k4DimethylationSiteId))
			return false;
		H3k4DimethylationSiteId castOther = (H3k4DimethylationSiteId) other;

		return ((this.getH3k4DimethylationSiteId() == castOther
				.getH3k4DimethylationSiteId()) || (this
				.getH3k4DimethylationSiteId() != null
				&& castOther.getH3k4DimethylationSiteId() != null && this
				.getH3k4DimethylationSiteId().equals(
						castOther.getH3k4DimethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k4DimethylationSiteId() == null ? 0 : this
						.getH3k4DimethylationSiteId().hashCode());
		result = 37 * result
