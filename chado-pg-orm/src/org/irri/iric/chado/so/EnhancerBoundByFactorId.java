...
/**
 * EnhancerBoundByFactorId generated by hbm2java
 */
public class EnhancerBoundByFactorId implements java.io.Serializable {

	private Integer enhancerBoundByFactorId;
	...
	public EnhancerBoundByFactorId() {
	}

	public EnhancerBoundByFactorId(Integer enhancerBoundByFactorId,
		...
		this.enhancerBoundByFactorId = enhancerBoundByFactorId;
	...
	public Integer getEnhancerBoundByFactorId() {
		return this.enhancerBoundByFactorId;
	}

	public void setEnhancerBoundByFactorId(Integer enhancerBoundByFactorId) {
		this.enhancerBoundByFactorId = enhancerBoundByFactorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnhancerBoundByFactorId))
			return false;
		EnhancerBoundByFactorId castOther = (EnhancerBoundByFactorId) other;

		return ((this.getEnhancerBoundByFactorId() == castOther
				.getEnhancerBoundByFactorId()) || (this
				.getEnhancerBoundByFactorId() != null
				&& castOther.getEnhancerBoundByFactorId() != null && this
				.getEnhancerBoundByFactorId().equals(
						castOther.getEnhancerBoundByFactorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnhancerBoundByFactorId() == null ? 0 : this
						.getEnhancerBoundByFactorId().hashCode());
		result = 37 * result
