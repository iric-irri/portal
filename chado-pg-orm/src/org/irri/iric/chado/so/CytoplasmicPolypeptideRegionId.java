...
/**
 * CytoplasmicPolypeptideRegionId generated by hbm2java
 */
public class CytoplasmicPolypeptideRegionId implements java.io.Serializable {

	private Integer cytoplasmicPolypeptideRegionId;
	...
	public CytoplasmicPolypeptideRegionId() {
	}

	public CytoplasmicPolypeptideRegionId(
			Integer cytoplasmicPolypeptideRegionId, Integer featureId,
		...
		this.cytoplasmicPolypeptideRegionId = cytoplasmicPolypeptideRegionId;
	...
	public Integer getCytoplasmicPolypeptideRegionId() {
		return this.cytoplasmicPolypeptideRegionId;
	}

	public void setCytoplasmicPolypeptideRegionId(
			Integer cytoplasmicPolypeptideRegionId) {
		this.cytoplasmicPolypeptideRegionId = cytoplasmicPolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CytoplasmicPolypeptideRegionId))
			return false;
		CytoplasmicPolypeptideRegionId castOther = (CytoplasmicPolypeptideRegionId) other;

		return ((this.getCytoplasmicPolypeptideRegionId() == castOther
				.getCytoplasmicPolypeptideRegionId()) || (this
				.getCytoplasmicPolypeptideRegionId() != null
				&& castOther.getCytoplasmicPolypeptideRegionId() != null && this
				.getCytoplasmicPolypeptideRegionId().equals(
						castOther.getCytoplasmicPolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCytoplasmicPolypeptideRegionId() == null ? 0 : this
						.getCytoplasmicPolypeptideRegionId().hashCode());
		result = 37 * result
