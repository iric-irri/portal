...
/**
 * ProteinCodingId generated by hbm2java
 */
public class ProteinCodingId implements java.io.Serializable {

	private Integer proteinCodingId;
	...
	public ProteinCodingId() {
	}

	public ProteinCodingId(Integer proteinCodingId, Integer featureId,
		...
		this.proteinCodingId = proteinCodingId;
	...
	public Integer getProteinCodingId() {
		return this.proteinCodingId;
	}

	public void setProteinCodingId(Integer proteinCodingId) {
		this.proteinCodingId = proteinCodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinCodingId))
			return false;
		ProteinCodingId castOther = (ProteinCodingId) other;

		return ((this.getProteinCodingId() == castOther.getProteinCodingId()) || (this
				.getProteinCodingId() != null
				&& castOther.getProteinCodingId() != null && this
				.getProteinCodingId().equals(castOther.getProteinCodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinCodingId() == null ? 0 : this.getProteinCodingId()
						.hashCode());
		result = 37 * result
