...
/**
 * BaseCallErrorCorrectionId generated by hbm2java
 */
public class BaseCallErrorCorrectionId implements java.io.Serializable {

	private Integer baseCallErrorCorrectionId;
	...
	public BaseCallErrorCorrectionId() {
	}

	public BaseCallErrorCorrectionId(Integer baseCallErrorCorrectionId,
		...
		this.baseCallErrorCorrectionId = baseCallErrorCorrectionId;
	...
	public Integer getBaseCallErrorCorrectionId() {
		return this.baseCallErrorCorrectionId;
	}

	public void setBaseCallErrorCorrectionId(Integer baseCallErrorCorrectionId) {
		this.baseCallErrorCorrectionId = baseCallErrorCorrectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaseCallErrorCorrectionId))
			return false;
		BaseCallErrorCorrectionId castOther = (BaseCallErrorCorrectionId) other;

		return ((this.getBaseCallErrorCorrectionId() == castOther
				.getBaseCallErrorCorrectionId()) || (this
				.getBaseCallErrorCorrectionId() != null
				&& castOther.getBaseCallErrorCorrectionId() != null && this
				.getBaseCallErrorCorrectionId().equals(
						castOther.getBaseCallErrorCorrectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBaseCallErrorCorrectionId() == null ? 0 : this
						.getBaseCallErrorCorrectionId().hashCode());
		result = 37 * result
