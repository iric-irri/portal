...
/**
 * OrthologousId generated by hbm2java
 */
public class OrthologousId implements java.io.Serializable {

	private Integer orthologousId;
	...
	public OrthologousId() {
	}

	public OrthologousId(Integer orthologousId, Integer featureId,
		...
		this.orthologousId = orthologousId;
	...
	public Integer getOrthologousId() {
		return this.orthologousId;
	}

	public void setOrthologousId(Integer orthologousId) {
		this.orthologousId = orthologousId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OrthologousId))
			return false;
		OrthologousId castOther = (OrthologousId) other;

		return ((this.getOrthologousId() == castOther.getOrthologousId()) || (this
				.getOrthologousId() != null
				&& castOther.getOrthologousId() != null && this
				.getOrthologousId().equals(castOther.getOrthologousId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOrthologousId() == null ? 0 : this.getOrthologousId()
						.hashCode());
		result = 37 * result
