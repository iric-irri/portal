...
/**
 * GeneMemberRegionId generated by hbm2java
 */
public class GeneMemberRegionId implements java.io.Serializable {

	private Integer geneMemberRegionId;
	...
	public GeneMemberRegionId() {
	}

	public GeneMemberRegionId(Integer geneMemberRegionId, Integer featureId,
		...
		this.geneMemberRegionId = geneMemberRegionId;
	...
	public Integer getGeneMemberRegionId() {
		return this.geneMemberRegionId;
	}

	public void setGeneMemberRegionId(Integer geneMemberRegionId) {
		this.geneMemberRegionId = geneMemberRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneMemberRegionId))
			return false;
		GeneMemberRegionId castOther = (GeneMemberRegionId) other;

		return ((this.getGeneMemberRegionId() == castOther
				.getGeneMemberRegionId()) || (this.getGeneMemberRegionId() != null
				&& castOther.getGeneMemberRegionId() != null && this
				.getGeneMemberRegionId().equals(
						castOther.getGeneMemberRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneMemberRegionId() == null ? 0 : this
						.getGeneMemberRegionId().hashCode());
		result = 37 * result
