...
/**
 * UagStopCodonSignalId generated by hbm2java
 */
public class UagStopCodonSignalId implements java.io.Serializable {

	private Integer uagStopCodonSignalId;
	...
	public UagStopCodonSignalId() {
	}

	public UagStopCodonSignalId(Integer uagStopCodonSignalId,
		...
		this.uagStopCodonSignalId = uagStopCodonSignalId;
	...
	public Integer getUagStopCodonSignalId() {
		return this.uagStopCodonSignalId;
	}

	public void setUagStopCodonSignalId(Integer uagStopCodonSignalId) {
		this.uagStopCodonSignalId = uagStopCodonSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UagStopCodonSignalId))
			return false;
		UagStopCodonSignalId castOther = (UagStopCodonSignalId) other;

		return ((this.getUagStopCodonSignalId() == castOther
				.getUagStopCodonSignalId()) || (this.getUagStopCodonSignalId() != null
				&& castOther.getUagStopCodonSignalId() != null && this
				.getUagStopCodonSignalId().equals(
						castOther.getUagStopCodonSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUagStopCodonSignalId() == null ? 0 : this
						.getUagStopCodonSignalId().hashCode());
		result = 37 * result
