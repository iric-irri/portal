...
/**
 * CdnaId generated by hbm2java
 */
public class CdnaId implements java.io.Serializable {

	private Integer cdnaId;
	...
	public CdnaId(Integer cdnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCdnaId() {
		return this.cdnaId;
	}

	public void setCdnaId(Integer cdnaId) {
		this.cdnaId = cdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdnaId))
			return false;
		CdnaId castOther = (CdnaId) other;

		return ((this.getCdnaId() == castOther.getCdnaId()) || (this
				.getCdnaId() != null && castOther.getCdnaId() != null && this
				.getCdnaId().equals(castOther.getCdnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCdnaId() == null ? 0 : this.getCdnaId().hashCode());
		result = 37 * result
