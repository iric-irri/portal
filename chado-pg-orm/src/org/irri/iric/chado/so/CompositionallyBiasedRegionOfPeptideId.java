...
/**
 * CompositionallyBiasedRegionOfPeptideId generated by hbm2java
 */
public class CompositionallyBiasedRegionOfPeptideId implements
		java.io.Serializable {

	private Integer compositionallyBiasedRegionOfPeptideId;
	...
	public CompositionallyBiasedRegionOfPeptideId() {
	}

	public CompositionallyBiasedRegionOfPeptideId(
			Integer compositionallyBiasedRegionOfPeptideId, Integer featureId,
		...
		this.compositionallyBiasedRegionOfPeptideId = compositionallyBiasedRegionOfPeptideId;
	...
	public Integer getCompositionallyBiasedRegionOfPeptideId() {
		return this.compositionallyBiasedRegionOfPeptideId;
	}

	public void setCompositionallyBiasedRegionOfPeptideId(
			Integer compositionallyBiasedRegionOfPeptideId) {
		this.compositionallyBiasedRegionOfPeptideId = compositionallyBiasedRegionOfPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CompositionallyBiasedRegionOfPeptideId))
			return false;
		CompositionallyBiasedRegionOfPeptideId castOther = (CompositionallyBiasedRegionOfPeptideId) other;

		return ((this.getCompositionallyBiasedRegionOfPeptideId() == castOther
				.getCompositionallyBiasedRegionOfPeptideId()) || (this
				.getCompositionallyBiasedRegionOfPeptideId() != null
				&& castOther.getCompositionallyBiasedRegionOfPeptideId() != null && this
				.getCompositionallyBiasedRegionOfPeptideId().equals(
						castOther.getCompositionallyBiasedRegionOfPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCompositionallyBiasedRegionOfPeptideId() == null ? 0
						: this.getCompositionallyBiasedRegionOfPeptideId()
								.hashCode());
		result = 37 * result
