...
/**
 * TranscriptionallyInducedId generated by hbm2java
 */
public class TranscriptionallyInducedId implements java.io.Serializable {

	private Integer transcriptionallyInducedId;
	...
	public TranscriptionallyInducedId() {
	}

	public TranscriptionallyInducedId(Integer transcriptionallyInducedId,
		...
		this.transcriptionallyInducedId = transcriptionallyInducedId;
	...
	public Integer getTranscriptionallyInducedId() {
		return this.transcriptionallyInducedId;
	}

	public void setTranscriptionallyInducedId(Integer transcriptionallyInducedId) {
		this.transcriptionallyInducedId = transcriptionallyInducedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionallyInducedId))
			return false;
		TranscriptionallyInducedId castOther = (TranscriptionallyInducedId) other;

		return ((this.getTranscriptionallyInducedId() == castOther
				.getTranscriptionallyInducedId()) || (this
				.getTranscriptionallyInducedId() != null
				&& castOther.getTranscriptionallyInducedId() != null && this
				.getTranscriptionallyInducedId().equals(
						castOther.getTranscriptionallyInducedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionallyInducedId() == null ? 0 : this
						.getTranscriptionallyInducedId().hashCode());
		result = 37 * result
