...
/**
 * ChloroplastSequenceId generated by hbm2java
 */
public class ChloroplastSequenceId implements java.io.Serializable {

	private Integer chloroplastSequenceId;
	...
	public ChloroplastSequenceId() {
	}

	public ChloroplastSequenceId(Integer chloroplastSequenceId,
		...
		this.chloroplastSequenceId = chloroplastSequenceId;
	...
	public Integer getChloroplastSequenceId() {
		return this.chloroplastSequenceId;
	}

	public void setChloroplastSequenceId(Integer chloroplastSequenceId) {
		this.chloroplastSequenceId = chloroplastSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChloroplastSequenceId))
			return false;
		ChloroplastSequenceId castOther = (ChloroplastSequenceId) other;

		return ((this.getChloroplastSequenceId() == castOther
				.getChloroplastSequenceId()) || (this
				.getChloroplastSequenceId() != null
				&& castOther.getChloroplastSequenceId() != null && this
				.getChloroplastSequenceId().equals(
						castOther.getChloroplastSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChloroplastSequenceId() == null ? 0 : this
						.getChloroplastSequenceId().hashCode());
		result = 37 * result
