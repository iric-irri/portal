...
/**
 * LysineId generated by hbm2java
 */
public class LysineId implements java.io.Serializable {

	private Integer lysineId;
	...
	public LysineId(Integer lysineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLysineId() {
		return this.lysineId;
	}

	public void setLysineId(Integer lysineId) {
		this.lysineId = lysineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LysineId))
			return false;
		LysineId castOther = (LysineId) other;

		return ((this.getLysineId() == castOther.getLysineId()) || (this
				.getLysineId() != null && castOther.getLysineId() != null && this
				.getLysineId().equals(castOther.getLysineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getLysineId() == null ? 0 : this.getLysineId().hashCode());
		result = 37 * result
