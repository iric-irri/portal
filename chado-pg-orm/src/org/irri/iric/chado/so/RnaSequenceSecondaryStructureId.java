...
/**
 * RnaSequenceSecondaryStructureId generated by hbm2java
 */
public class RnaSequenceSecondaryStructureId implements java.io.Serializable {

	private Integer rnaSequenceSecondaryStructureId;
	...
	public RnaSequenceSecondaryStructureId() {
	}

	public RnaSequenceSecondaryStructureId(
			Integer rnaSequenceSecondaryStructureId, Integer featureId,
		...
		this.rnaSequenceSecondaryStructureId = rnaSequenceSecondaryStructureId;
	...
	public Integer getRnaSequenceSecondaryStructureId() {
		return this.rnaSequenceSecondaryStructureId;
	}

	public void setRnaSequenceSecondaryStructureId(
			Integer rnaSequenceSecondaryStructureId) {
		this.rnaSequenceSecondaryStructureId = rnaSequenceSecondaryStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaSequenceSecondaryStructureId))
			return false;
		RnaSequenceSecondaryStructureId castOther = (RnaSequenceSecondaryStructureId) other;

		return ((this.getRnaSequenceSecondaryStructureId() == castOther
				.getRnaSequenceSecondaryStructureId()) || (this
				.getRnaSequenceSecondaryStructureId() != null
				&& castOther.getRnaSequenceSecondaryStructureId() != null && this
				.getRnaSequenceSecondaryStructureId().equals(
						castOther.getRnaSequenceSecondaryStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaSequenceSecondaryStructureId() == null ? 0 : this
						.getRnaSequenceSecondaryStructureId().hashCode());
		result = 37 * result
