...
/**
 * DjJClusterId generated by hbm2java
 */
public class DjJClusterId implements java.io.Serializable {

	private Integer djJClusterId;
	...
	public DjJClusterId(Integer djJClusterId, Integer featureId,
		...
		this.djJClusterId = djJClusterId;
	...
	public Integer getDjJClusterId() {
		return this.djJClusterId;
	}

	public void setDjJClusterId(Integer djJClusterId) {
		this.djJClusterId = djJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DjJClusterId))
			return false;
		DjJClusterId castOther = (DjJClusterId) other;

		return ((this.getDjJClusterId() == castOther.getDjJClusterId()) || (this
				.getDjJClusterId() != null
				&& castOther.getDjJClusterId() != null && this
				.getDjJClusterId().equals(castOther.getDjJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDjJClusterId() == null ? 0 : this.getDjJClusterId()
						.hashCode());
		result = 37 * result
