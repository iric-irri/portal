...
/**
 * TranscriptBoundByNucleicAcidId generated by hbm2java
 */
public class TranscriptBoundByNucleicAcidId implements java.io.Serializable {

	private Integer transcriptBoundByNucleicAcidId;
	...
	public TranscriptBoundByNucleicAcidId() {
	}

	public TranscriptBoundByNucleicAcidId(
			Integer transcriptBoundByNucleicAcidId, Integer featureId,
		...
		this.transcriptBoundByNucleicAcidId = transcriptBoundByNucleicAcidId;
	...
	public Integer getTranscriptBoundByNucleicAcidId() {
		return this.transcriptBoundByNucleicAcidId;
	}

	public void setTranscriptBoundByNucleicAcidId(
			Integer transcriptBoundByNucleicAcidId) {
		this.transcriptBoundByNucleicAcidId = transcriptBoundByNucleicAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptBoundByNucleicAcidId))
			return false;
		TranscriptBoundByNucleicAcidId castOther = (TranscriptBoundByNucleicAcidId) other;

		return ((this.getTranscriptBoundByNucleicAcidId() == castOther
				.getTranscriptBoundByNucleicAcidId()) || (this
				.getTranscriptBoundByNucleicAcidId() != null
				&& castOther.getTranscriptBoundByNucleicAcidId() != null && this
				.getTranscriptBoundByNucleicAcidId().equals(
						castOther.getTranscriptBoundByNucleicAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptBoundByNucleicAcidId() == null ? 0 : this
						.getTranscriptBoundByNucleicAcidId().hashCode());
		result = 37 * result
