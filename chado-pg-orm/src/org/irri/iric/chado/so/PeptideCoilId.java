...
/**
 * PeptideCoilId generated by hbm2java
 */
public class PeptideCoilId implements java.io.Serializable {

	private Integer peptideCoilId;
	...
	public PeptideCoilId() {
	}

	public PeptideCoilId(Integer peptideCoilId, Integer featureId,
		...
		this.peptideCoilId = peptideCoilId;
	...
	public Integer getPeptideCoilId() {
		return this.peptideCoilId;
	}

	public void setPeptideCoilId(Integer peptideCoilId) {
		this.peptideCoilId = peptideCoilId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeptideCoilId))
			return false;
		PeptideCoilId castOther = (PeptideCoilId) other;

		return ((this.getPeptideCoilId() == castOther.getPeptideCoilId()) || (this
				.getPeptideCoilId() != null
				&& castOther.getPeptideCoilId() != null && this
				.getPeptideCoilId().equals(castOther.getPeptideCoilId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeptideCoilId() == null ? 0 : this.getPeptideCoilId()
						.hashCode());
		result = 37 * result
