...
/**
 * ArgTrnaPrimaryTranscriptId generated by hbm2java
 */
public class ArgTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer argTrnaPrimaryTranscriptId;
	...
	public ArgTrnaPrimaryTranscriptId() {
	}

	public ArgTrnaPrimaryTranscriptId(Integer argTrnaPrimaryTranscriptId,
		...
		this.argTrnaPrimaryTranscriptId = argTrnaPrimaryTranscriptId;
	...
	public Integer getArgTrnaPrimaryTranscriptId() {
		return this.argTrnaPrimaryTranscriptId;
	}

	public void setArgTrnaPrimaryTranscriptId(Integer argTrnaPrimaryTranscriptId) {
		this.argTrnaPrimaryTranscriptId = argTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArgTrnaPrimaryTranscriptId))
			return false;
		ArgTrnaPrimaryTranscriptId castOther = (ArgTrnaPrimaryTranscriptId) other;

		return ((this.getArgTrnaPrimaryTranscriptId() == castOther
				.getArgTrnaPrimaryTranscriptId()) || (this
				.getArgTrnaPrimaryTranscriptId() != null
				&& castOther.getArgTrnaPrimaryTranscriptId() != null && this
				.getArgTrnaPrimaryTranscriptId().equals(
						castOther.getArgTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getArgTrnaPrimaryTranscriptId() == null ? 0 : this
						.getArgTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
