...
/**
 * PolymorphicVariantId generated by hbm2java
 */
public class PolymorphicVariantId implements java.io.Serializable {

	private Integer polymorphicVariantId;
	...
	public PolymorphicVariantId() {
	}

	public PolymorphicVariantId(Integer polymorphicVariantId,
		...
		this.polymorphicVariantId = polymorphicVariantId;
	...
	public Integer getPolymorphicVariantId() {
		return this.polymorphicVariantId;
	}

	public void setPolymorphicVariantId(Integer polymorphicVariantId) {
		this.polymorphicVariantId = polymorphicVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolymorphicVariantId))
			return false;
		PolymorphicVariantId castOther = (PolymorphicVariantId) other;

		return ((this.getPolymorphicVariantId() == castOther
				.getPolymorphicVariantId()) || (this.getPolymorphicVariantId() != null
				&& castOther.getPolymorphicVariantId() != null && this
				.getPolymorphicVariantId().equals(
						castOther.getPolymorphicVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolymorphicVariantId() == null ? 0 : this
						.getPolymorphicVariantId().hashCode());
		result = 37 * result
