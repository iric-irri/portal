...
/**
 * Home object for domain model class Match.
 * @see org.irri.iric.chado.so.Match
 * @author Hibernate Tools
 */
public class MatchHome {

	private static final Log log = LogFactory.getLog(MatchHome.class);
	...
	public void persist(Match transientInstance) {
		log.debug("persisting Match instance");
		try {
	...
	public Match merge(Match detachedInstance) {
		...
		try {
			Match result = (Match) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Match findById(org.irri.iric.chado.so.MatchId id) {
		log.debug("getting Match instance with id: " + id);
		try {
			Match instance = (Match) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.so.Match", id);
			if (instance == null) {
	...
	public List findByExample(Match instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Match")
