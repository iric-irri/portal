...
/**
 * ThreeMethylpseudouridineId generated by hbm2java
 */
public class ThreeMethylpseudouridineId implements java.io.Serializable {

	private Integer threeMethylpseudouridineId;
	...
	public ThreeMethylpseudouridineId() {
	}

	public ThreeMethylpseudouridineId(Integer threeMethylpseudouridineId,
		...
		this.threeMethylpseudouridineId = threeMethylpseudouridineId;
	...
	public Integer getThreeMethylpseudouridineId() {
		return this.threeMethylpseudouridineId;
	}

	public void setThreeMethylpseudouridineId(Integer threeMethylpseudouridineId) {
		this.threeMethylpseudouridineId = threeMethylpseudouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeMethylpseudouridineId))
			return false;
		ThreeMethylpseudouridineId castOther = (ThreeMethylpseudouridineId) other;

		return ((this.getThreeMethylpseudouridineId() == castOther
				.getThreeMethylpseudouridineId()) || (this
				.getThreeMethylpseudouridineId() != null
				&& castOther.getThreeMethylpseudouridineId() != null && this
				.getThreeMethylpseudouridineId().equals(
						castOther.getThreeMethylpseudouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeMethylpseudouridineId() == null ? 0 : this
						.getThreeMethylpseudouridineId().hashCode());
		result = 37 * result
