...
/**
 * StopCodonSignalId generated by hbm2java
 */
public class StopCodonSignalId implements java.io.Serializable {

	private Integer stopCodonSignalId;
	...
	public StopCodonSignalId() {
	}

	public StopCodonSignalId(Integer stopCodonSignalId, Integer featureId,
		...
		this.stopCodonSignalId = stopCodonSignalId;
	...
	public Integer getStopCodonSignalId() {
		return this.stopCodonSignalId;
	}

	public void setStopCodonSignalId(Integer stopCodonSignalId) {
		this.stopCodonSignalId = stopCodonSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopCodonSignalId))
			return false;
		StopCodonSignalId castOther = (StopCodonSignalId) other;

		return ((this.getStopCodonSignalId() == castOther
				.getStopCodonSignalId()) || (this.getStopCodonSignalId() != null
				&& castOther.getStopCodonSignalId() != null && this
				.getStopCodonSignalId()
				.equals(castOther.getStopCodonSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopCodonSignalId() == null ? 0 : this
						.getStopCodonSignalId().hashCode());
		result = 37 * result
