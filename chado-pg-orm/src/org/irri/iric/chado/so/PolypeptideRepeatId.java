...
/**
 * PolypeptideRepeatId generated by hbm2java
 */
public class PolypeptideRepeatId implements java.io.Serializable {

	private Integer polypeptideRepeatId;
	...
	public PolypeptideRepeatId() {
	}

	public PolypeptideRepeatId(Integer polypeptideRepeatId, Integer featureId,
		...
		this.polypeptideRepeatId = polypeptideRepeatId;
	...
	public Integer getPolypeptideRepeatId() {
		return this.polypeptideRepeatId;
	}

	public void setPolypeptideRepeatId(Integer polypeptideRepeatId) {
		this.polypeptideRepeatId = polypeptideRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideRepeatId))
			return false;
		PolypeptideRepeatId castOther = (PolypeptideRepeatId) other;

		return ((this.getPolypeptideRepeatId() == castOther
				.getPolypeptideRepeatId()) || (this.getPolypeptideRepeatId() != null
				&& castOther.getPolypeptideRepeatId() != null && this
				.getPolypeptideRepeatId().equals(
						castOther.getPolypeptideRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideRepeatId() == null ? 0 : this
						.getPolypeptideRepeatId().hashCode());
		result = 37 * result
