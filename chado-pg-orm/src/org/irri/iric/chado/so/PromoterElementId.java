...
/**
 * PromoterElementId generated by hbm2java
 */
public class PromoterElementId implements java.io.Serializable {

	private Integer promoterElementId;
	...
	public PromoterElementId() {
	}

	public PromoterElementId(Integer promoterElementId, Integer featureId,
		...
		this.promoterElementId = promoterElementId;
	...
	public Integer getPromoterElementId() {
		return this.promoterElementId;
	}

	public void setPromoterElementId(Integer promoterElementId) {
		this.promoterElementId = promoterElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PromoterElementId))
			return false;
		PromoterElementId castOther = (PromoterElementId) other;

		return ((this.getPromoterElementId() == castOther
				.getPromoterElementId()) || (this.getPromoterElementId() != null
				&& castOther.getPromoterElementId() != null && this
				.getPromoterElementId()
				.equals(castOther.getPromoterElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPromoterElementId() == null ? 0 : this
						.getPromoterElementId().hashCode());
		result = 37 * result
