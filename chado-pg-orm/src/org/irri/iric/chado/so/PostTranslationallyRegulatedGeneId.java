...
/**
 * PostTranslationallyRegulatedGeneId generated by hbm2java
 */
public class PostTranslationallyRegulatedGeneId implements java.io.Serializable {

	private Integer postTranslationallyRegulatedGeneId;
	...
	public PostTranslationallyRegulatedGeneId() {
	}

	public PostTranslationallyRegulatedGeneId(
			Integer postTranslationallyRegulatedGeneId, Integer featureId,
		...
		this.postTranslationallyRegulatedGeneId = postTranslationallyRegulatedGeneId;
	...
	public Integer getPostTranslationallyRegulatedGeneId() {
		return this.postTranslationallyRegulatedGeneId;
	}

	public void setPostTranslationallyRegulatedGeneId(
			Integer postTranslationallyRegulatedGeneId) {
		this.postTranslationallyRegulatedGeneId = postTranslationallyRegulatedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PostTranslationallyRegulatedGeneId))
			return false;
		PostTranslationallyRegulatedGeneId castOther = (PostTranslationallyRegulatedGeneId) other;

		return ((this.getPostTranslationallyRegulatedGeneId() == castOther
				.getPostTranslationallyRegulatedGeneId()) || (this
				.getPostTranslationallyRegulatedGeneId() != null
				&& castOther.getPostTranslationallyRegulatedGeneId() != null && this
				.getPostTranslationallyRegulatedGeneId().equals(
						castOther.getPostTranslationallyRegulatedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPostTranslationallyRegulatedGeneId() == null ? 0 : this
						.getPostTranslationallyRegulatedGeneId().hashCode());
		result = 37 * result
