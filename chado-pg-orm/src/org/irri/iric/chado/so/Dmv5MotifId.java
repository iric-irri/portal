...
/**
 * Dmv5MotifId generated by hbm2java
 */
public class Dmv5MotifId implements java.io.Serializable {

	private Integer dmv5MotifId;
	...
	public Dmv5MotifId(Integer dmv5MotifId, Integer featureId,
	...
	public Integer getDmv5MotifId() {
		return this.dmv5MotifId;
	}

	public void setDmv5MotifId(Integer dmv5MotifId) {
		this.dmv5MotifId = dmv5MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dmv5MotifId))
			return false;
		Dmv5MotifId castOther = (Dmv5MotifId) other;

		return ((this.getDmv5MotifId() == castOther.getDmv5MotifId()) || (this
				.getDmv5MotifId() != null && castOther.getDmv5MotifId() != null && this
				.getDmv5MotifId().equals(castOther.getDmv5MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDmv5MotifId() == null ? 0 : this.getDmv5MotifId()
						.hashCode());
		result = 37 * result
