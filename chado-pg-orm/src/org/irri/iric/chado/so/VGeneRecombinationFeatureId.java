...
/**
 * VGeneRecombinationFeatureId generated by hbm2java
 */
public class VGeneRecombinationFeatureId implements java.io.Serializable {

	private Integer VGeneRecombinationFeatureId;
	...
	public VGeneRecombinationFeatureId() {
	}

	public VGeneRecombinationFeatureId(Integer VGeneRecombinationFeatureId,
		...
		this.VGeneRecombinationFeatureId = VGeneRecombinationFeatureId;
	...
	public Integer getVGeneRecombinationFeatureId() {
		return this.VGeneRecombinationFeatureId;
	}

	public void setVGeneRecombinationFeatureId(
			Integer VGeneRecombinationFeatureId) {
		this.VGeneRecombinationFeatureId = VGeneRecombinationFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VGeneRecombinationFeatureId))
			return false;
		VGeneRecombinationFeatureId castOther = (VGeneRecombinationFeatureId) other;

		return ((this.getVGeneRecombinationFeatureId() == castOther
				.getVGeneRecombinationFeatureId()) || (this
				.getVGeneRecombinationFeatureId() != null
				&& castOther.getVGeneRecombinationFeatureId() != null && this
				.getVGeneRecombinationFeatureId().equals(
						castOther.getVGeneRecombinationFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVGeneRecombinationFeatureId() == null ? 0 : this
						.getVGeneRecombinationFeatureId().hashCode());
		result = 37 * result
