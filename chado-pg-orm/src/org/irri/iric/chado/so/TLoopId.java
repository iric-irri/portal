...
/**
 * TLoopId generated by hbm2java
 */
public class TLoopId implements java.io.Serializable {

	private Integer TLoopId;
	...
	public TLoopId(Integer TLoopId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTLoopId() {
		return this.TLoopId;
	}

	public void setTLoopId(Integer TLoopId) {
		this.TLoopId = TLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TLoopId))
			return false;
		TLoopId castOther = (TLoopId) other;

		return ((this.getTLoopId() == castOther.getTLoopId()) || (this
				.getTLoopId() != null && castOther.getTLoopId() != null && this
				.getTLoopId().equals(castOther.getTLoopId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTLoopId() == null ? 0 : this.getTLoopId().hashCode());
		result = 37 * result
