...
/**
 * CrypticSpliceDonorId generated by hbm2java
 */
public class CrypticSpliceDonorId implements java.io.Serializable {

	private Integer crypticSpliceDonorId;
	...
	public CrypticSpliceDonorId() {
	}

	public CrypticSpliceDonorId(Integer crypticSpliceDonorId,
		...
		this.crypticSpliceDonorId = crypticSpliceDonorId;
	...
	public Integer getCrypticSpliceDonorId() {
		return this.crypticSpliceDonorId;
	}

	public void setCrypticSpliceDonorId(Integer crypticSpliceDonorId) {
		this.crypticSpliceDonorId = crypticSpliceDonorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticSpliceDonorId))
			return false;
		CrypticSpliceDonorId castOther = (CrypticSpliceDonorId) other;

		return ((this.getCrypticSpliceDonorId() == castOther
				.getCrypticSpliceDonorId()) || (this.getCrypticSpliceDonorId() != null
				&& castOther.getCrypticSpliceDonorId() != null && this
				.getCrypticSpliceDonorId().equals(
						castOther.getCrypticSpliceDonorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticSpliceDonorId() == null ? 0 : this
						.getCrypticSpliceDonorId().hashCode());
		result = 37 * result
