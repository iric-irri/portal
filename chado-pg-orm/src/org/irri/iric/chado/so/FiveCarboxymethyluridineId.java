...
/**
 * FiveCarboxymethyluridineId generated by hbm2java
 */
public class FiveCarboxymethyluridineId implements java.io.Serializable {

	private Integer fiveCarboxymethyluridineId;
	...
	public FiveCarboxymethyluridineId() {
	}

	public FiveCarboxymethyluridineId(Integer fiveCarboxymethyluridineId,
		...
		this.fiveCarboxymethyluridineId = fiveCarboxymethyluridineId;
	...
	public Integer getFiveCarboxymethyluridineId() {
		return this.fiveCarboxymethyluridineId;
	}

	public void setFiveCarboxymethyluridineId(Integer fiveCarboxymethyluridineId) {
		this.fiveCarboxymethyluridineId = fiveCarboxymethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCarboxymethyluridineId))
			return false;
		FiveCarboxymethyluridineId castOther = (FiveCarboxymethyluridineId) other;

		return ((this.getFiveCarboxymethyluridineId() == castOther
				.getFiveCarboxymethyluridineId()) || (this
				.getFiveCarboxymethyluridineId() != null
				&& castOther.getFiveCarboxymethyluridineId() != null && this
				.getFiveCarboxymethyluridineId().equals(
						castOther.getFiveCarboxymethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCarboxymethyluridineId() == null ? 0 : this
						.getFiveCarboxymethyluridineId().hashCode());
		result = 37 * result
