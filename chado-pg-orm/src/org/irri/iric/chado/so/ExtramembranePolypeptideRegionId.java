...
/**
 * ExtramembranePolypeptideRegionId generated by hbm2java
 */
public class ExtramembranePolypeptideRegionId implements java.io.Serializable {

	private Integer extramembranePolypeptideRegionId;
	...
	public ExtramembranePolypeptideRegionId() {
	}

	public ExtramembranePolypeptideRegionId(
			Integer extramembranePolypeptideRegionId, Integer featureId,
		...
		this.extramembranePolypeptideRegionId = extramembranePolypeptideRegionId;
	...
	public Integer getExtramembranePolypeptideRegionId() {
		return this.extramembranePolypeptideRegionId;
	}

	public void setExtramembranePolypeptideRegionId(
			Integer extramembranePolypeptideRegionId) {
		this.extramembranePolypeptideRegionId = extramembranePolypeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExtramembranePolypeptideRegionId))
			return false;
		ExtramembranePolypeptideRegionId castOther = (ExtramembranePolypeptideRegionId) other;

		return ((this.getExtramembranePolypeptideRegionId() == castOther
				.getExtramembranePolypeptideRegionId()) || (this
				.getExtramembranePolypeptideRegionId() != null
				&& castOther.getExtramembranePolypeptideRegionId() != null && this
				.getExtramembranePolypeptideRegionId().equals(
						castOther.getExtramembranePolypeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExtramembranePolypeptideRegionId() == null ? 0 : this
						.getExtramembranePolypeptideRegionId().hashCode());
		result = 37 * result
