...
/**
 * GenomicIslandId generated by hbm2java
 */
public class GenomicIslandId implements java.io.Serializable {

	private Integer genomicIslandId;
	...
	public GenomicIslandId() {
	}

	public GenomicIslandId(Integer genomicIslandId, Integer featureId,
		...
		this.genomicIslandId = genomicIslandId;
	...
	public Integer getGenomicIslandId() {
		return this.genomicIslandId;
	}

	public void setGenomicIslandId(Integer genomicIslandId) {
		this.genomicIslandId = genomicIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GenomicIslandId))
			return false;
		GenomicIslandId castOther = (GenomicIslandId) other;

		return ((this.getGenomicIslandId() == castOther.getGenomicIslandId()) || (this
				.getGenomicIslandId() != null
				&& castOther.getGenomicIslandId() != null && this
				.getGenomicIslandId().equals(castOther.getGenomicIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGenomicIslandId() == null ? 0 : this.getGenomicIslandId()
						.hashCode());
		result = 37 * result
