...
/**
 * ElongatedOutOfFramePolypeptideNTerminalId generated by hbm2java
 */
public class ElongatedOutOfFramePolypeptideNTerminalId implements
		java.io.Serializable {

	private Integer elongatedOutOfFramePolypeptideNTerminalId;
	...
	public ElongatedOutOfFramePolypeptideNTerminalId() {
	}

	public ElongatedOutOfFramePolypeptideNTerminalId(
			Integer elongatedOutOfFramePolypeptideNTerminalId,
		...
		this.elongatedOutOfFramePolypeptideNTerminalId = elongatedOutOfFramePolypeptideNTerminalId;
	...
	public Integer getElongatedOutOfFramePolypeptideNTerminalId() {
		return this.elongatedOutOfFramePolypeptideNTerminalId;
	}

	public void setElongatedOutOfFramePolypeptideNTerminalId(
			Integer elongatedOutOfFramePolypeptideNTerminalId) {
		this.elongatedOutOfFramePolypeptideNTerminalId = elongatedOutOfFramePolypeptideNTerminalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedOutOfFramePolypeptideNTerminalId))
			return false;
		ElongatedOutOfFramePolypeptideNTerminalId castOther = (ElongatedOutOfFramePolypeptideNTerminalId) other;

		return ((this.getElongatedOutOfFramePolypeptideNTerminalId() == castOther
				.getElongatedOutOfFramePolypeptideNTerminalId()) || (this
				.getElongatedOutOfFramePolypeptideNTerminalId() != null
				&& castOther.getElongatedOutOfFramePolypeptideNTerminalId() != null && this
				.getElongatedOutOfFramePolypeptideNTerminalId()
				.equals(castOther
						.getElongatedOutOfFramePolypeptideNTerminalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedOutOfFramePolypeptideNTerminalId() == null ? 0
						: this.getElongatedOutOfFramePolypeptideNTerminalId()
								.hashCode());
		result = 37 * result
