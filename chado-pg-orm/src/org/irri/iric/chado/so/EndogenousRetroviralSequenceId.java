...
/**
 * EndogenousRetroviralSequenceId generated by hbm2java
 */
public class EndogenousRetroviralSequenceId implements java.io.Serializable {

	private Integer endogenousRetroviralSequenceId;
	...
	public EndogenousRetroviralSequenceId() {
	}

	public EndogenousRetroviralSequenceId(
			Integer endogenousRetroviralSequenceId, Integer featureId,
		...
		this.endogenousRetroviralSequenceId = endogenousRetroviralSequenceId;
	...
	public Integer getEndogenousRetroviralSequenceId() {
		return this.endogenousRetroviralSequenceId;
	}

	public void setEndogenousRetroviralSequenceId(
			Integer endogenousRetroviralSequenceId) {
		this.endogenousRetroviralSequenceId = endogenousRetroviralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EndogenousRetroviralSequenceId))
			return false;
		EndogenousRetroviralSequenceId castOther = (EndogenousRetroviralSequenceId) other;

		return ((this.getEndogenousRetroviralSequenceId() == castOther
				.getEndogenousRetroviralSequenceId()) || (this
				.getEndogenousRetroviralSequenceId() != null
				&& castOther.getEndogenousRetroviralSequenceId() != null && this
				.getEndogenousRetroviralSequenceId().equals(
						castOther.getEndogenousRetroviralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEndogenousRetroviralSequenceId() == null ? 0 : this
						.getEndogenousRetroviralSequenceId().hashCode());
		result = 37 * result
