...
/**
 * CosmidId generated by hbm2java
 */
public class CosmidId implements java.io.Serializable {

	private Integer cosmidId;
	...
	public CosmidId(Integer cosmidId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCosmidId() {
		return this.cosmidId;
	}

	public void setCosmidId(Integer cosmidId) {
		this.cosmidId = cosmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CosmidId))
			return false;
		CosmidId castOther = (CosmidId) other;

		return ((this.getCosmidId() == castOther.getCosmidId()) || (this
				.getCosmidId() != null && castOther.getCosmidId() != null && this
				.getCosmidId().equals(castOther.getCosmidId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCosmidId() == null ? 0 : this.getCosmidId().hashCode());
		result = 37 * result
