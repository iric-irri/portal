...
/**
 * CentralHydrophobicRegionOfSignalPeptideId generated by hbm2java
 */
public class CentralHydrophobicRegionOfSignalPeptideId implements
		java.io.Serializable {

	private Integer centralHydrophobicRegionOfSignalPeptideId;
	...
	public CentralHydrophobicRegionOfSignalPeptideId() {
	}

	public CentralHydrophobicRegionOfSignalPeptideId(
			Integer centralHydrophobicRegionOfSignalPeptideId,
		...
		this.centralHydrophobicRegionOfSignalPeptideId = centralHydrophobicRegionOfSignalPeptideId;
	...
	public Integer getCentralHydrophobicRegionOfSignalPeptideId() {
		return this.centralHydrophobicRegionOfSignalPeptideId;
	}

	public void setCentralHydrophobicRegionOfSignalPeptideId(
			Integer centralHydrophobicRegionOfSignalPeptideId) {
		this.centralHydrophobicRegionOfSignalPeptideId = centralHydrophobicRegionOfSignalPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentralHydrophobicRegionOfSignalPeptideId))
			return false;
		CentralHydrophobicRegionOfSignalPeptideId castOther = (CentralHydrophobicRegionOfSignalPeptideId) other;

		return ((this.getCentralHydrophobicRegionOfSignalPeptideId() == castOther
				.getCentralHydrophobicRegionOfSignalPeptideId()) || (this
				.getCentralHydrophobicRegionOfSignalPeptideId() != null
				&& castOther.getCentralHydrophobicRegionOfSignalPeptideId() != null && this
				.getCentralHydrophobicRegionOfSignalPeptideId()
				.equals(castOther
						.getCentralHydrophobicRegionOfSignalPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentralHydrophobicRegionOfSignalPeptideId() == null ? 0
						: this.getCentralHydrophobicRegionOfSignalPeptideId()
								.hashCode());
		result = 37 * result
