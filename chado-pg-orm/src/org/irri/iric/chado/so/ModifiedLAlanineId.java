...
/**
 * ModifiedLAlanineId generated by hbm2java
 */
public class ModifiedLAlanineId implements java.io.Serializable {

	private Integer modifiedLAlanineId;
	...
	public ModifiedLAlanineId() {
	}

	public ModifiedLAlanineId(Integer modifiedLAlanineId, Integer featureId,
		...
		this.modifiedLAlanineId = modifiedLAlanineId;
	...
	public Integer getModifiedLAlanineId() {
		return this.modifiedLAlanineId;
	}

	public void setModifiedLAlanineId(Integer modifiedLAlanineId) {
		this.modifiedLAlanineId = modifiedLAlanineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLAlanineId))
			return false;
		ModifiedLAlanineId castOther = (ModifiedLAlanineId) other;

		return ((this.getModifiedLAlanineId() == castOther
				.getModifiedLAlanineId()) || (this.getModifiedLAlanineId() != null
				&& castOther.getModifiedLAlanineId() != null && this
				.getModifiedLAlanineId().equals(
						castOther.getModifiedLAlanineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLAlanineId() == null ? 0 : this
						.getModifiedLAlanineId().hashCode());
		result = 37 * result
