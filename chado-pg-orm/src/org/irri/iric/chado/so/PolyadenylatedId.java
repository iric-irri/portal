...
/**
 * PolyadenylatedId generated by hbm2java
 */
public class PolyadenylatedId implements java.io.Serializable {

	private Integer polyadenylatedId;
	...
	public PolyadenylatedId() {
	}

	public PolyadenylatedId(Integer polyadenylatedId, Integer featureId,
		...
		this.polyadenylatedId = polyadenylatedId;
	...
	public Integer getPolyadenylatedId() {
		return this.polyadenylatedId;
	}

	public void setPolyadenylatedId(Integer polyadenylatedId) {
		this.polyadenylatedId = polyadenylatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyadenylatedId))
			return false;
		PolyadenylatedId castOther = (PolyadenylatedId) other;

		return ((this.getPolyadenylatedId() == castOther.getPolyadenylatedId()) || (this
				.getPolyadenylatedId() != null
				&& castOther.getPolyadenylatedId() != null && this
				.getPolyadenylatedId().equals(castOther.getPolyadenylatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyadenylatedId() == null ? 0 : this
						.getPolyadenylatedId().hashCode());
		result = 37 * result
