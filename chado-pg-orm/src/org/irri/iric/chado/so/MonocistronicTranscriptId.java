...
/**
 * MonocistronicTranscriptId generated by hbm2java
 */
public class MonocistronicTranscriptId implements java.io.Serializable {

	private Integer monocistronicTranscriptId;
	...
	public MonocistronicTranscriptId() {
	}

	public MonocistronicTranscriptId(Integer monocistronicTranscriptId,
		...
		this.monocistronicTranscriptId = monocistronicTranscriptId;
	...
	public Integer getMonocistronicTranscriptId() {
		return this.monocistronicTranscriptId;
	}

	public void setMonocistronicTranscriptId(Integer monocistronicTranscriptId) {
		this.monocistronicTranscriptId = monocistronicTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MonocistronicTranscriptId))
			return false;
		MonocistronicTranscriptId castOther = (MonocistronicTranscriptId) other;

		return ((this.getMonocistronicTranscriptId() == castOther
				.getMonocistronicTranscriptId()) || (this
				.getMonocistronicTranscriptId() != null
				&& castOther.getMonocistronicTranscriptId() != null && this
				.getMonocistronicTranscriptId().equals(
						castOther.getMonocistronicTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMonocistronicTranscriptId() == null ? 0 : this
						.getMonocistronicTranscriptId().hashCode());
		result = 37 * result
