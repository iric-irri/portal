...
/**
 * CrypticProphageId generated by hbm2java
 */
public class CrypticProphageId implements java.io.Serializable {

	private Integer crypticProphageId;
	...
	public CrypticProphageId() {
	}

	public CrypticProphageId(Integer crypticProphageId, Integer featureId,
		...
		this.crypticProphageId = crypticProphageId;
	...
	public Integer getCrypticProphageId() {
		return this.crypticProphageId;
	}

	public void setCrypticProphageId(Integer crypticProphageId) {
		this.crypticProphageId = crypticProphageId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticProphageId))
			return false;
		CrypticProphageId castOther = (CrypticProphageId) other;

		return ((this.getCrypticProphageId() == castOther
				.getCrypticProphageId()) || (this.getCrypticProphageId() != null
				&& castOther.getCrypticProphageId() != null && this
				.getCrypticProphageId()
				.equals(castOther.getCrypticProphageId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticProphageId() == null ? 0 : this
						.getCrypticProphageId().hashCode());
		result = 37 * result
