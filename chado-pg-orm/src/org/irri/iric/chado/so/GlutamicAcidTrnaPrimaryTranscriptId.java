...
/**
 * GlutamicAcidTrnaPrimaryTranscriptId generated by hbm2java
 */
public class GlutamicAcidTrnaPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer glutamicAcidTrnaPrimaryTranscriptId;
	...
	public GlutamicAcidTrnaPrimaryTranscriptId() {
	}

	public GlutamicAcidTrnaPrimaryTranscriptId(
			Integer glutamicAcidTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.glutamicAcidTrnaPrimaryTranscriptId = glutamicAcidTrnaPrimaryTranscriptId;
	...
	public Integer getGlutamicAcidTrnaPrimaryTranscriptId() {
		return this.glutamicAcidTrnaPrimaryTranscriptId;
	}

	public void setGlutamicAcidTrnaPrimaryTranscriptId(
			Integer glutamicAcidTrnaPrimaryTranscriptId) {
		this.glutamicAcidTrnaPrimaryTranscriptId = glutamicAcidTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutamicAcidTrnaPrimaryTranscriptId))
			return false;
		GlutamicAcidTrnaPrimaryTranscriptId castOther = (GlutamicAcidTrnaPrimaryTranscriptId) other;

		return ((this.getGlutamicAcidTrnaPrimaryTranscriptId() == castOther
				.getGlutamicAcidTrnaPrimaryTranscriptId()) || (this
				.getGlutamicAcidTrnaPrimaryTranscriptId() != null
				&& castOther.getGlutamicAcidTrnaPrimaryTranscriptId() != null && this
				.getGlutamicAcidTrnaPrimaryTranscriptId().equals(
						castOther.getGlutamicAcidTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutamicAcidTrnaPrimaryTranscriptId() == null ? 0 : this
						.getGlutamicAcidTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
