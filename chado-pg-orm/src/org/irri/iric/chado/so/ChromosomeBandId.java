...
/**
 * ChromosomeBandId generated by hbm2java
 */
public class ChromosomeBandId implements java.io.Serializable {

	private Integer chromosomeBandId;
	...
	public ChromosomeBandId() {
	}

	public ChromosomeBandId(Integer chromosomeBandId, Integer featureId,
		...
		this.chromosomeBandId = chromosomeBandId;
	...
	public Integer getChromosomeBandId() {
		return this.chromosomeBandId;
	}

	public void setChromosomeBandId(Integer chromosomeBandId) {
		this.chromosomeBandId = chromosomeBandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeBandId))
			return false;
		ChromosomeBandId castOther = (ChromosomeBandId) other;

		return ((this.getChromosomeBandId() == castOther.getChromosomeBandId()) || (this
				.getChromosomeBandId() != null
				&& castOther.getChromosomeBandId() != null && this
				.getChromosomeBandId().equals(castOther.getChromosomeBandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeBandId() == null ? 0 : this
						.getChromosomeBandId().hashCode());
		result = 37 * result
