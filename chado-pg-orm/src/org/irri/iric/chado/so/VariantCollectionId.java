...
/**
 * VariantCollectionId generated by hbm2java
 */
public class VariantCollectionId implements java.io.Serializable {

	private Integer variantCollectionId;
	...
	public VariantCollectionId() {
	}

	public VariantCollectionId(Integer variantCollectionId, Integer featureId,
		...
		this.variantCollectionId = variantCollectionId;
	...
	public Integer getVariantCollectionId() {
		return this.variantCollectionId;
	}

	public void setVariantCollectionId(Integer variantCollectionId) {
		this.variantCollectionId = variantCollectionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantCollectionId))
			return false;
		VariantCollectionId castOther = (VariantCollectionId) other;

		return ((this.getVariantCollectionId() == castOther
				.getVariantCollectionId()) || (this.getVariantCollectionId() != null
				&& castOther.getVariantCollectionId() != null && this
				.getVariantCollectionId().equals(
						castOther.getVariantCollectionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantCollectionId() == null ? 0 : this
						.getVariantCollectionId().hashCode());
		result = 37 * result
