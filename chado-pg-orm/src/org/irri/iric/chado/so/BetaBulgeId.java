...
/**
 * BetaBulgeId generated by hbm2java
 */
public class BetaBulgeId implements java.io.Serializable {

	private Integer betaBulgeId;
	...
	public BetaBulgeId(Integer betaBulgeId, Integer featureId,
	...
	public Integer getBetaBulgeId() {
		return this.betaBulgeId;
	}

	public void setBetaBulgeId(Integer betaBulgeId) {
		this.betaBulgeId = betaBulgeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaBulgeId))
			return false;
		BetaBulgeId castOther = (BetaBulgeId) other;

		return ((this.getBetaBulgeId() == castOther.getBetaBulgeId()) || (this
				.getBetaBulgeId() != null && castOther.getBetaBulgeId() != null && this
				.getBetaBulgeId().equals(castOther.getBetaBulgeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaBulgeId() == null ? 0 : this.getBetaBulgeId()
						.hashCode());
		result = 37 * result
