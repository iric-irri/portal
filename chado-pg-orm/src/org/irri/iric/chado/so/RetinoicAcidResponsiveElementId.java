...
/**
 * RetinoicAcidResponsiveElementId generated by hbm2java
 */
public class RetinoicAcidResponsiveElementId implements java.io.Serializable {

	private Integer retinoicAcidResponsiveElementId;
	...
	public RetinoicAcidResponsiveElementId() {
	}

	public RetinoicAcidResponsiveElementId(
			Integer retinoicAcidResponsiveElementId, Integer featureId,
		...
		this.retinoicAcidResponsiveElementId = retinoicAcidResponsiveElementId;
	...
	public Integer getRetinoicAcidResponsiveElementId() {
		return this.retinoicAcidResponsiveElementId;
	}

	public void setRetinoicAcidResponsiveElementId(
			Integer retinoicAcidResponsiveElementId) {
		this.retinoicAcidResponsiveElementId = retinoicAcidResponsiveElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RetinoicAcidResponsiveElementId))
			return false;
		RetinoicAcidResponsiveElementId castOther = (RetinoicAcidResponsiveElementId) other;

		return ((this.getRetinoicAcidResponsiveElementId() == castOther
				.getRetinoicAcidResponsiveElementId()) || (this
				.getRetinoicAcidResponsiveElementId() != null
				&& castOther.getRetinoicAcidResponsiveElementId() != null && this
				.getRetinoicAcidResponsiveElementId().equals(
						castOther.getRetinoicAcidResponsiveElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRetinoicAcidResponsiveElementId() == null ? 0 : this
						.getRetinoicAcidResponsiveElementId().hashCode());
		result = 37 * result
