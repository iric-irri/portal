...
/**
 * EditingVariantId generated by hbm2java
 */
public class EditingVariantId implements java.io.Serializable {

	private Integer editingVariantId;
	...
	public EditingVariantId() {
	}

	public EditingVariantId(Integer editingVariantId, Integer featureId,
		...
		this.editingVariantId = editingVariantId;
	...
	public Integer getEditingVariantId() {
		return this.editingVariantId;
	}

	public void setEditingVariantId(Integer editingVariantId) {
		this.editingVariantId = editingVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditingVariantId))
			return false;
		EditingVariantId castOther = (EditingVariantId) other;

		return ((this.getEditingVariantId() == castOther.getEditingVariantId()) || (this
				.getEditingVariantId() != null
				&& castOther.getEditingVariantId() != null && this
				.getEditingVariantId().equals(castOther.getEditingVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditingVariantId() == null ? 0 : this
						.getEditingVariantId().hashCode());
		result = 37 * result
