...
/**
 * TranslocatonAttributeId generated by hbm2java
 */
public class TranslocatonAttributeId implements java.io.Serializable {

	private Integer translocatonAttributeId;
	...
	public TranslocatonAttributeId() {
	}

	public TranslocatonAttributeId(Integer translocatonAttributeId,
		...
		this.translocatonAttributeId = translocatonAttributeId;
	...
	public Integer getTranslocatonAttributeId() {
		return this.translocatonAttributeId;
	}

	public void setTranslocatonAttributeId(Integer translocatonAttributeId) {
		this.translocatonAttributeId = translocatonAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslocatonAttributeId))
			return false;
		TranslocatonAttributeId castOther = (TranslocatonAttributeId) other;

		return ((this.getTranslocatonAttributeId() == castOther
				.getTranslocatonAttributeId()) || (this
				.getTranslocatonAttributeId() != null
				&& castOther.getTranslocatonAttributeId() != null && this
				.getTranslocatonAttributeId().equals(
						castOther.getTranslocatonAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslocatonAttributeId() == null ? 0 : this
						.getTranslocatonAttributeId().hashCode());
		result = 37 * result
