...
/**
 * ReverseId generated by hbm2java
 */
public class ReverseId implements java.io.Serializable {
	...
	public ReverseId(Integer reverseId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReverseId))
			return false;
		ReverseId castOther = (ReverseId) other;

		return ((this.getReverseId() == castOther.getReverseId()) || (this
				.getReverseId() != null && castOther.getReverseId() != null && this
				.getReverseId().equals(castOther.getReverseId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getReverseId() == null ? 0 : this.getReverseId().hashCode());
		result = 37 * result
