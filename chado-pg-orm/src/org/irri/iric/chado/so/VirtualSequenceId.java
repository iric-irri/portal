...
/**
 * VirtualSequenceId generated by hbm2java
 */
public class VirtualSequenceId implements java.io.Serializable {

	private Integer virtualSequenceId;
	...
	public VirtualSequenceId() {
	}

	public VirtualSequenceId(Integer virtualSequenceId, Integer featureId,
		...
		this.virtualSequenceId = virtualSequenceId;
	...
	public Integer getVirtualSequenceId() {
		return this.virtualSequenceId;
	}

	public void setVirtualSequenceId(Integer virtualSequenceId) {
		this.virtualSequenceId = virtualSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VirtualSequenceId))
			return false;
		VirtualSequenceId castOther = (VirtualSequenceId) other;

		return ((this.getVirtualSequenceId() == castOther
				.getVirtualSequenceId()) || (this.getVirtualSequenceId() != null
				&& castOther.getVirtualSequenceId() != null && this
				.getVirtualSequenceId()
				.equals(castOther.getVirtualSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVirtualSequenceId() == null ? 0 : this
						.getVirtualSequenceId().hashCode());
		result = 37 * result
