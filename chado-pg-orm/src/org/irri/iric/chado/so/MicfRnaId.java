...
/**
 * MicfRnaId generated by hbm2java
 */
public class MicfRnaId implements java.io.Serializable {

	private Integer micfRnaId;
	...
	public MicfRnaId(Integer micfRnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMicfRnaId() {
		return this.micfRnaId;
	}

	public void setMicfRnaId(Integer micfRnaId) {
		this.micfRnaId = micfRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MicfRnaId))
			return false;
		MicfRnaId castOther = (MicfRnaId) other;

		return ((this.getMicfRnaId() == castOther.getMicfRnaId()) || (this
				.getMicfRnaId() != null && castOther.getMicfRnaId() != null && this
				.getMicfRnaId().equals(castOther.getMicfRnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMicfRnaId() == null ? 0 : this.getMicfRnaId().hashCode());
		result = 37 * result
