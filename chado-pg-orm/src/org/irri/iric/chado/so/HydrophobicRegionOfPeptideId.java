...
/**
 * HydrophobicRegionOfPeptideId generated by hbm2java
 */
public class HydrophobicRegionOfPeptideId implements java.io.Serializable {

	private Integer hydrophobicRegionOfPeptideId;
	...
	public HydrophobicRegionOfPeptideId() {
	}

	public HydrophobicRegionOfPeptideId(Integer hydrophobicRegionOfPeptideId,
		...
		this.hydrophobicRegionOfPeptideId = hydrophobicRegionOfPeptideId;
	...
	public Integer getHydrophobicRegionOfPeptideId() {
		return this.hydrophobicRegionOfPeptideId;
	}

	public void setHydrophobicRegionOfPeptideId(
			Integer hydrophobicRegionOfPeptideId) {
		this.hydrophobicRegionOfPeptideId = hydrophobicRegionOfPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HydrophobicRegionOfPeptideId))
			return false;
		HydrophobicRegionOfPeptideId castOther = (HydrophobicRegionOfPeptideId) other;

		return ((this.getHydrophobicRegionOfPeptideId() == castOther
				.getHydrophobicRegionOfPeptideId()) || (this
				.getHydrophobicRegionOfPeptideId() != null
				&& castOther.getHydrophobicRegionOfPeptideId() != null && this
				.getHydrophobicRegionOfPeptideId().equals(
						castOther.getHydrophobicRegionOfPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHydrophobicRegionOfPeptideId() == null ? 0 : this
						.getHydrophobicRegionOfPeptideId().hashCode());
		result = 37 * result
