...
/**
 * IncreasedTranscriptStabilityVariantId generated by hbm2java
 */
public class IncreasedTranscriptStabilityVariantId implements
		java.io.Serializable {

	private Integer increasedTranscriptStabilityVariantId;
	...
	public IncreasedTranscriptStabilityVariantId() {
	}

	public IncreasedTranscriptStabilityVariantId(
			Integer increasedTranscriptStabilityVariantId, Integer featureId,
		...
		this.increasedTranscriptStabilityVariantId = increasedTranscriptStabilityVariantId;
	...
	public Integer getIncreasedTranscriptStabilityVariantId() {
		return this.increasedTranscriptStabilityVariantId;
	}

	public void setIncreasedTranscriptStabilityVariantId(
			Integer increasedTranscriptStabilityVariantId) {
		this.increasedTranscriptStabilityVariantId = increasedTranscriptStabilityVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncreasedTranscriptStabilityVariantId))
			return false;
		IncreasedTranscriptStabilityVariantId castOther = (IncreasedTranscriptStabilityVariantId) other;

		return ((this.getIncreasedTranscriptStabilityVariantId() == castOther
				.getIncreasedTranscriptStabilityVariantId()) || (this
				.getIncreasedTranscriptStabilityVariantId() != null
				&& castOther.getIncreasedTranscriptStabilityVariantId() != null && this
				.getIncreasedTranscriptStabilityVariantId().equals(
						castOther.getIncreasedTranscriptStabilityVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncreasedTranscriptStabilityVariantId() == null ? 0
						: this.getIncreasedTranscriptStabilityVariantId()
								.hashCode());
		result = 37 * result
