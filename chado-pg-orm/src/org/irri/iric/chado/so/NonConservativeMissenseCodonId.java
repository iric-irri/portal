...
/**
 * NonConservativeMissenseCodonId generated by hbm2java
 */
public class NonConservativeMissenseCodonId implements java.io.Serializable {

	private Integer nonConservativeMissenseCodonId;
	...
	public NonConservativeMissenseCodonId() {
	}

	public NonConservativeMissenseCodonId(
			Integer nonConservativeMissenseCodonId, Integer featureId,
		...
		this.nonConservativeMissenseCodonId = nonConservativeMissenseCodonId;
	...
	public Integer getNonConservativeMissenseCodonId() {
		return this.nonConservativeMissenseCodonId;
	}

	public void setNonConservativeMissenseCodonId(
			Integer nonConservativeMissenseCodonId) {
		this.nonConservativeMissenseCodonId = nonConservativeMissenseCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonConservativeMissenseCodonId))
			return false;
		NonConservativeMissenseCodonId castOther = (NonConservativeMissenseCodonId) other;

		return ((this.getNonConservativeMissenseCodonId() == castOther
				.getNonConservativeMissenseCodonId()) || (this
				.getNonConservativeMissenseCodonId() != null
				&& castOther.getNonConservativeMissenseCodonId() != null && this
				.getNonConservativeMissenseCodonId().equals(
						castOther.getNonConservativeMissenseCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonConservativeMissenseCodonId() == null ? 0 : this
						.getNonConservativeMissenseCodonId().hashCode());
		result = 37 * result
