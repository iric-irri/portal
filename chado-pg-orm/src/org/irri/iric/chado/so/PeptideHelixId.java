...
/**
 * PeptideHelixId generated by hbm2java
 */
public class PeptideHelixId implements java.io.Serializable {

	private Integer peptideHelixId;
	...
	public PeptideHelixId() {
	}

	public PeptideHelixId(Integer peptideHelixId, Integer featureId,
		...
		this.peptideHelixId = peptideHelixId;
	...
	public Integer getPeptideHelixId() {
		return this.peptideHelixId;
	}

	public void setPeptideHelixId(Integer peptideHelixId) {
		this.peptideHelixId = peptideHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeptideHelixId))
			return false;
		PeptideHelixId castOther = (PeptideHelixId) other;

		return ((this.getPeptideHelixId() == castOther.getPeptideHelixId()) || (this
				.getPeptideHelixId() != null
				&& castOther.getPeptideHelixId() != null && this
				.getPeptideHelixId().equals(castOther.getPeptideHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeptideHelixId() == null ? 0 : this.getPeptideHelixId()
						.hashCode());
		result = 37 * result
