...
/**
 * FreeChromosomeArmId generated by hbm2java
 */
public class FreeChromosomeArmId implements java.io.Serializable {

	private Integer freeChromosomeArmId;
	...
	public FreeChromosomeArmId() {
	}

	public FreeChromosomeArmId(Integer freeChromosomeArmId, Integer featureId,
		...
		this.freeChromosomeArmId = freeChromosomeArmId;
	...
	public Integer getFreeChromosomeArmId() {
		return this.freeChromosomeArmId;
	}

	public void setFreeChromosomeArmId(Integer freeChromosomeArmId) {
		this.freeChromosomeArmId = freeChromosomeArmId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreeChromosomeArmId))
			return false;
		FreeChromosomeArmId castOther = (FreeChromosomeArmId) other;

		return ((this.getFreeChromosomeArmId() == castOther
				.getFreeChromosomeArmId()) || (this.getFreeChromosomeArmId() != null
				&& castOther.getFreeChromosomeArmId() != null && this
				.getFreeChromosomeArmId().equals(
						castOther.getFreeChromosomeArmId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFreeChromosomeArmId() == null ? 0 : this
						.getFreeChromosomeArmId().hashCode());
		result = 37 * result
