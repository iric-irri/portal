...
/**
 * SilencedByHistoneDeacetylationId generated by hbm2java
 */
public class SilencedByHistoneDeacetylationId implements java.io.Serializable {

	private Integer silencedByHistoneDeacetylationId;
	...
	public SilencedByHistoneDeacetylationId() {
	}

	public SilencedByHistoneDeacetylationId(
			Integer silencedByHistoneDeacetylationId, Integer featureId,
		...
		this.silencedByHistoneDeacetylationId = silencedByHistoneDeacetylationId;
	...
	public Integer getSilencedByHistoneDeacetylationId() {
		return this.silencedByHistoneDeacetylationId;
	}

	public void setSilencedByHistoneDeacetylationId(
			Integer silencedByHistoneDeacetylationId) {
		this.silencedByHistoneDeacetylationId = silencedByHistoneDeacetylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByHistoneDeacetylationId))
			return false;
		SilencedByHistoneDeacetylationId castOther = (SilencedByHistoneDeacetylationId) other;

		return ((this.getSilencedByHistoneDeacetylationId() == castOther
				.getSilencedByHistoneDeacetylationId()) || (this
				.getSilencedByHistoneDeacetylationId() != null
				&& castOther.getSilencedByHistoneDeacetylationId() != null && this
				.getSilencedByHistoneDeacetylationId().equals(
						castOther.getSilencedByHistoneDeacetylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByHistoneDeacetylationId() == null ? 0 : this
						.getSilencedByHistoneDeacetylationId().hashCode());
		result = 37 * result
