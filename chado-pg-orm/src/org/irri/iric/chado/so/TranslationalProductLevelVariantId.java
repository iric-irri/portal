...
/**
 * TranslationalProductLevelVariantId generated by hbm2java
 */
public class TranslationalProductLevelVariantId implements java.io.Serializable {

	private Integer translationalProductLevelVariantId;
	...
	public TranslationalProductLevelVariantId() {
	}

	public TranslationalProductLevelVariantId(
			Integer translationalProductLevelVariantId, Integer featureId,
		...
		this.translationalProductLevelVariantId = translationalProductLevelVariantId;
	...
	public Integer getTranslationalProductLevelVariantId() {
		return this.translationalProductLevelVariantId;
	}

	public void setTranslationalProductLevelVariantId(
			Integer translationalProductLevelVariantId) {
		this.translationalProductLevelVariantId = translationalProductLevelVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationalProductLevelVariantId))
			return false;
		TranslationalProductLevelVariantId castOther = (TranslationalProductLevelVariantId) other;

		return ((this.getTranslationalProductLevelVariantId() == castOther
				.getTranslationalProductLevelVariantId()) || (this
				.getTranslationalProductLevelVariantId() != null
				&& castOther.getTranslationalProductLevelVariantId() != null && this
				.getTranslationalProductLevelVariantId().equals(
						castOther.getTranslationalProductLevelVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationalProductLevelVariantId() == null ? 0 : this
						.getTranslationalProductLevelVariantId().hashCode());
		result = 37 * result
