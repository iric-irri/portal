...
/**
 * RecodedMrnaId generated by hbm2java
 */
public class RecodedMrnaId implements java.io.Serializable {

	private Integer recodedMrnaId;
	...
	public RecodedMrnaId() {
	}

	public RecodedMrnaId(Integer recodedMrnaId, Integer featureId,
		...
		this.recodedMrnaId = recodedMrnaId;
	...
	public Integer getRecodedMrnaId() {
		return this.recodedMrnaId;
	}

	public void setRecodedMrnaId(Integer recodedMrnaId) {
		this.recodedMrnaId = recodedMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodedMrnaId))
			return false;
		RecodedMrnaId castOther = (RecodedMrnaId) other;

		return ((this.getRecodedMrnaId() == castOther.getRecodedMrnaId()) || (this
				.getRecodedMrnaId() != null
				&& castOther.getRecodedMrnaId() != null && this
				.getRecodedMrnaId().equals(castOther.getRecodedMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecodedMrnaId() == null ? 0 : this.getRecodedMrnaId()
						.hashCode());
		result = 37 * result
