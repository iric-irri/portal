...
/**
 * Sl5AcceptorSiteId generated by hbm2java
 */
public class Sl5AcceptorSiteId implements java.io.Serializable {

	private Integer sl5AcceptorSiteId;
	...
	public Sl5AcceptorSiteId() {
	}

	public Sl5AcceptorSiteId(Integer sl5AcceptorSiteId, Integer featureId,
		...
		this.sl5AcceptorSiteId = sl5AcceptorSiteId;
	...
	public Integer getSl5AcceptorSiteId() {
		return this.sl5AcceptorSiteId;
	}

	public void setSl5AcceptorSiteId(Integer sl5AcceptorSiteId) {
		this.sl5AcceptorSiteId = sl5AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl5AcceptorSiteId))
			return false;
		Sl5AcceptorSiteId castOther = (Sl5AcceptorSiteId) other;

		return ((this.getSl5AcceptorSiteId() == castOther
				.getSl5AcceptorSiteId()) || (this.getSl5AcceptorSiteId() != null
				&& castOther.getSl5AcceptorSiteId() != null && this
				.getSl5AcceptorSiteId()
				.equals(castOther.getSl5AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl5AcceptorSiteId() == null ? 0 : this
						.getSl5AcceptorSiteId().hashCode());
		result = 37 * result
