...
/**
 * StsMapId generated by hbm2java
 */
public class StsMapId implements java.io.Serializable {

	private Integer stsMapId;
	...
	public StsMapId(Integer stsMapId, Integer featureId, Integer dbxrefId,
	...
	public Integer getStsMapId() {
		return this.stsMapId;
	}

	public void setStsMapId(Integer stsMapId) {
		this.stsMapId = stsMapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StsMapId))
			return false;
		StsMapId castOther = (StsMapId) other;

		return ((this.getStsMapId() == castOther.getStsMapId()) || (this
				.getStsMapId() != null && castOther.getStsMapId() != null && this
				.getStsMapId().equals(castOther.getStsMapId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getStsMapId() == null ? 0 : this.getStsMapId().hashCode());
		result = 37 * result
