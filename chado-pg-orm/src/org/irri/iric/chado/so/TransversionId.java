...
/**
 * TransversionId generated by hbm2java
 */
public class TransversionId implements java.io.Serializable {

	private Integer transversionId;
	...
	public TransversionId() {
	}

	public TransversionId(Integer transversionId, Integer featureId,
		...
		this.transversionId = transversionId;
	...
	public Integer getTransversionId() {
		return this.transversionId;
	}

	public void setTransversionId(Integer transversionId) {
		this.transversionId = transversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransversionId))
			return false;
		TransversionId castOther = (TransversionId) other;

		return ((this.getTransversionId() == castOther.getTransversionId()) || (this
				.getTransversionId() != null
				&& castOther.getTransversionId() != null && this
				.getTransversionId().equals(castOther.getTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransversionId() == null ? 0 : this.getTransversionId()
						.hashCode());
		result = 37 * result
