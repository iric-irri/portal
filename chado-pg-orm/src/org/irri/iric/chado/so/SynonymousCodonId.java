...
/**
 * SynonymousCodonId generated by hbm2java
 */
public class SynonymousCodonId implements java.io.Serializable {

	private Integer synonymousCodonId;
	...
	public SynonymousCodonId() {
	}

	public SynonymousCodonId(Integer synonymousCodonId, Integer featureId,
		...
		this.synonymousCodonId = synonymousCodonId;
	...
	public Integer getSynonymousCodonId() {
		return this.synonymousCodonId;
	}

	public void setSynonymousCodonId(Integer synonymousCodonId) {
		this.synonymousCodonId = synonymousCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SynonymousCodonId))
			return false;
		SynonymousCodonId castOther = (SynonymousCodonId) other;

		return ((this.getSynonymousCodonId() == castOther
				.getSynonymousCodonId()) || (this.getSynonymousCodonId() != null
				&& castOther.getSynonymousCodonId() != null && this
				.getSynonymousCodonId()
				.equals(castOther.getSynonymousCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSynonymousCodonId() == null ? 0 : this
						.getSynonymousCodonId().hashCode());
		result = 37 * result
