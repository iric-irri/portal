...
/**
 * ChipSeqRegionId generated by hbm2java
 */
public class ChipSeqRegionId implements java.io.Serializable {

	private Integer chipSeqRegionId;
	...
	public ChipSeqRegionId() {
	}

	public ChipSeqRegionId(Integer chipSeqRegionId, Integer featureId,
		...
		this.chipSeqRegionId = chipSeqRegionId;
	...
	public Integer getChipSeqRegionId() {
		return this.chipSeqRegionId;
	}

	public void setChipSeqRegionId(Integer chipSeqRegionId) {
		this.chipSeqRegionId = chipSeqRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChipSeqRegionId))
			return false;
		ChipSeqRegionId castOther = (ChipSeqRegionId) other;

		return ((this.getChipSeqRegionId() == castOther.getChipSeqRegionId()) || (this
				.getChipSeqRegionId() != null
				&& castOther.getChipSeqRegionId() != null && this
				.getChipSeqRegionId().equals(castOther.getChipSeqRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChipSeqRegionId() == null ? 0 : this.getChipSeqRegionId()
						.hashCode());
		result = 37 * result
