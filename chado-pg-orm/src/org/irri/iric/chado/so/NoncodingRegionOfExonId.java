...
/**
 * NoncodingRegionOfExonId generated by hbm2java
 */
public class NoncodingRegionOfExonId implements java.io.Serializable {

	private Integer noncodingRegionOfExonId;
	...
	public NoncodingRegionOfExonId() {
	}

	public NoncodingRegionOfExonId(Integer noncodingRegionOfExonId,
		...
		this.noncodingRegionOfExonId = noncodingRegionOfExonId;
	...
	public Integer getNoncodingRegionOfExonId() {
		return this.noncodingRegionOfExonId;
	}

	public void setNoncodingRegionOfExonId(Integer noncodingRegionOfExonId) {
		this.noncodingRegionOfExonId = noncodingRegionOfExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NoncodingRegionOfExonId))
			return false;
		NoncodingRegionOfExonId castOther = (NoncodingRegionOfExonId) other;

		return ((this.getNoncodingRegionOfExonId() == castOther
				.getNoncodingRegionOfExonId()) || (this
				.getNoncodingRegionOfExonId() != null
				&& castOther.getNoncodingRegionOfExonId() != null && this
				.getNoncodingRegionOfExonId().equals(
						castOther.getNoncodingRegionOfExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNoncodingRegionOfExonId() == null ? 0 : this
						.getNoncodingRegionOfExonId().hashCode());
		result = 37 * result
