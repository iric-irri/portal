...
/**
 * HistoneMethylationSiteId generated by hbm2java
 */
public class HistoneMethylationSiteId implements java.io.Serializable {

	private Integer histoneMethylationSiteId;
	...
	public HistoneMethylationSiteId() {
	}

	public HistoneMethylationSiteId(Integer histoneMethylationSiteId,
		...
		this.histoneMethylationSiteId = histoneMethylationSiteId;
	...
	public Integer getHistoneMethylationSiteId() {
		return this.histoneMethylationSiteId;
	}

	public void setHistoneMethylationSiteId(Integer histoneMethylationSiteId) {
		this.histoneMethylationSiteId = histoneMethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneMethylationSiteId))
			return false;
		HistoneMethylationSiteId castOther = (HistoneMethylationSiteId) other;

		return ((this.getHistoneMethylationSiteId() == castOther
				.getHistoneMethylationSiteId()) || (this
				.getHistoneMethylationSiteId() != null
				&& castOther.getHistoneMethylationSiteId() != null && this
				.getHistoneMethylationSiteId().equals(
						castOther.getHistoneMethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneMethylationSiteId() == null ? 0 : this
						.getHistoneMethylationSiteId().hashCode());
		result = 37 * result
