...
/**
 * HistidineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class HistidineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer histidineTrnaPrimaryTranscriptId;
	...
	public HistidineTrnaPrimaryTranscriptId() {
	}

	public HistidineTrnaPrimaryTranscriptId(
			Integer histidineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.histidineTrnaPrimaryTranscriptId = histidineTrnaPrimaryTranscriptId;
	...
	public Integer getHistidineTrnaPrimaryTranscriptId() {
		return this.histidineTrnaPrimaryTranscriptId;
	}

	public void setHistidineTrnaPrimaryTranscriptId(
			Integer histidineTrnaPrimaryTranscriptId) {
		this.histidineTrnaPrimaryTranscriptId = histidineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistidineTrnaPrimaryTranscriptId))
			return false;
		HistidineTrnaPrimaryTranscriptId castOther = (HistidineTrnaPrimaryTranscriptId) other;

		return ((this.getHistidineTrnaPrimaryTranscriptId() == castOther
				.getHistidineTrnaPrimaryTranscriptId()) || (this
				.getHistidineTrnaPrimaryTranscriptId() != null
				&& castOther.getHistidineTrnaPrimaryTranscriptId() != null && this
				.getHistidineTrnaPrimaryTranscriptId().equals(
						castOther.getHistidineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistidineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getHistidineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
