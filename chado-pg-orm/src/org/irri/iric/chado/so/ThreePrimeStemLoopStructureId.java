...
/**
 * ThreePrimeStemLoopStructureId generated by hbm2java
 */
public class ThreePrimeStemLoopStructureId implements java.io.Serializable {

	private Integer threePrimeStemLoopStructureId;
	...
	public ThreePrimeStemLoopStructureId() {
	}

	public ThreePrimeStemLoopStructureId(Integer threePrimeStemLoopStructureId,
		...
		this.threePrimeStemLoopStructureId = threePrimeStemLoopStructureId;
	...
	public Integer getThreePrimeStemLoopStructureId() {
		return this.threePrimeStemLoopStructureId;
	}

	public void setThreePrimeStemLoopStructureId(
			Integer threePrimeStemLoopStructureId) {
		this.threePrimeStemLoopStructureId = threePrimeStemLoopStructureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeStemLoopStructureId))
			return false;
		ThreePrimeStemLoopStructureId castOther = (ThreePrimeStemLoopStructureId) other;

		return ((this.getThreePrimeStemLoopStructureId() == castOther
				.getThreePrimeStemLoopStructureId()) || (this
				.getThreePrimeStemLoopStructureId() != null
				&& castOther.getThreePrimeStemLoopStructureId() != null && this
				.getThreePrimeStemLoopStructureId().equals(
						castOther.getThreePrimeStemLoopStructureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeStemLoopStructureId() == null ? 0 : this
						.getThreePrimeStemLoopStructureId().hashCode());
		result = 37 * result
