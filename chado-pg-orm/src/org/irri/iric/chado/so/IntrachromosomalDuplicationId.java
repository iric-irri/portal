...
/**
 * IntrachromosomalDuplicationId generated by hbm2java
 */
public class IntrachromosomalDuplicationId implements java.io.Serializable {

	private Integer intrachromosomalDuplicationId;
	...
	public IntrachromosomalDuplicationId() {
	}

	public IntrachromosomalDuplicationId(Integer intrachromosomalDuplicationId,
		...
		this.intrachromosomalDuplicationId = intrachromosomalDuplicationId;
	...
	public Integer getIntrachromosomalDuplicationId() {
		return this.intrachromosomalDuplicationId;
	}

	public void setIntrachromosomalDuplicationId(
			Integer intrachromosomalDuplicationId) {
		this.intrachromosomalDuplicationId = intrachromosomalDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntrachromosomalDuplicationId))
			return false;
		IntrachromosomalDuplicationId castOther = (IntrachromosomalDuplicationId) other;

		return ((this.getIntrachromosomalDuplicationId() == castOther
				.getIntrachromosomalDuplicationId()) || (this
				.getIntrachromosomalDuplicationId() != null
				&& castOther.getIntrachromosomalDuplicationId() != null && this
				.getIntrachromosomalDuplicationId().equals(
						castOther.getIntrachromosomalDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntrachromosomalDuplicationId() == null ? 0 : this
						.getIntrachromosomalDuplicationId().hashCode());
		result = 37 * result
