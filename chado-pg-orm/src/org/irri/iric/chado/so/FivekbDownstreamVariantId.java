...
/**
 * FivekbDownstreamVariantId generated by hbm2java
 */
public class FivekbDownstreamVariantId implements java.io.Serializable {

	private Integer fivekbDownstreamVariantId;
	...
	public FivekbDownstreamVariantId() {
	}

	public FivekbDownstreamVariantId(Integer fivekbDownstreamVariantId,
		...
		this.fivekbDownstreamVariantId = fivekbDownstreamVariantId;
	...
	public Integer getFivekbDownstreamVariantId() {
		return this.fivekbDownstreamVariantId;
	}

	public void setFivekbDownstreamVariantId(Integer fivekbDownstreamVariantId) {
		this.fivekbDownstreamVariantId = fivekbDownstreamVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivekbDownstreamVariantId))
			return false;
		FivekbDownstreamVariantId castOther = (FivekbDownstreamVariantId) other;

		return ((this.getFivekbDownstreamVariantId() == castOther
				.getFivekbDownstreamVariantId()) || (this
				.getFivekbDownstreamVariantId() != null
				&& castOther.getFivekbDownstreamVariantId() != null && this
				.getFivekbDownstreamVariantId().equals(
						castOther.getFivekbDownstreamVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivekbDownstreamVariantId() == null ? 0 : this
						.getFivekbDownstreamVariantId().hashCode());
		result = 37 * result
