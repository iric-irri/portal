...
/**
 * QualityValueId generated by hbm2java
 */
public class QualityValueId implements java.io.Serializable {

	private Integer qualityValueId;
	...
	public QualityValueId() {
	}

	public QualityValueId(Integer qualityValueId, Integer featureId,
	...
	public Integer getQualityValueId() {
		return this.qualityValueId;
	}

	public void setQualityValueId(Integer qualityValueId) {
		this.qualityValueId = qualityValueId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QualityValueId))
			return false;
		QualityValueId castOther = (QualityValueId) other;

		return ((this.getQualityValueId() == castOther.getQualityValueId()) || (this
				.getQualityValueId() != null
				&& castOther.getQualityValueId() != null && this
				.getQualityValueId().equals(castOther.getQualityValueId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getQualityValueId() == null ? 0 : this.getQualityValueId()
						.hashCode());
		result = 37 * result
