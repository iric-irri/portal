...
/**
 * FiveMethylaminomethyluridineId generated by hbm2java
 */
public class FiveMethylaminomethyluridineId implements java.io.Serializable {

	private Integer fiveMethylaminomethyluridineId;
	...
	public FiveMethylaminomethyluridineId() {
	}

	public FiveMethylaminomethyluridineId(
			Integer fiveMethylaminomethyluridineId, Integer featureId,
		...
		this.fiveMethylaminomethyluridineId = fiveMethylaminomethyluridineId;
	...
	public Integer getFiveMethylaminomethyluridineId() {
		return this.fiveMethylaminomethyluridineId;
	}

	public void setFiveMethylaminomethyluridineId(
			Integer fiveMethylaminomethyluridineId) {
		this.fiveMethylaminomethyluridineId = fiveMethylaminomethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethylaminomethyluridineId))
			return false;
		FiveMethylaminomethyluridineId castOther = (FiveMethylaminomethyluridineId) other;

		return ((this.getFiveMethylaminomethyluridineId() == castOther
				.getFiveMethylaminomethyluridineId()) || (this
				.getFiveMethylaminomethyluridineId() != null
				&& castOther.getFiveMethylaminomethyluridineId() != null && this
				.getFiveMethylaminomethyluridineId().equals(
						castOther.getFiveMethylaminomethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethylaminomethyluridineId() == null ? 0 : this
						.getFiveMethylaminomethyluridineId().hashCode());
		result = 37 * result
