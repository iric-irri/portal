...
/**
 * GroupIIntronId generated by hbm2java
 */
public class GroupIIntronId implements java.io.Serializable {

	private Integer groupIIntronId;
	...
	public GroupIIntronId() {
	}

	public GroupIIntronId(Integer groupIIntronId, Integer featureId,
		...
		this.groupIIntronId = groupIIntronId;
	...
	public Integer getGroupIIntronId() {
		return this.groupIIntronId;
	}

	public void setGroupIIntronId(Integer groupIIntronId) {
		this.groupIIntronId = groupIIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIIntronId))
			return false;
		GroupIIntronId castOther = (GroupIIntronId) other;

		return ((this.getGroupIIntronId() == castOther.getGroupIIntronId()) || (this
				.getGroupIIntronId() != null
				&& castOther.getGroupIIntronId() != null && this
				.getGroupIIntronId().equals(castOther.getGroupIIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroupIIntronId() == null ? 0 : this.getGroupIIntronId()
						.hashCode());
		result = 37 * result
