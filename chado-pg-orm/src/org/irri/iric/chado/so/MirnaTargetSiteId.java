...
/**
 * MirnaTargetSiteId generated by hbm2java
 */
public class MirnaTargetSiteId implements java.io.Serializable {

	private Integer mirnaTargetSiteId;
	...
	public MirnaTargetSiteId() {
	}

	public MirnaTargetSiteId(Integer mirnaTargetSiteId, Integer featureId,
		...
		this.mirnaTargetSiteId = mirnaTargetSiteId;
	...
	public Integer getMirnaTargetSiteId() {
		return this.mirnaTargetSiteId;
	}

	public void setMirnaTargetSiteId(Integer mirnaTargetSiteId) {
		this.mirnaTargetSiteId = mirnaTargetSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaTargetSiteId))
			return false;
		MirnaTargetSiteId castOther = (MirnaTargetSiteId) other;

		return ((this.getMirnaTargetSiteId() == castOther
				.getMirnaTargetSiteId()) || (this.getMirnaTargetSiteId() != null
				&& castOther.getMirnaTargetSiteId() != null && this
				.getMirnaTargetSiteId()
				.equals(castOther.getMirnaTargetSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaTargetSiteId() == null ? 0 : this
						.getMirnaTargetSiteId().hashCode());
		result = 37 * result
