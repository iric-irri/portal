...
/**
 * KTurnRnaMotifId generated by hbm2java
 */
public class KTurnRnaMotifId implements java.io.Serializable {

	private Integer KTurnRnaMotifId;
	...
	public KTurnRnaMotifId() {
	}

	public KTurnRnaMotifId(Integer KTurnRnaMotifId, Integer featureId,
		...
		this.KTurnRnaMotifId = KTurnRnaMotifId;
	...
	public Integer getKTurnRnaMotifId() {
		return this.KTurnRnaMotifId;
	}

	public void setKTurnRnaMotifId(Integer KTurnRnaMotifId) {
		this.KTurnRnaMotifId = KTurnRnaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KTurnRnaMotifId))
			return false;
		KTurnRnaMotifId castOther = (KTurnRnaMotifId) other;

		return ((this.getKTurnRnaMotifId() == castOther.getKTurnRnaMotifId()) || (this
				.getKTurnRnaMotifId() != null
				&& castOther.getKTurnRnaMotifId() != null && this
				.getKTurnRnaMotifId().equals(castOther.getKTurnRnaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getKTurnRnaMotifId() == null ? 0 : this.getKTurnRnaMotifId()
						.hashCode());
		result = 37 * result
