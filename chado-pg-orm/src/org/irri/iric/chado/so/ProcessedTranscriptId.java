...
/**
 * ProcessedTranscriptId generated by hbm2java
 */
public class ProcessedTranscriptId implements java.io.Serializable {

	private Integer processedTranscriptId;
	...
	public ProcessedTranscriptId() {
	}

	public ProcessedTranscriptId(Integer processedTranscriptId,
		...
		this.processedTranscriptId = processedTranscriptId;
	...
	public Integer getProcessedTranscriptId() {
		return this.processedTranscriptId;
	}

	public void setProcessedTranscriptId(Integer processedTranscriptId) {
		this.processedTranscriptId = processedTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProcessedTranscriptId))
			return false;
		ProcessedTranscriptId castOther = (ProcessedTranscriptId) other;

		return ((this.getProcessedTranscriptId() == castOther
				.getProcessedTranscriptId()) || (this
				.getProcessedTranscriptId() != null
				&& castOther.getProcessedTranscriptId() != null && this
				.getProcessedTranscriptId().equals(
						castOther.getProcessedTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProcessedTranscriptId() == null ? 0 : this
						.getProcessedTranscriptId().hashCode());
		result = 37 * result
