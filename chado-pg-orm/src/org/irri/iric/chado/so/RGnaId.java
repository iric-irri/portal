...
/**
 * RGnaId generated by hbm2java
 */
public class RGnaId implements java.io.Serializable {

	private Integer RGnaId;
	...
	public RGnaId(Integer RGnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRGnaId() {
		return this.RGnaId;
	}

	public void setRGnaId(Integer RGnaId) {
		this.RGnaId = RGnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RGnaId))
			return false;
		RGnaId castOther = (RGnaId) other;

		return ((this.getRGnaId() == castOther.getRGnaId()) || (this
				.getRGnaId() != null && castOther.getRGnaId() != null && this
				.getRGnaId().equals(castOther.getRGnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRGnaId() == null ? 0 : this.getRGnaId().hashCode());
		result = 37 * result
