...
/**
 * EnhancerId generated by hbm2java
 */
public class EnhancerId implements java.io.Serializable {

	private Integer enhancerId;
	...
	public EnhancerId(Integer enhancerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getEnhancerId() {
		return this.enhancerId;
	}

	public void setEnhancerId(Integer enhancerId) {
		this.enhancerId = enhancerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnhancerId))
			return false;
		EnhancerId castOther = (EnhancerId) other;

		return ((this.getEnhancerId() == castOther.getEnhancerId()) || (this
				.getEnhancerId() != null && castOther.getEnhancerId() != null && this
				.getEnhancerId().equals(castOther.getEnhancerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnhancerId() == null ? 0 : this.getEnhancerId()
						.hashCode());
		result = 37 * result
