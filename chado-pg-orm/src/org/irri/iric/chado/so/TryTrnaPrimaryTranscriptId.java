...
/**
 * TryTrnaPrimaryTranscriptId generated by hbm2java
 */
public class TryTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer tryTrnaPrimaryTranscriptId;
	...
	public TryTrnaPrimaryTranscriptId() {
	}

	public TryTrnaPrimaryTranscriptId(Integer tryTrnaPrimaryTranscriptId,
		...
		this.tryTrnaPrimaryTranscriptId = tryTrnaPrimaryTranscriptId;
	...
	public Integer getTryTrnaPrimaryTranscriptId() {
		return this.tryTrnaPrimaryTranscriptId;
	}

	public void setTryTrnaPrimaryTranscriptId(Integer tryTrnaPrimaryTranscriptId) {
		this.tryTrnaPrimaryTranscriptId = tryTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TryTrnaPrimaryTranscriptId))
			return false;
		TryTrnaPrimaryTranscriptId castOther = (TryTrnaPrimaryTranscriptId) other;

		return ((this.getTryTrnaPrimaryTranscriptId() == castOther
				.getTryTrnaPrimaryTranscriptId()) || (this
				.getTryTrnaPrimaryTranscriptId() != null
				&& castOther.getTryTrnaPrimaryTranscriptId() != null && this
				.getTryTrnaPrimaryTranscriptId().equals(
						castOther.getTryTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTryTrnaPrimaryTranscriptId() == null ? 0 : this
						.getTryTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
