...
/**
 * SmallRegulatoryNcrnaId generated by hbm2java
 */
public class SmallRegulatoryNcrnaId implements java.io.Serializable {

	private Integer smallRegulatoryNcrnaId;
	...
	public SmallRegulatoryNcrnaId() {
	}

	public SmallRegulatoryNcrnaId(Integer smallRegulatoryNcrnaId,
		...
		this.smallRegulatoryNcrnaId = smallRegulatoryNcrnaId;
	...
	public Integer getSmallRegulatoryNcrnaId() {
		return this.smallRegulatoryNcrnaId;
	}

	public void setSmallRegulatoryNcrnaId(Integer smallRegulatoryNcrnaId) {
		this.smallRegulatoryNcrnaId = smallRegulatoryNcrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SmallRegulatoryNcrnaId))
			return false;
		SmallRegulatoryNcrnaId castOther = (SmallRegulatoryNcrnaId) other;

		return ((this.getSmallRegulatoryNcrnaId() == castOther
				.getSmallRegulatoryNcrnaId()) || (this
				.getSmallRegulatoryNcrnaId() != null
				&& castOther.getSmallRegulatoryNcrnaId() != null && this
				.getSmallRegulatoryNcrnaId().equals(
						castOther.getSmallRegulatoryNcrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSmallRegulatoryNcrnaId() == null ? 0 : this
						.getSmallRegulatoryNcrnaId().hashCode());
		result = 37 * result
