...
/**
 * ModifiedLHistidineId generated by hbm2java
 */
public class ModifiedLHistidineId implements java.io.Serializable {

	private Integer modifiedLHistidineId;
	...
	public ModifiedLHistidineId() {
	}

	public ModifiedLHistidineId(Integer modifiedLHistidineId,
		...
		this.modifiedLHistidineId = modifiedLHistidineId;
	...
	public Integer getModifiedLHistidineId() {
		return this.modifiedLHistidineId;
	}

	public void setModifiedLHistidineId(Integer modifiedLHistidineId) {
		this.modifiedLHistidineId = modifiedLHistidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLHistidineId))
			return false;
		ModifiedLHistidineId castOther = (ModifiedLHistidineId) other;

		return ((this.getModifiedLHistidineId() == castOther
				.getModifiedLHistidineId()) || (this.getModifiedLHistidineId() != null
				&& castOther.getModifiedLHistidineId() != null && this
				.getModifiedLHistidineId().equals(
						castOther.getModifiedLHistidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLHistidineId() == null ? 0 : this
						.getModifiedLHistidineId().hashCode());
		result = 37 * result
