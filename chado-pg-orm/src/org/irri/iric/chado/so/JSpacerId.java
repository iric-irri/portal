...
/**
 * JSpacerId generated by hbm2java
 */
public class JSpacerId implements java.io.Serializable {

	private Integer JSpacerId;
	...
	public JSpacerId(Integer JSpacerId, Integer featureId, Integer dbxrefId,
	...
	public Integer getJSpacerId() {
		return this.JSpacerId;
	}

	public void setJSpacerId(Integer JSpacerId) {
		this.JSpacerId = JSpacerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JSpacerId))
			return false;
		JSpacerId castOther = (JSpacerId) other;

		return ((this.getJSpacerId() == castOther.getJSpacerId()) || (this
				.getJSpacerId() != null && castOther.getJSpacerId() != null && this
				.getJSpacerId().equals(castOther.getJSpacerId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getJSpacerId() == null ? 0 : this.getJSpacerId().hashCode());
		result = 37 * result
