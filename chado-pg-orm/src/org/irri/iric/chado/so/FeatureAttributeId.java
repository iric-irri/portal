...
/**
 * FeatureAttributeId generated by hbm2java
 */
public class FeatureAttributeId implements java.io.Serializable {

	private Integer featureAttributeId;
	...
	public FeatureAttributeId() {
	}

	public FeatureAttributeId(Integer featureAttributeId, Integer featureId,
	...
	public Integer getFeatureAttributeId() {
		return this.featureAttributeId;
	}

	public void setFeatureAttributeId(Integer featureAttributeId) {
		this.featureAttributeId = featureAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeatureAttributeId))
			return false;
		FeatureAttributeId castOther = (FeatureAttributeId) other;

		return ((this.getFeatureAttributeId() == castOther
				.getFeatureAttributeId()) || (this.getFeatureAttributeId() != null
				&& castOther.getFeatureAttributeId() != null && this
				.getFeatureAttributeId().equals(
						castOther.getFeatureAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFeatureAttributeId() == null ? 0 : this
						.getFeatureAttributeId().hashCode());
		result = 37 * result
