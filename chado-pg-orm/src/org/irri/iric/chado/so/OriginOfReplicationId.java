...
/**
 * OriginOfReplicationId generated by hbm2java
 */
public class OriginOfReplicationId implements java.io.Serializable {

	private Integer originOfReplicationId;
	...
	public OriginOfReplicationId() {
	}

	public OriginOfReplicationId(Integer originOfReplicationId,
		...
		this.originOfReplicationId = originOfReplicationId;
	...
	public Integer getOriginOfReplicationId() {
		return this.originOfReplicationId;
	}

	public void setOriginOfReplicationId(Integer originOfReplicationId) {
		this.originOfReplicationId = originOfReplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OriginOfReplicationId))
			return false;
		OriginOfReplicationId castOther = (OriginOfReplicationId) other;

		return ((this.getOriginOfReplicationId() == castOther
				.getOriginOfReplicationId()) || (this
				.getOriginOfReplicationId() != null
				&& castOther.getOriginOfReplicationId() != null && this
				.getOriginOfReplicationId().equals(
						castOther.getOriginOfReplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOriginOfReplicationId() == null ? 0 : this
						.getOriginOfReplicationId().hashCode());
		result = 37 * result
