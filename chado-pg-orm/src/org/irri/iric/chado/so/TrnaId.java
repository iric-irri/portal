...
/**
 * TrnaId generated by hbm2java
 */
public class TrnaId implements java.io.Serializable {

	private Integer trnaId;
	...
	public TrnaId(Integer trnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTrnaId() {
		return this.trnaId;
	}

	public void setTrnaId(Integer trnaId) {
		this.trnaId = trnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaId))
			return false;
		TrnaId castOther = (TrnaId) other;

		return ((this.getTrnaId() == castOther.getTrnaId()) || (this
				.getTrnaId() != null && castOther.getTrnaId() != null && this
				.getTrnaId().equals(castOther.getTrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTrnaId() == null ? 0 : this.getTrnaId().hashCode());
		result = 37 * result
