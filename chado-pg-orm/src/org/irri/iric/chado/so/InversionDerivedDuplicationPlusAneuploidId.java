...
/**
 * InversionDerivedDuplicationPlusAneuploidId generated by hbm2java
 */
public class InversionDerivedDuplicationPlusAneuploidId implements
		java.io.Serializable {

	private Integer inversionDerivedDuplicationPlusAneuploidId;
	...
	public InversionDerivedDuplicationPlusAneuploidId() {
	}

	public InversionDerivedDuplicationPlusAneuploidId(
			Integer inversionDerivedDuplicationPlusAneuploidId,
		...
		this.inversionDerivedDuplicationPlusAneuploidId = inversionDerivedDuplicationPlusAneuploidId;
	...
	public Integer getInversionDerivedDuplicationPlusAneuploidId() {
		return this.inversionDerivedDuplicationPlusAneuploidId;
	}

	public void setInversionDerivedDuplicationPlusAneuploidId(
			Integer inversionDerivedDuplicationPlusAneuploidId) {
		this.inversionDerivedDuplicationPlusAneuploidId = inversionDerivedDuplicationPlusAneuploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedDuplicationPlusAneuploidId))
			return false;
		InversionDerivedDuplicationPlusAneuploidId castOther = (InversionDerivedDuplicationPlusAneuploidId) other;

		return ((this.getInversionDerivedDuplicationPlusAneuploidId() == castOther
				.getInversionDerivedDuplicationPlusAneuploidId()) || (this
				.getInversionDerivedDuplicationPlusAneuploidId() != null
				&& castOther.getInversionDerivedDuplicationPlusAneuploidId() != null && this
				.getInversionDerivedDuplicationPlusAneuploidId()
				.equals(castOther
						.getInversionDerivedDuplicationPlusAneuploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedDuplicationPlusAneuploidId() == null ? 0
						: this.getInversionDerivedDuplicationPlusAneuploidId()
								.hashCode());
		result = 37 * result
