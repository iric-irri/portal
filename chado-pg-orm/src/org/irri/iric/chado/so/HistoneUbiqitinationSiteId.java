...
/**
 * HistoneUbiqitinationSiteId generated by hbm2java
 */
public class HistoneUbiqitinationSiteId implements java.io.Serializable {

	private Integer histoneUbiqitinationSiteId;
	...
	public HistoneUbiqitinationSiteId() {
	}

	public HistoneUbiqitinationSiteId(Integer histoneUbiqitinationSiteId,
		...
		this.histoneUbiqitinationSiteId = histoneUbiqitinationSiteId;
	...
	public Integer getHistoneUbiqitinationSiteId() {
		return this.histoneUbiqitinationSiteId;
	}

	public void setHistoneUbiqitinationSiteId(Integer histoneUbiqitinationSiteId) {
		this.histoneUbiqitinationSiteId = histoneUbiqitinationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistoneUbiqitinationSiteId))
			return false;
		HistoneUbiqitinationSiteId castOther = (HistoneUbiqitinationSiteId) other;

		return ((this.getHistoneUbiqitinationSiteId() == castOther
				.getHistoneUbiqitinationSiteId()) || (this
				.getHistoneUbiqitinationSiteId() != null
				&& castOther.getHistoneUbiqitinationSiteId() != null && this
				.getHistoneUbiqitinationSiteId().equals(
						castOther.getHistoneUbiqitinationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHistoneUbiqitinationSiteId() == null ? 0 : this
						.getHistoneUbiqitinationSiteId().hashCode());
		result = 37 * result
