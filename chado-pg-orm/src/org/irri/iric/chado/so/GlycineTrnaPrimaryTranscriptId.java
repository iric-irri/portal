...
/**
 * GlycineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class GlycineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer glycineTrnaPrimaryTranscriptId;
	...
	public GlycineTrnaPrimaryTranscriptId() {
	}

	public GlycineTrnaPrimaryTranscriptId(
			Integer glycineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.glycineTrnaPrimaryTranscriptId = glycineTrnaPrimaryTranscriptId;
	...
	public Integer getGlycineTrnaPrimaryTranscriptId() {
		return this.glycineTrnaPrimaryTranscriptId;
	}

	public void setGlycineTrnaPrimaryTranscriptId(
			Integer glycineTrnaPrimaryTranscriptId) {
		this.glycineTrnaPrimaryTranscriptId = glycineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlycineTrnaPrimaryTranscriptId))
			return false;
		GlycineTrnaPrimaryTranscriptId castOther = (GlycineTrnaPrimaryTranscriptId) other;

		return ((this.getGlycineTrnaPrimaryTranscriptId() == castOther
				.getGlycineTrnaPrimaryTranscriptId()) || (this
				.getGlycineTrnaPrimaryTranscriptId() != null
				&& castOther.getGlycineTrnaPrimaryTranscriptId() != null && this
				.getGlycineTrnaPrimaryTranscriptId().equals(
						castOther.getGlycineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlycineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getGlycineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
