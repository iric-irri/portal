...
/**
 * FivePrimeFlankingRegionId generated by hbm2java
 */
public class FivePrimeFlankingRegionId implements java.io.Serializable {

	private Integer fivePrimeFlankingRegionId;
	...
	public FivePrimeFlankingRegionId() {
	}

	public FivePrimeFlankingRegionId(Integer fivePrimeFlankingRegionId,
		...
		this.fivePrimeFlankingRegionId = fivePrimeFlankingRegionId;
	...
	public Integer getFivePrimeFlankingRegionId() {
		return this.fivePrimeFlankingRegionId;
	}

	public void setFivePrimeFlankingRegionId(Integer fivePrimeFlankingRegionId) {
		this.fivePrimeFlankingRegionId = fivePrimeFlankingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeFlankingRegionId))
			return false;
		FivePrimeFlankingRegionId castOther = (FivePrimeFlankingRegionId) other;

		return ((this.getFivePrimeFlankingRegionId() == castOther
				.getFivePrimeFlankingRegionId()) || (this
				.getFivePrimeFlankingRegionId() != null
				&& castOther.getFivePrimeFlankingRegionId() != null && this
				.getFivePrimeFlankingRegionId().equals(
						castOther.getFivePrimeFlankingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeFlankingRegionId() == null ? 0 : this
						.getFivePrimeFlankingRegionId().hashCode());
		result = 37 * result
