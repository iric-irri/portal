...
/**
 * CodingRegionOfExonId generated by hbm2java
 */
public class CodingRegionOfExonId implements java.io.Serializable {

	private Integer codingRegionOfExonId;
	...
	public CodingRegionOfExonId() {
	}

	public CodingRegionOfExonId(Integer codingRegionOfExonId,
		...
		this.codingRegionOfExonId = codingRegionOfExonId;
	...
	public Integer getCodingRegionOfExonId() {
		return this.codingRegionOfExonId;
	}

	public void setCodingRegionOfExonId(Integer codingRegionOfExonId) {
		this.codingRegionOfExonId = codingRegionOfExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingRegionOfExonId))
			return false;
		CodingRegionOfExonId castOther = (CodingRegionOfExonId) other;

		return ((this.getCodingRegionOfExonId() == castOther
				.getCodingRegionOfExonId()) || (this.getCodingRegionOfExonId() != null
				&& castOther.getCodingRegionOfExonId() != null && this
				.getCodingRegionOfExonId().equals(
						castOther.getCodingRegionOfExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingRegionOfExonId() == null ? 0 : this
						.getCodingRegionOfExonId().hashCode());
		result = 37 * result
