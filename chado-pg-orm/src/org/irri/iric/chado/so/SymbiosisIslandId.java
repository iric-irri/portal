...
/**
 * SymbiosisIslandId generated by hbm2java
 */
public class SymbiosisIslandId implements java.io.Serializable {

	private Integer symbiosisIslandId;
	...
	public SymbiosisIslandId() {
	}

	public SymbiosisIslandId(Integer symbiosisIslandId, Integer featureId,
		...
		this.symbiosisIslandId = symbiosisIslandId;
	...
	public Integer getSymbiosisIslandId() {
		return this.symbiosisIslandId;
	}

	public void setSymbiosisIslandId(Integer symbiosisIslandId) {
		this.symbiosisIslandId = symbiosisIslandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SymbiosisIslandId))
			return false;
		SymbiosisIslandId castOther = (SymbiosisIslandId) other;

		return ((this.getSymbiosisIslandId() == castOther
				.getSymbiosisIslandId()) || (this.getSymbiosisIslandId() != null
				&& castOther.getSymbiosisIslandId() != null && this
				.getSymbiosisIslandId()
				.equals(castOther.getSymbiosisIslandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSymbiosisIslandId() == null ? 0 : this
						.getSymbiosisIslandId().hashCode());
		result = 37 * result
