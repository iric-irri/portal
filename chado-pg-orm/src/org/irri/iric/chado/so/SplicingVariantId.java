...
/**
 * SplicingVariantId generated by hbm2java
 */
public class SplicingVariantId implements java.io.Serializable {

	private Integer splicingVariantId;
	...
	public SplicingVariantId() {
	}

	public SplicingVariantId(Integer splicingVariantId, Integer featureId,
		...
		this.splicingVariantId = splicingVariantId;
	...
	public Integer getSplicingVariantId() {
		return this.splicingVariantId;
	}

	public void setSplicingVariantId(Integer splicingVariantId) {
		this.splicingVariantId = splicingVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SplicingVariantId))
			return false;
		SplicingVariantId castOther = (SplicingVariantId) other;

		return ((this.getSplicingVariantId() == castOther
				.getSplicingVariantId()) || (this.getSplicingVariantId() != null
				&& castOther.getSplicingVariantId() != null && this
				.getSplicingVariantId()
				.equals(castOther.getSplicingVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSplicingVariantId() == null ? 0 : this
						.getSplicingVariantId().hashCode());
		result = 37 * result
