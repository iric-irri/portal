...
/**
 * StTurnLeftHandedTypeOneId generated by hbm2java
 */
public class StTurnLeftHandedTypeOneId implements java.io.Serializable {

	private Integer stTurnLeftHandedTypeOneId;
	...
	public StTurnLeftHandedTypeOneId() {
	}

	public StTurnLeftHandedTypeOneId(Integer stTurnLeftHandedTypeOneId,
		...
		this.stTurnLeftHandedTypeOneId = stTurnLeftHandedTypeOneId;
	...
	public Integer getStTurnLeftHandedTypeOneId() {
		return this.stTurnLeftHandedTypeOneId;
	}

	public void setStTurnLeftHandedTypeOneId(Integer stTurnLeftHandedTypeOneId) {
		this.stTurnLeftHandedTypeOneId = stTurnLeftHandedTypeOneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StTurnLeftHandedTypeOneId))
			return false;
		StTurnLeftHandedTypeOneId castOther = (StTurnLeftHandedTypeOneId) other;

		return ((this.getStTurnLeftHandedTypeOneId() == castOther
				.getStTurnLeftHandedTypeOneId()) || (this
				.getStTurnLeftHandedTypeOneId() != null
				&& castOther.getStTurnLeftHandedTypeOneId() != null && this
				.getStTurnLeftHandedTypeOneId().equals(
						castOther.getStTurnLeftHandedTypeOneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStTurnLeftHandedTypeOneId() == null ? 0 : this
						.getStTurnLeftHandedTypeOneId().hashCode());
		result = 37 * result
