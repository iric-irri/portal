...
/**
 * UgaStopCodonSignalId generated by hbm2java
 */
public class UgaStopCodonSignalId implements java.io.Serializable {

	private Integer ugaStopCodonSignalId;
	...
	public UgaStopCodonSignalId() {
	}

	public UgaStopCodonSignalId(Integer ugaStopCodonSignalId,
		...
		this.ugaStopCodonSignalId = ugaStopCodonSignalId;
	...
	public Integer getUgaStopCodonSignalId() {
		return this.ugaStopCodonSignalId;
	}

	public void setUgaStopCodonSignalId(Integer ugaStopCodonSignalId) {
		this.ugaStopCodonSignalId = ugaStopCodonSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UgaStopCodonSignalId))
			return false;
		UgaStopCodonSignalId castOther = (UgaStopCodonSignalId) other;

		return ((this.getUgaStopCodonSignalId() == castOther
				.getUgaStopCodonSignalId()) || (this.getUgaStopCodonSignalId() != null
				&& castOther.getUgaStopCodonSignalId() != null && this
				.getUgaStopCodonSignalId().equals(
						castOther.getUgaStopCodonSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUgaStopCodonSignalId() == null ? 0 : this
						.getUgaStopCodonSignalId().hashCode());
		result = 37 * result
