...
/**
 * SageTagId generated by hbm2java
 */
public class SageTagId implements java.io.Serializable {

	private Integer sageTagId;
	...
	public SageTagId(Integer sageTagId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSageTagId() {
		return this.sageTagId;
	}

	public void setSageTagId(Integer sageTagId) {
		this.sageTagId = sageTagId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SageTagId))
			return false;
		SageTagId castOther = (SageTagId) other;

		return ((this.getSageTagId() == castOther.getSageTagId()) || (this
				.getSageTagId() != null && castOther.getSageTagId() != null && this
				.getSageTagId().equals(castOther.getSageTagId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSageTagId() == null ? 0 : this.getSageTagId().hashCode());
		result = 37 * result
