...
/**
 * TransposableElementGeneId generated by hbm2java
 */
public class TransposableElementGeneId implements java.io.Serializable {

	private Integer transposableElementGeneId;
	...
	public TransposableElementGeneId() {
	}

	public TransposableElementGeneId(Integer transposableElementGeneId,
		...
		this.transposableElementGeneId = transposableElementGeneId;
	...
	public Integer getTransposableElementGeneId() {
		return this.transposableElementGeneId;
	}

	public void setTransposableElementGeneId(Integer transposableElementGeneId) {
		this.transposableElementGeneId = transposableElementGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransposableElementGeneId))
			return false;
		TransposableElementGeneId castOther = (TransposableElementGeneId) other;

		return ((this.getTransposableElementGeneId() == castOther
				.getTransposableElementGeneId()) || (this
				.getTransposableElementGeneId() != null
				&& castOther.getTransposableElementGeneId() != null && this
				.getTransposableElementGeneId().equals(
						castOther.getTransposableElementGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransposableElementGeneId() == null ? 0 : this
						.getTransposableElementGeneId().hashCode());
		result = 37 * result
