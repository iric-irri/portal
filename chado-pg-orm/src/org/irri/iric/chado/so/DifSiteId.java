...
/**
 * DifSiteId generated by hbm2java
 */
public class DifSiteId implements java.io.Serializable {

	private Integer difSiteId;
	...
	public DifSiteId(Integer difSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDifSiteId() {
		return this.difSiteId;
	}

	public void setDifSiteId(Integer difSiteId) {
		this.difSiteId = difSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DifSiteId))
			return false;
		DifSiteId castOther = (DifSiteId) other;

		return ((this.getDifSiteId() == castOther.getDifSiteId()) || (this
				.getDifSiteId() != null && castOther.getDifSiteId() != null && this
				.getDifSiteId().equals(castOther.getDifSiteId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDifSiteId() == null ? 0 : this.getDifSiteId().hashCode());
		result = 37 * result
