...
/**
 * ApicoplastGeneId generated by hbm2java
 */
public class ApicoplastGeneId implements java.io.Serializable {

	private Integer apicoplastGeneId;
	...
	public ApicoplastGeneId() {
	}

	public ApicoplastGeneId(Integer apicoplastGeneId, Integer featureId,
		...
		this.apicoplastGeneId = apicoplastGeneId;
	...
	public Integer getApicoplastGeneId() {
		return this.apicoplastGeneId;
	}

	public void setApicoplastGeneId(Integer apicoplastGeneId) {
		this.apicoplastGeneId = apicoplastGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApicoplastGeneId))
			return false;
		ApicoplastGeneId castOther = (ApicoplastGeneId) other;

		return ((this.getApicoplastGeneId() == castOther.getApicoplastGeneId()) || (this
				.getApicoplastGeneId() != null
				&& castOther.getApicoplastGeneId() != null && this
				.getApicoplastGeneId().equals(castOther.getApicoplastGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getApicoplastGeneId() == null ? 0 : this
						.getApicoplastGeneId().hashCode());
		result = 37 * result
