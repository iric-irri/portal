...
/**
 * InsertionSequenceId generated by hbm2java
 */
public class InsertionSequenceId implements java.io.Serializable {

	private Integer insertionSequenceId;
	...
	public InsertionSequenceId() {
	}

	public InsertionSequenceId(Integer insertionSequenceId, Integer featureId,
		...
		this.insertionSequenceId = insertionSequenceId;
	...
	public Integer getInsertionSequenceId() {
		return this.insertionSequenceId;
	}

	public void setInsertionSequenceId(Integer insertionSequenceId) {
		this.insertionSequenceId = insertionSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionSequenceId))
			return false;
		InsertionSequenceId castOther = (InsertionSequenceId) other;

		return ((this.getInsertionSequenceId() == castOther
				.getInsertionSequenceId()) || (this.getInsertionSequenceId() != null
				&& castOther.getInsertionSequenceId() != null && this
				.getInsertionSequenceId().equals(
						castOther.getInsertionSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionSequenceId() == null ? 0 : this
						.getInsertionSequenceId().hashCode());
		result = 37 * result
