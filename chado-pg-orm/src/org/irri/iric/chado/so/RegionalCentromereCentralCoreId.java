...
/**
 * RegionalCentromereCentralCoreId generated by hbm2java
 */
public class RegionalCentromereCentralCoreId implements java.io.Serializable {

	private Integer regionalCentromereCentralCoreId;
	...
	public RegionalCentromereCentralCoreId() {
	}

	public RegionalCentromereCentralCoreId(
			Integer regionalCentromereCentralCoreId, Integer featureId,
		...
		this.regionalCentromereCentralCoreId = regionalCentromereCentralCoreId;
	...
	public Integer getRegionalCentromereCentralCoreId() {
		return this.regionalCentromereCentralCoreId;
	}

	public void setRegionalCentromereCentralCoreId(
			Integer regionalCentromereCentralCoreId) {
		this.regionalCentromereCentralCoreId = regionalCentromereCentralCoreId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegionalCentromereCentralCoreId))
			return false;
		RegionalCentromereCentralCoreId castOther = (RegionalCentromereCentralCoreId) other;

		return ((this.getRegionalCentromereCentralCoreId() == castOther
				.getRegionalCentromereCentralCoreId()) || (this
				.getRegionalCentromereCentralCoreId() != null
				&& castOther.getRegionalCentromereCentralCoreId() != null && this
				.getRegionalCentromereCentralCoreId().equals(
						castOther.getRegionalCentromereCentralCoreId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegionalCentromereCentralCoreId() == null ? 0 : this
						.getRegionalCentromereCentralCoreId().hashCode());
		result = 37 * result
