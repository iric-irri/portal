...
/**
 * CentromereDnaElementIiiId generated by hbm2java
 */
public class CentromereDnaElementIiiId implements java.io.Serializable {

	private Integer centromereDnaElementIiiId;
	...
	public CentromereDnaElementIiiId() {
	}

	public CentromereDnaElementIiiId(Integer centromereDnaElementIiiId,
		...
		this.centromereDnaElementIiiId = centromereDnaElementIiiId;
	...
	public Integer getCentromereDnaElementIiiId() {
		return this.centromereDnaElementIiiId;
	}

	public void setCentromereDnaElementIiiId(Integer centromereDnaElementIiiId) {
		this.centromereDnaElementIiiId = centromereDnaElementIiiId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentromereDnaElementIiiId))
			return false;
		CentromereDnaElementIiiId castOther = (CentromereDnaElementIiiId) other;

		return ((this.getCentromereDnaElementIiiId() == castOther
				.getCentromereDnaElementIiiId()) || (this
				.getCentromereDnaElementIiiId() != null
				&& castOther.getCentromereDnaElementIiiId() != null && this
				.getCentromereDnaElementIiiId().equals(
						castOther.getCentromereDnaElementIiiId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentromereDnaElementIiiId() == null ? 0 : this
						.getCentromereDnaElementIiiId().hashCode());
		result = 37 * result
