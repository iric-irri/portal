...
/**
 * DnaseiHypersensitiveSiteId generated by hbm2java
 */
public class DnaseiHypersensitiveSiteId implements java.io.Serializable {

	private Integer dnaseiHypersensitiveSiteId;
	...
	public DnaseiHypersensitiveSiteId() {
	}

	public DnaseiHypersensitiveSiteId(Integer dnaseiHypersensitiveSiteId,
		...
		this.dnaseiHypersensitiveSiteId = dnaseiHypersensitiveSiteId;
	...
	public Integer getDnaseiHypersensitiveSiteId() {
		return this.dnaseiHypersensitiveSiteId;
	}

	public void setDnaseiHypersensitiveSiteId(Integer dnaseiHypersensitiveSiteId) {
		this.dnaseiHypersensitiveSiteId = dnaseiHypersensitiveSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaseiHypersensitiveSiteId))
			return false;
		DnaseiHypersensitiveSiteId castOther = (DnaseiHypersensitiveSiteId) other;

		return ((this.getDnaseiHypersensitiveSiteId() == castOther
				.getDnaseiHypersensitiveSiteId()) || (this
				.getDnaseiHypersensitiveSiteId() != null
				&& castOther.getDnaseiHypersensitiveSiteId() != null && this
				.getDnaseiHypersensitiveSiteId().equals(
						castOther.getDnaseiHypersensitiveSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaseiHypersensitiveSiteId() == null ? 0 : this
						.getDnaseiHypersensitiveSiteId().hashCode());
		result = 37 * result
