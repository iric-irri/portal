...
/**
 * Rrna25sId generated by hbm2java
 */
public class Rrna25sId implements java.io.Serializable {

	private Integer rrna25sId;
	...
	public Rrna25sId(Integer rrna25sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna25sId() {
		return this.rrna25sId;
	}

	public void setRrna25sId(Integer rrna25sId) {
		this.rrna25sId = rrna25sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna25sId))
			return false;
		Rrna25sId castOther = (Rrna25sId) other;

		return ((this.getRrna25sId() == castOther.getRrna25sId()) || (this
				.getRrna25sId() != null && castOther.getRrna25sId() != null && this
				.getRrna25sId().equals(castOther.getRrna25sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna25sId() == null ? 0 : this.getRrna25sId().hashCode());
		result = 37 * result
