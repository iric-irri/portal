...
/**
 * GeneArrayId generated by hbm2java
 */
public class GeneArrayId implements java.io.Serializable {

	private Integer geneArrayId;
	...
	public GeneArrayId(Integer geneArrayId, Integer featureId,
	...
	public Integer getGeneArrayId() {
		return this.geneArrayId;
	}

	public void setGeneArrayId(Integer geneArrayId) {
		this.geneArrayId = geneArrayId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneArrayId))
			return false;
		GeneArrayId castOther = (GeneArrayId) other;

		return ((this.getGeneArrayId() == castOther.getGeneArrayId()) || (this
				.getGeneArrayId() != null && castOther.getGeneArrayId() != null && this
				.getGeneArrayId().equals(castOther.getGeneArrayId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneArrayId() == null ? 0 : this.getGeneArrayId()
						.hashCode());
		result = 37 * result
