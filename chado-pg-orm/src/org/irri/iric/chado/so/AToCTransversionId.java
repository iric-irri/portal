...
/**
 * AToCTransversionId generated by hbm2java
 */
public class AToCTransversionId implements java.io.Serializable {

	private Integer AToCTransversionId;
	...
	public AToCTransversionId() {
	}

	public AToCTransversionId(Integer AToCTransversionId, Integer featureId,
		...
		this.AToCTransversionId = AToCTransversionId;
	...
	public Integer getAToCTransversionId() {
		return this.AToCTransversionId;
	}

	public void setAToCTransversionId(Integer AToCTransversionId) {
		this.AToCTransversionId = AToCTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AToCTransversionId))
			return false;
		AToCTransversionId castOther = (AToCTransversionId) other;

		return ((this.getAToCTransversionId() == castOther
				.getAToCTransversionId()) || (this.getAToCTransversionId() != null
				&& castOther.getAToCTransversionId() != null && this
				.getAToCTransversionId().equals(
						castOther.getAToCTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAToCTransversionId() == null ? 0 : this
						.getAToCTransversionId().hashCode());
		result = 37 * result
