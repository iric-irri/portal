...
/**
 * RnaPolymerasePromoterId generated by hbm2java
 */
public class RnaPolymerasePromoterId implements java.io.Serializable {

	private Integer rnaPolymerasePromoterId;
	...
	public RnaPolymerasePromoterId() {
	}

	public RnaPolymerasePromoterId(Integer rnaPolymerasePromoterId,
		...
		this.rnaPolymerasePromoterId = rnaPolymerasePromoterId;
	...
	public Integer getRnaPolymerasePromoterId() {
		return this.rnaPolymerasePromoterId;
	}

	public void setRnaPolymerasePromoterId(Integer rnaPolymerasePromoterId) {
		this.rnaPolymerasePromoterId = rnaPolymerasePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaPolymerasePromoterId))
			return false;
		RnaPolymerasePromoterId castOther = (RnaPolymerasePromoterId) other;

		return ((this.getRnaPolymerasePromoterId() == castOther
				.getRnaPolymerasePromoterId()) || (this
				.getRnaPolymerasePromoterId() != null
				&& castOther.getRnaPolymerasePromoterId() != null && this
				.getRnaPolymerasePromoterId().equals(
						castOther.getRnaPolymerasePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaPolymerasePromoterId() == null ? 0 : this
						.getRnaPolymerasePromoterId().hashCode());
		result = 37 * result
