...
/**
 * FiveTaurinomethylTwoThiouridineId generated by hbm2java
 */
public class FiveTaurinomethylTwoThiouridineId implements java.io.Serializable {

	private Integer fiveTaurinomethylTwoThiouridineId;
	...
	public FiveTaurinomethylTwoThiouridineId() {
	}

	public FiveTaurinomethylTwoThiouridineId(
			Integer fiveTaurinomethylTwoThiouridineId, Integer featureId,
		...
		this.fiveTaurinomethylTwoThiouridineId = fiveTaurinomethylTwoThiouridineId;
	...
	public Integer getFiveTaurinomethylTwoThiouridineId() {
		return this.fiveTaurinomethylTwoThiouridineId;
	}

	public void setFiveTaurinomethylTwoThiouridineId(
			Integer fiveTaurinomethylTwoThiouridineId) {
		this.fiveTaurinomethylTwoThiouridineId = fiveTaurinomethylTwoThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveTaurinomethylTwoThiouridineId))
			return false;
		FiveTaurinomethylTwoThiouridineId castOther = (FiveTaurinomethylTwoThiouridineId) other;

		return ((this.getFiveTaurinomethylTwoThiouridineId() == castOther
				.getFiveTaurinomethylTwoThiouridineId()) || (this
				.getFiveTaurinomethylTwoThiouridineId() != null
				&& castOther.getFiveTaurinomethylTwoThiouridineId() != null && this
				.getFiveTaurinomethylTwoThiouridineId().equals(
						castOther.getFiveTaurinomethylTwoThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveTaurinomethylTwoThiouridineId() == null ? 0 : this
						.getFiveTaurinomethylTwoThiouridineId().hashCode());
		result = 37 * result
