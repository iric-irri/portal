...
/**
 * RegulatedId generated by hbm2java
 */
public class RegulatedId implements java.io.Serializable {

	private Integer regulatedId;
	...
	public RegulatedId(Integer regulatedId, Integer featureId,
	...
	public Integer getRegulatedId() {
		return this.regulatedId;
	}

	public void setRegulatedId(Integer regulatedId) {
		this.regulatedId = regulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegulatedId))
			return false;
		RegulatedId castOther = (RegulatedId) other;

		return ((this.getRegulatedId() == castOther.getRegulatedId()) || (this
				.getRegulatedId() != null && castOther.getRegulatedId() != null && this
				.getRegulatedId().equals(castOther.getRegulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegulatedId() == null ? 0 : this.getRegulatedId()
						.hashCode());
		result = 37 * result
