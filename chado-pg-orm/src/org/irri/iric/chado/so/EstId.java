...
/**
 * EstId generated by hbm2java
 */
public class EstId implements java.io.Serializable {
	...
	public EstId(Integer estId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EstId))
			return false;
		EstId castOther = (EstId) other;

		return ((this.getEstId() == castOther.getEstId()) || (this.getEstId() != null
				&& castOther.getEstId() != null && this.getEstId().equals(
				castOther.getEstId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getEstId() == null ? 0 : this.getEstId().hashCode());
		result = 37 * result
