...
/**
 * MirnaLoopId generated by hbm2java
 */
public class MirnaLoopId implements java.io.Serializable {

	private Integer mirnaLoopId;
	...
	public MirnaLoopId(Integer mirnaLoopId, Integer featureId,
	...
	public Integer getMirnaLoopId() {
		return this.mirnaLoopId;
	}

	public void setMirnaLoopId(Integer mirnaLoopId) {
		this.mirnaLoopId = mirnaLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaLoopId))
			return false;
		MirnaLoopId castOther = (MirnaLoopId) other;

		return ((this.getMirnaLoopId() == castOther.getMirnaLoopId()) || (this
				.getMirnaLoopId() != null && castOther.getMirnaLoopId() != null && this
				.getMirnaLoopId().equals(castOther.getMirnaLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaLoopId() == null ? 0 : this.getMirnaLoopId()
						.hashCode());
		result = 37 * result
