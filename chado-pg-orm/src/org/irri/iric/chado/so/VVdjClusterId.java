...
/**
 * VVdjClusterId generated by hbm2java
 */
public class VVdjClusterId implements java.io.Serializable {

	private Integer VVdjClusterId;
	...
	public VVdjClusterId() {
	}

	public VVdjClusterId(Integer VVdjClusterId, Integer featureId,
		...
		this.VVdjClusterId = VVdjClusterId;
	...
	public Integer getVVdjClusterId() {
		return this.VVdjClusterId;
	}

	public void setVVdjClusterId(Integer VVdjClusterId) {
		this.VVdjClusterId = VVdjClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVdjClusterId))
			return false;
		VVdjClusterId castOther = (VVdjClusterId) other;

		return ((this.getVVdjClusterId() == castOther.getVVdjClusterId()) || (this
				.getVVdjClusterId() != null
				&& castOther.getVVdjClusterId() != null && this
				.getVVdjClusterId().equals(castOther.getVVdjClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVVdjClusterId() == null ? 0 : this.getVVdjClusterId()
						.hashCode());
		result = 37 * result
