...
/**
 * OneMethylpseudouridineId generated by hbm2java
 */
public class OneMethylpseudouridineId implements java.io.Serializable {

	private Integer oneMethylpseudouridineId;
	...
	public OneMethylpseudouridineId() {
	}

	public OneMethylpseudouridineId(Integer oneMethylpseudouridineId,
		...
		this.oneMethylpseudouridineId = oneMethylpseudouridineId;
	...
	public Integer getOneMethylpseudouridineId() {
		return this.oneMethylpseudouridineId;
	}

	public void setOneMethylpseudouridineId(Integer oneMethylpseudouridineId) {
		this.oneMethylpseudouridineId = oneMethylpseudouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneMethylpseudouridineId))
			return false;
		OneMethylpseudouridineId castOther = (OneMethylpseudouridineId) other;

		return ((this.getOneMethylpseudouridineId() == castOther
				.getOneMethylpseudouridineId()) || (this
				.getOneMethylpseudouridineId() != null
				&& castOther.getOneMethylpseudouridineId() != null && this
				.getOneMethylpseudouridineId().equals(
						castOther.getOneMethylpseudouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneMethylpseudouridineId() == null ? 0 : this
						.getOneMethylpseudouridineId().hashCode());
		result = 37 * result
