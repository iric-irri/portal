...
/**
 * UnorientInsertDupId generated by hbm2java
 */
public class UnorientInsertDupId implements java.io.Serializable {

	private Integer unorientInsertDupId;
	...
	public UnorientInsertDupId() {
	}

	public UnorientInsertDupId(Integer unorientInsertDupId, Integer featureId,
		...
		this.unorientInsertDupId = unorientInsertDupId;
	...
	public Integer getUnorientInsertDupId() {
		return this.unorientInsertDupId;
	}

	public void setUnorientInsertDupId(Integer unorientInsertDupId) {
		this.unorientInsertDupId = unorientInsertDupId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnorientInsertDupId))
			return false;
		UnorientInsertDupId castOther = (UnorientInsertDupId) other;

		return ((this.getUnorientInsertDupId() == castOther
				.getUnorientInsertDupId()) || (this.getUnorientInsertDupId() != null
				&& castOther.getUnorientInsertDupId() != null && this
				.getUnorientInsertDupId().equals(
						castOther.getUnorientInsertDupId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUnorientInsertDupId() == null ? 0 : this
						.getUnorientInsertDupId().hashCode());
		result = 37 * result
