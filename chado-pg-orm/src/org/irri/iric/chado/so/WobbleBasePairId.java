...
/**
 * WobbleBasePairId generated by hbm2java
 */
public class WobbleBasePairId implements java.io.Serializable {

	private Integer wobbleBasePairId;
	...
	public WobbleBasePairId() {
	}

	public WobbleBasePairId(Integer wobbleBasePairId, Integer featureId,
		...
		this.wobbleBasePairId = wobbleBasePairId;
	...
	public Integer getWobbleBasePairId() {
		return this.wobbleBasePairId;
	}

	public void setWobbleBasePairId(Integer wobbleBasePairId) {
		this.wobbleBasePairId = wobbleBasePairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WobbleBasePairId))
			return false;
		WobbleBasePairId castOther = (WobbleBasePairId) other;

		return ((this.getWobbleBasePairId() == castOther.getWobbleBasePairId()) || (this
				.getWobbleBasePairId() != null
				&& castOther.getWobbleBasePairId() != null && this
				.getWobbleBasePairId().equals(castOther.getWobbleBasePairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWobbleBasePairId() == null ? 0 : this
						.getWobbleBasePairId().hashCode());
		result = 37 * result
