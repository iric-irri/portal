...
/**
 * GammaTurnClassicId generated by hbm2java
 */
public class GammaTurnClassicId implements java.io.Serializable {

	private Integer gammaTurnClassicId;
	...
	public GammaTurnClassicId() {
	}

	public GammaTurnClassicId(Integer gammaTurnClassicId, Integer featureId,
		...
		this.gammaTurnClassicId = gammaTurnClassicId;
	...
	public Integer getGammaTurnClassicId() {
		return this.gammaTurnClassicId;
	}

	public void setGammaTurnClassicId(Integer gammaTurnClassicId) {
		this.gammaTurnClassicId = gammaTurnClassicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GammaTurnClassicId))
			return false;
		GammaTurnClassicId castOther = (GammaTurnClassicId) other;

		return ((this.getGammaTurnClassicId() == castOther
				.getGammaTurnClassicId()) || (this.getGammaTurnClassicId() != null
				&& castOther.getGammaTurnClassicId() != null && this
				.getGammaTurnClassicId().equals(
						castOther.getGammaTurnClassicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGammaTurnClassicId() == null ? 0 : this
						.getGammaTurnClassicId().hashCode());
		result = 37 * result
