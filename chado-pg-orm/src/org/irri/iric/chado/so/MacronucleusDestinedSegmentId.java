...
/**
 * MacronucleusDestinedSegmentId generated by hbm2java
 */
public class MacronucleusDestinedSegmentId implements java.io.Serializable {

	private Integer macronucleusDestinedSegmentId;
	...
	public MacronucleusDestinedSegmentId() {
	}

	public MacronucleusDestinedSegmentId(Integer macronucleusDestinedSegmentId,
		...
		this.macronucleusDestinedSegmentId = macronucleusDestinedSegmentId;
	...
	public Integer getMacronucleusDestinedSegmentId() {
		return this.macronucleusDestinedSegmentId;
	}

	public void setMacronucleusDestinedSegmentId(
			Integer macronucleusDestinedSegmentId) {
		this.macronucleusDestinedSegmentId = macronucleusDestinedSegmentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MacronucleusDestinedSegmentId))
			return false;
		MacronucleusDestinedSegmentId castOther = (MacronucleusDestinedSegmentId) other;

		return ((this.getMacronucleusDestinedSegmentId() == castOther
				.getMacronucleusDestinedSegmentId()) || (this
				.getMacronucleusDestinedSegmentId() != null
				&& castOther.getMacronucleusDestinedSegmentId() != null && this
				.getMacronucleusDestinedSegmentId().equals(
						castOther.getMacronucleusDestinedSegmentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMacronucleusDestinedSegmentId() == null ? 0 : this
						.getMacronucleusDestinedSegmentId().hashCode());
		result = 37 * result
