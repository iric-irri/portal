...
/**
 * PopulationSpecificVariantId generated by hbm2java
 */
public class PopulationSpecificVariantId implements java.io.Serializable {

	private Integer populationSpecificVariantId;
	...
	public PopulationSpecificVariantId() {
	}

	public PopulationSpecificVariantId(Integer populationSpecificVariantId,
		...
		this.populationSpecificVariantId = populationSpecificVariantId;
	...
	public Integer getPopulationSpecificVariantId() {
		return this.populationSpecificVariantId;
	}

	public void setPopulationSpecificVariantId(
			Integer populationSpecificVariantId) {
		this.populationSpecificVariantId = populationSpecificVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PopulationSpecificVariantId))
			return false;
		PopulationSpecificVariantId castOther = (PopulationSpecificVariantId) other;

		return ((this.getPopulationSpecificVariantId() == castOther
				.getPopulationSpecificVariantId()) || (this
				.getPopulationSpecificVariantId() != null
				&& castOther.getPopulationSpecificVariantId() != null && this
				.getPopulationSpecificVariantId().equals(
						castOther.getPopulationSpecificVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPopulationSpecificVariantId() == null ? 0 : this
						.getPopulationSpecificVariantId().hashCode());
		result = 37 * result
