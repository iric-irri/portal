...
/**
 * PolypeptideMotifId generated by hbm2java
 */
public class PolypeptideMotifId implements java.io.Serializable {

	private Integer polypeptideMotifId;
	...
	public PolypeptideMotifId() {
	}

	public PolypeptideMotifId(Integer polypeptideMotifId, Integer featureId,
		...
		this.polypeptideMotifId = polypeptideMotifId;
	...
	public Integer getPolypeptideMotifId() {
		return this.polypeptideMotifId;
	}

	public void setPolypeptideMotifId(Integer polypeptideMotifId) {
		this.polypeptideMotifId = polypeptideMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideMotifId))
			return false;
		PolypeptideMotifId castOther = (PolypeptideMotifId) other;

		return ((this.getPolypeptideMotifId() == castOther
				.getPolypeptideMotifId()) || (this.getPolypeptideMotifId() != null
				&& castOther.getPolypeptideMotifId() != null && this
				.getPolypeptideMotifId().equals(
						castOther.getPolypeptideMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideMotifId() == null ? 0 : this
						.getPolypeptideMotifId().hashCode());
		result = 37 * result
