...
/**
 * AmbisenseSsrnaViralSequenceId generated by hbm2java
 */
public class AmbisenseSsrnaViralSequenceId implements java.io.Serializable {

	private Integer ambisenseSsrnaViralSequenceId;
	...
	public AmbisenseSsrnaViralSequenceId() {
	}

	public AmbisenseSsrnaViralSequenceId(Integer ambisenseSsrnaViralSequenceId,
		...
		this.ambisenseSsrnaViralSequenceId = ambisenseSsrnaViralSequenceId;
	...
	public Integer getAmbisenseSsrnaViralSequenceId() {
		return this.ambisenseSsrnaViralSequenceId;
	}

	public void setAmbisenseSsrnaViralSequenceId(
			Integer ambisenseSsrnaViralSequenceId) {
		this.ambisenseSsrnaViralSequenceId = ambisenseSsrnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AmbisenseSsrnaViralSequenceId))
			return false;
		AmbisenseSsrnaViralSequenceId castOther = (AmbisenseSsrnaViralSequenceId) other;

		return ((this.getAmbisenseSsrnaViralSequenceId() == castOther
				.getAmbisenseSsrnaViralSequenceId()) || (this
				.getAmbisenseSsrnaViralSequenceId() != null
				&& castOther.getAmbisenseSsrnaViralSequenceId() != null && this
				.getAmbisenseSsrnaViralSequenceId().equals(
						castOther.getAmbisenseSsrnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAmbisenseSsrnaViralSequenceId() == null ? 0 : this
						.getAmbisenseSsrnaViralSequenceId().hashCode());
		result = 37 * result
