...
/**
 * NegativeSenseSsrnaViralSequenceId generated by hbm2java
 */
public class NegativeSenseSsrnaViralSequenceId implements java.io.Serializable {

	private Integer negativeSenseSsrnaViralSequenceId;
	...
	public NegativeSenseSsrnaViralSequenceId() {
	}

	public NegativeSenseSsrnaViralSequenceId(
			Integer negativeSenseSsrnaViralSequenceId, Integer featureId,
		...
		this.negativeSenseSsrnaViralSequenceId = negativeSenseSsrnaViralSequenceId;
	...
	public Integer getNegativeSenseSsrnaViralSequenceId() {
		return this.negativeSenseSsrnaViralSequenceId;
	}

	public void setNegativeSenseSsrnaViralSequenceId(
			Integer negativeSenseSsrnaViralSequenceId) {
		this.negativeSenseSsrnaViralSequenceId = negativeSenseSsrnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NegativeSenseSsrnaViralSequenceId))
			return false;
		NegativeSenseSsrnaViralSequenceId castOther = (NegativeSenseSsrnaViralSequenceId) other;

		return ((this.getNegativeSenseSsrnaViralSequenceId() == castOther
				.getNegativeSenseSsrnaViralSequenceId()) || (this
				.getNegativeSenseSsrnaViralSequenceId() != null
				&& castOther.getNegativeSenseSsrnaViralSequenceId() != null && this
				.getNegativeSenseSsrnaViralSequenceId().equals(
						castOther.getNegativeSenseSsrnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNegativeSenseSsrnaViralSequenceId() == null ? 0 : this
						.getNegativeSenseSsrnaViralSequenceId().hashCode());
		result = 37 * result
