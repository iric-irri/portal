...
/**
 * VJClusterId generated by hbm2java
 */
public class VJClusterId implements java.io.Serializable {

	private Integer VJClusterId;
	...
	public VJClusterId(Integer VJClusterId, Integer featureId,
	...
	public Integer getVJClusterId() {
		return this.VJClusterId;
	}

	public void setVJClusterId(Integer VJClusterId) {
		this.VJClusterId = VJClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VJClusterId))
			return false;
		VJClusterId castOther = (VJClusterId) other;

		return ((this.getVJClusterId() == castOther.getVJClusterId()) || (this
				.getVJClusterId() != null && castOther.getVJClusterId() != null && this
				.getVJClusterId().equals(castOther.getVJClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVJClusterId() == null ? 0 : this.getVJClusterId()
						.hashCode());
		result = 37 * result
