...
/**
 * ProlylTrnaId generated by hbm2java
 */
public class ProlylTrnaId implements java.io.Serializable {

	private Integer prolylTrnaId;
	...
	public ProlylTrnaId(Integer prolylTrnaId, Integer featureId,
		...
		this.prolylTrnaId = prolylTrnaId;
	...
	public Integer getProlylTrnaId() {
		return this.prolylTrnaId;
	}

	public void setProlylTrnaId(Integer prolylTrnaId) {
		this.prolylTrnaId = prolylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProlylTrnaId))
			return false;
		ProlylTrnaId castOther = (ProlylTrnaId) other;

		return ((this.getProlylTrnaId() == castOther.getProlylTrnaId()) || (this
				.getProlylTrnaId() != null
				&& castOther.getProlylTrnaId() != null && this
				.getProlylTrnaId().equals(castOther.getProlylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProlylTrnaId() == null ? 0 : this.getProlylTrnaId()
						.hashCode());
		result = 37 * result
