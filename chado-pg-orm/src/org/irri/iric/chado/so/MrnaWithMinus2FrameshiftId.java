...
/**
 * MrnaWithMinus2FrameshiftId generated by hbm2java
 */
public class MrnaWithMinus2FrameshiftId implements java.io.Serializable {

	private Integer mrnaWithMinus2FrameshiftId;
	...
	public MrnaWithMinus2FrameshiftId() {
	}

	public MrnaWithMinus2FrameshiftId(Integer mrnaWithMinus2FrameshiftId,
		...
		this.mrnaWithMinus2FrameshiftId = mrnaWithMinus2FrameshiftId;
	...
	public Integer getMrnaWithMinus2FrameshiftId() {
		return this.mrnaWithMinus2FrameshiftId;
	}

	public void setMrnaWithMinus2FrameshiftId(Integer mrnaWithMinus2FrameshiftId) {
		this.mrnaWithMinus2FrameshiftId = mrnaWithMinus2FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaWithMinus2FrameshiftId))
			return false;
		MrnaWithMinus2FrameshiftId castOther = (MrnaWithMinus2FrameshiftId) other;

		return ((this.getMrnaWithMinus2FrameshiftId() == castOther
				.getMrnaWithMinus2FrameshiftId()) || (this
				.getMrnaWithMinus2FrameshiftId() != null
				&& castOther.getMrnaWithMinus2FrameshiftId() != null && this
				.getMrnaWithMinus2FrameshiftId().equals(
						castOther.getMrnaWithMinus2FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaWithMinus2FrameshiftId() == null ? 0 : this
						.getMrnaWithMinus2FrameshiftId().hashCode());
		result = 37 * result
