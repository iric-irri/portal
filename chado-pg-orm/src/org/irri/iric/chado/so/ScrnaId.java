...
/**
 * ScrnaId generated by hbm2java
 */
public class ScrnaId implements java.io.Serializable {

	private Integer scrnaId;
	...
	public ScrnaId(Integer scrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getScrnaId() {
		return this.scrnaId;
	}

	public void setScrnaId(Integer scrnaId) {
		this.scrnaId = scrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ScrnaId))
			return false;
		ScrnaId castOther = (ScrnaId) other;

		return ((this.getScrnaId() == castOther.getScrnaId()) || (this
				.getScrnaId() != null && castOther.getScrnaId() != null && this
				.getScrnaId().equals(castOther.getScrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getScrnaId() == null ? 0 : this.getScrnaId().hashCode());
		result = 37 * result
