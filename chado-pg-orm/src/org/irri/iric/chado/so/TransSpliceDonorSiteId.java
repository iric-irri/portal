...
/**
 * TransSpliceDonorSiteId generated by hbm2java
 */
public class TransSpliceDonorSiteId implements java.io.Serializable {

	private Integer transSpliceDonorSiteId;
	...
	public TransSpliceDonorSiteId() {
	}

	public TransSpliceDonorSiteId(Integer transSpliceDonorSiteId,
		...
		this.transSpliceDonorSiteId = transSpliceDonorSiteId;
	...
	public Integer getTransSpliceDonorSiteId() {
		return this.transSpliceDonorSiteId;
	}

	public void setTransSpliceDonorSiteId(Integer transSpliceDonorSiteId) {
		this.transSpliceDonorSiteId = transSpliceDonorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransSpliceDonorSiteId))
			return false;
		TransSpliceDonorSiteId castOther = (TransSpliceDonorSiteId) other;

		return ((this.getTransSpliceDonorSiteId() == castOther
				.getTransSpliceDonorSiteId()) || (this
				.getTransSpliceDonorSiteId() != null
				&& castOther.getTransSpliceDonorSiteId() != null && this
				.getTransSpliceDonorSiteId().equals(
						castOther.getTransSpliceDonorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransSpliceDonorSiteId() == null ? 0 : this
						.getTransSpliceDonorSiteId().hashCode());
		result = 37 * result
