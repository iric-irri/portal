...
/**
 * ValineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class ValineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer valineTrnaPrimaryTranscriptId;
	...
	public ValineTrnaPrimaryTranscriptId() {
	}

	public ValineTrnaPrimaryTranscriptId(Integer valineTrnaPrimaryTranscriptId,
		...
		this.valineTrnaPrimaryTranscriptId = valineTrnaPrimaryTranscriptId;
	...
	public Integer getValineTrnaPrimaryTranscriptId() {
		return this.valineTrnaPrimaryTranscriptId;
	}

	public void setValineTrnaPrimaryTranscriptId(
			Integer valineTrnaPrimaryTranscriptId) {
		this.valineTrnaPrimaryTranscriptId = valineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ValineTrnaPrimaryTranscriptId))
			return false;
		ValineTrnaPrimaryTranscriptId castOther = (ValineTrnaPrimaryTranscriptId) other;

		return ((this.getValineTrnaPrimaryTranscriptId() == castOther
				.getValineTrnaPrimaryTranscriptId()) || (this
				.getValineTrnaPrimaryTranscriptId() != null
				&& castOther.getValineTrnaPrimaryTranscriptId() != null && this
				.getValineTrnaPrimaryTranscriptId().equals(
						castOther.getValineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getValineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getValineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
