...
/**
 * RibozymicId generated by hbm2java
 */
public class RibozymicId implements java.io.Serializable {

	private Integer ribozymicId;
	...
	public RibozymicId(Integer ribozymicId, Integer featureId,
	...
	public Integer getRibozymicId() {
		return this.ribozymicId;
	}

	public void setRibozymicId(Integer ribozymicId) {
		this.ribozymicId = ribozymicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RibozymicId))
			return false;
		RibozymicId castOther = (RibozymicId) other;

		return ((this.getRibozymicId() == castOther.getRibozymicId()) || (this
				.getRibozymicId() != null && castOther.getRibozymicId() != null && this
				.getRibozymicId().equals(castOther.getRibozymicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRibozymicId() == null ? 0 : this.getRibozymicId()
						.hashCode());
		result = 37 * result
