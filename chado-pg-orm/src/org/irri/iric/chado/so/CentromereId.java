...
/**
 * CentromereId generated by hbm2java
 */
public class CentromereId implements java.io.Serializable {

	private Integer centromereId;
	...
	public CentromereId(Integer centromereId, Integer featureId,
		...
		this.centromereId = centromereId;
	...
	public Integer getCentromereId() {
		return this.centromereId;
	}

	public void setCentromereId(Integer centromereId) {
		this.centromereId = centromereId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CentromereId))
			return false;
		CentromereId castOther = (CentromereId) other;

		return ((this.getCentromereId() == castOther.getCentromereId()) || (this
				.getCentromereId() != null
				&& castOther.getCentromereId() != null && this
				.getCentromereId().equals(castOther.getCentromereId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCentromereId() == null ? 0 : this.getCentromereId()
						.hashCode());
		result = 37 * result
