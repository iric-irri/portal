...
/**
 * MiniGeneId generated by hbm2java
 */
public class MiniGeneId implements java.io.Serializable {

	private Integer miniGeneId;
	...
	public MiniGeneId(Integer miniGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMiniGeneId() {
		return this.miniGeneId;
	}

	public void setMiniGeneId(Integer miniGeneId) {
		this.miniGeneId = miniGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MiniGeneId))
			return false;
		MiniGeneId castOther = (MiniGeneId) other;

		return ((this.getMiniGeneId() == castOther.getMiniGeneId()) || (this
				.getMiniGeneId() != null && castOther.getMiniGeneId() != null && this
				.getMiniGeneId().equals(castOther.getMiniGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMiniGeneId() == null ? 0 : this.getMiniGeneId()
						.hashCode());
		result = 37 * result
