...
/**
 * FivekbUpstreamVariantId generated by hbm2java
 */
public class FivekbUpstreamVariantId implements java.io.Serializable {

	private Integer fivekbUpstreamVariantId;
	...
	public FivekbUpstreamVariantId() {
	}

	public FivekbUpstreamVariantId(Integer fivekbUpstreamVariantId,
		...
		this.fivekbUpstreamVariantId = fivekbUpstreamVariantId;
	...
	public Integer getFivekbUpstreamVariantId() {
		return this.fivekbUpstreamVariantId;
	}

	public void setFivekbUpstreamVariantId(Integer fivekbUpstreamVariantId) {
		this.fivekbUpstreamVariantId = fivekbUpstreamVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivekbUpstreamVariantId))
			return false;
		FivekbUpstreamVariantId castOther = (FivekbUpstreamVariantId) other;

		return ((this.getFivekbUpstreamVariantId() == castOther
				.getFivekbUpstreamVariantId()) || (this
				.getFivekbUpstreamVariantId() != null
				&& castOther.getFivekbUpstreamVariantId() != null && this
				.getFivekbUpstreamVariantId().equals(
						castOther.getFivekbUpstreamVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivekbUpstreamVariantId() == null ? 0 : this
						.getFivekbUpstreamVariantId().hashCode());
		result = 37 * result
