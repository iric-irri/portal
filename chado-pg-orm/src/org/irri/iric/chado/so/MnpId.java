...
/**
 * MnpId generated by hbm2java
 */
public class MnpId implements java.io.Serializable {
	...
	public MnpId(Integer mnpId, Integer featureId, Integer dbxrefId,
	...
	public Integer getMnpId() {
		return this.mnpId;
	}

	public void setMnpId(Integer mnpId) {
		this.mnpId = mnpId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MnpId))
			return false;
		MnpId castOther = (MnpId) other;

		return ((this.getMnpId() == castOther.getMnpId()) || (this.getMnpId() != null
				&& castOther.getMnpId() != null && this.getMnpId().equals(
				castOther.getMnpId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMnpId() == null ? 0 : this.getMnpId().hashCode());
		result = 37 * result
