...
/**
 * RecodedByTranslationalBypassId generated by hbm2java
 */
public class RecodedByTranslationalBypassId implements java.io.Serializable {

	private Integer recodedByTranslationalBypassId;
	...
	public RecodedByTranslationalBypassId() {
	}

	public RecodedByTranslationalBypassId(
			Integer recodedByTranslationalBypassId, Integer featureId,
		...
		this.recodedByTranslationalBypassId = recodedByTranslationalBypassId;
	...
	public Integer getRecodedByTranslationalBypassId() {
		return this.recodedByTranslationalBypassId;
	}

	public void setRecodedByTranslationalBypassId(
			Integer recodedByTranslationalBypassId) {
		this.recodedByTranslationalBypassId = recodedByTranslationalBypassId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodedByTranslationalBypassId))
			return false;
		RecodedByTranslationalBypassId castOther = (RecodedByTranslationalBypassId) other;

		return ((this.getRecodedByTranslationalBypassId() == castOther
				.getRecodedByTranslationalBypassId()) || (this
				.getRecodedByTranslationalBypassId() != null
				&& castOther.getRecodedByTranslationalBypassId() != null && this
				.getRecodedByTranslationalBypassId().equals(
						castOther.getRecodedByTranslationalBypassId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecodedByTranslationalBypassId() == null ? 0 : this
						.getRecodedByTranslationalBypassId().hashCode());
		result = 37 * result
