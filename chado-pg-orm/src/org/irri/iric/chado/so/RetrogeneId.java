...
/**
 * RetrogeneId generated by hbm2java
 */
public class RetrogeneId implements java.io.Serializable {

	private Integer retrogeneId;
	...
	public RetrogeneId(Integer retrogeneId, Integer featureId,
	...
	public Integer getRetrogeneId() {
		return this.retrogeneId;
	}

	public void setRetrogeneId(Integer retrogeneId) {
		this.retrogeneId = retrogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RetrogeneId))
			return false;
		RetrogeneId castOther = (RetrogeneId) other;

		return ((this.getRetrogeneId() == castOther.getRetrogeneId()) || (this
				.getRetrogeneId() != null && castOther.getRetrogeneId() != null && this
				.getRetrogeneId().equals(castOther.getRetrogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRetrogeneId() == null ? 0 : this.getRetrogeneId()
						.hashCode());
		result = 37 * result
