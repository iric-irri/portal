...
/**
 * SupportedByDomainMatchId generated by hbm2java
 */
public class SupportedByDomainMatchId implements java.io.Serializable {

	private Integer supportedByDomainMatchId;
	...
	public SupportedByDomainMatchId() {
	}

	public SupportedByDomainMatchId(Integer supportedByDomainMatchId,
		...
		this.supportedByDomainMatchId = supportedByDomainMatchId;
	...
	public Integer getSupportedByDomainMatchId() {
		return this.supportedByDomainMatchId;
	}

	public void setSupportedByDomainMatchId(Integer supportedByDomainMatchId) {
		this.supportedByDomainMatchId = supportedByDomainMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SupportedByDomainMatchId))
			return false;
		SupportedByDomainMatchId castOther = (SupportedByDomainMatchId) other;

		return ((this.getSupportedByDomainMatchId() == castOther
				.getSupportedByDomainMatchId()) || (this
				.getSupportedByDomainMatchId() != null
				&& castOther.getSupportedByDomainMatchId() != null && this
				.getSupportedByDomainMatchId().equals(
						castOther.getSupportedByDomainMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSupportedByDomainMatchId() == null ? 0 : this
						.getSupportedByDomainMatchId().hashCode());
		result = 37 * result
