...
/**
 * RnasePRnaGeneId generated by hbm2java
 */
public class RnasePRnaGeneId implements java.io.Serializable {

	private Integer rnasePRnaGeneId;
	...
	public RnasePRnaGeneId() {
	}

	public RnasePRnaGeneId(Integer rnasePRnaGeneId, Integer featureId,
		...
		this.rnasePRnaGeneId = rnasePRnaGeneId;
	...
	public Integer getRnasePRnaGeneId() {
		return this.rnasePRnaGeneId;
	}

	public void setRnasePRnaGeneId(Integer rnasePRnaGeneId) {
		this.rnasePRnaGeneId = rnasePRnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnasePRnaGeneId))
			return false;
		RnasePRnaGeneId castOther = (RnasePRnaGeneId) other;

		return ((this.getRnasePRnaGeneId() == castOther.getRnasePRnaGeneId()) || (this
				.getRnasePRnaGeneId() != null
				&& castOther.getRnasePRnaGeneId() != null && this
				.getRnasePRnaGeneId().equals(castOther.getRnasePRnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnasePRnaGeneId() == null ? 0 : this.getRnasePRnaGeneId()
						.hashCode());
		result = 37 * result
