...
/**
 * SyntheticSequenceId generated by hbm2java
 */
public class SyntheticSequenceId implements java.io.Serializable {

	private Integer syntheticSequenceId;
	...
	public SyntheticSequenceId() {
	}

	public SyntheticSequenceId(Integer syntheticSequenceId, Integer featureId,
		...
		this.syntheticSequenceId = syntheticSequenceId;
	...
	public Integer getSyntheticSequenceId() {
		return this.syntheticSequenceId;
	}

	public void setSyntheticSequenceId(Integer syntheticSequenceId) {
		this.syntheticSequenceId = syntheticSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SyntheticSequenceId))
			return false;
		SyntheticSequenceId castOther = (SyntheticSequenceId) other;

		return ((this.getSyntheticSequenceId() == castOther
				.getSyntheticSequenceId()) || (this.getSyntheticSequenceId() != null
				&& castOther.getSyntheticSequenceId() != null && this
				.getSyntheticSequenceId().equals(
						castOther.getSyntheticSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSyntheticSequenceId() == null ? 0 : this
						.getSyntheticSequenceId().hashCode());
		result = 37 * result
