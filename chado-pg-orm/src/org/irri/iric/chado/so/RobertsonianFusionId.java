...
/**
 * RobertsonianFusionId generated by hbm2java
 */
public class RobertsonianFusionId implements java.io.Serializable {

	private Integer robertsonianFusionId;
	...
	public RobertsonianFusionId() {
	}

	public RobertsonianFusionId(Integer robertsonianFusionId,
		...
		this.robertsonianFusionId = robertsonianFusionId;
	...
	public Integer getRobertsonianFusionId() {
		return this.robertsonianFusionId;
	}

	public void setRobertsonianFusionId(Integer robertsonianFusionId) {
		this.robertsonianFusionId = robertsonianFusionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RobertsonianFusionId))
			return false;
		RobertsonianFusionId castOther = (RobertsonianFusionId) other;

		return ((this.getRobertsonianFusionId() == castOther
				.getRobertsonianFusionId()) || (this.getRobertsonianFusionId() != null
				&& castOther.getRobertsonianFusionId() != null && this
				.getRobertsonianFusionId().equals(
						castOther.getRobertsonianFusionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRobertsonianFusionId() == null ? 0 : this
						.getRobertsonianFusionId().hashCode());
		result = 37 * result
