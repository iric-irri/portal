...
/**
 * MirnaPrimaryTranscriptId generated by hbm2java
 */
public class MirnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer mirnaPrimaryTranscriptId;
	...
	public MirnaPrimaryTranscriptId() {
	}

	public MirnaPrimaryTranscriptId(Integer mirnaPrimaryTranscriptId,
		...
		this.mirnaPrimaryTranscriptId = mirnaPrimaryTranscriptId;
	...
	public Integer getMirnaPrimaryTranscriptId() {
		return this.mirnaPrimaryTranscriptId;
	}

	public void setMirnaPrimaryTranscriptId(Integer mirnaPrimaryTranscriptId) {
		this.mirnaPrimaryTranscriptId = mirnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaPrimaryTranscriptId))
			return false;
		MirnaPrimaryTranscriptId castOther = (MirnaPrimaryTranscriptId) other;

		return ((this.getMirnaPrimaryTranscriptId() == castOther
				.getMirnaPrimaryTranscriptId()) || (this
				.getMirnaPrimaryTranscriptId() != null
				&& castOther.getMirnaPrimaryTranscriptId() != null && this
				.getMirnaPrimaryTranscriptId().equals(
						castOther.getMirnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaPrimaryTranscriptId() == null ? 0 : this
						.getMirnaPrimaryTranscriptId().hashCode());
		result = 37 * result
