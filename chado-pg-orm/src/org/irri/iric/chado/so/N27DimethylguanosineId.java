...
/**
 * N27DimethylguanosineId generated by hbm2java
 */
public class N27DimethylguanosineId implements java.io.Serializable {

	private Integer n27DimethylguanosineId;
	...
	public N27DimethylguanosineId() {
	}

	public N27DimethylguanosineId(Integer n27DimethylguanosineId,
		...
		this.n27DimethylguanosineId = n27DimethylguanosineId;
	...
	public Integer getN27DimethylguanosineId() {
		return this.n27DimethylguanosineId;
	}

	public void setN27DimethylguanosineId(Integer n27DimethylguanosineId) {
		this.n27DimethylguanosineId = n27DimethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N27DimethylguanosineId))
			return false;
		N27DimethylguanosineId castOther = (N27DimethylguanosineId) other;

		return ((this.getN27DimethylguanosineId() == castOther
				.getN27DimethylguanosineId()) || (this
				.getN27DimethylguanosineId() != null
				&& castOther.getN27DimethylguanosineId() != null && this
				.getN27DimethylguanosineId().equals(
						castOther.getN27DimethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN27DimethylguanosineId() == null ? 0 : this
						.getN27DimethylguanosineId().hashCode());
		result = 37 * result
