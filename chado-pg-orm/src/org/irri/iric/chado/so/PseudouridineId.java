...
/**
 * PseudouridineId generated by hbm2java
 */
public class PseudouridineId implements java.io.Serializable {

	private Integer pseudouridineId;
	...
	public PseudouridineId() {
	}

	public PseudouridineId(Integer pseudouridineId, Integer featureId,
		...
		this.pseudouridineId = pseudouridineId;
	...
	public Integer getPseudouridineId() {
		return this.pseudouridineId;
	}

	public void setPseudouridineId(Integer pseudouridineId) {
		this.pseudouridineId = pseudouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudouridineId))
			return false;
		PseudouridineId castOther = (PseudouridineId) other;

		return ((this.getPseudouridineId() == castOther.getPseudouridineId()) || (this
				.getPseudouridineId() != null
				&& castOther.getPseudouridineId() != null && this
				.getPseudouridineId().equals(castOther.getPseudouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudouridineId() == null ? 0 : this.getPseudouridineId()
						.hashCode());
		result = 37 * result
