...
/**
 * Minus1FrameshiftVariantId generated by hbm2java
 */
public class Minus1FrameshiftVariantId implements java.io.Serializable {

	private Integer minus1FrameshiftVariantId;
	...
	public Minus1FrameshiftVariantId() {
	}

	public Minus1FrameshiftVariantId(Integer minus1FrameshiftVariantId,
		...
		this.minus1FrameshiftVariantId = minus1FrameshiftVariantId;
	...
	public Integer getMinus1FrameshiftVariantId() {
		return this.minus1FrameshiftVariantId;
	}

	public void setMinus1FrameshiftVariantId(Integer minus1FrameshiftVariantId) {
		this.minus1FrameshiftVariantId = minus1FrameshiftVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus1FrameshiftVariantId))
			return false;
		Minus1FrameshiftVariantId castOther = (Minus1FrameshiftVariantId) other;

		return ((this.getMinus1FrameshiftVariantId() == castOther
				.getMinus1FrameshiftVariantId()) || (this
				.getMinus1FrameshiftVariantId() != null
				&& castOther.getMinus1FrameshiftVariantId() != null && this
				.getMinus1FrameshiftVariantId().equals(
						castOther.getMinus1FrameshiftVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus1FrameshiftVariantId() == null ? 0 : this
						.getMinus1FrameshiftVariantId().hashCode());
		result = 37 * result
