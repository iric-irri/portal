...
/**
 * ChromosomePartId generated by hbm2java
 */
public class ChromosomePartId implements java.io.Serializable {

	private Integer chromosomePartId;
	...
	public ChromosomePartId() {
	}

	public ChromosomePartId(Integer chromosomePartId, Integer featureId,
		...
		this.chromosomePartId = chromosomePartId;
	...
	public Integer getChromosomePartId() {
		return this.chromosomePartId;
	}

	public void setChromosomePartId(Integer chromosomePartId) {
		this.chromosomePartId = chromosomePartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomePartId))
			return false;
		ChromosomePartId castOther = (ChromosomePartId) other;

		return ((this.getChromosomePartId() == castOther.getChromosomePartId()) || (this
				.getChromosomePartId() != null
				&& castOther.getChromosomePartId() != null && this
				.getChromosomePartId().equals(castOther.getChromosomePartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomePartId() == null ? 0 : this
						.getChromosomePartId().hashCode());
		result = 37 * result
