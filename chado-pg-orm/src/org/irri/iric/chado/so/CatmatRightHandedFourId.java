...
/**
 * CatmatRightHandedFourId generated by hbm2java
 */
public class CatmatRightHandedFourId implements java.io.Serializable {

	private Integer catmatRightHandedFourId;
	...
	public CatmatRightHandedFourId() {
	}

	public CatmatRightHandedFourId(Integer catmatRightHandedFourId,
		...
		this.catmatRightHandedFourId = catmatRightHandedFourId;
	...
	public Integer getCatmatRightHandedFourId() {
		return this.catmatRightHandedFourId;
	}

	public void setCatmatRightHandedFourId(Integer catmatRightHandedFourId) {
		this.catmatRightHandedFourId = catmatRightHandedFourId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatmatRightHandedFourId))
			return false;
		CatmatRightHandedFourId castOther = (CatmatRightHandedFourId) other;

		return ((this.getCatmatRightHandedFourId() == castOther
				.getCatmatRightHandedFourId()) || (this
				.getCatmatRightHandedFourId() != null
				&& castOther.getCatmatRightHandedFourId() != null && this
				.getCatmatRightHandedFourId().equals(
						castOther.getCatmatRightHandedFourId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCatmatRightHandedFourId() == null ? 0 : this
						.getCatmatRightHandedFourId().hashCode());
		result = 37 * result
