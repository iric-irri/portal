...
/**
 * RecombinationHotspotId generated by hbm2java
 */
public class RecombinationHotspotId implements java.io.Serializable {

	private Integer recombinationHotspotId;
	...
	public RecombinationHotspotId() {
	}

	public RecombinationHotspotId(Integer recombinationHotspotId,
		...
		this.recombinationHotspotId = recombinationHotspotId;
	...
	public Integer getRecombinationHotspotId() {
		return this.recombinationHotspotId;
	}

	public void setRecombinationHotspotId(Integer recombinationHotspotId) {
		this.recombinationHotspotId = recombinationHotspotId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationHotspotId))
			return false;
		RecombinationHotspotId castOther = (RecombinationHotspotId) other;

		return ((this.getRecombinationHotspotId() == castOther
				.getRecombinationHotspotId()) || (this
				.getRecombinationHotspotId() != null
				&& castOther.getRecombinationHotspotId() != null && this
				.getRecombinationHotspotId().equals(
						castOther.getRecombinationHotspotId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationHotspotId() == null ? 0 : this
						.getRecombinationHotspotId().hashCode());
		result = 37 * result
