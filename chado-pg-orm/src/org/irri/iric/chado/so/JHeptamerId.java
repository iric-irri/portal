...
/**
 * JHeptamerId generated by hbm2java
 */
public class JHeptamerId implements java.io.Serializable {

	private Integer JHeptamerId;
	...
	public JHeptamerId(Integer JHeptamerId, Integer featureId,
	...
	public Integer getJHeptamerId() {
		return this.JHeptamerId;
	}

	public void setJHeptamerId(Integer JHeptamerId) {
		this.JHeptamerId = JHeptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JHeptamerId))
			return false;
		JHeptamerId castOther = (JHeptamerId) other;

		return ((this.getJHeptamerId() == castOther.getJHeptamerId()) || (this
				.getJHeptamerId() != null && castOther.getJHeptamerId() != null && this
				.getJHeptamerId().equals(castOther.getJHeptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJHeptamerId() == null ? 0 : this.getJHeptamerId()
						.hashCode());
		result = 37 * result
