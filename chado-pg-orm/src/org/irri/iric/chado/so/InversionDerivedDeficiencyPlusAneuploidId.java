...
/**
 * InversionDerivedDeficiencyPlusAneuploidId generated by hbm2java
 */
public class InversionDerivedDeficiencyPlusAneuploidId implements
		java.io.Serializable {

	private Integer inversionDerivedDeficiencyPlusAneuploidId;
	...
	public InversionDerivedDeficiencyPlusAneuploidId() {
	}

	public InversionDerivedDeficiencyPlusAneuploidId(
			Integer inversionDerivedDeficiencyPlusAneuploidId,
		...
		this.inversionDerivedDeficiencyPlusAneuploidId = inversionDerivedDeficiencyPlusAneuploidId;
	...
	public Integer getInversionDerivedDeficiencyPlusAneuploidId() {
		return this.inversionDerivedDeficiencyPlusAneuploidId;
	}

	public void setInversionDerivedDeficiencyPlusAneuploidId(
			Integer inversionDerivedDeficiencyPlusAneuploidId) {
		this.inversionDerivedDeficiencyPlusAneuploidId = inversionDerivedDeficiencyPlusAneuploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionDerivedDeficiencyPlusAneuploidId))
			return false;
		InversionDerivedDeficiencyPlusAneuploidId castOther = (InversionDerivedDeficiencyPlusAneuploidId) other;

		return ((this.getInversionDerivedDeficiencyPlusAneuploidId() == castOther
				.getInversionDerivedDeficiencyPlusAneuploidId()) || (this
				.getInversionDerivedDeficiencyPlusAneuploidId() != null
				&& castOther.getInversionDerivedDeficiencyPlusAneuploidId() != null && this
				.getInversionDerivedDeficiencyPlusAneuploidId()
				.equals(castOther
						.getInversionDerivedDeficiencyPlusAneuploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionDerivedDeficiencyPlusAneuploidId() == null ? 0
						: this.getInversionDerivedDeficiencyPlusAneuploidId()
								.hashCode());
		result = 37 * result
