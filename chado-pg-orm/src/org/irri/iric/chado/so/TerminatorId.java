...
/**
 * TerminatorId generated by hbm2java
 */
public class TerminatorId implements java.io.Serializable {
	...
	public TerminatorId(Integer terminatorId, Integer featureId,
	...
	public Integer getTerminatorId() {
		return this.terminatorId;
	}

	public void setTerminatorId(Integer terminatorId) {
		this.terminatorId = terminatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminatorId))
			return false;
		TerminatorId castOther = (TerminatorId) other;

		return ((this.getTerminatorId() == castOther.getTerminatorId()) || (this
				.getTerminatorId() != null
				&& castOther.getTerminatorId() != null && this
				.getTerminatorId().equals(castOther.getTerminatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminatorId() == null ? 0 : this.getTerminatorId()
						.hashCode());
		result = 37 * result
