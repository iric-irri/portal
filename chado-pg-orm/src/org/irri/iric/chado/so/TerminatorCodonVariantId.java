...
/**
 * TerminatorCodonVariantId generated by hbm2java
 */
public class TerminatorCodonVariantId implements java.io.Serializable {

	private Integer terminatorCodonVariantId;
	...
	public TerminatorCodonVariantId() {
	}

	public TerminatorCodonVariantId(Integer terminatorCodonVariantId,
		...
		this.terminatorCodonVariantId = terminatorCodonVariantId;
	...
	public Integer getTerminatorCodonVariantId() {
		return this.terminatorCodonVariantId;
	}

	public void setTerminatorCodonVariantId(Integer terminatorCodonVariantId) {
		this.terminatorCodonVariantId = terminatorCodonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminatorCodonVariantId))
			return false;
		TerminatorCodonVariantId castOther = (TerminatorCodonVariantId) other;

		return ((this.getTerminatorCodonVariantId() == castOther
				.getTerminatorCodonVariantId()) || (this
				.getTerminatorCodonVariantId() != null
				&& castOther.getTerminatorCodonVariantId() != null && this
				.getTerminatorCodonVariantId().equals(
						castOther.getTerminatorCodonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminatorCodonVariantId() == null ? 0 : this
						.getTerminatorCodonVariantId().hashCode());
		result = 37 * result
