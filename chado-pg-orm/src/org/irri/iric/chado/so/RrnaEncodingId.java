...
/**
 * RrnaEncodingId generated by hbm2java
 */
public class RrnaEncodingId implements java.io.Serializable {

	private Integer rrnaEncodingId;
	...
	public RrnaEncodingId() {
	}

	public RrnaEncodingId(Integer rrnaEncodingId, Integer featureId,
		...
		this.rrnaEncodingId = rrnaEncodingId;
	...
	public Integer getRrnaEncodingId() {
		return this.rrnaEncodingId;
	}

	public void setRrnaEncodingId(Integer rrnaEncodingId) {
		this.rrnaEncodingId = rrnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaEncodingId))
			return false;
		RrnaEncodingId castOther = (RrnaEncodingId) other;

		return ((this.getRrnaEncodingId() == castOther.getRrnaEncodingId()) || (this
				.getRrnaEncodingId() != null
				&& castOther.getRrnaEncodingId() != null && this
				.getRrnaEncodingId().equals(castOther.getRrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaEncodingId() == null ? 0 : this.getRrnaEncodingId()
						.hashCode());
		result = 37 * result
