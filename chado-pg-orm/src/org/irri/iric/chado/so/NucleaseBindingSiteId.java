...
/**
 * NucleaseBindingSiteId generated by hbm2java
 */
public class NucleaseBindingSiteId implements java.io.Serializable {

	private Integer nucleaseBindingSiteId;
	...
	public NucleaseBindingSiteId() {
	}

	public NucleaseBindingSiteId(Integer nucleaseBindingSiteId,
		...
		this.nucleaseBindingSiteId = nucleaseBindingSiteId;
	...
	public Integer getNucleaseBindingSiteId() {
		return this.nucleaseBindingSiteId;
	}

	public void setNucleaseBindingSiteId(Integer nucleaseBindingSiteId) {
		this.nucleaseBindingSiteId = nucleaseBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleaseBindingSiteId))
			return false;
		NucleaseBindingSiteId castOther = (NucleaseBindingSiteId) other;

		return ((this.getNucleaseBindingSiteId() == castOther
				.getNucleaseBindingSiteId()) || (this
				.getNucleaseBindingSiteId() != null
				&& castOther.getNucleaseBindingSiteId() != null && this
				.getNucleaseBindingSiteId().equals(
						castOther.getNucleaseBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleaseBindingSiteId() == null ? 0 : this
						.getNucleaseBindingSiteId().hashCode());
		result = 37 * result
