...
/**
 * TranscriptWithTranslationalFrameshiftId generated by hbm2java
 */
public class TranscriptWithTranslationalFrameshiftId implements
		java.io.Serializable {

	private Integer transcriptWithTranslationalFrameshiftId;
	...
	public TranscriptWithTranslationalFrameshiftId() {
	}

	public TranscriptWithTranslationalFrameshiftId(
			Integer transcriptWithTranslationalFrameshiftId, Integer featureId,
		...
		this.transcriptWithTranslationalFrameshiftId = transcriptWithTranslationalFrameshiftId;
	...
	public Integer getTranscriptWithTranslationalFrameshiftId() {
		return this.transcriptWithTranslationalFrameshiftId;
	}

	public void setTranscriptWithTranslationalFrameshiftId(
			Integer transcriptWithTranslationalFrameshiftId) {
		this.transcriptWithTranslationalFrameshiftId = transcriptWithTranslationalFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptWithTranslationalFrameshiftId))
			return false;
		TranscriptWithTranslationalFrameshiftId castOther = (TranscriptWithTranslationalFrameshiftId) other;

		return ((this.getTranscriptWithTranslationalFrameshiftId() == castOther
				.getTranscriptWithTranslationalFrameshiftId()) || (this
				.getTranscriptWithTranslationalFrameshiftId() != null
				&& castOther.getTranscriptWithTranslationalFrameshiftId() != null && this
				.getTranscriptWithTranslationalFrameshiftId().equals(
						castOther.getTranscriptWithTranslationalFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptWithTranslationalFrameshiftId() == null ? 0
						: this.getTranscriptWithTranslationalFrameshiftId()
								.hashCode());
		result = 37 * result
