...
/**
 * TrnaGeneId generated by hbm2java
 */
public class TrnaGeneId implements java.io.Serializable {

	private Integer trnaGeneId;
	...
	public TrnaGeneId(Integer trnaGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTrnaGeneId() {
		return this.trnaGeneId;
	}

	public void setTrnaGeneId(Integer trnaGeneId) {
		this.trnaGeneId = trnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaGeneId))
			return false;
		TrnaGeneId castOther = (TrnaGeneId) other;

		return ((this.getTrnaGeneId() == castOther.getTrnaGeneId()) || (this
				.getTrnaGeneId() != null && castOther.getTrnaGeneId() != null && this
				.getTrnaGeneId().equals(castOther.getTrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrnaGeneId() == null ? 0 : this.getTrnaGeneId()
						.hashCode());
		result = 37 * result
