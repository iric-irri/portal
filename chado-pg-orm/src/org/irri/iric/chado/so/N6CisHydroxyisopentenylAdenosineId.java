...
/**
 * N6CisHydroxyisopentenylAdenosineId generated by hbm2java
 */
public class N6CisHydroxyisopentenylAdenosineId implements java.io.Serializable {

	private Integer n6CisHydroxyisopentenylAdenosineId;
	...
	public N6CisHydroxyisopentenylAdenosineId() {
	}

	public N6CisHydroxyisopentenylAdenosineId(
			Integer n6CisHydroxyisopentenylAdenosineId, Integer featureId,
		...
		this.n6CisHydroxyisopentenylAdenosineId = n6CisHydroxyisopentenylAdenosineId;
	...
	public Integer getN6CisHydroxyisopentenylAdenosineId() {
		return this.n6CisHydroxyisopentenylAdenosineId;
	}

	public void setN6CisHydroxyisopentenylAdenosineId(
			Integer n6CisHydroxyisopentenylAdenosineId) {
		this.n6CisHydroxyisopentenylAdenosineId = n6CisHydroxyisopentenylAdenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6CisHydroxyisopentenylAdenosineId))
			return false;
		N6CisHydroxyisopentenylAdenosineId castOther = (N6CisHydroxyisopentenylAdenosineId) other;

		return ((this.getN6CisHydroxyisopentenylAdenosineId() == castOther
				.getN6CisHydroxyisopentenylAdenosineId()) || (this
				.getN6CisHydroxyisopentenylAdenosineId() != null
				&& castOther.getN6CisHydroxyisopentenylAdenosineId() != null && this
				.getN6CisHydroxyisopentenylAdenosineId().equals(
						castOther.getN6CisHydroxyisopentenylAdenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6CisHydroxyisopentenylAdenosineId() == null ? 0 : this
						.getN6CisHydroxyisopentenylAdenosineId().hashCode());
		result = 37 * result
