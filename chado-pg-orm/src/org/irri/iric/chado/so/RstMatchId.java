...
/**
 * RstMatchId generated by hbm2java
 */
public class RstMatchId implements java.io.Serializable {

	private Integer rstMatchId;
	...
	public RstMatchId(Integer rstMatchId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRstMatchId() {
		return this.rstMatchId;
	}

	public void setRstMatchId(Integer rstMatchId) {
		this.rstMatchId = rstMatchId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RstMatchId))
			return false;
		RstMatchId castOther = (RstMatchId) other;

		return ((this.getRstMatchId() == castOther.getRstMatchId()) || (this
				.getRstMatchId() != null && castOther.getRstMatchId() != null && this
				.getRstMatchId().equals(castOther.getRstMatchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRstMatchId() == null ? 0 : this.getRstMatchId()
						.hashCode());
		result = 37 * result
