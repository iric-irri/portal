...
/**
 * AnchorBindingSiteId generated by hbm2java
 */
public class AnchorBindingSiteId implements java.io.Serializable {

	private Integer anchorBindingSiteId;
	...
	public AnchorBindingSiteId() {
	}

	public AnchorBindingSiteId(Integer anchorBindingSiteId, Integer featureId,
		...
		this.anchorBindingSiteId = anchorBindingSiteId;
	...
	public Integer getAnchorBindingSiteId() {
		return this.anchorBindingSiteId;
	}

	public void setAnchorBindingSiteId(Integer anchorBindingSiteId) {
		this.anchorBindingSiteId = anchorBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnchorBindingSiteId))
			return false;
		AnchorBindingSiteId castOther = (AnchorBindingSiteId) other;

		return ((this.getAnchorBindingSiteId() == castOther
				.getAnchorBindingSiteId()) || (this.getAnchorBindingSiteId() != null
				&& castOther.getAnchorBindingSiteId() != null && this
				.getAnchorBindingSiteId().equals(
						castOther.getAnchorBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAnchorBindingSiteId() == null ? 0 : this
						.getAnchorBindingSiteId().hashCode());
		result = 37 * result
