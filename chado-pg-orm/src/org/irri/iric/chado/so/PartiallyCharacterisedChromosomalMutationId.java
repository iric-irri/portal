...
/**
 * PartiallyCharacterisedChromosomalMutationId generated by hbm2java
 */
public class PartiallyCharacterisedChromosomalMutationId implements
		java.io.Serializable {

	private Integer partiallyCharacterisedChromosomalMutationId;
	...
	public PartiallyCharacterisedChromosomalMutationId() {
	}

	public PartiallyCharacterisedChromosomalMutationId(
			Integer partiallyCharacterisedChromosomalMutationId,
		...
		this.partiallyCharacterisedChromosomalMutationId = partiallyCharacterisedChromosomalMutationId;
	...
	public Integer getPartiallyCharacterisedChromosomalMutationId() {
		return this.partiallyCharacterisedChromosomalMutationId;
	}

	public void setPartiallyCharacterisedChromosomalMutationId(
			Integer partiallyCharacterisedChromosomalMutationId) {
		this.partiallyCharacterisedChromosomalMutationId = partiallyCharacterisedChromosomalMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PartiallyCharacterisedChromosomalMutationId))
			return false;
		PartiallyCharacterisedChromosomalMutationId castOther = (PartiallyCharacterisedChromosomalMutationId) other;

		return ((this.getPartiallyCharacterisedChromosomalMutationId() == castOther
				.getPartiallyCharacterisedChromosomalMutationId()) || (this
				.getPartiallyCharacterisedChromosomalMutationId() != null
				&& castOther.getPartiallyCharacterisedChromosomalMutationId() != null && this
				.getPartiallyCharacterisedChromosomalMutationId()
				.equals(castOther
						.getPartiallyCharacterisedChromosomalMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPartiallyCharacterisedChromosomalMutationId() == null ? 0
						: this.getPartiallyCharacterisedChromosomalMutationId()
								.hashCode());
		result = 37 * result
