...
/**
 * RescueId generated by hbm2java
 */
public class RescueId implements java.io.Serializable {
	...
	public RescueId(Integer rescueId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RescueId))
			return false;
		RescueId castOther = (RescueId) other;

		return ((this.getRescueId() == castOther.getRescueId()) || (this
				.getRescueId() != null && castOther.getRescueId() != null && this
				.getRescueId().equals(castOther.getRescueId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRescueId() == null ? 0 : this.getRescueId().hashCode());
		result = 37 * result
