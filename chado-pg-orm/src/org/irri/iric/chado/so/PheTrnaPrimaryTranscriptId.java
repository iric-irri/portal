...
/**
 * PheTrnaPrimaryTranscriptId generated by hbm2java
 */
public class PheTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer pheTrnaPrimaryTranscriptId;
	...
	public PheTrnaPrimaryTranscriptId() {
	}

	public PheTrnaPrimaryTranscriptId(Integer pheTrnaPrimaryTranscriptId,
		...
		this.pheTrnaPrimaryTranscriptId = pheTrnaPrimaryTranscriptId;
	...
	public Integer getPheTrnaPrimaryTranscriptId() {
		return this.pheTrnaPrimaryTranscriptId;
	}

	public void setPheTrnaPrimaryTranscriptId(Integer pheTrnaPrimaryTranscriptId) {
		this.pheTrnaPrimaryTranscriptId = pheTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PheTrnaPrimaryTranscriptId))
			return false;
		PheTrnaPrimaryTranscriptId castOther = (PheTrnaPrimaryTranscriptId) other;

		return ((this.getPheTrnaPrimaryTranscriptId() == castOther
				.getPheTrnaPrimaryTranscriptId()) || (this
				.getPheTrnaPrimaryTranscriptId() != null
				&& castOther.getPheTrnaPrimaryTranscriptId() != null && this
				.getPheTrnaPrimaryTranscriptId().equals(
						castOther.getPheTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPheTrnaPrimaryTranscriptId() == null ? 0 : this
						.getPheTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
