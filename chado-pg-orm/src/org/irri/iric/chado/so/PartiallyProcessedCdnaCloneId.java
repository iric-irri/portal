...
/**
 * PartiallyProcessedCdnaCloneId generated by hbm2java
 */
public class PartiallyProcessedCdnaCloneId implements java.io.Serializable {

	private Integer partiallyProcessedCdnaCloneId;
	...
	public PartiallyProcessedCdnaCloneId() {
	}

	public PartiallyProcessedCdnaCloneId(Integer partiallyProcessedCdnaCloneId,
		...
		this.partiallyProcessedCdnaCloneId = partiallyProcessedCdnaCloneId;
	...
	public Integer getPartiallyProcessedCdnaCloneId() {
		return this.partiallyProcessedCdnaCloneId;
	}

	public void setPartiallyProcessedCdnaCloneId(
			Integer partiallyProcessedCdnaCloneId) {
		this.partiallyProcessedCdnaCloneId = partiallyProcessedCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PartiallyProcessedCdnaCloneId))
			return false;
		PartiallyProcessedCdnaCloneId castOther = (PartiallyProcessedCdnaCloneId) other;

		return ((this.getPartiallyProcessedCdnaCloneId() == castOther
				.getPartiallyProcessedCdnaCloneId()) || (this
				.getPartiallyProcessedCdnaCloneId() != null
				&& castOther.getPartiallyProcessedCdnaCloneId() != null && this
				.getPartiallyProcessedCdnaCloneId().equals(
						castOther.getPartiallyProcessedCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPartiallyProcessedCdnaCloneId() == null ? 0 : this
						.getPartiallyProcessedCdnaCloneId().hashCode());
		result = 37 * result
