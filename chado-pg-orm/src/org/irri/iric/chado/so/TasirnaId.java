...
/**
 * TasirnaId generated by hbm2java
 */
public class TasirnaId implements java.io.Serializable {

	private Integer tasirnaId;
	...
	public TasirnaId(Integer tasirnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTasirnaId() {
		return this.tasirnaId;
	}

	public void setTasirnaId(Integer tasirnaId) {
		this.tasirnaId = tasirnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TasirnaId))
			return false;
		TasirnaId castOther = (TasirnaId) other;

		return ((this.getTasirnaId() == castOther.getTasirnaId()) || (this
				.getTasirnaId() != null && castOther.getTasirnaId() != null && this
				.getTasirnaId().equals(castOther.getTasirnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTasirnaId() == null ? 0 : this.getTasirnaId().hashCode());
		result = 37 * result
