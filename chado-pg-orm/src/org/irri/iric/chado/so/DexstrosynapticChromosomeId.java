...
/**
 * DexstrosynapticChromosomeId generated by hbm2java
 */
public class DexstrosynapticChromosomeId implements java.io.Serializable {

	private Integer dexstrosynapticChromosomeId;
	...
	public DexstrosynapticChromosomeId() {
	}

	public DexstrosynapticChromosomeId(Integer dexstrosynapticChromosomeId,
		...
		this.dexstrosynapticChromosomeId = dexstrosynapticChromosomeId;
	...
	public Integer getDexstrosynapticChromosomeId() {
		return this.dexstrosynapticChromosomeId;
	}

	public void setDexstrosynapticChromosomeId(
			Integer dexstrosynapticChromosomeId) {
		this.dexstrosynapticChromosomeId = dexstrosynapticChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DexstrosynapticChromosomeId))
			return false;
		DexstrosynapticChromosomeId castOther = (DexstrosynapticChromosomeId) other;

		return ((this.getDexstrosynapticChromosomeId() == castOther
				.getDexstrosynapticChromosomeId()) || (this
				.getDexstrosynapticChromosomeId() != null
				&& castOther.getDexstrosynapticChromosomeId() != null && this
				.getDexstrosynapticChromosomeId().equals(
						castOther.getDexstrosynapticChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDexstrosynapticChromosomeId() == null ? 0 : this
						.getDexstrosynapticChromosomeId().hashCode());
		result = 37 * result
