...
/**
 * U3FivePrimeLtrRegionId generated by hbm2java
 */
public class U3FivePrimeLtrRegionId implements java.io.Serializable {

	private Integer u3FivePrimeLtrRegionId;
	...
	public U3FivePrimeLtrRegionId() {
	}

	public U3FivePrimeLtrRegionId(Integer u3FivePrimeLtrRegionId,
		...
		this.u3FivePrimeLtrRegionId = u3FivePrimeLtrRegionId;
	...
	public Integer getU3FivePrimeLtrRegionId() {
		return this.u3FivePrimeLtrRegionId;
	}

	public void setU3FivePrimeLtrRegionId(Integer u3FivePrimeLtrRegionId) {
		this.u3FivePrimeLtrRegionId = u3FivePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U3FivePrimeLtrRegionId))
			return false;
		U3FivePrimeLtrRegionId castOther = (U3FivePrimeLtrRegionId) other;

		return ((this.getU3FivePrimeLtrRegionId() == castOther
				.getU3FivePrimeLtrRegionId()) || (this
				.getU3FivePrimeLtrRegionId() != null
				&& castOther.getU3FivePrimeLtrRegionId() != null && this
				.getU3FivePrimeLtrRegionId().equals(
						castOther.getU3FivePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU3FivePrimeLtrRegionId() == null ? 0 : this
						.getU3FivePrimeLtrRegionId().hashCode());
		result = 37 * result
