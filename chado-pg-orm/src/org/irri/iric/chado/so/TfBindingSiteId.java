...
/**
 * TfBindingSiteId generated by hbm2java
 */
public class TfBindingSiteId implements java.io.Serializable {

	private Integer tfBindingSiteId;
	...
	public TfBindingSiteId() {
	}

	public TfBindingSiteId(Integer tfBindingSiteId, Integer featureId,
		...
		this.tfBindingSiteId = tfBindingSiteId;
	...
	public Integer getTfBindingSiteId() {
		return this.tfBindingSiteId;
	}

	public void setTfBindingSiteId(Integer tfBindingSiteId) {
		this.tfBindingSiteId = tfBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TfBindingSiteId))
			return false;
		TfBindingSiteId castOther = (TfBindingSiteId) other;

		return ((this.getTfBindingSiteId() == castOther.getTfBindingSiteId()) || (this
				.getTfBindingSiteId() != null
				&& castOther.getTfBindingSiteId() != null && this
				.getTfBindingSiteId().equals(castOther.getTfBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTfBindingSiteId() == null ? 0 : this.getTfBindingSiteId()
						.hashCode());
		result = 37 * result
