...
/**
 * NucleomorphicSequenceId generated by hbm2java
 */
public class NucleomorphicSequenceId implements java.io.Serializable {

	private Integer nucleomorphicSequenceId;
	...
	public NucleomorphicSequenceId() {
	}

	public NucleomorphicSequenceId(Integer nucleomorphicSequenceId,
		...
		this.nucleomorphicSequenceId = nucleomorphicSequenceId;
	...
	public Integer getNucleomorphicSequenceId() {
		return this.nucleomorphicSequenceId;
	}

	public void setNucleomorphicSequenceId(Integer nucleomorphicSequenceId) {
		this.nucleomorphicSequenceId = nucleomorphicSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleomorphicSequenceId))
			return false;
		NucleomorphicSequenceId castOther = (NucleomorphicSequenceId) other;

		return ((this.getNucleomorphicSequenceId() == castOther
				.getNucleomorphicSequenceId()) || (this
				.getNucleomorphicSequenceId() != null
				&& castOther.getNucleomorphicSequenceId() != null && this
				.getNucleomorphicSequenceId().equals(
						castOther.getNucleomorphicSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleomorphicSequenceId() == null ? 0 : this
						.getNucleomorphicSequenceId().hashCode());
		result = 37 * result
