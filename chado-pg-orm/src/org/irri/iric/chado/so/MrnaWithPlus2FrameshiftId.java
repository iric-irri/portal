...
/**
 * MrnaWithPlus2FrameshiftId generated by hbm2java
 */
public class MrnaWithPlus2FrameshiftId implements java.io.Serializable {

	private Integer mrnaWithPlus2FrameshiftId;
	...
	public MrnaWithPlus2FrameshiftId() {
	}

	public MrnaWithPlus2FrameshiftId(Integer mrnaWithPlus2FrameshiftId,
		...
		this.mrnaWithPlus2FrameshiftId = mrnaWithPlus2FrameshiftId;
	...
	public Integer getMrnaWithPlus2FrameshiftId() {
		return this.mrnaWithPlus2FrameshiftId;
	}

	public void setMrnaWithPlus2FrameshiftId(Integer mrnaWithPlus2FrameshiftId) {
		this.mrnaWithPlus2FrameshiftId = mrnaWithPlus2FrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaWithPlus2FrameshiftId))
			return false;
		MrnaWithPlus2FrameshiftId castOther = (MrnaWithPlus2FrameshiftId) other;

		return ((this.getMrnaWithPlus2FrameshiftId() == castOther
				.getMrnaWithPlus2FrameshiftId()) || (this
				.getMrnaWithPlus2FrameshiftId() != null
				&& castOther.getMrnaWithPlus2FrameshiftId() != null && this
				.getMrnaWithPlus2FrameshiftId().equals(
						castOther.getMrnaWithPlus2FrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaWithPlus2FrameshiftId() == null ? 0 : this
						.getMrnaWithPlus2FrameshiftId().hashCode());
		result = 37 * result
