...
/**
 * RescueGeneId generated by hbm2java
 */
public class RescueGeneId implements java.io.Serializable {

	private Integer rescueGeneId;
	...
	public RescueGeneId(Integer rescueGeneId, Integer featureId,
		...
		this.rescueGeneId = rescueGeneId;
	...
	public Integer getRescueGeneId() {
		return this.rescueGeneId;
	}

	public void setRescueGeneId(Integer rescueGeneId) {
		this.rescueGeneId = rescueGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RescueGeneId))
			return false;
		RescueGeneId castOther = (RescueGeneId) other;

		return ((this.getRescueGeneId() == castOther.getRescueGeneId()) || (this
				.getRescueGeneId() != null
				&& castOther.getRescueGeneId() != null && this
				.getRescueGeneId().equals(castOther.getRescueGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRescueGeneId() == null ? 0 : this.getRescueGeneId()
						.hashCode());
		result = 37 * result
