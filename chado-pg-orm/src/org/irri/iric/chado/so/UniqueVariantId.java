...
/**
 * UniqueVariantId generated by hbm2java
 */
public class UniqueVariantId implements java.io.Serializable {

	private Integer uniqueVariantId;
	...
	public UniqueVariantId() {
	}

	public UniqueVariantId(Integer uniqueVariantId, Integer featureId,
		...
		this.uniqueVariantId = uniqueVariantId;
	...
	public Integer getUniqueVariantId() {
		return this.uniqueVariantId;
	}

	public void setUniqueVariantId(Integer uniqueVariantId) {
		this.uniqueVariantId = uniqueVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UniqueVariantId))
			return false;
		UniqueVariantId castOther = (UniqueVariantId) other;

		return ((this.getUniqueVariantId() == castOther.getUniqueVariantId()) || (this
				.getUniqueVariantId() != null
				&& castOther.getUniqueVariantId() != null && this
				.getUniqueVariantId().equals(castOther.getUniqueVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUniqueVariantId() == null ? 0 : this.getUniqueVariantId()
						.hashCode());
		result = 37 * result
