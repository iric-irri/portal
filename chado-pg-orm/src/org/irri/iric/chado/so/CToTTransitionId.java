...
/**
 * CToTTransitionId generated by hbm2java
 */
public class CToTTransitionId implements java.io.Serializable {

	private Integer CToTTransitionId;
	...
	public CToTTransitionId() {
	}

	public CToTTransitionId(Integer CToTTransitionId, Integer featureId,
		...
		this.CToTTransitionId = CToTTransitionId;
	...
	public Integer getCToTTransitionId() {
		return this.CToTTransitionId;
	}

	public void setCToTTransitionId(Integer CToTTransitionId) {
		this.CToTTransitionId = CToTTransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CToTTransitionId))
			return false;
		CToTTransitionId castOther = (CToTTransitionId) other;

		return ((this.getCToTTransitionId() == castOther.getCToTTransitionId()) || (this
				.getCToTTransitionId() != null
				&& castOther.getCToTTransitionId() != null && this
				.getCToTTransitionId().equals(castOther.getCToTTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCToTTransitionId() == null ? 0 : this
						.getCToTTransitionId().hashCode());
		result = 37 * result
