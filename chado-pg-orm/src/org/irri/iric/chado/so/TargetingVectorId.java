...
/**
 * TargetingVectorId generated by hbm2java
 */
public class TargetingVectorId implements java.io.Serializable {

	private Integer targetingVectorId;
	...
	public TargetingVectorId() {
	}

	public TargetingVectorId(Integer targetingVectorId, Integer featureId,
		...
		this.targetingVectorId = targetingVectorId;
	...
	public Integer getTargetingVectorId() {
		return this.targetingVectorId;
	}

	public void setTargetingVectorId(Integer targetingVectorId) {
		this.targetingVectorId = targetingVectorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TargetingVectorId))
			return false;
		TargetingVectorId castOther = (TargetingVectorId) other;

		return ((this.getTargetingVectorId() == castOther
				.getTargetingVectorId()) || (this.getTargetingVectorId() != null
				&& castOther.getTargetingVectorId() != null && this
				.getTargetingVectorId()
				.equals(castOther.getTargetingVectorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTargetingVectorId() == null ? 0 : this
						.getTargetingVectorId().hashCode());
		result = 37 * result
