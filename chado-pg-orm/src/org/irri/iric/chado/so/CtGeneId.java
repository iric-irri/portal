...
/**
 * CtGeneId generated by hbm2java
 */
public class CtGeneId implements java.io.Serializable {

	private Integer ctGeneId;
	...
	public CtGeneId(Integer ctGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCtGeneId() {
		return this.ctGeneId;
	}

	public void setCtGeneId(Integer ctGeneId) {
		this.ctGeneId = ctGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CtGeneId))
			return false;
		CtGeneId castOther = (CtGeneId) other;

		return ((this.getCtGeneId() == castOther.getCtGeneId()) || (this
				.getCtGeneId() != null && castOther.getCtGeneId() != null && this
				.getCtGeneId().equals(castOther.getCtGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCtGeneId() == null ? 0 : this.getCtGeneId().hashCode());
		result = 37 * result
