...
/**
 * EngineeredRegionId generated by hbm2java
 */
public class EngineeredRegionId implements java.io.Serializable {

	private Integer engineeredRegionId;
	...
	public EngineeredRegionId() {
	}

	public EngineeredRegionId(Integer engineeredRegionId, Integer featureId,
		...
		this.engineeredRegionId = engineeredRegionId;
	...
	public Integer getEngineeredRegionId() {
		return this.engineeredRegionId;
	}

	public void setEngineeredRegionId(Integer engineeredRegionId) {
		this.engineeredRegionId = engineeredRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredRegionId))
			return false;
		EngineeredRegionId castOther = (EngineeredRegionId) other;

		return ((this.getEngineeredRegionId() == castOther
				.getEngineeredRegionId()) || (this.getEngineeredRegionId() != null
				&& castOther.getEngineeredRegionId() != null && this
				.getEngineeredRegionId().equals(
						castOther.getEngineeredRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredRegionId() == null ? 0 : this
						.getEngineeredRegionId().hashCode());
		result = 37 * result
