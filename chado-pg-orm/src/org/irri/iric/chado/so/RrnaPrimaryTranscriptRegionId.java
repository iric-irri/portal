...
/**
 * RrnaPrimaryTranscriptRegionId generated by hbm2java
 */
public class RrnaPrimaryTranscriptRegionId implements java.io.Serializable {

	private Integer rrnaPrimaryTranscriptRegionId;
	...
	public RrnaPrimaryTranscriptRegionId() {
	}

	public RrnaPrimaryTranscriptRegionId(Integer rrnaPrimaryTranscriptRegionId,
		...
		this.rrnaPrimaryTranscriptRegionId = rrnaPrimaryTranscriptRegionId;
	...
	public Integer getRrnaPrimaryTranscriptRegionId() {
		return this.rrnaPrimaryTranscriptRegionId;
	}

	public void setRrnaPrimaryTranscriptRegionId(
			Integer rrnaPrimaryTranscriptRegionId) {
		this.rrnaPrimaryTranscriptRegionId = rrnaPrimaryTranscriptRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaPrimaryTranscriptRegionId))
			return false;
		RrnaPrimaryTranscriptRegionId castOther = (RrnaPrimaryTranscriptRegionId) other;

		return ((this.getRrnaPrimaryTranscriptRegionId() == castOther
				.getRrnaPrimaryTranscriptRegionId()) || (this
				.getRrnaPrimaryTranscriptRegionId() != null
				&& castOther.getRrnaPrimaryTranscriptRegionId() != null && this
				.getRrnaPrimaryTranscriptRegionId().equals(
						castOther.getRrnaPrimaryTranscriptRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaPrimaryTranscriptRegionId() == null ? 0 : this
						.getRrnaPrimaryTranscriptRegionId().hashCode());
		result = 37 * result
