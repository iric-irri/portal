...
/**
 * ChromosomeFissionId generated by hbm2java
 */
public class ChromosomeFissionId implements java.io.Serializable {

	private Integer chromosomeFissionId;
	...
	public ChromosomeFissionId() {
	}

	public ChromosomeFissionId(Integer chromosomeFissionId, Integer featureId,
		...
		this.chromosomeFissionId = chromosomeFissionId;
	...
	public Integer getChromosomeFissionId() {
		return this.chromosomeFissionId;
	}

	public void setChromosomeFissionId(Integer chromosomeFissionId) {
		this.chromosomeFissionId = chromosomeFissionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeFissionId))
			return false;
		ChromosomeFissionId castOther = (ChromosomeFissionId) other;

		return ((this.getChromosomeFissionId() == castOther
				.getChromosomeFissionId()) || (this.getChromosomeFissionId() != null
				&& castOther.getChromosomeFissionId() != null && this
				.getChromosomeFissionId().equals(
						castOther.getChromosomeFissionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeFissionId() == null ? 0 : this
						.getChromosomeFissionId().hashCode());
		result = 37 * result
