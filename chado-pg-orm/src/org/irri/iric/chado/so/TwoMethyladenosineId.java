...
/**
 * TwoMethyladenosineId generated by hbm2java
 */
public class TwoMethyladenosineId implements java.io.Serializable {

	private Integer twoMethyladenosineId;
	...
	public TwoMethyladenosineId() {
	}

	public TwoMethyladenosineId(Integer twoMethyladenosineId,
		...
		this.twoMethyladenosineId = twoMethyladenosineId;
	...
	public Integer getTwoMethyladenosineId() {
		return this.twoMethyladenosineId;
	}

	public void setTwoMethyladenosineId(Integer twoMethyladenosineId) {
		this.twoMethyladenosineId = twoMethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethyladenosineId))
			return false;
		TwoMethyladenosineId castOther = (TwoMethyladenosineId) other;

		return ((this.getTwoMethyladenosineId() == castOther
				.getTwoMethyladenosineId()) || (this.getTwoMethyladenosineId() != null
				&& castOther.getTwoMethyladenosineId() != null && this
				.getTwoMethyladenosineId().equals(
						castOther.getTwoMethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethyladenosineId() == null ? 0 : this
						.getTwoMethyladenosineId().hashCode());
		result = 37 * result
