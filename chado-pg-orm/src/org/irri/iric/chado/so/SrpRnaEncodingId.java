...
/**
 * SrpRnaEncodingId generated by hbm2java
 */
public class SrpRnaEncodingId implements java.io.Serializable {

	private Integer srpRnaEncodingId;
	...
	public SrpRnaEncodingId() {
	}

	public SrpRnaEncodingId(Integer srpRnaEncodingId, Integer featureId,
		...
		this.srpRnaEncodingId = srpRnaEncodingId;
	...
	public Integer getSrpRnaEncodingId() {
		return this.srpRnaEncodingId;
	}

	public void setSrpRnaEncodingId(Integer srpRnaEncodingId) {
		this.srpRnaEncodingId = srpRnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SrpRnaEncodingId))
			return false;
		SrpRnaEncodingId castOther = (SrpRnaEncodingId) other;

		return ((this.getSrpRnaEncodingId() == castOther.getSrpRnaEncodingId()) || (this
				.getSrpRnaEncodingId() != null
				&& castOther.getSrpRnaEncodingId() != null && this
				.getSrpRnaEncodingId().equals(castOther.getSrpRnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSrpRnaEncodingId() == null ? 0 : this
						.getSrpRnaEncodingId().hashCode());
		result = 37 * result
