...
/**
 * Sl2AcceptorSiteId generated by hbm2java
 */
public class Sl2AcceptorSiteId implements java.io.Serializable {

	private Integer sl2AcceptorSiteId;
	...
	public Sl2AcceptorSiteId() {
	}

	public Sl2AcceptorSiteId(Integer sl2AcceptorSiteId, Integer featureId,
		...
		this.sl2AcceptorSiteId = sl2AcceptorSiteId;
	...
	public Integer getSl2AcceptorSiteId() {
		return this.sl2AcceptorSiteId;
	}

	public void setSl2AcceptorSiteId(Integer sl2AcceptorSiteId) {
		this.sl2AcceptorSiteId = sl2AcceptorSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sl2AcceptorSiteId))
			return false;
		Sl2AcceptorSiteId castOther = (Sl2AcceptorSiteId) other;

		return ((this.getSl2AcceptorSiteId() == castOther
				.getSl2AcceptorSiteId()) || (this.getSl2AcceptorSiteId() != null
				&& castOther.getSl2AcceptorSiteId() != null && this
				.getSl2AcceptorSiteId()
				.equals(castOther.getSl2AcceptorSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSl2AcceptorSiteId() == null ? 0 : this
						.getSl2AcceptorSiteId().hashCode());
		result = 37 * result
