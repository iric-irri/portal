...
/**
 * GrnaEncodingId generated by hbm2java
 */
public class GrnaEncodingId implements java.io.Serializable {

	private Integer grnaEncodingId;
	...
	public GrnaEncodingId() {
	}

	public GrnaEncodingId(Integer grnaEncodingId, Integer featureId,
		...
		this.grnaEncodingId = grnaEncodingId;
	...
	public Integer getGrnaEncodingId() {
		return this.grnaEncodingId;
	}

	public void setGrnaEncodingId(Integer grnaEncodingId) {
		this.grnaEncodingId = grnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GrnaEncodingId))
			return false;
		GrnaEncodingId castOther = (GrnaEncodingId) other;

		return ((this.getGrnaEncodingId() == castOther.getGrnaEncodingId()) || (this
				.getGrnaEncodingId() != null
				&& castOther.getGrnaEncodingId() != null && this
				.getGrnaEncodingId().equals(castOther.getGrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGrnaEncodingId() == null ? 0 : this.getGrnaEncodingId()
						.hashCode());
		result = 37 * result
