...
/**
 * LongTerminalRepeatId generated by hbm2java
 */
public class LongTerminalRepeatId implements java.io.Serializable {

	private Integer longTerminalRepeatId;
	...
	public LongTerminalRepeatId() {
	}

	public LongTerminalRepeatId(Integer longTerminalRepeatId,
		...
		this.longTerminalRepeatId = longTerminalRepeatId;
	...
	public Integer getLongTerminalRepeatId() {
		return this.longTerminalRepeatId;
	}

	public void setLongTerminalRepeatId(Integer longTerminalRepeatId) {
		this.longTerminalRepeatId = longTerminalRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LongTerminalRepeatId))
			return false;
		LongTerminalRepeatId castOther = (LongTerminalRepeatId) other;

		return ((this.getLongTerminalRepeatId() == castOther
				.getLongTerminalRepeatId()) || (this.getLongTerminalRepeatId() != null
				&& castOther.getLongTerminalRepeatId() != null && this
				.getLongTerminalRepeatId().equals(
						castOther.getLongTerminalRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLongTerminalRepeatId() == null ? 0 : this
						.getLongTerminalRepeatId().hashCode());
		result = 37 * result
