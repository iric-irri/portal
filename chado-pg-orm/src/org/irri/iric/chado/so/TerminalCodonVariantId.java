...
/**
 * TerminalCodonVariantId generated by hbm2java
 */
public class TerminalCodonVariantId implements java.io.Serializable {

	private Integer terminalCodonVariantId;
	...
	public TerminalCodonVariantId() {
	}

	public TerminalCodonVariantId(Integer terminalCodonVariantId,
		...
		this.terminalCodonVariantId = terminalCodonVariantId;
	...
	public Integer getTerminalCodonVariantId() {
		return this.terminalCodonVariantId;
	}

	public void setTerminalCodonVariantId(Integer terminalCodonVariantId) {
		this.terminalCodonVariantId = terminalCodonVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminalCodonVariantId))
			return false;
		TerminalCodonVariantId castOther = (TerminalCodonVariantId) other;

		return ((this.getTerminalCodonVariantId() == castOther
				.getTerminalCodonVariantId()) || (this
				.getTerminalCodonVariantId() != null
				&& castOther.getTerminalCodonVariantId() != null && this
				.getTerminalCodonVariantId().equals(
						castOther.getTerminalCodonVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTerminalCodonVariantId() == null ? 0 : this
						.getTerminalCodonVariantId().hashCode());
		result = 37 * result
