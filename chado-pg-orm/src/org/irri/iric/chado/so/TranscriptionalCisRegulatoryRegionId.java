...
/**
 * TranscriptionalCisRegulatoryRegionId generated by hbm2java
 */
public class TranscriptionalCisRegulatoryRegionId implements
		java.io.Serializable {

	private Integer transcriptionalCisRegulatoryRegionId;
	...
	public TranscriptionalCisRegulatoryRegionId() {
	}

	public TranscriptionalCisRegulatoryRegionId(
			Integer transcriptionalCisRegulatoryRegionId, Integer featureId,
		...
		this.transcriptionalCisRegulatoryRegionId = transcriptionalCisRegulatoryRegionId;
	...
	public Integer getTranscriptionalCisRegulatoryRegionId() {
		return this.transcriptionalCisRegulatoryRegionId;
	}

	public void setTranscriptionalCisRegulatoryRegionId(
			Integer transcriptionalCisRegulatoryRegionId) {
		this.transcriptionalCisRegulatoryRegionId = transcriptionalCisRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionalCisRegulatoryRegionId))
			return false;
		TranscriptionalCisRegulatoryRegionId castOther = (TranscriptionalCisRegulatoryRegionId) other;

		return ((this.getTranscriptionalCisRegulatoryRegionId() == castOther
				.getTranscriptionalCisRegulatoryRegionId()) || (this
				.getTranscriptionalCisRegulatoryRegionId() != null
				&& castOther.getTranscriptionalCisRegulatoryRegionId() != null && this
				.getTranscriptionalCisRegulatoryRegionId().equals(
						castOther.getTranscriptionalCisRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionalCisRegulatoryRegionId() == null ? 0 : this
						.getTranscriptionalCisRegulatoryRegionId().hashCode());
		result = 37 * result
