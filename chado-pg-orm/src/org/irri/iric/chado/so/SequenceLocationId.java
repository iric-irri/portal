...
/**
 * SequenceLocationId generated by hbm2java
 */
public class SequenceLocationId implements java.io.Serializable {

	private Integer sequenceLocationId;
	...
	public SequenceLocationId() {
	}

	public SequenceLocationId(Integer sequenceLocationId, Integer featureId,
		...
		this.sequenceLocationId = sequenceLocationId;
	...
	public Integer getSequenceLocationId() {
		return this.sequenceLocationId;
	}

	public void setSequenceLocationId(Integer sequenceLocationId) {
		this.sequenceLocationId = sequenceLocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceLocationId))
			return false;
		SequenceLocationId castOther = (SequenceLocationId) other;

		return ((this.getSequenceLocationId() == castOther
				.getSequenceLocationId()) || (this.getSequenceLocationId() != null
				&& castOther.getSequenceLocationId() != null && this
				.getSequenceLocationId().equals(
						castOther.getSequenceLocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceLocationId() == null ? 0 : this
						.getSequenceLocationId().hashCode());
		result = 37 * result
