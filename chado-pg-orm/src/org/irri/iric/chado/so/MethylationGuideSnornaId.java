...
/**
 * MethylationGuideSnornaId generated by hbm2java
 */
public class MethylationGuideSnornaId implements java.io.Serializable {

	private Integer methylationGuideSnornaId;
	...
	public MethylationGuideSnornaId() {
	}

	public MethylationGuideSnornaId(Integer methylationGuideSnornaId,
		...
		this.methylationGuideSnornaId = methylationGuideSnornaId;
	...
	public Integer getMethylationGuideSnornaId() {
		return this.methylationGuideSnornaId;
	}

	public void setMethylationGuideSnornaId(Integer methylationGuideSnornaId) {
		this.methylationGuideSnornaId = methylationGuideSnornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylationGuideSnornaId))
			return false;
		MethylationGuideSnornaId castOther = (MethylationGuideSnornaId) other;

		return ((this.getMethylationGuideSnornaId() == castOther
				.getMethylationGuideSnornaId()) || (this
				.getMethylationGuideSnornaId() != null
				&& castOther.getMethylationGuideSnornaId() != null && this
				.getMethylationGuideSnornaId().equals(
						castOther.getMethylationGuideSnornaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylationGuideSnornaId() == null ? 0 : this
						.getMethylationGuideSnornaId().hashCode());
		result = 37 * result
