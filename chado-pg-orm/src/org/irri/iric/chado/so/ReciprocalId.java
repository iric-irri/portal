...
/**
 * ReciprocalId generated by hbm2java
 */
public class ReciprocalId implements java.io.Serializable {

	private Integer reciprocalId;
	...
	public ReciprocalId(Integer reciprocalId, Integer featureId,
		...
		this.reciprocalId = reciprocalId;
	...
	public Integer getReciprocalId() {
		return this.reciprocalId;
	}

	public void setReciprocalId(Integer reciprocalId) {
		this.reciprocalId = reciprocalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReciprocalId))
			return false;
		ReciprocalId castOther = (ReciprocalId) other;

		return ((this.getReciprocalId() == castOther.getReciprocalId()) || (this
				.getReciprocalId() != null
				&& castOther.getReciprocalId() != null && this
				.getReciprocalId().equals(castOther.getReciprocalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReciprocalId() == null ? 0 : this.getReciprocalId()
						.hashCode());
		result = 37 * result
