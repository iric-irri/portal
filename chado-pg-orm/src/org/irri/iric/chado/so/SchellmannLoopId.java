...
/**
 * SchellmannLoopId generated by hbm2java
 */
public class SchellmannLoopId implements java.io.Serializable {

	private Integer schellmannLoopId;
	...
	public SchellmannLoopId() {
	}

	public SchellmannLoopId(Integer schellmannLoopId, Integer featureId,
		...
		this.schellmannLoopId = schellmannLoopId;
	...
	public Integer getSchellmannLoopId() {
		return this.schellmannLoopId;
	}

	public void setSchellmannLoopId(Integer schellmannLoopId) {
		this.schellmannLoopId = schellmannLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SchellmannLoopId))
			return false;
		SchellmannLoopId castOther = (SchellmannLoopId) other;

		return ((this.getSchellmannLoopId() == castOther.getSchellmannLoopId()) || (this
				.getSchellmannLoopId() != null
				&& castOther.getSchellmannLoopId() != null && this
				.getSchellmannLoopId().equals(castOther.getSchellmannLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSchellmannLoopId() == null ? 0 : this
						.getSchellmannLoopId().hashCode());
		result = 37 * result
