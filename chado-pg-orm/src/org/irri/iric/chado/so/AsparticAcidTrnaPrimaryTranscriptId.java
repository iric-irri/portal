...
/**
 * AsparticAcidTrnaPrimaryTranscriptId generated by hbm2java
 */
public class AsparticAcidTrnaPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer asparticAcidTrnaPrimaryTranscriptId;
	...
	public AsparticAcidTrnaPrimaryTranscriptId() {
	}

	public AsparticAcidTrnaPrimaryTranscriptId(
			Integer asparticAcidTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.asparticAcidTrnaPrimaryTranscriptId = asparticAcidTrnaPrimaryTranscriptId;
	...
	public Integer getAsparticAcidTrnaPrimaryTranscriptId() {
		return this.asparticAcidTrnaPrimaryTranscriptId;
	}

	public void setAsparticAcidTrnaPrimaryTranscriptId(
			Integer asparticAcidTrnaPrimaryTranscriptId) {
		this.asparticAcidTrnaPrimaryTranscriptId = asparticAcidTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsparticAcidTrnaPrimaryTranscriptId))
			return false;
		AsparticAcidTrnaPrimaryTranscriptId castOther = (AsparticAcidTrnaPrimaryTranscriptId) other;

		return ((this.getAsparticAcidTrnaPrimaryTranscriptId() == castOther
				.getAsparticAcidTrnaPrimaryTranscriptId()) || (this
				.getAsparticAcidTrnaPrimaryTranscriptId() != null
				&& castOther.getAsparticAcidTrnaPrimaryTranscriptId() != null && this
				.getAsparticAcidTrnaPrimaryTranscriptId().equals(
						castOther.getAsparticAcidTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsparticAcidTrnaPrimaryTranscriptId() == null ? 0 : this
						.getAsparticAcidTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
