...
/**
 * DicistronicId generated by hbm2java
 */
public class DicistronicId implements java.io.Serializable {

	private Integer dicistronicId;
	...
	public DicistronicId() {
	}

	public DicistronicId(Integer dicistronicId, Integer featureId,
		...
		this.dicistronicId = dicistronicId;
	...
	public Integer getDicistronicId() {
		return this.dicistronicId;
	}

	public void setDicistronicId(Integer dicistronicId) {
		this.dicistronicId = dicistronicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DicistronicId))
			return false;
		DicistronicId castOther = (DicistronicId) other;

		return ((this.getDicistronicId() == castOther.getDicistronicId()) || (this
				.getDicistronicId() != null
				&& castOther.getDicistronicId() != null && this
				.getDicistronicId().equals(castOther.getDicistronicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDicistronicId() == null ? 0 : this.getDicistronicId()
						.hashCode());
		result = 37 * result
