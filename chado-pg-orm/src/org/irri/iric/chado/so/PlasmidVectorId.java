...
/**
 * PlasmidVectorId generated by hbm2java
 */
public class PlasmidVectorId implements java.io.Serializable {

	private Integer plasmidVectorId;
	...
	public PlasmidVectorId() {
	}

	public PlasmidVectorId(Integer plasmidVectorId, Integer featureId,
		...
		this.plasmidVectorId = plasmidVectorId;
	...
	public Integer getPlasmidVectorId() {
		return this.plasmidVectorId;
	}

	public void setPlasmidVectorId(Integer plasmidVectorId) {
		this.plasmidVectorId = plasmidVectorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlasmidVectorId))
			return false;
		PlasmidVectorId castOther = (PlasmidVectorId) other;

		return ((this.getPlasmidVectorId() == castOther.getPlasmidVectorId()) || (this
				.getPlasmidVectorId() != null
				&& castOther.getPlasmidVectorId() != null && this
				.getPlasmidVectorId().equals(castOther.getPlasmidVectorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlasmidVectorId() == null ? 0 : this.getPlasmidVectorId()
						.hashCode());
		result = 37 * result
