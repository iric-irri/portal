...
/**
 * NuclearGeneId generated by hbm2java
 */
public class NuclearGeneId implements java.io.Serializable {

	private Integer nuclearGeneId;
	...
	public NuclearGeneId() {
	}

	public NuclearGeneId(Integer nuclearGeneId, Integer featureId,
		...
		this.nuclearGeneId = nuclearGeneId;
	...
	public Integer getNuclearGeneId() {
		return this.nuclearGeneId;
	}

	public void setNuclearGeneId(Integer nuclearGeneId) {
		this.nuclearGeneId = nuclearGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearGeneId))
			return false;
		NuclearGeneId castOther = (NuclearGeneId) other;

		return ((this.getNuclearGeneId() == castOther.getNuclearGeneId()) || (this
				.getNuclearGeneId() != null
				&& castOther.getNuclearGeneId() != null && this
				.getNuclearGeneId().equals(castOther.getNuclearGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearGeneId() == null ? 0 : this.getNuclearGeneId()
						.hashCode());
		result = 37 * result
