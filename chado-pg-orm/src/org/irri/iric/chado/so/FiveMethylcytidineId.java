...
/**
 * FiveMethylcytidineId generated by hbm2java
 */
public class FiveMethylcytidineId implements java.io.Serializable {

	private Integer fiveMethylcytidineId;
	...
	public FiveMethylcytidineId() {
	}

	public FiveMethylcytidineId(Integer fiveMethylcytidineId,
		...
		this.fiveMethylcytidineId = fiveMethylcytidineId;
	...
	public Integer getFiveMethylcytidineId() {
		return this.fiveMethylcytidineId;
	}

	public void setFiveMethylcytidineId(Integer fiveMethylcytidineId) {
		this.fiveMethylcytidineId = fiveMethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethylcytidineId))
			return false;
		FiveMethylcytidineId castOther = (FiveMethylcytidineId) other;

		return ((this.getFiveMethylcytidineId() == castOther
				.getFiveMethylcytidineId()) || (this.getFiveMethylcytidineId() != null
				&& castOther.getFiveMethylcytidineId() != null && this
				.getFiveMethylcytidineId().equals(
						castOther.getFiveMethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethylcytidineId() == null ? 0 : this
						.getFiveMethylcytidineId().hashCode());
		result = 37 * result
