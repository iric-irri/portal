...
/**
 * PnaOligoId generated by hbm2java
 */
public class PnaOligoId implements java.io.Serializable {

	private Integer pnaOligoId;
	...
	public PnaOligoId(Integer pnaOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getPnaOligoId() {
		return this.pnaOligoId;
	}

	public void setPnaOligoId(Integer pnaOligoId) {
		this.pnaOligoId = pnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PnaOligoId))
			return false;
		PnaOligoId castOther = (PnaOligoId) other;

		return ((this.getPnaOligoId() == castOther.getPnaOligoId()) || (this
				.getPnaOligoId() != null && castOther.getPnaOligoId() != null && this
				.getPnaOligoId().equals(castOther.getPnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPnaOligoId() == null ? 0 : this.getPnaOligoId()
						.hashCode());
		result = 37 * result
