...
/**
 * TyrosylTrnaId generated by hbm2java
 */
public class TyrosylTrnaId implements java.io.Serializable {

	private Integer tyrosylTrnaId;
	...
	public TyrosylTrnaId() {
	}

	public TyrosylTrnaId(Integer tyrosylTrnaId, Integer featureId,
		...
		this.tyrosylTrnaId = tyrosylTrnaId;
	...
	public Integer getTyrosylTrnaId() {
		return this.tyrosylTrnaId;
	}

	public void setTyrosylTrnaId(Integer tyrosylTrnaId) {
		this.tyrosylTrnaId = tyrosylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TyrosylTrnaId))
			return false;
		TyrosylTrnaId castOther = (TyrosylTrnaId) other;

		return ((this.getTyrosylTrnaId() == castOther.getTyrosylTrnaId()) || (this
				.getTyrosylTrnaId() != null
				&& castOther.getTyrosylTrnaId() != null && this
				.getTyrosylTrnaId().equals(castOther.getTyrosylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTyrosylTrnaId() == null ? 0 : this.getTyrosylTrnaId()
						.hashCode());
		result = 37 * result
