...
/**
 * InteriorCodingExonId generated by hbm2java
 */
public class InteriorCodingExonId implements java.io.Serializable {

	private Integer interiorCodingExonId;
	...
	public InteriorCodingExonId() {
	}

	public InteriorCodingExonId(Integer interiorCodingExonId,
		...
		this.interiorCodingExonId = interiorCodingExonId;
	...
	public Integer getInteriorCodingExonId() {
		return this.interiorCodingExonId;
	}

	public void setInteriorCodingExonId(Integer interiorCodingExonId) {
		this.interiorCodingExonId = interiorCodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InteriorCodingExonId))
			return false;
		InteriorCodingExonId castOther = (InteriorCodingExonId) other;

		return ((this.getInteriorCodingExonId() == castOther
				.getInteriorCodingExonId()) || (this.getInteriorCodingExonId() != null
				&& castOther.getInteriorCodingExonId() != null && this
				.getInteriorCodingExonId().equals(
						castOther.getInteriorCodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInteriorCodingExonId() == null ? 0 : this
						.getInteriorCodingExonId().hashCode());
		result = 37 * result
