...
/**
 * CleavedInitiatorMethionineId generated by hbm2java
 */
public class CleavedInitiatorMethionineId implements java.io.Serializable {

	private Integer cleavedInitiatorMethionineId;
	...
	public CleavedInitiatorMethionineId() {
	}

	public CleavedInitiatorMethionineId(Integer cleavedInitiatorMethionineId,
		...
		this.cleavedInitiatorMethionineId = cleavedInitiatorMethionineId;
	...
	public Integer getCleavedInitiatorMethionineId() {
		return this.cleavedInitiatorMethionineId;
	}

	public void setCleavedInitiatorMethionineId(
			Integer cleavedInitiatorMethionineId) {
		this.cleavedInitiatorMethionineId = cleavedInitiatorMethionineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CleavedInitiatorMethionineId))
			return false;
		CleavedInitiatorMethionineId castOther = (CleavedInitiatorMethionineId) other;

		return ((this.getCleavedInitiatorMethionineId() == castOther
				.getCleavedInitiatorMethionineId()) || (this
				.getCleavedInitiatorMethionineId() != null
				&& castOther.getCleavedInitiatorMethionineId() != null && this
				.getCleavedInitiatorMethionineId().equals(
						castOther.getCleavedInitiatorMethionineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCleavedInitiatorMethionineId() == null ? 0 : this
						.getCleavedInitiatorMethionineId().hashCode());
		result = 37 * result
