...
/**
 * DoubleId generated by hbm2java
 */
public class DoubleId implements java.io.Serializable {
	...
	public DoubleId(Integer doubleId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DoubleId))
			return false;
		DoubleId castOther = (DoubleId) other;

		return ((this.getDoubleId() == castOther.getDoubleId()) || (this
				.getDoubleId() != null && castOther.getDoubleId() != null && this
				.getDoubleId().equals(castOther.getDoubleId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDoubleId() == null ? 0 : this.getDoubleId().hashCode());
		result = 37 * result
