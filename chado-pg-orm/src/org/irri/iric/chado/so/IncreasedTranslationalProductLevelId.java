...
/**
 * IncreasedTranslationalProductLevelId generated by hbm2java
 */
public class IncreasedTranslationalProductLevelId implements
		java.io.Serializable {

	private Integer increasedTranslationalProductLevelId;
	...
	public IncreasedTranslationalProductLevelId() {
	}

	public IncreasedTranslationalProductLevelId(
			Integer increasedTranslationalProductLevelId, Integer featureId,
		...
		this.increasedTranslationalProductLevelId = increasedTranslationalProductLevelId;
	...
	public Integer getIncreasedTranslationalProductLevelId() {
		return this.increasedTranslationalProductLevelId;
	}

	public void setIncreasedTranslationalProductLevelId(
			Integer increasedTranslationalProductLevelId) {
		this.increasedTranslationalProductLevelId = increasedTranslationalProductLevelId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IncreasedTranslationalProductLevelId))
			return false;
		IncreasedTranslationalProductLevelId castOther = (IncreasedTranslationalProductLevelId) other;

		return ((this.getIncreasedTranslationalProductLevelId() == castOther
				.getIncreasedTranslationalProductLevelId()) || (this
				.getIncreasedTranslationalProductLevelId() != null
				&& castOther.getIncreasedTranslationalProductLevelId() != null && this
				.getIncreasedTranslationalProductLevelId().equals(
						castOther.getIncreasedTranslationalProductLevelId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIncreasedTranslationalProductLevelId() == null ? 0 : this
						.getIncreasedTranslationalProductLevelId().hashCode());
		result = 37 * result
