...
/**
 * ImmaturePeptideRegionId generated by hbm2java
 */
public class ImmaturePeptideRegionId implements java.io.Serializable {

	private Integer immaturePeptideRegionId;
	...
	public ImmaturePeptideRegionId() {
	}

	public ImmaturePeptideRegionId(Integer immaturePeptideRegionId,
		...
		this.immaturePeptideRegionId = immaturePeptideRegionId;
	...
	public Integer getImmaturePeptideRegionId() {
		return this.immaturePeptideRegionId;
	}

	public void setImmaturePeptideRegionId(Integer immaturePeptideRegionId) {
		this.immaturePeptideRegionId = immaturePeptideRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ImmaturePeptideRegionId))
			return false;
		ImmaturePeptideRegionId castOther = (ImmaturePeptideRegionId) other;

		return ((this.getImmaturePeptideRegionId() == castOther
				.getImmaturePeptideRegionId()) || (this
				.getImmaturePeptideRegionId() != null
				&& castOther.getImmaturePeptideRegionId() != null && this
				.getImmaturePeptideRegionId().equals(
						castOther.getImmaturePeptideRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getImmaturePeptideRegionId() == null ? 0 : this
						.getImmaturePeptideRegionId().hashCode());
		result = 37 * result
