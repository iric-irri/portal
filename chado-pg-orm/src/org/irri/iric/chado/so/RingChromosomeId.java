...
/**
 * RingChromosomeId generated by hbm2java
 */
public class RingChromosomeId implements java.io.Serializable {

	private Integer ringChromosomeId;
	...
	public RingChromosomeId() {
	}

	public RingChromosomeId(Integer ringChromosomeId, Integer featureId,
		...
		this.ringChromosomeId = ringChromosomeId;
	...
	public Integer getRingChromosomeId() {
		return this.ringChromosomeId;
	}

	public void setRingChromosomeId(Integer ringChromosomeId) {
		this.ringChromosomeId = ringChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RingChromosomeId))
			return false;
		RingChromosomeId castOther = (RingChromosomeId) other;

		return ((this.getRingChromosomeId() == castOther.getRingChromosomeId()) || (this
				.getRingChromosomeId() != null
				&& castOther.getRingChromosomeId() != null && this
				.getRingChromosomeId().equals(castOther.getRingChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRingChromosomeId() == null ? 0 : this
						.getRingChromosomeId().hashCode());
		result = 37 * result
