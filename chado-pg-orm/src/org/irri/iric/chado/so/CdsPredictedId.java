...
/**
 * CdsPredictedId generated by hbm2java
 */
public class CdsPredictedId implements java.io.Serializable {

	private Integer cdsPredictedId;
	...
	public CdsPredictedId() {
	}

	public CdsPredictedId(Integer cdsPredictedId, Integer featureId,
		...
		this.cdsPredictedId = cdsPredictedId;
	...
	public Integer getCdsPredictedId() {
		return this.cdsPredictedId;
	}

	public void setCdsPredictedId(Integer cdsPredictedId) {
		this.cdsPredictedId = cdsPredictedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsPredictedId))
			return false;
		CdsPredictedId castOther = (CdsPredictedId) other;

		return ((this.getCdsPredictedId() == castOther.getCdsPredictedId()) || (this
				.getCdsPredictedId() != null
				&& castOther.getCdsPredictedId() != null && this
				.getCdsPredictedId().equals(castOther.getCdsPredictedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsPredictedId() == null ? 0 : this.getCdsPredictedId()
						.hashCode());
		result = 37 * result
