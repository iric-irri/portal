...
/**
 * AlphaHelixId generated by hbm2java
 */
public class AlphaHelixId implements java.io.Serializable {

	private Integer alphaHelixId;
	...
	public AlphaHelixId(Integer alphaHelixId, Integer featureId,
		...
		this.alphaHelixId = alphaHelixId;
	...
	public Integer getAlphaHelixId() {
		return this.alphaHelixId;
	}

	public void setAlphaHelixId(Integer alphaHelixId) {
		this.alphaHelixId = alphaHelixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlphaHelixId))
			return false;
		AlphaHelixId castOther = (AlphaHelixId) other;

		return ((this.getAlphaHelixId() == castOther.getAlphaHelixId()) || (this
				.getAlphaHelixId() != null
				&& castOther.getAlphaHelixId() != null && this
				.getAlphaHelixId().equals(castOther.getAlphaHelixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlphaHelixId() == null ? 0 : this.getAlphaHelixId()
						.hashCode());
		result = 37 * result
