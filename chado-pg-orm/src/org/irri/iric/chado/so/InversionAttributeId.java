...
/**
 * InversionAttributeId generated by hbm2java
 */
public class InversionAttributeId implements java.io.Serializable {

	private Integer inversionAttributeId;
	...
	public InversionAttributeId() {
	}

	public InversionAttributeId(Integer inversionAttributeId,
		...
		this.inversionAttributeId = inversionAttributeId;
	...
	public Integer getInversionAttributeId() {
		return this.inversionAttributeId;
	}

	public void setInversionAttributeId(Integer inversionAttributeId) {
		this.inversionAttributeId = inversionAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InversionAttributeId))
			return false;
		InversionAttributeId castOther = (InversionAttributeId) other;

		return ((this.getInversionAttributeId() == castOther
				.getInversionAttributeId()) || (this.getInversionAttributeId() != null
				&& castOther.getInversionAttributeId() != null && this
				.getInversionAttributeId().equals(
						castOther.getInversionAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInversionAttributeId() == null ? 0 : this
						.getInversionAttributeId().hashCode());
		result = 37 * result
