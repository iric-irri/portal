...
/**
 * BetaTurnTypeSixATwoId generated by hbm2java
 */
public class BetaTurnTypeSixATwoId implements java.io.Serializable {

	private Integer betaTurnTypeSixATwoId;
	...
	public BetaTurnTypeSixATwoId() {
	}

	public BetaTurnTypeSixATwoId(Integer betaTurnTypeSixATwoId,
		...
		this.betaTurnTypeSixATwoId = betaTurnTypeSixATwoId;
	...
	public Integer getBetaTurnTypeSixATwoId() {
		return this.betaTurnTypeSixATwoId;
	}

	public void setBetaTurnTypeSixATwoId(Integer betaTurnTypeSixATwoId) {
		this.betaTurnTypeSixATwoId = betaTurnTypeSixATwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeSixATwoId))
			return false;
		BetaTurnTypeSixATwoId castOther = (BetaTurnTypeSixATwoId) other;

		return ((this.getBetaTurnTypeSixATwoId() == castOther
				.getBetaTurnTypeSixATwoId()) || (this
				.getBetaTurnTypeSixATwoId() != null
				&& castOther.getBetaTurnTypeSixATwoId() != null && this
				.getBetaTurnTypeSixATwoId().equals(
						castOther.getBetaTurnTypeSixATwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeSixATwoId() == null ? 0 : this
						.getBetaTurnTypeSixATwoId().hashCode());
		result = 37 * result
