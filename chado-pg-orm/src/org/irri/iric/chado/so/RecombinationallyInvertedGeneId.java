...
/**
 * RecombinationallyInvertedGeneId generated by hbm2java
 */
public class RecombinationallyInvertedGeneId implements java.io.Serializable {

	private Integer recombinationallyInvertedGeneId;
	...
	public RecombinationallyInvertedGeneId() {
	}

	public RecombinationallyInvertedGeneId(
			Integer recombinationallyInvertedGeneId, Integer featureId,
		...
		this.recombinationallyInvertedGeneId = recombinationallyInvertedGeneId;
	...
	public Integer getRecombinationallyInvertedGeneId() {
		return this.recombinationallyInvertedGeneId;
	}

	public void setRecombinationallyInvertedGeneId(
			Integer recombinationallyInvertedGeneId) {
		this.recombinationallyInvertedGeneId = recombinationallyInvertedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationallyInvertedGeneId))
			return false;
		RecombinationallyInvertedGeneId castOther = (RecombinationallyInvertedGeneId) other;

		return ((this.getRecombinationallyInvertedGeneId() == castOther
				.getRecombinationallyInvertedGeneId()) || (this
				.getRecombinationallyInvertedGeneId() != null
				&& castOther.getRecombinationallyInvertedGeneId() != null && this
				.getRecombinationallyInvertedGeneId().equals(
						castOther.getRecombinationallyInvertedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationallyInvertedGeneId() == null ? 0 : this
						.getRecombinationallyInvertedGeneId().hashCode());
		result = 37 * result
