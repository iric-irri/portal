...
/**
 * MteId generated by hbm2java
 */
public class MteId implements java.io.Serializable {
	...
	public MteId(Integer mteId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MteId))
			return false;
		MteId castOther = (MteId) other;

		return ((this.getMteId() == castOther.getMteId()) || (this.getMteId() != null
				&& castOther.getMteId() != null && this.getMteId().equals(
				castOther.getMteId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getMteId() == null ? 0 : this.getMteId().hashCode());
		result = 37 * result
