...
/**
 * SubstitutionId generated by hbm2java
 */
public class SubstitutionId implements java.io.Serializable {
	...
	public SubstitutionId(Integer substitutionId, Integer featureId,
	...
	public void setSubstitutionId(Integer substitutionId) {
		this.substitutionId = substitutionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SubstitutionId))
			return false;
		SubstitutionId castOther = (SubstitutionId) other;

		return ((this.getSubstitutionId() == castOther.getSubstitutionId()) || (this
				.getSubstitutionId() != null
				&& castOther.getSubstitutionId() != null && this
				.getSubstitutionId().equals(castOther.getSubstitutionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSubstitutionId() == null ? 0 : this.getSubstitutionId()
						.hashCode());
		result = 37 * result
