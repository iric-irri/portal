...
/**
 * AsparaginylTrnaId generated by hbm2java
 */
public class AsparaginylTrnaId implements java.io.Serializable {

	private Integer asparaginylTrnaId;
	...
	public AsparaginylTrnaId() {
	}

	public AsparaginylTrnaId(Integer asparaginylTrnaId, Integer featureId,
		...
		this.asparaginylTrnaId = asparaginylTrnaId;
	...
	public Integer getAsparaginylTrnaId() {
		return this.asparaginylTrnaId;
	}

	public void setAsparaginylTrnaId(Integer asparaginylTrnaId) {
		this.asparaginylTrnaId = asparaginylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsparaginylTrnaId))
			return false;
		AsparaginylTrnaId castOther = (AsparaginylTrnaId) other;

		return ((this.getAsparaginylTrnaId() == castOther
				.getAsparaginylTrnaId()) || (this.getAsparaginylTrnaId() != null
				&& castOther.getAsparaginylTrnaId() != null && this
				.getAsparaginylTrnaId()
				.equals(castOther.getAsparaginylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsparaginylTrnaId() == null ? 0 : this
						.getAsparaginylTrnaId().hashCode());
		result = 37 * result
