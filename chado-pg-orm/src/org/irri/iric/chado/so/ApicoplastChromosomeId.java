...
/**
 * ApicoplastChromosomeId generated by hbm2java
 */
public class ApicoplastChromosomeId implements java.io.Serializable {

	private Integer apicoplastChromosomeId;
	...
	public ApicoplastChromosomeId() {
	}

	public ApicoplastChromosomeId(Integer apicoplastChromosomeId,
		...
		this.apicoplastChromosomeId = apicoplastChromosomeId;
	...
	public Integer getApicoplastChromosomeId() {
		return this.apicoplastChromosomeId;
	}

	public void setApicoplastChromosomeId(Integer apicoplastChromosomeId) {
		this.apicoplastChromosomeId = apicoplastChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApicoplastChromosomeId))
			return false;
		ApicoplastChromosomeId castOther = (ApicoplastChromosomeId) other;

		return ((this.getApicoplastChromosomeId() == castOther
				.getApicoplastChromosomeId()) || (this
				.getApicoplastChromosomeId() != null
				&& castOther.getApicoplastChromosomeId() != null && this
				.getApicoplastChromosomeId().equals(
						castOther.getApicoplastChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getApicoplastChromosomeId() == null ? 0 : this
						.getApicoplastChromosomeId().hashCode());
		result = 37 * result
