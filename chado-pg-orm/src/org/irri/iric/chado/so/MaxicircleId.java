...
/**
 * MaxicircleId generated by hbm2java
 */
public class MaxicircleId implements java.io.Serializable {

	private Integer maxicircleId;
	...
	public MaxicircleId(Integer maxicircleId, Integer featureId,
		...
		this.maxicircleId = maxicircleId;
	...
	public Integer getMaxicircleId() {
		return this.maxicircleId;
	}

	public void setMaxicircleId(Integer maxicircleId) {
		this.maxicircleId = maxicircleId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaxicircleId))
			return false;
		MaxicircleId castOther = (MaxicircleId) other;

		return ((this.getMaxicircleId() == castOther.getMaxicircleId()) || (this
				.getMaxicircleId() != null
				&& castOther.getMaxicircleId() != null && this
				.getMaxicircleId().equals(castOther.getMaxicircleId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaxicircleId() == null ? 0 : this.getMaxicircleId()
						.hashCode());
		result = 37 * result
