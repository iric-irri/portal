...
/**
 * VertebrateImmuneSystemGeneRecombinationSpacerId generated by hbm2java
 */
public class VertebrateImmuneSystemGeneRecombinationSpacerId implements
		java.io.Serializable {

	private Integer vertebrateImmuneSystemGeneRecombinationSpacerId;
	...
	public VertebrateImmuneSystemGeneRecombinationSpacerId() {
	}

	public VertebrateImmuneSystemGeneRecombinationSpacerId(
			Integer vertebrateImmuneSystemGeneRecombinationSpacerId,
		...
		this.vertebrateImmuneSystemGeneRecombinationSpacerId = vertebrateImmuneSystemGeneRecombinationSpacerId;
	...
	public Integer getVertebrateImmuneSystemGeneRecombinationSpacerId() {
		return this.vertebrateImmuneSystemGeneRecombinationSpacerId;
	}

	public void setVertebrateImmuneSystemGeneRecombinationSpacerId(
			Integer vertebrateImmuneSystemGeneRecombinationSpacerId) {
		this.vertebrateImmuneSystemGeneRecombinationSpacerId = vertebrateImmuneSystemGeneRecombinationSpacerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VertebrateImmuneSystemGeneRecombinationSpacerId))
			return false;
		VertebrateImmuneSystemGeneRecombinationSpacerId castOther = (VertebrateImmuneSystemGeneRecombinationSpacerId) other;

		return ((this.getVertebrateImmuneSystemGeneRecombinationSpacerId() == castOther
				.getVertebrateImmuneSystemGeneRecombinationSpacerId()) || (this
				.getVertebrateImmuneSystemGeneRecombinationSpacerId() != null
				&& castOther
						.getVertebrateImmuneSystemGeneRecombinationSpacerId() != null && this
				.getVertebrateImmuneSystemGeneRecombinationSpacerId()
				.equals(castOther
						.getVertebrateImmuneSystemGeneRecombinationSpacerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVertebrateImmuneSystemGeneRecombinationSpacerId() == null ? 0
						: this.getVertebrateImmuneSystemGeneRecombinationSpacerId()
								.hashCode());
		result = 37 * result
