...
/**
 * HighQualityDraftId generated by hbm2java
 */
public class HighQualityDraftId implements java.io.Serializable {

	private Integer highQualityDraftId;
	...
	public HighQualityDraftId() {
	}

	public HighQualityDraftId(Integer highQualityDraftId, Integer featureId,
		...
		this.highQualityDraftId = highQualityDraftId;
	...
	public Integer getHighQualityDraftId() {
		return this.highQualityDraftId;
	}

	public void setHighQualityDraftId(Integer highQualityDraftId) {
		this.highQualityDraftId = highQualityDraftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HighQualityDraftId))
			return false;
		HighQualityDraftId castOther = (HighQualityDraftId) other;

		return ((this.getHighQualityDraftId() == castOther
				.getHighQualityDraftId()) || (this.getHighQualityDraftId() != null
				&& castOther.getHighQualityDraftId() != null && this
				.getHighQualityDraftId().equals(
						castOther.getHighQualityDraftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHighQualityDraftId() == null ? 0 : this
						.getHighQualityDraftId().hashCode());
		result = 37 * result
