...
/**
 * IntegronId generated by hbm2java
 */
public class IntegronId implements java.io.Serializable {

	private Integer integronId;
	...
	public IntegronId(Integer integronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIntegronId() {
		return this.integronId;
	}

	public void setIntegronId(Integer integronId) {
		this.integronId = integronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntegronId))
			return false;
		IntegronId castOther = (IntegronId) other;

		return ((this.getIntegronId() == castOther.getIntegronId()) || (this
				.getIntegronId() != null && castOther.getIntegronId() != null && this
				.getIntegronId().equals(castOther.getIntegronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntegronId() == null ? 0 : this.getIntegronId()
						.hashCode());
		result = 37 * result
