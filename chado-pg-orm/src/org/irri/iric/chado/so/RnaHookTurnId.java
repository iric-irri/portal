...
/**
 * RnaHookTurnId generated by hbm2java
 */
public class RnaHookTurnId implements java.io.Serializable {

	private Integer rnaHookTurnId;
	...
	public RnaHookTurnId() {
	}

	public RnaHookTurnId(Integer rnaHookTurnId, Integer featureId,
		...
		this.rnaHookTurnId = rnaHookTurnId;
	...
	public Integer getRnaHookTurnId() {
		return this.rnaHookTurnId;
	}

	public void setRnaHookTurnId(Integer rnaHookTurnId) {
		this.rnaHookTurnId = rnaHookTurnId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaHookTurnId))
			return false;
		RnaHookTurnId castOther = (RnaHookTurnId) other;

		return ((this.getRnaHookTurnId() == castOther.getRnaHookTurnId()) || (this
				.getRnaHookTurnId() != null
				&& castOther.getRnaHookTurnId() != null && this
				.getRnaHookTurnId().equals(castOther.getRnaHookTurnId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaHookTurnId() == null ? 0 : this.getRnaHookTurnId()
						.hashCode());
		result = 37 * result
