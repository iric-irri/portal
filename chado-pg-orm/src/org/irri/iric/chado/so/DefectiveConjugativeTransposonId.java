...
/**
 * DefectiveConjugativeTransposonId generated by hbm2java
 */
public class DefectiveConjugativeTransposonId implements java.io.Serializable {

	private Integer defectiveConjugativeTransposonId;
	...
	public DefectiveConjugativeTransposonId() {
	}

	public DefectiveConjugativeTransposonId(
			Integer defectiveConjugativeTransposonId, Integer featureId,
		...
		this.defectiveConjugativeTransposonId = defectiveConjugativeTransposonId;
	...
	public Integer getDefectiveConjugativeTransposonId() {
		return this.defectiveConjugativeTransposonId;
	}

	public void setDefectiveConjugativeTransposonId(
			Integer defectiveConjugativeTransposonId) {
		this.defectiveConjugativeTransposonId = defectiveConjugativeTransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DefectiveConjugativeTransposonId))
			return false;
		DefectiveConjugativeTransposonId castOther = (DefectiveConjugativeTransposonId) other;

		return ((this.getDefectiveConjugativeTransposonId() == castOther
				.getDefectiveConjugativeTransposonId()) || (this
				.getDefectiveConjugativeTransposonId() != null
				&& castOther.getDefectiveConjugativeTransposonId() != null && this
				.getDefectiveConjugativeTransposonId().equals(
						castOther.getDefectiveConjugativeTransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDefectiveConjugativeTransposonId() == null ? 0 : this
						.getDefectiveConjugativeTransposonId().hashCode());
		result = 37 * result
