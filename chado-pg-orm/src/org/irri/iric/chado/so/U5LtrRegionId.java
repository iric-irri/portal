...
/**
 * U5LtrRegionId generated by hbm2java
 */
public class U5LtrRegionId implements java.io.Serializable {

	private Integer u5LtrRegionId;
	...
	public U5LtrRegionId() {
	}

	public U5LtrRegionId(Integer u5LtrRegionId, Integer featureId,
		...
		this.u5LtrRegionId = u5LtrRegionId;
	...
	public Integer getU5LtrRegionId() {
		return this.u5LtrRegionId;
	}

	public void setU5LtrRegionId(Integer u5LtrRegionId) {
		this.u5LtrRegionId = u5LtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U5LtrRegionId))
			return false;
		U5LtrRegionId castOther = (U5LtrRegionId) other;

		return ((this.getU5LtrRegionId() == castOther.getU5LtrRegionId()) || (this
				.getU5LtrRegionId() != null
				&& castOther.getU5LtrRegionId() != null && this
				.getU5LtrRegionId().equals(castOther.getU5LtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU5LtrRegionId() == null ? 0 : this.getU5LtrRegionId()
						.hashCode());
		result = 37 * result
