...
/**
 * H3k9TrimethylationSiteId generated by hbm2java
 */
public class H3k9TrimethylationSiteId implements java.io.Serializable {

	private Integer h3k9TrimethylationSiteId;
	...
	public H3k9TrimethylationSiteId() {
	}

	public H3k9TrimethylationSiteId(Integer h3k9TrimethylationSiteId,
		...
		this.h3k9TrimethylationSiteId = h3k9TrimethylationSiteId;
	...
	public Integer getH3k9TrimethylationSiteId() {
		return this.h3k9TrimethylationSiteId;
	}

	public void setH3k9TrimethylationSiteId(Integer h3k9TrimethylationSiteId) {
		this.h3k9TrimethylationSiteId = h3k9TrimethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H3k9TrimethylationSiteId))
			return false;
		H3k9TrimethylationSiteId castOther = (H3k9TrimethylationSiteId) other;

		return ((this.getH3k9TrimethylationSiteId() == castOther
				.getH3k9TrimethylationSiteId()) || (this
				.getH3k9TrimethylationSiteId() != null
				&& castOther.getH3k9TrimethylationSiteId() != null && this
				.getH3k9TrimethylationSiteId().equals(
						castOther.getH3k9TrimethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH3k9TrimethylationSiteId() == null ? 0 : this
						.getH3k9TrimethylationSiteId().hashCode());
		result = 37 * result
