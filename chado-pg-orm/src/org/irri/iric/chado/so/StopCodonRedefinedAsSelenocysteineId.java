...
/**
 * StopCodonRedefinedAsSelenocysteineId generated by hbm2java
 */
public class StopCodonRedefinedAsSelenocysteineId implements
		java.io.Serializable {

	private Integer stopCodonRedefinedAsSelenocysteineId;
	...
	public StopCodonRedefinedAsSelenocysteineId() {
	}

	public StopCodonRedefinedAsSelenocysteineId(
			Integer stopCodonRedefinedAsSelenocysteineId, Integer featureId,
		...
		this.stopCodonRedefinedAsSelenocysteineId = stopCodonRedefinedAsSelenocysteineId;
	...
	public Integer getStopCodonRedefinedAsSelenocysteineId() {
		return this.stopCodonRedefinedAsSelenocysteineId;
	}

	public void setStopCodonRedefinedAsSelenocysteineId(
			Integer stopCodonRedefinedAsSelenocysteineId) {
		this.stopCodonRedefinedAsSelenocysteineId = stopCodonRedefinedAsSelenocysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopCodonRedefinedAsSelenocysteineId))
			return false;
		StopCodonRedefinedAsSelenocysteineId castOther = (StopCodonRedefinedAsSelenocysteineId) other;

		return ((this.getStopCodonRedefinedAsSelenocysteineId() == castOther
				.getStopCodonRedefinedAsSelenocysteineId()) || (this
				.getStopCodonRedefinedAsSelenocysteineId() != null
				&& castOther.getStopCodonRedefinedAsSelenocysteineId() != null && this
				.getStopCodonRedefinedAsSelenocysteineId().equals(
						castOther.getStopCodonRedefinedAsSelenocysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopCodonRedefinedAsSelenocysteineId() == null ? 0 : this
						.getStopCodonRedefinedAsSelenocysteineId().hashCode());
		result = 37 * result
