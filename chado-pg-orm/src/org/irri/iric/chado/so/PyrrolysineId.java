...
/**
 * PyrrolysineId generated by hbm2java
 */
public class PyrrolysineId implements java.io.Serializable {

	private Integer pyrrolysineId;
	...
	public PyrrolysineId() {
	}

	public PyrrolysineId(Integer pyrrolysineId, Integer featureId,
		...
		this.pyrrolysineId = pyrrolysineId;
	...
	public Integer getPyrrolysineId() {
		return this.pyrrolysineId;
	}

	public void setPyrrolysineId(Integer pyrrolysineId) {
		this.pyrrolysineId = pyrrolysineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrrolysineId))
			return false;
		PyrrolysineId castOther = (PyrrolysineId) other;

		return ((this.getPyrrolysineId() == castOther.getPyrrolysineId()) || (this
				.getPyrrolysineId() != null
				&& castOther.getPyrrolysineId() != null && this
				.getPyrrolysineId().equals(castOther.getPyrrolysineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrrolysineId() == null ? 0 : this.getPyrrolysineId()
						.hashCode());
		result = 37 * result
