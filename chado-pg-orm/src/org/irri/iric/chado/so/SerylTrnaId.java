...
/**
 * SerylTrnaId generated by hbm2java
 */
public class SerylTrnaId implements java.io.Serializable {

	private Integer serylTrnaId;
	...
	public SerylTrnaId(Integer serylTrnaId, Integer featureId,
	...
	public Integer getSerylTrnaId() {
		return this.serylTrnaId;
	}

	public void setSerylTrnaId(Integer serylTrnaId) {
		this.serylTrnaId = serylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerylTrnaId))
			return false;
		SerylTrnaId castOther = (SerylTrnaId) other;

		return ((this.getSerylTrnaId() == castOther.getSerylTrnaId()) || (this
				.getSerylTrnaId() != null && castOther.getSerylTrnaId() != null && this
				.getSerylTrnaId().equals(castOther.getSerylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSerylTrnaId() == null ? 0 : this.getSerylTrnaId()
						.hashCode());
		result = 37 * result
