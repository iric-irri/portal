...
/**
 * N6GlycinylcarbamoyladenosineId generated by hbm2java
 */
public class N6GlycinylcarbamoyladenosineId implements java.io.Serializable {

	private Integer n6GlycinylcarbamoyladenosineId;
	...
	public N6GlycinylcarbamoyladenosineId() {
	}

	public N6GlycinylcarbamoyladenosineId(
			Integer n6GlycinylcarbamoyladenosineId, Integer featureId,
		...
		this.n6GlycinylcarbamoyladenosineId = n6GlycinylcarbamoyladenosineId;
	...
	public Integer getN6GlycinylcarbamoyladenosineId() {
		return this.n6GlycinylcarbamoyladenosineId;
	}

	public void setN6GlycinylcarbamoyladenosineId(
			Integer n6GlycinylcarbamoyladenosineId) {
		this.n6GlycinylcarbamoyladenosineId = n6GlycinylcarbamoyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6GlycinylcarbamoyladenosineId))
			return false;
		N6GlycinylcarbamoyladenosineId castOther = (N6GlycinylcarbamoyladenosineId) other;

		return ((this.getN6GlycinylcarbamoyladenosineId() == castOther
				.getN6GlycinylcarbamoyladenosineId()) || (this
				.getN6GlycinylcarbamoyladenosineId() != null
				&& castOther.getN6GlycinylcarbamoyladenosineId() != null && this
				.getN6GlycinylcarbamoyladenosineId().equals(
						castOther.getN6GlycinylcarbamoyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6GlycinylcarbamoyladenosineId() == null ? 0 : this
						.getN6GlycinylcarbamoyladenosineId().hashCode());
		result = 37 * result
