...
/**
 * ElongatedPolypeptideId generated by hbm2java
 */
public class ElongatedPolypeptideId implements java.io.Serializable {

	private Integer elongatedPolypeptideId;
	...
	public ElongatedPolypeptideId() {
	}

	public ElongatedPolypeptideId(Integer elongatedPolypeptideId,
		...
		this.elongatedPolypeptideId = elongatedPolypeptideId;
	...
	public Integer getElongatedPolypeptideId() {
		return this.elongatedPolypeptideId;
	}

	public void setElongatedPolypeptideId(Integer elongatedPolypeptideId) {
		this.elongatedPolypeptideId = elongatedPolypeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedPolypeptideId))
			return false;
		ElongatedPolypeptideId castOther = (ElongatedPolypeptideId) other;

		return ((this.getElongatedPolypeptideId() == castOther
				.getElongatedPolypeptideId()) || (this
				.getElongatedPolypeptideId() != null
				&& castOther.getElongatedPolypeptideId() != null && this
				.getElongatedPolypeptideId().equals(
						castOther.getElongatedPolypeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedPolypeptideId() == null ? 0 : this
						.getElongatedPolypeptideId().hashCode());
		result = 37 * result
