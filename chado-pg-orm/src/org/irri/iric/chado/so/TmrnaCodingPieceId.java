...
/**
 * TmrnaCodingPieceId generated by hbm2java
 */
public class TmrnaCodingPieceId implements java.io.Serializable {

	private Integer tmrnaCodingPieceId;
	...
	public TmrnaCodingPieceId() {
	}

	public TmrnaCodingPieceId(Integer tmrnaCodingPieceId, Integer featureId,
		...
		this.tmrnaCodingPieceId = tmrnaCodingPieceId;
	...
	public Integer getTmrnaCodingPieceId() {
		return this.tmrnaCodingPieceId;
	}

	public void setTmrnaCodingPieceId(Integer tmrnaCodingPieceId) {
		this.tmrnaCodingPieceId = tmrnaCodingPieceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaCodingPieceId))
			return false;
		TmrnaCodingPieceId castOther = (TmrnaCodingPieceId) other;

		return ((this.getTmrnaCodingPieceId() == castOther
				.getTmrnaCodingPieceId()) || (this.getTmrnaCodingPieceId() != null
				&& castOther.getTmrnaCodingPieceId() != null && this
				.getTmrnaCodingPieceId().equals(
						castOther.getTmrnaCodingPieceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaCodingPieceId() == null ? 0 : this
						.getTmrnaCodingPieceId().hashCode());
		result = 37 * result
