...
/**
 * InframeVariantId generated by hbm2java
 */
public class InframeVariantId implements java.io.Serializable {

	private Integer inframeVariantId;
	...
	public InframeVariantId() {
	}

	public InframeVariantId(Integer inframeVariantId, Integer featureId,
		...
		this.inframeVariantId = inframeVariantId;
	...
	public Integer getInframeVariantId() {
		return this.inframeVariantId;
	}

	public void setInframeVariantId(Integer inframeVariantId) {
		this.inframeVariantId = inframeVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InframeVariantId))
			return false;
		InframeVariantId castOther = (InframeVariantId) other;

		return ((this.getInframeVariantId() == castOther.getInframeVariantId()) || (this
				.getInframeVariantId() != null
				&& castOther.getInframeVariantId() != null && this
				.getInframeVariantId().equals(castOther.getInframeVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInframeVariantId() == null ? 0 : this
						.getInframeVariantId().hashCode());
		result = 37 * result
