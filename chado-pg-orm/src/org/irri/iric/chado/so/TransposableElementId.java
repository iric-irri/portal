...
/**
 * TransposableElementId generated by hbm2java
 */
public class TransposableElementId implements java.io.Serializable {

	private Integer transposableElementId;
	...
	public TransposableElementId() {
	}

	public TransposableElementId(Integer transposableElementId,
		...
		this.transposableElementId = transposableElementId;
	...
	public Integer getTransposableElementId() {
		return this.transposableElementId;
	}

	public void setTransposableElementId(Integer transposableElementId) {
		this.transposableElementId = transposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransposableElementId))
			return false;
		TransposableElementId castOther = (TransposableElementId) other;

		return ((this.getTransposableElementId() == castOther
				.getTransposableElementId()) || (this
				.getTransposableElementId() != null
				&& castOther.getTransposableElementId() != null && this
				.getTransposableElementId().equals(
						castOther.getTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransposableElementId() == null ? 0 : this
						.getTransposableElementId().hashCode());
		result = 37 * result
