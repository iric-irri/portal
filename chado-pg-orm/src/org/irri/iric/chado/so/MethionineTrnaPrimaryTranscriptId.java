...
/**
 * MethionineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class MethionineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer methionineTrnaPrimaryTranscriptId;
	...
	public MethionineTrnaPrimaryTranscriptId() {
	}

	public MethionineTrnaPrimaryTranscriptId(
			Integer methionineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.methionineTrnaPrimaryTranscriptId = methionineTrnaPrimaryTranscriptId;
	...
	public Integer getMethionineTrnaPrimaryTranscriptId() {
		return this.methionineTrnaPrimaryTranscriptId;
	}

	public void setMethionineTrnaPrimaryTranscriptId(
			Integer methionineTrnaPrimaryTranscriptId) {
		this.methionineTrnaPrimaryTranscriptId = methionineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethionineTrnaPrimaryTranscriptId))
			return false;
		MethionineTrnaPrimaryTranscriptId castOther = (MethionineTrnaPrimaryTranscriptId) other;

		return ((this.getMethionineTrnaPrimaryTranscriptId() == castOther
				.getMethionineTrnaPrimaryTranscriptId()) || (this
				.getMethionineTrnaPrimaryTranscriptId() != null
				&& castOther.getMethionineTrnaPrimaryTranscriptId() != null && this
				.getMethionineTrnaPrimaryTranscriptId().equals(
						castOther.getMethionineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethionineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getMethionineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
