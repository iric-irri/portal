...
/**
 * InteinId generated by hbm2java
 */
public class InteinId implements java.io.Serializable {

	private Integer inteinId;
	...
	public InteinId(Integer inteinId, Integer featureId, Integer dbxrefId,
	...
	public Integer getInteinId() {
		return this.inteinId;
	}

	public void setInteinId(Integer inteinId) {
		this.inteinId = inteinId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InteinId))
			return false;
		InteinId castOther = (InteinId) other;

		return ((this.getInteinId() == castOther.getInteinId()) || (this
				.getInteinId() != null && castOther.getInteinId() != null && this
				.getInteinId().equals(castOther.getInteinId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getInteinId() == null ? 0 : this.getInteinId().hashCode());
		result = 37 * result
