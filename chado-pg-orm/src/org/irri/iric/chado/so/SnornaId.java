...
/**
 * SnornaId generated by hbm2java
 */
public class SnornaId implements java.io.Serializable {

	private Integer snornaId;
	...
	public SnornaId(Integer snornaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSnornaId() {
		return this.snornaId;
	}

	public void setSnornaId(Integer snornaId) {
		this.snornaId = snornaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnornaId))
			return false;
		SnornaId castOther = (SnornaId) other;

		return ((this.getSnornaId() == castOther.getSnornaId()) || (this
				.getSnornaId() != null && castOther.getSnornaId() != null && this
				.getSnornaId().equals(castOther.getSnornaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSnornaId() == null ? 0 : this.getSnornaId().hashCode());
		result = 37 * result
