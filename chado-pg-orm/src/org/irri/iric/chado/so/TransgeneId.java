...
/**
 * TransgeneId generated by hbm2java
 */
public class TransgeneId implements java.io.Serializable {

	private Integer transgeneId;
	...
	public TransgeneId(Integer transgeneId, Integer featureId,
	...
	public Integer getTransgeneId() {
		return this.transgeneId;
	}

	public void setTransgeneId(Integer transgeneId) {
		this.transgeneId = transgeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransgeneId))
			return false;
		TransgeneId castOther = (TransgeneId) other;

		return ((this.getTransgeneId() == castOther.getTransgeneId()) || (this
				.getTransgeneId() != null && castOther.getTransgeneId() != null && this
				.getTransgeneId().equals(castOther.getTransgeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransgeneId() == null ? 0 : this.getTransgeneId()
						.hashCode());
		result = 37 * result
