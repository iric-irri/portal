...
/**
 * TranslocationBreakpointId generated by hbm2java
 */
public class TranslocationBreakpointId implements java.io.Serializable {

	private Integer translocationBreakpointId;
	...
	public TranslocationBreakpointId() {
	}

	public TranslocationBreakpointId(Integer translocationBreakpointId,
		...
		this.translocationBreakpointId = translocationBreakpointId;
	...
	public Integer getTranslocationBreakpointId() {
		return this.translocationBreakpointId;
	}

	public void setTranslocationBreakpointId(Integer translocationBreakpointId) {
		this.translocationBreakpointId = translocationBreakpointId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslocationBreakpointId))
			return false;
		TranslocationBreakpointId castOther = (TranslocationBreakpointId) other;

		return ((this.getTranslocationBreakpointId() == castOther
				.getTranslocationBreakpointId()) || (this
				.getTranslocationBreakpointId() != null
				&& castOther.getTranslocationBreakpointId() != null && this
				.getTranslocationBreakpointId().equals(
						castOther.getTranslocationBreakpointId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslocationBreakpointId() == null ? 0 : this
						.getTranslocationBreakpointId().hashCode());
		result = 37 * result
