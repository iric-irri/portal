...
/**
 * CompoundChromosomeArmId generated by hbm2java
 */
public class CompoundChromosomeArmId implements java.io.Serializable {

	private Integer compoundChromosomeArmId;
	...
	public CompoundChromosomeArmId() {
	}

	public CompoundChromosomeArmId(Integer compoundChromosomeArmId,
		...
		this.compoundChromosomeArmId = compoundChromosomeArmId;
	...
	public Integer getCompoundChromosomeArmId() {
		return this.compoundChromosomeArmId;
	}

	public void setCompoundChromosomeArmId(Integer compoundChromosomeArmId) {
		this.compoundChromosomeArmId = compoundChromosomeArmId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CompoundChromosomeArmId))
			return false;
		CompoundChromosomeArmId castOther = (CompoundChromosomeArmId) other;

		return ((this.getCompoundChromosomeArmId() == castOther
				.getCompoundChromosomeArmId()) || (this
				.getCompoundChromosomeArmId() != null
				&& castOther.getCompoundChromosomeArmId() != null && this
				.getCompoundChromosomeArmId().equals(
						castOther.getCompoundChromosomeArmId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCompoundChromosomeArmId() == null ? 0 : this
						.getCompoundChromosomeArmId().hashCode());
		result = 37 * result
