...
/**
 * ComplexChangeOfTranslationalProductVariantId generated by hbm2java
 */
public class ComplexChangeOfTranslationalProductVariantId implements
		java.io.Serializable {

	private Integer complexChangeOfTranslationalProductVariantId;
	...
	public ComplexChangeOfTranslationalProductVariantId() {
	}

	public ComplexChangeOfTranslationalProductVariantId(
			Integer complexChangeOfTranslationalProductVariantId,
		...
		this.complexChangeOfTranslationalProductVariantId = complexChangeOfTranslationalProductVariantId;
	...
	public Integer getComplexChangeOfTranslationalProductVariantId() {
		return this.complexChangeOfTranslationalProductVariantId;
	}

	public void setComplexChangeOfTranslationalProductVariantId(
			Integer complexChangeOfTranslationalProductVariantId) {
		this.complexChangeOfTranslationalProductVariantId = complexChangeOfTranslationalProductVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComplexChangeOfTranslationalProductVariantId))
			return false;
		ComplexChangeOfTranslationalProductVariantId castOther = (ComplexChangeOfTranslationalProductVariantId) other;

		return ((this.getComplexChangeOfTranslationalProductVariantId() == castOther
				.getComplexChangeOfTranslationalProductVariantId()) || (this
				.getComplexChangeOfTranslationalProductVariantId() != null
				&& castOther.getComplexChangeOfTranslationalProductVariantId() != null && this
				.getComplexChangeOfTranslationalProductVariantId()
				.equals(castOther
						.getComplexChangeOfTranslationalProductVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplexChangeOfTranslationalProductVariantId() == null ? 0
						: this.getComplexChangeOfTranslationalProductVariantId()
								.hashCode());
		result = 37 * result
