...
/**
 * AsparagineId generated by hbm2java
 */
public class AsparagineId implements java.io.Serializable {

	private Integer asparagineId;
	...
	public AsparagineId(Integer asparagineId, Integer featureId,
		...
		this.asparagineId = asparagineId;
	...
	public Integer getAsparagineId() {
		return this.asparagineId;
	}

	public void setAsparagineId(Integer asparagineId) {
		this.asparagineId = asparagineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsparagineId))
			return false;
		AsparagineId castOther = (AsparagineId) other;

		return ((this.getAsparagineId() == castOther.getAsparagineId()) || (this
				.getAsparagineId() != null
				&& castOther.getAsparagineId() != null && this
				.getAsparagineId().equals(castOther.getAsparagineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAsparagineId() == null ? 0 : this.getAsparagineId()
						.hashCode());
		result = 37 * result
