...
/**
 * ParacentricInversionId generated by hbm2java
 */
public class ParacentricInversionId implements java.io.Serializable {

	private Integer paracentricInversionId;
	...
	public ParacentricInversionId() {
	}

	public ParacentricInversionId(Integer paracentricInversionId,
		...
		this.paracentricInversionId = paracentricInversionId;
	...
	public Integer getParacentricInversionId() {
		return this.paracentricInversionId;
	}

	public void setParacentricInversionId(Integer paracentricInversionId) {
		this.paracentricInversionId = paracentricInversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ParacentricInversionId))
			return false;
		ParacentricInversionId castOther = (ParacentricInversionId) other;

		return ((this.getParacentricInversionId() == castOther
				.getParacentricInversionId()) || (this
				.getParacentricInversionId() != null
				&& castOther.getParacentricInversionId() != null && this
				.getParacentricInversionId().equals(
						castOther.getParacentricInversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getParacentricInversionId() == null ? 0 : this
						.getParacentricInversionId().hashCode());
		result = 37 * result
