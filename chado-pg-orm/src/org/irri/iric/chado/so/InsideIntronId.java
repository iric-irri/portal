...
/**
 * InsideIntronId generated by hbm2java
 */
public class InsideIntronId implements java.io.Serializable {

	private Integer insideIntronId;
	...
	public InsideIntronId() {
	}

	public InsideIntronId(Integer insideIntronId, Integer featureId,
		...
		this.insideIntronId = insideIntronId;
	...
	public Integer getInsideIntronId() {
		return this.insideIntronId;
	}

	public void setInsideIntronId(Integer insideIntronId) {
		this.insideIntronId = insideIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsideIntronId))
			return false;
		InsideIntronId castOther = (InsideIntronId) other;

		return ((this.getInsideIntronId() == castOther.getInsideIntronId()) || (this
				.getInsideIntronId() != null
				&& castOther.getInsideIntronId() != null && this
				.getInsideIntronId().equals(castOther.getInsideIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsideIntronId() == null ? 0 : this.getInsideIntronId()
						.hashCode());
		result = 37 * result
