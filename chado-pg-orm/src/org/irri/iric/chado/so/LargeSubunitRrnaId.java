...
/**
 * LargeSubunitRrnaId generated by hbm2java
 */
public class LargeSubunitRrnaId implements java.io.Serializable {

	private Integer largeSubunitRrnaId;
	...
	public LargeSubunitRrnaId() {
	}

	public LargeSubunitRrnaId(Integer largeSubunitRrnaId, Integer featureId,
		...
		this.largeSubunitRrnaId = largeSubunitRrnaId;
	...
	public Integer getLargeSubunitRrnaId() {
		return this.largeSubunitRrnaId;
	}

	public void setLargeSubunitRrnaId(Integer largeSubunitRrnaId) {
		this.largeSubunitRrnaId = largeSubunitRrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LargeSubunitRrnaId))
			return false;
		LargeSubunitRrnaId castOther = (LargeSubunitRrnaId) other;

		return ((this.getLargeSubunitRrnaId() == castOther
				.getLargeSubunitRrnaId()) || (this.getLargeSubunitRrnaId() != null
				&& castOther.getLargeSubunitRrnaId() != null && this
				.getLargeSubunitRrnaId().equals(
						castOther.getLargeSubunitRrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLargeSubunitRrnaId() == null ? 0 : this
						.getLargeSubunitRrnaId().hashCode());
		result = 37 * result
