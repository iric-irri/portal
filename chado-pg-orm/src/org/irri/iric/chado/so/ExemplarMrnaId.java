...
/**
 * ExemplarMrnaId generated by hbm2java
 */
public class ExemplarMrnaId implements java.io.Serializable {

	private Integer exemplarMrnaId;
	...
	public ExemplarMrnaId() {
	}

	public ExemplarMrnaId(Integer exemplarMrnaId, Integer featureId,
		...
		this.exemplarMrnaId = exemplarMrnaId;
	...
	public Integer getExemplarMrnaId() {
		return this.exemplarMrnaId;
	}

	public void setExemplarMrnaId(Integer exemplarMrnaId) {
		this.exemplarMrnaId = exemplarMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExemplarMrnaId))
			return false;
		ExemplarMrnaId castOther = (ExemplarMrnaId) other;

		return ((this.getExemplarMrnaId() == castOther.getExemplarMrnaId()) || (this
				.getExemplarMrnaId() != null
				&& castOther.getExemplarMrnaId() != null && this
				.getExemplarMrnaId().equals(castOther.getExemplarMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExemplarMrnaId() == null ? 0 : this.getExemplarMrnaId()
						.hashCode());
		result = 37 * result
