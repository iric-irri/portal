...
/**
 * PolypeptideFunctionVariantId generated by hbm2java
 */
public class PolypeptideFunctionVariantId implements java.io.Serializable {

	private Integer polypeptideFunctionVariantId;
	...
	public PolypeptideFunctionVariantId() {
	}

	public PolypeptideFunctionVariantId(Integer polypeptideFunctionVariantId,
		...
		this.polypeptideFunctionVariantId = polypeptideFunctionVariantId;
	...
	public Integer getPolypeptideFunctionVariantId() {
		return this.polypeptideFunctionVariantId;
	}

	public void setPolypeptideFunctionVariantId(
			Integer polypeptideFunctionVariantId) {
		this.polypeptideFunctionVariantId = polypeptideFunctionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideFunctionVariantId))
			return false;
		PolypeptideFunctionVariantId castOther = (PolypeptideFunctionVariantId) other;

		return ((this.getPolypeptideFunctionVariantId() == castOther
				.getPolypeptideFunctionVariantId()) || (this
				.getPolypeptideFunctionVariantId() != null
				&& castOther.getPolypeptideFunctionVariantId() != null && this
				.getPolypeptideFunctionVariantId().equals(
						castOther.getPolypeptideFunctionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideFunctionVariantId() == null ? 0 : this
						.getPolypeptideFunctionVariantId().hashCode());
		result = 37 * result
