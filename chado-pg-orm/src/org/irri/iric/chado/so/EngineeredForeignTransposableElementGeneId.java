...
/**
 * EngineeredForeignTransposableElementGeneId generated by hbm2java
 */
public class EngineeredForeignTransposableElementGeneId implements
		java.io.Serializable {

	private Integer engineeredForeignTransposableElementGeneId;
	...
	public EngineeredForeignTransposableElementGeneId() {
	}

	public EngineeredForeignTransposableElementGeneId(
			Integer engineeredForeignTransposableElementGeneId,
		...
		this.engineeredForeignTransposableElementGeneId = engineeredForeignTransposableElementGeneId;
	...
	public Integer getEngineeredForeignTransposableElementGeneId() {
		return this.engineeredForeignTransposableElementGeneId;
	}

	public void setEngineeredForeignTransposableElementGeneId(
			Integer engineeredForeignTransposableElementGeneId) {
		this.engineeredForeignTransposableElementGeneId = engineeredForeignTransposableElementGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredForeignTransposableElementGeneId))
			return false;
		EngineeredForeignTransposableElementGeneId castOther = (EngineeredForeignTransposableElementGeneId) other;

		return ((this.getEngineeredForeignTransposableElementGeneId() == castOther
				.getEngineeredForeignTransposableElementGeneId()) || (this
				.getEngineeredForeignTransposableElementGeneId() != null
				&& castOther.getEngineeredForeignTransposableElementGeneId() != null && this
				.getEngineeredForeignTransposableElementGeneId()
				.equals(castOther
						.getEngineeredForeignTransposableElementGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredForeignTransposableElementGeneId() == null ? 0
						: this.getEngineeredForeignTransposableElementGeneId()
								.hashCode());
		result = 37 * result
