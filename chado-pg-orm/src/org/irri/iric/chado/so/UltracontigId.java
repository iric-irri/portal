...
/**
 * UltracontigId generated by hbm2java
 */
public class UltracontigId implements java.io.Serializable {

	private Integer ultracontigId;
	...
	public UltracontigId() {
	}

	public UltracontigId(Integer ultracontigId, Integer featureId,
		...
		this.ultracontigId = ultracontigId;
	...
	public Integer getUltracontigId() {
		return this.ultracontigId;
	}

	public void setUltracontigId(Integer ultracontigId) {
		this.ultracontigId = ultracontigId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UltracontigId))
			return false;
		UltracontigId castOther = (UltracontigId) other;

		return ((this.getUltracontigId() == castOther.getUltracontigId()) || (this
				.getUltracontigId() != null
				&& castOther.getUltracontigId() != null && this
				.getUltracontigId().equals(castOther.getUltracontigId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUltracontigId() == null ? 0 : this.getUltracontigId()
						.hashCode());
		result = 37 * result
