...
/**
 * JGeneRecombinationFeatureId generated by hbm2java
 */
public class JGeneRecombinationFeatureId implements java.io.Serializable {

	private Integer JGeneRecombinationFeatureId;
	...
	public JGeneRecombinationFeatureId() {
	}

	public JGeneRecombinationFeatureId(Integer JGeneRecombinationFeatureId,
		...
		this.JGeneRecombinationFeatureId = JGeneRecombinationFeatureId;
	...
	public Integer getJGeneRecombinationFeatureId() {
		return this.JGeneRecombinationFeatureId;
	}

	public void setJGeneRecombinationFeatureId(
			Integer JGeneRecombinationFeatureId) {
		this.JGeneRecombinationFeatureId = JGeneRecombinationFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JGeneRecombinationFeatureId))
			return false;
		JGeneRecombinationFeatureId castOther = (JGeneRecombinationFeatureId) other;

		return ((this.getJGeneRecombinationFeatureId() == castOther
				.getJGeneRecombinationFeatureId()) || (this
				.getJGeneRecombinationFeatureId() != null
				&& castOther.getJGeneRecombinationFeatureId() != null && this
				.getJGeneRecombinationFeatureId().equals(
						castOther.getJGeneRecombinationFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJGeneRecombinationFeatureId() == null ? 0 : this
						.getJGeneRecombinationFeatureId().hashCode());
		result = 37 * result
