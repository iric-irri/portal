...
/**
 * SatelliteDnaId generated by hbm2java
 */
public class SatelliteDnaId implements java.io.Serializable {

	private Integer satelliteDnaId;
	...
	public SatelliteDnaId() {
	}

	public SatelliteDnaId(Integer satelliteDnaId, Integer featureId,
		...
		this.satelliteDnaId = satelliteDnaId;
	...
	public Integer getSatelliteDnaId() {
		return this.satelliteDnaId;
	}

	public void setSatelliteDnaId(Integer satelliteDnaId) {
		this.satelliteDnaId = satelliteDnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SatelliteDnaId))
			return false;
		SatelliteDnaId castOther = (SatelliteDnaId) other;

		return ((this.getSatelliteDnaId() == castOther.getSatelliteDnaId()) || (this
				.getSatelliteDnaId() != null
				&& castOther.getSatelliteDnaId() != null && this
				.getSatelliteDnaId().equals(castOther.getSatelliteDnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSatelliteDnaId() == null ? 0 : this.getSatelliteDnaId()
						.hashCode());
		result = 37 * result
