...
/**
 * InsertionAttributeId generated by hbm2java
 */
public class InsertionAttributeId implements java.io.Serializable {

	private Integer insertionAttributeId;
	...
	public InsertionAttributeId() {
	}

	public InsertionAttributeId(Integer insertionAttributeId,
		...
		this.insertionAttributeId = insertionAttributeId;
	...
	public Integer getInsertionAttributeId() {
		return this.insertionAttributeId;
	}

	public void setInsertionAttributeId(Integer insertionAttributeId) {
		this.insertionAttributeId = insertionAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionAttributeId))
			return false;
		InsertionAttributeId castOther = (InsertionAttributeId) other;

		return ((this.getInsertionAttributeId() == castOther
				.getInsertionAttributeId()) || (this.getInsertionAttributeId() != null
				&& castOther.getInsertionAttributeId() != null && this
				.getInsertionAttributeId().equals(
						castOther.getInsertionAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionAttributeId() == null ? 0 : this
						.getInsertionAttributeId().hashCode());
		result = 37 * result
