...
/**
 * MethylatedAId generated by hbm2java
 */
public class MethylatedAId implements java.io.Serializable {

	private Integer methylatedAId;
	...
	public MethylatedAId() {
	}

	public MethylatedAId(Integer methylatedAId, Integer featureId,
		...
		this.methylatedAId = methylatedAId;
	...
	public Integer getMethylatedAId() {
		return this.methylatedAId;
	}

	public void setMethylatedAId(Integer methylatedAId) {
		this.methylatedAId = methylatedAId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylatedAId))
			return false;
		MethylatedAId castOther = (MethylatedAId) other;

		return ((this.getMethylatedAId() == castOther.getMethylatedAId()) || (this
				.getMethylatedAId() != null
				&& castOther.getMethylatedAId() != null && this
				.getMethylatedAId().equals(castOther.getMethylatedAId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylatedAId() == null ? 0 : this.getMethylatedAId()
						.hashCode());
		result = 37 * result
