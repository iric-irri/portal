...
/**
 * HAcaBoxSnornaPrimaryTranscriptId generated by hbm2java
 */
public class HAcaBoxSnornaPrimaryTranscriptId implements java.io.Serializable {

	private Integer HAcaBoxSnornaPrimaryTranscriptId;
	...
	public HAcaBoxSnornaPrimaryTranscriptId() {
	}

	public HAcaBoxSnornaPrimaryTranscriptId(
			Integer HAcaBoxSnornaPrimaryTranscriptId, Integer featureId,
		...
		this.HAcaBoxSnornaPrimaryTranscriptId = HAcaBoxSnornaPrimaryTranscriptId;
	...
	public Integer getHAcaBoxSnornaPrimaryTranscriptId() {
		return this.HAcaBoxSnornaPrimaryTranscriptId;
	}

	public void setHAcaBoxSnornaPrimaryTranscriptId(
			Integer HAcaBoxSnornaPrimaryTranscriptId) {
		this.HAcaBoxSnornaPrimaryTranscriptId = HAcaBoxSnornaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HAcaBoxSnornaPrimaryTranscriptId))
			return false;
		HAcaBoxSnornaPrimaryTranscriptId castOther = (HAcaBoxSnornaPrimaryTranscriptId) other;

		return ((this.getHAcaBoxSnornaPrimaryTranscriptId() == castOther
				.getHAcaBoxSnornaPrimaryTranscriptId()) || (this
				.getHAcaBoxSnornaPrimaryTranscriptId() != null
				&& castOther.getHAcaBoxSnornaPrimaryTranscriptId() != null && this
				.getHAcaBoxSnornaPrimaryTranscriptId().equals(
						castOther.getHAcaBoxSnornaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHAcaBoxSnornaPrimaryTranscriptId() == null ? 0 : this
						.getHAcaBoxSnornaPrimaryTranscriptId().hashCode());
		result = 37 * result
