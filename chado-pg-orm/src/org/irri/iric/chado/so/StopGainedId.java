...
/**
 * StopGainedId generated by hbm2java
 */
public class StopGainedId implements java.io.Serializable {

	private Integer stopGainedId;
	...
	public StopGainedId(Integer stopGainedId, Integer featureId,
		...
		this.stopGainedId = stopGainedId;
	...
	public Integer getStopGainedId() {
		return this.stopGainedId;
	}

	public void setStopGainedId(Integer stopGainedId) {
		this.stopGainedId = stopGainedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopGainedId))
			return false;
		StopGainedId castOther = (StopGainedId) other;

		return ((this.getStopGainedId() == castOther.getStopGainedId()) || (this
				.getStopGainedId() != null
				&& castOther.getStopGainedId() != null && this
				.getStopGainedId().equals(castOther.getStopGainedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopGainedId() == null ? 0 : this.getStopGainedId()
						.hashCode());
		result = 37 * result
