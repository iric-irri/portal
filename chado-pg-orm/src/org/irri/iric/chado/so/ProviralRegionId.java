...
/**
 * ProviralRegionId generated by hbm2java
 */
public class ProviralRegionId implements java.io.Serializable {

	private Integer proviralRegionId;
	...
	public ProviralRegionId() {
	}

	public ProviralRegionId(Integer proviralRegionId, Integer featureId,
		...
		this.proviralRegionId = proviralRegionId;
	...
	public Integer getProviralRegionId() {
		return this.proviralRegionId;
	}

	public void setProviralRegionId(Integer proviralRegionId) {
		this.proviralRegionId = proviralRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProviralRegionId))
			return false;
		ProviralRegionId castOther = (ProviralRegionId) other;

		return ((this.getProviralRegionId() == castOther.getProviralRegionId()) || (this
				.getProviralRegionId() != null
				&& castOther.getProviralRegionId() != null && this
				.getProviralRegionId().equals(castOther.getProviralRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProviralRegionId() == null ? 0 : this
						.getProviralRegionId().hashCode());
		result = 37 * result
