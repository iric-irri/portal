...
/**
 * SelenocysteinylTrnaId generated by hbm2java
 */
public class SelenocysteinylTrnaId implements java.io.Serializable {

	private Integer selenocysteinylTrnaId;
	...
	public SelenocysteinylTrnaId() {
	}

	public SelenocysteinylTrnaId(Integer selenocysteinylTrnaId,
		...
		this.selenocysteinylTrnaId = selenocysteinylTrnaId;
	...
	public Integer getSelenocysteinylTrnaId() {
		return this.selenocysteinylTrnaId;
	}

	public void setSelenocysteinylTrnaId(Integer selenocysteinylTrnaId) {
		this.selenocysteinylTrnaId = selenocysteinylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SelenocysteinylTrnaId))
			return false;
		SelenocysteinylTrnaId castOther = (SelenocysteinylTrnaId) other;

		return ((this.getSelenocysteinylTrnaId() == castOther
				.getSelenocysteinylTrnaId()) || (this
				.getSelenocysteinylTrnaId() != null
				&& castOther.getSelenocysteinylTrnaId() != null && this
				.getSelenocysteinylTrnaId().equals(
						castOther.getSelenocysteinylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSelenocysteinylTrnaId() == null ? 0 : this
						.getSelenocysteinylTrnaId().hashCode());
		result = 37 * result
