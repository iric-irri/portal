...
/**
 * TfBindingSiteVariantId generated by hbm2java
 */
public class TfBindingSiteVariantId implements java.io.Serializable {

	private Integer tfBindingSiteVariantId;
	...
	public TfBindingSiteVariantId() {
	}

	public TfBindingSiteVariantId(Integer tfBindingSiteVariantId,
		...
		this.tfBindingSiteVariantId = tfBindingSiteVariantId;
	...
	public Integer getTfBindingSiteVariantId() {
		return this.tfBindingSiteVariantId;
	}

	public void setTfBindingSiteVariantId(Integer tfBindingSiteVariantId) {
		this.tfBindingSiteVariantId = tfBindingSiteVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TfBindingSiteVariantId))
			return false;
		TfBindingSiteVariantId castOther = (TfBindingSiteVariantId) other;

		return ((this.getTfBindingSiteVariantId() == castOther
				.getTfBindingSiteVariantId()) || (this
				.getTfBindingSiteVariantId() != null
				&& castOther.getTfBindingSiteVariantId() != null && this
				.getTfBindingSiteVariantId().equals(
						castOther.getTfBindingSiteVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTfBindingSiteVariantId() == null ? 0 : this
						.getTfBindingSiteVariantId().hashCode());
		result = 37 * result
