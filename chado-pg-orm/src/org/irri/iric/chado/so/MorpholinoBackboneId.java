...
/**
 * MorpholinoBackboneId generated by hbm2java
 */
public class MorpholinoBackboneId implements java.io.Serializable {

	private Integer morpholinoBackboneId;
	...
	public MorpholinoBackboneId() {
	}

	public MorpholinoBackboneId(Integer morpholinoBackboneId,
		...
		this.morpholinoBackboneId = morpholinoBackboneId;
	...
	public Integer getMorpholinoBackboneId() {
		return this.morpholinoBackboneId;
	}

	public void setMorpholinoBackboneId(Integer morpholinoBackboneId) {
		this.morpholinoBackboneId = morpholinoBackboneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MorpholinoBackboneId))
			return false;
		MorpholinoBackboneId castOther = (MorpholinoBackboneId) other;

		return ((this.getMorpholinoBackboneId() == castOther
				.getMorpholinoBackboneId()) || (this.getMorpholinoBackboneId() != null
				&& castOther.getMorpholinoBackboneId() != null && this
				.getMorpholinoBackboneId().equals(
						castOther.getMorpholinoBackboneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMorpholinoBackboneId() == null ? 0 : this
						.getMorpholinoBackboneId().hashCode());
		result = 37 * result
