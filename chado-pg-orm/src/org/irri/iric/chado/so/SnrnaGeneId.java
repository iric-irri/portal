...
/**
 * SnrnaGeneId generated by hbm2java
 */
public class SnrnaGeneId implements java.io.Serializable {

	private Integer snrnaGeneId;
	...
	public SnrnaGeneId(Integer snrnaGeneId, Integer featureId,
	...
	public Integer getSnrnaGeneId() {
		return this.snrnaGeneId;
	}

	public void setSnrnaGeneId(Integer snrnaGeneId) {
		this.snrnaGeneId = snrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnrnaGeneId))
			return false;
		SnrnaGeneId castOther = (SnrnaGeneId) other;

		return ((this.getSnrnaGeneId() == castOther.getSnrnaGeneId()) || (this
				.getSnrnaGeneId() != null && castOther.getSnrnaGeneId() != null && this
				.getSnrnaGeneId().equals(castOther.getSnrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnrnaGeneId() == null ? 0 : this.getSnrnaGeneId()
						.hashCode());
		result = 37 * result
