...
/**
 * ElongatedOutOfFramePolypeptideCTerminalId generated by hbm2java
 */
public class ElongatedOutOfFramePolypeptideCTerminalId implements
		java.io.Serializable {

	private Integer elongatedOutOfFramePolypeptideCTerminalId;
	...
	public ElongatedOutOfFramePolypeptideCTerminalId() {
	}

	public ElongatedOutOfFramePolypeptideCTerminalId(
			Integer elongatedOutOfFramePolypeptideCTerminalId,
		...
		this.elongatedOutOfFramePolypeptideCTerminalId = elongatedOutOfFramePolypeptideCTerminalId;
	...
	public Integer getElongatedOutOfFramePolypeptideCTerminalId() {
		return this.elongatedOutOfFramePolypeptideCTerminalId;
	}

	public void setElongatedOutOfFramePolypeptideCTerminalId(
			Integer elongatedOutOfFramePolypeptideCTerminalId) {
		this.elongatedOutOfFramePolypeptideCTerminalId = elongatedOutOfFramePolypeptideCTerminalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ElongatedOutOfFramePolypeptideCTerminalId))
			return false;
		ElongatedOutOfFramePolypeptideCTerminalId castOther = (ElongatedOutOfFramePolypeptideCTerminalId) other;

		return ((this.getElongatedOutOfFramePolypeptideCTerminalId() == castOther
				.getElongatedOutOfFramePolypeptideCTerminalId()) || (this
				.getElongatedOutOfFramePolypeptideCTerminalId() != null
				&& castOther.getElongatedOutOfFramePolypeptideCTerminalId() != null && this
				.getElongatedOutOfFramePolypeptideCTerminalId()
				.equals(castOther
						.getElongatedOutOfFramePolypeptideCTerminalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getElongatedOutOfFramePolypeptideCTerminalId() == null ? 0
						: this.getElongatedOutOfFramePolypeptideCTerminalId()
								.hashCode());
		result = 37 * result
