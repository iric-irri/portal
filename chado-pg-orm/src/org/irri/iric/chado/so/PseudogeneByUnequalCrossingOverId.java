...
/**
 * PseudogeneByUnequalCrossingOverId generated by hbm2java
 */
public class PseudogeneByUnequalCrossingOverId implements java.io.Serializable {

	private Integer pseudogeneByUnequalCrossingOverId;
	...
	public PseudogeneByUnequalCrossingOverId() {
	}

	public PseudogeneByUnequalCrossingOverId(
			Integer pseudogeneByUnequalCrossingOverId, Integer featureId,
		...
		this.pseudogeneByUnequalCrossingOverId = pseudogeneByUnequalCrossingOverId;
	...
	public Integer getPseudogeneByUnequalCrossingOverId() {
		return this.pseudogeneByUnequalCrossingOverId;
	}

	public void setPseudogeneByUnequalCrossingOverId(
			Integer pseudogeneByUnequalCrossingOverId) {
		this.pseudogeneByUnequalCrossingOverId = pseudogeneByUnequalCrossingOverId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudogeneByUnequalCrossingOverId))
			return false;
		PseudogeneByUnequalCrossingOverId castOther = (PseudogeneByUnequalCrossingOverId) other;

		return ((this.getPseudogeneByUnequalCrossingOverId() == castOther
				.getPseudogeneByUnequalCrossingOverId()) || (this
				.getPseudogeneByUnequalCrossingOverId() != null
				&& castOther.getPseudogeneByUnequalCrossingOverId() != null && this
				.getPseudogeneByUnequalCrossingOverId().equals(
						castOther.getPseudogeneByUnequalCrossingOverId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudogeneByUnequalCrossingOverId() == null ? 0 : this
						.getPseudogeneByUnequalCrossingOverId().hashCode());
		result = 37 * result
