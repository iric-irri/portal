...
/**
 * EngineeredForeignGeneId generated by hbm2java
 */
public class EngineeredForeignGeneId implements java.io.Serializable {

	private Integer engineeredForeignGeneId;
	...
	public EngineeredForeignGeneId() {
	}

	public EngineeredForeignGeneId(Integer engineeredForeignGeneId,
		...
		this.engineeredForeignGeneId = engineeredForeignGeneId;
	...
	public Integer getEngineeredForeignGeneId() {
		return this.engineeredForeignGeneId;
	}

	public void setEngineeredForeignGeneId(Integer engineeredForeignGeneId) {
		this.engineeredForeignGeneId = engineeredForeignGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredForeignGeneId))
			return false;
		EngineeredForeignGeneId castOther = (EngineeredForeignGeneId) other;

		return ((this.getEngineeredForeignGeneId() == castOther
				.getEngineeredForeignGeneId()) || (this
				.getEngineeredForeignGeneId() != null
				&& castOther.getEngineeredForeignGeneId() != null && this
				.getEngineeredForeignGeneId().equals(
						castOther.getEngineeredForeignGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredForeignGeneId() == null ? 0 : this
						.getEngineeredForeignGeneId().hashCode());
		result = 37 * result
