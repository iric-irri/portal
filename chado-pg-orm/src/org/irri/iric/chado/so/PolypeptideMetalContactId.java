...
/**
 * PolypeptideMetalContactId generated by hbm2java
 */
public class PolypeptideMetalContactId implements java.io.Serializable {

	private Integer polypeptideMetalContactId;
	...
	public PolypeptideMetalContactId() {
	}

	public PolypeptideMetalContactId(Integer polypeptideMetalContactId,
		...
		this.polypeptideMetalContactId = polypeptideMetalContactId;
	...
	public Integer getPolypeptideMetalContactId() {
		return this.polypeptideMetalContactId;
	}

	public void setPolypeptideMetalContactId(Integer polypeptideMetalContactId) {
		this.polypeptideMetalContactId = polypeptideMetalContactId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideMetalContactId))
			return false;
		PolypeptideMetalContactId castOther = (PolypeptideMetalContactId) other;

		return ((this.getPolypeptideMetalContactId() == castOther
				.getPolypeptideMetalContactId()) || (this
				.getPolypeptideMetalContactId() != null
				&& castOther.getPolypeptideMetalContactId() != null && this
				.getPolypeptideMetalContactId().equals(
						castOther.getPolypeptideMetalContactId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideMetalContactId() == null ? 0 : this
						.getPolypeptideMetalContactId().hashCode());
		result = 37 * result
