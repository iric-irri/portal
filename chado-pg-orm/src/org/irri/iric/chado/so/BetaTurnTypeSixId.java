...
/**
 * BetaTurnTypeSixId generated by hbm2java
 */
public class BetaTurnTypeSixId implements java.io.Serializable {

	private Integer betaTurnTypeSixId;
	...
	public BetaTurnTypeSixId() {
	}

	public BetaTurnTypeSixId(Integer betaTurnTypeSixId, Integer featureId,
		...
		this.betaTurnTypeSixId = betaTurnTypeSixId;
	...
	public Integer getBetaTurnTypeSixId() {
		return this.betaTurnTypeSixId;
	}

	public void setBetaTurnTypeSixId(Integer betaTurnTypeSixId) {
		this.betaTurnTypeSixId = betaTurnTypeSixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnTypeSixId))
			return false;
		BetaTurnTypeSixId castOther = (BetaTurnTypeSixId) other;

		return ((this.getBetaTurnTypeSixId() == castOther
				.getBetaTurnTypeSixId()) || (this.getBetaTurnTypeSixId() != null
				&& castOther.getBetaTurnTypeSixId() != null && this
				.getBetaTurnTypeSixId()
				.equals(castOther.getBetaTurnTypeSixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnTypeSixId() == null ? 0 : this
						.getBetaTurnTypeSixId().hashCode());
		result = 37 * result
