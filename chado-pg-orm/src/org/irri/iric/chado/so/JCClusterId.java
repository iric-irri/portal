...
/**
 * JCClusterId generated by hbm2java
 */
public class JCClusterId implements java.io.Serializable {

	private Integer JCClusterId;
	...
	public JCClusterId(Integer JCClusterId, Integer featureId,
	...
	public Integer getJCClusterId() {
		return this.JCClusterId;
	}

	public void setJCClusterId(Integer JCClusterId) {
		this.JCClusterId = JCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JCClusterId))
			return false;
		JCClusterId castOther = (JCClusterId) other;

		return ((this.getJCClusterId() == castOther.getJCClusterId()) || (this
				.getJCClusterId() != null && castOther.getJCClusterId() != null && this
				.getJCClusterId().equals(castOther.getJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getJCClusterId() == null ? 0 : this.getJCClusterId()
						.hashCode());
		result = 37 * result
