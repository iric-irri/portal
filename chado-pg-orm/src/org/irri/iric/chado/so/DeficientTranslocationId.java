...
/**
 * DeficientTranslocationId generated by hbm2java
 */
public class DeficientTranslocationId implements java.io.Serializable {

	private Integer deficientTranslocationId;
	...
	public DeficientTranslocationId() {
	}

	public DeficientTranslocationId(Integer deficientTranslocationId,
		...
		this.deficientTranslocationId = deficientTranslocationId;
	...
	public Integer getDeficientTranslocationId() {
		return this.deficientTranslocationId;
	}

	public void setDeficientTranslocationId(Integer deficientTranslocationId) {
		this.deficientTranslocationId = deficientTranslocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeficientTranslocationId))
			return false;
		DeficientTranslocationId castOther = (DeficientTranslocationId) other;

		return ((this.getDeficientTranslocationId() == castOther
				.getDeficientTranslocationId()) || (this
				.getDeficientTranslocationId() != null
				&& castOther.getDeficientTranslocationId() != null && this
				.getDeficientTranslocationId().equals(
						castOther.getDeficientTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDeficientTranslocationId() == null ? 0 : this
						.getDeficientTranslocationId().hashCode());
		result = 37 * result
