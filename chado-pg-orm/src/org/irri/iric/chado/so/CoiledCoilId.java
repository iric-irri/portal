...
/**
 * CoiledCoilId generated by hbm2java
 */
public class CoiledCoilId implements java.io.Serializable {

	private Integer coiledCoilId;
	...
	public CoiledCoilId(Integer coiledCoilId, Integer featureId,
		...
		this.coiledCoilId = coiledCoilId;
	...
	public Integer getCoiledCoilId() {
		return this.coiledCoilId;
	}

	public void setCoiledCoilId(Integer coiledCoilId) {
		this.coiledCoilId = coiledCoilId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CoiledCoilId))
			return false;
		CoiledCoilId castOther = (CoiledCoilId) other;

		return ((this.getCoiledCoilId() == castOther.getCoiledCoilId()) || (this
				.getCoiledCoilId() != null
				&& castOther.getCoiledCoilId() != null && this
				.getCoiledCoilId().equals(castOther.getCoiledCoilId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCoiledCoilId() == null ? 0 : this.getCoiledCoilId()
						.hashCode());
		result = 37 * result
