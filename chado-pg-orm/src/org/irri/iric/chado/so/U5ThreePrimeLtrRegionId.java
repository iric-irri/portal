...
/**
 * U5ThreePrimeLtrRegionId generated by hbm2java
 */
public class U5ThreePrimeLtrRegionId implements java.io.Serializable {

	private Integer u5ThreePrimeLtrRegionId;
	...
	public U5ThreePrimeLtrRegionId() {
	}

	public U5ThreePrimeLtrRegionId(Integer u5ThreePrimeLtrRegionId,
		...
		this.u5ThreePrimeLtrRegionId = u5ThreePrimeLtrRegionId;
	...
	public Integer getU5ThreePrimeLtrRegionId() {
		return this.u5ThreePrimeLtrRegionId;
	}

	public void setU5ThreePrimeLtrRegionId(Integer u5ThreePrimeLtrRegionId) {
		this.u5ThreePrimeLtrRegionId = u5ThreePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U5ThreePrimeLtrRegionId))
			return false;
		U5ThreePrimeLtrRegionId castOther = (U5ThreePrimeLtrRegionId) other;

		return ((this.getU5ThreePrimeLtrRegionId() == castOther
				.getU5ThreePrimeLtrRegionId()) || (this
				.getU5ThreePrimeLtrRegionId() != null
				&& castOther.getU5ThreePrimeLtrRegionId() != null && this
				.getU5ThreePrimeLtrRegionId().equals(
						castOther.getU5ThreePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU5ThreePrimeLtrRegionId() == null ? 0 : this
						.getU5ThreePrimeLtrRegionId().hashCode());
		result = 37 * result
