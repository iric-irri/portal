...
/**
 * BredMotifId generated by hbm2java
 */
public class BredMotifId implements java.io.Serializable {

	private Integer bredMotifId;
	...
	public BredMotifId(Integer bredMotifId, Integer featureId,
	...
	public Integer getBredMotifId() {
		return this.bredMotifId;
	}

	public void setBredMotifId(Integer bredMotifId) {
		this.bredMotifId = bredMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BredMotifId))
			return false;
		BredMotifId castOther = (BredMotifId) other;

		return ((this.getBredMotifId() == castOther.getBredMotifId()) || (this
				.getBredMotifId() != null && castOther.getBredMotifId() != null && this
				.getBredMotifId().equals(castOther.getBredMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBredMotifId() == null ? 0 : this.getBredMotifId()
						.hashCode());
		result = 37 * result
