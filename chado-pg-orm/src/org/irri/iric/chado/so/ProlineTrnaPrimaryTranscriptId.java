...
/**
 * ProlineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class ProlineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer prolineTrnaPrimaryTranscriptId;
	...
	public ProlineTrnaPrimaryTranscriptId() {
	}

	public ProlineTrnaPrimaryTranscriptId(
			Integer prolineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.prolineTrnaPrimaryTranscriptId = prolineTrnaPrimaryTranscriptId;
	...
	public Integer getProlineTrnaPrimaryTranscriptId() {
		return this.prolineTrnaPrimaryTranscriptId;
	}

	public void setProlineTrnaPrimaryTranscriptId(
			Integer prolineTrnaPrimaryTranscriptId) {
		this.prolineTrnaPrimaryTranscriptId = prolineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProlineTrnaPrimaryTranscriptId))
			return false;
		ProlineTrnaPrimaryTranscriptId castOther = (ProlineTrnaPrimaryTranscriptId) other;

		return ((this.getProlineTrnaPrimaryTranscriptId() == castOther
				.getProlineTrnaPrimaryTranscriptId()) || (this
				.getProlineTrnaPrimaryTranscriptId() != null
				&& castOther.getProlineTrnaPrimaryTranscriptId() != null && this
				.getProlineTrnaPrimaryTranscriptId().equals(
						castOther.getProlineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProlineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getProlineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
