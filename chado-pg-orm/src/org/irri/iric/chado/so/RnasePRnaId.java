...
/**
 * RnasePRnaId generated by hbm2java
 */
public class RnasePRnaId implements java.io.Serializable {

	private Integer rnasePRnaId;
	...
	public RnasePRnaId(Integer rnasePRnaId, Integer featureId,
	...
	public Integer getRnasePRnaId() {
		return this.rnasePRnaId;
	}

	public void setRnasePRnaId(Integer rnasePRnaId) {
		this.rnasePRnaId = rnasePRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnasePRnaId))
			return false;
		RnasePRnaId castOther = (RnasePRnaId) other;

		return ((this.getRnasePRnaId() == castOther.getRnasePRnaId()) || (this
				.getRnasePRnaId() != null && castOther.getRnasePRnaId() != null && this
				.getRnasePRnaId().equals(castOther.getRnasePRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnasePRnaId() == null ? 0 : this.getRnasePRnaId()
						.hashCode());
		result = 37 * result
