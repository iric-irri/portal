...
/**
 * LtrRetrotransposonId generated by hbm2java
 */
public class LtrRetrotransposonId implements java.io.Serializable {

	private Integer ltrRetrotransposonId;
	...
	public LtrRetrotransposonId() {
	}

	public LtrRetrotransposonId(Integer ltrRetrotransposonId,
		...
		this.ltrRetrotransposonId = ltrRetrotransposonId;
	...
	public Integer getLtrRetrotransposonId() {
		return this.ltrRetrotransposonId;
	}

	public void setLtrRetrotransposonId(Integer ltrRetrotransposonId) {
		this.ltrRetrotransposonId = ltrRetrotransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LtrRetrotransposonId))
			return false;
		LtrRetrotransposonId castOther = (LtrRetrotransposonId) other;

		return ((this.getLtrRetrotransposonId() == castOther
				.getLtrRetrotransposonId()) || (this.getLtrRetrotransposonId() != null
				&& castOther.getLtrRetrotransposonId() != null && this
				.getLtrRetrotransposonId().equals(
						castOther.getLtrRetrotransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLtrRetrotransposonId() == null ? 0 : this
						.getLtrRetrotransposonId().hashCode());
		result = 37 * result
