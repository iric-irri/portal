...
/**
 * PseudoknotId generated by hbm2java
 */
public class PseudoknotId implements java.io.Serializable {

	private Integer pseudoknotId;
	...
	public PseudoknotId(Integer pseudoknotId, Integer featureId,
		...
		this.pseudoknotId = pseudoknotId;
	...
	public Integer getPseudoknotId() {
		return this.pseudoknotId;
	}

	public void setPseudoknotId(Integer pseudoknotId) {
		this.pseudoknotId = pseudoknotId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PseudoknotId))
			return false;
		PseudoknotId castOther = (PseudoknotId) other;

		return ((this.getPseudoknotId() == castOther.getPseudoknotId()) || (this
				.getPseudoknotId() != null
				&& castOther.getPseudoknotId() != null && this
				.getPseudoknotId().equals(castOther.getPseudoknotId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPseudoknotId() == null ? 0 : this.getPseudoknotId()
						.hashCode());
		result = 37 * result
