...
/**
 * PolypeptideDomainId generated by hbm2java
 */
public class PolypeptideDomainId implements java.io.Serializable {

	private Integer polypeptideDomainId;
	...
	public PolypeptideDomainId() {
	}

	public PolypeptideDomainId(Integer polypeptideDomainId, Integer featureId,
		...
		this.polypeptideDomainId = polypeptideDomainId;
	...
	public Integer getPolypeptideDomainId() {
		return this.polypeptideDomainId;
	}

	public void setPolypeptideDomainId(Integer polypeptideDomainId) {
		this.polypeptideDomainId = polypeptideDomainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideDomainId))
			return false;
		PolypeptideDomainId castOther = (PolypeptideDomainId) other;

		return ((this.getPolypeptideDomainId() == castOther
				.getPolypeptideDomainId()) || (this.getPolypeptideDomainId() != null
				&& castOther.getPolypeptideDomainId() != null && this
				.getPolypeptideDomainId().equals(
						castOther.getPolypeptideDomainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideDomainId() == null ? 0 : this
						.getPolypeptideDomainId().hashCode());
		result = 37 * result
