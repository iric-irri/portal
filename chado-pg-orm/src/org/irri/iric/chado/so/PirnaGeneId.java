...
/**
 * PirnaGeneId generated by hbm2java
 */
public class PirnaGeneId implements java.io.Serializable {

	private Integer pirnaGeneId;
	...
	public PirnaGeneId(Integer pirnaGeneId, Integer featureId,
	...
	public Integer getPirnaGeneId() {
		return this.pirnaGeneId;
	}

	public void setPirnaGeneId(Integer pirnaGeneId) {
		this.pirnaGeneId = pirnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PirnaGeneId))
			return false;
		PirnaGeneId castOther = (PirnaGeneId) other;

		return ((this.getPirnaGeneId() == castOther.getPirnaGeneId()) || (this
				.getPirnaGeneId() != null && castOther.getPirnaGeneId() != null && this
				.getPirnaGeneId().equals(castOther.getPirnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPirnaGeneId() == null ? 0 : this.getPirnaGeneId()
						.hashCode());
		result = 37 * result
