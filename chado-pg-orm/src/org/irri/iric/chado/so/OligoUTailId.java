...
/**
 * OligoUTailId generated by hbm2java
 */
public class OligoUTailId implements java.io.Serializable {

	private Integer oligoUTailId;
	...
	public OligoUTailId(Integer oligoUTailId, Integer featureId,
		...
		this.oligoUTailId = oligoUTailId;
	...
	public Integer getOligoUTailId() {
		return this.oligoUTailId;
	}

	public void setOligoUTailId(Integer oligoUTailId) {
		this.oligoUTailId = oligoUTailId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OligoUTailId))
			return false;
		OligoUTailId castOther = (OligoUTailId) other;

		return ((this.getOligoUTailId() == castOther.getOligoUTailId()) || (this
				.getOligoUTailId() != null
				&& castOther.getOligoUTailId() != null && this
				.getOligoUTailId().equals(castOther.getOligoUTailId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOligoUTailId() == null ? 0 : this.getOligoUTailId()
						.hashCode());
		result = 37 * result
