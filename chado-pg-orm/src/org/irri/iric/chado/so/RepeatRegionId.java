...
/**
 * RepeatRegionId generated by hbm2java
 */
public class RepeatRegionId implements java.io.Serializable {

	private Integer repeatRegionId;
	...
	public RepeatRegionId() {
	}

	public RepeatRegionId(Integer repeatRegionId, Integer featureId,
		...
		this.repeatRegionId = repeatRegionId;
	...
	public Integer getRepeatRegionId() {
		return this.repeatRegionId;
	}

	public void setRepeatRegionId(Integer repeatRegionId) {
		this.repeatRegionId = repeatRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RepeatRegionId))
			return false;
		RepeatRegionId castOther = (RepeatRegionId) other;

		return ((this.getRepeatRegionId() == castOther.getRepeatRegionId()) || (this
				.getRepeatRegionId() != null
				&& castOther.getRepeatRegionId() != null && this
				.getRepeatRegionId().equals(castOther.getRepeatRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRepeatRegionId() == null ? 0 : this.getRepeatRegionId()
						.hashCode());
		result = 37 * result
