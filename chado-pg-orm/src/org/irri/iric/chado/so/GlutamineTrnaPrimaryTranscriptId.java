...
/**
 * GlutamineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class GlutamineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer glutamineTrnaPrimaryTranscriptId;
	...
	public GlutamineTrnaPrimaryTranscriptId() {
	}

	public GlutamineTrnaPrimaryTranscriptId(
			Integer glutamineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.glutamineTrnaPrimaryTranscriptId = glutamineTrnaPrimaryTranscriptId;
	...
	public Integer getGlutamineTrnaPrimaryTranscriptId() {
		return this.glutamineTrnaPrimaryTranscriptId;
	}

	public void setGlutamineTrnaPrimaryTranscriptId(
			Integer glutamineTrnaPrimaryTranscriptId) {
		this.glutamineTrnaPrimaryTranscriptId = glutamineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutamineTrnaPrimaryTranscriptId))
			return false;
		GlutamineTrnaPrimaryTranscriptId castOther = (GlutamineTrnaPrimaryTranscriptId) other;

		return ((this.getGlutamineTrnaPrimaryTranscriptId() == castOther
				.getGlutamineTrnaPrimaryTranscriptId()) || (this
				.getGlutamineTrnaPrimaryTranscriptId() != null
				&& castOther.getGlutamineTrnaPrimaryTranscriptId() != null && this
				.getGlutamineTrnaPrimaryTranscriptId().equals(
						castOther.getGlutamineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutamineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getGlutamineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
