...
/**
 * GToTTransversionId generated by hbm2java
 */
public class GToTTransversionId implements java.io.Serializable {

	private Integer GToTTransversionId;
	...
	public GToTTransversionId() {
	}

	public GToTTransversionId(Integer GToTTransversionId, Integer featureId,
		...
		this.GToTTransversionId = GToTTransversionId;
	...
	public Integer getGToTTransversionId() {
		return this.GToTTransversionId;
	}

	public void setGToTTransversionId(Integer GToTTransversionId) {
		this.GToTTransversionId = GToTTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GToTTransversionId))
			return false;
		GToTTransversionId castOther = (GToTTransversionId) other;

		return ((this.getGToTTransversionId() == castOther
				.getGToTTransversionId()) || (this.getGToTTransversionId() != null
				&& castOther.getGToTTransversionId() != null && this
				.getGToTTransversionId().equals(
						castOther.getGToTTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGToTTransversionId() == null ? 0 : this
						.getGToTTransversionId().hashCode());
		result = 37 * result
