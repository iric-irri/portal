...
/**
 * RecodingStimulatoryRegionId generated by hbm2java
 */
public class RecodingStimulatoryRegionId implements java.io.Serializable {

	private Integer recodingStimulatoryRegionId;
	...
	public RecodingStimulatoryRegionId() {
	}

	public RecodingStimulatoryRegionId(Integer recodingStimulatoryRegionId,
		...
		this.recodingStimulatoryRegionId = recodingStimulatoryRegionId;
	...
	public Integer getRecodingStimulatoryRegionId() {
		return this.recodingStimulatoryRegionId;
	}

	public void setRecodingStimulatoryRegionId(
			Integer recodingStimulatoryRegionId) {
		this.recodingStimulatoryRegionId = recodingStimulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodingStimulatoryRegionId))
			return false;
		RecodingStimulatoryRegionId castOther = (RecodingStimulatoryRegionId) other;

		return ((this.getRecodingStimulatoryRegionId() == castOther
				.getRecodingStimulatoryRegionId()) || (this
				.getRecodingStimulatoryRegionId() != null
				&& castOther.getRecodingStimulatoryRegionId() != null && this
				.getRecodingStimulatoryRegionId().equals(
						castOther.getRecodingStimulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecodingStimulatoryRegionId() == null ? 0 : this
						.getRecodingStimulatoryRegionId().hashCode());
		result = 37 * result
