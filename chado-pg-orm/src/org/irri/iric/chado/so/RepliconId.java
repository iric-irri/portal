...
/**
 * RepliconId generated by hbm2java
 */
public class RepliconId implements java.io.Serializable {

	private Integer repliconId;
	...
	public RepliconId(Integer repliconId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRepliconId() {
		return this.repliconId;
	}

	public void setRepliconId(Integer repliconId) {
		this.repliconId = repliconId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RepliconId))
			return false;
		RepliconId castOther = (RepliconId) other;

		return ((this.getRepliconId() == castOther.getRepliconId()) || (this
				.getRepliconId() != null && castOther.getRepliconId() != null && this
				.getRepliconId().equals(castOther.getRepliconId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRepliconId() == null ? 0 : this.getRepliconId()
						.hashCode());
		result = 37 * result
