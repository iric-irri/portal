...
/**
 * RFivePrimeLtrRegionId generated by hbm2java
 */
public class RFivePrimeLtrRegionId implements java.io.Serializable {

	private Integer RFivePrimeLtrRegionId;
	...
	public RFivePrimeLtrRegionId() {
	}

	public RFivePrimeLtrRegionId(Integer RFivePrimeLtrRegionId,
		...
		this.RFivePrimeLtrRegionId = RFivePrimeLtrRegionId;
	...
	public Integer getRFivePrimeLtrRegionId() {
		return this.RFivePrimeLtrRegionId;
	}

	public void setRFivePrimeLtrRegionId(Integer RFivePrimeLtrRegionId) {
		this.RFivePrimeLtrRegionId = RFivePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RFivePrimeLtrRegionId))
			return false;
		RFivePrimeLtrRegionId castOther = (RFivePrimeLtrRegionId) other;

		return ((this.getRFivePrimeLtrRegionId() == castOther
				.getRFivePrimeLtrRegionId()) || (this
				.getRFivePrimeLtrRegionId() != null
				&& castOther.getRFivePrimeLtrRegionId() != null && this
				.getRFivePrimeLtrRegionId().equals(
						castOther.getRFivePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRFivePrimeLtrRegionId() == null ? 0 : this
						.getRFivePrimeLtrRegionId().hashCode());
		result = 37 * result
