...
/**
 * WholeGenomeSequenceStatusId generated by hbm2java
 */
public class WholeGenomeSequenceStatusId implements java.io.Serializable {

	private Integer wholeGenomeSequenceStatusId;
	...
	public WholeGenomeSequenceStatusId() {
	}

	public WholeGenomeSequenceStatusId(Integer wholeGenomeSequenceStatusId,
		...
		this.wholeGenomeSequenceStatusId = wholeGenomeSequenceStatusId;
	...
	public Integer getWholeGenomeSequenceStatusId() {
		return this.wholeGenomeSequenceStatusId;
	}

	public void setWholeGenomeSequenceStatusId(
			Integer wholeGenomeSequenceStatusId) {
		this.wholeGenomeSequenceStatusId = wholeGenomeSequenceStatusId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WholeGenomeSequenceStatusId))
			return false;
		WholeGenomeSequenceStatusId castOther = (WholeGenomeSequenceStatusId) other;

		return ((this.getWholeGenomeSequenceStatusId() == castOther
				.getWholeGenomeSequenceStatusId()) || (this
				.getWholeGenomeSequenceStatusId() != null
				&& castOther.getWholeGenomeSequenceStatusId() != null && this
				.getWholeGenomeSequenceStatusId().equals(
						castOther.getWholeGenomeSequenceStatusId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWholeGenomeSequenceStatusId() == null ? 0 : this
						.getWholeGenomeSequenceStatusId().hashCode());
		result = 37 * result
