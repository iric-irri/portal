...
/**
 * AttcSiteId generated by hbm2java
 */
public class AttcSiteId implements java.io.Serializable {

	private Integer attcSiteId;
	...
	public AttcSiteId(Integer attcSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttcSiteId() {
		return this.attcSiteId;
	}

	public void setAttcSiteId(Integer attcSiteId) {
		this.attcSiteId = attcSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttcSiteId))
			return false;
		AttcSiteId castOther = (AttcSiteId) other;

		return ((this.getAttcSiteId() == castOther.getAttcSiteId()) || (this
				.getAttcSiteId() != null && castOther.getAttcSiteId() != null && this
				.getAttcSiteId().equals(castOther.getAttcSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttcSiteId() == null ? 0 : this.getAttcSiteId()
						.hashCode());
		result = 37 * result
