...
/**
 * PolycistronicId generated by hbm2java
 */
public class PolycistronicId implements java.io.Serializable {

	private Integer polycistronicId;
	...
	public PolycistronicId() {
	}

	public PolycistronicId(Integer polycistronicId, Integer featureId,
		...
		this.polycistronicId = polycistronicId;
	...
	public Integer getPolycistronicId() {
		return this.polycistronicId;
	}

	public void setPolycistronicId(Integer polycistronicId) {
		this.polycistronicId = polycistronicId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolycistronicId))
			return false;
		PolycistronicId castOther = (PolycistronicId) other;

		return ((this.getPolycistronicId() == castOther.getPolycistronicId()) || (this
				.getPolycistronicId() != null
				&& castOther.getPolycistronicId() != null && this
				.getPolycistronicId().equals(castOther.getPolycistronicId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolycistronicId() == null ? 0 : this.getPolycistronicId()
						.hashCode());
		result = 37 * result
