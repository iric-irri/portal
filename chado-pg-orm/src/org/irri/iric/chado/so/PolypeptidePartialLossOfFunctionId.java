...
/**
 * PolypeptidePartialLossOfFunctionId generated by hbm2java
 */
public class PolypeptidePartialLossOfFunctionId implements java.io.Serializable {

	private Integer polypeptidePartialLossOfFunctionId;
	...
	public PolypeptidePartialLossOfFunctionId() {
	}

	public PolypeptidePartialLossOfFunctionId(
			Integer polypeptidePartialLossOfFunctionId, Integer featureId,
		...
		this.polypeptidePartialLossOfFunctionId = polypeptidePartialLossOfFunctionId;
	...
	public Integer getPolypeptidePartialLossOfFunctionId() {
		return this.polypeptidePartialLossOfFunctionId;
	}

	public void setPolypeptidePartialLossOfFunctionId(
			Integer polypeptidePartialLossOfFunctionId) {
		this.polypeptidePartialLossOfFunctionId = polypeptidePartialLossOfFunctionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptidePartialLossOfFunctionId))
			return false;
		PolypeptidePartialLossOfFunctionId castOther = (PolypeptidePartialLossOfFunctionId) other;

		return ((this.getPolypeptidePartialLossOfFunctionId() == castOther
				.getPolypeptidePartialLossOfFunctionId()) || (this
				.getPolypeptidePartialLossOfFunctionId() != null
				&& castOther.getPolypeptidePartialLossOfFunctionId() != null && this
				.getPolypeptidePartialLossOfFunctionId().equals(
						castOther.getPolypeptidePartialLossOfFunctionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptidePartialLossOfFunctionId() == null ? 0 : this
						.getPolypeptidePartialLossOfFunctionId().hashCode());
		result = 37 * result
