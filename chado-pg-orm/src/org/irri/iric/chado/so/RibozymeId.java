...
/**
 * RibozymeId generated by hbm2java
 */
public class RibozymeId implements java.io.Serializable {

	private Integer ribozymeId;
	...
	public RibozymeId(Integer ribozymeId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRibozymeId() {
		return this.ribozymeId;
	}

	public void setRibozymeId(Integer ribozymeId) {
		this.ribozymeId = ribozymeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RibozymeId))
			return false;
		RibozymeId castOther = (RibozymeId) other;

		return ((this.getRibozymeId() == castOther.getRibozymeId()) || (this
				.getRibozymeId() != null && castOther.getRibozymeId() != null && this
				.getRibozymeId().equals(castOther.getRibozymeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRibozymeId() == null ? 0 : this.getRibozymeId()
						.hashCode());
		result = 37 * result
