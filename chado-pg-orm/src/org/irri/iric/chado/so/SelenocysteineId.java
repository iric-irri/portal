...
/**
 * SelenocysteineId generated by hbm2java
 */
public class SelenocysteineId implements java.io.Serializable {

	private Integer selenocysteineId;
	...
	public SelenocysteineId() {
	}

	public SelenocysteineId(Integer selenocysteineId, Integer featureId,
		...
		this.selenocysteineId = selenocysteineId;
	...
	public Integer getSelenocysteineId() {
		return this.selenocysteineId;
	}

	public void setSelenocysteineId(Integer selenocysteineId) {
		this.selenocysteineId = selenocysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SelenocysteineId))
			return false;
		SelenocysteineId castOther = (SelenocysteineId) other;

		return ((this.getSelenocysteineId() == castOther.getSelenocysteineId()) || (this
				.getSelenocysteineId() != null
				&& castOther.getSelenocysteineId() != null && this
				.getSelenocysteineId().equals(castOther.getSelenocysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSelenocysteineId() == null ? 0 : this
						.getSelenocysteineId().hashCode());
		result = 37 * result
