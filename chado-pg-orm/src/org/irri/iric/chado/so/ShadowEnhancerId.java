...
/**
 * ShadowEnhancerId generated by hbm2java
 */
public class ShadowEnhancerId implements java.io.Serializable {

	private Integer shadowEnhancerId;
	...
	public ShadowEnhancerId() {
	}

	public ShadowEnhancerId(Integer shadowEnhancerId, Integer featureId,
		...
		this.shadowEnhancerId = shadowEnhancerId;
	...
	public Integer getShadowEnhancerId() {
		return this.shadowEnhancerId;
	}

	public void setShadowEnhancerId(Integer shadowEnhancerId) {
		this.shadowEnhancerId = shadowEnhancerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShadowEnhancerId))
			return false;
		ShadowEnhancerId castOther = (ShadowEnhancerId) other;

		return ((this.getShadowEnhancerId() == castOther.getShadowEnhancerId()) || (this
				.getShadowEnhancerId() != null
				&& castOther.getShadowEnhancerId() != null && this
				.getShadowEnhancerId().equals(castOther.getShadowEnhancerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getShadowEnhancerId() == null ? 0 : this
						.getShadowEnhancerId().hashCode());
		result = 37 * result
