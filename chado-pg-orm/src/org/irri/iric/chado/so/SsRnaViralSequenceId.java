...
/**
 * SsRnaViralSequenceId generated by hbm2java
 */
public class SsRnaViralSequenceId implements java.io.Serializable {

	private Integer ssRnaViralSequenceId;
	...
	public SsRnaViralSequenceId() {
	}

	public SsRnaViralSequenceId(Integer ssRnaViralSequenceId,
		...
		this.ssRnaViralSequenceId = ssRnaViralSequenceId;
	...
	public Integer getSsRnaViralSequenceId() {
		return this.ssRnaViralSequenceId;
	}

	public void setSsRnaViralSequenceId(Integer ssRnaViralSequenceId) {
		this.ssRnaViralSequenceId = ssRnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SsRnaViralSequenceId))
			return false;
		SsRnaViralSequenceId castOther = (SsRnaViralSequenceId) other;

		return ((this.getSsRnaViralSequenceId() == castOther
				.getSsRnaViralSequenceId()) || (this.getSsRnaViralSequenceId() != null
				&& castOther.getSsRnaViralSequenceId() != null && this
				.getSsRnaViralSequenceId().equals(
						castOther.getSsRnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSsRnaViralSequenceId() == null ? 0 : this
						.getSsRnaViralSequenceId().hashCode());
		result = 37 * result
