...
/**
 * InsertionSiteId generated by hbm2java
 */
public class InsertionSiteId implements java.io.Serializable {

	private Integer insertionSiteId;
	...
	public InsertionSiteId() {
	}

	public InsertionSiteId(Integer insertionSiteId, Integer featureId,
		...
		this.insertionSiteId = insertionSiteId;
	...
	public Integer getInsertionSiteId() {
		return this.insertionSiteId;
	}

	public void setInsertionSiteId(Integer insertionSiteId) {
		this.insertionSiteId = insertionSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InsertionSiteId))
			return false;
		InsertionSiteId castOther = (InsertionSiteId) other;

		return ((this.getInsertionSiteId() == castOther.getInsertionSiteId()) || (this
				.getInsertionSiteId() != null
				&& castOther.getInsertionSiteId() != null && this
				.getInsertionSiteId().equals(castOther.getInsertionSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInsertionSiteId() == null ? 0 : this.getInsertionSiteId()
						.hashCode());
		result = 37 * result
