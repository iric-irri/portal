...
/**
 * ImprovedHighQualityDraftId generated by hbm2java
 */
public class ImprovedHighQualityDraftId implements java.io.Serializable {

	private Integer improvedHighQualityDraftId;
	...
	public ImprovedHighQualityDraftId() {
	}

	public ImprovedHighQualityDraftId(Integer improvedHighQualityDraftId,
		...
		this.improvedHighQualityDraftId = improvedHighQualityDraftId;
	...
	public Integer getImprovedHighQualityDraftId() {
		return this.improvedHighQualityDraftId;
	}

	public void setImprovedHighQualityDraftId(Integer improvedHighQualityDraftId) {
		this.improvedHighQualityDraftId = improvedHighQualityDraftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ImprovedHighQualityDraftId))
			return false;
		ImprovedHighQualityDraftId castOther = (ImprovedHighQualityDraftId) other;

		return ((this.getImprovedHighQualityDraftId() == castOther
				.getImprovedHighQualityDraftId()) || (this
				.getImprovedHighQualityDraftId() != null
				&& castOther.getImprovedHighQualityDraftId() != null && this
				.getImprovedHighQualityDraftId().equals(
						castOther.getImprovedHighQualityDraftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getImprovedHighQualityDraftId() == null ? 0 : this
						.getImprovedHighQualityDraftId().hashCode());
		result = 37 * result
