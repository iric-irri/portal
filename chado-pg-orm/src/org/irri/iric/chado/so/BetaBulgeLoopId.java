...
/**
 * BetaBulgeLoopId generated by hbm2java
 */
public class BetaBulgeLoopId implements java.io.Serializable {

	private Integer betaBulgeLoopId;
	...
	public BetaBulgeLoopId() {
	}

	public BetaBulgeLoopId(Integer betaBulgeLoopId, Integer featureId,
		...
		this.betaBulgeLoopId = betaBulgeLoopId;
	...
	public Integer getBetaBulgeLoopId() {
		return this.betaBulgeLoopId;
	}

	public void setBetaBulgeLoopId(Integer betaBulgeLoopId) {
		this.betaBulgeLoopId = betaBulgeLoopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaBulgeLoopId))
			return false;
		BetaBulgeLoopId castOther = (BetaBulgeLoopId) other;

		return ((this.getBetaBulgeLoopId() == castOther.getBetaBulgeLoopId()) || (this
				.getBetaBulgeLoopId() != null
				&& castOther.getBetaBulgeLoopId() != null && this
				.getBetaBulgeLoopId().equals(castOther.getBetaBulgeLoopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaBulgeLoopId() == null ? 0 : this.getBetaBulgeLoopId()
						.hashCode());
		result = 37 * result
