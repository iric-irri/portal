...
/**
 * ThreeMethylcytidineId generated by hbm2java
 */
public class ThreeMethylcytidineId implements java.io.Serializable {

	private Integer threeMethylcytidineId;
	...
	public ThreeMethylcytidineId() {
	}

	public ThreeMethylcytidineId(Integer threeMethylcytidineId,
		...
		this.threeMethylcytidineId = threeMethylcytidineId;
	...
	public Integer getThreeMethylcytidineId() {
		return this.threeMethylcytidineId;
	}

	public void setThreeMethylcytidineId(Integer threeMethylcytidineId) {
		this.threeMethylcytidineId = threeMethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeMethylcytidineId))
			return false;
		ThreeMethylcytidineId castOther = (ThreeMethylcytidineId) other;

		return ((this.getThreeMethylcytidineId() == castOther
				.getThreeMethylcytidineId()) || (this
				.getThreeMethylcytidineId() != null
				&& castOther.getThreeMethylcytidineId() != null && this
				.getThreeMethylcytidineId().equals(
						castOther.getThreeMethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeMethylcytidineId() == null ? 0 : this
						.getThreeMethylcytidineId().hashCode());
		result = 37 * result
