 ...
 * @see org.irri.iric.chado.so.Region
	...
	public List findByExample(Region instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Region")
