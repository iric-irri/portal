...
/**
 * DnaConstraintSequenceId generated by hbm2java
 */
public class DnaConstraintSequenceId implements java.io.Serializable {

	private Integer dnaConstraintSequenceId;
	...
	public DnaConstraintSequenceId() {
	}

	public DnaConstraintSequenceId(Integer dnaConstraintSequenceId,
		...
		this.dnaConstraintSequenceId = dnaConstraintSequenceId;
	...
	public Integer getDnaConstraintSequenceId() {
		return this.dnaConstraintSequenceId;
	}

	public void setDnaConstraintSequenceId(Integer dnaConstraintSequenceId) {
		this.dnaConstraintSequenceId = dnaConstraintSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DnaConstraintSequenceId))
			return false;
		DnaConstraintSequenceId castOther = (DnaConstraintSequenceId) other;

		return ((this.getDnaConstraintSequenceId() == castOther
				.getDnaConstraintSequenceId()) || (this
				.getDnaConstraintSequenceId() != null
				&& castOther.getDnaConstraintSequenceId() != null && this
				.getDnaConstraintSequenceId().equals(
						castOther.getDnaConstraintSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDnaConstraintSequenceId() == null ? 0 : this
						.getDnaConstraintSequenceId().hashCode());
		result = 37 * result
