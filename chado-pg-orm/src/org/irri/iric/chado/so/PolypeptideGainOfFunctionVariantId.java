...
/**
 * PolypeptideGainOfFunctionVariantId generated by hbm2java
 */
public class PolypeptideGainOfFunctionVariantId implements java.io.Serializable {

	private Integer polypeptideGainOfFunctionVariantId;
	...
	public PolypeptideGainOfFunctionVariantId() {
	}

	public PolypeptideGainOfFunctionVariantId(
			Integer polypeptideGainOfFunctionVariantId, Integer featureId,
		...
		this.polypeptideGainOfFunctionVariantId = polypeptideGainOfFunctionVariantId;
	...
	public Integer getPolypeptideGainOfFunctionVariantId() {
		return this.polypeptideGainOfFunctionVariantId;
	}

	public void setPolypeptideGainOfFunctionVariantId(
			Integer polypeptideGainOfFunctionVariantId) {
		this.polypeptideGainOfFunctionVariantId = polypeptideGainOfFunctionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideGainOfFunctionVariantId))
			return false;
		PolypeptideGainOfFunctionVariantId castOther = (PolypeptideGainOfFunctionVariantId) other;

		return ((this.getPolypeptideGainOfFunctionVariantId() == castOther
				.getPolypeptideGainOfFunctionVariantId()) || (this
				.getPolypeptideGainOfFunctionVariantId() != null
				&& castOther.getPolypeptideGainOfFunctionVariantId() != null && this
				.getPolypeptideGainOfFunctionVariantId().equals(
						castOther.getPolypeptideGainOfFunctionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideGainOfFunctionVariantId() == null ? 0 : this
						.getPolypeptideGainOfFunctionVariantId().hashCode());
		result = 37 * result
