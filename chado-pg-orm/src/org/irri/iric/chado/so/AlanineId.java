...
/**
 * AlanineId generated by hbm2java
 */
public class AlanineId implements java.io.Serializable {

	private Integer alanineId;
	...
	public AlanineId(Integer alanineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAlanineId() {
		return this.alanineId;
	}

	public void setAlanineId(Integer alanineId) {
		this.alanineId = alanineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlanineId))
			return false;
		AlanineId castOther = (AlanineId) other;

		return ((this.getAlanineId() == castOther.getAlanineId()) || (this
				.getAlanineId() != null && castOther.getAlanineId() != null && this
				.getAlanineId().equals(castOther.getAlanineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getAlanineId() == null ? 0 : this.getAlanineId().hashCode());
		result = 37 * result
