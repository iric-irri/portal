...
/**
 * NuclearChromosomeId generated by hbm2java
 */
public class NuclearChromosomeId implements java.io.Serializable {

	private Integer nuclearChromosomeId;
	...
	public NuclearChromosomeId() {
	}

	public NuclearChromosomeId(Integer nuclearChromosomeId, Integer featureId,
		...
		this.nuclearChromosomeId = nuclearChromosomeId;
	...
	public Integer getNuclearChromosomeId() {
		return this.nuclearChromosomeId;
	}

	public void setNuclearChromosomeId(Integer nuclearChromosomeId) {
		this.nuclearChromosomeId = nuclearChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearChromosomeId))
			return false;
		NuclearChromosomeId castOther = (NuclearChromosomeId) other;

		return ((this.getNuclearChromosomeId() == castOther
				.getNuclearChromosomeId()) || (this.getNuclearChromosomeId() != null
				&& castOther.getNuclearChromosomeId() != null && this
				.getNuclearChromosomeId().equals(
						castOther.getNuclearChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearChromosomeId() == null ? 0 : this
						.getNuclearChromosomeId().hashCode());
		result = 37 * result
