...
/**
 * CrypticSpliceSiteVariantId generated by hbm2java
 */
public class CrypticSpliceSiteVariantId implements java.io.Serializable {

	private Integer crypticSpliceSiteVariantId;
	...
	public CrypticSpliceSiteVariantId() {
	}

	public CrypticSpliceSiteVariantId(Integer crypticSpliceSiteVariantId,
		...
		this.crypticSpliceSiteVariantId = crypticSpliceSiteVariantId;
	...
	public Integer getCrypticSpliceSiteVariantId() {
		return this.crypticSpliceSiteVariantId;
	}

	public void setCrypticSpliceSiteVariantId(Integer crypticSpliceSiteVariantId) {
		this.crypticSpliceSiteVariantId = crypticSpliceSiteVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticSpliceSiteVariantId))
			return false;
		CrypticSpliceSiteVariantId castOther = (CrypticSpliceSiteVariantId) other;

		return ((this.getCrypticSpliceSiteVariantId() == castOther
				.getCrypticSpliceSiteVariantId()) || (this
				.getCrypticSpliceSiteVariantId() != null
				&& castOther.getCrypticSpliceSiteVariantId() != null && this
				.getCrypticSpliceSiteVariantId().equals(
						castOther.getCrypticSpliceSiteVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticSpliceSiteVariantId() == null ? 0 : this
						.getCrypticSpliceSiteVariantId().hashCode());
		result = 37 * result
