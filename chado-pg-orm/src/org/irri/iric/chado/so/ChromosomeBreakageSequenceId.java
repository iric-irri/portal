...
/**
 * ChromosomeBreakageSequenceId generated by hbm2java
 */
public class ChromosomeBreakageSequenceId implements java.io.Serializable {

	private Integer chromosomeBreakageSequenceId;
	...
	public ChromosomeBreakageSequenceId() {
	}

	public ChromosomeBreakageSequenceId(Integer chromosomeBreakageSequenceId,
		...
		this.chromosomeBreakageSequenceId = chromosomeBreakageSequenceId;
	...
	public Integer getChromosomeBreakageSequenceId() {
		return this.chromosomeBreakageSequenceId;
	}

	public void setChromosomeBreakageSequenceId(
			Integer chromosomeBreakageSequenceId) {
		this.chromosomeBreakageSequenceId = chromosomeBreakageSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomeBreakageSequenceId))
			return false;
		ChromosomeBreakageSequenceId castOther = (ChromosomeBreakageSequenceId) other;

		return ((this.getChromosomeBreakageSequenceId() == castOther
				.getChromosomeBreakageSequenceId()) || (this
				.getChromosomeBreakageSequenceId() != null
				&& castOther.getChromosomeBreakageSequenceId() != null && this
				.getChromosomeBreakageSequenceId().equals(
						castOther.getChromosomeBreakageSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomeBreakageSequenceId() == null ? 0 : this
						.getChromosomeBreakageSequenceId().hashCode());
		result = 37 * result
