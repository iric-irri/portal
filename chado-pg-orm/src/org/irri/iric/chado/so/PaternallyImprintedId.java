...
/**
 * PaternallyImprintedId generated by hbm2java
 */
public class PaternallyImprintedId implements java.io.Serializable {

	private Integer paternallyImprintedId;
	...
	public PaternallyImprintedId() {
	}

	public PaternallyImprintedId(Integer paternallyImprintedId,
		...
		this.paternallyImprintedId = paternallyImprintedId;
	...
	public Integer getPaternallyImprintedId() {
		return this.paternallyImprintedId;
	}

	public void setPaternallyImprintedId(Integer paternallyImprintedId) {
		this.paternallyImprintedId = paternallyImprintedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaternallyImprintedId))
			return false;
		PaternallyImprintedId castOther = (PaternallyImprintedId) other;

		return ((this.getPaternallyImprintedId() == castOther
				.getPaternallyImprintedId()) || (this
				.getPaternallyImprintedId() != null
				&& castOther.getPaternallyImprintedId() != null && this
				.getPaternallyImprintedId().equals(
						castOther.getPaternallyImprintedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPaternallyImprintedId() == null ? 0 : this
						.getPaternallyImprintedId().hashCode());
		result = 37 * result
