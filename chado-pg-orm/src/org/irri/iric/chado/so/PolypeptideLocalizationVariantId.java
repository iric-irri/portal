...
/**
 * PolypeptideLocalizationVariantId generated by hbm2java
 */
public class PolypeptideLocalizationVariantId implements java.io.Serializable {

	private Integer polypeptideLocalizationVariantId;
	...
	public PolypeptideLocalizationVariantId() {
	}

	public PolypeptideLocalizationVariantId(
			Integer polypeptideLocalizationVariantId, Integer featureId,
		...
		this.polypeptideLocalizationVariantId = polypeptideLocalizationVariantId;
	...
	public Integer getPolypeptideLocalizationVariantId() {
		return this.polypeptideLocalizationVariantId;
	}

	public void setPolypeptideLocalizationVariantId(
			Integer polypeptideLocalizationVariantId) {
		this.polypeptideLocalizationVariantId = polypeptideLocalizationVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideLocalizationVariantId))
			return false;
		PolypeptideLocalizationVariantId castOther = (PolypeptideLocalizationVariantId) other;

		return ((this.getPolypeptideLocalizationVariantId() == castOther
				.getPolypeptideLocalizationVariantId()) || (this
				.getPolypeptideLocalizationVariantId() != null
				&& castOther.getPolypeptideLocalizationVariantId() != null && this
				.getPolypeptideLocalizationVariantId().equals(
						castOther.getPolypeptideLocalizationVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideLocalizationVariantId() == null ? 0 : this
						.getPolypeptideLocalizationVariantId().hashCode());
		result = 37 * result
