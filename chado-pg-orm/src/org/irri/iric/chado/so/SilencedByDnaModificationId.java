...
/**
 * SilencedByDnaModificationId generated by hbm2java
 */
public class SilencedByDnaModificationId implements java.io.Serializable {

	private Integer silencedByDnaModificationId;
	...
	public SilencedByDnaModificationId() {
	}

	public SilencedByDnaModificationId(Integer silencedByDnaModificationId,
		...
		this.silencedByDnaModificationId = silencedByDnaModificationId;
	...
	public Integer getSilencedByDnaModificationId() {
		return this.silencedByDnaModificationId;
	}

	public void setSilencedByDnaModificationId(
			Integer silencedByDnaModificationId) {
		this.silencedByDnaModificationId = silencedByDnaModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByDnaModificationId))
			return false;
		SilencedByDnaModificationId castOther = (SilencedByDnaModificationId) other;

		return ((this.getSilencedByDnaModificationId() == castOther
				.getSilencedByDnaModificationId()) || (this
				.getSilencedByDnaModificationId() != null
				&& castOther.getSilencedByDnaModificationId() != null && this
				.getSilencedByDnaModificationId().equals(
						castOther.getSilencedByDnaModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByDnaModificationId() == null ? 0 : this
						.getSilencedByDnaModificationId().hashCode());
		result = 37 * result
