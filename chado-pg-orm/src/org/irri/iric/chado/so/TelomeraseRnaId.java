...
/**
 * TelomeraseRnaId generated by hbm2java
 */
public class TelomeraseRnaId implements java.io.Serializable {

	private Integer telomeraseRnaId;
	...
	public TelomeraseRnaId() {
	}

	public TelomeraseRnaId(Integer telomeraseRnaId, Integer featureId,
		...
		this.telomeraseRnaId = telomeraseRnaId;
	...
	public Integer getTelomeraseRnaId() {
		return this.telomeraseRnaId;
	}

	public void setTelomeraseRnaId(Integer telomeraseRnaId) {
		this.telomeraseRnaId = telomeraseRnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TelomeraseRnaId))
			return false;
		TelomeraseRnaId castOther = (TelomeraseRnaId) other;

		return ((this.getTelomeraseRnaId() == castOther.getTelomeraseRnaId()) || (this
				.getTelomeraseRnaId() != null
				&& castOther.getTelomeraseRnaId() != null && this
				.getTelomeraseRnaId().equals(castOther.getTelomeraseRnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTelomeraseRnaId() == null ? 0 : this.getTelomeraseRnaId()
						.hashCode());
		result = 37 * result
