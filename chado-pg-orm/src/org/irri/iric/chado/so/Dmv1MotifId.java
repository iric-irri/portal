...
/**
 * Dmv1MotifId generated by hbm2java
 */
public class Dmv1MotifId implements java.io.Serializable {

	private Integer dmv1MotifId;
	...
	public Dmv1MotifId(Integer dmv1MotifId, Integer featureId,
	...
	public Integer getDmv1MotifId() {
		return this.dmv1MotifId;
	}

	public void setDmv1MotifId(Integer dmv1MotifId) {
		this.dmv1MotifId = dmv1MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Dmv1MotifId))
			return false;
		Dmv1MotifId castOther = (Dmv1MotifId) other;

		return ((this.getDmv1MotifId() == castOther.getDmv1MotifId()) || (this
				.getDmv1MotifId() != null && castOther.getDmv1MotifId() != null && this
				.getDmv1MotifId().equals(castOther.getDmv1MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDmv1MotifId() == null ? 0 : this.getDmv1MotifId()
						.hashCode());
		result = 37 * result
