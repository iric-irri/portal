...
/**
 * MrnaRecodedByTranslationalBypassId generated by hbm2java
 */
public class MrnaRecodedByTranslationalBypassId implements java.io.Serializable {

	private Integer mrnaRecodedByTranslationalBypassId;
	...
	public MrnaRecodedByTranslationalBypassId() {
	}

	public MrnaRecodedByTranslationalBypassId(
			Integer mrnaRecodedByTranslationalBypassId, Integer featureId,
		...
		this.mrnaRecodedByTranslationalBypassId = mrnaRecodedByTranslationalBypassId;
	...
	public Integer getMrnaRecodedByTranslationalBypassId() {
		return this.mrnaRecodedByTranslationalBypassId;
	}

	public void setMrnaRecodedByTranslationalBypassId(
			Integer mrnaRecodedByTranslationalBypassId) {
		this.mrnaRecodedByTranslationalBypassId = mrnaRecodedByTranslationalBypassId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MrnaRecodedByTranslationalBypassId))
			return false;
		MrnaRecodedByTranslationalBypassId castOther = (MrnaRecodedByTranslationalBypassId) other;

		return ((this.getMrnaRecodedByTranslationalBypassId() == castOther
				.getMrnaRecodedByTranslationalBypassId()) || (this
				.getMrnaRecodedByTranslationalBypassId() != null
				&& castOther.getMrnaRecodedByTranslationalBypassId() != null && this
				.getMrnaRecodedByTranslationalBypassId().equals(
						castOther.getMrnaRecodedByTranslationalBypassId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMrnaRecodedByTranslationalBypassId() == null ? 0 : this
						.getMrnaRecodedByTranslationalBypassId().hashCode());
		result = 37 * result
