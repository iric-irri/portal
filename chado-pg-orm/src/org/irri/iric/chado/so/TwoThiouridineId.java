...
/**
 * TwoThiouridineId generated by hbm2java
 */
public class TwoThiouridineId implements java.io.Serializable {

	private Integer twoThiouridineId;
	...
	public TwoThiouridineId() {
	}

	public TwoThiouridineId(Integer twoThiouridineId, Integer featureId,
		...
		this.twoThiouridineId = twoThiouridineId;
	...
	public Integer getTwoThiouridineId() {
		return this.twoThiouridineId;
	}

	public void setTwoThiouridineId(Integer twoThiouridineId) {
		this.twoThiouridineId = twoThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoThiouridineId))
			return false;
		TwoThiouridineId castOther = (TwoThiouridineId) other;

		return ((this.getTwoThiouridineId() == castOther.getTwoThiouridineId()) || (this
				.getTwoThiouridineId() != null
				&& castOther.getTwoThiouridineId() != null && this
				.getTwoThiouridineId().equals(castOther.getTwoThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoThiouridineId() == null ? 0 : this
						.getTwoThiouridineId().hashCode());
		result = 37 * result
