...
/**
 * GeneToGeneFeatureId generated by hbm2java
 */
public class GeneToGeneFeatureId implements java.io.Serializable {

	private Integer geneToGeneFeatureId;
	...
	public GeneToGeneFeatureId() {
	}

	public GeneToGeneFeatureId(Integer geneToGeneFeatureId, Integer featureId,
		...
		this.geneToGeneFeatureId = geneToGeneFeatureId;
	...
	public Integer getGeneToGeneFeatureId() {
		return this.geneToGeneFeatureId;
	}

	public void setGeneToGeneFeatureId(Integer geneToGeneFeatureId) {
		this.geneToGeneFeatureId = geneToGeneFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneToGeneFeatureId))
			return false;
		GeneToGeneFeatureId castOther = (GeneToGeneFeatureId) other;

		return ((this.getGeneToGeneFeatureId() == castOther
				.getGeneToGeneFeatureId()) || (this.getGeneToGeneFeatureId() != null
				&& castOther.getGeneToGeneFeatureId() != null && this
				.getGeneToGeneFeatureId().equals(
						castOther.getGeneToGeneFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneToGeneFeatureId() == null ? 0 : this
						.getGeneToGeneFeatureId().hashCode());
		result = 37 * result
