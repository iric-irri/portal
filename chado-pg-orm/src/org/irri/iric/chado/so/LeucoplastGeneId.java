...
/**
 * LeucoplastGeneId generated by hbm2java
 */
public class LeucoplastGeneId implements java.io.Serializable {

	private Integer leucoplastGeneId;
	...
	public LeucoplastGeneId() {
	}

	public LeucoplastGeneId(Integer leucoplastGeneId, Integer featureId,
		...
		this.leucoplastGeneId = leucoplastGeneId;
	...
	public Integer getLeucoplastGeneId() {
		return this.leucoplastGeneId;
	}

	public void setLeucoplastGeneId(Integer leucoplastGeneId) {
		this.leucoplastGeneId = leucoplastGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucoplastGeneId))
			return false;
		LeucoplastGeneId castOther = (LeucoplastGeneId) other;

		return ((this.getLeucoplastGeneId() == castOther.getLeucoplastGeneId()) || (this
				.getLeucoplastGeneId() != null
				&& castOther.getLeucoplastGeneId() != null && this
				.getLeucoplastGeneId().equals(castOther.getLeucoplastGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeucoplastGeneId() == null ? 0 : this
						.getLeucoplastGeneId().hashCode());
		result = 37 * result
