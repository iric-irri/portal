...
/**
 * NonCanonicalFivePrimeSpliceSiteId generated by hbm2java
 */
public class NonCanonicalFivePrimeSpliceSiteId implements java.io.Serializable {

	private Integer nonCanonicalFivePrimeSpliceSiteId;
	...
	public NonCanonicalFivePrimeSpliceSiteId() {
	}

	public NonCanonicalFivePrimeSpliceSiteId(
			Integer nonCanonicalFivePrimeSpliceSiteId, Integer featureId,
		...
		this.nonCanonicalFivePrimeSpliceSiteId = nonCanonicalFivePrimeSpliceSiteId;
	...
	public Integer getNonCanonicalFivePrimeSpliceSiteId() {
		return this.nonCanonicalFivePrimeSpliceSiteId;
	}

	public void setNonCanonicalFivePrimeSpliceSiteId(
			Integer nonCanonicalFivePrimeSpliceSiteId) {
		this.nonCanonicalFivePrimeSpliceSiteId = nonCanonicalFivePrimeSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonCanonicalFivePrimeSpliceSiteId))
			return false;
		NonCanonicalFivePrimeSpliceSiteId castOther = (NonCanonicalFivePrimeSpliceSiteId) other;

		return ((this.getNonCanonicalFivePrimeSpliceSiteId() == castOther
				.getNonCanonicalFivePrimeSpliceSiteId()) || (this
				.getNonCanonicalFivePrimeSpliceSiteId() != null
				&& castOther.getNonCanonicalFivePrimeSpliceSiteId() != null && this
				.getNonCanonicalFivePrimeSpliceSiteId().equals(
						castOther.getNonCanonicalFivePrimeSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonCanonicalFivePrimeSpliceSiteId() == null ? 0 : this
						.getNonCanonicalFivePrimeSpliceSiteId().hashCode());
		result = 37 * result
