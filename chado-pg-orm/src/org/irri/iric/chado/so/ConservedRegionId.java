...
/**
 * ConservedRegionId generated by hbm2java
 */
public class ConservedRegionId implements java.io.Serializable {

	private Integer conservedRegionId;
	...
	public ConservedRegionId() {
	}

	public ConservedRegionId(Integer conservedRegionId, Integer featureId,
	...
	public Integer getConservedRegionId() {
		return this.conservedRegionId;
	}

	public void setConservedRegionId(Integer conservedRegionId) {
		this.conservedRegionId = conservedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ConservedRegionId))
			return false;
		ConservedRegionId castOther = (ConservedRegionId) other;

		return ((this.getConservedRegionId() == castOther
				.getConservedRegionId()) || (this.getConservedRegionId() != null
				&& castOther.getConservedRegionId() != null && this
				.getConservedRegionId()
				.equals(castOther.getConservedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getConservedRegionId() == null ? 0 : this
						.getConservedRegionId().hashCode());
		result = 37 * result
