...
/**
 * FivePrimeUstId generated by hbm2java
 */
public class FivePrimeUstId implements java.io.Serializable {

	private Integer fivePrimeUstId;
	...
	public FivePrimeUstId() {
	}

	public FivePrimeUstId(Integer fivePrimeUstId, Integer featureId,
		...
		this.fivePrimeUstId = fivePrimeUstId;
	...
	public Integer getFivePrimeUstId() {
		return this.fivePrimeUstId;
	}

	public void setFivePrimeUstId(Integer fivePrimeUstId) {
		this.fivePrimeUstId = fivePrimeUstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeUstId))
			return false;
		FivePrimeUstId castOther = (FivePrimeUstId) other;

		return ((this.getFivePrimeUstId() == castOther.getFivePrimeUstId()) || (this
				.getFivePrimeUstId() != null
				&& castOther.getFivePrimeUstId() != null && this
				.getFivePrimeUstId().equals(castOther.getFivePrimeUstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeUstId() == null ? 0 : this.getFivePrimeUstId()
						.hashCode());
		result = 37 * result
