...
/**
 * OpenChromatinRegionId generated by hbm2java
 */
public class OpenChromatinRegionId implements java.io.Serializable {

	private Integer openChromatinRegionId;
	...
	public OpenChromatinRegionId() {
	}

	public OpenChromatinRegionId(Integer openChromatinRegionId,
		...
		this.openChromatinRegionId = openChromatinRegionId;
	...
	public Integer getOpenChromatinRegionId() {
		return this.openChromatinRegionId;
	}

	public void setOpenChromatinRegionId(Integer openChromatinRegionId) {
		this.openChromatinRegionId = openChromatinRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OpenChromatinRegionId))
			return false;
		OpenChromatinRegionId castOther = (OpenChromatinRegionId) other;

		return ((this.getOpenChromatinRegionId() == castOther
				.getOpenChromatinRegionId()) || (this
				.getOpenChromatinRegionId() != null
				&& castOther.getOpenChromatinRegionId() != null && this
				.getOpenChromatinRegionId().equals(
						castOther.getOpenChromatinRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOpenChromatinRegionId() == null ? 0 : this
						.getOpenChromatinRegionId().hashCode());
		result = 37 * result
