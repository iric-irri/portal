...
/**
 * HyperploidId generated by hbm2java
 */
public class HyperploidId implements java.io.Serializable {

	private Integer hyperploidId;
	...
	public HyperploidId(Integer hyperploidId, Integer featureId,
		...
		this.hyperploidId = hyperploidId;
	...
	public Integer getHyperploidId() {
		return this.hyperploidId;
	}

	public void setHyperploidId(Integer hyperploidId) {
		this.hyperploidId = hyperploidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HyperploidId))
			return false;
		HyperploidId castOther = (HyperploidId) other;

		return ((this.getHyperploidId() == castOther.getHyperploidId()) || (this
				.getHyperploidId() != null
				&& castOther.getHyperploidId() != null && this
				.getHyperploidId().equals(castOther.getHyperploidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHyperploidId() == null ? 0 : this.getHyperploidId()
						.hashCode());
		result = 37 * result
