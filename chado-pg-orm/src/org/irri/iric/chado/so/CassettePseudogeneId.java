...
/**
 * CassettePseudogeneId generated by hbm2java
 */
public class CassettePseudogeneId implements java.io.Serializable {

	private Integer cassettePseudogeneId;
	...
	public CassettePseudogeneId() {
	}

	public CassettePseudogeneId(Integer cassettePseudogeneId,
		...
		this.cassettePseudogeneId = cassettePseudogeneId;
	...
	public Integer getCassettePseudogeneId() {
		return this.cassettePseudogeneId;
	}

	public void setCassettePseudogeneId(Integer cassettePseudogeneId) {
		this.cassettePseudogeneId = cassettePseudogeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CassettePseudogeneId))
			return false;
		CassettePseudogeneId castOther = (CassettePseudogeneId) other;

		return ((this.getCassettePseudogeneId() == castOther
				.getCassettePseudogeneId()) || (this.getCassettePseudogeneId() != null
				&& castOther.getCassettePseudogeneId() != null && this
				.getCassettePseudogeneId().equals(
						castOther.getCassettePseudogeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCassettePseudogeneId() == null ? 0 : this
						.getCassettePseudogeneId().hashCode());
		result = 37 * result
