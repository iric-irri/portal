...
/**
 * SoForeignId generated by hbm2java
 */
public class SoForeignId implements java.io.Serializable {

	private Integer soForeignId;
	...
	public SoForeignId(Integer soForeignId, Integer featureId,
	...
	public Integer getSoForeignId() {
		return this.soForeignId;
	}

	public void setSoForeignId(Integer soForeignId) {
		this.soForeignId = soForeignId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SoForeignId))
			return false;
		SoForeignId castOther = (SoForeignId) other;

		return ((this.getSoForeignId() == castOther.getSoForeignId()) || (this
				.getSoForeignId() != null && castOther.getSoForeignId() != null && this
				.getSoForeignId().equals(castOther.getSoForeignId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSoForeignId() == null ? 0 : this.getSoForeignId()
						.hashCode());
		result = 37 * result
