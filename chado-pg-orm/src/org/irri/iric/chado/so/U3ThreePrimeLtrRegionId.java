...
/**
 * U3ThreePrimeLtrRegionId generated by hbm2java
 */
public class U3ThreePrimeLtrRegionId implements java.io.Serializable {

	private Integer u3ThreePrimeLtrRegionId;
	...
	public U3ThreePrimeLtrRegionId() {
	}

	public U3ThreePrimeLtrRegionId(Integer u3ThreePrimeLtrRegionId,
		...
		this.u3ThreePrimeLtrRegionId = u3ThreePrimeLtrRegionId;
	...
	public Integer getU3ThreePrimeLtrRegionId() {
		return this.u3ThreePrimeLtrRegionId;
	}

	public void setU3ThreePrimeLtrRegionId(Integer u3ThreePrimeLtrRegionId) {
		this.u3ThreePrimeLtrRegionId = u3ThreePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U3ThreePrimeLtrRegionId))
			return false;
		U3ThreePrimeLtrRegionId castOther = (U3ThreePrimeLtrRegionId) other;

		return ((this.getU3ThreePrimeLtrRegionId() == castOther
				.getU3ThreePrimeLtrRegionId()) || (this
				.getU3ThreePrimeLtrRegionId() != null
				&& castOther.getU3ThreePrimeLtrRegionId() != null && this
				.getU3ThreePrimeLtrRegionId().equals(
						castOther.getU3ThreePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU3ThreePrimeLtrRegionId() == null ? 0 : this
						.getU3ThreePrimeLtrRegionId().hashCode());
		result = 37 * result
