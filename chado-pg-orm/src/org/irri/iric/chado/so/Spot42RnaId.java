...
/**
 * Spot42RnaId generated by hbm2java
 */
public class Spot42RnaId implements java.io.Serializable {

	private Integer spot42RnaId;
	...
	public Spot42RnaId(Integer spot42RnaId, Integer featureId,
	...
	public Integer getSpot42RnaId() {
		return this.spot42RnaId;
	}

	public void setSpot42RnaId(Integer spot42RnaId) {
		this.spot42RnaId = spot42RnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Spot42RnaId))
			return false;
		Spot42RnaId castOther = (Spot42RnaId) other;

		return ((this.getSpot42RnaId() == castOther.getSpot42RnaId()) || (this
				.getSpot42RnaId() != null && castOther.getSpot42RnaId() != null && this
				.getSpot42RnaId().equals(castOther.getSpot42RnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpot42RnaId() == null ? 0 : this.getSpot42RnaId()
						.hashCode());
		result = 37 * result
