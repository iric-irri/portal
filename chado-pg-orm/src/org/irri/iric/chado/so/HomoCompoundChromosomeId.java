...
/**
 * HomoCompoundChromosomeId generated by hbm2java
 */
public class HomoCompoundChromosomeId implements java.io.Serializable {

	private Integer homoCompoundChromosomeId;
	...
	public HomoCompoundChromosomeId() {
	}

	public HomoCompoundChromosomeId(Integer homoCompoundChromosomeId,
		...
		this.homoCompoundChromosomeId = homoCompoundChromosomeId;
	...
	public Integer getHomoCompoundChromosomeId() {
		return this.homoCompoundChromosomeId;
	}

	public void setHomoCompoundChromosomeId(Integer homoCompoundChromosomeId) {
		this.homoCompoundChromosomeId = homoCompoundChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HomoCompoundChromosomeId))
			return false;
		HomoCompoundChromosomeId castOther = (HomoCompoundChromosomeId) other;

		return ((this.getHomoCompoundChromosomeId() == castOther
				.getHomoCompoundChromosomeId()) || (this
				.getHomoCompoundChromosomeId() != null
				&& castOther.getHomoCompoundChromosomeId() != null && this
				.getHomoCompoundChromosomeId().equals(
						castOther.getHomoCompoundChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHomoCompoundChromosomeId() == null ? 0 : this
						.getHomoCompoundChromosomeId().hashCode());
		result = 37 * result
