...
/**
 * HaplotypeBlockId generated by hbm2java
 */
public class HaplotypeBlockId implements java.io.Serializable {

	private Integer haplotypeBlockId;
	...
	public HaplotypeBlockId() {
	}

	public HaplotypeBlockId(Integer haplotypeBlockId, Integer featureId,
		...
		this.haplotypeBlockId = haplotypeBlockId;
	...
	public Integer getHaplotypeBlockId() {
		return this.haplotypeBlockId;
	}

	public void setHaplotypeBlockId(Integer haplotypeBlockId) {
		this.haplotypeBlockId = haplotypeBlockId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HaplotypeBlockId))
			return false;
		HaplotypeBlockId castOther = (HaplotypeBlockId) other;

		return ((this.getHaplotypeBlockId() == castOther.getHaplotypeBlockId()) || (this
				.getHaplotypeBlockId() != null
				&& castOther.getHaplotypeBlockId() != null && this
				.getHaplotypeBlockId().equals(castOther.getHaplotypeBlockId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHaplotypeBlockId() == null ? 0 : this
						.getHaplotypeBlockId().hashCode());
		result = 37 * result
