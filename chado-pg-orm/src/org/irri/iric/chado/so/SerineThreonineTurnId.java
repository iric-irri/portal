...
/**
 * SerineThreonineTurnId generated by hbm2java
 */
public class SerineThreonineTurnId implements java.io.Serializable {

	private Integer serineThreonineTurnId;
	...
	public SerineThreonineTurnId() {
	}

	public SerineThreonineTurnId(Integer serineThreonineTurnId,
		...
		this.serineThreonineTurnId = serineThreonineTurnId;
	...
	public Integer getSerineThreonineTurnId() {
		return this.serineThreonineTurnId;
	}

	public void setSerineThreonineTurnId(Integer serineThreonineTurnId) {
		this.serineThreonineTurnId = serineThreonineTurnId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerineThreonineTurnId))
			return false;
		SerineThreonineTurnId castOther = (SerineThreonineTurnId) other;

		return ((this.getSerineThreonineTurnId() == castOther
				.getSerineThreonineTurnId()) || (this
				.getSerineThreonineTurnId() != null
				&& castOther.getSerineThreonineTurnId() != null && this
				.getSerineThreonineTurnId().equals(
						castOther.getSerineThreonineTurnId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSerineThreonineTurnId() == null ? 0 : this
						.getSerineThreonineTurnId().hashCode());
		result = 37 * result
