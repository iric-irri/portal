...
/**
 * PolypeptideStructuralMotifId generated by hbm2java
 */
public class PolypeptideStructuralMotifId implements java.io.Serializable {

	private Integer polypeptideStructuralMotifId;
	...
	public PolypeptideStructuralMotifId() {
	}

	public PolypeptideStructuralMotifId(Integer polypeptideStructuralMotifId,
		...
		this.polypeptideStructuralMotifId = polypeptideStructuralMotifId;
	...
	public Integer getPolypeptideStructuralMotifId() {
		return this.polypeptideStructuralMotifId;
	}

	public void setPolypeptideStructuralMotifId(
			Integer polypeptideStructuralMotifId) {
		this.polypeptideStructuralMotifId = polypeptideStructuralMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideStructuralMotifId))
			return false;
		PolypeptideStructuralMotifId castOther = (PolypeptideStructuralMotifId) other;

		return ((this.getPolypeptideStructuralMotifId() == castOther
				.getPolypeptideStructuralMotifId()) || (this
				.getPolypeptideStructuralMotifId() != null
				&& castOther.getPolypeptideStructuralMotifId() != null && this
				.getPolypeptideStructuralMotifId().equals(
						castOther.getPolypeptideStructuralMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideStructuralMotifId() == null ? 0 : this
						.getPolypeptideStructuralMotifId().hashCode());
		result = 37 * result
