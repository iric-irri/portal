...
/**
 * CysteineId generated by hbm2java
 */
public class CysteineId implements java.io.Serializable {

	private Integer cysteineId;
	...
	public CysteineId(Integer cysteineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCysteineId() {
		return this.cysteineId;
	}

	public void setCysteineId(Integer cysteineId) {
		this.cysteineId = cysteineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CysteineId))
			return false;
		CysteineId castOther = (CysteineId) other;

		return ((this.getCysteineId() == castOther.getCysteineId()) || (this
				.getCysteineId() != null && castOther.getCysteineId() != null && this
				.getCysteineId().equals(castOther.getCysteineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCysteineId() == null ? 0 : this.getCysteineId()
						.hashCode());
		result = 37 * result
