...
/**
 * InvertedRepeatId generated by hbm2java
 */
public class InvertedRepeatId implements java.io.Serializable {

	private Integer invertedRepeatId;
	...
	public InvertedRepeatId() {
	}

	public InvertedRepeatId(Integer invertedRepeatId, Integer featureId,
		...
		this.invertedRepeatId = invertedRepeatId;
	...
	public Integer getInvertedRepeatId() {
		return this.invertedRepeatId;
	}

	public void setInvertedRepeatId(Integer invertedRepeatId) {
		this.invertedRepeatId = invertedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvertedRepeatId))
			return false;
		InvertedRepeatId castOther = (InvertedRepeatId) other;

		return ((this.getInvertedRepeatId() == castOther.getInvertedRepeatId()) || (this
				.getInvertedRepeatId() != null
				&& castOther.getInvertedRepeatId() != null && this
				.getInvertedRepeatId().equals(castOther.getInvertedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvertedRepeatId() == null ? 0 : this
						.getInvertedRepeatId().hashCode());
		result = 37 * result
