...
/**
 * IdnaId generated by hbm2java
 */
public class IdnaId implements java.io.Serializable {

	private Integer idnaId;
	...
	public IdnaId(Integer idnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIdnaId() {
		return this.idnaId;
	}

	public void setIdnaId(Integer idnaId) {
		this.idnaId = idnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IdnaId))
			return false;
		IdnaId castOther = (IdnaId) other;

		return ((this.getIdnaId() == castOther.getIdnaId()) || (this
				.getIdnaId() != null && castOther.getIdnaId() != null && this
				.getIdnaId().equals(castOther.getIdnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getIdnaId() == null ? 0 : this.getIdnaId().hashCode());
		result = 37 * result
