...
/**
 * Ndm2MotifId generated by hbm2java
 */
public class Ndm2MotifId implements java.io.Serializable {

	private Integer ndm2MotifId;
	...
	public Ndm2MotifId(Integer ndm2MotifId, Integer featureId,
	...
	public Integer getNdm2MotifId() {
		return this.ndm2MotifId;
	}

	public void setNdm2MotifId(Integer ndm2MotifId) {
		this.ndm2MotifId = ndm2MotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Ndm2MotifId))
			return false;
		Ndm2MotifId castOther = (Ndm2MotifId) other;

		return ((this.getNdm2MotifId() == castOther.getNdm2MotifId()) || (this
				.getNdm2MotifId() != null && castOther.getNdm2MotifId() != null && this
				.getNdm2MotifId().equals(castOther.getNdm2MotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNdm2MotifId() == null ? 0 : this.getNdm2MotifId()
						.hashCode());
		result = 37 * result
