...
/**
 * BetaBulgeLoopSixId generated by hbm2java
 */
public class BetaBulgeLoopSixId implements java.io.Serializable {

	private Integer betaBulgeLoopSixId;
	...
	public BetaBulgeLoopSixId() {
	}

	public BetaBulgeLoopSixId(Integer betaBulgeLoopSixId, Integer featureId,
		...
		this.betaBulgeLoopSixId = betaBulgeLoopSixId;
	...
	public Integer getBetaBulgeLoopSixId() {
		return this.betaBulgeLoopSixId;
	}

	public void setBetaBulgeLoopSixId(Integer betaBulgeLoopSixId) {
		this.betaBulgeLoopSixId = betaBulgeLoopSixId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaBulgeLoopSixId))
			return false;
		BetaBulgeLoopSixId castOther = (BetaBulgeLoopSixId) other;

		return ((this.getBetaBulgeLoopSixId() == castOther
				.getBetaBulgeLoopSixId()) || (this.getBetaBulgeLoopSixId() != null
				&& castOther.getBetaBulgeLoopSixId() != null && this
				.getBetaBulgeLoopSixId().equals(
						castOther.getBetaBulgeLoopSixId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaBulgeLoopSixId() == null ? 0 : this
						.getBetaBulgeLoopSixId().hashCode());
		result = 37 * result
