...
/**
 * ThreePrimeFlankingRegionId generated by hbm2java
 */
public class ThreePrimeFlankingRegionId implements java.io.Serializable {

	private Integer threePrimeFlankingRegionId;
	...
	public ThreePrimeFlankingRegionId() {
	}

	public ThreePrimeFlankingRegionId(Integer threePrimeFlankingRegionId,
		...
		this.threePrimeFlankingRegionId = threePrimeFlankingRegionId;
	...
	public Integer getThreePrimeFlankingRegionId() {
		return this.threePrimeFlankingRegionId;
	}

	public void setThreePrimeFlankingRegionId(Integer threePrimeFlankingRegionId) {
		this.threePrimeFlankingRegionId = threePrimeFlankingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeFlankingRegionId))
			return false;
		ThreePrimeFlankingRegionId castOther = (ThreePrimeFlankingRegionId) other;

		return ((this.getThreePrimeFlankingRegionId() == castOther
				.getThreePrimeFlankingRegionId()) || (this
				.getThreePrimeFlankingRegionId() != null
				&& castOther.getThreePrimeFlankingRegionId() != null && this
				.getThreePrimeFlankingRegionId().equals(
						castOther.getThreePrimeFlankingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeFlankingRegionId() == null ? 0 : this
						.getThreePrimeFlankingRegionId().hashCode());
		result = 37 * result
