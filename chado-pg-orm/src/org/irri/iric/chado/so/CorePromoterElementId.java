...
/**
 * CorePromoterElementId generated by hbm2java
 */
public class CorePromoterElementId implements java.io.Serializable {

	private Integer corePromoterElementId;
	...
	public CorePromoterElementId() {
	}

	public CorePromoterElementId(Integer corePromoterElementId,
		...
		this.corePromoterElementId = corePromoterElementId;
	...
	public Integer getCorePromoterElementId() {
		return this.corePromoterElementId;
	}

	public void setCorePromoterElementId(Integer corePromoterElementId) {
		this.corePromoterElementId = corePromoterElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CorePromoterElementId))
			return false;
		CorePromoterElementId castOther = (CorePromoterElementId) other;

		return ((this.getCorePromoterElementId() == castOther
				.getCorePromoterElementId()) || (this
				.getCorePromoterElementId() != null
				&& castOther.getCorePromoterElementId() != null && this
				.getCorePromoterElementId().equals(
						castOther.getCorePromoterElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCorePromoterElementId() == null ? 0 : this
						.getCorePromoterElementId().hashCode());
		result = 37 * result
