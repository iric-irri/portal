...
/**
 * MissenseCodonId generated by hbm2java
 */
public class MissenseCodonId implements java.io.Serializable {

	private Integer missenseCodonId;
	...
	public MissenseCodonId() {
	}

	public MissenseCodonId(Integer missenseCodonId, Integer featureId,
		...
		this.missenseCodonId = missenseCodonId;
	...
	public Integer getMissenseCodonId() {
		return this.missenseCodonId;
	}

	public void setMissenseCodonId(Integer missenseCodonId) {
		this.missenseCodonId = missenseCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MissenseCodonId))
			return false;
		MissenseCodonId castOther = (MissenseCodonId) other;

		return ((this.getMissenseCodonId() == castOther.getMissenseCodonId()) || (this
				.getMissenseCodonId() != null
				&& castOther.getMissenseCodonId() != null && this
				.getMissenseCodonId().equals(castOther.getMissenseCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMissenseCodonId() == null ? 0 : this.getMissenseCodonId()
						.hashCode());
		result = 37 * result
