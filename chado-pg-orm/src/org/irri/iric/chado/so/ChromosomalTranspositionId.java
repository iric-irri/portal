...
/**
 * ChromosomalTranspositionId generated by hbm2java
 */
public class ChromosomalTranspositionId implements java.io.Serializable {

	private Integer chromosomalTranspositionId;
	...
	public ChromosomalTranspositionId() {
	}

	public ChromosomalTranspositionId(Integer chromosomalTranspositionId,
		...
		this.chromosomalTranspositionId = chromosomalTranspositionId;
	...
	public Integer getChromosomalTranspositionId() {
		return this.chromosomalTranspositionId;
	}

	public void setChromosomalTranspositionId(Integer chromosomalTranspositionId) {
		this.chromosomalTranspositionId = chromosomalTranspositionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalTranspositionId))
			return false;
		ChromosomalTranspositionId castOther = (ChromosomalTranspositionId) other;

		return ((this.getChromosomalTranspositionId() == castOther
				.getChromosomalTranspositionId()) || (this
				.getChromosomalTranspositionId() != null
				&& castOther.getChromosomalTranspositionId() != null && this
				.getChromosomalTranspositionId().equals(
						castOther.getChromosomalTranspositionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalTranspositionId() == null ? 0 : this
						.getChromosomalTranspositionId().hashCode());
		result = 37 * result
