...
/**
 * SingleStrandedCdnaId generated by hbm2java
 */
public class SingleStrandedCdnaId implements java.io.Serializable {

	private Integer singleStrandedCdnaId;
	...
	public SingleStrandedCdnaId() {
	}

	public SingleStrandedCdnaId(Integer singleStrandedCdnaId,
		...
		this.singleStrandedCdnaId = singleStrandedCdnaId;
	...
	public Integer getSingleStrandedCdnaId() {
		return this.singleStrandedCdnaId;
	}

	public void setSingleStrandedCdnaId(Integer singleStrandedCdnaId) {
		this.singleStrandedCdnaId = singleStrandedCdnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SingleStrandedCdnaId))
			return false;
		SingleStrandedCdnaId castOther = (SingleStrandedCdnaId) other;

		return ((this.getSingleStrandedCdnaId() == castOther
				.getSingleStrandedCdnaId()) || (this.getSingleStrandedCdnaId() != null
				&& castOther.getSingleStrandedCdnaId() != null && this
				.getSingleStrandedCdnaId().equals(
						castOther.getSingleStrandedCdnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSingleStrandedCdnaId() == null ? 0 : this
						.getSingleStrandedCdnaId().hashCode());
		result = 37 * result
