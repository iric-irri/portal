...
/**
 * ModifiedBaseId generated by hbm2java
 */
public class ModifiedBaseId implements java.io.Serializable {

	private Integer modifiedBaseId;
	...
	public ModifiedBaseId() {
	}

	public ModifiedBaseId(Integer modifiedBaseId, Integer featureId,
		...
		this.modifiedBaseId = modifiedBaseId;
	...
	public Integer getModifiedBaseId() {
		return this.modifiedBaseId;
	}

	public void setModifiedBaseId(Integer modifiedBaseId) {
		this.modifiedBaseId = modifiedBaseId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedBaseId))
			return false;
		ModifiedBaseId castOther = (ModifiedBaseId) other;

		return ((this.getModifiedBaseId() == castOther.getModifiedBaseId()) || (this
				.getModifiedBaseId() != null
				&& castOther.getModifiedBaseId() != null && this
				.getModifiedBaseId().equals(castOther.getModifiedBaseId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedBaseId() == null ? 0 : this.getModifiedBaseId()
						.hashCode());
		result = 37 * result
