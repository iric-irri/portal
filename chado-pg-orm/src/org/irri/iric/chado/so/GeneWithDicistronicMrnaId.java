...
/**
 * GeneWithDicistronicMrnaId generated by hbm2java
 */
public class GeneWithDicistronicMrnaId implements java.io.Serializable {

	private Integer geneWithDicistronicMrnaId;
	...
	public GeneWithDicistronicMrnaId() {
	}

	public GeneWithDicistronicMrnaId(Integer geneWithDicistronicMrnaId,
		...
		this.geneWithDicistronicMrnaId = geneWithDicistronicMrnaId;
	...
	public Integer getGeneWithDicistronicMrnaId() {
		return this.geneWithDicistronicMrnaId;
	}

	public void setGeneWithDicistronicMrnaId(Integer geneWithDicistronicMrnaId) {
		this.geneWithDicistronicMrnaId = geneWithDicistronicMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithDicistronicMrnaId))
			return false;
		GeneWithDicistronicMrnaId castOther = (GeneWithDicistronicMrnaId) other;

		return ((this.getGeneWithDicistronicMrnaId() == castOther
				.getGeneWithDicistronicMrnaId()) || (this
				.getGeneWithDicistronicMrnaId() != null
				&& castOther.getGeneWithDicistronicMrnaId() != null && this
				.getGeneWithDicistronicMrnaId().equals(
						castOther.getGeneWithDicistronicMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithDicistronicMrnaId() == null ? 0 : this
						.getGeneWithDicistronicMrnaId().hashCode());
		result = 37 * result
