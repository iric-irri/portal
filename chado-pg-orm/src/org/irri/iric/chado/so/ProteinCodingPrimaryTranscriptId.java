...
/**
 * ProteinCodingPrimaryTranscriptId generated by hbm2java
 */
public class ProteinCodingPrimaryTranscriptId implements java.io.Serializable {

	private Integer proteinCodingPrimaryTranscriptId;
	...
	public ProteinCodingPrimaryTranscriptId() {
	}

	public ProteinCodingPrimaryTranscriptId(
			Integer proteinCodingPrimaryTranscriptId, Integer featureId,
		...
		this.proteinCodingPrimaryTranscriptId = proteinCodingPrimaryTranscriptId;
	...
	public Integer getProteinCodingPrimaryTranscriptId() {
		return this.proteinCodingPrimaryTranscriptId;
	}

	public void setProteinCodingPrimaryTranscriptId(
			Integer proteinCodingPrimaryTranscriptId) {
		this.proteinCodingPrimaryTranscriptId = proteinCodingPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinCodingPrimaryTranscriptId))
			return false;
		ProteinCodingPrimaryTranscriptId castOther = (ProteinCodingPrimaryTranscriptId) other;

		return ((this.getProteinCodingPrimaryTranscriptId() == castOther
				.getProteinCodingPrimaryTranscriptId()) || (this
				.getProteinCodingPrimaryTranscriptId() != null
				&& castOther.getProteinCodingPrimaryTranscriptId() != null && this
				.getProteinCodingPrimaryTranscriptId().equals(
						castOther.getProteinCodingPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinCodingPrimaryTranscriptId() == null ? 0 : this
						.getProteinCodingPrimaryTranscriptId().hashCode());
		result = 37 * result
