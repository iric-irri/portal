...
/**
 * N6AcetyladenosineId generated by hbm2java
 */
public class N6AcetyladenosineId implements java.io.Serializable {

	private Integer n6AcetyladenosineId;
	...
	public N6AcetyladenosineId() {
	}

	public N6AcetyladenosineId(Integer n6AcetyladenosineId, Integer featureId,
		...
		this.n6AcetyladenosineId = n6AcetyladenosineId;
	...
	public Integer getN6AcetyladenosineId() {
		return this.n6AcetyladenosineId;
	}

	public void setN6AcetyladenosineId(Integer n6AcetyladenosineId) {
		this.n6AcetyladenosineId = n6AcetyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6AcetyladenosineId))
			return false;
		N6AcetyladenosineId castOther = (N6AcetyladenosineId) other;

		return ((this.getN6AcetyladenosineId() == castOther
				.getN6AcetyladenosineId()) || (this.getN6AcetyladenosineId() != null
				&& castOther.getN6AcetyladenosineId() != null && this
				.getN6AcetyladenosineId().equals(
						castOther.getN6AcetyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6AcetyladenosineId() == null ? 0 : this
						.getN6AcetyladenosineId().hashCode());
		result = 37 * result
