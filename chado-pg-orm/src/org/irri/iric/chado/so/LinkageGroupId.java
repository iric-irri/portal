...
/**
 * LinkageGroupId generated by hbm2java
 */
public class LinkageGroupId implements java.io.Serializable {
	...
	public LinkageGroupId() {
	}

	public LinkageGroupId(Integer linkageGroupId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinkageGroupId))
			return false;
		LinkageGroupId castOther = (LinkageGroupId) other;

		return ((this.getLinkageGroupId() == castOther.getLinkageGroupId()) || (this
				.getLinkageGroupId() != null
				&& castOther.getLinkageGroupId() != null && this
				.getLinkageGroupId().equals(castOther.getLinkageGroupId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLinkageGroupId() == null ? 0 : this.getLinkageGroupId()
						.hashCode());
		result = 37 * result
