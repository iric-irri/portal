...
public class ExemplarId implements java.io.Serializable {
	...
	public ExemplarId(Integer exemplarId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		return ((this.getExemplarId() == castOther.getExemplarId()) || (this
				.getExemplarId() != null && castOther.getExemplarId() != null && this
				.getExemplarId().equals(castOther.getExemplarId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExemplarId() == null ? 0 : this.getExemplarId()
						.hashCode());
		result = 37 * result
