...
/**
 * ArginylTrnaId generated by hbm2java
 */
public class ArginylTrnaId implements java.io.Serializable {

	private Integer arginylTrnaId;
	...
	public ArginylTrnaId() {
	}

	public ArginylTrnaId(Integer arginylTrnaId, Integer featureId,
		...
		this.arginylTrnaId = arginylTrnaId;
	...
	public Integer getArginylTrnaId() {
		return this.arginylTrnaId;
	}

	public void setArginylTrnaId(Integer arginylTrnaId) {
		this.arginylTrnaId = arginylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArginylTrnaId))
			return false;
		ArginylTrnaId castOther = (ArginylTrnaId) other;

		return ((this.getArginylTrnaId() == castOther.getArginylTrnaId()) || (this
				.getArginylTrnaId() != null
				&& castOther.getArginylTrnaId() != null && this
				.getArginylTrnaId().equals(castOther.getArginylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getArginylTrnaId() == null ? 0 : this.getArginylTrnaId()
						.hashCode());
		result = 37 * result
