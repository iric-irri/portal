...
/**
 * InternalTranscribedSpacerRegionId generated by hbm2java
 */
public class InternalTranscribedSpacerRegionId implements java.io.Serializable {

	private Integer internalTranscribedSpacerRegionId;
	...
	public InternalTranscribedSpacerRegionId() {
	}

	public InternalTranscribedSpacerRegionId(
			Integer internalTranscribedSpacerRegionId, Integer featureId,
		...
		this.internalTranscribedSpacerRegionId = internalTranscribedSpacerRegionId;
	...
	public Integer getInternalTranscribedSpacerRegionId() {
		return this.internalTranscribedSpacerRegionId;
	}

	public void setInternalTranscribedSpacerRegionId(
			Integer internalTranscribedSpacerRegionId) {
		this.internalTranscribedSpacerRegionId = internalTranscribedSpacerRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalTranscribedSpacerRegionId))
			return false;
		InternalTranscribedSpacerRegionId castOther = (InternalTranscribedSpacerRegionId) other;

		return ((this.getInternalTranscribedSpacerRegionId() == castOther
				.getInternalTranscribedSpacerRegionId()) || (this
				.getInternalTranscribedSpacerRegionId() != null
				&& castOther.getInternalTranscribedSpacerRegionId() != null && this
				.getInternalTranscribedSpacerRegionId().equals(
						castOther.getInternalTranscribedSpacerRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalTranscribedSpacerRegionId() == null ? 0 : this
						.getInternalTranscribedSpacerRegionId().hashCode());
		result = 37 * result
