...
/**
 * ChromosomalStructuralElementId generated by hbm2java
 */
public class ChromosomalStructuralElementId implements java.io.Serializable {

	private Integer chromosomalStructuralElementId;
	...
	public ChromosomalStructuralElementId() {
	}

	public ChromosomalStructuralElementId(
			Integer chromosomalStructuralElementId, Integer featureId,
		...
		this.chromosomalStructuralElementId = chromosomalStructuralElementId;
	...
	public Integer getChromosomalStructuralElementId() {
		return this.chromosomalStructuralElementId;
	}

	public void setChromosomalStructuralElementId(
			Integer chromosomalStructuralElementId) {
		this.chromosomalStructuralElementId = chromosomalStructuralElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChromosomalStructuralElementId))
			return false;
		ChromosomalStructuralElementId castOther = (ChromosomalStructuralElementId) other;

		return ((this.getChromosomalStructuralElementId() == castOther
				.getChromosomalStructuralElementId()) || (this
				.getChromosomalStructuralElementId() != null
				&& castOther.getChromosomalStructuralElementId() != null && this
				.getChromosomalStructuralElementId().equals(
						castOther.getChromosomalStructuralElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChromosomalStructuralElementId() == null ? 0 : this
						.getChromosomalStructuralElementId().hashCode());
		result = 37 * result
