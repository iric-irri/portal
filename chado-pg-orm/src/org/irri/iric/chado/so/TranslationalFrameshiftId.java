...
/**
 * TranslationalFrameshiftId generated by hbm2java
 */
public class TranslationalFrameshiftId implements java.io.Serializable {

	private Integer translationalFrameshiftId;
	...
	public TranslationalFrameshiftId() {
	}

	public TranslationalFrameshiftId(Integer translationalFrameshiftId,
		...
		this.translationalFrameshiftId = translationalFrameshiftId;
	...
	public Integer getTranslationalFrameshiftId() {
		return this.translationalFrameshiftId;
	}

	public void setTranslationalFrameshiftId(Integer translationalFrameshiftId) {
		this.translationalFrameshiftId = translationalFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationalFrameshiftId))
			return false;
		TranslationalFrameshiftId castOther = (TranslationalFrameshiftId) other;

		return ((this.getTranslationalFrameshiftId() == castOther
				.getTranslationalFrameshiftId()) || (this
				.getTranslationalFrameshiftId() != null
				&& castOther.getTranslationalFrameshiftId() != null && this
				.getTranslationalFrameshiftId().equals(
						castOther.getTranslationalFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationalFrameshiftId() == null ? 0 : this
						.getTranslationalFrameshiftId().hashCode());
		result = 37 * result
