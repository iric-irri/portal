...
/**
 * RnaAptamerId generated by hbm2java
 */
public class RnaAptamerId implements java.io.Serializable {

	private Integer rnaAptamerId;
	...
	public RnaAptamerId(Integer rnaAptamerId, Integer featureId,
		...
		this.rnaAptamerId = rnaAptamerId;
	...
	public Integer getRnaAptamerId() {
		return this.rnaAptamerId;
	}

	public void setRnaAptamerId(Integer rnaAptamerId) {
		this.rnaAptamerId = rnaAptamerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnaAptamerId))
			return false;
		RnaAptamerId castOther = (RnaAptamerId) other;

		return ((this.getRnaAptamerId() == castOther.getRnaAptamerId()) || (this
				.getRnaAptamerId() != null
				&& castOther.getRnaAptamerId() != null && this
				.getRnaAptamerId().equals(castOther.getRnaAptamerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnaAptamerId() == null ? 0 : this.getRnaAptamerId()
						.hashCode());
		result = 37 * result
