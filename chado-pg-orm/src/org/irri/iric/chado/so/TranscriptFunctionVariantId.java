...
/**
 * TranscriptFunctionVariantId generated by hbm2java
 */
public class TranscriptFunctionVariantId implements java.io.Serializable {

	private Integer transcriptFunctionVariantId;
	...
	public TranscriptFunctionVariantId() {
	}

	public TranscriptFunctionVariantId(Integer transcriptFunctionVariantId,
		...
		this.transcriptFunctionVariantId = transcriptFunctionVariantId;
	...
	public Integer getTranscriptFunctionVariantId() {
		return this.transcriptFunctionVariantId;
	}

	public void setTranscriptFunctionVariantId(
			Integer transcriptFunctionVariantId) {
		this.transcriptFunctionVariantId = transcriptFunctionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptFunctionVariantId))
			return false;
		TranscriptFunctionVariantId castOther = (TranscriptFunctionVariantId) other;

		return ((this.getTranscriptFunctionVariantId() == castOther
				.getTranscriptFunctionVariantId()) || (this
				.getTranscriptFunctionVariantId() != null
				&& castOther.getTranscriptFunctionVariantId() != null && this
				.getTranscriptFunctionVariantId().equals(
						castOther.getTranscriptFunctionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptFunctionVariantId() == null ? 0 : this
						.getTranscriptFunctionVariantId().hashCode());
		result = 37 * result
