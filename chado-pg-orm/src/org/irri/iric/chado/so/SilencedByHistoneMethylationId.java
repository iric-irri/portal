...
/**
 * SilencedByHistoneMethylationId generated by hbm2java
 */
public class SilencedByHistoneMethylationId implements java.io.Serializable {

	private Integer silencedByHistoneMethylationId;
	...
	public SilencedByHistoneMethylationId() {
	}

	public SilencedByHistoneMethylationId(
			Integer silencedByHistoneMethylationId, Integer featureId,
		...
		this.silencedByHistoneMethylationId = silencedByHistoneMethylationId;
	...
	public Integer getSilencedByHistoneMethylationId() {
		return this.silencedByHistoneMethylationId;
	}

	public void setSilencedByHistoneMethylationId(
			Integer silencedByHistoneMethylationId) {
		this.silencedByHistoneMethylationId = silencedByHistoneMethylationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SilencedByHistoneMethylationId))
			return false;
		SilencedByHistoneMethylationId castOther = (SilencedByHistoneMethylationId) other;

		return ((this.getSilencedByHistoneMethylationId() == castOther
				.getSilencedByHistoneMethylationId()) || (this
				.getSilencedByHistoneMethylationId() != null
				&& castOther.getSilencedByHistoneMethylationId() != null && this
				.getSilencedByHistoneMethylationId().equals(
						castOther.getSilencedByHistoneMethylationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSilencedByHistoneMethylationId() == null ? 0 : this
						.getSilencedByHistoneMethylationId().hashCode());
		result = 37 * result
