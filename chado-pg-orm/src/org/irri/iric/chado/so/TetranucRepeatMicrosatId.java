...
/**
 * TetranucRepeatMicrosatId generated by hbm2java
 */
public class TetranucRepeatMicrosatId implements java.io.Serializable {

	private Integer tetranucRepeatMicrosatId;
	...
	public TetranucRepeatMicrosatId() {
	}

	public TetranucRepeatMicrosatId(Integer tetranucRepeatMicrosatId,
		...
		this.tetranucRepeatMicrosatId = tetranucRepeatMicrosatId;
	...
	public Integer getTetranucRepeatMicrosatId() {
		return this.tetranucRepeatMicrosatId;
	}

	public void setTetranucRepeatMicrosatId(Integer tetranucRepeatMicrosatId) {
		this.tetranucRepeatMicrosatId = tetranucRepeatMicrosatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TetranucRepeatMicrosatId))
			return false;
		TetranucRepeatMicrosatId castOther = (TetranucRepeatMicrosatId) other;

		return ((this.getTetranucRepeatMicrosatId() == castOther
				.getTetranucRepeatMicrosatId()) || (this
				.getTetranucRepeatMicrosatId() != null
				&& castOther.getTetranucRepeatMicrosatId() != null && this
				.getTetranucRepeatMicrosatId().equals(
						castOther.getTetranucRepeatMicrosatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTetranucRepeatMicrosatId() == null ? 0 : this
						.getTetranucRepeatMicrosatId().hashCode());
		result = 37 * result
