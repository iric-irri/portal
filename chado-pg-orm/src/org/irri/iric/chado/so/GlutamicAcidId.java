...
/**
 * GlutamicAcidId generated by hbm2java
 */
public class GlutamicAcidId implements java.io.Serializable {

	private Integer glutamicAcidId;
	...
	public GlutamicAcidId() {
	}

	public GlutamicAcidId(Integer glutamicAcidId, Integer featureId,
		...
		this.glutamicAcidId = glutamicAcidId;
	...
	public Integer getGlutamicAcidId() {
		return this.glutamicAcidId;
	}

	public void setGlutamicAcidId(Integer glutamicAcidId) {
		this.glutamicAcidId = glutamicAcidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutamicAcidId))
			return false;
		GlutamicAcidId castOther = (GlutamicAcidId) other;

		return ((this.getGlutamicAcidId() == castOther.getGlutamicAcidId()) || (this
				.getGlutamicAcidId() != null
				&& castOther.getGlutamicAcidId() != null && this
				.getGlutamicAcidId().equals(castOther.getGlutamicAcidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutamicAcidId() == null ? 0 : this.getGlutamicAcidId()
						.hashCode());
		result = 37 * result
