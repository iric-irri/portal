...
/**
 * NonAdjacentResiduesId generated by hbm2java
 */
public class NonAdjacentResiduesId implements java.io.Serializable {

	private Integer nonAdjacentResiduesId;
	...
	public NonAdjacentResiduesId() {
	}

	public NonAdjacentResiduesId(Integer nonAdjacentResiduesId,
		...
		this.nonAdjacentResiduesId = nonAdjacentResiduesId;
	...
	public Integer getNonAdjacentResiduesId() {
		return this.nonAdjacentResiduesId;
	}

	public void setNonAdjacentResiduesId(Integer nonAdjacentResiduesId) {
		this.nonAdjacentResiduesId = nonAdjacentResiduesId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonAdjacentResiduesId))
			return false;
		NonAdjacentResiduesId castOther = (NonAdjacentResiduesId) other;

		return ((this.getNonAdjacentResiduesId() == castOther
				.getNonAdjacentResiduesId()) || (this
				.getNonAdjacentResiduesId() != null
				&& castOther.getNonAdjacentResiduesId() != null && this
				.getNonAdjacentResiduesId().equals(
						castOther.getNonAdjacentResiduesId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNonAdjacentResiduesId() == null ? 0 : this
						.getNonAdjacentResiduesId().hashCode());
		result = 37 * result
