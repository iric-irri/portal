...
/**
 * SignalPeptideId generated by hbm2java
 */
public class SignalPeptideId implements java.io.Serializable {

	private Integer signalPeptideId;
	...
	public SignalPeptideId() {
	}

	public SignalPeptideId(Integer signalPeptideId, Integer featureId,
		...
		this.signalPeptideId = signalPeptideId;
	...
	public Integer getSignalPeptideId() {
		return this.signalPeptideId;
	}

	public void setSignalPeptideId(Integer signalPeptideId) {
		this.signalPeptideId = signalPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SignalPeptideId))
			return false;
		SignalPeptideId castOther = (SignalPeptideId) other;

		return ((this.getSignalPeptideId() == castOther.getSignalPeptideId()) || (this
				.getSignalPeptideId() != null
				&& castOther.getSignalPeptideId() != null && this
				.getSignalPeptideId().equals(castOther.getSignalPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSignalPeptideId() == null ? 0 : this.getSignalPeptideId()
						.hashCode());
		result = 37 * result
