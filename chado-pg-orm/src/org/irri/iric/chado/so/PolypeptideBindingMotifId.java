...
/**
 * PolypeptideBindingMotifId generated by hbm2java
 */
public class PolypeptideBindingMotifId implements java.io.Serializable {

	private Integer polypeptideBindingMotifId;
	...
	public PolypeptideBindingMotifId() {
	}

	public PolypeptideBindingMotifId(Integer polypeptideBindingMotifId,
		...
		this.polypeptideBindingMotifId = polypeptideBindingMotifId;
	...
	public Integer getPolypeptideBindingMotifId() {
		return this.polypeptideBindingMotifId;
	}

	public void setPolypeptideBindingMotifId(Integer polypeptideBindingMotifId) {
		this.polypeptideBindingMotifId = polypeptideBindingMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideBindingMotifId))
			return false;
		PolypeptideBindingMotifId castOther = (PolypeptideBindingMotifId) other;

		return ((this.getPolypeptideBindingMotifId() == castOther
				.getPolypeptideBindingMotifId()) || (this
				.getPolypeptideBindingMotifId() != null
				&& castOther.getPolypeptideBindingMotifId() != null && this
				.getPolypeptideBindingMotifId().equals(
						castOther.getPolypeptideBindingMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideBindingMotifId() == null ? 0 : this
						.getPolypeptideBindingMotifId().hashCode());
		result = 37 * result
