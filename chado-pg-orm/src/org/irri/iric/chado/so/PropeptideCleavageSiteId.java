...
/**
 * PropeptideCleavageSiteId generated by hbm2java
 */
public class PropeptideCleavageSiteId implements java.io.Serializable {

	private Integer propeptideCleavageSiteId;
	...
	public PropeptideCleavageSiteId() {
	}

	public PropeptideCleavageSiteId(Integer propeptideCleavageSiteId,
		...
		this.propeptideCleavageSiteId = propeptideCleavageSiteId;
	...
	public Integer getPropeptideCleavageSiteId() {
		return this.propeptideCleavageSiteId;
	}

	public void setPropeptideCleavageSiteId(Integer propeptideCleavageSiteId) {
		this.propeptideCleavageSiteId = propeptideCleavageSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PropeptideCleavageSiteId))
			return false;
		PropeptideCleavageSiteId castOther = (PropeptideCleavageSiteId) other;

		return ((this.getPropeptideCleavageSiteId() == castOther
				.getPropeptideCleavageSiteId()) || (this
				.getPropeptideCleavageSiteId() != null
				&& castOther.getPropeptideCleavageSiteId() != null && this
				.getPropeptideCleavageSiteId().equals(
						castOther.getPropeptideCleavageSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPropeptideCleavageSiteId() == null ? 0 : this
						.getPropeptideCleavageSiteId().hashCode());
		result = 37 * result
