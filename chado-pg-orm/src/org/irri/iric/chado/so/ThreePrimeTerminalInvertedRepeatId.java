...
/**
 * ThreePrimeTerminalInvertedRepeatId generated by hbm2java
 */
public class ThreePrimeTerminalInvertedRepeatId implements java.io.Serializable {

	private Integer threePrimeTerminalInvertedRepeatId;
	...
	public ThreePrimeTerminalInvertedRepeatId() {
	}

	public ThreePrimeTerminalInvertedRepeatId(
			Integer threePrimeTerminalInvertedRepeatId, Integer featureId,
		...
		this.threePrimeTerminalInvertedRepeatId = threePrimeTerminalInvertedRepeatId;
	...
	public Integer getThreePrimeTerminalInvertedRepeatId() {
		return this.threePrimeTerminalInvertedRepeatId;
	}

	public void setThreePrimeTerminalInvertedRepeatId(
			Integer threePrimeTerminalInvertedRepeatId) {
		this.threePrimeTerminalInvertedRepeatId = threePrimeTerminalInvertedRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeTerminalInvertedRepeatId))
			return false;
		ThreePrimeTerminalInvertedRepeatId castOther = (ThreePrimeTerminalInvertedRepeatId) other;

		return ((this.getThreePrimeTerminalInvertedRepeatId() == castOther
				.getThreePrimeTerminalInvertedRepeatId()) || (this
				.getThreePrimeTerminalInvertedRepeatId() != null
				&& castOther.getThreePrimeTerminalInvertedRepeatId() != null && this
				.getThreePrimeTerminalInvertedRepeatId().equals(
						castOther.getThreePrimeTerminalInvertedRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeTerminalInvertedRepeatId() == null ? 0 : this
						.getThreePrimeTerminalInvertedRepeatId().hashCode());
		result = 37 * result
