...
/**
 * PeroxywybutosineId generated by hbm2java
 */
public class PeroxywybutosineId implements java.io.Serializable {

	private Integer peroxywybutosineId;
	...
	public PeroxywybutosineId() {
	}

	public PeroxywybutosineId(Integer peroxywybutosineId, Integer featureId,
		...
		this.peroxywybutosineId = peroxywybutosineId;
	...
	public Integer getPeroxywybutosineId() {
		return this.peroxywybutosineId;
	}

	public void setPeroxywybutosineId(Integer peroxywybutosineId) {
		this.peroxywybutosineId = peroxywybutosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PeroxywybutosineId))
			return false;
		PeroxywybutosineId castOther = (PeroxywybutosineId) other;

		return ((this.getPeroxywybutosineId() == castOther
				.getPeroxywybutosineId()) || (this.getPeroxywybutosineId() != null
				&& castOther.getPeroxywybutosineId() != null && this
				.getPeroxywybutosineId().equals(
						castOther.getPeroxywybutosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeroxywybutosineId() == null ? 0 : this
						.getPeroxywybutosineId().hashCode());
		result = 37 * result
