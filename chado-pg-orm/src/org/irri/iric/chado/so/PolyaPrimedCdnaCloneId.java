...
/**
 * PolyaPrimedCdnaCloneId generated by hbm2java
 */
public class PolyaPrimedCdnaCloneId implements java.io.Serializable {

	private Integer polyaPrimedCdnaCloneId;
	...
	public PolyaPrimedCdnaCloneId() {
	}

	public PolyaPrimedCdnaCloneId(Integer polyaPrimedCdnaCloneId,
		...
		this.polyaPrimedCdnaCloneId = polyaPrimedCdnaCloneId;
	...
	public Integer getPolyaPrimedCdnaCloneId() {
		return this.polyaPrimedCdnaCloneId;
	}

	public void setPolyaPrimedCdnaCloneId(Integer polyaPrimedCdnaCloneId) {
		this.polyaPrimedCdnaCloneId = polyaPrimedCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyaPrimedCdnaCloneId))
			return false;
		PolyaPrimedCdnaCloneId castOther = (PolyaPrimedCdnaCloneId) other;

		return ((this.getPolyaPrimedCdnaCloneId() == castOther
				.getPolyaPrimedCdnaCloneId()) || (this
				.getPolyaPrimedCdnaCloneId() != null
				&& castOther.getPolyaPrimedCdnaCloneId() != null && this
				.getPolyaPrimedCdnaCloneId().equals(
						castOther.getPolyaPrimedCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyaPrimedCdnaCloneId() == null ? 0 : this
						.getPolyaPrimedCdnaCloneId().hashCode());
		result = 37 * result
