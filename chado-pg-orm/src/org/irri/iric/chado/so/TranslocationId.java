...
/**
 * TranslocationId generated by hbm2java
 */
public class TranslocationId implements java.io.Serializable {

	private Integer translocationId;
	...
	public TranslocationId() {
	}

	public TranslocationId(Integer translocationId, Integer featureId,
	...
	public Integer getTranslocationId() {
		return this.translocationId;
	}

	public void setTranslocationId(Integer translocationId) {
		this.translocationId = translocationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslocationId))
			return false;
		TranslocationId castOther = (TranslocationId) other;

		return ((this.getTranslocationId() == castOther.getTranslocationId()) || (this
				.getTranslocationId() != null
				&& castOther.getTranslocationId() != null && this
				.getTranslocationId().equals(castOther.getTranslocationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslocationId() == null ? 0 : this.getTranslocationId()
						.hashCode());
		result = 37 * result
