...
/**
 * CircularSingleStrandedRnaChromosomeId generated by hbm2java
 */
public class CircularSingleStrandedRnaChromosomeId implements
		java.io.Serializable {

	private Integer circularSingleStrandedRnaChromosomeId;
	...
	public CircularSingleStrandedRnaChromosomeId() {
	}

	public CircularSingleStrandedRnaChromosomeId(
			Integer circularSingleStrandedRnaChromosomeId, Integer featureId,
		...
		this.circularSingleStrandedRnaChromosomeId = circularSingleStrandedRnaChromosomeId;
	...
	public Integer getCircularSingleStrandedRnaChromosomeId() {
		return this.circularSingleStrandedRnaChromosomeId;
	}

	public void setCircularSingleStrandedRnaChromosomeId(
			Integer circularSingleStrandedRnaChromosomeId) {
		this.circularSingleStrandedRnaChromosomeId = circularSingleStrandedRnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CircularSingleStrandedRnaChromosomeId))
			return false;
		CircularSingleStrandedRnaChromosomeId castOther = (CircularSingleStrandedRnaChromosomeId) other;

		return ((this.getCircularSingleStrandedRnaChromosomeId() == castOther
				.getCircularSingleStrandedRnaChromosomeId()) || (this
				.getCircularSingleStrandedRnaChromosomeId() != null
				&& castOther.getCircularSingleStrandedRnaChromosomeId() != null && this
				.getCircularSingleStrandedRnaChromosomeId().equals(
						castOther.getCircularSingleStrandedRnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCircularSingleStrandedRnaChromosomeId() == null ? 0
						: this.getCircularSingleStrandedRnaChromosomeId()
								.hashCode());
		result = 37 * result
