...
/**
 * LinearId generated by hbm2java
 */
public class LinearId implements java.io.Serializable {
	...
	public LinearId(Integer linearId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLinearId() {
		return this.linearId;
	}

	public void setLinearId(Integer linearId) {
		this.linearId = linearId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinearId))
			return false;
		LinearId castOther = (LinearId) other;

		return ((this.getLinearId() == castOther.getLinearId()) || (this
				.getLinearId() != null && castOther.getLinearId() != null && this
				.getLinearId().equals(castOther.getLinearId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getLinearId() == null ? 0 : this.getLinearId().hashCode());
		result = 37 * result
