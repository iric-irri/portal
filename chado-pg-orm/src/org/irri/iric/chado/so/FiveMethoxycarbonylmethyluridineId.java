...
/**
 * FiveMethoxycarbonylmethyluridineId generated by hbm2java
 */
public class FiveMethoxycarbonylmethyluridineId implements java.io.Serializable {

	private Integer fiveMethoxycarbonylmethyluridineId;
	...
	public FiveMethoxycarbonylmethyluridineId() {
	}

	public FiveMethoxycarbonylmethyluridineId(
			Integer fiveMethoxycarbonylmethyluridineId, Integer featureId,
		...
		this.fiveMethoxycarbonylmethyluridineId = fiveMethoxycarbonylmethyluridineId;
	...
	public Integer getFiveMethoxycarbonylmethyluridineId() {
		return this.fiveMethoxycarbonylmethyluridineId;
	}

	public void setFiveMethoxycarbonylmethyluridineId(
			Integer fiveMethoxycarbonylmethyluridineId) {
		this.fiveMethoxycarbonylmethyluridineId = fiveMethoxycarbonylmethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethoxycarbonylmethyluridineId))
			return false;
		FiveMethoxycarbonylmethyluridineId castOther = (FiveMethoxycarbonylmethyluridineId) other;

		return ((this.getFiveMethoxycarbonylmethyluridineId() == castOther
				.getFiveMethoxycarbonylmethyluridineId()) || (this
				.getFiveMethoxycarbonylmethyluridineId() != null
				&& castOther.getFiveMethoxycarbonylmethyluridineId() != null && this
				.getFiveMethoxycarbonylmethyluridineId().equals(
						castOther.getFiveMethoxycarbonylmethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethoxycarbonylmethyluridineId() == null ? 0 : this
						.getFiveMethoxycarbonylmethyluridineId().hashCode());
		result = 37 * result
