...
/**
 * NcrnaId generated by hbm2java
 */
public class NcrnaId implements java.io.Serializable {

	private Integer ncrnaId;
	...
	public NcrnaId(Integer ncrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getNcrnaId() {
		return this.ncrnaId;
	}

	public void setNcrnaId(Integer ncrnaId) {
		this.ncrnaId = ncrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcrnaId))
			return false;
		NcrnaId castOther = (NcrnaId) other;

		return ((this.getNcrnaId() == castOther.getNcrnaId()) || (this
				.getNcrnaId() != null && castOther.getNcrnaId() != null && this
				.getNcrnaId().equals(castOther.getNcrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getNcrnaId() == null ? 0 : this.getNcrnaId().hashCode());
		result = 37 * result
