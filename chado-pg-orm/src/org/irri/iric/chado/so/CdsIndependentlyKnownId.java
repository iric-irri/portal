...
/**
 * CdsIndependentlyKnownId generated by hbm2java
 */
public class CdsIndependentlyKnownId implements java.io.Serializable {

	private Integer cdsIndependentlyKnownId;
	...
	public CdsIndependentlyKnownId() {
	}

	public CdsIndependentlyKnownId(Integer cdsIndependentlyKnownId,
		...
		this.cdsIndependentlyKnownId = cdsIndependentlyKnownId;
	...
	public Integer getCdsIndependentlyKnownId() {
		return this.cdsIndependentlyKnownId;
	}

	public void setCdsIndependentlyKnownId(Integer cdsIndependentlyKnownId) {
		this.cdsIndependentlyKnownId = cdsIndependentlyKnownId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CdsIndependentlyKnownId))
			return false;
		CdsIndependentlyKnownId castOther = (CdsIndependentlyKnownId) other;

		return ((this.getCdsIndependentlyKnownId() == castOther
				.getCdsIndependentlyKnownId()) || (this
				.getCdsIndependentlyKnownId() != null
				&& castOther.getCdsIndependentlyKnownId() != null && this
				.getCdsIndependentlyKnownId().equals(
						castOther.getCdsIndependentlyKnownId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCdsIndependentlyKnownId() == null ? 0 : this
						.getCdsIndependentlyKnownId().hashCode());
		result = 37 * result
