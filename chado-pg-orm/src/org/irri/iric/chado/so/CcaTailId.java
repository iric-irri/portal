...
/**
 * CcaTailId generated by hbm2java
 */
public class CcaTailId implements java.io.Serializable {

	private Integer ccaTailId;
	...
	public CcaTailId(Integer ccaTailId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCcaTailId() {
		return this.ccaTailId;
	}

	public void setCcaTailId(Integer ccaTailId) {
		this.ccaTailId = ccaTailId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CcaTailId))
			return false;
		CcaTailId castOther = (CcaTailId) other;

		return ((this.getCcaTailId() == castOther.getCcaTailId()) || (this
				.getCcaTailId() != null && castOther.getCcaTailId() != null && this
				.getCcaTailId().equals(castOther.getCcaTailId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCcaTailId() == null ? 0 : this.getCcaTailId().hashCode());
		result = 37 * result
