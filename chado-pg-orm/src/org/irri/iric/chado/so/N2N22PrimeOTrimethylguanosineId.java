...
/**
 * N2N22PrimeOTrimethylguanosineId generated by hbm2java
 */
public class N2N22PrimeOTrimethylguanosineId implements java.io.Serializable {

	private Integer n2N22PrimeOTrimethylguanosineId;
	...
	public N2N22PrimeOTrimethylguanosineId() {
	}

	public N2N22PrimeOTrimethylguanosineId(
			Integer n2N22PrimeOTrimethylguanosineId, Integer featureId,
		...
		this.n2N22PrimeOTrimethylguanosineId = n2N22PrimeOTrimethylguanosineId;
	...
	public Integer getN2N22PrimeOTrimethylguanosineId() {
		return this.n2N22PrimeOTrimethylguanosineId;
	}

	public void setN2N22PrimeOTrimethylguanosineId(
			Integer n2N22PrimeOTrimethylguanosineId) {
		this.n2N22PrimeOTrimethylguanosineId = n2N22PrimeOTrimethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N2N22PrimeOTrimethylguanosineId))
			return false;
		N2N22PrimeOTrimethylguanosineId castOther = (N2N22PrimeOTrimethylguanosineId) other;

		return ((this.getN2N22PrimeOTrimethylguanosineId() == castOther
				.getN2N22PrimeOTrimethylguanosineId()) || (this
				.getN2N22PrimeOTrimethylguanosineId() != null
				&& castOther.getN2N22PrimeOTrimethylguanosineId() != null && this
				.getN2N22PrimeOTrimethylguanosineId().equals(
						castOther.getN2N22PrimeOTrimethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN2N22PrimeOTrimethylguanosineId() == null ? 0 : this
						.getN2N22PrimeOTrimethylguanosineId().hashCode());
		result = 37 * result
