...
/**
 * SsOligoId generated by hbm2java
 */
public class SsOligoId implements java.io.Serializable {

	private Integer ssOligoId;
	...
	public SsOligoId(Integer ssOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSsOligoId() {
		return this.ssOligoId;
	}

	public void setSsOligoId(Integer ssOligoId) {
		this.ssOligoId = ssOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SsOligoId))
			return false;
		SsOligoId castOther = (SsOligoId) other;

		return ((this.getSsOligoId() == castOther.getSsOligoId()) || (this
				.getSsOligoId() != null && castOther.getSsOligoId() != null && this
				.getSsOligoId().equals(castOther.getSsOligoId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSsOligoId() == null ? 0 : this.getSsOligoId().hashCode());
		result = 37 * result
