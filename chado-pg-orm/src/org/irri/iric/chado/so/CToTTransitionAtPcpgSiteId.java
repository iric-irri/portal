...
/**
 * CToTTransitionAtPcpgSiteId generated by hbm2java
 */
public class CToTTransitionAtPcpgSiteId implements java.io.Serializable {

	private Integer CToTTransitionAtPcpgSiteId;
	...
	public CToTTransitionAtPcpgSiteId() {
	}

	public CToTTransitionAtPcpgSiteId(Integer CToTTransitionAtPcpgSiteId,
		...
		this.CToTTransitionAtPcpgSiteId = CToTTransitionAtPcpgSiteId;
	...
	public Integer getCToTTransitionAtPcpgSiteId() {
		return this.CToTTransitionAtPcpgSiteId;
	}

	public void setCToTTransitionAtPcpgSiteId(Integer CToTTransitionAtPcpgSiteId) {
		this.CToTTransitionAtPcpgSiteId = CToTTransitionAtPcpgSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CToTTransitionAtPcpgSiteId))
			return false;
		CToTTransitionAtPcpgSiteId castOther = (CToTTransitionAtPcpgSiteId) other;

		return ((this.getCToTTransitionAtPcpgSiteId() == castOther
				.getCToTTransitionAtPcpgSiteId()) || (this
				.getCToTTransitionAtPcpgSiteId() != null
				&& castOther.getCToTTransitionAtPcpgSiteId() != null && this
				.getCToTTransitionAtPcpgSiteId().equals(
						castOther.getCToTTransitionAtPcpgSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCToTTransitionAtPcpgSiteId() == null ? 0 : this
						.getCToTTransitionAtPcpgSiteId().hashCode());
		result = 37 * result
