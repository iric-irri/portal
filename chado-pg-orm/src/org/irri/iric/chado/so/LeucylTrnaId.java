...
/**
 * LeucylTrnaId generated by hbm2java
 */
public class LeucylTrnaId implements java.io.Serializable {

	private Integer leucylTrnaId;
	...
	public LeucylTrnaId(Integer leucylTrnaId, Integer featureId,
		...
		this.leucylTrnaId = leucylTrnaId;
	...
	public Integer getLeucylTrnaId() {
		return this.leucylTrnaId;
	}

	public void setLeucylTrnaId(Integer leucylTrnaId) {
		this.leucylTrnaId = leucylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucylTrnaId))
			return false;
		LeucylTrnaId castOther = (LeucylTrnaId) other;

		return ((this.getLeucylTrnaId() == castOther.getLeucylTrnaId()) || (this
				.getLeucylTrnaId() != null
				&& castOther.getLeucylTrnaId() != null && this
				.getLeucylTrnaId().equals(castOther.getLeucylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLeucylTrnaId() == null ? 0 : this.getLeucylTrnaId()
						.hashCode());
		result = 37 * result
