...
/**
 * MaternalUniparentalDisomyId generated by hbm2java
 */
public class MaternalUniparentalDisomyId implements java.io.Serializable {

	private Integer maternalUniparentalDisomyId;
	...
	public MaternalUniparentalDisomyId() {
	}

	public MaternalUniparentalDisomyId(Integer maternalUniparentalDisomyId,
		...
		this.maternalUniparentalDisomyId = maternalUniparentalDisomyId;
	...
	public Integer getMaternalUniparentalDisomyId() {
		return this.maternalUniparentalDisomyId;
	}

	public void setMaternalUniparentalDisomyId(
			Integer maternalUniparentalDisomyId) {
		this.maternalUniparentalDisomyId = maternalUniparentalDisomyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaternalUniparentalDisomyId))
			return false;
		MaternalUniparentalDisomyId castOther = (MaternalUniparentalDisomyId) other;

		return ((this.getMaternalUniparentalDisomyId() == castOther
				.getMaternalUniparentalDisomyId()) || (this
				.getMaternalUniparentalDisomyId() != null
				&& castOther.getMaternalUniparentalDisomyId() != null && this
				.getMaternalUniparentalDisomyId().equals(
						castOther.getMaternalUniparentalDisomyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaternalUniparentalDisomyId() == null ? 0 : this
						.getMaternalUniparentalDisomyId().hashCode());
		result = 37 * result
