...
/**
 * UneditedRegionId generated by hbm2java
 */
public class UneditedRegionId implements java.io.Serializable {

	private Integer uneditedRegionId;
	...
	public UneditedRegionId() {
	}

	public UneditedRegionId(Integer uneditedRegionId, Integer featureId,
		...
		this.uneditedRegionId = uneditedRegionId;
	...
	public Integer getUneditedRegionId() {
		return this.uneditedRegionId;
	}

	public void setUneditedRegionId(Integer uneditedRegionId) {
		this.uneditedRegionId = uneditedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UneditedRegionId))
			return false;
		UneditedRegionId castOther = (UneditedRegionId) other;

		return ((this.getUneditedRegionId() == castOther.getUneditedRegionId()) || (this
				.getUneditedRegionId() != null
				&& castOther.getUneditedRegionId() != null && this
				.getUneditedRegionId().equals(castOther.getUneditedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getUneditedRegionId() == null ? 0 : this
						.getUneditedRegionId().hashCode());
		result = 37 * result
