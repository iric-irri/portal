...
/**
 * ArginineId generated by hbm2java
 */
public class ArginineId implements java.io.Serializable {

	private Integer arginineId;
	...
	public ArginineId(Integer arginineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getArginineId() {
		return this.arginineId;
	}

	public void setArginineId(Integer arginineId) {
		this.arginineId = arginineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ArginineId))
			return false;
		ArginineId castOther = (ArginineId) other;

		return ((this.getArginineId() == castOther.getArginineId()) || (this
				.getArginineId() != null && castOther.getArginineId() != null && this
				.getArginineId().equals(castOther.getArginineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getArginineId() == null ? 0 : this.getArginineId()
						.hashCode());
		result = 37 * result
