...
/**
 * PyrimidineToPurineTransversionId generated by hbm2java
 */
public class PyrimidineToPurineTransversionId implements java.io.Serializable {

	private Integer pyrimidineToPurineTransversionId;
	...
	public PyrimidineToPurineTransversionId() {
	}

	public PyrimidineToPurineTransversionId(
			Integer pyrimidineToPurineTransversionId, Integer featureId,
		...
		this.pyrimidineToPurineTransversionId = pyrimidineToPurineTransversionId;
	...
	public Integer getPyrimidineToPurineTransversionId() {
		return this.pyrimidineToPurineTransversionId;
	}

	public void setPyrimidineToPurineTransversionId(
			Integer pyrimidineToPurineTransversionId) {
		this.pyrimidineToPurineTransversionId = pyrimidineToPurineTransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PyrimidineToPurineTransversionId))
			return false;
		PyrimidineToPurineTransversionId castOther = (PyrimidineToPurineTransversionId) other;

		return ((this.getPyrimidineToPurineTransversionId() == castOther
				.getPyrimidineToPurineTransversionId()) || (this
				.getPyrimidineToPurineTransversionId() != null
				&& castOther.getPyrimidineToPurineTransversionId() != null && this
				.getPyrimidineToPurineTransversionId().equals(
						castOther.getPyrimidineToPurineTransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPyrimidineToPurineTransversionId() == null ? 0 : this
						.getPyrimidineToPurineTransversionId().hashCode());
		result = 37 * result
