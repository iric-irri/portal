...
/**
 * GroupIiaIntronId generated by hbm2java
 */
public class GroupIiaIntronId implements java.io.Serializable {

	private Integer groupIiaIntronId;
	...
	public GroupIiaIntronId() {
	}

	public GroupIiaIntronId(Integer groupIiaIntronId, Integer featureId,
		...
		this.groupIiaIntronId = groupIiaIntronId;
	...
	public Integer getGroupIiaIntronId() {
		return this.groupIiaIntronId;
	}

	public void setGroupIiaIntronId(Integer groupIiaIntronId) {
		this.groupIiaIntronId = groupIiaIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIiaIntronId))
			return false;
		GroupIiaIntronId castOther = (GroupIiaIntronId) other;

		return ((this.getGroupIiaIntronId() == castOther.getGroupIiaIntronId()) || (this
				.getGroupIiaIntronId() != null
				&& castOther.getGroupIiaIntronId() != null && this
				.getGroupIiaIntronId().equals(castOther.getGroupIiaIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGroupIiaIntronId() == null ? 0 : this
						.getGroupIiaIntronId().hashCode());
		result = 37 * result
