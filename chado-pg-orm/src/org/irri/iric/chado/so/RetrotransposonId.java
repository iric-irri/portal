...
/**
 * RetrotransposonId generated by hbm2java
 */
public class RetrotransposonId implements java.io.Serializable {

	private Integer retrotransposonId;
	...
	public RetrotransposonId() {
	}

	public RetrotransposonId(Integer retrotransposonId, Integer featureId,
		...
		this.retrotransposonId = retrotransposonId;
	...
	public Integer getRetrotransposonId() {
		return this.retrotransposonId;
	}

	public void setRetrotransposonId(Integer retrotransposonId) {
		this.retrotransposonId = retrotransposonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RetrotransposonId))
			return false;
		RetrotransposonId castOther = (RetrotransposonId) other;

		return ((this.getRetrotransposonId() == castOther
				.getRetrotransposonId()) || (this.getRetrotransposonId() != null
				&& castOther.getRetrotransposonId() != null && this
				.getRetrotransposonId()
				.equals(castOther.getRetrotransposonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRetrotransposonId() == null ? 0 : this
						.getRetrotransposonId().hashCode());
		result = 37 * result
