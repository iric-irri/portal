...
/**
 * DyeTerminatorReadId generated by hbm2java
 */
public class DyeTerminatorReadId implements java.io.Serializable {

	private Integer dyeTerminatorReadId;
	...
	public DyeTerminatorReadId() {
	}

	public DyeTerminatorReadId(Integer dyeTerminatorReadId, Integer featureId,
		...
		this.dyeTerminatorReadId = dyeTerminatorReadId;
	...
	public Integer getDyeTerminatorReadId() {
		return this.dyeTerminatorReadId;
	}

	public void setDyeTerminatorReadId(Integer dyeTerminatorReadId) {
		this.dyeTerminatorReadId = dyeTerminatorReadId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DyeTerminatorReadId))
			return false;
		DyeTerminatorReadId castOther = (DyeTerminatorReadId) other;

		return ((this.getDyeTerminatorReadId() == castOther
				.getDyeTerminatorReadId()) || (this.getDyeTerminatorReadId() != null
				&& castOther.getDyeTerminatorReadId() != null && this
				.getDyeTerminatorReadId().equals(
						castOther.getDyeTerminatorReadId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDyeTerminatorReadId() == null ? 0 : this
						.getDyeTerminatorReadId().hashCode());
		result = 37 * result
