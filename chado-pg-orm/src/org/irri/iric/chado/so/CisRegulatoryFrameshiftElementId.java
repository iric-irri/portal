...
/**
 * CisRegulatoryFrameshiftElementId generated by hbm2java
 */
public class CisRegulatoryFrameshiftElementId implements java.io.Serializable {

	private Integer cisRegulatoryFrameshiftElementId;
	...
	public CisRegulatoryFrameshiftElementId() {
	}

	public CisRegulatoryFrameshiftElementId(
			Integer cisRegulatoryFrameshiftElementId, Integer featureId,
		...
		this.cisRegulatoryFrameshiftElementId = cisRegulatoryFrameshiftElementId;
	...
	public Integer getCisRegulatoryFrameshiftElementId() {
		return this.cisRegulatoryFrameshiftElementId;
	}

	public void setCisRegulatoryFrameshiftElementId(
			Integer cisRegulatoryFrameshiftElementId) {
		this.cisRegulatoryFrameshiftElementId = cisRegulatoryFrameshiftElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CisRegulatoryFrameshiftElementId))
			return false;
		CisRegulatoryFrameshiftElementId castOther = (CisRegulatoryFrameshiftElementId) other;

		return ((this.getCisRegulatoryFrameshiftElementId() == castOther
				.getCisRegulatoryFrameshiftElementId()) || (this
				.getCisRegulatoryFrameshiftElementId() != null
				&& castOther.getCisRegulatoryFrameshiftElementId() != null && this
				.getCisRegulatoryFrameshiftElementId().equals(
						castOther.getCisRegulatoryFrameshiftElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCisRegulatoryFrameshiftElementId() == null ? 0 : this
						.getCisRegulatoryFrameshiftElementId().hashCode());
		result = 37 * result
