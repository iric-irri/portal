...
/**
 * XElementCombinatorialRepeatId generated by hbm2java
 */
public class XElementCombinatorialRepeatId implements java.io.Serializable {

	private Integer XElementCombinatorialRepeatId;
	...
	public XElementCombinatorialRepeatId() {
	}

	public XElementCombinatorialRepeatId(Integer XElementCombinatorialRepeatId,
		...
		this.XElementCombinatorialRepeatId = XElementCombinatorialRepeatId;
	...
	public Integer getXElementCombinatorialRepeatId() {
		return this.XElementCombinatorialRepeatId;
	}

	public void setXElementCombinatorialRepeatId(
			Integer XElementCombinatorialRepeatId) {
		this.XElementCombinatorialRepeatId = XElementCombinatorialRepeatId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof XElementCombinatorialRepeatId))
			return false;
		XElementCombinatorialRepeatId castOther = (XElementCombinatorialRepeatId) other;

		return ((this.getXElementCombinatorialRepeatId() == castOther
				.getXElementCombinatorialRepeatId()) || (this
				.getXElementCombinatorialRepeatId() != null
				&& castOther.getXElementCombinatorialRepeatId() != null && this
				.getXElementCombinatorialRepeatId().equals(
						castOther.getXElementCombinatorialRepeatId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getXElementCombinatorialRepeatId() == null ? 0 : this
						.getXElementCombinatorialRepeatId().hashCode());
		result = 37 * result
