...
/**
 * StTurnRightHandedTypeTwoId generated by hbm2java
 */
public class StTurnRightHandedTypeTwoId implements java.io.Serializable {

	private Integer stTurnRightHandedTypeTwoId;
	...
	public StTurnRightHandedTypeTwoId() {
	}

	public StTurnRightHandedTypeTwoId(Integer stTurnRightHandedTypeTwoId,
		...
		this.stTurnRightHandedTypeTwoId = stTurnRightHandedTypeTwoId;
	...
	public Integer getStTurnRightHandedTypeTwoId() {
		return this.stTurnRightHandedTypeTwoId;
	}

	public void setStTurnRightHandedTypeTwoId(Integer stTurnRightHandedTypeTwoId) {
		this.stTurnRightHandedTypeTwoId = stTurnRightHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StTurnRightHandedTypeTwoId))
			return false;
		StTurnRightHandedTypeTwoId castOther = (StTurnRightHandedTypeTwoId) other;

		return ((this.getStTurnRightHandedTypeTwoId() == castOther
				.getStTurnRightHandedTypeTwoId()) || (this
				.getStTurnRightHandedTypeTwoId() != null
				&& castOther.getStTurnRightHandedTypeTwoId() != null && this
				.getStTurnRightHandedTypeTwoId().equals(
						castOther.getStTurnRightHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStTurnRightHandedTypeTwoId() == null ? 0 : this
						.getStTurnRightHandedTypeTwoId().hashCode());
		result = 37 * result
