...
/**
 * BetaBulgeLoopFiveId generated by hbm2java
 */
public class BetaBulgeLoopFiveId implements java.io.Serializable {

	private Integer betaBulgeLoopFiveId;
	...
	public BetaBulgeLoopFiveId() {
	}

	public BetaBulgeLoopFiveId(Integer betaBulgeLoopFiveId, Integer featureId,
		...
		this.betaBulgeLoopFiveId = betaBulgeLoopFiveId;
	...
	public Integer getBetaBulgeLoopFiveId() {
		return this.betaBulgeLoopFiveId;
	}

	public void setBetaBulgeLoopFiveId(Integer betaBulgeLoopFiveId) {
		this.betaBulgeLoopFiveId = betaBulgeLoopFiveId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaBulgeLoopFiveId))
			return false;
		BetaBulgeLoopFiveId castOther = (BetaBulgeLoopFiveId) other;

		return ((this.getBetaBulgeLoopFiveId() == castOther
				.getBetaBulgeLoopFiveId()) || (this.getBetaBulgeLoopFiveId() != null
				&& castOther.getBetaBulgeLoopFiveId() != null && this
				.getBetaBulgeLoopFiveId().equals(
						castOther.getBetaBulgeLoopFiveId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaBulgeLoopFiveId() == null ? 0 : this
						.getBetaBulgeLoopFiveId().hashCode());
		result = 37 * result
