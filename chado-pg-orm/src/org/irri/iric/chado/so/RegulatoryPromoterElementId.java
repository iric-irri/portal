...
/**
 * RegulatoryPromoterElementId generated by hbm2java
 */
public class RegulatoryPromoterElementId implements java.io.Serializable {

	private Integer regulatoryPromoterElementId;
	...
	public RegulatoryPromoterElementId() {
	}

	public RegulatoryPromoterElementId(Integer regulatoryPromoterElementId,
		...
		this.regulatoryPromoterElementId = regulatoryPromoterElementId;
	...
	public Integer getRegulatoryPromoterElementId() {
		return this.regulatoryPromoterElementId;
	}

	public void setRegulatoryPromoterElementId(
			Integer regulatoryPromoterElementId) {
		this.regulatoryPromoterElementId = regulatoryPromoterElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegulatoryPromoterElementId))
			return false;
		RegulatoryPromoterElementId castOther = (RegulatoryPromoterElementId) other;

		return ((this.getRegulatoryPromoterElementId() == castOther
				.getRegulatoryPromoterElementId()) || (this
				.getRegulatoryPromoterElementId() != null
				&& castOther.getRegulatoryPromoterElementId() != null && this
				.getRegulatoryPromoterElementId().equals(
						castOther.getRegulatoryPromoterElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegulatoryPromoterElementId() == null ? 0 : this
						.getRegulatoryPromoterElementId().hashCode());
		result = 37 * result
