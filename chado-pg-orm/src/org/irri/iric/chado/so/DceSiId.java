...
/**
 * DceSiId generated by hbm2java
 */
public class DceSiId implements java.io.Serializable {

	private Integer dceSiId;
	...
	public DceSiId(Integer dceSiId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDceSiId() {
		return this.dceSiId;
	}

	public void setDceSiId(Integer dceSiId) {
		this.dceSiId = dceSiId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DceSiId))
			return false;
		DceSiId castOther = (DceSiId) other;

		return ((this.getDceSiId() == castOther.getDceSiId()) || (this
				.getDceSiId() != null && castOther.getDceSiId() != null && this
				.getDceSiId().equals(castOther.getDceSiId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDceSiId() == null ? 0 : this.getDceSiId().hashCode());
		result = 37 * result
