...
/**
 * BreuMotifId generated by hbm2java
 */
public class BreuMotifId implements java.io.Serializable {

	private Integer breuMotifId;
	...
	public BreuMotifId(Integer breuMotifId, Integer featureId,
	...
	public Integer getBreuMotifId() {
		return this.breuMotifId;
	}

	public void setBreuMotifId(Integer breuMotifId) {
		this.breuMotifId = breuMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BreuMotifId))
			return false;
		BreuMotifId castOther = (BreuMotifId) other;

		return ((this.getBreuMotifId() == castOther.getBreuMotifId()) || (this
				.getBreuMotifId() != null && castOther.getBreuMotifId() != null && this
				.getBreuMotifId().equals(castOther.getBreuMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBreuMotifId() == null ? 0 : this.getBreuMotifId()
						.hashCode());
		result = 37 * result
