...
/**
 * OctamerMotifId generated by hbm2java
 */
public class OctamerMotifId implements java.io.Serializable {

	private Integer octamerMotifId;
	...
	public OctamerMotifId() {
	}

	public OctamerMotifId(Integer octamerMotifId, Integer featureId,
		...
		this.octamerMotifId = octamerMotifId;
	...
	public Integer getOctamerMotifId() {
		return this.octamerMotifId;
	}

	public void setOctamerMotifId(Integer octamerMotifId) {
		this.octamerMotifId = octamerMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OctamerMotifId))
			return false;
		OctamerMotifId castOther = (OctamerMotifId) other;

		return ((this.getOctamerMotifId() == castOther.getOctamerMotifId()) || (this
				.getOctamerMotifId() != null
				&& castOther.getOctamerMotifId() != null && this
				.getOctamerMotifId().equals(castOther.getOctamerMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOctamerMotifId() == null ? 0 : this.getOctamerMotifId()
						.hashCode());
		result = 37 * result
