...
/**
 * RegionalCentromereInnerRepeatRegionId generated by hbm2java
 */
public class RegionalCentromereInnerRepeatRegionId implements
		java.io.Serializable {

	private Integer regionalCentromereInnerRepeatRegionId;
	...
	public RegionalCentromereInnerRepeatRegionId() {
	}

	public RegionalCentromereInnerRepeatRegionId(
			Integer regionalCentromereInnerRepeatRegionId, Integer featureId,
		...
		this.regionalCentromereInnerRepeatRegionId = regionalCentromereInnerRepeatRegionId;
	...
	public Integer getRegionalCentromereInnerRepeatRegionId() {
		return this.regionalCentromereInnerRepeatRegionId;
	}

	public void setRegionalCentromereInnerRepeatRegionId(
			Integer regionalCentromereInnerRepeatRegionId) {
		this.regionalCentromereInnerRepeatRegionId = regionalCentromereInnerRepeatRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegionalCentromereInnerRepeatRegionId))
			return false;
		RegionalCentromereInnerRepeatRegionId castOther = (RegionalCentromereInnerRepeatRegionId) other;

		return ((this.getRegionalCentromereInnerRepeatRegionId() == castOther
				.getRegionalCentromereInnerRepeatRegionId()) || (this
				.getRegionalCentromereInnerRepeatRegionId() != null
				&& castOther.getRegionalCentromereInnerRepeatRegionId() != null && this
				.getRegionalCentromereInnerRepeatRegionId().equals(
						castOther.getRegionalCentromereInnerRepeatRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRegionalCentromereInnerRepeatRegionId() == null ? 0
						: this.getRegionalCentromereInnerRepeatRegionId()
								.hashCode());
		result = 37 * result
