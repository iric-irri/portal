...
/**
 * GrnaGeneId generated by hbm2java
 */
public class GrnaGeneId implements java.io.Serializable {

	private Integer grnaGeneId;
	...
	public GrnaGeneId(Integer grnaGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getGrnaGeneId() {
		return this.grnaGeneId;
	}

	public void setGrnaGeneId(Integer grnaGeneId) {
		this.grnaGeneId = grnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GrnaGeneId))
			return false;
		GrnaGeneId castOther = (GrnaGeneId) other;

		return ((this.getGrnaGeneId() == castOther.getGrnaGeneId()) || (this
				.getGrnaGeneId() != null && castOther.getGrnaGeneId() != null && this
				.getGrnaGeneId().equals(castOther.getGrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGrnaGeneId() == null ? 0 : this.getGrnaGeneId()
						.hashCode());
		result = 37 * result
