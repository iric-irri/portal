...
/**
 * LipoproteinSignalPeptideId generated by hbm2java
 */
public class LipoproteinSignalPeptideId implements java.io.Serializable {

	private Integer lipoproteinSignalPeptideId;
	...
	public LipoproteinSignalPeptideId() {
	}

	public LipoproteinSignalPeptideId(Integer lipoproteinSignalPeptideId,
		...
		this.lipoproteinSignalPeptideId = lipoproteinSignalPeptideId;
	...
	public Integer getLipoproteinSignalPeptideId() {
		return this.lipoproteinSignalPeptideId;
	}

	public void setLipoproteinSignalPeptideId(Integer lipoproteinSignalPeptideId) {
		this.lipoproteinSignalPeptideId = lipoproteinSignalPeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LipoproteinSignalPeptideId))
			return false;
		LipoproteinSignalPeptideId castOther = (LipoproteinSignalPeptideId) other;

		return ((this.getLipoproteinSignalPeptideId() == castOther
				.getLipoproteinSignalPeptideId()) || (this
				.getLipoproteinSignalPeptideId() != null
				&& castOther.getLipoproteinSignalPeptideId() != null && this
				.getLipoproteinSignalPeptideId().equals(
						castOther.getLipoproteinSignalPeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLipoproteinSignalPeptideId() == null ? 0 : this
						.getLipoproteinSignalPeptideId().hashCode());
		result = 37 * result
