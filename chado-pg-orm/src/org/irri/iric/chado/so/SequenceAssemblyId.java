...
/**
 * SequenceAssemblyId generated by hbm2java
 */
public class SequenceAssemblyId implements java.io.Serializable {

	private Integer sequenceAssemblyId;
	...
	public SequenceAssemblyId() {
	}

	public SequenceAssemblyId(Integer sequenceAssemblyId, Integer featureId,
		...
		this.sequenceAssemblyId = sequenceAssemblyId;
	...
	public Integer getSequenceAssemblyId() {
		return this.sequenceAssemblyId;
	}

	public void setSequenceAssemblyId(Integer sequenceAssemblyId) {
		this.sequenceAssemblyId = sequenceAssemblyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceAssemblyId))
			return false;
		SequenceAssemblyId castOther = (SequenceAssemblyId) other;

		return ((this.getSequenceAssemblyId() == castOther
				.getSequenceAssemblyId()) || (this.getSequenceAssemblyId() != null
				&& castOther.getSequenceAssemblyId() != null && this
				.getSequenceAssemblyId().equals(
						castOther.getSequenceAssemblyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceAssemblyId() == null ? 0 : this
						.getSequenceAssemblyId().hashCode());
		result = 37 * result
