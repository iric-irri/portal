...
/**
 * TryptophanylTrnaId generated by hbm2java
 */
public class TryptophanylTrnaId implements java.io.Serializable {

	private Integer tryptophanylTrnaId;
	...
	public TryptophanylTrnaId() {
	}

	public TryptophanylTrnaId(Integer tryptophanylTrnaId, Integer featureId,
		...
		this.tryptophanylTrnaId = tryptophanylTrnaId;
	...
	public Integer getTryptophanylTrnaId() {
		return this.tryptophanylTrnaId;
	}

	public void setTryptophanylTrnaId(Integer tryptophanylTrnaId) {
		this.tryptophanylTrnaId = tryptophanylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TryptophanylTrnaId))
			return false;
		TryptophanylTrnaId castOther = (TryptophanylTrnaId) other;

		return ((this.getTryptophanylTrnaId() == castOther
				.getTryptophanylTrnaId()) || (this.getTryptophanylTrnaId() != null
				&& castOther.getTryptophanylTrnaId() != null && this
				.getTryptophanylTrnaId().equals(
						castOther.getTryptophanylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTryptophanylTrnaId() == null ? 0 : this
						.getTryptophanylTrnaId().hashCode());
		result = 37 * result
