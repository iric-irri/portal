...
/**
 * NcPrimaryTranscriptId generated by hbm2java
 */
public class NcPrimaryTranscriptId implements java.io.Serializable {

	private Integer ncPrimaryTranscriptId;
	...
	public NcPrimaryTranscriptId() {
	}

	public NcPrimaryTranscriptId(Integer ncPrimaryTranscriptId,
		...
		this.ncPrimaryTranscriptId = ncPrimaryTranscriptId;
	...
	public Integer getNcPrimaryTranscriptId() {
		return this.ncPrimaryTranscriptId;
	}

	public void setNcPrimaryTranscriptId(Integer ncPrimaryTranscriptId) {
		this.ncPrimaryTranscriptId = ncPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcPrimaryTranscriptId))
			return false;
		NcPrimaryTranscriptId castOther = (NcPrimaryTranscriptId) other;

		return ((this.getNcPrimaryTranscriptId() == castOther
				.getNcPrimaryTranscriptId()) || (this
				.getNcPrimaryTranscriptId() != null
				&& castOther.getNcPrimaryTranscriptId() != null && this
				.getNcPrimaryTranscriptId().equals(
						castOther.getNcPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNcPrimaryTranscriptId() == null ? 0 : this
						.getNcPrimaryTranscriptId().hashCode());
		result = 37 * result
