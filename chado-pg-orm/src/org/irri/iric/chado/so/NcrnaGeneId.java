...
/**
 * NcrnaGeneId generated by hbm2java
 */
public class NcrnaGeneId implements java.io.Serializable {

	private Integer ncrnaGeneId;
	...
	public NcrnaGeneId(Integer ncrnaGeneId, Integer featureId,
	...
	public Integer getNcrnaGeneId() {
		return this.ncrnaGeneId;
	}

	public void setNcrnaGeneId(Integer ncrnaGeneId) {
		this.ncrnaGeneId = ncrnaGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcrnaGeneId))
			return false;
		NcrnaGeneId castOther = (NcrnaGeneId) other;

		return ((this.getNcrnaGeneId() == castOther.getNcrnaGeneId()) || (this
				.getNcrnaGeneId() != null && castOther.getNcrnaGeneId() != null && this
				.getNcrnaGeneId().equals(castOther.getNcrnaGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNcrnaGeneId() == null ? 0 : this.getNcrnaGeneId()
						.hashCode());
		result = 37 * result
