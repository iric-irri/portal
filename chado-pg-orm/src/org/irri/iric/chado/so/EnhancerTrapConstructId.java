...
/**
 * EnhancerTrapConstructId generated by hbm2java
 */
public class EnhancerTrapConstructId implements java.io.Serializable {

	private Integer enhancerTrapConstructId;
	...
	public EnhancerTrapConstructId() {
	}

	public EnhancerTrapConstructId(Integer enhancerTrapConstructId,
		...
		this.enhancerTrapConstructId = enhancerTrapConstructId;
	...
	public Integer getEnhancerTrapConstructId() {
		return this.enhancerTrapConstructId;
	}

	public void setEnhancerTrapConstructId(Integer enhancerTrapConstructId) {
		this.enhancerTrapConstructId = enhancerTrapConstructId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EnhancerTrapConstructId))
			return false;
		EnhancerTrapConstructId castOther = (EnhancerTrapConstructId) other;

		return ((this.getEnhancerTrapConstructId() == castOther
				.getEnhancerTrapConstructId()) || (this
				.getEnhancerTrapConstructId() != null
				&& castOther.getEnhancerTrapConstructId() != null && this
				.getEnhancerTrapConstructId().equals(
						castOther.getEnhancerTrapConstructId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEnhancerTrapConstructId() == null ? 0 : this
						.getEnhancerTrapConstructId().hashCode());
		result = 37 * result
