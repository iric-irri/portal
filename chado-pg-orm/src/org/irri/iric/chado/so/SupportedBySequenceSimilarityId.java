...
/**
 * SupportedBySequenceSimilarityId generated by hbm2java
 */
public class SupportedBySequenceSimilarityId implements java.io.Serializable {

	private Integer supportedBySequenceSimilarityId;
	...
	public SupportedBySequenceSimilarityId() {
	}

	public SupportedBySequenceSimilarityId(
			Integer supportedBySequenceSimilarityId, Integer featureId,
		...
		this.supportedBySequenceSimilarityId = supportedBySequenceSimilarityId;
	...
	public Integer getSupportedBySequenceSimilarityId() {
		return this.supportedBySequenceSimilarityId;
	}

	public void setSupportedBySequenceSimilarityId(
			Integer supportedBySequenceSimilarityId) {
		this.supportedBySequenceSimilarityId = supportedBySequenceSimilarityId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SupportedBySequenceSimilarityId))
			return false;
		SupportedBySequenceSimilarityId castOther = (SupportedBySequenceSimilarityId) other;

		return ((this.getSupportedBySequenceSimilarityId() == castOther
				.getSupportedBySequenceSimilarityId()) || (this
				.getSupportedBySequenceSimilarityId() != null
				&& castOther.getSupportedBySequenceSimilarityId() != null && this
				.getSupportedBySequenceSimilarityId().equals(
						castOther.getSupportedBySequenceSimilarityId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSupportedBySequenceSimilarityId() == null ? 0 : this
						.getSupportedBySequenceSimilarityId().hashCode());
		result = 37 * result
