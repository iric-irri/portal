...
/**
 * PaternalUniparentalDisomyId generated by hbm2java
 */
public class PaternalUniparentalDisomyId implements java.io.Serializable {

	private Integer paternalUniparentalDisomyId;
	...
	public PaternalUniparentalDisomyId() {
	}

	public PaternalUniparentalDisomyId(Integer paternalUniparentalDisomyId,
		...
		this.paternalUniparentalDisomyId = paternalUniparentalDisomyId;
	...
	public Integer getPaternalUniparentalDisomyId() {
		return this.paternalUniparentalDisomyId;
	}

	public void setPaternalUniparentalDisomyId(
			Integer paternalUniparentalDisomyId) {
		this.paternalUniparentalDisomyId = paternalUniparentalDisomyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaternalUniparentalDisomyId))
			return false;
		PaternalUniparentalDisomyId castOther = (PaternalUniparentalDisomyId) other;

		return ((this.getPaternalUniparentalDisomyId() == castOther
				.getPaternalUniparentalDisomyId()) || (this
				.getPaternalUniparentalDisomyId() != null
				&& castOther.getPaternalUniparentalDisomyId() != null && this
				.getPaternalUniparentalDisomyId().equals(
						castOther.getPaternalUniparentalDisomyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPaternalUniparentalDisomyId() == null ? 0 : this
						.getPaternalUniparentalDisomyId().hashCode());
		result = 37 * result
