...
/**
 * H4k5AcylationSiteId generated by hbm2java
 */
public class H4k5AcylationSiteId implements java.io.Serializable {

	private Integer h4k5AcylationSiteId;
	...
	public H4k5AcylationSiteId() {
	}

	public H4k5AcylationSiteId(Integer h4k5AcylationSiteId, Integer featureId,
		...
		this.h4k5AcylationSiteId = h4k5AcylationSiteId;
	...
	public Integer getH4k5AcylationSiteId() {
		return this.h4k5AcylationSiteId;
	}

	public void setH4k5AcylationSiteId(Integer h4k5AcylationSiteId) {
		this.h4k5AcylationSiteId = h4k5AcylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H4k5AcylationSiteId))
			return false;
		H4k5AcylationSiteId castOther = (H4k5AcylationSiteId) other;

		return ((this.getH4k5AcylationSiteId() == castOther
				.getH4k5AcylationSiteId()) || (this.getH4k5AcylationSiteId() != null
				&& castOther.getH4k5AcylationSiteId() != null && this
				.getH4k5AcylationSiteId().equals(
						castOther.getH4k5AcylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH4k5AcylationSiteId() == null ? 0 : this
						.getH4k5AcylationSiteId().hashCode());
		result = 37 * result
