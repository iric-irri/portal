...
/**
 * MaxicircleGeneId generated by hbm2java
 */
public class MaxicircleGeneId implements java.io.Serializable {

	private Integer maxicircleGeneId;
	...
	public MaxicircleGeneId() {
	}

	public MaxicircleGeneId(Integer maxicircleGeneId, Integer featureId,
		...
		this.maxicircleGeneId = maxicircleGeneId;
	...
	public Integer getMaxicircleGeneId() {
		return this.maxicircleGeneId;
	}

	public void setMaxicircleGeneId(Integer maxicircleGeneId) {
		this.maxicircleGeneId = maxicircleGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MaxicircleGeneId))
			return false;
		MaxicircleGeneId castOther = (MaxicircleGeneId) other;

		return ((this.getMaxicircleGeneId() == castOther.getMaxicircleGeneId()) || (this
				.getMaxicircleGeneId() != null
				&& castOther.getMaxicircleGeneId() != null && this
				.getMaxicircleGeneId().equals(castOther.getMaxicircleGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMaxicircleGeneId() == null ? 0 : this
						.getMaxicircleGeneId().hashCode());
		result = 37 * result
