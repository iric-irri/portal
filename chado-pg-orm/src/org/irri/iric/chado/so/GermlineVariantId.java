...
/**
 * GermlineVariantId generated by hbm2java
 */
public class GermlineVariantId implements java.io.Serializable {

	private Integer germlineVariantId;
	...
	public GermlineVariantId() {
	}

	public GermlineVariantId(Integer germlineVariantId, Integer featureId,
		...
		this.germlineVariantId = germlineVariantId;
	...
	public Integer getGermlineVariantId() {
		return this.germlineVariantId;
	}

	public void setGermlineVariantId(Integer germlineVariantId) {
		this.germlineVariantId = germlineVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GermlineVariantId))
			return false;
		GermlineVariantId castOther = (GermlineVariantId) other;

		return ((this.getGermlineVariantId() == castOther
				.getGermlineVariantId()) || (this.getGermlineVariantId() != null
				&& castOther.getGermlineVariantId() != null && this
				.getGermlineVariantId()
				.equals(castOther.getGermlineVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGermlineVariantId() == null ? 0 : this
						.getGermlineVariantId().hashCode());
		result = 37 * result
