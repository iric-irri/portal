...
/**
 * BetaTurnId generated by hbm2java
 */
public class BetaTurnId implements java.io.Serializable {

	private Integer betaTurnId;
	...
	public BetaTurnId(Integer betaTurnId, Integer featureId, Integer dbxrefId,
	...
	public Integer getBetaTurnId() {
		return this.betaTurnId;
	}

	public void setBetaTurnId(Integer betaTurnId) {
		this.betaTurnId = betaTurnId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnId))
			return false;
		BetaTurnId castOther = (BetaTurnId) other;

		return ((this.getBetaTurnId() == castOther.getBetaTurnId()) || (this
				.getBetaTurnId() != null && castOther.getBetaTurnId() != null && this
				.getBetaTurnId().equals(castOther.getBetaTurnId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnId() == null ? 0 : this.getBetaTurnId()
						.hashCode());
		result = 37 * result
