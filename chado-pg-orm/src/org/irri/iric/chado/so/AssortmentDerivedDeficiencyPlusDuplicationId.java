...
/**
 * AssortmentDerivedDeficiencyPlusDuplicationId generated by hbm2java
 */
public class AssortmentDerivedDeficiencyPlusDuplicationId implements
		java.io.Serializable {

	private Integer assortmentDerivedDeficiencyPlusDuplicationId;
	...
	public AssortmentDerivedDeficiencyPlusDuplicationId() {
	}

	public AssortmentDerivedDeficiencyPlusDuplicationId(
			Integer assortmentDerivedDeficiencyPlusDuplicationId,
		...
		this.assortmentDerivedDeficiencyPlusDuplicationId = assortmentDerivedDeficiencyPlusDuplicationId;
	...
	public Integer getAssortmentDerivedDeficiencyPlusDuplicationId() {
		return this.assortmentDerivedDeficiencyPlusDuplicationId;
	}

	public void setAssortmentDerivedDeficiencyPlusDuplicationId(
			Integer assortmentDerivedDeficiencyPlusDuplicationId) {
		this.assortmentDerivedDeficiencyPlusDuplicationId = assortmentDerivedDeficiencyPlusDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssortmentDerivedDeficiencyPlusDuplicationId))
			return false;
		AssortmentDerivedDeficiencyPlusDuplicationId castOther = (AssortmentDerivedDeficiencyPlusDuplicationId) other;

		return ((this.getAssortmentDerivedDeficiencyPlusDuplicationId() == castOther
				.getAssortmentDerivedDeficiencyPlusDuplicationId()) || (this
				.getAssortmentDerivedDeficiencyPlusDuplicationId() != null
				&& castOther.getAssortmentDerivedDeficiencyPlusDuplicationId() != null && this
				.getAssortmentDerivedDeficiencyPlusDuplicationId()
				.equals(castOther
						.getAssortmentDerivedDeficiencyPlusDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssortmentDerivedDeficiencyPlusDuplicationId() == null ? 0
						: this.getAssortmentDerivedDeficiencyPlusDuplicationId()
								.hashCode());
		result = 37 * result
