...
/**
 * DsRnaViralSequenceId generated by hbm2java
 */
public class DsRnaViralSequenceId implements java.io.Serializable {

	private Integer dsRnaViralSequenceId;
	...
	public DsRnaViralSequenceId() {
	}

	public DsRnaViralSequenceId(Integer dsRnaViralSequenceId,
		...
		this.dsRnaViralSequenceId = dsRnaViralSequenceId;
	...
	public Integer getDsRnaViralSequenceId() {
		return this.dsRnaViralSequenceId;
	}

	public void setDsRnaViralSequenceId(Integer dsRnaViralSequenceId) {
		this.dsRnaViralSequenceId = dsRnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DsRnaViralSequenceId))
			return false;
		DsRnaViralSequenceId castOther = (DsRnaViralSequenceId) other;

		return ((this.getDsRnaViralSequenceId() == castOther
				.getDsRnaViralSequenceId()) || (this.getDsRnaViralSequenceId() != null
				&& castOther.getDsRnaViralSequenceId() != null && this
				.getDsRnaViralSequenceId().equals(
						castOther.getDsRnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDsRnaViralSequenceId() == null ? 0 : this
						.getDsRnaViralSequenceId().hashCode());
		result = 37 * result
