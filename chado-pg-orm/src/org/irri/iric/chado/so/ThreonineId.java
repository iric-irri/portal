...
/**
 * ThreonineId generated by hbm2java
 */
public class ThreonineId implements java.io.Serializable {

	private Integer threonineId;
	...
	public ThreonineId(Integer threonineId, Integer featureId,
	...
	public Integer getThreonineId() {
		return this.threonineId;
	}

	public void setThreonineId(Integer threonineId) {
		this.threonineId = threonineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreonineId))
			return false;
		ThreonineId castOther = (ThreonineId) other;

		return ((this.getThreonineId() == castOther.getThreonineId()) || (this
				.getThreonineId() != null && castOther.getThreonineId() != null && this
				.getThreonineId().equals(castOther.getThreonineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreonineId() == null ? 0 : this.getThreonineId()
						.hashCode());
		result = 37 * result
