...
/**
 * YacId generated by hbm2java
 */
public class YacId implements java.io.Serializable {

	private Integer yacId;
	...
	public YacId(Integer yacId, Integer featureId, Integer dbxrefId,
	...
	public Integer getYacId() {
		return this.yacId;
	}

	public void setYacId(Integer yacId) {
		this.yacId = yacId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YacId))
			return false;
		YacId castOther = (YacId) other;

		return ((this.getYacId() == castOther.getYacId()) || (this.getYacId() != null
				&& castOther.getYacId() != null && this.getYacId().equals(
				castOther.getYacId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getYacId() == null ? 0 : this.getYacId().hashCode());
		result = 37 * result
