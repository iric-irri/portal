...
/**
 * CopyNumberGainId generated by hbm2java
 */
public class CopyNumberGainId implements java.io.Serializable {

	private Integer copyNumberGainId;
	...
	public CopyNumberGainId() {
	}

	public CopyNumberGainId(Integer copyNumberGainId, Integer featureId,
		...
		this.copyNumberGainId = copyNumberGainId;
	...
	public Integer getCopyNumberGainId() {
		return this.copyNumberGainId;
	}

	public void setCopyNumberGainId(Integer copyNumberGainId) {
		this.copyNumberGainId = copyNumberGainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CopyNumberGainId))
			return false;
		CopyNumberGainId castOther = (CopyNumberGainId) other;

		return ((this.getCopyNumberGainId() == castOther.getCopyNumberGainId()) || (this
				.getCopyNumberGainId() != null
				&& castOther.getCopyNumberGainId() != null && this
				.getCopyNumberGainId().equals(castOther.getCopyNumberGainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCopyNumberGainId() == null ? 0 : this
						.getCopyNumberGainId().hashCode());
		result = 37 * result
