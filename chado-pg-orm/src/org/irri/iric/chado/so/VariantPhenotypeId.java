...
/**
 * VariantPhenotypeId generated by hbm2java
 */
public class VariantPhenotypeId implements java.io.Serializable {

	private Integer variantPhenotypeId;
	...
	public VariantPhenotypeId() {
	}

	public VariantPhenotypeId(Integer variantPhenotypeId, Integer featureId,
		...
		this.variantPhenotypeId = variantPhenotypeId;
	...
	public Integer getVariantPhenotypeId() {
		return this.variantPhenotypeId;
	}

	public void setVariantPhenotypeId(Integer variantPhenotypeId) {
		this.variantPhenotypeId = variantPhenotypeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VariantPhenotypeId))
			return false;
		VariantPhenotypeId castOther = (VariantPhenotypeId) other;

		return ((this.getVariantPhenotypeId() == castOther
				.getVariantPhenotypeId()) || (this.getVariantPhenotypeId() != null
				&& castOther.getVariantPhenotypeId() != null && this
				.getVariantPhenotypeId().equals(
						castOther.getVariantPhenotypeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVariantPhenotypeId() == null ? 0 : this
						.getVariantPhenotypeId().hashCode());
		result = 37 * result
