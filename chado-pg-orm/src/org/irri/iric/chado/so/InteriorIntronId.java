...
/**
 * InteriorIntronId generated by hbm2java
 */
public class InteriorIntronId implements java.io.Serializable {

	private Integer interiorIntronId;
	...
	public InteriorIntronId() {
	}

	public InteriorIntronId(Integer interiorIntronId, Integer featureId,
		...
		this.interiorIntronId = interiorIntronId;
	...
	public Integer getInteriorIntronId() {
		return this.interiorIntronId;
	}

	public void setInteriorIntronId(Integer interiorIntronId) {
		this.interiorIntronId = interiorIntronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InteriorIntronId))
			return false;
		InteriorIntronId castOther = (InteriorIntronId) other;

		return ((this.getInteriorIntronId() == castOther.getInteriorIntronId()) || (this
				.getInteriorIntronId() != null
				&& castOther.getInteriorIntronId() != null && this
				.getInteriorIntronId().equals(castOther.getInteriorIntronId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInteriorIntronId() == null ? 0 : this
						.getInteriorIntronId().hashCode());
		result = 37 * result
