...
/**
 * PurineTransitionId generated by hbm2java
 */
public class PurineTransitionId implements java.io.Serializable {

	private Integer purineTransitionId;
	...
	public PurineTransitionId() {
	}

	public PurineTransitionId(Integer purineTransitionId, Integer featureId,
		...
		this.purineTransitionId = purineTransitionId;
	...
	public Integer getPurineTransitionId() {
		return this.purineTransitionId;
	}

	public void setPurineTransitionId(Integer purineTransitionId) {
		this.purineTransitionId = purineTransitionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PurineTransitionId))
			return false;
		PurineTransitionId castOther = (PurineTransitionId) other;

		return ((this.getPurineTransitionId() == castOther
				.getPurineTransitionId()) || (this.getPurineTransitionId() != null
				&& castOther.getPurineTransitionId() != null && this
				.getPurineTransitionId().equals(
						castOther.getPurineTransitionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPurineTransitionId() == null ? 0 : this
						.getPurineTransitionId().hashCode());
		result = 37 * result
