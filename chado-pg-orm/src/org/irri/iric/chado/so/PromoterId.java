...
/**
 * PromoterId generated by hbm2java
 */
public class PromoterId implements java.io.Serializable {
	...
	public PromoterId(Integer promoterId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PromoterId))
			return false;
		PromoterId castOther = (PromoterId) other;

		return ((this.getPromoterId() == castOther.getPromoterId()) || (this
				.getPromoterId() != null && castOther.getPromoterId() != null && this
				.getPromoterId().equals(castOther.getPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPromoterId() == null ? 0 : this.getPromoterId()
						.hashCode());
		result = 37 * result
