...
/**
 * SiteSpecificRecombinationTargetRegionId generated by hbm2java
 */
public class SiteSpecificRecombinationTargetRegionId implements
		java.io.Serializable {

	private Integer siteSpecificRecombinationTargetRegionId;
	...
	public SiteSpecificRecombinationTargetRegionId() {
	}

	public SiteSpecificRecombinationTargetRegionId(
			Integer siteSpecificRecombinationTargetRegionId, Integer featureId,
		...
		this.siteSpecificRecombinationTargetRegionId = siteSpecificRecombinationTargetRegionId;
	...
	public Integer getSiteSpecificRecombinationTargetRegionId() {
		return this.siteSpecificRecombinationTargetRegionId;
	}

	public void setSiteSpecificRecombinationTargetRegionId(
			Integer siteSpecificRecombinationTargetRegionId) {
		this.siteSpecificRecombinationTargetRegionId = siteSpecificRecombinationTargetRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SiteSpecificRecombinationTargetRegionId))
			return false;
		SiteSpecificRecombinationTargetRegionId castOther = (SiteSpecificRecombinationTargetRegionId) other;

		return ((this.getSiteSpecificRecombinationTargetRegionId() == castOther
				.getSiteSpecificRecombinationTargetRegionId()) || (this
				.getSiteSpecificRecombinationTargetRegionId() != null
				&& castOther.getSiteSpecificRecombinationTargetRegionId() != null && this
				.getSiteSpecificRecombinationTargetRegionId().equals(
						castOther.getSiteSpecificRecombinationTargetRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSiteSpecificRecombinationTargetRegionId() == null ? 0
						: this.getSiteSpecificRecombinationTargetRegionId()
								.hashCode());
		result = 37 * result
