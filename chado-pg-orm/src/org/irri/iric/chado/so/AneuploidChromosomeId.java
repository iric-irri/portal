...
/**
 * AneuploidChromosomeId generated by hbm2java
 */
public class AneuploidChromosomeId implements java.io.Serializable {

	private Integer aneuploidChromosomeId;
	...
	public AneuploidChromosomeId() {
	}

	public AneuploidChromosomeId(Integer aneuploidChromosomeId,
		...
		this.aneuploidChromosomeId = aneuploidChromosomeId;
	...
	public Integer getAneuploidChromosomeId() {
		return this.aneuploidChromosomeId;
	}

	public void setAneuploidChromosomeId(Integer aneuploidChromosomeId) {
		this.aneuploidChromosomeId = aneuploidChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AneuploidChromosomeId))
			return false;
		AneuploidChromosomeId castOther = (AneuploidChromosomeId) other;

		return ((this.getAneuploidChromosomeId() == castOther
				.getAneuploidChromosomeId()) || (this
				.getAneuploidChromosomeId() != null
				&& castOther.getAneuploidChromosomeId() != null && this
				.getAneuploidChromosomeId().equals(
						castOther.getAneuploidChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAneuploidChromosomeId() == null ? 0 : this
						.getAneuploidChromosomeId().hashCode());
		result = 37 * result
