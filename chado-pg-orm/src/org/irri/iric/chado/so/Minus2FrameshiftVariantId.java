...
/**
 * Minus2FrameshiftVariantId generated by hbm2java
 */
public class Minus2FrameshiftVariantId implements java.io.Serializable {

	private Integer minus2FrameshiftVariantId;
	...
	public Minus2FrameshiftVariantId() {
	}

	public Minus2FrameshiftVariantId(Integer minus2FrameshiftVariantId,
		...
		this.minus2FrameshiftVariantId = minus2FrameshiftVariantId;
	...
	public Integer getMinus2FrameshiftVariantId() {
		return this.minus2FrameshiftVariantId;
	}

	public void setMinus2FrameshiftVariantId(Integer minus2FrameshiftVariantId) {
		this.minus2FrameshiftVariantId = minus2FrameshiftVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Minus2FrameshiftVariantId))
			return false;
		Minus2FrameshiftVariantId castOther = (Minus2FrameshiftVariantId) other;

		return ((this.getMinus2FrameshiftVariantId() == castOther
				.getMinus2FrameshiftVariantId()) || (this
				.getMinus2FrameshiftVariantId() != null
				&& castOther.getMinus2FrameshiftVariantId() != null && this
				.getMinus2FrameshiftVariantId().equals(
						castOther.getMinus2FrameshiftVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMinus2FrameshiftVariantId() == null ? 0 : this
						.getMinus2FrameshiftVariantId().hashCode());
		result = 37 * result
