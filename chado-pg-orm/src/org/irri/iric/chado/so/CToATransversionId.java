...
/**
 * CToATransversionId generated by hbm2java
 */
public class CToATransversionId implements java.io.Serializable {

	private Integer CToATransversionId;
	...
	public CToATransversionId() {
	}

	public CToATransversionId(Integer CToATransversionId, Integer featureId,
		...
		this.CToATransversionId = CToATransversionId;
	...
	public Integer getCToATransversionId() {
		return this.CToATransversionId;
	}

	public void setCToATransversionId(Integer CToATransversionId) {
		this.CToATransversionId = CToATransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CToATransversionId))
			return false;
		CToATransversionId castOther = (CToATransversionId) other;

		return ((this.getCToATransversionId() == castOther
				.getCToATransversionId()) || (this.getCToATransversionId() != null
				&& castOther.getCToATransversionId() != null && this
				.getCToATransversionId().equals(
						castOther.getCToATransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCToATransversionId() == null ? 0 : this
						.getCToATransversionId().hashCode());
		result = 37 * result
