...
/**
 * IntegratedMobileGeneticElementId generated by hbm2java
 */
public class IntegratedMobileGeneticElementId implements java.io.Serializable {

	private Integer integratedMobileGeneticElementId;
	...
	public IntegratedMobileGeneticElementId() {
	}

	public IntegratedMobileGeneticElementId(
			Integer integratedMobileGeneticElementId, Integer featureId,
		...
		this.integratedMobileGeneticElementId = integratedMobileGeneticElementId;
	...
	public Integer getIntegratedMobileGeneticElementId() {
		return this.integratedMobileGeneticElementId;
	}

	public void setIntegratedMobileGeneticElementId(
			Integer integratedMobileGeneticElementId) {
		this.integratedMobileGeneticElementId = integratedMobileGeneticElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntegratedMobileGeneticElementId))
			return false;
		IntegratedMobileGeneticElementId castOther = (IntegratedMobileGeneticElementId) other;

		return ((this.getIntegratedMobileGeneticElementId() == castOther
				.getIntegratedMobileGeneticElementId()) || (this
				.getIntegratedMobileGeneticElementId() != null
				&& castOther.getIntegratedMobileGeneticElementId() != null && this
				.getIntegratedMobileGeneticElementId().equals(
						castOther.getIntegratedMobileGeneticElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntegratedMobileGeneticElementId() == null ? 0 : this
						.getIntegratedMobileGeneticElementId().hashCode());
		result = 37 * result
