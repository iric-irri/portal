...
/**
 * IntronicSpliceEnhancerId generated by hbm2java
 */
public class IntronicSpliceEnhancerId implements java.io.Serializable {

	private Integer intronicSpliceEnhancerId;
	...
	public IntronicSpliceEnhancerId() {
	}

	public IntronicSpliceEnhancerId(Integer intronicSpliceEnhancerId,
		...
		this.intronicSpliceEnhancerId = intronicSpliceEnhancerId;
	...
	public Integer getIntronicSpliceEnhancerId() {
		return this.intronicSpliceEnhancerId;
	}

	public void setIntronicSpliceEnhancerId(Integer intronicSpliceEnhancerId) {
		this.intronicSpliceEnhancerId = intronicSpliceEnhancerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronicSpliceEnhancerId))
			return false;
		IntronicSpliceEnhancerId castOther = (IntronicSpliceEnhancerId) other;

		return ((this.getIntronicSpliceEnhancerId() == castOther
				.getIntronicSpliceEnhancerId()) || (this
				.getIntronicSpliceEnhancerId() != null
				&& castOther.getIntronicSpliceEnhancerId() != null && this
				.getIntronicSpliceEnhancerId().equals(
						castOther.getIntronicSpliceEnhancerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntronicSpliceEnhancerId() == null ? 0 : this
						.getIntronicSpliceEnhancerId().hashCode());
		result = 37 * result
