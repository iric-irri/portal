...
/**
 * ViralSequenceId generated by hbm2java
 */
public class ViralSequenceId implements java.io.Serializable {

	private Integer viralSequenceId;
	...
	public ViralSequenceId() {
	}

	public ViralSequenceId(Integer viralSequenceId, Integer featureId,
		...
		this.viralSequenceId = viralSequenceId;
	...
	public Integer getViralSequenceId() {
		return this.viralSequenceId;
	}

	public void setViralSequenceId(Integer viralSequenceId) {
		this.viralSequenceId = viralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViralSequenceId))
			return false;
		ViralSequenceId castOther = (ViralSequenceId) other;

		return ((this.getViralSequenceId() == castOther.getViralSequenceId()) || (this
				.getViralSequenceId() != null
				&& castOther.getViralSequenceId() != null && this
				.getViralSequenceId().equals(castOther.getViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getViralSequenceId() == null ? 0 : this.getViralSequenceId()
						.hashCode());
		result = 37 * result
