...
/**
 * CatmatLeftHandedFourId generated by hbm2java
 */
public class CatmatLeftHandedFourId implements java.io.Serializable {

	private Integer catmatLeftHandedFourId;
	...
	public CatmatLeftHandedFourId() {
	}

	public CatmatLeftHandedFourId(Integer catmatLeftHandedFourId,
		...
		this.catmatLeftHandedFourId = catmatLeftHandedFourId;
	...
	public Integer getCatmatLeftHandedFourId() {
		return this.catmatLeftHandedFourId;
	}

	public void setCatmatLeftHandedFourId(Integer catmatLeftHandedFourId) {
		this.catmatLeftHandedFourId = catmatLeftHandedFourId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatmatLeftHandedFourId))
			return false;
		CatmatLeftHandedFourId castOther = (CatmatLeftHandedFourId) other;

		return ((this.getCatmatLeftHandedFourId() == castOther
				.getCatmatLeftHandedFourId()) || (this
				.getCatmatLeftHandedFourId() != null
				&& castOther.getCatmatLeftHandedFourId() != null && this
				.getCatmatLeftHandedFourId().equals(
						castOther.getCatmatLeftHandedFourId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCatmatLeftHandedFourId() == null ? 0 : this
						.getCatmatLeftHandedFourId().hashCode());
		result = 37 * result
