...
/**
 * PositivelyAutoregulatedId generated by hbm2java
 */
public class PositivelyAutoregulatedId implements java.io.Serializable {

	private Integer positivelyAutoregulatedId;
	...
	public PositivelyAutoregulatedId() {
	}

	public PositivelyAutoregulatedId(Integer positivelyAutoregulatedId,
		...
		this.positivelyAutoregulatedId = positivelyAutoregulatedId;
	...
	public Integer getPositivelyAutoregulatedId() {
		return this.positivelyAutoregulatedId;
	}

	public void setPositivelyAutoregulatedId(Integer positivelyAutoregulatedId) {
		this.positivelyAutoregulatedId = positivelyAutoregulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PositivelyAutoregulatedId))
			return false;
		PositivelyAutoregulatedId castOther = (PositivelyAutoregulatedId) other;

		return ((this.getPositivelyAutoregulatedId() == castOther
				.getPositivelyAutoregulatedId()) || (this
				.getPositivelyAutoregulatedId() != null
				&& castOther.getPositivelyAutoregulatedId() != null && this
				.getPositivelyAutoregulatedId().equals(
						castOther.getPositivelyAutoregulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPositivelyAutoregulatedId() == null ? 0 : this
						.getPositivelyAutoregulatedId().hashCode());
		result = 37 * result
