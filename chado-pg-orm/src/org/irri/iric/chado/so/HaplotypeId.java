...
/**
 * HaplotypeId generated by hbm2java
 */
public class HaplotypeId implements java.io.Serializable {
	...
	public HaplotypeId(Integer haplotypeId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HaplotypeId))
			return false;
		HaplotypeId castOther = (HaplotypeId) other;

		return ((this.getHaplotypeId() == castOther.getHaplotypeId()) || (this
				.getHaplotypeId() != null && castOther.getHaplotypeId() != null && this
				.getHaplotypeId().equals(castOther.getHaplotypeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHaplotypeId() == null ? 0 : this.getHaplotypeId()
						.hashCode());
		result = 37 * result
