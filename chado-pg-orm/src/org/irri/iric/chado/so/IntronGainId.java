...
/**
 * IntronGainId generated by hbm2java
 */
public class IntronGainId implements java.io.Serializable {

	private Integer intronGainId;
	...
	public IntronGainId(Integer intronGainId, Integer featureId,
		...
		this.intronGainId = intronGainId;
	...
	public Integer getIntronGainId() {
		return this.intronGainId;
	}

	public void setIntronGainId(Integer intronGainId) {
		this.intronGainId = intronGainId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronGainId))
			return false;
		IntronGainId castOther = (IntronGainId) other;

		return ((this.getIntronGainId() == castOther.getIntronGainId()) || (this
				.getIntronGainId() != null
				&& castOther.getIntronGainId() != null && this
				.getIntronGainId().equals(castOther.getIntronGainId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntronGainId() == null ? 0 : this.getIntronGainId()
						.hashCode());
		result = 37 * result
