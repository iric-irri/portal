...
/**
 * InvalidatedCdnaCloneId generated by hbm2java
 */
public class InvalidatedCdnaCloneId implements java.io.Serializable {

	private Integer invalidatedCdnaCloneId;
	...
	public InvalidatedCdnaCloneId() {
	}

	public InvalidatedCdnaCloneId(Integer invalidatedCdnaCloneId,
		...
		this.invalidatedCdnaCloneId = invalidatedCdnaCloneId;
	...
	public Integer getInvalidatedCdnaCloneId() {
		return this.invalidatedCdnaCloneId;
	}

	public void setInvalidatedCdnaCloneId(Integer invalidatedCdnaCloneId) {
		this.invalidatedCdnaCloneId = invalidatedCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvalidatedCdnaCloneId))
			return false;
		InvalidatedCdnaCloneId castOther = (InvalidatedCdnaCloneId) other;

		return ((this.getInvalidatedCdnaCloneId() == castOther
				.getInvalidatedCdnaCloneId()) || (this
				.getInvalidatedCdnaCloneId() != null
				&& castOther.getInvalidatedCdnaCloneId() != null && this
				.getInvalidatedCdnaCloneId().equals(
						castOther.getInvalidatedCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInvalidatedCdnaCloneId() == null ? 0 : this
						.getInvalidatedCdnaCloneId().hashCode());
		result = 37 * result
