...
/**
 * OverlappingEstSetId generated by hbm2java
 */
public class OverlappingEstSetId implements java.io.Serializable {

	private Integer overlappingEstSetId;
	...
	public OverlappingEstSetId() {
	}

	public OverlappingEstSetId(Integer overlappingEstSetId, Integer featureId,
		...
		this.overlappingEstSetId = overlappingEstSetId;
	...
	public Integer getOverlappingEstSetId() {
		return this.overlappingEstSetId;
	}

	public void setOverlappingEstSetId(Integer overlappingEstSetId) {
		this.overlappingEstSetId = overlappingEstSetId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OverlappingEstSetId))
			return false;
		OverlappingEstSetId castOther = (OverlappingEstSetId) other;

		return ((this.getOverlappingEstSetId() == castOther
				.getOverlappingEstSetId()) || (this.getOverlappingEstSetId() != null
				&& castOther.getOverlappingEstSetId() != null && this
				.getOverlappingEstSetId().equals(
						castOther.getOverlappingEstSetId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOverlappingEstSetId() == null ? 0 : this
						.getOverlappingEstSetId().hashCode());
		result = 37 * result
