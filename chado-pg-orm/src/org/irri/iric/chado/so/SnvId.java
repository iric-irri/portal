...
/**
 * SnvId generated by hbm2java
 */
public class SnvId implements java.io.Serializable {

	private Integer snvId;
	...
	public SnvId(Integer snvId, Integer featureId, Integer dbxrefId,
	...
	public Integer getSnvId() {
		return this.snvId;
	}

	public void setSnvId(Integer snvId) {
		this.snvId = snvId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnvId))
			return false;
		SnvId castOther = (SnvId) other;

		return ((this.getSnvId() == castOther.getSnvId()) || (this.getSnvId() != null
				&& castOther.getSnvId() != null && this.getSnvId().equals(
				castOther.getSnvId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSnvId() == null ? 0 : this.getSnvId().hashCode());
		result = 37 * result
