...
/**
 * GeneFusionId generated by hbm2java
 */
public class GeneFusionId implements java.io.Serializable {

	private Integer geneFusionId;
	...
	public GeneFusionId(Integer geneFusionId, Integer featureId,
		...
		this.geneFusionId = geneFusionId;
	...
	public Integer getGeneFusionId() {
		return this.geneFusionId;
	}

	public void setGeneFusionId(Integer geneFusionId) {
		this.geneFusionId = geneFusionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneFusionId))
			return false;
		GeneFusionId castOther = (GeneFusionId) other;

		return ((this.getGeneFusionId() == castOther.getGeneFusionId()) || (this
				.getGeneFusionId() != null
				&& castOther.getGeneFusionId() != null && this
				.getGeneFusionId().equals(castOther.getGeneFusionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneFusionId() == null ? 0 : this.getGeneFusionId()
						.hashCode());
		result = 37 * result
