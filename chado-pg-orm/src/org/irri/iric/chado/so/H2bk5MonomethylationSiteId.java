...
/**
 * H2bk5MonomethylationSiteId generated by hbm2java
 */
public class H2bk5MonomethylationSiteId implements java.io.Serializable {

	private Integer h2bk5MonomethylationSiteId;
	...
	public H2bk5MonomethylationSiteId() {
	}

	public H2bk5MonomethylationSiteId(Integer h2bk5MonomethylationSiteId,
		...
		this.h2bk5MonomethylationSiteId = h2bk5MonomethylationSiteId;
	...
	public Integer getH2bk5MonomethylationSiteId() {
		return this.h2bk5MonomethylationSiteId;
	}

	public void setH2bk5MonomethylationSiteId(Integer h2bk5MonomethylationSiteId) {
		this.h2bk5MonomethylationSiteId = h2bk5MonomethylationSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof H2bk5MonomethylationSiteId))
			return false;
		H2bk5MonomethylationSiteId castOther = (H2bk5MonomethylationSiteId) other;

		return ((this.getH2bk5MonomethylationSiteId() == castOther
				.getH2bk5MonomethylationSiteId()) || (this
				.getH2bk5MonomethylationSiteId() != null
				&& castOther.getH2bk5MonomethylationSiteId() != null && this
				.getH2bk5MonomethylationSiteId().equals(
						castOther.getH2bk5MonomethylationSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getH2bk5MonomethylationSiteId() == null ? 0 : this
						.getH2bk5MonomethylationSiteId().hashCode());
		result = 37 * result
