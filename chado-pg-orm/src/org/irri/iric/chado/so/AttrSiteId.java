...
/**
 * AttrSiteId generated by hbm2java
 */
public class AttrSiteId implements java.io.Serializable {

	private Integer attrSiteId;
	...
	public AttrSiteId(Integer attrSiteId, Integer featureId, Integer dbxrefId,
	...
	public Integer getAttrSiteId() {
		return this.attrSiteId;
	}

	public void setAttrSiteId(Integer attrSiteId) {
		this.attrSiteId = attrSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AttrSiteId))
			return false;
		AttrSiteId castOther = (AttrSiteId) other;

		return ((this.getAttrSiteId() == castOther.getAttrSiteId()) || (this
				.getAttrSiteId() != null && castOther.getAttrSiteId() != null && this
				.getAttrSiteId().equals(castOther.getAttrSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAttrSiteId() == null ? 0 : this.getAttrSiteId()
						.hashCode());
		result = 37 * result
