...
/**
 * SyntheticOligoId generated by hbm2java
 */
public class SyntheticOligoId implements java.io.Serializable {

	private Integer syntheticOligoId;
	...
	public SyntheticOligoId() {
	}

	public SyntheticOligoId(Integer syntheticOligoId, Integer featureId,
		...
		this.syntheticOligoId = syntheticOligoId;
	...
	public Integer getSyntheticOligoId() {
		return this.syntheticOligoId;
	}

	public void setSyntheticOligoId(Integer syntheticOligoId) {
		this.syntheticOligoId = syntheticOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SyntheticOligoId))
			return false;
		SyntheticOligoId castOther = (SyntheticOligoId) other;

		return ((this.getSyntheticOligoId() == castOther.getSyntheticOligoId()) || (this
				.getSyntheticOligoId() != null
				&& castOther.getSyntheticOligoId() != null && this
				.getSyntheticOligoId().equals(castOther.getSyntheticOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSyntheticOligoId() == null ? 0 : this
						.getSyntheticOligoId().hashCode());
		result = 37 * result
