...
/**
 * TranscriptionVariantId generated by hbm2java
 */
public class TranscriptionVariantId implements java.io.Serializable {

	private Integer transcriptionVariantId;
	...
	public TranscriptionVariantId() {
	}

	public TranscriptionVariantId(Integer transcriptionVariantId,
		...
		this.transcriptionVariantId = transcriptionVariantId;
	...
	public Integer getTranscriptionVariantId() {
		return this.transcriptionVariantId;
	}

	public void setTranscriptionVariantId(Integer transcriptionVariantId) {
		this.transcriptionVariantId = transcriptionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptionVariantId))
			return false;
		TranscriptionVariantId castOther = (TranscriptionVariantId) other;

		return ((this.getTranscriptionVariantId() == castOther
				.getTranscriptionVariantId()) || (this
				.getTranscriptionVariantId() != null
				&& castOther.getTranscriptionVariantId() != null && this
				.getTranscriptionVariantId().equals(
						castOther.getTranscriptionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptionVariantId() == null ? 0 : this
						.getTranscriptionVariantId().hashCode());
		result = 37 * result
