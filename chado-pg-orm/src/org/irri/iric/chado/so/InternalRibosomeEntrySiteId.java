...
/**
 * InternalRibosomeEntrySiteId generated by hbm2java
 */
public class InternalRibosomeEntrySiteId implements java.io.Serializable {

	private Integer internalRibosomeEntrySiteId;
	...
	public InternalRibosomeEntrySiteId() {
	}

	public InternalRibosomeEntrySiteId(Integer internalRibosomeEntrySiteId,
		...
		this.internalRibosomeEntrySiteId = internalRibosomeEntrySiteId;
	...
	public Integer getInternalRibosomeEntrySiteId() {
		return this.internalRibosomeEntrySiteId;
	}

	public void setInternalRibosomeEntrySiteId(
			Integer internalRibosomeEntrySiteId) {
		this.internalRibosomeEntrySiteId = internalRibosomeEntrySiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalRibosomeEntrySiteId))
			return false;
		InternalRibosomeEntrySiteId castOther = (InternalRibosomeEntrySiteId) other;

		return ((this.getInternalRibosomeEntrySiteId() == castOther
				.getInternalRibosomeEntrySiteId()) || (this
				.getInternalRibosomeEntrySiteId() != null
				&& castOther.getInternalRibosomeEntrySiteId() != null && this
				.getInternalRibosomeEntrySiteId().equals(
						castOther.getInternalRibosomeEntrySiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalRibosomeEntrySiteId() == null ? 0 : this
						.getInternalRibosomeEntrySiteId().hashCode());
		result = 37 * result
