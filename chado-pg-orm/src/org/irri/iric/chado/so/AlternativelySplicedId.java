...
/**
 * AlternativelySplicedId generated by hbm2java
 */
public class AlternativelySplicedId implements java.io.Serializable {

	private Integer alternativelySplicedId;
	...
	public AlternativelySplicedId() {
	}

	public AlternativelySplicedId(Integer alternativelySplicedId,
		...
		this.alternativelySplicedId = alternativelySplicedId;
	...
	public Integer getAlternativelySplicedId() {
		return this.alternativelySplicedId;
	}

	public void setAlternativelySplicedId(Integer alternativelySplicedId) {
		this.alternativelySplicedId = alternativelySplicedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AlternativelySplicedId))
			return false;
		AlternativelySplicedId castOther = (AlternativelySplicedId) other;

		return ((this.getAlternativelySplicedId() == castOther
				.getAlternativelySplicedId()) || (this
				.getAlternativelySplicedId() != null
				&& castOther.getAlternativelySplicedId() != null && this
				.getAlternativelySplicedId().equals(
						castOther.getAlternativelySplicedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAlternativelySplicedId() == null ? 0 : this
						.getAlternativelySplicedId().hashCode());
		result = 37 * result
