...
/**
 * TwoMethylthioN6ThreonylCarbamoyladenosineId generated by hbm2java
 */
public class TwoMethylthioN6ThreonylCarbamoyladenosineId implements
		java.io.Serializable {

	private Integer twoMethylthioN6ThreonylCarbamoyladenosineId;
	...
	public TwoMethylthioN6ThreonylCarbamoyladenosineId() {
	}

	public TwoMethylthioN6ThreonylCarbamoyladenosineId(
			Integer twoMethylthioN6ThreonylCarbamoyladenosineId,
		...
		this.twoMethylthioN6ThreonylCarbamoyladenosineId = twoMethylthioN6ThreonylCarbamoyladenosineId;
	...
	public Integer getTwoMethylthioN6ThreonylCarbamoyladenosineId() {
		return this.twoMethylthioN6ThreonylCarbamoyladenosineId;
	}

	public void setTwoMethylthioN6ThreonylCarbamoyladenosineId(
			Integer twoMethylthioN6ThreonylCarbamoyladenosineId) {
		this.twoMethylthioN6ThreonylCarbamoyladenosineId = twoMethylthioN6ThreonylCarbamoyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TwoMethylthioN6ThreonylCarbamoyladenosineId))
			return false;
		TwoMethylthioN6ThreonylCarbamoyladenosineId castOther = (TwoMethylthioN6ThreonylCarbamoyladenosineId) other;

		return ((this.getTwoMethylthioN6ThreonylCarbamoyladenosineId() == castOther
				.getTwoMethylthioN6ThreonylCarbamoyladenosineId()) || (this
				.getTwoMethylthioN6ThreonylCarbamoyladenosineId() != null
				&& castOther.getTwoMethylthioN6ThreonylCarbamoyladenosineId() != null && this
				.getTwoMethylthioN6ThreonylCarbamoyladenosineId()
				.equals(castOther
						.getTwoMethylthioN6ThreonylCarbamoyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTwoMethylthioN6ThreonylCarbamoyladenosineId() == null ? 0
						: this.getTwoMethylthioN6ThreonylCarbamoyladenosineId()
								.hashCode());
		result = 37 * result
