...
/**
 * RapdId generated by hbm2java
 */
public class RapdId implements java.io.Serializable {

	private Integer rapdId;
	...
	public RapdId(Integer rapdId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRapdId() {
		return this.rapdId;
	}

	public void setRapdId(Integer rapdId) {
		this.rapdId = rapdId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RapdId))
			return false;
		RapdId castOther = (RapdId) other;

		return ((this.getRapdId() == castOther.getRapdId()) || (this
				.getRapdId() != null && castOther.getRapdId() != null && this
				.getRapdId().equals(castOther.getRapdId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRapdId() == null ? 0 : this.getRapdId().hashCode());
		result = 37 * result
