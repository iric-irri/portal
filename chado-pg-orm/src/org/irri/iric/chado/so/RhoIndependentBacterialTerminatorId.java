...
/**
 * RhoIndependentBacterialTerminatorId generated by hbm2java
 */
public class RhoIndependentBacterialTerminatorId implements
		java.io.Serializable {

	private Integer rhoIndependentBacterialTerminatorId;
	...
	public RhoIndependentBacterialTerminatorId() {
	}

	public RhoIndependentBacterialTerminatorId(
			Integer rhoIndependentBacterialTerminatorId, Integer featureId,
		...
		this.rhoIndependentBacterialTerminatorId = rhoIndependentBacterialTerminatorId;
	...
	public Integer getRhoIndependentBacterialTerminatorId() {
		return this.rhoIndependentBacterialTerminatorId;
	}

	public void setRhoIndependentBacterialTerminatorId(
			Integer rhoIndependentBacterialTerminatorId) {
		this.rhoIndependentBacterialTerminatorId = rhoIndependentBacterialTerminatorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RhoIndependentBacterialTerminatorId))
			return false;
		RhoIndependentBacterialTerminatorId castOther = (RhoIndependentBacterialTerminatorId) other;

		return ((this.getRhoIndependentBacterialTerminatorId() == castOther
				.getRhoIndependentBacterialTerminatorId()) || (this
				.getRhoIndependentBacterialTerminatorId() != null
				&& castOther.getRhoIndependentBacterialTerminatorId() != null && this
				.getRhoIndependentBacterialTerminatorId().equals(
						castOther.getRhoIndependentBacterialTerminatorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRhoIndependentBacterialTerminatorId() == null ? 0 : this
						.getRhoIndependentBacterialTerminatorId().hashCode());
		result = 37 * result
