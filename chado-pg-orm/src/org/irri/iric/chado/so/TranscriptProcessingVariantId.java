...
/**
 * TranscriptProcessingVariantId generated by hbm2java
 */
public class TranscriptProcessingVariantId implements java.io.Serializable {

	private Integer transcriptProcessingVariantId;
	...
	public TranscriptProcessingVariantId() {
	}

	public TranscriptProcessingVariantId(Integer transcriptProcessingVariantId,
		...
		this.transcriptProcessingVariantId = transcriptProcessingVariantId;
	...
	public Integer getTranscriptProcessingVariantId() {
		return this.transcriptProcessingVariantId;
	}

	public void setTranscriptProcessingVariantId(
			Integer transcriptProcessingVariantId) {
		this.transcriptProcessingVariantId = transcriptProcessingVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptProcessingVariantId))
			return false;
		TranscriptProcessingVariantId castOther = (TranscriptProcessingVariantId) other;

		return ((this.getTranscriptProcessingVariantId() == castOther
				.getTranscriptProcessingVariantId()) || (this
				.getTranscriptProcessingVariantId() != null
				&& castOther.getTranscriptProcessingVariantId() != null && this
				.getTranscriptProcessingVariantId().equals(
						castOther.getTranscriptProcessingVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptProcessingVariantId() == null ? 0 : this
						.getTranscriptProcessingVariantId().hashCode());
		result = 37 * result
