...
/**
 * TmrnaEncodingId generated by hbm2java
 */
public class TmrnaEncodingId implements java.io.Serializable {

	private Integer tmrnaEncodingId;
	...
	public TmrnaEncodingId() {
	}

	public TmrnaEncodingId(Integer tmrnaEncodingId, Integer featureId,
		...
		this.tmrnaEncodingId = tmrnaEncodingId;
	...
	public Integer getTmrnaEncodingId() {
		return this.tmrnaEncodingId;
	}

	public void setTmrnaEncodingId(Integer tmrnaEncodingId) {
		this.tmrnaEncodingId = tmrnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaEncodingId))
			return false;
		TmrnaEncodingId castOther = (TmrnaEncodingId) other;

		return ((this.getTmrnaEncodingId() == castOther.getTmrnaEncodingId()) || (this
				.getTmrnaEncodingId() != null
				&& castOther.getTmrnaEncodingId() != null && this
				.getTmrnaEncodingId().equals(castOther.getTmrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTmrnaEncodingId() == null ? 0 : this.getTmrnaEncodingId()
						.hashCode());
		result = 37 * result
