...
/**
 * YacEndId generated by hbm2java
 */
public class YacEndId implements java.io.Serializable {

	private Integer yacEndId;
	...
	public YacEndId(Integer yacEndId, Integer featureId, Integer dbxrefId,
	...
	public Integer getYacEndId() {
		return this.yacEndId;
	}

	public void setYacEndId(Integer yacEndId) {
		this.yacEndId = yacEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YacEndId))
			return false;
		YacEndId castOther = (YacEndId) other;

		return ((this.getYacEndId() == castOther.getYacEndId()) || (this
				.getYacEndId() != null && castOther.getYacEndId() != null && this
				.getYacEndId().equals(castOther.getYacEndId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getYacEndId() == null ? 0 : this.getYacEndId().hashCode());
		result = 37 * result
