...
/**
 * CrypticGeneId generated by hbm2java
 */
public class CrypticGeneId implements java.io.Serializable {

	private Integer crypticGeneId;
	...
	public CrypticGeneId() {
	}

	public CrypticGeneId(Integer crypticGeneId, Integer featureId,
		...
		this.crypticGeneId = crypticGeneId;
	...
	public Integer getCrypticGeneId() {
		return this.crypticGeneId;
	}

	public void setCrypticGeneId(Integer crypticGeneId) {
		this.crypticGeneId = crypticGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticGeneId))
			return false;
		CrypticGeneId castOther = (CrypticGeneId) other;

		return ((this.getCrypticGeneId() == castOther.getCrypticGeneId()) || (this
				.getCrypticGeneId() != null
				&& castOther.getCrypticGeneId() != null && this
				.getCrypticGeneId().equals(castOther.getCrypticGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticGeneId() == null ? 0 : this.getCrypticGeneId()
						.hashCode());
		result = 37 * result
