...
/**
 * CloneInsertStartId generated by hbm2java
 */
public class CloneInsertStartId implements java.io.Serializable {

	private Integer cloneInsertStartId;
	...
	public CloneInsertStartId() {
	}

	public CloneInsertStartId(Integer cloneInsertStartId, Integer featureId,
		...
		this.cloneInsertStartId = cloneInsertStartId;
	...
	public Integer getCloneInsertStartId() {
		return this.cloneInsertStartId;
	}

	public void setCloneInsertStartId(Integer cloneInsertStartId) {
		this.cloneInsertStartId = cloneInsertStartId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CloneInsertStartId))
			return false;
		CloneInsertStartId castOther = (CloneInsertStartId) other;

		return ((this.getCloneInsertStartId() == castOther
				.getCloneInsertStartId()) || (this.getCloneInsertStartId() != null
				&& castOther.getCloneInsertStartId() != null && this
				.getCloneInsertStartId().equals(
						castOther.getCloneInsertStartId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCloneInsertStartId() == null ? 0 : this
						.getCloneInsertStartId().hashCode());
		result = 37 * result
