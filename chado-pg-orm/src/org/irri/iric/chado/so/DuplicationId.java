...
/**
 * DuplicationId generated by hbm2java
 */
public class DuplicationId implements java.io.Serializable {
	...
	public DuplicationId(Integer duplicationId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DuplicationId))
			return false;
		DuplicationId castOther = (DuplicationId) other;

		return ((this.getDuplicationId() == castOther.getDuplicationId()) || (this
				.getDuplicationId() != null
				&& castOther.getDuplicationId() != null && this
				.getDuplicationId().equals(castOther.getDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDuplicationId() == null ? 0 : this.getDuplicationId()
						.hashCode());
		result = 37 * result
