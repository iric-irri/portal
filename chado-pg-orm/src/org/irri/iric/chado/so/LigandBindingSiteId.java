...
/**
 * LigandBindingSiteId generated by hbm2java
 */
public class LigandBindingSiteId implements java.io.Serializable {

	private Integer ligandBindingSiteId;
	...
	public LigandBindingSiteId() {
	}

	public LigandBindingSiteId(Integer ligandBindingSiteId, Integer featureId,
		...
		this.ligandBindingSiteId = ligandBindingSiteId;
	...
	public Integer getLigandBindingSiteId() {
		return this.ligandBindingSiteId;
	}

	public void setLigandBindingSiteId(Integer ligandBindingSiteId) {
		this.ligandBindingSiteId = ligandBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LigandBindingSiteId))
			return false;
		LigandBindingSiteId castOther = (LigandBindingSiteId) other;

		return ((this.getLigandBindingSiteId() == castOther
				.getLigandBindingSiteId()) || (this.getLigandBindingSiteId() != null
				&& castOther.getLigandBindingSiteId() != null && this
				.getLigandBindingSiteId().equals(
						castOther.getLigandBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLigandBindingSiteId() == null ? 0 : this
						.getLigandBindingSiteId().hashCode());
		result = 37 * result
