...
/**
 * GlutaminylTrnaId generated by hbm2java
 */
public class GlutaminylTrnaId implements java.io.Serializable {

	private Integer glutaminylTrnaId;
	...
	public GlutaminylTrnaId() {
	}

	public GlutaminylTrnaId(Integer glutaminylTrnaId, Integer featureId,
		...
		this.glutaminylTrnaId = glutaminylTrnaId;
	...
	public Integer getGlutaminylTrnaId() {
		return this.glutaminylTrnaId;
	}

	public void setGlutaminylTrnaId(Integer glutaminylTrnaId) {
		this.glutaminylTrnaId = glutaminylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutaminylTrnaId))
			return false;
		GlutaminylTrnaId castOther = (GlutaminylTrnaId) other;

		return ((this.getGlutaminylTrnaId() == castOther.getGlutaminylTrnaId()) || (this
				.getGlutaminylTrnaId() != null
				&& castOther.getGlutaminylTrnaId() != null && this
				.getGlutaminylTrnaId().equals(castOther.getGlutaminylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutaminylTrnaId() == null ? 0 : this
						.getGlutaminylTrnaId().hashCode());
		result = 37 * result
