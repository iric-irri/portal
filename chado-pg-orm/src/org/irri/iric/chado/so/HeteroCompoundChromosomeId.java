...
/**
 * HeteroCompoundChromosomeId generated by hbm2java
 */
public class HeteroCompoundChromosomeId implements java.io.Serializable {

	private Integer heteroCompoundChromosomeId;
	...
	public HeteroCompoundChromosomeId() {
	}

	public HeteroCompoundChromosomeId(Integer heteroCompoundChromosomeId,
		...
		this.heteroCompoundChromosomeId = heteroCompoundChromosomeId;
	...
	public Integer getHeteroCompoundChromosomeId() {
		return this.heteroCompoundChromosomeId;
	}

	public void setHeteroCompoundChromosomeId(Integer heteroCompoundChromosomeId) {
		this.heteroCompoundChromosomeId = heteroCompoundChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HeteroCompoundChromosomeId))
			return false;
		HeteroCompoundChromosomeId castOther = (HeteroCompoundChromosomeId) other;

		return ((this.getHeteroCompoundChromosomeId() == castOther
				.getHeteroCompoundChromosomeId()) || (this
				.getHeteroCompoundChromosomeId() != null
				&& castOther.getHeteroCompoundChromosomeId() != null && this
				.getHeteroCompoundChromosomeId().equals(
						castOther.getHeteroCompoundChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getHeteroCompoundChromosomeId() == null ? 0 : this
						.getHeteroCompoundChromosomeId().hashCode());
		result = 37 * result
