...
/**
 * EncodesDifferentPolypeptidesDifferentStopId generated by hbm2java
 */
public class EncodesDifferentPolypeptidesDifferentStopId implements
		java.io.Serializable {

	private Integer encodesDifferentPolypeptidesDifferentStopId;
	...
	public EncodesDifferentPolypeptidesDifferentStopId() {
	}

	public EncodesDifferentPolypeptidesDifferentStopId(
			Integer encodesDifferentPolypeptidesDifferentStopId,
		...
		this.encodesDifferentPolypeptidesDifferentStopId = encodesDifferentPolypeptidesDifferentStopId;
	...
	public Integer getEncodesDifferentPolypeptidesDifferentStopId() {
		return this.encodesDifferentPolypeptidesDifferentStopId;
	}

	public void setEncodesDifferentPolypeptidesDifferentStopId(
			Integer encodesDifferentPolypeptidesDifferentStopId) {
		this.encodesDifferentPolypeptidesDifferentStopId = encodesDifferentPolypeptidesDifferentStopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesDifferentPolypeptidesDifferentStopId))
			return false;
		EncodesDifferentPolypeptidesDifferentStopId castOther = (EncodesDifferentPolypeptidesDifferentStopId) other;

		return ((this.getEncodesDifferentPolypeptidesDifferentStopId() == castOther
				.getEncodesDifferentPolypeptidesDifferentStopId()) || (this
				.getEncodesDifferentPolypeptidesDifferentStopId() != null
				&& castOther.getEncodesDifferentPolypeptidesDifferentStopId() != null && this
				.getEncodesDifferentPolypeptidesDifferentStopId()
				.equals(castOther
						.getEncodesDifferentPolypeptidesDifferentStopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesDifferentPolypeptidesDifferentStopId() == null ? 0
						: this.getEncodesDifferentPolypeptidesDifferentStopId()
								.hashCode());
		result = 37 * result
