...
/**
 * GlutamylTrnaId generated by hbm2java
 */
public class GlutamylTrnaId implements java.io.Serializable {

	private Integer glutamylTrnaId;
	...
	public GlutamylTrnaId() {
	}

	public GlutamylTrnaId(Integer glutamylTrnaId, Integer featureId,
		...
		this.glutamylTrnaId = glutamylTrnaId;
	...
	public Integer getGlutamylTrnaId() {
		return this.glutamylTrnaId;
	}

	public void setGlutamylTrnaId(Integer glutamylTrnaId) {
		this.glutamylTrnaId = glutamylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GlutamylTrnaId))
			return false;
		GlutamylTrnaId castOther = (GlutamylTrnaId) other;

		return ((this.getGlutamylTrnaId() == castOther.getGlutamylTrnaId()) || (this
				.getGlutamylTrnaId() != null
				&& castOther.getGlutamylTrnaId() != null && this
				.getGlutamylTrnaId().equals(castOther.getGlutamylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGlutamylTrnaId() == null ? 0 : this.getGlutamylTrnaId()
						.hashCode());
		result = 37 * result
