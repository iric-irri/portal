...
/**
 * TransgenicTransposableElementId generated by hbm2java
 */
public class TransgenicTransposableElementId implements java.io.Serializable {

	private Integer transgenicTransposableElementId;
	...
	public TransgenicTransposableElementId() {
	}

	public TransgenicTransposableElementId(
			Integer transgenicTransposableElementId, Integer featureId,
		...
		this.transgenicTransposableElementId = transgenicTransposableElementId;
	...
	public Integer getTransgenicTransposableElementId() {
		return this.transgenicTransposableElementId;
	}

	public void setTransgenicTransposableElementId(
			Integer transgenicTransposableElementId) {
		this.transgenicTransposableElementId = transgenicTransposableElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TransgenicTransposableElementId))
			return false;
		TransgenicTransposableElementId castOther = (TransgenicTransposableElementId) other;

		return ((this.getTransgenicTransposableElementId() == castOther
				.getTransgenicTransposableElementId()) || (this
				.getTransgenicTransposableElementId() != null
				&& castOther.getTransgenicTransposableElementId() != null && this
				.getTransgenicTransposableElementId().equals(
						castOther.getTransgenicTransposableElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTransgenicTransposableElementId() == null ? 0 : this
						.getTransgenicTransposableElementId().hashCode());
		result = 37 * result
