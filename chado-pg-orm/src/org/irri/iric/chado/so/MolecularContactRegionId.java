...
/**
 * MolecularContactRegionId generated by hbm2java
 */
public class MolecularContactRegionId implements java.io.Serializable {

	private Integer molecularContactRegionId;
	...
	public MolecularContactRegionId() {
	}

	public MolecularContactRegionId(Integer molecularContactRegionId,
		...
		this.molecularContactRegionId = molecularContactRegionId;
	...
	public Integer getMolecularContactRegionId() {
		return this.molecularContactRegionId;
	}

	public void setMolecularContactRegionId(Integer molecularContactRegionId) {
		this.molecularContactRegionId = molecularContactRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MolecularContactRegionId))
			return false;
		MolecularContactRegionId castOther = (MolecularContactRegionId) other;

		return ((this.getMolecularContactRegionId() == castOther
				.getMolecularContactRegionId()) || (this
				.getMolecularContactRegionId() != null
				&& castOther.getMolecularContactRegionId() != null && this
				.getMolecularContactRegionId().equals(
						castOther.getMolecularContactRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMolecularContactRegionId() == null ? 0 : this
						.getMolecularContactRegionId().hashCode());
		result = 37 * result
