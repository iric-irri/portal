...
/**
 * PostTranslationallyRegulatedId generated by hbm2java
 */
public class PostTranslationallyRegulatedId implements java.io.Serializable {

	private Integer postTranslationallyRegulatedId;
	...
	public PostTranslationallyRegulatedId() {
	}

	public PostTranslationallyRegulatedId(
			Integer postTranslationallyRegulatedId, Integer featureId,
		...
		this.postTranslationallyRegulatedId = postTranslationallyRegulatedId;
	...
	public Integer getPostTranslationallyRegulatedId() {
		return this.postTranslationallyRegulatedId;
	}

	public void setPostTranslationallyRegulatedId(
			Integer postTranslationallyRegulatedId) {
		this.postTranslationallyRegulatedId = postTranslationallyRegulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PostTranslationallyRegulatedId))
			return false;
		PostTranslationallyRegulatedId castOther = (PostTranslationallyRegulatedId) other;

		return ((this.getPostTranslationallyRegulatedId() == castOther
				.getPostTranslationallyRegulatedId()) || (this
				.getPostTranslationallyRegulatedId() != null
				&& castOther.getPostTranslationallyRegulatedId() != null && this
				.getPostTranslationallyRegulatedId().equals(
						castOther.getPostTranslationallyRegulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPostTranslationallyRegulatedId() == null ? 0 : this
						.getPostTranslationallyRegulatedId().hashCode());
		result = 37 * result
