...
/**
 * NegativelyAutoregulatedId generated by hbm2java
 */
public class NegativelyAutoregulatedId implements java.io.Serializable {

	private Integer negativelyAutoregulatedId;
	...
	public NegativelyAutoregulatedId() {
	}

	public NegativelyAutoregulatedId(Integer negativelyAutoregulatedId,
		...
		this.negativelyAutoregulatedId = negativelyAutoregulatedId;
	...
	public Integer getNegativelyAutoregulatedId() {
		return this.negativelyAutoregulatedId;
	}

	public void setNegativelyAutoregulatedId(Integer negativelyAutoregulatedId) {
		this.negativelyAutoregulatedId = negativelyAutoregulatedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NegativelyAutoregulatedId))
			return false;
		NegativelyAutoregulatedId castOther = (NegativelyAutoregulatedId) other;

		return ((this.getNegativelyAutoregulatedId() == castOther
				.getNegativelyAutoregulatedId()) || (this
				.getNegativelyAutoregulatedId() != null
				&& castOther.getNegativelyAutoregulatedId() != null && this
				.getNegativelyAutoregulatedId().equals(
						castOther.getNegativelyAutoregulatedId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNegativelyAutoregulatedId() == null ? 0 : this
						.getNegativelyAutoregulatedId().hashCode());
		result = 37 * result
