...
/**
 * DsDnaViralSequenceId generated by hbm2java
 */
public class DsDnaViralSequenceId implements java.io.Serializable {

	private Integer dsDnaViralSequenceId;
	...
	public DsDnaViralSequenceId() {
	}

	public DsDnaViralSequenceId(Integer dsDnaViralSequenceId,
		...
		this.dsDnaViralSequenceId = dsDnaViralSequenceId;
	...
	public Integer getDsDnaViralSequenceId() {
		return this.dsDnaViralSequenceId;
	}

	public void setDsDnaViralSequenceId(Integer dsDnaViralSequenceId) {
		this.dsDnaViralSequenceId = dsDnaViralSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DsDnaViralSequenceId))
			return false;
		DsDnaViralSequenceId castOther = (DsDnaViralSequenceId) other;

		return ((this.getDsDnaViralSequenceId() == castOther
				.getDsDnaViralSequenceId()) || (this.getDsDnaViralSequenceId() != null
				&& castOther.getDsDnaViralSequenceId() != null && this
				.getDsDnaViralSequenceId().equals(
						castOther.getDsDnaViralSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDsDnaViralSequenceId() == null ? 0 : this
						.getDsDnaViralSequenceId().hashCode());
		result = 37 * result
