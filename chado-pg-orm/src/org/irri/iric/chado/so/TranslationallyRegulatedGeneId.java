...
/**
 * TranslationallyRegulatedGeneId generated by hbm2java
 */
public class TranslationallyRegulatedGeneId implements java.io.Serializable {

	private Integer translationallyRegulatedGeneId;
	...
	public TranslationallyRegulatedGeneId() {
	}

	public TranslationallyRegulatedGeneId(
			Integer translationallyRegulatedGeneId, Integer featureId,
		...
		this.translationallyRegulatedGeneId = translationallyRegulatedGeneId;
	...
	public Integer getTranslationallyRegulatedGeneId() {
		return this.translationallyRegulatedGeneId;
	}

	public void setTranslationallyRegulatedGeneId(
			Integer translationallyRegulatedGeneId) {
		this.translationallyRegulatedGeneId = translationallyRegulatedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationallyRegulatedGeneId))
			return false;
		TranslationallyRegulatedGeneId castOther = (TranslationallyRegulatedGeneId) other;

		return ((this.getTranslationallyRegulatedGeneId() == castOther
				.getTranslationallyRegulatedGeneId()) || (this
				.getTranslationallyRegulatedGeneId() != null
				&& castOther.getTranslationallyRegulatedGeneId() != null && this
				.getTranslationallyRegulatedGeneId().equals(
						castOther.getTranslationallyRegulatedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationallyRegulatedGeneId() == null ? 0 : this
						.getTranslationallyRegulatedGeneId().hashCode());
		result = 37 * result
