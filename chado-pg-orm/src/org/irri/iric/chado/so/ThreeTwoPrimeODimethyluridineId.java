...
/**
 * ThreeTwoPrimeODimethyluridineId generated by hbm2java
 */
public class ThreeTwoPrimeODimethyluridineId implements java.io.Serializable {

	private Integer threeTwoPrimeODimethyluridineId;
	...
	public ThreeTwoPrimeODimethyluridineId() {
	}

	public ThreeTwoPrimeODimethyluridineId(
			Integer threeTwoPrimeODimethyluridineId, Integer featureId,
		...
		this.threeTwoPrimeODimethyluridineId = threeTwoPrimeODimethyluridineId;
	...
	public Integer getThreeTwoPrimeODimethyluridineId() {
		return this.threeTwoPrimeODimethyluridineId;
	}

	public void setThreeTwoPrimeODimethyluridineId(
			Integer threeTwoPrimeODimethyluridineId) {
		this.threeTwoPrimeODimethyluridineId = threeTwoPrimeODimethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeTwoPrimeODimethyluridineId))
			return false;
		ThreeTwoPrimeODimethyluridineId castOther = (ThreeTwoPrimeODimethyluridineId) other;

		return ((this.getThreeTwoPrimeODimethyluridineId() == castOther
				.getThreeTwoPrimeODimethyluridineId()) || (this
				.getThreeTwoPrimeODimethyluridineId() != null
				&& castOther.getThreeTwoPrimeODimethyluridineId() != null && this
				.getThreeTwoPrimeODimethyluridineId().equals(
						castOther.getThreeTwoPrimeODimethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeTwoPrimeODimethyluridineId() == null ? 0 : this
						.getThreeTwoPrimeODimethyluridineId().hashCode());
		result = 37 * result
