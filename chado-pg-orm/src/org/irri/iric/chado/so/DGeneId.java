...
/**
 * DGeneId generated by hbm2java
 */
public class DGeneId implements java.io.Serializable {

	private Integer DGeneId;
	...
	public DGeneId(Integer DGeneId, Integer featureId, Integer dbxrefId,
	...
	public Integer getDGeneId() {
		return this.DGeneId;
	}

	public void setDGeneId(Integer DGeneId) {
		this.DGeneId = DGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DGeneId))
			return false;
		DGeneId castOther = (DGeneId) other;

		return ((this.getDGeneId() == castOther.getDGeneId()) || (this
				.getDGeneId() != null && castOther.getDGeneId() != null && this
				.getDGeneId().equals(castOther.getDGeneId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getDGeneId() == null ? 0 : this.getDGeneId().hashCode());
		result = 37 * result
