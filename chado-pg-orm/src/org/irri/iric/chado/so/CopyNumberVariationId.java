...
/**
 * CopyNumberVariationId generated by hbm2java
 */
public class CopyNumberVariationId implements java.io.Serializable {

	private Integer copyNumberVariationId;
	...
	public CopyNumberVariationId() {
	}

	public CopyNumberVariationId(Integer copyNumberVariationId,
		...
		this.copyNumberVariationId = copyNumberVariationId;
	...
	public Integer getCopyNumberVariationId() {
		return this.copyNumberVariationId;
	}

	public void setCopyNumberVariationId(Integer copyNumberVariationId) {
		this.copyNumberVariationId = copyNumberVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CopyNumberVariationId))
			return false;
		CopyNumberVariationId castOther = (CopyNumberVariationId) other;

		return ((this.getCopyNumberVariationId() == castOther
				.getCopyNumberVariationId()) || (this
				.getCopyNumberVariationId() != null
				&& castOther.getCopyNumberVariationId() != null && this
				.getCopyNumberVariationId().equals(
						castOther.getCopyNumberVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCopyNumberVariationId() == null ? 0 : this
						.getCopyNumberVariationId().hashCode());
		result = 37 * result
