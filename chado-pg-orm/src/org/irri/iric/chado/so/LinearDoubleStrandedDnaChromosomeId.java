...
/**
 * LinearDoubleStrandedDnaChromosomeId generated by hbm2java
 */
public class LinearDoubleStrandedDnaChromosomeId implements
		java.io.Serializable {

	private Integer linearDoubleStrandedDnaChromosomeId;
	...
	public LinearDoubleStrandedDnaChromosomeId() {
	}

	public LinearDoubleStrandedDnaChromosomeId(
			Integer linearDoubleStrandedDnaChromosomeId, Integer featureId,
		...
		this.linearDoubleStrandedDnaChromosomeId = linearDoubleStrandedDnaChromosomeId;
	...
	public Integer getLinearDoubleStrandedDnaChromosomeId() {
		return this.linearDoubleStrandedDnaChromosomeId;
	}

	public void setLinearDoubleStrandedDnaChromosomeId(
			Integer linearDoubleStrandedDnaChromosomeId) {
		this.linearDoubleStrandedDnaChromosomeId = linearDoubleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinearDoubleStrandedDnaChromosomeId))
			return false;
		LinearDoubleStrandedDnaChromosomeId castOther = (LinearDoubleStrandedDnaChromosomeId) other;

		return ((this.getLinearDoubleStrandedDnaChromosomeId() == castOther
				.getLinearDoubleStrandedDnaChromosomeId()) || (this
				.getLinearDoubleStrandedDnaChromosomeId() != null
				&& castOther.getLinearDoubleStrandedDnaChromosomeId() != null && this
				.getLinearDoubleStrandedDnaChromosomeId().equals(
						castOther.getLinearDoubleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLinearDoubleStrandedDnaChromosomeId() == null ? 0 : this
						.getLinearDoubleStrandedDnaChromosomeId().hashCode());
		result = 37 * result
