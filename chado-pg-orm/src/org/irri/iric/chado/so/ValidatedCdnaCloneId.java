...
/**
 * ValidatedCdnaCloneId generated by hbm2java
 */
public class ValidatedCdnaCloneId implements java.io.Serializable {

	private Integer validatedCdnaCloneId;
	...
	public ValidatedCdnaCloneId() {
	}

	public ValidatedCdnaCloneId(Integer validatedCdnaCloneId,
		...
		this.validatedCdnaCloneId = validatedCdnaCloneId;
	...
	public Integer getValidatedCdnaCloneId() {
		return this.validatedCdnaCloneId;
	}

	public void setValidatedCdnaCloneId(Integer validatedCdnaCloneId) {
		this.validatedCdnaCloneId = validatedCdnaCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ValidatedCdnaCloneId))
			return false;
		ValidatedCdnaCloneId castOther = (ValidatedCdnaCloneId) other;

		return ((this.getValidatedCdnaCloneId() == castOther
				.getValidatedCdnaCloneId()) || (this.getValidatedCdnaCloneId() != null
				&& castOther.getValidatedCdnaCloneId() != null && this
				.getValidatedCdnaCloneId().equals(
						castOther.getValidatedCdnaCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getValidatedCdnaCloneId() == null ? 0 : this
						.getValidatedCdnaCloneId().hashCode());
		result = 37 * result
