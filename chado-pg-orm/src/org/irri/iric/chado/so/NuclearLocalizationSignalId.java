...
/**
 * NuclearLocalizationSignalId generated by hbm2java
 */
public class NuclearLocalizationSignalId implements java.io.Serializable {

	private Integer nuclearLocalizationSignalId;
	...
	public NuclearLocalizationSignalId() {
	}

	public NuclearLocalizationSignalId(Integer nuclearLocalizationSignalId,
		...
		this.nuclearLocalizationSignalId = nuclearLocalizationSignalId;
	...
	public Integer getNuclearLocalizationSignalId() {
		return this.nuclearLocalizationSignalId;
	}

	public void setNuclearLocalizationSignalId(
			Integer nuclearLocalizationSignalId) {
		this.nuclearLocalizationSignalId = nuclearLocalizationSignalId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NuclearLocalizationSignalId))
			return false;
		NuclearLocalizationSignalId castOther = (NuclearLocalizationSignalId) other;

		return ((this.getNuclearLocalizationSignalId() == castOther
				.getNuclearLocalizationSignalId()) || (this
				.getNuclearLocalizationSignalId() != null
				&& castOther.getNuclearLocalizationSignalId() != null && this
				.getNuclearLocalizationSignalId().equals(
						castOther.getNuclearLocalizationSignalId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNuclearLocalizationSignalId() == null ? 0 : this
						.getNuclearLocalizationSignalId().hashCode());
		result = 37 * result
