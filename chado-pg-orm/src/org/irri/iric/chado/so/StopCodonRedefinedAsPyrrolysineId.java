...
/**
 * StopCodonRedefinedAsPyrrolysineId generated by hbm2java
 */
public class StopCodonRedefinedAsPyrrolysineId implements java.io.Serializable {

	private Integer stopCodonRedefinedAsPyrrolysineId;
	...
	public StopCodonRedefinedAsPyrrolysineId() {
	}

	public StopCodonRedefinedAsPyrrolysineId(
			Integer stopCodonRedefinedAsPyrrolysineId, Integer featureId,
		...
		this.stopCodonRedefinedAsPyrrolysineId = stopCodonRedefinedAsPyrrolysineId;
	...
	public Integer getStopCodonRedefinedAsPyrrolysineId() {
		return this.stopCodonRedefinedAsPyrrolysineId;
	}

	public void setStopCodonRedefinedAsPyrrolysineId(
			Integer stopCodonRedefinedAsPyrrolysineId) {
		this.stopCodonRedefinedAsPyrrolysineId = stopCodonRedefinedAsPyrrolysineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StopCodonRedefinedAsPyrrolysineId))
			return false;
		StopCodonRedefinedAsPyrrolysineId castOther = (StopCodonRedefinedAsPyrrolysineId) other;

		return ((this.getStopCodonRedefinedAsPyrrolysineId() == castOther
				.getStopCodonRedefinedAsPyrrolysineId()) || (this
				.getStopCodonRedefinedAsPyrrolysineId() != null
				&& castOther.getStopCodonRedefinedAsPyrrolysineId() != null && this
				.getStopCodonRedefinedAsPyrrolysineId().equals(
						castOther.getStopCodonRedefinedAsPyrrolysineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getStopCodonRedefinedAsPyrrolysineId() == null ? 0 : this
						.getStopCodonRedefinedAsPyrrolysineId().hashCode());
		result = 37 * result
