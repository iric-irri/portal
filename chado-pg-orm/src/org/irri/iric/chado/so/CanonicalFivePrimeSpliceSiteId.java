...
/**
 * CanonicalFivePrimeSpliceSiteId generated by hbm2java
 */
public class CanonicalFivePrimeSpliceSiteId implements java.io.Serializable {

	private Integer canonicalFivePrimeSpliceSiteId;
	...
	public CanonicalFivePrimeSpliceSiteId() {
	}

	public CanonicalFivePrimeSpliceSiteId(
			Integer canonicalFivePrimeSpliceSiteId, Integer featureId,
		...
		this.canonicalFivePrimeSpliceSiteId = canonicalFivePrimeSpliceSiteId;
	...
	public Integer getCanonicalFivePrimeSpliceSiteId() {
		return this.canonicalFivePrimeSpliceSiteId;
	}

	public void setCanonicalFivePrimeSpliceSiteId(
			Integer canonicalFivePrimeSpliceSiteId) {
		this.canonicalFivePrimeSpliceSiteId = canonicalFivePrimeSpliceSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CanonicalFivePrimeSpliceSiteId))
			return false;
		CanonicalFivePrimeSpliceSiteId castOther = (CanonicalFivePrimeSpliceSiteId) other;

		return ((this.getCanonicalFivePrimeSpliceSiteId() == castOther
				.getCanonicalFivePrimeSpliceSiteId()) || (this
				.getCanonicalFivePrimeSpliceSiteId() != null
				&& castOther.getCanonicalFivePrimeSpliceSiteId() != null && this
				.getCanonicalFivePrimeSpliceSiteId().equals(
						castOther.getCanonicalFivePrimeSpliceSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCanonicalFivePrimeSpliceSiteId() == null ? 0 : this
						.getCanonicalFivePrimeSpliceSiteId().hashCode());
		result = 37 * result
