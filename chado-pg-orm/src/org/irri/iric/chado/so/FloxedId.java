...
/**
 * FloxedId generated by hbm2java
 */
public class FloxedId implements java.io.Serializable {

	private Integer floxedId;
	...
	public FloxedId(Integer floxedId, Integer featureId, Integer dbxrefId,
	...
	public Integer getFloxedId() {
		return this.floxedId;
	}

	public void setFloxedId(Integer floxedId) {
		this.floxedId = floxedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FloxedId))
			return false;
		FloxedId castOther = (FloxedId) other;

		return ((this.getFloxedId() == castOther.getFloxedId()) || (this
				.getFloxedId() != null && castOther.getFloxedId() != null && this
				.getFloxedId().equals(castOther.getFloxedId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getFloxedId() == null ? 0 : this.getFloxedId().hashCode());
		result = 37 * result
