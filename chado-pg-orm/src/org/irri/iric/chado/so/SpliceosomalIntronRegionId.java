...
/**
 * SpliceosomalIntronRegionId generated by hbm2java
 */
public class SpliceosomalIntronRegionId implements java.io.Serializable {

	private Integer spliceosomalIntronRegionId;
	...
	public SpliceosomalIntronRegionId() {
	}

	public SpliceosomalIntronRegionId(Integer spliceosomalIntronRegionId,
		...
		this.spliceosomalIntronRegionId = spliceosomalIntronRegionId;
	...
	public Integer getSpliceosomalIntronRegionId() {
		return this.spliceosomalIntronRegionId;
	}

	public void setSpliceosomalIntronRegionId(Integer spliceosomalIntronRegionId) {
		this.spliceosomalIntronRegionId = spliceosomalIntronRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SpliceosomalIntronRegionId))
			return false;
		SpliceosomalIntronRegionId castOther = (SpliceosomalIntronRegionId) other;

		return ((this.getSpliceosomalIntronRegionId() == castOther
				.getSpliceosomalIntronRegionId()) || (this
				.getSpliceosomalIntronRegionId() != null
				&& castOther.getSpliceosomalIntronRegionId() != null && this
				.getSpliceosomalIntronRegionId().equals(
						castOther.getSpliceosomalIntronRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSpliceosomalIntronRegionId() == null ? 0 : this
						.getSpliceosomalIntronRegionId().hashCode());
		result = 37 * result
