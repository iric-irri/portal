...
/**
 * ModifiedLLysineId generated by hbm2java
 */
public class ModifiedLLysineId implements java.io.Serializable {

	private Integer modifiedLLysineId;
	...
	public ModifiedLLysineId() {
	}

	public ModifiedLLysineId(Integer modifiedLLysineId, Integer featureId,
		...
		this.modifiedLLysineId = modifiedLLysineId;
	...
	public Integer getModifiedLLysineId() {
		return this.modifiedLLysineId;
	}

	public void setModifiedLLysineId(Integer modifiedLLysineId) {
		this.modifiedLLysineId = modifiedLLysineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLLysineId))
			return false;
		ModifiedLLysineId castOther = (ModifiedLLysineId) other;

		return ((this.getModifiedLLysineId() == castOther
				.getModifiedLLysineId()) || (this.getModifiedLLysineId() != null
				&& castOther.getModifiedLLysineId() != null && this
				.getModifiedLLysineId()
				.equals(castOther.getModifiedLLysineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLLysineId() == null ? 0 : this
						.getModifiedLLysineId().hashCode());
		result = 37 * result
