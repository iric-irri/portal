...
/**
 * MethylwyosineId generated by hbm2java
 */
public class MethylwyosineId implements java.io.Serializable {

	private Integer methylwyosineId;
	...
	public MethylwyosineId() {
	}

	public MethylwyosineId(Integer methylwyosineId, Integer featureId,
		...
		this.methylwyosineId = methylwyosineId;
	...
	public Integer getMethylwyosineId() {
		return this.methylwyosineId;
	}

	public void setMethylwyosineId(Integer methylwyosineId) {
		this.methylwyosineId = methylwyosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethylwyosineId))
			return false;
		MethylwyosineId castOther = (MethylwyosineId) other;

		return ((this.getMethylwyosineId() == castOther.getMethylwyosineId()) || (this
				.getMethylwyosineId() != null
				&& castOther.getMethylwyosineId() != null && this
				.getMethylwyosineId().equals(castOther.getMethylwyosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethylwyosineId() == null ? 0 : this.getMethylwyosineId()
						.hashCode());
		result = 37 * result
