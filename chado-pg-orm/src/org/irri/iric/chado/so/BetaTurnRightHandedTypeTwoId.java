...
/**
 * BetaTurnRightHandedTypeTwoId generated by hbm2java
 */
public class BetaTurnRightHandedTypeTwoId implements java.io.Serializable {

	private Integer betaTurnRightHandedTypeTwoId;
	...
	public BetaTurnRightHandedTypeTwoId() {
	}

	public BetaTurnRightHandedTypeTwoId(Integer betaTurnRightHandedTypeTwoId,
		...
		this.betaTurnRightHandedTypeTwoId = betaTurnRightHandedTypeTwoId;
	...
	public Integer getBetaTurnRightHandedTypeTwoId() {
		return this.betaTurnRightHandedTypeTwoId;
	}

	public void setBetaTurnRightHandedTypeTwoId(
			Integer betaTurnRightHandedTypeTwoId) {
		this.betaTurnRightHandedTypeTwoId = betaTurnRightHandedTypeTwoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BetaTurnRightHandedTypeTwoId))
			return false;
		BetaTurnRightHandedTypeTwoId castOther = (BetaTurnRightHandedTypeTwoId) other;

		return ((this.getBetaTurnRightHandedTypeTwoId() == castOther
				.getBetaTurnRightHandedTypeTwoId()) || (this
				.getBetaTurnRightHandedTypeTwoId() != null
				&& castOther.getBetaTurnRightHandedTypeTwoId() != null && this
				.getBetaTurnRightHandedTypeTwoId().equals(
						castOther.getBetaTurnRightHandedTypeTwoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBetaTurnRightHandedTypeTwoId() == null ? 0 : this
						.getBetaTurnRightHandedTypeTwoId().hashCode());
		result = 37 * result
