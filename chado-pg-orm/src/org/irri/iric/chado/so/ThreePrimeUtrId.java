...
/**
 * ThreePrimeUtrId generated by hbm2java
 */
public class ThreePrimeUtrId implements java.io.Serializable {

	private Integer threePrimeUtrId;
	...
	public ThreePrimeUtrId() {
	}

	public ThreePrimeUtrId(Integer threePrimeUtrId, Integer featureId,
		...
		this.threePrimeUtrId = threePrimeUtrId;
	...
	public Integer getThreePrimeUtrId() {
		return this.threePrimeUtrId;
	}

	public void setThreePrimeUtrId(Integer threePrimeUtrId) {
		this.threePrimeUtrId = threePrimeUtrId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeUtrId))
			return false;
		ThreePrimeUtrId castOther = (ThreePrimeUtrId) other;

		return ((this.getThreePrimeUtrId() == castOther.getThreePrimeUtrId()) || (this
				.getThreePrimeUtrId() != null
				&& castOther.getThreePrimeUtrId() != null && this
				.getThreePrimeUtrId().equals(castOther.getThreePrimeUtrId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeUtrId() == null ? 0 : this.getThreePrimeUtrId()
						.hashCode());
		result = 37 * result
