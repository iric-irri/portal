...
/**
 * SarcinLikeRnaMotifId generated by hbm2java
 */
public class SarcinLikeRnaMotifId implements java.io.Serializable {

	private Integer sarcinLikeRnaMotifId;
	...
	public SarcinLikeRnaMotifId() {
	}

	public SarcinLikeRnaMotifId(Integer sarcinLikeRnaMotifId,
		...
		this.sarcinLikeRnaMotifId = sarcinLikeRnaMotifId;
	...
	public Integer getSarcinLikeRnaMotifId() {
		return this.sarcinLikeRnaMotifId;
	}

	public void setSarcinLikeRnaMotifId(Integer sarcinLikeRnaMotifId) {
		this.sarcinLikeRnaMotifId = sarcinLikeRnaMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SarcinLikeRnaMotifId))
			return false;
		SarcinLikeRnaMotifId castOther = (SarcinLikeRnaMotifId) other;

		return ((this.getSarcinLikeRnaMotifId() == castOther
				.getSarcinLikeRnaMotifId()) || (this.getSarcinLikeRnaMotifId() != null
				&& castOther.getSarcinLikeRnaMotifId() != null && this
				.getSarcinLikeRnaMotifId().equals(
						castOther.getSarcinLikeRnaMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSarcinLikeRnaMotifId() == null ? 0 : this
						.getSarcinLikeRnaMotifId().hashCode());
		result = 37 * result
