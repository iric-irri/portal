...
/**
 * RrnaSmallSubunitPrimaryTranscriptId generated by hbm2java
 */
public class RrnaSmallSubunitPrimaryTranscriptId implements
		java.io.Serializable {

	private Integer rrnaSmallSubunitPrimaryTranscriptId;
	...
	public RrnaSmallSubunitPrimaryTranscriptId() {
	}

	public RrnaSmallSubunitPrimaryTranscriptId(
			Integer rrnaSmallSubunitPrimaryTranscriptId, Integer featureId,
		...
		this.rrnaSmallSubunitPrimaryTranscriptId = rrnaSmallSubunitPrimaryTranscriptId;
	...
	public Integer getRrnaSmallSubunitPrimaryTranscriptId() {
		return this.rrnaSmallSubunitPrimaryTranscriptId;
	}

	public void setRrnaSmallSubunitPrimaryTranscriptId(
			Integer rrnaSmallSubunitPrimaryTranscriptId) {
		this.rrnaSmallSubunitPrimaryTranscriptId = rrnaSmallSubunitPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaSmallSubunitPrimaryTranscriptId))
			return false;
		RrnaSmallSubunitPrimaryTranscriptId castOther = (RrnaSmallSubunitPrimaryTranscriptId) other;

		return ((this.getRrnaSmallSubunitPrimaryTranscriptId() == castOther
				.getRrnaSmallSubunitPrimaryTranscriptId()) || (this
				.getRrnaSmallSubunitPrimaryTranscriptId() != null
				&& castOther.getRrnaSmallSubunitPrimaryTranscriptId() != null && this
				.getRrnaSmallSubunitPrimaryTranscriptId().equals(
						castOther.getRrnaSmallSubunitPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaSmallSubunitPrimaryTranscriptId() == null ? 0 : this
						.getRrnaSmallSubunitPrimaryTranscriptId().hashCode());
		result = 37 * result
