...
/**
 * Rrna58sId generated by hbm2java
 */
public class Rrna58sId implements java.io.Serializable {

	private Integer rrna58sId;
	...
	public Rrna58sId(Integer rrna58sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna58sId() {
		return this.rrna58sId;
	}

	public void setRrna58sId(Integer rrna58sId) {
		this.rrna58sId = rrna58sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna58sId))
			return false;
		Rrna58sId castOther = (Rrna58sId) other;

		return ((this.getRrna58sId() == castOther.getRrna58sId()) || (this
				.getRrna58sId() != null && castOther.getRrna58sId() != null && this
				.getRrna58sId().equals(castOther.getRrna58sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna58sId() == null ? 0 : this.getRrna58sId().hashCode());
		result = 37 * result
