...
/**
 * PromoterTargetingSequenceId generated by hbm2java
 */
public class PromoterTargetingSequenceId implements java.io.Serializable {

	private Integer promoterTargetingSequenceId;
	...
	public PromoterTargetingSequenceId() {
	}

	public PromoterTargetingSequenceId(Integer promoterTargetingSequenceId,
		...
		this.promoterTargetingSequenceId = promoterTargetingSequenceId;
	...
	public Integer getPromoterTargetingSequenceId() {
		return this.promoterTargetingSequenceId;
	}

	public void setPromoterTargetingSequenceId(
			Integer promoterTargetingSequenceId) {
		this.promoterTargetingSequenceId = promoterTargetingSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PromoterTargetingSequenceId))
			return false;
		PromoterTargetingSequenceId castOther = (PromoterTargetingSequenceId) other;

		return ((this.getPromoterTargetingSequenceId() == castOther
				.getPromoterTargetingSequenceId()) || (this
				.getPromoterTargetingSequenceId() != null
				&& castOther.getPromoterTargetingSequenceId() != null && this
				.getPromoterTargetingSequenceId().equals(
						castOther.getPromoterTargetingSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPromoterTargetingSequenceId() == null ? 0 : this
						.getPromoterTargetingSequenceId().hashCode());
		result = 37 * result
