...
/**
 * NucleotideToProteinBindingSiteId generated by hbm2java
 */
public class NucleotideToProteinBindingSiteId implements java.io.Serializable {

	private Integer nucleotideToProteinBindingSiteId;
	...
	public NucleotideToProteinBindingSiteId() {
	}

	public NucleotideToProteinBindingSiteId(
			Integer nucleotideToProteinBindingSiteId, Integer featureId,
		...
		this.nucleotideToProteinBindingSiteId = nucleotideToProteinBindingSiteId;
	...
	public Integer getNucleotideToProteinBindingSiteId() {
		return this.nucleotideToProteinBindingSiteId;
	}

	public void setNucleotideToProteinBindingSiteId(
			Integer nucleotideToProteinBindingSiteId) {
		this.nucleotideToProteinBindingSiteId = nucleotideToProteinBindingSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleotideToProteinBindingSiteId))
			return false;
		NucleotideToProteinBindingSiteId castOther = (NucleotideToProteinBindingSiteId) other;

		return ((this.getNucleotideToProteinBindingSiteId() == castOther
				.getNucleotideToProteinBindingSiteId()) || (this
				.getNucleotideToProteinBindingSiteId() != null
				&& castOther.getNucleotideToProteinBindingSiteId() != null && this
				.getNucleotideToProteinBindingSiteId().equals(
						castOther.getNucleotideToProteinBindingSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleotideToProteinBindingSiteId() == null ? 0 : this
						.getNucleotideToProteinBindingSiteId().hashCode());
		result = 37 * result
