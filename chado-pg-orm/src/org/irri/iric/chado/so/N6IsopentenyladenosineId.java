...
/**
 * N6IsopentenyladenosineId generated by hbm2java
 */
public class N6IsopentenyladenosineId implements java.io.Serializable {

	private Integer n6IsopentenyladenosineId;
	...
	public N6IsopentenyladenosineId() {
	}

	public N6IsopentenyladenosineId(Integer n6IsopentenyladenosineId,
		...
		this.n6IsopentenyladenosineId = n6IsopentenyladenosineId;
	...
	public Integer getN6IsopentenyladenosineId() {
		return this.n6IsopentenyladenosineId;
	}

	public void setN6IsopentenyladenosineId(Integer n6IsopentenyladenosineId) {
		this.n6IsopentenyladenosineId = n6IsopentenyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N6IsopentenyladenosineId))
			return false;
		N6IsopentenyladenosineId castOther = (N6IsopentenyladenosineId) other;

		return ((this.getN6IsopentenyladenosineId() == castOther
				.getN6IsopentenyladenosineId()) || (this
				.getN6IsopentenyladenosineId() != null
				&& castOther.getN6IsopentenyladenosineId() != null && this
				.getN6IsopentenyladenosineId().equals(
						castOther.getN6IsopentenyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN6IsopentenyladenosineId() == null ? 0 : this
						.getN6IsopentenyladenosineId().hashCode());
		result = 37 * result
