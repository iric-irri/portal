...
/**
 * ThreeThreeAminoThreeCarboxypropylUridineId generated by hbm2java
 */
public class ThreeThreeAminoThreeCarboxypropylUridineId implements
		java.io.Serializable {

	private Integer threeThreeAminoThreeCarboxypropylUridineId;
	...
	public ThreeThreeAminoThreeCarboxypropylUridineId() {
	}

	public ThreeThreeAminoThreeCarboxypropylUridineId(
			Integer threeThreeAminoThreeCarboxypropylUridineId,
		...
		this.threeThreeAminoThreeCarboxypropylUridineId = threeThreeAminoThreeCarboxypropylUridineId;
	...
	public Integer getThreeThreeAminoThreeCarboxypropylUridineId() {
		return this.threeThreeAminoThreeCarboxypropylUridineId;
	}

	public void setThreeThreeAminoThreeCarboxypropylUridineId(
			Integer threeThreeAminoThreeCarboxypropylUridineId) {
		this.threeThreeAminoThreeCarboxypropylUridineId = threeThreeAminoThreeCarboxypropylUridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreeThreeAminoThreeCarboxypropylUridineId))
			return false;
		ThreeThreeAminoThreeCarboxypropylUridineId castOther = (ThreeThreeAminoThreeCarboxypropylUridineId) other;

		return ((this.getThreeThreeAminoThreeCarboxypropylUridineId() == castOther
				.getThreeThreeAminoThreeCarboxypropylUridineId()) || (this
				.getThreeThreeAminoThreeCarboxypropylUridineId() != null
				&& castOther.getThreeThreeAminoThreeCarboxypropylUridineId() != null && this
				.getThreeThreeAminoThreeCarboxypropylUridineId()
				.equals(castOther
						.getThreeThreeAminoThreeCarboxypropylUridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreeThreeAminoThreeCarboxypropylUridineId() == null ? 0
						: this.getThreeThreeAminoThreeCarboxypropylUridineId()
								.hashCode());
		result = 37 * result
