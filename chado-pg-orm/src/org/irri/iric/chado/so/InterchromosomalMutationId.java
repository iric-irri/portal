...
/**
 * InterchromosomalMutationId generated by hbm2java
 */
public class InterchromosomalMutationId implements java.io.Serializable {

	private Integer interchromosomalMutationId;
	...
	public InterchromosomalMutationId() {
	}

	public InterchromosomalMutationId(Integer interchromosomalMutationId,
		...
		this.interchromosomalMutationId = interchromosomalMutationId;
	...
	public Integer getInterchromosomalMutationId() {
		return this.interchromosomalMutationId;
	}

	public void setInterchromosomalMutationId(Integer interchromosomalMutationId) {
		this.interchromosomalMutationId = interchromosomalMutationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InterchromosomalMutationId))
			return false;
		InterchromosomalMutationId castOther = (InterchromosomalMutationId) other;

		return ((this.getInterchromosomalMutationId() == castOther
				.getInterchromosomalMutationId()) || (this
				.getInterchromosomalMutationId() != null
				&& castOther.getInterchromosomalMutationId() != null && this
				.getInterchromosomalMutationId().equals(
						castOther.getInterchromosomalMutationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInterchromosomalMutationId() == null ? 0 : this
						.getInterchromosomalMutationId().hashCode());
		result = 37 * result
