...
/**
 * NucleotideMotifId generated by hbm2java
 */
public class NucleotideMotifId implements java.io.Serializable {

	private Integer nucleotideMotifId;
	...
	public NucleotideMotifId() {
	}

	public NucleotideMotifId(Integer nucleotideMotifId, Integer featureId,
		...
		this.nucleotideMotifId = nucleotideMotifId;
	...
	public Integer getNucleotideMotifId() {
		return this.nucleotideMotifId;
	}

	public void setNucleotideMotifId(Integer nucleotideMotifId) {
		this.nucleotideMotifId = nucleotideMotifId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NucleotideMotifId))
			return false;
		NucleotideMotifId castOther = (NucleotideMotifId) other;

		return ((this.getNucleotideMotifId() == castOther
				.getNucleotideMotifId()) || (this.getNucleotideMotifId() != null
				&& castOther.getNucleotideMotifId() != null && this
				.getNucleotideMotifId()
				.equals(castOther.getNucleotideMotifId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNucleotideMotifId() == null ? 0 : this
						.getNucleotideMotifId().hashCode());
		result = 37 * result
