...
/**
 * AntiparallelBetaStrandId generated by hbm2java
 */
public class AntiparallelBetaStrandId implements java.io.Serializable {

	private Integer antiparallelBetaStrandId;
	...
	public AntiparallelBetaStrandId() {
	}

	public AntiparallelBetaStrandId(Integer antiparallelBetaStrandId,
		...
		this.antiparallelBetaStrandId = antiparallelBetaStrandId;
	...
	public Integer getAntiparallelBetaStrandId() {
		return this.antiparallelBetaStrandId;
	}

	public void setAntiparallelBetaStrandId(Integer antiparallelBetaStrandId) {
		this.antiparallelBetaStrandId = antiparallelBetaStrandId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AntiparallelBetaStrandId))
			return false;
		AntiparallelBetaStrandId castOther = (AntiparallelBetaStrandId) other;

		return ((this.getAntiparallelBetaStrandId() == castOther
				.getAntiparallelBetaStrandId()) || (this
				.getAntiparallelBetaStrandId() != null
				&& castOther.getAntiparallelBetaStrandId() != null && this
				.getAntiparallelBetaStrandId().equals(
						castOther.getAntiparallelBetaStrandId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAntiparallelBetaStrandId() == null ? 0 : this
						.getAntiparallelBetaStrandId().hashCode());
		result = 37 * result
