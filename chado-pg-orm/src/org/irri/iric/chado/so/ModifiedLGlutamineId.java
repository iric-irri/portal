...
/**
 * ModifiedLGlutamineId generated by hbm2java
 */
public class ModifiedLGlutamineId implements java.io.Serializable {

	private Integer modifiedLGlutamineId;
	...
	public ModifiedLGlutamineId() {
	}

	public ModifiedLGlutamineId(Integer modifiedLGlutamineId,
		...
		this.modifiedLGlutamineId = modifiedLGlutamineId;
	...
	public Integer getModifiedLGlutamineId() {
		return this.modifiedLGlutamineId;
	}

	public void setModifiedLGlutamineId(Integer modifiedLGlutamineId) {
		this.modifiedLGlutamineId = modifiedLGlutamineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ModifiedLGlutamineId))
			return false;
		ModifiedLGlutamineId castOther = (ModifiedLGlutamineId) other;

		return ((this.getModifiedLGlutamineId() == castOther
				.getModifiedLGlutamineId()) || (this.getModifiedLGlutamineId() != null
				&& castOther.getModifiedLGlutamineId() != null && this
				.getModifiedLGlutamineId().equals(
						castOther.getModifiedLGlutamineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getModifiedLGlutamineId() == null ? 0 : this
						.getModifiedLGlutamineId().hashCode());
		result = 37 * result
