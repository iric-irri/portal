...
/**
 * ComplexChangeInTranscriptId generated by hbm2java
 */
public class ComplexChangeInTranscriptId implements java.io.Serializable {

	private Integer complexChangeInTranscriptId;
	...
	public ComplexChangeInTranscriptId() {
	}

	public ComplexChangeInTranscriptId(Integer complexChangeInTranscriptId,
		...
		this.complexChangeInTranscriptId = complexChangeInTranscriptId;
	...
	public Integer getComplexChangeInTranscriptId() {
		return this.complexChangeInTranscriptId;
	}

	public void setComplexChangeInTranscriptId(
			Integer complexChangeInTranscriptId) {
		this.complexChangeInTranscriptId = complexChangeInTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComplexChangeInTranscriptId))
			return false;
		ComplexChangeInTranscriptId castOther = (ComplexChangeInTranscriptId) other;

		return ((this.getComplexChangeInTranscriptId() == castOther
				.getComplexChangeInTranscriptId()) || (this
				.getComplexChangeInTranscriptId() != null
				&& castOther.getComplexChangeInTranscriptId() != null && this
				.getComplexChangeInTranscriptId().equals(
						castOther.getComplexChangeInTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplexChangeInTranscriptId() == null ? 0 : this
						.getComplexChangeInTranscriptId().hashCode());
		result = 37 * result
