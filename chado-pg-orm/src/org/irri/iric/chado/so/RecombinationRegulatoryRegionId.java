...
/**
 * RecombinationRegulatoryRegionId generated by hbm2java
 */
public class RecombinationRegulatoryRegionId implements java.io.Serializable {

	private Integer recombinationRegulatoryRegionId;
	...
	public RecombinationRegulatoryRegionId() {
	}

	public RecombinationRegulatoryRegionId(
			Integer recombinationRegulatoryRegionId, Integer featureId,
		...
		this.recombinationRegulatoryRegionId = recombinationRegulatoryRegionId;
	...
	public Integer getRecombinationRegulatoryRegionId() {
		return this.recombinationRegulatoryRegionId;
	}

	public void setRecombinationRegulatoryRegionId(
			Integer recombinationRegulatoryRegionId) {
		this.recombinationRegulatoryRegionId = recombinationRegulatoryRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationRegulatoryRegionId))
			return false;
		RecombinationRegulatoryRegionId castOther = (RecombinationRegulatoryRegionId) other;

		return ((this.getRecombinationRegulatoryRegionId() == castOther
				.getRecombinationRegulatoryRegionId()) || (this
				.getRecombinationRegulatoryRegionId() != null
				&& castOther.getRecombinationRegulatoryRegionId() != null && this
				.getRecombinationRegulatoryRegionId().equals(
						castOther.getRecombinationRegulatoryRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationRegulatoryRegionId() == null ? 0 : this
						.getRecombinationRegulatoryRegionId().hashCode());
		result = 37 * result
