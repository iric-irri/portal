...
/**
 * NcTranscriptVariantId generated by hbm2java
 */
public class NcTranscriptVariantId implements java.io.Serializable {

	private Integer ncTranscriptVariantId;
	...
	public NcTranscriptVariantId() {
	}

	public NcTranscriptVariantId(Integer ncTranscriptVariantId,
		...
		this.ncTranscriptVariantId = ncTranscriptVariantId;
	...
	public Integer getNcTranscriptVariantId() {
		return this.ncTranscriptVariantId;
	}

	public void setNcTranscriptVariantId(Integer ncTranscriptVariantId) {
		this.ncTranscriptVariantId = ncTranscriptVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NcTranscriptVariantId))
			return false;
		NcTranscriptVariantId castOther = (NcTranscriptVariantId) other;

		return ((this.getNcTranscriptVariantId() == castOther
				.getNcTranscriptVariantId()) || (this
				.getNcTranscriptVariantId() != null
				&& castOther.getNcTranscriptVariantId() != null && this
				.getNcTranscriptVariantId().equals(
						castOther.getNcTranscriptVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNcTranscriptVariantId() == null ? 0 : this
						.getNcTranscriptVariantId().hashCode());
		result = 37 * result
