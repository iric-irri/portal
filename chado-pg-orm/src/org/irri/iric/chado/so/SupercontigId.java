...
/**
 * SupercontigId generated by hbm2java
 */
public class SupercontigId implements java.io.Serializable {

	private Integer supercontigId;
	...
	public SupercontigId() {
	}

	public SupercontigId(Integer supercontigId, Integer featureId,
		...
		this.supercontigId = supercontigId;
	...
	public Integer getSupercontigId() {
		return this.supercontigId;
	}

	public void setSupercontigId(Integer supercontigId) {
		this.supercontigId = supercontigId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SupercontigId))
			return false;
		SupercontigId castOther = (SupercontigId) other;

		return ((this.getSupercontigId() == castOther.getSupercontigId()) || (this
				.getSupercontigId() != null
				&& castOther.getSupercontigId() != null && this
				.getSupercontigId().equals(castOther.getSupercontigId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSupercontigId() == null ? 0 : this.getSupercontigId()
						.hashCode());
		result = 37 * result
