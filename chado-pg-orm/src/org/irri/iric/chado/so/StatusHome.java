 ...
 * @see org.irri.iric.chado.so.Status
	...
	public List findByExample(Status instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Status")
