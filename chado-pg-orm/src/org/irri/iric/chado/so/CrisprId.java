...
/**
 * CrisprId generated by hbm2java
 */
public class CrisprId implements java.io.Serializable {

	private Integer crisprId;
	...
	public CrisprId(Integer crisprId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCrisprId() {
		return this.crisprId;
	}

	public void setCrisprId(Integer crisprId) {
		this.crisprId = crisprId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrisprId))
			return false;
		CrisprId castOther = (CrisprId) other;

		return ((this.getCrisprId() == castOther.getCrisprId()) || (this
				.getCrisprId() != null && castOther.getCrisprId() != null && this
				.getCrisprId().equals(castOther.getCrisprId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCrisprId() == null ? 0 : this.getCrisprId().hashCode());
		result = 37 * result
