...
/**
 * ReadingFrameId generated by hbm2java
 */
public class ReadingFrameId implements java.io.Serializable {

	private Integer readingFrameId;
	...
	public ReadingFrameId() {
	}

	public ReadingFrameId(Integer readingFrameId, Integer featureId,
		...
		this.readingFrameId = readingFrameId;
	...
	public Integer getReadingFrameId() {
		return this.readingFrameId;
	}

	public void setReadingFrameId(Integer readingFrameId) {
		this.readingFrameId = readingFrameId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReadingFrameId))
			return false;
		ReadingFrameId castOther = (ReadingFrameId) other;

		return ((this.getReadingFrameId() == castOther.getReadingFrameId()) || (this
				.getReadingFrameId() != null
				&& castOther.getReadingFrameId() != null && this
				.getReadingFrameId().equals(castOther.getReadingFrameId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReadingFrameId() == null ? 0 : this.getReadingFrameId()
						.hashCode());
		result = 37 * result
