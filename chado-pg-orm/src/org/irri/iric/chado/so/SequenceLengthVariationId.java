...
/**
 * SequenceLengthVariationId generated by hbm2java
 */
public class SequenceLengthVariationId implements java.io.Serializable {

	private Integer sequenceLengthVariationId;
	...
	public SequenceLengthVariationId() {
	}

	public SequenceLengthVariationId(Integer sequenceLengthVariationId,
		...
		this.sequenceLengthVariationId = sequenceLengthVariationId;
	...
	public Integer getSequenceLengthVariationId() {
		return this.sequenceLengthVariationId;
	}

	public void setSequenceLengthVariationId(Integer sequenceLengthVariationId) {
		this.sequenceLengthVariationId = sequenceLengthVariationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceLengthVariationId))
			return false;
		SequenceLengthVariationId castOther = (SequenceLengthVariationId) other;

		return ((this.getSequenceLengthVariationId() == castOther
				.getSequenceLengthVariationId()) || (this
				.getSequenceLengthVariationId() != null
				&& castOther.getSequenceLengthVariationId() != null && this
				.getSequenceLengthVariationId().equals(
						castOther.getSequenceLengthVariationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceLengthVariationId() == null ? 0 : this
						.getSequenceLengthVariationId().hashCode());
		result = 37 * result
