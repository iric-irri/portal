...
/**
 * MitochondrialSequenceId generated by hbm2java
 */
public class MitochondrialSequenceId implements java.io.Serializable {

	private Integer mitochondrialSequenceId;
	...
	public MitochondrialSequenceId() {
	}

	public MitochondrialSequenceId(Integer mitochondrialSequenceId,
		...
		this.mitochondrialSequenceId = mitochondrialSequenceId;
	...
	public Integer getMitochondrialSequenceId() {
		return this.mitochondrialSequenceId;
	}

	public void setMitochondrialSequenceId(Integer mitochondrialSequenceId) {
		this.mitochondrialSequenceId = mitochondrialSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MitochondrialSequenceId))
			return false;
		MitochondrialSequenceId castOther = (MitochondrialSequenceId) other;

		return ((this.getMitochondrialSequenceId() == castOther
				.getMitochondrialSequenceId()) || (this
				.getMitochondrialSequenceId() != null
				&& castOther.getMitochondrialSequenceId() != null && this
				.getMitochondrialSequenceId().equals(
						castOther.getMitochondrialSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMitochondrialSequenceId() == null ? 0 : this
						.getMitochondrialSequenceId().hashCode());
		result = 37 * result
