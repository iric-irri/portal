...
/**
 * RasirnaId generated by hbm2java
 */
public class RasirnaId implements java.io.Serializable {

	private Integer rasirnaId;
	...
	public RasirnaId(Integer rasirnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRasirnaId() {
		return this.rasirnaId;
	}

	public void setRasirnaId(Integer rasirnaId) {
		this.rasirnaId = rasirnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RasirnaId))
			return false;
		RasirnaId castOther = (RasirnaId) other;

		return ((this.getRasirnaId() == castOther.getRasirnaId()) || (this
				.getRasirnaId() != null && castOther.getRasirnaId() != null && this
				.getRasirnaId().equals(castOther.getRasirnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRasirnaId() == null ? 0 : this.getRasirnaId().hashCode());
		result = 37 * result
