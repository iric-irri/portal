...
/**
 * TnaId generated by hbm2java
 */
public class TnaId implements java.io.Serializable {
	...
	public TnaId(Integer tnaId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TnaId))
			return false;
		TnaId castOther = (TnaId) other;

		return ((this.getTnaId() == castOther.getTnaId()) || (this.getTnaId() != null
				&& castOther.getTnaId() != null && this.getTnaId().equals(
				castOther.getTnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTnaId() == null ? 0 : this.getTnaId().hashCode());
		result = 37 * result
