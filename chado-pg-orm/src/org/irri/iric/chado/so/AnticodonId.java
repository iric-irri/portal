...
/**
 * AnticodonId generated by hbm2java
 */
public class AnticodonId implements java.io.Serializable {

	private Integer anticodonId;
	...
	public AnticodonId(Integer anticodonId, Integer featureId,
	...
	public Integer getAnticodonId() {
		return this.anticodonId;
	}

	public void setAnticodonId(Integer anticodonId) {
		this.anticodonId = anticodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnticodonId))
			return false;
		AnticodonId castOther = (AnticodonId) other;

		return ((this.getAnticodonId() == castOther.getAnticodonId()) || (this
				.getAnticodonId() != null && castOther.getAnticodonId() != null && this
				.getAnticodonId().equals(castOther.getAnticodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAnticodonId() == null ? 0 : this.getAnticodonId()
						.hashCode());
		result = 37 * result
