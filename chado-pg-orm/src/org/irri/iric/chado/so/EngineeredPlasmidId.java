...
/**
 * EngineeredPlasmidId generated by hbm2java
 */
public class EngineeredPlasmidId implements java.io.Serializable {

	private Integer engineeredPlasmidId;
	...
	public EngineeredPlasmidId() {
	}

	public EngineeredPlasmidId(Integer engineeredPlasmidId, Integer featureId,
		...
		this.engineeredPlasmidId = engineeredPlasmidId;
	...
	public Integer getEngineeredPlasmidId() {
		return this.engineeredPlasmidId;
	}

	public void setEngineeredPlasmidId(Integer engineeredPlasmidId) {
		this.engineeredPlasmidId = engineeredPlasmidId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EngineeredPlasmidId))
			return false;
		EngineeredPlasmidId castOther = (EngineeredPlasmidId) other;

		return ((this.getEngineeredPlasmidId() == castOther
				.getEngineeredPlasmidId()) || (this.getEngineeredPlasmidId() != null
				&& castOther.getEngineeredPlasmidId() != null && this
				.getEngineeredPlasmidId().equals(
						castOther.getEngineeredPlasmidId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEngineeredPlasmidId() == null ? 0 : this
						.getEngineeredPlasmidId().hashCode());
		result = 37 * result
