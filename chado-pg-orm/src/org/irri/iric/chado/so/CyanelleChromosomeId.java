...
/**
 * CyanelleChromosomeId generated by hbm2java
 */
public class CyanelleChromosomeId implements java.io.Serializable {

	private Integer cyanelleChromosomeId;
	...
	public CyanelleChromosomeId() {
	}

	public CyanelleChromosomeId(Integer cyanelleChromosomeId,
		...
		this.cyanelleChromosomeId = cyanelleChromosomeId;
	...
	public Integer getCyanelleChromosomeId() {
		return this.cyanelleChromosomeId;
	}

	public void setCyanelleChromosomeId(Integer cyanelleChromosomeId) {
		this.cyanelleChromosomeId = cyanelleChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CyanelleChromosomeId))
			return false;
		CyanelleChromosomeId castOther = (CyanelleChromosomeId) other;

		return ((this.getCyanelleChromosomeId() == castOther
				.getCyanelleChromosomeId()) || (this.getCyanelleChromosomeId() != null
				&& castOther.getCyanelleChromosomeId() != null && this
				.getCyanelleChromosomeId().equals(
						castOther.getCyanelleChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCyanelleChromosomeId() == null ? 0 : this
						.getCyanelleChromosomeId().hashCode());
		result = 37 * result
