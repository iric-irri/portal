...
/**
 * U12SnrnaId generated by hbm2java
 */
public class U12SnrnaId implements java.io.Serializable {

	private Integer u12SnrnaId;
	...
	public U12SnrnaId(Integer u12SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU12SnrnaId() {
		return this.u12SnrnaId;
	}

	public void setU12SnrnaId(Integer u12SnrnaId) {
		this.u12SnrnaId = u12SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U12SnrnaId))
			return false;
		U12SnrnaId castOther = (U12SnrnaId) other;

		return ((this.getU12SnrnaId() == castOther.getU12SnrnaId()) || (this
				.getU12SnrnaId() != null && castOther.getU12SnrnaId() != null && this
				.getU12SnrnaId().equals(castOther.getU12SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getU12SnrnaId() == null ? 0 : this.getU12SnrnaId()
						.hashCode());
		result = 37 * result
