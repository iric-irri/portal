...
/**
 * IntronId generated by hbm2java
 */
public class IntronId implements java.io.Serializable {

	private Integer intronId;
	...
	public IntronId(Integer intronId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIntronId() {
		return this.intronId;
	}

	public void setIntronId(Integer intronId) {
		this.intronId = intronId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntronId))
			return false;
		IntronId castOther = (IntronId) other;

		return ((this.getIntronId() == castOther.getIntronId()) || (this
				.getIntronId() != null && castOther.getIntronId() != null && this
				.getIntronId().equals(castOther.getIntronId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getIntronId() == null ? 0 : this.getIntronId().hashCode());
		result = 37 * result
