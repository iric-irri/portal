...
/**
 * ProteinCodingGeneId generated by hbm2java
 */
public class ProteinCodingGeneId implements java.io.Serializable {

	private Integer proteinCodingGeneId;
	...
	public ProteinCodingGeneId() {
	}

	public ProteinCodingGeneId(Integer proteinCodingGeneId, Integer featureId,
		...
		this.proteinCodingGeneId = proteinCodingGeneId;
	...
	public Integer getProteinCodingGeneId() {
		return this.proteinCodingGeneId;
	}

	public void setProteinCodingGeneId(Integer proteinCodingGeneId) {
		this.proteinCodingGeneId = proteinCodingGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProteinCodingGeneId))
			return false;
		ProteinCodingGeneId castOther = (ProteinCodingGeneId) other;

		return ((this.getProteinCodingGeneId() == castOther
				.getProteinCodingGeneId()) || (this.getProteinCodingGeneId() != null
				&& castOther.getProteinCodingGeneId() != null && this
				.getProteinCodingGeneId().equals(
						castOther.getProteinCodingGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getProteinCodingGeneId() == null ? 0 : this
						.getProteinCodingGeneId().hashCode());
		result = 37 * result
