...
/**
 * PolycistronicMrnaId generated by hbm2java
 */
public class PolycistronicMrnaId implements java.io.Serializable {

	private Integer polycistronicMrnaId;
	...
	public PolycistronicMrnaId() {
	}

	public PolycistronicMrnaId(Integer polycistronicMrnaId, Integer featureId,
		...
		this.polycistronicMrnaId = polycistronicMrnaId;
	...
	public Integer getPolycistronicMrnaId() {
		return this.polycistronicMrnaId;
	}

	public void setPolycistronicMrnaId(Integer polycistronicMrnaId) {
		this.polycistronicMrnaId = polycistronicMrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolycistronicMrnaId))
			return false;
		PolycistronicMrnaId castOther = (PolycistronicMrnaId) other;

		return ((this.getPolycistronicMrnaId() == castOther
				.getPolycistronicMrnaId()) || (this.getPolycistronicMrnaId() != null
				&& castOther.getPolycistronicMrnaId() != null && this
				.getPolycistronicMrnaId().equals(
						castOther.getPolycistronicMrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolycistronicMrnaId() == null ? 0 : this
						.getPolycistronicMrnaId().hashCode());
		result = 37 * result
