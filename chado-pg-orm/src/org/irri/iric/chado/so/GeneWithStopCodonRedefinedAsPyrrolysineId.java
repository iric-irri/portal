...
/**
 * GeneWithStopCodonRedefinedAsPyrrolysineId generated by hbm2java
 */
public class GeneWithStopCodonRedefinedAsPyrrolysineId implements
		java.io.Serializable {

	private Integer geneWithStopCodonRedefinedAsPyrrolysineId;
	...
	public GeneWithStopCodonRedefinedAsPyrrolysineId() {
	}

	public GeneWithStopCodonRedefinedAsPyrrolysineId(
			Integer geneWithStopCodonRedefinedAsPyrrolysineId,
		...
		this.geneWithStopCodonRedefinedAsPyrrolysineId = geneWithStopCodonRedefinedAsPyrrolysineId;
	...
	public Integer getGeneWithStopCodonRedefinedAsPyrrolysineId() {
		return this.geneWithStopCodonRedefinedAsPyrrolysineId;
	}

	public void setGeneWithStopCodonRedefinedAsPyrrolysineId(
			Integer geneWithStopCodonRedefinedAsPyrrolysineId) {
		this.geneWithStopCodonRedefinedAsPyrrolysineId = geneWithStopCodonRedefinedAsPyrrolysineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneWithStopCodonRedefinedAsPyrrolysineId))
			return false;
		GeneWithStopCodonRedefinedAsPyrrolysineId castOther = (GeneWithStopCodonRedefinedAsPyrrolysineId) other;

		return ((this.getGeneWithStopCodonRedefinedAsPyrrolysineId() == castOther
				.getGeneWithStopCodonRedefinedAsPyrrolysineId()) || (this
				.getGeneWithStopCodonRedefinedAsPyrrolysineId() != null
				&& castOther.getGeneWithStopCodonRedefinedAsPyrrolysineId() != null && this
				.getGeneWithStopCodonRedefinedAsPyrrolysineId()
				.equals(castOther
						.getGeneWithStopCodonRedefinedAsPyrrolysineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneWithStopCodonRedefinedAsPyrrolysineId() == null ? 0
						: this.getGeneWithStopCodonRedefinedAsPyrrolysineId()
								.hashCode());
		result = 37 * result
