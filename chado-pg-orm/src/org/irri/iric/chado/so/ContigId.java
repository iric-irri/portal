...
/**
 * ContigId generated by hbm2java
 */
public class ContigId implements java.io.Serializable {
	...
	public ContigId(Integer contigId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContigId))
			return false;
		ContigId castOther = (ContigId) other;

		return ((this.getContigId() == castOther.getContigId()) || (this
				.getContigId() != null && castOther.getContigId() != null && this
				.getContigId().equals(castOther.getContigId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getContigId() == null ? 0 : this.getContigId().hashCode());
		result = 37 * result
