...
/**
 * CassetteArrayMemberId generated by hbm2java
 */
public class CassetteArrayMemberId implements java.io.Serializable {

	private Integer cassetteArrayMemberId;
	...
	public CassetteArrayMemberId() {
	}

	public CassetteArrayMemberId(Integer cassetteArrayMemberId,
		...
		this.cassetteArrayMemberId = cassetteArrayMemberId;
	...
	public Integer getCassetteArrayMemberId() {
		return this.cassetteArrayMemberId;
	}

	public void setCassetteArrayMemberId(Integer cassetteArrayMemberId) {
		this.cassetteArrayMemberId = cassetteArrayMemberId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CassetteArrayMemberId))
			return false;
		CassetteArrayMemberId castOther = (CassetteArrayMemberId) other;

		return ((this.getCassetteArrayMemberId() == castOther
				.getCassetteArrayMemberId()) || (this
				.getCassetteArrayMemberId() != null
				&& castOther.getCassetteArrayMemberId() != null && this
				.getCassetteArrayMemberId().equals(
						castOther.getCassetteArrayMemberId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCassetteArrayMemberId() == null ? 0 : this
						.getCassetteArrayMemberId().hashCode());
		result = 37 * result
