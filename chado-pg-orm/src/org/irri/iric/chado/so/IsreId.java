...
/**
 * IsreId generated by hbm2java
 */
public class IsreId implements java.io.Serializable {

	private Integer isreId;
	...
	public IsreId(Integer isreId, Integer featureId, Integer dbxrefId,
	...
	public Integer getIsreId() {
		return this.isreId;
	}

	public void setIsreId(Integer isreId) {
		this.isreId = isreId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IsreId))
			return false;
		IsreId castOther = (IsreId) other;

		return ((this.getIsreId() == castOther.getIsreId()) || (this
				.getIsreId() != null && castOther.getIsreId() != null && this
				.getIsreId().equals(castOther.getIsreId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getIsreId() == null ? 0 : this.getIsreId().hashCode());
		result = 37 * result
