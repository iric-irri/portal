...
/**
 * MemberOfRegulonId generated by hbm2java
 */
public class MemberOfRegulonId implements java.io.Serializable {

	private Integer memberOfRegulonId;
	...
	public MemberOfRegulonId() {
	}

	public MemberOfRegulonId(Integer memberOfRegulonId, Integer featureId,
		...
		this.memberOfRegulonId = memberOfRegulonId;
	...
	public Integer getMemberOfRegulonId() {
		return this.memberOfRegulonId;
	}

	public void setMemberOfRegulonId(Integer memberOfRegulonId) {
		this.memberOfRegulonId = memberOfRegulonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MemberOfRegulonId))
			return false;
		MemberOfRegulonId castOther = (MemberOfRegulonId) other;

		return ((this.getMemberOfRegulonId() == castOther
				.getMemberOfRegulonId()) || (this.getMemberOfRegulonId() != null
				&& castOther.getMemberOfRegulonId() != null && this
				.getMemberOfRegulonId()
				.equals(castOther.getMemberOfRegulonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMemberOfRegulonId() == null ? 0 : this
						.getMemberOfRegulonId().hashCode());
		result = 37 * result
