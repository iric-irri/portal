...
/**
 * Rrna18sId generated by hbm2java
 */
public class Rrna18sId implements java.io.Serializable {

	private Integer rrna18sId;
	...
	public Rrna18sId(Integer rrna18sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna18sId() {
		return this.rrna18sId;
	}

	public void setRrna18sId(Integer rrna18sId) {
		this.rrna18sId = rrna18sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna18sId))
			return false;
		Rrna18sId castOther = (Rrna18sId) other;

		return ((this.getRrna18sId() == castOther.getRrna18sId()) || (this
				.getRrna18sId() != null && castOther.getRrna18sId() != null && this
				.getRrna18sId().equals(castOther.getRrna18sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna18sId() == null ? 0 : this.getRrna18sId().hashCode());
		result = 37 * result
