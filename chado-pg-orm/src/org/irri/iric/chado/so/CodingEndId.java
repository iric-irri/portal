...
/**
 * CodingEndId generated by hbm2java
 */
public class CodingEndId implements java.io.Serializable {

	private Integer codingEndId;
	...
	public CodingEndId(Integer codingEndId, Integer featureId,
	...
	public Integer getCodingEndId() {
		return this.codingEndId;
	}

	public void setCodingEndId(Integer codingEndId) {
		this.codingEndId = codingEndId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CodingEndId))
			return false;
		CodingEndId castOther = (CodingEndId) other;

		return ((this.getCodingEndId() == castOther.getCodingEndId()) || (this
				.getCodingEndId() != null && castOther.getCodingEndId() != null && this
				.getCodingEndId().equals(castOther.getCodingEndId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCodingEndId() == null ? 0 : this.getCodingEndId()
						.hashCode());
		result = 37 * result
