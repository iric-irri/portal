...
/**
 * InteinContainingId generated by hbm2java
 */
public class InteinContainingId implements java.io.Serializable {

	private Integer inteinContainingId;
	...
	public InteinContainingId() {
	}

	public InteinContainingId(Integer inteinContainingId, Integer featureId,
		...
		this.inteinContainingId = inteinContainingId;
	...
	public Integer getInteinContainingId() {
		return this.inteinContainingId;
	}

	public void setInteinContainingId(Integer inteinContainingId) {
		this.inteinContainingId = inteinContainingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InteinContainingId))
			return false;
		InteinContainingId castOther = (InteinContainingId) other;

		return ((this.getInteinContainingId() == castOther
				.getInteinContainingId()) || (this.getInteinContainingId() != null
				&& castOther.getInteinContainingId() != null && this
				.getInteinContainingId().equals(
						castOther.getInteinContainingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInteinContainingId() == null ? 0 : this
						.getInteinContainingId().hashCode());
		result = 37 * result
