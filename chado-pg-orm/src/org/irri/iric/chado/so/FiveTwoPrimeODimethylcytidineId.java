...
/**
 * FiveTwoPrimeODimethylcytidineId generated by hbm2java
 */
public class FiveTwoPrimeODimethylcytidineId implements java.io.Serializable {

	private Integer fiveTwoPrimeODimethylcytidineId;
	...
	public FiveTwoPrimeODimethylcytidineId() {
	}

	public FiveTwoPrimeODimethylcytidineId(
			Integer fiveTwoPrimeODimethylcytidineId, Integer featureId,
		...
		this.fiveTwoPrimeODimethylcytidineId = fiveTwoPrimeODimethylcytidineId;
	...
	public Integer getFiveTwoPrimeODimethylcytidineId() {
		return this.fiveTwoPrimeODimethylcytidineId;
	}

	public void setFiveTwoPrimeODimethylcytidineId(
			Integer fiveTwoPrimeODimethylcytidineId) {
		this.fiveTwoPrimeODimethylcytidineId = fiveTwoPrimeODimethylcytidineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveTwoPrimeODimethylcytidineId))
			return false;
		FiveTwoPrimeODimethylcytidineId castOther = (FiveTwoPrimeODimethylcytidineId) other;

		return ((this.getFiveTwoPrimeODimethylcytidineId() == castOther
				.getFiveTwoPrimeODimethylcytidineId()) || (this
				.getFiveTwoPrimeODimethylcytidineId() != null
				&& castOther.getFiveTwoPrimeODimethylcytidineId() != null && this
				.getFiveTwoPrimeODimethylcytidineId().equals(
						castOther.getFiveTwoPrimeODimethylcytidineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveTwoPrimeODimethylcytidineId() == null ? 0 : this
						.getFiveTwoPrimeODimethylcytidineId().hashCode());
		result = 37 * result
