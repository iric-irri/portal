...
/**
 * EditedCdsId generated by hbm2java
 */
public class EditedCdsId implements java.io.Serializable {

	private Integer editedCdsId;
	...
	public EditedCdsId(Integer editedCdsId, Integer featureId,
	...
	public Integer getEditedCdsId() {
		return this.editedCdsId;
	}

	public void setEditedCdsId(Integer editedCdsId) {
		this.editedCdsId = editedCdsId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedCdsId))
			return false;
		EditedCdsId castOther = (EditedCdsId) other;

		return ((this.getEditedCdsId() == castOther.getEditedCdsId()) || (this
				.getEditedCdsId() != null && castOther.getEditedCdsId() != null && this
				.getEditedCdsId().equals(castOther.getEditedCdsId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEditedCdsId() == null ? 0 : this.getEditedCdsId()
						.hashCode());
		result = 37 * result
