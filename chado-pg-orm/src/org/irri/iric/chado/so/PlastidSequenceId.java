...
/**
 * PlastidSequenceId generated by hbm2java
 */
public class PlastidSequenceId implements java.io.Serializable {

	private Integer plastidSequenceId;
	...
	public PlastidSequenceId() {
	}

	public PlastidSequenceId(Integer plastidSequenceId, Integer featureId,
		...
		this.plastidSequenceId = plastidSequenceId;
	...
	public Integer getPlastidSequenceId() {
		return this.plastidSequenceId;
	}

	public void setPlastidSequenceId(Integer plastidSequenceId) {
		this.plastidSequenceId = plastidSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlastidSequenceId))
			return false;
		PlastidSequenceId castOther = (PlastidSequenceId) other;

		return ((this.getPlastidSequenceId() == castOther
				.getPlastidSequenceId()) || (this.getPlastidSequenceId() != null
				&& castOther.getPlastidSequenceId() != null && this
				.getPlastidSequenceId()
				.equals(castOther.getPlastidSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlastidSequenceId() == null ? 0 : this
						.getPlastidSequenceId().hashCode());
		result = 37 * result
