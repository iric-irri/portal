...
/**
 * TranslationalProductFunctionVariantId generated by hbm2java
 */
public class TranslationalProductFunctionVariantId implements
		java.io.Serializable {

	private Integer translationalProductFunctionVariantId;
	...
	public TranslationalProductFunctionVariantId() {
	}

	public TranslationalProductFunctionVariantId(
			Integer translationalProductFunctionVariantId, Integer featureId,
		...
		this.translationalProductFunctionVariantId = translationalProductFunctionVariantId;
	...
	public Integer getTranslationalProductFunctionVariantId() {
		return this.translationalProductFunctionVariantId;
	}

	public void setTranslationalProductFunctionVariantId(
			Integer translationalProductFunctionVariantId) {
		this.translationalProductFunctionVariantId = translationalProductFunctionVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranslationalProductFunctionVariantId))
			return false;
		TranslationalProductFunctionVariantId castOther = (TranslationalProductFunctionVariantId) other;

		return ((this.getTranslationalProductFunctionVariantId() == castOther
				.getTranslationalProductFunctionVariantId()) || (this
				.getTranslationalProductFunctionVariantId() != null
				&& castOther.getTranslationalProductFunctionVariantId() != null && this
				.getTranslationalProductFunctionVariantId().equals(
						castOther.getTranslationalProductFunctionVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranslationalProductFunctionVariantId() == null ? 0
						: this.getTranslationalProductFunctionVariantId()
								.hashCode());
		result = 37 * result
