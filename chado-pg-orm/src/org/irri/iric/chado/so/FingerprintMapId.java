...
/**
 * FingerprintMapId generated by hbm2java
 */
public class FingerprintMapId implements java.io.Serializable {

	private Integer fingerprintMapId;
	...
	public FingerprintMapId() {
	}

	public FingerprintMapId(Integer fingerprintMapId, Integer featureId,
		...
		this.fingerprintMapId = fingerprintMapId;
	...
	public Integer getFingerprintMapId() {
		return this.fingerprintMapId;
	}

	public void setFingerprintMapId(Integer fingerprintMapId) {
		this.fingerprintMapId = fingerprintMapId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FingerprintMapId))
			return false;
		FingerprintMapId castOther = (FingerprintMapId) other;

		return ((this.getFingerprintMapId() == castOther.getFingerprintMapId()) || (this
				.getFingerprintMapId() != null
				&& castOther.getFingerprintMapId() != null && this
				.getFingerprintMapId().equals(castOther.getFingerprintMapId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFingerprintMapId() == null ? 0 : this
						.getFingerprintMapId().hashCode());
		result = 37 * result
