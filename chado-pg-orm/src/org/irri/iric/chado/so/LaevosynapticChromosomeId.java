...
/**
 * LaevosynapticChromosomeId generated by hbm2java
 */
public class LaevosynapticChromosomeId implements java.io.Serializable {

	private Integer laevosynapticChromosomeId;
	...
	public LaevosynapticChromosomeId() {
	}

	public LaevosynapticChromosomeId(Integer laevosynapticChromosomeId,
		...
		this.laevosynapticChromosomeId = laevosynapticChromosomeId;
	...
	public Integer getLaevosynapticChromosomeId() {
		return this.laevosynapticChromosomeId;
	}

	public void setLaevosynapticChromosomeId(Integer laevosynapticChromosomeId) {
		this.laevosynapticChromosomeId = laevosynapticChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LaevosynapticChromosomeId))
			return false;
		LaevosynapticChromosomeId castOther = (LaevosynapticChromosomeId) other;

		return ((this.getLaevosynapticChromosomeId() == castOther
				.getLaevosynapticChromosomeId()) || (this
				.getLaevosynapticChromosomeId() != null
				&& castOther.getLaevosynapticChromosomeId() != null && this
				.getLaevosynapticChromosomeId().equals(
						castOther.getLaevosynapticChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLaevosynapticChromosomeId() == null ? 0 : this
						.getLaevosynapticChromosomeId().hashCode());
		result = 37 * result
