...
/**
 * ThreePrimeNoncodingExonId generated by hbm2java
 */
public class ThreePrimeNoncodingExonId implements java.io.Serializable {

	private Integer threePrimeNoncodingExonId;
	...
	public ThreePrimeNoncodingExonId() {
	}

	public ThreePrimeNoncodingExonId(Integer threePrimeNoncodingExonId,
		...
		this.threePrimeNoncodingExonId = threePrimeNoncodingExonId;
	...
	public Integer getThreePrimeNoncodingExonId() {
		return this.threePrimeNoncodingExonId;
	}

	public void setThreePrimeNoncodingExonId(Integer threePrimeNoncodingExonId) {
		this.threePrimeNoncodingExonId = threePrimeNoncodingExonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeNoncodingExonId))
			return false;
		ThreePrimeNoncodingExonId castOther = (ThreePrimeNoncodingExonId) other;

		return ((this.getThreePrimeNoncodingExonId() == castOther
				.getThreePrimeNoncodingExonId()) || (this
				.getThreePrimeNoncodingExonId() != null
				&& castOther.getThreePrimeNoncodingExonId() != null && this
				.getThreePrimeNoncodingExonId().equals(
						castOther.getThreePrimeNoncodingExonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeNoncodingExonId() == null ? 0 : this
						.getThreePrimeNoncodingExonId().hashCode());
		result = 37 * result
