...
/**
 * FiveCm2PrimeOMethuId generated by hbm2java
 */
public class FiveCm2PrimeOMethuId implements java.io.Serializable {

	private Integer fiveCm2PrimeOMethuId;
	...
	public FiveCm2PrimeOMethuId() {
	}

	public FiveCm2PrimeOMethuId(Integer fiveCm2PrimeOMethuId,
		...
		this.fiveCm2PrimeOMethuId = fiveCm2PrimeOMethuId;
	...
	public Integer getFiveCm2PrimeOMethuId() {
		return this.fiveCm2PrimeOMethuId;
	}

	public void setFiveCm2PrimeOMethuId(Integer fiveCm2PrimeOMethuId) {
		this.fiveCm2PrimeOMethuId = fiveCm2PrimeOMethuId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveCm2PrimeOMethuId))
			return false;
		FiveCm2PrimeOMethuId castOther = (FiveCm2PrimeOMethuId) other;

		return ((this.getFiveCm2PrimeOMethuId() == castOther
				.getFiveCm2PrimeOMethuId()) || (this.getFiveCm2PrimeOMethuId() != null
				&& castOther.getFiveCm2PrimeOMethuId() != null && this
				.getFiveCm2PrimeOMethuId().equals(
						castOther.getFiveCm2PrimeOMethuId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveCm2PrimeOMethuId() == null ? 0 : this
						.getFiveCm2PrimeOMethuId().hashCode());
		result = 37 * result
