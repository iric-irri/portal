...
/**
 * FreeRingDuplicationId generated by hbm2java
 */
public class FreeRingDuplicationId implements java.io.Serializable {

	private Integer freeRingDuplicationId;
	...
	public FreeRingDuplicationId() {
	}

	public FreeRingDuplicationId(Integer freeRingDuplicationId,
		...
		this.freeRingDuplicationId = freeRingDuplicationId;
	...
	public Integer getFreeRingDuplicationId() {
		return this.freeRingDuplicationId;
	}

	public void setFreeRingDuplicationId(Integer freeRingDuplicationId) {
		this.freeRingDuplicationId = freeRingDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FreeRingDuplicationId))
			return false;
		FreeRingDuplicationId castOther = (FreeRingDuplicationId) other;

		return ((this.getFreeRingDuplicationId() == castOther
				.getFreeRingDuplicationId()) || (this
				.getFreeRingDuplicationId() != null
				&& castOther.getFreeRingDuplicationId() != null && this
				.getFreeRingDuplicationId().equals(
						castOther.getFreeRingDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFreeRingDuplicationId() == null ? 0 : this
						.getFreeRingDuplicationId().hashCode());
		result = 37 * result
