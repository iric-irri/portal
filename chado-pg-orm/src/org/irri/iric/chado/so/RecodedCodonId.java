...
/**
 * RecodedCodonId generated by hbm2java
 */
public class RecodedCodonId implements java.io.Serializable {

	private Integer recodedCodonId;
	...
	public RecodedCodonId() {
	}

	public RecodedCodonId(Integer recodedCodonId, Integer featureId,
		...
		this.recodedCodonId = recodedCodonId;
	...
	public Integer getRecodedCodonId() {
		return this.recodedCodonId;
	}

	public void setRecodedCodonId(Integer recodedCodonId) {
		this.recodedCodonId = recodedCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodedCodonId))
			return false;
		RecodedCodonId castOther = (RecodedCodonId) other;

		return ((this.getRecodedCodonId() == castOther.getRecodedCodonId()) || (this
				.getRecodedCodonId() != null
				&& castOther.getRecodedCodonId() != null && this
				.getRecodedCodonId().equals(castOther.getRecodedCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecodedCodonId() == null ? 0 : this.getRecodedCodonId()
						.hashCode());
		result = 37 * result
