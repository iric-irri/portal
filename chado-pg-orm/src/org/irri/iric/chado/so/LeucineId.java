...
/**
 * LeucineId generated by hbm2java
 */
public class LeucineId implements java.io.Serializable {

	private Integer leucineId;
	...
	public LeucineId(Integer leucineId, Integer featureId, Integer dbxrefId,
	...
	public Integer getLeucineId() {
		return this.leucineId;
	}

	public void setLeucineId(Integer leucineId) {
		this.leucineId = leucineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LeucineId))
			return false;
		LeucineId castOther = (LeucineId) other;

		return ((this.getLeucineId() == castOther.getLeucineId()) || (this
				.getLeucineId() != null && castOther.getLeucineId() != null && this
				.getLeucineId().equals(castOther.getLeucineId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getLeucineId() == null ? 0 : this.getLeucineId().hashCode());
		result = 37 * result
