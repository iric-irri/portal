...
/**
 * DownstreamGeneVariantId generated by hbm2java
 */
public class DownstreamGeneVariantId implements java.io.Serializable {

	private Integer downstreamGeneVariantId;
	...
	public DownstreamGeneVariantId() {
	}

	public DownstreamGeneVariantId(Integer downstreamGeneVariantId,
		...
		this.downstreamGeneVariantId = downstreamGeneVariantId;
	...
	public Integer getDownstreamGeneVariantId() {
		return this.downstreamGeneVariantId;
	}

	public void setDownstreamGeneVariantId(Integer downstreamGeneVariantId) {
		this.downstreamGeneVariantId = downstreamGeneVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DownstreamGeneVariantId))
			return false;
		DownstreamGeneVariantId castOther = (DownstreamGeneVariantId) other;

		return ((this.getDownstreamGeneVariantId() == castOther
				.getDownstreamGeneVariantId()) || (this
				.getDownstreamGeneVariantId() != null
				&& castOther.getDownstreamGeneVariantId() != null && this
				.getDownstreamGeneVariantId().equals(
						castOther.getDownstreamGeneVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDownstreamGeneVariantId() == null ? 0 : this
						.getDownstreamGeneVariantId().hashCode());
		result = 37 * result
