...
/**
 * EncodesOverlappingPolypeptidesDifferentStartAndStopId generated by hbm2java
 */
public class EncodesOverlappingPolypeptidesDifferentStartAndStopId implements
		java.io.Serializable {

	private Integer encodesOverlappingPolypeptidesDifferentStartAndStopId;
	...
	public EncodesOverlappingPolypeptidesDifferentStartAndStopId() {
	}

	public EncodesOverlappingPolypeptidesDifferentStartAndStopId(
			Integer encodesOverlappingPolypeptidesDifferentStartAndStopId,
		...
		this.encodesOverlappingPolypeptidesDifferentStartAndStopId = encodesOverlappingPolypeptidesDifferentStartAndStopId;
	...
	public Integer getEncodesOverlappingPolypeptidesDifferentStartAndStopId() {
		return this.encodesOverlappingPolypeptidesDifferentStartAndStopId;
	}

	public void setEncodesOverlappingPolypeptidesDifferentStartAndStopId(
			Integer encodesOverlappingPolypeptidesDifferentStartAndStopId) {
		this.encodesOverlappingPolypeptidesDifferentStartAndStopId = encodesOverlappingPolypeptidesDifferentStartAndStopId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesOverlappingPolypeptidesDifferentStartAndStopId))
			return false;
		EncodesOverlappingPolypeptidesDifferentStartAndStopId castOther = (EncodesOverlappingPolypeptidesDifferentStartAndStopId) other;

		return ((this
				.getEncodesOverlappingPolypeptidesDifferentStartAndStopId() == castOther
				.getEncodesOverlappingPolypeptidesDifferentStartAndStopId()) || (this
				.getEncodesOverlappingPolypeptidesDifferentStartAndStopId() != null
				&& castOther
						.getEncodesOverlappingPolypeptidesDifferentStartAndStopId() != null && this
				.getEncodesOverlappingPolypeptidesDifferentStartAndStopId()
				.equals(castOther
						.getEncodesOverlappingPolypeptidesDifferentStartAndStopId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesOverlappingPolypeptidesDifferentStartAndStopId() == null ? 0
						: this.getEncodesOverlappingPolypeptidesDifferentStartAndStopId()
								.hashCode());
		result = 37 * result
