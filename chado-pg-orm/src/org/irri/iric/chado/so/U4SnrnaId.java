...
/**
 * U4SnrnaId generated by hbm2java
 */
public class U4SnrnaId implements java.io.Serializable {

	private Integer u4SnrnaId;
	...
	public U4SnrnaId(Integer u4SnrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getU4SnrnaId() {
		return this.u4SnrnaId;
	}

	public void setU4SnrnaId(Integer u4SnrnaId) {
		this.u4SnrnaId = u4SnrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof U4SnrnaId))
			return false;
		U4SnrnaId castOther = (U4SnrnaId) other;

		return ((this.getU4SnrnaId() == castOther.getU4SnrnaId()) || (this
				.getU4SnrnaId() != null && castOther.getU4SnrnaId() != null && this
				.getU4SnrnaId().equals(castOther.getU4SnrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getU4SnrnaId() == null ? 0 : this.getU4SnrnaId().hashCode());
		result = 37 * result
