...
/**
 * TelomereId generated by hbm2java
 */
public class TelomereId implements java.io.Serializable {

	private Integer telomereId;
	...
	public TelomereId(Integer telomereId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTelomereId() {
		return this.telomereId;
	}

	public void setTelomereId(Integer telomereId) {
		this.telomereId = telomereId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TelomereId))
			return false;
		TelomereId castOther = (TelomereId) other;

		return ((this.getTelomereId() == castOther.getTelomereId()) || (this
				.getTelomereId() != null && castOther.getTelomereId() != null && this
				.getTelomereId().equals(castOther.getTelomereId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTelomereId() == null ? 0 : this.getTelomereId()
						.hashCode());
		result = 37 * result
