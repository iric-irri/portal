...
/**
 * PolypeptideNickelIonContactSiteId generated by hbm2java
 */
public class PolypeptideNickelIonContactSiteId implements java.io.Serializable {

	private Integer polypeptideNickelIonContactSiteId;
	...
	public PolypeptideNickelIonContactSiteId() {
	}

	public PolypeptideNickelIonContactSiteId(
			Integer polypeptideNickelIonContactSiteId, Integer featureId,
		...
		this.polypeptideNickelIonContactSiteId = polypeptideNickelIonContactSiteId;
	...
	public Integer getPolypeptideNickelIonContactSiteId() {
		return this.polypeptideNickelIonContactSiteId;
	}

	public void setPolypeptideNickelIonContactSiteId(
			Integer polypeptideNickelIonContactSiteId) {
		this.polypeptideNickelIonContactSiteId = polypeptideNickelIonContactSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolypeptideNickelIonContactSiteId))
			return false;
		PolypeptideNickelIonContactSiteId castOther = (PolypeptideNickelIonContactSiteId) other;

		return ((this.getPolypeptideNickelIonContactSiteId() == castOther
				.getPolypeptideNickelIonContactSiteId()) || (this
				.getPolypeptideNickelIonContactSiteId() != null
				&& castOther.getPolypeptideNickelIonContactSiteId() != null && this
				.getPolypeptideNickelIonContactSiteId().equals(
						castOther.getPolypeptideNickelIonContactSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolypeptideNickelIonContactSiteId() == null ? 0 : this
						.getPolypeptideNickelIonContactSiteId().hashCode());
		result = 37 * result
