...
/**
 * EditedId generated by hbm2java
 */
public class EditedId implements java.io.Serializable {
	...
	public EditedId(Integer editedId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EditedId))
			return false;
		EditedId castOther = (EditedId) other;

		return ((this.getEditedId() == castOther.getEditedId()) || (this
				.getEditedId() != null && castOther.getEditedId() != null && this
				.getEditedId().equals(castOther.getEditedId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getEditedId() == null ? 0 : this.getEditedId().hashCode());
		result = 37 * result
