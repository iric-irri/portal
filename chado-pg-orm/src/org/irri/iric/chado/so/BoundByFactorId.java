...
/**
 * BoundByFactorId generated by hbm2java
 */
public class BoundByFactorId implements java.io.Serializable {

	private Integer boundByFactorId;
	...
	public BoundByFactorId() {
	}

	public BoundByFactorId(Integer boundByFactorId, Integer featureId,
		...
		this.boundByFactorId = boundByFactorId;
	...
	public Integer getBoundByFactorId() {
		return this.boundByFactorId;
	}

	public void setBoundByFactorId(Integer boundByFactorId) {
		this.boundByFactorId = boundByFactorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BoundByFactorId))
			return false;
		BoundByFactorId castOther = (BoundByFactorId) other;

		return ((this.getBoundByFactorId() == castOther.getBoundByFactorId()) || (this
				.getBoundByFactorId() != null
				&& castOther.getBoundByFactorId() != null && this
				.getBoundByFactorId().equals(castOther.getBoundByFactorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBoundByFactorId() == null ? 0 : this.getBoundByFactorId()
						.hashCode());
		result = 37 * result
