...
/**
 * TToATransversionId generated by hbm2java
 */
public class TToATransversionId implements java.io.Serializable {

	private Integer TToATransversionId;
	...
	public TToATransversionId() {
	}

	public TToATransversionId(Integer TToATransversionId, Integer featureId,
		...
		this.TToATransversionId = TToATransversionId;
	...
	public Integer getTToATransversionId() {
		return this.TToATransversionId;
	}

	public void setTToATransversionId(Integer TToATransversionId) {
		this.TToATransversionId = TToATransversionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TToATransversionId))
			return false;
		TToATransversionId castOther = (TToATransversionId) other;

		return ((this.getTToATransversionId() == castOther
				.getTToATransversionId()) || (this.getTToATransversionId() != null
				&& castOther.getTToATransversionId() != null && this
				.getTToATransversionId().equals(
						castOther.getTToATransversionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTToATransversionId() == null ? 0 : this
						.getTToATransversionId().hashCode());
		result = 37 * result
