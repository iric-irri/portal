...
/**
 * AutosynapticChromosomeId generated by hbm2java
 */
public class AutosynapticChromosomeId implements java.io.Serializable {

	private Integer autosynapticChromosomeId;
	...
	public AutosynapticChromosomeId() {
	}

	public AutosynapticChromosomeId(Integer autosynapticChromosomeId,
		...
		this.autosynapticChromosomeId = autosynapticChromosomeId;
	...
	public Integer getAutosynapticChromosomeId() {
		return this.autosynapticChromosomeId;
	}

	public void setAutosynapticChromosomeId(Integer autosynapticChromosomeId) {
		this.autosynapticChromosomeId = autosynapticChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AutosynapticChromosomeId))
			return false;
		AutosynapticChromosomeId castOther = (AutosynapticChromosomeId) other;

		return ((this.getAutosynapticChromosomeId() == castOther
				.getAutosynapticChromosomeId()) || (this
				.getAutosynapticChromosomeId() != null
				&& castOther.getAutosynapticChromosomeId() != null && this
				.getAutosynapticChromosomeId().equals(
						castOther.getAutosynapticChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAutosynapticChromosomeId() == null ? 0 : this
						.getAutosynapticChromosomeId().hashCode());
		result = 37 * result
