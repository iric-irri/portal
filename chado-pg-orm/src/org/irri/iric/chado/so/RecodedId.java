...
/**
 * RecodedId generated by hbm2java
 */
public class RecodedId implements java.io.Serializable {

	private Integer recodedId;
	...
	public RecodedId(Integer recodedId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRecodedId() {
		return this.recodedId;
	}

	public void setRecodedId(Integer recodedId) {
		this.recodedId = recodedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecodedId))
			return false;
		RecodedId castOther = (RecodedId) other;

		return ((this.getRecodedId() == castOther.getRecodedId()) || (this
				.getRecodedId() != null && castOther.getRecodedId() != null && this
				.getRecodedId().equals(castOther.getRecodedId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRecodedId() == null ? 0 : this.getRecodedId().hashCode());
		result = 37 * result
