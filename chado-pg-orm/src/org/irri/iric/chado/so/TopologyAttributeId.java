...
/**
 * TopologyAttributeId generated by hbm2java
 */
public class TopologyAttributeId implements java.io.Serializable {

	private Integer topologyAttributeId;
	...
	public TopologyAttributeId() {
	}

	public TopologyAttributeId(Integer topologyAttributeId, Integer featureId,
		...
		this.topologyAttributeId = topologyAttributeId;
	...
	public Integer getTopologyAttributeId() {
		return this.topologyAttributeId;
	}

	public void setTopologyAttributeId(Integer topologyAttributeId) {
		this.topologyAttributeId = topologyAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TopologyAttributeId))
			return false;
		TopologyAttributeId castOther = (TopologyAttributeId) other;

		return ((this.getTopologyAttributeId() == castOther
				.getTopologyAttributeId()) || (this.getTopologyAttributeId() != null
				&& castOther.getTopologyAttributeId() != null && this
				.getTopologyAttributeId().equals(
						castOther.getTopologyAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTopologyAttributeId() == null ? 0 : this
						.getTopologyAttributeId().hashCode());
		result = 37 * result
