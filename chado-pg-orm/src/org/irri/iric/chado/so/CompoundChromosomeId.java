...
/**
 * CompoundChromosomeId generated by hbm2java
 */
public class CompoundChromosomeId implements java.io.Serializable {

	private Integer compoundChromosomeId;
	...
	public CompoundChromosomeId() {
	}

	public CompoundChromosomeId(Integer compoundChromosomeId,
		...
		this.compoundChromosomeId = compoundChromosomeId;
	...
	public Integer getCompoundChromosomeId() {
		return this.compoundChromosomeId;
	}

	public void setCompoundChromosomeId(Integer compoundChromosomeId) {
		this.compoundChromosomeId = compoundChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CompoundChromosomeId))
			return false;
		CompoundChromosomeId castOther = (CompoundChromosomeId) other;

		return ((this.getCompoundChromosomeId() == castOther
				.getCompoundChromosomeId()) || (this.getCompoundChromosomeId() != null
				&& castOther.getCompoundChromosomeId() != null && this
				.getCompoundChromosomeId().equals(
						castOther.getCompoundChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCompoundChromosomeId() == null ? 0 : this
						.getCompoundChromosomeId().hashCode());
		result = 37 * result
