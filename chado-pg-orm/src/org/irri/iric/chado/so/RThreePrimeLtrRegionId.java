...
/**
 * RThreePrimeLtrRegionId generated by hbm2java
 */
public class RThreePrimeLtrRegionId implements java.io.Serializable {

	private Integer RThreePrimeLtrRegionId;
	...
	public RThreePrimeLtrRegionId() {
	}

	public RThreePrimeLtrRegionId(Integer RThreePrimeLtrRegionId,
		...
		this.RThreePrimeLtrRegionId = RThreePrimeLtrRegionId;
	...
	public Integer getRThreePrimeLtrRegionId() {
		return this.RThreePrimeLtrRegionId;
	}

	public void setRThreePrimeLtrRegionId(Integer RThreePrimeLtrRegionId) {
		this.RThreePrimeLtrRegionId = RThreePrimeLtrRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RThreePrimeLtrRegionId))
			return false;
		RThreePrimeLtrRegionId castOther = (RThreePrimeLtrRegionId) other;

		return ((this.getRThreePrimeLtrRegionId() == castOther
				.getRThreePrimeLtrRegionId()) || (this
				.getRThreePrimeLtrRegionId() != null
				&& castOther.getRThreePrimeLtrRegionId() != null && this
				.getRThreePrimeLtrRegionId().equals(
						castOther.getRThreePrimeLtrRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRThreePrimeLtrRegionId() == null ? 0 : this
						.getRThreePrimeLtrRegionId().hashCode());
		result = 37 * result
