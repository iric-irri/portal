...
/**
 * ContigReadId generated by hbm2java
 */
public class ContigReadId implements java.io.Serializable {

	private Integer contigReadId;
	...
	public ContigReadId(Integer contigReadId, Integer featureId,
		...
		this.contigReadId = contigReadId;
	...
	public Integer getContigReadId() {
		return this.contigReadId;
	}

	public void setContigReadId(Integer contigReadId) {
		this.contigReadId = contigReadId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ContigReadId))
			return false;
		ContigReadId castOther = (ContigReadId) other;

		return ((this.getContigReadId() == castOther.getContigReadId()) || (this
				.getContigReadId() != null
				&& castOther.getContigReadId() != null && this
				.getContigReadId().equals(castOther.getContigReadId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getContigReadId() == null ? 0 : this.getContigReadId()
						.hashCode());
		result = 37 * result
