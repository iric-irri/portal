...
/**
 * TrnaEncodingId generated by hbm2java
 */
public class TrnaEncodingId implements java.io.Serializable {

	private Integer trnaEncodingId;
	...
	public TrnaEncodingId() {
	}

	public TrnaEncodingId(Integer trnaEncodingId, Integer featureId,
		...
		this.trnaEncodingId = trnaEncodingId;
	...
	public Integer getTrnaEncodingId() {
		return this.trnaEncodingId;
	}

	public void setTrnaEncodingId(Integer trnaEncodingId) {
		this.trnaEncodingId = trnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaEncodingId))
			return false;
		TrnaEncodingId castOther = (TrnaEncodingId) other;

		return ((this.getTrnaEncodingId() == castOther.getTrnaEncodingId()) || (this
				.getTrnaEncodingId() != null
				&& castOther.getTrnaEncodingId() != null && this
				.getTrnaEncodingId().equals(castOther.getTrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrnaEncodingId() == null ? 0 : this.getTrnaEncodingId()
						.hashCode());
		result = 37 * result
