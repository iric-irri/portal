...
/**
 * ThreePrimeDSpacerId generated by hbm2java
 */
public class ThreePrimeDSpacerId implements java.io.Serializable {

	private Integer threePrimeDSpacerId;
	...
	public ThreePrimeDSpacerId() {
	}

	public ThreePrimeDSpacerId(Integer threePrimeDSpacerId, Integer featureId,
		...
		this.threePrimeDSpacerId = threePrimeDSpacerId;
	...
	public Integer getThreePrimeDSpacerId() {
		return this.threePrimeDSpacerId;
	}

	public void setThreePrimeDSpacerId(Integer threePrimeDSpacerId) {
		this.threePrimeDSpacerId = threePrimeDSpacerId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeDSpacerId))
			return false;
		ThreePrimeDSpacerId castOther = (ThreePrimeDSpacerId) other;

		return ((this.getThreePrimeDSpacerId() == castOther
				.getThreePrimeDSpacerId()) || (this.getThreePrimeDSpacerId() != null
				&& castOther.getThreePrimeDSpacerId() != null && this
				.getThreePrimeDSpacerId().equals(
						castOther.getThreePrimeDSpacerId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeDSpacerId() == null ? 0 : this
						.getThreePrimeDSpacerId().hashCode());
		result = 37 * result
