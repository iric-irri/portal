...
/**
 * VdjJCClusterId generated by hbm2java
 */
public class VdjJCClusterId implements java.io.Serializable {

	private Integer vdjJCClusterId;
	...
	public VdjJCClusterId() {
	}

	public VdjJCClusterId(Integer vdjJCClusterId, Integer featureId,
		...
		this.vdjJCClusterId = vdjJCClusterId;
	...
	public Integer getVdjJCClusterId() {
		return this.vdjJCClusterId;
	}

	public void setVdjJCClusterId(Integer vdjJCClusterId) {
		this.vdjJCClusterId = vdjJCClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VdjJCClusterId))
			return false;
		VdjJCClusterId castOther = (VdjJCClusterId) other;

		return ((this.getVdjJCClusterId() == castOther.getVdjJCClusterId()) || (this
				.getVdjJCClusterId() != null
				&& castOther.getVdjJCClusterId() != null && this
				.getVdjJCClusterId().equals(castOther.getVdjJCClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVdjJCClusterId() == null ? 0 : this.getVdjJCClusterId()
						.hashCode());
		result = 37 * result
