...
/**
 * RiboswitchId generated by hbm2java
 */
public class RiboswitchId implements java.io.Serializable {
	...
	public RiboswitchId(Integer riboswitchId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RiboswitchId))
			return false;
		RiboswitchId castOther = (RiboswitchId) other;

		return ((this.getRiboswitchId() == castOther.getRiboswitchId()) || (this
				.getRiboswitchId() != null
				&& castOther.getRiboswitchId() != null && this
				.getRiboswitchId().equals(castOther.getRiboswitchId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRiboswitchId() == null ? 0 : this.getRiboswitchId()
						.hashCode());
		result = 37 * result
