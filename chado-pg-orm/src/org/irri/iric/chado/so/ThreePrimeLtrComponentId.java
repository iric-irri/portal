...
/**
 * ThreePrimeLtrComponentId generated by hbm2java
 */
public class ThreePrimeLtrComponentId implements java.io.Serializable {

	private Integer threePrimeLtrComponentId;
	...
	public ThreePrimeLtrComponentId() {
	}

	public ThreePrimeLtrComponentId(Integer threePrimeLtrComponentId,
		...
		this.threePrimeLtrComponentId = threePrimeLtrComponentId;
	...
	public Integer getThreePrimeLtrComponentId() {
		return this.threePrimeLtrComponentId;
	}

	public void setThreePrimeLtrComponentId(Integer threePrimeLtrComponentId) {
		this.threePrimeLtrComponentId = threePrimeLtrComponentId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeLtrComponentId))
			return false;
		ThreePrimeLtrComponentId castOther = (ThreePrimeLtrComponentId) other;

		return ((this.getThreePrimeLtrComponentId() == castOther
				.getThreePrimeLtrComponentId()) || (this
				.getThreePrimeLtrComponentId() != null
				&& castOther.getThreePrimeLtrComponentId() != null && this
				.getThreePrimeLtrComponentId().equals(
						castOther.getThreePrimeLtrComponentId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeLtrComponentId() == null ? 0 : this
						.getThreePrimeLtrComponentId().hashCode());
		result = 37 * result
