...
/**
 * GeneArrayMemberId generated by hbm2java
 */
public class GeneArrayMemberId implements java.io.Serializable {

	private Integer geneArrayMemberId;
	...
	public GeneArrayMemberId() {
	}

	public GeneArrayMemberId(Integer geneArrayMemberId, Integer featureId,
		...
		this.geneArrayMemberId = geneArrayMemberId;
	...
	public Integer getGeneArrayMemberId() {
		return this.geneArrayMemberId;
	}

	public void setGeneArrayMemberId(Integer geneArrayMemberId) {
		this.geneArrayMemberId = geneArrayMemberId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneArrayMemberId))
			return false;
		GeneArrayMemberId castOther = (GeneArrayMemberId) other;

		return ((this.getGeneArrayMemberId() == castOther
				.getGeneArrayMemberId()) || (this.getGeneArrayMemberId() != null
				&& castOther.getGeneArrayMemberId() != null && this
				.getGeneArrayMemberId()
				.equals(castOther.getGeneArrayMemberId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneArrayMemberId() == null ? 0 : this
						.getGeneArrayMemberId().hashCode());
		result = 37 * result
