...
/**
 * InternalShineDalgarnoSequenceId generated by hbm2java
 */
public class InternalShineDalgarnoSequenceId implements java.io.Serializable {

	private Integer internalShineDalgarnoSequenceId;
	...
	public InternalShineDalgarnoSequenceId() {
	}

	public InternalShineDalgarnoSequenceId(
			Integer internalShineDalgarnoSequenceId, Integer featureId,
		...
		this.internalShineDalgarnoSequenceId = internalShineDalgarnoSequenceId;
	...
	public Integer getInternalShineDalgarnoSequenceId() {
		return this.internalShineDalgarnoSequenceId;
	}

	public void setInternalShineDalgarnoSequenceId(
			Integer internalShineDalgarnoSequenceId) {
		this.internalShineDalgarnoSequenceId = internalShineDalgarnoSequenceId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InternalShineDalgarnoSequenceId))
			return false;
		InternalShineDalgarnoSequenceId castOther = (InternalShineDalgarnoSequenceId) other;

		return ((this.getInternalShineDalgarnoSequenceId() == castOther
				.getInternalShineDalgarnoSequenceId()) || (this
				.getInternalShineDalgarnoSequenceId() != null
				&& castOther.getInternalShineDalgarnoSequenceId() != null && this
				.getInternalShineDalgarnoSequenceId().equals(
						castOther.getInternalShineDalgarnoSequenceId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getInternalShineDalgarnoSequenceId() == null ? 0 : this
						.getInternalShineDalgarnoSequenceId().hashCode());
		result = 37 * result
