...
/**
 * ThreePrimeRaceCloneId generated by hbm2java
 */
public class ThreePrimeRaceCloneId implements java.io.Serializable {

	private Integer threePrimeRaceCloneId;
	...
	public ThreePrimeRaceCloneId() {
	}

	public ThreePrimeRaceCloneId(Integer threePrimeRaceCloneId,
		...
		this.threePrimeRaceCloneId = threePrimeRaceCloneId;
	...
	public Integer getThreePrimeRaceCloneId() {
		return this.threePrimeRaceCloneId;
	}

	public void setThreePrimeRaceCloneId(Integer threePrimeRaceCloneId) {
		this.threePrimeRaceCloneId = threePrimeRaceCloneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeRaceCloneId))
			return false;
		ThreePrimeRaceCloneId castOther = (ThreePrimeRaceCloneId) other;

		return ((this.getThreePrimeRaceCloneId() == castOther
				.getThreePrimeRaceCloneId()) || (this
				.getThreePrimeRaceCloneId() != null
				&& castOther.getThreePrimeRaceCloneId() != null && this
				.getThreePrimeRaceCloneId().equals(
						castOther.getThreePrimeRaceCloneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeRaceCloneId() == null ? 0 : this
						.getThreePrimeRaceCloneId().hashCode());
		result = 37 * result
