...
/**
 * FivePrimeRstId generated by hbm2java
 */
public class FivePrimeRstId implements java.io.Serializable {

	private Integer fivePrimeRstId;
	...
	public FivePrimeRstId() {
	}

	public FivePrimeRstId(Integer fivePrimeRstId, Integer featureId,
		...
		this.fivePrimeRstId = fivePrimeRstId;
	...
	public Integer getFivePrimeRstId() {
		return this.fivePrimeRstId;
	}

	public void setFivePrimeRstId(Integer fivePrimeRstId) {
		this.fivePrimeRstId = fivePrimeRstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivePrimeRstId))
			return false;
		FivePrimeRstId castOther = (FivePrimeRstId) other;

		return ((this.getFivePrimeRstId() == castOther.getFivePrimeRstId()) || (this
				.getFivePrimeRstId() != null
				&& castOther.getFivePrimeRstId() != null && this
				.getFivePrimeRstId().equals(castOther.getFivePrimeRstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivePrimeRstId() == null ? 0 : this.getFivePrimeRstId()
						.hashCode());
		result = 37 * result
