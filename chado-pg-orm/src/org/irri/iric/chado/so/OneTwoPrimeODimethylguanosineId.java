...
/**
 * OneTwoPrimeODimethylguanosineId generated by hbm2java
 */
public class OneTwoPrimeODimethylguanosineId implements java.io.Serializable {

	private Integer oneTwoPrimeODimethylguanosineId;
	...
	public OneTwoPrimeODimethylguanosineId() {
	}

	public OneTwoPrimeODimethylguanosineId(
			Integer oneTwoPrimeODimethylguanosineId, Integer featureId,
		...
		this.oneTwoPrimeODimethylguanosineId = oneTwoPrimeODimethylguanosineId;
	...
	public Integer getOneTwoPrimeODimethylguanosineId() {
		return this.oneTwoPrimeODimethylguanosineId;
	}

	public void setOneTwoPrimeODimethylguanosineId(
			Integer oneTwoPrimeODimethylguanosineId) {
		this.oneTwoPrimeODimethylguanosineId = oneTwoPrimeODimethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneTwoPrimeODimethylguanosineId))
			return false;
		OneTwoPrimeODimethylguanosineId castOther = (OneTwoPrimeODimethylguanosineId) other;

		return ((this.getOneTwoPrimeODimethylguanosineId() == castOther
				.getOneTwoPrimeODimethylguanosineId()) || (this
				.getOneTwoPrimeODimethylguanosineId() != null
				&& castOther.getOneTwoPrimeODimethylguanosineId() != null && this
				.getOneTwoPrimeODimethylguanosineId().equals(
						castOther.getOneTwoPrimeODimethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneTwoPrimeODimethylguanosineId() == null ? 0 : this
						.getOneTwoPrimeODimethylguanosineId().hashCode());
		result = 37 * result
