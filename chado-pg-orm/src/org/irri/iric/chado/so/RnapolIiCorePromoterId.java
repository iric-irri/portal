...
/**
 * RnapolIiCorePromoterId generated by hbm2java
 */
public class RnapolIiCorePromoterId implements java.io.Serializable {

	private Integer rnapolIiCorePromoterId;
	...
	public RnapolIiCorePromoterId() {
	}

	public RnapolIiCorePromoterId(Integer rnapolIiCorePromoterId,
		...
		this.rnapolIiCorePromoterId = rnapolIiCorePromoterId;
	...
	public Integer getRnapolIiCorePromoterId() {
		return this.rnapolIiCorePromoterId;
	}

	public void setRnapolIiCorePromoterId(Integer rnapolIiCorePromoterId) {
		this.rnapolIiCorePromoterId = rnapolIiCorePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RnapolIiCorePromoterId))
			return false;
		RnapolIiCorePromoterId castOther = (RnapolIiCorePromoterId) other;

		return ((this.getRnapolIiCorePromoterId() == castOther
				.getRnapolIiCorePromoterId()) || (this
				.getRnapolIiCorePromoterId() != null
				&& castOther.getRnapolIiCorePromoterId() != null && this
				.getRnapolIiCorePromoterId().equals(
						castOther.getRnapolIiCorePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRnapolIiCorePromoterId() == null ? 0 : this
						.getRnapolIiCorePromoterId().hashCode());
		result = 37 * result
