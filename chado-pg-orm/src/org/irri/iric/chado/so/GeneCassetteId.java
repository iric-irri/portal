...
/**
 * GeneCassetteId generated by hbm2java
 */
public class GeneCassetteId implements java.io.Serializable {

	private Integer geneCassetteId;
	...
	public GeneCassetteId() {
	}

	public GeneCassetteId(Integer geneCassetteId, Integer featureId,
		...
		this.geneCassetteId = geneCassetteId;
	...
	public Integer getGeneCassetteId() {
		return this.geneCassetteId;
	}

	public void setGeneCassetteId(Integer geneCassetteId) {
		this.geneCassetteId = geneCassetteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneCassetteId))
			return false;
		GeneCassetteId castOther = (GeneCassetteId) other;

		return ((this.getGeneCassetteId() == castOther.getGeneCassetteId()) || (this
				.getGeneCassetteId() != null
				&& castOther.getGeneCassetteId() != null && this
				.getGeneCassetteId().equals(castOther.getGeneCassetteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneCassetteId() == null ? 0 : this.getGeneCassetteId()
						.hashCode());
		result = 37 * result
