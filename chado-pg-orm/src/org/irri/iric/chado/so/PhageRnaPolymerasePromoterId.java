...
/**
 * PhageRnaPolymerasePromoterId generated by hbm2java
 */
public class PhageRnaPolymerasePromoterId implements java.io.Serializable {

	private Integer phageRnaPolymerasePromoterId;
	...
	public PhageRnaPolymerasePromoterId() {
	}

	public PhageRnaPolymerasePromoterId(Integer phageRnaPolymerasePromoterId,
		...
		this.phageRnaPolymerasePromoterId = phageRnaPolymerasePromoterId;
	...
	public Integer getPhageRnaPolymerasePromoterId() {
		return this.phageRnaPolymerasePromoterId;
	}

	public void setPhageRnaPolymerasePromoterId(
			Integer phageRnaPolymerasePromoterId) {
		this.phageRnaPolymerasePromoterId = phageRnaPolymerasePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhageRnaPolymerasePromoterId))
			return false;
		PhageRnaPolymerasePromoterId castOther = (PhageRnaPolymerasePromoterId) other;

		return ((this.getPhageRnaPolymerasePromoterId() == castOther
				.getPhageRnaPolymerasePromoterId()) || (this
				.getPhageRnaPolymerasePromoterId() != null
				&& castOther.getPhageRnaPolymerasePromoterId() != null && this
				.getPhageRnaPolymerasePromoterId().equals(
						castOther.getPhageRnaPolymerasePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPhageRnaPolymerasePromoterId() == null ? 0 : this
						.getPhageRnaPolymerasePromoterId().hashCode());
		result = 37 * result
