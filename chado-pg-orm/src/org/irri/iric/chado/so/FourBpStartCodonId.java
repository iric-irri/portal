...
/**
 * FourBpStartCodonId generated by hbm2java
 */
public class FourBpStartCodonId implements java.io.Serializable {

	private Integer fourBpStartCodonId;
	...
	public FourBpStartCodonId() {
	}

	public FourBpStartCodonId(Integer fourBpStartCodonId, Integer featureId,
		...
		this.fourBpStartCodonId = fourBpStartCodonId;
	...
	public Integer getFourBpStartCodonId() {
		return this.fourBpStartCodonId;
	}

	public void setFourBpStartCodonId(Integer fourBpStartCodonId) {
		this.fourBpStartCodonId = fourBpStartCodonId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FourBpStartCodonId))
			return false;
		FourBpStartCodonId castOther = (FourBpStartCodonId) other;

		return ((this.getFourBpStartCodonId() == castOther
				.getFourBpStartCodonId()) || (this.getFourBpStartCodonId() != null
				&& castOther.getFourBpStartCodonId() != null && this
				.getFourBpStartCodonId().equals(
						castOther.getFourBpStartCodonId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFourBpStartCodonId() == null ? 0 : this
						.getFourBpStartCodonId().hashCode());
		result = 37 * result
