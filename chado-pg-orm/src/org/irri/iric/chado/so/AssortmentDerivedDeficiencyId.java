...
/**
 * AssortmentDerivedDeficiencyId generated by hbm2java
 */
public class AssortmentDerivedDeficiencyId implements java.io.Serializable {

	private Integer assortmentDerivedDeficiencyId;
	...
	public AssortmentDerivedDeficiencyId() {
	}

	public AssortmentDerivedDeficiencyId(Integer assortmentDerivedDeficiencyId,
		...
		this.assortmentDerivedDeficiencyId = assortmentDerivedDeficiencyId;
	...
	public Integer getAssortmentDerivedDeficiencyId() {
		return this.assortmentDerivedDeficiencyId;
	}

	public void setAssortmentDerivedDeficiencyId(
			Integer assortmentDerivedDeficiencyId) {
		this.assortmentDerivedDeficiencyId = assortmentDerivedDeficiencyId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AssortmentDerivedDeficiencyId))
			return false;
		AssortmentDerivedDeficiencyId castOther = (AssortmentDerivedDeficiencyId) other;

		return ((this.getAssortmentDerivedDeficiencyId() == castOther
				.getAssortmentDerivedDeficiencyId()) || (this
				.getAssortmentDerivedDeficiencyId() != null
				&& castOther.getAssortmentDerivedDeficiencyId() != null && this
				.getAssortmentDerivedDeficiencyId().equals(
						castOther.getAssortmentDerivedDeficiencyId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssortmentDerivedDeficiencyId() == null ? 0 : this
						.getAssortmentDerivedDeficiencyId().hashCode());
		result = 37 * result
