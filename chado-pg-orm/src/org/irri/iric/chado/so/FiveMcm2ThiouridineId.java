...
/**
 * FiveMcm2ThiouridineId generated by hbm2java
 */
public class FiveMcm2ThiouridineId implements java.io.Serializable {

	private Integer fiveMcm2ThiouridineId;
	...
	public FiveMcm2ThiouridineId() {
	}

	public FiveMcm2ThiouridineId(Integer fiveMcm2ThiouridineId,
		...
		this.fiveMcm2ThiouridineId = fiveMcm2ThiouridineId;
	...
	public Integer getFiveMcm2ThiouridineId() {
		return this.fiveMcm2ThiouridineId;
	}

	public void setFiveMcm2ThiouridineId(Integer fiveMcm2ThiouridineId) {
		this.fiveMcm2ThiouridineId = fiveMcm2ThiouridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMcm2ThiouridineId))
			return false;
		FiveMcm2ThiouridineId castOther = (FiveMcm2ThiouridineId) other;

		return ((this.getFiveMcm2ThiouridineId() == castOther
				.getFiveMcm2ThiouridineId()) || (this
				.getFiveMcm2ThiouridineId() != null
				&& castOther.getFiveMcm2ThiouridineId() != null && this
				.getFiveMcm2ThiouridineId().equals(
						castOther.getFiveMcm2ThiouridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMcm2ThiouridineId() == null ? 0 : this
						.getFiveMcm2ThiouridineId().hashCode());
		result = 37 * result
