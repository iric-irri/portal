...
/**
 * CrypticSpliceAcceptorId generated by hbm2java
 */
public class CrypticSpliceAcceptorId implements java.io.Serializable {

	private Integer crypticSpliceAcceptorId;
	...
	public CrypticSpliceAcceptorId() {
	}

	public CrypticSpliceAcceptorId(Integer crypticSpliceAcceptorId,
		...
		this.crypticSpliceAcceptorId = crypticSpliceAcceptorId;
	...
	public Integer getCrypticSpliceAcceptorId() {
		return this.crypticSpliceAcceptorId;
	}

	public void setCrypticSpliceAcceptorId(Integer crypticSpliceAcceptorId) {
		this.crypticSpliceAcceptorId = crypticSpliceAcceptorId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrypticSpliceAcceptorId))
			return false;
		CrypticSpliceAcceptorId castOther = (CrypticSpliceAcceptorId) other;

		return ((this.getCrypticSpliceAcceptorId() == castOther
				.getCrypticSpliceAcceptorId()) || (this
				.getCrypticSpliceAcceptorId() != null
				&& castOther.getCrypticSpliceAcceptorId() != null && this
				.getCrypticSpliceAcceptorId().equals(
						castOther.getCrypticSpliceAcceptorId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCrypticSpliceAcceptorId() == null ? 0 : this
						.getCrypticSpliceAcceptorId().hashCode());
		result = 37 * result
