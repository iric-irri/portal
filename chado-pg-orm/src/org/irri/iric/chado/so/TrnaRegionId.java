...
/**
 * TrnaRegionId generated by hbm2java
 */
public class TrnaRegionId implements java.io.Serializable {

	private Integer trnaRegionId;
	...
	public TrnaRegionId(Integer trnaRegionId, Integer featureId,
		...
		this.trnaRegionId = trnaRegionId;
	...
	public Integer getTrnaRegionId() {
		return this.trnaRegionId;
	}

	public void setTrnaRegionId(Integer trnaRegionId) {
		this.trnaRegionId = trnaRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TrnaRegionId))
			return false;
		TrnaRegionId castOther = (TrnaRegionId) other;

		return ((this.getTrnaRegionId() == castOther.getTrnaRegionId()) || (this
				.getTrnaRegionId() != null
				&& castOther.getTrnaRegionId() != null && this
				.getTrnaRegionId().equals(castOther.getTrnaRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTrnaRegionId() == null ? 0 : this.getTrnaRegionId()
						.hashCode());
		result = 37 * result
