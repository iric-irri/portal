...
/**
 * ExperimentallyDefinedBindingRegionId generated by hbm2java
 */
public class ExperimentallyDefinedBindingRegionId implements
		java.io.Serializable {

	private Integer experimentallyDefinedBindingRegionId;
	...
	public ExperimentallyDefinedBindingRegionId() {
	}

	public ExperimentallyDefinedBindingRegionId(
			Integer experimentallyDefinedBindingRegionId, Integer featureId,
		...
		this.experimentallyDefinedBindingRegionId = experimentallyDefinedBindingRegionId;
	...
	public Integer getExperimentallyDefinedBindingRegionId() {
		return this.experimentallyDefinedBindingRegionId;
	}

	public void setExperimentallyDefinedBindingRegionId(
			Integer experimentallyDefinedBindingRegionId) {
		this.experimentallyDefinedBindingRegionId = experimentallyDefinedBindingRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExperimentallyDefinedBindingRegionId))
			return false;
		ExperimentallyDefinedBindingRegionId castOther = (ExperimentallyDefinedBindingRegionId) other;

		return ((this.getExperimentallyDefinedBindingRegionId() == castOther
				.getExperimentallyDefinedBindingRegionId()) || (this
				.getExperimentallyDefinedBindingRegionId() != null
				&& castOther.getExperimentallyDefinedBindingRegionId() != null && this
				.getExperimentallyDefinedBindingRegionId().equals(
						castOther.getExperimentallyDefinedBindingRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getExperimentallyDefinedBindingRegionId() == null ? 0 : this
						.getExperimentallyDefinedBindingRegionId().hashCode());
		result = 37 * result
