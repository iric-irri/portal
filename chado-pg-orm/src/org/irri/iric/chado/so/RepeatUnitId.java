...
/**
 * RepeatUnitId generated by hbm2java
 */
public class RepeatUnitId implements java.io.Serializable {
	...
	public RepeatUnitId(Integer repeatUnitId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RepeatUnitId))
			return false;
		RepeatUnitId castOther = (RepeatUnitId) other;

		return ((this.getRepeatUnitId() == castOther.getRepeatUnitId()) || (this
				.getRepeatUnitId() != null
				&& castOther.getRepeatUnitId() != null && this
				.getRepeatUnitId().equals(castOther.getRepeatUnitId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRepeatUnitId() == null ? 0 : this.getRepeatUnitId()
						.hashCode());
		result = 37 * result
