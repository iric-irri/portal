...
/**
 * TandemId generated by hbm2java
 */
public class TandemId implements java.io.Serializable {

	private Integer tandemId;
	...
	public TandemId(Integer tandemId, Integer featureId, Integer dbxrefId,
	...
	public void setTandemId(Integer tandemId) {
		this.tandemId = tandemId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TandemId))
			return false;
		TandemId castOther = (TandemId) other;

		return ((this.getTandemId() == castOther.getTandemId()) || (this
				.getTandemId() != null && castOther.getTandemId() != null && this
				.getTandemId().equals(castOther.getTandemId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTandemId() == null ? 0 : this.getTandemId().hashCode());
		result = 37 * result
