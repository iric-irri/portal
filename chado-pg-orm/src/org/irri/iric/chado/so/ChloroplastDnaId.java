...
/**
 * ChloroplastDnaId generated by hbm2java
 */
public class ChloroplastDnaId implements java.io.Serializable {

	private Integer chloroplastDnaId;
	...
	public ChloroplastDnaId() {
	}

	public ChloroplastDnaId(Integer chloroplastDnaId, Integer featureId,
		...
		this.chloroplastDnaId = chloroplastDnaId;
	...
	public Integer getChloroplastDnaId() {
		return this.chloroplastDnaId;
	}

	public void setChloroplastDnaId(Integer chloroplastDnaId) {
		this.chloroplastDnaId = chloroplastDnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ChloroplastDnaId))
			return false;
		ChloroplastDnaId castOther = (ChloroplastDnaId) other;

		return ((this.getChloroplastDnaId() == castOther.getChloroplastDnaId()) || (this
				.getChloroplastDnaId() != null
				&& castOther.getChloroplastDnaId() != null && this
				.getChloroplastDnaId().equals(castOther.getChloroplastDnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getChloroplastDnaId() == null ? 0 : this
						.getChloroplastDnaId().hashCode());
		result = 37 * result
