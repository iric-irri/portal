...
/**
 * MethionylTrnaId generated by hbm2java
 */
public class MethionylTrnaId implements java.io.Serializable {

	private Integer methionylTrnaId;
	...
	public MethionylTrnaId() {
	}

	public MethionylTrnaId(Integer methionylTrnaId, Integer featureId,
		...
		this.methionylTrnaId = methionylTrnaId;
	...
	public Integer getMethionylTrnaId() {
		return this.methionylTrnaId;
	}

	public void setMethionylTrnaId(Integer methionylTrnaId) {
		this.methionylTrnaId = methionylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MethionylTrnaId))
			return false;
		MethionylTrnaId castOther = (MethionylTrnaId) other;

		return ((this.getMethionylTrnaId() == castOther.getMethionylTrnaId()) || (this
				.getMethionylTrnaId() != null
				&& castOther.getMethionylTrnaId() != null && this
				.getMethionylTrnaId().equals(castOther.getMethionylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMethionylTrnaId() == null ? 0 : this.getMethionylTrnaId()
						.hashCode());
		result = 37 * result
