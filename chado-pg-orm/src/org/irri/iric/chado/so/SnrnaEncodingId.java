...
/**
 * SnrnaEncodingId generated by hbm2java
 */
public class SnrnaEncodingId implements java.io.Serializable {

	private Integer snrnaEncodingId;
	...
	public SnrnaEncodingId() {
	}

	public SnrnaEncodingId(Integer snrnaEncodingId, Integer featureId,
		...
		this.snrnaEncodingId = snrnaEncodingId;
	...
	public Integer getSnrnaEncodingId() {
		return this.snrnaEncodingId;
	}

	public void setSnrnaEncodingId(Integer snrnaEncodingId) {
		this.snrnaEncodingId = snrnaEncodingId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SnrnaEncodingId))
			return false;
		SnrnaEncodingId castOther = (SnrnaEncodingId) other;

		return ((this.getSnrnaEncodingId() == castOther.getSnrnaEncodingId()) || (this
				.getSnrnaEncodingId() != null
				&& castOther.getSnrnaEncodingId() != null && this
				.getSnrnaEncodingId().equals(castOther.getSnrnaEncodingId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSnrnaEncodingId() == null ? 0 : this.getSnrnaEncodingId()
						.hashCode());
		result = 37 * result
