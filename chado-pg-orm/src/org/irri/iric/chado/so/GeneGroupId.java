...
/**
 * GeneGroupId generated by hbm2java
 */
public class GeneGroupId implements java.io.Serializable {

	private Integer geneGroupId;
	...
	public GeneGroupId(Integer geneGroupId, Integer featureId,
	...
	public Integer getGeneGroupId() {
		return this.geneGroupId;
	}

	public void setGeneGroupId(Integer geneGroupId) {
		this.geneGroupId = geneGroupId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneGroupId))
			return false;
		GeneGroupId castOther = (GeneGroupId) other;

		return ((this.getGeneGroupId() == castOther.getGeneGroupId()) || (this
				.getGeneGroupId() != null && castOther.getGeneGroupId() != null && this
				.getGeneGroupId().equals(castOther.getGeneGroupId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneGroupId() == null ? 0 : this.getGeneGroupId()
						.hashCode());
		result = 37 * result
