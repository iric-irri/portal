...
/**
 * OneMethylinosineId generated by hbm2java
 */
public class OneMethylinosineId implements java.io.Serializable {

	private Integer oneMethylinosineId;
	...
	public OneMethylinosineId() {
	}

	public OneMethylinosineId(Integer oneMethylinosineId, Integer featureId,
		...
		this.oneMethylinosineId = oneMethylinosineId;
	...
	public Integer getOneMethylinosineId() {
		return this.oneMethylinosineId;
	}

	public void setOneMethylinosineId(Integer oneMethylinosineId) {
		this.oneMethylinosineId = oneMethylinosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneMethylinosineId))
			return false;
		OneMethylinosineId castOther = (OneMethylinosineId) other;

		return ((this.getOneMethylinosineId() == castOther
				.getOneMethylinosineId()) || (this.getOneMethylinosineId() != null
				&& castOther.getOneMethylinosineId() != null && this
				.getOneMethylinosineId().equals(
						castOther.getOneMethylinosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneMethylinosineId() == null ? 0 : this
						.getOneMethylinosineId().hashCode());
		result = 37 * result
