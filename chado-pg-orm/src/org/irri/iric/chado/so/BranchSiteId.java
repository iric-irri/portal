...
/**
 * BranchSiteId generated by hbm2java
 */
public class BranchSiteId implements java.io.Serializable {

	private Integer branchSiteId;
	...
	public BranchSiteId(Integer branchSiteId, Integer featureId,
	...
	public Integer getBranchSiteId() {
		return this.branchSiteId;
	}

	public void setBranchSiteId(Integer branchSiteId) {
		this.branchSiteId = branchSiteId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BranchSiteId))
			return false;
		BranchSiteId castOther = (BranchSiteId) other;

		return ((this.getBranchSiteId() == castOther.getBranchSiteId()) || (this
				.getBranchSiteId() != null
				&& castOther.getBranchSiteId() != null && this
				.getBranchSiteId().equals(castOther.getBranchSiteId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBranchSiteId() == null ? 0 : this.getBranchSiteId()
						.hashCode());
		result = 37 * result
