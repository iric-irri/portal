...
/**
 * TranscriptBoundByProteinId generated by hbm2java
 */
public class TranscriptBoundByProteinId implements java.io.Serializable {

	private Integer transcriptBoundByProteinId;
	...
	public TranscriptBoundByProteinId() {
	}

	public TranscriptBoundByProteinId(Integer transcriptBoundByProteinId,
		...
		this.transcriptBoundByProteinId = transcriptBoundByProteinId;
	...
	public Integer getTranscriptBoundByProteinId() {
		return this.transcriptBoundByProteinId;
	}

	public void setTranscriptBoundByProteinId(Integer transcriptBoundByProteinId) {
		this.transcriptBoundByProteinId = transcriptBoundByProteinId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TranscriptBoundByProteinId))
			return false;
		TranscriptBoundByProteinId castOther = (TranscriptBoundByProteinId) other;

		return ((this.getTranscriptBoundByProteinId() == castOther
				.getTranscriptBoundByProteinId()) || (this
				.getTranscriptBoundByProteinId() != null
				&& castOther.getTranscriptBoundByProteinId() != null && this
				.getTranscriptBoundByProteinId().equals(
						castOther.getTranscriptBoundByProteinId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTranscriptBoundByProteinId() == null ? 0 : this
						.getTranscriptBoundByProteinId().hashCode());
		result = 37 * result
