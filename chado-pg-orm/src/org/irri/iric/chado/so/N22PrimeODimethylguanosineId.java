...
/**
 * N22PrimeODimethylguanosineId generated by hbm2java
 */
public class N22PrimeODimethylguanosineId implements java.io.Serializable {

	private Integer n22PrimeODimethylguanosineId;
	...
	public N22PrimeODimethylguanosineId() {
	}

	public N22PrimeODimethylguanosineId(Integer n22PrimeODimethylguanosineId,
		...
		this.n22PrimeODimethylguanosineId = n22PrimeODimethylguanosineId;
	...
	public Integer getN22PrimeODimethylguanosineId() {
		return this.n22PrimeODimethylguanosineId;
	}

	public void setN22PrimeODimethylguanosineId(
			Integer n22PrimeODimethylguanosineId) {
		this.n22PrimeODimethylguanosineId = n22PrimeODimethylguanosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof N22PrimeODimethylguanosineId))
			return false;
		N22PrimeODimethylguanosineId castOther = (N22PrimeODimethylguanosineId) other;

		return ((this.getN22PrimeODimethylguanosineId() == castOther
				.getN22PrimeODimethylguanosineId()) || (this
				.getN22PrimeODimethylguanosineId() != null
				&& castOther.getN22PrimeODimethylguanosineId() != null && this
				.getN22PrimeODimethylguanosineId().equals(
						castOther.getN22PrimeODimethylguanosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getN22PrimeODimethylguanosineId() == null ? 0 : this
						.getN22PrimeODimethylguanosineId().hashCode());
		result = 37 * result
