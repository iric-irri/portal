...
/**
 * MirnaStemId generated by hbm2java
 */
public class MirnaStemId implements java.io.Serializable {

	private Integer mirnaStemId;
	...
	public MirnaStemId(Integer mirnaStemId, Integer featureId,
	...
	public Integer getMirnaStemId() {
		return this.mirnaStemId;
	}

	public void setMirnaStemId(Integer mirnaStemId) {
		this.mirnaStemId = mirnaStemId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MirnaStemId))
			return false;
		MirnaStemId castOther = (MirnaStemId) other;

		return ((this.getMirnaStemId() == castOther.getMirnaStemId()) || (this
				.getMirnaStemId() != null && castOther.getMirnaStemId() != null && this
				.getMirnaStemId().equals(castOther.getMirnaStemId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMirnaStemId() == null ? 0 : this.getMirnaStemId()
						.hashCode());
		result = 37 * result
