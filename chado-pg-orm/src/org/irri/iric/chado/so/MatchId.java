...
/**
 * MatchId generated by hbm2java
 */
public class MatchId implements java.io.Serializable {
	...
	public MatchId(Integer matchId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MatchId))
			return false;
		MatchId castOther = (MatchId) other;
