...
/**
 * TnaOligoId generated by hbm2java
 */
public class TnaOligoId implements java.io.Serializable {

	private Integer tnaOligoId;
	...
	public TnaOligoId(Integer tnaOligoId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTnaOligoId() {
		return this.tnaOligoId;
	}

	public void setTnaOligoId(Integer tnaOligoId) {
		this.tnaOligoId = tnaOligoId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TnaOligoId))
			return false;
		TnaOligoId castOther = (TnaOligoId) other;

		return ((this.getTnaOligoId() == castOther.getTnaOligoId()) || (this
				.getTnaOligoId() != null && castOther.getTnaOligoId() != null && this
				.getTnaOligoId().equals(castOther.getTnaOligoId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTnaOligoId() == null ? 0 : this.getTnaOligoId()
						.hashCode());
		result = 37 * result
