...
/**
 * ReadPairId generated by hbm2java
 */
public class ReadPairId implements java.io.Serializable {

	private Integer readPairId;
	...
	public ReadPairId(Integer readPairId, Integer featureId, Integer dbxrefId,
	...
	public Integer getReadPairId() {
		return this.readPairId;
	}

	public void setReadPairId(Integer readPairId) {
		this.readPairId = readPairId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReadPairId))
			return false;
		ReadPairId castOther = (ReadPairId) other;

		return ((this.getReadPairId() == castOther.getReadPairId()) || (this
				.getReadPairId() != null && castOther.getReadPairId() != null && this
				.getReadPairId().equals(castOther.getReadPairId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getReadPairId() == null ? 0 : this.getReadPairId()
						.hashCode());
		result = 37 * result
