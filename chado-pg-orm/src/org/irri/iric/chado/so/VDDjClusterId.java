...
/**
 * VDDjClusterId generated by hbm2java
 */
public class VDDjClusterId implements java.io.Serializable {

	private Integer VDDjClusterId;
	...
	public VDDjClusterId() {
	}

	public VDDjClusterId(Integer VDDjClusterId, Integer featureId,
		...
		this.VDDjClusterId = VDDjClusterId;
	...
	public Integer getVDDjClusterId() {
		return this.VDDjClusterId;
	}

	public void setVDDjClusterId(Integer VDDjClusterId) {
		this.VDDjClusterId = VDDjClusterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDDjClusterId))
			return false;
		VDDjClusterId castOther = (VDDjClusterId) other;

		return ((this.getVDDjClusterId() == castOther.getVDDjClusterId()) || (this
				.getVDDjClusterId() != null
				&& castOther.getVDDjClusterId() != null && this
				.getVDDjClusterId().equals(castOther.getVDDjClusterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getVDDjClusterId() == null ? 0 : this.getVDDjClusterId()
						.hashCode());
		result = 37 * result
