...
/**
 * DuplicationAttributeId generated by hbm2java
 */
public class DuplicationAttributeId implements java.io.Serializable {

	private Integer duplicationAttributeId;
	...
	public DuplicationAttributeId() {
	}

	public DuplicationAttributeId(Integer duplicationAttributeId,
		...
		this.duplicationAttributeId = duplicationAttributeId;
	...
	public Integer getDuplicationAttributeId() {
		return this.duplicationAttributeId;
	}

	public void setDuplicationAttributeId(Integer duplicationAttributeId) {
		this.duplicationAttributeId = duplicationAttributeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DuplicationAttributeId))
			return false;
		DuplicationAttributeId castOther = (DuplicationAttributeId) other;

		return ((this.getDuplicationAttributeId() == castOther
				.getDuplicationAttributeId()) || (this
				.getDuplicationAttributeId() != null
				&& castOther.getDuplicationAttributeId() != null && this
				.getDuplicationAttributeId().equals(
						castOther.getDuplicationAttributeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDuplicationAttributeId() == null ? 0 : this
						.getDuplicationAttributeId().hashCode());
		result = 37 * result
