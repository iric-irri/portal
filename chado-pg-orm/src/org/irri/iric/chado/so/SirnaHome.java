 ...
 * @see org.irri.iric.chado.so.Sirna
...
public class SirnaHome {
	...
	public List findByExample(Sirna instance) {
		log.debug("finding Sirna instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.so.Sirna")
