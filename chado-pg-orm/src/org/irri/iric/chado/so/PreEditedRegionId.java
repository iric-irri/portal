...
/**
 * PreEditedRegionId generated by hbm2java
 */
public class PreEditedRegionId implements java.io.Serializable {

	private Integer preEditedRegionId;
	...
	public PreEditedRegionId() {
	}

	public PreEditedRegionId(Integer preEditedRegionId, Integer featureId,
		...
		this.preEditedRegionId = preEditedRegionId;
	...
	public Integer getPreEditedRegionId() {
		return this.preEditedRegionId;
	}

	public void setPreEditedRegionId(Integer preEditedRegionId) {
		this.preEditedRegionId = preEditedRegionId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreEditedRegionId))
			return false;
		PreEditedRegionId castOther = (PreEditedRegionId) other;

		return ((this.getPreEditedRegionId() == castOther
				.getPreEditedRegionId()) || (this.getPreEditedRegionId() != null
				&& castOther.getPreEditedRegionId() != null && this
				.getPreEditedRegionId()
				.equals(castOther.getPreEditedRegionId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPreEditedRegionId() == null ? 0 : this
						.getPreEditedRegionId().hashCode());
		result = 37 * result
