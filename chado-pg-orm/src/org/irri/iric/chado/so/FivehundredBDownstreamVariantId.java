...
/**
 * FivehundredBDownstreamVariantId generated by hbm2java
 */
public class FivehundredBDownstreamVariantId implements java.io.Serializable {

	private Integer fivehundredBDownstreamVariantId;
	...
	public FivehundredBDownstreamVariantId() {
	}

	public FivehundredBDownstreamVariantId(
			Integer fivehundredBDownstreamVariantId, Integer featureId,
		...
		this.fivehundredBDownstreamVariantId = fivehundredBDownstreamVariantId;
	...
	public Integer getFivehundredBDownstreamVariantId() {
		return this.fivehundredBDownstreamVariantId;
	}

	public void setFivehundredBDownstreamVariantId(
			Integer fivehundredBDownstreamVariantId) {
		this.fivehundredBDownstreamVariantId = fivehundredBDownstreamVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FivehundredBDownstreamVariantId))
			return false;
		FivehundredBDownstreamVariantId castOther = (FivehundredBDownstreamVariantId) other;

		return ((this.getFivehundredBDownstreamVariantId() == castOther
				.getFivehundredBDownstreamVariantId()) || (this
				.getFivehundredBDownstreamVariantId() != null
				&& castOther.getFivehundredBDownstreamVariantId() != null && this
				.getFivehundredBDownstreamVariantId().equals(
						castOther.getFivehundredBDownstreamVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFivehundredBDownstreamVariantId() == null ? 0 : this
						.getFivehundredBDownstreamVariantId().hashCode());
		result = 37 * result
