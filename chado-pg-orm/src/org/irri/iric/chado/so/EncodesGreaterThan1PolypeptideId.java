...
/**
 * EncodesGreaterThan1PolypeptideId generated by hbm2java
 */
public class EncodesGreaterThan1PolypeptideId implements java.io.Serializable {

	private Integer encodesGreaterThan1PolypeptideId;
	...
	public EncodesGreaterThan1PolypeptideId() {
	}

	public EncodesGreaterThan1PolypeptideId(
			Integer encodesGreaterThan1PolypeptideId, Integer featureId,
		...
		this.encodesGreaterThan1PolypeptideId = encodesGreaterThan1PolypeptideId;
	...
	public Integer getEncodesGreaterThan1PolypeptideId() {
		return this.encodesGreaterThan1PolypeptideId;
	}

	public void setEncodesGreaterThan1PolypeptideId(
			Integer encodesGreaterThan1PolypeptideId) {
		this.encodesGreaterThan1PolypeptideId = encodesGreaterThan1PolypeptideId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EncodesGreaterThan1PolypeptideId))
			return false;
		EncodesGreaterThan1PolypeptideId castOther = (EncodesGreaterThan1PolypeptideId) other;

		return ((this.getEncodesGreaterThan1PolypeptideId() == castOther
				.getEncodesGreaterThan1PolypeptideId()) || (this
				.getEncodesGreaterThan1PolypeptideId() != null
				&& castOther.getEncodesGreaterThan1PolypeptideId() != null && this
				.getEncodesGreaterThan1PolypeptideId().equals(
						castOther.getEncodesGreaterThan1PolypeptideId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEncodesGreaterThan1PolypeptideId() == null ? 0 : this
						.getEncodesGreaterThan1PolypeptideId().hashCode());
		result = 37 * result
