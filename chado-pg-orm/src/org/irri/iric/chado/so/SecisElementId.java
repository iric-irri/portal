...
/**
 * SecisElementId generated by hbm2java
 */
public class SecisElementId implements java.io.Serializable {

	private Integer secisElementId;
	...
	public SecisElementId() {
	}

	public SecisElementId(Integer secisElementId, Integer featureId,
		...
		this.secisElementId = secisElementId;
	...
	public Integer getSecisElementId() {
		return this.secisElementId;
	}

	public void setSecisElementId(Integer secisElementId) {
		this.secisElementId = secisElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SecisElementId))
			return false;
		SecisElementId castOther = (SecisElementId) other;

		return ((this.getSecisElementId() == castOther.getSecisElementId()) || (this
				.getSecisElementId() != null
				&& castOther.getSecisElementId() != null && this
				.getSecisElementId().equals(castOther.getSecisElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSecisElementId() == null ? 0 : this.getSecisElementId()
						.hashCode());
		result = 37 * result
