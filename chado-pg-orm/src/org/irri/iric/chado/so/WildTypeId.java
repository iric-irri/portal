...
/**
 * WildTypeId generated by hbm2java
 */
public class WildTypeId implements java.io.Serializable {

	private Integer wildTypeId;
	...
	public WildTypeId(Integer wildTypeId, Integer featureId, Integer dbxrefId,
	...
	public Integer getWildTypeId() {
		return this.wildTypeId;
	}

	public void setWildTypeId(Integer wildTypeId) {
		this.wildTypeId = wildTypeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WildTypeId))
			return false;
		WildTypeId castOther = (WildTypeId) other;

		return ((this.getWildTypeId() == castOther.getWildTypeId()) || (this
				.getWildTypeId() != null && castOther.getWildTypeId() != null && this
				.getWildTypeId().equals(castOther.getWildTypeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getWildTypeId() == null ? 0 : this.getWildTypeId()
						.hashCode());
		result = 37 * result
