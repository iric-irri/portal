...
/**
 * OperonId generated by hbm2java
 */
public class OperonId implements java.io.Serializable {

	private Integer operonId;
	...
	public OperonId(Integer operonId, Integer featureId, Integer dbxrefId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OperonId))
			return false;
		OperonId castOther = (OperonId) other;

		return ((this.getOperonId() == castOther.getOperonId()) || (this
				.getOperonId() != null && castOther.getOperonId() != null && this
				.getOperonId().equals(castOther.getOperonId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getOperonId() == null ? 0 : this.getOperonId().hashCode());
		result = 37 * result
