...
/**
 * ThrTrnaPrimaryTranscriptId generated by hbm2java
 */
public class ThrTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer thrTrnaPrimaryTranscriptId;
	...
	public ThrTrnaPrimaryTranscriptId() {
	}

	public ThrTrnaPrimaryTranscriptId(Integer thrTrnaPrimaryTranscriptId,
		...
		this.thrTrnaPrimaryTranscriptId = thrTrnaPrimaryTranscriptId;
	...
	public Integer getThrTrnaPrimaryTranscriptId() {
		return this.thrTrnaPrimaryTranscriptId;
	}

	public void setThrTrnaPrimaryTranscriptId(Integer thrTrnaPrimaryTranscriptId) {
		this.thrTrnaPrimaryTranscriptId = thrTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThrTrnaPrimaryTranscriptId))
			return false;
		ThrTrnaPrimaryTranscriptId castOther = (ThrTrnaPrimaryTranscriptId) other;

		return ((this.getThrTrnaPrimaryTranscriptId() == castOther
				.getThrTrnaPrimaryTranscriptId()) || (this
				.getThrTrnaPrimaryTranscriptId() != null
				&& castOther.getThrTrnaPrimaryTranscriptId() != null && this
				.getThrTrnaPrimaryTranscriptId().equals(
						castOther.getThrTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThrTrnaPrimaryTranscriptId() == null ? 0 : this
						.getThrTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
