...
/**
 * RecombinationallyRearrangedGeneId generated by hbm2java
 */
public class RecombinationallyRearrangedGeneId implements java.io.Serializable {

	private Integer recombinationallyRearrangedGeneId;
	...
	public RecombinationallyRearrangedGeneId() {
	}

	public RecombinationallyRearrangedGeneId(
			Integer recombinationallyRearrangedGeneId, Integer featureId,
		...
		this.recombinationallyRearrangedGeneId = recombinationallyRearrangedGeneId;
	...
	public Integer getRecombinationallyRearrangedGeneId() {
		return this.recombinationallyRearrangedGeneId;
	}

	public void setRecombinationallyRearrangedGeneId(
			Integer recombinationallyRearrangedGeneId) {
		this.recombinationallyRearrangedGeneId = recombinationallyRearrangedGeneId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecombinationallyRearrangedGeneId))
			return false;
		RecombinationallyRearrangedGeneId castOther = (RecombinationallyRearrangedGeneId) other;

		return ((this.getRecombinationallyRearrangedGeneId() == castOther
				.getRecombinationallyRearrangedGeneId()) || (this
				.getRecombinationallyRearrangedGeneId() != null
				&& castOther.getRecombinationallyRearrangedGeneId() != null && this
				.getRecombinationallyRearrangedGeneId().equals(
						castOther.getRecombinationallyRearrangedGeneId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRecombinationallyRearrangedGeneId() == null ? 0 : this
						.getRecombinationallyRearrangedGeneId().hashCode());
		result = 37 * result
