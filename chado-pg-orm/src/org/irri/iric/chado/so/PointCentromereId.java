...
/**
 * PointCentromereId generated by hbm2java
 */
public class PointCentromereId implements java.io.Serializable {

	private Integer pointCentromereId;
	...
	public PointCentromereId() {
	}

	public PointCentromereId(Integer pointCentromereId, Integer featureId,
		...
		this.pointCentromereId = pointCentromereId;
	...
	public Integer getPointCentromereId() {
		return this.pointCentromereId;
	}

	public void setPointCentromereId(Integer pointCentromereId) {
		this.pointCentromereId = pointCentromereId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PointCentromereId))
			return false;
		PointCentromereId castOther = (PointCentromereId) other;

		return ((this.getPointCentromereId() == castOther
				.getPointCentromereId()) || (this.getPointCentromereId() != null
				&& castOther.getPointCentromereId() != null && this
				.getPointCentromereId()
				.equals(castOther.getPointCentromereId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPointCentromereId() == null ? 0 : this
						.getPointCentromereId().hashCode());
		result = 37 * result
