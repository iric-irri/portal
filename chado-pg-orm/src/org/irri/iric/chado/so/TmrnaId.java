...
/**
 * TmrnaId generated by hbm2java
 */
public class TmrnaId implements java.io.Serializable {

	private Integer tmrnaId;
	...
	public TmrnaId(Integer tmrnaId, Integer featureId, Integer dbxrefId,
	...
	public Integer getTmrnaId() {
		return this.tmrnaId;
	}

	public void setTmrnaId(Integer tmrnaId) {
		this.tmrnaId = tmrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmrnaId))
			return false;
		TmrnaId castOther = (TmrnaId) other;

		return ((this.getTmrnaId() == castOther.getTmrnaId()) || (this
				.getTmrnaId() != null && castOther.getTmrnaId() != null && this
				.getTmrnaId().equals(castOther.getTmrnaId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTmrnaId() == null ? 0 : this.getTmrnaId().hashCode());
		result = 37 * result
