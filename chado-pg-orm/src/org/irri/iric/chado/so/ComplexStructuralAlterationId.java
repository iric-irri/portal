...
/**
 * ComplexStructuralAlterationId generated by hbm2java
 */
public class ComplexStructuralAlterationId implements java.io.Serializable {

	private Integer complexStructuralAlterationId;
	...
	public ComplexStructuralAlterationId() {
	}

	public ComplexStructuralAlterationId(Integer complexStructuralAlterationId,
		...
		this.complexStructuralAlterationId = complexStructuralAlterationId;
	...
	public Integer getComplexStructuralAlterationId() {
		return this.complexStructuralAlterationId;
	}

	public void setComplexStructuralAlterationId(
			Integer complexStructuralAlterationId) {
		this.complexStructuralAlterationId = complexStructuralAlterationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComplexStructuralAlterationId))
			return false;
		ComplexStructuralAlterationId castOther = (ComplexStructuralAlterationId) other;

		return ((this.getComplexStructuralAlterationId() == castOther
				.getComplexStructuralAlterationId()) || (this
				.getComplexStructuralAlterationId() != null
				&& castOther.getComplexStructuralAlterationId() != null && this
				.getComplexStructuralAlterationId().equals(
						castOther.getComplexStructuralAlterationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getComplexStructuralAlterationId() == null ? 0 : this
						.getComplexStructuralAlterationId().hashCode());
		result = 37 * result
