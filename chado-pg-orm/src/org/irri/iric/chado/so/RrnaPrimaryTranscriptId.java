...
/**
 * RrnaPrimaryTranscriptId generated by hbm2java
 */
public class RrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer rrnaPrimaryTranscriptId;
	...
	public RrnaPrimaryTranscriptId() {
	}

	public RrnaPrimaryTranscriptId(Integer rrnaPrimaryTranscriptId,
		...
		this.rrnaPrimaryTranscriptId = rrnaPrimaryTranscriptId;
	...
	public Integer getRrnaPrimaryTranscriptId() {
		return this.rrnaPrimaryTranscriptId;
	}

	public void setRrnaPrimaryTranscriptId(Integer rrnaPrimaryTranscriptId) {
		this.rrnaPrimaryTranscriptId = rrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RrnaPrimaryTranscriptId))
			return false;
		RrnaPrimaryTranscriptId castOther = (RrnaPrimaryTranscriptId) other;

		return ((this.getRrnaPrimaryTranscriptId() == castOther
				.getRrnaPrimaryTranscriptId()) || (this
				.getRrnaPrimaryTranscriptId() != null
				&& castOther.getRrnaPrimaryTranscriptId() != null && this
				.getRrnaPrimaryTranscriptId().equals(
						castOther.getRrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getRrnaPrimaryTranscriptId() == null ? 0 : this
						.getRrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
