...
/**
 * MacronuclearChromosomeId generated by hbm2java
 */
public class MacronuclearChromosomeId implements java.io.Serializable {

	private Integer macronuclearChromosomeId;
	...
	public MacronuclearChromosomeId() {
	}

	public MacronuclearChromosomeId(Integer macronuclearChromosomeId,
		...
		this.macronuclearChromosomeId = macronuclearChromosomeId;
	...
	public Integer getMacronuclearChromosomeId() {
		return this.macronuclearChromosomeId;
	}

	public void setMacronuclearChromosomeId(Integer macronuclearChromosomeId) {
		this.macronuclearChromosomeId = macronuclearChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MacronuclearChromosomeId))
			return false;
		MacronuclearChromosomeId castOther = (MacronuclearChromosomeId) other;

		return ((this.getMacronuclearChromosomeId() == castOther
				.getMacronuclearChromosomeId()) || (this
				.getMacronuclearChromosomeId() != null
				&& castOther.getMacronuclearChromosomeId() != null && this
				.getMacronuclearChromosomeId().equals(
						castOther.getMacronuclearChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getMacronuclearChromosomeId() == null ? 0 : this
						.getMacronuclearChromosomeId().hashCode());
		result = 37 * result
