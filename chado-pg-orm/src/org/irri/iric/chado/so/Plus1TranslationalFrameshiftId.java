...
/**
 * Plus1TranslationalFrameshiftId generated by hbm2java
 */
public class Plus1TranslationalFrameshiftId implements java.io.Serializable {

	private Integer plus1TranslationalFrameshiftId;
	...
	public Plus1TranslationalFrameshiftId() {
	}

	public Plus1TranslationalFrameshiftId(
			Integer plus1TranslationalFrameshiftId, Integer featureId,
		...
		this.plus1TranslationalFrameshiftId = plus1TranslationalFrameshiftId;
	...
	public Integer getPlus1TranslationalFrameshiftId() {
		return this.plus1TranslationalFrameshiftId;
	}

	public void setPlus1TranslationalFrameshiftId(
			Integer plus1TranslationalFrameshiftId) {
		this.plus1TranslationalFrameshiftId = plus1TranslationalFrameshiftId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Plus1TranslationalFrameshiftId))
			return false;
		Plus1TranslationalFrameshiftId castOther = (Plus1TranslationalFrameshiftId) other;

		return ((this.getPlus1TranslationalFrameshiftId() == castOther
				.getPlus1TranslationalFrameshiftId()) || (this
				.getPlus1TranslationalFrameshiftId() != null
				&& castOther.getPlus1TranslationalFrameshiftId() != null && this
				.getPlus1TranslationalFrameshiftId().equals(
						castOther.getPlus1TranslationalFrameshiftId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPlus1TranslationalFrameshiftId() == null ? 0 : this
						.getPlus1TranslationalFrameshiftId().hashCode());
		result = 37 * result
