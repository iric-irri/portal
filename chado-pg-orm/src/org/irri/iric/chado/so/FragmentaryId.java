...
/**
 * FragmentaryId generated by hbm2java
 */
public class FragmentaryId implements java.io.Serializable {

	private Integer fragmentaryId;
	...
	public FragmentaryId() {
	}

	public FragmentaryId(Integer fragmentaryId, Integer featureId,
		...
		this.fragmentaryId = fragmentaryId;
	...
	public Integer getFragmentaryId() {
		return this.fragmentaryId;
	}

	public void setFragmentaryId(Integer fragmentaryId) {
		this.fragmentaryId = fragmentaryId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FragmentaryId))
			return false;
		FragmentaryId castOther = (FragmentaryId) other;

		return ((this.getFragmentaryId() == castOther.getFragmentaryId()) || (this
				.getFragmentaryId() != null
				&& castOther.getFragmentaryId() != null && this
				.getFragmentaryId().equals(castOther.getFragmentaryId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFragmentaryId() == null ? 0 : this.getFragmentaryId()
						.hashCode());
		result = 37 * result
