...
/**
 * AuRichElementId generated by hbm2java
 */
public class AuRichElementId implements java.io.Serializable {

	private Integer auRichElementId;
	...
	public AuRichElementId() {
	}

	public AuRichElementId(Integer auRichElementId, Integer featureId,
		...
		this.auRichElementId = auRichElementId;
	...
	public Integer getAuRichElementId() {
		return this.auRichElementId;
	}

	public void setAuRichElementId(Integer auRichElementId) {
		this.auRichElementId = auRichElementId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AuRichElementId))
			return false;
		AuRichElementId castOther = (AuRichElementId) other;

		return ((this.getAuRichElementId() == castOther.getAuRichElementId()) || (this
				.getAuRichElementId() != null
				&& castOther.getAuRichElementId() != null && this
				.getAuRichElementId().equals(castOther.getAuRichElementId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAuRichElementId() == null ? 0 : this.getAuRichElementId()
						.hashCode());
		result = 37 * result
