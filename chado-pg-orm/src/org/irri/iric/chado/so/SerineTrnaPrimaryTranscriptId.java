...
/**
 * SerineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class SerineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer serineTrnaPrimaryTranscriptId;
	...
	public SerineTrnaPrimaryTranscriptId() {
	}

	public SerineTrnaPrimaryTranscriptId(Integer serineTrnaPrimaryTranscriptId,
		...
		this.serineTrnaPrimaryTranscriptId = serineTrnaPrimaryTranscriptId;
	...
	public Integer getSerineTrnaPrimaryTranscriptId() {
		return this.serineTrnaPrimaryTranscriptId;
	}

	public void setSerineTrnaPrimaryTranscriptId(
			Integer serineTrnaPrimaryTranscriptId) {
		this.serineTrnaPrimaryTranscriptId = serineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SerineTrnaPrimaryTranscriptId))
			return false;
		SerineTrnaPrimaryTranscriptId castOther = (SerineTrnaPrimaryTranscriptId) other;

		return ((this.getSerineTrnaPrimaryTranscriptId() == castOther
				.getSerineTrnaPrimaryTranscriptId()) || (this
				.getSerineTrnaPrimaryTranscriptId() != null
				&& castOther.getSerineTrnaPrimaryTranscriptId() != null && this
				.getSerineTrnaPrimaryTranscriptId().equals(
						castOther.getSerineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSerineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getSerineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
