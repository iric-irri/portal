...
/**
 * SevenMethylguanineId generated by hbm2java
 */
public class SevenMethylguanineId implements java.io.Serializable {

	private Integer sevenMethylguanineId;
	...
	public SevenMethylguanineId() {
	}

	public SevenMethylguanineId(Integer sevenMethylguanineId,
		...
		this.sevenMethylguanineId = sevenMethylguanineId;
	...
	public Integer getSevenMethylguanineId() {
		return this.sevenMethylguanineId;
	}

	public void setSevenMethylguanineId(Integer sevenMethylguanineId) {
		this.sevenMethylguanineId = sevenMethylguanineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SevenMethylguanineId))
			return false;
		SevenMethylguanineId castOther = (SevenMethylguanineId) other;

		return ((this.getSevenMethylguanineId() == castOther
				.getSevenMethylguanineId()) || (this.getSevenMethylguanineId() != null
				&& castOther.getSevenMethylguanineId() != null && this
				.getSevenMethylguanineId().equals(
						castOther.getSevenMethylguanineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSevenMethylguanineId() == null ? 0 : this
						.getSevenMethylguanineId().hashCode());
		result = 37 * result
