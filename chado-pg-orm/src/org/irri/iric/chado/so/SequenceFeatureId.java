...
/**
 * SequenceFeatureId generated by hbm2java
 */
public class SequenceFeatureId implements java.io.Serializable {

	private Integer sequenceFeatureId;
	...
	public SequenceFeatureId() {
	}

	public SequenceFeatureId(Integer sequenceFeatureId, Integer featureId,
		...
		this.sequenceFeatureId = sequenceFeatureId;
	...
	public Integer getSequenceFeatureId() {
		return this.sequenceFeatureId;
	}

	public void setSequenceFeatureId(Integer sequenceFeatureId) {
		this.sequenceFeatureId = sequenceFeatureId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SequenceFeatureId))
			return false;
		SequenceFeatureId castOther = (SequenceFeatureId) other;

		return ((this.getSequenceFeatureId() == castOther
				.getSequenceFeatureId()) || (this.getSequenceFeatureId() != null
				&& castOther.getSequenceFeatureId() != null && this
				.getSequenceFeatureId()
				.equals(castOther.getSequenceFeatureId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSequenceFeatureId() == null ? 0 : this
						.getSequenceFeatureId().hashCode());
		result = 37 * result
