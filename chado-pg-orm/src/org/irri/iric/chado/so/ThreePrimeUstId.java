...
/**
 * ThreePrimeUstId generated by hbm2java
 */
public class ThreePrimeUstId implements java.io.Serializable {

	private Integer threePrimeUstId;
	...
	public ThreePrimeUstId() {
	}

	public ThreePrimeUstId(Integer threePrimeUstId, Integer featureId,
		...
		this.threePrimeUstId = threePrimeUstId;
	...
	public Integer getThreePrimeUstId() {
		return this.threePrimeUstId;
	}

	public void setThreePrimeUstId(Integer threePrimeUstId) {
		this.threePrimeUstId = threePrimeUstId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThreePrimeUstId))
			return false;
		ThreePrimeUstId castOther = (ThreePrimeUstId) other;

		return ((this.getThreePrimeUstId() == castOther.getThreePrimeUstId()) || (this
				.getThreePrimeUstId() != null
				&& castOther.getThreePrimeUstId() != null && this
				.getThreePrimeUstId().equals(castOther.getThreePrimeUstId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getThreePrimeUstId() == null ? 0 : this.getThreePrimeUstId()
						.hashCode());
		result = 37 * result
