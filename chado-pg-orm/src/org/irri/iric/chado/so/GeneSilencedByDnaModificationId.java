...
/**
 * GeneSilencedByDnaModificationId generated by hbm2java
 */
public class GeneSilencedByDnaModificationId implements java.io.Serializable {

	private Integer geneSilencedByDnaModificationId;
	...
	public GeneSilencedByDnaModificationId() {
	}

	public GeneSilencedByDnaModificationId(
			Integer geneSilencedByDnaModificationId, Integer featureId,
		...
		this.geneSilencedByDnaModificationId = geneSilencedByDnaModificationId;
	...
	public Integer getGeneSilencedByDnaModificationId() {
		return this.geneSilencedByDnaModificationId;
	}

	public void setGeneSilencedByDnaModificationId(
			Integer geneSilencedByDnaModificationId) {
		this.geneSilencedByDnaModificationId = geneSilencedByDnaModificationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GeneSilencedByDnaModificationId))
			return false;
		GeneSilencedByDnaModificationId castOther = (GeneSilencedByDnaModificationId) other;

		return ((this.getGeneSilencedByDnaModificationId() == castOther
				.getGeneSilencedByDnaModificationId()) || (this
				.getGeneSilencedByDnaModificationId() != null
				&& castOther.getGeneSilencedByDnaModificationId() != null && this
				.getGeneSilencedByDnaModificationId().equals(
						castOther.getGeneSilencedByDnaModificationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGeneSilencedByDnaModificationId() == null ? 0 : this
						.getGeneSilencedByDnaModificationId().hashCode());
		result = 37 * result
