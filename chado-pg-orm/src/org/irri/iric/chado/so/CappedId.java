...
/**
 * CappedId generated by hbm2java
 */
public class CappedId implements java.io.Serializable {

	private Integer cappedId;
	...
	public CappedId(Integer cappedId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCappedId() {
		return this.cappedId;
	}

	public void setCappedId(Integer cappedId) {
		this.cappedId = cappedId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CappedId))
			return false;
		CappedId castOther = (CappedId) other;

		return ((this.getCappedId() == castOther.getCappedId()) || (this
				.getCappedId() != null && castOther.getCappedId() != null && this
				.getCappedId().equals(castOther.getCappedId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCappedId() == null ? 0 : this.getCappedId().hashCode());
		result = 37 * result
