...
/**
 * OneMethyladenosineId generated by hbm2java
 */
public class OneMethyladenosineId implements java.io.Serializable {

	private Integer oneMethyladenosineId;
	...
	public OneMethyladenosineId() {
	}

	public OneMethyladenosineId(Integer oneMethyladenosineId,
		...
		this.oneMethyladenosineId = oneMethyladenosineId;
	...
	public Integer getOneMethyladenosineId() {
		return this.oneMethyladenosineId;
	}

	public void setOneMethyladenosineId(Integer oneMethyladenosineId) {
		this.oneMethyladenosineId = oneMethyladenosineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OneMethyladenosineId))
			return false;
		OneMethyladenosineId castOther = (OneMethyladenosineId) other;

		return ((this.getOneMethyladenosineId() == castOther
				.getOneMethyladenosineId()) || (this.getOneMethyladenosineId() != null
				&& castOther.getOneMethyladenosineId() != null && this
				.getOneMethyladenosineId().equals(
						castOther.getOneMethyladenosineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOneMethyladenosineId() == null ? 0 : this
						.getOneMethyladenosineId().hashCode());
		result = 37 * result
