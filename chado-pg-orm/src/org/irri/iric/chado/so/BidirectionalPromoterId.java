...
/**
 * BidirectionalPromoterId generated by hbm2java
 */
public class BidirectionalPromoterId implements java.io.Serializable {

	private Integer bidirectionalPromoterId;
	...
	public BidirectionalPromoterId() {
	}

	public BidirectionalPromoterId(Integer bidirectionalPromoterId,
		...
		this.bidirectionalPromoterId = bidirectionalPromoterId;
	...
	public Integer getBidirectionalPromoterId() {
		return this.bidirectionalPromoterId;
	}

	public void setBidirectionalPromoterId(Integer bidirectionalPromoterId) {
		this.bidirectionalPromoterId = bidirectionalPromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BidirectionalPromoterId))
			return false;
		BidirectionalPromoterId castOther = (BidirectionalPromoterId) other;

		return ((this.getBidirectionalPromoterId() == castOther
				.getBidirectionalPromoterId()) || (this
				.getBidirectionalPromoterId() != null
				&& castOther.getBidirectionalPromoterId() != null && this
				.getBidirectionalPromoterId().equals(
						castOther.getBidirectionalPromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBidirectionalPromoterId() == null ? 0 : this
						.getBidirectionalPromoterId().hashCode());
		result = 37 * result
