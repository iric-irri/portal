...
/**
 * Rrna16sId generated by hbm2java
 */
public class Rrna16sId implements java.io.Serializable {

	private Integer rrna16sId;
	...
	public Rrna16sId(Integer rrna16sId, Integer featureId, Integer dbxrefId,
	...
	public Integer getRrna16sId() {
		return this.rrna16sId;
	}

	public void setRrna16sId(Integer rrna16sId) {
		this.rrna16sId = rrna16sId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Rrna16sId))
			return false;
		Rrna16sId castOther = (Rrna16sId) other;

		return ((this.getRrna16sId() == castOther.getRrna16sId()) || (this
				.getRrna16sId() != null && castOther.getRrna16sId() != null && this
				.getRrna16sId().equals(castOther.getRrna16sId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRrna16sId() == null ? 0 : this.getRrna16sId().hashCode());
		result = 37 * result
