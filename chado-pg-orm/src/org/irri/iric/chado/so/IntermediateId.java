...
public class IntermediateId implements java.io.Serializable {
	...
	public IntermediateId(Integer intermediateId, Integer featureId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntermediateId))
			return false;
		IntermediateId castOther = (IntermediateId) other;

		return ((this.getIntermediateId() == castOther.getIntermediateId()) || (this
				.getIntermediateId() != null
				&& castOther.getIntermediateId() != null && this
				.getIntermediateId().equals(castOther.getIntermediateId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIntermediateId() == null ? 0 : this.getIntermediateId()
						.hashCode());
		result = 37 * result
