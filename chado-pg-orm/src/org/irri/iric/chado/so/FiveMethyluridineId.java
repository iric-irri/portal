...
/**
 * FiveMethyluridineId generated by hbm2java
 */
public class FiveMethyluridineId implements java.io.Serializable {

	private Integer fiveMethyluridineId;
	...
	public FiveMethyluridineId() {
	}

	public FiveMethyluridineId(Integer fiveMethyluridineId, Integer featureId,
		...
		this.fiveMethyluridineId = fiveMethyluridineId;
	...
	public Integer getFiveMethyluridineId() {
		return this.fiveMethyluridineId;
	}

	public void setFiveMethyluridineId(Integer fiveMethyluridineId) {
		this.fiveMethyluridineId = fiveMethyluridineId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FiveMethyluridineId))
			return false;
		FiveMethyluridineId castOther = (FiveMethyluridineId) other;

		return ((this.getFiveMethyluridineId() == castOther
				.getFiveMethyluridineId()) || (this.getFiveMethyluridineId() != null
				&& castOther.getFiveMethyluridineId() != null && this
				.getFiveMethyluridineId().equals(
						castOther.getFiveMethyluridineId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getFiveMethyluridineId() == null ? 0 : this
						.getFiveMethyluridineId().hashCode());
		result = 37 * result
