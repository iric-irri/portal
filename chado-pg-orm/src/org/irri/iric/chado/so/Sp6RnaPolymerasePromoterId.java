...
/**
 * Sp6RnaPolymerasePromoterId generated by hbm2java
 */
public class Sp6RnaPolymerasePromoterId implements java.io.Serializable {

	private Integer sp6RnaPolymerasePromoterId;
	...
	public Sp6RnaPolymerasePromoterId() {
	}

	public Sp6RnaPolymerasePromoterId(Integer sp6RnaPolymerasePromoterId,
		...
		this.sp6RnaPolymerasePromoterId = sp6RnaPolymerasePromoterId;
	...
	public Integer getSp6RnaPolymerasePromoterId() {
		return this.sp6RnaPolymerasePromoterId;
	}

	public void setSp6RnaPolymerasePromoterId(Integer sp6RnaPolymerasePromoterId) {
		this.sp6RnaPolymerasePromoterId = sp6RnaPolymerasePromoterId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sp6RnaPolymerasePromoterId))
			return false;
		Sp6RnaPolymerasePromoterId castOther = (Sp6RnaPolymerasePromoterId) other;

		return ((this.getSp6RnaPolymerasePromoterId() == castOther
				.getSp6RnaPolymerasePromoterId()) || (this
				.getSp6RnaPolymerasePromoterId() != null
				&& castOther.getSp6RnaPolymerasePromoterId() != null && this
				.getSp6RnaPolymerasePromoterId().equals(
						castOther.getSp6RnaPolymerasePromoterId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getSp6RnaPolymerasePromoterId() == null ? 0 : this
						.getSp6RnaPolymerasePromoterId().hashCode());
		result = 37 * result
