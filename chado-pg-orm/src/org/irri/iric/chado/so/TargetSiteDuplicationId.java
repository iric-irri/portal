...
/**
 * TargetSiteDuplicationId generated by hbm2java
 */
public class TargetSiteDuplicationId implements java.io.Serializable {

	private Integer targetSiteDuplicationId;
	...
	public TargetSiteDuplicationId() {
	}

	public TargetSiteDuplicationId(Integer targetSiteDuplicationId,
		...
		this.targetSiteDuplicationId = targetSiteDuplicationId;
	...
	public Integer getTargetSiteDuplicationId() {
		return this.targetSiteDuplicationId;
	}

	public void setTargetSiteDuplicationId(Integer targetSiteDuplicationId) {
		this.targetSiteDuplicationId = targetSiteDuplicationId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TargetSiteDuplicationId))
			return false;
		TargetSiteDuplicationId castOther = (TargetSiteDuplicationId) other;

		return ((this.getTargetSiteDuplicationId() == castOther
				.getTargetSiteDuplicationId()) || (this
				.getTargetSiteDuplicationId() != null
				&& castOther.getTargetSiteDuplicationId() != null && this
				.getTargetSiteDuplicationId().equals(
						castOther.getTargetSiteDuplicationId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTargetSiteDuplicationId() == null ? 0 : this
						.getTargetSiteDuplicationId().hashCode());
		result = 37 * result
