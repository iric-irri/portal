...
/**
 * PolyadenylationVariantId generated by hbm2java
 */
public class PolyadenylationVariantId implements java.io.Serializable {

	private Integer polyadenylationVariantId;
	...
	public PolyadenylationVariantId() {
	}

	public PolyadenylationVariantId(Integer polyadenylationVariantId,
		...
		this.polyadenylationVariantId = polyadenylationVariantId;
	...
	public Integer getPolyadenylationVariantId() {
		return this.polyadenylationVariantId;
	}

	public void setPolyadenylationVariantId(Integer polyadenylationVariantId) {
		this.polyadenylationVariantId = polyadenylationVariantId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PolyadenylationVariantId))
			return false;
		PolyadenylationVariantId castOther = (PolyadenylationVariantId) other;

		return ((this.getPolyadenylationVariantId() == castOther
				.getPolyadenylationVariantId()) || (this
				.getPolyadenylationVariantId() != null
				&& castOther.getPolyadenylationVariantId() != null && this
				.getPolyadenylationVariantId().equals(
						castOther.getPolyadenylationVariantId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPolyadenylationVariantId() == null ? 0 : this
						.getPolyadenylationVariantId().hashCode());
		result = 37 * result
