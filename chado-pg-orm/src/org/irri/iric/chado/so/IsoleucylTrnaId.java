...
/**
 * IsoleucylTrnaId generated by hbm2java
 */
public class IsoleucylTrnaId implements java.io.Serializable {

	private Integer isoleucylTrnaId;
	...
	public IsoleucylTrnaId() {
	}

	public IsoleucylTrnaId(Integer isoleucylTrnaId, Integer featureId,
		...
		this.isoleucylTrnaId = isoleucylTrnaId;
	...
	public Integer getIsoleucylTrnaId() {
		return this.isoleucylTrnaId;
	}

	public void setIsoleucylTrnaId(Integer isoleucylTrnaId) {
		this.isoleucylTrnaId = isoleucylTrnaId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IsoleucylTrnaId))
			return false;
		IsoleucylTrnaId castOther = (IsoleucylTrnaId) other;

		return ((this.getIsoleucylTrnaId() == castOther.getIsoleucylTrnaId()) || (this
				.getIsoleucylTrnaId() != null
				&& castOther.getIsoleucylTrnaId() != null && this
				.getIsoleucylTrnaId().equals(castOther.getIsoleucylTrnaId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIsoleucylTrnaId() == null ? 0 : this.getIsoleucylTrnaId()
						.hashCode());
		result = 37 * result
