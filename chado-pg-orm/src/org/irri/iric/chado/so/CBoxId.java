...
/**
 * CBoxId generated by hbm2java
 */
public class CBoxId implements java.io.Serializable {
	...
	public CBoxId(Integer CBoxId, Integer featureId, Integer dbxrefId,
	...
	public Integer getCBoxId() {
		return this.CBoxId;
	}

	public void setCBoxId(Integer CBoxId) {
		this.CBoxId = CBoxId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CBoxId))
			return false;
		CBoxId castOther = (CBoxId) other;

		return ((this.getCBoxId() == castOther.getCBoxId()) || (this
				.getCBoxId() != null && castOther.getCBoxId() != null && this
				.getCBoxId().equals(castOther.getCBoxId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getCBoxId() == null ? 0 : this.getCBoxId().hashCode());
		result = 37 * result
