...
/**
 * IsoleucineTrnaPrimaryTranscriptId generated by hbm2java
 */
public class IsoleucineTrnaPrimaryTranscriptId implements java.io.Serializable {

	private Integer isoleucineTrnaPrimaryTranscriptId;
	...
	public IsoleucineTrnaPrimaryTranscriptId() {
	}

	public IsoleucineTrnaPrimaryTranscriptId(
			Integer isoleucineTrnaPrimaryTranscriptId, Integer featureId,
		...
		this.isoleucineTrnaPrimaryTranscriptId = isoleucineTrnaPrimaryTranscriptId;
	...
	public Integer getIsoleucineTrnaPrimaryTranscriptId() {
		return this.isoleucineTrnaPrimaryTranscriptId;
	}

	public void setIsoleucineTrnaPrimaryTranscriptId(
			Integer isoleucineTrnaPrimaryTranscriptId) {
		this.isoleucineTrnaPrimaryTranscriptId = isoleucineTrnaPrimaryTranscriptId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IsoleucineTrnaPrimaryTranscriptId))
			return false;
		IsoleucineTrnaPrimaryTranscriptId castOther = (IsoleucineTrnaPrimaryTranscriptId) other;

		return ((this.getIsoleucineTrnaPrimaryTranscriptId() == castOther
				.getIsoleucineTrnaPrimaryTranscriptId()) || (this
				.getIsoleucineTrnaPrimaryTranscriptId() != null
				&& castOther.getIsoleucineTrnaPrimaryTranscriptId() != null && this
				.getIsoleucineTrnaPrimaryTranscriptId().equals(
						castOther.getIsoleucineTrnaPrimaryTranscriptId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIsoleucineTrnaPrimaryTranscriptId() == null ? 0 : this
						.getIsoleucineTrnaPrimaryTranscriptId().hashCode());
		result = 37 * result
