...
/**
 * CircularDoubleStrandedDnaChromosomeId generated by hbm2java
 */
public class CircularDoubleStrandedDnaChromosomeId implements
		java.io.Serializable {

	private Integer circularDoubleStrandedDnaChromosomeId;
	...
	public CircularDoubleStrandedDnaChromosomeId() {
	}

	public CircularDoubleStrandedDnaChromosomeId(
			Integer circularDoubleStrandedDnaChromosomeId, Integer featureId,
		...
		this.circularDoubleStrandedDnaChromosomeId = circularDoubleStrandedDnaChromosomeId;
	...
	public Integer getCircularDoubleStrandedDnaChromosomeId() {
		return this.circularDoubleStrandedDnaChromosomeId;
	}

	public void setCircularDoubleStrandedDnaChromosomeId(
			Integer circularDoubleStrandedDnaChromosomeId) {
		this.circularDoubleStrandedDnaChromosomeId = circularDoubleStrandedDnaChromosomeId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CircularDoubleStrandedDnaChromosomeId))
			return false;
		CircularDoubleStrandedDnaChromosomeId castOther = (CircularDoubleStrandedDnaChromosomeId) other;

		return ((this.getCircularDoubleStrandedDnaChromosomeId() == castOther
				.getCircularDoubleStrandedDnaChromosomeId()) || (this
				.getCircularDoubleStrandedDnaChromosomeId() != null
				&& castOther.getCircularDoubleStrandedDnaChromosomeId() != null && this
				.getCircularDoubleStrandedDnaChromosomeId().equals(
						castOther.getCircularDoubleStrandedDnaChromosomeId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCircularDoubleStrandedDnaChromosomeId() == null ? 0
						: this.getCircularDoubleStrandedDnaChromosomeId()
								.hashCode());
		result = 37 * result
