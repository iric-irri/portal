 ...
 * @see org.irri.iric.chado.Analysis
...
public class AnalysisHome {
	...
	public Analysis merge(Analysis detachedInstance) {
		...
		try {
			Analysis result = (Analysis) sessionFactory.getCurrentSession()
	...
	public Analysis findById(int id) {
		...
		try {
			Analysis instance = (Analysis) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Analysis", id);
			if (instance == null) {
	...
	public List findByExample(Analysis instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Analysis")
