...
/**
 * Home object for domain model class Db.
 * @see org.irri.iric.chado.Db
 * @author Hibernate Tools
 */
public class DbHome {

	private static final Log log = LogFactory.getLog(DbHome.class);
	...
	public void persist(Db transientInstance) {
		log.debug("persisting Db instance");
		try {
	...
	public Db merge(Db detachedInstance) {
		...
		try {
			Db result = (Db) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Db findById(int id) {
		...
		try {
			Db instance = (Db) sessionFactory.getCurrentSession().get(
					"org.irri.iric.chado.Db", id);
			if (instance == null) {
	...
	public List findByExample(Db instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Db")
