...
/**
 * Home object for domain model class Feature.
 * @see org.irri.iric.chado.Feature
 * @author Hibernate Tools
 */
public class FeatureHome {

	private static final Log log = LogFactory.getLog(FeatureHome.class);
	...
	public void persist(Feature transientInstance) {
		log.debug("persisting Feature instance");
		try {
	...
	public Feature merge(Feature detachedInstance) {
		...
		try {
			Feature result = (Feature) sessionFactory.getCurrentSession()
	...
	public Feature findById(int id) {
		...
		try {
			Feature instance = (Feature) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Feature", id);
			if (instance == null) {
	...
	public List findByExample(Feature instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Feature")
