...
/**
 * Home object for domain model class Tableinfo.
 * @see org.irri.iric.chado.Tableinfo
 * @author Hibernate Tools
 */
public class TableinfoHome {

	private static final Log log = LogFactory.getLog(TableinfoHome.class);
	...
	public void persist(Tableinfo transientInstance) {
		log.debug("persisting Tableinfo instance");
		try {
	...
	public Tableinfo merge(Tableinfo detachedInstance) {
		...
		try {
			Tableinfo result = (Tableinfo) sessionFactory.getCurrentSession()
	...
	public Tableinfo findById(int id) {
		...
		try {
			Tableinfo instance = (Tableinfo) sessionFactory.getCurrentSession()
					.get("org.irri.iric.chado.Tableinfo", id);
			if (instance == null) {
	...
	public List findByExample(Tableinfo instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.irri.iric.chado.Tableinfo")
